...
Assembles and links one or more assembly-language source files. The command-line options are case sensitive.  
 ...
 For more information on ml64.exe, see [MASM for x64 (ml64.exe)](../intrinsics/masm-for-x64--ml64.exe-.md).  
...
|Option|Action|  
|------------|------------|  
|**/AT**|Enables tiny-memory-model support. Enables error messages for code constructs that violate the requirements for .com format files. Note that this is not equivalent to the [.MODEL](../intrinsics/.model.md) **TINY** directive.<br /><br /> Not available in ml64.exe.|  
...
|**/ERRORREPORT** [ **NONE** &#124; **PROMPT** &#124; **QUEUE** &#124; **SEND** ]|If ml.exe or ml64.exe fails at runtime, you can use **/ERRORREPORT** to send information to Microsoft about these internal errors.<br /><br /> For more information about **/ERRORREPORT**, see [/errorReport (Report Internal Compiler Errors)](../buildref/-errorreport--report-internal-compiler-errors-.md).|  
...
|**/safeseh**|Marks the object as either containing no exception handlers or containing exception handlers that are all declared with [.SAFESEH](../intrinsics/.safeseh.md).<br /><br /> Not available in ml64.exe.|  
|**/Sf**|Adds first-pass listing to listing file.|  
|**/Sl** `width`|Sets the line width of source listing in characters per line. Range is 60 to 255 or 0. Default is 0. Same as [PAGE](../intrinsics/page.md) width.|  
|**/Sn**|Turns off symbol table when producing a listing.|  
|**/Sp** `length`|Sets the page length of source listing in lines per page. Range is 10 to 255 or 0. Default is 0. Same as [PAGE](../intrinsics/page.md) length.|  
|**/Ss** `text`|Specifies text for source listing. Same as [SUBTITLE](../intrinsics/subtitle.md) text.|  
|**/St** `text`|Specifies title for source listing. Same as [TITLE](../intrinsics/title.md) text.|  
...
|**/?**|Displays a summary of ML command-line syntax.|  
 ...
 `linkoptions`  
 The link options.  See [Linker Options](../buildref/linker-options.md) for more information.  
