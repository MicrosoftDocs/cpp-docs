...
## Remarks  
 ...
 ATL uses `CMessageMap` to support contained windows and dynamic message map chaining. For example, any class containing a [CContainedWindow](../atl/ccontainedwindowt-class.md) object must derive from `CMessageMap`. The following code is taken from the [SUBEDIT](../top/visual-c---samples.md) sample. Through [CComControl](../atl/ccomcontrol-class.md), the `CAtlEdit` class automatically derives from `CMessageMap`.  
  
 [!code[NVC_ATL_Windowing#90](../atl/codesnippet/CPP/cmessagemap-class_1.h)]  
...
### Remarks  
 Called by the window procedure of a [CContainedWindow](../atl/ccontainedwindowt-class.md) object or of an object that is dynamically chaining to the message map.  
  
## See Also  
 [CDynamicChain Class](../atl/cdynamicchain-class.md)   
