...
##  <a name="_atl_using_.25.module.25"></a> Using %MODULE%  
 The [ATL Control Wizard](../atl/atl-control-wizard.md) automatically generates a script that uses `%MODULE%`. ATL uses this replaceable parameter for the actual location of your server's DLL or EXE.  
...
```  
 ...
 [!code[NVC_ATL_Utilities#113](../atl/codesnippet/CPP/using-replaceable-parameters--the-registrar-s-preprocessor-_1.cpp)]  
