...
## Remarks  
 This class provides a constructor and derives methods from [CAtlList](../atl/catllist-class.md) and [CAutoPtrElementTraits](../atl/cautoptrelementtraits-class.md) to aid the creation of a list object storing smart pointers. The class [CAutoPtrArray](../atl/cautoptrarray-class.md) provides a similar function for an array object.  
