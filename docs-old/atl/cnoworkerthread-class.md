...
## Remarks  
 This class provides the same public interface as [CWorkerThread](../atl/cworkerthread-class.md). This interface is expected to be provided by the `MonitorClass` template parameter to cache classes.  
