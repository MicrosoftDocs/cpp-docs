...
- [DECLARE_AGGREGATABLE](../Topic/DECLARE_AGGREGATABLE.md) Declares that your object can be aggregated.  
 ...
 [!code[NVC_ATL_COM#2](../atl/codesnippet/CPP/ccomcoclass-class_1.h)]  
...
### Remarks  
 ...
 The ATL class implementing the required COM object (that is, the class used as the first template parameter to [CComCoClass](../atl/ccomcoclass-class.md)) must be in the same project as the calling code. The creation of the COM object is carried out by the class factory registered for this ATL class.  
 ...
 Note that the interface `Q` must have an IID associated with it that can be retrieved using the [__uuidof](../cpp/__uuidof-operator.md) operator.  
...
### Example  
 ...
 [!code[NVC_ATL_COM#11](../atl/codesnippet/CPP/ccomcoclass-class_2.cpp)]  
...
### Parameters  
 ...
 `hInst`  
 [in] The handle to the resource. By default, this parameter is **_AtlModule::GetResourceInstance**, where **_AtlModule** is the global instance of [CAtlModule](../atl/catlmodule-class.md).  
...
### Remarks  
 ...
 [!code[NVC_ATL_COM#12](../atl/codesnippet/CPP/ccomcoclass-class_3.h)]  
