...
## In This Section  
 ...
 Describes the steps that you need to take to handle COM events using ATL's [IDispEventImpl](../atl/idispeventimpl-class.md) and [IDispEventSimpleImpl](../atl/idispeventsimpleimpl-class.md) classes.  
 ...
 Provides code for manipulating paths and URLs in the form of [CPathT](../atl/cpatht-class.md) and [CUrl](../atl/curl-class.md). A thread pool, [CThreadPool](../atl/cthreadpool-class.md), can be used in your own applications. This code can be found in atlpath.h and atlutil.h.  
  
## Related Sections  
 [ATL Samples](../top/visual-c---samples.md)  
