...
template<
    ...
    class   VTraits = CElementTraits<V>> class CRBTree
```  
...
## Remarks  
 ...
 This template class is designed to be used by [CRBMap](../atl/crbmap-class.md) and [CRBMultiMap](../atl/crbmultimap-class.md). The bulk of the methods that make up these derived classes are provided by `CRBTree`.  
