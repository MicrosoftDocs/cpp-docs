...
#### Parameters  
 `ThreadTraits`  
 The class providing the thread creation function, such as [CRTThreadTraits](../atl/crtthreadtraits-class.md) or [Win32ThreadTraits](../atl/win32threadtraits-class.md).  
...
3.  Call [CWorkerThread::AddHandle](../Topic/CWorkerThread::AddHandle.md) with the handle of a kernel object and a pointer to an implementation of [IWorkerThreadClient](../atl/iworkerthreadclient-interface.md).  
  
     – or –  
  
     Call [CWorkerThread::AddTimer](../Topic/CWorkerThread::AddTimer.md) with a pointer to an implementation of [IWorkerThreadClient](../atl/iworkerthreadclient-interface.md).  
...
### Parameters  
 ...
 `pClient`  
 The pointer to the [IWorkerThreadClient](../atl/iworkerthreadclient-interface.md) interface on the object to be called when the handle is signaled.  
...
## See Also  
 ...
 [IWorkerThreadClient Interface](../atl/iworkerthreadclient-interface.md)
