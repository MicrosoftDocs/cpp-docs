...
- [CWorkerThread](../atl/cworkerthread-class.md)  
 ...
 If the thread will not be using CRT functions, use [Win32ThreadTraits](../atl/win32threadtraits-class.md) instead.  
...
### Remarks  
 ...
 This function calls [_beginthreadex](../crt/_beginthread--_beginthreadex.md) to create the thread.  
