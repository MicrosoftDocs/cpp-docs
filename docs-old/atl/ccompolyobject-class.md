...
#### Parameters  
 `contained`  
 Your class, derived from [CComObjectRoot](../atl/ccomobjectroot-class.md) or [CComObjectRootEx](../atl/ccomobjectrootex-class.md), as well as from any other interfaces you want to support on the object.  
...
## Remarks  
 ...
 If aggregated, the `CComPolyObject` object has its own **IUnknown**, separate from the outer object's **IUnknown**, and maintains its own reference count. `CComPolyObject` uses [CComContainedObject](../atl/ccomcontainedobject-class.md) to delegate to the outer unknown.  
...
##  <a name="ccompolyobject__m_contained"></a>  CComPolyObject::m_contained  
 A [CComContainedObject](../atl/ccomcontainedobject-class.md) object derived from your class.  
...
### Parameters  
 `contained`  
 [in] Your class, derived from [CComObjectRoot](../atl/ccomobjectroot-class.md) or [CComObjectRootEx](../atl/ccomobjectrootex-class.md), as well as from any other interfaces you want to support on the object.  
