...
#### Parameters  
 *Worker*  
 The class conforming to the [worker archetype](../atl/worker-archetype.md) providing the code used to process work items queued on the thread pool.  
...
## Remarks  
 ...
 An example of a *Worker* class is [CNonStatelessWorker Class](../atl/cnonstatelessworker-class.md).  
  
## Inheritance Hierarchy  
 `IUnknown`  
  
 [IThreadPoolConfig](../atl/ithreadpoolconfig-interface.md)  
...
### Remarks  
 Objects of this class can be successfully queried for the **IUnknown** and [IThreadPoolConfig](../atl/ithreadpoolconfig-interface.md) interfaces.  
...
## See Also  
 [IThreadPoolConfig Interface](../atl/ithreadpoolconfig-interface.md)   
