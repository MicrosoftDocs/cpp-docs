...
## Remarks  
 This class is used by [CAtlDllModuleT Class](../atl/catldllmodulet-class.md), [CAtlExeModuleT Class](../atl/catlexemodulet-class.md), and [CAtlServiceModuleT Class](../atl/catlservicemodulet-class.md) to provide support for DLL applications, EXE applications, and Windows services, respectively.  
  
 For more information on modules in ATL, see [ATL Module Classes](../atl/atl-module-classes.md).  
  
 This class replaces the obsolete [CComModule Class](../atl/ccommodule-class.md) used in earlier versions of ATL.  
