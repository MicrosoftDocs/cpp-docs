...
## Remarks  
 This class provides default static functions and methods for moving, copying, comparing, and hashing elements stored in a collection class object. `CElementTraits` is specified as the default provider of these operations by the collection classes [CAtlArray](../atl/catlarray-class.md), [CAtlList](../atl/catllist-class.md), [CRBMap](../atl/crbmap-class.md), [CRBMultiMap](../atl/crbmultimap-class.md), and [CRBTree](../atl/crbtree-class.md).  
