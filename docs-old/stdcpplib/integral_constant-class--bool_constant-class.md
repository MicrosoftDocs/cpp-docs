...
constexpr  operatorvalue_type() const noexcept { return (value);
...
## See Also  
 ...
 [false_type](../stdcpplib/-type_traits--typedefs.md#false_type_typedef)   
 [true_type](../stdcpplib/-type_traits--typedefs.md#true_type_typedef)
