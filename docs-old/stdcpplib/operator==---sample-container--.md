...
## Return Value  
 Returns `_Left`**.**[size](../stdcpplib/container-class--size.md) **==** `_Right`**.size && equal**(_*Left***.**[begin](../stdcpplib/container-class--begin.md), `_Left`. [end](../stdcpplib/container-class--end.md)*, _Right***.begin**).  
