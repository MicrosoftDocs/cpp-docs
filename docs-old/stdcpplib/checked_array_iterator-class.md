...
## Remarks  
 ...
 For more information and example code on the checked iterator feature, see [Checked Iterators](../stdcpplib/checked-iterators.md).  
...
### Remarks  
 For more information, see [Checked Iterators](../stdcpplib/checked-iterators.md).  
