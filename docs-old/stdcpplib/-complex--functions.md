...
```
template<class Type>
Type abs(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    Type arg(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> conj(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> cos(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> cosh(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> exp(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> log(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> log10(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    Type norm(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> polar(const Type& _Modulus,    const Type& _Argument = 0);
```  
...
```
template<class Type>    complex<Type> pow(const complex<Type>& _Base,     int  _Power);

template<class Type>    complex<Type> pow(const complex<Type>& _Base,    const Type& _Power);

template<class Type>    complex<Type> pow(const complex<Type>& _Base,    const complex<Type>& _Power);

template<class Type>    complex<Type> pow(const Type& _Base,    const complex<Type>& _Power);
```  
...
```
template<class Type>    complex<Type> sin(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> sinh(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> sqrt(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> tan(const complex<Type>& _ComplexNum);
```  
...
```
template<class Type>    complex<Type> tanh(const complex<Type>& _ComplexNum);
```  
