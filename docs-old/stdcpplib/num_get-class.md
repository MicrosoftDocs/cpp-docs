...
### Parameters  
 ...
 `_Iosbase`  
 The [ios_base](../stdcpplib/ios_base-class.md) whose flags are used by the conversion.  
  
 `_State`  
 The state to which failbit (see [ios_base::iostate](../stdcpplib/ios_base-class.md#ios_base__iostate)) is added upon failure.  
...
### Remarks  
 ...
 If `iosbase.`[ios_base::flags](../stdcpplib/ios_base-class.md#ios_base__flags)`() & ios_base::basefield == ios_base::`[oct](../stdcpplib/-ios--functions.md#oct), the conversion specification is `lo`.  
 ...
 The format of an integer input field is further determined by the [locale facet](../stdcpplib/locale-class.md#facet_class)`fac` returned by the call [use_facet](../stdcpplib/-locale--functions.md#use_facet) `<`[numpunct](../stdcpplib/numpunct-class.md)`<Elem>(iosbase.` [ios_base::getloc](../stdcpplib/ios_base-class.md#ios_base__getloc)`())`. Specifically:  
  
 `fac.` [numpunct::grouping](../stdcpplib/numpunct-class.md#numpunct__grouping) `()` determines how digits are grouped to the left of any decimal point  
  
 `fac.` [numpunct::thousands_sep](../stdcpplib/numpunct-class.md#numpunct__thousands_sep) `()` determines the sequence that separates groups of digits to the left of any decimal point.  
 ...
 behaves the same as the first, except that it endeavors to match a complete, nonempty floating-point input field. `fac.`[numpunct::decimal_point](../stdcpplib/numpunct-class.md#numpunct__decimal_point)`()` determines the sequence that separates the integer digits from the fraction digits. The equivalent scan conversion specifier is `lf`.  
 ...
 A Boolean input field takes one of two forms. If `iosbase.flags() & ios_base::`[boolalpha](../stdcpplib/-ios--functions.md#boolalpha) is false, it is the same as an integer input field, except that the converted value must be either 0 (for false) or 1 (for true). Otherwise, the sequence must match either `fac.`[numpunct::falsename](../stdcpplib/numpunct-class.md#numpunct__falsename)`()` (for false), or `fac.`[numpunct::truename](../stdcpplib/numpunct-class.md#numpunct__truename)`()` (for true).  
...
```  
 ...
 behaves the same as the first, except that it tries to match a complete, nonempty floating-point input field. **fac**. [decimal_point](../stdcpplib/numpunct-class.md#numpunct__decimal_point) determines the sequence that separates the integer digits from the fraction digits. The equivalent scan conversion specifier is **lf**.  
...
```  
 ...
 A boolean input field takes one of two forms. If **iosbase**. **flags** & `ios_base::`[boolalpha](../stdcpplib/-ios--functions.md#boolalpha) is **false**, it is the same as an integer input field, except that the converted value must be either 0 (for **false**) or 1 (for **true**). Otherwise, the sequence must match either **fac**. [falsename](../stdcpplib/numpunct-class.md#numpunct__falsename) (for **false**), or **fac**. [truename](../stdcpplib/numpunct-class.md#numpunct__truename) (for **true**).  
...
-   \> 0: These values are not defined.  
 ...
 The constructor initializes its base object with **locale::**[facet](../stdcpplib/locale-class.md#facet_class)( `_Refs`).  
