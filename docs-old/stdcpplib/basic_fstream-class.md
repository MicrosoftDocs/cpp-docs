...
---
# basic_fstream Class
Describes an object that controls insertion and extraction of elements and encoded objects using a stream buffer of class [basic_filebuf](../stdcpplib/basic_filebuf-class.md)< `Elem`, `Tr`>, with elements of type `Elem`, whose character traits are determined by the class `Tr`.  
...
|[rdbuf](#basic_fstream__rdbuf)|Returns the address of the stored stream buffer, of type pointer to [basic_filebuf](../stdcpplib/basic_filebuf-class.md)< `Elem`, `Tr`>.|  
...
### Remarks  
 The first constructor initializes the base class by calling [basic_iostream](../stdcpplib/basic_iostream-class.md)( **sb**), where **sb** is the stored object of class [basic_filebuf](../stdcpplib/basic_filebuf-class.md)\< **Elem**, **Tr**>. It also initializes **sb** by calling `basic_filebuf`\< **Elem**, **Tr**>.  
  
 The second and third constructors initializes the base class by calling `basic_iostream`( **sb**). It also initializes **sb** by calling `basic_filebuf`\< **Elem**, **Tr**>, and then **sb.**[open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__open)(_ *Filename*, `_Mode`). If the latter function returns a null pointer, the constructor calls [setstate](../stdcpplib/basic_ios-class.md#basic_ios__setstate)( **failbit**).  
  
 The fourth constructor initializes the object with the contents of `right`, treated as an rvalue reference.  
  
### Example  
  See [streampos](../stdcpplib/-ios--typedefs.md#streampos) for an example that uses `basic_fstream`.  
...
### Remarks  
 The member function calls [rdbuf](#basic_fstream__rdbuf)**->** [close](../stdcpplib/basic_filebuf-class.md#basic_filebuf__close).  
  
### Example  
  See [basic_filebuf::close](../stdcpplib/basic_filebuf-class.md#basic_filebuf__close) for an example of how to use **close**.  
...
### Remarks  
 The member function returns [rdbuf](#basic_fstream__rdbuf)**->**[is_open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__is_open).  
  
### Example  
  See [basic_filebuf::is_open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__is_open) for an example of how to use `is_open`.  
...
### Remarks  
 The member function calls [rdbuf](#basic_fstream__rdbuf) **->** [open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__open)(_ *Filename*, `_Mode`). If that function returns a null pointer, the function calls [setstate](../stdcpplib/basic_ios-class.md#basic_ios__setstate)( **failbit**).  
  
### Example  
  See [basic_filebuf::open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__open) for an example of how to use **open**.  
...
##  <a name="basic_fstream__rdbuf"></a>  basic_fstream::rdbuf  
 Returns the address of the stored stream buffer, of type pointer to [basic_filebuf](../stdcpplib/basic_filebuf-class.md)\< **Elem**, **Tr**>.  
...
### Example  
  See [basic_filebuf::close](../stdcpplib/basic_filebuf-class.md#basic_filebuf__close) for an example of how to use `rdbuf`.  
