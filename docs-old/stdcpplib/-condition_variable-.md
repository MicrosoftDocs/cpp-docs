...
---
# &lt;condition_variable&gt;
Defines the classes [condition_variable](../stdcpplib/condition_variable-class.md) and [condition_variable_any](../stdcpplib/condition_variable_any-class.md) that are used to create objects that wait for a condition to become true.  
...
## See Also  
 ...
 [condition_variable Class](../stdcpplib/condition_variable-class.md)   
 [condition_variable_any Class](../stdcpplib/condition_variable_any-class.md)   
 [cv_status Enumeration](../stdcpplib/-condition_variable--enums.md#cv_status_enumeration)
