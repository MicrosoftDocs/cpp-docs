...
---
# time_point Class
A `time_point` describes a type that represents a point in time. It holds an object of type [duration](../stdcpplib/duration-class.md) that stores the elapsed time since the epoch that is represented by the template argument `Clock`.  
...
##  <a name="time_point__operator_add_eq"></a>  time_point::operator+=  
 Adds a specified value to the stored [duration](../stdcpplib/duration-class.md) value.  
...
##  <a name="time_point__operator-_eq"></a>  time_point::operator-=  
 Subtracts a specified value from the stored [duration](../stdcpplib/duration-class.md) value.  
...
### Parameters  
 `Dur`  
 A [duration](../stdcpplib/duration-class.md) object.  
  
 `Tp`  
 A `time_point` object.  
  
### Remarks  
 The first constructor constructs an object whose stored `duration` value is equal to [duration::zero](../stdcpplib/duration-class.md#duration__zero_method).  
  
 The second constructor constructs an object whose stored duration value is equal to `Dur`. Unless `is_convertible<Duration2, duration>`*holds true*, the second constructor does not participate in overload resolution. For more information, see [<type_traits>](../stdcpplib/-type_traits-.md).  
...
##  <a name="time_point__time_since_epoch_method"></a>  time_point::time_since_epoch Method  
 Retrieves the stored [duration](../stdcpplib/duration-class.md) value.  
