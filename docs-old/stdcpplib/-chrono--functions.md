...
##  <a name="time_point_cast_function"></a>  time_point_cast Function  
 Casts a [time_point](../stdcpplib/time_point-class.md) object to a specified type.  
...
### Remarks  
 Unless `To` is an instantiation of [duration](../stdcpplib/duration-class.md), this function does not participate in overload resolution.  
