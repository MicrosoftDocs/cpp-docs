...
---
# basic_ofstream Class
Describes an object that controls insertion of elements and encoded objects into a stream buffer of class [basic_filebuf](../stdcpplib/basic_filebuf-class.md)< `Elem`, `Tr`>, with elements of type `Elem`, whose character traits are determined by the class `Tr`.  
...
### Remarks  
 The first constructor initializes the base class by calling [basic_ostream](../stdcpplib/basic_ostream-class.md)( **sb**), where **sb** is the stored object of class [basic_filebuf](../stdcpplib/basic_filebuf-class.md)< `Elem`, `Tr`>. It also initializes **sb** by calling `basic_filebuf`< `Elem`, `Tr`>.  
  
 The second and third constructors initializes the base class by calling `basic_ostream`( **sb**). It also initializes **sb** by calling `basic_filebuf`< `Elem`, `Tr`> and then **sb**. [open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__open)( `_Filename`, `_Mode` &#124; `ios_base::out`). If the latter function returns a null pointer, the constructor calls [setstate](../stdcpplib/basic_ios-class.md#basic_ios__setstate)( **failbit**).  
...
### Remarks  
 The member function calls [rdbuf](../stdcpplib/basic_ifstream-class.md#basic_ifstream__rdbuf)**->**[close](../stdcpplib/basic_filebuf-class.md#basic_filebuf__close).  
...
### Remarks  
 The member function returns [rdbuf](#basic_ofstream__rdbuf) **->** [is_open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__is_open).  
...
### Remarks  
 The member function calls [rdbuf](#basic_ofstream__rdbuf) **->** [open](../stdcpplib/basic_filebuf-class.md#basic_filebuf__open)(_ *Filename*, `_Mode` &#124; `ios_base::out`). If that function returns a null pointer, the function calls [setstate](../stdcpplib/basic_ios-class.md#basic_ios__setstate)( **failbit**).  
...
## See Also  
 [basic_ostream Class](../stdcpplib/basic_ostream-class.md)   
