...
## Remarks  
 The class describes an object that stores a reference to an object of class [valarray](../stdcpplib/valarray-class.md)**\<Type>**, along with an object of class [slice](../stdcpplib/slice-class.md), which describes the sequence of elements to select from the **valarray\<Type>** object.  
