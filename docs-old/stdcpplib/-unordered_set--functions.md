...
### Remarks  
 The template function executes `left.`[swap](../stdcpplib/unordered_set-class.md#unordered_set__swap)`(right)`.  
...
### Remarks  
 The template function executes `left.`[unordered_multiset::swap](../stdcpplib/unordered_multiset-class.md#unordered_multiset__swap)`(right)`.  
