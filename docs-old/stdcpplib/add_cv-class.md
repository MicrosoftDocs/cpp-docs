...
## Remarks  
 An instance of the type modifier holds the modified-type [add_volatile Class](../stdcpplib/add_volatile-class.md)`<` [add_const Class](../stdcpplib/add_const-class.md)`<Ty> >`.  
