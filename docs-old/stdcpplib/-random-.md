...
-   For most purposes, URNGs produce raw bits that must be shaped by distributions. (A notable exception to this is [std::shuffle()](../stdcpplib/-algorithm--functions.md#std__shuffle) because it uses a URNG directly.)  
  
-   A single instantiation of a URNG or distribution cannot safely be called concurrently because running a URNG or distribution is a modifying operation. For more information, see [Thread Safety in the C++ Standard Library](../stdcpplib/thread-safety-in-the-c---standard-library.md).  
...
|||  
|-|-|  
|[random_device Class](../stdcpplib/random_device-class.md)|Generates a non-deterministic, cryptographically secure random sequence by using an external device. Usually used to seed an engine. Low performance, very high quality. For more information, see [Remarks](#comments).|  
...
|||  
|-|-|  
|[linear_congruential_engine Class](../stdcpplib/linear_congruential_engine-class.md)|Generates a random sequence by using the linear congruential algorithm. Most simplistic and lowest quality.|  
|[mersenne_twister_engine Class](../stdcpplib/mersenne_twister_engine-class.md)|Generates a random sequence by using the Mersenne twister algorithm. Most complex, and is highest quality except for the random_device class. Very fast performance.|  
|[subtract_with_carry_engine Class](../stdcpplib/subtract_with_carry_engine-class.md)|Generates a random sequence by using the subtract-with-carry algorithm. An improvement on `linear_congruential_engine`, but much lower quality and performance than `mersenne_twister_engine`.|  
...
|||  
|-|-|  
|[discard_block_engine Class](../stdcpplib/discard_block_engine-class.md)|Generates a random sequence by discarding values returned by its base engine.|  
|[independent_bits_engine Class](../stdcpplib/independent_bits_engine-class.md)|Generates a random sequence with a specified number of bits by repacking bits from the values returned by its base engine.|  
|[shuffle_order_engine Class](../stdcpplib/shuffle_order_engine-class.md)|Generates a random sequence by reordering the values returned from its base engine.|  
...
|||  
|-|-|  
|[uniform_int_distribution Class](../stdcpplib/uniform_int_distribution-class.md)|Produces a uniform integer value distribution across a range in the closed interval [a, b] (inclusive- inclusive).|  
|[uniform_real_distribution Class](../stdcpplib/uniform_real_distribution-class.md)|Produces a uniform real (floating-point) value distribution across a range in the interval [a, b) (inclusive-exclusive).|  
|[generate_canonical](../stdcpplib/-random--functions.md#generate_canonical)|Produces an even distribution of real (floating point) values of a given precision across [0, 1) (inclusive-exclusive).|  
...
|||  
|-|-|  
|[bernoulli_distribution Class](../stdcpplib/bernoulli_distribution-class.md)|Produces a Bernoulli distribution of `bool` values.|  
|[binomial_distribution Class](../stdcpplib/binomial_distribution-class.md)|Produces a binomial distribution of integer values.|  
|[geometric_distribution Class](../stdcpplib/geometric_distribution-class.md)|Produces a geometric distribution of integer values.|  
|[negative_binomial_distribution Class](../stdcpplib/negative_binomial_distribution-class.md)|Produces a negative binomial distribution of integer values.|  
...
|||  
|-|-|  
|[cauchy_distribution Class](../stdcpplib/cauchy_distribution-class.md)|Produces a Cauchy distribution of real (floating point) values.|  
|[chi_squared_distribution Class](../stdcpplib/chi_squared_distribution-class.md)|Produces a chi-squared distribution of real (floating point) values.|  
|[fisher_f_distribution Class](../stdcpplib/fisher_f_distribution-class.md)|Produces an F-distribution (also known as Snedecor's F distribution or the Fisher–Snedecor distribution) of real (floating point) values.|  
|[lognormal_distribution Class](../stdcpplib/lognormal_distribution-class.md)|Produces a log-normal distribution of real (floating point) values.|  
|[normal_distribution Class](../stdcpplib/normal_distribution-class.md)|Produces a normal (Gaussian) distribution of real (floating point) values.|  
|[student_t_distribution Class](../stdcpplib/student_t_distribution-class.md)|Produces a Student's *t*-distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[exponential_distribution Class](../stdcpplib/exponential_distribution-class.md)|Produces an exponential distribution of real (floating point) values.|  
|[extreme_value_distribution Class](../stdcpplib/extreme_value_distribution-class.md)|Produces an extreme value distribution of real (floating point) values.|  
|[gamma_distribution Class](../stdcpplib/gamma_distribution-class.md)|Produces a gamma distribution of real (floating point) values.|  
|[poisson_distribution Class](../stdcpplib/poisson_distribution-class.md)|Produces a Poisson distribution of integer values.|  
|[weibull_distribution Class](../stdcpplib/weibull_distribution-class.md)|Produces a Weibull distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[discrete_distribution Class](../stdcpplib/discrete_distribution-class.md)|Produces a discrete integer distribution.|  
|[piecewise_constant_distribution Class](../stdcpplib/piecewise_constant_distribution-class.md)|Produces a piecewise constant distribution of real (floating point) values.|  
|[piecewise_linear_distribution Class](../stdcpplib/piecewise_linear_distribution-class.md)|Produces a piecewise linear distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[seed_seq Class](../stdcpplib/seed_seq-class.md)|Generates a non-biased scrambled seed sequence. Used to avoid replication of random variate streams. Useful when many URNGs are instantiated from engines.|  
...
- `template <class Seq> void seed(Seq& q)` seeds the generator by using a [seed_seq](../stdcpplib/seed_seq-class.md)`Seq`.  
