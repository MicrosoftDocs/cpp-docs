...
### Parameters  
 ...
 `_Fmt`  
 The format of the output. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../crt/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
  
 `_Mod`  
 A modifier for the format. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../crt/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
...
### Parameters  
 ...
 `first`  
 The beginning of the formatting string for the output. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../crt/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
  
 `last`  
 The end of the formatting string for the output. See [strftime, wcsftime, _strftime_l, _wcsftime_l](../crt/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for valid values.  
