...
3.  Build the project as a Windows 8.1 project, and address any build errors. Any errors at this stage are probably due to breaking changes in the build tools and libraries. See [Visual C++ change history 2003 - 2015](../porting/visual-c---change-history-2003---20151.md) for a detailed explanation of the changes that might affect your code.  
...
## See Also  
 [Visual C++ Porting Guide](../porting/porting-to-the-universal-windows-platform--c---.md)   
