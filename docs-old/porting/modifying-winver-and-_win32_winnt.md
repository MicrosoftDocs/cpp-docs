...
>  Values are not guaranteed to work if you include internal MFC headers in your application.  
 ...
 You can also define this macro by using the **/D** compiler option. For more information, see [/D (Preprocessor Definitions)](../buildref/-d--preprocessor-definitions-.md).  
