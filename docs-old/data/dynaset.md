...
> [!NOTE]
>  This topic applies to the MFC ODBC classes, including [CRecordset](../mfcref/crecordset-class.md). For information about dynasets in the DAO classes, see [CDaoRecordset](../mfcref/cdaorecordset-class.md). With DAO, you can open dynaset-type recordsets.  
