...
> [!TIP]
>  To optimize **Requery** performance, avoid changing the recordset's [filter](../data/recordset--filtering-records--odbc-.md) or [sort](../data/recordset--sorting-records--odbc-.md). Change only the parameter value before calling **Requery**.  
