...
|OLE DB templates classes and macros|[OLE DB Templates Reference](../data/ole-db-templates.md) (Visual C++)|  
|OLE DB consumer attributes|[OLE DB Consumer Attributes](../windows/ole-db-consumer-attributes.md)|  
|OLE DB interfaces|[OLE DB programmer's reference](https://msdn.microsoft.com/en-us/library/ms713643.aspx) (in the [!INCLUDE[winsdkshort](../atl/includes/winsdkshort_md.md)])|  
...
|ODBC conceptual topics|[Open Database Connectivity (ODBC)](../data/open-database-connectivity--odbc-.md)|  
|Data-bound controls (ADO and RDO) conceptual topics|[Data-Bound Controls (ADO and RDO)](../data/data-bound-controls--ado-and-rdo-.md)|  
