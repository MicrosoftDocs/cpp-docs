...
-   Trapping errors. Most controls have an error event from which you can write an error handler (see [Error Trapping](../data/error-trapping.md)).  
  
 For more information, see [Mapping Messages to Functions](../mfcref/mapping-messages-to-functions.md).  
