...
## Remarks  
 ...
 Use `SetParamString` to set string parameter data in the buffer. Use [SetParam](../data/cdynamicparameteraccessor--setparam.md) to set nonstring parameter data in the buffer.  
