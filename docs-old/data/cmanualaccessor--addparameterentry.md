...
## Remarks  
 To use this function, you must first call [CreateParameterAccessor](../data/cmanualaccessor--createparameteraccessor.md).  
...
## See Also  
 ...
 [CManualAccessor::AddBindEntry](../data/cmanualaccessor--addbindentry.md)   
