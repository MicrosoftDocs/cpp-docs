...
-   Online documentation that includes overviews, articles about programming topics, and class reference materials  
 ...
 For information about these components, see [ODBC and MFC](../data/odbc-and-mfc.md).  
  
 For more information, see:  
  
-   [Choosing between DAO and ODBC](../data/should-i-use-dao-or-odbc-.md).  
  
-   [Availability of database definition language (DDL) and database manipulation language (DML)](../data/are-ddl-and-dml-supported-.md) in DAO and ODBC.  
  
-   [Installing MFC database support](../data/installing-mfc-database-support.md).  
  
-   The [ODBC](../data/odbc-and-mfc.md) classes in MFC.  
  
-   [MFC data access programming documentation](../data/mfc-database-documentation.md).  
  
-   [How MFC implements ODBC](../data/odbc-and-mfc.md).  
