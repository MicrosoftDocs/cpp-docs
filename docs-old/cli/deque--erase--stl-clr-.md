...
## Remarks  
 ...
 Both member functions return an iterator that designates the first element remaining beyond any elements removed, or [deque::end (STL/CLR)](../cli/deque--end--stl-clr-.md)`()` if no such element exists.  
