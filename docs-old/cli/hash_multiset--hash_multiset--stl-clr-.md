...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[hash_multiset::begin (STL/CLR)](../cli/hash_multiset--begin--stl-clr-.md)`(),` `right``.`[hash_multiset::end (STL/CLR)](../cli/hash_multiset--end--stl-clr-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_multiset object `right`, with the default ordering predicate and hash function.  
...
## See Also  
 ...
 [hash_multiset::generic_container (STL/CLR)](../cli/hash_multiset--generic_container--stl-clr-.md)   
 [hash_multiset::operator= (STL/CLR)](../cli/hash_multiset--operator=--stl-clr-.md)