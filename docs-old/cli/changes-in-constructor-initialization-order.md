...
The order of initialization for class constructors has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../cli/includes/cpp_current_long_md.md)].  
...
3.  The code body of the class constructor is executed.  
 ...
 Note this change applies only to CLR classes; native classes in [!INCLUDE[cpp_current_long](../cli/includes/cpp_current_long_md.md)] still follow the previous conventions. In both cases, these rules cascade upward throughout the whole hierarchy chain of a given class.  
...
## See Also  
 ...
 [Constructors](../cpp/constructors--c---.md)   
 [Constructor Initializers](../notintoc/constructor-initializers.md)