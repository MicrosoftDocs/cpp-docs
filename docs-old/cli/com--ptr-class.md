...
---
# com::ptr Class
A wrapper for a COM object that can be used as a member of a CLR class.  The wrapper also automates lifetime management of the COM object, releasing all owned references on the object when its destructor is called. Analogous to [CComPtr Class](../atl/ccomptr-class.md).  
...
## Remarks  
 ...
 A `com::ptr` cannot be used directly as a function parameter; use a [Tracking Reference Operator](../windows/tracking-reference-operator--c---component-extensions-.md) or a [Handle to Object Operator (^)](../windows/handle-to-object-operator--^----c---component-extensions-.md) instead.  
...
## See Also  
 ...
 [ptr Members](../cli/ptr-members.md)