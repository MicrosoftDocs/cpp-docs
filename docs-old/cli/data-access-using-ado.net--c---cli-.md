...
## In This Section  
 [How to: Marshal ANSI Strings for ADO.NET (C++/CLI)](../cli/how-to--marshal-ansi-strings-for-ado.net--c---cli-.md)  
  
 [How to: Marshal BSTR Strings for ADO.NET (C++/CLI)](../cli/how-to--marshal-bstr-strings-for-ado.net--c---cli-.md)  
  
 [How to: Marshal Unicode Strings for ADO.NET (C++/CLI)](../cli/how-to--marshal-unicode-strings-for-ado.net--c---cli-.md)  
  
 [How to: Marshal a VARIANT for ADO.NET (C++/CLI)](../cli/how-to--marshal-a-variant-for-ado.net--c---cli-.md)  
  
 [How to: Marshal a SAFEARRAY for ADO.NET (C++/CLI)](../cli/how-to--marshal-a-safearray-for-ado.net--c---cli-.md)  
