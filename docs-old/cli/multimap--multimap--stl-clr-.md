...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[multimap::begin (STL/CLR)](../cli/multimap--begin--stl-clr-.md)`(),` `right``.`[multimap::end (STL/CLR)](../cli/multimap--end--stl-clr-.md)`())`, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the multimap object `right`, with the default ordering predicate.  
...
## See Also  
 ...
 [multimap::generic_container (STL/CLR)](../cli/multimap--generic_container--stl-clr-.md)   
 [multimap::operator= (STL/CLR)](../cli/multimap--operator=--stl-clr-.md)