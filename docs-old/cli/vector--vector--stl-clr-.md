...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[vector::begin (STL/CLR)](../cli/vector--begin--stl-clr-.md)`(),` `right``.`[vector::end (STL/CLR)](../cli/vector--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the vector object `right`.  
  
 The constructor:  
  
 `vector(vector<Value>^ right);`  
  
 initializes the controlled sequence with the sequence `[``right``->`[vector::begin (STL/CLR)](../cli/vector--begin--stl-clr-.md)`(),` `right``->`[vector::end (STL/CLR)](../cli/vector--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the vector object whose handle is `right`.  
...
## See Also  
 ...
 [vector::assign (STL/CLR)](../cli/vector--assign--stl-clr-.md)   
 [vector::generic_container (STL/CLR)](../cli/vector--generic_container--stl-clr-.md)   
 [vector::operator= (STL/CLR)](../cli/vector--operator=--stl-clr-.md)