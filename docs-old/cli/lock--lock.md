...
## Remarks  
 ...
 The fourth form of the constructor does not acquire a lock on `_object`. `lock_later` is a member of the [lock_when Enum](../cli/lock_when-enum.md). Use [lock::acquire](../cli/lock--acquire.md) or [lock::try_acquire](../cli/lock--try_acquire.md) to acquire the lock in this case.  
...
## See Also  
 ...
 [lock::~lock](../cli/lock--~lock.md)   
 [lock::acquire](../cli/lock--acquire.md)   
 [lock::try_acquire](../cli/lock--try_acquire.md)