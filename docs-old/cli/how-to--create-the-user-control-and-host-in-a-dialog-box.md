...
The steps in this article assume that you are creating a dialog-based ([CDialog Class](../mfcref/cdialog-class.md)) Microsoft Foundation Classes (MFC) project, but you can also add support for a Windows Forms control to an existing MFC dialog box.  
