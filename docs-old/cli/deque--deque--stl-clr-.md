...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[deque::begin (STL/CLR)](../cli/deque--begin--stl-clr-.md)`(),` `right``.`[deque::end (STL/CLR)](../cli/deque--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the deque object `right`.  
  
 The constructor:  
  
 `deque(deque<Value>^ right);`  
  
 initializes the controlled sequence with the sequence `[``right``->`[deque::begin (STL/CLR)](../cli/deque--begin--stl-clr-.md)`(),` `right``->`[deque::end (STL/CLR)](../cli/deque--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the deque object whose handle is `right`.  
...
## See Also  
 ...
 [deque::assign (STL/CLR)](../cli/deque--assign--stl-clr-.md)   
 [deque::generic_container (STL/CLR)](../cli/deque--generic_container--stl-clr-.md)   
 [operator= (deque) (STL/CLR)](../cli/operator=--deque---stl-clr-.md)