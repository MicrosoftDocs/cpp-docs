...
-   [Creating an MFC ActiveX Control Container](../mfcref/creating-an-mfc-activex-control-container.md)  
...
-   [ActiveX Control Containers: Inserting a Control into a Control Container Application](../mfc/activex-control-containers--inserting-a-control-into-a-control-container-application.md)  
...
-   [ActiveX Control Containers: Programming ActiveX Controls in an ActiveX Control Container](../mfc/activex-control-containers--programming-activex-controls-in-an-activex-control-container.md)  
