...
1.  [Insert an ActiveX control into the ActiveX container project](../mfc/activex-control-containers--inserting-a-control-into-a-control-container-application.md) using Gallery.  
...
## Modifications to the Project  
 ...
 [!code[NVC_MFC_AxCont#1](../mfc/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_1.h)]  
...
##  <a name="_core_the_wrapper_class_header_28h29_file"></a> The Wrapper Class Header (.H) File  
 ...
 [!code[NVC_MFC_AxCont#2](../mfc/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_2.h)]  
[!code[NVC_MFC_AxCont#3](../mfc/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_3.h)]  
...
##  <a name="_core_member_variable_modifications_to_the_project"></a> Member Variable Modifications to the Project  
 ...
 [!code[NVC_MFC_AxCont#4](../mfc/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_4.h)]  
[!code[NVC_MFC_AxCont#5](../mfc/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_5.h)]  
  
 In addition, a call to **DDX_Control** is automatically added to the `CContainerDlg`'s implementation of `DoDataExchange`:  
  
 [!code[NVC_MFC_AxCont#6](../mfc/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_6.cpp)]  
...
##  <a name="_core_programming_the_activex_control"></a> Programming the ActiveX Control  
 ...
 [!code[NVC_MFC_AxCont#7](../mfc/codesnippet/CPP/activex-control-containers--programming-activex-controls-in-an-activex-control-container_7.cpp)]  
