...
-   [Registering Controls](#_core_registering_controls)  
    ...
    > [!NOTE]
    >  For additional information on redistributing ActiveX controls, see [Redistributing Controls](../data/redistributing-controls.md).  
...
##  <a name="_core_registering_controls"></a> Registering Controls  
 ...
 [!code[NVC_MFC_AxCont#16](../mfc/codesnippet/CPP/mfc-activex-controls--distributing-activex-controls_1.cpp)]  
