...
This article presents an example of using class [CSocket](../mfcref/csocket-class.md). The example employs `CArchive` objects to serialize data through a socket. Note that this is not document serialization to or from a file.  
