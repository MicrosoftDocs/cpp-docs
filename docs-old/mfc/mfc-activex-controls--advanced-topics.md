...
##  <a name="_core_implementing_a_parameterized_property"></a> Implementing a Parameterized Property  
 ...
 [!code[NVC_MFC_AxVb#1](../mfc/codesnippet/VisualBasic/mfc-activex-controls--advanced-topics_1.vb)]  
...
### Changes Made by the Add Property Wizard  
 ...
 [!code[NVC_MFC_AxUI#35](../mfc/codesnippet/CPP/mfc-activex-controls--advanced-topics_2.h)]  
 ...
 [!code[NVC_MFC_AxUI#36](../mfc/codesnippet/CPP/mfc-activex-controls--advanced-topics_3.cpp)]  
...
|**CTL_E_REPLACEMENTSTOOLONG**|Replacements too long|  
 ...
 [!code[NVC_MFC_AxUI#37](../mfc/codesnippet/CPP/mfc-activex-controls--advanced-topics_4.cpp)]  
...
##  <a name="_core_handling_special_keys_in_your_control"></a> Handling Special Keys in the Control  
 ...
 [!code[NVC_MFC_AxUI#38](../mfc/codesnippet/CPP/mfc-activex-controls--advanced-topics_5.cpp)]  
...
-   Declare a local variable and subclass as the dialog item. Insert code that resembles the following (`CMyCtrl` is the wrapper class, `IDC_MYCTRL1` is the control's ID):  
     ...
     [!code[NVC_MFC_AxCont#19](../mfc/codesnippet/CPP/mfc-activex-controls--advanced-topics_6.cpp)]  
