...
## Form and Record Views  
 ...
 [CHtmlEditView](../mfcref/chtmleditview-class.md)  
...
## Control Views  
 ...
 A view that contains a Windows list control (see [CListCtrl](../mfcref/clistctrl-class.md)). A list control displays a collection of items, each consisting of an icon and a label, in a manner similar to the right pane of File Explorer.  
  
 [CTreeView](../mfcref/ctreeview-class.md)  
 A view that contains a Windows tree control (see [CTreeCtrl](../mfcref/ctreectrl-class.md)). A tree control displays a hierarchical list of icons and labels arranged in a manner similar to the left pane of File Explorer.  
...
## Related Classes  
 ...
 [CSplitterWnd](../mfcref/csplitterwnd-class.md)  
 ...
 [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md)  
