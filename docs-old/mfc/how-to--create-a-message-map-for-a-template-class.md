...
## Example  
 Consider an example where the MFC [CListBox](../mfcref/clistbox-class.md) class is extended to provide synchronization with an external data source. The fictitious **CSyncListBox** class is declared as follows:  
  
 [!code[NVC_MFC_CListBox#42](../mfc/codesnippet/CPP/how-to--create-a-message-map-for-a-template-class_1.h)]  
 ...
 [!code[NVC_MFC_CListBox#43](../mfc/codesnippet/CPP/how-to--create-a-message-map-for-a-template-class_2.cpp)]  
 ...
 [!code[NVC_MFC_CListBox#44](../mfc/codesnippet/CPP/how-to--create-a-message-map-for-a-template-class_3.cpp)]  
 ...
 [!code[NVC_MFC_CListBox#45](../mfc/codesnippet/CPP/how-to--create-a-message-map-for-a-template-class_4.cpp)]  
 ...
 [!code[NVC_MFC_CListBox#46](../mfc/codesnippet/CPP/how-to--create-a-message-map-for-a-template-class_5.cpp)]  
  
 The following demonstrates sample usage of the **CSyncListBox** class using a **CStringList** object:  
  
 [!code[NVC_MFC_CListBox#47](../mfc/codesnippet/CPP/how-to--create-a-message-map-for-a-template-class_6.cpp)]  
  
 To complete the test, the **StringizeElement** function must be specialized to work with the **CStringList** class:  
  
 [!code[NVC_MFC_CListBox#48](../mfc/codesnippet/CPP/how-to--create-a-message-map-for-a-template-class_7.cpp)]  
