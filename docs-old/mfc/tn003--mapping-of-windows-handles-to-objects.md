...
-   HWND ([CWnd](../mfcref/cwnd-class.md) and `CWnd`-derived classes)  
  
-   HDC ([CDC](../mfcref/cdc-class.md) and `CDC`-derived classes)  
  
-   HMENU ([CMenu](../mfcref/cmenu-class.md))  
  
-   HPEN ([CGdiObject](../mfcref/cgdiobject-class.md))  
...
-   HIMAGELIST ([CImageList](../mfcref/cimagelist-class.md))  
  
-   SOCKET ([CSocket](../mfcref/csocket-class.md))  
