...
-   ID_EDIT_CLEAR_ALL   Clears the entire document.  
     ...
     If you choose to implement this command, we recommend you use this command ID. See the MFC Tutorial sample [SCRIBBLE](../top/visual-c---samples.md) for an example implementation.  
...
-   ID_OLE_INSERT_NEW   Inserts a new OLE object  
     ...
     See the MFC OLE sample [OCLIENT](../top/visual-c---samples.md) example for a complete implementation of this command.  
