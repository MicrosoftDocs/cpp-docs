...
1.  Use the [CFile](../mfcref/cfile-class.md) class to get and set information about a file. One useful application is to use the `CFile` static member function **GetStatus** to determine if a file exists. **GetStatus** returns 0 if the specified file does not exist.  
 ...
 [!code[NVC_MFCFiles#3](../atl/codesnippet/CPP/accessing-file-status_1.cpp)]  
