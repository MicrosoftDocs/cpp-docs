...
> [!WARNING]
>  This section applies to Windows desktop applications written in C++. For information about resources in [!INCLUDE[win8_appname_long](../build/includes/win8_appname_long_md.md)] apps written in C++, see [Defining App Resources](assetId:///476ea844-632c-4467-9ce3-966be1350dd4).  
>   
>  For information on adding resources to C++/CLI  projects, please see [Resources in Applications](../Topic/Resources%20in%20Desktop%20Apps.md) in the *.NET Framework Developer's Guide.*  
...
## Related Sections  
 ...
 [Introducing Visual Studio](assetId:///99997089-56ff-4d60-81a9-447062dc98ac)  
...
## See Also  
 [Windows Desktop Applications](../windows/windows-desktop-applications--c---.md)   
