...
## Remarks  
 This form of `operator new` is known as scalar new, in contrast to the vector new form ([operator new&#91;&#93;](../crt/operator-new-crt-.md)).  
 ...
 [operator delete](../crt/operator-delete--crt-.md) frees memory allocated with `operator new`.  
