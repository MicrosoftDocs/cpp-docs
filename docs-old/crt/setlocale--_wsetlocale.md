...
|`_tsetlocale`|`setlocale`|`setlocale`|`_wsetlocale`|  
 ...
 For more information, see the [setlocale](../c/setlocale.md) pragma directive in the [C/C++ Preprocessor Reference](../c/c-c---preprocessor-reference.md).  
  
 The function [_configthreadlocale](../crt/_configthreadlocale.md) is used to control whether `setlocale` affects the locale of all threads in a program or only the locale of the calling thread.  
...
## See Also  
 ...
 [strlen, wcslen, _mbslen, _mbslen_l, _mbstrlen, _mbstrlen_l](../crt/strlen--wcslen--_mbslen--_mbslen_l--_mbstrlen--_mbstrlen_l.md)   
