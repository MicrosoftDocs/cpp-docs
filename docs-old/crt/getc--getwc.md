...
## Remarks  
 ...
 These functions lock the calling thread and are therefore thread-safe. For a non-locking version, see [_getc_nolock, _getwc_nolock](../crt/_getc_nolock--_getwc_nolock.md).  
