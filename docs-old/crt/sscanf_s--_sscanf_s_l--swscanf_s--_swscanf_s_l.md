...
Reads formatted data from a string. These versions of [sscanf, _sscanf_l, swscanf, _swscanf_l](../crt/sscanf--_sscanf_l--swscanf--_swscanf_l.md) have security enhancements, as described in [Security Features in the CRT](../crt/security-features-in-the-crt.md).  
...
#### Parameters  
 ...
 `format`  
 Format-control string. For more information, see [Format Specification Fields: scanf and wscanf Functions](../crt/format-specification-fields--scanf-and-wscanf-functions.md).  
...
## Return Value  
 ...
 If `buffer` or `format` is a `NULL` pointer, the invalid parameter handler is invoked, as described in [Parameter Validation](../crt/parameter-validation.md). If execution is allowed to continue, these functions return -1 and set `errno` to `EINVAL`  
...
## Remarks  
 ...
 For more information, see [scanf_s, _scanf_s_l, wscanf_s, _wscanf_s_l](../crt/scanf_s--_scanf_s_l--wscanf_s--_wscanf_s_l.md) and [scanf Type Field Characters](../crt/scanf-type-field-characters.md).  
...
## See Also  
 ...
 [snprintf, _snprintf, _snprintf_l, _snwprintf, _snwprintf_l](../crt/snprintf--_snprintf--_snprintf_l--_snwprintf--_snwprintf_l.md)