...
---
# fread_s
Reads data from a stream. This version of [fread](../crt/fread.md) has security enhancements, as described in [Security Features in the CRT](../crt/security-features-in-the-crt.md).  
