...
## Remarks  
 ...
 You must use [/EHa](../buildref/-eh--exception-handling-model-.md) when using `_set_se_translator`.  
...
|`_set_se_translator`|\<eh.h>|  
 ...
 The functionality provided by `_set_se_translator` is not available in code compiled with the [/clr:pure](../buildref/-clr--common-language-runtime-compilation-.md) compiler option.  
