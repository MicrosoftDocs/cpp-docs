...
## Remarks  
 ...
 These functions lock the calling thread and are therefore thread-safe. For non-locking versions, see [_getch_nolock, _getwch_nolock](../crt/_getch_nolock--_getwch_nolock.md).  
...
## See Also  
 ...
 [_getche, _getwche](../crt/_getche--_getwche.md)   
