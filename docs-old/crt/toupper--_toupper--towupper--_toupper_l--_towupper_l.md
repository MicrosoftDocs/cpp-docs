...
## Return Value  
 ...
 In order for `toupper` to give the expected results, [__isascii](../crt/isascii--__isascii--iswascii.md) and [islower](../crt/islower--iswlower--_islower_l--_iswlower_l.md) must both return nonzero.  
...
## Remarks  
 ...
 In order for `toupper` to give the expected results, [__isascii](../crt/isascii--__isascii--iswascii.md) and [isupper](../crt/isupper--_isupper_l--iswupper--_iswupper_l.md) must both return nonzero.  
  
 [Data Conversion Routines](../crt/data-conversion.md)  
...
## Example  
 See the example in [to Functions](../crt/to-functions.md).  
