...
---
# _putenv, _wputenv
Creates, modifies, or removes environment variables. More secure versions of these functions are available; see [_putenv_s, _wputenv_s](../crt/_putenv_s--_wputenv_s.md).  
...
## Example  
 For a sample of how to use `_putenv`, see [getenv, _wgetenv](../crt/getenv--_wgetenv.md).  
