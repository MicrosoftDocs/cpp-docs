...
---
# bsearch_s
Performs a binary search of a sorted array. This is version of [bsearch](../crt/bsearch.md) with security enhancements as described in [Security Features in the CRT](../crt/security-features-in-the-crt.md).  
...
## Return Value  
 ...
 If invalid parameters are passed to the function, the invalid parameter handler is invoked as described in [Parameter Validation](../crt/parameter-validation.md). If execution is allowed to continue, `errno`is set to `EINVAL` and the function returns `NULL`. For more information, see [errno, _doserrno, _sys_errlist, and _sys_nerr](../crt/errno--_doserrno--_sys_errlist--and-_sys_nerr.md).  
...
## Example  
 This program sorts a string array with [qsort_s](../crt/qsort_s.md), and then uses bsearch_s to find the word "cat".  
...
## See Also  
 [Searching and Sorting](../crt/searching-and-sorting.md)   
