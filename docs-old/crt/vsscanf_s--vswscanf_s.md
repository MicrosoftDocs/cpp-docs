...
Reads formatted data from a string. These versions of [vsscanf, vswscanf](../crt/vsscanf--vswscanf.md) have security enhancements, as described in [Security Features in the CRT](../crt/security-features-in-the-crt.md).  
...
## See Also  
 ...
 [vsscanf, vswscanf](../crt/vsscanf--vswscanf.md)