...
> [!NOTE]
>  The `new` keyword has many uses and meanings. For more information, see the disambiguation topic [new](../notintoc/new.md).  
  
## All Runtimes  
 (There are no remarks for this language feature that apply to all runtimes.)  
  
## Windows Runtime  
 Not supported in [!INCLUDE[wrt](../atl/includes/wrt_md.md)].  
