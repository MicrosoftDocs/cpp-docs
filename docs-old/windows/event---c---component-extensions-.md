 ...
 *delegate*  
 The [delegate](../windows/delegate---c---component-extensions-.md), whose signature the event handler must match.  
 ...
 *event block*  
 ...
 `event` is a context-sensitive keyword; see [Context-Sensitive Keywords](../windows/context-sensitive-keywords---c---component-extensions-.md) for more information.  
...
4.  Use the event:  
 ...
 For more information on [!INCLUDE[cppcli](../buildref/includes/cppcli_md.md)] events, see  
  
-   [Events in an Interface](../cli/how-to--use-events-in-c---cli.md)  
  
-   [Overriding the Default Access of add, remove, and raise Methods](../notintoc/how-to--override-default-access-of-add--remove--and-raise-methods.md)  
  
-   [Multiple Handlers to an Event](../notintoc/how-to--add-multiple-handlers-to-events.md)  
  
-   [Managed Virtual Events](../notintoc/how-to--implement-managed-virtual-events.md)  
  
-   [Event Accessor Methods](../notintoc/how-to--define-event-accessor-methods.md)  
  
-   [Static Events](../notintoc/how-to--define-and-use-static-events.md)  
  
-   [Raising an Event Defined in a Different Assembly](../notintoc/how-to--raise-events-defined-in-a-different-assembly.md)  
  
-   [Abstract Events](../notintoc/how-to--implement-abstract-events.md)  
