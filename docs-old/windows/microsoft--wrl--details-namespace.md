...
|[ModuleBase Class](../windows/modulebase-class.md)|Represents the base class of the Module classes.|  
...
|[FactoryCache Structure](../windows/factorycache-structure.md)|Contains the location of a class factory and a value that identifies a registered [!INCLUDE[wrt](../atl/includes/wrt_md.md)] or COM class object.|  
...
|[Swap Function (Windows Runtime C++ Template Library)](../windows/swap-function--windows-runtime-c---template-library-.md)|Exchanges the values of the two specified arguments.|  
