 ...
 *modifier* (optional)  
 [abstract](../windows/abstract---c---component-extensions-.md) and [sealed](../windows/sealed---c---component-extensions-.md) are valid modifiers.  
 ...
 *base_type* (optional)  
 ...
 For more information, see the language-specific descriptions of this parameter in the [!INCLUDE[wrt](../atl/includes/wrt_md.md)] and [!INCLUDE[clr_for_headings](../cli/includes/clr_for_headings_md.md)] sections.  
 ...
 **Remarks**  
 ...
 When a reference type inherits from another reference type, virtual functions in the base class must explicitly be overridden (with [override](../windows/override---c---component-extensions-.md)) or hidden (with [new (new slot in vtable)](../windows/new--new-slot-in-vtable----c---component-extensions-.md)). The derived class functions must also be explicitly marked as `virtual`.  
  
 To detect at compile time whether a type is a `ref class` or `ref struct`, or a `value class` or `value struct`, use `__is_ref_class (``type``)`, `__is_value_class (``type``)`, or `__is_simple_value_class (``type``)`. For more information, see [Compiler Support for Type Traits](../windows/compiler-support-for-type-traits--c---component-extensions-.md).  
  
 For more information on classes and structs, see  
  
-   [Instantiating Classes and Structs](../cli/how-to--define-and-consume-classes-and-structs--c---cli-.md)  
  
-   [Semantics of the this Pointer in Value and Reference Types](../notintoc/semantics-of-the-this-pointer-in-value-and-reference-types.md)  
  
-   [C++ Stack Semantics for Reference Types](../cli/c---stack-semantics-for-reference-types.md)  
  
-   [Classes, Structures, and Unions](../cpp/classes-and-structs--c---.md)  
  
-   [public and private on Native Classes](../notintoc/how-to--declare-public-and-private-on-native-classes.md)  
  
-   [Implicitly Abstract Classes](../notintoc/implicitly-abstract-classes.md)  
  
-   [Define Static Constructors in a Class or Struct](../notintoc/how-to--define-static-constructors-in-a-class-or-struct.md)  
  
-   [Copy Constructor May Not Be Generated](../notintoc/copy-constructor-may-not-be-generated.md)  
  
-   [Hide-by-Signature Functions in Reference Types](../notintoc/hide-by-signature-functions-in-reference-types.md)  
  
-   [Destructors and Finalizers in Visual C++](../notintoc/destructors-and-finalizers-in-visual-c--.md)  
  
-   [Type and Member Visibility](../notintoc/type-and-member-visibility.md)  
  
-   [User-Defined Operators (C++/CLI)](../cli/user-defined-operators--c---cli-.md)  
  
-   [User-Defined Conversions (C++/CLI)](../cli/user-defined-conversions--c---cli-.md)  
