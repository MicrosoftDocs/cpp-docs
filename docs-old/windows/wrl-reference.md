...
## In This Section  
 ...
 Enables fundamental [!INCLUDE[wrt](../atl/includes/wrt_md.md)] functionality, such as object and factory creation.  
  
## Related Sections  
 [Windows Runtime C++ Template Library (WRL)](../windows/windows-runtime-c---template-library--wrl-.md)  
 Introduces [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)], a COM-based template library that provides a low-level way to author and use [!INCLUDE[wrt](../atl/includes/wrt_md.md)] components.