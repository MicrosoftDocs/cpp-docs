...
-   [How to: Use Tracking References and Value Types](../notintoc/how-to--use-tracking-references-and-value-types.md)  
  
-   [How to: Use Tracking References and Interior Pointers](../notintoc/how-to--use-tracking-references-and-interior-pointers.md)  
  
-   [How to: Write Template Functions that Take Native, Value, or Reference Parameters](../notintoc/how-to--write-template-functions-that-take-native--value--or-reference-parameters.md)  
