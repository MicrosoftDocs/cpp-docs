...
Declares an interface.  For information on native interfaces, see [__interface](../cpp/__interface.md).  
...
-   [Interface Static Constructor](../cli/how-to--define-an-interface-static-constructor--c---cli-.md)  
  
-   [Generic Interfaces (Visual C++)](../windows/generic-interfaces--visual-c---.md)  
  
 For information on other CLR types, see [Classes and Structs](../windows/classes-and-structs---c---component-extensions-.md).  
  
 You can detect at compile time if a type is an interface with `__is_interface_class(``type``)`. For more information, see [Compiler Support for Type Traits](../windows/compiler-support-for-type-traits--c---component-extensions-.md).  
