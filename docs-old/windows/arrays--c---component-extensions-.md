...
The `Platform::Array<T>` type in [!INCLUDE[cppwrt_short](../buildref/includes/cppwrt_short_md.md)], or the `array` keyword in [!INCLUDE[cppcli](../buildref/includes/cppcli_md.md)], declares an array of a specified type and initial value.  
...
-   [Array Covariance](../notintoc/array-covariance.md)  
  
-   [How to: Use Arrays in C++/CLI](../cli/how-to--use-arrays-in-c---cli.md)  
  
-   [How to: Create Multidimension Arrays](../notintoc/how-to--create-multidimension-arrays.md)  
  
-   [How to: Create Arrays of Managed Arrays (Jagged Arrays)](../notintoc/how-to--create-arrays-of-managed-arrays--jagged-arrays-.md)  
  
-   [How to: Make Typedefs for Managed Arrays](../notintoc/how-to--make-typedefs-for-managed-arrays.md)  
  
-   [How to: Use Managed Arrays as Template Type Parameters](../notintoc/how-to--use-managed-arrays-as-template-type-parameters.md)  
  
-   [Variable Argument Lists (...) (C++/CLI)](../windows/variable-argument-lists--...---c---cli-.md)  
  
-   [How to: Sort Arrays](../notintoc/how-to--sort-arrays.md)  
  
-   [How to: Sort Arrays Using Custom Criteria](../notintoc/how-to--sort-arrays-using-custom-criteria.md)  
 ...
 *qualifiers* [optional]  
 One or more of these storage class specifiers: [mutable](../cpp/mutable-data-members--c---.md), [volatile](../cpp/volatile--c---.md), [const](../cpp/const--c---.md), [extern](../cpp/using-extern-to-specify-linkage.md), [static](../notintoc/static--c---.md).  
  
 `array-type`  
 The type of the array variable. Valid types are [!INCLUDE[wrt](../atl/includes/wrt_md.md)] classes and fundamental types, ref classes and structs, value classes and structs, and native pointers (`type``*`).  
 ...
 **Remarks**  
 ...
 You can detect at compile time whether a type is a reference-counted array with `__is_ref_array(``type``)`. For more information, see [Compiler Support for Type Traits](../windows/compiler-support-for-type-traits--c---component-extensions-.md).  
 ...
 *qualifiers* [optional]  
 ...
 `array-type`  
 The type of the array variable. Valid types are [!INCLUDE[wrt](../atl/includes/wrt_md.md)] classes and fundamental types, ref classes and structs, value classes and structs, native pointers (`type``*`), and native POD (plain old data) types.  
 ...
 `rank-size-list`  
 A comma-delimited list of the size of each dimension in the array. Alternatively, if the `initialization-list` parameter is specified, the compiler can deduce the size of each dimension and `rank-size-list` can be omitted. For more information, see [How to: Create Multidimension Arrays](../notintoc/how-to--create-multidimension-arrays.md).  
 ...
 **Remarks**  
 ...
 `array` is in the [Platform, default, and cli Namespaces](../windows/platform--default--and-cli-namespaces---c---component-extensions-.md) namespace.  
 ...
 When you allocate an array whose element type is a value type `V`, the default constructor for `V` is applied to each array element. For more information, see [.NET Framework Equivalents to C++ Native Types (C++/CLI)](../cli/.net-framework-equivalents-to-c---native-types--c---cli-.md).  
  
 At compile time, you can detect whether a type is a common language runtime (CLR) array with`__is_ref_array(``type``)`. For more information, see [Compiler Support for Type Traits](../windows/compiler-support-for-type-traits--c---component-extensions-.md).  
