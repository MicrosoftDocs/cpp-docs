 ...
 **Remarks**  
 ...
 For information about modifying the behavior of inherited types and inherited type members, see [Override Specifiers](../windows/override-specifiers---c---component-extensions-.md).  
 ...
 **Remarks**  
 ...
 For information about explicit overrides in native code or code compiled with **/clr:oldSyntax**, see [Explicit Overrides](../cpp/explicit-overrides--c---.md).  
