...
## Remarks  
 `db_source` creates a [CDataSource](../data/cdatasource-class.md) and a [CSession](../data/csession-class.md) object, which together represent a connection with an OLE DB consumer data source.  
