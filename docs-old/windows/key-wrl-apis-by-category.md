...
|[Event Class (Windows Runtime C++ Template Library)](../windows/event-class--windows-runtime-c---template-library-.md)|Represents an event.|  
...
|[RoInitializeWrapper Class](../windows/roinitializewrapper-class.md)|Initializes the [!INCLUDE[wrt](../atl/includes/wrt_md.md)].|  
...
|[Callback Function](../windows/callback-function--windows-runtime-c---template-library-.md)|Creates an object whose member function is a callback method.|  
...
|[Make Function](../windows/make-function.md)|Initializes the specified [!INCLUDE[wrt](../atl/includes/wrt_md.md)] class.|  
