...
### Remarks  
 ...
 For information on how to declare an interior pointer that points into an object that cannot be moved on the garbage-collected heap, see [pin_ptr](../windows/pin_ptr--c---cli-.md).  
  
 `interior_ptr` is in the cli namespace.  See [Platform, default, and cli Namespaces](../windows/platform--default--and-cli-namespaces---c---component-extensions-.md) for more information.  
