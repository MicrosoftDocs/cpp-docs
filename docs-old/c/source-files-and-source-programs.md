 ...
 *declaration*  
 ...
 [Overview of Declarations](../c/overview-of-declarations.md) gives the syntax for the `declaration` nonterminal, and the *Preprocessor Reference* explains how the [translation unit](../c/phases-of-translation.md) is processed.  
  
> [!NOTE]
>  See the introduction to [C Language Syntax Summary](../c/c-language-syntax-summary.md), for an explanation of the ANSI syntax conventions.  
