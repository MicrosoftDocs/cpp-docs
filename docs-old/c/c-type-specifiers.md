 ...
 **END Microsoft Specific**  
 ...
 You can create additional type specifiers with `typedef` declarations, as described in [Typedef Declarations](../c/typedef-declarations.md). See [Storage of Basic Types](../c/storage-of-basic-types.md) for information on the size of each type.  
