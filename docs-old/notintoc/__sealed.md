...
# __sealed
> [!NOTE]
>  This topic applies only to version 1 of Managed Extensions for C++. This syntax should only be used to maintain version 1 code. See [sealed](../windows/sealed---c---component-extensions-.md) for information on using the equivalent functionality in the new syntax.  
...
-   The **__sealed** keyword is not allowed when used with the [__interface](../cpp/__interface.md) keyword.  
