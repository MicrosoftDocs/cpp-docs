...
3.  Create a new add-in project named `Addin`.  
     ...
     In the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] Add-In wizard, click **Next**.  
...
1.  Open the file Connect.cs or Connect.vb and add these lines to the `using` (C#) or `Imports` (Visual Basic) statements:  
     ...
     [!code[VSSDKAddin#1](../notintoc/codesnippet/CSharp/walkthrough--calling-into-the-visual-studio-sdk-by-using-automation_1.cs)]
[!code[VSSDKAddin#1](../notintoc/codesnippet/VisualBasic/walkthrough--calling-into-the-visual-studio-sdk-by-using-automation_1.vb)]  
...
3.  Add these lines of code to the `if(commandName == "Addin.Connect.Addin")` or `If commandName = "Addin.Connect.Addin" Then` clause of the `Exec` method:  
     ...
     [!code[VSSDKAddin#2](../notintoc/codesnippet/CSharp/walkthrough--calling-into-the-visual-studio-sdk-by-using-automation_2.cs)]
[!code[VSSDKAddin#2](../notintoc/codesnippet/VisualBasic/walkthrough--calling-into-the-visual-studio-sdk-by-using-automation_2.vb)]  
...
4.  Build and start the Addin project in debug mode by pressing F5.  
     ...
     This starts another instance of [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)].  
  
5.  In the new [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] instance, on the **Tools** menu, click **Addin**. The message box displays this:  
