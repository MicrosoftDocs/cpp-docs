...
## In This Section  
 [Installing VSPackages](../notintoc/installing-vspackages.md)  
...
## Related Sections  
 ...
 Describes how to use the [!INCLUDE[esprtest](../notintoc/includes/esprtest_md.md)] suite to create, manage, edit, and run tests, and also obtain and store test results.