...
# __abstract
> [!NOTE]
>  This topic applies only to version 1 of Managed Extensions for C++. This syntax should only be used to maintain version 1 code. See [abstract](../windows/abstract---c---component-extensions-.md) for information on using the equivalent functionality in the new syntax.  
...
## Remarks  
 ...
 Differing from the C++ notion of an [abstract](../cpp/abstract-classes--c---.md) base class, a class with the `__abstract` keyword can define its member functions.  
