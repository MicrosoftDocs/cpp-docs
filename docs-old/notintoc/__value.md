...
# __value
> [!NOTE]
>  This topic applies only to version 1 of Managed Extensions for C++. This syntax should only be used to maintain version 1 code. See [Classes and Structs](../windows/classes-and-structs---c---component-extensions-.md) for information on using the equivalent functionality in the new syntax.  
...
-   A `__value` type is sealed by definition. For more information, see [__sealed](../notintoc/__sealed.md).  
