...
---
# unchecked_uninitialized_copy
Same as [uninitialized_copy](../Topic/uninitialized_copy.md) but allows the use of an unchecked iterator as output iterator when _SECURE_SCL=1 is defined. This function is defined in the [stdext Namespace](../stdcpplib/stdext-namespace.md) namespace.  
...
## Remarks  
 ...
 For more information on checked iterators, see [Checked Iterators](../stdcpplib/checked-iterators.md).  
