...
The Progress Bar region of the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] status bar displays the incremental progress of quick operations, for example, saving a file to disk.  
...
## Example  
 ...
 [!code[VSSDKProgressStatusBar#1](../notintoc/codesnippet/CSharp/how-to--program-the-progress-bar-region-of-the-status-bar_1.cs)]
[!code[VSSDKProgressStatusBar#1](../notintoc/codesnippet/VisualBasic/how-to--program-the-progress-bar-region-of-the-status-bar_1.vb)]  
