...
The [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] **Toolbox** provides a collection of objects that provide functionality to editors and designers through the IDE's drag-and-drop mechanism.  
  
 There are two basic ways in which a VSPackage works with the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] **Toolbox**:  
...
## In This Section  
 [How to: Create a Toolbox Control That Uses Windows Forms](../notintoc/how-to--create-a-toolbox-control-that-uses-windows-forms.md)  
...
## Related Sections  
 ...
 Describes how to work with the **Toolbox** in the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] integrated development environment (IDE).  
 ...
 Explains how to use [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] services to create UI elements that match the rest of [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)].