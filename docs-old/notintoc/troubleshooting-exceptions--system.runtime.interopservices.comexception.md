 ...
 **Disable the hosting process.**  
 COM is used to communicate between [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] and the hosting process. Because it is used before code runs, a call to `CoInitializeSecurity` causes this exception to be thrown.  
