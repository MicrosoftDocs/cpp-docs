...
The [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] **Task List** lets users add custom programming tasks, view task comments that link to lines in the code, and create and view custom categories for task messages.  
...
## See Also  
 [Creating Custom Task List Views](../notintoc/creating-custom-task-list-views.md)   
 [How to: Create Custom Categories of Task Lists](../notintoc/how-to--create-custom-categories-of-task-lists.md)