...
You can add references to your project by using the Reference Manager in a Visual Studio extension. Before the Reference Manager appears, your projects must configure it to show data from the correct locations. For example, a project that targets the [!INCLUDE[net_v40_short](../notintoc/includes/net_v40_short_md.md)] must populate assemblies from a different folder than a project that targets the [!INCLUDE[net_v35_long](../notintoc/includes/net_v35_long_md.md)].  
...
-   \<xref:Microsoft.VisualStudio.Shell.Interop.IVsPlatformReferenceProviderContext>  
 ...
 ![Configuring the Reference Manager](../notintoc/media/refmgrextend.png "RefMgrExtend")  
  
 ![Configuring the Reference Manager](../notintoc/media/refmgrextend2.png "RefMgrExtend2")  
