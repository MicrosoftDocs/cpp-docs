...
'\<lsetstmt>' is not declared. LSet statements are no longer supported; use Microsoft.VisualBasic.LSet instead.  
 ...
 Several functions that were intrinsic to [!INCLUDE[vbprvb](../cli/includes/vbprvb_md.md)] in previous versions have been moved to the \<xref:Microsoft.VisualBasic?displayProperty=fullName> namespace. This makes their functionality more generally available to all programming languages.  
