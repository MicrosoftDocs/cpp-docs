...
3.  If the parameter **PREPROCESS_FUNCTION** is in [the .vsz file](../ide/.vsz-file--project-control-.md), the wizard calls [CanAddATLClass](../ide/jscript-functions-for-c---wizards.md). Use [SetErrorInfo](../ide/seterrorinfo.md) in case of failure and return **false**:  
