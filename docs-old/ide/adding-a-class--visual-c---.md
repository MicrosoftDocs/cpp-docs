...
-   For more information about how to create MFC classes, see [MFC Class](../mfcref/adding-an-mfc-class.md).  
  
-   For more information about how to create ATL classes, see [ATL Simple Object](../atl/adding-an-atl-simple-object.md).  
  
> [!NOTE]
>  The template **Add ATL Support to MFC** does not create a class, but instead configures the project to use ATL. For more information, see [ATL Support in an MFC Project](../mfcref/adding-atl-support-to-your-mfc-project.md).  
  
 To make a C++ class that does not use MFC, ATL, or CLR, use the **C++ Class** template in the **C++** group of installed templates. For more information, see [Adding a Generic C++ Class](../ide/adding-a-generic-c---class.md).  
  
 Two kinds of form-based C++ classes are available. The first one, [CFormView Class](../mfcref/cformview-class.md) creates an MFC class. The second one creates a CLR Windows Forms class.  
