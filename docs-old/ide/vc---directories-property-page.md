 ...
 **Reference Directories**  
 Directories in which to search for assembly and module (metadata) files that are referenced in the source code by the [#using](../c/sharpusing-directive--c---.md) directive. Corresponds to the **LIBPATH** environment variable.  
