...
-   Open a corresponding code wizard, if one is available. For more information, see [Adding Functionality with Code Wizards](../ide/adding-functionality-with-code-wizards--c---.md).  
...
|ATL Active Server Page Component|[ATL Active Server Page Component Wizard](../atl/atl-active-server-page-component-wizard.md)|  
|ATL Control|[ATL Control Wizard](../atl/atl-control-wizard.md)|  
|ATL Dialog|[ATL Dialog Wizard](../atl/atl-dialog-wizard.md)|  
|ATL COM+ 1.0 Component|[ATL COM+ 1.0 Component Wizard](../atl/atl-com--1.0-component-wizard.md)|  
|ATL OLEDB Consumer|[ATL OLE DB Consumer Wizard](../atl/atl-ole-db-consumer-wizard.md)|  
|ATL OLEDB Provider|[ATL OLE DB Provider Wizard](../atl/atl-ole-db-provider-wizard.md)|  
|ATL Property Page|[ATL Property Page Wizard](../atl/atl-property-page-wizard.md)|  
|ATL Simple Object|[ATL Simple Object Wizard](../atl/atl-simple-object-wizard.md)|  
...
|Template|Wizard|  
|--------------|------------|  
|MFC Class|[MFC Add Class Wizard](../mfcref/mfc-add-class-wizard.md)|  
|MFC Class From ActiveX Control|[Add Class From ActiveX Control Wizard](../ide/add-class-from-activex-control-wizard.md)|  
|MFC Class From TypeLib|[Add Class From Typelib Wizard](../mfcref/add-class-from-typelib-wizard.md)|  
|MFC ODBC Consumer|[MFC ODBC Consumer Wizard](../mfcref/mfc-odbc-consumer-wizard.md)|  
  
### Generic Classes  
  
|Template|Wizard|  
|--------------|------------|  
|Generic C++ Class|[Generic C++ Class Wizard](../ide/generic-c---class-wizard.md)|  
