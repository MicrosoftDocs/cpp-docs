...
6.  Click in the newly created tab in Visual Studio and type a valid Visual C++ program, or copy and paste one of the sample programs.  
     ...
     For example, you can use the [How to: Write a Text File (C++/CLI)](../cli/how-to--write-a-text-file--c---cli-.md) sample program (in the **File Handling and I/O** node of the Programming Guide).  
...
## What's Next  
 **Previous:** [Walkthrough: Compiling a Native C++ Program on the Command Line](../build/walkthrough--compiling-a-native-c---program-on-the-command-line.md) &#124; **Next:**[Walkthrough: Compiling a C Program on the Command Line](../build/walkthrough--compiling-a-c-program-on-the-command-line.md)  
