...
## Using the Command Prompt shortcuts  
 ...
 Use this toolset to create output files for [!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]. It runs as a 32-bit process, native on an x86 machine and under WOW64 on a 64-bit Windows operating system.  
 ...
 Use this toolset to create output files for [!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)] machines. It runs as a native process on a 64-bit Windows operating system.  
...
2.  Open the **Developer Command Prompt** shortcut for your version of [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)]. If you have installed the Visual C++ Build Tools edition, use the **x86 Native Tools Command Prompt**. Optionally, to run as administrator, right-click to open the shortcut menu for the Developer Command Prompt and choose **More**, **Run as Administrator**.  
...
|----------------------------|--------------|----------------------------------|-------------------------------|  
|x86|x86 32-bit native|x86, [!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|x86|  
|x86_amd64|[!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)] on x86 cross|x86, [!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|[!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|  
|x86_arm|ARM on x86 cross|x86, [!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|ARM|  
|amd64|[!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)] 64-bit native|[!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|[!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|  
|amd64_x86|x86 on [!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)] cross|[!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|x86|  
|amd64_arm|ARM on [!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)] cross|[!INCLUDE[vcprx64](../build/includes/vcprx64_md.md)]|ARM|  
...
2.  To configure this Command Prompt window for 32-bit x86 command-line builds, at the command prompt, enter:  
 ...
 [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] also provides vcvars32.bat to set up a command-line environment. The vcvars32.bat file is found in the bin directory under the VC installation directory. It's limited to setting the appropriate environment variables to enable 32-bit x86 command-line builds. It's the equivalent of the `vcvarsall x86` command.  
...
> [!CAUTION]
>  The vcvarsall.bat file can vary from computer to computer. Do not replace a missing or damaged vcvarsall.bat file by using a file from another computer. Rerun [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] Setup to replace the missing file.  
>   
