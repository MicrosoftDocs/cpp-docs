...
|Term|Definition|  
|----------|----------------|  
|[MSBuild (Visual C++) Overview](../build/msbuild--visual-c----overview.md)|Describes how Visual C++ uses the **MSBuild** system.|  
...
|[Walkthrough: Using MSBuild to Create a Visual C++ Project](../build/walkthrough--using-msbuild-to-create-a-visual-c---project.md)|Demonstrates how to create a Visual C++ project using **MSBuild**.|  
