...
## Visual C++ Security Features  
 ...
 [/GS (Buffer Security Check)](../buildref/-gs--buffer-security-check-.md)  
 ...
 [/SAFESEH (Image has Safe Exception Handlers)](../buildref/-safeseh--image-has-safe-exception-handlers-.md)  
 ...
 [/NXCOMPAT](../buildref/-nxcompat.md), [/NXCOMPAT (Compatible with Data Execution Prevention)](../buildref/-nxcompat--compatible-with-data-execution-prevention-.md)  
 ...
 [/analyze (Code Analysis)](../buildref/-analyze--code-analysis-.md)  
 ...
 [/DYNAMICBASE (Use address space layout randomization)](../buildref/-dynamicbase--use-address-space-layout-randomization-.md)  
...
## Windows User Accounts  
 Using Windows user accounts that belong to the Administrators group exposes developers and--by extension--customers to security risks. For more information, see [Running as a Member of the Users Group](../top/running-as-a-member-of-the-users-group.md) and [How User Account Control (UAC) Affects Your Application](../top/how-user-account-control--uac--affects-your-application.md).  
