...
### Breaking Changes  
 This improved support for ISO C/C++ standards may require changes to existing code so that it conforms to C++11 and C99, and compiles correctly in Visual Studio 2015.  For more information, see [Visual C++ change history 2003 - 2015](../porting/visual-c---change-history-2003---20151.md).  
