...
Forces transfer of control to the controlling expression of the smallest enclosing [do](../cpp/do-while-statement--c---.md), [for](../cpp/for-statement--c---.md), or [while](../cpp/while-statement--c---.md) loop.  
