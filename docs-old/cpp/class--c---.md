...
#### Parameters  
 ...
 `base-list`  
 Optional list of classes or structures this class will derive its members from. See [Base Classes](../cpp/base-classes.md) for more information. Each base class or structure name can be preceded by an access specifier ([public](../cpp/public--c---.md), [private](../cpp/private--c---.md), [protected](../cpp/protected--c---.md)) and the [virtual](../cpp/virtual--c---.md) keyword. See the member-access table in [Controlling Access to Class Members](../notintoc/controlling-access-to-class-members.md) for more information.  
