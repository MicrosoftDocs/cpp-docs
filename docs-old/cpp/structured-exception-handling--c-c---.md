 ...
 **Throwing C++ exception**  
**Destroying TestClass!**  
**Executing SEH __except block** For more information, see [/EH (Exception Handling Model)](../buildref/-eh--exception-handling-model-.md).  
