...
-   The identifier.  
 ...
 The more complex declarator forms for pointers to arrays and functions also apply to references to arrays and functions, see [pointers](../cpp/pointers--c---.md) and [declarators](assetId:///8a7b9b51-92bd-4ac0-b3fe-0c4abe771838).  
...
## See Also  
 [Initializing References](../notintoc/initializing-references.md)