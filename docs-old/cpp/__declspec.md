 ...
 *extended-decl-modifier*:  
 ...
 Extended attribute grammar supports these Microsoft-specific storage-class attributes: [align](../cpp/align--c---.md), [allocate](../cpp/allocate.md), [appdomain](../cpp/appdomain.md), [code_seg](../cpp/code_seg--__declspec-.md), [deprecated](../cpp/deprecated--c---.md), [dllexport](../cpp/dllexport--dllimport.md), [dllimport](../cpp/dllexport--dllimport.md), [jitintrinsic](../cpp/jitintrinsic.md), [naked](../cpp/naked--c---.md), [noalias](../cpp/noalias.md), [noinline](../cpp/noinline.md), [noreturn](../cpp/noreturn.md), [nothrow](../cpp/nothrow--c---.md), [novtable](../cpp/novtable.md), [process](../cpp/process.md), [restrict](../cpp/restrict.md), [safebuffers](../cpp/safebuffers.md), [selectany](../cpp/selectany.md), and [thread](../cpp/thread.md). It also supports these COM-object attributes: [property](../cpp/property--c---.md) and [uuid](../cpp/uuid--c---.md).  
...
## See Also  
 ...
 [C Extended Storage-Class Attributes](../c/c-extended-storage-class-attributes.md)