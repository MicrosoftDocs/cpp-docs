...
```  
 ...
 The address of an overloaded function can be taken only when it is clear which version of the function is being referenced. See [Address of Overloaded Functions](../notintoc/address-of-overloaded-functions.md) for information about how to obtain the address of a particular overloaded function.  
...
## See Also  
 ...
 [Indirection and Address-of Operators](../c/indirection-and-address-of-operators.md)