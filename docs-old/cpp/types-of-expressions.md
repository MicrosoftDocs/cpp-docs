...
-   [Expressions with the conditional operator](../cpp/conditional-operator-----.md). The conditional operator is a ternary operator — the only such operator in the C++ language — and takes three operands.  
  
-   [Constant expressions](../cpp/c---constant-expressions.md). Constant expressions are formed entirely of constant data.  
...
-   [Expressions with pointer-to-member operators](../cpp/pointer-to-member-operators--.--and----.md).  
