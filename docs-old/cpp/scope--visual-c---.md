...
---
# Scope (Visual C++)
C++ names can be used only in certain regions of a program. This area is called the "scope" of the name. Scope determines the "lifetime" of a name that does not denote an object of static extent. Scope also determines the visibility of a name, when class constructors and destructors are called, and when variables local to the scope are initialized. (For more information, see [Constructors](../cpp/constructors--c---.md) and [Destructors](../cpp/destructors--c---.md).) There are five kinds of scope:  
...
>  The reuse of identifier names as shown in this example is considered poor programming style.  
 ...
 For more information about pointers, see [Derived Types](assetId:///aa14183c-02fe-4d81-95fe-beddb0c01c7c). For information about declaration and initialization of class objects, see [Classes, Structures, and Unions](../cpp/classes-and-structs--c---.md). For information about using the **new** and **delete** free-store operators, see [Special Member Functions](../notintoc/special-member-functions--c---.md).  
...
## See Also  
 [Basic Concepts](../cpp/basic-concepts---c---.md)