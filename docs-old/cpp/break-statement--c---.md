...
## Remarks  
 The `break` statement is used with the conditional [switch](../cpp/switch-statement--c---.md) statement and with the [do](../cpp/do-while-statement--c---.md), [for](../cpp/for-statement--c---.md), and [while](../cpp/while-statement--c---.md) loop statements.  
...
## See Also  
 [Jump Statements](../cpp/jump-statements--c---.md)   
 [Keywords](../cpp/keywords--c---.md)   
 [continue Statement](../cpp/continue-statement--c---.md)