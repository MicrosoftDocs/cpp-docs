...
-   #### To use a listing to view decorated names  
    ...
    1.  Generate a listing by compiling the source file that contains the data, object, or function definition or prototype with the [Listing File Type](../buildref/-fa---fa--listing-file-.md) compiler option set to Assembly with Source Code (**/FAs**).  
