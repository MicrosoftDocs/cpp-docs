...
## In This Section  
 [Value Edit Control](../buildref/value-edit-control.md)  
 Describes the Value Edit control in ERRLOOK.  
  
 [Error Message Edit Control](../buildref/error-message-edit-control.md)  
 Describes the Error Message Edit control in ERRLOOK.  
  
 [Modules Button](../buildref/modules-button.md)  
 Describes the Modules button in ERRLOOK.  
  
 [Look Up Button](../buildref/look-up-button.md)  
