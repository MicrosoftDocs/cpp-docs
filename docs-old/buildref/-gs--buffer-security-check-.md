...
-   A buffer allocated by using the [_alloca](../crt/_alloca.md) function.  
...
-   Optimizations ([/O options](../buildref/-o-options--optimize-code-.md)) are not enabled.  
  
-   Functions that have a variable argument list (...).  
  
-   Functions that are marked with [naked](../cpp/naked--c---.md).  
