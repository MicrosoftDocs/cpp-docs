...
-   If a string argument matches a [reserved word](../buildref/reserved-words.md), it must be enclosed in double quotation marks (").  
  
## See Also  
 [Module-Definition (.Def) Files](../buildref/module-definition--.def--files.md)   
