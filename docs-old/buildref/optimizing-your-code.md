...
## Language Features  
 ...
 [Optimization Pragmas and Keywords](../buildref/optimization-pragmas-and-keywords.md)  
...
### The optimize Pragma  
 If an optimized section of code causes errors or a slowdown, you can use the [optimize](../c/optimize.md) pragma to turn off optimization for that section.  
...
## Programming Practices  
 ...
 [Tips for Improving Time-Critical Code](../buildref/tips-for-improving-time-critical-code.md)  
 ...
 [Optimization Best Practices](../buildref/optimization-best-practices.md)  
...
-   [Why Floating-Point Numbers May Lose Precision](../buildref/why-floating-point-numbers-may-lose-precision.md)  
  
 The following assortment of topics provide information about how to optimize building, loading, and executing your code.  
  
-   [Improving Compiler Throughput](../buildref/improving-compiler-throughput.md)  
  
-   [Using Function Name Without () Produces No Code](../buildref/using-function-name-without----produces-no-code.md)  
  
-   [Optimizing Inline Assembly](../intrinsics/optimizing-inline-assembly.md)  
  
-   [Specifying Compiler Optimization for an ATL Project](../atl/specifying-compiler-optimization-for-an-atl-project.md)  
...
-   [!INCLUDE[crabout](../buildref/includes/crabout_md.md)] how to reduce the time to load DLL methods, see "Optimizing DLL Load Time Performance" in the "Under the Hood" column in the "MSDN Magazine" on the [MSDN Library](http://go.microsoft.com/fwlink/?linkid=556) Web site.  
  
-   [!INCLUDE[crabout](../buildref/includes/crabout_md.md)] how to minimize paging in applications, see "Improving Runtime Performance with the Smooth Working Set Tool" and "Improving Runtime Performance with the Smooth Working Set Tool—Part 2" in the "Bugslayer" column in the "MSDN Magazine" on the [MSDN Library](http://go.microsoft.com/fwlink/?linkid=556) Web site.  
