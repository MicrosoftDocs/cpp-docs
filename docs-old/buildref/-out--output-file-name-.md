...
## Remarks  
 ...
 This option the default base name for a .mapfile or import library. For details, see [Generate Mapfile](../buildref/-map--generate-mapfile-.md) (/MAP) and [/IMPLIB](../buildref/-implib--name-import-library-.md).  
