...
## Remarks  
 ...
 The MIDL compiler is called by the Visual C++ linker when linking projects that have the [module](../windows/module--c---.md) attribute.  
 ...
 *filename* is the parameter that you pass to /IDLOUT. If [/TLBOUT](../buildref/-tlbout--name-.tlb-file-.md) is specified, the .tlb file will get its name from /TLBOUT *filename*.  
...
-   See \<xref:Microsoft.VisualStudio.VCProjectEngine.VCLinkerTool.MergedIDLBaseFileName*>.  
