...
> [!NOTE]
>  The Standard C++ Library in [!INCLUDE[cpp_dev12_long](../buildref/includes/cpp_dev12_long_md.md)] does not support the **/Zc:strictStrings** compiler option in debug builds. If you see several [C2665](../compilererrors2/compiler-error-c2665.md) errors in your build output, this may be the cause.  
