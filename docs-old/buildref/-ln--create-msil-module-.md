...
## Remarks  
 ...
 When **/LN** is used, one of the [/clr (Common Language Runtime Compilation)](../buildref/-clr--common-language-runtime-compilation-.md) options must also be used.  
  
 A managed program that does not have an assembly metadata in the manifest is called a module. If you compile with [/c (Compile Without Linking)](../buildref/-c--compile-without-linking-.md) and **/LN**, specify [/NOASSEMBLY (Create a MSIL Module)](../buildref/-noassembly--create-a-msil-module-.md) in the linker phase to create the output file.  
...
-   Specify [/NOASSEMBLY (Create a MSIL Module)](../buildref/-noassembly--create-a-msil-module-.md) in the linker phase to create the output file.  
