...
## Remarks  
 The /VERSION option tells the linker to put a version number in the header of the .exe or .dll file. Use DUMPBIN [/HEADERS](../buildref/-headers.md) to see the image version field of the OPTIONAL HEADER VALUES to see the effect of /VERSION.  
 ...
 Another way to insert a version number is with the [VERSION](../buildref/version--c-c---.md) module-definition statement.  
