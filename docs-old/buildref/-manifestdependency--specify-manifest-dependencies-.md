...
## Remarks  
 ...
 See [/MANIFEST (Create Side-by-Side Assembly Manifest)](../buildref/-manifest--create-side-by-side-assembly-manifest-.md) for information on how to create a manifest file.  
...
-   Via the [comment](../c/comment--c-c---.md) pragma.  
...
1.  See \<xref:Microsoft.VisualStudio.VCProjectEngine.VCLinkerTool.AdditionalManifestDependencies*>.  
