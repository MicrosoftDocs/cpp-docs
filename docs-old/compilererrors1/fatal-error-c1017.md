...
```  
 ...
 To see exactly how the compiler handles preprocessor directives, use [/P](../buildref/-p--preprocess-to-a-file-.md), [/E](../buildref/-e--preprocess-to-stdout-.md), or [/EP](../buildref/-ep--preprocess-to-stdout-without-sharpline-directives-.md).