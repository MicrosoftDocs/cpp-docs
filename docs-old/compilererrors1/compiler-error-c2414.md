...
2.  A newer processor supports the instruction with a different number of operands. Adjust the [/arch (Minimum CPU Architecture)](../buildref/-arch--minimum-cpu-architecture-.md) option to use the later processor.