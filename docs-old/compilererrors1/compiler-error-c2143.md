...
syntax error : missing 'token1' before 'token2'  
 ...
 Check the [C++ Language Reference](../cpp/c---language-reference.md) to determine where code is syntactically incorrect. Because the compiler may report this error after it encounters the line that causes the problem, check several lines of code that precede the error.  
