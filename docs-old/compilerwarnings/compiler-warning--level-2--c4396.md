...
"name" : the inline specifier cannot be used when a friend declaration refers to a specialization of a function template  
 ...
 A specialization of a function template cannot specify any of the [inline](../notintoc/inline--__inline--__forceinline.md) specifiers. The compiler issues warning C4396 and ignores the inline specifier.  
