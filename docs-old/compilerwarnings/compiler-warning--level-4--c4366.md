...
The result of the unary 'operator' operator may be unaligned  
 ...
 To resolve C4366, either change the alignment of the structure or declare the pointer with the [__unaligned](../cpp/__unaligned.md) keyword.  
  
 For more information, see __unaligned and [pack](../c/pack.md).  
