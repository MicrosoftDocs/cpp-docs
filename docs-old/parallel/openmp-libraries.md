...
|VCOMPD.LIB|Multithreaded, dynamic link (import library for VCOMPD.LID) (debug)|  
 ...
 You can use [/NODEFAULTLIB (Ignore Libraries)](../buildref/-nodefaultlib--ignore-libraries-.md) to remove the default lib and explicitly link with the lib of your choice.  
