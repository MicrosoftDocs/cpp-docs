...
-   `omp_get_dynamic` function, see [Section 3.1.8](../parallel/3.1.8-omp_get_dynamic-function.md) on page 40.  
  
-   `OMP_NUM_THREADS` environment variable, see [Section 4.2](../parallel/4.2-omp_num_threads.md) on page 48, and Section 2.3 on page 8.  
