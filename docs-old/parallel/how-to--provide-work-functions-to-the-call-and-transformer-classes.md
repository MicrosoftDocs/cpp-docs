...
This topic illustrates several ways to provide work functions to the [concurrency::call](../parallel/call-class.md) and [concurrency::transformer](../parallel/transformer-class.md) classes.  
 ...
 For illustration, every example in this topic uses the `call` class. For an example that uses the `transformer` class, see [How to: Use transformer in a Data Pipeline](../parallel/how-to--use-transformer-in-a-data-pipeline.md).  
...
## Example  
 ...
 [!code[concrt-call-lambda#1](../parallel/codesnippet/CPP/how-to--provide-work-functions-to-the-call-and-transformer-classes_1.cpp)]  
...
## Example  
 ...
 [!code[concrt-call-functor#1](../parallel/codesnippet/CPP/how-to--provide-work-functions-to-the-call-and-transformer-classes_2.cpp)]  
...
## Example  
 ...
 [!code[concrt-call-method#1](../parallel/codesnippet/CPP/how-to--provide-work-functions-to-the-call-and-transformer-classes_3.cpp)]  
  
 You can also assign the result of the `bind1st` function to a [std::function](../stdcpplib/function-class.md) object or use the `auto` keyword, as shown in the following example.  
  
 [!code[concrt-call-method#2](../parallel/codesnippet/CPP/how-to--provide-work-functions-to-the-call-and-transformer-classes_4.cpp)]  
...
## See Also  
 ...
 [transformer Class](../parallel/transformer-class.md)