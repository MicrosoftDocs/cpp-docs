...
|[join::release_message Method](#join__release_message_method)|Releases a previous message reservation. (Overrides [source_block::release_message](../parallel/source_block-class.md#source_block__release_message_method).)|  
|[join::reserve_message Method](#join__reserve_message_method)|Reserves a message previously offered by this `join` messaging block. (Overrides [source_block::reserve_message](../parallel/source_block-class.md#source_block__reserve_message_method).)|  
|[join::resume_propagation Method](#join__resume_propagation_method)|Resumes propagation after a reservation has been released. (Overrides [source_block::resume_propagation](../parallel/source_block-class.md#source_block__resume_propagation_method).)|  
...
## See Also  
 ...
 [multitype_join Class](../parallel/multitype_join-class.md)   
 [join_type Enumeration](../parallel/concurrency-namespace-enums.md)
