...
## Remarks  
 ...
 For more information, see [2.7.1 threadprivate Directive](../parallel/2.7.1-threadprivate-directive.md).  
 ...
 You cannot use `threadprivate` in any DLL that will be loaded via [LoadLibrary](http://msdn.microsoft.com/library/windows/desktop/ms684175).  This includes DLLs that are loaded with [/DELAYLOAD (Delay Load Import)](../buildref/-delayload--delay-load-import-.md), which also uses **LoadLibrary**.  
...
## Example  
 For a sample of using `threadprivate`, see [private](../parallel/private--openmp-.md).  
