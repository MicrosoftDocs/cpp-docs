...
---
# OMP_SCHEDULE
Modifies the behavior of the [schedule](../parallel/schedule.md) clause when `schedule(runtime)` is specified in a `for` or `parallel for` directive.  
...
## Remarks  
 ...
 For more information, see [4.1 OMP_SCHEDULE](../parallel/4.1-omp_schedule.md).  
