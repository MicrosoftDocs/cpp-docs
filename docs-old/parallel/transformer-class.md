...
|[transformer::release_message Method](#transformer__release_message_method)|Releases a previous message reservation. (Overrides [source_block::release_message](../parallel/source_block-class.md#source_block__release_message_method).)|  
|[transformer::reserve_message Method](#transformer__reserve_message_method)|Reserves a message previously offered by this `transformer` messaging block. (Overrides [source_block::reserve_message](../parallel/source_block-class.md#source_block__reserve_message_method).)|  
|[transformer::resume_propagation Method](#transformer__resume_propagation_method)|Resumes propagation after a reservation has been released. (Overrides [source_block::resume_propagation](../parallel/source_block-class.md#source_block__resume_propagation_method).)|  
