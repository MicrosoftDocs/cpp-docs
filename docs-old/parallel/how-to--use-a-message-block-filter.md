...
## Example  
 ...
 [!code[concrt-primes-filter#1](../parallel/codesnippet/CPP/how-to--use-a-message-block-filter_1.cpp)]  
...
## Example  
 ...
 [!code[concrt-primes-filter#2](../parallel/codesnippet/CPP/how-to--use-a-message-block-filter_2.cpp)]  
...
## Example  
 ...
 [!code[concrt-primes-filter#3](../parallel/codesnippet/CPP/how-to--use-a-message-block-filter_3.cpp)]  
 ...
 **bool (_Type)**  
**bool (_Type const &)** To eliminate the unnecessary copying of data, use the second form when you have an aggregate type that is transmitted by value.  
