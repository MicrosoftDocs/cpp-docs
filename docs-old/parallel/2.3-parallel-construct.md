...
-   **private**, **firstprivate**, **default**, **shared**, **copyin**, and **reduction** clauses, see [Section 2.7.2](../parallel/2.7.2-data-sharing-attribute-clauses.md) on page 25.  
  
-   **OMP_NUM_THREADS** environment variable, [Section 4.2](../parallel/4.2-omp_num_threads.md) on page 48.  
  
-   **omp_set_dynamic** library function, see [Section 3.1.7](../parallel/3.1.7-omp_set_dynamic-function.md) on page 39.  
  
-   **OMP_DYNAMIC** environment variable, see [Section 4.3](../parallel/4.3-omp_dynamic.md) on page 49.  
  
-   **omp_set_nested** function, see [Section 3.1.9](../parallel/3.1.9-omp_set_nested-function.md) on page 40.  
  
-   **OMP_NESTED** environment variable, see [Section 4.4](../parallel/4.4-omp_nested.md) on page 49.  
  
-   **omp_set_num_threads** library function, see [Section 3.1.1](../parallel/3.1.1-omp_set_num_threads-function.md) on page 36.