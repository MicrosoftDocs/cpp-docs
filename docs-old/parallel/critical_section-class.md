...
## Remarks  
 For more information, see [Synchronization Data Structures](../parallel/synchronization-data-structures.md).  
...
### Remarks  
 ...
 If the lock is already held by the calling context, an [improper_lock](../parallel/improper_lock-class.md) exception will be thrown.  
