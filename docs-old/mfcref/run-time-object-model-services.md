...
The classes             [CObject](../mfcref/cobject-class.md) and             [CRuntimeClass](../mfcref/cruntimeclass-structure.md) encapsulate several object services, including access to run-time class information, serialization, and dynamic object creation. All classes derived from             `CObject` inherit this functionality.  
...
### Remarks  
 ...
 [!code[NVC_MFCCObjectSample#20](../mfc/codesnippet/CPP/run-time-object-model-services_1.h)]  
  
 For more information on the                         `DECLARE_SERIAL` macro, see                         [CObject Class Topics](../mfc/using-cobject.md).  
  
### Example  
 [!code[NVC_MFCCObjectSample#21](../mfc/codesnippet/CPP/run-time-object-model-services_2.h)]  
...
### Example  
 [!code[NVC_MFCCObjectSample#2](../mfc/codesnippet/CPP/run-time-object-model-services_3.h)]  
  
 [!code[NVC_MFCCObjectSample#3](../mfc/codesnippet/CPP/run-time-object-model-services_4.cpp)]  
...
### Example  
 [!code[NVC_MFCCObjectSample#22](../mfc/codesnippet/CPP/run-time-object-model-services_5.h)]  
  
 [!code[NVC_MFCCObjectSample#23](../mfc/codesnippet/CPP/run-time-object-model-services_6.cpp)]  
...
### Example  
 [!code[NVC_MFCCObjectSample#24](../mfc/codesnippet/CPP/run-time-object-model-services_7.cpp)]  
...
### Remarks  
 `RUNTIME_CLASS` returns a pointer to a                         [CRuntimeClass](../mfcref/cruntimeclass-structure.md) structure for the class specified by                         *class_name*. Only                         `CObject`-derived classes declared with                         `DECLARE_DYNAMIC`,                         `DECLARE_DYNCREATE`, or                         `DECLARE_SERIAL` will return pointers to a                         `CRuntimeClass` structure.  
  
 For more information, see                         [CObject Class Topics](../mfc/using-cobject.md).  
  
### Example  
 [!code[NVC_MFCCObjectSample#25](../mfc/codesnippet/CPP/run-time-object-model-services_8.cpp)]  
