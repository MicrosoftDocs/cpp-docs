...
## Example  
 The following example demonstrates how to use the visual manager Office 2007. This code snippet is part of the [Desktop Alert Demo sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_DesktopAlertDemo#7](../mfcref/codesnippet/CPP/cmfcvisualmanageroffice2007-class_1.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCVisualManagerOffice2007](../mfcref/cmfcvisualmanageroffice2007-class.md)  
