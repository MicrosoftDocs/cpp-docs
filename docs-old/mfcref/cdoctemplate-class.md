...
### Remarks  
 The derived classes [CMultiDocTemplate](../mfcref/cmultidoctemplate-class.md) and [CSingleDocTemplate](../mfcref/csingledoctemplate-class.md) override this function. If you derive your own document-template class from `CDocTemplate`, your derived class must override this function.  
...
### Remarks  
 Use this member function to construct a `CDocTemplate` object. Dynamically allocate a `CDocTemplate` object and pass it to [CWinApp::AddDocTemplate](../mfcref/cwinapp-class.md#cwinapp__adddoctemplate) from the `InitInstance` member function of your application class.  
...
### Remarks  
 ...
 [CSingleDocTemplate](../mfcref/csingledoctemplate-class.md) and [CMultiDocTemplate](../mfcref/cmultidoctemplate-class.md) both override this pure virtual function. Any class you derive from `CDocTemplate` must also override this function.  
...
### Remarks  
 This member function is called by the framework to load the resources for a given `CDocTemplate` or derived class. Normally it is called during construction, except when the template is being constructed globally. In that case, the call to `LoadTemplate` is delayed until [CWinApp::AddDocTemplate](../mfcref/cwinapp-class.md#cwinapp__adddoctemplate) is called.  
...
### Remarks  
 Call this function to set the resources to be used when an OLE object is in-place activated. These resources may include menus and accelerator tables. This function is usually called in the [CWinApp::InitInstance](../mfcref/cwinapp-class.md#cwinapp__initinstance) function of your application.  
 ...
 *pOleFrameClass*  
 Pointer to a [CRuntimeClass](../mfcref/cruntimeclass-structure.md) structure containing class information for the frame window object created when in-place activation occurs.  
