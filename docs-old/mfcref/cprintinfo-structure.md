...
## Remarks  
 ...
 `CPrintInfo` contains information about both the print job as a whole, such as the range of pages to be printed, and the current status of the print job, such as the page currently being printed. Some information is stored in an associated [CPrintDialog](../mfcref/cprintdialog-class.md) object; this object contains the values entered by the user in the Print dialog box.  
...
### Remarks  
 ...
 You normally don't change this member, but if you do change it, change it before you call [CView::DoPreparePrinting](../mfcref/cview-class.md#cview__doprepareprinting) in your override of [CView::OnPreparePrinting](../mfcref/cview-class.md#cview__onprepareprinting).  
...
### Example  
  See the example for [CView::OnPreparePrinting](../mfcref/cview-class.md#cview__onprepareprinting).  
...
## See Also  
 ...
 [CView::OnBeginPrinting](../mfcref/cview-class.md#cview__onbeginprinting)   
 [CView::OnEndPrinting](../mfcref/cview-class.md#cview__onendprinting)   
 [CView::OnEndPrintPreview](../mfcref/cview-class.md#cview__onendprintpreview)   
 [CView::OnPrepareDC](../mfcref/cview-class.md#cview__onpreparedc)   
 [CView::OnPreparePrinting](../mfcref/cview-class.md#cview__onprepareprinting)   
