...
### Remarks  
 For more detailed remarks, see [CMapStringToOb::RemoveKey](../mfcref/cmapstringtoob-class.md#cmapstringtoob__removekey).  
...
### Remarks  
 For more detailed remarks, see [CMapStringToOb::SetAt](../mfcref/cmapstringtoob-class.md#cmapstringtoob__setat).  
