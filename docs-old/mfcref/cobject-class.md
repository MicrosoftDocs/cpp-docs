...
### Example  
 See [CObList::CObList](../mfcref/coblist-class.md#coblist__coblist) for a listing of the `CAge` class used in all `CObject` examples.  
  
 [!code[NVC_MFCCObjectSample#7](../mfc/codesnippet/CPP/cobject-class_1.cpp)]  
...
### Example  
 See [CObList::CObList](../mfcref/coblist-class.md#coblist__coblist) for a listing of the `CAge` class used in the `CObject` examples.  
  
 [!code[NVC_MFCCObjectSample#8](../mfc/codesnippet/CPP/cobject-class_2.cpp)]  
  
##  <a name="cobject__dump"></a>  CObject::Dump  
 Dumps the contents of your object to a [CDumpContext](../mfcref/cdumpcontext-class.md) object.  
...
>  Your `Dump` function should not print a newline character at the end of its output.  
 ...
 The [CDumpContext insertion (<<) operator](../mfcref/cdumpcontext-class.md#cdumpcontext__operator__lt__lt_) calls `Dump` when a `CObject` pointer is inserted.  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#9](../mfc/codesnippet/CPP/cobject-class_3.cpp)]  
...
### Return Value  
 A pointer to the [CRuntimeClass](../mfcref/cruntimeclass-structure.md) structure corresponding to this object's class; never **NULL**.  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#10](../mfc/codesnippet/CPP/cobject-class_4.cpp)]  
...
### Parameters  
 `pClass`  
 A pointer to a [CRuntimeClass](../mfcref/cruntimeclass-structure.md) structure associated with your `CObject`-derived class.  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#11](../mfc/codesnippet/CPP/cobject-class_5.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#12](../mfc/codesnippet/CPP/cobject-class_6.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCCObjectSample#14](../mfc/codesnippet/CPP/cobject-class_7.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#15](../mfc/codesnippet/CPP/cobject-class_8.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#16](../mfc/codesnippet/CPP/cobject-class_9.h)]  
...
### Remarks  
 ...
 Use [CArchive::IsLoading](../mfcref/carchive-class.md#carchive__isloading) or [CArchive::IsStoring](../mfcref/carchive-class.md#carchive__isstoring) to determine whether the archive is loading or storing.  
  
 `Serialize` is called by [CArchive::ReadObject](../mfcref/carchive-class.md#carchive__readobject) and [CArchive::WriteObject](../mfcref/carchive-class.md#carchive__writeobject). These functions are associated with the `CArchive` insertion operator ( **<\<**) and extraction operator ( **>>**).  
...
### Example  
 ...
 [!code[NVC_MFCCObjectSample#13](../mfc/codesnippet/CPP/cobject-class_10.cpp)]  
