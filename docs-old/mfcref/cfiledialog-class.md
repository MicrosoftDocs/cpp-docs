...
### Remarks  
 ...
 [!INCLUDE[wiprlhext](../crt/includes/wiprlhext_md.md)] style file dialogs do not support certain members and flags of the `CFileDialog`. As a result, these will have no effect.  
