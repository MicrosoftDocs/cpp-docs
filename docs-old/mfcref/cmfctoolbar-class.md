...
|[CMFCToolBar::AdjustLayout](#cmfctoolbar__adjustlayout)|Recalculates the size and position of a toolbar. (Overrides [CBasePane::AdjustLayout](../mfcref/cbasepane-class.md#cbasepane__adjustlayout)).|  
...
|[CMFCToolBar::ButtonToIndex](#cmfctoolbar__buttontoindex)|Returns the index of a specified [CMFCToolBarButton Class](../mfcref/cmfctoolbarbutton-class.md) object in this toolbar.|  
|[CMFCToolBar::CalcFixedLayout](#cmfctoolbar__calcfixedlayout)|Calculates the horizontal size of the toolbar. (Overrides [CBasePane::CalcFixedLayout](../mfcref/cbasepane-class.md#cbasepane__calcfixedlayout).)|  
|[CMFCToolBar::CalcSize](#cmfctoolbar__calcsize)|Called by the framework as part of the layout calculation process. (Overrides [CPane::CalcSize](../mfcref/cpane-class.md#cpane__calcsize).)|  
...
|[CMFCToolBar::CanBeClosed](#cmfctoolbar__canbeclosed)|Specifies whether a user can close the toolbar. (Overrides [CBasePane::CanBeClosed](../mfcref/cbasepane-class.md#cbasepane__canbeclosed).)|  
...
|[CMFCToolBar::CanFocus](#cmfctoolbar__canfocus)|Specifies whether the pane can receive focus. (Overrides [CBasePane::CanFocus](../mfcref/cbasepane-class.md#cbasepane__canfocus).)|  
|[CMFCToolBar::CanHandleSiblings](#cmfctoolbar__canhandlesiblings)|Determines whether the toolbar and its sibling are positioned on the same pane.|  
...
|[CMFCToolBar::EnableDocking](#cmfctoolbar__enabledocking)|Enables docking of the pane to the main frame. (Overrides [CBasePane::EnableDocking](../mfcref/cbasepane-class.md#cbasepane__enabledocking).)|  
...
|[CMFCToolBar::LoadState](#cmfctoolbar__loadstate)|Loads the toolbar state information from the Windows registry. (Overrides [CPane::LoadState](../mfcref/cpane-class.md#cpane__loadstate).)|  
...
|[CMFCToolBar::OnFillBackground](#cmfctoolbar__onfillbackground)|Called by the framework from [CBasePane::DoPaint](../mfcref/cbasepane-class.md#cbasepane__dopaint) to fill the toolbar background.|  
|[CMFCToolBar::OnReset](#cmfctoolbar__onreset)|Restores the toolbar to its original state.|  
|[CMFCToolBar::OnSetAccData](#cmfctoolbar__onsetaccdata)|(Overrides [CBasePane::OnSetAccData](../mfcref/cbasepane-class.md#cbasepane__onsetaccdata).)|  
...
|[CMFCToolBar::SaveState](#cmfctoolbar__savestate)|Saves the state information for the toolbar in the Windows registry. (Overrides [CPane::SaveState](../mfcref/cpane-class.md#cpane__savestate).)|  
...
|[CMFCToolBar::StretchPane](#cmfctoolbar__stretchpane)|Stretches the toolbar vertically or horizontally. (Overrides [CBasePane::StretchPane](../mfcref/cbasepane-class.md#cbasepane__stretchpane).)|  
...
3.  Call [CBasePane::EnableDocking](../mfcref/cbasepane-class.md#cbasepane__enabledocking) to specify the docking style.  
  
 To insert a special button, such as a combo box or drop-down toolbar, reserve a dummy button in the parent resource, and replace the dummy button at runtime by using [CMFCToolBar::ReplaceButton](#cmfctoolbar__replacebutton). For more information, see [Walkthrough: Putting Controls On Toolbars](../mfc/walkthrough--putting-controls-on-toolbars.md).  
  
 `CMFCToolBar` is the base class for the MFC Library classes [CMFCMenuBar Class](../mfcref/cmfcmenubar-class.md), [CMFCPopupMenuBar Class](../mfcref/cmfcpopupmenubar-class.md), and [CMFCDropDownToolBar Class](../mfcref/cmfcdropdowntoolbar-class.md).  
  
## Example  
 The following example demonstrates how to use various methods in the `CMFCToolBar` class. The example shows how to set the text of the window label of the tool bar, set the borders, set the style of the pane, and enable the **Add or Remove Buttons** button that appears on the end of the toolbar. This code snippet is part of the [IE Demo sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../mfcref/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#8](../mfcref/codesnippet/CPP/cmfctoolbar-class_2.cpp)]  
...
### Remarks  
 ...
 This method increments the command counter by using the [CMFCCmdUsageCount::AddCmd](../mfcref/cmfccmdusagecount-class.md#cmfccmdusagecount__addcmd) method.  
...
### Remarks  
 ...
 Override this method to provide your own dynamic layout in classes that you derive from [CMFCToolar](../mfcref/cmfctoolbar-class.md).  
...
### Remarks  
 ...
 Override this method in an object derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md) and return `FALSE` when you do not want the user to decide whether text labels are displayed on toolbar buttons under the images.  
...
### Remarks  
 This method is called by the framework to determine whether the list on the toolbar customization page should include a particular object derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md).  
...
### Remarks  
 ...
 For more information about the `nGrayImagePercentage` parameter, see [CMFCToolBarImages::GrayImages](../mfcref/cmfctoolbarimages-class.md#cmfctoolbarimages__grayimages).  
  
##  <a name="cmfctoolbar__buttontoindex"></a>  CMFCToolBar::ButtonToIndex  
 Returns the index of a specified [CMFCToolBarButton Class](../mfcref/cmfctoolbarbutton-class.md) object in this toolbar.  
...
### Remarks  
 ...
 Override this method in a class derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md) to provide your own height calculation.  
...
### Remarks  
 ...
 The default implementation returns `TRUE`. Override this method in a class derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md) to make toolbar objects that cannot be closed by the user.  
...
### Remarks  
 This method overrides the base class implementation, [CBasePane::CanFocus](../mfcref/cbasepane-class.md#cbasepane__canfocus), because toolbar objects cannot receive focus.  
...
### Remarks  
 A [CMFCToolBar](../mfcref/cmfctoolbar-class.md) object maintains an internal list of the buttons on the toolbar. Call this function to retrieve the index of a button in the list given the command ID of the button.  
...
### Example  
 The following example demonstrates how to use the `CreateEx` method of the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../mfcref/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#7](../mfcref/codesnippet/CPP/cmfctoolbar-class_3.cpp)]  
...
### Remarks  
 ...
 Override this method to customize the appearance of an object derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md).  
...
### Remarks  
 ...
 Override this method in a class derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md) to customize the appearance of separators on the toolbar. The default implementation calls [CMFCVisualManager::OnDrawSeparator](../mfcref/cmfcvisualmanager-class.md#cmfcvisualmanager__ondrawseparator) to draw a separator whose appearance is determined by the current visual manager.  
...
### Remarks  
 This method extends the base class implementation, [CBasePane::EnableDocking](../mfcref/cbasepane-class.md#cbasepane__enabledocking), by setting the `CBasePane::m_dwControlBarStyle` data member to `AFX_CBRS_FLOAT`. This method then passes `dwAlignment` to the base class implementation.  
...
### Return Value  
 A constant reference to a [CObList Class](../mfcref/coblist-class.md) object, which contains a collection of [CMFCToolBarButton Class](../mfcref/cmfctoolbarbutton-class.md) objects.  
...
### Return Value  
 A const reference to a [CObList Class](../mfcref/coblist-class.md) object that contains a collection of [CMFCToolbar](../mfcref/cmfctoolbar-class.md) objects.  
...
### Return Value  
 A const reference to a [CList Class](../mfcref/clist-class.md) object that contains a collection of basic commands.  
...
##  <a name="cmfctoolbar__getbutton"></a>  CMFCToolBar::GetButton  
 Returns a pointer to the [CMFCToolBarButton Class](../mfcref/cmfctoolbarbutton-class.md) object at a specified index.  
...
### Return Value  
 A [CSize Class](../atl/csize-class.md) object that specifies the dimensions of each button on the toolbar.  
...
### Return Value  
 A value that specifies the style of the toolbar button. . See [ToolBar Control Styles](../mfcref/toolbar-control-styles.md) for a list of possible styles.  
...
### Parameters  
 ...
 [out] `listButtons`  
 A reference to a [CObList Class](../mfcref/coblist-class.md) object that receives the list of toolbar buttons.  
...
### Remarks  
 Load the disabled toolbar button images by using the [CMFCToolBarEditBoxButton Class](../mfcref/cmfctoolbareditboxbutton-class.md) and [CMFCToolBar::LoadBitmap](#cmfctoolbar__loadbitmap) methods.  
...
### Remarks  
 Load the disabled images by using the [CMFCToolBarEditBoxButton Class](../mfcref/cmfctoolbareditboxbutton-class.md) method.  
...
### Return Value  
 A handle to window that is not derived from [CMFCBaseToolBar Class](../mfcref/cmfcbasetoolbar-class.md), which previously had the input focus; or `NULL` if there is no such window.  
  
### Remarks  
 When a [CMFCToolBar](../mfcref/cmfctoolbar-class.md) control receives the input focus, it stores a handle to the window that lost the focus so that it can restore it later.  
...
### Return Value  
 A pointer to the [CMFCToolBarImages Class](../mfcref/cmfctoolbarimages-class.md) object that contains the collection of default images for all toolbars in the application.  
...
### Return Value  
 A [CSize Class](../atl/csize-class.md) object that represents the current size of toolbar button images.  
...
### Example  
 The following example demonstrates how to use the `GetItemRect` method of the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../mfcref/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#9](../mfcref/codesnippet/CPP/cmfctoolbar-class_4.cpp)]  
...
### Remarks  
 The framework calls this method when it updates the client area that is associated with a toolbar button. It calls the [CWnd::InvalidateRect](../mfcref/cwnd-class.md#cwnd__invalidaterect) method with the client rectangle of the `CMFCToolBarButton` object that exists at the provided index.  
...
### Remarks  
 The toolbar object returns `TRUE` if it can display buttons that have extended borders. A toolbar button calls this method when it handles the [CMFCToolBarButton::OnChangeParentWnd](../mfcref/cmfctoolbarbutton-class.md#cmfctoolbarbutton__onchangeparentwnd) notification and will set its internal extra border size flag accordingly. This internal flag may be retrieved later by calling [CMFCToolBarButton::IsExtraSize](../mfcref/cmfctoolbarbutton-class.md#cmfctoolbarbutton__isextrasize).  
  
 Override this method in a class derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md) and return `TRUE` if your bar can display the toolbar buttons with the extra border size and return `FALSE` otherwise. The default implementation returns `TRUE`.  
...
### Remarks  
 ...
 The framework changes the mode when the user invokes the customization dialog box ( [CMFCToolBarsCustomizeDialog Class](../mfcref/cmfctoolbarscustomizedialog-class.md)).  
...
```  
static BOOL __stdcall LoadLargeIconsState(  
...
### Remarks  
 ...
 The [CWinAppEx::LoadState](../mfcref/cwinappex-class.md#cwinappex__loadstate) method calls this method as a part of the initialization process of the application.  
...
### Remarks  
 The framework calls this method as a part of the initialization process of the application. For more information, see [CWinAppEx::LoadState](../mfcref/cwinappex-class.md#cwinappex__loadstate).  
...
### Example  
 The following example demonstrates how to use the `LoadToolBar` method in the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../top/visual-c---samples.md).  
...
##  <a name="cmfctoolbar__onfillbackground"></a>  CMFCToolBar::OnFillBackground  
 Called by the framework from [CBasePane::DoPaint](../mfcref/cbasepane-class.md#cbasepane__dopaint) to fill the toolbar background.  
...
### Remarks  
 ...
 The default implementation does nothing. Override `OnReset` in a class derived from [CMFCToolBar](../mfcref/cmfctoolbar-class.md) when the toolbar has dummy buttons that must be replaced when the toolbar returns to its original state.  
...
### Remarks  
 This method posts a `WM_COMMAND` message to the window that owns the toolbar by calling [CWnd::PostMessage](../mfcref/cwnd-class.md#cwnd__postmessage) and passing the command ID of the specified button as the `wParam` parameter.  
...
### Parameters  
 ...
 [in] `uiID`  
 The resource ID of the toolbar. If this parameter is -1, this method uses the [CWnd::GetDlgCtrlID](../mfcref/cwnd-class.md#cwnd__getdlgctrlid) method to retrieve the resource ID.  
...
### Example  
 The following example demonstrates how to use the `ReplaceButton` method in the `CMFCToolBar` class. This code snippet is part of the [IE Demo sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_IEDemo#6](../mfcref/codesnippet/CPP/cmfctoolbar-class_1.h)]  
[!code[NVC_MFC_IEDemo#10](../mfcref/codesnippet/CPP/cmfctoolbar-class_5.cpp)]  
...
```  
static BOOL __stdcall SaveParameters(  
    LPCTSTR lpszProfileName = NULL);  
```  
...
### Remarks  
 The framework calls this method when it saves the application state to the registry. For more information, see [CWinAppEx::SaveState](../mfcref/cwinappex-class.md#cwinappex__savestate).  
...
### Parameters  
 ...
 [in] `nStyle`  
 The style of the button. See [ToolBar Control Styles](../mfcref/toolbar-control-styles.md) for the list of available toolbar button styles.  
...
### Remarks  
 ...
 This class uses the `CMFCCmdUsageCount` class to track the usage count of commands. For more information about this class, see [CMFCCmdUsageCount Class](../mfcref/cmfccmdusagecount-class.md).  
...
```  
static void __stdcall SetHelpMode(  
    BOOL bOn = TRUE);  
```  
