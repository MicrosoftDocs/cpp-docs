...
### Parameters  
 ...
 `rect`  
 Specifies the hot key control's size and position. It can be either a [CRect](../atl/crect-class.md) object or a "RECT" structure.  
  
 `pParentWnd`  
 Specifies the hot key control's parent window, usually a [CDialog](../mfcref/cdialog-class.md). It must not be **NULL**.  
...
### Example  
  [!code[NVC_MFCControlLadenDialog#69](../mfc/codesnippet/CPP/chotkeyctrl-class_1.cpp)]  
