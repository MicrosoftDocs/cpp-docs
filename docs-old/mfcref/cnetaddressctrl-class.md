...
## Remarks  
 ...
 The `CNetAddressCtrl` class is derived from the [CEdit](../mfcref/cedit-class.md) class. Consequently, the network address control provides access to all Windows edit control messages.  
 ...
 ![Dialog with a network address control and infotip.](../mfcref/media/cnetaddctrl.png "CNetAddCtrl")  
...
## Example  
 ...
 [!code[NVC_MFC_CNetAddressCtrl_s1#1](../mfcref/codesnippet/CPP/cnetaddressctrl-class_1.cpp)]  
...
## Example  
 ...
 [!code[NVC_MFC_CNetAddressCtrl_s1#2](../mfcref/codesnippet/CPP/cnetaddressctrl-class_2.h)]  
...
|---------------|-----------------|  
|[in] `dwStyle`|A bitwise combination of styles to be applied to the control. For more information, see [Edit Styles](../mfcref/edit-styles.md).|  
...
|[in] `dwStyle`|A bitwise combination (OR) of styles to be applied to the control. For more information, see [Edit Styles](../mfcref/edit-styles.md).|  
|[in] `rect`|A reference to a                                         [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure that contains the position and size of the control.|  
|[in] `pParentWnd`|A non-null pointer to a [CWnd](../mfcref/cwnd-class.md) object that is the parent window of the control.|  
|[in] `nID`|The ID of the control.|  
