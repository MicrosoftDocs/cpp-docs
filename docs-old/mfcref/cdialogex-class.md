...
## Remarks  
 ...
 A `CDialogEx` object can be a parent of a [CMFCPopupMenu Class](../mfcref/cmfcpopupmenu-class.md) object. The [CMFCPopupMenu Class](../mfcref/cmfcpopupmenu-class.md) object calls the `CDialogEx::SetActiveMenu` method when the [CMFCPopupMenu Class](../mfcref/cmfcpopupmenu-class.md) object opens. Afterward, the `CDialogEx` object handles any menu event until the [CMFCPopupMenu Class](../mfcref/cmfcpopupmenu-class.md) object is closed.  
