...
### Parameters  
 ...
 `rect`  
 Specifies the spin button control's size and position. It can be either a [CRect](../atl/crect-class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure  
