...
## Remarks  
 ...
 Certain member functions of this class call global helper functions that must be customized for most uses of the `CList` class. See [Collection Class Helpers](../mfcref/collection-class-helpers.md) in the "Macros and Globals" section.  
  
 For more information on using `CList`, see the article [Collections](../mfc/collections.md).  
  
## Example  
 [!code[NVC_MFCCollections#35](../mfc/codesnippet/CPP/clist-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#36](../mfc/codesnippet/CPP/clist-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#37](../mfc/codesnippet/CPP/clist-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#38](../mfc/codesnippet/CPP/clist-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#39](../mfc/codesnippet/CPP/clist-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#40](../mfc/codesnippet/CPP/clist-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#41](../mfc/codesnippet/CPP/clist-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#42](../mfc/codesnippet/CPP/clist-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#43](../mfc/codesnippet/CPP/clist-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#44](../mfc/codesnippet/CPP/clist-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#45](../mfc/codesnippet/CPP/clist-class_11.cpp)]  
...
### Return Value  
 See the return value description for [GetHead](../mfcref/coblist-class.md#coblist__gethead).  
  
### Remarks  
 You must ensure that the list is not empty before calling `GetTail`. If the list is empty, then the Debug version of the Microsoft Foundation Class Library asserts. Use [IsEmpty](../mfcref/coblist-class.md#coblist__isempty) to verify that the list contains elements.  
  
### Example  
 [!code[NVC_MFCCollections#46](../mfc/codesnippet/CPP/clist-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#47](../mfc/codesnippet/CPP/clist-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#48](../mfc/codesnippet/CPP/clist-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#49](../mfc/codesnippet/CPP/clist-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#50](../mfc/codesnippet/CPP/clist-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#51](../mfc/codesnippet/CPP/clist-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#52](../mfc/codesnippet/CPP/clist-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#53](../mfc/codesnippet/CPP/clist-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#54](../mfc/codesnippet/CPP/clist-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFCCollections#55](../mfc/codesnippet/CPP/clist-class_21.cpp)]  
