...
|[CWnd::GetNextDlgTabItem](#cwnd__getnextdlgtabitem)|Retrieves the first control with the [WS_TABSTOP](../mfcref/window-styles.md) style that follows (or precedes) the specified control.|  
...
|[CWnd::OnCharToItem](#cwnd__onchartoitem)|Called by a child list box with the [LBS_WANTKEYBOARDINPUT](../mfcref/list-box-styles.md) style in response to a [WM_CHAR](#cwnd__onchar) message.|  
...
## Remarks  
 ...
 Within the Microsoft Foundation Class Library, further classes are derived from `CWnd` to provide specific window types. Many of these classes, including [CFrameWnd](../mfcref/cframewnd-class.md), [CMDIFrameWnd](../mfcref/cmdiframewnd-class.md), [CMDIChildWnd](../mfcref/cmdichildwnd-class.md), [CView](../mfcref/cview-class.md), and [CDialog](../mfcref/cdialog-class.md), are designed for further derivation. The control classes derived from `CWnd`, such as [CButton](../mfcref/cbutton-class.md), can be used directly or can be used for further derivation of classes.  
...
### Remarks  
 ...
 To arrange iconic MDI child windows in an MDI client window, call [CMDIFrameWnd::MDIIconArrange](../mfcref/cmdiframewnd-class.md#cmdiframewnd__mdiiconarrange).  
  
### Example  
 [!code[NVC_MFCWindowing#66](../mfcref/codesnippet/CPP/cwnd-class_1.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#67](../mfcref/codesnippet/CPP/cwnd-class_2.h)]  
  
 [!code[NVC_MFCWindowing#68](../mfcref/codesnippet/CPP/cwnd-class_3.cpp)]  
  
 [!code[NVC_MFCWindowing#69](../mfcref/codesnippet/CPP/cwnd-class_4.cpp)]  
...
### Parameters  
 `lpPaint`  
 Points to the [PAINTSTRUCT](../mfcref/paintstruct-structure.md) structure that is to receive painting information.  
...
### Example  
 [!code[NVC_MFCWindowing#70](../mfcref/codesnippet/CPP/cwnd-class_5.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_AxDataBinding#1](../mfcref/codesnippet/CPP/cwnd-class_6.cpp)]  
[!code[NVC_MFC_AxDataBinding#2](../mfcref/codesnippet/CPP/cwnd-class_7.cpp)]  
[!code[NVC_MFC_AxDataBinding#3](../mfcref/codesnippet/CPP/cwnd-class_8.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_AxDataBinding#1](../mfcref/codesnippet/CPP/cwnd-class_6.cpp)]  
[!code[NVC_MFC_AxDataBinding#4](../mfcref/codesnippet/CPP/cwnd-class_9.cpp)]  
[!code[NVC_MFC_AxDataBinding#3](../mfcref/codesnippet/CPP/cwnd-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#71](../mfcref/codesnippet/CPP/cwnd-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#72](../mfcref/codesnippet/CPP/cwnd-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#73](../mfcref/codesnippet/CPP/cwnd-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#75](../mfcref/codesnippet/CPP/cwnd-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#76](../mfcref/codesnippet/CPP/cwnd-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#77](../mfcref/codesnippet/CPP/cwnd-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#78](../mfcref/codesnippet/CPP/cwnd-class_17.cpp)]  
...
##  <a name="cwnd__create"></a>  CWnd::Create  
 Creates the specified child window and attaches it to the [CWnd](../mfcref/cwnd-class.md) object.  
...
### Parameters  
 ...
 [in] `dwStyle`  
 Bitwise combination (OR) of [window styles](../mfcref/window-styles.md). The `WS_POPUP` option is not a valid style.  
 ...
 [in] `pContext`  
 Pointer to a [CCreateContext](../mfcref/ccreatecontext-structure.md) structure that is used to customize the document-view architecture for the application.  
...
>  This change fixes a crash in managed/native interop scenarios. A `TRACE` statement in `CWnd::Create` alerts the developer of the problem.  
 ...
 Use the [AfxRegisterWndClass](../Topic/AfxRegisterWndClass.md) function to register window classes. User defined window classes are available in the module where they are registered.  
  
 The [CWnd::OnCreate](#cwnd__oncreate) method is called before the `Create` method returns, and before the window becomes visible.  
  
### Example  
 [!code[NVC_MFCWindowing#79](../mfcref/codesnippet/CPP/cwnd-class_18.cpp)]  
...
### Remarks  
 The bitmap must have previously been created by the [CBitmap::CreateBitmap](../mfcref/cbitmap-class.md#cbitmap__createbitmap) member function, the                         [CreateDIBitmap](http://msdn.microsoft.com/library/windows/desktop/dd183491) Windows function, or the [CBitmap::LoadBitmap](../mfcref/cbitmap-class.md#cbitmap__loadbitmap) member function.  
...
### Example  
 [!code[NVC_MFCWindowing#80](../mfcref/codesnippet/CPP/cwnd-class_19.cpp)]  
 ...
 *pszWindowName*  
 ...
 `rect`  
 Specifies the control's size and position. It can be either a [CRect](../atl/crect-class.md) object or a "RECT" structure.  
 ...
 `pPersist`  
 A pointer to a [CFile](../mfcref/cfile-class.md) containing the persistent state for the control. The default value is **NULL**, indicating that the control initializes itself without restoring its state from any persistent storage. If not **NULL**, it should be a pointer to a `CFile`-derived object which contains the control's persistent data, in the form of either a stream or a storage. This data could have been saved in a previous activation of the client. The `CFile` can contain other data, but must have its read-write pointer set to the first byte of persistent data at the time of the call to `CreateControl`.  
...
### Example  
 [!code[NVC_MFCWindowing#81](../mfcref/codesnippet/CPP/cwnd-class_20.h)]  
...
### Parameters  
 `dwExStyle`  
 Bitwise combination (OR) of [extended window styles](../mfcref/extended-window-styles.md); otherwise `NULL` for the default extended window style.  
 ...
 `dwStyle`  
 Bitwise combination (OR) of [window styles](../mfcref/window-styles.md); otherwise `NULL` for the default window style.  
...
### Example  
 [!code[NVC_MFCWindowing#82](../mfcref/codesnippet/CPP/cwnd-class_21.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#83](../mfcref/codesnippet/CPP/cwnd-class_22.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#84](../mfcref/codesnippet/CPP/cwnd-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#85](../mfcref/codesnippet/CPP/cwnd-class_24.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#86](../mfcref/codesnippet/CPP/cwnd-class_25.cpp)]  
...
### Remarks  
 ...
 The `DestroyWindow` member function also destroys modeless dialog boxes created by [CDialog::Create](../mfcref/cdialog-class.md#cdialog__create).  
  
 If the `CWnd` being destroyed is a child window and does not have the [WS_EX_NOPARENTNOTIFY](../mfcref/extended-window-styles.md) style set, then the                         [WM_PARENTNOTIFY](https://msdn.microsoft.com/en-us/library/ms632638.aspx) message is sent to the parent.  
  
### Example  
 [!code[NVC_MFCWindowing#87](../mfcref/codesnippet/CPP/cwnd-class_26.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#88](../mfcref/codesnippet/CPP/cwnd-class_27.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#89](../mfcref/codesnippet/CPP/cwnd-class_28.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCWindowing#90](../mfcref/codesnippet/CPP/cwnd-class_29.cpp)]  
  
 The `DoDataExchange` overridden member function must precede the macro statements in your source file.  
  
 For more information on dialog data exchange and validation, see [Displaying and Manipulating Data in a Form](../data/displaying-and-manipulating-data-in-a-form.md) and [Dialog Data Exchange and Validation](../mfc/dialog-data-exchange-and-validation.md). For a description of the DDX_ and DDV_ macros generated by the Add Variable wizard, see [Technical Note 26](../mfc/tn026--ddx-and-ddv-routines.md).  
  
##  <a name="cwnd__dragacceptfiles"></a>  CWnd::DragAcceptFiles  
 Call this member function from within a window, using a `CWnd` pointer, in your application's [CWinApp::InitInstance](../mfcref/cwinapp-class.md#cwinapp__initinstance) function to indicate that the window accepts dropped files from the Windows File Manager or File Explorer.  
...
> [!NOTE]
>  Some windows, such as [CToolBar](../mfcref/ctoolbar-class.md), provide a built-in implementation of [OnToolHitTest](#cwnd__ontoolhittest).  
...
### Example  
 [!code[NVC_MFCWindowing#91](../mfcref/codesnippet/CPP/cwnd-class_30.cpp)]  
  
 [!code[NVC_MFCWindowing#92](../mfcref/codesnippet/CPP/cwnd-class_31.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#93](../mfcref/codesnippet/CPP/cwnd-class_32.cpp)]  
...
### Parameters  
 `lpPaint`  
 Points to a [PAINTSTRUCT](../mfcref/paintstruct-structure.md) structure that contains the painting information retrieved by the [BeginPaint](#cwnd__beginpaint) member function.  
...
### Example  
 [!code[NVC_MFCWindowing#94](../mfcref/codesnippet/CPP/cwnd-class_33.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#95](../mfcref/codesnippet/CPP/cwnd-class_34.cpp)]  
...
### Return Value  
 [CPoint](../atl/cpoint-class.md) object containing the coordinates of the caret's position.  
...
### Example  
 [!code[NVC_MFCWindowing#96](../mfcref/codesnippet/CPP/cwnd-class_35.cpp)]  
...
### Return Value  
 Returns a pointer to the [MSG](../mfcref/msg-structure1.md) structure that contains the message the window is currently processing. Should only be called when in an **On***Message* handler.  
  
### Example  
  See the example for [CMDIFrameWnd::MDICascade](../mfcref/cmdiframewnd-class.md#cmdiframewnd__mdicascade).  
...
### Example  
 [!code[NVC_MFCWindowing#97](../mfcref/codesnippet/CPP/cwnd-class_36.cpp)]  
...
### Parameters  
 ...
 `rString`  
 A reference to a [CString](../atl/cstringt-class.md).  
...
### Example  
 [!code[NVC_MFC_AxDataBinding#1](../mfcref/codesnippet/CPP/cwnd-class_6.cpp)]  
[!code[NVC_MFC_AxDataBinding#5](../mfcref/codesnippet/CPP/cwnd-class_37.cpp)]  
[!code[NVC_MFC_AxDataBinding#3](../mfcref/codesnippet/CPP/cwnd-class_8.cpp)]  
...
### Return Value  
 The window's extended style. For more information about the extended window styles used in MFC, see [Extended Window Styles](../mfcref/extended-window-styles.md).  
...
### Return Value  
 Pointer to a [CFont](../mfcref/cfont-class.md) object that is attached to the current font for the window.  
...
### Example  
 [!code[NVC_MFCWindowing#98](../mfcref/codesnippet/CPP/cwnd-class_38.cpp)]  
...
### Remarks  
 A group of controls begins with a control that was created with the [WS_GROUP](../mfcref/window-styles.md) style and ends with the last control that was not created with the **WS_GROUP** style.  
...
|----------------------------|-----------------------------|  
|Windowed ActiveX control|Contains an HWND and associates a [COleControlSite](../mfcref/colecontrolsite-class.md) object with it. The `m_hWnd` member of `COleControlSiteOrWnd` is set to the HWND of the control, and the **m_pSite** member points to the control's `COleControlSite`.|  
...
##  <a name="cwnd__getnextdlgtabitem"></a>  CWnd::GetNextDlgTabItem  
 Retrieves a pointer to the first control that was created with the [WS_TABSTOP](../mfcref/window-styles.md) style and that precedes or follows the specified control.  
...
### Remarks  
 The member function searches up the parent chain until a [CFrameWnd](../mfcref/cframewnd-class.md) (or derived class) object is found.  
...
### Parameters  
 ...
 `vtProp`  
 Specifies the type of the property to be retrieved. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../mfcref/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
>  This function should be called only on a `CWnd` object that represents an ActiveX control.  
 ...
 For more information about using this member function with ActiveX Control Containers, see the article [ActiveX Control Containers: Programming ActiveX Controls in an ActiveX Control Container](../mfc/activex-control-containers--programming-activex-controls-in-an-activex-control-container.md).  
...
### Remarks  
 The safe owner is the first non-child parent window of `pParent`. If `pParent` is **NULL**, the thread's main window (retrieved via [AfxGetMainWnd](../Topic/AfxGetMainWnd.md)) is used to find an owner.  
...
### Return Value  
 The window's style. For more information about the window styles used in MFC, see [Window Styles](../mfcref/window-styles.md).  
...
### Remarks  
 ...
 The pointer returned by the `GetSystemMenu` member function can be used with the [CMenu::AppendMenu](../mfcref/cmenu-class.md#cmenu__appendmenu), [CMenu::InsertMenu](../mfcref/cmenu-class.md#cmenu__insertmenu), or [CMenu::ModifyMenu](../mfcref/cmenu-class.md#cmenu__modifymenu) functions to change the Control menu.  
...
### Example  
 [!code[NVC_MFCWindowing#99](../mfcref/codesnippet/CPP/cwnd-class_39.cpp)]  
...
### Remarks  
 If `CWnd` has no attached window, or its top-level parent is not a [CFrameWnd](../mfcref/cframewnd-class.md)-derived object, this function returns **NULL**.  
...
### Remarks  
 The **flags** member of the [WINDOWPLACEMENT](../mfcref/windowplacement-structure.md) structure retrieved by this function is always 0. If `CWnd` is maximized, the **showCmd** member of `WINDOWPLACEMENT` is **SW_SHOWMAXIMIZED**. If the window is minimized, it is **SW_SHOWMINIMIZED.** It is **SW_SHOWNORMAL** otherwise.  
...
### Parameters  
 ...
 `rString`  
 A [CString](../atl/cstringt-class.md) object that is to receive the copied string of the window's title.  
...
### Remarks  
 The **MF_HILITE** and **MF_UNHILITE** flags can be used only with this member function; they cannot be used with the [CMenu::ModifyMenu](../mfcref/cmenu-class.md#cmenu__modifymenu) member function.  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the `uCommand` parameter described in the [HTMLHelp API Reference](vsconovhtmlhelpapioverview) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
  
### Remarks  
 See [CWinApp::HtmlHelp](../mfcref/cwinapp-class.md#cwinapp__htmlhelp) for more information.  
...
### Parameters  
 `pRgn`  
 A pointer to a [CRgn](../mfcref/crgn-class.md) object that identifies the region to be added to the update region. The region is assumed to have client coordinates. If this parameter is **NULL**, the entire client area is added to the update region.  
...
### Parameters  
 ...
 `vtRet`  
 Specifies the type of the return value. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../mfcref/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
### Remarks  
 ...
 This function converts the parameters to **VARIANTARG** values, then invokes the **IDispatch::Invoke** method on the ActiveX control. If the call to **IDispatch::Invoke** fails, this function will throw an exception. If the `SCODE` (status code) returned by **IDispatch::Invoke** is `DISP_E_EXCEPTION`, this function throws a [COleException](../mfcref/coleexception-class.md) object, otherwise it throws a [COleDispatchException](../mfcref/coledispatchexception-class.md).  
...
### Parameters  
 `lpMsg`  
 Points to an [MSG](../mfcref/msg-structure1.md) structure that contains the message to be checked.  
...
### Return Value  
 ...
 [!code[NVC_MFCWindowing#100](../mfcref/codesnippet/CPP/cwnd-class_40.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#101](../mfcref/codesnippet/CPP/cwnd-class_41.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#102](../mfcref/codesnippet/CPP/cwnd-class_42.cpp)]  
...
### Return Value  
 Nonzero if `CWnd` is visible (has the [WS_VISIBLE](../mfcref/window-styles.md) style bit set, and parent window is visible). Because the return value reflects the state of the **WS_VISIBLE** style bit, the return value may be nonzero even though `CWnd` is totally obscured by other windows.  
...
### Example  
 [!code[NVC_MFCWindowing#103](../mfcref/codesnippet/CPP/cwnd-class_43.cpp)]  
...
### Remarks  
 ...
 The `LockWindowUpdate` member function does not make the given window invisible and does not clear the [WS_VISIBLE](../mfcref/window-styles.md) style bit.  
...
##  <a name="cwnd__messagebox"></a>  CWnd::MessageBox  
 Creates and displays a window that contains an application-supplied message and caption, plus a combination of the predefined icons and pushbuttons described in the [Message-Box Styles](../mfcref/message-box-styles.md) list.  
...
### Remarks  
 Use the global function [AfxMessageBox](../Topic/AfxMessageBox.md) instead of this member function to implement a message box in your application.  
  
 The following shows the various system icons that can be used in a message box:  
  
|||  
|-|-|  
|![Stop &#40;x&#41; icon](../mfcref/media/vc364f1.gif "vc364F1")|**MB_ICONHAND**, **MB_ICONSTOP**, and **MB_ICONERROR**|  
|![Help &#40;?&#41; icon](../mfcref/media/vc364f2.gif "vc364F2")|**MB_ICONQUESTION**|  
|![Important &#40;&#33;&#41; icon](../mfcref/media/vc364f3.gif "vc364F3")|**MB_ICONEXCLAMATION** and **MB_ICONWARNING**|  
|![Information &#40;i&#41; icon](../mfcref/media/vc364f4.gif "vc364F4")|**MB_ICONASTERISK** and **MB_ICONINFORMATION**|  
  
### Example  
 [!code[NVC_MFCWindowing#104](../mfcref/codesnippet/CPP/cwnd-class_44.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#105](../mfcref/codesnippet/CPP/cwnd-class_45.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#106](../mfcref/codesnippet/CPP/cwnd-class_46.cpp)]  
...
void MoveWindow(  
    LPCRECT lpRect, BOOL bRepaint = TRUE );  
```  
 ...
 *y*  
 ...
 `lpRect`  
 The [CRect](../atl/crect-class.md) object or "RECT" structure that specifies the new size and position.  
...
|---------------|-----------------|  
|[in] `pWnd`|Pointer to a [CWnd](../mfcref/cwnd-class.md) object that represents the window where the user clicked the comman button or pressed the command key. This window can be a child window of the window receiving the message.|  
...
##  <a name="cwnd__onchartoitem"></a>  CWnd::OnCharToItem  
 Called when a list box with the [LBS_WANTKEYBOARDINPUT](../mfcref/list-box-styles.md) style sends its owner a                 [WM_CHARTOITEM](http://msdn.microsoft.com/library/windows/desktop/bb761358) message in response to a [WM_CHAR](#cwnd__onchar) message.  
...
### Parameters  
 ...
 `lpCompareItemStruct`  
 Contains a long pointer to a [COMPAREITEMSTRUCT](../mfcref/compareitemstruct-structure.md) data structure that contains the identifiers and application-supplied data for two items in the combo or list box.  
...
### Remarks  
 If a combo or list box is created with the [CBS_SORT](../mfcref/combo-box-styles.md) or [LBS_SORT](../mfcref/list-box-styles.md) style, Windows sends the combo-box or list-box owner a `WM_COMPAREITEM` message whenever the application adds a new item.  
...
### Remarks  
 You can process this message by displaying a context menu using the [TrackPopupMenu](../mfcref/cmenu-class.md#cmenu__trackpopupmenu).  
...
### Parameters  
 `pWnd`  
 A pointer to a [CWnd](../mfcref/cwnd-class.md) object that is sending the data.  
...
### Parameters  
 `lpCreateStruct`  
 Points to a [CREATESTRUCT](../mfcref/createstruct-structure.md) structure that contains information about the `CWnd` object being created.  
...
### Remarks  
 ...
 To change the background color of a single-line edit control, set the brush handle in both the **CTLCOLOR_EDIT** and **CTLCOLOR_MSGBOX** message codes, and call the [CDC::SetBkColor](../mfcref/cdc-class.md#cdc__setbkcolor) function in response to the **CTLCOLOR_EDIT** code.  
...
### Example  
 [!code[NVC_MFCWindowing#107](../mfcref/codesnippet/CPP/cwnd-class_47.cpp)]  
...
##  <a name="cwnd__ondeleteitem"></a>  CWnd::OnDeleteItem  
 The framework calls this member function to inform the owner of an owner-draw list box or combo box that the list box or combo box is destroyed or that items have been removed by [CComboBox::DeleteString](../mfcref/ccombobox-class.md#ccombobox__deletestring), [CListBox::DeleteString](../mfcref/clistbox-class.md#clistbox__deletestring), [CComboBox::ResetContent](../mfcref/ccombobox-class.md#ccombobox__resetcontent), or [CListBox::ResetContent](../mfcref/clistbox-class.md#clistbox__resetcontent).  
...
### Parameters  
 ...
 `lpDeleteItemStruct`  
 Specifies a long pointer to a [DELETEITEMSTRUCT](../mfcref/deleteitemstruct-structure.md) data structure that contains information about the deleted list box item.  
...
### Remarks  
 The **itemAction** member of the [DRAWITEMSTRUCT](../mfcref/drawitemstruct-structure.md) structure defines the drawing operation that is to be performed. The data in this member allows the owner of the control to determine what drawing action is required.  
 ...
 If the **hwndItem** member belongs to a [CButton](../mfcref/cbutton-class.md), [CMenu](../mfcref/cmenu-class.md), [CListBox](../mfcref/clistbox-class.md), or [CComboBox](../mfcref/ccombobox-class.md) object, then the `DrawItem` virtual function of the appropriate class is called. Override the `DrawItem` member function of the appropriate control's class to draw the item.  
...
### Remarks  
 `OnEnable` is called before the [EnableWindow](#cwnd__enablewindow) member function returns, but after the window enabled state ( [WS_DISABLED](../mfcref/window-styles.md) style bit) has changed.  
...
### Parameters  
 *lpMMI*  
 Points to a `MINMAXINFO` structure that contains information about a window's maximized size and position and its minimum and maximum tracking size. For more about this structure, see the [MINMAXINFO](../mfcref/minmaxinfo-structure.md) structure.  
...
### Remarks  
 See [CWinApp::OnHelp](../mfcref/cwinapp-class.md#cwinapp__onhelp) for more information.  
...
### Remarks  
 See [CWinApp::OnHelpFinder](../mfcref/cwinapp-class.md#cwinapp__onhelpfinder) for more information.  
...
### Remarks  
 See [CWinApp::OnHelpIndex](../mfcref/cwinapp-class.md#cwinapp__onhelpindex) for more information.  
...
### Remarks  
 See [CWinApp::OnHelpUsing](../mfcref/cwinapp-class.md#cwinapp__onhelpusing) for more information.  
...
### Example  
 [!code[NVC_MFCWindowing#108](../mfcref/codesnippet/CPP/cwnd-class_48.cpp)]  
...
### Parameters  
 ...
 `lpMeasureItemStruct`  
 Points to a [MEASUREITEMSTRUCT](../mfcref/measureitemstruct-structure.md) data structure that contains the dimensions of the owner-draw control.  
...
### Remarks  
 ...
 If a list box or combo box is created with the [LBS_OWNERDRAWVARIABLE](../mfcref/list-box-styles.md) or [CBS_OWNERDRAWVARIABLE](../mfcref/combo-box-styles.md) style, the framework calls this function for the owner for each item in the control; otherwise this function is called once.  
...
|[in] `pMenu`|Pointer to the [CMenu](../mfcref/cmenu-class.md) object that contains the menu item.|  
...
### Example  
 [!code[NVC_MFCAxCtl#9](../mfcref/codesnippet/CPP/cwnd-class_49.cpp)]  
...
|[in] `point`|A [CPoint](../atl/cpoint-class.md) object that specifies the                                         *x* and                                         *y* coordinates of the cursor relative to the upper-left corner of the client area.|  
...
|[in] `pt`|A [CPoint](../atl/cpoint-class.md) object that specifies the                                         *x* and                                         *y* coordinates of the cursor relative to the upper-left corner of the client area.|  
...
### Parameters  
 ...
 `lpRect`  
 Address of the [CRect](../atl/crect-class.md) or "RECT" structure that will contain the item's coordinates.  
...
### Parameters  
 ...
 `lpncsp`  
 Points to a [NCCALCSIZE_PARAMS](../mfcref/nccalcsize_params-structure.md) data structure that contains information an application can use to calculate the new size and position of the `CWnd` rectangle (including client area, borders, caption, scroll bars, and so on).  
...
### Parameters  
 `lpCreateStruct`  
 Points to the [CREATESTRUCT](../mfcref/createstruct-structure.md) data structure for `CWnd`.  
...
|[in] `point`|A [CPoint](../atl/cpoint-class.md) object that specifies the                                         *x* and                                         *y* coordinates of the cursor relative to the upper-left corner of the screen.|  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] `pWnd`|A pointer to a [CWnd](../mfcref/cwnd-class.md) object that represents the window sending the                                         [WM_NOTIFY](http://msdn.microsoft.com/library/windows/desktop/bb775583) message.<br /><br /> This parameter is the pointer to a control if the `nCommand` parameter is `NF_QUERY`, or the pointer to the parent window of a control if `nCommand` is `NF_REQUERY`.|  
...
### Remarks  
 ...
 For information on rendering an image in document/view applications, see [CView::OnDraw](../mfcref/cview-class.md#cview__ondraw).  
 ...
 *hPaintStruct*  
 Identifies a [PAINTSTRUCT](../mfcref/paintstruct-structure.md) data structure that defines what part of the client area to paint.  
...
### Example  
 [!code[NVC_MFCWindowing#109](../mfcref/codesnippet/CPP/cwnd-class_50.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#110](../mfcref/codesnippet/CPP/cwnd-class_51.cpp)]  
...
### Remarks  
 This function is called only when an application has initiated a training card with Windows Help. An application initiates a training card by specifying the **HELP_TCARD** command in a call to the [WinHelp](../mfcref/cwinapp-class.md#cwinapp__winhelp) function.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] `pMenu`|Pointer to the [CMenu](../mfcref/cmenu-class.md) object that represents the menu or submenu.|  
...
##  <a name="cwnd__onvkeytoitem"></a>  CWnd::OnVKeyToItem  
 If the `CWnd` object owns a list box with the [LBS_WANTKEYBOARDINPUT](../mfcref/list-box-styles.md) style, the list box will send the `WM_VKEYTOITEM` message in response to a `WM_KEYDOWN` message.  
...
### Remarks  
 This member function is called by the framework only for list boxes that have the [LBS_HASSTRINGS](../mfcref/list-box-styles.md) style.  
...
### Parameters  
 `lpwndpos`  
 Points to a [WINDOWPOS](../mfcref/windowpos-structure1.md) data structure that contains information about the window's new size and position.  
...
### Remarks  
 An application can prevent changes to the window by setting or clearing the appropriate bits in the **flags** member of the [WINDOWPOS](../mfcref/windowpos-structure1.md) structure.  
  
 For a window with the [WS_OVERLAPPED](../mfcref/window-styles.md) or [WS_THICKFRAME](../mfcref/window-styles.md) style, the default implementation sends a                         [WM_GETMINMAXINFO](http://msdn.microsoft.com/library/windows/desktop/ms632626) message to the window. This is done to validate the new size and position of the window and to enforce the **CS_BYTEALIGNCLIENT** and **CS_BYTEALIGN** client styles. An application can override this functionality by not calling its base class.  
...
### Example  
 [!code[NVC_MFCWindowing#111](../mfcref/codesnippet/CPP/cwnd-class_52.cpp)]  
...
### Example  
  See the example for [AfxGetMainWnd](../Topic/AfxGetMainWnd.md).  
...
### Parameters  
 *cs*  
 A [CREATESTRUCT](../mfcref/createstruct-structure.md) structure.  
...
### Example  
 [!code[NVC_MFCWindowing#112](../mfcref/codesnippet/CPP/cwnd-class_53.cpp)]  
...
##  <a name="cwnd__pretranslatemessage"></a>  CWnd::PreTranslateMessage  
 Used by class [CWinApp](../mfcref/cwinapp-class.md) to translate window messages before they are dispatched to the                 [TranslateMessage](http://msdn.microsoft.com/library/windows/desktop/ms644955) and                 [DispatchMessage](http://msdn.microsoft.com/library/windows/desktop/ms644934) Windows functions.  
...
### Parameters  
 `pMsg`  
 Points to a [MSG](../mfcref/msg-structure1.md) structure that contains the message to process.  
...
### Remarks  
 ...
 Reflected messages are sent directly to [CWnd::OnWndMsg](#cwnd__onwndmsg) or [CCmdTarget::OnCmdMsg](../mfcref/ccmdtarget-class.md#ccmdtarget__oncmdmsg).  
...
### Parameters  
 `lpPoint`  
 Points to a [CPoint](../atl/cpoint-class.md) object or "POINT" structure that contains the screen coordinates to be converted.  
  
 `lpRect`  
 Points to a [CRect](../atl/crect-class.md) object or "RECT" structure that contains the screen coordinates to be converted.  
...
### Example  
  See the example for [CListCtrl::GetItemRect](../mfcref/clistctrl-class.md#clistctrl__getitemrect).  
...
### Parameters  
 ...
 `lpRect`  
 Points to a [CRect](../atl/crect-class.md) object or "RECT" structure that specifies the portion of the client area to be scrolled. If `lpRect` is **NULL**, the entire client area is scrolled. The caret is repositioned if the cursor rectangle intersects the scroll rectangle.  
...
### Example  
 [!code[NVC_MFCWindowing#113](../mfcref/codesnippet/CPP/cwnd-class_54.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#114](../mfcref/codesnippet/CPP/cwnd-class_55.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#115](../mfcref/codesnippet/CPP/cwnd-class_56.cpp)]  
...
### Parameters  
 ...
 `lpszString`  
 Points to a [CString](../atl/cstringt-class.md) object or null-terminated string that contains the text to be copied to the control.  
  
### Remarks  
 `SetDlgItemText` sends a                         [WM_SETTEXT](http://msdn.microsoft.com/library/windows/desktop/ms632644) message to the given control.  
  
### Example  
 [!code[NVC_MFCWindowing#116](../mfcref/codesnippet/CPP/cwnd-class_57.cpp)]  
...
### Remarks  
 ...
 `SetMenu` will not destroy a previous menu. An application should call the [CMenu::DestroyMenu](../mfcref/cmenu-class.md#cmenu__destroymenu) member function to accomplish this task.  
  
### Example  
  See the example for [CMenu::LoadMenu](../mfcref/cmenu-class.md#cmenu__loadmenu).  
...
### Parameters  
 ...
 `vtProp`  
 Specifies the type of the property to be set. For possible values, see the Remarks section for [COleDispatchDriver::InvokeHelper](../mfcref/coledispatchdriver-class.md#coledispatchdriver__invokehelper).  
...
>  This function should be called only on a `CWnd` object that represents an OLE control.  
 ...
 For more information about using this member function with OLE Control Containers, see the article [ActiveX Control Containers: Programming ActiveX Controls in an ActiveX Control Container](../mfc/activex-control-containers--programming-activex-controls-in-an-activex-control-container.md).  
...
### Example  
 [!code[NVC_MFCWindowing#117](../mfcref/codesnippet/CPP/cwnd-class_58.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#118](../mfcref/codesnippet/CPP/cwnd-class_59.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#119](../mfcref/codesnippet/CPP/cwnd-class_60.cpp)]  
...
### Parameters  
 `lpwndpl`  
 Points to a [WINDOWPLACEMENT](../mfcref/windowplacement-structure.md) structure that specifies the new show state and positions.  
...
### Example  
 [!code[NVC_MFCWindowing#120](../mfcref/codesnippet/CPP/cwnd-class_61.cpp)]  
...
### Parameters  
 `lpszString`  
 Points to a [CString](../atl/cstringt-class.md) object or null-terminated string to be used as the new title or control text.  
...
### Example  
 [!code[NVC_MFCWindowing#121](../mfcref/codesnippet/CPP/cwnd-class_62.cpp)]  
...
### Remarks  
 `ShowWindow` must be called only once per application for the main window with [CWinApp::m_nCmdShow](../mfcref/cwinapp-class.md#cwinapp__m_ncmdshow). Subsequent calls to `ShowWindow` must use one of the values listed above instead of the one specified by `CWinApp::m_nCmdShow`.  
...
### Example  
 [!code[NVC_MFCWindowing#122](../mfcref/codesnippet/CPP/cwnd-class_63.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#123](../mfcref/codesnippet/CPP/cwnd-class_64.cpp)]  
...
### Remarks  
 The framework automatically calls `UpdateData` with `bSaveAndValidate` set to **FALSE** when a modal dialog box is created in the default implementation of [CDialog::OnInitDialog](../mfcref/cdialog-class.md#cdialog__oninitdialog). The call occurs before the dialog box is visible. The default implementation of [CDialog::OnOK](../mfcref/cdialog-class.md#cdialog__onok) calls this member function with `bSaveAndValidate` set to **TRUE** to retrieve the data, and if successful, will close the dialog box. (If the Cancel button is clicked in the dialog box, the dialog box is closed without the data being retrieved.)  
...
### Example  
 [!code[NVC_MFCWindowing#124](../mfcref/codesnippet/CPP/cwnd-class_65.cpp)]  
...
### Parameters  
 `lpRect`  
 Points to a [CRect](../atl/crect-class.md) object or "RECT" structure that contains client coordinates of the rectangle to be removed from the update region. If `lpRect` is **NULL**, the entire window is validated.  
...
### Parameters  
 `pRgn`  
 A pointer to a [CRgn](../mfcref/crgn-class.md) object that identifies a region that defines the area to be removed from the update region. If this parameter is **NULL**, the entire client area is removed.  
...
### Parameters  
 `point`  
 Specifies a [CPoint](../atl/cpoint-class.md) object or "POINT" data structure that defines the point to be checked.  
...
### Remarks  
 See [CWinApp::WinHelp](../mfcref/cwinapp-class.md#cwinapp__winhelp) for more information.  
...
## See Also  
 ...
 [CFrameWnd Class](../mfcref/cframewnd-class.md)   
