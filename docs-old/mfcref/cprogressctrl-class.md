...
### Example  
 [!code[NVC_MFC_CProgressCtrl#1](../mfcref/codesnippet/CPP/cprogressctrl-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#2](../mfcref/codesnippet/CPP/cprogressctrl-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#3](../mfcref/codesnippet/CPP/cprogressctrl-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#4](../mfcref/codesnippet/CPP/cprogressctrl-class_4.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#9](../mfcref/codesnippet/CPP/cprogressctrl-class_5.h)]  
  
### Example  
 The following code example retrieves the state of the current progress bar control.  
  
 [!code[NVC_MFC_CProgressCtrl_s1#5](../mfcref/codesnippet/CPP/cprogressctrl-class_6.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#3](../mfcref/codesnippet/CPP/cprogressctrl-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#5](../mfcref/codesnippet/CPP/cprogressctrl-class_8.cpp)]  
...
### Remarks  
 The `SetBarColor` method sets the progress bar color only if a [!INCLUDE[windowsver](../buildref/includes/windowsver_md.md)][theme](https://msdn.microsoft.com/en-us/library/windows/desktop/hh270423.aspx) is not in effect.  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#1](../mfcref/codesnippet/CPP/cprogressctrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#6](../mfcref/codesnippet/CPP/cprogressctrl-class_10.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#2](../mfcref/codesnippet/CPP/cprogressctrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#7](../mfcref/codesnippet/CPP/cprogressctrl-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#8](../mfcref/codesnippet/CPP/cprogressctrl-class_13.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CProgressCtrl_s1#4](../mfcref/codesnippet/CPP/cprogressctrl-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#9](../mfcref/codesnippet/CPP/cprogressctrl-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CProgressCtrl#10](../mfcref/codesnippet/CPP/cprogressctrl-class_16.cpp)]  
