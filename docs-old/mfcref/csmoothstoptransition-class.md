...
|Name|Description|  
|----------|-----------------|  
|[CSmoothStopTransition::Create](#csmoothstoptransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../mfcref/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CSmoothStopTransition](../mfcref/csmoothstoptransition-class.md)  
