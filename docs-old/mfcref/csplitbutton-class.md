...
## Remarks  
 ...
 ![Dialog with a splitbutton and pager control.](../mfcref/media/splitbutton_pager.png "SplitButton_Pager")  
 ...
 **Header:** afxcmn.h  
 ...
 This class is supported in [!INCLUDE[windowsver](../buildref/includes/windowsver_md.md)] and later.  
...
|---------------|-----------------|  
|[in] `dwStyle`|A bitwise combination (OR) of styles to be applied to the control. For more information, see [Button Styles](../mfcref/button-styles.md).|  
...
|[in] `pParentWnd`|A non-null pointer to a [CWnd](../mfcref/cwnd-class.md) object that is the parent window of the control.|  
...
|[in] `pMenu`|A pointer to a [CMenu](../mfcref/cmenu-class.md) object that specifies a submenu. The `CSplitButton` object deletes the `CMenu` object and its associated `HMENU` when the `CSplitButton` object goes out of scope.|  
...
### Remarks  
 ...
 To implement a custom action that the containing control supports, use a [CButton](../mfcref/cbutton-class.md) object with a style of `BS_SPLITBUTTON` instead of a `CSplitButton` object. Then implement a handler for the `BCN_DROPDOWN` notification in the `CButton` object. For more information, see [Button Styles](../mfcref/button-styles.md).  
...
|[in] `nMenuId`|The resource ID of the menu bar.|  
|[in] `nSubMenuId`|The resource ID of a submenu.|  
|[in] `pMenu`|Pointer to a [CMenu](../mfcref/cmenu-class.md) object that specifies a submenu. The `CSplitButton` object deletes the `CMenu` object and its associated `HMENU` when the `CSplitButton` object goes out of scope.|  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#1](../mfcref/codesnippet/CPP/csplitbutton-class_1.cpp)]  
