...
-   Band 2 contains a combo box and four standard buttons.  
     ...
     ![Example of a Rebar menu](../mfcref/media/vc4scc1.gif "vc4SCC1")  
...
### Parameters  
 ...
 `rect`  
 A reference to a [CRect](../atl/crect-class.md) object or                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure, which is the position and size of the rebar control.  
  
 `pParentWnd`  
 A pointer to a [CWnd](../mfcref/cwnd-class.md) object that is the parent window of the rebar control. It must not be **NULL**.  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#3](../mfcref/codesnippet/CPP/crebarctrl-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#4](../mfcref/codesnippet/CPP/crebarctrl-class_2.cpp)]  
  
##  <a name="crebarctrl__dragmove"></a>  CReBarCtrl::DragMove  
 Implements the behavior of the Win32 message                 [RB_DRAGMOVE](https://msdn.microsoft.com/en-us/library/bb774433.aspx), as described in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
...
### Return Value  
 A pointer to a [CImageList](../mfcref/cimagelist-class.md) object. Returns **NULL** if no image list is set for the control.  
...
### Return Value  
 A pointer to a [CPalette](../mfcref/cpalette-class.md) object specifying the rebar control's current palette.  
  
### Remarks  
 Note that this member function uses a `CPalette` object as its return value, rather than an `HPALETTE`.  
  
### Example  
 [!code[NVC_MFC_CReBarCtrl#5](../mfcref/codesnippet/CPP/crebarctrl-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#6](../mfcref/codesnippet/CPP/crebarctrl-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#7](../mfcref/codesnippet/CPP/crebarctrl-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#8](../mfcref/codesnippet/CPP/crebarctrl-class_6.cpp)]  
...
### Return Value  
 A pointer to a [CToolTipCtrl](../mfcref/ctooltipctrl-class.md) object.  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#9](../mfcref/codesnippet/CPP/crebarctrl-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#10](../mfcref/codesnippet/CPP/crebarctrl-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#11](../mfcref/codesnippet/CPP/crebarctrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#12](../mfcref/codesnippet/CPP/crebarctrl-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#13](../mfcref/codesnippet/CPP/crebarctrl-class_11.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CReBarCtrl_s1#1](../mfcref/codesnippet/CPP/crebarctrl-class_12.h)]  
  
### Example  
 The following code example sets each rebar band to be the same width.  
  
 [!code[NVC_MFC_CReBarCtrl_s1#2](../mfcref/codesnippet/CPP/crebarctrl-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#14](../mfcref/codesnippet/CPP/crebarctrl-class_14.cpp)]  
...
### Parameters  
 `pImageList`  
 A pointer to a [CImageList](../mfcref/cimagelist-class.md) object containing the image list to be assigned to the rebar control.  
...
### Return Value  
 A pointer to a [CWnd](../mfcref/cwnd-class.md) object that is the current owner of the rebar control.  
...
### Return Value  
 A pointer to a [CPalette](../mfcref/cpalette-class.md) object specifying the rebar control's previous palette.  
...
### Parameters  
 `rect`  
 A reference to a [CRect](../atl/crect-class.md) object that specifies the rectangle that the rebar control should be sized to.  
