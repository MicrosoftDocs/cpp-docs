...
### Example  
 [!code[NVC_MFCControlLadenDialog#56](../mfc/codesnippet/CPP/canimatectrl-class_1.cpp)]  
...
### Parameters  
 ...
 `rect`  
 Specifies the animation control's position and size. It can be either a [CRect](../atl/crect-class.md) object or a RECT structure.  
...
### Remarks  
 ...
 Apply the following [window styles](../mfcref/window-styles.md) to an animation control.  
