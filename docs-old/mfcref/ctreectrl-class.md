...
##  <a name="ctreectrl__create"></a>  CTreeCtrl::Create  
 If you specify the tree control in a dialog box template, or if you are using [CTreeView](../mfcref/ctreeview-class.md), your tree control is created automatically when the dialog box or view is created.  
...
### Parameters  
 ...
 `rect`  
 Specifies the tree view control's size and position. It can be either a [CRect](../atl/crect-class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure.  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#1](../mfcref/codesnippet/CPP/ctreectrl-class_1.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFC_CTreeCtrl#2](../mfcref/codesnippet/CPP/ctreectrl-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#3](../mfcref/codesnippet/CPP/ctreectrl-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#4](../mfcref/codesnippet/CPP/ctreectrl-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#5](../mfcref/codesnippet/CPP/ctreectrl-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#6](../mfcref/codesnippet/CPP/ctreectrl-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#7](../mfcref/codesnippet/CPP/ctreectrl-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#8](../mfcref/codesnippet/CPP/ctreectrl-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#9](../mfcref/codesnippet/CPP/ctreectrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#10](../mfcref/codesnippet/CPP/ctreectrl-class_10.cpp)]  
...
### Remarks  
 ...
 For more information on image lists, see the [CImageList](../mfcref/cimagelist-class.md) class.  
  
### Example  
 [!code[NVC_MFC_CTreeCtrl#11](../mfcref/codesnippet/CPP/ctreectrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#12](../mfcref/codesnippet/CPP/ctreectrl-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#13](../mfcref/codesnippet/CPP/ctreectrl-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#14](../mfcref/codesnippet/CPP/ctreectrl-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#15](../mfcref/codesnippet/CPP/ctreectrl-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#16](../mfcref/codesnippet/CPP/ctreectrl-class_16.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#1](../mfcref/codesnippet/CPP/ctreectrl-class_17.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#5](../mfcref/codesnippet/CPP/ctreectrl-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#17](../mfcref/codesnippet/CPP/ctreectrl-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#18](../mfcref/codesnippet/CPP/ctreectrl-class_20.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#6](../mfcref/codesnippet/CPP/ctreectrl-class_21.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#19](../mfcref/codesnippet/CPP/ctreectrl-class_22.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl#20](../mfcref/codesnippet/CPP/ctreectrl-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#21](../mfcref/codesnippet/CPP/ctreectrl-class_24.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#22](../mfcref/codesnippet/CPP/ctreectrl-class_25.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#23](../mfcref/codesnippet/CPP/ctreectrl-class_26.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#24](../mfcref/codesnippet/CPP/ctreectrl-class_27.cpp)]  
...
### Return Value  
 A pointer to a [CToolTipCtrl](../mfcref/ctooltipctrl-class.md) object to be used by the tree control. If the [Create](#ctreectrl__create) member function uses the style **TVS_NOTOOLTIPS**, no tooltips are used, and **NULL** is returned.  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#25](../mfcref/codesnippet/CPP/ctreectrl-class_28.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#26](../mfcref/codesnippet/CPP/ctreectrl-class_29.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#27](../mfcref/codesnippet/CPP/ctreectrl-class_30.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#2](../mfcref/codesnippet/CPP/ctreectrl-class_31.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#28](../mfcref/codesnippet/CPP/ctreectrl-class_32.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#4](../mfcref/codesnippet/CPP/ctreectrl-class_33.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#29](../mfcref/codesnippet/CPP/ctreectrl-class_34.cpp)]  
  
### Example  
 To use checkboxes, set TVS_CHECKBOXES before populating the tree control.  
  
 [!code[NVC_MFC_CTreeCtrl#30](../mfcref/codesnippet/CPP/ctreectrl-class_35.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#3](../mfcref/codesnippet/CPP/ctreectrl-class_36.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#31](../mfcref/codesnippet/CPP/ctreectrl-class_37.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#32](../mfcref/codesnippet/CPP/ctreectrl-class_38.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#33](../mfcref/codesnippet/CPP/ctreectrl-class_39.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#8](../mfcref/codesnippet/CPP/ctreectrl-class_40.cpp)]  
...
### Remarks  
 ...
 For more information on images, see [CImageList](../mfcref/cimagelist-class.md).  
...
### Example  
 ...
 [!code[NVC_MFC_CTreeCtrl_s1#7](../mfcref/codesnippet/CPP/ctreectrl-class_41.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#34](../mfcref/codesnippet/CPP/ctreectrl-class_42.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#35](../mfcref/codesnippet/CPP/ctreectrl-class_43.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#36](../mfcref/codesnippet/CPP/ctreectrl-class_44.cpp)]  
...
### Parameters  
 `pWndTip`  
 A pointer to a [CToolTipCtrl](../mfcref/ctooltipctrl-class.md) object that the tree control will use.  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#37](../mfcref/codesnippet/CPP/ctreectrl-class_45.cpp)]  
...
### Example  
 [!code[NVC_MFC_CTreeCtrl#38](../mfcref/codesnippet/CPP/ctreectrl-class_46.cpp)]  
  
 [!code[NVC_MFC_CTreeCtrl#39](../mfcref/codesnippet/CPP/ctreectrl-class_47.cpp)]  
