...
### Remarks  
 ...
 The constructor with a `CBitmap` parameter constructs a patterned brush. The parameter identifies a bitmap. The bitmap is assumed to have been created by using [CBitmap::CreateBitmap](../mfcref/cbitmap-class.md#cbitmap__createbitmap), [CBitmap::CreateBitmapIndirect](../mfcref/cbitmap-class.md#cbitmap__createbitmapindirect), [CBitmap::LoadBitmap](../mfcref/cbitmap-class.md#cbitmap__loadbitmap), or [CBitmap::CreateCompatibleBitmap](../mfcref/cbitmap-class.md#cbitmap__createcompatiblebitmap). The minimum size for a bitmap to be used in a fill pattern is 8 pixels by 8 pixels.  
  
### Example  
 [!code[NVC_MFCDocView#21](../mfc/codesnippet/CPP/cbrush-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#22](../mfc/codesnippet/CPP/cbrush-class_2.cpp)]  
 ...
 *nUsage*  
 Specifies whether the **bmiColors[]** fields of the [BITMAPINFO](../mfcref/bitmapinfo-structure.md) data structure (a part of the "packed DIB") contain explicit RGB values or indices into the currently realized logical palette. The parameter must be one of the following values:  
...
### Example  
 [!code[NVC_MFCDocView#23](../mfc/codesnippet/CPP/cbrush-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#24](../mfc/codesnippet/CPP/cbrush-class_4.cpp)]  
...
### Remarks  
 The brush can subsequently be selected for any device context that supports raster operations. The bitmap identified by `pBitmap` is typically initialized by using the [CBitmap::CreateBitmap](../mfcref/cbitmap-class.md#cbitmap__createbitmap), [CBitmap::CreateBitmapIndirect](../mfcref/cbitmap-class.md#cbitmap__createbitmapindirect), [CBitmap::LoadBitmap](../mfcref/cbitmap-class.md#cbitmap__loadbitmap), or [CBitmap::CreateCompatibleBitmap](../mfcref/cbitmap-class.md#cbitmap__createcompatiblebitmap) function.  
...
### Example  
 [!code[NVC_MFCDocView#25](../mfc/codesnippet/CPP/cbrush-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#26](../mfc/codesnippet/CPP/cbrush-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#27](../mfc/codesnippet/CPP/cbrush-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#28](../mfc/codesnippet/CPP/cbrush-class_8.cpp)]  
