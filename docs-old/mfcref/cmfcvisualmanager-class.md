...
|[CMFCVisualManager::OnDrawBrowseButton](#cmfcvisualmanager__ondrawbrowsebutton)|Called by the framework when it draws a browse button that belongs to an edit control ( [CMFCEditBrowseCtrl Class](../mfcref/cmfceditbrowsectrl-class.md)).|  
...
|[CMFCVisualManager::OnDrawEditBorder](#cmfcvisualmanager__ondraweditborder)|Called by the framework when it draws a border around a [CMFCToolBarEditBoxButton](../mfcref/cmfctoolbareditboxbutton-class.md) object.|  
...
|[CMFCVisualManager::OnDrawPaneBorder](#cmfcvisualmanager__ondrawpaneborder)|Called by the framework when it draws the border of a [CPane Class](../mfcref/cpane-class.md).|  
...
|[CMFCVisualManager::OnDrawRibbonProgressBar](#cmfcvisualmanager__ondrawribbonprogressbar)|Called by the framework when it draws a [CMFCRibbonProgressBar](../mfcref/cmfcribbonprogressbar-class.md) object.|  
...
|[CMFCVisualManager::OnDrawRibbonSliderChannel](#cmfcvisualmanager__ondrawribbonsliderchannel)|Called by the framework when it draws the channel of a [CMFCRibbonSlider](../mfcref/cmfcribbonslider-class.md) object.|  
...
|[CMFCVisualManager::OnDrawTab](#cmfcvisualmanager__ondrawtab)|Called by the framework when it draws a [CMFCTabCtrl](../mfcref/cmfctabctrl-class.md) object.|  
...
|[CMFCVisualManager::OnFillTasksGroupInterior](#cmfcvisualmanager__onfilltasksgroupinterior)|Called by the framework when it fills the interior of a [CMFCTasksPaneTaskGroup](../mfcref/cmfctaskspanetaskgroup-class.md) object on the [CMFCTasksPane](../mfcref/cmfctaskspane-class.md).|  
...
## Remarks  
 ...
 To change the appearance of your application you must use other classes that provide methods for drawing all of the visual elements of your application. Some examples of these classes are [CMFCVisualManagerOfficeXP Class](../mfcref/cmfcvisualmanagerofficexp-class.md), [CMFCVisualManagerOffice2003 Class](../mfcref/cmfcvisualmanageroffice2003-class.md), and [CMFCVisualManagerOffice2007 Class](../mfcref/cmfcvisualmanageroffice2007-class.md). When you want to change the appearance of your application, pass one of these visual managers into the method `SetDefaultManager`. For an example that demonstrates how your application can mimic the appearance of Microsoft Office 2003, see [CMFCVisualManagerOffice2003 Class](../mfcref/cmfcvisualmanageroffice2003-class.md).  
...
## Example  
 The following example demonstrates how to retrieve the default values of a `CMFCVisualManager` object. This code snippet is part of the [Tasks Pane sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_TasksPane#1](../mfcref/codesnippet/CPP/cmfcvisualmanager-class_1.h)]  
...
### Return Value  
 A [CSize](../atl/csize-class.md) object that contains the extra size of the border for toolbar buttons.  
...
##  <a name="cmfcvisualmanager__getinstance"></a>  CMFCVisualManager::GetInstance  
 Returns a pointer to the current [CMFCVisualManager Class](../mfcref/cmfcvisualmanager-class.md) object for the application.  
...
### Return Value  
 A [CSize](../atl/csize-class.md) parameter that indicate the size of the system buttons.  
...
### Remarks  
 The text color of a [CMFCToolBarButton Class](../mfcref/cmfctoolbarbutton-class.md) object depends on the state of the button. The possible states of a toolbar button are `ButtonsIsRegular`, `ButtonsIsPressed`, or `ButtonsIsHighlighted`.  
...
### Remarks  
 This method is called by [CMFCToolBarImages::Draw](../mfcref/cmfctoolbarimages-class.md#cmfctoolbarimages__draw) when it draws an image on the toolbar that is unavailable.  
...
### Remarks  
 The [CMFCPopupMenu Class](../mfcref/cmfcpopupmenu-class.md) calls this method when it has to draw the menu and shadow. By default, this method returns `FALSE`. If you want to use pop-up menus similar to the pop-up menus in Office XP, override this method in a custom visual manager and return `TRUE`.  
...
### Parameters  
 ...
 [in] `rectBorderSize`  
 A [CRect](../atl/crect-class.md) parameter that contains the sizes of the borders.  
...
### Remarks  
 The default implementation of this method displays the standard gripper. To customize the appearance of the gripper, override this method in a custom class derived from the [CMFCVisualManager Class](../mfcref/cmfcvisualmanager-class.md).  
...
### Remarks  
 Override this function in a derived class if you want to customize the appearance of browse buttons in instances of the [CMFCEditBrowseCtrl Class](../mfcref/cmfceditbrowsectrl-class.md). The possible values for the state of the button are `ButtonsIsRegular`, `ButtonsIsPressed`, and `ButtonsIsHighlighted`.  
...
##  <a name="cmfcvisualmanager__ondrawcaptionbutton"></a>  CMFCVisualManager::OnDrawCaptionButton  
 The framework calls this method when it draws a [CMFCCaptionButton](../mfcref/cmfccaptionbutton-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawcomboborder"></a>  CMFCVisualManager::OnDrawComboBorder  
 The framework calls this method when it draws the border around an instance of the [CMFCToolBarComboBoxButton Class](../mfcref/cmfctoolbarcomboboxbutton-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawcombodropbutton"></a>  CMFCVisualManager::OnDrawComboDropButton  
 The framework calls this method when it draws the drop button of a [CMFCToolBarComboBoxButton](../mfcref/cmfctoolbarcomboboxbutton-class.md).  
...
##  <a name="cmfcvisualmanager__ondraweditborder"></a>  CMFCVisualManager::OnDrawEditBorder  
 The framework calls this method when it draws the border around an instance of the [CMFCToolBarEditBoxButton Class](../mfcref/cmfctoolbareditboxbutton-class.md).  
...
### Parameters  
 [in] `pCtrl`  
 A pointer to a header control. The visual manager draws the sort arrow of this [CMFCHeaderCtrl Class](../mfcref/cmfcheaderctrl-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawmenuborder"></a>  CMFCVisualManager::OnDrawMenuBorder  
 The framework calls this method when it draws the border of a [CMFCPopupMenu](../mfcref/cmfcpopupmenu-class.md).  
...
### Remarks  
 ...
 The default implementation for this method calls [CDC::DrawFrameControl](../mfcref/cdc-class.md#cdc__drawframecontrol) with the `DFC_CAPTION` type. Override this method in your derived visual manager class to customize the appearance of system buttons.  
...
##  <a name="cmfcvisualmanager__ondrawpanecaption"></a>  CMFCVisualManager::OnDrawPaneCaption  
 The framework calls this method when it draws a caption for an instance of the [CDockablePane Class](../mfcref/cdockablepane-class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton](../mfcref/cmfcribbonbutton-class.md) object. The framework draws the border for this ribbon button.  
...
##  <a name="cmfcvisualmanager__ondrawribboncategory"></a>  CMFCVisualManager::OnDrawRibbonCategory  
 The framework calls this method when it draws a [CMFCRibbonCategory](../mfcref/cmfcribboncategory-class.md) object.  
...
### Remarks  
 A ribbon category is a logical grouping of menu commands. For more information about ribbon categories, see [CMFCRibbonCategory Class](../mfcref/cmfcribboncategory-class.md).  
...
### Parameters  
 ...
 [in] `pContextCaption`  
 A pointer to a caption bar. The visual manager draws this [CMFCRibbonContextCaption Class](../mfcref/cmfcribboncontextcaption-class.md) object.  
...
### Remarks  
 Override this method in a derived class to customize the appearance of the caption bar for a ribbon category. For more information about the caption bar, see [CMFCRibbonContextCaption Class](../mfcref/cmfcribboncontextcaption-class.md).  
...
### Remarks  
 Override this method in a derived visual manager to customize the appearance of a ribbon category tab. For more information about ribbon categories, see [CMFCRibbonCategory Class](../mfcref/cmfcribboncategory-class.md).  
...
### Parameters  
 ...
 [in] `pLabel`  
 A pointer to a [CMFCRibbonLabel](../mfcref/cmfcribbonlabel-class.md) object. The framework draws this ribbon label.  
...
##  <a name="cmfcvisualmanager__ondrawribbonmainpanelbuttonborder"></a>  CMFCVisualManager::OnDrawRibbonMainPanelButtonBorder  
 The framework calls this method when it draws the border of a [CMFCRibbonButton](../mfcref/cmfcribbonbutton-class.md) that is positioned on the **Main** panel.  
...
##  <a name="cmfcvisualmanager__ondrawribbonmainpanelframe"></a>  CMFCVisualManager::OnDrawRibbonMainPanelFrame  
 The framework calls this method when it draws the frame around the [CMFCRibbonMainPanel](../mfcref/cmfcribbonmainpanel-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawribbonpanel"></a>  CMFCVisualManager::OnDrawRibbonPanel  
 The framework calls this method when it draws a [CMFCRibbonPanel](../mfcref/cmfcribbonpanel-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawribbonpanelcaption"></a>  CMFCVisualManager::OnDrawRibbonPanelCaption  
 The framework calls this method when it draws the caption of a [CMFCRibbonPanel Class](../mfcref/cmfcribbonpanel-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawribbonprogressbar"></a>  CMFCVisualManager::OnDrawRibbonProgressBar  
 The framework calls this method when it draws a [CMFCRibbonProgressBar Class](../mfcref/cmfcribbonprogressbar-class.md).  
...
### Parameters  
 ...
 [in] `pSeparator`  
 A pointer to a [CMFCRibbonSeparator](../mfcref/cmfcribbonseparator-class.md) object. The framework draws this ribbon separator.  
...
##  <a name="cmfcvisualmanager__ondrawribbonsliderthumb"></a>  CMFCVisualManager::OnDrawRibbonSliderThumb  
 The framework calls this method when it draws the thumb of a [CMFCRibbonSlider](../mfcref/cmfcribbonslider-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawribbonsliderzoombutton"></a>  CMFCVisualManager::OnDrawRibbonSliderZoomButton  
 The framework calls this method when it draws the zoom buttons for a [CMFCRibbonSlider](../mfcref/cmfcribbonslider-class.md) object.  
...
### Parameters  
 ...
 [in] `pPane`  
 A pointer to a status bar pane. The framework draws this [CMFCRibbonStatusBarPane](../mfcref/cmfcribbonstatusbarpane-class.md) object.  
...
### Parameters  
 ...
 `pWndRibbonBar`  
 A pointer to a [CMFCRibbonBar](../mfcref/cmfcribbonbar-class.md) object. The framework draws the frame for this ribbon bar.  
...
##  <a name="cmfcvisualmanager__ondrawspinbuttons"></a>  CMFCVisualManager::OnDrawSpinButtons  
 The framework calls this method when it draws an instance of the [CMFCSpinButtonCtrl Class](../mfcref/cmfcspinbuttonctrl-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawstatusbarpaneborder"></a>  CMFCVisualManager::OnDrawStatusBarPaneBorder  
 The framework calls this method when it draws the border for a [CMFCStatusBar](../mfcref/cmfcstatusbar-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawstatusbarprogress"></a>  CMFCVisualManager::OnDrawStatusBarProgress  
 The framework calls this method when it draws the progress indicator on the [CMFCStatusBar](../mfcref/cmfcstatusbar-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawstatusbarsizebox"></a>  CMFCVisualManager::OnDrawStatusBarSizeBox  
 The framework calls this method when it draws the size box for a [CMFCStatusBar](../mfcref/cmfcstatusbar-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawtab"></a>  CMFCVisualManager::OnDrawTab  
 The framework calls this method when it draws the tabs for a [CMFCBaseTabCtrl](../mfcref/cmfcbasetabctrl-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawtabcontent"></a>  CMFCVisualManager::OnDrawTabContent  
 The framework calls this method when it draws the contents located on the interior of an instance of the [CMFCBaseTabCtrl Class](../mfcref/cmfcbasetabctrl-class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCButton](../mfcref/cmfcbutton-class.md) object. The framework draws the border for this `CMFCButton` instance.  
...
##  <a name="cmfcvisualmanager__ondrawtask"></a>  CMFCVisualManager::OnDrawTask  
 The framework calls this method when it draws a [CMFCTasksPane](../mfcref/cmfctaskspane-class.md) object.  
...
### Parameters  
 ...
 [in] `pTask`  
 A pointer to a [CMFCTasksPaneTask](../mfcref/cmfctaskspanetask-class.md) object. The framework draws this task.  
...
##  <a name="cmfcvisualmanager__ondrawtasksgroupareaborder"></a>  CMFCVisualManager::OnDrawTasksGroupAreaBorder  
 The framework calls this method when it draws a border around a group on a [CMFCTasksPane Class](../mfcref/cmfctaskspane-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawtasksgroupcaption"></a>  CMFCVisualManager::OnDrawTasksGroupCaption  
 The framework calls this method when it draws the caption for a [CMFCTasksPaneTaskGroup](../mfcref/cmfctaskspanetaskgroup-class.md) object.  
...
### Remarks  
 The task groups appear on the [CMFCTasksPane](../mfcref/cmfctaskspane-class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawtearoffcaption"></a>  CMFCVisualManager::OnDrawTearOffCaption  
 The framework calls this method when it draws the caption for a [CMFCPopupMenu Class](../mfcref/cmfcpopupmenu-class.md).  
...
### Remarks  
 The framework erases the text and icon for a button when a [CMFCBaseTabCtrl](../mfcref/cmfcbasetabctrl-class.md) object processes the `WM_ERASEBKGND` message.  
...
##  <a name="cmfcvisualmanager__onerasetabsframe"></a>  CMFCVisualManager::OnEraseTabsFrame  
 The framework calls this method when it erases a frame on a [CMFCBaseTabCtrl Class](../mfcref/cmfcbasetabctrl-class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCAutoHideButton](../mfcref/cmfcautohidebutton-class.md) object. The framework fills the background for this auto-hide button.  
...
##  <a name="cmfcvisualmanager__onfillbarbackground"></a>  CMFCVisualManager::OnFillBarBackground  
 The framework calls this method when it fills the background of a [CBasePane](../mfcref/cbasepane-class.md) object.  
...
### Example  
 The following example demonstrates how to use the `OnFillBarBackground` in the `CMFCVisualManager` class. This code snippet is part of the [Outlook Demo sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_OutlookDemo#4](../mfcref/codesnippet/CPP/cmfcvisualmanager-class_2.cpp)]  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCToolBarButton](../mfcref/cmfctoolbarbutton-class.md). The framework fills the background for this button.  
...
### Parameters  
 [in] `pCtrl`  
 A pointer to a [CMFCHeaderCtrl](../mfcref/cmfcheaderctrl-class.md) object. The framework fills the background for this header control.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton](../mfcref/cmfcribbonbutton-class.md) object. The framework fills the interior of this ribbon button.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton Class](../mfcref/cmfcribbonbutton-class.md) object. The framework fills this ribbon button.  
...
### Parameters  
 ...
 [in] `pPanel`  
 A pointer to an instance of the [CMFCRibbonMainPanel Class](../mfcref/cmfcribbonmainpanel-class.md). The framework fills the menu frame for this ribbon panel.  
...
##  <a name="cmfcvisualmanager__onfilltasksgroupinterior"></a>  CMFCVisualManager::OnFillTasksGroupInterior  
 The framework calls this method when it fills the interior of a [CMFCTasksPaneTaskGroup](../mfcref/cmfctaskspanetaskgroup-class.md) object.  
...
##  <a name="cmfcvisualmanager__onfilltaskspanebackground"></a>  CMFCVisualManager::OnFillTasksPaneBackground  
 The framework calls this method when it fills the background of a [CMFCTasksPane](../mfcref/cmfctaskspane-class.md) control.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCToolBarMenuButton](../mfcref/cmfctoolbarmenubutton-class.md) object to display. The default implementation does not use this parameter.  
...
##  <a name="cmfcvisualmanager__setshadowhighlightedimage"></a>  CMFCVisualManager::SetShadowHighlightedImage  
 Sets a flag that indicates whether the [CMFCVisualManager](../mfcref/cmfcvisualmanager-class.md) displays shadows for highlighted images.  
