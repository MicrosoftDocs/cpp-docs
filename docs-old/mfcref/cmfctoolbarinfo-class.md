...
---
# CMFCToolBarInfo Class
Contains the resource IDs of toolbar images in various states. `CMFCToolBarInfo` is a helper class that is used as a parameter of the [CMFCToolBar::LoadToolBarEx](../mfcref/cmfctoolbar-class.md#cmfctoolbar__loadtoolbarex) method.  
...
## Inheritance Hierarchy  
 [CMFCToolBarInfo](../mfcref/cmfctoolbarinfo-class.md)  
...
## See Also  
 ...
 [CMFCToolBar::LoadToolBarEx](../mfcref/cmfctoolbar-class.md#cmfctoolbar__loadtoolbarex)