...
---
# CTabView Class
The `CTabView` class simplifies the use of the tab control class ( [CMFCTabCtrl](../mfcref/ctabview-class.md)) in applications that use MFC's document/view architecture.  
...
## Remarks  
 ...
 [TabbedView Sample: MFC Tabbed View Application](../top/visual-c---samples.md) illustrates usage of `CTabView`.  
  
## Example  
 The following example shows how `CTabView` is used in the TabbedView sample.  
  
 [!code[NVC_MFC_TabbedView#1](../mfcref/codesnippet/CPP/ctabview-class_1.h)]  
...
### Remarks  
 For more information see [CMFCTabCtrl::SetActiveTab](../mfcref/cmfctabctrl-class.md#cmfctabctrl__setactivetab).  
  
## See Also  
 [Hierarchy Chart](../mfc/hierarchy-chart.md)   
 [Classes](../mfcref/mfc-classes.md)   
 [CMFCTabCtrl](../mfcref/ctabview-class.md)   
