...
|Name|Description|  
|----------|-----------------|  
|[CLinearTransition::Create](#clineartransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../mfcref/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CLinearTransition](../mfcref/clineartransition-class.md)  
