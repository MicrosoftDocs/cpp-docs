...
## Remarks  
 ...
 ![Example of RebarMenu](../mfcref/media/vc4sc61.gif "vc4SC61")  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#1](../mfcref/codesnippet/CPP/crebar-class_1.cpp)]  
...
### Return Value  
 A reference to a [CReBarCtrl](../mfcref/crebarctrl-class.md) object.  
...
### Example  
 [!code[NVC_MFC_CReBarCtrl#2](../mfcref/codesnippet/CPP/crebar-class_2.cpp)]  
