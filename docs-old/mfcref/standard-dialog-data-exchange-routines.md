...
##  <a name="ddx_datetimectrl"></a>  DDX_DateTimeCtrl  
 The                 `DDX_DateTimeCtrl` function manages the transfer of date and/or time data between a date and time picker control (                [CDateTimeCtrl](../mfcref/cdatetimectrl-class.md)) in a dialog box or form view object and either a                 [CTime](../atl/ctime-class.md) or a                 [COleDateTime](../atl/coledatetime-class.md) data member of the dialog box or form view object.  
...
### Remarks  
 ...
 In the third version above,                         `DDX_DateTimeCtrl` manages the transfer of                         `CString` data between a date time control and a                         [CString](../atl/cstringt-class.md) data member of the control view object. The string is formatted using the current locale's rules for formatting dates and times.  
...
##  <a name="ddx_monthcalctrl"></a>  DDX_MonthCalCtrl  
 The                 `DDX_MonthCalCtrl` function manages the transfer of date data between a month calendar control (                [CMonthCalCtrl](../mfcref/cmonthcalctrl-class.md)) in a dialog box, form view, or control view object and either a                 [CTime](../atl/ctime-class.md) or a                 [COleDateTime](../atl/coledatetime-class.md) data member of the dialog box, form view, or control view object.  
...
##  <a name="ddx_text"></a>  DDX_Text  
 The                 `DDX_Text` function manages the transfer of                 `int`,                 **UINT**,                 **long**,                 `DWORD`,                 `CString`,                 **float**, or                 **double** data between an edit control in a dialog box, form view, or control view and a                 [CString](../atl/cstringt-class.md) data member of the dialog box, form view, or control view object.  
...
## See Also  
 [Standard Dialog Data Validation Routines](../mfcref/standard-dialog-data-validation-routines.md)   
