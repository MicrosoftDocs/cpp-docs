...
-   Knowledge Base article Q259949 : INFO: SetCaretPos() Is Not Appropriate with CEdit or CRichEditCtrl Controls  
 ...
 For an example of using a rich edit control in an MFC application, see the [WORDPAD](../top/visual-c---samples.md) sample application.  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#1](../mfcref/codesnippet/CPP/cricheditctrl-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#2](../mfcref/codesnippet/CPP/cricheditctrl-class_2.cpp)]  
...
### Parameters  
 `pt`  
 A [CPoint](../atl/cpoint-class.md) object containing the coordinates of the specified point.  
...
### Remarks  
 This member function works with a rich edit control. To get the information for an edit control, call [CEdit::CharFromPos](../mfcref/cedit-class.md#cedit__charfrompos).  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#3](../mfcref/codesnippet/CPP/cricheditctrl-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#4](../mfcref/codesnippet/CPP/cricheditctrl-class_4.cpp)]  
...
### Parameters  
 ...
 `rect`  
 Specifies the edit control's size and position. Can be a [CRect](../atl/crect-class.md) object or RECT structure.  
  
 `pParentWnd`  
 Specifies the edit control's parent window (often a [CDialog](../mfcref/cdialog-class.md)). It must not be **NULL**.  
...
### Remarks  
 ...
 When you create a rich edit control with this function, first you must load the necessary common controls library. To load the libary, call the global function [AfxInitRichEdit](../Topic/AfxInitRichEdit.md), which in turn initializes the common controls library. You need to call `AfxInitRichEdit` only once in your process.  
  
 When **Create** executes, Windows sends the [WM_NCCREATE](../mfcref/cwnd-class.md#cwnd__onnccreate), [WM_NCCALCSIZE](../mfcref/cwnd-class.md#cwnd__onnccalcsize), [WM_CREATE](../mfcref/cwnd-class.md#cwnd__oncreate), and [WM_GETMINMAXINFO](../mfcref/cwnd-class.md#cwnd__ongetminmaxinfo) messages to the edit control.  
  
 These messages are handled by default by the [OnNcCreate](../mfcref/cwnd-class.md#cwnd__onnccreate), [OnNcCalcSize](../mfcref/cwnd-class.md#cwnd__onnccalcsize), [OnCreate](../mfcref/cwnd-class.md#cwnd__oncreate), and [OnGetMinMaxInfo](../mfcref/cwnd-class.md#cwnd__ongetminmaxinfo) member functions in the `CWnd` base class. To extend the default message handling, derive a class from `CRichEditCtrl`, add a message map to the new class, and override the above message-handler member functions. Override `OnCreate`, for example, to perform needed initialization for the new class.  
  
 Apply the following [window styles](../mfcref/window-styles.md) to an edit control.  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#5](../mfcref/codesnippet/CPP/cricheditctrl-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#6](../mfcref/codesnippet/CPP/cricheditctrl-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#7](../mfcref/codesnippet/CPP/cricheditctrl-class_7.cpp)]  
...
### Parameters  
 `pDisplayRect`  
 Pointer to a RECT or [CRect](../atl/crect-class.md) object specifying the area of the device to display the text.  
...
### Remarks  
 ...
 The undo flag is automatically cleared whenever you call the [CWnd](../mfcref/cwnd-class.md) member function [SetWindowText](../mfcref/cwnd-class.md#cwnd__setwindowtext).  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#8](../mfcref/codesnippet/CPP/cricheditctrl-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#9](../mfcref/codesnippet/CPP/cricheditctrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#10](../mfcref/codesnippet/CPP/cricheditctrl-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#11](../mfcref/codesnippet/CPP/cricheditctrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#12](../mfcref/codesnippet/CPP/cricheditctrl-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#13](../mfcref/codesnippet/CPP/cricheditctrl-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#14](../mfcref/codesnippet/CPP/cricheditctrl-class_14.cpp)]  
...
### Parameters  
 `lpRect`  
 [CRect](../atl/crect-class.md) or pointer to a RECT to receive the formatting rectangle of this `CRichEditCtrl` object.  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#15](../mfcref/codesnippet/CPP/cricheditctrl-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#16](../mfcref/codesnippet/CPP/cricheditctrl-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#17](../mfcref/codesnippet/CPP/cricheditctrl-class_17.cpp)]  
...
### Parameters  
 ...
 `refString`  
 A reference to a [CString](../atl/cstringt-class.md) object that will receive the text.  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#18](../mfcref/codesnippet/CPP/cricheditctrl-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#19](../mfcref/codesnippet/CPP/cricheditctrl-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#20](../mfcref/codesnippet/CPP/cricheditctrl-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#21](../mfcref/codesnippet/CPP/cricheditctrl-class_21.cpp)]  
...
### Parameters  
 ...
 `nChars`  
 Specifies the number of character positions to scroll horizontally. This value is ignored if the rich edit control has either the **ES_RIGHT** or **ES_CENTER** style. [Edit styles](../mfcref/edit-styles.md) are specified in [Create](#cricheditctrl__create).  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#22](../mfcref/codesnippet/CPP/cricheditctrl-class_22.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#23](../mfcref/codesnippet/CPP/cricheditctrl-class_23.cpp)]  
...
### Remarks  
 To replace all the text in this `CRichEditCtrl` object, use [CWnd::SetWindowText](../mfcref/cwnd-class.md#cwnd__setwindowtext).  
...
### Remarks  
 This function is useful during [CWnd::OnSize](../mfcref/cwnd-class.md#cwnd__onsize) processing for a bottomless `CRichEditCtrl` object.  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#24](../mfcref/codesnippet/CPP/cricheditctrl-class_24.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#25](../mfcref/codesnippet/CPP/cricheditctrl-class_25.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#26](../mfcref/codesnippet/CPP/cricheditctrl-class_26.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#27](../mfcref/codesnippet/CPP/cricheditctrl-class_27.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#28](../mfcref/codesnippet/CPP/cricheditctrl-class_28.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#29](../mfcref/codesnippet/CPP/cricheditctrl-class_29.cpp)]  
...
### Parameters  
 `lpRect`  
 [CRect](../atl/crect-class.md) or pointer to a RECT that indicates the new bounds for the formatting rectangle.  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#30](../mfcref/codesnippet/CPP/cricheditctrl-class_30.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#31](../mfcref/codesnippet/CPP/cricheditctrl-class_31.cpp)]  
 ...
 *lLineWidth*  
 ...
 `dc`  
 [CDC](../mfcref/cdc-class.md) for the new target device.  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#32](../mfcref/codesnippet/CPP/cricheditctrl-class_32.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#33](../mfcref/codesnippet/CPP/cricheditctrl-class_33.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#34](../mfcref/codesnippet/CPP/cricheditctrl-class_34.cpp)]  
  
 [!code[NVC_MFC_CRichEditCtrl#35](../mfcref/codesnippet/CPP/cricheditctrl-class_35.cpp)]  
...
### Example  
 [!code[NVC_MFC_CRichEditCtrl#36](../mfcref/codesnippet/CPP/cricheditctrl-class_36.cpp)]  
  
 [!code[NVC_MFC_CRichEditCtrl#37](../mfcref/codesnippet/CPP/cricheditctrl-class_37.cpp)]  
...
## See Also  
 [MFC Sample WORDPAD](../top/visual-c---samples.md)   
