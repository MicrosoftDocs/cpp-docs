...
|Name|Description|  
|----------|-----------------|  
|[CCustomTransition::Create](#ccustomtransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../mfcref/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CCustomTransition](../mfcref/ccustomtransition-class.md)  
