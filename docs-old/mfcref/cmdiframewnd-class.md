...
## Remarks  
 ...
 You can construct an MDI frame window by calling the [Create](../mfcref/cframewnd-class.md#cframewnd__create) or [LoadFrame](../mfcref/cframewnd-class.md#cframewnd__loadframe) member function of `CFrameWnd`.  
 ...
 The `CMDIFrameWnd` class inherits much of its default implementation from `CFrameWnd`. For a detailed list of these features, refer to the [CFrameWnd](../mfcref/cframewnd-class.md) class description. The `CMDIFrameWnd` class has the following additional features:  
...
### Example  
 [!code[NVC_MFCWindowing#13](../mfcref/codesnippet/CPP/cmdiframewnd-class_1.cpp)]  
...
### Parameters  
 `lpCreateStruct`  
 A long pointer to a [CREATESTRUCT](../mfcref/createstruct-structure.md) structure.  
...
### Example  
 [!code[NVC_MFCWindowing#14](../mfcref/codesnippet/CPP/cmdiframewnd-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#15](../mfcref/codesnippet/CPP/cmdiframewnd-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#16](../mfcref/codesnippet/CPP/cmdiframewnd-class_4.cpp)]  
...
### Remarks  
 This member function sends the [WM_MDIACTIVATE](../mfcref/cwnd-class.md#cwnd__onmdiactivate) message to both the child window being activated and the child window being deactivated.  
...
> [!NOTE]
>  An MDI child window is activated independently of the MDI frame window. When the frame becomes active, the child window that was last activated is sent a [WM_NCACTIVATE](../mfcref/cwnd-class.md#cwnd__onncactivate) message to draw an active window frame and caption bar, but it does not receive another `WM_MDIACTIVATE` message.  
...
### Example  
 [!code[NVC_MFCWindowing#17](../mfcref/codesnippet/CPP/cmdiframewnd-class_5.cpp)]  
...
### Example  
 See the example for [CMDIChildWnd::MDIMaximize](../mfcref/cmdichildwnd-class.md#cmdichildwnd__mdimaximize).  
...
### Example  
 [!code[NVC_MFCWindowing#18](../mfcref/codesnippet/CPP/cmdiframewnd-class_6.cpp)]  
...
### Example  
 See the example for [CMDIChildWnd::MDIRestore](../mfcref/cmdichildwnd-class.md#cmdichildwnd__mdirestore).  
...
### Remarks  
 After calling `MDISetMenu`, an application must call the [DrawMenuBar](../mfcref/cwnd-class.md#cwnd__drawmenubar) member function of `CWnd` to update the menu bar.  
...
### Example  
 [!code[NVC_MFCWindowing#19](../mfcref/codesnippet/CPP/cmdiframewnd-class_7.cpp)]  
  
 [!code[NVC_MFCWindowing#20](../mfcref/codesnippet/CPP/cmdiframewnd-class_8.cpp)]  
