...
-   **dbCurrency** Currency; see MFC class [COleCurrency](../mfcref/colecurrency-class.md)  
  
-   **dbSingle** Single  
  
-   **dbDouble** Double  
  
-   **dbDate** Date/Time; see MFC class [COleDateTime](../atl/coledatetime-class.md)  
  
-   **dbText** Text; see MFC class [CString](../atl/cstringt-class.md)  
  
-   **dbLongBinary** Long Binary (OLE Object); you might want to use MFC class [CByteArray](../mfcref/cbytearray-class.md) instead of class `CLongBinary` as `CByteArray` is richer and easier to use.  
...
|**dbLongBinary**|0|Long Binary (OLE Object; [CByteArray](../mfcref/cbytearray-class.md); use instead of `CLongBinary`)|  
 ...
 *m_strSourceTable*  
 ...
 For related information about tabledefs, see the **m_strValidationRule** member of the [CDaoTableDefInfo](../mfcref/cdaotabledefinfo-structure.md) structure.  
...
## Remarks  
 ...
 Field objects are not represented by an MFC class. Instead, the DAO objects underlying MFC objects of the following classes contain collections of field objects: [CDaoTableDef](../mfcref/cdaotabledef-class.md), [CDaoRecordset](../mfcref/cdaorecordset-class.md), and [CDaoQueryDef](../mfcref/cdaoquerydef-class.md). These classes supply member functions to access some individual items of field information, or you can access them all at once with a `CDaoFieldInfo` object by calling the `GetFieldInfo` member function of the containing object.  
