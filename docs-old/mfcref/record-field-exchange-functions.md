...
|||  
|-|-|  
|[RFX_Binary](../Topic/RFX_Binary.md)|Transfers arrays of bytes of type [CByteArray](../mfcref/cbytearray-class.md).|  
|[RFX_Bool](../Topic/RFX_Bool.md)|Transfers Boolean data.|  
|[RFX_Byte](../Topic/RFX_Byte.md)|Transfers a single byte of data.|  
|[RFX_Date](../Topic/RFX_Date.md)|Transfers time and date data using [CTime](../atl/ctime-class.md) or **TIMESTAMP_STRUCT**.|  
...
|[RFX_LongBinary](../Topic/RFX_LongBinary.md)|Transfers binary large object (BLOB) data with an object of the [CLongBinary](../mfcref/clongbinary-class.md) class.|  
...
|||  
|-|-|  
|[DFX_Binary](../Topic/DFX_Binary.md)|Transfers arrays of bytes of type [CByteArray](../mfcref/cbytearray-class.md).|  
|[DFX_Bool](../Topic/DFX_Bool.md)|Transfers Boolean data.|  
|[DFX_Byte](../Topic/DFX_Byte.md)|Transfers a single byte of data.|  
|[DFX_Currency](../Topic/DFX_Currency.md)|Transfers currency data, of type [COleCurrency](../mfcref/colecurrency-class.md).|  
|[DFX_DateTime](../Topic/DFX_DateTime.md)|Transfers time and date data, of type [COleDateTime](../atl/coledatetime-class.md).|  
