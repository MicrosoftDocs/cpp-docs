...
|[CWinApp::DoMessageBox](#cwinapp__domessagebox)|Implements [AfxMessageBox](../Topic/AfxMessageBox.md) for the application.|  
...
|[CWinApp::RunAutomated](#cwinapp__runautomated)|Tests the application's command line for the                                         **/Automation** option. Obsolete. Instead, use the value in [CCommandLineInfo::m_bRunAutomated](../mfcref/ccommandlineinfo-class.md#ccommandlineinfo__m_brunautomated) after calling [ParseCommandLine](#cwinapp__parsecommandline).|  
|[CWinApp::RunEmbedded](#cwinapp__runembedded)|Tests the application's command line for the                                         **/Embedding** option. Obsolete. Instead, use the value in [CCommandLineInfo::m_bRunEmbedded](../mfcref/ccommandlineinfo-class.md#ccommandlineinfo__m_brunembedded) after calling [ParseCommandLine](#cwinapp__parsecommandline).|  
...
-   [AfxGetApp](../Topic/AfxGetApp.md) Obtains a pointer to the `CWinApp` object.  
  
-   [AfxGetInstanceHandle](../Topic/AfxGetInstanceHandle.md) Obtains a handle to the current application instance.  
  
-   [AfxGetResourceHandle](../Topic/AfxGetResourceHandle.md) Obtains a handle to the application's resources.  
  
-   [AfxGetAppName](../Topic/AfxGetAppName.md) Obtains a pointer to a string containing the application's name. Alternately, if you have a pointer to the `CWinApp` object, use `m_pszExeName` to get the application's name.  
...
### Example  
 [!code[NVC_MFCWindowing#35](../mfcref/codesnippet/CPP/cwinapp-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#36](../mfcref/codesnippet/CPP/cwinapp-class_2.cpp)]  
...
### Remarks  
 ...
 To customize the behavior, override this function in a derived [CWinApp Class](../mfcref/cwinapp-class.md) or pass your own application recovery method as a parameter to [CWinApp::RegisterWithRestartManager](#cwinapp__registerwithrestartmanager).  
...
### Remarks  
 ...
 If the function is successful, when you have finished printing, you must destroy the device context. You can let the destructor of the [CDC](../mfcref/cdc-class.md) object do it, or you can do it explicitly by calling [CDC::DeleteDC](../mfcref/cdc-class.md#cdc__deletedc).  
...
LONG DelRegTree(  
    HKEY hParentKey, const CString& strKeyName, CAtlTransactionManager* pTM = NULL );  
```  
...
##  <a name="cwinapp__domessagebox"></a>  CWinApp::DoMessageBox  
 The framework calls this member function to implement a message box for the global function [AfxMessageBox](../Topic/AfxMessageBox.md).  
 ...
 *lpszPrompt*  
 ...
 `nType`  
 The message box [style](../mfcref/message-box-styles.md).  
...
##  <a name="cwinapp__dowaitcursor"></a>  CWinApp::DoWaitCursor  
 This member function is called by the framework to implement [CWaitCursor](../mfcref/cwaitcursor-class.md), [CCmdTarget::BeginWaitCursor](../mfcref/ccmdtarget-class.md#ccmdtarget__beginwaitcursor), [CCmdTarget::EndWaitCursor](../mfcref/ccmdtarget-class.md#ccmdtarget__endwaitcursor), and [CCmdTarget::RestoreWaitCursor](../mfcref/ccmdtarget-class.md#ccmdtarget__restorewaitcursor).  
...
### Example  
 [!code[NVC_MFCWindowing#37](../mfcref/codesnippet/CPP/cwinapp-class_3.cpp)]  
  
##  <a name="cwinapp__enabled2dsupport"></a>  CWinApp::EnableD2DSupport  
 [!INCLUDE[dev10_sp1required](../mfcref/includes/dev10_sp1required_md.md)]  
...
### Example  
 [!code[NVC_MFCWindowing#38](../mfcref/codesnippet/CPP/cwinapp-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#39](../mfcref/codesnippet/CPP/cwinapp-class_5.cpp)]  
...
### Remarks  
 Each application that uses the restart manager must have one instance of the [CDataRecoveryHandler Class](../mfcref/cdatarecoveryhandler-class.md). This class is responsible for monitoring open documents and autosaving files. The behavior of the `CDataRecoveryHandler` depends on the configuration of the restart manager. For more information, see [CDataRecoveryHandler Class](../mfcref/cdatarecoveryhandler-class.md).  
  
 This method returns `NULL` on operating systems earlier than [!INCLUDE[wiprlhext](../crt/includes/wiprlhext_md.md)]. The restart manager is not supported on operating systems earlier than [!INCLUDE[wiprlhext](../crt/includes/wiprlhext_md.md)].  
...
### Remarks  
 Use the **POSITION** value returned in a call to [GetNextDocTemplate](#cwinapp__getnextdoctemplate) to get the first [CDocTemplate](../mfcref/cdoctemplate-class.md) object.  
...
### Return Value  
 A pointer to a [CDocTemplate](../mfcref/cdoctemplate-class.md) object.  
...
### Example  
 [!code[NVC_MFCWindowing#40](../mfcref/codesnippet/CPP/cwinapp-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#41](../mfcref/codesnippet/CPP/cwinapp-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#42](../mfcref/codesnippet/CPP/cwinapp-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#43](../mfcref/codesnippet/CPP/cwinapp-class_9.cpp)]  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the `uCommand` parameter described in [About the HTMLHelp API Function](vsconhowcallingthehtmlhelpapi) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCListView#9](../atl/codesnippet/CPP/cwinapp-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#44](../mfcref/codesnippet/CPP/cwinapp-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#45](../mfcref/codesnippet/CPP/cwinapp-class_12.h)]  
  
 [!code[NVC_MFCWindowing#46](../mfcref/codesnippet/CPP/cwinapp-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#47](../mfcref/codesnippet/CPP/cwinapp-class_14.cpp)]  
...
|-   `AFX_RESTART_MANAGER_REOPEN_PREVIOUS_FILES`|The restart manager opens previously open documents after restarting the application from an unexpected exit. The [CDataRecoveryHandler Class](../mfcref/cdatarecoveryhandler-class.md) handles storing the list of open documents and restoring them.|  
...
### Remarks  
 The `m_hInstance` data member is a handle to the current instance of the application running under Windows. This is returned by the global function [AfxGetInstanceHandle](../Topic/AfxGetInstanceHandle.md). `m_hInstance` is a public variable of type `HINSTANCE`.  
  
### Example  
 [!code[NVC_MFCWindowing#55](../mfcref/codesnippet/CPP/cwinapp-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#52](../mfcref/codesnippet/CPP/cwinapp-class_16.cpp)]  
...
### Remarks  
 You should pass `m_nCmdShow` as an argument when you call [CWnd::ShowWindow](../mfcref/cwnd-class.md#cwnd__showwindow) for your application's main window. `m_nCmdShow` is a public variable of type `int`.  
  
### Example  
 [!code[NVC_MFCWindowing#56](../mfcref/codesnippet/CPP/cwinapp-class_17.cpp)]  
...
### Remarks  
 The data recovery handler of an application monitors open documents and autosaves them. The framework uses the data recovery handler to restore autosaved files when an application restarts after it exits unexpectedly. For more information, see [CDataRecoveryHandler Class](../mfcref/cdatarecoveryhandler-class.md).  
...
### Remarks  
 ...
 Returned by the global function [AfxGetAppName](../Topic/AfxGetAppName.md). `m_pszAppName` is a public variable of type **const char\***.  
...
>  If you assign a value to `m_pszAppName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#57](../mfcref/codesnippet/CPP/cwinapp-class_18.cpp)]  
  
### Example  
 [!code[NVC_MFCWindowing#65](../mfcref/codesnippet/CPP/cwinapp-class_19.cpp)]  
...
>  If you assign a value to `m_pszExeName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#58](../mfcref/codesnippet/CPP/cwinapp-class_20.cpp)]  
...
>  If you assign a value to `m_pszHelpFilePath`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#59](../mfcref/codesnippet/CPP/cwinapp-class_21.cpp)]  
...
>  If you assign a value to `m_pszProfileName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code[NVC_MFCWindowing#60](../mfcref/codesnippet/CPP/cwinapp-class_22.cpp)]  
...
-   The value is stored to a registry key. The name for the application profile setting is appended to the following registry key: HKEY_CURRENT_USER/Software/LocalAppWizard-Generated/.  
 ...
 [!code[NVC_MFCWindowing#61](../mfcref/codesnippet/CPP/cwinapp-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#48](../mfcref/codesnippet/CPP/cwinapp-class_24.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#49](../mfcref/codesnippet/CPP/cwinapp-class_25.cpp)]  
  
 [!code[NVC_MFCWindowing#50](../mfcref/codesnippet/CPP/cwinapp-class_26.cpp)]  
...
>  The default implementation of `OnIdle` updates command user-interface objects such as menu items and toolbar buttons, and it performs internal data structure cleanup. Therefore, if you override `OnIdle`, you must call `CWinApp::OnIdle` with the `lCount` in your overridden version. First call all base-class idle processing (that is, until the base class `OnIdle` returns 0). If you need to perform work before the base-class processing completes, review the base-class implementation to select the proper `lCount` during which to do your work.  
 ...
 If you do not want `OnIdle` to be called whenever a message is retrieved from the message queue, you can override the [CWinThreadIsIdleMessage](../mfcref/cwinthread-class.md#cwinthread__isidlemessage). If an application has set a very short timer, or if the system is sending the **WM_SYSTIMER** message, then `OnIdle` will be called repeatedly, and degrade performance.  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#51](../mfcref/codesnippet/CPP/cwinapp-class_27.cpp)]  
  
##  <a name="cwinapp__opendocumentfile"></a>  CWinApp::OpenDocumentFile  
 The framework calls this method to open the named [CDocument](../mfcref/cdocument-class.md) file for the application.  
...
##  <a name="cwinapp__parsecommandline"></a>  CWinApp::ParseCommandLine  
 Call this member function to parse the command line and send the parameters, one at a time, to [CCommandLineInfo::ParseParam](../mfcref/ccommandlineinfo-class.md#ccommandlineinfo__parseparam).  
...
### Parameters  
 `rCmdInfo`  
 A reference to a [CCommandLineInfo](../mfcref/ccommandlineinfo-class.md) object.  
...
4.  `ProcessShellCommand` handles the command-line arguments and flags.  
 ...
 For a description of the command-line flags, see [CCommandLineInfo::m_nShellCommand](../mfcref/ccommandlineinfo-class.md#ccommandlineinfo__m_nshellcommand).  
...
2.  `ParseCommandLine` then calls [CCommandLineInfo::ParseParam](../mfcref/ccommandlineinfo-class.md#ccommandlineinfo__parseparam) repeatedly, once for each parameter.  
  
3.  `ParseParam` fills the `CCommandLineInfo` object, which is then passed to `ProcessShellCommand`.  
  
4.  `ProcessShellCommand` handles the command-line arguments and flags.  
  
 The data members of the `CCommandLineInfo` object, identified by [CCommandLineInfo::m_nShellCommand](../mfcref/ccommandlineinfo-class.md#ccommandlineinfo__m_nshellcommand), are of the following enumerated type, which is defined within the `CCommandLineInfo` class.  
...
### Remarks  
 When the restart manager restarts an application, the framework calls this method. This method retrieves the data recovery handler and restores the autosaved files. This method calls [CDataRecoveryHandler::RestoreAutosavedDocuments](../mfcref/cdatarecoveryhandler-class.md#cdatarecoveryhandler__restoreautosaveddocuments) to determine whether the user wants to restore the autosaved files.  
  
 This method returns `FALSE` if the [CDataRecoveryHandler](../mfcref/cdatarecoveryhandler-class.md) determines that there were no open documents. If there were no open documents, the application starts ordinarily.  
...
### Remarks  
 The default implementation of this member function calls the [CDocument::SaveModified](../mfcref/cdocument-class.md#cdocument__savemodified) member function in turn for all modified documents within the application.  
...
### Parameters  
 `hDevNames`  
 A handle to a [DEVNAMES](../mfcref/devnames-structure.md) structure that identifies the driver, device, and output port names of a specific printer.  
...
### Example  
 [!code[NVC_MFCWindowing#53](../mfcref/codesnippet/CPP/cwinapp-class_28.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#54](../mfcref/codesnippet/CPP/cwinapp-class_29.cpp)]  
