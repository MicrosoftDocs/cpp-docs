...
1.  Define your application settings using the [application settings](../mfcref/application-settings--mfc-dll-wizard.md) page of the [MFC DLL Wizard](../mfcref/mfc-dll-wizard.md).  
