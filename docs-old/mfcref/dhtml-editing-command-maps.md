...
The following macros can be used to map DHTML editing commands in             [CHtmlEditView](../mfcref/chtmleditview-class.md)-derived classes. For an example of their use, see             [HTMLEdit Sample](../top/visual-c---samples.md).  
...
### Remarks  
 This macro is to be used in the definition of                         [CHtmlEditView](../mfcref/chtmleditview-class.md)-derived classes.  
  
 Use                         [BEGIN_DHTMLEDITING_CMDMAP](../Topic/BEGIN_DHTMLEDITING_CMDMAP.md) to implement the map.  
  
### Example  
 See                                 [HTMLEdit Sample](../top/visual-c---samples.md).  
...
### Parameters  
 `className`  
 The name of the class containing the DHTML editing command map. This class should derive directly or indirectly from                                 [CHtmlEditView](../mfcref/chtmleditview-class.md) and include the                                 [DECLARE_DHTMLEDITING_CMDMAP](../Topic/DECLARE_DHTMLEDITING_CMDMAP.md) macro within its class definition.  
