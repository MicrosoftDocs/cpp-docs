...
---
# CMDITabInfo Class
The `CMDITabInfo` class is used to pass parameters to [CMDIFrameWndEx::EnableMDITabbedGroups](../mfcref/cmdiframewndex-class.md#cmdiframewndex__enablemditabbedgroups) method. Set members of this class to control the behavior of MDI tabbed groups.  
...
## Example  
 ...
 [!code[NVC_MFC_MDITab#1](../mfcref/codesnippet/CPP/cmditabinfo-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CMDITabInfo](../mfcref/cmditabinfo-class.md)  
...
### Remarks  
 [CMFCVisualManager::GetMDITabsBordersSize](../mfcref/cmfcvisualmanager-class.md#cmfcvisualmanager__getmditabsborderssize) returns the default value.  
...
### Parameters  
 [in] `ar`  
 A [CArchive Class](../mfcref/carchive-class.md) object to serialize.  
