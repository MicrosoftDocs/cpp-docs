...
### Parameters  
 ...
 `font`  
 A reference to a [CFontHolder](../mfcref/cfontholder-class.md) object that contains the font property.  
...
## See Also  
 ...
 [COleControl::DoPropExchange](../mfcref/colecontrol-class.md#colecontrol__dopropexchange)