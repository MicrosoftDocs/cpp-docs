...
|[COleSafeArray::GetByteArray](#colesafearray__getbytearray)|Copies the contents of the safe array into a [CByteArray](../mfcref/cbytearray-class.md).|  
...
### Remarks  
 On error, the function throws a [CMemoryException](../mfcref/cmemoryexception-class.md) or [COleException](../mfcref/coleexception-class.md).  
  
### Example  
 [!code[NVC_MFCOleContainer#26](../mfc/codesnippet/CPP/colesafearray-class_1.cpp)]  
...
COleSafeArray(  
    const SAFEARRAY& saSrc, VARTYPE vtSrc );  
  
COleSafeArray(  
    LPCSAFEARRAY pSrc, VARTYPE vtSrc );  
...
### Remarks  
 This function will clear the current array data if necessary. On error, the function throws a [CMemoryException](../mfcref/cmemoryexception-class.md).  
  
### Example  
 [!code[NVC_MFCOleContainer#27](../mfc/codesnippet/CPP/colesafearray-class_2.cpp)]  
...
### Remarks  
 ...
 On error, the function throws a [CMemoryException](../mfcref/cmemoryexception-class.md).  
  
### Example  
 [!code[NVC_MFCOleContainer#28](../mfc/codesnippet/CPP/colesafearray-class_3.cpp)]  
...
### Remarks  
 If objects are stored in the array, each object is released. On error, the function throws a [CMemoryException](../mfcref/cmemoryexception-class.md) or [COleException](../mfcref/coleexception-class.md).  
...
### Remarks  
 ...
 On error, the function throws a [COleException](../mfcref/coleexception-class.md).  
...
### Example  
 [!code[NVC_MFCOleContainer#29](../mfc/codesnippet/CPP/colesafearray-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#30](../mfc/codesnippet/CPP/colesafearray-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#31](../mfc/codesnippet/CPP/colesafearray-class_6.cpp)]  
...
### Remarks  
 On error, it throws a [COleException](../mfcref/coleexception-class.md).  
...
### Example  
 [!code[NVC_MFCOleContainer#32](../mfc/codesnippet/CPP/colesafearray-class_7.cpp)]  
...
### Remarks  
 This function is called after access to the data in an array is finished. On error, it throws a [COleException](../mfcref/coleexception-class.md).  
