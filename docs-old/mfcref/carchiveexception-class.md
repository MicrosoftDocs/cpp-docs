...
## Remarks  
 ...
 `CArchiveException` objects are constructed and thrown inside [CArchive](../mfcref/carchive-class.md) member functions. You can access these objects within the scope of a **CATCH** expression. The cause code is independent of the operating system. For more information about exception processing, see [Exception Handling (MFC)](../mfc/exception-handling-in-mfc.md).  
