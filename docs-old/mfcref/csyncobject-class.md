...
## Remarks  
 The Microsoft Foundation Class Library provides several classes derived from `CSyncObject`. These are [CEvent](../mfcref/cevent-class.md), [CMutex](../mfcref/cmutex-class.md), [CCriticalSection](../mfcref/ccriticalsection-class.md), and [CSemaphore](../mfcref/csemaphore-class.md).  
