...
|Name|Description|  
|----------|-----------------|  
|[CParabolicTransitionFromAcceleration::Create](#cparabolictransitionfromacceleration__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../mfcref/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CParabolicTransitionFromAcceleration](../mfcref/cparabolictransitionfromacceleration-class.md)  
