...
|[CMFCTasksPane::CreateDefaultMiniframe](#cmfctaskspane__createdefaultminiframe)|(Overrides [CPane::CreateDefaultMiniframe](../mfcref/cpane-class.md#cpane__createdefaultminiframe).)|  
...
|[CMFCTasksPane::GetScrollBarCtrl](#cmfctaskspane__getscrollbarctrl)|(Overrides [CWnd::GetScrollBarCtrl](../mfcref/cwnd-class.md#cwnd__getscrollbarctrl).)|  
...
|[CMFCTasksPane::OnSetAccData](#cmfctaskspane__onsetaccdata)|(Overrides [CBasePane::OnSetAccData](../mfcref/cbasepane-class.md#cbasepane__onsetaccdata).)|  
...
|[CMFCTasksPane::RecalcLayout](#cmfctaskspane__recalclayout)|(Overrides [CPane::RecalcLayout](../mfcref/cpane-class.md#cpane__recalclayout).)|  
...
2.  When processing the `WM_CREATE` message, call the `Create` method. You can use the regular [CControlBar](../mfcref/ccontrolbar-class.md) styles. For more information, see `CControlBar::Create`.  
...
5.  Call [CMFCTasksPane::EnableGroupCollapse](#cmfctaskspane__enablegroupcollapse) to specify whether item groups can collapse.  
 ...
 ![Example of Task Pane](../mfcref/media/nexttaskpane.png "NextTaskPane")  
 ...
 ![Custom task group](../mfcref/media/nexttaskgrpcustom.png "NextTaskGrpCustom")  
...
## Example  
 ...
 [!code[NVC_MFC_RibbonApp#28](../mfcref/codesnippet/CPP/cmfctaskspane-class_1.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCTasksPane](../mfcref/cmfctaskspane-class.md)  
...
### Parameters  
 ...
 [in] `bSpecial`  
 `TRUE` to mark this group as a *special* group; otherwise, `FALSE`. For more information about special groups, see the Remarks section of [CMFCTasksPane Class](../mfcref/cmfctaskspane-class.md).  
...
##  <a name="cmfctaskspane__cmfctaskspane"></a>  CMFCTasksPane::CMFCTasksPane  
 Constructs a [CMFCTasksPane](../mfcref/cmfctaskspane-class.md) object.  
