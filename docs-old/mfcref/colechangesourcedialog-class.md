...
### Parameters  
 `pItem`  
 Pointer to the linked [COleClientItem](../mfcref/coleclientitem-class.md) whose source is to be updated.  
...
### Return Value  
 The complete source display name (moniker) for the [COleClientItem](../mfcref/coleclientitem-class.md) specified in the constructor.  
...
### Return Value  
 The file moniker portion of the source display name for the [COleClientItem](../mfcref/coleclientitem-class.md) specified in the constructor.  
...
### Return Value  
 The item moniker portion of the source display name for the [COleClientItem](../mfcref/coleclientitem-class.md) specified in the constructor.  
