...
|Name|Description|  
|----------|-----------------|  
|[CReversalTransition::Create](#creversaltransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../mfcref/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CReversalTransition](../mfcref/creversaltransition-class.md)  
