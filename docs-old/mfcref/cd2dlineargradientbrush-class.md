...
|[CD2DLinearGradientBrush::Create](#cd2dlineargradientbrush__create)|Creates a CD2DLinearGradientBrush. (Overrides [CD2DResource::Create](../mfcref/cd2dresource-class.md#cd2dresource__create).)|  
|[CD2DLinearGradientBrush::Destroy](#cd2dlineargradientbrush__destroy)|Destroys a CD2DLinearGradientBrush object. (Overrides [CD2DGradientBrush::Destroy](../mfcref/cd2dgradientbrush-class.md#cd2dgradientbrush__destroy).)|  
...
## Inheritance Hierarchy  
 ...
 [CD2DLinearGradientBrush](../mfcref/cd2dlineargradientbrush-class.md)  
