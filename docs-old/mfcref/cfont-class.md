...
### Example  
 [!code[NVC_MFCDocView#70](../mfc/codesnippet/CPP/cfont-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#71](../mfc/codesnippet/CPP/cfont-class_2.cpp)]  
...
### Remarks  
 ...
 This font has the characteristics specified in the                         [LOGFONT](http://msdn.microsoft.com/library/windows/desktop/dd145037) structure. When the font is selected by using the [CDC::SelectObject](../mfcref/cdc-class.md#cdc__selectobject) member function, the GDI font mapper attempts to match the logical font with an existing physical font. If the font mapper fails to find an exact match for the logical font, it provides an alternative font whose characteristics match as many of the requested characteristics as possible.  
...
### Example  
 [!code[NVC_MFCDocView#72](../mfc/codesnippet/CPP/cfont-class_3.cpp)]  
...
### Parameters  
 ...
 `pDC`  
 Pointer to the [CDC](../mfcref/cdc-class.md) object to be used to convert the height in `nPointSize` to logical units. If **NULL**, a screen device context is used for the conversion.  
...
### Example  
 [!code[NVC_MFCDocView#73](../mfc/codesnippet/CPP/cfont-class_4.cpp)]  
...
### Parameters  
 ...
 `pDC`  
 Pointer to the [CDC](../mfcref/cdc-class.md) object to be used to convert the height in **lfHeight** to logical units. If **NULL**, a screen device context is used for the conversion.  
...
### Example  
 [!code[NVC_MFCDocView#74](../mfc/codesnippet/CPP/cfont-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#75](../mfc/codesnippet/CPP/cfont-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#76](../mfc/codesnippet/CPP/cfont-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#77](../mfc/codesnippet/CPP/cfont-class_8.cpp)]  
