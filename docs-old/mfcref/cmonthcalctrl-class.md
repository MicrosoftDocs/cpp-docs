...
### Parameters  
 ...
 `pParentWnd`  
 A pointer to a [CWnd](../mfcref/cwnd-class.md) object that is the parent window of the month calendar control. It must not be **NULL**.  
...
1.  Call [CMonthCalCtrl](../mfcref/cmonthcalctrl-class.md) to construct a `CMonthCalCtrl` object.  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#1](../mfcref/codesnippet/CPP/cmonthcalctrl-class_1.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CMonthCalCtrl_s1#9](../mfcref/codesnippet/CPP/cmonthcalctrl-class_2.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CMonthCalCtrl_s1#3](../mfcref/codesnippet/CPP/cmonthcalctrl-class_3.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CMonthCalCtrl_s1#7](../mfcref/codesnippet/CPP/cmonthcalctrl-class_4.cpp)]  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../atl/coledatetime-class.md) object or a [CTime](../atl/ctime-class.md) object. Receives the current time.  
...
### Example  
 ...
 [!code[NVC_MFC_CMonthCalCtrl_s1#1](../mfcref/codesnippet/CPP/cmonthcalctrl-class_5.cpp)]  
...
### Parameters  
 `refMinRange`  
 A reference to a [COleDateTime](../atl/coledatetime-class.md) or [CTime](../atl/ctime-class.md) object containing the minimum date allowed.  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#2](../mfcref/codesnippet/CPP/cmonthcalctrl-class_6.cpp)]  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../atl/coledatetime-class.md) or [CTime](../atl/ctime-class.md) object indicating the current day.  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#3](../mfcref/codesnippet/CPP/cmonthcalctrl-class_7.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CMonthCalCtrl_s1#6](../mfcref/codesnippet/CPP/cmonthcalctrl-class_8.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CMonthCalCtrl_s1#4](../mfcref/codesnippet/CPP/cmonthcalctrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#4](../mfcref/codesnippet/CPP/cmonthcalctrl-class_10.cpp)]  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../atl/coledatetime-class.md) or [CTime](../atl/ctime-class.md) object indicating the currently-selected month calendar control.  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#5](../mfcref/codesnippet/CPP/cmonthcalctrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#6](../mfcref/codesnippet/CPP/cmonthcalctrl-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#7](../mfcref/codesnippet/CPP/cmonthcalctrl-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CMonthCalCtrl#8](../mfcref/codesnippet/CPP/cmonthcalctrl-class_14.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CMonthCalCtrl_s1#2](../mfcref/codesnippet/CPP/cmonthcalctrl-class_15.cpp)]  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../atl/coledatetime-class.md) object that contains the current date.  
  
 `pDateTime`  
 In the second version, a pointer to a [CTime](../atl/ctime-class.md) object containing the current date information. In the third version, a pointer to a                                 [SYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/ms724950) structure that contains the current date information.  
