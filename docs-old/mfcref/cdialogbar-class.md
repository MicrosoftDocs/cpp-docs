...
> [!NOTE]
>  In the current release, a `CDialogBar` object cannot host Windows Forms controls. For more information about Windows Forms controls in Visual C++, see [Using a Windows Form User Control in MFC](../cli/using-a-windows-form-user-control-in-mfc.md).  
...
### Example  
 [!code[NVC_MFCMessageMaps#13](../mfcref/codesnippet/CPP/cdialogbar-class_1.cpp)]  
