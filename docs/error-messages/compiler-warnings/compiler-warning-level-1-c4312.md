...
'operation' : conversion from 'type1' to 'type2' of greater size  
 ...
 This warning is only issued for 64-bit compilation targets. For more information, see [Rules for Using Pointers](https://msdn.microsoft.com/library/windows/desktop/aa384242).  
