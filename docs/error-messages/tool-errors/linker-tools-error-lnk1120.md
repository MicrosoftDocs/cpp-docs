...
> [!IMPORTANT]
> **This error can't be fixed by itself.** To fix this error, correct all of the linker errors before it in the build output. The LNK1120 error goes away when no unresolved externals remain.
