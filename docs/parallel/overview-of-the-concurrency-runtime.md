 ...
 **Concurrency Runtime Architecture**  
 ...
 ![The Concurrency Runtime Architecture](../parallel/media/concurrencyrun.png "ConcurrencyRun")  
...
>  The Task Scheduler and Resource Manager components are not available from a [!INCLUDE[win8_appname_long](../build/includes/win8_appname_long_md.md)] app or when you use the task class or other types in ppltasks.h.  
 ...
 The Concurrency Runtime also provides synchronization primitives that use cooperative blocking to synchronize access to resources. For more information about these synchronization primitives, see [Synchronization Data Structures](../parallel/synchronization-data-structures.md).  
...
### Parallel Patterns Library  
 ...
 For more information about the Parallel Patterns Library, see [Parallel Patterns Library (PPL)](../parallel/parallel-patterns-library--ppl-.md).  
...
### Task Scheduler  
 ...
 For more information about the Task Scheduler, see [Task Scheduler](../parallel/task-scheduler--concurrency-runtime-.md).  
...
**6561**  
**65536**  
**390625** For more information about lambda functions in C++, see [Lambda Expressions](../cpp/lambda-expressions-in-c--.md).  
...
|Resource Manager|concrtrm.h|  
 ...
 The Concurrency Runtime is declared in the [Concurrency](../parallel/concurrency-namespace.md) namespace. (You can also use [concurrency](../parallel/concurrency-namespace.md), which is an alias for this namespace.) The `concurrency::details` namespace supports the Concurrency Runtime framework, and is not intended to be used directly from your code.  
  
 The Concurrency Runtime is provided as part of the C Runtime Library (CRT). For more information about how to build an application that uses the CRT, see [CRT Library Features](../crt/crt-library-features.md).  
