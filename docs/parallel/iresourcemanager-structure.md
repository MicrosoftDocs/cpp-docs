...
### Remarks  
 [invalid_argument](../stdcpplib/invalid_argument-class.md) is thrown if the parameter `nodeCount` has the value `0` was passed in, or if the parameter `pCoreCount` has the value `NULL`.  
  
 [invalid_operation](../parallel/invalid_operation-class.md) is thrown if this method is called while other schedulers exist in the process.  
...
## See Also  
 ...
 [ISchedulerProxy Structure](../parallel/ischedulerproxy-structure.md)   
