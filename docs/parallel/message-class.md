...
### Remarks  
 The constructor that takes a pointer to a `message` object as an argument throws an [invalid_argument](../stdcpplib/invalid_argument-class.md) exception if the parameter `_Msg` is `NULL`.  
