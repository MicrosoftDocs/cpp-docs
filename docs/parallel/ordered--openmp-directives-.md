...
## Remarks  
 The **ordered** directive must be within the dynamic extent of a [for](../parallel/for--openmp-.md) or **parallel for** construct with an **ordered** clause.  
  
 The **ordered** directive supports no OpenMP clauses.  
  
 For more information, see [2.6.6 ordered Construct](../parallel/2.6.6-ordered-construct.md).  
