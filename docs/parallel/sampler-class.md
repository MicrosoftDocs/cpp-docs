...
##  <a name="sampler__sampler_constructor"></a>  sampler::sampler Constructor  
 Constructs an instance of the [sampler Class](../parallel/sampler-class.md).  
...
```  
sampler&  operator= ( // [1] copy assignment operatorconst sampler& _Other ) restrict(amp, cpu);  
  
sampler&  operator= ( // [2] move assingment operatorsampler&& _Other ) restrict(amp, cpu);  
```  
