...
texture_view( // [1] constructor  
    texture<_Value_type, _Rank>& _Src ) restrict(amp);  
...
texture_view( // [3] constructor  
    const texture<_Value_type, _Rank>& _Src ) restrict(amp);  
...
texture_view( // [5] copy constructor  
    const texture_view<_Value_type, _Rank>& _Other ) restrict(amp, cpu);  
  
texture_view( // [6] copy constructor  
    const texture_view<const _Value_type, _Rank>& _Other ) restrict(amp, cpu);  
...
texture_view<const _Value_type, _Rank>&  operator= ( // [2] copy constructor  
    const texture_view<_Value_type, _Rank>& _Other ) restrict(cpu);  
