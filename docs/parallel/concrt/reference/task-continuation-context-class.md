...
|Name|Description|  
|----------|-----------------|  
|[task_continuation_context::get_current_winrt_context Method](reference/task_continuation_context-class.md#task_continuation_context__get_current_winrt_context_method)|Returns a task continuation context object that represents the current winrt thread context.|  
...
|[task_continuation_context::use_synchronous_execution Method](reference/task_continuation_context-class.md#task_continuation_context__use_synchronous_execution_method)|Returns a task continuation context object that represents the synchronous execution context.|  
