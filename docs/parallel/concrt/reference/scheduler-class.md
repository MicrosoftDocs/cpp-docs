...
### Remarks  
 ...
 At some point in the future, you must call the [CurrentScheduler::Detach](../../../parallel/concrt/reference/currentscheduler-class.md#currentscheduler__detach_method) method in order to allow the scheduler to shut down.  
