...
### Cooperative Blocking  
 ...
 The [concurrency::Context::Yield](reference/Context-class.md#Context__Yield) method yields execution so that the runtime can perform other tasks and then reschedule the context for execution. When you call the `Context::Block` method, the runtime does not reschedule the context.  
