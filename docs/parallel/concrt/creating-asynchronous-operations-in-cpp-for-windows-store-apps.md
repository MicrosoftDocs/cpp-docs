...
-   Use [concurrency::create_async](concurrency-namespace-functions.md#create_async_function) to create asynchronous operations that can be used by other components (which might be written in languages other than C++).  
