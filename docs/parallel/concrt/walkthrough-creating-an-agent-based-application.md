...
7.  Implement the [concurrency::agent::run](reference/agent-class.md#agent__run_method) method in the `protected` section of your class.  
 ...
 [!code-cpp[concrt-basic-agent#6](../../parallel/concrt/codesnippet/CPP/walkthrough-creating-an-agent-based-application_7.h)]  
     ...
     Each time this method reads data from the file, it calls the [concurrency::asend](reference/concurrency-namespace-functions.md#asend_function) function to send that data to the target buffer. It sends the empty string to its target buffer to indicate the end of processing.  
