...
This example demonstrates how to use [concurrency::parallel_for](concurrency-namespace-functions.md#parallel_for_function) to compute the product of two matrices.  
