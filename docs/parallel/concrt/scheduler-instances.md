...
-   The [concurrency::CurrentScheduler::Create](reference/CurrentScheduler-class.md#CurrentScheduler__Create) method creates a `Scheduler` object that uses a specific policy and associates that scheduler with the current context.  
  
-   The [concurrency::Scheduler::Create](reference/Scheduler-class.md#Scheduler__Create) method creates a `Scheduler` object that uses a specific policy, but does not associate it with the current context.  
...
|`Scheduler::Reference`|`Scheduler::Release`|  
 ...
 Because the runtime does not destroy a `Scheduler` object before all tasks have finished, you can use the [concurrency::Scheduler::RegisterShutdownEvent](reference/Scheduler-class.md#Scheduler__RegisterShutdownEvent) method or the [concurrency::CurrentScheduler::RegisterShutdownEvent](reference/CurrentScheduler-class.md#CurrentScheduler__RegisterShutdownEvent) method to receive a notification when a `Scheduler` object is destroyed. This is useful when you must wait for every task that is scheduled by a `Scheduler` object to finish.  
...
|Method|Description|  
|------------|-----------------|  
|[Create](reference/CurrentScheduler-class.md#CurrentScheduler__Create)|Creates a `Scheduler` object that uses the specified policy and associates it with the current context.|  
|[Get](reference/CurrentScheduler-class.md#CurrentScheduler__Get)|Retrieves a pointer to the `Scheduler` object that is associated with the current context. This method does not increment the reference count of the `Scheduler` object.|  
|[Detach](reference/CurrentScheduler-class.md#CurrentScheduler__Detach)|Detaches the current scheduler from the current context and sets the previous one as the current scheduler.|  
|[RegisterShutdownEvent](reference/CurrentScheduler-class.md#CurrentScheduler__RegisterShutdownEvent)|Registers an event that the runtime sets when the current scheduler is destroyed.|  
|[CreateScheduleGroup](reference/CurrentScheduler-class.md#CurrentScheduler__CreateScheduleGroup)|Creates a [concurrency::ScheduleGroup](../../parallel/concrt/reference/schedulegroup-class.md) object in the current scheduler.|  
|[ScheduleTask](reference/CurrentScheduler-class.md#CurrentScheduler__ScheduleTask)|Adds a lightweight task to the scheduling queue of the current scheduler.|  
|[GetPolicy](reference/CurrentScheduler-class.md#CurrentScheduler__GetPolicy)|Retrieves a copy of the policy that is associated with the current scheduler.|  
  
 The following table shows the important methods that are defined by the `Scheduler` class.  
  
|Method|Description|  
|------------|-----------------|  
|[Create](reference/Scheduler-class.md#Scheduler__Create)|Creates a `Scheduler` object that uses the specified policy.|  
|[Attach](reference/Scheduler-class.md#Scheduler__Attach)|Associates the `Scheduler` object together with the current context.|  
|[Reference](reference/Scheduler-class.md#Scheduler__Reference)|Increments the reference counter of the `Scheduler` object.|  
|[Release](reference/Scheduler-class.md#Scheduler__Release)|Decrements the reference counter of the `Scheduler` object.|  
|[RegisterShutdownEvent](reference/Scheduler-class.md#Scheduler__RegisterShutdownEvent)|Registers an event that the runtime sets when the `Scheduler` object is destroyed.|  
|[CreateScheduleGroup](reference/Scheduler-class.md#Scheduler__CreateScheduleGroup)|Creates a [concurrency::ScheduleGroup](../../parallel/concrt/reference/schedulegroup-class.md) object in the `Scheduler` object.|  
|[ScheduleTask](reference/Scheduler-class.md#Scheduler__ScheduleTask)|Schedules a lightweight task from the `Scheduler` object.|  
|[GetPolicy](reference/Scheduler-class.md#Scheduler__GetPolicy)|Retrieves a copy of the policy that is associated with the `Scheduler` object.|  
|[SetDefaultSchedulerPolicy](reference/Scheduler-class.md#Scheduler__SetDefaultSchedulerPolicy)|Sets the policy for the runtime to use when it creates the default scheduler.|  
|[ResetDefaultSchedulerPolicy](reference/Scheduler-class.md#Scheduler__ResetDefaultSchedulerPolicy)|Restores the default policy to the one that was active before the call to `SetDefaultSchedulerPolicy`. If the default scheduler is created after this call, the runtime uses default policy settings to create the scheduler.|  
