...
## Example  
 ...
 [!code[concrt-task-tree-search#2](../parallel/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_1.cpp)]  
...
## Example  
 ...
 [!code[concrt-task-tree-search#1](../parallel/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_2.cpp)]  
...
## Example  
 ...
 [!code[concrt-task-tree-search#3](../parallel/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_3.cpp)]  
...
## Example  
 ...
 [!code[concrt-task-tree-search#4](../parallel/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_4.cpp)]  
  
 This example uses the [concurrency::parallel_invoke](../Topic/parallel_invoke%20Function.md) algorithm to search for values in parallel. For more information about this algorithm, see [Parallel Algorithms](../parallel/parallel-algorithms.md).  
  
## Example  
 The following complete example uses exception handling to search for values in a basic tree structure.  
  
 [!code[concrt-task-tree-search#5](../parallel/codesnippet/CPP/how-to--use-exception-handling-to-break-from-a-parallel-loop_5.cpp)]  
