...
|Function|Purpose|  
|--------------|-------------|  
|[ExitInstance](../topic/../mfc/reference/cwinthread-exitinstance-class.md)|Perform cleanup when thread terminates. Usually overridden.|  
|[InitInstance](../topic/../mfc/reference/cwinthread-initinstance-class.md)|Perform thread instance initialization. Must be overridden.|  
|[OnIdle](../topic/../mfc/reference/cwinthread-onidle-class.md)|Perform thread-specific idle-time processing. Not usually overridden.|  
|[PreTranslateMessage](../topic/../mfc/reference/cwinthread-pretranslatemessage-class.md)|Filter messages before they are dispatched to **TranslateMessage** and **DispatchMessage**. Not usually overridden.|  
|[ProcessWndProcException](../topic/../mfc/reference/cwinthread-processwndprocexception-class.md)|Intercept unhandled exceptions thrown by the thread's message and command handlers. Not usually overridden.|  
|[Run](../topic/../mfc/reference/cwinthread-run-class.md)|Controlling function for the thread. Contains the message pump. Rarely overridden.|  
