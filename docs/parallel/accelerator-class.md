...
|[accelerator::direct3d_warp Data Member](#accelerator__direct3d_warp_data_member)|Gets the string constant for an "accelerator" object that you can use for executing C++ AMP code on multi-core CPUs that use Streaming SIMD Extensions (SSE).|  
...
##  <a name="accelerator_view___dtoraccelerator_view_destructor"></a>  accelerator_view::~accelerator_view Destructor  
 Destroys the [accelerator_view](../parallel/accelerator_view-class.md) object.  
...
##  <a name="accelerator_view__accelerator_data_member"></a>  accelerator_view::accelerator Data Member  
 Gets the "accelerator" object for the [accelerator_view](../parallel/accelerator_view-class.md) object.  
...
##  <a name="accelerator_view__accelerator_view_constructor"></a>  accelerator_view::accelerator_view Constructor  
 Initializes a new instance of the [accelerator_view](../parallel/accelerator_view-class.md) class by copying an existing `accelerator_view` object.  
...
##  <a name="accelerator_view__flush_method"></a>  accelerator_view::flush Method  
 Submits all pending commands queued to the [accelerator_view](../parallel/accelerator_view-class.md) object to the accelerator for execution.  
...
##  <a name="accelerator_view__get_accelerator_method"></a>  accelerator_view::get_accelerator Method  
 Returns the "accelerator" object for the [accelerator_view](../parallel/accelerator_view-class.md) object.  
...
##  <a name="accelerator_view__get_is_debug_method"></a>  accelerator_view::get_is_debug Method  
 Returns a Boolean value that indicates whether the [accelerator_view](../parallel/accelerator_view-class.md) object has the DEBUG layer enabled for extensive error reporting.  
...
##  <a name="accelerator_view__get_queuing_mode_method"></a>  accelerator_view::get_queuing_mode Method  
 Returns the queuing mode for the [accelerator_view](../parallel/accelerator_view-class.md) object.  
...
##  <a name="accelerator_view__get_version_method"></a>  accelerator_view::get_version Method  
 Returns the version of the [accelerator_view](../parallel/accelerator_view-class.md).  
...
##  <a name="accelerator_view__is_debug_data_member"></a>  accelerator_view::is_debug Data Member  
 Gets a Boolean value that indicates whether the [accelerator_view](../parallel/accelerator_view-class.md) object has the  DEBUG layer enabled for extensive error reporting.  
...
##  <a name="accelerator_view__operator_neq_operator"></a>  accelerator_view::operator!= Operator  
 Compares this [accelerator_view](../parallel/accelerator_view-class.md) object with another and returns `false` if they are the same; otherwise, returns `true`.  
...
##  <a name="accelerator_view__operator_eq_operator"></a>  accelerator_view::operator= Operator  
 Copies the contents of the specified [accelerator_view](../parallel/accelerator_view-class.md) object into this one.  
...
##  <a name="accelerator_view__operator_eq_eq_operator"></a>  accelerator_view::operator== Operator  
 Compares this [accelerator_view](../parallel/accelerator_view-class.md) object with another and returns `true` if they are the same; otherwise, returns `false`.  
...
##  <a name="accelerator_view__queuing_mode_data_member"></a>  accelerator_view::queuing_mode Data Member  
 Gets the queuing mode for the [accelerator_view](../parallel/accelerator_view-class.md) object.  
...
##  <a name="accelerator_view__version_data_member"></a>  accelerator_view::version Data Member  
 Gets the version of the [accelerator_view](../parallel/accelerator_view-class.md).  
...
##  <a name="accelerator_view__wait_method"></a>  accelerator_view::wait Method  
 Waits for all commands submitted to the [accelerator_view](../parallel/accelerator_view-class.md) object to finish.  
