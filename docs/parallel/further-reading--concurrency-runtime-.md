...
-   The document [Parallel Programming](../Topic/Parallel%20Programming%20in%20the%20.NET%20Framework.md) describes the parallel programming functionality that is provided by the [!INCLUDE[net_v40_long](../parallel/includes/net_v40_long_md.md)].  
