...
## Remarks  
 OMP nested parallelism can be turned on with `omp_set_nested`, or by setting the [OMP_NESTED](../parallel/omp_nested.md) environment variable.  
 ...
 Use [omp_get_nested](../parallel/omp_get_nested.md) to display the current setting of `omp_set_nested`.  
  
 For more information, see [3.1.9 omp_set_nested Function](../parallel/3.1.9-omp_set_nested-function.md).  
