...
##  <a name="_dtoraccelerator_destructor"></a>  accelerator::~accelerator Destructor  
...
##  <a name="_dtoraccelerator_view_destructor"></a>  accelerator_view::~accelerator_view Destructor  
