...
---
# invalid_compute_domain Class
The exception that's thrown when the runtime can't start a kernel by using the compute domain specified at the [parallel_for_each] --brokenlink-- (#parallel_for_each%20Function%20\(C++%20AMP\).md) call site.  
