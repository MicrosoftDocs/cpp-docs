...
|Name|Description|  
|----------|-----------------|  
|[norm_3::norm_3 Constructor] --brokenlink-- (#norm_3::norm_3%20Constructor.md)|Overloaded. Default constructor, initializes all elements with 0.|  
...
|Name|Description|  
|----------|-----------------|  
|[norm_3::size Constant] --brokenlink-- (#norm_3::size%20Constant.md)||  
