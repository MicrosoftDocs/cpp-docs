...
|Name|Description|  
|----------|-----------------|  
|[address_mode Enumeration](reference/concurrency-namespace-enums-amp.md#address_mode)|Specifies address modes supported for texture sampling.|  
|[filter_mode Enumeration](reference/concurrency-namespace-enums-amp.md#filter_mode)|Specifies filter modes supported for texture sampling.|  
...
|Name|Description|  
|----------|-----------------|  
|[copy Function](reference/concurrency-namespace-functions.md#copy)|Overloaded. Copies the contents of the source texture into the destination host buffer.|  
|[copy_async Function](reference/concurrency-namespace-functions.md#copy_async)|Overloaded. Asynchronously copies the contents of the source texture into the destination host buffer.|  
