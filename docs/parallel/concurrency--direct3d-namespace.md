...
|Name|Description|  
|----------|-----------------|  
|[scoped_d3d_access_lock Class](../parallel/scoped_d3d_access_lock-class.md)|An RAII wrapper for a D3D access lock on an `accelerator_view` object.|  
  
### Structures  
  
|Name|Description|  
|----------|-----------------|  
|[adopt_d3d_access_lock_t Structure](../parallel/adopt_d3d_access_lock_t-structure.md)|Tag type to indicate the D3D access lock should be adopted rather than acquired.|  
...
|[create_accelerator_view Function](../Topic/create_accelerator_view%20Function.md)|Creates an [accelerator_view Class](../parallel/accelerator_view-class.md) from a pointer to a Direct3D device interface|  
