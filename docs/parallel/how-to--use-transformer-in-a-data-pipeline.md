...
This topic contains a basic example that shows how to use the [concurrency::transformer](../parallel/transformer-class.md) class in a data pipeline. For a more complete example that uses a data pipeline to perform image processing, see [Walkthrough: Creating an Image-Processing Network](../parallel/walkthrough--creating-an-image-processing-network.md).  
...
5.  The fifth stage writes the final result to a message buffer.  
 ...
 [!code[concrt-data-pipeline#1](../parallel/codesnippet/CPP/how-to--use-transformer-in-a-data-pipeline_1.cpp)]  
