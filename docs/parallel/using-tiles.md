...
-   [tiled_extent Class](../parallel/tiled_extent-class.md) and [tiled_index Class](../parallel/tiled_index-class.md). You use a `tiled_extent` object instead of an `extent` object in the `parallel_for_each` call. You use a `tiled_index` object instead of an `index` object in the `parallel_for_each` call.  
...
## Example of Global, Tile, and Local Indices  
 ...
 ![8&#45;by&#45;9 matrix divided into 2&#45;by&#45;3 tiles](../parallel/media/usingtilesmatrix.PNG "UsingTilesMatrix")  
