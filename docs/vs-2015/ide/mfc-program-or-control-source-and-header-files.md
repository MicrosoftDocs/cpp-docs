...
The latest version of this topic can be found at [MFC Program or Control Source and Header Files](https://docs.microsoft.com/cpp/ide/mfc-program-or-control-source-and-header-files).  
