...
The latest version of this topic can be found at [Redistributing Web Client Applications](https://docs.microsoft.com/cpp/ide/redistributing-web-client-applications).  
