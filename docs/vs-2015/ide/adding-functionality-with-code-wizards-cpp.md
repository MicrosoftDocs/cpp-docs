...
The latest version of this topic can be found at [Adding Functionality with Code Wizards (C++)](https://docs.microsoft.com/cpp/ide/adding-functionality-with-code-wizards-cpp).  
