...
> [!NOTE]
>  Although [ClickOnce](../Topic/ClickOnce%20Security%20and%20Deployment.md) deployment for [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] native applications is possible in Visual Studio, it requires extra steps. For more information, see [ClickOnce Deployment for Visual C++ Applications](../ide/clickonce-deployment-for-visual-cpp-applications.md).  
