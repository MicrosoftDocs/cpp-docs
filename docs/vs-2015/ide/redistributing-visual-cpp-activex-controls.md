...
The latest version of this topic can be found at [Redistributing Visual C++ ActiveX Controls](https://docs.microsoft.com/cpp/ide/redistributing-visual-cpp-activex-controls).  
