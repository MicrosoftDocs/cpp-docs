...
The latest version of this topic can be found at [Specify Project Settings, Create New Project From Existing Code Files Wizard](https://docs.microsoft.com/cpp/ide/specify-project-settings-create-new-project-from-existing-code-files-wizard).  
