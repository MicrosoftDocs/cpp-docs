...
The latest version of this topic can be found at [Application Settings, Makefile Project Wizard](https://docs.microsoft.com/cpp/ide/application-settings-makefile-project-wizard).  
