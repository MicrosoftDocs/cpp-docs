...
The latest version of this topic can be found at [IDL Attributes, Add Property Wizard](https://docs.microsoft.com/cpp/ide/idl-attributes-add-property-wizard).  
