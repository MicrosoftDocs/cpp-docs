...
The latest version of this topic can be found at [Compiling a C++ Program that Targets the CLR](https://docs.microsoft.com/cpp/ide/walkthrough-compiling-a-cpp-program-that-targets-the-clr-in-visual-studio).  
