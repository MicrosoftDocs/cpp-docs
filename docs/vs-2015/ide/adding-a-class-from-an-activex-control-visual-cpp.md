...
The latest version of this topic can be found at [Adding a Class from an ActiveX Control (Visual C++)](https://docs.microsoft.com/cpp/ide/adding-a-class-from-an-activex-control-visual-cpp).  
