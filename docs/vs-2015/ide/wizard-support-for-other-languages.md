...
The latest version of this topic can be found at [Wizard Support for Other Languages](https://docs.microsoft.com/cpp/ide/wizard-support-for-other-languages).  
