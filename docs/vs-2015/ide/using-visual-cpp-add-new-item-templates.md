...
The latest version of this topic can be found at [Using Visual C++ Add New Item Templates](https://docs.microsoft.com/cpp/ide/using-visual-cpp-add-new-item-templates).  
