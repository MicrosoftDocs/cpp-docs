...
The latest version of this topic can be found at [Creating and Managing Visual C++ Projects](https://docs.microsoft.com/cpp/ide/creating-and-managing-visual-cpp-projects).  
...
## In This Section  
 ...
 Describes the project types that are available in [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] and how to create a C-language project.  
