...
The latest version of this topic can be found at [Custom Build Step Property Page: General](https://docs.microsoft.com/cpp/ide/custom-build-step-property-page-general).  
