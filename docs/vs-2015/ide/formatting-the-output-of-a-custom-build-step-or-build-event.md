...
The latest version of this topic can be found at [Formatting the Output of a Custom Build Step or Build Event](https://docs.microsoft.com/cpp/ide/formatting-the-output-of-a-custom-build-step-or-build-event).  
