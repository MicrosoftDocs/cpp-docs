...
The latest version of this topic can be found at [Manifest Tool Input and Output Properties (Visual C++)](https://docs.microsoft.com/cpp/ide/input-and-output-manifest-tool).  
