...
The latest version of this topic can be found at [New Project From Existing Code Release Configuration](https://docs.microsoft.com/cpp/ide/specify-release-configuration).  
