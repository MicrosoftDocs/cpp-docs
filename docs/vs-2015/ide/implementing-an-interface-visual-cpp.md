...
The latest version of this topic can be found at [Implementing an Interface (Visual C++)](https://docs.microsoft.com/cpp/ide/implementing-an-interface-visual-cpp).  
