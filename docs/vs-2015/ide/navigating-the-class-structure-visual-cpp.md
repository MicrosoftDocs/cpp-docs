...
The latest version of this topic can be found at [Navigating the Class Structure (Visual C++)](https://docs.microsoft.com/cpp/ide/navigating-the-class-structure-visual-cpp).  
