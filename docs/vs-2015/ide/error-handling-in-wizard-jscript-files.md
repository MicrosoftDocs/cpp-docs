...
The latest version of this topic can be found at [Error Handling in Wizard JScript Files](https://docs.microsoft.com/cpp/ide/error-handling-in-wizard-jscript-files).  
