...
The latest version of this topic can be found at [Walkthrough: Debugging a Project (C++)](https://docs.microsoft.com/cpp/ide/walkthrough-debugging-a-project-cpp).  
...
2.  To decrease the `totalParticipants` when a Cardgame terminates, add the following code between the opening and closing braces of the `Cardgame::~Cardgame` destructor.  
     ...
     [!code-cpp[NVC_Walkthrough_Debugging_A_Project#110](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_debugging_a_project/cpp/game/cardgame.cpp#110)]  
  
3.  The Cardgame.cpp file should resemble this after you change it:  
  
     [!code-cpp[NVC_Walkthrough_Debugging_A_Project#111](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_debugging_a_project/cpp/game/cardgame.cpp#111)]  
