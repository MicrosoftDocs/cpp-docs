...
The latest version of this topic can be found at [Visual C++ Tools and Features in Visual Studio Editions](https://docs.microsoft.com/cpp/ide/visual-cpp-tools-and-features-in-visual-studio-editions).  
...
|64-bit [!INCLUDE[vcprx64](../includes/vcprx64-md.md)] compiler|||X|X|  
|X86_ [!INCLUDE[vcprx64](../includes/vcprx64-md.md)] cross-compiler|X|X|X|X|  
