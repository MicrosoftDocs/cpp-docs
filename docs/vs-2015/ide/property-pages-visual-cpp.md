...
The latest version of this topic can be found at [Property Pages (Visual C++)](https://docs.microsoft.com/cpp/ide/property-pages-visual-cpp).  
...
## Default Properties vs. Modified Properties  
 When you use the **New Project** dialog box to create a project, [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] uses the specified project template to initialize the project properties. Therefore, the property values in the template can be thought of as default values for that project type. In other project types, the properties may have different default values.  
