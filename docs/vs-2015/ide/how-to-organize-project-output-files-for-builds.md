...
The latest version of this topic can be found at [How to: Organize Project Output Files for Builds](https://docs.microsoft.com/cpp/ide/how-to-organize-project-output-files-for-builds).  
