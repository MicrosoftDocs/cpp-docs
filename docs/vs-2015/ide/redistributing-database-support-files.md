...
The latest version of this topic can be found at [Redistributing Database Support Files](https://docs.microsoft.com/cpp/ide/redistributing-database-support-files).  
