...
The latest version of this topic can be found at [Determining Which DLLs to Redistribute](https://docs.microsoft.com/cpp/ide/determining-which-dlls-to-redistribute).  
