...
The latest version of this topic can be found at [MIDL Property Pages: Advanced](https://docs.microsoft.com/cpp/ide/midl-property-pages-advanced).  
...
```  
 ...
 For information on how to access the **Advanced** property page in the **MIDL** folder, see [How To: Specify Project Properties with Property Pages](../misc/how-to-specify-project-properties-with-property-pages.md).  
