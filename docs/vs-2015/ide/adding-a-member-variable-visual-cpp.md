...
The latest version of this topic can be found at [Adding a Member Variable  (Visual C++)](https://docs.microsoft.com/cpp/ide/adding-a-member-variable-visual-cpp).  
