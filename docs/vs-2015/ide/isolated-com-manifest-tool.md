...
The latest version of this topic can be found at [Manifest Tool Isolated COM Properties (Visual C++)](https://docs.microsoft.com/cpp/ide/isolated-com-manifest-tool).  
