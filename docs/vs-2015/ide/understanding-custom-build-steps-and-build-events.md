...
The latest version of this topic can be found at [Understanding Custom Build Steps and Build Events](https://docs.microsoft.com/cpp/ide/understanding-custom-build-steps-and-build-events).  
