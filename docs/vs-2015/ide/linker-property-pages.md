...
The latest version of this topic can be found at [Linker Property Pages](https://docs.microsoft.com/cpp/ide/linker-property-pages).  
 ...
 **Per-user Redirection**  
 Registration in [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] has traditionally been done in HKEY_CLASSES_ROOT (HKCR). With [!INCLUDE[wiprlhext](../includes/wiprlhext-md.md)], to access HKCR you must run [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] in elevated mode. Developers do not always want to run in elevated mode but still must work with registration. Per-user redirection allows you to register without having to run in this mode.  
