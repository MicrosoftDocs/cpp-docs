...
The latest version of this topic can be found at [Deploy a Visual C++ Application to an App-local Folder](https://docs.microsoft.com/cpp/ide/walkthrough-deploying-a-visual-cpp-application-to-an-application-local-folder).  
