...
The latest version of this topic can be found at [ATL Program or Control Source and Header Files](https://docs.microsoft.com/cpp/ide/atl-program-or-control-source-and-header-files).  
