...
The latest version of this topic can be found at [File Types Created for Visual C++ Projects](https://docs.microsoft.com/cpp/ide/file-types-created-for-visual-cpp-projects).  
...
|.idl|Compiling|An interface definition language file. See [Interface Definition (IDL) File](http://msdn.microsoft.com/library/windows/desktop/aa378712) in the [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] for more information.|  
...
|.vup|Project|The utility project file.|  
 ...
 For information on other files associated with Visual Studio, see [File Types and File Extensions in Visual Studio .NET](http://msdn.microsoft.com/library/0ba5007b-465d-4efa-b1e4-f0ee68527649).  
