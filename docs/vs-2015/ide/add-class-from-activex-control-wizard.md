...
The latest version of this topic can be found at [Add Class From ActiveX Control Wizard](https://docs.microsoft.com/cpp/ide/add-class-from-activex-control-wizard).  
