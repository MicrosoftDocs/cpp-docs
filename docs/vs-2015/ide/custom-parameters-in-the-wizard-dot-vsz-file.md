...
The latest version of this topic can be found at [Custom Parameters in the Wizard .Vsz File](https://docs.microsoft.com/cpp/ide/custom-parameters-in-the-wizard-dot-vsz-file).  
