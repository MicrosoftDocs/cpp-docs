...
The latest version of this topic can be found at [Implementing a Connection Point (Visual C++)](https://docs.microsoft.com/cpp/ide/implementing-a-connection-point-visual-cpp).  
