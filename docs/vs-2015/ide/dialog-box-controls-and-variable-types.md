...
The latest version of this topic can be found at [Dialog Box Controls and Variable Types](https://docs.microsoft.com/cpp/ide/dialog-box-controls-and-variable-types).  
