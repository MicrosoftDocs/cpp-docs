...
The latest version of this topic can be found at [Walkthrough: Deploying Your Program (C++)](https://docs.microsoft.com/cpp/ide/walkthrough-deploying-your-program-cpp).  
