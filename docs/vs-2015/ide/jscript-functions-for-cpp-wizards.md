...
The latest version of this topic can be found at [JScript Functions for C++ Wizards](https://docs.microsoft.com/cpp/ide/jscript-functions-for-cpp-wizards).  
  
  
AddATLSupportToProject](../Topic/AddATLSupportToProject.md)|Adds ATL support to an MFC project.|  
