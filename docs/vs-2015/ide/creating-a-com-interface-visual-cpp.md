...
The latest version of this topic can be found at [Creating a COM Interface (Visual C++)](https://docs.microsoft.com/cpp/ide/creating-a-com-interface-visual-cpp).  
