...
The latest version of this topic can be found at [New Project From Existing Code Debug Setting (Visual C++)](https://docs.microsoft.com/cpp/ide/specify-debug-configuration-settings).  
