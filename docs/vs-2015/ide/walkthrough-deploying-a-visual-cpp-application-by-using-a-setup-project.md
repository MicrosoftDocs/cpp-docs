...
The latest version of this topic can be found at [Deploy a Visual C++ Application By Using a Setup Project](https://docs.microsoft.com/cpp/ide/walkthrough-deploying-a-visual-cpp-application-by-using-a-setup-project).  
...
-   A computer with [!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)] installed.  
