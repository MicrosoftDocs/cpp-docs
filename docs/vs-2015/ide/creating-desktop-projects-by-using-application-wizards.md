...
The latest version of this topic can be found at [Creating Desktop Projects By Using Application Wizards](https://docs.microsoft.com/cpp/ide/creating-desktop-projects-by-using-application-wizards).  
