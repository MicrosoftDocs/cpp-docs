...
The latest version of this topic can be found at [Examining the Basic Wizard Project](https://docs.microsoft.com/cpp/ide/examining-the-basic-wizard-project).  
