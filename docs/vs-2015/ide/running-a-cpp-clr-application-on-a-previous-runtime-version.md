...
The latest version of this topic can be found at [Running a C++ -clr Application on a Previous Runtime Version](https://docs.microsoft.com/cpp/ide/running-a-cpp-clr-application-on-a-previous-runtime-version).  
