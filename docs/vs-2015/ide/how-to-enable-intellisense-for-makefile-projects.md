...
The latest version of this topic can be found at [How to: Enable IntelliSense for Makefile Projects](https://docs.microsoft.com/cpp/ide/how-to-enable-intellisense-for-makefile-projects).  
