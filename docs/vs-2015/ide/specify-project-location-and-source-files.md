...
The latest version of this topic can be found at [New Project From Existing Code - Source Files (Visual C++)](https://docs.microsoft.com/cpp/ide/specify-project-location-and-source-files).  
