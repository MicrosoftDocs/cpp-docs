...
The latest version of this topic can be found at [Walkthrough: Working with Projects and Solutions (C++)](https://docs.microsoft.com/cpp/ide/walkthrough-working-with-projects-and-solutions-cpp).  
...
Here's how to create a C++ project in Visual Studio, add code, and then build and run the project. The project in this walkthrough is a program that tracks how many players are playing different card games.  
 ...
 In [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], work is organized in projects and solutions. A solution can contain more than one project—for example, a DLL and an executable that references that DLL. For more information, see [Solutions and Projects](../Topic/Solutions%20and%20Projects%20in%20Visual%20Studio.md).  
...
## Creating a Project  
 To create a project, first choose a project-type template. For each project type, [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] sets compiler settings and—depending on the type—generates starter code that you can modify later.  
...
4.  Enter a name for the project in the **Name** box. For this example, enter **Game**.  
     ...
     When you create a project, [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] puts the project in a solution. By default, the solution has the same name as the project. You can change the name in the **Solution name** box, but for this example, keep the default name.  
...
## Organizing Projects and Files in a Solution  
 ...
 This part of the walkthrough shows how add a class to the project. When you add the class, [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] adds the corresponding .h and .cpp files. Next, you add a new source code file for the main program that tests the class.  
...
4.  The Cardgame.h file is opened in the editor. Make these changes:  
    ...
    -   Add two private data members after the opening brace of the class definition.  
         ...
         [!code-cpp[NVC_Walkthrough_Working_With_Projects#100](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_working_with_projects/cpp/game/cardgame.h#100)]  
    ...
    -   Modify the default constructor that Visual Studio generated. After the `public:` access specifier, find the line that looks like this:  
         ...
         [!code-cpp[NVC_Walkthrough_Working_With_Projects#101](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_working_with_projects/cpp/game/cardgame.h#101)]  
    ...
    -   After the default destructor, add an inline declaration for a static int member function named **GetParticipants** that takes no parameters and returns the **totalParticipants** value.  
         ...
         [!code-cpp[NVC_Walkthrough_Working_With_Projects#102](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_working_with_projects/cpp/game/cardgame.h#102)]  
  
5.  The Cardgame.h file should resemble this after you change it:  
  
     [!code-cpp[NVC_Walkthrough_Working_With_Projects#103](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_working_with_projects/cpp/game/cardgame.h#103)]  
...
7.  Delete everything in the file and replace it with this code:  
     ...
     [!code-cpp[NVC_Walkthrough_Working_With_Projects#111](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_working_with_projects/cpp/game/cardgame.cpp#111)]  
...
3.  In the TestGames.cpp editing window, enter the following code.  
     ...
     [!code-cpp[NVC_Walkthrough_Working_With_Projects#120](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_working_with_projects/cpp/game/testgames.cpp#120)]  
