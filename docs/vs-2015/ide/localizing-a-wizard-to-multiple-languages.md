...
The latest version of this topic can be found at [Localizing a Wizard to Multiple Languages](https://docs.microsoft.com/cpp/ide/localizing-a-wizard-to-multiple-languages).  
