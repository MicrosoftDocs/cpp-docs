...
The latest version of this topic can be found at [Examining the Mechanics of a Wizard](https://docs.microsoft.com/cpp/ide/examining-the-mechanics-of-a-wizard).  
