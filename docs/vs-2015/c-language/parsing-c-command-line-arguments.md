...
The latest version of this topic can be found at [Parsing C Command-Line Arguments](https://docs.microsoft.com/cpp/c-language/parsing-c-command-line-arguments).  
