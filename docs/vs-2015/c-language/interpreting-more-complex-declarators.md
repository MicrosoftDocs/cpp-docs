...
The latest version of this topic can be found at [Interpreting More Complex Declarators](https://docs.microsoft.com/cpp/c-language/interpreting-more-complex-declarators).  
