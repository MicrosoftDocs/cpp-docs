...
The latest version of this topic can be found at [Rules and Limitations for dllimport-dllexport](https://docs.microsoft.com/cpp/c-language/rules-and-limitations-for-dllimport-dllexport).  
