...
The latest version of this topic can be found at [L-Value and R-Value Expressions](https://docs.microsoft.com/cpp/c-language/l-value-and-r-value-expressions).  
