...
The latest version of this topic can be found at [Function Declarations and Definitions](https://docs.microsoft.com/cpp/c-language/function-declarations-and-definitions).  
