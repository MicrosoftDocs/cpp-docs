...
The latest version of this topic can be found at [extern Storage-Class Specifier](https://docs.microsoft.com/cpp/c-language/extern-storage-class-specifier).  
