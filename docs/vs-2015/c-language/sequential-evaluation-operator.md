...
The latest version of this topic can be found at [Sequential-Evaluation Operator](https://docs.microsoft.com/cpp/c-language/sequential-evaluation-operator).  
