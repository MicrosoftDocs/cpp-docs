...
The latest version of this topic can be found at [C Postfix Increment and Decrement Operators](https://docs.microsoft.com/cpp/c-language/c-postfix-increment-and-decrement-operators).  
