...
The latest version of this topic can be found at [Conversions to and from Pointer Types](https://docs.microsoft.com/cpp/c-language/conversions-to-and-from-pointer-types).  
