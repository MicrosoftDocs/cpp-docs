...
The latest version of this topic can be found at [C Relational and Equality Operators](https://docs.microsoft.com/cpp/c-language/c-relational-and-equality-operators).  
