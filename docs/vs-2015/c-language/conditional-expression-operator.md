...
The latest version of this topic can be found at [Conditional-Expression Operator](https://docs.microsoft.com/cpp/c-language/conditional-expression-operator).  
