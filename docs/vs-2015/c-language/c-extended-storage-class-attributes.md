...
The latest version of this topic can be found at [C Extended Storage-Class Attributes](https://docs.microsoft.com/cpp/c-language/c-extended-storage-class-attributes).  
