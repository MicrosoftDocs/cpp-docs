...
The latest version of this topic can be found at [Conversions from Unsigned Integral Types](https://docs.microsoft.com/cpp/c-language/conversions-from-unsigned-integral-types).  
