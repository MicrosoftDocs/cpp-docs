...
The latest version of this topic can be found at [Prefix Increment and Decrement Operators](https://docs.microsoft.com/cpp/c-language/prefix-increment-and-decrement-operators).  
