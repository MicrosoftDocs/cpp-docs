...
The latest version of this topic can be found at [Conversions from Signed Integral Types](https://docs.microsoft.com/cpp/c-language/conversions-from-signed-integral-types).  
