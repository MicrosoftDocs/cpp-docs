...
The latest version of this topic can be found at [Customizing C Command-Line Processing](https://docs.microsoft.com/cpp/c-language/customizing-c-command-line-processing).  
