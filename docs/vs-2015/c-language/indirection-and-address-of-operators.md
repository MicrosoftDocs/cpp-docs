...
The latest version of this topic can be found at [Indirection and Address-of Operators](https://docs.microsoft.com/cpp/c-language/indirection-and-address-of-operators).  
