...
The latest version of this topic can be found at [Precedence and Order of Evaluation](https://docs.microsoft.com/cpp/c-language/precedence-and-order-of-evaluation).  
