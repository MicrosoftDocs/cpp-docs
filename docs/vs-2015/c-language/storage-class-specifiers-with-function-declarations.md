...
The latest version of this topic can be found at [Storage-Class Specifiers with Function Declarations](https://docs.microsoft.com/cpp/c-language/storage-class-specifiers-with-function-declarations).  
