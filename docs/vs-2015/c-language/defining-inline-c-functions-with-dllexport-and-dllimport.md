...
The latest version of this topic can be found at [Defining Inline C Functions with dllexport and dllimport](https://docs.microsoft.com/cpp/c-language/defining-inline-c-functions-with-dllexport-and-dllimport).  
