...
The latest version of this topic can be found at [Declarators and Variable Declarations](https://docs.microsoft.com/cpp/c-language/declarators-and-variable-declarations).  
