...
The latest version of this topic can be found at [C Declarations and Definitions](https://docs.microsoft.com/cpp/c-language/c-declarations-and-definitions).  
