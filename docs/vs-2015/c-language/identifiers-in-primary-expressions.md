...
The latest version of this topic can be found at [Identifiers in Primary Expressions](https://docs.microsoft.com/cpp/c-language/identifiers-in-primary-expressions).  
