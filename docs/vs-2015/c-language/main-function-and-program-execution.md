...
The latest version of this topic can be found at [main Function and Program Execution](https://docs.microsoft.com/cpp/c-language/main-function-and-program-execution).  
