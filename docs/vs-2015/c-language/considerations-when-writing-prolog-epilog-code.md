...
The latest version of this topic can be found at [Considerations When Writing Prolog-Epilog Code](https://docs.microsoft.com/cpp/c-language/considerations-when-writing-prolog-epilog-code).  
