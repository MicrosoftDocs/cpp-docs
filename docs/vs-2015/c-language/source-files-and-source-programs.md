...
The latest version of this topic can be found at [Source Files and Source Programs](https://docs.microsoft.com/cpp/c-language/source-files-and-source-programs).  
