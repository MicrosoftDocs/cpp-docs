...
The latest version of this topic can be found at [Conversions from Floating-Point Types](https://docs.microsoft.com/cpp/c-language/conversions-from-floating-point-types).  
