...
The latest version of this topic can be found at [Storage-Class Specifiers for External-Level Declarations](https://docs.microsoft.com/cpp/c-language/storage-class-specifiers-for-external-level-declarations).  
