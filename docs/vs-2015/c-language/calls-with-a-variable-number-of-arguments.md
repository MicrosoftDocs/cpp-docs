...
The latest version of this topic can be found at [Calls with a Variable Number of Arguments](https://docs.microsoft.com/cpp/c-language/calls-with-a-variable-number-of-arguments).  
