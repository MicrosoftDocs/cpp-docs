...
The latest version of this topic can be found at [Definitions and Declarations (C)](https://docs.microsoft.com/cpp/c-language/definitions-and-declarations-c).  
