...
The latest version of this topic can be found at [Casting Integers to Floating-Point Values](https://docs.microsoft.com/cpp/c-language/casting-integers-to-floating-point-values).  
