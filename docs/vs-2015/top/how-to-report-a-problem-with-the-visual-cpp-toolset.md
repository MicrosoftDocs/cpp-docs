...
The latest version of this topic can be found at [How to Report a Problem with the Visual C++ Toolset](https://docs.microsoft.com/cpp/how-to-report-a-problem-with-the-visual-cpp-toolset).  
