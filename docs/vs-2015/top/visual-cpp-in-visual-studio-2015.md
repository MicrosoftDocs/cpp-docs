...
The latest version of this topic can be found at [Visual C++ in Visual Studio](https://docs.microsoft.com/cpp/visual-cpp-in-visual-studio).  
  
  
The [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] programming language and development tools help you develop native Universal Windows apps, native desktop and server applications, cross-platform libraries that run on Android and iOS as well as Windows, and managed apps that run on the .NET Framework.  
...
## General Information about Visual C++  
 ...
 Guidance for porting code and upgrading projects to Visual C++ in [!INCLUDE[vs_dev14](../includes/vs-dev14-md.md)], including porting C++ code to Windows 10 and the Universal Windows Platform.  
 ...
 Learn more about new features and the latest information from the developers of [!INCLUDE[vcprvc](../includes/vcprvc-md.md)].  
...
## C++ Libraries in Visual Studio  
 ...
 [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] apps and components.  
