...
-   Use each [Declare Statement](http://msdn.microsoft.com/library/d3f21fb0-b804-4c99-97ed-583b23894cf1) to specify the character set for the external procedure it is declaring. The following example illustrates this.  
