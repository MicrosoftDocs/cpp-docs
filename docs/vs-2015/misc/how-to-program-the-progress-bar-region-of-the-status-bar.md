...
The Progress Bar region of the [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] status bar displays the incremental progress of quick operations, for example, saving a file to disk.  
...
## Example  
 ...
 [!code-csharp[VSSDKProgressStatusBar#1](../snippets/csharp/VS_Snippets_VSSDK/vssdkprogressstatusbar/cs/vssdkprogressstatusbarpackage.cs#1)]
 [!code-vb[VSSDKProgressStatusBar#1](../snippets/visualbasic/VS_Snippets_VSSDK/vssdkprogressstatusbar/vb/vssdkprogressstatusbarpackage.vb#1)]  
