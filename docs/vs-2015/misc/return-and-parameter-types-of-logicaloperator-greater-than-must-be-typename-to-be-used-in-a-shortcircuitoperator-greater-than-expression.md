...
An `And` operator or an `Or` operator is declared with unsuitable parameters or return type for use in an [AndAlso Operator](http://msdn.microsoft.com/library/bbc15191-b374-495b-9b8f-7b8c2f4388eb) or an [OrElse Operator](http://msdn.microsoft.com/library/253803d8-05b0-47d7-b213-abd222847779).  
