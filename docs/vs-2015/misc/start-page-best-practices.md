...
### Windows Presentation Framework (WPF)  
 Your XAML markup should follow WPF best practices. For information about [!INCLUDE[TLA#tla_winclient](../includes/tlasharptla-winclient-md.md)] and [!INCLUDE[TLA#tla_netframewk](../includes/tlasharptla-netframewk-md.md)] best practices for application development, see the following topics, as appropriate.  
...
## See Also  
 ...
 [Deploying Custom Start Pages](http://msdn.microsoft.com/library/4a7eb360-de83-41d5-be53-3cfb160d19f9)   
 [Adding Visual Studio Commands to a Start Page](http://msdn.microsoft.com/library/a8e2765c-cfb5-47b5-a414-6e48b434e0c2)