...
-   Otherwise, this warning usually occurs when your ruleset is empty or all of the rule enabled in child ruleset have been disabled. Use the [!INCLUDE[vs_current_short](../includes/vs-current-short-md.md)] ruleset editor to enable some rules in your ruleset. For more information, see [Creating Custom Rule Sets](http://msdn.microsoft.com/library/88db3a0a-1b92-496d-9fae-b2bb980f5933).  
