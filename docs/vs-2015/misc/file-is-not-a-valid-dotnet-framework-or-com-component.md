...
You are attempting to view a file in the Object Browser that does not contain a valid object. Only [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] and COM components can be viewed in the Object Browser.  
