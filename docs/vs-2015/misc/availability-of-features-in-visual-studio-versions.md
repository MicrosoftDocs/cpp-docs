...
||Visual Studio 2010<br /><br /> and<br /><br /> Visual Studio 2010 SP1|[!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)]|[!INCLUDE[vs_dev12](../includes/vs-dev12-md.md)]|  
|-|-----------------------------------------------------------|-------------------------------------------------------------------|--------------------------------------------------------------|  
...
4.  Visual Studio Tools for Office (VSTO) compatibility and Add-in functionality:  
    ...
    ||Visual Studio 2010|[!INCLUDE[vs_dev11_long](../includes/vs-dev11-long-md.md)]|[!INCLUDE[vs_dev12](../includes/vs-dev12-md.md)]|  
    |-|------------------------|-------------------------------------------------------------------|--------------------------------------------------------------|  
