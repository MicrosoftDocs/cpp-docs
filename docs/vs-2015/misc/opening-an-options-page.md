...
3.  Call the <xref:Microsoft.VisualStudio.Shell.Package.ShowOptionPage%2A> method by using the <xref:System.Type> of the options page as a parameter.  
     ...
     [!code-csharp[UI_UserSettings_ToolsOptionPages#5](../snippets/csharp/VS_Snippets_VSSDK/ui_usersettings_toolsoptionpages/cs/uiusersettingstoolsoptionspagespackage.cs#5)]
     [!code-vb[UI_UserSettings_ToolsOptionPages#5](../snippets/visualbasic/VS_Snippets_VSSDK/ui_usersettings_toolsoptionpages/vb/uiusersettingstoolsoptionspagespackage.vb#5)]  
...
3.  Call the <xref:System.ComponentModel.Design.MenuCommandService.GlobalInvoke%2A> method by using the <xref:System.ComponentModel.Design.CommandID> instance and the GUID string as parameters.  
     ...
     [!code-csharp[UI_UserSettings_ToolsOptionPages#6](../snippets/csharp/VS_Snippets_VSSDK/ui_usersettings_toolsoptionpages/cs/uiusersettingstoolsoptionspagespackage.cs#6)]
     [!code-vb[UI_UserSettings_ToolsOptionPages#6](../snippets/visualbasic/VS_Snippets_VSSDK/ui_usersettings_toolsoptionpages/vb/uiusersettingstoolsoptionspagespackage.vb#6)]