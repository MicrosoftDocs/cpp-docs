...
Generic types are not CLS-compliant  
 ...
 A CLS-compliant type cannot also be a generic type.  For more information about generics in Visual C++, see [Support for Generics in C++](../windows/generics-cpp-component-extensions.md).  
