...
The latest version of this topic can be found at [Constructing Input Stream Objects](https://docs.microsoft.com/cpp/standard-library/constructing-input-stream-objects).  
