...
The latest version of this topic can be found at [independent_bits_engine Class](https://docs.microsoft.com/cpp/standard-library/independent-bits-engine-class).  
