...
The latest version of this topic can be found at [Input Stream Member Functions](https://docs.microsoft.com/cpp/standard-library/input-stream-member-functions).  
