...
The latest version of this topic can be found at [is_member_function_pointer Class](https://docs.microsoft.com/cpp/standard-library/is-member-function-pointer-class).  
