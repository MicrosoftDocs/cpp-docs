...
The latest version of this topic can be found at [scoped_allocator_adaptor Class](https://docs.microsoft.com/cpp/standard-library/scoped-allocator-adaptor-class).  
