...
The latest version of this topic can be found at [integral_constant Class, bool_constant Class](https://docs.microsoft.com/cpp/standard-library/integral-constant-class-bool-constant-class).  
