...
The latest version of this topic can be found at [binomial_distribution Class](https://docs.microsoft.com/cpp/standard-library/binomial-distribution-class).  
