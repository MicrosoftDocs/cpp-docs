...
The latest version of this topic can be found at [mutex Class (C++ Standard Library)| Microsoft Docs](https://docs.microsoft.com/cpp/standard-library/mutex-class-stl).  
