...
The latest version of this topic can be found at [lognormal_distribution Class](https://docs.microsoft.com/cpp/standard-library/lognormal-distribution-class).  
