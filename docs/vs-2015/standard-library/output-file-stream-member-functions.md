...
The latest version of this topic can be found at [Output File Stream Member Functions](https://docs.microsoft.com/cpp/standard-library/output-file-stream-member-functions).  
