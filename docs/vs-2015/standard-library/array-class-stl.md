...
The latest version of this topic can be found at [array Class (C++ Standard Library)| Microsoft Docs](https://docs.microsoft.com/cpp/standard-library/array-class-stl).  
