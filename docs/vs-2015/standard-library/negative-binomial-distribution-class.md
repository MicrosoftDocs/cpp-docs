...
The latest version of this topic can be found at [negative_binomial_distribution Class](https://docs.microsoft.com/cpp/standard-library/negative-binomial-distribution-class).  
