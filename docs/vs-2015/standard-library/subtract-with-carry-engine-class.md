...
The latest version of this topic can be found at [subtract_with_carry_engine Class](https://docs.microsoft.com/cpp/standard-library/subtract-with-carry-engine-class).  
