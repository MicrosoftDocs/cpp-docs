...
The latest version of this topic can be found at [condition_variable_any Class](https://docs.microsoft.com/cpp/standard-library/condition-variable-any-class).  
