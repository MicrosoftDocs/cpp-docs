...
The latest version of this topic can be found at [C++ Standard Library Overview](https://docs.microsoft.com/cpp/standard-library/cpp-standard-library-overview).  
