...
The latest version of this topic can be found at [is_trivially_copy_assignable Class](https://docs.microsoft.com/cpp/standard-library/is-trivially-copy-assignable-class).  
