...
The latest version of this topic can be found at [valarray Class](https://docs.microsoft.com/cpp/standard-library/valarray-class).  
...
### Remarks  
 ...
 When compiled by using `_ITERATOR_DEBUG_LEVEL` defined as 1 or 2, a runtime error will occur if you attempt to access an element outside the bounds of the valarray.  See [Checked Iterators](../standard-library/checked-iterators.md) for more information.  
