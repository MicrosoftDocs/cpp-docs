...
The latest version of this topic can be found at [forward_iterator_tag Struct](https://docs.microsoft.com/cpp/standard-library/forward-iterator-tag-struct).  
