...
The latest version of this topic can be found at [C++ Standard Library Header Files](https://docs.microsoft.com/cpp/standard-library/cpp-standard-library-header-files).  
