...
The latest version of this topic can be found at [piecewise_constant_distribution Class](https://docs.microsoft.com/cpp/standard-library/piecewise-constant-distribution-class).  
