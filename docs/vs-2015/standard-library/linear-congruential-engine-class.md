...
The latest version of this topic can be found at [linear_congruential_engine Class](https://docs.microsoft.com/cpp/standard-library/linear-congruential-engine-class).  
