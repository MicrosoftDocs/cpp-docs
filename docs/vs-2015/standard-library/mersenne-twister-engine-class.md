...
The latest version of this topic can be found at [mersenne_twister_engine Class](https://docs.microsoft.com/cpp/standard-library/mersenne-twister-engine-class).  
