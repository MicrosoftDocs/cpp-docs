...
The latest version of this topic can be found at [recursive_directory_iterator Class](https://docs.microsoft.com/cpp/standard-library/recursive-directory-iterator-class).  
