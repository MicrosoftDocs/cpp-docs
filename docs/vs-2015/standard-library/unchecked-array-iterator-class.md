...
The latest version of this topic can be found at [unchecked_array_iterator Class](https://docs.microsoft.com/cpp/standard-library/unchecked-array-iterator-class).  
