...
The latest version of this topic can be found at [Using Insertion Operators and Controlling Format](https://docs.microsoft.com/cpp/standard-library/using-insertion-operators-and-controlling-format).  
