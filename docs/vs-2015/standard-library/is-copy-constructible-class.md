...
The latest version of this topic can be found at [is_copy_constructible Class](https://docs.microsoft.com/cpp/standard-library/is-copy-constructible-class).  
