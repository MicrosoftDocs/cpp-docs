...
The latest version of this topic can be found at [is_nothrow_destructible Class](https://docs.microsoft.com/cpp/standard-library/is-nothrow-destructible-class).  
