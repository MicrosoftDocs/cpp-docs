...
The latest version of this topic can be found at [&lt;memory&gt; functions](https://docs.microsoft.com/cpp/standard-library/memory-functions).  
...
### Example  
 ...
 [!code-cpp[stl_smart_pointers#214](../snippets/cpp/VS_Snippets_Cpp/stl_smart_pointers/cpp/stl_smart_ppointers.cpp#214)]  
