...
The latest version of this topic can be found at [&lt;unordered_set&gt; operators](https://docs.microsoft.com/cpp/standard-library/unordered-set-operators).  
  
||||
|-|-|-|
|[operator!=](#operator_neq)|[operator==](#operator_eq_eq)|[operator!= (unordered_multiset)](#operator_neq_unordered_multiset)|
|[operator== (unordered_multiset)](#operator_eq_eq_unordered_multiset)|  
