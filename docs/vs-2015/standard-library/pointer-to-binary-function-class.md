...
The latest version of this topic can be found at [pointer_to_binary_function Class](https://docs.microsoft.com/cpp/standard-library/pointer-to-binary-function-class).  
