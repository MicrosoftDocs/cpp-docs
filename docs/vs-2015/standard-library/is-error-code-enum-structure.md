...
The latest version of this topic can be found at [is_error_code_enum Structure](https://docs.microsoft.com/cpp/standard-library/is-error-code-enum-structure).  
