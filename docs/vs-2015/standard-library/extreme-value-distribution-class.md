...
The latest version of this topic can be found at [extreme_value_distribution Class](https://docs.microsoft.com/cpp/standard-library/extreme-value-distribution-class).  
