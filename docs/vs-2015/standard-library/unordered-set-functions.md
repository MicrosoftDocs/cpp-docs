...
The latest version of this topic can be found at [&lt;unordered_set&gt; functions](https://docs.microsoft.com/cpp/standard-library/unordered-set-functions).  
  
||||
|-|-|-|
|[swap Function](#swap_function)|[swap Function (unordered_set)](#swap_function_2)|  
...
##  <a name="swap_function_2"></a>  swap Function  (unordered_multiset)
 Swaps the contents of two containers.  
