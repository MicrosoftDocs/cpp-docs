...
The latest version of this topic can be found at [chi_squared_distribution Class](https://docs.microsoft.com/cpp/standard-library/chi-squared-distribution-class).  
