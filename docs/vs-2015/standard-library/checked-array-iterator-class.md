...
The latest version of this topic can be found at [checked_array_iterator Class](https://docs.microsoft.com/cpp/standard-library/checked-array-iterator-class).  
