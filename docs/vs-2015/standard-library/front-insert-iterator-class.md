...
The latest version of this topic can be found at [front_insert_iterator Class](https://docs.microsoft.com/cpp/standard-library/front-insert-iterator-class).  
