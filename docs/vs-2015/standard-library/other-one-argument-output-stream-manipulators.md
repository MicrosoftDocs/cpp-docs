...
The latest version of this topic can be found at [Other One-Argument Output Stream Manipulators](https://docs.microsoft.com/cpp/standard-library/other-one-argument-output-stream-manipulators).  
