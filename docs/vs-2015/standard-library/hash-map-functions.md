...
The latest version of this topic can be found at [&lt;hash_map&gt; functions](https://docs.microsoft.com/cpp/standard-library/hash-map-functions).  
  
||||
|-|-|-|
|[swap](#swap)|[swap (hash_multimap)](#swap__hash_map_)|  
...
##  <a name="swap"></a>  swap  (hash_multimap)
