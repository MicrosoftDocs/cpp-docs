...
The latest version of this topic can be found at [bernoulli_distribution Class](https://docs.microsoft.com/cpp/standard-library/bernoulli-distribution-class).  
