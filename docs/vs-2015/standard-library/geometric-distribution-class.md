...
The latest version of this topic can be found at [geometric_distribution Class](https://docs.microsoft.com/cpp/standard-library/geometric-distribution-class).  
