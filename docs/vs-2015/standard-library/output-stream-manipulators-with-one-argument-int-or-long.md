...
The latest version of this topic can be found at [Output Stream Manipulators with One Argument (int or long)](https://docs.microsoft.com/cpp/standard-library/output-stream-manipulators-with-one-argument-int-or-long).  
