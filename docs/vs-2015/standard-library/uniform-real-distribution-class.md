...
The latest version of this topic can be found at [uniform_real_distribution Class](https://docs.microsoft.com/cpp/standard-library/uniform-real-distribution-class).  
