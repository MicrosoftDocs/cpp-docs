...
The latest version of this topic can be found at [exponential_distribution Class](https://docs.microsoft.com/cpp/standard-library/exponential-distribution-class).  
