...
The latest version of this topic can be found at [&lt;functional&gt; functions](https://docs.microsoft.com/cpp/standard-library/functional-functions).  
...
### Example  
 [!code-cpp[functional_ptr_fun#1](../snippets/cpp/VS_Snippets_Cpp/functional_ptr_fun/cpp/functional_ptr_fun.cpp#1)]  
