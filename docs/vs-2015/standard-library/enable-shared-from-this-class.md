...
The latest version of this topic can be found at [enable_shared_from_this Class](https://docs.microsoft.com/cpp/standard-library/enable-shared-from-this-class).  
