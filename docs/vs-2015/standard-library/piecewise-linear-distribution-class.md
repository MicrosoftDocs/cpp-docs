...
The latest version of this topic can be found at [piecewise_linear_distribution Class](https://docs.microsoft.com/cpp/standard-library/piecewise-linear-distribution-class).  
