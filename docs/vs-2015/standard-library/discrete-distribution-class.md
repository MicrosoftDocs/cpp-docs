...
The latest version of this topic can be found at [discrete_distribution Class](https://docs.microsoft.com/cpp/standard-library/discrete-distribution-class).  
