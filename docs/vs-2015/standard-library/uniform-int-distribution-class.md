...
The latest version of this topic can be found at [uniform_int_distribution Class](https://docs.microsoft.com/cpp/standard-library/uniform-int-distribution-class).  
