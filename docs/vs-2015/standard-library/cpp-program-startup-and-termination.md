...
The latest version of this topic can be found at [C++ Program Startup and Termination](https://docs.microsoft.com/cpp/standard-library/cpp-program-startup-and-termination).  
