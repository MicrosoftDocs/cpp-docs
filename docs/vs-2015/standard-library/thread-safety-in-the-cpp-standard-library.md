...
The latest version of this topic can be found at [Thread Safety in the C++ Standard Library](https://docs.microsoft.com/cpp/standard-library/thread-safety-in-the-cpp-standard-library).  
