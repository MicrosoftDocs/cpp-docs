...
The latest version of this topic can be found at [is_default_constructible Class](https://docs.microsoft.com/cpp/standard-library/is-default-constructible-class).  
