...
The latest version of this topic can be found at [&lt;ostream&gt; operators](https://docs.microsoft.com/cpp/standard-library/ostream-operators).  
  
These are the global template operator functions defined in &lt;ostream&gt;. For member operator functions, see the [basic_ostream Class](../standard-library/basic-ostream-class.md) documentation.
