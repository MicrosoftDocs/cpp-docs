...
The latest version of this topic can be found at [pointer_to_unary_function Class](https://docs.microsoft.com/cpp/standard-library/pointer-to-unary-function-class).  
