...
The latest version of this topic can be found at [is_member_object_pointer Class](https://docs.microsoft.com/cpp/standard-library/is-member-object-pointer-class).  
