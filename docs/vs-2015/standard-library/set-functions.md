...
The latest version of this topic can be found at [&lt;set&gt; functions](https://docs.microsoft.com/cpp/standard-library/set-functions).  
  
||||
|-|-|-|
|[swap](#swap)|[swap (multiset)](#swap_multiset)|  
