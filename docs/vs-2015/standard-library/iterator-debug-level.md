...
The latest version of this topic can be found at [_ITERATOR_DEBUG_LEVEL](https://docs.microsoft.com/cpp/standard-library/iterator-debug-level).  
  
The `_ITERATOR_DEBUG_LEVEL` macro controls whether [checked iterators](../standard-library/checked-iterators.md) and [debug iterator support](../standard-library/debug-iterator-support.md) are enabled. This macro supersedes and combines the functionality of the [_SECURE_SCL](../standard-library/secure-scl.md) and [_HAS_ITERATOR_DEBUGGING](../standard-library/has-iterator-debugging.md) macros.  
