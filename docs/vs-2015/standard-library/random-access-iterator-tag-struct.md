...
The latest version of this topic can be found at [random_access_iterator_tag Struct](https://docs.microsoft.com/cpp/standard-library/random-access-iterator-tag-struct).  
