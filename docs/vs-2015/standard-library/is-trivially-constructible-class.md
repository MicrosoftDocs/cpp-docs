...
The latest version of this topic can be found at [is_trivially_constructible Class](https://docs.microsoft.com/cpp/standard-library/is-trivially-constructible-class).  
