...
The latest version of this topic can be found at [recursive_timed_mutex Class](https://docs.microsoft.com/cpp/standard-library/recursive-timed-mutex-class).  
