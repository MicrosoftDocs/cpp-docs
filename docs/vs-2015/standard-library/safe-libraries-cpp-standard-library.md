...
The latest version of this topic can be found at [Safe Libraries: C++ Standard Library](https://docs.microsoft.com/cpp/standard-library/safe-libraries-cpp-standard-library).  
