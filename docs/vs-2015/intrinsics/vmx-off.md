...
The latest version of this topic can be found at [__vmx_off](https://docs.microsoft.com/cpp/intrinsics/vmx-off).  
...
|---------------|------------------|  
|`__vmx_off`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
