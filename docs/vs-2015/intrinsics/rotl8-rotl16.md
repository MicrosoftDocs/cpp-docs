...
The latest version of this topic can be found at [_rotl8, _rotl16](https://docs.microsoft.com/cpp/intrinsics/rotl8-rotl16).  
...
|---------------|------------------|  
|`_rotl8`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`_rotl16`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
