...
The latest version of this topic can be found at [__svm_clgi](https://docs.microsoft.com/cpp/intrinsics/svm-clgi).  
...
|---------------|------------------|  
|`__svm_clgi`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
