...
The latest version of this topic can be found at [__wbinvd](https://docs.microsoft.com/cpp/intrinsics/wbinvd).  
...
|---------------|------------------|  
|`__wbinvd`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
