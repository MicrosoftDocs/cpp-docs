...
The latest version of this topic can be found at [__stosd](https://docs.microsoft.com/cpp/intrinsics/stosd).  
...
|---------------|------------------|  
|`__stosd`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
