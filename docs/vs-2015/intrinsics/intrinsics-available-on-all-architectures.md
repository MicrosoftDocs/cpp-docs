...
The latest version of this topic can be found at [Intrinsics Available on All Architectures](https://docs.microsoft.com/cpp/intrinsics/intrinsics-available-on-all-architectures).  
