...
The latest version of this topic can be found at [__addfsbyte, __addfsword, __addfsdword](https://docs.microsoft.com/cpp/intrinsics/addfsbyte-addfsword-addfsdword).  
