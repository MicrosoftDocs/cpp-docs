...
The latest version of this topic can be found at [_InterlockedExchangePointer Intrinsic Functions](https://docs.microsoft.com/cpp/intrinsics/interlockedexchangepointer-intrinsic-functions).  
...
|---------------|------------------|------------|  
|`_InterlockedExchangePointer`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
|`_InterlockedExchangePointer_acq`, `_InterlockedExchangePointer_rel`, `_InterlockedExchangePointer_nf`|ARM|\<intrin.h>|  
|`_InterlockedExchangePointer_HLEAcquire`, `_InterlockedExchangePointer_HLERelease`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)] with HLE support|\<immintrin.h>|  
