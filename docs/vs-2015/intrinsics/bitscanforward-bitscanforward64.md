...
The latest version of this topic can be found at [_BitScanForward, _BitScanForward64](https://docs.microsoft.com/cpp/intrinsics/bitscanforward-bitscanforward64).  
...
|---------------|------------------|  
|`_BitScanForward`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`_BitScanForward64`|ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
