...
The latest version of this topic can be found at [__writefsbyte, __writefsdword, __writefsqword, __writefsword](https://docs.microsoft.com/cpp/intrinsics/writefsbyte-writefsdword-writefsqword-writefsword).  
