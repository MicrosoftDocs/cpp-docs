...
The latest version of this topic can be found at [_InterlockedDecrement Intrinsic Functions](https://docs.microsoft.com/cpp/intrinsics/interlockeddecrement-intrinsic-functions).  
  
  
Microsoft Specific**  
  
 Provides compiler intrinsic support for the Win32 [!INCLUDE[winSDK](../includes/winsdk-md.md)] [InterlockedDecrement](http://msdn.microsoft.com/library/ms683580.aspx) function.  
...
|---------------|------------------|  
|`_InterlockedDecrement`, `_InterlockedDecrement16`, `_InterlockedDecrement64`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
