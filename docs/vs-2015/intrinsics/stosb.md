...
The latest version of this topic can be found at [__stosb](https://docs.microsoft.com/cpp/intrinsics/stosb).  
...
|---------------|------------------|  
|`__stosb`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
