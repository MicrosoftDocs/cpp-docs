...
The latest version of this topic can be found at [__emul, __emulu](https://docs.microsoft.com/cpp/intrinsics/emul-emulu).  
...
|---------------|------------------|  
|`__emul`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`__emulu`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
