...
The latest version of this topic can be found at [__outbyte](https://docs.microsoft.com/cpp/intrinsics/outbyte).  
...
|---------------|------------------|  
|`__outbyte`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
