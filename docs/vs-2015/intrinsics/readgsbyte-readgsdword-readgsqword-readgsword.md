...
The latest version of this topic can be found at [__readgsbyte, __readgsdword, __readgsqword, __readgsword](https://docs.microsoft.com/cpp/intrinsics/readgsbyte-readgsdword-readgsqword-readgsword).  
...
|---------------|------------------|  
|`__readgsbyte`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`__readgsdword`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`__readgsqword`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`__readgsword`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
