...
The latest version of this topic can be found at [__vmx_vmclear](https://docs.microsoft.com/cpp/intrinsics/vmx-vmclear).  
...
|---------------|------------------|  
|`__vmx_vmclear`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
