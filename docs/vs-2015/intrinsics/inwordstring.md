...
The latest version of this topic can be found at [__inwordstring](https://docs.microsoft.com/cpp/intrinsics/inwordstring).  
...
|---------------|------------------|  
|`__inwordstring`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
