...
The latest version of this topic can be found at [_rotr8, _rotr16](https://docs.microsoft.com/cpp/intrinsics/rotr8-rotr16).  
...
|---------------|------------------|  
|`_rotr8`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`_rotr16`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
