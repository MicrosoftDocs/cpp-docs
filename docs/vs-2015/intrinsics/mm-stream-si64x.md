...
The latest version of this topic can be found at [_mm_stream_si64x](https://docs.microsoft.com/cpp/intrinsics/mm-stream-si64x).  
...
|---------------|------------------|  
|`_mm_stream_si64x`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
