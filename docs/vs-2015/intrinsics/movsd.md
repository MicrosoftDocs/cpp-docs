...
The latest version of this topic can be found at [__movsd](https://docs.microsoft.com/cpp/intrinsics/movsd).  
...
|---------------|------------------|  
|`__movsd`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
