...
The latest version of this topic can be found at [__ll_lshift](https://docs.microsoft.com/cpp/intrinsics/ll-lshift).  
...
|---------------|------------------|  
|`__ll_lshift`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
