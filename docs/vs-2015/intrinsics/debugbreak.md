...
The latest version of this topic can be found at [__debugbreak](https://docs.microsoft.com/cpp/intrinsics/debugbreak).  
...
|---------------|------------------|------------|  
|`__debugbreak`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
