...
The latest version of this topic can be found at [__vmx_on](https://docs.microsoft.com/cpp/intrinsics/vmx-on).  
...
|---------------|------------------|  
|`__vmx_on`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
