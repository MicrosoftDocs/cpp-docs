...
The latest version of this topic can be found at [__svm_skinit](https://docs.microsoft.com/cpp/intrinsics/svm-skinit).  
...
|---------------|------------------|  
|`__svm_skinit`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
