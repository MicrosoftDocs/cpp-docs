...
The latest version of this topic can be found at [__vmx_vmptrld](https://docs.microsoft.com/cpp/intrinsics/vmx-vmptrld).  
...
|---------------|------------------|  
|`__vmx_vmptrld`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
