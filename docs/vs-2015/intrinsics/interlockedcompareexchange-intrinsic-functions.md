...
The latest version of this topic can be found at [_InterlockedCompareExchange Intrinsic Functions](https://docs.microsoft.com/cpp/intrinsics/interlockedcompareexchange-intrinsic-functions).  
...
|---------------|------------------|------------|  
|`_InterlockedCompareExchange`, `_InterlockedCompareExchange8`, `_InterlockedCompareExchange16`, `_InterlockedCompareExchange64`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
...
|`_InterlockedCompareExchange_np`, `_InterlockedCompareExchange16_np`, `_InterlockedCompareExchange64_np`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
|`_InterlockedCompareExchange_HLEAcquire`, `_InterlockedCompareExchange_HLERelease`, `_InterlockedCompareExchange64_HLEAcquire`, `_InterlockedCompareExchange64_HLERelease`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<immintrin.h>|  
...
## Remarks  
 ...
 `_InterlockedCompareExchange` provides compiler intrinsic support for the Win32 [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] [InterlockedCompareExchange](http://msdn.microsoft.com/library/ms683560.aspx) function.  
