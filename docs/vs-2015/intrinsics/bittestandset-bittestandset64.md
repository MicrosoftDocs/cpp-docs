...
The latest version of this topic can be found at [_bittestandset, _bittestandset64](https://docs.microsoft.com/cpp/intrinsics/bittestandset-bittestandset64).  
...
|---------------|------------------|  
|`_bittestandset`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
|`_bittestandset64`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
