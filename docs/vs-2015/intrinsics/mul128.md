...
The latest version of this topic can be found at [__mul128](https://docs.microsoft.com/cpp/intrinsics/mul128).  
...
|---------------|------------------|  
|`__mul128`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
