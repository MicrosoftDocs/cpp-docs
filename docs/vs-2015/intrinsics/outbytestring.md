...
The latest version of this topic can be found at [__outbytestring](https://docs.microsoft.com/cpp/intrinsics/outbytestring).  
...
|---------------|------------------|  
|`__outbytestring`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
