...
The latest version of this topic can be found at [__segmentlimit](https://docs.microsoft.com/cpp/intrinsics/segmentlimit).  
...
|---------------|------------------|  
|`__segmentlimit`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
