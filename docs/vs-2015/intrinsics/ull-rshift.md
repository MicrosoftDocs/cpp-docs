...
The latest version of this topic can be found at [__ull_rshift](https://docs.microsoft.com/cpp/intrinsics/ull-rshift).  
...
|---------------|------------------|  
|`__ull_rshift`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
