...
The latest version of this topic can be found at [__outdwordstring](https://docs.microsoft.com/cpp/intrinsics/outdwordstring).  
...
|---------------|------------------|  
|`__outdwordstring`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
