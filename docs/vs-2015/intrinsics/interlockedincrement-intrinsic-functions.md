...
The latest version of this topic can be found at [_InterlockedIncrement Intrinsic Functions](https://docs.microsoft.com/cpp/intrinsics/interlockedincrement-intrinsic-functions).  
  
  
Microsoft Specific**  
  
 Provide compiler intrinsic support for the Win32 [!INCLUDE[winsdkshort](../includes/winsdkshort-md.md)] [InterlockedIncrement](http://msdn.microsoft.com/library/ms683614.aspx) function.  
...
|---------------|------------------|------------|  
|`_InterlockedIncrement`, `_InterlockedIncrement16`, `_InterlockedIncrement64`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
