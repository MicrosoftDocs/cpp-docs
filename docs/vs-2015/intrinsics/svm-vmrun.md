...
The latest version of this topic can be found at [__svm_vmrun](https://docs.microsoft.com/cpp/intrinsics/svm-vmrun).  
...
|---------------|------------------|  
|`__svm_vmrun`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
