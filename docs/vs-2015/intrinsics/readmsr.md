...
The latest version of this topic can be found at [__readmsr](https://docs.microsoft.com/cpp/intrinsics/readmsr).  
...
|---------------|------------------|  
|`__readmsr`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
