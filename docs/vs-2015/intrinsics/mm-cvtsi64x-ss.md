...
The latest version of this topic can be found at [_mm_cvtsi64x_ss](https://docs.microsoft.com/cpp/intrinsics/mm-cvtsi64x-ss).  
  
  
Microsoft Specific**  
  
 Generates the [!INCLUDE[vcprx64](../includes/vcprx64-md.md)] extended version of the Convert 64-Bit Integer to Scalar Single-Precision Floating-Point Value (`cvtsi2ss`) instruction.  
