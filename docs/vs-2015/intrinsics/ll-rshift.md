...
The latest version of this topic can be found at [__ll_rshift](https://docs.microsoft.com/cpp/intrinsics/ll-rshift).  
...
|---------------|------------------|  
|`__ll_rshift`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
