...
The latest version of this topic can be found at [__assume](https://docs.microsoft.com/cpp/intrinsics/assume).  
...
|---------------|------------------|  
|`__assume`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
