...
The latest version of this topic can be found at [__svm_invlpga](https://docs.microsoft.com/cpp/intrinsics/svm-invlpga).  
...
|---------------|------------------|  
|`__svm_invlpga`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
