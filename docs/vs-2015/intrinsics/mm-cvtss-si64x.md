...
The latest version of this topic can be found at [_mm_cvtss_si64x](https://docs.microsoft.com/cpp/intrinsics/mm-cvtss-si64x).  
  
  
Microsoft Specific**  
  
 Generates the [!INCLUDE[vcprx64](../includes/vcprx64-md.md)] extended version of the Convert Scalar Single Precision Floating Point Number to 64-bit Integer (`cvtss2si`) instruction.  
...
|---------------|------------------|  
|`_mm_cvtss_si64x`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
