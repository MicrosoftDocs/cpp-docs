...
The latest version of this topic can be found at [_umul128](https://docs.microsoft.com/cpp/intrinsics/umul128).  
...
|---------------|------------------|------------|  
|`_umul128`|ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
