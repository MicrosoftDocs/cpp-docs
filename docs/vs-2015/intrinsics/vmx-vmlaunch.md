...
The latest version of this topic can be found at [__vmx_vmlaunch](https://docs.microsoft.com/cpp/intrinsics/vmx-vmlaunch).  
...
|---------------|------------------|  
|`__vmx_vmlaunch`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
