...
The latest version of this topic can be found at [_mm_cvttss_si64x](https://docs.microsoft.com/cpp/intrinsics/mm-cvttss-si64x).  
...
|---------------|------------------|  
|`_mm_cvttss_si64x`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
