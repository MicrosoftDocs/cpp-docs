...
The latest version of this topic can be found at [__vmx_vmresume](https://docs.microsoft.com/cpp/intrinsics/vmx-vmresume).  
...
|---------------|------------------|  
|`__vmx_vmresume`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
