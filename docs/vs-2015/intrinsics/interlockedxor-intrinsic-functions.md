...
The latest version of this topic can be found at [_InterlockedXor Intrinsic Functions](https://docs.microsoft.com/cpp/intrinsics/interlockedxor-intrinsic-functions).  
...
|---------------|------------------|------------|  
|`_InterlockedXor`, `_InterlockedXor8`, `_InterlockedXor16`, `_InterlockedXor64`|x86, ARM, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
...
|`_InterlockedXor_np`, `_InterlockedXor8_np`, `_InterlockedXor16_np`, `_InterlockedXor64_np`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<intrin.h>|  
|`_InterlockedXor_HLEAcquire`, `_InterlockedXor_HLERelease`, `_InterlockedXor64_HLEAcquire`, `_InterlockedXor64_HLERelease`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|\<immintrin.h>|  
