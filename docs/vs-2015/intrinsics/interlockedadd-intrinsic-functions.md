...
The latest version of this topic can be found at [_InterlockedAdd Intrinsic Functions](https://docs.microsoft.com/cpp/intrinsics/interlockedadd-intrinsic-functions).  
