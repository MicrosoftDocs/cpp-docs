...
The latest version of this topic can be found at [__shiftright128](https://docs.microsoft.com/cpp/intrinsics/shiftright128).  
...
|---------------|------------------|  
|`__shiftright128`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
