...
The latest version of this topic can be found at [__fastfail](https://docs.microsoft.com/cpp/intrinsics/fastfail).  
...
|------------------|-----------------|-------------------------------|  
|x86|int 0x29|ecx|  
|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|int 0x29|rcx|  
...
|---------------|------------------|  
|`__fastfail`|x86, [!INCLUDE[vcprx64](../includes/vcprx64-md.md)], ARM|  
