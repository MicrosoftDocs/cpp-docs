...
The latest version of this topic can be found at [__vmx_vmread](https://docs.microsoft.com/cpp/intrinsics/vmx-vmread).  
...
|---------------|------------------|  
|`__vmx_vmread`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
