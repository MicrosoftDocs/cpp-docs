...
The latest version of this topic can be found at [__vmx_vmwrite](https://docs.microsoft.com/cpp/intrinsics/vmx-vmwrite).  
...
|---------------|------------------|  
|`__vmx_vmwrite`|[!INCLUDE[vcprx64](../includes/vcprx64-md.md)]|  
