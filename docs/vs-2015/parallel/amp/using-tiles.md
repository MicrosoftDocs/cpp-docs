...
- [tile_barrier::wait Method](http://msdn.microsoft.com/library/98aa8ef0-ed25-49c1-90ab-c6516c3a7a8f): Creates a fence around both global and `tile_static` memory.  
  
- [tile_barrier::wait_with_all_memory_fence Method](http://msdn.microsoft.com/library/2116d010-fdbb-4eea-af46-de3d82276932): Creates a fence around both global and `tile_static` memory.  
  
- [tile_barrier::wait_with_global_memory_fence Method](http://msdn.microsoft.com/library/fc3b89f4-0865-40d3-90f7-c3fc8686e4e9): Creates a fence around only global memory.  
  
- [tile_barrier::wait_with_tile_static_memory_fence Method](http://msdn.microsoft.com/library/65109506-63a0-4219-ae61-03974355c09c): Creates a fence around only `tile_static` memory.  
