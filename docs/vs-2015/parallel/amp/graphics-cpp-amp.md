...
### Reading from Texture Objects  
 You can read from a `texture` object by using [texture::operatorOperator](http://msdn.microsoft.com/library/a71de53c-9da9-4086-b56d-53b1ac4461db), [texture::operator() Operator](http://msdn.microsoft.com/library/831454d3-d1fa-4a82-a0c8-690155ae1ff0), or [texture::get Method](http://msdn.microsoft.com/library/78a2bfa3-8cfc-43ec-acb2-2140505849f1). [texture::operatorOperator](http://msdn.microsoft.com/library/a71de53c-9da9-4086-b56d-53b1ac4461db) and [texture::operator() Operator](http://msdn.microsoft.com/library/831454d3-d1fa-4a82-a0c8-690155ae1ff0) return a value, not a reference. Therefore, you cannot write to a `texture` object by using [texture::operatorOperator](http://msdn.microsoft.com/library/a71de53c-9da9-4086-b56d-53b1ac4461db).  
...
### Writing to Texture Objects  
 Use the [texture::set](http://msdn.microsoft.com/library/c518e29e-64f3-4d27-8e2c-3beb2ce2981c) method to write to `texture` objects. A texture object can be readonly or read/write. For a texture object to be readable and writeable, the following conditions must be true:  
...
### Copying Texture Objects  
 You can copy between texture objects by using the [copy](http://msdn.microsoft.com/library/cf3cda4b-5c64-4083-a0aa-39de2b378802) function or the [copy_async](http://msdn.microsoft.com/library/6f06115b-1b85-43f4-a3b7-019af90748ec) function, as shown in the following code example.  
...
## Interoperability  
 The C++ AMP runtime supports interoperability between `texture<T,1>` and the [ID3D11Texture1D interface](http://go.microsoft.com/fwlink/p/LinkId=248503), between `texture<T,2>` and the [ID3D11Texture2D interface](http://go.microsoft.com/fwlink/p/LinkId=255317), and between `texture<T,3>` and the [ID3D11Texture3D interface](http://go.microsoft.com/fwlink/p/LinkId=255377). The [get_texture](http://msdn.microsoft.com/library/4f3354b8-3d5b-4feb-8825-95f32175d7e0) method takes a `texture` object and returns an `IUnknown` interface. The [make_texture](http://msdn.microsoft.com/library/abf23804-dac7-455b-826e-c50f57e8f4b7) method takes an `IUnknown` interface and an `accelerator_view` object and returns a `texture` object.  
