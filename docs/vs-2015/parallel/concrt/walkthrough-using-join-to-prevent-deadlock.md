...
##  <a name="problem"></a> The Dining Philosophers Problem  
 ...
 ![The Dining Philosophers Problem](../../parallel/concrt/media/dining-philosophersproblem.png "Dining_PhilosophersProblem")  
...
### Code  
 [!code-cpp[concrt-philosophers-deadlock#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-deadlock/cpp/philosophers-deadlock.cpp#1)]  
...
1.  Remove the following code from the example.  
 ...
 [!code-cpp[concrt-philosophers-deadlock#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-deadlock/cpp/philosophers-deadlock.cpp#2)]  
  
2.  Change the type of the `_left` and `_right` data members of the `philosopher` class to `unbounded_buffer`.  
  
 [!code-cpp[concrt-philosophers-join#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-join/cpp/philosophers-join.cpp#2)]  
  
3.  Modify the `philosopher` constructor to take `unbounded_buffer` objects as its parameters.  
  
 [!code-cpp[concrt-philosophers-join#3](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-join/cpp/philosophers-join.cpp#3)]  
...
4.  Modify the `pickup_chopsticks` method to use a non-greedy `join` object to receive messages from the message buffers for both chopsticks.  
 ...
 [!code-cpp[concrt-philosophers-join#4](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-join/cpp/philosophers-join.cpp#4)]  
...
5.  Modify the `putdown_chopsticks` method to release access to the chopsticks by sending a message to the message buffers for both chopsticks.  
 ...
 [!code-cpp[concrt-philosophers-join#5](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-join/cpp/philosophers-join.cpp#5)]  
...
6.  Modify the `run` method to hold the results of the `pickup_chopsticks` method and to pass those results to the `putdown_chopsticks` method.  
 ...
 [!code-cpp[concrt-philosophers-join#6](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-join/cpp/philosophers-join.cpp#6)]  
...
7.  Modify the declaration of the `chopsticks` variable in the `wmain` function to be an array of `unbounded_buffer` objects that each hold one message.  
 ...
 [!code-cpp[concrt-philosophers-join#7](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-join/cpp/philosophers-join.cpp#7)]  
...
### Code  
 [!code-cpp[concrt-philosophers-join#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-philosophers-join/cpp/philosophers-join.cpp#1)]  
