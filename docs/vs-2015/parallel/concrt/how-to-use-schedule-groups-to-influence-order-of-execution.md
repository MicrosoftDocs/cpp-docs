...
In the Concurrency Runtime, the order in which tasks are scheduled is non-deterministic. However, you can use scheduling policies to influence the order in which tasks run. This topic shows how to use schedule groups together with the [concurrency::SchedulingProtocol](http://msdn.microsoft.com/library/6376ca26-54c8-4804-863f-c081e387fe36) scheduler policy to influence the order in which tasks run.  
