...
>  For more information about the `timer` and `call` classes, which are part of the Asynchronous Agents Library, see [Asynchronous Message Blocks](../../parallel/concrt/asynchronous-message-blocks.md).  
 ...
 [!code-cpp[concrt-task-delay#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-task-delay/cpp/task-delay.cpp#1)]  
...
## Example  
 ...
 [!code-cpp[concrt-task-delay#3](../../snippets/cpp/VS_Snippets_ConcRT/concrt-task-delay/cpp/task-delay.cpp#3)]  
