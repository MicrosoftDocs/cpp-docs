...
##  <a name="design"></a> Designing a Custom Message Block  
 ...
 [!code-cpp[concrt-priority-buffer#20](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.cpp#20)]  
 ...
 A class that derives from `source_block` must implement six methods: [propagate_to_any_targets](http://msdn.microsoft.com/library/d7e2b8e8-3788-4a44-af96-58a1a16eb1f0), [accept_message](http://msdn.microsoft.com/library/7c1f52be-d7be-42ff-bf33-d59bb2466f13), [reserve_message](http://msdn.microsoft.com/library/94c8348f-3bc0-4a30-8608-b1d48a90e789), [consume_message](http://msdn.microsoft.com/library/1d20e951-ef02-40c3-aa61-048723623ca9), [release_message](http://msdn.microsoft.com/library/c48db15b-5bc8-4f73-86d4-ade1bc076392), and [resume_propagation](http://msdn.microsoft.com/library/81625251-040d-42f6-b6fb-acb8185a630f). A class that derives from `target_block` must implement the [propagate_message](http://msdn.microsoft.com/library/9e868729-9235-481f-84c9-589b5befd2ce) method and can optionally implement the [send_message](http://msdn.microsoft.com/library/ac572d55-13ee-46a3-95ed-8880995d749d) method. Deriving from `propagator_block` is functionally equivalent to deriving from both `source_block` and `target_block`.  
...
2.  In `priority_buffer.h`, add the following code.  
 ...
 [!code-cpp[concrt-priority-buffer#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#1)]  
...
3.  In the `std` namespace, define specializations of [std::less](../../standard-library/less-struct.md) and [std::greater](../../standard-library/greater-struct.md) that act on concurrency::[message](../../parallel/concrt/reference/message-class.md) objects.  
 ...
 [!code-cpp[concrt-priority-buffer#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#2)]  
...
4.  In the `concurrencyex` namespace, declare the `priority_buffer` class.  
 ...
 [!code-cpp[concrt-priority-buffer#3](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#3)]  
...
5.  In the `private` section of the `priority_buffer` class, add the following member variables.  
 ...
 [!code-cpp[concrt-priority-buffer#6](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#6)]  
...
6.  In the `private` section, define the copy constructor and the assignment operator. This prevents `priority_queue` objects from being assignable.  
 ...
 [!code-cpp[concrt-priority-buffer#7](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#7)]  
  
7.  In the `public` section, define the constructors that are common to many message block types. Also define the destructor.  
  
 [!code-cpp[concrt-priority-buffer#4](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#4)]  
...
8.  In the `public` section, define the methods `enqueue` and `dequeue`. These helper methods provide an alternative way to send messages to and receive messages from a `priority_buffer` object.  
 ...
 [!code-cpp[concrt-priority-buffer#5](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#5)]  
  
9. In the `protected` section, define the `propagate_to_any_targets` method.  
  
 [!code-cpp[concrt-priority-buffer#9](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#9)]  
...
10. In the `protected` section, define the `accept_message` method.  
 ...
 [!code-cpp[concrt-priority-buffer#8](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#8)]  
...
11. In the `protected` section, define the `reserve_message` method.  
 ...
 [!code-cpp[concrt-priority-buffer#10](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#10)]  
...
12. In the `protected` section, define the `consume_message` method.  
 ...
 [!code-cpp[concrt-priority-buffer#11](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#11)]  
...
13. In the `protected` section, define the `release_message` method.  
 ...
 [!code-cpp[concrt-priority-buffer#12](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#12)]  
...
14. In the `protected` section, define the `resume_propagation` method.  
 ...
 [!code-cpp[concrt-priority-buffer#13](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#13)]  
...
15. In the `protected` section, define the `link_target_notification` method.  
 ...
 [!code-cpp[concrt-priority-buffer#14](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#14)]  
...
16. In the `private` section, define the `propagate_priority_order` method.  
 ...
 [!code-cpp[concrt-priority-buffer#15](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#15)]  
...
17. In the `protected` section, define the `propagate_message` method.  
 ...
 [!code-cpp[concrt-priority-buffer#16](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#16)]  
     ...
     The runtime calls this method when you call the [concurrency::asend](http://msdn.microsoft.com/library/920dc665-7e23-4bd7-8c74-3e74067aa52a) function or when the message block is connected to other message blocks.  
  
18. In the `protected` section, define the `send_message` method.  
  
 [!code-cpp[concrt-priority-buffer#17](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#17)]  
     ...
     The runtime calls this method during a synchronous send operation, such as when you call the [concurrency::send](http://msdn.microsoft.com/library/8713fb36-066b-47de-af12-589fa74805d6) function.  
 ...
 Because the `priority_buffer` class orders messages by priority and then by the order in which messages are received, this class is most useful when it receives messages asynchronously, for example, when you call the [concurrency::asend](http://msdn.microsoft.com/library/920dc665-7e23-4bd7-8c74-3e74067aa52a) function or when the message block is connected to other message blocks.  
...
##  <a name="complete"></a> The Complete Example  
 ...
 [!code-cpp[concrt-priority-buffer#18](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.h#18)]  
  
 The following example concurrently performs a number of `asend` and [concurrency::receive](http://msdn.microsoft.com/library/f36bbca1-97ac-4343-bfac-ea71ca2139e9) operations on a `priority_buffer` object.  
  
 [!code-cpp[concrt-priority-buffer#19](../../snippets/cpp/VS_Snippets_ConcRT/concrt-priority-buffer/cpp/priority_buffer.cpp#19)]  
