...
##  <a name="small-loops"></a> Do Not Parallelize Small Loop Bodies  
 ...
 [!code-cpp[concrt-small-loops#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-small-loops/cpp/small-loops.cpp#1)]  
...
##  <a name="highest"></a> Express Parallelism at the Highest Possible Level  
 ...
 [!code-cpp[concrt-image-processing-filter#21](../../snippets/cpp/VS_Snippets_ConcRT/concrt-image-processing-filter/cpp/image-processing-filter.cpp#21)]  
...
##  <a name="divide-and-conquer"></a> Use parallel_invoke to Solve Divide-and-Conquer Problems  
 ...
 [!code-cpp[concrt-parallel-bitonic-sort#12](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#12)]  
...
##  <a name="breaking-loops"></a> Use Cancellation or Exception Handling to Break from a Parallel Loop  
 ...
 [!code-cpp[concrt-task-tree-search#6](../../snippets/cpp/VS_Snippets_ConcRT/concrt-task-tree-search/cpp/task-tree-search.cpp#6)]  
 ...
 [!code-cpp[concrt-task-tree-search#3](../../snippets/cpp/VS_Snippets_ConcRT/concrt-task-tree-search/cpp/task-tree-search.cpp#3)]  
 ...
 For more general information about the cancellation and exception-handling mechanisms that are provided by the PPL, see [Cancellation](../../parallel/concrt/exception-handling-in-the-concurrency-runtime.md#cancellation_in_the_ppl) and [Exception Handling](../../parallel/concrt/exception-handling-in-the-concurrency-runtime.md).  
...
##  <a name="object-destruction"></a> Understand how Cancellation and Exception Handling Affect Object Destruction  
 ...
 [!code-cpp[concrt-parallel-resource-destruction#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-resource-destruction/cpp/parallel-resource-destruction.h#1)]  
 ...
 [!code-cpp[concrt-parallel-resource-destruction#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-resource-destruction/cpp/parallel-resource-destruction.cpp#2)]  
...
##  <a name="blocking"></a> Do Not Perform Blocking Operations When You Cancel Parallel Work  
 ...
 [!code-cpp[concrt-blocking-cancel#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-blocking-cancel/cpp/blocking-cancel.cpp#2)]  
 ...
 *False sharing* occurs when multiple concurrent tasks that are running on separate processors write to variables that are located on the same cache line. When one task writes to one of the variables, the cache line for both variables is invalidated. Each processor must reload the cache line every time that the cache line is invalidated. Therefore, false sharing can cause decreased performance in your application.  
 ...
 [!code-cpp[concrt-false-sharing#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-false-sharing/cpp/false-sharing.cpp#1)]  
 ...
 [!code-cpp[concrt-false-sharing#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-false-sharing/cpp/false-sharing.cpp#2)]  
 ...
 [!code-cpp[concrt-false-sharing#3](../../snippets/cpp/VS_Snippets_ConcRT/concrt-false-sharing/cpp/false-sharing.cpp#3)]  
...
##  <a name="lifetime"></a> Make Sure That Variables Are Valid Throughout the Lifetime of a Task  
 ...
 [!code-cpp[concrt-lambda-lifetime#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-lambda-lifetime/cpp/lambda-lifetime.cpp#1)]  
 ...
 [!code-cpp[concrt-lambda-lifetime#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-lambda-lifetime/cpp/lambda-lifetime.cpp#2)]  
 ...
 [!code-cpp[concrt-lambda-lifetime#4](../../snippets/cpp/VS_Snippets_ConcRT/concrt-lambda-lifetime/cpp/lambda-lifetime.cpp#4)]  
