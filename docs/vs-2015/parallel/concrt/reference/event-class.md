...
> [!IMPORTANT]
>  In a [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] app, do not call `wait` on the ASTA thread because this call can block the current thread and can cause the app to become unresponsive.  
...
> [!IMPORTANT]
>  In a [!INCLUDE[win8_appname_long](../../../includes/win8-appname-long-md.md)] app, do not call `wait_for_multiple` on the ASTA thread because this call can block the current thread and can cause the app to become unresponsive.  
