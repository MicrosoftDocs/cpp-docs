...
### Remarks  
 ...
 This function is new in [!INCLUDE[vs_dev14](../../../includes/vs-dev14-md.md)] and is identical to the [Yield](#context__yield_method) function but does not conflict with the Yield macro in Windows.h.  
