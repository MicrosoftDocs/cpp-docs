...
> [!IMPORTANT]
>  The Task Scheduler and Resource Manager components are not available from a [!INCLUDE[win8_appname_long](../../includes/win8-appname-long-md.md)] app or when you use the task class or other types in ppltasks.h.  
