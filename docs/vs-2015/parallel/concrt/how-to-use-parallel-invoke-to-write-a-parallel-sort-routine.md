...
##  <a name="serial"></a> Performing Bitonic Sort Serially  
 ...
 [!code-cpp[concrt-parallel-bitonic-sort#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#1)]  
...
1.  Add a `#include` directive for the header file ppl.h.  
 ...
 [!code-cpp[concrt-parallel-bitonic-sort#10](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#10)]  
  
2.  Add a `using` directive for the `concurrency` namespace.  
  
 [!code-cpp[concrt-parallel-bitonic-sort#11](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#11)]  
...
3.  Create a new function, called `parallel_bitonic_mege`, which uses the `parallel_invoke` algorithm to merge the sequences in parallel if there is sufficient amount of work to do. Otherwise, call `bitonic_merge` to merge the sequences serially.  
 ...
 [!code-cpp[concrt-parallel-bitonic-sort#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#2)]  
  
4.  Perform a process that resembles the one in the previous step, but for the `bitonic_sort` function.  
  
 [!code-cpp[concrt-parallel-bitonic-sort#3](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#3)]  
  
5.  Create an overloaded version of the `parallel_bitonic_sort` function that sorts the array in increasing order.  
  
 [!code-cpp[concrt-parallel-bitonic-sort#4](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#4)]  
 ...
 [!code-cpp[concrt-parallel-bitonic-sort#5](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#5)]  
 ...
 [!code-cpp[concrt-parallel-bitonic-sort#8](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#8)]  
...
## Robust Programming  
 ...
 [!code-cpp[concrt-parallel-bitonic-sort#9](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-bitonic-sort/cpp/parallel-bitonic-sort.cpp#9)]  
