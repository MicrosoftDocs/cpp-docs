...
### Using COM with the Parallel Patterns Library  
 ...
 [!code-cpp[concrt-parallel-scripts#1](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#1)]  
 ...
 [!code-cpp[concrt-parallel-scripts#2](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#2)]  
 ...
 [!code-cpp[concrt-parallel-scripts#3](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#3)]  
  
 You can use the `CCoInitializer` class to automatically free the COM library when the task exits, as follows.  
  
 [!code-cpp[concrt-parallel-scripts#4](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#4)]  
...
### Using COM with Asynchronous Agents  
 ...
 [!code-cpp[concrt-parallel-scripts#5](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#5)]  
...
### Using COM with Lightweight Tasks  
 ...
 [!code-cpp[concrt-parallel-scripts#6](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#6)]  
...
## An Example of a COM-Enabled Application  
 ...
 [!code-cpp[concrt-parallel-scripts#7](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#7)]  
...
### Calling the Script from the PPL  
 ...
 [!code-cpp[concrt-parallel-scripts#10](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#10)]  
...
### Calling the Script from an Agent  
 ...
 [!code-cpp[concrt-parallel-scripts#11](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#11)]  
 ...
 [!code-cpp[concrt-parallel-scripts#12](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#12)]  
  
 To use the `AgentFibonacci` function with the example, add the following code before the `wmain` function returns.  
  
 [!code-cpp[concrt-parallel-scripts#13](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#13)]  
...
### The Complete Example  
 ...
 [!code-cpp[concrt-parallel-scripts#14](../../snippets/cpp/VS_Snippets_ConcRT/concrt-parallel-scripts/cpp/parallel-scripts.cpp#14)]  
