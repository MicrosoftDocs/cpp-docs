...
The latest version of this topic can be found at [collection_adapter::mapped_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-mapped-type-stl-clr).  
