...
The latest version of this topic can be found at [Cast Notation and Introduction of safe_cast&lt;&gt;](https://docs.microsoft.com/cpp/dotnet/cast-notation-and-introduction-of-safe-cast-angles).  
  
  
The cast notation has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
