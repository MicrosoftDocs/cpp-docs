...
The latest version of this topic can be found at [range_adapter::range_adapter (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/range-adapter-range-adapter-stl-clr).  
