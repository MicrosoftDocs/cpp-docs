...
The latest version of this topic can be found at [priority_queue::generic_value (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-generic-value-stl-clr).  
