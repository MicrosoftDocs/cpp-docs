...
The latest version of this topic can be found at [hash_multimap::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-difference-type-stl-clr).  
