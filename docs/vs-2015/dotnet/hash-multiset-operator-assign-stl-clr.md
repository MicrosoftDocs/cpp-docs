...
The latest version of this topic can be found at [hash_multiset::operator= (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-operator-assign-stl-clr).  
