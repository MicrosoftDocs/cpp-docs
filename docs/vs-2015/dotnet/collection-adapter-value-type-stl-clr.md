...
The latest version of this topic can be found at [collection_adapter::value_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-value-type-stl-clr).  
