...
The latest version of this topic can be found at [How to: Use a Native Type in a -clr Compilation](https://docs.microsoft.com/cpp/dotnet/how-to-use-a-native-type-in-a-clr-compilation).  
