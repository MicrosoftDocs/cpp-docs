...
The latest version of this topic can be found at [How to: Marshal BSTR Strings for ADO.NET (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-bstr-strings-for-adonet-cpp-cli).  
