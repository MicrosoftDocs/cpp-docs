...
The latest version of this topic can be found at [hash_multiset::equal_range (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-equal-range-stl-clr).  
