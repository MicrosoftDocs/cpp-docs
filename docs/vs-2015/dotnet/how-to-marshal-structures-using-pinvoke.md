...
The latest version of this topic can be found at [How to: Marshal Structures Using PInvoke](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-structures-using-pinvoke).  
