...
The latest version of this topic can be found at [How to: Compile MFC and ATL Code By Using -clr](https://docs.microsoft.com/cpp/dotnet/how-to-compile-mfc-and-atl-code-by-using-clr).  
