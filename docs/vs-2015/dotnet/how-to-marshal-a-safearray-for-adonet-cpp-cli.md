...
The latest version of this topic can be found at [How to: Marshal a SAFEARRAY for ADO.NET (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-a-safearray-for-adonet-cpp-cli).  
