...
The latest version of this topic can be found at [.NET Programming with C++/CLI (Visual C++)](https://docs.microsoft.com/cpp/dotnet/dotnet-programming-with-cpp-cli-visual-cpp).  
