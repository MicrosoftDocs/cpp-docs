...
The latest version of this topic can be found at [hash_map::generic_container (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-generic-container-stl-clr).  
