...
The latest version of this topic can be found at [How to: Marshal Unicode Strings for ADO.NET (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-unicode-strings-for-adonet-cpp-cli).  
