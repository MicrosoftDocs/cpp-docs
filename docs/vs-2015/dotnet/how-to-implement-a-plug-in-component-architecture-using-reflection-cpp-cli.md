...
The latest version of this topic can be found at [Implement a Plug-In Architecture (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-implement-a-plug-in-component-architecture-using-reflection-cpp-cli).  
