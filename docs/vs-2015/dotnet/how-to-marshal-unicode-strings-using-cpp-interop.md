...
The latest version of this topic can be found at [How to: Marshal Unicode Strings Using C++ Interop](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-unicode-strings-using-cpp-interop).  
