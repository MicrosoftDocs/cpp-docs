...
The latest version of this topic can be found at [Value Type Semantics](https://docs.microsoft.com/cpp/dotnet/value-type-semantics).  
  
  
Value type semantics have changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
