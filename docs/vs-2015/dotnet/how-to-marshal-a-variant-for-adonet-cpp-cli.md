...
The latest version of this topic can be found at [How to: Marshal a VARIANT for ADO.NET (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-a-variant-for-adonet-cpp-cli).  
