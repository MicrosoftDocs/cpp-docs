...
The latest version of this topic can be found at [multimap::reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multimap-reverse-iterator-stl-clr).  
