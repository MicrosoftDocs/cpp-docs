...
The latest version of this topic can be found at [hash_multiset::const_reference (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-const-reference-stl-clr).  
