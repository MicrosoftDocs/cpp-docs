...
The latest version of this topic can be found at [How to: Convert from a .NET Collection to a STL/CLR Container](https://docs.microsoft.com/cpp/dotnet/how-to-convert-from-a-dotnet-collection-to-a-stl-clr-container).  
