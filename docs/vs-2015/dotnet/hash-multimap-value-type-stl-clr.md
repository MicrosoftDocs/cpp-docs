...
The latest version of this topic can be found at [hash_multimap::value_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-value-type-stl-clr).  
