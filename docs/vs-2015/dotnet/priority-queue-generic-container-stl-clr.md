...
The latest version of this topic can be found at [priority_queue::generic_container (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-generic-container-stl-clr).  
