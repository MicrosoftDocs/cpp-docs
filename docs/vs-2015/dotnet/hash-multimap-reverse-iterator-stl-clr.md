...
The latest version of this topic can be found at [hash_multimap::reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-reverse-iterator-stl-clr).  
