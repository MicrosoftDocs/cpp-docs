...
The latest version of this topic can be found at [multiset::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multiset-difference-type-stl-clr).  
