...
The latest version of this topic can be found at [How to: Retrieve Time Elapsed Since Startup (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-retrieve-time-elapsed-since-startup-cpp-cli).  
