...
The latest version of this topic can be found at [Hosting a Windows Forms User Control as an MFC View](https://docs.microsoft.com/cpp/dotnet/hosting-a-windows-forms-user-control-as-an-mfc-view).  
