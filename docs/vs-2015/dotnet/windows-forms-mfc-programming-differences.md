...
The latest version of this topic can be found at [Windows Forms-MFC Programming Differences](https://docs.microsoft.com/cpp/dotnet/windows-forms-mfc-programming-differences).  
