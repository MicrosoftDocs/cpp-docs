...
The latest version of this topic can be found at [Basic Concepts in Using Managed Exceptions](https://docs.microsoft.com/cpp/dotnet/basic-concepts-in-using-managed-exceptions).  
