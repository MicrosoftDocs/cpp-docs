...
The latest version of this topic can be found at [binary_delegate_noreturn (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/binary-delegate-noreturn-stl-clr).  
