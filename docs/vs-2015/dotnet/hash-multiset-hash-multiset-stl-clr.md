...
The latest version of this topic can be found at [hash_multiset::hash_multiset (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-hash-multiset-stl-clr).  
