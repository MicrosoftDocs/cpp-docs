...
The latest version of this topic can be found at [How to: Marshal Structures Using C++ Interop](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-structures-using-cpp-interop).  
...
## Example  
 The following example demonstrates passing a structure from an unmanaged to a managed function, both by value and by reference. Because the structure in this example contains only simple, intrinsic data types (see [Blittable and Non-Blittable Types](../Topic/Blittable%20and%20Non-Blittable%20Types.md)), no special marshalling is required. To marshal non-blittable structures, such as those that contain pointers, see [How to: Marshal Embedded Pointers Using C++ Interop](../dotnet/how-to-marshal-embedded-pointers-using-cpp-interop.md).  
