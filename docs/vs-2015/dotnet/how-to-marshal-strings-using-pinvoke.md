...
The latest version of this topic can be found at [How to: Marshal Strings Using PInvoke](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-strings-using-pinvoke).  
