...
The latest version of this topic can be found at [Version Issues for Value Types Nested in Native Types (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/version-issues-for-value-types-nested-in-native-types-cpp-cli).  
