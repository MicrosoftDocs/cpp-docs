...
The latest version of this topic can be found at [hash_multiset::bucket_count (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-bucket-count-stl-clr).  
