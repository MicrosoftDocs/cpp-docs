...
The latest version of this topic can be found at [hash_map::generic_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-generic-reverse-iterator-stl-clr).  
