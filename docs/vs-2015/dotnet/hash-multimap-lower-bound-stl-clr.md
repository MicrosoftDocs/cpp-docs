...
The latest version of this topic can be found at [hash_multimap::lower_bound (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-lower-bound-stl-clr).  
