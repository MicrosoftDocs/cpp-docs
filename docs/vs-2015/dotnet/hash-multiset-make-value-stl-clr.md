...
The latest version of this topic can be found at [hash_multiset::make_value (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-make-value-stl-clr).  
