...
The latest version of this topic can be found at [map::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/map-const-reverse-iterator-stl-clr).  
