...
The latest version of this topic can be found at [Property Declaration](https://docs.microsoft.com/cpp/dotnet/property-declaration).  
  
  
The way to declare a property in a managed class has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
