...
The latest version of this topic can be found at [How to: Convert from a STL/CLR Container to a .NET Collection](https://docs.microsoft.com/cpp/dotnet/how-to-convert-from-a-stl-clr-container-to-a-dotnet-collection).  
