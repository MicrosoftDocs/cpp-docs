...
The latest version of this topic can be found at [How to: Declare Handles in Native Types](https://docs.microsoft.com/cpp/dotnet/how-to-declare-handles-in-native-types).  
