...
The latest version of this topic can be found at [set::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/set-const-reverse-iterator-stl-clr).  
