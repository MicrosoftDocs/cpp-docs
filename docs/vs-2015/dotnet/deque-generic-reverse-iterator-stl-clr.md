...
The latest version of this topic can be found at [deque::generic_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/deque-generic-reverse-iterator-stl-clr).  
