...
The latest version of this topic can be found at [Converting Projects from Mixed Mode to Pure Intermediate Language](https://docs.microsoft.com/cpp/dotnet/converting-projects-from-mixed-mode-to-pure-intermediate-language).  
...
3.  Remove all unmanaged types:  
    ...
    1.  Wherever appropriate, replace unmanaged types with references to structures from the [System](https://msdn.microsoft.com/library/system.appdomainmanager.appdomainmanager.aspx) namespace. Common managed types are listed in the following table:  
