...
The latest version of this topic can be found at [multimap::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multimap-const-reverse-iterator-stl-clr).  
