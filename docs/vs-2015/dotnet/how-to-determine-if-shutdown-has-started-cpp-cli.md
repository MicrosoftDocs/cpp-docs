...
The latest version of this topic can be found at [How to: Determine if Shutdown Has Started (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-determine-if-shutdown-has-started-cpp-cli).  
