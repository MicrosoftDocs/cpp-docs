...
The latest version of this topic can be found at [.NET Framework Equivalents to C++ Native Types (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/dotnet-framework-equivalents-to-cpp-native-types-cpp-cli).  
