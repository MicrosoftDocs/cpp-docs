...
The latest version of this topic can be found at [C++ Stack Semantics for Reference Types](https://docs.microsoft.com/cpp/dotnet/cpp-stack-semantics-for-reference-types).  
