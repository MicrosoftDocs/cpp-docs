...
The latest version of this topic can be found at [Interoperability with Other .NET Languages (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/interoperability-with-other-dotnet-languages-cpp-cli).  
