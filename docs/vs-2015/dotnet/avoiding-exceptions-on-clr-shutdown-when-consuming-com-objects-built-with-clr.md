...
The latest version of this topic can be found at [Avoiding Exceptions thrown by COM Objects Built with -clr](https://docs.microsoft.com/cpp/dotnet/avoiding-exceptions-on-clr-shutdown-when-consuming-com-objects-built-with-clr).  
