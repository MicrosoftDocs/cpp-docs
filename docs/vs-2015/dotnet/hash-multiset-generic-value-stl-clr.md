...
The latest version of this topic can be found at [hash_multiset::generic_value (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-generic-value-stl-clr).  
