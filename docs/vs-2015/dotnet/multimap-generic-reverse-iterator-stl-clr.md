...
The latest version of this topic can be found at [multimap::generic_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multimap-generic-reverse-iterator-stl-clr).  
