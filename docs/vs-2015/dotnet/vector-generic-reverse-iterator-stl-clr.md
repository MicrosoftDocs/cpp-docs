...
The latest version of this topic can be found at [vector::generic_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/vector-generic-reverse-iterator-stl-clr).  
