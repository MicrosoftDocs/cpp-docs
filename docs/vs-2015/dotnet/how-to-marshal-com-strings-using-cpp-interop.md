...
The latest version of this topic can be found at [How to: Marshal COM Strings Using C++ Interop](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-com-strings-using-cpp-interop).  
