...
The latest version of this topic can be found at [Hosting a Windows Form User Control as an MFC Dialog Box](https://docs.microsoft.com/cpp/dotnet/hosting-a-windows-form-user-control-as-an-mfc-dialog-box).  
