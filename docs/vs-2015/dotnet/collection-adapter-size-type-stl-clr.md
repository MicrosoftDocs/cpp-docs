...
The latest version of this topic can be found at [collection_adapter::size_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-size-type-stl-clr).  
