...
The latest version of this topic can be found at [map::generic_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/map-generic-reverse-iterator-stl-clr).  
