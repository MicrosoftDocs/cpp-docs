...
The latest version of this topic can be found at [How to: Extend the Marshaling Library](https://docs.microsoft.com/cpp/dotnet/how-to-extend-the-marshaling-library).  
