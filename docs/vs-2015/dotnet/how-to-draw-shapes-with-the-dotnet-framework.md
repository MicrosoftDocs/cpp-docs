...
The latest version of this topic can be found at [How to: Draw Shapes with the .NET Framework](https://docs.microsoft.com/cpp/dotnet/how-to-draw-shapes-with-the-dotnet-framework).  
