...
The latest version of this topic can be found at [collection_adapter::collection_adapter (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-collection-adapter-stl-clr).  
