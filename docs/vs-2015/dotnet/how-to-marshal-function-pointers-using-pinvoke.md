...
The latest version of this topic can be found at [How to: Marshal Function Pointers Using PInvoke](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-function-pointers-using-pinvoke).  
