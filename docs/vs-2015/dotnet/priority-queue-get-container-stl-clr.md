...
The latest version of this topic can be found at [priority_queue::get_container (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-get-container-stl-clr).  
