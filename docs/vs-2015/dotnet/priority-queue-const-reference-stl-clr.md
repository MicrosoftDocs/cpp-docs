...
The latest version of this topic can be found at [priority_queue::const_reference (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-const-reference-stl-clr).  
