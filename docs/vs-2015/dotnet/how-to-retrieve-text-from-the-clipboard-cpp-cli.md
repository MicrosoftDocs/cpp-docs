...
The latest version of this topic can be found at [How to: Retrieve Text from the Clipboard (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-retrieve-text-from-the-clipboard-cpp-cli).  
