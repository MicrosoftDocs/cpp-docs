...
The latest version of this topic can be found at [Sealing a Virtual Function](https://docs.microsoft.com/cpp/dotnet/sealing-a-virtual-function).  
  
  
The syntax for sealing a virtual function has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
