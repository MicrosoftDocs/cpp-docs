...
The latest version of this topic can be found at [General Language Changes (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/general-language-changes-cpp-cli).  
  
  
A number of CLR language features changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
