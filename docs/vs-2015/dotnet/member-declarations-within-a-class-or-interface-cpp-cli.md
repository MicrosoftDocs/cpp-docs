...
The latest version of this topic can be found at [Member Declarations within a Class or Interface (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/member-declarations-within-a-class-or-interface-cpp-cli).  
  
  
The declaration of properties and operators has been extensively reworked from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)], hiding the underlying implementation details that were exposed in the Managed Extensions design. Event declarations have been modified as well.  
