...
The latest version of this topic can be found at [hash_multimap::equal_range (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-equal-range-stl-clr).  
