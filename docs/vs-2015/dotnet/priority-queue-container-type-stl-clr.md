...
The latest version of this topic can be found at [priority_queue::container_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-container-type-stl-clr).  
