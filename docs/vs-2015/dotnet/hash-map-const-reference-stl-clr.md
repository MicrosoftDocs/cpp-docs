...
The latest version of this topic can be found at [hash_map::const_reference (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-const-reference-stl-clr).  
