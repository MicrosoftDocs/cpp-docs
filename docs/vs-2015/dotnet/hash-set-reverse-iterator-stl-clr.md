...
The latest version of this topic can be found at [hash_set::reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-set-reverse-iterator-stl-clr).  
