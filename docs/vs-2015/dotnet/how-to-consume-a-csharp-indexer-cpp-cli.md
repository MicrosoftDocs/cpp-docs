...
The latest version of this topic can be found at [How to: Consume a C# Indexer (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-consume-a-csharp-indexer-cpp-cli).  
