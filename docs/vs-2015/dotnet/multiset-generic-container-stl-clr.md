...
The latest version of this topic can be found at [multiset::generic_container (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multiset-generic-container-stl-clr).  
