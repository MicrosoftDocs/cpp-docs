...
The latest version of this topic can be found at [vector::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/vector-const-reverse-iterator-stl-clr).  
