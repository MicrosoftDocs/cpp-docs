...
The latest version of this topic can be found at [How to: Read Data from the Windows Registry (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-read-data-from-the-windows-registry-cpp-cli).  
