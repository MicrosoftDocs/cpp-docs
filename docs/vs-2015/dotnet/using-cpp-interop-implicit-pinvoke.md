...
The latest version of this topic can be found at [Using C++ Interop (Implicit PInvoke)](https://docs.microsoft.com/cpp/dotnet/using-cpp-interop-implicit-pinvoke).  
