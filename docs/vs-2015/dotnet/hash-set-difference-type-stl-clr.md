...
The latest version of this topic can be found at [hash_set::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-set-difference-type-stl-clr).  
