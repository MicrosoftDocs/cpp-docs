...
The latest version of this topic can be found at [How to: Enumerate Data Types using Reflection (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-enumerate-data-types-in-assemblies-using-reflection-cpp-cli).  
