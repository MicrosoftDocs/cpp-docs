...
The latest version of this topic can be found at [hash_multiset::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-difference-type-stl-clr).  
