...
The latest version of this topic can be found at [hash_multimap::upper_bound (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-upper-bound-stl-clr).  
