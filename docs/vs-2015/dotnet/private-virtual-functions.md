...
The latest version of this topic can be found at [Private Virtual Functions](https://docs.microsoft.com/cpp/dotnet/private-virtual-functions).  
  
  
The way private virtual functions are handled in derived classes has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
