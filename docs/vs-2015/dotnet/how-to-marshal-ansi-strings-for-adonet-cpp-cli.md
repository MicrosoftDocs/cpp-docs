...
The latest version of this topic can be found at [How to: Marshal ANSI Strings for ADO.NET (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-ansi-strings-for-adonet-cpp-cli).  
