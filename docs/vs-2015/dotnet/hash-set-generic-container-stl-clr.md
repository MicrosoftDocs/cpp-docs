...
The latest version of this topic can be found at [hash_set::generic_container (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-set-generic-container-stl-clr).  
