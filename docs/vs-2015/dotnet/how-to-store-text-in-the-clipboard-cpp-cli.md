...
The latest version of this topic can be found at [How to: Store Text in the Clipboard (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-store-text-in-the-clipboard-cpp-cli).  
