...
The latest version of this topic can be found at [Library Support for Mixed Assemblies](https://docs.microsoft.com/cpp/dotnet/library-support-for-mixed-assemblies).  
