...
The latest version of this topic can be found at [priority_queue::operator= (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-operator-assign-stl-clr).  
