...
The latest version of this topic can be found at [How to: Expose an STL/CLR Container from an Assembly](https://docs.microsoft.com/cpp/dotnet/how-to-expose-an-stl-clr-container-from-an-assembly).  
