...
The latest version of this topic can be found at [Delegates and Events](https://docs.microsoft.com/cpp/dotnet/delegates-and-events).  
  
  
The way to declare delegates and events has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
