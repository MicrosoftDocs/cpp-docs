...
The latest version of this topic can be found at [multimap::generic_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multimap-generic-iterator-stl-clr).  
