...
The latest version of this topic can be found at [hash_map::max_load_factor (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-max-load-factor-stl-clr).  
