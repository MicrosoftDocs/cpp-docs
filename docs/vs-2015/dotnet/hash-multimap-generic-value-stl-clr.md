...
The latest version of this topic can be found at [hash_multimap::generic_value (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-generic-value-stl-clr).  
