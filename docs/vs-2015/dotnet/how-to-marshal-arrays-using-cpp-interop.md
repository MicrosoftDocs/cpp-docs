...
The latest version of this topic can be found at [How to: Marshal Arrays Using C++ Interop](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-arrays-using-cpp-interop).  
