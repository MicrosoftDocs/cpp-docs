...
The latest version of this topic can be found at [multiset::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multiset-const-reverse-iterator-stl-clr).  
