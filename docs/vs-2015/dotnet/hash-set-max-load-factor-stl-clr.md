...
The latest version of this topic can be found at [hash_set::max_load_factor (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-set-max-load-factor-stl-clr).  
