...
The latest version of this topic can be found at [priority_queue::size_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-size-type-stl-clr).  
