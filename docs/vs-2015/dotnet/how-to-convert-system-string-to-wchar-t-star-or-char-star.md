...
The latest version of this topic can be found at [How to: Convert System::String to wchar_t* or char*](https://docs.microsoft.com/cpp/dotnet/how-to-convert-system-string-to-wchar-t-star-or-char-star).  
