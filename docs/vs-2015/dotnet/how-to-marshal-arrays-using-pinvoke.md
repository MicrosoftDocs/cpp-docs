...
The latest version of this topic can be found at [How to: Marshal Arrays Using PInvoke](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-arrays-using-pinvoke).  
