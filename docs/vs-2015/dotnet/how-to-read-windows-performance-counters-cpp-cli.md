...
The latest version of this topic can be found at [How to: Read Windows Performance Counters (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-read-windows-performance-counters-cpp-cli).  
