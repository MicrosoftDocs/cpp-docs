...
The latest version of this topic can be found at [How to: Catch Exceptions in Native Code Thrown from MSIL](https://docs.microsoft.com/cpp/dotnet/how-to-catch-exceptions-in-native-code-thrown-from-msil).  
