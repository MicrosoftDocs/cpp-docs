...
The latest version of this topic can be found at [multimap::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multimap-difference-type-stl-clr).  
