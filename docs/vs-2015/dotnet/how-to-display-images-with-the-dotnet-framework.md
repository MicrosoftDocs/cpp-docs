...
The latest version of this topic can be found at [How to: Display Images with the .NET Framework](https://docs.microsoft.com/cpp/dotnet/how-to-display-images-with-the-dotnet-framework).  
