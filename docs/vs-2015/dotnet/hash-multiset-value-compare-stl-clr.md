...
The latest version of this topic can be found at [hash_multiset::value_compare (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-value-compare-stl-clr).  
