...
The latest version of this topic can be found at [Implicit Boxing of Value Types](https://docs.microsoft.com/cpp/dotnet/implicit-boxing-of-value-types).  
  
  
The boxing of value types has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
...
```  
 ...
 As you can see, there is a whole lot of boxing going on. Under [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)], value type boxing is implicit:  
