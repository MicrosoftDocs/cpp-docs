...
The latest version of this topic can be found at [vector::generic_container (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/vector-generic-container-stl-clr).  
