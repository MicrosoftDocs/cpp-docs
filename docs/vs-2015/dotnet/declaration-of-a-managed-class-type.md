...
The latest version of this topic can be found at [Declaration of a Managed Class Type](https://docs.microsoft.com/cpp/dotnet/declaration-of-a-managed-class-type).  
  
  
The way to declare a reference class type changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
