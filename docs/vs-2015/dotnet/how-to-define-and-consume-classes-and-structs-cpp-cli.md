...
The latest version of this topic can be found at [How to: Define and Consume Classes and Structs (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-define-and-consume-classes-and-structs-cpp-cli).  
  
  
This article shows how to define and consume user-defined reference types and value types in [!INCLUDE[cppcli](../includes/cppcli-md.md)].  
