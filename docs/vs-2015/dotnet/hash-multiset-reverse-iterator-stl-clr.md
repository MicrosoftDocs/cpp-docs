...
The latest version of this topic can be found at [hash_multiset::reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-reverse-iterator-stl-clr).  
