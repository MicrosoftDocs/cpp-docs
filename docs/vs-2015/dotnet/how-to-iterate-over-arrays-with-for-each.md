...
The latest version of this topic can be found at [How to: Iterate Over Arrays with for each](https://docs.microsoft.com/cpp/dotnet/how-to-iterate-over-arrays-with-for-each).  
