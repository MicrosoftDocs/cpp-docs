...
The latest version of this topic can be found at [Property Index Declaration](https://docs.microsoft.com/cpp/dotnet/property-index-declaration).  
  
  
The syntax for declaring an indexed property has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
