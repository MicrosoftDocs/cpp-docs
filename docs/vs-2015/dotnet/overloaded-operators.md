...
The latest version of this topic can be found at [Overloaded Operators](https://docs.microsoft.com/cpp/dotnet/overloaded-operators).  
  
  
Operator overloading has changed significantly from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
