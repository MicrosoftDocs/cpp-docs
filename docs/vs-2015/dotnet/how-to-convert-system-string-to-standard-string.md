...
The latest version of this topic can be found at [How to: Convert System::String to Standard String](https://docs.microsoft.com/cpp/dotnet/how-to-convert-system-string-to-standard-string).  
