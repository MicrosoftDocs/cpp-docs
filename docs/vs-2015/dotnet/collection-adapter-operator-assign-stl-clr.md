...
The latest version of this topic can be found at [collection_adapter::operator= (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-operator-assign-stl-clr).  
