...
The latest version of this topic can be found at [hash_multimap::key_compare (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-key-compare-stl-clr).  
