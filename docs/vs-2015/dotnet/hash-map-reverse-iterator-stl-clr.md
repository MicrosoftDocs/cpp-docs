...
The latest version of this topic can be found at [hash_map::reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-reverse-iterator-stl-clr).  
