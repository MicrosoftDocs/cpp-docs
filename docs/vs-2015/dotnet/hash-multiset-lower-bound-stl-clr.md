...
The latest version of this topic can be found at [hash_multiset::lower_bound (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-lower-bound-stl-clr).  
