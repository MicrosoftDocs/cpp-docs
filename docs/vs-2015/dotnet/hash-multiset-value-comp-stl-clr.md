...
The latest version of this topic can be found at [hash_multiset::value_comp (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-value-comp-stl-clr).  
