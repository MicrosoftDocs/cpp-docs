...
The latest version of this topic can be found at [range_adapter::operator= (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/range-adapter-operator-assign-stl-clr).  
