...
The latest version of this topic can be found at [How to: Define an Interface Static Constructor (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-define-an-interface-static-constructor-cpp-cli).  
