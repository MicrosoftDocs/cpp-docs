...
The latest version of this topic can be found at [deque::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/deque-const-reverse-iterator-stl-clr).  
