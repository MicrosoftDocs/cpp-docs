...
The latest version of this topic can be found at [hash_set::generic_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-set-generic-iterator-stl-clr).  
