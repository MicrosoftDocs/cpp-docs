...
The latest version of this topic can be found at [How to: Create a Partially Trusted Application (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/create-a-partially-trusted-application).  
  
  
This topic discusses how to create a partially trusted Common Language Runtime application using [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] by removing dependency on msvcm90.dll.  
