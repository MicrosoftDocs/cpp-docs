...
The latest version of this topic can be found at [How to: Iterate Over a Generic Collection with for each](https://docs.microsoft.com/cpp/dotnet/how-to-iterate-over-a-generic-collection-with-for-each).  
