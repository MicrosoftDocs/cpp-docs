...
The latest version of this topic can be found at [multiset::generic_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multiset-generic-iterator-stl-clr).  
