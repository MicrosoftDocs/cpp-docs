...
The latest version of this topic can be found at [How to: Diagnose and Fix Assembly Compatibility Problems (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-diagnose-and-fix-assembly-compatibility-problems-cpp-cli).  
