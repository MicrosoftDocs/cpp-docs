...
The latest version of this topic can be found at [How to: Use Regular Expressions to Rearrange Data (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-use-regular-expressions-to-rearrange-data-cpp-cli).  
