...
The latest version of this topic can be found at [hash_multiset::generic_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-generic-iterator-stl-clr).  
