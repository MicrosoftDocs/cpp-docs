...
The latest version of this topic can be found at [How to: Use Regular Expressions to Extract Data Fields (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-use-regular-expressions-to-extract-data-fields-cpp-cli).  
