...
The latest version of this topic can be found at [priority_queue::value_comp (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-value-comp-stl-clr).  
