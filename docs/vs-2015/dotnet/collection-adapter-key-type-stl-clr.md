...
The latest version of this topic can be found at [collection_adapter::key_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-key-type-stl-clr).  
