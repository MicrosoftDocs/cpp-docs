...
The latest version of this topic can be found at [How to: Create CLR Console Applications (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-create-clr-console-applications-cpp-cli).  
