...
The latest version of this topic can be found at [hash_multimap::load_factor (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-load-factor-stl-clr).  
