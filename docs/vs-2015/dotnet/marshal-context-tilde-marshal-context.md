...
The latest version of this topic can be found at [marshal_context::~marshal_context](https://docs.microsoft.com/cpp/dotnet/marshal-context-tilde-marshal-context).  
