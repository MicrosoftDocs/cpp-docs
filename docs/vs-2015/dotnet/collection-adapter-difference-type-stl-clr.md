...
The latest version of this topic can be found at [collection_adapter::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-difference-type-stl-clr).  
