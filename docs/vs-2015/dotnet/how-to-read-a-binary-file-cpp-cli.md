...
The latest version of this topic can be found at [How to: Read a Binary File (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-read-a-binary-file-cpp-cli).  
