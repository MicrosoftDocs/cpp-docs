...
The latest version of this topic can be found at [hash_multimap::hash_multimap (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-hash-multimap-stl-clr).  
