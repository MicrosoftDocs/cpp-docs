...
The latest version of this topic can be found at [list::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/list-const-reverse-iterator-stl-clr).  
