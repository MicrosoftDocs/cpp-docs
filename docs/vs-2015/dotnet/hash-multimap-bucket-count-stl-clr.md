...
The latest version of this topic can be found at [hash_multimap::bucket_count (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-bucket-count-stl-clr).  
