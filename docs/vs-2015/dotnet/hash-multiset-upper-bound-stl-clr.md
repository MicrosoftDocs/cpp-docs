...
The latest version of this topic can be found at [hash_multiset::upper_bound (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-upper-bound-stl-clr).  
