...
The latest version of this topic can be found at [How to: Migrate to -clr:safe (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-migrate-to-clr-safe-cpp-cli).  
