...
The latest version of this topic can be found at [hash_map::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-difference-type-stl-clr).  
