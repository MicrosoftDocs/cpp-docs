...
The latest version of this topic can be found at [collection_adapter::begin (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/collection-adapter-begin-stl-clr).  
