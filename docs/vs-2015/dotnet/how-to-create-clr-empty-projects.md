...
The latest version of this topic can be found at [How to: Create CLR Empty Projects](https://docs.microsoft.com/cpp/dotnet/how-to-create-clr-empty-projects).  
