...
The latest version of this topic can be found at [How to: Use Tracking References in C++/CLI](https://docs.microsoft.com/cpp/dotnet/how-to-use-tracking-references-in-cpp-cli).  
  
  
This article shows how to use a tracking reference (%) in [!INCLUDE[cppcli](../includes/cppcli-md.md)] to pass common language runtime (CLR) types by reference.  
