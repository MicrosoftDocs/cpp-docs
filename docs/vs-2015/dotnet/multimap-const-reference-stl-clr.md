...
The latest version of this topic can be found at [multimap::const_reference (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/multimap-const-reference-stl-clr).  
