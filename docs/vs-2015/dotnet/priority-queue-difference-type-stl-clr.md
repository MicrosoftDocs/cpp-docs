...
The latest version of this topic can be found at [priority_queue::difference_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-difference-type-stl-clr).  
