...
The latest version of this topic can be found at [How to: Rotate Images with the .NET Framework](https://docs.microsoft.com/cpp/dotnet/how-to-rotate-images-with-the-dotnet-framework).  
