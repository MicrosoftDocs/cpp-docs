...
The latest version of this topic can be found at [Changes in Constructor Initialization Order](https://docs.microsoft.com/cpp/dotnet/changes-in-constructor-initialization-order).  
  
  
The order of initialization for class constructors has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
...
3.  The code body of the class constructor is executed.  
 ...
 Note this change applies only to CLR classes; native classes in [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)] still follow the previous conventions. In both cases, these rules cascade upward throughout the whole hierarchy chain of a given class.  
