...
The latest version of this topic can be found at [How to: Use Arrays in C++/CLI](https://docs.microsoft.com/cpp/dotnet/how-to-use-arrays-in-cpp-cli).  
  
  
This article describes how to use arrays in [!INCLUDE[cppcli](../includes/cppcli-md.md)].  
