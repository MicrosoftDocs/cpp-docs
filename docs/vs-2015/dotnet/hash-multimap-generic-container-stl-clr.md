...
The latest version of this topic can be found at [hash_multimap::generic_container (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-generic-container-stl-clr).  
