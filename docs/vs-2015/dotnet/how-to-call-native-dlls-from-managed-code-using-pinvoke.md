...
The latest version of this topic can be found at [How to: Call Native DLLs from Managed Code Using PInvoke](https://docs.microsoft.com/cpp/dotnet/how-to-call-native-dlls-from-managed-code-using-pinvoke).  
