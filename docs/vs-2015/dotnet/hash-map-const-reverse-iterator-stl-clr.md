...
The latest version of this topic can be found at [hash_map::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-const-reverse-iterator-stl-clr).  
