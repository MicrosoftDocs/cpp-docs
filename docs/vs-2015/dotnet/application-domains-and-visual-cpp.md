...
The latest version of this topic can be found at [Application Domains and Visual C++](https://docs.microsoft.com/cpp/dotnet/application-domains-and-visual-cpp).  
