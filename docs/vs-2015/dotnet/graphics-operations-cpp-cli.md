...
The latest version of this topic can be found at [Graphics Operations (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/graphics-operations-cpp-cli).  
  
  
Demonstrates image manipulation using the [!INCLUDE[winsdklong](../includes/winsdklong-md.md)].  
