...
The latest version of this topic can be found at [How to: Create the User Control and Host MDI View](https://docs.microsoft.com/cpp/dotnet/how-to-create-the-user-control-and-host-mdi-view).  
