...
The latest version of this topic can be found at [How to: Write a Binary File (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-write-a-binary-file-cpp-cli).  
