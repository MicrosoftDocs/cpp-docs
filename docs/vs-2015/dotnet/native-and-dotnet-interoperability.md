...
The latest version of this topic can be found at [Native and .NET Interoperability](https://docs.microsoft.com/cpp/dotnet/native-and-dotnet-interoperability).  
