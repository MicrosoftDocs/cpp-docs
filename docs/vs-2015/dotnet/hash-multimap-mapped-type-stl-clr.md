...
The latest version of this topic can be found at [hash_multimap::mapped_type (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-mapped-type-stl-clr).  
