...
The latest version of this topic can be found at [How to: Retrieve the Windows Version (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-retrieve-the-windows-version-cpp-cli).  
