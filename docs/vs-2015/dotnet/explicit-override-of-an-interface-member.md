...
The latest version of this topic can be found at [Explicit Override of an Interface Member](https://docs.microsoft.com/cpp/dotnet/explicit-override-of-an-interface-member).  
  
  
The syntax for declaring an explicit override of an interface member within a class has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
