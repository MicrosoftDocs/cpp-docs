...
The latest version of this topic can be found at [Mixed (Native and Managed) Assemblies](https://docs.microsoft.com/cpp/dotnet/mixed-native-and-managed-assemblies).  
...
## In This Section  
 ...
 Discusses how to create a partially trusted Common Language Runtime application using [!INCLUDE[vcprvc](../includes/vcprvc-md.md)] by removing dependency on msvcm90.dll.  
