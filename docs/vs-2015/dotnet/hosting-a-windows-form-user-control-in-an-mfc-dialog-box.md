...
The latest version of this topic can be found at [Hosting a Windows Form User Control in an MFC Dialog Box](https://docs.microsoft.com/cpp/dotnet/hosting-a-windows-form-user-control-in-an-mfc-dialog-box).  
