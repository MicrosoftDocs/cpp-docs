...
The latest version of this topic can be found at [hash_multimap::max_load_factor (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multimap-max-load-factor-stl-clr).  
