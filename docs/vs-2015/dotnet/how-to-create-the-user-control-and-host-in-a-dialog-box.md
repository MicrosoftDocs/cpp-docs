...
The latest version of this topic can be found at [How to: Create the User Control and Host in a Dialog Box](https://docs.microsoft.com/cpp/dotnet/how-to-create-the-user-control-and-host-in-a-dialog-box).  
