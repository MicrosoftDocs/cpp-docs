...
The latest version of this topic can be found at [hash_multiset::load_factor (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-load-factor-stl-clr).  
