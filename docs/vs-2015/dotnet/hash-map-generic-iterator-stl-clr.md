...
The latest version of this topic can be found at [hash_map::generic_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-map-generic-iterator-stl-clr).  
