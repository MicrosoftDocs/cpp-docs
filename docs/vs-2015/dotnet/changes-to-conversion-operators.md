...
The latest version of this topic can be found at [Changes to Conversion Operators](https://docs.microsoft.com/cpp/dotnet/changes-to-conversion-operators).  
  
  
The syntax for conversion operators has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../includes/cpp-current-long-md.md)].  
