...
The latest version of this topic can be found at [hash_multiset::max_load_factor (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-max-load-factor-stl-clr).  
