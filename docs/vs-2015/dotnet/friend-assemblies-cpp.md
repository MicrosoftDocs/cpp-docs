...
The latest version of this topic can be found at [Friend Assemblies (C++)](https://docs.microsoft.com/cpp/dotnet/friend-assemblies-cpp).  
 ...
 **Remarks**  
 ...
 (This language feature is not supported in the [!INCLUDE[wrt](../includes/wrt-md.md)].)  
