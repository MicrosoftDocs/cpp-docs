...
The latest version of this topic can be found at [How to: Determine if an Image is Native or CLR](https://docs.microsoft.com/cpp/dotnet/how-to-determine-if-an-image-is-native-or-clr).  
