...
The latest version of this topic can be found at [How to: Retrieve the .NET Framework Version (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-retrieve-the-dotnet-framework-version-cpp-cli).  
