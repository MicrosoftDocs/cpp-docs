...
The latest version of this topic can be found at [How to: Marshal ANSI Strings Using C++ Interop](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-ansi-strings-using-cpp-interop).  
