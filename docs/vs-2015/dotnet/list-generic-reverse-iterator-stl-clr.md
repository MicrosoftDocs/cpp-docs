...
The latest version of this topic can be found at [list::generic_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/list-generic-reverse-iterator-stl-clr).  
