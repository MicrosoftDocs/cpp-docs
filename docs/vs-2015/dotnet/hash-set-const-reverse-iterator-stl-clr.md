...
The latest version of this topic can be found at [hash_set::const_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-set-const-reverse-iterator-stl-clr).  
