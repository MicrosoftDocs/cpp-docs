...
The latest version of this topic can be found at [How to: Define and consume enums in C++/CLI](https://docs.microsoft.com/cpp/dotnet/how-to-define-and-consume-enums-in-cpp-cli).  
