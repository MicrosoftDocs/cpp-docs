...
The latest version of this topic can be found at [How to: Marshal Callbacks and Delegates By Using C++ Interop](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-callbacks-and-delegates-by-using-cpp-interop).  
