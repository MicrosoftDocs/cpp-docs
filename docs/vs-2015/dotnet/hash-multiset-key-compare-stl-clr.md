...
The latest version of this topic can be found at [hash_multiset::key_compare (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/hash-multiset-key-compare-stl-clr).  
