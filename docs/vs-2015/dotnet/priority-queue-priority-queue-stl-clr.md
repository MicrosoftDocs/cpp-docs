...
The latest version of this topic can be found at [priority_queue::priority_queue (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/priority-queue-priority-queue-stl-clr).  
