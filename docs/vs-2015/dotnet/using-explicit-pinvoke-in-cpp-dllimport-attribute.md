...
The latest version of this topic can be found at [Using Explicit PInvoke in C++ (DllImport Attribute)](https://docs.microsoft.com/cpp/dotnet/using-explicit-pinvoke-in-cpp-dllimport-attribute).  
