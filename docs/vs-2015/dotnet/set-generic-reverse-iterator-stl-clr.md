...
The latest version of this topic can be found at [set::generic_reverse_iterator (STL/CLR)](https://docs.microsoft.com/cpp/dotnet/set-generic-reverse-iterator-stl-clr).  
