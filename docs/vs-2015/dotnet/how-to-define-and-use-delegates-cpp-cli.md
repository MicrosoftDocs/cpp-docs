...
The latest version of this topic can be found at [How to: Define and Use Delegates (C++/CLI)](https://docs.microsoft.com/cpp/dotnet/how-to-define-and-use-delegates-cpp-cli).  
  
  
This article shows how to define and consume delegates in [!INCLUDE[cppcli](../includes/cppcli-md.md)].  
