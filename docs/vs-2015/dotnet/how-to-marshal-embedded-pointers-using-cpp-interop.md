...
The latest version of this topic can be found at [How to: Marshal Embedded Pointers Using C++ Interop](https://docs.microsoft.com/cpp/dotnet/how-to-marshal-embedded-pointers-using-cpp-interop).  
