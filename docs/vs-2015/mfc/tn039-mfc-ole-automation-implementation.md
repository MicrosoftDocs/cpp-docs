...
The latest version of this topic can be found at [TN039: MFC-OLE Automation Implementation](https://docs.microsoft.com/cpp/mfc/tn039-mfc-ole-automation-implementation).  
