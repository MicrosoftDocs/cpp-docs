...
The latest version of this topic can be found at [Using the Classes to Write Applications for Windows](https://docs.microsoft.com/cpp/mfc/using-the-classes-to-write-applications-for-windows).  
