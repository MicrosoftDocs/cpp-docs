...
The latest version of this topic can be found at [Handling Customization Notifications](https://docs.microsoft.com/cpp/mfc/handling-customization-notifications).  
