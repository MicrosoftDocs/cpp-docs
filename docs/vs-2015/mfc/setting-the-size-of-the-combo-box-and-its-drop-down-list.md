...
The latest version of this topic can be found at [Setting the Size of the Combo Box and Its Drop-Down List](https://docs.microsoft.com/cpp/windows/setting-the-size-of-the-combo-box-and-its-drop-down-list).  
