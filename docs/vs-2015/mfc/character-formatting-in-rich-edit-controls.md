...
The latest version of this topic can be found at [Character Formatting in Rich Edit Controls](https://docs.microsoft.com/cpp/mfc/character-formatting-in-rich-edit-controls).  
