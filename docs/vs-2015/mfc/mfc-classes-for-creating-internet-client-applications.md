...
The latest version of this topic can be found at [MFC Classes for Creating Internet Client Applications](https://docs.microsoft.com/cpp/mfc/mfc-classes-for-creating-internet-client-applications).  
