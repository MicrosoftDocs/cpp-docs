...
The latest version of this topic can be found at [How to: Add Ribbon Controls and Event Handlers](https://docs.microsoft.com/cpp/mfc/how-to-add-ribbon-controls-and-event-handlers).  
