...
The latest version of this topic can be found at [Previewing Resources](https://docs.microsoft.com/cpp/windows/previewing-resources).  
...
2.  In the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca), click the **Property Pages** button.  
