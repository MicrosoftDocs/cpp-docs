...
The latest version of this topic can be found at [Receiving Notification from Common Controls](https://docs.microsoft.com/cpp/mfc/receiving-notification-from-common-controls).  
...
>  `CWnd::GetCurrentMessage` should only be called within a message handler.  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#4)]  
