...
The latest version of this topic can be found at [TN016: Using C++ Multiple Inheritance with MFC](https://docs.microsoft.com/cpp/mfc/tn016-using-cpp-multiple-inheritance-with-mfc).  
