...
The latest version of this topic can be found at [Changing the Tab Order of Controls](https://docs.microsoft.com/cpp/windows/changing-the-tab-order-of-controls).  
...
1.  In the [Properties Window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca), select **True** or **False** in the **Tabstop** property.  
