...
The latest version of this topic can be found at [Toolbar Fundamentals](https://docs.microsoft.com/cpp/mfc/toolbar-fundamentals).  
...
##  <a name="_core_the_toolbar_in_code"></a> The Toolbar in Code  
 ...
 [!code-cpp[NVC_MFCListView#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCListView/Cpp/MainFrm.h#6)]  
