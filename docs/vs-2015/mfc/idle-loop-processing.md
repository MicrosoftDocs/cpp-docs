...
The latest version of this topic can be found at [Idle Loop Processing](https://docs.microsoft.com/cpp/mfc/idle-loop-processing).  
...
##  <a name="_core_peekmessage_elsewhere_in_your_application"></a> PeekMessage Elsewhere in Your Application  
 ...
 [!code-cpp[NVC_MFCDocView#8](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#8)]  
