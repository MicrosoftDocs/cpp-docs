...
The latest version of this topic can be found at [How to: Customize the Application Button](https://docs.microsoft.com/cpp/mfc/how-to-customize-the-application-button).  
...
When you click the Application button, a menu of commands is displayed. Typically, the menu contains file-related commands such as **Open**, **Save**, **Print**, and **Exit**.  
 ...
 ![MFC Ribbon Application Button](../mfc/media/application-button.png "Application_Button")  
