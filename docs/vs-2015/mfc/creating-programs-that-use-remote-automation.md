...
The latest version of this topic can be found at [Creating Programs That Use Remote Automation](https://docs.microsoft.com/cpp/mfc/creating-programs-that-use-remote-automation).  
