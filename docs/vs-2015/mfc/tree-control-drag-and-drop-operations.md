...
The latest version of this topic can be found at [Tree Control Drag-and-Drop Operations](https://docs.microsoft.com/cpp/mfc/tree-control-drag-and-drop-operations).  
