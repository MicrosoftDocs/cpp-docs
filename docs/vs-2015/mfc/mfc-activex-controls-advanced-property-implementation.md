...
The latest version of this topic can be found at [MFC ActiveX Controls: Advanced Property Implementation](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-advanced-property-implementation).  
...
9. Click **Finish**.  
 ...
 [!code-cpp[NVC_MFC_AxUI#29](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.cpp#29)]  
