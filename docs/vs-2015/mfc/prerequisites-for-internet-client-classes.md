...
The latest version of this topic can be found at [Prerequisites for Internet Client Classes](https://docs.microsoft.com/cpp/mfc/prerequisites-for-internet-client-classes).  
