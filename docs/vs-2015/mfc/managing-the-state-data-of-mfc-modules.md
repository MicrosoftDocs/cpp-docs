...
The latest version of this topic can be found at [Managing the State Data of MFC Modules](https://docs.microsoft.com/cpp/mfc/managing-the-state-data-of-mfc-modules).  
