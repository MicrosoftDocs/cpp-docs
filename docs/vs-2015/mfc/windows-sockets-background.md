...
The latest version of this topic can be found at [Windows Sockets: Background](https://docs.microsoft.com/cpp/mfc/windows-sockets-background).  
...
##  <a name="_core_the_socket_data_type"></a> The SOCKET Data Type  
 ...
 The **SOCKET** data type is described in detail in the [!INCLUDE[winSDK](../includes/winsdk-md.md)]. See "Socket Data Type and Error Values" under Windows Sockets.  
