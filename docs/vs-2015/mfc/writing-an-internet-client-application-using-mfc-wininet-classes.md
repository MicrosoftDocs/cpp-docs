...
The latest version of this topic can be found at [Writing an Internet Client Application Using MFC WinInet Classes](https://docs.microsoft.com/cpp/mfc/writing-an-internet-client-application-using-mfc-wininet-classes).  
