...
The latest version of this topic can be found at [Walkthrough: Updating the MFC Scribble Application (Part 1)](https://docs.microsoft.com/cpp/mfc/walkthrough-updating-the-mfc-scribble-application-part-1).  
...
-   Use the [Resource Editors](../mfc/resource-editors.md) to invent your own bitmaps. Or use the resource editors to assemble bitmaps from the portable network graphics (.png) images that are included with [!INCLUDE[vsprvs](../includes/vsprvs-md.md)]. These images are in the `VS2008ImageLibrary` directory.  
