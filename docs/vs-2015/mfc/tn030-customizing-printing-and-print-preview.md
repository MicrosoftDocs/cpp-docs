...
The latest version of this topic can be found at [TN030: Customizing Printing and Print Preview](https://docs.microsoft.com/cpp/mfc/tn030-customizing-printing-and-print-preview).  
