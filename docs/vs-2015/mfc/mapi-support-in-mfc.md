...
The latest version of this topic can be found at [MAPI Support in MFC](https://docs.microsoft.com/cpp/mfc/mapi-support-in-mfc).  
...
2.  Manually add the following to your document's message map:  
     ...
     [!code-cpp[NVC_MFCDocView#9](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyDoc.cpp#9)]  
