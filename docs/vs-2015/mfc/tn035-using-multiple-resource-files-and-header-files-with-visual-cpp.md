...
The latest version of this topic can be found at [TN035: Using Multiple Resource Files and Header Files with Visual C++](https://docs.microsoft.com/cpp/mfc/tn035-using-multiple-resource-files-and-header-files-with-visual-cpp).  
