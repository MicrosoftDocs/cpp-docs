...
The latest version of this topic can be found at [Arrangement of Controls on Dialog Boxes](https://docs.microsoft.com/cpp/windows/arrangement-of-controls-on-dialog-boxes).  
