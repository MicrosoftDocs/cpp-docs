...
The latest version of this topic can be found at [Alternatives to the Document-View Architecture](https://docs.microsoft.com/cpp/mfc/alternatives-to-the-document-view-architecture).  
