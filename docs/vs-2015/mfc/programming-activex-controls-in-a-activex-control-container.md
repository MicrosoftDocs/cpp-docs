...
The latest version of this topic can be found at [ActiveX Control Containers: Programming ActiveX Controls in an ActiveX Control Container](https://docs.microsoft.com/cpp/mfc/programming-activex-controls-in-a-activex-control-container).  
...
## Modifications to the Project  
 ...
 [!code-cpp[NVC_MFC_AxCont#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/ContainerDlg.h#1)]  
...
##  <a name="_core_the_wrapper_class_header_28h29_file"></a> The Wrapper Class Header (.H) File  
 ...
 [!code-cpp[NVC_MFC_AxCont#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/circ.h#2)]  
[!code-cpp[NVC_MFC_AxCont#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/circ.h#3)]  
...
##  <a name="_core_member_variable_modifications_to_the_project"></a> Member Variable Modifications to the Project  
 ...
 [!code-cpp[NVC_MFC_AxCont#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/ContainerDlg.h#4)]  
[!code-cpp[NVC_MFC_AxCont#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/ContainerDlg.h#5)]  
  
 In addition, a call to **DDX_Control** is automatically added to the `CContainerDlg`'s implementation of `DoDataExchange`:  
  
 [!code-cpp[NVC_MFC_AxCont#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/ContainerDlg.cpp#6)]  
...
##  <a name="_core_programming_the_activex_control"></a> Programming the ActiveX Control  
 ...
 [!code-cpp[NVC_MFC_AxCont#7](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/ContainerDlg.cpp#7)]  
