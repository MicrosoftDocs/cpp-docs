...
The latest version of this topic can be found at [TN042: ODBC Driver Developer Recommendations](https://docs.microsoft.com/cpp/mfc/tn042-odbc-driver-developer-recommendations).  
