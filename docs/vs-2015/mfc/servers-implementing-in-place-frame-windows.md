...
The latest version of this topic can be found at [Servers: Implementing In-Place Frame Windows](https://docs.microsoft.com/cpp/mfc/servers-implementing-in-place-frame-windows).  
...
3.  If you have a toolbar, declare a `CToolBar` member in the frame-window class.  
     ...
     [!code-cpp[NVC_MFCOleServer#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleServer/Cpp/IpFrame.cpp#1)]  
