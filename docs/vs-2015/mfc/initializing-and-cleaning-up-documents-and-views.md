...
The latest version of this topic can be found at [Initializing and Cleaning Up Documents and Views](https://docs.microsoft.com/cpp/mfc/initializing-and-cleaning-up-documents-and-views).  
