...
The latest version of this topic can be found at [One-Stage and Two-Stage Construction of Objects](https://docs.microsoft.com/cpp/mfc/one-stage-and-two-stage-construction-of-objects).  
...
## Example of Both Construction Techniques  
 ...
 [!code-cpp[NVC_MFCDocViewSDI#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocViewSDI/Cpp/MyView.cpp#6)]  
