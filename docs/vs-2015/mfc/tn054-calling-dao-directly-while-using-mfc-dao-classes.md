...
The latest version of this topic can be found at [TN054: Calling DAO Directly While Using MFC DAO Classes](https://docs.microsoft.com/cpp/mfc/tn054-calling-dao-directly-while-using-mfc-dao-classes).  
