...
The latest version of this topic can be found at [MFC ActiveX Controls: Distributing ActiveX Controls](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-distributing-activex-controls).  
...
##  <a name="_core_registering_controls"></a> Registering Controls  
 ...
 [!code-cpp[NVC_MFC_AxCont#16](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxCont/Cpp/NVC_MFC_AxCont.cpp#16)]  
