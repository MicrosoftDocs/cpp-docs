...
The latest version of this topic can be found at [OLE Background: Implementation Strategies](https://docs.microsoft.com/cpp/mfc/ole-background-implementation-strategies).  
...
-   You have an application that was not written using the Microsoft Foundation Classes and that may or may not have implemented OLE support.  
 ...
 Once you have decided on a strategy, you should either read the [Containers](../mfc/containers.md) or [Servers](../mfc/servers.md) articles (depending on the type of application you are writing) or examine the sample programs, or both. The MFC OLE samples [OCLIENT](../top/visual-cpp-samples.md) and [HIERSVR](../top/visual-cpp-samples.md) show how to implement the various aspects of containers and servers, respectively. At various points throughout these articles, you will be referred to certain functions in these samples as examples of the techniques being discussed.  
