...
The latest version of this topic can be found at [Creating Stack and Queue Collections](https://docs.microsoft.com/cpp/mfc/creating-stack-and-queue-collections).  
...
1.  Derive a new list class from one of the existing MFC list classes and add more member functions to support the functionality of stack operations.  
     ...
     [!code-cpp[NVC_MFCCollections#20](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.h#20)]  
...
1.  Derive a new list class from one of the predefined list classes provided with the Microsoft Foundation Class Library and add more member functions to support the semantics of queue operations.  
     ...
     [!code-cpp[NVC_MFCCollections#21](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.h#21)]  
