...
The latest version of this topic can be found at [ActiveX Control Containers: Inserting a Control into a Control Container Application](https://docs.microsoft.com/cpp/mfc/inserting-a-control-into-a-control-container-application).  
