...
The latest version of this topic can be found at [Using Drop-Down Buttons in a Toolbar Control](https://docs.microsoft.com/cpp/mfc/using-drop-down-buttons-in-a-toolbar-control).  
...
1.  Once your `CToolBarCtrl` object has been created, set the `TBSTYLE_EX_DRAWDDARROWS` style, using the following code:  
     ...
     [!code-cpp[NVC_MFCControlLadenDialog#36](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#36)]  
...
2.  Set the `TBSTYLE_DROPDOWN` style for any new ([InsertButton](../mfc/reference/ctoolbarctrl-class.md#insertbutton) or [AddButtons](../mfc/reference/ctoolbarctrl-class.md#addbuttons)) or existing ([SetButtonInfo](../mfc/reference/ctoolbarctrl-class.md#setbuttoninfo)) buttons that will be drop-down buttons. The following example demonstrates modifying an existing button in a `CToolBarCtrl` object:  
     ...
     [!code-cpp[NVC_MFCControlLadenDialog#37](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#37)]  
  
3.  Add a `TBN_DROPDOWN` handler to the parent class of the toolbar object.  
  
     [!code-cpp[NVC_MFCControlLadenDialog#38](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#38)]  
  
4.  In the new handler, display the appropriate popup menu. The following code demonstrates one method:  
  
     [!code-cpp[NVC_MFCControlLadenDialog#39](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#39)]  
