...
The latest version of this topic can be found at [How to: Update User-Interface Objects](https://docs.microsoft.com/cpp/mfc/how-to-update-user-interface-objects).  
