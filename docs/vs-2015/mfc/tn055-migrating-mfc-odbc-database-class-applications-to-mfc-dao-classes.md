...
The latest version of this topic can be found at [TN055: Migrating MFC ODBC Database Class Applications to MFC DAO Classes](https://docs.microsoft.com/cpp/mfc/tn055-migrating-mfc-odbc-database-class-applications-to-mfc-dao-classes).  
