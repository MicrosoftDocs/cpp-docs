...
The latest version of this topic can be found at [MFC ActiveX Controls: Adding Custom Events](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-adding-custom-events).  
...
##  <a name="_core_classwizard_changes_for_custom_events"></a> Add Event Wizard Changes for Custom Events  
 ...
 [!code-cpp[NVC_MFC_AxUI#7](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.h#7)]  
 ...
 [!code-cpp[NVC_MFC_AxUI#8](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.cpp#8)]  
 ...
 [!code-cpp[NVC_MFC_AxUI#9](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/NVC_MFC_AxUI.idl#9)]  
...
6.  Double-click the new handler function in Class View to jump to the message handler code in the implementation (.CPP) file of your ActiveX control.  
 ...
 [!code-cpp[NVC_MFC_AxUI#10](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.cpp#10)]  
...
>  When the Add Event Wizard creates message handlers for mouse button actions, a call to the same message handler of the base class is automatically added. Do not remove this call. If your control uses any of the stock mouse messages, the message handlers in the base class must be called to ensure that mouse capture is handled properly.  
 ...
 [!code-cpp[NVC_MFC_AxUI#11](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.cpp#11)]  
  
 You will also need to add the following declaration of the `InCircle` function to your control's header (.H) file:  
  
 [!code-cpp[NVC_MFC_AxUI#12](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.h#12)]  
