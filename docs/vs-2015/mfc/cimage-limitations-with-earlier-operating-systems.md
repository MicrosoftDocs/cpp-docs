...
The latest version of this topic can be found at [CImage Limitations with Earlier Operating Systems](https://docs.microsoft.com/cpp/mfc/cimage-limitations-with-earlier-operating-systems).  
...
## Example  
 [!code-cpp[NVC_MFCDocViewSDI#8](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocViewSDI/Cpp/MyView.cpp#8)]  
 ...
 [!code-cpp[NVC_MFCDocViewSDI#9](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocViewSDI/Cpp/stdafx.h#9)]  
