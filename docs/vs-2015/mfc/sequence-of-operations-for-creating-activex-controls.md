...
The latest version of this topic can be found at [Sequence of Operations for Creating ActiveX Controls](https://docs.microsoft.com/cpp/mfc/sequence-of-operations-for-creating-activex-controls).  
