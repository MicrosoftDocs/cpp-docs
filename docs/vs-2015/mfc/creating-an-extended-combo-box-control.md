...
The latest version of this topic can be found at [Creating an Extended Combo Box Control](https://docs.microsoft.com/cpp/mfc/creating-an-extended-combo-box-control).  
