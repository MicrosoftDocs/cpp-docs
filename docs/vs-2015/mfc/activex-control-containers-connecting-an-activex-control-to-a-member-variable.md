...
The latest version of this topic can be found at [ActiveX Control Containers: Connecting an ActiveX Control to a Member Variable](https://docs.microsoft.com/cpp/mfc/activex-control-containers-connecting-an-activex-control-to-a-member-variable).  
