...
The latest version of this topic can be found at [Tree Control Parent and Child Items](https://docs.microsoft.com/cpp/mfc/tree-control-parent-and-child-items).  
