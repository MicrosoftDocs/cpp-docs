...
The latest version of this topic can be found at [Sequence of Operations for Building MFC Applications](https://docs.microsoft.com/cpp/mfc/sequence-of-operations-for-building-mfc-applications).  
...
|Map menus to handler functions.|Use the **Events** button in the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca) to connect menus and accelerators to handler functions in your code.|The Properties window inserts message-map entries and empty function templates into the source files you specify and manages many manual coding tasks.|  
