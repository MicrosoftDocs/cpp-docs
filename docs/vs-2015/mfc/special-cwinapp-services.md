...
The latest version of this topic can be found at [Special CWinApp Services](https://docs.microsoft.com/cpp/mfc/special-cwinapp-services).  
...
##  <a name="_core_shell_registration"></a> Shell Registration  
 ...
 [!code-cpp[NVC_MFCDocView#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/NVC_MFCDocView.cpp#6)]  
