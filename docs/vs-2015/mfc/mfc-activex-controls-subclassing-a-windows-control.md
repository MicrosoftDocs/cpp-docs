...
The latest version of this topic can be found at [MFC ActiveX Controls: Subclassing a Windows Control](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-subclassing-a-windows-control).  
...
##  <a name="_core_overriding_issubclassedcontrol_and_precreatewindow"></a> Overriding IsSubclassedControl and PreCreateWindow  
 ...
 [!code-cpp[NVC_MFC_AxSub#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxSub/Cpp/MyAxSubCtrl.h#1)]  
  
 In the control implementation file (.CPP), add the following lines of code to implement the two overridden functions:  
  
 [!code-cpp[NVC_MFC_AxSub#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxSub/Cpp/MyAxSubCtrl.cpp#2)]  
 ...
 [!code-cpp[NVC_MFC_AxSub#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxSub/Cpp/MyAxSubCtrl.cpp#3)]  
...
##  <a name="_core_modifying_the_ondraw_member_function"></a> Modifying the OnDraw Member Function  
 ...
 [!code-cpp[NVC_MFC_AxSub#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxSub/Cpp/MyAxSubCtrl.cpp#4)]  
...
-   In the control class .H file, declare a handler function. The function should have a return type of **LRESULT** and two parameters, with types **WPARAM** and **LPARAM**, respectively. For example:  
     ...
     [!code-cpp[NVC_MFC_AxSub#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxSub/Cpp/MyAxSubCtrl.h#5)]  
    [!code-cpp[NVC_MFC_AxSub#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxSub/Cpp/MyAxSubCtrl.h#6)]  
...
-   In the control class .CPP file, add an `ON_MESSAGE` entry to the message map. The parameters of this entry should be the message identifier and the name of the handler function. For example:  
     ...
     [!code-cpp[NVC_MFC_AxSub#7](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxSub/Cpp/MyAxSubCtrl.cpp#7)]  
