...
The latest version of this topic can be found at [Template-Based Classes](https://docs.microsoft.com/cpp/mfc/template-based-classes).  
...
-   Other types that you define  
 ...
 [!code-cpp[NVC_MFCCollections#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#1)]  
 ...
 [!code-cpp[NVC_MFCCollections#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#2)]  
...
###  <a name="_core_simple_map_usage"></a> Simple Map Usage  
 ...
 [!code-cpp[NVC_MFCCollections#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#3)]  
 ...
 [!code-cpp[NVC_MFCCollections#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#4)]  
...
###  <a name="_core_typed.2d.pointer_array_and_list_usage"></a> Typed-Pointer Array and List Usage  
 ...
 [!code-cpp[NVC_MFCCollections#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#5)]  
...
###  <a name="_core_typed.2d.pointer_map_usage"></a> Typed-Pointer Map Usage  
 ...
 [!code-cpp[NVC_MFCCollections#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#6)]  
