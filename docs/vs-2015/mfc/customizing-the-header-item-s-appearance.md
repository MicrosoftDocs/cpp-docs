...
The latest version of this topic can be found at [Customizing the Header Item&#39;s Appearance](https://docs.microsoft.com/cpp/mfc/customizing-the-header-item-s-appearance).  
...
-   To indicate that the header control should be hidden, use the `HDS_HIDDEN` style.  
 ...
 For more information about these properties, see [Items](http://msdn.microsoft.com/library/windows/desktop/bb775238) in the [!INCLUDE[winSDK](../includes/winsdk-md.md)]. For information about adding items to a header control, see [Adding Items to the Header Control](../mfc/adding-items-to-the-header-control.md).  
