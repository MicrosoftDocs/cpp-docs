...
The latest version of this topic can be found at [Where Does Remote Automation Fit In?](https://docs.microsoft.com/cpp/mfc/where-does-remote-automation-fit-in-q).  
