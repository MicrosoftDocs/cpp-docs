...
The latest version of this topic can be found at [TN024: MFC-Defined Messages and Resources](https://docs.microsoft.com/cpp/mfc/tn024-mfc-defined-messages-and-resources).  
