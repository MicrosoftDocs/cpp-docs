...
The latest version of this topic can be found at [Menus and Resources: Container Additions](https://docs.microsoft.com/cpp/mfc/menus-and-resources-container-additions).  
