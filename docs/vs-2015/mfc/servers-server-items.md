...
The latest version of this topic can be found at [Servers: Server Items](https://docs.microsoft.com/cpp/mfc/servers-server-items).  
...
3.  Implement an override of `OnGetEmbeddedItem` for your server-document class. For further information, see the article [Servers: Implementing Server Documents](../mfc/servers-implementing-server-documents.md) and the MFC OLE sample [HIERSVR](../top/visual-cpp-samples.md).  
