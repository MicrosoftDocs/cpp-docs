...
The latest version of this topic can be found at [Adding Columns to the Control (Report View)](https://docs.microsoft.com/cpp/mfc/adding-columns-to-the-control-report-view).  
