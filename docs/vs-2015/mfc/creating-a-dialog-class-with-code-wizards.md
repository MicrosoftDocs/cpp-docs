...
The latest version of this topic can be found at [Creating a Dialog Class with Code Wizards](https://docs.microsoft.com/cpp/mfc/creating-a-dialog-class-with-code-wizards).  
