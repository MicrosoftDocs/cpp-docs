...
The latest version of this topic can be found at [TN068: Performing Transactions with the Microsoft Access 7 ODBC Driver](https://docs.microsoft.com/cpp/mfc/tn068-performing-transactions-with-the-microsoft-access-7-odbc-driver).  
