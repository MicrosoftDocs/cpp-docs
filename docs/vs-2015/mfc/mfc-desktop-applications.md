...
The latest version of this topic can be found at [MFC Desktop Applications](https://docs.microsoft.com/cpp/mfc/mfc-desktop-applications).  
...
> [!IMPORTANT]
>  The MFC classes and their members cannot be used in applications that execute in the [!INCLUDE[wrt](../includes/wrt-md.md)].  
>   
>  MFC libraries (DLLs) for multibyte character encoding (MBCS) are no longer included in Visual Studio, but are available as a Visual Studio add-on. For more information, see [MFC MBCS DLL Add-on](../mfc/mfc-mbcs-dll-add-on.md).  
...
## In This Section  
 ...
 [Technical Notes](../mfc/mfc-technical-notes.md)  
...
## See Also  
 [MFC and ATL](../mfc/mfc-and-atl.md)
