...
The latest version of this topic can be found at [Processing Notification Messages in Date and Time Picker Controls](https://docs.microsoft.com/cpp/mfc/processing-notification-messages-in-date-and-time-picker-controls).  
