...
The latest version of this topic can be found at [Derived View Classes Available in MFC](https://docs.microsoft.com/cpp/mfc/derived-view-classes-available-in-mfc).  
