...
The latest version of this topic can be found at [Steps in a Typical FTP Client Application to Delete a File](https://docs.microsoft.com/cpp/mfc/steps-in-a-typical-ftp-client-application-to-delete-a-file).  
