...
The latest version of this topic can be found at [Windows Sockets: Byte Ordering](https://docs.microsoft.com/cpp/mfc/windows-sockets-byte-ordering).  
...
>  When the other end of the communication is not an MFC application, you also must avoid streaming C++ objects derived from `CObject` into your archive because the receiver will not be able to handle them. See the note in [Windows Sockets: Using Sockets with Archives](../mfc/windows-sockets-using-sockets-with-archives.md).  
 ...
 For more information about byte orders, see the Windows Sockets specification, available in the [!INCLUDE[winSDK](../includes/winsdk-md.md)].  
...
## A Byte-Order Conversion Example  
 ...
 [!code-cpp[NVC_MFCSimpleSocket#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSimpleSocket/Cpp/NVC_MFCSimpleSocket.cpp#5)]  
  
 In MFC terms, this would be expressed as follows:  
  
 [!code-cpp[NVC_MFCSimpleSocket#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSimpleSocket/Cpp/NVC_MFCSimpleSocket.cpp#6)]  
 ...
 [!code-cpp[NVC_MFCSimpleSocket#7](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSimpleSocket/Cpp/NVC_MFCSimpleSocket.cpp#7)]  
