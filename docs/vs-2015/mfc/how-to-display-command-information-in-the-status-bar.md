...
The latest version of this topic can be found at [How to: Display Command Information in the Status Bar](https://docs.microsoft.com/cpp/mfc/how-to-display-command-information-in-the-status-bar).  
