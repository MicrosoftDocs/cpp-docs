...
The latest version of this topic can be found at [Automatic Linking of MFC Library Version](https://docs.microsoft.com/cpp/mfc/automatic-linking-of-mfc-library-version).  
