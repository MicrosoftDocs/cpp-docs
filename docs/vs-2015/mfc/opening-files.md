...
The latest version of this topic can be found at [Opening Files](https://docs.microsoft.com/cpp/mfc/opening-files).  
...
2.  Call the [Open](../mfc/reference/cfile-class.md#open) member function for the file object, supplying a path and permission flags.  
 ...
 [!code-cpp[NVC_MFCFiles#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCFiles/Cpp/MFCFiles.cpp#1)]  
