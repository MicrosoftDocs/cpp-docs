...
The latest version of this topic can be found at [Recommendations for Choosing a Collection Class](https://docs.microsoft.com/cpp/mfc/recommendations-for-choosing-a-collection-class).  
