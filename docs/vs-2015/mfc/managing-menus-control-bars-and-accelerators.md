...
The latest version of this topic can be found at [Managing Menus, Control Bars, and Accelerators](https://docs.microsoft.com/cpp/mfc/managing-menus-control-bars-and-accelerators).  
