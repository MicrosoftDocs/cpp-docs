...
The latest version of this topic can be found at [Drawing in a View](https://docs.microsoft.com/cpp/mfc/drawing-in-a-view).  
...
2.  Displays the data by calling member functions of a device-context object that the framework passes to `OnDraw`.  
 ...
 [!code-cpp[NVC_MFCDocView#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#1)]  
