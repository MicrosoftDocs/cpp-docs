...
The latest version of this topic can be found at [Steps in a Typical Gopher Client Application](https://docs.microsoft.com/cpp/mfc/steps-in-a-typical-gopher-client-application).  
