...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "Internet applications [C++], MFC"
  - "MFC [C++], Internet applications"
...
The latest version of this topic can be found at [Writing MFC Applications](https://docs.microsoft.com/cpp/mfc/writing-mfc-applications).  
