...
The latest version of this topic can be found at [Clipboard: Using the OLE Clipboard Mechanism](https://docs.microsoft.com/cpp/mfc/clipboard-using-the-ole-clipboard-mechanism).  
...
OLE uses standard formats and some OLE-specific formats for transferring data through the Clipboard.  
 ...
 [!code-cpp[NVC_MFCListView#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCListView/Cpp/MyListView.cpp#3)]  
