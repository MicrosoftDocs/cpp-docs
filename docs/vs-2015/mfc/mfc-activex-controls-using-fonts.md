...
The latest version of this topic can be found at [MFC ActiveX Controls: Using Fonts](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-using-fonts).  
...
6.  Click **Finish**.  
 ...
 [!code-cpp[NVC_MFC_AxFont#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#1)]  
  
 In addition, the Add Property Wizard adds the following line to the control .IDL file:  
  
 [!code-cpp[NVC_MFC_AxFont#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/NVC_MFC_AxFont.idl#2)]  
...
6.  Click **Finish**.  
 ...
 [!code-cpp[NVC_MFC_AxFont#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#3)]  
...
##  <a name="_core_modifying_the_ondraw_function"></a> Modifying the OnDraw Function  
 ...
 [!code-cpp[NVC_MFC_AxFont#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#4)]  
...
8.  Click **Finish**.  
 ...
 [!code-cpp[NVC_MFC_AxFont#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#5)]  
 ...
 [!code-cpp[NVC_MFC_AxFont#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#6)]  
  
 Finally, the Add Property Wizard modifies the control .IDL file by adding an entry for the `HeadingFont` property:  
  
 [!code-cpp[NVC_MFC_AxFont#7](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/NVC_MFC_AxFont.idl#7)]  
...
### Modifications to the Control Code  
 ...
 [!code-cpp[NVC_MFC_AxFont#8](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.h#8)]  
  
 In the control implementation file (.CPP), do the following:  
  
-   Initialize `m_fontHeading` in the control constructor.  
  
     [!code-cpp[NVC_MFC_AxFont#9](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#9)]  
  
-   Declare a static **FONTDESC** structure containing default attributes of the font.  
  
     [!code-cpp[NVC_MFC_AxFont#10](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#10)]  
...
-   In the control `DoPropExchange` member function, add a call to the `PX_Font` function. This provides initialization and persistence for your custom Font property.  
     ...
     [!code-cpp[NVC_MFC_AxFont#11](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#11)]  
  
-   Finish implementing the control `GetHeadingFont` member function.  
  
     [!code-cpp[NVC_MFC_AxFont#12](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#12)]  
  
-   Finish implementing the control `SetHeadingFont` member function.  
  
     [!code-cpp[NVC_MFC_AxFont#13](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#13)]  
  
-   Modify the control `OnDraw` member function to define a variable to hold the previously selected font.  
  
     [!code-cpp[NVC_MFC_AxFont#14](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#14)]  
...
-   Modify the control `OnDraw` member function to select the custom font into the device context by adding the following line wherever the font is to be used.  
     ...
     [!code-cpp[NVC_MFC_AxFont#15](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#15)]  
...
-   Modify the control `OnDraw` member function to select the previous font back into the device context by adding the following line after the font has been used.  
     ...
     [!code-cpp[NVC_MFC_AxFont#16](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#16)]  
 ...
 [!code-cpp[NVC_MFC_AxFont#17](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#17)]  
  
 You must also increment the count parameter of your `BEGIN_PROPPAGEIDS` macro by one. The following line illustrates this:  
  
 [!code-cpp[NVC_MFC_AxFont#18](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#18)]  
...
### Additions to the Header File  
 ...
 [!code-cpp[NVC_MFC_AxFont#19](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.h#19)]  
...
### Additions to the Implementation File  
 ...
 [!code-cpp[NVC_MFC_AxFont#20](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxFont/Cpp/MyAxFontCtrl.cpp#20)]  
