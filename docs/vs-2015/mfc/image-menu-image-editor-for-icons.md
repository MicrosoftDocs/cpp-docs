...
The latest version of this topic can be found at [Image Menu (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/image-menu-image-editor-for-icons).  
