...
The latest version of this topic can be found at [Windows Sockets: How Sockets with Archives Work](https://docs.microsoft.com/cpp/mfc/windows-sockets-how-sockets-with-archives-work).  
...
CArchive, CSocketFile, and CSocket  
 ...
 [!code-cpp[NVC_MFCSimpleSocket#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSimpleSocket/Cpp/NVC_MFCSimpleSocket.cpp#2)]  
