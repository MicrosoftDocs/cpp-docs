...
The latest version of this topic can be found at [CWinApp and the MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/cwinapp-and-the-mfc-application-wizard).  
