...
The latest version of this topic can be found at [Making Controls the Same Width, Height, or Size](https://docs.microsoft.com/cpp/windows/making-controls-the-same-width-height-or-size).  
