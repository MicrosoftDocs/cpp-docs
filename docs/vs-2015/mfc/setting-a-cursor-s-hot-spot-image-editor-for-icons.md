...
The latest version of this topic can be found at [Setting a Cursor&#39;s Hot Spot (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/setting-a-cursor-s-hot-spot-image-editor-for-icons).  
  
  
The hot spot of a [cursor](../mfc/icons-and-cursors-image-resources-for-display-devices-image-editor-for-icons.md) is the point to which Windows refers in tracking the cursor's position. By default, the hot spot is set to the upper-left corner of the cursor (coordinates 0,0). The Hotspot property in the [Properties window](../Topic/Properties%20Window.md) shows the hot spot coordinates.  
