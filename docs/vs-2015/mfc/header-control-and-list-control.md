...
The latest version of this topic can be found at [Header Control and List Control](https://docs.microsoft.com/cpp/mfc/header-control-and-list-control).  
...
>  These controls only include a built-in header control if the list view control is created using the `LVS_REPORT` style.  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#14](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#14)]  
