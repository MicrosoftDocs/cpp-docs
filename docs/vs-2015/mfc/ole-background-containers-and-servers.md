...
The latest version of this topic can be found at [OLE Background: Containers and Servers](https://docs.microsoft.com/cpp/mfc/ole-background-containers-and-servers).  
