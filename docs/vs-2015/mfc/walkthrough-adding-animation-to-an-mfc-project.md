...
The latest version of this topic can be found at [Walkthrough: Adding Animation to an MFC Project](https://docs.microsoft.com/cpp/mfc/walkthrough-adding-animation-to-an-mfc-project).  
