...
The latest version of this topic can be found at [Derived Message Maps](https://docs.microsoft.com/cpp/mfc/derived-message-maps).  
...
A View Hierarchy  
 ...
 [!code-cpp[NVC_MFCMessageHandling#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCMessageHandling/Cpp/MFCMessageHandlingView.cpp#2)]  
