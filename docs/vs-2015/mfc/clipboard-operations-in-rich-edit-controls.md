...
The latest version of this topic can be found at [Clipboard Operations in Rich Edit Controls](https://docs.microsoft.com/cpp/mfc/clipboard-operations-in-rich-edit-controls).  
