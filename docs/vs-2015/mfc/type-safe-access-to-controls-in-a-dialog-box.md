...
The latest version of this topic can be found at [Type-Safe Access to Controls in a Dialog Box](https://docs.microsoft.com/cpp/mfc/type-safe-access-to-controls-in-a-dialog-box).  
