...
The latest version of this topic can be found at [Serializing Data to and from Files](https://docs.microsoft.com/cpp/mfc/serializing-data-to-and-from-files).  
