...
The latest version of this topic can be found at [Updating the Text of a Status-Bar Pane](https://docs.microsoft.com/cpp/mfc/updating-the-text-of-a-status-bar-pane).  
...
3.  Add the pane to the **indicators** array.  
     ...
     [!code-cpp[NVC_MFCDocView#10](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MainFrm.cpp#10)]  
...
1.  Add a command update handler for the command.  
     ...
     [!code-cpp[NVC_MFCDocView#11](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MainFrm.h#11)]  
  
2.  In the appropriate .CPP file, add the handler's definition, as shown here for `ID_INDICATOR_PAGE` (in MAINFRM.CPP):  
  
     [!code-cpp[NVC_MFCDocView#12](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MainFrm.cpp#12)]  
...
3.  In the appropriate message map, add the `ON_UPDATE_COMMAND_UI` macro, as shown here for `ID_INDICATOR_PAGE` (in MAINFRM.CPP):  
     ...
     [!code-cpp[NVC_MFCDocView#13](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MainFrm.cpp#13)]  
