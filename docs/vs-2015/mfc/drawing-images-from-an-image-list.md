...
The latest version of this topic can be found at [Drawing Images from an Image List](https://docs.microsoft.com/cpp/mfc/drawing-images-from-an-image-list).  
