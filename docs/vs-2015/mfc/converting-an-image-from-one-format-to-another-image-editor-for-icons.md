...
The latest version of this topic can be found at [Converting an Image From One Format to Another (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/converting-an-image-from-one-format-to-another-image-editor-for-icons).  
