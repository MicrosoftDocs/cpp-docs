...
The latest version of this topic can be found at [Optimizing Persistence and Initialization](https://docs.microsoft.com/cpp/mfc/optimizing-persistence-and-initialization).  
...
By default, persistence and initialization in a control are handled by the `DoPropExchange` member function. In a typical control, this function contains calls to several **PX_** functions (`PX_Color`, `PX_Font`, and so on), one for each property.  
 ...
 [!code-cpp[NVC_MFC_AxOpt#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxOpt/Cpp/MyAxOptCtrl.cpp#1)]  
  
 To improve the performance of this control's binary persistence, you can override the `Serialize` function as follows:  
  
 [!code-cpp[NVC_MFC_AxOpt#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxOpt/Cpp/MyAxOptCtrl.cpp#2)]  
 ...
 [!code-cpp[NVC_MFC_AxOpt#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxOpt/Cpp/MyAxOptCtrl.cpp#3)]  
 ...
 [!code-cpp[NVC_MFC_AxOpt#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxOpt/Cpp/MyAxOptCtrl.cpp#4)]  
