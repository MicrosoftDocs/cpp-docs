...
The latest version of this topic can be found at [Resource Files (Visual Studio)](https://docs.microsoft.com/cpp/windows/resource-files-visual-studio).  

NOTE]
>  This material applies to Windows desktop applications. For information about resources in [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] apps, see [Defining App Resources](http://msdn.microsoft.com/en-us/476ea844-632c-4467-9ce3-966be1350dd4).  
>   
