...
The latest version of this topic can be found at [Windows Sockets: Using Sockets with Archives](https://docs.microsoft.com/cpp/mfc/windows-sockets-using-sockets-with-archives).  
