...
The latest version of this topic can be found at [TN025: Document, View, and Frame Creation](https://docs.microsoft.com/cpp/mfc/tn025-document-view-and-frame-creation).  
