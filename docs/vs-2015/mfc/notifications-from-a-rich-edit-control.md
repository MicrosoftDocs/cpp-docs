...
The latest version of this topic can be found at [Notifications from a Rich Edit Control](https://docs.microsoft.com/cpp/mfc/notifications-from-a-rich-edit-control).  
