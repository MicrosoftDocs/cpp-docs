...
The latest version of this topic can be found at [Selecting an Area of an Image (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/selecting-an-area-of-an-image-image-editor-for-icons).  
