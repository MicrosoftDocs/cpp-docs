...
The latest version of this topic can be found at [Interpreting User Input Through a View](https://docs.microsoft.com/cpp/mfc/interpreting-user-input-through-a-view).  
