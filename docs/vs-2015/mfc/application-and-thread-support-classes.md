...
The latest version of this topic can be found at [Application and Thread Support Classes](https://docs.microsoft.com/cpp/mfc/application-and-thread-support-classes).  
