...
The latest version of this topic can be found at [Using Custom Format Strings in a Date and Time Picker Control](https://docs.microsoft.com/cpp/mfc/using-custom-format-strings-in-a-date-and-time-picker-control).  
...
-   **DTS_TIMEFORMAT** Displays the time in long format, producing output like "5:31:42 PM".  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#7](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#7)]  
