...
The latest version of this topic can be found at [Accessing Run-Time Class Information](https://docs.microsoft.com/cpp/mfc/accessing-run-time-class-information).  
...
1.  Use `RUNTIME_CLASS` with the name of the class, as shown here for the class `CObject`:  
     ...
     [!code-cpp[NVC_MFCCObjectSample#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCObjectSample/Cpp/MFCCObjectSample.cpp#4)]  
...
2.  Call the `IsKindOf` member function for objects of that class, using the `RUNTIME_CLASS` macro to generate the `CRuntimeClass` argument, as shown here:  
     ...
     [!code-cpp[NVC_MFCCObjectSample#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCObjectSample/Cpp/MFCCObjectSample.cpp#5)]  
