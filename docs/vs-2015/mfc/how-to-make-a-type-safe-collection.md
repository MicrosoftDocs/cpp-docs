...
The latest version of this topic can be found at [How to: Make a Type-Safe Collection](https://docs.microsoft.com/cpp/mfc/how-to-make-a-type-safe-collection).  
...
1.  Declare a variable of the collection class type. For example:  
     ...
     [!code-cpp[NVC_MFCCollections#7](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#7)]  
  
2.  Call the member functions of the collection object. For example:  
  
     [!code-cpp[NVC_MFCCollections#8](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#8)]  
...
###  <a name="_core_serializing_elements"></a> Serializing Elements  
 ...
 [!code-cpp[NVC_MFCCollections#9](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#9)]  
...
1.  Use one of the nontemplate classes, such as `CWordArray`, directly.  
     ...
     [!code-cpp[NVC_MFCCollections#10](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#10)]  
...
1.  Derive your own collection class from one of the predefined nontemplate classes.  
     ...
     [!code-cpp[NVC_MFCCollections#11](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.h#11)]  
