...
The latest version of this topic can be found at [Using Common Controls in a Dialog Box](https://docs.microsoft.com/cpp/mfc/using-common-controls-in-a-dialog-box).  
