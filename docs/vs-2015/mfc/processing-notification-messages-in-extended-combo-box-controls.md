...
The latest version of this topic can be found at [Processing Notification Messages in Extended Combo Box Controls](https://docs.microsoft.com/cpp/mfc/processing-notification-messages-in-extended-combo-box-controls).  
