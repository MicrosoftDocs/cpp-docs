...
The latest version of this topic can be found at [Callback Items and the Callback Mask](https://docs.microsoft.com/cpp/mfc/callback-items-and-the-callback-mask).  
