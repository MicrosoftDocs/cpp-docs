...
The latest version of this topic can be found at [MFC Application Architecture Classes](https://docs.microsoft.com/cpp/mfc/mfc-application-architecture-classes).  
