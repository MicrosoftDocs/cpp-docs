...
The latest version of this topic can be found at [User-defined Tools](https://docs.microsoft.com/cpp/mfc/user-defined-tools).  
...
## Enabling user-defined tools support  
 ...
 [!code-cpp[NVC_MFC_VisualStudioDemo#1](../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/VisualStudioDemo.cpp#1)]  
