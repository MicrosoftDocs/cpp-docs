...
The latest version of this topic can be found at [Creating New Documents, Windows, and Views](https://docs.microsoft.com/cpp/mfc/creating-new-documents-windows-and-views).  
