...
The latest version of this topic can be found at [Advantages of the Document-View Architecture](https://docs.microsoft.com/cpp/mfc/advantages-of-the-document-view-architecture).  
