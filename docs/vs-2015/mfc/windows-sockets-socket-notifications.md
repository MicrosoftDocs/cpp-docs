...
The latest version of this topic can be found at [Windows Sockets: Socket Notifications](https://docs.microsoft.com/cpp/mfc/windows-sockets-socket-notifications).  
