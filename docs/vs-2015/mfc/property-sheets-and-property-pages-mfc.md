...
The latest version of this topic can be found at [Property Sheets and Property Pages (MFC)](https://docs.microsoft.com/cpp/mfc/property-sheets-and-property-pages-mfc).  
