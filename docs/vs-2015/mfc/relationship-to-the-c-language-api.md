...
The latest version of this topic can be found at [Relationship to the C-Language API](https://docs.microsoft.com/cpp/mfc/relationship-to-the-c-language-api).  
