...
The latest version of this topic can be found at [Editing Graphical Resources (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/editing-graphical-resources-image-editor-for-icons).  
