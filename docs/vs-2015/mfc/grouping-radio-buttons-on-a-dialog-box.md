...
The latest version of this topic can be found at [Grouping Radio Buttons on a Dialog Box](https://docs.microsoft.com/cpp/windows/grouping-radio-buttons-on-a-dialog-box).  
