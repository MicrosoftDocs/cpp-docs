...
The latest version of this topic can be found at [Drag and Drop: Implementing a Drop Target](https://docs.microsoft.com/cpp/mfc/drag-and-drop-implementing-a-drop-target).  
