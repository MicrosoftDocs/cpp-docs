...
The latest version of this topic can be found at [OLE Background: Linking and Embedding](https://docs.microsoft.com/cpp/mfc/ole-background-linking-and-embedding).  
