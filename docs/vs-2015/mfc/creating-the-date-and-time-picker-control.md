...
The latest version of this topic can be found at [Creating the Date and Time Picker Control](https://docs.microsoft.com/cpp/mfc/creating-the-date-and-time-picker-control).  
