...
The latest version of this topic can be found at [Saving Bitmaps as GIFs or JPEGs (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/saving-bitmaps-as-gifs-or-jpegs-image-editor-for-icons).  
