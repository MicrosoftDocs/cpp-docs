...
The latest version of this topic can be found at [Setting the Images for an Individual Item](https://docs.microsoft.com/cpp/mfc/setting-the-images-for-an-individual-item).  
...
## Setting the Image for a New Item  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#12](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#12)]  
...
4.  Make a call to [CComboBoxEx::SetItem](../mfc/reference/ccomboboxex-class.md#ccomboboxex__setitem), passing in the modified structure.  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#13](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#13)]  
