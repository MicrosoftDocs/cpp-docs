...
The latest version of this topic can be found at [Changing the Font of Text on an Image (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/changing-the-font-of-text-on-an-image-image-editor-for-icons).  
