...
The latest version of this topic can be found at [Property Sheets as Wizards](https://docs.microsoft.com/cpp/mfc/property-sheets-as-wizards).  
...
## Example  
 [!code-cpp[NVC_MFCDocView#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#5)]  
