...
The latest version of this topic can be found at [How to: Implement Tracking in Your Code](https://docs.microsoft.com/cpp/mfc/how-to-implement-tracking-in-your-code).  
...
|Hatching pattern overlays item|Item's server is open|  
 ...
 [!code-cpp[NVC_MFCOClient#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOClient/Cpp/mainview.cpp#1)]  
  
 The tracker is initialized by setting the minimum size and clearing the style of the tracker.  
  
 [!code-cpp[NVC_MFCOClient#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOClient/Cpp/mainview.cpp#2)]  
 ...
 [!code-cpp[NVC_MFCOClient#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOClient/Cpp/mainview.cpp#3)]  
  
 The following code overlays the item with a hatched pattern if the item is currently open.  
  
 [!code-cpp[NVC_MFCOClient#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOClient/Cpp/mainview.cpp#4)]  
 ...
 [!code-cpp[NVC_MFCOClient#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOClient/Cpp/mainview.cpp#5)]  
