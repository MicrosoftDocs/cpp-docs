...
The latest version of this topic can be found at [Multiple Document Types, Views, and Frame Windows](https://docs.microsoft.com/cpp/mfc/multiple-document-types-views-and-frame-windows).  
