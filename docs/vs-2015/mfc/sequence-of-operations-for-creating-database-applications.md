...
The latest version of this topic can be found at [Sequence of Operations for Creating Database Applications](https://docs.microsoft.com/cpp/mfc/sequence-of-operations-for-creating-database-applications).  
...
|----------|------------|------------------------|  
|Decide whether to use the MFC ODBC or DAO classes.|Use ODBC for new MFC projects. Use DAO only to maintain existing applications. See [Should I use DAO or ODBC]--brokenlink--(../Topic/Should%20I%20Use%20DAO%20or%20ODBC.md). For general information, see the article [Data Access Programming](../data/data-access-programming-mfc-atl.md).|The framework supplies classes that support database access.|  
