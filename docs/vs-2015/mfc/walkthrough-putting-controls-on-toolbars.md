...
The latest version of this topic can be found at [Walkthrough: Putting Controls On Toolbars](https://docs.microsoft.com/cpp/mfc/walkthrough-putting-controls-on-toolbars).  
