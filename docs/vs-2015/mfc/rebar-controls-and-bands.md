...
The latest version of this topic can be found at [Rebar Controls and Bands](https://docs.microsoft.com/cpp/mfc/rebar-controls-and-bands).  
...
-   [GetBandBorders](../mfc/reference/crebarctrl-class.md#getbandborders) Retrieves the borders of a band.  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#27](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#27)]  
