...
The latest version of this topic can be found at [Tool Tips in Windows Not Derived from CFrameWnd](https://docs.microsoft.com/cpp/mfc/tool-tips-in-windows-not-derived-from-cframewnd).  
