...
The latest version of this topic can be found at [Walkthrough: Using the New MFC Shell Controls](https://docs.microsoft.com/cpp/mfc/walkthrough-using-the-new-mfc-shell-controls).  
...
## Prerequisites  
 This walkthrough assumes that you have set up [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] to use **General Development Settings**. If you are using a different development setting, some [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] windows that we use in this walkthrough might not be displayed by default.  
