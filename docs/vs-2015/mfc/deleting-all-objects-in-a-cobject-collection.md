...
The latest version of this topic can be found at [Deleting All Objects in a CObject Collection](https://docs.microsoft.com/cpp/mfc/deleting-all-objects-in-a-cobject-collection).  
...
3.  Call the `RemoveAll` function to remove all elements from the list after the objects associated with those elements have been deleted.  
 ...
 [!code-cpp[NVC_MFCCollections#17](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#17)]  
...
3.  Call the `RemoveAll` function to remove all elements from the array after they have been deleted.  
     ...
     [!code-cpp[NVC_MFCCollections#18](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#18)]  
...
3.  Call the `RemoveAll` function to remove all elements from the map after they have been deleted.  
     ...
     [!code-cpp[NVC_MFCCollections#19](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#19)]  
