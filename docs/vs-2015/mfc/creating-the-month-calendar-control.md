...
The latest version of this topic can be found at [Creating the Month Calendar Control](https://docs.microsoft.com/cpp/mfc/creating-the-month-calendar-control).  
