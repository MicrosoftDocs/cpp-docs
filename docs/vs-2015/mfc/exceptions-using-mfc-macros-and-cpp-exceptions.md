...
The latest version of this topic can be found at [Exceptions: Using MFC Macros and C++ Exceptions](https://docs.microsoft.com/cpp/mfc/exceptions-using-mfc-macros-and-cpp-exceptions).  
...
##  <a name="_core_mixing_exception_keywords_and_macros"></a> Mixing Exception Keywords and Macros  
 ...
 [!code-cpp[NVC_MFCExceptions#10](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCExceptions/Cpp/MFCExceptions.cpp#10)]  
 ...
 [!code-cpp[NVC_MFCExceptions#11](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCExceptions/Cpp/MFCExceptions.cpp#11)]  
...
##  <a name="_core_try_blocks_inside_catch_blocks"></a> Try Blocks Inside Catch Blocks  
 ...
 [!code-cpp[NVC_MFCExceptions#12](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCExceptions/Cpp/MFCExceptions.cpp#12)]  
