...
The latest version of this topic can be found at [TN045: MFC-Database Support for Long Varchar-Varbinary](https://docs.microsoft.com/cpp/mfc/tn045-mfc-database-support-for-long-varchar-varbinary).  
