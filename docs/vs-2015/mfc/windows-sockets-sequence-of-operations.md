...
The latest version of this topic can be found at [Windows Sockets: Sequence of Operations](https://docs.microsoft.com/cpp/mfc/windows-sockets-sequence-of-operations).  
