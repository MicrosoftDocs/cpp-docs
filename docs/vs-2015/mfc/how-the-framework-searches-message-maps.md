...
The latest version of this topic can be found at [How the Framework Searches Message Maps](https://docs.microsoft.com/cpp/mfc/how-the-framework-searches-message-maps).  
