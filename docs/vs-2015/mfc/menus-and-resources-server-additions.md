...
The latest version of this topic can be found at [Menus and Resources: Server Additions](https://docs.microsoft.com/cpp/mfc/menus-and-resources-server-additions).  
