...
The latest version of this topic can be found at [Retrieving Data from the Dialog Object](https://docs.microsoft.com/cpp/mfc/retrieving-data-from-the-dialog-object).  
