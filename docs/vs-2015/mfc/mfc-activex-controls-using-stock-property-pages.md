...
The latest version of this topic can be found at [MFC ActiveX Controls: Using Stock Property Pages](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-using-stock-property-pages).  
...
-   [MFC ActiveX Controls: Adding Another Custom Property Page](../mfc/mfc-activex-controls-adding-another-custom-property-page.md)  
 ...
 [!code-cpp[NVC_MFC_AxOpt#21](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxOpt/Cpp/MyAxOptCtrl.cpp#21)]  
