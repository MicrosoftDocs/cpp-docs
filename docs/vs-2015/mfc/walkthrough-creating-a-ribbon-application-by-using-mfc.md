...
The latest version of this topic can be found at [Walkthrough: Creating a Ribbon Application By Using MFC](https://docs.microsoft.com/cpp/mfc/walkthrough-creating-a-ribbon-application-by-using-mfc).  
