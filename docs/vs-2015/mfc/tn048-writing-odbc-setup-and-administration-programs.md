...
The latest version of this topic can be found at [TN048: Writing ODBC Setup and Administration Programs for MFC Database Applications](https://docs.microsoft.com/cpp/mfc/tn048-writing-odbc-setup-and-administration-programs).  
