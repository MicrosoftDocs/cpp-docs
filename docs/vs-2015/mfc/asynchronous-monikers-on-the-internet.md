...
The latest version of this topic can be found at [Asynchronous Monikers on the Internet](https://docs.microsoft.com/cpp/mfc/asynchronous-monikers-on-the-internet).  
