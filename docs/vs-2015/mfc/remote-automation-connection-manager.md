...
The latest version of this topic can be found at [Remote Automation Connection Manager](https://docs.microsoft.com/cpp/mfc/remote-automation-connection-manager).  
