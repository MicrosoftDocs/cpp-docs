...
The latest version of this topic can be found at [Docking and Floating Toolbars](https://docs.microsoft.com/cpp/mfc/docking-and-floating-toolbars).  
...
##  <a name="_core_setting_wrap_positions_for_a_fixed.2d.style_toolbar"></a> Setting Wrap Positions for a Fixed-Style Toolbar  
 ...
 [!code-cpp[NVC_MFCDocViewSDI#10](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocViewSDI/Cpp/MainFrm.cpp#10)]  
