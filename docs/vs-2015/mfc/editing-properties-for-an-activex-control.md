...
The latest version of this topic can be found at [Editing Properties for an ActiveX Control](https://docs.microsoft.com/cpp/windows/editing-properties-for-an-activex-control).  
