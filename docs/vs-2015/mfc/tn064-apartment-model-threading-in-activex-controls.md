...
The latest version of this topic can be found at [TN064: Apartment-Model Threading in ActiveX Controls](https://docs.microsoft.com/cpp/mfc/tn064-apartment-model-threading-in-activex-controls).  
