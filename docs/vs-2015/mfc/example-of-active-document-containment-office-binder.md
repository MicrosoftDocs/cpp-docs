...
The latest version of this topic can be found at [Example of Active Document Containment: Office Binder](https://docs.microsoft.com/cpp/mfc/example-of-active-document-containment-office-binder).  
