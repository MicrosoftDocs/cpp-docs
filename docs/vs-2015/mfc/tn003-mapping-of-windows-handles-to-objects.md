...
The latest version of this topic can be found at [TN003: Mapping of Windows Handles to Objects](https://docs.microsoft.com/cpp/mfc/tn003-mapping-of-windows-handles-to-objects).  
