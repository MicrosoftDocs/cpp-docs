...
The latest version of this topic can be found at [Recommendations for Handling Input-Output](https://docs.microsoft.com/cpp/mfc/recommendations-for-handling-input-output).  
