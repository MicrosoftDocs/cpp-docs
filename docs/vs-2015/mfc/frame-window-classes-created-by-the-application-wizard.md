...
The latest version of this topic can be found at [Frame-Window Classes Created by the Application Wizard](https://docs.microsoft.com/cpp/mfc/frame-window-classes-created-by-the-application-wizard).  
