...
The latest version of this topic can be found at [Deriving a Class from CObject](https://docs.microsoft.com/cpp/mfc/deriving-a-class-from-cobject).  
...
1.  Use the normal C++ syntax to derive your class from `CObject` (or from a class derived from `CObject`).  
     ...
     [!code-cpp[NVC_MFCCObjectSample#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCObjectSample/Cpp/MFCCObjectSample.h#1)]  
