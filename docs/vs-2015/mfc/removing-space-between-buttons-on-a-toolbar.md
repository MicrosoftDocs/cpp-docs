...
The latest version of this topic can be found at [Removing Space Between Buttons on a Toolbar](https://docs.microsoft.com/cpp/windows/removing-space-between-buttons-on-a-toolbar).  
...
1.  Drag the button on one side of the space toward the button on the other side of the space until it overlaps the next button about halfway.  
