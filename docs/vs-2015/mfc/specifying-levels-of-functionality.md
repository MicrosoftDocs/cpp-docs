...
The latest version of this topic can be found at [Specifying Levels of Functionality](https://docs.microsoft.com/cpp/mfc/specifying-levels-of-functionality).  
