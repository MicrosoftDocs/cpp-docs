...
The latest version of this topic can be found at [Messages and Commands in the Framework](https://docs.microsoft.com/cpp/mfc/messages-and-commands-in-the-framework).  
