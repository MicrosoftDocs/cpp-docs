...
The latest version of this topic can be found at [Adding Values to a Combo Box Control](https://docs.microsoft.com/cpp/windows/adding-values-to-a-combo-box-control).  
...
2.  In the [Properties Window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca), scroll down to the **Data** property.  
