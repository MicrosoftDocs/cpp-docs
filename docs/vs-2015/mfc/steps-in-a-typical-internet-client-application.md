...
The latest version of this topic can be found at [Steps in a Typical Internet Client Application](https://docs.microsoft.com/cpp/mfc/steps-in-a-typical-internet-client-application).  
