...
The latest version of this topic can be found at [Windows Sockets: Deriving from Socket Classes](https://docs.microsoft.com/cpp/mfc/windows-sockets-deriving-from-socket-classes).  
