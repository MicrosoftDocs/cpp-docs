...
The latest version of this topic can be found at [Current Selection in a Rich Edit Control](https://docs.microsoft.com/cpp/mfc/current-selection-in-a-rich-edit-control).  
