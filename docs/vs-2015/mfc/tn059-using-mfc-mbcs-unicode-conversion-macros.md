...
The latest version of this topic can be found at [TN059: Using MFC MBCS-Unicode Conversion Macros](https://docs.microsoft.com/cpp/mfc/tn059-using-mfc-mbcs-unicode-conversion-macros).  
