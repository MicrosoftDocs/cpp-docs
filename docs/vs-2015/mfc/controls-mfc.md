...
The latest version of this topic can be found at [Controls (MFC)](https://docs.microsoft.com/cpp/mfc/controls-mfc).  
...
-   [Samples](../mfc/common-control-sample-list.md)  
 ...
 For information about Windows common controls in the [!INCLUDE[winSDK](../includes/winsdk-md.md)], see [Common Controls](http://msdn.microsoft.com/library/windows/desktop/bb775493).  
