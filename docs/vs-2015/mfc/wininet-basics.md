...
The latest version of this topic can be found at [WinInet Basics](https://docs.microsoft.com/cpp/mfc/wininet-basics).  
...
##  <a name="_core_create_a_very_simple_browser"></a> Create a Very Simple Browser  
 [!code-cpp[NVC_MFCWinInet#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/StdFile.cpp#1)]  
  
##  <a name="_core_download_a_web_page"></a> Download a Web Page  
 [!code-cpp[NVC_MFCWinInet#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/HttpFile.cpp#2)]  
  
##  <a name="_core_ftp_a_file"></a> FTP a File  
 [!code-cpp[NVC_MFCWinInet#3](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/FtpFile.cpp#3)]  
  
##  <a name="_core_retrieve_a_gopher_directory"></a> Retrieve a Gopher Directory  
 [!code-cpp[NVC_MFCWinInet#4](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/GopherDir.cpp#4)]  
