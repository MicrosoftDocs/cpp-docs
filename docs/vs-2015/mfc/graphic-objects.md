...
The latest version of this topic can be found at [Graphic Objects](https://docs.microsoft.com/cpp/mfc/graphic-objects).  
...
>  The class [CImage](../atl-mfc-shared/reference/cimage-class.md) provides enhanced bitmap support.  
 ...
 [!code-cpp[NVC_MFCDocViewSDI#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocViewSDI/Cpp/MyView.cpp#5)]  
