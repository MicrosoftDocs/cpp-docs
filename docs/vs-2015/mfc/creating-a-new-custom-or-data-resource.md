...
The latest version of this topic can be found at [Creating a New Custom or Data Resource](https://docs.microsoft.com/cpp/windows/creating-a-new-custom-or-data-resource).  
