...
The latest version of this topic can be found at [Setting the Day State of a Month Calendar Control](https://docs.microsoft.com/cpp/mfc/setting-the-day-state-of-a-month-calendar-control).  
...
2.  In the body of the handler, add the following code:  
     ...
     [!code-cpp[NVC_MFCControlLadenDialog#26](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#26)]  
