...
The latest version of this topic can be found at [BITMAP Structure](https://docs.microsoft.com/cpp/mfc/reference/bitmap-structure).  
...
## See Also  
 ...
 [CBitmap::CreateBitmapIndirect](../../mfc/reference/cbitmap-class.md#createbitmapindirect.md)
