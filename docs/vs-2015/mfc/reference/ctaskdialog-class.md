...
The latest version of this topic can be found at [CTaskDialog Class](https://docs.microsoft.com/cpp/mfc/reference/ctaskdialog-class).  
...
## Remarks  
 The `CTaskDialog` class replaces the standard Windows message box and has additional functionality such as new controls to gather information from the user. This class is in the MFC library in [!INCLUDE[vs_dev10_long](../../includes/vs-dev10-long-md.md)]. The `CTaskDialog` is available starting with [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)]. Earlier versions of Windows cannot display the `CTaskDialog` object. Use `CTaskDialog::IsSupported` to determine at runtime whether the current user can display the task dialog box. The standard Windows message box is still supported in [!INCLUDE[vs_dev10_long](../../includes/vs-dev10-long-md.md)].  
...
## Requirements  
 **Minimum required operating system:** [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTaskDialog#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTaskDialog/cpp/NVC_MFC_CTaskDialog.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTaskDialog#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTaskDialog/cpp/NVC_MFC_CTaskDialog.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTaskDialog#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTaskDialog/cpp/NVC_MFC_CTaskDialog.cpp#7)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTaskDialog#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTaskDialog/cpp/NVC_MFC_CTaskDialog.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTaskDialog#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTaskDialog/cpp/NVC_MFC_CTaskDialog.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTaskDialog#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTaskDialog/cpp/NVC_MFC_CTaskDialog.cpp#6)]  
...
### Remarks  
 ...
 Use `nMarqueeSpeed` to set the speed of the marquee bar; larger values indicate a slower speed. A value of 0 for `nMarqueeSpeed` makes the marquee bar move at the default speed for [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)].  
  
 This method throws an exception with the [ENSURE](../Topic/ENSURE%20\(MFC\).md) macro if `nMarqueeSpeed` is less than 0.  
  
### Example  
 [!code-cpp[NVC_MFC_CTaskDialog#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTaskDialog/cpp/NVC_MFC_CTaskDialog.cpp#4)]  
...
### Remarks  
 This method throws an exception with the [ENSURE](../Topic/ENSURE%20\(MFC\).md) macro if this instance of the [CTaskDialog Class](../../mfc/reference/ctaskdialog-class.md) is already displayed.  
