...
The latest version of this topic can be found at [CWinFormsView Class](https://docs.microsoft.com/cpp/mfc/reference/cwinformsview-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_Managed#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Managed/Cpp/MyView.h#1)]  
  
 [!code-cpp[NVC_MFC_Managed#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Managed/Cpp/MyView.cpp#2)]  
