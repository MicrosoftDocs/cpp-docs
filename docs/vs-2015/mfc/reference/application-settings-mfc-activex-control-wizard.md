...
The latest version of this topic can be found at [Application Settings, MFC ActiveX Control Wizard](https://docs.microsoft.com/cpp/mfc/reference/application-settings-mfc-activex-control-wizard).  
