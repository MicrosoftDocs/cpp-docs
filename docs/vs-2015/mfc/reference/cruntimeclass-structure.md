...
The latest version of this topic can be found at [CRuntimeClass Structure](https://docs.microsoft.com/cpp/mfc/reference/cruntimeclass-structure).  
...
### Example  
 [!code-cpp[NVC_MFCCObjectSample#17](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCObjectSample/Cpp/MFCCObjectSample.cpp#17)]  
...
### Example  
 [!code-cpp[NVC_MFCCObjectSample#18](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCObjectSample/Cpp/MFCCObjectSample.cpp#18)]  
