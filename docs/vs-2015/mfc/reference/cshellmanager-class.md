...
The latest version of this topic can be found at [CShellManager Class](https://docs.microsoft.com/cpp/mfc/reference/cshellmanager-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_Explorer#6](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_Explorer/cpp/ExplorerView.cpp#6)]  
