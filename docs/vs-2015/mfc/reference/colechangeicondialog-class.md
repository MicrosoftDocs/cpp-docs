...
The latest version of this topic can be found at [COleChangeIconDialog Class](https://docs.microsoft.com/cpp/mfc/reference/colechangeicondialog-class).  
...
## Remarks  
 ...
 For more information, see the [OLEUICHANGEICON](http://msdn.microsoft.com/library/windows/desktop/ms680098) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
