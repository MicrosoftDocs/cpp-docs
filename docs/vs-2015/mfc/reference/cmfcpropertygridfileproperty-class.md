...
The latest version of this topic can be found at [CMFCPropertyGridFileProperty Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpropertygridfileproperty-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_VisualStudioDemo#22](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/PropertiesViewBar.cpp#22)]  
