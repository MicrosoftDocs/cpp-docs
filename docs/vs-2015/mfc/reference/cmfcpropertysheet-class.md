...
The latest version of this topic can be found at [CMFCPropertySheet Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpropertysheet-class).  
...
## Illustrations  
 ...
 ![CMFCPropertySheet color controls](../../mfc/reference/media/cmfcpropertysheet-color.png "cmfcpropertysheet_color")  
 ...
 ![CMFCPropertySheet list and property controls](../../mfc/reference/media/cmfcpropertysheet-list.png "cmfcpropertysheet_list")  
