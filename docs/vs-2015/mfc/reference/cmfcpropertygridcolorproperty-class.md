...
The latest version of this topic can be found at [CMFCPropertyGridColorProperty Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpropertygridcolorproperty-class).  
