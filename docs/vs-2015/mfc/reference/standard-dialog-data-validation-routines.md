...
The latest version of this topic can be found at [Standard Dialog Data Validation Routines](https://docs.microsoft.com/cpp/mfc/reference/standard-dialog-data-validation-routines).  
