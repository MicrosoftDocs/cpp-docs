...
The latest version of this topic can be found at [CConnectionPoint Class](https://docs.microsoft.com/cpp/mfc/reference/cconnectionpoint-class).  
...
## Remarks  
 ...
 [!code-cpp[NVC_MFCConnectionPoints#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCConnectionPoints/Cpp/MyClass.h#7)]  
