...
The latest version of this topic can be found at [CEdit Class](https://docs.microsoft.com/cpp/mfc/reference/cedit-class).  
...
- **ON_EN_VSCROLL** The user clicks an edit control's vertical scroll bar. The parent window is notified before the screen is updated.  
 ...
 To modify certain styles in an edit control (such as **ES_READONLY**) you must send specific messages to the control instead of using [ModifyStyle](../../mfc/reference/cwnd-class.md#cwnd__modifystyle). See [Edit Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775464) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#6)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#7)]  
...
### Remarks  
 ...
 For more information, see [EM_FMTLINES](http://msdn.microsoft.com/library/windows/desktop/bb761570) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#8)]  
...
### Remarks  
 This method sends the [EM_GETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb761572) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information, see the [Edit_GetCueBannerText](http://msdn.microsoft.com/library/windows/desktop/bb761695) macro.  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#9)]  
...
> **GetHandle** will not work with Windows 95/98. If you call **GetHandle** in Windows 95/98, it will return **NULL**. **GetHandle** will work as documented under Windows NT, versions 3.51 and later.  
 ...
 For more information, see [EM_GETHANDLE](http://msdn.microsoft.com/library/windows/desktop/bb761576) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#10)]  
...
### Remarks  
 This method sends the [EM_GETHILITE](http://msdn.microsoft.com/library/windows/desktop/bb761578) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#11)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#12)]  
...
>  This member function is available beginning with Windows 95 and Windows NT 4.0.  
 ...
 For more information, see [EM_GETMARGINS](http://msdn.microsoft.com/library/windows/desktop/bb761590) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#13](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#13)]  
...
### Remarks  
 ...
 This method sends the [EM_GETPASSWORDCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761594) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#14](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#14)]  
...
### Remarks  
 For more information, see [EM_GETSEL](http://msdn.microsoft.com/library/windows/desktop/bb761598) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#15](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#15)]  
...
### Remarks  
 This function sends the [EM_HIDEBALLOONTIP](http://msdn.microsoft.com/library/windows/desktop/bb761604) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
>  In Win32 (Windows NT and Windows 95/98), [SetLimitText](#cedit__setlimittext) replaces this function.  
 ...
 For more information, see [EM_LIMITTEXT](http://msdn.microsoft.com/library/windows/desktop/bb761607) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#17](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#17)]  
...
### Remarks  
 ...
 For more information, see [EM_LINEFROMCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761609) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#18](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#18)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#19](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#19)]  
...
### Remarks  
 This method is supported by the [EM_LINELENGTH](http://msdn.microsoft.com/library/windows/desktop/bb761613) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#20](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#20)]  
...
### Remarks  
 This method sends the [EM_SETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb761639) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information, see the [Edit_SetCueBannerTextFocused](http://msdn.microsoft.com/library/windows/desktop/bb761703) macro.  
  
### Example  
 The following example demonstrates the [CEdit::SetCueBanner](#cedit__setcuebanner) method.  
  
 [!code-cpp[NVC_MFC_CEdit_s1#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit_s1/cpp/CEdit_s1Dlg.cpp#2)]  
...
> **GetHandle** will not work with Windows 95/98. If you call **GetHandle** in Windows 95/98, it will return **NULL**. **GetHandle** will work as documented under Windows NT, versions 3.51 and later.  
 ...
 For more information, see [EM_SETHANDLE](http://msdn.microsoft.com/library/windows/desktop/bb761641), [LocalAlloc](http://msdn.microsoft.com/library/windows/desktop/aa366723), and [LocalFree](http://msdn.microsoft.com/library/windows/desktop/aa366730) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#22](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#22)]  
...
### Remarks  
 This method sends the [EM_SETHILITE](http://msdn.microsoft.com/library/windows/desktop/bb761643) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_SETLIMITTEXT](http://msdn.microsoft.com/library/windows/desktop/bb761647) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
>  This member function is available beginning with Windows 95 and Windows NT 4.0.  
 ...
 For more information, see [EM_SETMARGINS](http://msdn.microsoft.com/library/windows/desktop/bb761649) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_SETPASSWORDCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761653) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CEdit#16](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#16)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#23](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#23)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#24](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#24)]  
...
### Remarks  
 ...
 For more information, see [EM_SETRECTNP](http://msdn.microsoft.com/library/windows/desktop/bb761659) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see [EM_SETSEL](http://msdn.microsoft.com/library/windows/desktop/bb761661) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_SETTABSTOPS](http://msdn.microsoft.com/library/windows/desktop/bb761663) and [GetDialogBaseUnits](http://msdn.microsoft.com/library/windows/desktop/ms645475) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This function sends the [EM_SHOWBALLOONTIP](http://msdn.microsoft.com/library/windows/desktop/bb761668) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information, see the [Edit_ShowBalloonTip](http://msdn.microsoft.com/library/windows/desktop/bb761707) macro.  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CEdit_s1#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit_s1/cpp/CEdit_s1Dlg.h#1)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CEdit_s1#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit_s1/cpp/CEdit_s1Dlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CEdit#25](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CEdit/Cpp/EditDlg.cpp#25)]  
