...
The latest version of this topic can be found at [CPaneDivider Class](https://docs.microsoft.com/cpp/mfc/reference/cpanedivider-class).  
...
## Example  
 The following example demonstrates how to get a `CPaneDivider` object from a `CWorkspaceBar` object. This code snippet is part of the [MDI Tabs Demo sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_MDITabsDemo#5](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_MDITabsDemo/cpp/MainFrm.cpp#5)]  
