...
The latest version of this topic can be found at [CSplitterWnd Class](https://docs.microsoft.com/cpp/mfc/reference/csplitterwnd-class).  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#125](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyChildFrame.cpp#125)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/ChildFrm.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/SplitChildFrm.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/ChildFrm.cpp#6)]  
