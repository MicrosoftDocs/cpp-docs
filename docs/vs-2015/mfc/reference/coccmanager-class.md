...
The latest version of this topic can be found at [COccManager Class](https://docs.microsoft.com/cpp/mfc/reference/coccmanager-class).  
...
> [!NOTE]
>  The control must have the **OLEMISC_ACTSLIKEBUTTON** status bit set. For more information on **OLEMISC** flags, see the [OLEMISC](http://msdn.microsoft.com/library/windows/desktop/ms678497) topic in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
