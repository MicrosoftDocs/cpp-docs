...
The latest version of this topic can be found at [CMFCRibbonCustomizePropertyPage Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribboncustomizepropertypage-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#22](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#22)]  
