...
The latest version of this topic can be found at [CDaoRecordView Class](https://docs.microsoft.com/cpp/mfc/reference/cdaorecordview-class).  
...
>  If you use ClassWizard, the wizard defines an `enum` value `CDaoRecordView::IDD` in the class declaration and uses it in the member initialization list for the constructor.  
 ...
 [!code-cpp[NVC_MFCDatabase#35](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoRecordView.cpp#35)]  
