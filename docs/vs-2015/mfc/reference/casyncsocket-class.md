...
The latest version of this topic can be found at [CAsyncSocket Class](https://docs.microsoft.com/cpp/mfc/reference/casyncsocket-class).  
...
### Example  
 [!code-cpp[NVC_MFCAsyncSocket#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAsyncSocket/Cpp/MyAsyncSocket.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFCAsyncSocket#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAsyncSocket/Cpp/MyAsyncSocket.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFCAsyncSocket#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAsyncSocket/Cpp/MyAsyncSocket.cpp#3)]  
