...
The latest version of this topic can be found at [CFrameWnd Class](https://docs.microsoft.com/cpp/mfc/reference/cframewnd-class).  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/ChildFrm.cpp#1)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCWindowing#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyView.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#3)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCDocViewSDI#16](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocViewSDI/Cpp/MainFrm.cpp#16)]  
...
### Remarks  
 ...
 This method affects the state of menus in applications written for [!INCLUDE[windowsver](../../includes/windowsver-md.md)] and later.  
