...
The latest version of this topic can be found at [Record Field Exchange Functions](https://docs.microsoft.com/cpp/mfc/reference/record-field-exchange-functions).  
