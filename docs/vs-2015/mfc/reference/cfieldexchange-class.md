...
The latest version of this topic can be found at [CFieldExchange Class](https://docs.microsoft.com/cpp/mfc/reference/cfieldexchange-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDatabase#33](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/Sections.cpp#33)]  
