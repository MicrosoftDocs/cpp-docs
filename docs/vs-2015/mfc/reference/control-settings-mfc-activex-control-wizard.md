...
The latest version of this topic can be found at [Control Settings, MFC ActiveX Control Wizard](https://docs.microsoft.com/cpp/mfc/reference/control-settings-mfc-activex-control-wizard).  
