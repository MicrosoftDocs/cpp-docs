...
The latest version of this topic can be found at [User Interface Features, MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/reference/user-interface-features-mfc-application-wizard).  
