...
The latest version of this topic can be found at [CMFCDropDownToolbarButton Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcdropdowntoolbarbutton-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_VisualStudioDemo#31](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/MainFrm.cpp#31)]  
