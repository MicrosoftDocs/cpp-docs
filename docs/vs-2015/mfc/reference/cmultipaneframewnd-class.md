...
The latest version of this topic can be found at [CMultiPaneFrameWnd Class](https://docs.microsoft.com/cpp/mfc/reference/cmultipaneframewnd-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_SetPaneSize#4](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_SetPaneSize/cpp/MainFrm.cpp#4)]  
