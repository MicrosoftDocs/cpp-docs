...
The latest version of this topic can be found at [CMFCFilterChunkValueImpl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcfilterchunkvalueimpl-class).  
