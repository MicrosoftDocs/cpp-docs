...
The latest version of this topic can be found at [Dispatch Maps](https://docs.microsoft.com/cpp/mfc/reference/dispatch-maps).  
...
### Example  
 [!code-cpp[NVC_MFCAutomation#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAutomation/Cpp/MyServerDoc.h#10)]  
...
|**VT_UNKNOWN**|`LPUNKNOWN`|  
 ...
 [!code-cpp[NVC_MFCAutomation#14](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAutomation/Cpp/MyDlg.cpp#14)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCActiveXControl#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCActiveXControl/Cpp/MFCActiveXControlCtrl.h#9)]  
  
 These correspond to the following `DISP_PROPERTY_PARAM` macro in the control dispatch map:  
  
 [!code-cpp[NVC_MFCActiveXControl#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCActiveXControl/Cpp/MFCActiveXControlCtrl.cpp#10)]  
  
 As another example, consider the following get and set member functions:  
  
 [!code-cpp[NVC_MFCActiveXControl#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCActiveXControl/Cpp/MFCActiveXControlCtrl.h#11)]  
  
 These correspond to the following `DISP_PROPERTY_PARAM` macro in the control dispatch map:  
  
 [!code-cpp[NVC_MFCActiveXControl#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCActiveXControl/Cpp/MFCActiveXControlCtrl.cpp#12)]  
