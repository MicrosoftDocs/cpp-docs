...
The latest version of this topic can be found at [Document Template Strings, MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/reference/document-template-strings-mfc-application-wizard).  
