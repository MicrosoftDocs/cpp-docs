...
The latest version of this topic can be found at [Add Class from Typelib Wizard](https://docs.microsoft.com/cpp/mfc/reference/add-class-from-typelib-wizard).  
