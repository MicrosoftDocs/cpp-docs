...
The latest version of this topic can be found at [CMFCPopupMenuBar Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpopupmenubar-class).  
...
## Example  
 The following example demonstrates how to initialize a `CMFCPopupMenuBar` object from a `CMFCPopupMenu` object. This code snippet is part of the [Draw Client sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_DrawClient#7](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_DrawClient/cpp/mainfrm.cpp#7)]  
