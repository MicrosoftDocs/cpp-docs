...
The latest version of this topic can be found at [Adding an MFC Class from a Type Library](https://docs.microsoft.com/cpp/mfc/reference/adding-an-mfc-class-from-a-type-library).  
