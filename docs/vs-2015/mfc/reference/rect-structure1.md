...
The latest version of this topic can be found at [RECT Structure1](https://docs.microsoft.com/cpp/mfc/reference/rect-structure1).  
...
## Example  
 [!code-cpp[NVC_MFC_Utilities#38](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/NVC_MFC_Utilities.cpp#38)]  
