...
The latest version of this topic can be found at [CRichEditView Class](https://docs.microsoft.com/cpp/mfc/reference/cricheditview-class).  
...
### Example  
 [!code-cpp[NVC_MFCDocView#151](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#151)]  
...
### Remarks  
 For more information, see the [EM_GETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb788026) message and the [CHARFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787883) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCDocView#152](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#152)]  
...
### Return Value  
 An `HRESULT` value reporting the success of the operation. For more information on `HRESULT`, see [Structure of COM Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IRichEditOle::GetClipboardData](http://msdn.microsoft.com/library/windows/desktop/bb774341), [IRichEditOleCallback::GetClipboardData](http://msdn.microsoft.com/library/windows/desktop/bb774315), and [CHARRANGE](http://msdn.microsoft.com/library/windows/desktop/bb787885) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] and see [IDataObject](http://msdn.microsoft.com/library/windows/desktop/ms688421) in the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)].  
...
- `SEL_MULTIOBJECT` Indicates that the current selection contains more than one OLE object.  
 ...
 For more information, see [IRichEditOleCallback::GetContextMenu](http://msdn.microsoft.com/library/windows/desktop/bb774317) and [CHARRANGE](http://msdn.microsoft.com/library/windows/desktop/bb787885) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCDocView#153](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#153)]  
...
### Remarks  
 For more information, see [EM_GETPARAFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774182) message and [PARAFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787942) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCDocView#154](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#154)]  
...
### Remarks  
 `GetTextLengthEx` provides additional ways of determining the length of the text. It supports the Rich Edit 2.0 functionality. For more information, see [About Rich Edit Controls](http://msdn.microsoft.com/library/windows/desktop/bb787873) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information on `HRESULT`, see [Structure of COM Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information on the `dwMask` and `dwEffect` parameters and their potential values, see the corresponding data members of [CHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb787881) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCDocView#155](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#155)]  
...
### Remarks  
 ...
 For more information, see [IStorage](http://msdn.microsoft.com/library/windows/desktop/aa380015) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCDocView#156](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#156)]  
...
### Remarks  
 ...
 For more information, see [MessageBeep](http://msdn.microsoft.com/library/windows/desktop/ms680356) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCDocView#157](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#157)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#158](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#158)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#159](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#159)]  
...
### Remarks  
 ...
 For more information on `HRESULT` and `IDataObject`, see [Structure of COM Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) and [IDataObject](http://msdn.microsoft.com/library/windows/desktop/ms688421), respectively, in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCDocView#160](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#160)]  
...
### Remarks  
 ...
 For more information, see [EM_SETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774230) message and [CHARFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787883) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCDocView#161](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#161)]  
...
### Remarks  
 ...
 For more information, see [EM_SETPARAFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774276) message and [PARAFORMAT2](http://msdn.microsoft.com/library/windows/desktop/bb787942) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCDocView#162](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#162)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#163](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#163)]  
