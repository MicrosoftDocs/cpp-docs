...
The latest version of this topic can be found at [Structures, Styles, Callbacks, and Message Maps](https://docs.microsoft.com/cpp/mfc/reference/structures-styles-callbacks-and-message-maps).  
