...
The latest version of this topic can be found at [DHTML Event Maps](https://docs.microsoft.com/cpp/mfc/reference/dhtml-event-maps).  
...
### Example  
 [!code-cpp[NVC_MFCDocView#196](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyMultiPageDlg.cpp#196)]  
