...
The latest version of this topic can be found at [CButton Class](https://docs.microsoft.com/cpp/mfc/reference/cbutton-class).  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#6)]  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#7)]  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#8)]  
...
### Remarks  
 This member function emulates the functionality of the **BCM_GETIDEALSIZE** message, as described in the [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the **BCM_GETIMAGELIST** message, as described in the [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method sends the [BCM_GETNOTE](http://msdn.microsoft.com/library/windows/desktop/bb775965) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method sends the [BCM_GETNOTELENGTH](http://msdn.microsoft.com/library/windows/desktop/bb775967) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method initializes the `mask` member of a [BUTTON_SPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775955) structure with the `BCSIF_GLYPH` flag, and then sends that structure in the [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message that is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. When the message function returns, this method retrieves the glyph from the `himlGlyph` member of the structure.  
...
### Remarks  
 ...
 This method sends the [BCM_GETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775969) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CButton#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton/Cpp/ButtonDlg.cpp#9)]  
...
### Remarks  
 This member function emulates the functionality of the **BCM_GETTEXTMARGIN** message, as described in the [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method sends the [BCM_SETDROPDOWNSTATE](http://msdn.microsoft.com/library/windows/desktop/bb775973) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CButton_s1#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton_s1/cpp/CButton_s1Dlg.h#1)]  
  
### Example  
 The following code example sets the state of the split button control to indicate that the drop-down arrow is pushed.  
  
 [!code-cpp[NVC_MFC_CButton_s1#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton_s1/cpp/CButton_s1Dlg.cpp#6)]  
...
### Remarks  
 ...
 This method sends the [BCM_SETSHIELD](http://msdn.microsoft.com/library/windows/desktop/bb775979) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the **BCM_SETIMAGELIST** message, as described in the [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method sends the [BCM_SETNOTE](http://msdn.microsoft.com/library/windows/desktop/bb775977) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CButton_s1#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton_s1/cpp/CButton_s1Dlg.cpp#7)]  
...
### Remarks  
 ...
 This method sends the [BCM_SETSPLITINFO](http://msdn.microsoft.com/library/windows/desktop/bb775981) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CButton_s1#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton_s1/cpp/CButton_s1Dlg.cpp#4)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CButton_s1#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton_s1/cpp/CButton_s1Dlg.cpp#5)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CButton_s1#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CButton_s1/cpp/CButton_s1Dlg.cpp#3)]  
...
### Remarks  
 This member function emulates the functionality of the **BCM_SETTEXTMARGIN** message, as described in the [Buttons](http://msdn.microsoft.com/library/windows/desktop/bb775943) section of the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
