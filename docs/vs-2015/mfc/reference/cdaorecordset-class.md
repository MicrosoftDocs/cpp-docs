...
The latest version of this topic can be found at [CDaoRecordset Class](https://docs.microsoft.com/cpp/mfc/reference/cdaorecordset-class).  
...
-   In a dynaset-type recordset, where the new record is inserted is not guaranteed. This behavior changed with Microsoft Jet 3.0 for reasons of performance and concurrency. If your goal is to make the newly added record the current record, get the bookmark of the last modified record and move to that bookmark:  
 ...
 [!code-cpp[NVC_MFCDatabase#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#1)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCDatabase#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#2)]  
...
- **AFX_DAO_LAST** Find the last location of a matching string.  
 ...
 [!code-cpp[NVC_MFCDatabase#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#3)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCDatabase#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#4)]  
...
>  In certain situations, using `IsFieldNull` can be inefficient, as the following code example illustrates:  
 ...
 [!code-cpp[NVC_MFCDatabase#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#5)]  
...
>  Call this member function only after you have called [Edit](#cdaorecordset__edit) or [AddNew](#cdaorecordset__addnew).  
 ...
 [!code-cpp[NVC_MFCDatabase#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#6)]  
 ...
 [!code-cpp[NVC_MFCDatabase#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#7)]  
...
>  Call this member function only after you have called [Edit](#cdaorecordset__edit) or [AddNew](#cdaorecordset__addnew).  
 ...
 [!code-cpp[NVC_MFCDatabase#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#8)]  
