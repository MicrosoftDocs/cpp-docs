...
The latest version of this topic can be found at [CDaoRelationFieldInfo Structure](https://docs.microsoft.com/cpp/mfc/reference/cdaorelationfieldinfo-structure).  
