...
The latest version of this topic can be found at [COleDispatchDriver Class](https://docs.microsoft.com/cpp/mfc/reference/coledispatchdriver-class).  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerView.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerView.cpp#4)]  
...
### Remarks  
 ...
 For more information about the `LPDISPATCH` type, see [Implementing the IDispatch Interface](http://msdn.microsoft.com/en-us/0e171f7f-0022-4e9b-ac8e-98192828e945) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCOleContainer#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerView.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerView.cpp#6)]  
...
### Parameters  
 ...
 `wFlags`  
 Flags describing the context of the call to **IDispatch::Invoke**. . For a list of possible values, see the `wFlags` parameter in [IDispatch::Invoke](http://msdn.microsoft.com/library/windows/desktop/ms221479\(v=vs.85\).aspx) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information on releasing COM objects, see [Implementing Reference Counting](http://msdn.microsoft.com/library/windows/desktop/ms693431) and [IUnknown::Release](http://msdn.microsoft.com/library/windows/desktop/ms682317) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCOleContainer#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerView.cpp#9)]  
...
### Remarks  
 ...
 For more information, see [IDispatch](http://msdn.microsoft.com/en-us/0e171f7f-0022-4e9b-ac8e-98192828e945) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerView.cpp#8)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerView.cpp#7)]  
