...
The latest version of this topic can be found at [CSinusoidalTransitionFromVelocity Class](https://docs.microsoft.com/cpp/mfc/reference/csinusoidaltransitionfromvelocity-class).  
