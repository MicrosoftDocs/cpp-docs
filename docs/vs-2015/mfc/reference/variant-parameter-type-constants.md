...
The latest version of this topic can be found at [Variant Parameter Type Constants](https://docs.microsoft.com/cpp/mfc/reference/variant-parameter-type-constants).  
