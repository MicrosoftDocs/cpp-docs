...
The latest version of this topic can be found at [CMFCToolTipCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctooltipctrl-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#41](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#41)]  
