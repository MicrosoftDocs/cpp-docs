...
The latest version of this topic can be found at [CPaneContainer Class](https://docs.microsoft.com/cpp/mfc/reference/cpanecontainer-class).  
...
[!code-cpp[NVC_MFC_SetPaneSize#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_SetPaneSize/cpp/MainFrm.cpp#1)]  
