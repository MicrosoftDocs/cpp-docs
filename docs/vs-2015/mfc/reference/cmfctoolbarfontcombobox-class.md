...
The latest version of this topic can be found at [CMFCToolBarFontComboBox Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctoolbarfontcombobox-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_WordPad#7](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_WordPad/cpp/formatba.cpp#7)]  
