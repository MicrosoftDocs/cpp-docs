...
The latest version of this topic can be found at [CDialogBar Class](https://docs.microsoft.com/cpp/mfc/reference/cdialogbar-class).  
...
### Example  
 [!code-cpp[NVC_MFCMessageMaps#13](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCMessageMaps/Cpp/MainFrm.cpp#13)]  
