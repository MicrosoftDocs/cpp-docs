...
The latest version of this topic can be found at [CMFCRibbonMiniToolBar Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribbonminitoolbar-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_MSOffice2007Demo#9](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_MSOffice2007Demo/cpp/MSOffice2007DemoView.cpp#9)]  
