...
The latest version of this topic can be found at [CFindReplaceDialog Class](https://docs.microsoft.com/cpp/mfc/reference/cfindreplacedialog-class).  
...
## Remarks  
 ...
 Use the [m_fr](#cfindreplacedialog__m_fr) structure to initialize the dialog box before calling **Create**. The `m_fr` structure is of type [FINDREPLACE](http://msdn.microsoft.com/library/windows/desktop/ms646835). For more information on this structure, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 In order for the parent window to be notified of find/replace requests, you must use the Windows [RegisterWindowMessage](http://msdn.microsoft.com/library/windows/desktop/ms644947) function and use the [ON_REGISTERED_MESSAGE](../Topic/ON_REGISTERED_MESSAGE.md) message-map macro in your frame window that handles this registered message.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#170](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#170)]  
...
### Parameters  
 ...
 `dwFlags`  
 One or more flags you can use to customize the settings of the dialog box, combined using the bitwise OR operator. The default value is `FR_DOWN`, which specifies that the search is to proceed in a downward direction. See the [FINDREPLACE](http://msdn.microsoft.com/library/windows/desktop/ms646835) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information on these flags.  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCDocView#171](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.h#171)]  
  
 [!code-cpp[NVC_MFCDocView#172](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#172)]  
  
 [!code-cpp[NVC_MFCDocView#173](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#173)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#69](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#69)]  
...
### Remarks  
 ...
 For more information on this structure, see the **FINDREPLACE** structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
