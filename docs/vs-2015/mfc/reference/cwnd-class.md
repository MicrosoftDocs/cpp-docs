...
The latest version of this topic can be found at [CWnd Class](https://docs.microsoft.com/cpp/mfc/reference/cwnd-class).  
...
|[CWnd::GetNextDlgTabItem](#cwnd__getnextdlgtabitem)|Retrieves the first control with the [WS_TABSTOP](../../mfc/reference/cwnd-class.md#window_styles) style that follows (or precedes) the specified control.|  
...
|[CWnd::OnCharToItem](#cwnd__onchartoitem)|Called by a child list box with the [LBS_WANTKEYBOARDINPUT](../../mfc/reference/cwnd-class.md#list-box_styles) style in response to a [WM_CHAR](#cwnd__onchar) message.|  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::accDoDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318470) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Remarks  
 This function is part of MFC's [Active Accessibility](http://msdn.microsoft.com/library/windows/desktop/dd373592) support.  
  
 Override this function in your `CWnd`-derived class to perform your object's default action. For more information, see [IAccessible::accDoDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318470) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `pvarChild`  
 Receives information identifying the object at the point specified by `xLeft` and `yTop`. See *pvarID* in [IAccessible::accHitTest](http://msdn.microsoft.com/library/windows/desktop/dd318471) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::accHitTest** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::accHitTest](http://msdn.microsoft.com/library/windows/desktop/dd318471) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::accLocation** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Remarks  
 Override this function in your `CWnd`-derived class if you have nonwindowed user interface elements (other than windowless ActiveX controls, which MFC handles).  
  
 For more information, see **IAccessible::accLocation** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `navDir`  
 Specifies the direction to navigate. See `navDir` in [IAccessible::accNavigate](http://msdn.microsoft.com/library/windows/desktop/dd318473) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `varStart`  
 Specifies the starting object. See `varStart` in **IAccessible::accNavigate** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 *pvarEndUpAt*  
 Receives information about the destination user interface object. See *pvarEnd* in **IAccessible::accNavigate** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::accNavigate** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::accNavigate](http://msdn.microsoft.com/library/windows/desktop/dd318473) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `flagsSelect`  
 Specifies how to change the current selection or focus. See `flagsSelect` in [IAccessible::accSelect](http://msdn.microsoft.com/library/windows/desktop/dd318474) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::accSelect** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::accSelect](http://msdn.microsoft.com/library/windows/desktop/dd318474) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [AnimateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632669), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#66](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MDIChildFrame.cpp#66)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCWindowing#67](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.h#67)]  
  
 [!code-cpp[NVC_MFCWindowing#68](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#68)]  
  
 [!code-cpp[NVC_MFCWindowing#69](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#69)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#70](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#70)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_AxDataBinding#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#1)]  
[!code-cpp[NVC_MFC_AxDataBinding#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#2)]  
[!code-cpp[NVC_MFC_AxDataBinding#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#3)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_AxDataBinding#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#1)]  
[!code-cpp[NVC_MFC_AxDataBinding#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#4)]  
[!code-cpp[NVC_MFC_AxDataBinding#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#71](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#71)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#72](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#72)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#73](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#73)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#74](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#74)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#75](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#75)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#76](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#76)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#77](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#77)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#78](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#78)]  
...
### Remarks  
 This member function emulates the functionality of the function [CloseWindow](http://msdn.microsoft.com/library/windows/desktop/ms632678), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#79](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#79)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#80](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#80)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#81](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/CDTPicker.h#81)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#82](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#82)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#83](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#83)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#84](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#84)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#85](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#85)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#86](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#86)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#87](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/Modeless.cpp#87)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#88](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#88)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#89](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#89)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCWindowing#90](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/PenWidthsDlg.cpp#90)]  
...
### Remarks  
 This member function emulates the functionality of the function [DragDetect](http://msdn.microsoft.com/library/windows/desktop/ms646256), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [DrawAnimatedRects](http://msdn.microsoft.com/library/windows/desktop/dd162475), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [DrawCaption](http://msdn.microsoft.com/library/windows/desktop/dd162476), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
>  Some windows, such as [CToolBar](../../mfc/reference/ctoolbar-class.md), provide a built-in implementation of [OnToolHitTest](#cwnd__ontoolhittest).  
 ...
 See [TOOLINFO](http://msdn.microsoft.com/library/windows/desktop/bb760256) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information on this structure.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#91](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#91)]  
  
 [!code-cpp[NVC_MFCWindowing#92](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#92)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#93](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#93)]  
...
### Remarks  
 `ExecuteDlgInit` will use resources bound to the executing module, or resources from other sources. To accomplish this, `ExecuteDlgInit` finds a resource handle by calling `AfxFindResourceHandle`. If your MFC application does not use the shared DLL (MFCx0[U][D].DLL), **AfxFindResourceHandle** calls [AfxGetResourceHandle](../Topic/AfxGetResourceHandle.md), which returns the current resource handle for the executable. If your MFC application that uses MFCx0[U][D].DLL, `AfxFindResourceHandle` traverses the **CDynLinkLibrary** object list of shared and extension DLLs looking for the correct resource handle.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#94](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#94)]  
...
### Remarks  
 This member function emulates the functionality of the function [FindWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms633500), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#95](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/PenWidthsDlg.cpp#95)]  
...
### Remarks  
 This method emulates the functionality of the function [FlashWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms679347), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accChild](http://msdn.microsoft.com/library/windows/desktop/dd318475) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accChild](http://msdn.microsoft.com/library/windows/desktop/dd318475) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accChildCount](http://msdn.microsoft.com/library/windows/desktop/dd318476) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accChildCount](http://msdn.microsoft.com/library/windows/desktop/dd318476) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318477) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accDefaultAction](http://msdn.microsoft.com/library/windows/desktop/dd318477) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accDescription](http://msdn.microsoft.com/library/windows/desktop/dd318478) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accDescription](http://msdn.microsoft.com/library/windows/desktop/dd318478) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `pvarChild`  
 Receives information about the object that has the focus. See *pvarID* in [IAccessible::get_accFocus](http://msdn.microsoft.com/library/windows/desktop/dd318479) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::get_accFocus** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accFocus](http://msdn.microsoft.com/library/windows/desktop/dd318479) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accHelp](http://msdn.microsoft.com/library/windows/desktop/dd318480) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accHelp](http://msdn.microsoft.com/library/windows/desktop/dd318480) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `pidTopic`  
 Identifies the Help file topic associated with the specified object. See `pidTopic` in [IAccessible::get_accHelpTopic](http://msdn.microsoft.com/library/windows/desktop/dd318481) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::get_accHelpTopic** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accHelpTopic](http://msdn.microsoft.com/library/windows/desktop/dd318481) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accKeyboardShortcut](http://msdn.microsoft.com/library/windows/desktop/dd318482) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accKeyboardShortcut](http://msdn.microsoft.com/library/windows/desktop/dd318482) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accName](http://msdn.microsoft.com/library/windows/desktop/dd318483) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accName](http://msdn.microsoft.com/library/windows/desktop/dd318483) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accParent](http://msdn.microsoft.com/library/windows/desktop/dd318484) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accParent](http://msdn.microsoft.com/library/windows/desktop/dd318484) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `pvarRole`  
 Receives the role information. See `pvarRole` in [IAccessible::get_accRole](http://msdn.microsoft.com/library/windows/desktop/dd318485) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::get_accRole** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accRole](http://msdn.microsoft.com/library/windows/desktop/dd318485) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `pvarChildren`  
 Receives information about which children are selected. See `pvarChildren` in [IAccessible::get_accSelection](http://msdn.microsoft.com/library/windows/desktop/dd318486) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::get_accSelection** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accSelection](http://msdn.microsoft.com/library/windows/desktop/dd318486) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `pvarState`  
 Receives information about the object's state. See `pvarState` in [IAccessible::get_accState](http://msdn.microsoft.com/library/windows/desktop/dd318487) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in **IAccessible::get_accState** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accState](http://msdn.microsoft.com/library/windows/desktop/dd318487) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Returns S_OK on success, a COM error code on failure. See **Return Values** in [IAccessible::get_accValue](http://msdn.microsoft.com/library/windows/desktop/dd318488) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IAccessible::get_accValue](http://msdn.microsoft.com/library/windows/desktop/dd318488) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetAncestor](http://msdn.microsoft.com/library/windows/desktop/ms633502), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#96](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#96)]  
...
### Remarks  
 ...
 For more information about these characteristics, see the description of the **WNDCLASS** structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#97](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#97)]  
...
### Example  
 [!code-cpp[NVC_MFC_AxDataBinding#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#1)]  
[!code-cpp[NVC_MFC_AxDataBinding#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#5)]  
[!code-cpp[NVC_MFC_AxDataBinding#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxDataBinding/Cpp/MyDlg.cpp#3)]  
...
### Remarks  
 This member function emulates the functionality of the function [GetLayeredWindowAttributes](http://msdn.microsoft.com/library/windows/desktop/ms633508), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#98](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#98)]  
...
### Remarks  
 This member function emulates the functionality of the function [GetMenuBarInfo](http://msdn.microsoft.com/library/windows/desktop/ms647833), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 See the Return Values section in [GetParent](http://msdn.microsoft.com/library/windows/desktop/ms633510) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetScrollBarInfo](http://msdn.microsoft.com/library/windows/desktop/bb787581), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
- **SB_VERT** Retrieves the parameters for the window's standard vertical scroll bar.  
 ...
 `lpScrollInfo`  
 A pointer to a [SCROLLINFO](http://msdn.microsoft.com/library/windows/desktop/bb787537) structure. See the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information about this structure.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#99](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#99)]  
...
### Remarks  
 This member function emulates the functionality of the function [GetTitleBarInfo](http://msdn.microsoft.com/library/windows/desktop/ms633513), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetWindowInfo](http://msdn.microsoft.com/library/windows/desktop/ms633516), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the `uCommand` parameter described in the HTML Help API Reference in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 ...
 [!code-cpp[NVC_MFCWindowing#100](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#100)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#101](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#101)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#102](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#102)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#103](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#103)]  
...
### Return Value  
 This method utilizes the [MessageBox](http://msdn.microsoft.com/library/windows/desktop/ms645505) function as defined in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This method returns the result of calling this function.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#104](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#104)]  
...
### Remarks  
 Styles to be added or removed can be combined by using the bitwise OR (&#124;) operator. See the topics [Window Styles](http://msdn.microsoft.com/library/windows/desktop/ms632600) and [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for information about the available window styles.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#105](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyView.cpp#105)]  
...
### Remarks  
 Styles to be added or removed can be combined by using the bitwise OR (&#124;) operator. See the topics [Extended Window Styles](../../mfc/reference/extended-window-styles.md) in this book and [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for information about the available extended styles  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#106](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#106)]  
...
### Remarks  
 This member function emulates the functionality of the function [NotifyWinEvent](http://msdn.microsoft.com/library/windows/desktop/dd373603), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_APPCOMMAND](http://msdn.microsoft.com/library/windows/desktop/ms646275) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 See the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for information on the `ReleaseCapture` Windows function.  
...
### Remarks  
 This member function emulates the functionality of the [WM_CHANGEUISTATE](http://msdn.microsoft.com/library/windows/desktop/ms646342) message, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_DWMNCRENDERINGCHANGED](http://msdn.microsoft.com/library/windows/desktop/dd388198) notification message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_DWMCOMPOSITIONCHANGED](http://msdn.microsoft.com/library/windows/desktop/dd388199) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#107](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/PenWidthsDlg.cpp#107)]  
...
### Remarks  
 This method receives the [WM_ENTERSIZEMOVE](http://msdn.microsoft.com/library/windows/desktop/ms632622) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_EXITSIZEMOVE](http://msdn.microsoft.com/library/windows/desktop/ms632623) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_HOTKEY](http://msdn.microsoft.com/library/windows/desktop/ms646279) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This message is placed at the top of the message queue associated with the thread that registered the hot key. Use the [RegisterHotKey](http://msdn.microsoft.com/library/windows/desktop/ms646309) function to register a system-wide hot key.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#108](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#108)]  
...
### Remarks  
 This method receives the [WM_INPUT_DEVICE_CHANGE](http://msdn.microsoft.com/library/windows/desktop/ms645591) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The is a generic input device message.  
...
### Remarks  
 This method receives the [WM_INPUTLANGCHANGE](http://msdn.microsoft.com/library/windows/desktop/ms632629) notification message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_INPUTLANGCHANGEREQUEST](http://msdn.microsoft.com/library/windows/desktop/ms632630) notification message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This message is posted when the user chooses a new input language with either a hotkey that is specified in the keyboard control panel application, or from the indicator on the system taskbar.  
...
### Remarks  
 This method receives the [WM_MENUDRAG](http://msdn.microsoft.com/library/windows/desktop/ms647606) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_MENUGETOBJECT](http://msdn.microsoft.com/library/windows/desktop/ms647607) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_MENURBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms647610) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The [WM_MENURBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms647610) message enables an application to provide a context-sensitive menu for the menu item specified in the message.  
...
### Example  
 [!code-cpp[NVC_MFCAxCtl#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAxCtl/Cpp/MyAxCtrl.cpp#9)]  
...
### Remarks  
 This method receives the [WM_MOUSEHOVER](http://msdn.microsoft.com/library/windows/desktop/ms645613) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_MOUSEHWHEEL](http://msdn.microsoft.com/library/windows/desktop/ms645614) notification message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This message is sent to the window that has the focus when the mouse's horizontal scroll wheel is tilted or rotated.  
...
### Remarks  
 This method receives the [WM_MOUSELEAVE](http://msdn.microsoft.com/library/windows/desktop/ms645615) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_NCMOUSEHOVER](http://msdn.microsoft.com/library/windows/desktop/ms645625) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_NCMOUSELEAVE](http://msdn.microsoft.com/library/windows/desktop/ms645626) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_DWMNCRENDERINGCHANGED](http://msdn.microsoft.com/library/windows/desktop/dd388200) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_XBUTTONDBLCLK](http://msdn.microsoft.com/library/windows/desktop/ms646244) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This message is posted to the window that contains the cursor. If a window has captured the mouse, this message is not posted.  
...
### Remarks  
 This method receives the [WM_NCXBUTTONDOWN](http://msdn.microsoft.com/library/windows/desktop/ms645632) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This message is posted to the window that contains the cursor. If a window has captured the mouse, this message is not posted.  
...
### Remarks  
 This method receives the [WM_NCXBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms646240) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This message is posted to the window that contains the cursor. If a window has captured the mouse, this message is not posted.  
...
### Remarks  
 This method receives the [WM_UNINITMENUPOPUP](http://msdn.microsoft.com/library/windows/desktop/ms647614) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. In response to this message, your application can set the `hmenuNext` member of the [MDINEXTMENU](http://msdn.microsoft.com/library/windows/desktop/ms647561) structure to specify the menu to switch to, and the `hwndNext` member to specify the window to receive menu notification messages.  
...
### Remarks  
 This method receives the [WM_NOTIFYFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb775584) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. **WM_NOTIFY** messages are sent from a common control to its parent window, and from the parent window to the common control.  
...
### Remarks  
 ...
 For more information about using **WM_Paint**, see the following topics in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]:  
...
### Remarks  
 This method receives the [WM_POWERBROADCAST](http://msdn.microsoft.com/library/windows/desktop/aa373247) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the [WM_QUERYUISTATE](http://msdn.microsoft.com/library/windows/desktop/ms646355) message, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_INPUT](http://msdn.microsoft.com/library/windows/desktop/ms646275) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_WTSSESSION_CHANGE](http://msdn.microsoft.com/library/aa383828) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `uFlags`  
 When the system sends the message as a result of a **SystemParametersInfo** call, this parameter is a flag that indicates the system parameter that was changed. For a list of values, see [SystemParametersInfo](http://msdn.microsoft.com/library/windows/desktop/ms724947) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. When an application sends the message, this parameter must be 0.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#109](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#109)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#110](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/SplitChildFrm.cpp#110)]  
...
### Remarks  
 ...
 See [TOOLINFO](http://msdn.microsoft.com/library/windows/desktop/bb760256), in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)], for more information about the structure.  
...
### Remarks  
 This method receives the [WM_UNICHAR](http://msdn.microsoft.com/library/windows/desktop/ms646288) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The [WM_UNICHAR](http://msdn.microsoft.com/library/windows/desktop/ms646288) message is designed to send or post Unicode characters to ANSI windows. It is equivalent to the [WM_CHAR](http://msdn.microsoft.com/library/windows/desktop/ms646276) message, but uses Unicode Transformation Format-32 encoding (UTF-32), whereas the [WM_CHAR](http://msdn.microsoft.com/library/windows/desktop/ms646276) message uses UTF-16.  
...
### Remarks  
 This method receives the [WM_UNINITMENUPOPUP](http://msdn.microsoft.com/library/windows/desktop/ms647614) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the [WM_UPDATEUISTATE](http://msdn.microsoft.com/library/windows/desktop/ms646361) message, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_USERCHANGED](http://msdn.microsoft.com/library/windows/desktop/ms632651) notification message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. When the user logs on or off, the operating system updates user-specific settings. The system sends this message immediately after updating the settings.  
...
### Remarks  
 This method receives the [WM_DWMWINDOWMAXIMIZEDCHANGE](http://msdn.microsoft.com/library/windows/desktop/dd388201) notification message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method receives the [WM_XBUTTONDBLCLK](http://msdn.microsoft.com/library/windows/desktop/ms646244) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. If the mouse is not captured, the message is posted to the window beneath the cursor. Otherwise, the message is posted to the window that has captured the mouse.  
...
### Remarks  
 This method receives the [WM_XBUTTONDOWN](http://msdn.microsoft.com/library/windows/desktop/ms646245) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. If the mouse is not captured, the message is posted to the window beneath the cursor. Otherwise, the message is posted to the window that has captured the mouse.  
...
### Remarks  
 This method receives the [WM_XBUTTONUP](http://msdn.microsoft.com/library/windows/desktop/ms646246) notification, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. If the mouse is not captured, the message is posted to the window beneath the cursor. Otherwise, the message is posted to the window that has captured the mouse.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#111](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#111)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#112](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MDIChildFrame.cpp#112)]  
...
### Remarks  
 This member function emulates the functionality of the function [PrintWindow](http://msdn.microsoft.com/library/windows/desktop/dd162869), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#113](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#113)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#114](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#114)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#115](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyView.cpp#115)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#116](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#116)]  
...
### Remarks  
 This member function emulates the functionality of the function [SetLayeredWindowAttributes](http://msdn.microsoft.com/library/windows/desktop/ms633540), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#117](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#117)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCWindowing#118](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#118)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#119](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#119)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#120](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#120)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#121](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#121)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#122](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#122)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#123](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MyDlg.cpp#123)]  
...
##  <a name="cwnd__updatedialogcontrols"></a>  CWnd::UpdateDialogControls  
 Call this member function to update the state of dialog buttons and other controls in a dialog box or window that uses the [ON_UPDATE_COMMAND_UI](../Topic/ON_UPDATE_COMMAND_UI.md) callback mechanism.  
...
### Remarks  
 This member function emulates the functionality of the function [UpdateLayeredWindow](http://msdn.microsoft.com/library/windows/desktop/ms633556), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#124](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#124)]  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the [WinHelp](http://msdn.microsoft.com/library/windows/desktop/bb762267) Windows function in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
