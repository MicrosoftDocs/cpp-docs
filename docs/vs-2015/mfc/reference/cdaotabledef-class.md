...
The latest version of this topic can be found at [CDaoTableDef Class](https://docs.microsoft.com/cpp/mfc/reference/cdaotabledef-class).  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCDatabase#34](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDaoDatabaseDoc.cpp#34)]  
