...
The latest version of this topic can be found at [CWindowDC Class](https://docs.microsoft.com/cpp/mfc/reference/cwindowdc-class).  
...
### Example  
 [!code-cpp[NVC_MFCDocView#188](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#188)]  
