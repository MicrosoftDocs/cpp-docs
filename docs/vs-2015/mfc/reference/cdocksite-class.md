...
The latest version of this topic can be found at [CDockSite Class](https://docs.microsoft.com/cpp/mfc/reference/cdocksite-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#27](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#27)]  
