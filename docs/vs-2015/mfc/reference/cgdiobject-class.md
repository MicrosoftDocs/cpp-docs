...
The latest version of this topic can be found at [CGdiObject Class](https://docs.microsoft.com/cpp/mfc/reference/cgdiobject-class).  
...
### Parameters  
 `nIndex`  
 A constant specifying the type of stock object desired. See the parameter *fnObject* for [GetStockObject](http://msdn.microsoft.com/library/windows/desktop/dd144925) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a description of appropriate values.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#175](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MainFrm.cpp#175)]  
