...
The latest version of this topic can be found at [CAnimationTimerEventHandler Class](https://docs.microsoft.com/cpp/mfc/reference/canimationtimereventhandler-class).  
