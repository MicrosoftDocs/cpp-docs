...
The latest version of this topic can be found at [CMFCPropertyGridFontProperty Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpropertygridfontproperty-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_NewControls#26](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.cpp#26)]  
