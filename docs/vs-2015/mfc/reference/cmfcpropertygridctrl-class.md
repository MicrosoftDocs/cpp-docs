...
The latest version of this topic can be found at [CMFCPropertyGridCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpropertygridctrl-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_NewControls#14](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.h#14)]  
[!code-cpp[NVC_MFC_NewControls#16](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.cpp#16)]  
[!code-cpp[NVC_MFC_NewControls#20](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.cpp#20)]  
[!code-cpp[NVC_MFC_NewControls#21](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.cpp#21)]  
[!code-cpp[NVC_MFC_NewControls#24](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.cpp#24)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_NewControls#15](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.cpp#15)]  
...
##  <a name="cmfcpropertygridctrl__isvsdotnetlook"></a>  CMFCPropertyGridCtrl::IsVSDotNetLook  
 Indicates whether the appearance of the property grid control is in the style of [!INCLUDE[vsprvslong](../../includes/vsprvslong-md.md)].  
...
### Return Value  
 `TRUE` if the property grid control is in the style of [!INCLUDE[vsprvslong](../../includes/vsprvslong-md.md)]; otherwise, `FALSE`.  
  
### Remarks  
 Use the [CMFCPropertyGridCtrl::SetVSDotNetLook](#cmfcpropertygridctrl__setvsdotnetlook) method to set the property grid control to the style of [!INCLUDE[vsprvslong](../../includes/vsprvslong-md.md)].  
...
##  <a name="cmfcpropertygridctrl__setvsdotnetlook"></a>  CMFCPropertyGridCtrl::SetVSDotNetLook  
 Sets the appearance of the property grid control to the style that is used in [!INCLUDE[vsprvslong](../../includes/vsprvslong-md.md)].  
...
### Parameters  
 [in] `bSet`  
 `TRUE` to set the property grid control to the style that is used in [!INCLUDE[vsprvslong](../../includes/vsprvslong-md.md)]; otherwise, `FALSE`. The default value is `TRUE`.  
