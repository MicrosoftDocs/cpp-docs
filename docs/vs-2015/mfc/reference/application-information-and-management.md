...
The latest version of this topic can be found at [Application Information and Management](https://docs.microsoft.com/cpp/mfc/reference/application-information-and-management).  
 ...
 *pParam*  
 ...
 `nPriority`  
 The desired priority of the thread. For a full list and description of the available priorities, see [SetThreadPriority](http://msdn.microsoft.com/library/windows/desktop/ms686277) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#126](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#126)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#127](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#127)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#128](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#128)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#129](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#129)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#130](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#130)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#132](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#132)]  
...
### Example  
 [!code-cpp[NVC_MFC_DLLUser#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_DLLUser/Cpp/NVC_MFC_DLLUser.cpp#1)]  
[!code-cpp[NVC_MFC_DLLUser#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_DLLUser/Cpp/NVC_MFC_DLLUser.cpp#2)]  
[!code-cpp[NVC_MFC_DLLUser#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_DLLUser/Cpp/NVC_MFC_DLLUser.cpp#3)]  
...
### Parameters  
 *lpWndClass*  
 Pointer to a [WNDCLASS](http://msdn.microsoft.com/library/windows/desktop/ms633576) structure containing information about the window class to be registered. For more information on this structure, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_DLL#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_DLL/Cpp/NVC_MFC_DLL.cpp#3)]  
...
### Parameters  
 *nClassStyle*  
 Specifies the Windows class style or combination of styles, created by using the bitwise-OR ( **&#124;**) operator, for the window class. For a list of class styles, see the [WNDCLASS](http://msdn.microsoft.com/library/windows/desktop/ms633576) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. If **NULL**, the defaults will be set as follows:  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#134](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#134)]  
...
### Remarks  
 Before [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)], applications that access the registry usually use the **HKEY_CLASSES_ROOT** node. However, with [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)], you must run an application in elevated mode to write to **HKCR**.  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#135](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#135)]  
...
### Example  
 [!code-cpp[NVC_MFC_AfxWinInit#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AfxWinInit/Cpp/NVC_MFC_AfxWinInit.cpp#1)]  
