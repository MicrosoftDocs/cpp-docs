...
The latest version of this topic can be found at [Creating a Forms-Based MFC Application](https://docs.microsoft.com/cpp/mfc/reference/creating-a-forms-based-mfc-application).  
