...
The latest version of this topic can be found at [CCachedDataPathProperty Class](https://docs.microsoft.com/cpp/mfc/reference/ccacheddatapathproperty-class).  
