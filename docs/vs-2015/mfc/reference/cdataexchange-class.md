...
The latest version of this topic can be found at [CDataExchange Class](https://docs.microsoft.com/cpp/mfc/reference/cdataexchange-class).  
...
### Example  
 [!code-cpp[NVC_MFCControlLadenDialog#70](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/TestDialog.cpp#70)]  
