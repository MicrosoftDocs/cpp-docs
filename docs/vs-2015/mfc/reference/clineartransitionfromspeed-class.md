...
The latest version of this topic can be found at [CLinearTransitionFromSpeed Class](https://docs.microsoft.com/cpp/mfc/reference/clineartransitionfromspeed-class).  
