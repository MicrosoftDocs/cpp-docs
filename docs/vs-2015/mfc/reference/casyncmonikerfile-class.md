...
The latest version of this topic can be found at [CAsyncMonikerFile Class](https://docs.microsoft.com/cpp/mfc/reference/casyncmonikerfile-class).  
...
### Remarks  
 ...
 For a description of the `IBindHost` interface, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 Retrieves the settings for **IBindStatusCallBack**. For a description of the `IBindStatusCallback` interface, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For a description of the `IBinding` interface, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWinInet#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/MyMoniker.cpp#5)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCWinInet#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/MFCWinInet.cpp#6)]  
  
 – or –  
  
 [!code-cpp[NVC_MFCWinInet#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/MFCWinInet.cpp#7)]  
