...
The latest version of this topic can be found at [CMenuTearOffManager Class](https://docs.microsoft.com/cpp/mfc/reference/cmenutearoffmanager-class).  
...
## Example  
 The following example demonstrates how to construct and initialize a `CMenuTearOffManager` object by calling the `CWinAppEX::EnableTearOffMenus` method. This code snippet is part of the [Word Pad sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_WordPad#12](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_WordPad/cpp/wordpad.cpp#12)]  
