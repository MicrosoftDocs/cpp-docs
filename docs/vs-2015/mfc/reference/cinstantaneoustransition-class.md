...
The latest version of this topic can be found at [CInstantaneousTransition Class](https://docs.microsoft.com/cpp/mfc/reference/cinstantaneoustransition-class).  
