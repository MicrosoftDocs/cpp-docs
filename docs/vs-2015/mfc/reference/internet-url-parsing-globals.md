...
The latest version of this topic can be found at [Internet URL Parsing Globals and Helpers](https://docs.microsoft.com/cpp/mfc/reference/internet-url-parsing-globals).  
