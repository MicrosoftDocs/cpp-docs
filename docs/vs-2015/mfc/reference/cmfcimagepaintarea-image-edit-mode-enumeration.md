...
The latest version of this topic can be found at [CMFCImagePaintArea::IMAGE_EDIT_MODE Enumeration](https://docs.microsoft.com/cpp/mfc/reference/cmfcimagepaintarea-image-edit-mode-enumeration).  
