...
The latest version of this topic can be found at [Document Template Strings, MFC Add Class Wizard](https://docs.microsoft.com/cpp/mfc/reference/document-template-strings-mfc-add-class-wizard).  
