...
The latest version of this topic can be found at [CView Class](https://docs.microsoft.com/cpp/mfc/reference/cview-class).  
...
- `DROPEFFECT_SCROLL` Indicates that a drag scroll operation is about to occur or is occurring in the target.  
 ...
 For more information on setting the default menu command, see [SetMenuDefaultItem](http://msdn.microsoft.com/library/windows/desktop/ms647996) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] and [CMenu::GetSafeHmenu](../../mfc/reference/cmenu-class.md#cmenu__getsafehmenu) in this volume.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#183](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#183)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDocView#184](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyEditView.cpp#184)]  
 ...
 [!code-cpp[NVC_MFCDocView#185](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/ExampleView.cpp#185)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDocView#186](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#186)]  
