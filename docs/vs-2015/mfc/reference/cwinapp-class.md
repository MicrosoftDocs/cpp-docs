...
The latest version of this topic can be found at [CWinApp Class](https://docs.microsoft.com/cpp/mfc/reference/cwinapp-class).  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#35](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#35)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#36](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#36)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#37](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#37)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#38](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#38)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#39](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#39)]  
...
### Remarks  
 ...
 This method returns `NULL` on operating systems earlier than [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)]. The restart manager is not supported on operating systems earlier than [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#40](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#40)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#41](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#41)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#42](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#42)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#43](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#43)]  
...
### Parameters  
 ...
 `nCmd`  
 Specifies the type of help requested. For a list of possible values and how they affect the `dwData` parameter, see the `uCommand` parameter described in About the HTMLHelp API Function in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCListView#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCListView/Cpp/MFCListView.cpp#9)]  
...
### Parameters  
 ...
 `nIDResource`  
 ID of the cursor resource. For a list of resources, see [LoadCursor](http://msdn.microsoft.com/library/windows/desktop/ms648391) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#44](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#44)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#45](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/stdafx.h#45)]  
  
 [!code-cpp[NVC_MFCWindowing#46](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#46)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#47](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#47)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#55](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#55)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#52](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#52)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#56](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#56)]  
...
>  If you assign a value to `m_pszAppName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code-cpp[NVC_MFCWindowing#57](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#57)]  
  
### Example  
 [!code-cpp[NVC_MFCWindowing#65](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#65)]  
...
>  If you assign a value to `m_pszExeName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code-cpp[NVC_MFCWindowing#58](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#58)]  
...
>  If you assign a value to `m_pszHelpFilePath`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code-cpp[NVC_MFCWindowing#59](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#59)]  
...
>  If you assign a value to `m_pszProfileName`, it must be dynamically allocated on the heap. The `CWinApp` destructor calls **free**( ) with this pointer. You many want to use the `_tcsdup`( ) run-time library function to do the allocating. Also, free the memory associated with the current pointer before assigning a new value. For example:  
 ...
 [!code-cpp[NVC_MFCWindowing#60](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#60)]  
...
-   The value is stored to a registry key. The name for the application profile setting is appended to the following registry key: HKEY_CURRENT_USER/Software/LocalAppWizard-Generated/.  
 ...
 [!code-cpp[NVC_MFCWindowing#61](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#61)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#48](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#48)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#49](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/StdApp.cpp#49)]  
  
 [!code-cpp[NVC_MFCWindowing#50](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/CustomApp.cpp#50)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCWindowing#51](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/NVC_MFCWindowing.cpp#51)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#53](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#53)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCWindowing#54](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#54)]  
