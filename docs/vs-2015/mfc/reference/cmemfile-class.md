...
The latest version of this topic can be found at [CMemFile Class](https://docs.microsoft.com/cpp/mfc/reference/cmemfile-class).  
...
### Example  
 [!code-cpp[NVC_MFCFiles#36](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCFiles/Cpp/MFCFiles.cpp#36)]  
