...
The latest version of this topic can be found at [CMFCRibbonQuickAccessToolBarDefaultState Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribbonquickaccesstoolbardefaultstate-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#21](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#21)]  
