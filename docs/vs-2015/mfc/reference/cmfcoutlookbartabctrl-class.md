...
The latest version of this topic can be found at [CMFCOutlookBarTabCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcoutlookbartabctrl-class).  
...
### Example  
 The following example demonstrates how to use the `AddControl` method in the `CMFCOutlookBarTabCtrl` class. This code snippet is part of the [Outlook Demo sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_OutlookDemo#3](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_OutlookDemo/cpp/MainFrm.cpp#3)]  
