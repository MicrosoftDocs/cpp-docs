...
The latest version of this topic can be found at [CMFCPrintPreviewToolBar Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcprintpreviewtoolbar-class).  
