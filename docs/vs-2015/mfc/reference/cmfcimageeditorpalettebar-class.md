...
The latest version of this topic can be found at [CMFCImageEditorPaletteBar Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcimageeditorpalettebar-class).  
