...
The latest version of this topic can be found at [BITMAPINFO Structure](https://docs.microsoft.com/cpp/mfc/reference/bitmapinfo-structure).  
...
## Remarks  
 ...
 For more information about the `BITMAPINFO` structure and appropriate values for members of the `BITMAPINFOHEADER` and `RGBQUAD` structures, see the following topics in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] documentation.  
