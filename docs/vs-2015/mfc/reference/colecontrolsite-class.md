...
The latest version of this topic can be found at [COleControlSite Class](https://docs.microsoft.com/cpp/mfc/reference/colecontrolsite-class).  
...
### Parameters  
 ...
 `wFlags`  
 Flags describing the context of the call to IDispatch::Invoke. For possible `wFlags` values, see `IDispatch::Invoke` in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see [OLEMISC](http://msdn.microsoft.com/library/windows/desktop/ms678497)in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `nFlags`  
 Window positioning flags. For a list of possible values, see the [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) function in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
 ...
 *y*  
 ...
 `nFlags`  
 Specifies the window sizing and positioning flags. For possible values, see the Remarks section for [SetWindowPos](http://msdn.microsoft.com/library/windows/desktop/ms633545) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
