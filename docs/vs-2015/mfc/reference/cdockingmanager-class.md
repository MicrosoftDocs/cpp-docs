...
The latest version of this topic can be found at [CDockingManager Class](https://docs.microsoft.com/cpp/mfc/reference/cdockingmanager-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_VisualStudioDemo#24](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/MainFrm.cpp#24)]  
