...
The latest version of this topic can be found at [CMFCImagePaintArea Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcimagepaintarea-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#37](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#37)]  
