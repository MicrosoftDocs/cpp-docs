...
The latest version of this topic can be found at [CInternetException Class](https://docs.microsoft.com/cpp/mfc/reference/cinternetexception-class).  
...
### Remarks  
 ...
 For a list of Win32 error codes, see [Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms681381). For a list of Internet-specific error messages, see  . Both topics are in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
