...
The latest version of this topic can be found at [CReBar Class](https://docs.microsoft.com/cpp/mfc/reference/crebar-class).  
...
### Example  
 [!code-cpp[NVC_MFC_CReBarCtrl#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CReBarCtrl/Cpp/RebarDlg.cpp#1)]  
...
### Parameters  
 ...
 `dwCtrlStyle`  
 The rebar control style. By default, **RBS_BANDBORDERS**, which displays narrow lines to separate adjacent bands within the rebar control. See [Rebar Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb774377) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of styles.  
...
### Example  
 [!code-cpp[NVC_MFC_CReBarCtrl#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CReBarCtrl/Cpp/RebarDlg.cpp#2)]  
