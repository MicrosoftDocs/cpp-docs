...
The latest version of this topic can be found at [CSocket Class](https://docs.microsoft.com/cpp/mfc/reference/csocket-class).  
...
## Remarks  
 ...
 [!code-cpp[NVC_MFCSocketThread#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSocketThread/Cpp/ChatSocket.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFCSocketThread#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSocketThread/Cpp/SockThread.h#1)]  
  
 [!code-cpp[NVC_MFCSocketThread#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSocketThread/Cpp/SockThread.cpp#2)]  
  
 [!code-cpp[NVC_MFCSocketThread#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSocketThread/Cpp/ListeningSocket.cpp#3)]  
