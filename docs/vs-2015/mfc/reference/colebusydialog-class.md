...
The latest version of this topic can be found at [COleBusyDialog Class](https://docs.microsoft.com/cpp/mfc/reference/colebusydialog-class).  
...
>  Application Wizard-generated container code uses this class.  
 ...
 For more information, see the [OLEUIBUSY](http://msdn.microsoft.com/library/windows/desktop/ms682493) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
