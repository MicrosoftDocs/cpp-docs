...
The latest version of this topic can be found at [CMFCDisableMenuAnimation Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcdisablemenuanimation-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_Misc#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_Misc/cpp/Misc.h#1)]  
