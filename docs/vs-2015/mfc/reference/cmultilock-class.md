...
The latest version of this topic can be found at [CMultiLock Class](https://docs.microsoft.com/cpp/mfc/reference/cmultilock-class).  
 ...
 *dwTimeOut*  
 ...
 `dwWakeMask`  
 Specifies other conditions that are allowed to abort the wait. For a full list of the available options for this parameter, see [MsgWaitForMultipleObjects](http://msdn.microsoft.com/library/windows/desktop/ms684242) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
