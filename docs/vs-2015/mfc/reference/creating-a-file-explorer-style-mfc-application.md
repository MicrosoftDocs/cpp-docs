...
The latest version of this topic can be found at [Creating a File Explorer-Style MFC Application](https://docs.microsoft.com/cpp/mfc/reference/creating-a-file-explorer-style-mfc-application).  
