...
The latest version of this topic can be found at [Mapping Messages to Functions](https://docs.microsoft.com/cpp/mfc/reference/mapping-messages-to-functions).  
