...
The latest version of this topic can be found at [CMFCDesktopAlertWnd Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcdesktopalertwnd-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_DesktopAlertDemo#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_DesktopAlertDemo/cpp/DesktopAlertDemoDlg.cpp#1)]  
