...
The latest version of this topic can be found at [CMFCVisualManager Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcvisualmanager-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_TasksPane#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_TasksPane/cpp/TasksPaneView.h#1)]  
...
##  <a name="cmfcvisualmanager__ondrawsplitterborder"></a>  CMFCVisualManager::OnDrawSplitterBorder  
 The framework calls this method when it draws the border around an instance of the [CSplitterWndEx Class](~/mfc/reference/csplitterwndex-class.md).  
...
##  <a name="cmfcvisualmanager__ondrawsplitterbox"></a>  CMFCVisualManager::OnDrawSplitterBox  
 The framework calls this method when it draws the drag box for an instance of the [CSplitterWndEx Class](~/mfc/reference/csplitterwndex-class.md). The drag box appears when the user selects the splitter bar and changes the dimensions of the child windows.  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_OutlookDemo#4](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_OutlookDemo/cpp/MailBar.cpp#4)]  
...
### Parameters  
 ...
 [in] `pSplitterWnd`  
 A pointer to an instance of the [CSplitterWndEx Class](~/mfc/reference/csplitterwndex-class.md). The framework fills the background for this splitter window.  
