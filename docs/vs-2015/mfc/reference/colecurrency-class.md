...
The latest version of this topic can be found at [COleCurrency Class](https://docs.microsoft.com/cpp/mfc/reference/colecurrency-class).  
...
- `COleCurrency(`Â `nUnits`**,** `nFractionalUnits`Â **)**Â Â Â Constructs a **COleCurrency** object from the specified numerical components. If the absolute value of the fractional part is greater than 10,000, the appropriate adjustment is made to the units. Note that the units and fractional part are specified by signed long values.  
 ...
 For more information, see the [CURRENCY](http://msdn.microsoft.com/en-us/5e81273c-7289-45c7-93c0-32c1553f708e) and [VARIANT](http://msdn.microsoft.com/en-us/e305240e-9e11-4006-98cc-26f4932d2118) entries in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 The following examples show the effects of the zero-parameter and two-parameter constructors:  
  
 [!code-cpp[NVC_MFCOleContainer#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#10)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#11)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#12)]  
...
>  Changing the value in the **CURRENCY** structure accessed by the pointer returned by this function will change the value of this **COleCurrency** object. It does not change the status of this **COleCurrency** object.  
 ...
 For more information, see the [CURRENCY](http://msdn.microsoft.com/en-us/5e81273c-7289-45c7-93c0-32c1553f708e) entry in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#15](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#15)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#16](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#16)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#17](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#17)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#18](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#18)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#19](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#19)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#13](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#13)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#20](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#20)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#14](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/MainFrm.cpp#14)]  
