...
The latest version of this topic can be found at [COleServerDoc Class](https://docs.microsoft.com/cpp/mfc/reference/coleserverdoc-class).  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCOleServer#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleServer/Cpp/MFCOleServerDoc.cpp#3)]  
...
### Remarks  
 ...
 For more information and additional values, see [OLECLOSE](http://msdn.microsoft.com/library/windows/desktop/ms680623) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [IOleInPlaceUIWindow](http://msdn.microsoft.com/library/windows/desktop/ms680716) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
