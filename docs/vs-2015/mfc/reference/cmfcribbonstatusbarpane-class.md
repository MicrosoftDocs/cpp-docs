...
The latest version of this topic can be found at [CMFCRibbonStatusBarPane Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribbonstatusbarpane-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#2)]  
