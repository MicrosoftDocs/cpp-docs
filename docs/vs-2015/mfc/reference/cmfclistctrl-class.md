...
The latest version of this topic can be found at [CMFCListCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfclistctrl-class).  
...
## Example  
 The following example demonstrates how to use various methods in the `CMFCListCtrl` class. The example shows how to create a list control, insert columns, insert items, set the text of an item, and set the font of the list control. This code snippet is part of the [Visual Studio Demo sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_VisualStudioDemo#25](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/WatchBar.h#25)]  
[!code-cpp[NVC_MFC_VisualStudioDemo#26](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/WatchBar.cpp#26)]  
