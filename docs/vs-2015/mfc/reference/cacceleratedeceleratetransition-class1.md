...
The latest version of this topic can be found at [CAccelerateDecelerateTransition Class1](https://docs.microsoft.com/cpp/mfc/reference/cacceleratedeceleratetransition-class1).  
