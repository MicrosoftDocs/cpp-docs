...
The latest version of this topic can be found at [CUserTool Class](https://docs.microsoft.com/cpp/mfc/reference/cusertool-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_VisualStudioDemo#35](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/MainFrm.cpp#35)]  
