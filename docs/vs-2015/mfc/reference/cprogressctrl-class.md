...
The latest version of this topic can be found at [CProgressCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cprogressctrl-class).  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#1)]  
...
### Parameters  
 `dwStyle`  
 Specifies the progress bar control's style. Apply any combination of window stylesdescribed in [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)], in addition to the following progress bar control styles, to the control:  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#2)]  
...
### Parameters  
 ...
 `dwStyle`  
 Specifies the progress bar control's style. Apply any combination of window styles described in [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PBM_GETBARCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760826) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PBM_GETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760828) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#4)]  
...
### Remarks  
 This method sends the [PBM_GETSTATE](http://msdn.microsoft.com/library/windows/desktop/bb760834) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CProgressCtrl_s1#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl_s1/cpp/CProgressCtrl_s1Dlg.h#9)]  
  
### Example  
 The following code example retrieves the state of the current progress bar control.  
  
 [!code-cpp[NVC_MFC_CProgressCtrl_s1#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl_s1/cpp/CProgressCtrl_s1Dlg.cpp#5)]  
...
### Remarks  
 ...
 This method sends the [PBM_GETSTEP](http://msdn.microsoft.com/library/windows/desktop/bb760836) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CProgressCtrl_s1#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl_s1/cpp/CProgressCtrl_s1Dlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#5)]  
...
### Remarks  
 The `SetBarColor` method sets the progress bar color only if a [!INCLUDE[windowsver](../../includes/windowsver-md.md)][theme](https://msdn.microsoft.com/library/windows/desktop/hh270423.aspx) is not in effect.  
  
 This method sends the [PBM_SETBARCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760838) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CProgressCtrl_s1#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl_s1/cpp/CProgressCtrl_s1Dlg.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#6)]  
...
### Remarks  
 ...
 This method sends the [PBM_SETMARQUEE](http://msdn.microsoft.com/library/windows/desktop/bb760842) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CProgressCtrl_s1#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl_s1/cpp/CProgressCtrl_s1Dlg.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#7)]  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#8)]  
...
### Remarks  
 This method sends the [PBM_SETSTATE](http://msdn.microsoft.com/library/windows/desktop/bb760850) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CProgressCtrl_s1#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl_s1/cpp/CProgressCtrl_s1Dlg.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#9)]  
...
### Example  
 [!code-cpp[NVC_MFC_CProgressCtrl#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CProgressCtrl/Cpp/ProgressDlg.cpp#10)]  
