...
The latest version of this topic can be found at [CDaoException Class](https://docs.microsoft.com/cpp/mfc/reference/cdaoexception-class).  
...
### Remarks  
 ...
 For information about `SCODE`, see the topic [Structure of OLE Error Codes](http://msdn.microsoft.com/library/windows/desktop/ms690088) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The `SCODE` data type maps to the `HRESULT` data type.  
