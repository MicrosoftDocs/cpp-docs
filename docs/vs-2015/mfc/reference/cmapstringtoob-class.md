...
The latest version of this topic can be found at [CMapStringToOb Class](https://docs.microsoft.com/cpp/mfc/reference/cmapstringtoob-class).  
...
### Example  
 [!code-cpp[NVC_MFCCollections#63](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#63)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCCollections#64](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#64)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCCollections#65](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#65)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCCollections#66](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#66)]  
...
### Example  
 [!code-cpp[NVC_MFCCollections#67](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#67)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCCollections#68](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#68)]  
...
|[CMapPtrToWord](../Topic/CMapPtrToWord%20Class.md)|**WORD& operator[]( void\*** `key` **\);**|  
|[CMapStringToPtr](../Topic/CMapStringToPtr%20Class.md)|**void\*& operator[]( LPCTSTR** `key` **\);**|  
|[CMapStringToString](../Topic/CMapStringToString%20Class.md)|**CString& operator[]( LPCTSTR** `key` **\);**|  
|[CMapWordToOb](../Topic/CMapWordToOb%20Class.md)|**CObject\*& operator[]( WORD** `key` **\);**|  
|[CMapWordToPtr](../Topic/CMapWordToPtr%20Class.md)|**void\*& operator[]( WORD** `key` **\);**|  
...
### Example  
 ...
 [!code-cpp[NVC_MFCCollections#72](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#72)]  
...
|Class|Member Function|  
|-----------|---------------------|  
|[CMapPtrToPtr](../Topic/CMapPtrToPtr%20Class.md)|**void RemoveAll( );**|  
|[CMapPtrToWord](../Topic/CMapPtrToWord%20Class.md)|**void RemoveAll( );**|  
|[CMapStringToPtr](../Topic/CMapStringToPtr%20Class.md)|**void RemoveAll( );**|  
|[CMapStringToString](../Topic/CMapStringToString%20Class.md)|**void RemoveAll( );**|  
|[CMapWordToOb](../Topic/CMapWordToOb%20Class.md)|**void RemoveAll( );**|  
|[CMapWordToPtr](../Topic/CMapWordToPtr%20Class.md)|**void RemoveAll( );**|  
  
### Example  
 See [CObList::CObList](../Topic/CObList%20Class.md#coblist__coblist) for a listing of the `CAge` class used in all collection examples.  
  
 [!code-cpp[NVC_MFCCollections#69](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#69)]  
...
|Class|Member Function|  
|-----------|---------------------|  
|[CMapPtrToPtr](../Topic/CMapPtrToPtr%20Class.md)|**BOOL RemoveKey( void\*** `key` **);**|  
|[CMapPtrToWord](../Topic/CMapPtrToWord%20Class.md)|**BOOL RemoveKey( void\*** `key` **);**|  
|[CMapStringToPtr](../Topic/CMapStringToPtr%20Class.md)|**BOOL RemoveKey( LPCTSTR** `key` **);**|  
|[CMapStringToString](../Topic/CMapStringToString%20Class.md)|**BOOL RemoveKey( LPCTSTR** `key` **);**|  
|[CMapWordToOb](../Topic/CMapWordToOb%20Class.md)|**BOOL RemoveKey( WORD** `key` **);**|  
|[CMapWordToPtr](../Topic/CMapWordToPtr%20Class.md)|**BOOL RemoveKey( WORD** `key` **);**|  
  
### Example  
 See [CObList::CObList](../Topic/CObList%20Class.md#coblist__coblist) for a listing of the `CAge` class used in all collection examples.  
  
 [!code-cpp[NVC_MFCCollections#70](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#70)]  
...
|Class|Member Function|  
|-----------|---------------------|  
|[CMapPtrToPtr](../Topic/CMapPtrToPtr%20Class.md)|**void SetAt( void\*** `key` **, void\*** `newValue` **);**|  
|[CMapPtrToWord](../Topic/CMapPtrToWord%20Class.md)|**void SetAt( void\*** `key` **, WORD** `newValue` **);**|  
|[CMapStringToPtr](../Topic/CMapStringToPtr%20Class.md)|**void SetAt( LPCTSTR** `key` **, void\*** `newValue` **);**|  
|[CMapStringToString](../Topic/CMapStringToString%20Class.md)|**void SetAt( LPCTSTR** `key` **, LPCTSTR** `newValue` **);**|  
|[CMapWordToOb](../Topic/CMapWordToOb%20Class.md)|**void SetAt( WORD** `key` **, CObject\*** `newValue` **);**|  
|[CMapWordToPtr](../Topic/CMapWordToPtr%20Class.md)|**void SetAt( WORD** `key` **, void\*** `newValue` **);**|  
  
### Example  
 See [CObList::CObList](../Topic/CObList%20Class.md#coblist__coblist) for a listing of the `CAge` class used in all collection examples.  
  
 [!code-cpp[NVC_MFCCollections#71](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCCollections/Cpp/MFCCollections.cpp#71)]  
...
## See Also  
 ...
 [CMapPtrToPtr Class](../Topic/CMapPtrToPtr%20Class.md)   
 [CMapPtrToWord Class](../Topic/CMapPtrToWord%20Class.md)   
 [CMapStringToPtr Class](../Topic/CMapStringToPtr%20Class.md)   
 [CMapStringToString Class](../Topic/CMapStringToString%20Class.md)   
 [CMapWordToOb Class](../Topic/CMapWordToOb%20Class.md)   
 [CMapWordToPtr Class](../Topic/CMapWordToPtr%20Class.md)
