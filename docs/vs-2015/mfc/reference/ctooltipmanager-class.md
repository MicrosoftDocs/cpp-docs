...
The latest version of this topic can be found at [CTooltipManager Class](https://docs.microsoft.com/cpp/mfc/reference/ctooltipmanager-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_DrawClient#11](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_DrawClient/cpp/DrawClient.cpp#11)]  
