...
The latest version of this topic can be found at [CMFCToolBarDateTimeCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctoolbardatetimectrl-class).  
...
### Example  
 The following example demonstrates how to construct an object of the `CMFCToolBarDateTimeCtrl` class. This code snippet is part of the [Toolbar Date Time Picker sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_ToolbarDateTimePicker#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_ToolbarDateTimePicker/cpp/MainFrm.cpp#1)]  
