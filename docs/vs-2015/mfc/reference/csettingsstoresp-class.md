...
The latest version of this topic can be found at [CSettingsStoreSP Class](https://docs.microsoft.com/cpp/mfc/reference/csettingsstoresp-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#33](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#33)]  
