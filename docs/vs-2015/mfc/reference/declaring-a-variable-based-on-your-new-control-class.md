...
The latest version of this topic can be found at [Declaring a Variable Based on Your New Control Class](https://docs.microsoft.com/cpp/mfc/reference/declaring-a-variable-based-on-your-new-control-class).  
