...
The latest version of this topic can be found at [Creating a Web Browser-Style MFC Application](https://docs.microsoft.com/cpp/mfc/reference/creating-a-web-browser-style-mfc-application).  
