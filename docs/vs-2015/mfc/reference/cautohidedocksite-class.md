...
The latest version of this topic can be found at [CAutoHideDockSite Class](https://docs.microsoft.com/cpp/mfc/reference/cautohidedocksite-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#29](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#29)]  
