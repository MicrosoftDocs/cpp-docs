...
The latest version of this topic can be found at [CMFCVisualManagerWindows7 Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcvisualmanagerwindows7-class).  
  
  
The `CMFCVisualManagerWindows7` gives an application the appearance of a [!INCLUDE[win7](../../includes/win7-md.md)] application.  
...
## Remarks  
 Use the `CMFCVisualManagerWindows7` class to change the appearance of your application to mimic a default [!INCLUDE[win7](../../includes/win7-md.md)] application. This class might not be valid if your application is running on a version of Windows earlier than [!INCLUDE[win7](../../includes/win7-md.md)]. In that scenario, the application uses the default visual manager defined in [CMFCVisualManager](../../mfc/reference/cmfcvisualmanager-class.md).  
