...
The latest version of this topic can be found at [Compound Document Support, MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/reference/compound-document-support-mfc-application-wizard).  
