...
The latest version of this topic can be found at [CTreeCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/ctreectrl-class).  
...
- [Tree View Control Reference](http://msdn.microsoft.com/library/windows/desktop/bb759988) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#1)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#5)]  
...
### Remarks  
 This method sends the [TVM_ENDEDITLABELNOW](http://msdn.microsoft.com/library/windows/desktop/bb773564) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#6)]  
...
##  <a name="ctreectrl__getbkcolor"></a>  CTreeCtrl::GetBkColor  
 This member function implements the behavior of the Win32 message [TVM_GETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773570), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#7)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#8)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#9)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#10)]  
...
### Remarks  
 This method sends the [TVM_GETEXTENDEDSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb773580) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#11)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#12)]  
  
##  <a name="ctreectrl__getinsertmarkcolor"></a>  CTreeCtrl::GetInsertMarkColor  
 This member function implements the behavior of the Win32 message [TVM_GETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773590), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#13](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#13)]  
...
### Parameters  
 `pItem`  
 A pointer to a [TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456) structure, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#14](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#14)]  
...
### Remarks  
 This method sends the [TVM_GETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773596) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. That message returns the [TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459) structure that describes the tree-view control item, and then this method retrieves the `iExpandedImage` member from that structure.  
  
##  <a name="ctreectrl__getitemheight"></a>  CTreeCtrl::GetItemHeight  
 This member function implements the behavior of the Win32 message [TVM_GETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773599), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#15](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#15)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#16](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#16)]  
...
### Remarks  
 ...
 This method sends the `TVM_GETITEMPARTRECT` message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information, see the [TreeView_GetItemPartRect](http://msdn.microsoft.com/library/windows/desktop/bb773847) macro.  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.h#1)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#17](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#17)]  
...
### Parameters  
 ...
 `nStateMask`  
 Mask indicating one or more states to be retrieved. For more information on possible values for `nStateMask`, see the discussion of the **state** and **stateMask** members of the [TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#18](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#18)]  
...
### Remarks  
 This method sends the [TVM_GETNEXTITEM](http://msdn.microsoft.com/library/windows/desktop/bb773622) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information, see the `TVGN_LASTVISIBLE` flag in the `flag` parameter of that message.  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.cpp#6)]  
  
##  <a name="ctreectrl__getlinecolor"></a>  CTreeCtrl::GetLineColor  
 This member function implements the behavior of the win32 message [TVM_GETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773619), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#19](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#19)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl#20](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#20)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#21](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#21)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#22](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#22)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#23](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#23)]  
...
### Remarks  
 This member function implements the behavior of the win32 message [TVM_GETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773625), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [TVM_GETSELECTEDCOUNT](http://msdn.microsoft.com/library/windows/desktop/bb773629) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#24](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#24)]  
  
##  <a name="ctreectrl__gettextcolor"></a>  CTreeCtrl::GetTextColor  
 This member function implements the behavior of the Win32 message [TVM_GETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773633), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
##  <a name="ctreectrl__gettooltips"></a>  CTreeCtrl::GetToolTips  
 This member function implements the behavior of the Win32 message [TVM_GETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773729), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#25](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#25)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#26](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#26)]  
 ...
 *lpInsertStruct*  
 ...
 `nMask`  
 Integer specifying which attributes to set. See the `TVITEM` structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
 ...
 `nState`  
 Specifies values for the item's states. See Tree View Control Item States in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of appropriate states.  
  
 `nStateMask`  
 Specifies which states are to be set. See the `TVITEM` structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#27](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#27)]  
...
### Remarks  
 ...
 This method sends the [TVM_MAPACCIDTOHTREEITEM](http://msdn.microsoft.com/library/windows/desktop/bb773734) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method sends the [TVM_MAPHTREEITEMTOACCID](http://msdn.microsoft.com/library/windows/desktop/bb773735) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#28](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#28)]  
...
### Remarks  
 ...
 This method sends the [TVM_SETAUTOSCROLLINFO](http://msdn.microsoft.com/library/windows/desktop/bb773738) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.cpp#4)]  
  
##  <a name="ctreectrl__setbkcolor"></a>  CTreeCtrl::SetBkColor  
 This member function implements the behavior of the Win32 message [TVM_SETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773741), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#29](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#29)]  
  
### Example  
 To use checkboxes, set TVS_CHECKBOXES before populating the tree control.  
  
 [!code-cpp[NVC_MFC_CTreeCtrl#30](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#30)]  
...
### Remarks  
 ...
 This method sends the [TVM_SETEXTENDEDSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb773744) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.cpp#3)]  
...
##  <a name="ctreectrl__setinsertmark"></a>  CTreeCtrl::SetInsertMark  
 This member function implements the behavior of the Win32 message [TVM_SETINSERTMARK](http://msdn.microsoft.com/library/windows/desktop/bb773753), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#31](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#31)]  
  
##  <a name="ctreectrl__setinsertmarkcolor"></a>  CTreeCtrl::SetInsertMarkColor  
 This member function implements the behavior of the Win32 message [TVM_SETINSERTMARKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773755), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `pItem`  
 A pointer to a [TVITEM](http://msdn.microsoft.com/library/windows/desktop/bb773456) structure that contains the new item attributes, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `hItem`  
 Handle of the item whose attributes are to be set. See the **hItem** member of the `TVITEM` structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#32](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#32)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#33](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#33)]  
...
### Remarks  
 This method sends the [TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This method assigns the `iExpandedImage` parameter to the `iExpandedImage` member of a [TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459) structure, and then uses that structure in the message.  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.cpp#8)]  
  
##  <a name="ctreectrl__setitemheight"></a>  CTreeCtrl::SetItemHeight  
 This member function implements the behavior of the Win32 message [TVM_SETITEMHEIGHT](http://msdn.microsoft.com/library/windows/desktop/bb773761), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [TVM_SETITEM](http://msdn.microsoft.com/library/windows/desktop/bb773758) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This method assigns the `uStateEx` parameter to the `uStateEx` member of a [TVITEMEX](http://msdn.microsoft.com/library/windows/desktop/bb773459) structure, and then uses that structure in the message.  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CTreeCtrl_s1#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl_s1/cpp/CTreeCtrl_s1Dlg.cpp#7)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#34](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#34)]  
...
### Remarks  
 This member function implements the behavior of the win32 message [TVM_SETLINECOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773764), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#35](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#35)]  
...
### Remarks  
 This member function implements the behavior of the win32 message [TVM_SETSCROLLTIME](http://msdn.microsoft.com/library/windows/desktop/bb773767), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
##  <a name="ctreectrl__settextcolor"></a>  CTreeCtrl::SetTextColor  
 This member function implements the behavior of the Win32 message [TVM_SETTEXTCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb773769), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#36](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#36)]  
  
##  <a name="ctreectrl__settooltips"></a>  CTreeCtrl::SetToolTips  
 This member function implements the behavior of the Win32 message [TVM_SETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb773772), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method sends the [TVM_SHOWINFOTIP](http://msdn.microsoft.com/library/windows/desktop/bb773779) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#37](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#37)]  
...
### Example  
 [!code-cpp[NVC_MFC_CTreeCtrl#38](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#38)]  
  
 [!code-cpp[NVC_MFC_CTreeCtrl#39](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CTreeCtrl/Cpp/TreeDlg.cpp#39)]  
