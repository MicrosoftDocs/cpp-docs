...
The latest version of this topic can be found at [DAO Database Engine Initialization and Termination](https://docs.microsoft.com/cpp/mfc/reference/dao-database-engine-initialization-and-termination).  
