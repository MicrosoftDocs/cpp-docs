...
The latest version of this topic can be found at [CMFCVisualManagerWindows Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcvisualmanagerwindows-class).  
...
|[CMFCVisualManagerWindows::IsWinXPThemeAvailable](#cmfcvisualmanagerwindows__iswinxpthemeavailable)|Indicates whether a Windows theme is available. A theme can be either a Windows XP theme or a [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)] theme.|  
...
## Remarks  
 Use the `CMFCVisualManagerWindows` class to change the appearance of your application to mimic the current Windows XP or [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)] theme on the computer where the application runs.  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_DesktopAlertDemo#10](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_DesktopAlertDemo/cpp/DesktopAlertDemoDlg.cpp#10)]  
...
##  <a name="cmfcvisualmanagerwindows__iswinxpthemeavailable"></a>  CMFCVisualManagerWindows::IsWinXPThemeAvailable  
 Determines whether a Windows XP or [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)] theme is available.  
...
### Remarks  
 This method is valid for both Windows XP and [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)] themes.  
