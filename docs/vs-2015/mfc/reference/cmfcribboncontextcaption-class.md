...
The latest version of this topic can be found at [CMFCRibbonContextCaption Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribboncontextcaption-class).  
