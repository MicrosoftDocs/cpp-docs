...
The latest version of this topic can be found at [CMFCRibbonLinkCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribbonlinkctrl-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_RibbonGadgets#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonGadgets/cpp/MainFrm.cpp#1)]  
