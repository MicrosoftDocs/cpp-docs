...
The latest version of this topic can be found at [CMFCRibbonCustomizeDialog Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribboncustomizedialog-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#18](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#18)]  
