...
The latest version of this topic can be found at [CCheckListBox Class](https://docs.microsoft.com/cpp/mfc/reference/cchecklistbox-class).  
...
### Example  
 [!code-cpp[NVC_MFCControlLadenDialog#60](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#60)]  
