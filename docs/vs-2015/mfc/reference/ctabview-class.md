...
The latest version of this topic can be found at [CTabView Class](https://docs.microsoft.com/cpp/mfc/reference/ctabview-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_TabbedView#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_TabbedView/cpp/TabbedViewView.h#1)]  
