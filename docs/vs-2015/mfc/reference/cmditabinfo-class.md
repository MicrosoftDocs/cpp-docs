...
The latest version of this topic can be found at [CMDITabInfo Class](https://docs.microsoft.com/cpp/mfc/reference/cmditabinfo-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_MDITab#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_MDITab/cpp/MainFrm.cpp#1)]  
