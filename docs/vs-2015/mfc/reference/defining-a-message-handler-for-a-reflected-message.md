...
The latest version of this topic can be found at [Defining a Message Handler for a Reflected Message](https://docs.microsoft.com/cpp/mfc/reference/defining-a-message-handler-for-a-reflected-message).  
