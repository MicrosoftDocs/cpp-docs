...
The latest version of this topic can be found at [Application Type, MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/reference/application-type-mfc-application-wizard).  
