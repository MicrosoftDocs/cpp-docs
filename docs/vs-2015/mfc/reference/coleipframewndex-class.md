...
The latest version of this topic can be found at [COleIPFrameWndEx Class](https://docs.microsoft.com/cpp/mfc/reference/coleipframewndex-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_WordPad#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_WordPad/cpp/ipframe.cpp#1)]  
