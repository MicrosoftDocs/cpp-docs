...
The latest version of this topic can be found at [CMFCRibbonComboBox Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribboncombobox-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#11](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#11)]  
