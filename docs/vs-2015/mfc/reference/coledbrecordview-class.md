...
The latest version of this topic can be found at [COleDBRecordView Class](https://docs.microsoft.com/cpp/mfc/reference/coledbrecordview-class).  
...
### Example  
 [!code-cpp[NVC_MFCDatabase#38](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyOleDbDoc.cpp#38)]  
