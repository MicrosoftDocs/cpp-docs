...
The latest version of this topic can be found at [CMFCKeyMapDialog Class](https://docs.microsoft.com/cpp/mfc/reference/cmfckeymapdialog-class).  
...
### Example  
 The following example demonstrates how to construct an object of the `CMFCKeyMapDialog` class. This example is part of the [Visual Studio Demo sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_VisualStudioDemo#21](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/MainFrm.cpp#21)]  
