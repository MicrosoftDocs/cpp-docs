...
The latest version of this topic can be found at [CMFCPopupMenu Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpopupmenu-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_CustomPages#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_CustomPages/cpp/MainFrm.cpp#2)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CustomPages#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_CustomPages/cpp/MainFrm.cpp#1)]  
