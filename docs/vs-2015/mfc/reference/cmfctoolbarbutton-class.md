...
The latest version of this topic can be found at [CMFCToolBarButton Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctoolbarbutton-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_TabControl#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_TabControl/cpp/MainFrm.cpp#1)]  
[!code-cpp[NVC_MFC_TabControl#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_TabControl/cpp/MainFrm.cpp#2)]  
...
### Remarks  
 This method calls the `EnableWindow` function to enable or disable input. For more information, see [EnableWindow](http://msdn.microsoft.com/library/windows/desktop/ms646291) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
