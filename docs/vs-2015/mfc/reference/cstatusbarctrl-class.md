...
The latest version of this topic can be found at [CStatusBarCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cstatusbarctrl-class).  
...
### Parameters  
 `dwStyle`  
 Specifies the status bar control's style. Apply any combination of status bar control styles listed in [Common Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775498) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. This parameter must include the **WS_CHILD** style. It should also include the **WS_VISIBLE** style.  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#2)]  
...
### Remarks  
 This method sends the [SB_GETICON](http://msdn.microsoft.com/library/windows/desktop/bb760744) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CStatusBarCtrl_s1#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl_s1/cpp/CStatusBarCtrl_s1Dlg.h#1)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CStatusBarCtrl_s1#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl_s1/cpp/CStatusBarCtrl_s1Dlg.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#6)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [SB_GETTIPTEXT](http://msdn.microsoft.com/library/windows/desktop/bb760751), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#7)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [SB_ISSIMPLE](http://msdn.microsoft.com/library/windows/desktop/bb760753), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function implements the behavior of the Win32 message [SB_SETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760754), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#8)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [SB_SETICON](http://msdn.microsoft.com/library/windows/desktop/bb760755), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#9)]  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#10)]  
...
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#11)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [SB_SETTIPTEXT](http://msdn.microsoft.com/library/windows/desktop/bb760759), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CStatusBarCtrl#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CStatusBarCtrl/Cpp/StatusBarCtrlDlg.cpp#12)]  
