...
The latest version of this topic can be found at [CToolBar Class](https://docs.microsoft.com/cpp/mfc/reference/ctoolbar-class).  
...
### Example  
 [!code-cpp[NVC_MFCDocView#179](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MainFrm.cpp#179)]  
...
### Parameters  
 ...
 `dwStyle`  
 The toolbar style. See [Toolbar Control and Button Styles](http://msdn.microsoft.com/library/windows/desktop/bb760439) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of appropriate styles.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#180](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/ChildFrm.cpp#180)]  
...
### Remarks  
 ...
 For more information about using common controls, see the article [Controls](../../mfc/controls-mfc.md) and [Common Controls](http://msdn.microsoft.com/library/windows/desktop/bb775493) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCDocViewSDI#15](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocViewSDI/Cpp/MainFrm.cpp#15)]  
...
### Example  
 [!code-cpp[NVC_MFCListView#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCListView/Cpp/MainFrm.cpp#8)]  
