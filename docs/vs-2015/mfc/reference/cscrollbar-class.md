...
The latest version of this topic can be found at [CScrollBar Class](https://docs.microsoft.com/cpp/mfc/reference/cscrollbar-class).  
...
### Example  
 [!code-cpp[NVC_MFC_CScrollBar#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CScrollBar/Cpp/ScrollBarDlg.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFC_CScrollBar#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CScrollBar/Cpp/ScrollBarDlg.h#2)]  
...
### Remarks  
 This member function emulates the functionality of the [SBM_SCROLLBARINFO](http://msdn.microsoft.com/library/windows/desktop/bb787545) message, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 The `SCROLLINFO` structure contains information about a scroll bar, including the minimum and maximum scrolling positions, the page size, and the position of the scroll box (the thumb). See the [SCROLLINFO](http://msdn.microsoft.com/library/windows/desktop/bb787537) structure topic in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information about changing the structure defaults.  
  
### Example  
 [!code-cpp[NVC_MFC_CScrollBar#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CScrollBar/Cpp/ScrollBarDlg.cpp#3)]  
...
### Example  
 [!code-cpp[NVC_MFC_CScrollBar#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CScrollBar/Cpp/ScrollBarDlg.cpp#4)]  
