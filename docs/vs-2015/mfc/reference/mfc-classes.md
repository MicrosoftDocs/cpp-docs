...
The latest version of this topic can be found at [MFC Classes](https://docs.microsoft.com/cpp/mfc/reference/mfc-classes).  
...
## In This Section  
 ...
 Gives an application the appearance of a [!INCLUDE[win7](../../includes/win7-md.md)] application.  
 ...
 [CSplitterWndEx Class](~/mfc/reference/csplitterwndex-class.md)  
