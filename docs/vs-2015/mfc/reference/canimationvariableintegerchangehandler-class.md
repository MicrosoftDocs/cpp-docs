...
The latest version of this topic can be found at [CAnimationVariableIntegerChangeHandler Class](https://docs.microsoft.com/cpp/mfc/reference/canimationvariableintegerchangehandler-class).  
