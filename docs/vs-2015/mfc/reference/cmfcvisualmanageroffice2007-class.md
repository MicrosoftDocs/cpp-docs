...
The latest version of this topic can be found at [CMFCVisualManagerOffice2007 Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcvisualmanageroffice2007-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_DesktopAlertDemo#7](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_DesktopAlertDemo/cpp/DesktopAlertDemoDlg.cpp#7)]  
