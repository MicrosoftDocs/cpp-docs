...
The latest version of this topic can be found at [CColorDialog Class](https://docs.microsoft.com/cpp/mfc/reference/ccolordialog-class).  
 ...
 *clrInit*  
 ...
 `dwFlags`  
 A set of flags that customize the function and appearance of the dialog box. For more information, see the [CHOOSECOLOR](http://msdn.microsoft.com/library/windows/desktop/ms646830) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `pParentWnd`  
 A pointer to the dialog box's parent or owner window.  
  
### Example  
 [!code-cpp[NVC_MFCDocView#49](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#49)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#50](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#50)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#51](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#51)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#53](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#53)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#52](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyView.cpp#52)]  
