...
The latest version of this topic can be found at [CMFCPropertyGridToolTipCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpropertygridtooltipctrl-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#23](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#23)]  
