...
The latest version of this topic can be found at [COleDocument Class](https://docs.microsoft.com/cpp/mfc/reference/coledocument-class).  
...
### Remarks  
 ...
 For more information, see the [PRINTDLG](http://msdn.microsoft.com/library/windows/desktop/ms646843) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 For more information, see the [DVTARGETDEVICE](http://msdn.microsoft.com/library/windows/desktop/ms686613) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerDoc.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFCOleContainer#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleContainer/Cpp/OleContainerDoc.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFCOleServer#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCOleServer/Cpp/MFCOleServerView.cpp#2)]  
...
## See Also  
 [MFC Sample CONTAINER](../../top/visual-cpp-samples.md)   
