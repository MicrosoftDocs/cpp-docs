...
The latest version of this topic can be found at [CPrintDialog Class](https://docs.microsoft.com/cpp/mfc/reference/cprintdialog-class).  
...
>  The `CPrintDialogEx` class encapsulates the services provided by the Windows 2000 Print property sheet. For more information see the [CPrintDialogEx](../../mfc/reference/cprintdialogex-class.md) overview.  
 ...
 You can use the Windows **CommDlgExtendedError** function to determine whether an error occurred during initialization of the dialog box and to learn more about the error. For more information on this function, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `dwFlags`  
 One or more flags you can use to customize the settings of the dialog box, combined using the bitwise OR operator. For example, the **PD_ALLPAGES** flag sets the default print range to all pages of the document. See the [PRINTDLG](http://msdn.microsoft.com/library/windows/desktop/ms646843) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information on these flags.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#174](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#174)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#106](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#106)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDocView#107](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#107)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDocView#108](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#108)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#109](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#109)]  
...
### Remarks  
 After constructing a `CPrintDialog` object, you can use `m_pd` to set various aspects of the dialog box before calling the [DoModal](#cprintdialog__domodal) member function. For more information on the `m_pd` structure, see [PRINTDLG](http://msdn.microsoft.com/library/windows/desktop/ms646843) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 If you modify the `m_pd` data member directly, you will override any default behavior.  
  
### Example  
 [!code-cpp[NVC_MFCDocView#111](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#111)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#110](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/MyRichEditView.cpp#110)]  
