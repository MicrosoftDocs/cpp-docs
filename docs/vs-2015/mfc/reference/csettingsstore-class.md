...
The latest version of this topic can be found at [CSettingsStore Class](https://docs.microsoft.com/cpp/mfc/reference/csettingsstore-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_ToolTipDemo#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_ToolTipDemo/cpp/TooltipDemoView.cpp#1)]  
