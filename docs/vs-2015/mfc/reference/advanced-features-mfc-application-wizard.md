...
The latest version of this topic can be found at [Advanced Features, MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/reference/advanced-features-mfc-application-wizard).  
 ...
 **Common Control Manifest**  
 ...
 An application manifest can also specify other DLLs and versions that your application needs. For more information about application manifests, see [Isolated Applications and Side-by-Side Assemblies](http://msdn.microsoft.com/library/dd408052) in the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)].  
