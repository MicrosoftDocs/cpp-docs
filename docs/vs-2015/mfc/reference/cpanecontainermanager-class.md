...
The latest version of this topic can be found at [CPaneContainerManager Class](https://docs.microsoft.com/cpp/mfc/reference/cpanecontainermanager-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_SetPaneSize#5](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_SetPaneSize/cpp/MainFrm.cpp#5)]  
