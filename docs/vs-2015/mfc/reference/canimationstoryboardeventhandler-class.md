...
The latest version of this topic can be found at [CAnimationStoryboardEventHandler Class](https://docs.microsoft.com/cpp/mfc/reference/canimationstoryboardeventhandler-class).  
