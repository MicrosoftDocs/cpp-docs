...
The latest version of this topic can be found at [CMFCPropertyGridProperty Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcpropertygridproperty-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_NewControls#27](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_NewControls/cpp/Page5.cpp#27)]  
