...
The latest version of this topic can be found at [Message Maps (MFC)](https://docs.microsoft.com/cpp/mfc/reference/message-maps-mfc).  
...
|[User-Defined Message Handlers](../../mfc/reference/user-defined-handlers.md)|Handle user-defined messages.|  
 ...
 [!code-cpp[NVC_MFCMessageMaps#16](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCMessageMaps/Cpp/MyDoc.cpp#16)]  
