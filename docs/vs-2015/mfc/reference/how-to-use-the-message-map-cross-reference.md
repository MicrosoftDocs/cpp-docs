...
The latest version of this topic can be found at [How to: Use the Message-Map Cross-Reference](https://docs.microsoft.com/cpp/mfc/reference/how-to-use-the-message-map-cross-reference).  
