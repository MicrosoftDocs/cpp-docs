...
The latest version of this topic can be found at [CMFCVisualManagerVS2005 Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcvisualmanagervs2005-class).  
...
## Remarks  
 You use the CMFCVisualManagerVS2005 class to change the visual appearance of your application to resemble that of the [!INCLUDE[vsprvsext](../../includes/vsprvsext-md.md)].  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_DesktopAlertDemo#9](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_DesktopAlertDemo/cpp/DesktopAlertDemoDlg.cpp#9)]  
