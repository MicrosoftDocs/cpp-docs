...
The latest version of this topic can be found at [CMFCDropDownToolBar Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcdropdowntoolbar-class).  
...
## Example  
 The following example demonstrates how to use the `Create` method in the `CMFCDropDownToolBar` class. This code snippet is part of the [Visual Studio Demo sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_VisualStudioDemo#29](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/MainFrm.h#29)]  
[!code-cpp[NVC_MFC_VisualStudioDemo#30](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/MainFrm.cpp#30)]  
