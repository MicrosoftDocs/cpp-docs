...
The latest version of this topic can be found at [CSplitButton Class](https://docs.microsoft.com/cpp/mfc/reference/csplitbutton-class).  
...
## Remarks  
 ...
 ![Dialog with a splitbutton and pager control.](../../mfc/reference/media/splitbutton-pager.png "SplitButton_Pager")  
