...
The latest version of this topic can be found at [CMFCColorPopupMenu Class](https://docs.microsoft.com/cpp/mfc/reference/cmfccolorpopupmenu-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#34](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#34)]  
