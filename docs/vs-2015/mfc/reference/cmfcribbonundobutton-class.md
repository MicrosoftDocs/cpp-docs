...
The latest version of this topic can be found at [CMFCRibbonUndoButton Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribbonundobutton-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonGadgets#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonGadgets/cpp/MainFrm.cpp#2)]  
