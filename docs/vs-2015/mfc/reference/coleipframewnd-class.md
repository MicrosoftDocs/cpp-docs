...
The latest version of this topic can be found at [COleIPFrameWnd Class](https://docs.microsoft.com/cpp/mfc/reference/coleipframewnd-class).  
...
### Remarks  
 For more information, see [OLEINPLACEFRAMEINFO](http://msdn.microsoft.com/library/windows/desktop/ms693737) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
