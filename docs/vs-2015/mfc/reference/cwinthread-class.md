...
The latest version of this topic can be found at [CWinThread Class](https://docs.microsoft.com/cpp/mfc/reference/cwinthread-class).  
...
- **THREAD_PRIORITY_IDLE**  
 ...
 For more information on these priorities, see [SetThreadPriority](http://msdn.microsoft.com/library/windows/desktop/ms686277) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 [!code-cpp[NVC_MFCDocView#189](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/NVC_MFCDocView.cpp#189)]  
