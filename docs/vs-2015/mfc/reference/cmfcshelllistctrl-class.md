...
The latest version of this topic can be found at [CMFCShellListCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcshelllistctrl-class).  
...
## Example  
 The following example demonstrates how to create an object of the `CMFCShellListCtrl` class and how to display the parent folder of the currently displayed folder. This code snippet is part of the [Explorer sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_Explorer#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_Explorer/cpp/ExplorerView.h#1)]  
[!code-cpp[NVC_MFC_Explorer#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_Explorer/cpp/ExplorerView.cpp#2)]  
[!code-cpp[NVC_MFC_Explorer#3](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_Explorer/cpp/ExplorerView.cpp#3)]  
