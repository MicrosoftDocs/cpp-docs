...
The latest version of this topic can be found at [Collection Class Helpers](https://docs.microsoft.com/cpp/mfc/reference/collection-class-helpers).  
...
### Example  
 [!code-cpp[NVC_MFC_Utilities#34](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/NVC_MFC_Utilities.cpp#34)]  
