...
The latest version of this topic can be found at [CMFCToolTipInfo Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctooltipinfo-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#42](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#42)]  
