...
The latest version of this topic can be found at [CMFCHeaderCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcheaderctrl-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#24](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#24)]  
