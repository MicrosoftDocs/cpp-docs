...
The latest version of this topic can be found at [CUserToolsManager Class](https://docs.microsoft.com/cpp/mfc/reference/cusertoolsmanager-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_VisualStudioDemo#38](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_VisualStudioDemo/cpp/MainFrm.cpp#38)]  
