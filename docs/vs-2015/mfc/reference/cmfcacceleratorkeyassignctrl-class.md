...
The latest version of this topic can be found at [CMFCAcceleratorKeyAssignCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcacceleratorkeyassignctrl-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#31](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#31)]  
