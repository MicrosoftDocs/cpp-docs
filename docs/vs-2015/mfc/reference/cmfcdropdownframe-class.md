...
The latest version of this topic can be found at [CMFCDropDownFrame Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcdropdownframe-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#36](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#36)]  
