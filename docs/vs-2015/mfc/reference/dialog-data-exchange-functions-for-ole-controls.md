...
The latest version of this topic can be found at [Dialog Data Exchange Functions for OLE Controls](https://docs.microsoft.com/cpp/mfc/reference/dialog-data-exchange-functions-for-ole-controls).  
