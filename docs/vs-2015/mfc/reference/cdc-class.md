...
The latest version of this topic can be found at [CDC Class](https://docs.microsoft.com/cpp/mfc/reference/cdc-class).  
...
### Remarks  
 See [AlphaBlend](http://msdn.microsoft.com/library/windows/desktop/dd183351) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#29](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#29)]  
...
### Remarks  
 ...
 See [BeginPath](http://msdn.microsoft.com/library/windows/desktop/dd183363) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of the drawing functions that define points in a path.  
  
### Example  
 [!code-cpp[NVC_MFCDocView#30](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#30)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#31](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#31)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#32](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#32)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#33](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#33)]  
 ...
 *nEdge*  
 Specifies the type of inner and outer edge to draw. This parameter must be a combination of one inner-border flag and one outer-border flag. See [DrawEdge](http://msdn.microsoft.com/library/windows/desktop/dd162477) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a table of the parameter's types.  
  
 `nFlags`  
 The flags that specify the type of border to be drawn. See `DrawEdge` in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a table of the parameter's values. For diagonal lines, the **BF_RECT** flags specify the end point of the vector bounded by the rectangle parameter.  
...
### Parameters  
 ...
 `nType`  
 Specifies the type of frame control to draw. See the *uType* parameter in [DrawFrameControl](http://msdn.microsoft.com/library/windows/desktop/dd162480) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of this parameter's possible values.  
  
 `nState`  
 Specifies the initial state of the frame control. Can be one or more of the values described for the *uState* parameter in `DrawFrameControl` in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. Use the `nState` value **DFCS_ADJUSTRECT** to adjust the bounding rectangle to exclude the surrounding edge of the push button.  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDocView#34](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#34)]  
...
### Parameters  
 ...
 `nFlags`  
 Flags that specify the image type and state. See [DrawState](http://msdn.microsoft.com/library/windows/desktop/dd162496) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for the possible `nFlags` types and states.  
 ...
 *lpDrawProc*  
 A pointer to a callback function used to render an image. This parameter is required if the image type in `nFlags` is **DST_COMPLEX**. It is optional and can be **NULL** if the image type is **DST_TEXT**. For all other image types, this parameter is ignored. For more information about the callback function, see the [DrawStateProc](http://msdn.microsoft.com/library/windows/desktop/dd162497) function in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `nFormat`  
 Specifies the method of formatting the text. It can be any combination of the values described for the `uFormat` parameter in [DrawText](http://msdn.microsoft.com/library/windows/desktop/dd162498) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. (combine using the bitwise OR operator):  
...
### Example  
 [!code-cpp[NVC_MFCDocView#35](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#35)]  
...
### Parameters  
 ...
 For a complete list of escape functions, see [Escape](http://msdn.microsoft.com/library/windows/desktop/dd162701) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
- [CDC::StartPage](#cdc__startpage)  
 ...
 In addition, [CDC::GetDeviceCaps](#cdc__getdevicecaps) supports Win32 indexes that supersede other printer escapes. See [GetDeviceCaps](http://msdn.microsoft.com/library/windows/desktop/dd144877) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information.  
...
### Remarks  
 This member function emulates the functionality of the function [GetCharacterPlacement](http://msdn.microsoft.com/library/windows/desktop/dd144860\(v=vs.85\).aspx), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetCharABCWidthsI](http://msdn.microsoft.com/library/windows/desktop/dd144859), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetCharWidthI](http://msdn.microsoft.com/library/windows/desktop/dd144864), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetDCBrushColor](http://msdn.microsoft.com/library/windows/desktop/dd144872), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function utilizes the Win32 function [GetDCPenColor](http://msdn.microsoft.com/library/windows/desktop/dd144875), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `nIndex`  
 Specifies the type of information to return. See [GetDeviceCaps](http://msdn.microsoft.com/library/windows/desktop/dd144877) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of values.  
...
### Remarks  
 This member function emulates the functionality of the function [GetFontLanguageInfo](http://msdn.microsoft.com/library/windows/desktop/dd144886), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetTextExtentExPointI](http://msdn.microsoft.com/library/windows/desktop/dd144936), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function emulates the functionality of the function [GetTextExtentPointI](http://msdn.microsoft.com/library/windows/desktop/dd144939), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
 ...
 *nMeshElements*  
 ...
 `dwMode`  
 Specifies gradient fill mode. For a list of possible values, see [GradientFill](http://msdn.microsoft.com/library/windows/desktop/dd144957) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 **TRUE** if successful; otherwise **FALSE**.  
  
### Remarks  
 For more information, see `GradientFill` in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCDocView#36](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#36)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#37](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#37)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#38](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#38)]  
...
### Remarks  
 ...
 For more information, see [PolyLine](http://msdn.microsoft.com/library/windows/desktop/dd162815) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCDocView#39](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#39)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#40](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#40)]  
...
### Remarks  
 This method emulates the functionality of the function [SetDCBrushColor](http://msdn.microsoft.com/library/windows/desktop/dd162969), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function utilizes the Win32 function [SetDCPenColor](http://msdn.microsoft.com/library/windows/desktop/dd162970), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
 ...
 *y*  
 ...
 `crColor`  
 A **COLORREF** RGB value that specifies the color used to paint the point. See [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a description of this value.  
...
### Return Value  
 ...
 It can be any of the values given in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDocView#41](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/DCView.cpp#41)]  
...
### Remarks  
 ...
 For more information, see [TransparentBlt](http://msdn.microsoft.com/library/windows/desktop/dd145141) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information about using color palettes, see [UpdateColors](http://msdn.microsoft.com/library/windows/desktop/dd145166) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
