...
The latest version of this topic can be found at [CControlBar Class](https://docs.microsoft.com/cpp/mfc/reference/ccontrolbar-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#61](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#61)]  
