...
The latest version of this topic can be found at [CD2DLinearGradientBrush Class](https://docs.microsoft.com/cpp/mfc/reference/cd2dlineargradientbrush-class).  
