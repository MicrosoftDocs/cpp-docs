...
The latest version of this topic can be found at [CMFCRibbonGalleryMenuButton Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcribbongallerymenubutton-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_MSOffice2007Demo#8](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_MSOffice2007Demo/cpp/MainFrm.cpp#8)]  
