...
The latest version of this topic can be found at [CBrush Class](https://docs.microsoft.com/cpp/mfc/reference/cbrush-class).  
...
### Example  
 [!code-cpp[NVC_MFCDocView#21](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#21)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#22](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#22)]  
...
-   In the second version, it is not necessary to call **GlobalAlloc** to allocate memory for the packed DIB.  
 ...
 For information about using the following Windows functions, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]:  
...
### Example  
 [!code-cpp[NVC_MFCDocView#23](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#23)]  
...
- `HS_VERTICAL` Vertical hatch  
 ...
 `crColor`  
 Specifies the foreground color of the brush as an RGB color (the color of the hatches). See [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#24](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#24)]  
...
### Remarks  
 ...
 For information about using [CreatePatternBrush](http://msdn.microsoft.com/library/windows/desktop/dd183508), a Windows function, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFCDocView#25](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#25)]  
...
### Parameters  
 `nIndex`  
 Specifies a color index. This value corresponds to the color used to paint one of the 21 window elements. See [GetSysColor](http://msdn.microsoft.com/library/windows/desktop/ms724371) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of values.  
...
### Example  
 [!code-cpp[NVC_MFCDocView#26](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#26)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#27](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#27)]  
...
### Example  
 [!code-cpp[NVC_MFCDocView#28](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDocView/Cpp/BrushView.cpp#28)]  
