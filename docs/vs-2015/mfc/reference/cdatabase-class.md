...
The latest version of this topic can be found at [CDatabase Class](https://docs.microsoft.com/cpp/mfc/reference/cdatabase-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFCDatabase#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDatabaseDoc.h#9)]  
  
 [!code-cpp[NVC_MFCDatabase#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDatabaseDoc.cpp#10)]  
...
### Example  
 [!code-cpp[NVC_MFCDatabase#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDatabaseDoc.cpp#12)]  
...
### Example  
 [!code-cpp[NVC_MFCDatabase#13](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDatabaseDoc.cpp#13)]  
...
|`SQL_BP_OTHER_HSTMT`|Bookmarks associated with one recordset object are valid on a second recordset.|  
 ...
 For more information about this return value, see the ODBC API function **SQLGetInfo** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information about bookmarks, see the article [Recordset: Bookmarks and Absolute Positions (ODBC)](../../data/odbc/recordset-bookmarks-and-absolute-positions-odbc.md).  
...
|`SQL_CB_PRESERVE`|Proceed normally with `CRecordset` operations.|  
 ...
 For more information about this return value, see the ODBC API function **SQLGetInfo** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information about transactions, see the article [Transaction (ODBC)](../../data/odbc/transaction-odbc.md).  
...
### Example  
 [!code-cpp[NVC_MFCDatabase#15](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDatabaseDoc.cpp#15)]  
...
>  Calling the [OpenEx](#cdatabase__openex) member function is the preferred way to connect to a data source and initialize your database object.  
 ...
 You can also use the connection string for multiple levels of login authorization (each for a different `CDatabase` object) or to convey other data source-specific information. For more information about connection strings, see Chapter 5 in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCDatabase#14](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDatabaseDoc.cpp#14)]  
...
### Example  
 [!code-cpp[NVC_MFCDatabase#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyDatabaseDoc.cpp#11)]  
