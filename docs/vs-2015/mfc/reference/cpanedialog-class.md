...
The latest version of this topic can be found at [CPaneDialog Class](https://docs.microsoft.com/cpp/mfc/reference/cpanedialog-class).  
...
### Example  
 The following example demonstrates how to use the `Create` method in the `CPaneDialog` class. This example is part of the [Set Pane Size sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_SetPaneSize#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_SetPaneSize/cpp/MainFrm.h#2)]  
[!code-cpp[NVC_MFC_SetPaneSize#3](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_SetPaneSize/cpp/MainFrm.cpp#3)]  
