...
The latest version of this topic can be found at [CMFCCaptionButton Class](https://docs.microsoft.com/cpp/mfc/reference/cmfccaptionbutton-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#43](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#43)]  
