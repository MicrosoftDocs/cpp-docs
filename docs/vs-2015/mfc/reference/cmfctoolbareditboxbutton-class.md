...
The latest version of this topic can be found at [CMFCToolBarEditBoxButton Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctoolbareditboxbutton-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#40](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#40)]  
