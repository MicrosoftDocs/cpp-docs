...
The latest version of this topic can be found at [Adding an MFC Message Handler](https://docs.microsoft.com/cpp/mfc/reference/adding-an-mfc-message-handler).  
