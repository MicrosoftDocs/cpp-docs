...
The latest version of this topic can be found at [CMFCVisualManagerOffice2003 Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcvisualmanageroffice2003-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_DesktopAlertDemo#6](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_DesktopAlertDemo/cpp/DesktopAlertDemo.cpp#6)]  
