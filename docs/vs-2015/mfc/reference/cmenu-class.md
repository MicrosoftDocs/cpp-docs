...
The latest version of this topic can be found at [CMenu Class](https://docs.microsoft.com/cpp/mfc/reference/cmenu-class).  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#21](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#21)]  
...
### Example  
  See the example for [ON_COMMAND_RANGE](../Topic/ON_COMMAND_RANGE.md).  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#22](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#22)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#23](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#23)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCWindowing#24](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#24)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#25](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#25)]  
...
### Remarks  
 This member function implements the behavior of the Win32 function [GetMenuDefaultItem](http://msdn.microsoft.com/library/windows/desktop/ms647976), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 ...
 `lpMenuItemInfo`  
 A pointer to a [MENUITEMINFO](http://msdn.microsoft.com/library/windows/desktop/ms647578), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)], that contains information about the menu.  
...
### Return Value  
 If the function succeeds, the return value is nonzero. If the function fails, the return value is zero. To get extended error information, use the Win32 function [GetLastError](http://msdn.microsoft.com/library/windows/desktop/ms679360), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Remarks  
 This member function implements the behavior of the of the Win32 function [GetMenuItemInfo](http://msdn.microsoft.com/library/windows/desktop/ms647980), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. Note that in the MFC implementation of `GetMenuItemInfo`, you do not use a handle to a menu.  
  
### Example  
 [!code-cpp[NVC_MFCWindowing#26](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#26)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#27](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#27)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#28](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#28)]  
...
### Parameters  
 `uItem`  
 See description of `uItem` in [InsertMenuItem](http://msdn.microsoft.com/library/windows/desktop/ms647988) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `lpMenuItemInfo`  
 See description of `lpmii` in **InsertMenuItem** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `fByPos`  
 See description of `fByPosition` in **InsertMenuItem** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Remarks  
 This function wraps [InsertMenuItem](http://msdn.microsoft.com/library/windows/desktop/ms647988), described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#29](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#29)]  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#30](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#30)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFCWindowing#31](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#31)]  
...
### Remarks  
 This member function implements the behavior of the Win32 function [SetMenuDefaultItem](http://msdn.microsoft.com/library/windows/desktop/ms647996), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFCWindowing#32](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#32)]  
  
 [!code-cpp[NVC_MFCWindowing#33](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MainFrm.cpp#33)]  
...
### Parameters  
 `uItem`  
 See description of `uItem` in [SetMenuItemInfo](http://msdn.microsoft.com/library/windows/desktop/ms648001) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `lpMenuItemInfo`  
 See description of `lpmii` in **SetMenuItemInfo** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `fByPos`  
 See description of `fByPosition` in **SetMenuItemInfo** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Remarks  
 This function wraps [SetMenuItemInfo](http://msdn.microsoft.com/library/windows/desktop/ms648001), described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Return Value  
 This method returns the result of calling [TrackPopupMenu](http://msdn.microsoft.com/library/windows/desktop/ms648002) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Remarks  
 A floating pop-up menu can appear anywhere on the screen.  
  
### Example  
 [!code-cpp[NVC_MFCWindowing#34](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWindowing/Cpp/MdiView.cpp#34)]  
