...
The latest version of this topic can be found at [CContextMenuManager Class](https://docs.microsoft.com/cpp/mfc/reference/ccontextmenumanager-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_CustomPages#4](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_CustomPages/cpp/CustomPages.cpp#4)]  
