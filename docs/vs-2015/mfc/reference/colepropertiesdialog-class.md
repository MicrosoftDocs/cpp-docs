...
The latest version of this topic can be found at [COlePropertiesDialog Class](https://docs.microsoft.com/cpp/mfc/reference/colepropertiesdialog-class).  
...
### Remarks  
 ...
 For more information on the **OLEUIGNRLPROPS** structure, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information on the **OLEUILINKPROPS** structure, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see the **OLEUIOBJECTPROPS** and [OLEUILINKPROPS](http://msdn.microsoft.com/library/windows/desktop/ms680735) structures in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information on the **PROPSHEETHEADER** structure, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information on the **OLEUIVIEWPROPS** structure, see the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
