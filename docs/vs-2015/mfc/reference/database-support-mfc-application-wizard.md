...
The latest version of this topic can be found at [Database Support, MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/reference/database-support-mfc-application-wizard).  
