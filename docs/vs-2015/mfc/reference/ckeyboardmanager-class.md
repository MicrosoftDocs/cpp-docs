...
The latest version of this topic can be found at [CKeyboardManager Class](https://docs.microsoft.com/cpp/mfc/reference/ckeyboardmanager-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_CustomPages#5](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_CustomPages/cpp/CustomPages.cpp#5)]  
