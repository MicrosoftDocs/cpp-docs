...
The latest version of this topic can be found at [CRichEditCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cricheditctrl-class).  
...
## Remarks  
 ...
 This Windows Common control (and therefore the `CRichEditCtrl` class) is available only to programs running under Windows 95/98 and Windows NT versions 3.51 and later. The `CRichEditCtrl` class supports versions 2.0 and 3.0 of the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] rich edit control.  
...
### Remarks  
 ...
 For more information, see [EM_CANPASTE](http://msdn.microsoft.com/library/windows/desktop/bb787993) message and [RegisterClipboardFormat](http://msdn.microsoft.com/library/windows/desktop/ms649049) function in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#1)]  
...
### Remarks  
 ...
 For more information, see [EM_CANREDO](http://msdn.microsoft.com/library/windows/desktop/bb787995) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see [EM_CANUNDO](http://msdn.microsoft.com/library/windows/desktop/bb775468) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#2)]  
...
### Remarks  
 ...
 For more information, see [EM_CHARFROMPOS](http://msdn.microsoft.com/library/windows/desktop/bb761566) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [WM_CLEAR](http://msdn.microsoft.com/library/windows/desktop/ms649020) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#3)]  
...
### Remarks  
 For more information, see [WM_COPY](http://msdn.microsoft.com/library/windows/desktop/ms649022) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#4)]  
...
### Parameters  
 `dwStyle`  
 Specifies the edit control's style. Apply a combination of the window styles listed in the **Remarks** section below, and [edit control styles](http://msdn.microsoft.com/library/windows/desktop/bb775464), described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
- **WS_TABSTOP** To include edit control in the tabbing order.  
 ...
 For more information about window styles, see [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#5)]  
...
### Parameters  
 `dwExStyle`  
 Specifies the extended style of the control being created. For a list of extended Windows styles, see the `dwExStyle` parameter for [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `dwStyle`  
 Specifies the edit control's style. Apply a combination of the window styles listed in the **Remarks** section of [Create](#cricheditctrl__create) and [edit control styles](http://msdn.microsoft.com/library/windows/desktop/bb775464), described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#6)]  
...
### Remarks  
 ...
 For more information, see [WM_CUT](http://msdn.microsoft.com/library/windows/desktop/ms649023) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#7)]  
...
### Remarks  
 ...
 For more information, see [EM_DISPLAYBAND](http://msdn.microsoft.com/library/windows/desktop/bb787997) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_EMPTYUNDOBUFFER](http://msdn.microsoft.com/library/windows/desktop/bb761568) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#8)]  
...
### Parameters  
 `dwFlags`  
 For a list of possible values, see `wParam` in [EM_FINDTEXTEXT](http://msdn.microsoft.com/library/windows/desktop/bb788011) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_FINDTEXTEX](http://msdn.microsoft.com/library/windows/desktop/bb788011) message and [FINDTEXTEX](http://msdn.microsoft.com/library/windows/desktop/bb787909) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#9)]  
...
### Parameters  
 `nCode`  
 Indicates the action to take. For a list of possible values, see the description for the parameter `code` in **EM_FINDWORDBREAK** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `nStart`  
 The zero-based character position from which to start.  
  
### Return Value  
 Based on the parameter `nCode`. For more information, see [EM_FINDWORDBREAK](http://msdn.microsoft.com/library/windows/desktop/bb788018) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_FORMATRANGE](http://msdn.microsoft.com/library/windows/desktop/bb788020) message and [FORMATRANGE](http://msdn.microsoft.com/library/windows/desktop/bb787911) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#10)]  
...
### Remarks  
 ...
 For more information, see [EM_POSFROMCHAR](http://msdn.microsoft.com/library/windows/desktop/bb761631) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see the **EM_GETCHARFORMAT** message and the **CHARFORMAT** and **CHARFORMAT2** structures in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_GETEVENTMASK](http://msdn.microsoft.com/library/windows/desktop/bb788032) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see [EM_GETFIRSTVISIBLELINE](http://msdn.microsoft.com/library/windows/desktop/bb761574) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#11)]  
...
### Remarks  
 ...
 For more information, see [EM_GETOLEINTERFACE](http://msdn.microsoft.com/library/windows/desktop/bb788041) message and [IRichEditOle](http://msdn.microsoft.com/library/windows/desktop/bb774306) interface in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_GETLIMITTEXT](http://msdn.microsoft.com/library/windows/desktop/bb761582) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#12)]  
...
>  Because the first word of the buffer stores the number of characters to be copied, make sure that your buffer is at least 4 bytes long.  
 ...
 For more information, see [EM_GETLINE](http://msdn.microsoft.com/library/windows/desktop/bb761584) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see [EM_GETLINECOUNT](http://msdn.microsoft.com/library/windows/desktop/bb761586) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#13](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#13)]  
...
### Remarks  
 ...
 For more information, see [EM_GETMODIFY](http://msdn.microsoft.com/library/windows/desktop/bb761592) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#14](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#14)]  
...
### Return Value  
 A combination of the current option flag values. For a list of these values, see the *fOptions* parameter in the [EM_SETOPTIONS](http://msdn.microsoft.com/library/windows/desktop/bb774254) message, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see the [EM_GETPARAFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774182) message and the **PARAFORMAT** and **PARAFORMAT2** structures in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Parameters  
 `fType`  
 The punctuation type flag, as described in the `fType` parameter of [EM_GETPUNCTUATION](http://msdn.microsoft.com/library/windows/desktop/bb774184) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `lpPunc`  
 A pointer to a [PUNCTUATION](http://msdn.microsoft.com/library/windows/desktop/bb787944) structure, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_GETRECT](http://msdn.microsoft.com/library/windows/desktop/bb761596) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
- **GetSel(** `nStartChar` **,** `nEndChar` **)** This form returns the bounds in the parameters `nStartChar` and `nEndChar`.  
 ...
 For more information, see [EM_EXGETSEL](http://msdn.microsoft.com/library/windows/desktop/bb788001) message and [CHARRANGE](http://msdn.microsoft.com/library/windows/desktop/bb787885) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#15](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#15)]  
...
### Remarks  
 ...
 For more information, see the [EM_GETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb788026) message and the **CHARFORMAT** and **CHARFORMAT2** structures in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see [EM_SELECTIONTYPE](http://msdn.microsoft.com/library/windows/desktop/bb774223) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#16](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#16)]  
...
### Remarks  
 ...
 For more information, see [EM_GETSELTEXT](http://msdn.microsoft.com/library/windows/desktop/bb774190) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 For more information, see [WM_GETTEXTLENGTH](http://msdn.microsoft.com/library/windows/desktop/ms632628) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#17](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#17)]  
...
### Parameters  
 `dwFlags`  
 Value specifying the method to be used in determining the text length. This member can be one or more of the values listed in the flags member of [GETTEXTLENGTHEX](http://msdn.microsoft.com/library/windows/desktop/bb787915) described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 `GetTextLengthEx` provides additional ways of determining the length of the text. It supports the Rich Edit 2.0 functionality. See [About Rich Edit Controls](http://msdn.microsoft.com/library/windows/desktop/bb787873) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]for more information.  
...
### Return Value  
 A set of bit flags from the [TEXTMODE](http://msdn.microsoft.com/library/windows/desktop/bb774364) enumeration type, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The flags indicate the current text mode and undo level of the control.  
...
### Remarks  
 For more information, see [EM_GETTEXTRANGE](http://msdn.microsoft.com/library/windows/desktop/bb774199) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `GetTextRange` supports the Rich Edit 2.0 functionality. See [About Rich Edit Controls](http://msdn.microsoft.com/library/windows/desktop/bb787873) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]for more information.  
...
### Return Value  
 The current word wrapping and word breaking options. These options are described in [EM_SETWORDWRAPMODE](http://msdn.microsoft.com/library/windows/desktop/bb774294) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_HIDESELECTION](http://msdn.microsoft.com/library/windows/desktop/bb774210) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#18](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#18)]  
...
>  For the text limit, each OLE item counts as a single character.  
 ...
 For more information, see [EM_EXLIMITTEXT](http://msdn.microsoft.com/library/windows/desktop/bb788003) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#19](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#19)]  
...
### Remarks  
 ...
 For more information, see [EM_EXLINEFROMCHAR](http://msdn.microsoft.com/library/windows/desktop/bb788005) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#20](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#20)]  
...
### Remarks  
 ...
 For more information, see [EM_LINEINDEX](http://msdn.microsoft.com/library/windows/desktop/bb761611) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#21](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#21)]  
...
### Remarks  
 ...
 For more information, see [EM_LINELENGTH](http://msdn.microsoft.com/library/windows/desktop/bb761613) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_LINESCROLL](http://msdn.microsoft.com/library/windows/desktop/bb761615) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [WM_PASTE](http://msdn.microsoft.com/library/windows/desktop/ms649028) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#22](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#22)]  
...
### Remarks  
 ...
 For more information, see [EM_PASTESPECIAL](http://msdn.microsoft.com/library/windows/desktop/bb774214) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#23](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#23)]  
...
### Remarks  
 For more information, see [EM_REDO](http://msdn.microsoft.com/library/windows/desktop/bb774218) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_REPLACESEL](http://msdn.microsoft.com/library/windows/desktop/bb761633) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see the [EM_REQUESTRESIZE](http://msdn.microsoft.com/library/windows/desktop/bb774220) message and the **Bottomless Rich Edit Controls** section of [About Rich Edit Controls](http://msdn.microsoft.com/library/windows/desktop/bb787873) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 If enabled, the rich edit control will scan the text to determine if it matches a standard URL format. For a list of these URL formats, see [EM_AUTOURLDETECT](http://msdn.microsoft.com/library/windows/desktop/bb787991) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_SETBKGNDCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb774228) message and [COLORREF](http://msdn.microsoft.com/library/windows/desktop/dd183449) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#24](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#24)]  
...
### Remarks  
 ...
 For more information, see the [EM_SETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774230) message and the **CHARFORMAT** and **CHARFORMAT2** structures in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#25](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#25)]  
...
### Remarks  
 ...
 For more information, see [EM_SETEVENTMASK](http://msdn.microsoft.com/library/windows/desktop/bb774238) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#26](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#26)]  
...
### Remarks  
 ...
 For more information, see [EM_SETMODIFY](http://msdn.microsoft.com/library/windows/desktop/bb761651) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_SETOLECALLBACK](http://msdn.microsoft.com/library/windows/desktop/bb774252) message and [IRichEditOleCallback](http://msdn.microsoft.com/library/windows/desktop/bb774308) interface in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
- `ECO_VERTICAL` Draws text and objects in a vertical direction. Available for Asian languages only.  
 ...
 For more information, see [EM_SETOPTIONS](http://msdn.microsoft.com/library/windows/desktop/bb774254) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#27](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#27)]  
...
### Remarks  
 ...
 For more information, see the [EM_SETPARAFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774276) message and the **PARAFORMAT** and **PARAFORMAT2** structures in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#28](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#28)]  
...
### Parameters  
 `fType`  
 The punctuation flag. For a list of possible values, see the `fType` parameter for [EM_SETPUNCTUATION](http://msdn.microsoft.com/library/windows/desktop/bb774278) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_SETREADONLY](http://msdn.microsoft.com/library/windows/desktop/bb761655) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#29](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#29)]  
...
### Remarks  
 ...
 For more information, see [EM_SETRECT](http://msdn.microsoft.com/library/windows/desktop/bb761657) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#30](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#30)]  
...
- **SetSel(** `nStartChar` **,** `nEndChar` **)** This form use the parameters `nStartChar` and `nEndChar` to set the bounds.  
 ...
 For more information, see [EM_EXSETSEL](http://msdn.microsoft.com/library/windows/desktop/bb788007) message and [CHARRANGE](http://msdn.microsoft.com/library/windows/desktop/bb787885) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see the [EM_SETCHARFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb774230) and the **CHARFORMAT** and **CHARFORMAT2** structures in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#31](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#31)]  
...
### Remarks  
 ...
 For more information, see [EM_SETTARGETDEVICE](http://msdn.microsoft.com/library/windows/desktop/bb774282) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#32](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#32)]  
...
### Parameters  
 *fMode*  
 Specifies the new settings for the control's text mode and undo level parameters. For a list of the possible values, see the mode parameter for [EM_SETTEXTMODE](http://msdn.microsoft.com/library/windows/desktop/bb774286) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Return Value  
 Zero if successful, otherwise nonzero.  
  
### Remarks  
 For a description of the text modes, see **EM_SETTEXTMODE** in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#33](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#33)]  
...
### Parameters  
 `uFlags`  
 The options to set for word wrapping and word breaking. For a list of possible options, see [EM_SETWORDWRAPMODE](http://msdn.microsoft.com/library/windows/desktop/bb774294) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 For more information, see [EM_STOPGROUPTYPING](http://msdn.microsoft.com/library/windows/desktop/bb774300) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
- `SF_RTF` Indicates reading text and formatting.  
 ...
 For more information, see [EM_STREAMIN](http://msdn.microsoft.com/library/windows/desktop/bb774302) message and [EDITSTREAM](http://msdn.microsoft.com/library/windows/desktop/bb787891) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#34](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#34)]  
  
 [!code-cpp[NVC_MFC_CRichEditCtrl#35](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#35)]  
...
- `SF_TEXTIZED` Indicates writing text and formatting, with textual representations of OLE items.  
 ...
 For more information, see [EM_STREAMOUT](http://msdn.microsoft.com/library/windows/desktop/bb774304) message and [EDITSTREAM](http://msdn.microsoft.com/library/windows/desktop/bb787891) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CRichEditCtrl#36](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#36)]  
  
 [!code-cpp[NVC_MFC_CRichEditCtrl#37](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CRichEditCtrl/Cpp/RichEditDlg.cpp#37)]  
...
### Remarks  
 ...
 For more information, see [EM_UNDO](http://msdn.microsoft.com/library/windows/desktop/bb761670) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
