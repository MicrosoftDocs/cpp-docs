...
The latest version of this topic can be found at [CMouseManager Class](https://docs.microsoft.com/cpp/mfc/reference/cmousemanager-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_StateCollection#4](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_StateCollection/cpp/StateCollection.cpp#4)]  
