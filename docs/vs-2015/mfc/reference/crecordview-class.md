...
The latest version of this topic can be found at [CRecordView Class](https://docs.microsoft.com/cpp/mfc/reference/crecordview-class).  
...
### Example  
 [!code-cpp[NVC_MFCDatabase#32](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCDatabase/Cpp/MyRecordView.cpp#32)]  
