...
The latest version of this topic can be found at [CMFCColorButton Class](https://docs.microsoft.com/cpp/mfc/reference/cmfccolorbutton-class).  
...
## Example  
 The following example demonstrates how to configure a color button by using various methods in the `CMFCColorButton` class. The methods set the color of the color button and its number of columns, and enable the automatic and the other buttons. This example is part of the [Status Bar Demo sample](../../top/visual-cpp-samples.md).  
  
 [!code-cpp[NVC_MFC_StatusBarDemo#10](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_StatusBarDemo/cpp/StatusBarDemoView.h#10)]  
[!code-cpp[NVC_MFC_StatusBarDemo#11](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_StatusBarDemo/cpp/StatusBarDemoView.cpp#11)]  
