...
The latest version of this topic can be found at [Standard Command and Window IDs](https://docs.microsoft.com/cpp/mfc/reference/standard-command-and-window-ids).  
...
>  The header file Afxres.h is indirectly included in Afxwin.h. You must explicitly include the following statement in your application's resource script (.rc) file:  
 ...
 [!code-cpp[NVC_MFC_Utilities#47](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/stdafx.h#47)]  
