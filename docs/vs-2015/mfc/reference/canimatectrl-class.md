...
The latest version of this topic can be found at [CAnimateCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/canimatectrl-class).  
...
### Example  
 [!code-cpp[NVC_MFCControlLadenDialog#56](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/AnimDlg.cpp#56)]  
...
### Parameters  
 `dwStyle`  
 Specifies the animation control's style. Apply any combination of the windows styles described in the Remarks section below and the animation control styles described in [Animation Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb761886) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
- **WS_DISABLED** Rarely  
 ...
 In addition to the window styles listed above, you may want to apply one or more of the animation control styles to an animation control. See the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more information on [animation control styles](http://msdn.microsoft.com/library/windows/desktop/bb761886).  
...
### Parameters  
 ...
 `dwStyle`  
 Specifies the animation control's style. Apply any combination of the window and animation control styles described in [Animation Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb761886) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [ACM_ISPLAYING](http://msdn.microsoft.com/library/windows/desktop/bb761895) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
