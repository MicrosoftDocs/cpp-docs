...
The latest version of this topic can be found at [CMFCTabDropTarget Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctabdroptarget-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#39](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#39)]  
