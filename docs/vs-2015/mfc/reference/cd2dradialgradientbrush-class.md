...
The latest version of this topic can be found at [CD2DRadialGradientBrush Class](https://docs.microsoft.com/cpp/mfc/reference/cd2dradialgradientbrush-class).  
