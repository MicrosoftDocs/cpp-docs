...
The latest version of this topic can be found at [CMFCDesktopAlertWndInfo Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcdesktopalertwndinfo-class).  
