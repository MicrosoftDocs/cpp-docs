...
The latest version of this topic can be found at [COleDocObjectItem Class](https://docs.microsoft.com/cpp/mfc/reference/coledocobjectitem-class).  
...
### Return Value  
 For a complete listing of return values, see [IOleCommandTarget::QueryStatus](http://msdn.microsoft.com/library/windows/desktop/ms688491) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Remarks  
 This member function emulates the functionality of the [IOleCommandTarget::QueryStatus](http://msdn.microsoft.com/library/windows/desktop/ms688491) method, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
