...
The latest version of this topic can be found at [Application Control](https://docs.microsoft.com/cpp/mfc/reference/application-control).  
...
### Example  
 [!code-cpp[NVC_MFCAutomation#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAutomation/Cpp/MainFrm.cpp#2)]  
...
### Example  
 [!code-cpp[NVC_MFCAutomation#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAutomation/Cpp/MainFrm.cpp#3)]  
  
 [!code-cpp[NVC_MFCAutomation#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAutomation/Cpp/CMFCAutomation.cpp#4)]  
...
### Example  
 [!code-cpp[NVC_MFCAutomation#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAutomation/Cpp/CMFCAutomationDoc.cpp#5)]  
