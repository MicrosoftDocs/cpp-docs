...
The latest version of this topic can be found at [CUserException Class](https://docs.microsoft.com/cpp/mfc/reference/cuserexception-class).  
...
## Remarks  
 ...
 [!code-cpp[NVC_MFCExceptions#24](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCExceptions/Cpp/MFCExceptions.cpp#24)]  
