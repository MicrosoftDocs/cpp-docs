...
The latest version of this topic can be found at [CBasePane Class](https://docs.microsoft.com/cpp/mfc/reference/cbasepane-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_WordPad#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_WordPad/cpp/mainfrm.cpp#2)]  
