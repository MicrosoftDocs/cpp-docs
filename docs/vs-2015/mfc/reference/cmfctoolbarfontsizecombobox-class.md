...
The latest version of this topic can be found at [CMFCToolBarFontSizeComboBox Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctoolbarfontsizecombobox-class).  
