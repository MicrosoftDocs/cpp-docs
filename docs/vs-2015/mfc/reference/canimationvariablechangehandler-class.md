...
The latest version of this topic can be found at [CAnimationVariableChangeHandler Class](https://docs.microsoft.com/cpp/mfc/reference/canimationvariablechangehandler-class).  
