...
The latest version of this topic can be found at [CMemoryState Structure](https://docs.microsoft.com/cpp/mfc/reference/cmemorystate-structure).  
...
### Example  
 [!code-cpp[NVC_MFC_Utilities#18](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/NVC_MFC_Utilities.cpp#18)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_Utilities#40](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/NVC_MFC_Utilities.cpp#40)]  
  
 In the `InitInstance` function, add the line:  
  
 [!code-cpp[NVC_MFC_Utilities#41](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/NVC_MFC_Utilities.cpp#41)]  
  
 Add a handler for the `ExitInstance` function and use the following code:  
  
 [!code-cpp[NVC_MFC_Utilities#42](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/NVC_MFC_Utilities.cpp#42)]  
