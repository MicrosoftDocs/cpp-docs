...
The latest version of this topic can be found at [CHeaderCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cheaderctrl-class).  
...
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#1)]  
...
### Remarks  
 This method implements the behavior of the Win32 message [HDM_CLEARFILTER](http://msdn.microsoft.com/library/windows/desktop/bb775306) with a column value of –1, as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#2)]  
...
### Remarks  
 This method implements the behavior of the Win32 message [HDM_CLEARFILTER](http://msdn.microsoft.com/library/windows/desktop/bb775306), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#3)]  
...
### Parameters  
 `dwStyle`  
 Specifies the header control's style. For a description of header control styles, see [Header Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775241) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#4)]  
...
### Parameters  
 ...
 `dwStyle`  
 The header control's style. For a description of header control styles, see [Header Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775241) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. See [Create](#cheaderctrl__create) for a list of additional styles.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_CREATEDRAGIMAGE](http://msdn.microsoft.com/library/windows/desktop/bb775308), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. It is provided to support header item drag and drop.  
...
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#5)]  
...
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#6)]  
...
### Remarks  
 This method implements the behavior of the Win32 message [HDM_EDITFILTER](http://msdn.microsoft.com/library/windows/desktop/bb775312), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#7)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_GETBITMAPMARGIN](http://msdn.microsoft.com/library/windows/desktop/bb775314), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#8)]  
...
### Remarks  
 This method sends the [HDM_GETFOCUSEDITEM](http://msdn.microsoft.com/library/windows/desktop/bb775330) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CHeaderCtrl_s4#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl_s4/cpp/NVC_MFC_CHeaderCtrl_s4Dlg.h#6)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CHeaderCtrl_s4#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl_s4/cpp/NVC_MFC_CHeaderCtrl_s4Dlg.cpp#4)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_GETIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb775332), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The `CImageList` object to which the returned pointer points is a temporary object and is deleted in the next idle-time processing.  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#9)]  
...
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#10](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#10)]  
...
### Remarks  
 This method sends the [HDM_GETITEMDROPDOWNRECT](http://msdn.microsoft.com/library/windows/desktop/bb775339) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CHeaderCtrl_s4#2](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl_s4/cpp/NVC_MFC_CHeaderCtrl_s4Dlg.cpp#2)]  
...
### Remarks  
 This method implements the behavior of the Win32 message [HDM_GETITEMRECT](http://msdn.microsoft.com/library/windows/desktop/bb775341), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_GETORDERARRAY](http://msdn.microsoft.com/library/windows/desktop/bb775343), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. It is provided to support header item ordering.  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#11)]  
...
### Remarks  
 ...
 This method sends the [HDM_GETOVERFLOWRECT](http://msdn.microsoft.com/library/windows/desktop/bb775345) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CHeaderCtrl_s4#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl_s4/cpp/NVC_MFC_CHeaderCtrl_s4Dlg.cpp#3)]  
...
### Remarks  
 This method sends the [HDM_HITTEST](http://msdn.microsoft.com/library/windows/desktop/bb775349) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CHeaderCtrl_s4#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl_s4/cpp/NVC_MFC_CHeaderCtrl_s4Dlg.cpp#1)]  
...
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#12](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#12)]  
...
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#13](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#13)]  
...
### Remarks  
 This member function implements the behavior of the Win32 macro [HDM_ORDERTOINDEX](http://msdn.microsoft.com/library/windows/desktop/bb775355), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. It is provided to support header item ordering.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_SETBITMAPMARGIN](http://msdn.microsoft.com/library/windows/desktop/bb775357), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#14](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#14)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_SETFILTERCHANGETIMEOUT](http://msdn.microsoft.com/library/windows/desktop/bb775359), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#15](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#15)]  
...
### Remarks  
 This method sends the [HDM_SETFOCUSEDITEM](http://msdn.microsoft.com/library/windows/desktop/bb775361) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_SETHOTDIVIDER](http://msdn.microsoft.com/library/windows/desktop/bb775363), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. It is provided to support header item drag and drop.  
  
### Example  
 [!code-cpp[NVC_MFC_CHeaderCtrl#16](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CHeaderCtrl/Cpp/HeaderDlg.cpp#16)]  
...
### Remarks  
 This member function implements the behavior of the Win32 message [HDM_SETIMAGELIST](http://msdn.microsoft.com/library/windows/desktop/bb775365), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The `CImageList` object to which the returned pointer points is a temporary object and is deleted in the next idle-time processing.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro [HDM_SETORDERARRAY](http://msdn.microsoft.com/library/windows/desktop/bb775369), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. It is provided to support header item ordering.  
