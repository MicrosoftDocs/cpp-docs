...
The latest version of this topic can be found at [COleTemplateServer Class](https://docs.microsoft.com/cpp/mfc/reference/coletemplateserver-class).  
