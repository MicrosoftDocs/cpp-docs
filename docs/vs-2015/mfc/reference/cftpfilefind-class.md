...
The latest version of this topic can be found at [CFtpFileFind Class](https://docs.microsoft.com/cpp/mfc/reference/cftpfilefind-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFCWinInet#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/FtpFile.cpp#8)]  
