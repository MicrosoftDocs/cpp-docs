...
The latest version of this topic can be found at [CSinusoidalTransitionFromRange Class](https://docs.microsoft.com/cpp/mfc/reference/csinusoidaltransitionfromrange-class).  
