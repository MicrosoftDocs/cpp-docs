...
The latest version of this topic can be found at [CHttpFile Class](https://docs.microsoft.com/cpp/mfc/reference/chttpfile-class).  
...
### Parameters  
 `dwFlags`  
 Flags describing the operation. For a list of the appropriate flags, see [HttpEndRequest](http://msdn.microsoft.com/library/windows/desktop/aa384230) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
 ...
 *dwTotalLen*  
 ...
 `dwFlags`  
 Flags describing the operation. For a list of appropriate flags, see [HttpSendRequestEx](http://msdn.microsoft.com/library/windows/desktop/aa384318) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]*.*  
...
### Example  
 ...
 [!code-cpp[NVC_MFCWinInet#9](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFCWinInet/Cpp/HttpFile.cpp#9)]  
