...
The latest version of this topic can be found at [CMFCTabCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctabctrl-class).  
...
-   Detachable tabbed windows.  
 ...
 The `CMFCTabCtrl` class can be used with a dialog box, but is intended for applications that use docking control bars like [!INCLUDE[ofprexcel](../../includes/ofprexcel-md.md)] and [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)]. For more information, see [CDockablePane Class](../../mfc/reference/cdockablepane-class.md).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_StateCollection#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_StateCollection/cpp/OutputBar.h#1)]  
[!code-cpp[NVC_MFC_StateCollection#3](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_StateCollection/cpp/OutputBar.cpp#3)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_StateCollection#1](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_StateCollection/cpp/OutputBar.h#1)]  
[!code-cpp[NVC_MFC_StateCollection#2](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_StateCollection/cpp/OutputBar.cpp#2)]  
