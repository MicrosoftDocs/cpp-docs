...
The latest version of this topic can be found at [CMFCTasksPane Class](https://docs.microsoft.com/cpp/mfc/reference/cmfctaskspane-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#28](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#28)]  
