...
The latest version of this topic can be found at [CPagerCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cpagerctrl-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CSplitButton_s2#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CSplitButton_s2/cpp/CSplitButton_s2/CSplitButton_s2Dlg.cpp#1)]  
...
### Remarks  
 This method sends the [PGM_FORWARDMOUSE](http://msdn.microsoft.com/library/windows/desktop/bb760867) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PGM_GETBORDER](http://msdn.microsoft.com/library/windows/desktop/bb760869) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CSplitButton_s2#5](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CSplitButton_s2/cpp/CSplitButton_s2/CSplitButton_s2Dlg.cpp#5)]  
...
### Remarks  
 This method sends the [PGM_GETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760868) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CSplitButton_s2#4](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CSplitButton_s2/cpp/CSplitButton_s2/CSplitButton_s2Dlg.cpp#4)]  
...
### Remarks  
 This method sends the [PGM_GETBUTTONSIZE](http://msdn.microsoft.com/library/windows/desktop/bb760870) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PGM_GETBUTTONSTATE](http://msdn.microsoft.com/library/windows/desktop/bb760871) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 This method sends the [PGM_GETDROPTARGET](http://msdn.microsoft.com/library/windows/desktop/bb760872) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. The caller of this method is responsible for calling the `Release` member of the [IDropTarget](http://msdn.microsoft.com/library/windows/desktop/ms679679) interface when the interface is no longer needed.  
...
### Remarks  
 This method sends the [PGM_GETPOS](http://msdn.microsoft.com/library/windows/desktop/bb760874) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CSplitButton_s2#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CSplitButton_s2/cpp/CSplitButton_s2/CSplitButton_s2Dlg.cpp#7)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CSplitButton_s2#6](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CSplitButton_s2/cpp/CSplitButton_s2/CSplitButton_s2Dlg.cpp#6)]  
...
### Remarks  
 This method sends the [PGM_RECALCSIZE](http://msdn.microsoft.com/library/windows/desktop/bb760876) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. Consequently, the pager control sends the [PGN_CALCSIZE](http://msdn.microsoft.com/library/windows/desktop/bb760864) notification to obtain the scrollable dimensions of the contained window.  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CSplitButton_s2#3](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CSplitButton_s2/cpp/CSplitButton_s2/CSplitButton_s2Dlg.cpp#3)]  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_CSplitButton_s2#8](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_CSplitButton_s2/cpp/CSplitButton_s2/MyPagerCtrl.cpp#8)]  
...
### Remarks  
 This method sends the [PGM_SETBKCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb760878) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PGM_SETBORDER](http://msdn.microsoft.com/library/windows/desktop/bb760880) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PGM_SETBUTTONSIZE](http://msdn.microsoft.com/library/windows/desktop/bb760886) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PGM_SETCHILD](http://msdn.microsoft.com/library/windows/desktop/bb760884) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 This method sends the [PGM_SETPOS](http://msdn.microsoft.com/library/windows/desktop/bb760886) message, which is described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
