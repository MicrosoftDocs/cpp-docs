...
The latest version of this topic can be found at [CDockingPanesRow Class](https://docs.microsoft.com/cpp/mfc/reference/cdockingpanesrow-class).  
...
## Example  
 ...
 [!code-cpp[NVC_MFC_RibbonApp#26](../../snippets/cpp/VS_Snippets_Misc/NVC_MFC_RibbonApp/cpp/MainFrm.cpp#26)]  
