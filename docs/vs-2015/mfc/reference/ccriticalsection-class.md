...
The latest version of this topic can be found at [CCriticalSection Class](https://docs.microsoft.com/cpp/mfc/reference/ccriticalsection-class).  
...
### Example  
 ...
 [!code-cpp[NVC_MFC_Utilities#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_Utilities/Cpp/MyClass.h#11)]  
