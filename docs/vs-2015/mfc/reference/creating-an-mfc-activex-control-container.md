...
The latest version of this topic can be found at [Creating an MFC ActiveX Control Container](https://docs.microsoft.com/cpp/mfc/reference/creating-an-mfc-activex-control-container).  
