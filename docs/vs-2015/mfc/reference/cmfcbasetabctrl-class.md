...
The latest version of this topic can be found at [CMFCBaseTabCtrl Class](https://docs.microsoft.com/cpp/mfc/reference/cmfcbasetabctrl-class).  
...
## Remarks  
 ...
 Starting with [!INCLUDE[vs_dev14](../../includes/vs-dev14-md.md)], this class supports Microsoft Active Accessibility.  
