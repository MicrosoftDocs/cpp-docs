...
The latest version of this topic can be found at [Control Names, MFC ActiveX Control Wizard](https://docs.microsoft.com/cpp/mfc/reference/control-names-mfc-activex-control-wizard).  
