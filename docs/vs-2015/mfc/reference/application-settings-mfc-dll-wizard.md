...
The latest version of this topic can be found at [Application Settings, MFC DLL Wizard](https://docs.microsoft.com/cpp/mfc/reference/application-settings-mfc-dll-wizard).  
