...
The latest version of this topic can be found at [CGopherConnection Class](https://docs.microsoft.com/cpp/mfc/reference/cgopherconnection-class).  
 ...
 *dwGopherType*  
 This specifies whether `pstrSelectorString` refers to a directory or document, and whether the request is gopher or gopher+. See the attributes for the structure [GOPHER_FIND_DATA](http://msdn.microsoft.com/library/windows/desktop/aa384215) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
