...
### [Frame-Window Styles](frame-window-styles-mfc.md)
...
## [Message Maps](message-maps-mfc.md)
### [Message Map Macros](message-map-macros-mfc.md)
...
## [MFC Class](adding-an-mfc-class.md)
...
## [MFC Class from a Type Library](adding-an-mfc-class-from-a-type-library.md)
### [Add Class from Typelib Wizard](add-class-from-typelib-wizard.md)
## [MFC Message Handler](adding-an-mfc-message-handler.md)
...
## [MFC ODBC Consume](adding-an-mfc-odbc-consumer.md)
### [MFC ODBC Consumer Wizard](mfc-odbc-consumer-wizard.md)
## [ATL Support in an MFC Project](adding-atl-support-to-your-mfc-project.md)
