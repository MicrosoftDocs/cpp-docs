...
The latest version of this topic can be found at [Creating a Modeless Property Sheet](https://docs.microsoft.com/cpp/mfc/creating-a-modeless-property-sheet).  
