...
The latest version of this topic can be found at [Processing Notification Messages in Month Calendar Controls](https://docs.microsoft.com/cpp/mfc/processing-notification-messages-in-month-calendar-controls).  
