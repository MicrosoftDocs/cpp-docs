...
The latest version of this topic can be found at [Providing Windowless Activation](https://docs.microsoft.com/cpp/mfc/providing-windowless-activation).  
...
[!code-cpp[NVC_MFC_AxOpt#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxOpt/Cpp/MyAxOptCtrl.cpp#6)]  
...
-   [GetClientRect](../mfc/reference/colecontrol-class.md#getclientrect)  
 ...
 [!code-cpp[NVC_MFC_AxOpt#8](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxOpt/Cpp/MyAxOptCtrl.cpp#8)]  
