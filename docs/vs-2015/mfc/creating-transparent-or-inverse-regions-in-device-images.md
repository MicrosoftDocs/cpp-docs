...
The latest version of this topic can be found at [Creating Transparent or Inverse Regions in Device Images (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/creating-transparent-or-inverse-regions-in-device-images).  
