...
The latest version of this topic can be found at [ActiveX Control Containers: Viewing and Modifying Control Properties](https://docs.microsoft.com/cpp/mfc/activex-control-containers-viewing-and-modifying-control-properties).  
