...
The latest version of this topic can be found at [Switching Between Dialog Box Controls and Code](https://docs.microsoft.com/cpp/windows/switching-between-dialog-box-controls-and-code).  
