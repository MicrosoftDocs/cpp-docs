...
The latest version of this topic can be found at [TN020: ID Naming and Numbering Conventions](https://docs.microsoft.com/cpp/mfc/tn020-id-naming-and-numbering-conventions).  
