...
The latest version of this topic can be found at [MFC ActiveX Controls: Adding Stock Events to an ActiveX Control](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-adding-stock-events-to-an-activex-control).  
...
##  <a name="_core_classwizard_changes_for_stock_events"></a> Add Event Wizard Changes for Stock Events  
 ...
 [!code-cpp[NVC_MFC_AxUI#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.cpp#5)]  
 ...
 [!code-cpp[NVC_MFC_AxUI#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/NVC_MFC_AxUI.idl#6)]  
