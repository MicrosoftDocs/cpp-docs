...
The latest version of this topic can be found at [Security Implications of Customization](https://docs.microsoft.com/cpp/mfc/security-implications-of-customization).  
