...
The latest version of this topic can be found at [Manipulating the Tool Tip Control](https://docs.microsoft.com/cpp/mfc/manipulating-the-tool-tip-control).  
...
-   [GetTipTextColor](../mfc/reference/ctooltipctrl-class.md#gettiptextcolor) and [SetTipTextColor](../mfc/reference/ctooltipctrl-class.md#settiptextcolor) Retrieves and sets the text color of the tool tip window.  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#41](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#41)]  
