...
The latest version of this topic can be found at [Document Templates and the Document-View Creation Process](https://docs.microsoft.com/cpp/mfc/document-templates-and-the-document-view-creation-process).  
