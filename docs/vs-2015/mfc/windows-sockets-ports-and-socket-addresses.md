...
The latest version of this topic can be found at [Windows Sockets: Ports and Socket Addresses](https://docs.microsoft.com/cpp/mfc/windows-sockets-ports-and-socket-addresses).  
