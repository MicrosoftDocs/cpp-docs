...
The latest version of this topic can be found at [Viewing and Adding ActiveX Controls to a Dialog Box](https://docs.microsoft.com/cpp/windows/viewing-and-adding-activex-controls-to-a-dialog-box).  
...
1.  In the [Insert ActiveX Control dialog box](../mfc/insert-activex-control-dialog-box.md), select the control you want to add to your dialog box and click **OK**.  
    ...
    > [!NOTE]
    >  You can add ActiveX controls to the [Toolbox window](http://msdn.microsoft.com/library/b754dad3-1f32-464f-8b9f-065e17e0bc22). For more information, see [Managing Items and Tabs in the Toolbox](http://msdn.microsoft.com/en-us/21285050-cadd-455a-b1f5-a2289a89c4db).  
