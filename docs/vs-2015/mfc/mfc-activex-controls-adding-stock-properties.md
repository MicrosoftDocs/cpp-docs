...
The latest version of this topic can be found at [MFC ActiveX Controls: Adding Stock Properties](https://docs.microsoft.com/cpp/mfc/mfc-activex-controls-adding-stock-properties).  
...
##  <a name="_core_classwizard_changes_for_stock_properties"></a> Add Property Wizard Changes for Stock Properties  
 ...
 [!code-cpp[NVC_MFC_AxUI#22](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.cpp#22)]  
  
 The following line is added to your control's interface description (.IDL) file:  
  
 [!code-cpp[NVC_MFC_AxUI#23](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/NVC_MFC_AxUI.idl#23)]  
...
##  <a name="_core_color_properties"></a> Color Properties  
 ...
 [!code-cpp[NVC_MFC_AxUI#24](../snippets/cpp/VS_Snippets_Cpp/NVC_MFC_AxUI/Cpp/MyAxUICtrl.cpp#24)]  
