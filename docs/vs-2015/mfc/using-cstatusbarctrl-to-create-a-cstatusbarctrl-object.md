...
The latest version of this topic can be found at [Using CStatusBarCtrl to Create a CStatusBarCtrl Object](https://docs.microsoft.com/cpp/mfc/using-cstatusbarctrl-to-create-a-cstatusbarctrl-object).  
