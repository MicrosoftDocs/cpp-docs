...
The latest version of this topic can be found at [Message Handling and Command Targets](https://docs.microsoft.com/cpp/mfc/message-handling-and-command-targets).  
