...
The latest version of this topic can be found at [Using Callback Fields in a Date and Time Picker Control](https://docs.microsoft.com/cpp/mfc/using-callback-fields-in-a-date-and-time-picker-control).  
...
## Handling the DTN_FORMATQUERY Notification  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#8](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#8)]  
...
## Handling the DTN_FORMAT Notification  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#9](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/MFCControlLadenDialogDlg.cpp#9)]  
