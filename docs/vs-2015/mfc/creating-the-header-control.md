...
The latest version of this topic can be found at [Creating the Header Control](https://docs.microsoft.com/cpp/mfc/creating-the-header-control).  
...
4.  Use the Properties window to map handler functions in the view class for any header-control notification messages you need to handle (see [Mapping Messages to Functions](../mfc/reference/mapping-messages-to-functions.md)).  
 ...
 For more information, see [Creating a Header Control](http://msdn.microsoft.com/library/windows/desktop/bb775238) in the [!INCLUDE[winSDK](../includes/winsdk-md.md)].  
