...
The latest version of this topic can be found at [Upgrading an Existing ActiveX Control](https://docs.microsoft.com/cpp/mfc/upgrading-an-existing-activex-control).  
