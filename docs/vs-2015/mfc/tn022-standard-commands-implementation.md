...
The latest version of this topic can be found at [TN022: Standard Commands Implementation](https://docs.microsoft.com/cpp/mfc/tn022-standard-commands-implementation).  
