...
The latest version of this topic can be found at [Two Ways to Create a CArchive Object](https://docs.microsoft.com/cpp/mfc/two-ways-to-create-a-carchive-object).  
...
2.  Pass the `CFile` object to the constructor for `CArchive`, as shown in the following example:  
     ...
     [!code-cpp[NVC_MFCSerialization#5](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSerialization/Cpp/MFCSerialization.cpp#5)]  
...
1.  The following example illustrates how to close the `CArchive` object:  
     ...
     [!code-cpp[NVC_MFCSerialization#6](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCSerialization/Cpp/MFCSerialization.cpp#6)]  
