...
The latest version of this topic can be found at [File Menu in an MFC Database Application](https://docs.microsoft.com/cpp/mfc/file-menu-in-an-mfc-database-application).  
