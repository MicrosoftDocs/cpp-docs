...
The latest version of this topic can be found at [Adding Controls By Hand](https://docs.microsoft.com/cpp/mfc/adding-controls-by-hand).  
...
You can either [add controls to a dialog box with the dialog editor](../mfc/using-the-dialog-editor-to-add-controls.md) or add them yourself, with code.  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/CustomDialog.h#1)]  
 ...
 [!code-cpp[NVC_MFCControlLadenDialog#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCControlLadenDialog/Cpp/CustomDialog.cpp#2)]  
