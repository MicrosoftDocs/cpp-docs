...
The latest version of this topic can be found at [Adding, Editing, or Deleting Controls](https://docs.microsoft.com/cpp/windows/adding-editing-or-deleting-controls).  
