...
The latest version of this topic can be found at [Insert ActiveX Control Dialog Box](https://docs.microsoft.com/cpp/windows/insert-activex-control-dialog-box).  
