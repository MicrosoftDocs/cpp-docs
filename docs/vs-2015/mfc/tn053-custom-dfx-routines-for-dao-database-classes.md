...
The latest version of this topic can be found at [TN053: Custom DFX Routines for DAO Database Classes](https://docs.microsoft.com/cpp/mfc/tn053-custom-dfx-routines-for-dao-database-classes).  
