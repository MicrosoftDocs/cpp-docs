...
The latest version of this topic can be found at [Automation Servers](https://docs.microsoft.com/cpp/mfc/automation-servers).  
...
##  <a name="_core_support_for_automation_servers"></a> Support for Automation Servers  
 ...
 [!code-cpp[NVC_MFCAutomation#1](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCAutomation/Cpp/MyServerDoc.cpp#1)]  
