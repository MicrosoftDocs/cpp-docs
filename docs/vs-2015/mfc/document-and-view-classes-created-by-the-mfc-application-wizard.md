...
The latest version of this topic can be found at [Document and View Classes Created by the MFC Application Wizard](https://docs.microsoft.com/cpp/mfc/document-and-view-classes-created-by-the-mfc-application-wizard).  
