...
The latest version of this topic can be found at [Adding Items to the Header Control](https://docs.microsoft.com/cpp/mfc/adding-items-to-the-header-control).  
...
3.  Repeat steps 1 and 2 for additional items.  
 ...
 For more information, see [Adding an Item to a Header Control](http://msdn.microsoft.com/library/windows/desktop/bb775238) in the [!INCLUDE[winSDK](../includes/winsdk-md.md)].  
