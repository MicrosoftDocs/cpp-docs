...
The latest version of this topic can be found at [Clipboard: Using the Windows Clipboard](https://docs.microsoft.com/cpp/mfc/clipboard-using-the-windows-clipboard).  
...
This topic describes how to use the standard Windows Clipboard API within your MFC application.  
 ...
 [!code-cpp[NVC_MFCListView#2](../snippets/cpp/VS_Snippets_Cpp/NVC_MFCListView/Cpp/MyListView.cpp#2)]  
