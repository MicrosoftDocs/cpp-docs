...
The latest version of this topic can be found at [Upgrading Projects from Earlier Versions of Visual C++](https://docs.microsoft.com/cpp/porting/upgrading-projects-from-earlier-versions-of-visual-cpp).  
