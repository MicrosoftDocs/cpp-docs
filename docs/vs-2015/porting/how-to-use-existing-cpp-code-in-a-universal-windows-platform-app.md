...
The latest version of this topic can be found at [How to: Use Existing C++ Code in a Universal Windows Platform App](https://docs.microsoft.com/cpp/porting/how-to-use-existing-cpp-code-in-a-universal-windows-platform-app).  
