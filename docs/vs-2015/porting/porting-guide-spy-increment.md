...
The latest version of this topic can be found at [Porting Guide: Spy++](https://docs.microsoft.com/cpp/porting/porting-guide-spy-increment).  
...
```  
 ...
 Windows XP is no longer supported by Microsoft, so even though targeting it is allowed in [!INCLUDE[vs_dev14](../includes/vs-dev14-md.md)], you should be phasing out support for it in your applications, and encouraging your users to adopt new versions of Windows.  
