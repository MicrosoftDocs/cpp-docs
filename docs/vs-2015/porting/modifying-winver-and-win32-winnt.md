...
The latest version of this topic can be found at [Modifying WINVER and _WIN32_WINNT](https://docs.microsoft.com/cpp/porting/modifying-winver-and-win32-winnt).  
