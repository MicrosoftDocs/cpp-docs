...
The latest version of this topic can be found at [Jumping to Labels in Inline Assembly](https://docs.microsoft.com/cpp/assembler/inline/jumping-to-labels-in-inline-assembly).  
