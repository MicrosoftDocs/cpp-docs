...
The latest version of this topic can be found at [Using and Preserving Registers in Inline Assembly](https://docs.microsoft.com/cpp/assembler/inline/using-and-preserving-registers-in-inline-assembly).  
