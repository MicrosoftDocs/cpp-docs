...
The latest version of this topic can be found at [Defining __asm Blocks as C Macros](https://docs.microsoft.com/cpp/assembler/inline/defining-asm-blocks-as-c-macros).  
