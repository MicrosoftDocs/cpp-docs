...
The latest version of this topic can be found at [Using Assembly Language in __asm Blocks](https://docs.microsoft.com/cpp/assembler/inline/using-assembly-language-in-asm-blocks).  
