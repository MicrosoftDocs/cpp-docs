...
The latest version of this topic can be found at [Using C or C++ Symbols in __asm Blocks](https://docs.microsoft.com/cpp/assembler/inline/using-c-or-cpp-symbols-in-asm-blocks).  
