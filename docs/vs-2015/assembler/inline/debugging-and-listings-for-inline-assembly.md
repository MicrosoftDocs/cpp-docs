...
The latest version of this topic can be found at [Debugging and Listings for Inline Assembly](https://docs.microsoft.com/cpp/assembler/inline/debugging-and-listings-for-inline-assembly).  
