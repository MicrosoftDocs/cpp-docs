...
The latest version of this topic can be found at [Using C or C++ in __asm Blocks](https://docs.microsoft.com/cpp/assembler/inline/using-c-or-cpp-in-asm-blocks).  
