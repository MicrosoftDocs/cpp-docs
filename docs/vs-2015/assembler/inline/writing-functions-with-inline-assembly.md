...
The latest version of this topic can be found at [Writing Functions with Inline Assembly](https://docs.microsoft.com/cpp/assembler/inline/writing-functions-with-inline-assembly).  
