...
The latest version of this topic can be found at [Using Operators in __asm Blocks](https://docs.microsoft.com/cpp/assembler/inline/using-operators-in-asm-blocks).  
