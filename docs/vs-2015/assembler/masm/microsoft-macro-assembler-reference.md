...
The latest version of this topic can be found at [Microsoft Macro Assembler Reference](https://docs.microsoft.com/cpp/assembler/masm/microsoft-macro-assembler-reference).  
...
## In This Section  
 ...
 Information about how to create output files for [!INCLUDE[vcprx64](../../includes/vcprx64-md.md)].  
