...
The latest version of this topic can be found at [ML and ML64 Command-Line Reference](https://docs.microsoft.com/cpp/assembler/masm/ml-and-ml64-command-line-reference).  
