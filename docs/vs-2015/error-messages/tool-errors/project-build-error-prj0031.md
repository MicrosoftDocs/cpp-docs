...
The latest version of this topic can be found at [Project Build Error PRJ0031](https://docs.microsoft.com/cpp/error-messages/tool-errors/project-build-error-prj0031).  
