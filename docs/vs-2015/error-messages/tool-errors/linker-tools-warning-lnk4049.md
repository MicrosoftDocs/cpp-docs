...
The latest version of this topic can be found at [Linker Tools Warning LNK4049](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-warning-lnk4049).  
