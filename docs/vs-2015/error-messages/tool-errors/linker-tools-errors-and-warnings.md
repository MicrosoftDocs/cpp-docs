...
The latest version of this topic can be found at [Linker Tools Errors and Warnings](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-errors-and-warnings).  
