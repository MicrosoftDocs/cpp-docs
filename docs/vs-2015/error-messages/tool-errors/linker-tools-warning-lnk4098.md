...
The latest version of this topic can be found at [Linker Tools Warning LNK4098](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-warning-lnk4098).  
