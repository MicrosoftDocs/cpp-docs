...
The latest version of this topic can be found at [Resource Compiler Error RW2002](https://docs.microsoft.com/cpp/error-messages/tool-errors/resource-compiler-error-rw2002).  
