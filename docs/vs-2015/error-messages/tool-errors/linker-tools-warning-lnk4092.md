...
The latest version of this topic can be found at [Linker Tools Warning LNK4092](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-warning-lnk4092).  
