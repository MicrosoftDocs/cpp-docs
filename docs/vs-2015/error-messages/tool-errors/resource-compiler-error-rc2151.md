...
The latest version of this topic can be found at [Resource Compiler Error RC2151](https://docs.microsoft.com/cpp/error-messages/tool-errors/resource-compiler-error-rc2151).  
