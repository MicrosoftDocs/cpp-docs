...
The latest version of this topic can be found at [Linker Tools Error LNK1306](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-error-lnk1306).  
