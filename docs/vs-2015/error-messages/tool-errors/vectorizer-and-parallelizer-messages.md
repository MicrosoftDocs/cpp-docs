...
The latest version of this topic can be found at [Vectorizer and Parallelizer Messages](https://docs.microsoft.com/cpp/error-messages/tool-errors/vectorizer-and-parallelizer-messages).  
