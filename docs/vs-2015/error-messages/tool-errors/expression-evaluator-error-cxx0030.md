...
The latest version of this topic can be found at [Expression Evaluator Error CXX0030](https://docs.microsoft.com/cpp/error-messages/tool-errors/expression-evaluator-error-cxx0030).  
