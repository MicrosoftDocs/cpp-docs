...
The latest version of this topic can be found at [Global Constants in C++](https://docs.microsoft.com/cpp/error-messages/tool-errors/global-constants-in-cpp).  
