...
The latest version of this topic can be found at [BSCMAKE Warning BK4502](https://docs.microsoft.com/cpp/error-messages/tool-errors/bscmake-warning-bk4502).  
