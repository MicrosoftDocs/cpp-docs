...
The latest version of this topic can be found at [Command-Line Warning D9041](https://docs.microsoft.com/cpp/error-messages/tool-errors/command-line-warning-d9041).  
