...
The latest version of this topic can be found at [Resource Compiler Fatal Error RC1052](https://docs.microsoft.com/cpp/error-messages/tool-errors/resource-compiler-fatal-error-rc1052).  
