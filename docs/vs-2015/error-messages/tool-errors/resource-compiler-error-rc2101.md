...
The latest version of this topic can be found at [Resource Compiler Error RC2101](https://docs.microsoft.com/cpp/error-messages/tool-errors/resource-compiler-error-rc2101).  
