...
The latest version of this topic can be found at [Linker Tools Warning LNK4222](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-warning-lnk4222).  
