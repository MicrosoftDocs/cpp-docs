...
The latest version of this topic can be found at [Missing Function Body or Variable](https://docs.microsoft.com/cpp/error-messages/tool-errors/missing-function-body-or-variable).  
