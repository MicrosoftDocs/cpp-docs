...
The latest version of this topic can be found at [Linker Tools Error LNK2039](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-error-lnk2039).  
