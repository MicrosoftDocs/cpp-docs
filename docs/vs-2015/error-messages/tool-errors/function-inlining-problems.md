...
The latest version of this topic can be found at [Function Inlining Problems](https://docs.microsoft.com/cpp/error-messages/tool-errors/function-inlining-problems).  
