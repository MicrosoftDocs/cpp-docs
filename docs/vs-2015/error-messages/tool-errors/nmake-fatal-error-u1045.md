...
The latest version of this topic can be found at [NMAKE Fatal Error U1045](https://docs.microsoft.com/cpp/error-messages/tool-errors/nmake-fatal-error-u1045).  
