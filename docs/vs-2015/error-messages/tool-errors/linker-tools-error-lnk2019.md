...
-   **A build dependency is only defined as a project dependency in the solution.** In earlier versions of [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)], this level of dependency was sufficient. However, starting with Visual Studio 2010, [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] requires a [project-to-project reference](../Topic/Managing%20references%20in%20a%20project.md). If your project does not have a project-to-project reference, you may receive this linker error. Add a project-to-project reference to fix it.  
