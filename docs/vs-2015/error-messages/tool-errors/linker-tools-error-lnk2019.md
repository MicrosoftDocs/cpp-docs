...
The latest version of this topic can be found at [Linker Tools Error LNK2019](https://docs.microsoft.com/cpp/error-messages/tool-errors/linker-tools-error-lnk2019).  
...
-   **A build dependency is only defined as a project dependency in the solution.** In earlier versions of [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)], this level of dependency was sufficient. However, starting with Visual Studio 2010, [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] requires a [project-to-project reference](http://msdn.microsoft.com/library/05d1c51b-44f3-4973-8a11-6c919b08ad62). If your project does not have a project-to-project reference, you may receive this linker error. Add a project-to-project reference to fix it.  
