...
The latest version of this topic can be found at [Fatal Error C1076](https://docs.microsoft.com/cpp/error-messages/compiler-errors-1/fatal-error-c1076).  
