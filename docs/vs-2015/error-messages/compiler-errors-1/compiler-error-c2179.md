...
The latest version of this topic can be found at [Compiler Error C2179](https://docs.microsoft.com/cpp/error-messages/compiler-errors-1/compiler-error-c2179).  
