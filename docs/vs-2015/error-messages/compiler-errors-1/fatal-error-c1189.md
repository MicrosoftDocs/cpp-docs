...
The latest version of this topic can be found at [Fatal Error C1189](https://docs.microsoft.com/cpp/error-messages/compiler-errors-1/fatal-error-c1189).  
...
```  
 ...
 You might also see this error if you build an ATL project by using the **/robust** MIDL compiler option. Use the **/robust** switch to build only [!INCLUDE[win2kfamily](../../includes/win2kfamily-md.md)] and later versions of Windows. To correct this error, use one of the following procedures:  
