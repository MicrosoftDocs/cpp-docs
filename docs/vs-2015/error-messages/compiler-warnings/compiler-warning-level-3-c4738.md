...
The latest version of this topic can be found at [Compiler Warning (Level 3) C4738](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-3-c4738).  
