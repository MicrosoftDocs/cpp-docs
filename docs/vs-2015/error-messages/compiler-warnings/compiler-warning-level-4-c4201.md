...
The latest version of this topic can be found at [Compiler Warning (level 4) C4201](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-4-c4201).  
