...
The latest version of this topic can be found at [Compiler Warnings C4400 Through C4599](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warnings-c4400-through-c4599).  
...
|[Compiler Warning (level 1) C4539](http://msdn.microsoft.com/library/a47ebf87-5e6a-43c9-89fd-f80c40b3a7f5)|'character': a universal-character-name specifies an invalid character|  
