...
The latest version of this topic can be found at [Compiler Warning C4430](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-c4430).  
