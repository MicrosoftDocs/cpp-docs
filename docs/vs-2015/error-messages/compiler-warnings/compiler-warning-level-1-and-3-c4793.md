...
The latest version of this topic can be found at [Compiler Warning (level 1 and 3) C4793](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-1-and-3-c4793).  
