...
The latest version of this topic can be found at [Compiler Warning (level 3) C4995](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-3-c4995).  
