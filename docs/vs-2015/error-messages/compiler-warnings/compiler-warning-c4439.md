...
The latest version of this topic can be found at [Compiler Warning C4439](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-c4439).  
