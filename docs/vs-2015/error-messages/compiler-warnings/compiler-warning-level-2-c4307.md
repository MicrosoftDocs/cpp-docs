...
The latest version of this topic can be found at [Compiler Warning (level 2) C4307](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-2-c4307).  
