...
The latest version of this topic can be found at [Compiler Warning C4394](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-c4394).  
