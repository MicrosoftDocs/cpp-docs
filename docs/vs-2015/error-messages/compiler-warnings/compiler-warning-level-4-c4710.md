...
The latest version of this topic can be found at [Compiler Warning (level 4) C4710](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-4-c4710).  
