...
The latest version of this topic can be found at [Compiler Warning (level 1) C4103](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-1-c4103).  
