...
The latest version of this topic can be found at [Compiler Warning (level 1) C4803](https://docs.microsoft.com/cpp/error-messages/compiler-warnings/compiler-warning-level-1-c4803).  
...
## Example  
 C4803 can be generated using **/clr**. See [event](../../windows/event-cpp-component-extensions.md) for more information on using events..  
