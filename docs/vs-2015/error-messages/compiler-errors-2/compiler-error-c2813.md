...
The latest version of this topic can be found at [Compiler Error C2813](https://docs.microsoft.com/cpp/error-messages/compiler-errors-2/compiler-error-c2813).  
...
import is not supported with /MP  
 ...
 This compiler error and the **/MP** compiler option are new in [!INCLUDE[vs_orcas_long](../../includes/vs-orcas-long-md.md)].  
