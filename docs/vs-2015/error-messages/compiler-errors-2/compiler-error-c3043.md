...
The latest version of this topic can be found at [Compiler Error C3043](https://docs.microsoft.com/cpp/error-messages/compiler-errors-2/compiler-error-c3043).  
