...
The latest version of this topic can be found at [Pointers to Members](https://docs.microsoft.com/cpp/cpp/pointers-to-members).  
...
2.  The declarator:  
    ...
    -   The qualified name of the class containing the members to be pointed to.  See [Names and Qualified Names](../misc/names-and-qualified-names.md).  
