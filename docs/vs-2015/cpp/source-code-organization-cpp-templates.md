...
The latest version of this topic can be found at [Source code organization (C++ Templates)](https://docs.microsoft.com/cpp/cpp/source-code-organization-cpp-templates).  
