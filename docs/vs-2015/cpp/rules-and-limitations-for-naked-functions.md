...
The latest version of this topic can be found at [Rules and Limitations for Naked Functions](https://docs.microsoft.com/cpp/cpp/rules-and-limitations-for-naked-functions).  
