...
The latest version of this topic can be found at [Pointer-to-Member Operators: .* and -&gt;*](https://docs.microsoft.com/cpp/cpp/pointer-to-member-operators-dot-star-and-star).  
