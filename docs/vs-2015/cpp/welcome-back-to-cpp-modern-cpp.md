...
The latest version of this topic can be found at [Welcome Back to C++ (Modern C++)](https://docs.microsoft.com/cpp/cpp/welcome-back-to-cpp-modern-cpp).  
