...
The latest version of this topic can be found at [Postfix Increment and Decrement Operators: ++ and --](https://docs.microsoft.com/cpp/cpp/postfix-increment-and-decrement-operators-increment-and-decrement).  
