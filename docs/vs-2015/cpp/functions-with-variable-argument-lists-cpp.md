...
The latest version of this topic can be found at [Functions with Variable Argument Lists  (C++)](https://docs.microsoft.com/cpp/cpp/functions-with-variable-argument-lists-cpp).  
