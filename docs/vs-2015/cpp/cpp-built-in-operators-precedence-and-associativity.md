...
The latest version of this topic can be found at [C++ Built-in Operators, Precedence and Associativity](https://docs.microsoft.com/cpp/cpp/cpp-built-in-operators-precedence-and-associativity).  
