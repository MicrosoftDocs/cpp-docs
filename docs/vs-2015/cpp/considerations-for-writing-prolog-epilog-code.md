...
The latest version of this topic can be found at [Considerations for Writing Prolog-Epilog Code](https://docs.microsoft.com/cpp/cpp/considerations-for-writing-prolog-epilog-code).  
