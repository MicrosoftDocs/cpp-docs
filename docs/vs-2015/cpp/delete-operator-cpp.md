...
The latest version of this topic can be found at [delete Operator (C++)](https://docs.microsoft.com/cpp/cpp/delete-operator-cpp).  
...
## How delete works  
 The [delete operator](../cpp/delete-operator-cpp.md) invokes the function [operator delete](../misc/operator-delete-function.md).  
