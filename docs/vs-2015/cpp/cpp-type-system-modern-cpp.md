...
The latest version of this topic can be found at [C++ Type System (Modern C++)](https://docs.microsoft.com/cpp/cpp/cpp-type-system-modern-cpp).  
...
-   You specify what operations can be performed on your type, and how it can be converted to other types, by defining (through overloading) the appropriate operators, either as class members or non-member functions. For more information, see [Overloading  (C++)](../misc/overloading-cpp.md).  
