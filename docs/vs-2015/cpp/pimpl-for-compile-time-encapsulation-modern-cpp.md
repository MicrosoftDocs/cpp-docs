...
The latest version of this topic can be found at [Pimpl For Compile-Time Encapsulation (Modern C++)](https://docs.microsoft.com/cpp/cpp/pimpl-for-compile-time-encapsulation-modern-cpp).  
