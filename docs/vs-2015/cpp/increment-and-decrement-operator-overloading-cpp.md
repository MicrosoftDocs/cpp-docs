...
The latest version of this topic can be found at [Increment and Decrement Operator Overloading (C++)](https://docs.microsoft.com/cpp/cpp/increment-and-decrement-operator-overloading-cpp).  
