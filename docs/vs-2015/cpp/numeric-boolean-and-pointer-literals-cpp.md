...
The latest version of this topic can be found at [Numeric, Boolean and Pointer Literals  (C++)](https://docs.microsoft.com/cpp/cpp/numeric-boolean-and-pointer-literals-cpp).  
