...
The latest version of this topic can be found at [General Rules for Operator Overloading](https://docs.microsoft.com/cpp/cpp/general-rules-for-operator-overloading).  
