...
The latest version of this topic can be found at [Bitwise Inclusive OR Operator: |](https://docs.microsoft.com/cpp/cpp/bitwise-inclusive-or-operator-pipe).  
...
## Remarks  
 ...
 Both operands to the bitwise inclusive OR operator must be of integral types. The usual arithmetic conversions covered in [Arithmetic Conversions](../misc/arithmetic-conversions.md) are applied to the operands.  
