...
The latest version of this topic can be found at [Argument Passing and Naming Conventions](https://docs.microsoft.com/cpp/cpp/argument-passing-and-naming-conventions).  
