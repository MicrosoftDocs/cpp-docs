...
The latest version of this topic can be found at [Argument-Dependent Name (Koenig) Lookup on Functions](https://docs.microsoft.com/cpp/cpp/argument-dependent-name-koenig-lookup-on-functions).  
