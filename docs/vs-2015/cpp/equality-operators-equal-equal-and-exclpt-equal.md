...
The latest version of this topic can be found at [Equality Operators: == and !=](https://docs.microsoft.com/cpp/cpp/equality-operators-equal-equal-and-exclpt-equal).  
