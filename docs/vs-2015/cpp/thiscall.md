...
The latest version of this topic can be found at [__thiscall](https://docs.microsoft.com/cpp/cpp/thiscall).  
...
Microsoft Specific  
 ...
 On ARM and [!INCLUDE[vcprx64](../includes/vcprx64-md.md)] machines, `__thiscall` is accepted and ignored by the compiler.  
