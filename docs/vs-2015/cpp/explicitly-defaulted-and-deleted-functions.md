...
The latest version of this topic can be found at [Explicitly Defaulted and Deleted Functions](https://docs.microsoft.com/cpp/cpp/explicitly-defaulted-and-deleted-functions).  
