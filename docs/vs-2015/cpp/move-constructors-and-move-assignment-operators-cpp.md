...
The latest version of this topic can be found at [Move Constructors and Move Assignment Operators (C++)](https://docs.microsoft.com/cpp/cpp/move-constructors-and-move-assignment-operators-cpp).  
...
```  
 ...
 Before [!INCLUDE[cpp_dev10_long](../includes/cpp-dev10-long-md.md)], this example produces the following output:  
