...
The latest version of this topic can be found at [Partial Ordering of Function Templates (C++)](https://docs.microsoft.com/cpp/cpp/partial-ordering-of-function-templates-cpp).  
