...
The latest version of this topic can be found at [return Statement in Program Termination (C++)](https://docs.microsoft.com/cpp/cpp/return-statement-in-program-termination-cpp).  
