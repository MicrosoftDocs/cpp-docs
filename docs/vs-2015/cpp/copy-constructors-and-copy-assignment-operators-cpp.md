...
The latest version of this topic can be found at [Copy Constructors and Copy Assignment Operators (C++)](https://docs.microsoft.com/cpp/cpp/copy-constructors-and-copy-assignment-operators-cpp).  
