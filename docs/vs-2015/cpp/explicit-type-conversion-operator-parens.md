...
The latest version of this topic can be found at [Explicit Type Conversion Operator: ()](https://docs.microsoft.com/cpp/cpp/explicit-type-conversion-operator-parens).  
