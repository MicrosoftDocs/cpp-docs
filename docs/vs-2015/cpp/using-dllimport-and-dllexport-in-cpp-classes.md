...
The latest version of this topic can be found at [Using dllimport and dllexport in C++ Classes](https://docs.microsoft.com/cpp/cpp/using-dllimport-and-dllexport-in-cpp-classes).  
