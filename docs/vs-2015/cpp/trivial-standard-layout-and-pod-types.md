...
The latest version of this topic can be found at [Trivial, standard-layout, and POD types](https://docs.microsoft.com/cpp/cpp/trivial-standard-layout-and-pod-types).  
