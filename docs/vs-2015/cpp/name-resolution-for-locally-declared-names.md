...
The latest version of this topic can be found at [Name Resolution for Locally Declared Names](https://docs.microsoft.com/cpp/cpp/name-resolution-for-locally-declared-names).  
