...
The latest version of this topic can be found at [Restrictions on Termination Handlers](https://docs.microsoft.com/cpp/cpp/restrictions-on-termination-handlers).  
