...
The latest version of this topic can be found at [Uniform Initialization and Delegating Constructors](https://docs.microsoft.com/cpp/cpp/uniform-initialization-and-delegating-constructors).  
