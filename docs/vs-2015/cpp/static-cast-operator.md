...
The latest version of this topic can be found at [static_cast Operator](https://docs.microsoft.com/cpp/cpp/static-cast-operator).  
...
## Remarks  
 In standard C++, no run-time type check is made to help ensure the safety of the conversion. In C++/CX, a compile time and runtime check are performed.
