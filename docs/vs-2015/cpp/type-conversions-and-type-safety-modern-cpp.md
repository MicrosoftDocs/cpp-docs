...
The latest version of this topic can be found at [Type Conversions and Type Safety (Modern C++)](https://docs.microsoft.com/cpp/cpp/type-conversions-and-type-safety-modern-cpp).  
