...
The latest version of this topic can be found at [How to: Interface Between Exceptional and Non-Exceptional Code](https://docs.microsoft.com/cpp/cpp/how-to-interface-between-exceptional-and-non-exceptional-code).  
