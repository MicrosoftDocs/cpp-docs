...
The latest version of this topic can be found at [Object Lifetime And Resource Management (Modern C++)](https://docs.microsoft.com/cpp/cpp/object-lifetime-and-resource-management-modern-cpp).  
