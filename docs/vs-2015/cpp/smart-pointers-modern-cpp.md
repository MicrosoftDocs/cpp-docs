...
The latest version of this topic can be found at [Smart Pointers (Modern C++)](https://docs.microsoft.com/cpp/cpp/smart-pointers-modern-cpp).  
...
## Uses for smart pointers  
 ...
 [!code-cpp[smart_pointers_intro#1](../snippets/cpp/VS_Snippets_Cpp/smart_pointers_intro/cpp/smart_pointer_intro.cpp#1)]  
...
>  Always create smart pointers on a separate line of code, never in a parameter list, so that a subtle resource leak won't occur due to certain parameter list allocation rules.  
 ...
 [!code-cpp[smart_pointers_intro#2](../snippets/cpp/VS_Snippets_Cpp/smart_pointers_intro/cpp/smart_pointer_intro.cpp#2)]  
...
5.  Let the smart pointer delete the object.  
 ...
 [!code-cpp[smart_pointers_intro#3](../snippets/cpp/VS_Snippets_Cpp/smart_pointers_intro/cpp/smart_pointer_intro.cpp#3)]  
 ...
 [!code-cpp[smart_pointers_intro#4](../snippets/cpp/VS_Snippets_Cpp/smart_pointers_intro/cpp/smart_pointer_intro.cpp#4)]  
