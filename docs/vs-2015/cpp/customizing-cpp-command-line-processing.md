...
The latest version of this topic can be found at [Customizing C++ Command-Line Processing](https://docs.microsoft.com/cpp/cpp/customizing-cpp-command-line-processing).  
