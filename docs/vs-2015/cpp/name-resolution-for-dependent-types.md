...
The latest version of this topic can be found at [Name Resolution for Dependent Types](https://docs.microsoft.com/cpp/cpp/name-resolution-for-dependent-types).  
...
### Template Disambiguation  
 [!INCLUDE[cpp_dev11_long](../includes/cpp-dev11-long-md.md)] enforces the C++98/03/11 standard rules for disambiguation with the "template" keyword. In the following example, [!INCLUDE[cpp_dev10_long](../includes/cpp-dev10-long-md.md)] would accept both the nonconforming lines and the conforming lines.  [!INCLUDE[cpp_dev11_long](../includes/cpp-dev11-long-md.md)] accepts only the conforming lines.  
