...
The latest version of this topic can be found at [Storage classes (C++)](https://docs.microsoft.com/cpp/cpp/storage-classes-cpp).  
...
2.  Starting with [!INCLUDE[cpp_dev10_long](../includes/cpp-dev10-long-md.md)], the `auto` keyword is no longer a C++ storage-class specifier, and the `register` keyword is deprecated.  
