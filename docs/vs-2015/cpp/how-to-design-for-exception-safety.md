...
The latest version of this topic can be found at [How to: Design for Exception Safety](https://docs.microsoft.com/cpp/cpp/how-to-design-for-exception-safety).  
