...
The latest version of this topic can be found at [Rvalue Reference Declarator: &amp;&amp;](https://docs.microsoft.com/cpp/cpp/rvalue-reference-declarator-amp-amp).  
...
```  
 ...
 For more information about the introduction of move semantics into the STL in [!INCLUDE[cpp_dev10_long](../includes/cpp-dev10-long-md.md)], see [C++ Standard Library](../standard-library/cpp-standard-library-reference.md).  
