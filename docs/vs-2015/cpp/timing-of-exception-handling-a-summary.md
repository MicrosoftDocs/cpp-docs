...
The latest version of this topic can be found at [Timing of Exception Handling: A Summary](https://docs.microsoft.com/cpp/cpp/timing-of-exception-handling-a-summary).  
