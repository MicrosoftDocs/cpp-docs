...
The latest version of this topic can be found at [String and I-O Formatting (Modern C++)](https://docs.microsoft.com/cpp/cpp/string-and-i-o-formatting-modern-cpp).  
