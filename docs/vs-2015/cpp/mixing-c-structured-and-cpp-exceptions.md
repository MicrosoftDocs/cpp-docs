...
The latest version of this topic can be found at [Mixing C (Structured) and C++ Exceptions](https://docs.microsoft.com/cpp/cpp/mixing-c-structured-and-cpp-exceptions).  
