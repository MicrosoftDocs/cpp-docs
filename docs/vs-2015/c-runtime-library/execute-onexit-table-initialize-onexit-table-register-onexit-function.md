...
The latest version of this topic can be found at [_execute_onexit_table, _initialize_onexit_table, _register_onexit_function](https://docs.microsoft.com/cpp/c-runtime-library/execute-onexit-table-initialize-onexit-table-register-onexit-function).  
