...
The latest version of this topic can be found at [_daylight, _dstbias, _timezone, and _tzname](https://docs.microsoft.com/cpp/c-runtime-library/daylight-dstbias-timezone-and-tzname).  
