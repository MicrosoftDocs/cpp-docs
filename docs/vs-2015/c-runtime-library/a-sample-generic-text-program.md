...
The latest version of this topic can be found at [A Sample Generic-Text Program](https://docs.microsoft.com/cpp/c-runtime-library/a-sample-generic-text-program).  
