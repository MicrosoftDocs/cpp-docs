...
The latest version of this topic can be found at [Unicode Stream I-O in Text and Binary Modes](https://docs.microsoft.com/cpp/c-runtime-library/unicode-stream-i-o-in-text-and-binary-modes).  
