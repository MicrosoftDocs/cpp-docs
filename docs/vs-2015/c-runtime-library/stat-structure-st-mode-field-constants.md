...
The latest version of this topic can be found at [_stat Structure st_mode Field Constants](https://docs.microsoft.com/cpp/c-runtime-library/stat-structure-st-mode-field-constants).  
