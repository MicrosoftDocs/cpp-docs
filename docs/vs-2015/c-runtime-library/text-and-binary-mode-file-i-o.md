...
The latest version of this topic can be found at [Text and Binary Mode File I-O](https://docs.microsoft.com/cpp/c-runtime-library/text-and-binary-mode-file-i-o).  
