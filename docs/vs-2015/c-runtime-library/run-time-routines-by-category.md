...
The latest version of this topic can be found at [Run-Time Routines by Category](https://docs.microsoft.com/cpp/c-runtime-library/run-time-routines-by-category).  
