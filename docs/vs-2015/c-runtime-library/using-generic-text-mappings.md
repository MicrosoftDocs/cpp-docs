...
The latest version of this topic can be found at [Using Generic-Text Mappings](https://docs.microsoft.com/cpp/c-runtime-library/using-generic-text-mappings).  
