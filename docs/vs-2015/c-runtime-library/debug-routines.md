...
-   Report debug messages to the user  
 ...
 To use these routines, the [_DEBUG](../c-runtime-library/debug.md) flag must be defined. All of these routines do nothing in a retail build of an application. For more information on how to use the new debug routines, see [CRT Debugging Techniques](http://msdn.microsoft.com/library/9be561f6-14a8-44ff-925d-d911d5b8e6ff).  
...
|[fabs](../c-runtime-library/reference/fabs-fabsf-fabsl.md)|[_logb](../c-runtime-library/reference/logb-logbf-logbl-logb-logbf.md)|[_y0](http://msdn.microsoft.com/library/96581b10-7ef1-43c5-80c0-5622b2d97bbe)|  
|[_finite](../c-runtime-library/reference/finite-finitef.md)|[longjmp](../c-runtime-library/reference/longjmp.md)|[_y1](http://msdn.microsoft.com/library/96581b10-7ef1-43c5-80c0-5622b2d97bbe)|  
|[floor](../c-runtime-library/reference/floor-floorf-floorl.md)|[_matherr](../c-runtime-library/reference/matherr.md)|[_yn](http://msdn.microsoft.com/library/96581b10-7ef1-43c5-80c0-5622b2d97bbe)|  
