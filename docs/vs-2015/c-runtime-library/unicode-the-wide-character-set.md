...
The latest version of this topic can be found at [Unicode: The Wide-Character Set](https://docs.microsoft.com/cpp/c-runtime-library/unicode-the-wide-character-set).  
