...
The latest version of this topic can be found at [Format Specification Syntax: printf and wprintf Functions](https://docs.microsoft.com/cpp/c-runtime-library/format-specification-syntax-printf-and-wprintf-functions).  
