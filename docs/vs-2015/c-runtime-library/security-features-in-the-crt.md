...
The latest version of this topic can be found at [Security Features in the CRT](https://docs.microsoft.com/cpp/c-runtime-library/security-features-in-the-crt).  
