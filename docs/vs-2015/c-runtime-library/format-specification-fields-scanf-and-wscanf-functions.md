...
The latest version of this topic can be found at [Format Specification Fields: scanf and wscanf Functions](https://docs.microsoft.com/cpp/c-runtime-library/format-specification-fields-scanf-and-wscanf-functions).  
