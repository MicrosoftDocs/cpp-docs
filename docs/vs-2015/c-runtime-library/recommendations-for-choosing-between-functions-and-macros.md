...
The latest version of this topic can be found at [Recommendations for Choosing Between Functions and Macros](https://docs.microsoft.com/cpp/c-runtime-library/recommendations-for-choosing-between-functions-and-macros).  
