...
The latest version of this topic can be found at [scanf Type Field Characters](https://docs.microsoft.com/cpp/c-runtime-library/scanf-type-field-characters).  
