...
The latest version of this topic can be found at [String to Numeric Value Functions](https://docs.microsoft.com/cpp/c-runtime-library/string-to-numeric-value-functions).  
  
strtod, _strtod_l, wcstod, _wcstod_l](../Topic/strtod,%20_strtod_l,%20wcstod,%20_wcstod_l.md)  
