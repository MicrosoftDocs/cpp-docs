...
The latest version of this topic can be found at [File Read-Write Access Constants](https://docs.microsoft.com/cpp/c-runtime-library/file-read-write-access-constants).  
