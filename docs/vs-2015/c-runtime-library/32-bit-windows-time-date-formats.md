...
The latest version of this topic can be found at [32-Bit Windows Time-Date Formats](https://docs.microsoft.com/cpp/c-runtime-library/32-bit-windows-time-date-formats).  
