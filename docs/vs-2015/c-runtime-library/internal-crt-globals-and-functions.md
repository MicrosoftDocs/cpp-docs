...
The latest version of this topic can be found at [Internal CRT Globals and Functions](https://docs.microsoft.com/cpp/c-runtime-library/internal-crt-globals-and-functions).  
