...
The latest version of this topic can be found at [_snscanf, _snscanf_l, _snwscanf, _snwscanf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/snscanf-snscanf-l-snwscanf-snwscanf-l).  
