...
The latest version of this topic can be found at [_ismbchira, _ismbchira_l, _ismbckata, _ismbckata_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbchira-ismbchira-l-ismbckata-ismbckata-l).  
