...
The latest version of this topic can be found at [_ismbbalnum, _ismbbalnum_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbbalnum-ismbbalnum-l).  
