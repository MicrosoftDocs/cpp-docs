...
The latest version of this topic can be found at [localtime_s, _localtime32_s, _localtime64_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/localtime-s-localtime32-s-localtime64-s).  
...
## .NET Framework Equivalent  
 [System::DateTime::ToLocalTime](https://msdn.microsoft.com/library/system.datetime.tolocaltime.aspx)  
