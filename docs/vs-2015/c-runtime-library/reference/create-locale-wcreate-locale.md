...
The latest version of this topic can be found at [_create_locale, _wcreate_locale](https://docs.microsoft.com/cpp/c-runtime-library/reference/create-locale-wcreate-locale).  
...
## .NET Framework Equivalent  
 [System::Globalization::CultureInfo Class](https://msdn.microsoft.com/library/system.globalization.cultureinfo.aspx)  
