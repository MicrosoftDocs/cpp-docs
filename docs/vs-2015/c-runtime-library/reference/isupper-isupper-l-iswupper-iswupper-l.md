...
The latest version of this topic can be found at [isupper, _isupper_l, iswupper, _iswupper_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isupper-isupper-l-iswupper-iswupper-l).  
