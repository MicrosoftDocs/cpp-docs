...
The latest version of this topic can be found at [rename, _wrename](https://docs.microsoft.com/cpp/c-runtime-library/reference/rename-wrename).  
...
## .NET Framework Equivalent  
 [System::IO::File::Move](https://msdn.microsoft.com/library/system.io.file.move.aspx)  
