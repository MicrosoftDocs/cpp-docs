...
The latest version of this topic can be found at [_CrtDbgReport, _CrtDbgReportW](https://docs.microsoft.com/cpp/c-runtime-library/reference/crtdbgreport-crtdbgreportw).  
...
-   [System::Diagnostics::Debug::Write](https://msdn.microsoft.com/library/system.diagnostics.debug.write.aspx)  
  
-   [System::Diagnostics::Debug::Writeline](https://msdn.microsoft.com/library/system.diagnostics.debug.writeline.aspx)  
  
-   [System::Diagnostics::Debug::WriteIf](https://msdn.microsoft.com/library/system.diagnostics.debug.writeif.aspx)  
  
-   [System::Diagnostics::Debug::WriteLineIf](https://msdn.microsoft.com/library/system.diagnostics.debug.writelineif.aspx)  
