...
The latest version of this topic can be found at [strcpy_s, wcscpy_s, _mbscpy_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/strcpy-s-wcscpy-s-mbscpy-s).  
...
> [!IMPORTANT]
>  `_mbscpy_s` cannot be used in applications that execute in the [!INCLUDE[wrt](../../includes/wrt-md.md)]. For more information, see [CRT functions not supported with /ZW](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
