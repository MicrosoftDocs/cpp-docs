...
The latest version of this topic can be found at [_splitpath_s, _wsplitpath_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/splitpath-s-wsplitpath-s).  
