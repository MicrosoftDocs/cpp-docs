...
The latest version of this topic can be found at [_strdec, _wcsdec, _mbsdec, _mbsdec_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strdec-wcsdec-mbsdec-mbsdec-l).  
  
Moves a string pointer back one character.  
  
> [!IMPORTANT]
>  `mbsdec` and `mbsdec_l` cannot be used in applications that execute in the [!INCLUDE[wrt](../../includes/wrt-md.md)]. For more information, see [CRT functions not supported with /ZW](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
