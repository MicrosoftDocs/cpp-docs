...
The latest version of this topic can be found at [strlen, wcslen, _mbslen, _mbslen_l, _mbstrlen, _mbstrlen_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strlen-wcslen-mbslen-mbslen-l-mbstrlen-mbstrlen-l).  
