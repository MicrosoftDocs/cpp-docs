...
The latest version of this topic can be found at [isblank, iswblank, _isblank_l, _iswblank_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isblank-iswblank-isblank-l-iswblank-l).  
