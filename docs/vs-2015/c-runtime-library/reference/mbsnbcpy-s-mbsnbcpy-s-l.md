...
The latest version of this topic can be found at [_mbsnbcpy_s, _mbsnbcpy_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/mbsnbcpy-s-mbsnbcpy-s-l).  
