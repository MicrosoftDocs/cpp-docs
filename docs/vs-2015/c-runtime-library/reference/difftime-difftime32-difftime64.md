...
The latest version of this topic can be found at [difftime, _difftime32, _difftime64](https://docs.microsoft.com/cpp/c-runtime-library/reference/difftime-difftime32-difftime64).  
...
## .NET Framework Equivalent  
 [System::DateTime::Subtract](https://msdn.microsoft.com/library/system.datetime.subtract.aspx)  
