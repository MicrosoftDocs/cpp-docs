...
The latest version of this topic can be found at [_vsprintf_p, _vsprintf_p_l, _vswprintf_p, _vswprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vsprintf-p-vsprintf-p-l-vswprintf-p-vswprintf-p-l).  
