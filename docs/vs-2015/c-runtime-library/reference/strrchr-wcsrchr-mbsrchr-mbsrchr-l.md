...
The latest version of this topic can be found at [strrchr, wcsrchr, _mbsrchr, _mbsrchr_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strrchr-wcsrchr-mbsrchr-mbsrchr-l).  
...
## .NET Framework Equivalent  
 [System::String::LastIndexOf](https://msdn.microsoft.com/library/system.string.lastindexof.aspx)  
