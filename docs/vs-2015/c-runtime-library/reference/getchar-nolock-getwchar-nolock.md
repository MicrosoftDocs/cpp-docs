...
The latest version of this topic can be found at [_getchar_nolock, _getwchar_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/getchar-nolock-getwchar-nolock).  
