...
The latest version of this topic can be found at [_chmod, _wchmod](https://docs.microsoft.com/cpp/c-runtime-library/reference/chmod-wchmod).  
...
-   [System::IO::File::SetAttributes](https://msdn.microsoft.com/library/system.io.file.setattributes.aspx)  
  
-   [System::Security::Permissions::FileIOPermission](https://msdn.microsoft.com/library/system.security.permissions.fileiopermission.aspx)  
