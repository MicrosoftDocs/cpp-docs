...
The latest version of this topic can be found at [atof, _atof_l, _wtof, _wtof_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/atof-atof-l-wtof-wtof-l).  
