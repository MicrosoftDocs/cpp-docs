...
The latest version of this topic can be found at [strtoumax, _strtoumax_l, wcstoumax, _wcstoumax_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strtoumax-strtoumax-l-wcstoumax-wcstoumax-l).  
...
## .NET Framework Equivalent  
 [System::Convert::ToUInt64](https://msdn.microsoft.com/library/system.convert.touint32.aspx)  
