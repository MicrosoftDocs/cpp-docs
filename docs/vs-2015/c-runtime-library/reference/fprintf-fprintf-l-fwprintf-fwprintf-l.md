...
The latest version of this topic can be found at [fprintf, _fprintf_l, fwprintf, _fwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/fprintf-fprintf-l-fwprintf-fwprintf-l).  
