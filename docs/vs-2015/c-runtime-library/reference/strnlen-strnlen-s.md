...
The latest version of this topic can be found at [strnlen, strnlen_s, wcsnlen, wcsnlen_s, _mbsnlen, _mbsnlen_l, _mbstrnlen, _mbstrnlen_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strnlen-strnlen-s).  
...
> [!IMPORTANT]
>  `_mbsnlen`, `_mbsnlen_l`, `_mbstrnlen`, and `_mbstrnlen_l` cannot be used in applications that execute in the [!INCLUDE[wrt](../../includes/wrt-md.md)]. For more information, see [CRT functions not supported with /ZW](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
...
## .NET Framework Equivalent  
 [System::String::Length](https://msdn.microsoft.com/library/system.string.length.aspx)  
