...
The latest version of this topic can be found at [scanf_s, _scanf_s_l, wscanf_s, _wscanf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/scanf-s-scanf-s-l-wscanf-s-wscanf-s-l).  
...
-   [System::Console::ReadLine](https://msdn.microsoft.com/library/system.console.readline.aspx)  
  
-   See also `Parse` methods, such as [System::Double::Parse](https://msdn.microsoft.com/library/system.double.parse.aspx).  
