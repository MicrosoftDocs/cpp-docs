...
The latest version of this topic can be found at [strtol, wcstol, _strtol_l, _wcstol_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strtol-wcstol-strtol-l-wcstol-l).  
