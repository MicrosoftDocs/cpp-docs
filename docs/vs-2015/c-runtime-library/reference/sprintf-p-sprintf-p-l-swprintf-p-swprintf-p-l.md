...
The latest version of this topic can be found at [_sprintf_p, _sprintf_p_l, _swprintf_p, _swprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/sprintf-p-sprintf-p-l-swprintf-p-swprintf-p-l).  
