...
The latest version of this topic can be found at [_searchenv_s, _wsearchenv_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/searchenv-s-wsearchenv-s).  
