...
The latest version of this topic can be found at [_unlink, _wunlink](https://docs.microsoft.com/cpp/c-runtime-library/reference/unlink-wunlink).  
...
## .NET Framework Equivalent  
 [System::IO::File::Delete](https://msdn.microsoft.com/library/system.io.file.delete.aspx)  
