...
The latest version of this topic can be found at [_fprintf_p, _fprintf_p_l, _fwprintf_p, _fwprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/fprintf-p-fprintf-p-l-fwprintf-p-fwprintf-p-l).  
