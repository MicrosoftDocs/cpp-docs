...
The latest version of this topic can be found at [_cprintf_s, _cprintf_s_l, _cwprintf_s, _cwprintf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/cprintf-s-cprintf-s-l-cwprintf-s-cwprintf-s-l).  
