...
The latest version of this topic can be found at [strtoimax, _strtoimax_l, wcstoimax, _wcstoimax_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strtoimax-strtoimax-l-wcstoimax-wcstoimax-l).  
