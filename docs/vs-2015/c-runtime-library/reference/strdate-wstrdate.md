...
The latest version of this topic can be found at [_strdate, _wstrdate](https://docs.microsoft.com/cpp/c-runtime-library/reference/strdate-wstrdate).  
...
## .NET Framework Equivalent  
 [System::DateTime::Parse](https://msdn.microsoft.com/library/system.datetime.parse.aspx)  
