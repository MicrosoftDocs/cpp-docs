...
The latest version of this topic can be found at [_vfprintf_p, _vfprintf_p_l, _vfwprintf_p, _vfwprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vfprintf-p-vfprintf-p-l-vfwprintf-p-vfwprintf-p-l).  
