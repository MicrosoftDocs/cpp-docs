...
The latest version of this topic can be found at [scanf, _scanf_l, wscanf, _wscanf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/scanf-scanf-l-wscanf-wscanf-l).  
