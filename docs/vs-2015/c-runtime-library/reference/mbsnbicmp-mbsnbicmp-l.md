...
The latest version of this topic can be found at [_mbsnbicmp, _mbsnbicmp_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/mbsnbicmp-mbsnbicmp-l).  
