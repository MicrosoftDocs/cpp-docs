...
The latest version of this topic can be found at [_ftell_nolock, _ftelli64_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/ftell-nolock-ftelli64-nolock).  
