...
The latest version of this topic can be found at [_snscanf_s, _snscanf_s_l, _snwscanf_s, _snwscanf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/snscanf-s-snscanf-s-l-snwscanf-s-snwscanf-s-l).  
