...
The latest version of this topic can be found at [lround, lroundf, lroundl, llround, llroundf, llroundl](https://docs.microsoft.com/cpp/c-runtime-library/reference/lround-lroundf-lroundl-llround-llroundf-llroundl).  
