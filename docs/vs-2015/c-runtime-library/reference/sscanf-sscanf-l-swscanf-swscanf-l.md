...
The latest version of this topic can be found at [sscanf, _sscanf_l, swscanf, _swscanf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/sscanf-sscanf-l-swscanf-swscanf-l).  
