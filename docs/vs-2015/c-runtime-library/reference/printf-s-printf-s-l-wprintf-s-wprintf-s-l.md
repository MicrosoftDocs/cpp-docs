...
The latest version of this topic can be found at [printf_s, _printf_s_l, wprintf_s, _wprintf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/printf-s-printf-s-l-wprintf-s-wprintf-s-l).  
