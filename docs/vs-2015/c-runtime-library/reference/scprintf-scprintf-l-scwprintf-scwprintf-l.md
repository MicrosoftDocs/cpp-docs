...
The latest version of this topic can be found at [_scprintf, _scprintf_l, _scwprintf, _scwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/scprintf-scprintf-l-scwprintf-scwprintf-l).  
