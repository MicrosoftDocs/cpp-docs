...
The latest version of this topic can be found at [_putch_nolock, _putwch_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/putch-nolock-putwch-nolock).  
