...
The latest version of this topic can be found at [_getch_nolock, _getwch_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/getch-nolock-getwch-nolock).  
