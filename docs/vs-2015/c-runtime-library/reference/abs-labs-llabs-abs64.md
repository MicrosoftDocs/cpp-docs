...
The latest version of this topic can be found at [abs, labs, llabs, _abs64](https://docs.microsoft.com/cpp/c-runtime-library/reference/abs-labs-llabs-abs64).  
...
## .NET Framework Equivalent  
 [System::Math::Abs](https://msdn.microsoft.com/library/system.math.abs.aspx)  
