...
The latest version of this topic can be found at [_get_purecall_handler, _set_purecall_handler](https://docs.microsoft.com/cpp/c-runtime-library/reference/get-purecall-handler-set-purecall-handler).  
