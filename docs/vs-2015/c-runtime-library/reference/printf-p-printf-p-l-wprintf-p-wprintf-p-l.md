...
The latest version of this topic can be found at [_printf_p, _printf_p_l, _wprintf_p, _wprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/printf-p-printf-p-l-wprintf-p-wprintf-p-l).  
...
-   [System::Console::WriteLine](https://msdn.microsoft.com/library/system.console.writeline.aspx)  
