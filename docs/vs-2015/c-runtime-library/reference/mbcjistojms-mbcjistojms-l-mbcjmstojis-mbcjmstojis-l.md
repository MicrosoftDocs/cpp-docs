...
The latest version of this topic can be found at [_mbcjistojms, _mbcjistojms_l, _mbcjmstojis, _mbcjmstojis_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/mbcjistojms-mbcjistojms-l-mbcjmstojis-mbcjmstojis-l).  
