...
The latest version of this topic can be found at [strncmp, wcsncmp, _mbsncmp, _mbsncmp_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strncmp-wcsncmp-mbsncmp-mbsncmp-l).  
