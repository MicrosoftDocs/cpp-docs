...
The latest version of this topic can be found at [strpbrk, wcspbrk, _mbspbrk, _mbspbrk_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strpbrk-wcspbrk-mbspbrk-mbspbrk-l).  
...
## .NET Framework Equivalent  
 [System::String::IndexOfAny](https://msdn.microsoft.com/library/system.string.indexofany.aspx)  
