...
The latest version of this topic can be found at [iscsym, iscsymf, __iscsym, __iswcsym, __iscsymf, __iswcsymf, _iscsym_l, _iswcsym_l, _iscsymf_l, _iswcsymf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/iscsym-functions).  
