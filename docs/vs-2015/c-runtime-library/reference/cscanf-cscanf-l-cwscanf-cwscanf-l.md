...
The latest version of this topic can be found at [_cscanf, _cscanf_l, _cwscanf, _cwscanf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/cscanf-cscanf-l-cwscanf-cwscanf-l).  
