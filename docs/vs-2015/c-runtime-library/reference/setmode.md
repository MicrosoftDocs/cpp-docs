...
The latest version of this topic can be found at [_setmode](https://docs.microsoft.com/cpp/c-runtime-library/reference/setmode).  
...
-   [System::IO::BinaryReader Class](https://msdn.microsoft.com/library/system.io.binaryreader.aspx)  
  
-   [System::IO::TextReader Class](https://msdn.microsoft.com/library/system.io.textreader.aspx)  
