...
The latest version of this topic can be found at [_ungetc_nolock, _ungetwc_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/ungetc-nolock-ungetwc-nolock).  
