...
The latest version of this topic can be found at [_lfind](https://docs.microsoft.com/cpp/c-runtime-library/reference/lfind).  
...
## .NET Framework Equivalent  
 [System::Collections::ArrayList::Contains](https://msdn.microsoft.com/library/system.collections.arraylist.contains.aspx)  
