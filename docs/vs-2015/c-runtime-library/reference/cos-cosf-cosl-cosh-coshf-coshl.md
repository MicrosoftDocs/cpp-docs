...
The latest version of this topic can be found at [cos, cosf, cosl, cosh, coshf, coshl](https://docs.microsoft.com/cpp/c-runtime-library/reference/cos-cosf-cosl-cosh-coshf-coshl).  
...
-   [System::Math::Cos](https://msdn.microsoft.com/library/system.math.cos.aspx)  
  
-   [System::Math::Cosh](https://msdn.microsoft.com/library/system.math.cosh.aspx)  
