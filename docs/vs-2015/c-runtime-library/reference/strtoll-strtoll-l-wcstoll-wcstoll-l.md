...
The latest version of this topic can be found at [strtoll, _strtoll_l, wcstoll, _wcstoll_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strtoll-strtoll-l-wcstoll-wcstoll-l).  
