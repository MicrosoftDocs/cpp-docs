...
The latest version of this topic can be found at [tolower, _tolower, towlower, _tolower_l, _towlower_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/tolower-tolower-towlower-tolower-l-towlower-l).  
...
## .NET Framework Equivalent  
 [System::Char::ToLower](https://msdn.microsoft.com/library/system.char.tolower.aspx)  
