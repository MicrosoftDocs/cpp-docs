...
The latest version of this topic can be found at [assert Macro, _assert, _wassert](https://docs.microsoft.com/cpp/c-runtime-library/reference/assert-macro-assert-wassert).  
...
## Remarks  
 ...
 For more information about CRT debugging, see [CRT Debugging Techniques](http://msdn.microsoft.com/library/9be561f6-14a8-44ff-925d-d911d5b8e6ff).  
