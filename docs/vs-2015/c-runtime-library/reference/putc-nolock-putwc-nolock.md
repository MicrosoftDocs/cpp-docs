...
The latest version of this topic can be found at [_putc_nolock, _putwc_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/putc-nolock-putwc-nolock).  
