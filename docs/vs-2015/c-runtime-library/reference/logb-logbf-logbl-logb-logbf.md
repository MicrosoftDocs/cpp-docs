...
The latest version of this topic can be found at [logb, logbf, logbl, _logb, _logbf](https://docs.microsoft.com/cpp/c-runtime-library/reference/logb-logbf-logbl-logb-logbf).  
