...
The latest version of this topic can be found at [isalnum, iswalnum, _isalnum_l, _iswalnum_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isalnum-iswalnum-isalnum-l-iswalnum-l).  
...
## .NET Framework Equivalent  
 [System::Char::IsLetterOrDigit](https://msdn.microsoft.com/library/system.char.isletterordigit.aspx)  
