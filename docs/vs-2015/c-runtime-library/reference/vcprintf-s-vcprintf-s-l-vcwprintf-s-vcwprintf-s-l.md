...
The latest version of this topic can be found at [_vcprintf_s, _vcprintf_s_l, _vcwprintf_s, _vcwprintf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vcprintf-s-vcprintf-s-l-vcwprintf-s-vcwprintf-s-l).  
