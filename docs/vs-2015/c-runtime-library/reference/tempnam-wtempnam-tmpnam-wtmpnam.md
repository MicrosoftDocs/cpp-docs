...
The latest version of this topic can be found at [_tempnam, _wtempnam, tmpnam, _wtmpnam](https://docs.microsoft.com/cpp/c-runtime-library/reference/tempnam-wtempnam-tmpnam-wtmpnam).  
