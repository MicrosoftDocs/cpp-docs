...
The latest version of this topic can be found at [Bessel Functions: _j0, _j1, _jn, _y0, _y1, _yn](https://docs.microsoft.com/cpp/c-runtime-library/reference/bessel-functions-j0-j1-jn-y0-y1-yn).  
