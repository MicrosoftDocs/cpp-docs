...
The latest version of this topic can be found at [exp, expf, expl](https://docs.microsoft.com/cpp/c-runtime-library/reference/exp-expf).  
...
## .NET Framework Equivalent  
 [System::Math::Exp](https://msdn.microsoft.com/library/system.math.exp.aspx)  
