...
The latest version of this topic can be found at [_vcprintf_p, _vcprintf_p_l, _vcwprintf_p, _vcwprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vcprintf-p-vcprintf-p-l-vcwprintf-p-vcwprintf-p-l).  
