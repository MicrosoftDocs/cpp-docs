...
The latest version of this topic can be found at [strcspn, wcscspn, _mbscspn, _mbscspn_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strcspn-wcscspn-mbscspn-mbscspn-l).  
...
## .NET Framework Equivalent  
 [System::String::Substring](https://msdn.microsoft.com/library/system.string.substring.aspx)  
