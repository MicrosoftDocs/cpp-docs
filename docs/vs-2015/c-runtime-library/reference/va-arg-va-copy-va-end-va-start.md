...
The latest version of this topic can be found at [va_arg, va_copy, va_end, va_start](https://docs.microsoft.com/cpp/c-runtime-library/reference/va-arg-va-copy-va-end-va-start).  
...
## .NET Framework Equivalent  
 [System::ParamArrayAttribute Class](https://msdn.microsoft.com/library/system.paramarrayattribute.aspx)  
