...
The latest version of this topic can be found at [islower, iswlower, _islower_l, _iswlower_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/islower-iswlower-islower-l-iswlower-l).  
