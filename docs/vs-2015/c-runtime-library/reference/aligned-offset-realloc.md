...
The latest version of this topic can be found at [_aligned_offset_realloc](https://docs.microsoft.com/cpp/c-runtime-library/reference/aligned-offset-realloc).  
