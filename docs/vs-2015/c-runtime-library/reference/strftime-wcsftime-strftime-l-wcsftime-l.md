...
The latest version of this topic can be found at [strftime, wcsftime, _strftime_l, _wcsftime_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strftime-wcsftime-strftime-l-wcsftime-l).  
...
-   [System::DateTime::ToLongDateString](https://msdn.microsoft.com/library/system.datetime.tolongdatestring.aspx)  
  
-   [System::DateTime::ToLongTimeString](https://msdn.microsoft.com/library/system.datetime.tolongtimestring.aspx)  
  
-   [System::DateTime::ToShortDateString](https://msdn.microsoft.com/library/system.datetime.toshortdatestring.aspx)  
