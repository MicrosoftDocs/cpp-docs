...
The latest version of this topic can be found at [_endthread, _endthreadex](https://docs.microsoft.com/cpp/c-runtime-library/reference/endthread-endthreadex).  
