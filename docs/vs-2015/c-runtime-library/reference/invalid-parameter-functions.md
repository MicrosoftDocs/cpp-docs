...
The latest version of this topic can be found at [_invalid_parameter, _invalid_parameter_noinfo, _invalid_parameter_noinfo_noreturn, _invoke_watson](https://docs.microsoft.com/cpp/c-runtime-library/reference/invalid-parameter-functions).  
