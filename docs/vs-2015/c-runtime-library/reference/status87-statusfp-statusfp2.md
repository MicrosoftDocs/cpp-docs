...
The latest version of this topic can be found at [_status87, _statusfp, _statusfp2](https://docs.microsoft.com/cpp/c-runtime-library/reference/status87-statusfp-statusfp2).  
