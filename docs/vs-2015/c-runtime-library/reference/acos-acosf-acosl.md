...
The latest version of this topic can be found at [acos, acosf, acosl](https://docs.microsoft.com/cpp/c-runtime-library/reference/acos-acosf-acosl).  
...
## .NET Framework Equivalent  
 [System::Math::Acos](https://msdn.microsoft.com/library/system.math.acos.aspx)  
