...
The latest version of this topic can be found at [_set_invalid_parameter_handler, _set_thread_local_invalid_parameter_handler](https://docs.microsoft.com/cpp/c-runtime-library/reference/set-invalid-parameter-handler-set-thread-local-invalid-parameter-handler).  
