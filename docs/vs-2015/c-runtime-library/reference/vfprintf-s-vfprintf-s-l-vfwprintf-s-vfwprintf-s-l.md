...
The latest version of this topic can be found at [vfprintf_s, _vfprintf_s_l, vfwprintf_s, _vfwprintf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vfprintf-s-vfprintf-s-l-vfwprintf-s-vfwprintf-s-l).  
