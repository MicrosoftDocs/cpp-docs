...
The latest version of this topic can be found at [_strupr_s, _strupr_s_l, _mbsupr_s, _mbsupr_s_l, _wcsupr_s, _wcsupr_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strupr-s-strupr-s-l-mbsupr-s-mbsupr-s-l-wcsupr-s-wcsupr-s-l).  
...
## .NET Framework Equivalent  
 [System::String::ToUpper](https://msdn.microsoft.com/library/system.string.toupper.aspx)  
