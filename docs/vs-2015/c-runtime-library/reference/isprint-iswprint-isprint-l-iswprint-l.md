...
The latest version of this topic can be found at [isprint, iswprint, _isprint_l, _iswprint_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isprint-iswprint-isprint-l-iswprint-l).  
