...
The latest version of this topic can be found at [strcat_s, wcscat_s, _mbscat_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/strcat-s-wcscat-s-mbscat-s).  
