...
The latest version of this topic can be found at [strerror_s, _strerror_s, _wcserror_s, __wcserror_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/strerror-s-strerror-s-wcserror-s-wcserror-s).  
...
## .NET Framework Equivalent  
 [System::Exception::Message](https://msdn.microsoft.com/library/system.exception.message.aspx)  
