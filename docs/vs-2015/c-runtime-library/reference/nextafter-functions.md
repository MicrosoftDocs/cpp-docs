...
The latest version of this topic can be found at [nextafter, nextafterf, nextafterl, _nextafter, _nextafterf, nexttoward, nexttowardf, nexttowardl](https://docs.microsoft.com/cpp/c-runtime-library/reference/nextafter-functions).  
