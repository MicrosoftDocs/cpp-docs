...
The latest version of this topic can be found at [_cscanf_s, _cscanf_s_l, _cwscanf_s, _cwscanf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/cscanf-s-cscanf-s-l-cwscanf-s-cwscanf-s-l).  
