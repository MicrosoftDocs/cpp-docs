...
The latest version of this topic can be found at [_isctype, iswctype, _isctype_l, _iswctype_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isctype-iswctype-isctype-l-iswctype-l).  
