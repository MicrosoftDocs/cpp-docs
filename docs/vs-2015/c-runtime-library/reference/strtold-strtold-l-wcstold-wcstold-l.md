...
The latest version of this topic can be found at [strtold, _strtold_l, wcstold, _wcstold_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strtold-strtold-l-wcstold-wcstold-l).  
...
## .NET Framework Equivalent  
 [System::Convert::ToDouble](https://msdn.microsoft.com/library/system.convert.todouble.aspx)  
