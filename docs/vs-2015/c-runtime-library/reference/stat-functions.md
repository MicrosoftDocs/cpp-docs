...
The latest version of this topic can be found at [_stat, _stat32, _stat64, _stati64, _stat32i64, _stat64i32, _wstat, _wstat32, _wstat64, _wstati64, _wstat32i64, _wstat64i32](https://docs.microsoft.com/cpp/c-runtime-library/reference/stat-functions).  
...
> [!NOTE]
>  `_wstat` does not work with [!INCLUDE[wiprlhext](../../includes/wiprlhext-md.md)] symbolic links. In these cases, `_wstat` will always report a file size of 0. `_stat` does work correctly with symbolic links.  
...
-   [System::IO::File::GetAttributes](https://msdn.microsoft.com/library/system.io.file.getattributes.aspx)  
  
-   [System::IO::File::GetCreationTime](https://msdn.microsoft.com/library/system.io.file.getcreationtime.aspx)  
  
-   [System::IO::File::GetLastAccessTime](https://msdn.microsoft.com/library/system.io.file.getlastaccesstime.aspx)  
  
-   [System::IO::File::GetLastWriteTime](https://msdn.microsoft.com/library/system.io.file.getlastwritetime.aspx)  
