...
The latest version of this topic can be found at [_aligned_offset_malloc](https://docs.microsoft.com/cpp/c-runtime-library/reference/aligned-offset-malloc).  
