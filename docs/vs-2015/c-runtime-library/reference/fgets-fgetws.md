...
The latest version of this topic can be found at [fgets, fgetws](https://docs.microsoft.com/cpp/c-runtime-library/reference/fgets-fgetws).  
...
-   [System::IO::StreamReader::ReadLine](https://msdn.microsoft.com/library/system.io.streamreader.readline.aspx)  
  
-   [System::IO::TextReader::ReadBlock](https://msdn.microsoft.com/library/system.io.textreader.readblock.aspx)  
