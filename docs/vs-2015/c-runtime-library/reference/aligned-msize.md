...
The latest version of this topic can be found at [_aligned_msize](https://docs.microsoft.com/cpp/c-runtime-library/reference/aligned-msize).  
...
## Remarks  
 ...
 When the application is linked with a debug version of the C run-time libraries, `_aligned_msize` resolves to [_aligned_msize_dbg](../../c-runtime-library/reference/aligned-msize-dbg.md). For more information about how the heap is managed during the debugging process, see [The CRT Debug Heap](http://msdn.microsoft.com/library/bf78ace6-28e4-4a04-97c6-39e0cdd00ba4).  
