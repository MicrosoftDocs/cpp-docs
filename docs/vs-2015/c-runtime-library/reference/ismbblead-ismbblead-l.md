...
The latest version of this topic can be found at [_ismbblead, _ismbblead_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbblead-ismbblead-l).  
