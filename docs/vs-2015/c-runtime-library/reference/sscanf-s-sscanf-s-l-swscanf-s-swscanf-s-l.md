...
The latest version of this topic can be found at [sscanf_s, _sscanf_s_l, swscanf_s, _swscanf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/sscanf-s-sscanf-s-l-swscanf-s-swscanf-s-l).  
...
## .NET Framework Equivalent  
 See `Parse` methods, such as [System::Double::Parse](https://msdn.microsoft.com/library/system.double.parse.aspx).  
