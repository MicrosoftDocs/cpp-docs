...
The latest version of this topic can be found at [fscanf, _fscanf_l, fwscanf, _fwscanf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/fscanf-fscanf-l-fwscanf-fwscanf-l).  
