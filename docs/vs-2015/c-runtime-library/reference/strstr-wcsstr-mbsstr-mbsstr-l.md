...
The latest version of this topic can be found at [strstr, wcsstr, _mbsstr, _mbsstr_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strstr-wcsstr-mbsstr-mbsstr-l).  
  
Returns a pointer to the first occurrence of a search string in a string.  
  
> [!IMPORTANT]
>  `_mbsstr` and `_mbsstr_l` cannot be used in applications that execute in the [!INCLUDE[wrt](../../includes/wrt-md.md)]. For more information, see [CRT functions not supported with /ZW](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
...
## .NET Framework Equivalent  
 [System::String::IndexOf](https://msdn.microsoft.com/library/system.string.indexof.aspx)  
