...
The latest version of this topic can be found at [isdigit, iswdigit, _isdigit_l, _iswdigit_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isdigit-iswdigit-isdigit-l-iswdigit-l).  
