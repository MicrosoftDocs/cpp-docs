...
The latest version of this topic can be found at [sqrt, sqrtf, sqrtl](https://docs.microsoft.com/cpp/c-runtime-library/reference/sqrt-sqrtf-sqrtl).  
...
## .NET Framework Equivalent  
 [System::Math::Sqrt](https://msdn.microsoft.com/library/system.math.sqrt.aspx)  
