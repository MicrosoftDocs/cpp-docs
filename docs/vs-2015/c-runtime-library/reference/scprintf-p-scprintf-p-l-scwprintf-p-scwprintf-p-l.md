...
The latest version of this topic can be found at [_scprintf_p, _scprintf_p_l, _scwprintf_p, _scwprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/scprintf-p-scprintf-p-l-scwprintf-p-scwprintf-p-l).  
