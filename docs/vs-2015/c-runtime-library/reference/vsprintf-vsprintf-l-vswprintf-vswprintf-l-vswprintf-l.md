...
The latest version of this topic can be found at [vsprintf, _vsprintf_l, vswprintf, _vswprintf_l, __vswprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vsprintf-vsprintf-l-vswprintf-vswprintf-l-vswprintf-l).  
...
## .NET Framework Equivalent  
 [System::String::Format](https://msdn.microsoft.com/library/system.string.format.aspx)  
