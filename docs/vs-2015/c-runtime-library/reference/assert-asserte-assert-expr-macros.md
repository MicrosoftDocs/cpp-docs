...
The latest version of this topic can be found at [_ASSERT, _ASSERTE, _ASSERT_EXPR Macros](https://docs.microsoft.com/cpp/c-runtime-library/reference/assert-asserte-assert-expr-macros).  
...
```  
 ...
 For more information about the reporting process, see the [_CrtDbgReport, _CrtDbgReportW](../../c-runtime-library/reference/crtdbgreport-crtdbgreportw.md) function. For more information about resolving assertion failures and using these macros as a debugging error handling mechanism, see [Using Macros for Verification and Reporting](http://msdn.microsoft.com/library/f2085314-a3a8-4caf-a5a4-2af9ad5aad05).  
...
## .NET Framework Equivalent  
 [System::Diagnostics::Debug::Assert](https://msdn.microsoft.com/library/system.diagnostics.debug.assert.aspx)  
