...
The latest version of this topic can be found at [strncat_s, _strncat_s_l, wcsncat_s, _wcsncat_s_l, _mbsncat_s, _mbsncat_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strncat-s-strncat-s-l-wcsncat-s-wcsncat-s-l-mbsncat-s-mbsncat-s-l).  
...
## .NET Framework Equivalent  
 [System::String::Concat](https://msdn.microsoft.com/library/system.string.concat.aspx)  
