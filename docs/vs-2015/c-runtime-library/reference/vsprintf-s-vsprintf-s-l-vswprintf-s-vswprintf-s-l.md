...
The latest version of this topic can be found at [vsprintf_s, _vsprintf_s_l, vswprintf_s, _vswprintf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vsprintf-s-vsprintf-s-l-vswprintf-s-vswprintf-s-l).  
