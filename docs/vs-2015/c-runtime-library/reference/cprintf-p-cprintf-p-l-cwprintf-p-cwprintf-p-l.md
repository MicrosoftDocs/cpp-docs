...
The latest version of this topic can be found at [_cprintf_p, _cprintf_p_l, _cwprintf_p, _cwprintf_p_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/cprintf-p-cprintf-p-l-cwprintf-p-cwprintf-p-l).  
