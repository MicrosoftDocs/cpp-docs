...
The latest version of this topic can be found at [floor, floorf, floorl](https://docs.microsoft.com/cpp/c-runtime-library/reference/floor-floorf-floorl).  
...
## .NET Framework Equivalent  
 [System::Math::Floor](https://msdn.microsoft.com/library/system.math.floor.aspx)  
