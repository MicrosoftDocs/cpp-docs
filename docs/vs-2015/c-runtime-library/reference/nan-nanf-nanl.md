...
The latest version of this topic can be found at [nan, nanf, nanl](https://docs.microsoft.com/cpp/c-runtime-library/reference/nan-nanf-nanl).  
...
## .NET Framework Equivalent  
 [System::Double::NaN](https://msdn.microsoft.com/library/system.double.nan.aspx)  
