...
The latest version of this topic can be found at [lrint, lrintf, lrintl, llrint, llrintf, llrintl](https://docs.microsoft.com/cpp/c-runtime-library/reference/lrint-lrintf-lrintl-llrint-llrintf-llrintl).  
