...
The latest version of this topic can be found at [_seh_filter_dll, _seh_filter_exe](https://docs.microsoft.com/cpp/c-runtime-library/reference/seh-filter-dll-seh-filter-exe).  
