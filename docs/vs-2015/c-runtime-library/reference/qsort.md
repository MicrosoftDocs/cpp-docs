...
The latest version of this topic can be found at [qsort](https://docs.microsoft.com/cpp/c-runtime-library/reference/qsort).  
...
## .NET Framework Equivalent  
 [System::Collections::ArrayList::Sort](https://msdn.microsoft.com/library/system.collections.arraylist.sort.aspx)  
