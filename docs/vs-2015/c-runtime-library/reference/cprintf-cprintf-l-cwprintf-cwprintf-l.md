...
The latest version of this topic can be found at [_cprintf, _cprintf_l, _cwprintf, _cwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/cprintf-cprintf-l-cwprintf-cwprintf-l).  
