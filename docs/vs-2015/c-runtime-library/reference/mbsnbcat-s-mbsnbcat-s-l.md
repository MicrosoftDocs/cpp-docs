...
The latest version of this topic can be found at [_mbsnbcat_s, _mbsnbcat_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/mbsnbcat-s-mbsnbcat-s-l).  
