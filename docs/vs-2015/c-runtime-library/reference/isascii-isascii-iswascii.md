...
The latest version of this topic can be found at [isascii, __isascii, iswascii](https://docs.microsoft.com/cpp/c-runtime-library/reference/isascii-isascii-iswascii).  
