...
The latest version of this topic can be found at [_ismbclower, _ismbclower_l, _ismbcupper, _ismbcupper_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbclower-ismbclower-l-ismbcupper-ismbcupper-l).  
...
-   [System::Char::IsLower](https://msdn.microsoft.com/library/system.char.islower.aspx)  
  
-   [System::Char::IsUpper](https://msdn.microsoft.com/library/system.char.isupper.aspx)  
