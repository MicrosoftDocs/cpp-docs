...
The latest version of this topic can be found at [erf, erff, erfl, erfc, erfcf, erfcl](https://docs.microsoft.com/cpp/c-runtime-library/reference/erf-erff-erfl-erfc-erfcf-erfcl).  
...
## Remarks  
 ...
 ![The error function of x](../../c-runtime-library/reference/media/crt-erf-formula.PNG "CRT_erf_formula")  
