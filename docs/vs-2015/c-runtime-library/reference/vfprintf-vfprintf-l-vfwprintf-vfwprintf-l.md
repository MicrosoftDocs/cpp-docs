...
The latest version of this topic can be found at [vfprintf, _vfprintf_l, vfwprintf, _vfwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vfprintf-vfprintf-l-vfwprintf-vfwprintf-l).  
