...
The latest version of this topic can be found at [_ungetch, _ungetwch, _ungetch_nolock, _ungetwch_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/ungetch-ungetwch-ungetch-nolock-ungetwch-nolock).  
