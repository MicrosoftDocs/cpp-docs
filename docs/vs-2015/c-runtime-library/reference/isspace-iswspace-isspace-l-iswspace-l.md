...
The latest version of this topic can be found at [isspace, iswspace, _isspace_l, _iswspace_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isspace-iswspace-isspace-l-iswspace-l).  
