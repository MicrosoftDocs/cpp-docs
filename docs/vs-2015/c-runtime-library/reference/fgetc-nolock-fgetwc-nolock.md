...
The latest version of this topic can be found at [_fgetc_nolock, _fgetwc_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/fgetc-nolock-fgetwc-nolock).  
