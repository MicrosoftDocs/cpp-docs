...
The latest version of this topic can be found at [toupper, _toupper, towupper, _toupper_l, _towupper_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/toupper-toupper-towupper-toupper-l-towupper-l).  
...
## .NET Framework Equivalent  
 [System::Char::ToUpper](https://msdn.microsoft.com/library/system.char.toupper.aspx)  
