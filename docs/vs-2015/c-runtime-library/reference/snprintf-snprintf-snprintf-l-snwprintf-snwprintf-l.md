...
The latest version of this topic can be found at [snprintf, _snprintf, _snprintf_l, _snwprintf, _snwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/snprintf-snprintf-snprintf-l-snwprintf-snwprintf-l).  
