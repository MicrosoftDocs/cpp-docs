...
The latest version of this topic can be found at [log, logf, log10, log10f](https://docs.microsoft.com/cpp/c-runtime-library/reference/log-logf-log10-log10f).  
...
-   [System::Math::Log](https://msdn.microsoft.com/library/system.math.log.aspx)  
  
-   [System::Math::Log10](https://msdn.microsoft.com/library/system.math.log10.aspx)  
