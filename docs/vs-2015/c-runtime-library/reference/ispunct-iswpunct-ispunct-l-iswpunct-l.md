...
The latest version of this topic can be found at [ispunct, iswpunct, _ispunct_l, _iswpunct_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ispunct-iswpunct-ispunct-l-iswpunct-l).  
