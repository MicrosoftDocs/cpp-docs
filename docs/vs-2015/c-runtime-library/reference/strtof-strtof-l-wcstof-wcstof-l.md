...
The latest version of this topic can be found at [strtof, _strtof_l, wcstof, _wcstof_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strtof-strtof-l-wcstof-wcstof-l).  
