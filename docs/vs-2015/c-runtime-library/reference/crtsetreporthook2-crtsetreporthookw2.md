...
The latest version of this topic can be found at [_CrtSetReportHook2, _CrtSetReportHookW2](https://docs.microsoft.com/cpp/c-runtime-library/reference/crtsetreporthook2-crtsetreporthookw2).  
