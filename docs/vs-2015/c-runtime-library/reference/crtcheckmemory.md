...
The latest version of this topic can be found at [_CrtCheckMemory](https://docs.microsoft.com/cpp/c-runtime-library/reference/crtcheckmemory).  
...
## .NET Framework Equivalent  
 [System::Diagnostics::PerformanceCounter](https://msdn.microsoft.com/library/system.diagnostics.performancecounter.aspx)  
