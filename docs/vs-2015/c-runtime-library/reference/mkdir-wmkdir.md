...
The latest version of this topic can be found at [_mkdir, _wmkdir](https://docs.microsoft.com/cpp/c-runtime-library/reference/mkdir-wmkdir).  
...
-   [System::IO::Directory::CreateDirectory](https://msdn.microsoft.com/library/system.io.directory.createdirectory.aspx)  
  
-   [System::IO::DirectoryInfo::CreateSubdirectory](https://msdn.microsoft.com/library/system.io.directoryinfo.createsubdirectory.aspx)  
