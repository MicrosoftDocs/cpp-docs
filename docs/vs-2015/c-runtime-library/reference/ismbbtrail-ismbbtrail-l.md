...
The latest version of this topic can be found at [_ismbbtrail, _ismbbtrail_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbbtrail-ismbbtrail-l).  
