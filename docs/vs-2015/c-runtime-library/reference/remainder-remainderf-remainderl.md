...
The latest version of this topic can be found at [remainder, remainderf, remainderl](https://docs.microsoft.com/cpp/c-runtime-library/reference/remainder-remainderf-remainderl).  
...
## .NET Framework Equivalent  
 [System::Math::IEEERemainder](https://msdn.microsoft.com/library/system.math.ieeeremainder.aspx)  
