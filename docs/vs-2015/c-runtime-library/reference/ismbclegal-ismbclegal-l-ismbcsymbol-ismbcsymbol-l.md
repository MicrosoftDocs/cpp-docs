...
The latest version of this topic can be found at [_ismbclegal, _ismbclegal_l, _ismbcsymbol, _ismbcsymbol_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbclegal-ismbclegal-l-ismbcsymbol-ismbcsymbol-l).  
