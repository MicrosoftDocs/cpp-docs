...
The latest version of this topic can be found at [mbstowcs_s, _mbstowcs_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/mbstowcs-s-mbstowcs-s-l).  
