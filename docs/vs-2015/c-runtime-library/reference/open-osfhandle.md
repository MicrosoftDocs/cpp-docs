...
The latest version of this topic can be found at [_open_osfhandle](https://docs.microsoft.com/cpp/c-runtime-library/reference/open-osfhandle).  
...
## .NET Framework Equivalent  
 [System::IO::FileStream::Handle](https://msdn.microsoft.com/library/system.io.filestream.handle.aspx)  
