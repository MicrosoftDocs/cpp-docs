...
The latest version of this topic can be found at [vprintf, _vprintf_l, vwprintf, _vwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vprintf-vprintf-l-vwprintf-vwprintf-l).  
