...
The latest version of this topic can be found at [_strnset_s, _strnset_s_l, _wcsnset_s, _wcsnset_s_l, _mbsnset_s, _mbsnset_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strnset-s-strnset-s-l-wcsnset-s-wcsnset-s-l-mbsnset-s-mbsnset-s-l).  
...
## .NET Framework Equivalent  
 [System::String::Replace](https://msdn.microsoft.com/library/system.string.replace.aspx)  
