...
The latest version of this topic can be found at [bsearch](https://docs.microsoft.com/cpp/c-runtime-library/reference/bsearch).  
...
## .NET Framework Equivalent  
 [System::Collections::ArrayList::BinarySearch](https://msdn.microsoft.com/library/system.collections.arraylist.binarysearch.aspx)  
