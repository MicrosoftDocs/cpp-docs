...
The latest version of this topic can be found at [_strdup, _wcsdup, _mbsdup](https://docs.microsoft.com/cpp/c-runtime-library/reference/strdup-wcsdup-mbsdup).  
  
Duplicates strings.  
  
> [!IMPORTANT]
>  `_mbsdup` cannot be used in applications that execute in the                  [!INCLUDE[wrt](../../includes/wrt-md.md)]. For more information, see                  [CRT functions not supported with /ZW](http://msdn.microsoft.com/library/windows/apps/jj606124.aspx).  
