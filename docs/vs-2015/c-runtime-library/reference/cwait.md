...
The latest version of this topic can be found at [_cwait](https://docs.microsoft.com/cpp/c-runtime-library/reference/cwait).  
...
## .NET Framework Equivalent  
 [System::Diagnostics::Process::WaitForExit](https://msdn.microsoft.com/library/system.diagnostics.process.waitforexit.aspx)  
