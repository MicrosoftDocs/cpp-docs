...
The latest version of this topic can be found at [ceil, ceilf, ceill](https://docs.microsoft.com/cpp/c-runtime-library/reference/ceil-ceilf-ceill).  
...
## .NET Framework Equivalent  
 [System::Math::Ceiling](https://msdn.microsoft.com/library/system.math.ceiling.aspx)  
