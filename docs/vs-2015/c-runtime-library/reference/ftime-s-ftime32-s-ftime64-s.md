...
The latest version of this topic can be found at [_ftime_s, _ftime32_s, _ftime64_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/ftime-s-ftime32-s-ftime64-s).  
...
## .NET Framework Equivalent  
 [System::DateTime::Now](https://msdn.microsoft.com/library/system.datetime.now.aspx)  
