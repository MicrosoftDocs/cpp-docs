...
The latest version of this topic can be found at [_makepath_s, _wmakepath_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/makepath-s-wmakepath-s).  
