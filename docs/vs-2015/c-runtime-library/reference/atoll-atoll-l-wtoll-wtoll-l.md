...
The latest version of this topic can be found at [atoll, _atoll_l, _wtoll, _wtoll_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/atoll-atoll-l-wtoll-wtoll-l).  
