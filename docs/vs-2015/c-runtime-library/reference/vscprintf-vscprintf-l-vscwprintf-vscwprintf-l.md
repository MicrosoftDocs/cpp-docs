...
The latest version of this topic can be found at [_vscprintf, _vscprintf_l, _vscwprintf, _vscwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vscprintf-vscprintf-l-vscwprintf-vscwprintf-l).  
