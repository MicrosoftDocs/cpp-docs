...
The latest version of this topic can be found at [_fputc_nolock, _fputwc_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/fputc-nolock-fputwc-nolock).  
