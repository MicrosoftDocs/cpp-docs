...
The latest version of this topic can be found at [strerror, _strerror, _wcserror, __wcserror](https://docs.microsoft.com/cpp/c-runtime-library/reference/strerror-strerror-wcserror-wcserror).  
