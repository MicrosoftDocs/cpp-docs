...
The latest version of this topic can be found at [sprintf, _sprintf_l, swprintf, _swprintf_l, __swprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/sprintf-sprintf-l-swprintf-swprintf-l-swprintf-l).  
