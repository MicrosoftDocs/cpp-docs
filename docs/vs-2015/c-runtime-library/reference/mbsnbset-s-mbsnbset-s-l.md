...
The latest version of this topic can be found at [_mbsnbset_s, _mbsnbset_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/mbsnbset-s-mbsnbset-s-l).  
