...
The latest version of this topic can be found at [_flushall](https://docs.microsoft.com/cpp/c-runtime-library/reference/flushall).  
...
-   [System::IO::StreamWriter::Flush](https://msdn.microsoft.com/library/system.io.streamwriter.flush.aspx)  
  
-   [System::IO::TextWriter::Flush](https://msdn.microsoft.com/library/system.io.textwriter.flush.aspx)  
  
-   [System::IO::BinaryWriter::Flush](https://msdn.microsoft.com/library/system.io.binarywriter.flush.aspx)  
