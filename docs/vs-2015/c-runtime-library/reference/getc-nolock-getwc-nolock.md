...
The latest version of this topic can be found at [_getc_nolock, _getwc_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/getc-nolock-getwc-nolock).  
