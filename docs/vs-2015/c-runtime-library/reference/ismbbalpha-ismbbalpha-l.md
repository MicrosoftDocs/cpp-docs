...
The latest version of this topic can be found at [_ismbbalpha, _ismbbalpha_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbbalpha-ismbbalpha-l).  
