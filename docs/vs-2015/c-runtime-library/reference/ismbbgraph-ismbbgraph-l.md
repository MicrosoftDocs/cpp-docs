...
The latest version of this topic can be found at [_ismbbgraph, _ismbbgraph_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/ismbbgraph-ismbbgraph-l).  
