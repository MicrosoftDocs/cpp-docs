...
The latest version of this topic can be found at [isgraph, iswgraph, _isgraph_l, _iswgraph_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isgraph-iswgraph-isgraph-l-iswgraph-l).  
