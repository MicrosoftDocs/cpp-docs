...
The latest version of this topic can be found at [fprintf_s, _fprintf_s_l, fwprintf_s, _fwprintf_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/fprintf-s-fprintf-s-l-fwprintf-s-fwprintf-s-l).  
