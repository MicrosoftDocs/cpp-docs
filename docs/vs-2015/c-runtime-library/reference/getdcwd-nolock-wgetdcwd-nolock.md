...
The latest version of this topic can be found at [_getdcwd_nolock, _wgetdcwd_nolock](https://docs.microsoft.com/cpp/c-runtime-library/reference/getdcwd-nolock-wgetdcwd-nolock).  
...
## .NET Framework Equivalent  
 [System::Environment::CurrentDirectory](https://msdn.microsoft.com/library/system.environment.currentdirectory.aspx)  
