...
The latest version of this topic can be found at [_vcprintf, _vcprintf_l, _vcwprintf, _vcwprintf_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/vcprintf-vcprintf-l-vcwprintf-vcwprintf-l).  
