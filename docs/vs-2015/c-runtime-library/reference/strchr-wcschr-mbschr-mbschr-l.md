...
The latest version of this topic can be found at [strchr, wcschr, _mbschr, _mbschr_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strchr-wcschr-mbschr-mbschr-l).  
