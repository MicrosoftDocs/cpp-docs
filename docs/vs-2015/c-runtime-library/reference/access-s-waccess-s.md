...
The latest version of this topic can be found at [_access_s, _waccess_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/access-s-waccess-s).  
