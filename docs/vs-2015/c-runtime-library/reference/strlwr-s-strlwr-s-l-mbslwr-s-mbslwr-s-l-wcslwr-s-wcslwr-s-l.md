...
The latest version of this topic can be found at [_strlwr_s, _strlwr_s_l, _mbslwr_s, _mbslwr_s_l, _wcslwr_s, _wcslwr_s_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strlwr-s-strlwr-s-l-mbslwr-s-mbslwr-s-l-wcslwr-s-wcslwr-s-l).  
...
## .NET Framework Equivalent  
 [System::String::ToLower](https://msdn.microsoft.com/library/system.string.tolower.aspx)  
