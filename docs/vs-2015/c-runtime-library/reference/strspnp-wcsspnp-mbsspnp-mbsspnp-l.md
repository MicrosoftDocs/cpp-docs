...
The latest version of this topic can be found at [_strspnp, _wcsspnp, _mbsspnp, _mbsspnp_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/strspnp-wcsspnp-mbsspnp-mbsspnp-l).  
