...
The latest version of this topic can be found at [scalbn, scalbnf, scalbnl, scalbln, scalblnf, scalblnl](https://docs.microsoft.com/cpp/c-runtime-library/reference/scalbn-scalbnf-scalbnl-scalbln-scalblnf-scalblnl).  
...
## .NET Framework Equivalent  
 [System::Math::Pow](https://msdn.microsoft.com/library/system.math.pow.aspx)  
