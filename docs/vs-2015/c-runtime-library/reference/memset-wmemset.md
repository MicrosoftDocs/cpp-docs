...
The latest version of this topic can be found at [memset, wmemset](https://docs.microsoft.com/cpp/c-runtime-library/reference/memset-wmemset).  
...
## .NET Framework Equivalent  
 [System::Buffer::SetByte](https://msdn.microsoft.com/library/system.buffer.setbyte.aspx)  
