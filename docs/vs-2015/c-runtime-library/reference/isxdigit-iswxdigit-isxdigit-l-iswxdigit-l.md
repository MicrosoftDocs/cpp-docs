...
The latest version of this topic can be found at [isxdigit, iswxdigit, _isxdigit_l, _iswxdigit_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isxdigit-iswxdigit-isxdigit-l-iswxdigit-l).  
...
## .NET Framework Equivalent  
 [System::Char::IsNumber](https://msdn.microsoft.com/library/system.char.isnumber.aspx)  
