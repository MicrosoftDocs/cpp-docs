...
The latest version of this topic can be found at [isleadbyte, _isleadbyte_l](https://docs.microsoft.com/cpp/c-runtime-library/reference/isleadbyte-isleadbyte-l).  
