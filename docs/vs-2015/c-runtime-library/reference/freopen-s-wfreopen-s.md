...
The latest version of this topic can be found at [freopen_s, _wfreopen_s](https://docs.microsoft.com/cpp/c-runtime-library/reference/freopen-s-wfreopen-s).  
...
-   [System::IO::File::Open](https://msdn.microsoft.com/library/system.io.file.open.aspx)  
