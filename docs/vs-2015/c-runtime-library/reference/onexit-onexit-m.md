...
The latest version of this topic can be found at [_onexit, _onexit_m](https://docs.microsoft.com/cpp/c-runtime-library/reference/onexit-onexit-m).  
...
## .NET Framework Equivalent  
 [System::Diagnostics::Process::Exited](https://msdn.microsoft.com/library/system.diagnostics.process.exited.aspx)  
