...
The latest version of this topic can be found at [_pctype, _pwctype, _wctype, _mbctype, _mbcasemap](https://docs.microsoft.com/cpp/c-runtime-library/pctype-pwctype-wctype-mbctype-mbcasemap).  
