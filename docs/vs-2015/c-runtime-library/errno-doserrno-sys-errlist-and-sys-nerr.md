...
The latest version of this topic can be found at [errno, _doserrno, _sys_errlist, and _sys_nerr](https://docs.microsoft.com/cpp/c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr).  
