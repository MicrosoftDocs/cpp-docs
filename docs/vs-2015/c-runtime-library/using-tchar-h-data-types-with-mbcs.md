...
The latest version of this topic can be found at [Using TCHAR.H Data Types with _MBCS](https://docs.microsoft.com/cpp/c-runtime-library/using-tchar-h-data-types-with-mbcs).  
