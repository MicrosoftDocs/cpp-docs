...
The latest version of this topic can be found at [printf_p Positional Parameters](https://docs.microsoft.com/cpp/c-runtime-library/printf-p-positional-parameters).  
