...
The latest version of this topic can be found at [Required and Optional Header Files](https://docs.microsoft.com/cpp/c-runtime-library/required-and-optional-header-files).  
