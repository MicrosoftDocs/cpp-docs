...
The latest version of this topic can be found at [C Run-Time Library Reference](https://docs.microsoft.com/cpp/c-runtime-library/c-run-time-library-reference).  
