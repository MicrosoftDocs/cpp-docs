...
The latest version of this topic can be found at [Constant and Global Variable Mappings](https://docs.microsoft.com/cpp/c-runtime-library/constant-and-global-variable-mappings).  
