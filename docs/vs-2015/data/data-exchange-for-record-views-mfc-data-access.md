...
The latest version of this topic can be found at [Data Exchange for Record Views   (MFC Data Access)](https://docs.microsoft.com/cpp/data/data-exchange-for-record-views-mfc-data-access).  
