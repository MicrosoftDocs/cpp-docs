...
The latest version of this topic can be found at [OLE DB Templates, Attributes, and Other Implementations](https://docs.microsoft.com/cpp/data/oledb/ole-db-templates-attributes-and-other-implementations).  
...
-   **OLE DB Provider Templates** Used to implement an OLE DB server (provider) application.  
 ...
 To use the OLE DB Templates, you should be familiar with C++ templates, COM, and the OLE DB interfaces. If you are not familiar with OLE DB, see [OLE DB Programmer's Reference](https://msdn.microsoft.com/library/ms713643.aspx).  
...
-   See [OLE DB Programmer's Reference](https://msdn.microsoft.com/library/ms713643.aspx) (in the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)]).  
...
## OLE DB SDK Interfaces  
 In the cases where the OLE DB Templates do not support OLE DB functionality, you need to use the OLE DB interfaces themselves. For more information, see [OLE DB Programmer's Reference](https://msdn.microsoft.com/library/ms713643.aspx) in the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)].  
