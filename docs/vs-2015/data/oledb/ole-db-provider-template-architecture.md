...
The latest version of this topic can be found at [OLE DB Provider Template Architecture](https://docs.microsoft.com/cpp/data/oledb/ole-db-provider-template-architecture).  
