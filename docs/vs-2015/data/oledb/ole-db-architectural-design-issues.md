...
The latest version of this topic can be found at [OLE DB Architectural Design Issues](https://docs.microsoft.com/cpp/data/oledb/ole-db-architectural-design-issues).  
