...
The latest version of this topic can be found at [CRowset::FindNextRow](https://docs.microsoft.com/cpp/data/oledb/crowset-findnextrow).  
...
#### Parameters  
 ...
 `wType`  
 [in] Indicates the data type of the value part of the buffer. For information about type indicators, see [Data Types](https://msdn.microsoft.com/library/ms723969.aspx) in the *OLE DB Programmer's Reference* in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
## See Also  
 ...
 [DBBINDING Structures](https://msdn.microsoft.com/library/ms716845.aspx)
