...
The latest version of this topic can be found at [OLE DB Programming](https://docs.microsoft.com/cpp/data/oledb/ole-db-programming).  
...
|OLE DB interfaces|[OLE DB programmer's reference](https://msdn.microsoft.com/library/ms713643.aspx) (in the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)])|  
