...
The latest version of this topic can be found at [CViewTableUsage, CViewTableInfo](https://docs.microsoft.com/cpp/data/oledb/cviewtableusage-cviewtableinfo).  
