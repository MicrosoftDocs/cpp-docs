...
The latest version of this topic can be found at [Obtaining Metadata with Schema Rowsets](https://docs.microsoft.com/cpp/data/oledb/obtaining-metadata-with-schema-rowsets).  
