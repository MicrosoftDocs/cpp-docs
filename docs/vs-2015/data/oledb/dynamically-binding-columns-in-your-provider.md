...
The latest version of this topic can be found at [Dynamically Binding Columns in Your Provider](https://docs.microsoft.com/cpp/data/oledb/dynamically-binding-columns-in-your-provider).  
