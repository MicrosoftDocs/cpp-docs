...
The latest version of this topic can be found at [Supporting Transactions in OLE DB](https://docs.microsoft.com/cpp/data/oledb/supporting-transactions-in-ole-db).  
