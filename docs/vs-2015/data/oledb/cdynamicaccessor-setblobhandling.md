...
The latest version of this topic can be found at [CDynamicAccessor::SetBlobHandling](https://docs.microsoft.com/cpp/data/oledb/cdynamicaccessor-setblobhandling).  
