...
The latest version of this topic can be found at [OLE DB Resource Pooling and Services](https://docs.microsoft.com/cpp/data/oledb/ole-db-resource-pooling-and-services).  
