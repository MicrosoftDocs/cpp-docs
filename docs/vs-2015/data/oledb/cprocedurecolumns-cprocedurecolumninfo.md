...
The latest version of this topic can be found at [CProcedureColumns, CProcedureColumnInfo](https://docs.microsoft.com/cpp/data/oledb/cprocedurecolumns-cprocedurecolumninfo).  
