...
The latest version of this topic can be found at [CConstraintTableUsage, CConstraintTableUsageInfo](https://docs.microsoft.com/cpp/data/oledb/cconstrainttableusage-cconstrainttableusageinfo).  
