...
The latest version of this topic can be found at [Passing OLE DB Conformance Tests](https://docs.microsoft.com/cpp/data/oledb/passing-ole-db-conformance-tests).  
