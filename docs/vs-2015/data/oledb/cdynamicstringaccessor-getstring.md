...
The latest version of this topic can be found at [CDynamicStringAccessor::GetString](https://docs.microsoft.com/cpp/data/oledb/cdynamicstringaccessor-getstring).  
