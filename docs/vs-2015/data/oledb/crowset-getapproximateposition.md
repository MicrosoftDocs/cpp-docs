...
The latest version of this topic can be found at [CRowset::GetApproximatePosition](https://docs.microsoft.com/cpp/data/oledb/crowset-getapproximateposition).  
...
## See Also  
 ...
 [IRowsetScroll::GetApproximatePosition](https://msdn.microsoft.com/library/ms712901.aspx)
