...
The latest version of this topic can be found at [Storing Strings in the OLE DB Provider](https://docs.microsoft.com/cpp/data/oledb/storing-strings-in-the-ole-db-provider).  
