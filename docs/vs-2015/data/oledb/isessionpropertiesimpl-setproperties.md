...
The latest version of this topic can be found at [ISessionPropertiesImpl::SetProperties](https://docs.microsoft.com/cpp/data/oledb/isessionpropertiesimpl-setproperties).  
