...
The latest version of this topic can be found at [Creating an OLE DB Consumer Using a Wizard](https://docs.microsoft.com/cpp/data/oledb/creating-an-ole-db-consumer-using-a-wizard).  
