...
The latest version of this topic can be found at [CSQLLanguages, CSQLLanguageInfo](https://docs.microsoft.com/cpp/data/oledb/csqllanguages-csqllanguageinfo).  
