...
The latest version of this topic can be found at [OLE DB Consumer Templates Reference](https://docs.microsoft.com/cpp/data/oledb/ole-db-consumer-templates-reference).  
