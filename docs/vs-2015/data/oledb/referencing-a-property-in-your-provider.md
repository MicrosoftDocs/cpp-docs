...
The latest version of this topic can be found at [Referencing a Property in Your Provider](https://docs.microsoft.com/cpp/data/oledb/referencing-a-property-in-your-provider).  
