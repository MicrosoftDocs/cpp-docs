...
The latest version of this topic can be found at [CDynamicParameterAccessor::GetParamType](https://docs.microsoft.com/cpp/data/oledb/cdynamicparameteraccessor-getparamtype).  
