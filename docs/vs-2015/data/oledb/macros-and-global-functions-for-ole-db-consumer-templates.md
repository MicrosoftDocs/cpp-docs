...
The latest version of this topic can be found at [Macros and Global Functions for OLE DB Consumer Templates](https://docs.microsoft.com/cpp/data/oledb/macros-and-global-functions-for-ole-db-consumer-templates).  
