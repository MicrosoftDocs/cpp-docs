...
The latest version of this topic can be found at [IDBSchemaRowsetImpl::CheckRestrictions](https://docs.microsoft.com/cpp/data/oledb/idbschemarowsetimpl-checkrestrictions).  
