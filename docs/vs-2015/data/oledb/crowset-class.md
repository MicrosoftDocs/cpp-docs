...
The latest version of this topic can be found at [CRowset Class](https://docs.microsoft.com/cpp/data/oledb/crowset-class).  
...
|[Compare](../../data/oledb/crowset-compare.md)|Compares two bookmarks using [IRowsetLocate::Compare](https://msdn.microsoft.com/library/ms709539.aspx).|  
...
|[Delete](../../data/oledb/crowset-delete.md)|Deletes rows from the rowset using [IRowsetChange:DeleteRows](https://msdn.microsoft.com/library/ms724362.aspx).|  
...
|[Insert](../../data/oledb/crowset-insert.md)|Creates and inserts a new row using [IRowsetChange:InsertRow](https://msdn.microsoft.com/library/ms716921.aspx).|  
...
|[ReleaseRows](../../data/oledb/crowset-releaserows.md)|Calls [IRowset::ReleaseRows](https://msdn.microsoft.com/library/ms719771.aspx) to release the current row handle.|  
|[SetData](../../data/oledb/crowset-setdata.md)|Sets data values in one or more columns of a row using [IRowsetChange:SetData](https://msdn.microsoft.com/library/ms721232.aspx).|  
