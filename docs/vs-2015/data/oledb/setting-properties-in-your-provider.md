...
The latest version of this topic can be found at [Setting Properties in Your Provider](https://docs.microsoft.com/cpp/data/oledb/setting-properties-in-your-provider).  
