...
The latest version of this topic can be found at [CTableConstraints, CTableConstraintInfo](https://docs.microsoft.com/cpp/data/oledb/ctableconstraints-ctableconstraintinfo).  
