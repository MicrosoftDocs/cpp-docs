...
The latest version of this topic can be found at [IDBPropertiesImpl::GetProperties](https://docs.microsoft.com/cpp/data/oledb/idbpropertiesimpl-getproperties).  
