...
The latest version of this topic can be found at [Modifying the Inheritance of RMyProviderRowset](https://docs.microsoft.com/cpp/data/oledb/modifying-the-inheritance-of-rmyproviderrowset).  
