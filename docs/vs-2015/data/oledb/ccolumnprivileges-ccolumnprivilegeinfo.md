...
The latest version of this topic can be found at [CColumnPrivileges, CColumnPrivilegeInfo](https://docs.microsoft.com/cpp/data/oledb/ccolumnprivileges-ccolumnprivilegeinfo).  
