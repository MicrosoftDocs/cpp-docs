...
The latest version of this topic can be found at [Using an Existing ADO Recordset](https://docs.microsoft.com/cpp/data/oledb/using-an-existing-ado-recordset).  
