...
The latest version of this topic can be found at [CDynamicParameterAccessor::SetParamString](https://docs.microsoft.com/cpp/data/oledb/cdynamicparameteraccessor-setparamstring).  
