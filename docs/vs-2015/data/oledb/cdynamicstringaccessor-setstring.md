...
The latest version of this topic can be found at [CDynamicStringAccessor::SetString](https://docs.microsoft.com/cpp/data/oledb/cdynamicstringaccessor-setstring).  
