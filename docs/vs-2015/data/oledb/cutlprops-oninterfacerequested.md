...
The latest version of this topic can be found at [CUtlProps::OnInterfaceRequested](https://docs.microsoft.com/cpp/data/oledb/cutlprops-oninterfacerequested).  
