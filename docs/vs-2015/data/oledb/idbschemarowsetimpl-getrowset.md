...
The latest version of this topic can be found at [IDBSchemaRowsetImpl::GetRowset](https://docs.microsoft.com/cpp/data/oledb/idbschemarowsetimpl-getrowset).  
...
## Remarks  
 ...
 See [IDBSchemaRowset::GetRowset](https://msdn.microsoft.com/library/ms722634.aspx) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
