...
The latest version of this topic can be found at [IDBSchemaRowsetImpl::SetRestrictions](https://docs.microsoft.com/cpp/data/oledb/idbschemarowsetimpl-setrestrictions).  
...
## Remarks  
 ...
 For more information on schema rowsets, see [IDBSchemaRowset](https://msdn.microsoft.com/library/ms713686.aspx) in the *OLE DB Programmer's Reference* in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
