...
The latest version of this topic can be found at [CConstraintColumnUsage, CConstraintColumnUsageInfo](https://docs.microsoft.com/cpp/data/oledb/cconstraintcolumnusage-cconstraintcolumnusageinfo).  
