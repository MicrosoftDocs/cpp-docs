...
The latest version of this topic can be found at [IDBSchemaRowsetImpl::GetSchemas](https://docs.microsoft.com/cpp/data/oledb/idbschemarowsetimpl-getschemas).  
...
## Remarks  
 This method returns an array of all schema rowsets supported by the provider. See [IDBSchemaRowset::GetSchemas](https://msdn.microsoft.com/library/ms719605.aspx) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
## See Also  
 ...
 [IDBSchemaRowset::GetRowset](https://msdn.microsoft.com/library/ms722634.aspx)   
