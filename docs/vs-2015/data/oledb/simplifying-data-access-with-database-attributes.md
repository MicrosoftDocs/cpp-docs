...
The latest version of this topic can be found at [Simplifying Data Access with Database Attributes](https://docs.microsoft.com/cpp/data/oledb/simplifying-data-access-with-database-attributes).  
