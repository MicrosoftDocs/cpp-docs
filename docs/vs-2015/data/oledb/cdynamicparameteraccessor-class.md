...
The latest version of this topic can be found at [CDynamicParameterAccessor Class](https://docs.microsoft.com/cpp/data/oledb/cdynamicparameteraccessor-class).  
  
  
Similar to [CDynamicAccessor](../../data/oledb/cdynamicaccessor-class.md) but obtains parameter information to be set by calling the [ICommandWithParameters](https://msdn.microsoft.com/library/ms712937.aspx) interface.  
