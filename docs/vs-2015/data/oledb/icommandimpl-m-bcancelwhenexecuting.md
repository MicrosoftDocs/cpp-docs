...
The latest version of this topic can be found at [ICommandImpl::m_bCancelWhenExecuting](https://docs.microsoft.com/cpp/data/oledb/icommandimpl-m-bcancelwhenexecuting).  
