...
The latest version of this topic can be found at [CRowset::Undo](https://docs.microsoft.com/cpp/data/oledb/crowset-undo).  
...
## See Also  
 ...
 [IRowsetUpdate::Undo](https://msdn.microsoft.com/library/ms719655.aspx)
