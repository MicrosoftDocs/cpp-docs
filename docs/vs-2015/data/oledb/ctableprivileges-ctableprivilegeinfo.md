...
The latest version of this topic can be found at [CTablePrivileges, CTablePrivilegeInfo](https://docs.microsoft.com/cpp/data/oledb/ctableprivileges-ctableprivilegeinfo).  
