...
The latest version of this topic can be found at [IRowsetUpdateImpl::m_mapCachedData](https://docs.microsoft.com/cpp/data/oledb/irowsetupdateimpl-m-mapcacheddata).  
