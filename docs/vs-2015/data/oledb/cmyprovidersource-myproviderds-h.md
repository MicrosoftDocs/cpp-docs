...
The latest version of this topic can be found at [CMyProviderSource (MyProviderDS.H)](https://docs.microsoft.com/cpp/data/oledb/cmyprovidersource-myproviderds-h).  
