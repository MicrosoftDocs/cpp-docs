...
The latest version of this topic can be found at [Working with OLE DB Consumer Templates](https://docs.microsoft.com/cpp/data/oledb/working-with-ole-db-consumer-templates).  
