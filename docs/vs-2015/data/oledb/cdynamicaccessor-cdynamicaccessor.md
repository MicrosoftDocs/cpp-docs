...
The latest version of this topic can be found at [CDynamicAccessor::CDynamicAccessor](https://docs.microsoft.com/cpp/data/oledb/cdynamicaccessor-cdynamicaccessor).  
