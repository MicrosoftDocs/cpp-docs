...
The latest version of this topic can be found at [CTranslations, CTranslationInfo](https://docs.microsoft.com/cpp/data/oledb/ctranslations-ctranslationinfo).  
