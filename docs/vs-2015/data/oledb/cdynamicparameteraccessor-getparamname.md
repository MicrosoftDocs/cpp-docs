...
The latest version of this topic can be found at [CDynamicParameterAccessor::GetParamName](https://docs.microsoft.com/cpp/data/oledb/cdynamicparameteraccessor-getparamname).  
