...
The latest version of this topic can be found at [CDynamicParameterAccessor::GetParamLength](https://docs.microsoft.com/cpp/data/oledb/cdynamicparameteraccessor-getparamlength).  
