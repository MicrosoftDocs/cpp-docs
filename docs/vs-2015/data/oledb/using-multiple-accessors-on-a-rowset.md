...
The latest version of this topic can be found at [Using Multiple Accessors on a Rowset](https://docs.microsoft.com/cpp/data/oledb/using-multiple-accessors-on-a-rowset).  
