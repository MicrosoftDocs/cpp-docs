...
The latest version of this topic can be found at [Enabling and Disabling OLE DB Services](https://docs.microsoft.com/cpp/data/oledb/enabling-and-disabling-ole-db-services).  
