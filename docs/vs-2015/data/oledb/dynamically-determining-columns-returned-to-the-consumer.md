...
The latest version of this topic can be found at [Dynamically Determining Columns Returned to the Consumer](https://docs.microsoft.com/cpp/data/oledb/dynamically-determining-columns-returned-to-the-consumer).  
