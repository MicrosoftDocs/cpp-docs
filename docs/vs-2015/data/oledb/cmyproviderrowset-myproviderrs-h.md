...
The latest version of this topic can be found at [CMyProviderRowset (MyProviderRS.H)](https://docs.microsoft.com/cpp/data/oledb/cmyproviderrowset-myproviderrs-h).  
