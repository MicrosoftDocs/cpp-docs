...
The latest version of this topic can be found at [IErrorRecordsImpl::GetErrorHelpContext](https://docs.microsoft.com/cpp/data/oledb/ierrorrecordsimpl-geterrorhelpcontext).  
