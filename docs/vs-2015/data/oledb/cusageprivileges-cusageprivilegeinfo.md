...
The latest version of this topic can be found at [CUsagePrivileges, CUsagePrivilegeInfo](https://docs.microsoft.com/cpp/data/oledb/cusageprivileges-cusageprivilegeinfo).  
