...
The latest version of this topic can be found at [OLE DB Consumers and Providers](https://docs.microsoft.com/cpp/data/oledb/ole-db-consumers-and-providers).  
