...
The latest version of this topic can be found at [Macros for OLE DB Provider Templates](https://docs.microsoft.com/cpp/data/oledb/macros-for-ole-db-provider-templates).  
