...
The latest version of this topic can be found at [Supporting Schema Rowsets](https://docs.microsoft.com/cpp/data/oledb/supporting-schema-rowsets).  
...
```  
 ...
 For more information about which restrictions correspond to a particular schema rowset, consult the table of schema rowset GUIDs in [IDBSchemaRowset](https://msdn.microsoft.com/library/ms713686.aspx) in the *OLE DB Programmer's Reference* in the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)].  
