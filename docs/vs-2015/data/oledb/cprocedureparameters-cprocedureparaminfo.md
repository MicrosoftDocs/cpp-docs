...
The latest version of this topic can be found at [CProcedureParameters CProcedureParamInfo](https://docs.microsoft.com/cpp/data/oledb/cprocedureparameters-cprocedureparaminfo).  
