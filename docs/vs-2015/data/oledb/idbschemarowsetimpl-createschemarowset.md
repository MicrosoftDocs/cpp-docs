...
The latest version of this topic can be found at [IDBSchemaRowsetImpl::CreateSchemaRowset](https://docs.microsoft.com/cpp/data/oledb/idbschemarowsetimpl-createschemarowset).  
