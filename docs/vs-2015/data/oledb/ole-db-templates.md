...
The latest version of this topic can be found at [OLE DB Templates](https://docs.microsoft.com/cpp/data/oledb/ole-db-templates).  
...
## Related Sections  
 ...
 Provides links to the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] documentation on OLE DB.  
