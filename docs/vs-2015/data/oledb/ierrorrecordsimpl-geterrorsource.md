...
The latest version of this topic can be found at [IErrorRecordsImpl::GetErrorSource](https://docs.microsoft.com/cpp/data/oledb/ierrorrecordsimpl-geterrorsource).  
