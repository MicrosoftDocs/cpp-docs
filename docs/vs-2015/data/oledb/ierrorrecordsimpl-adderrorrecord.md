...
The latest version of this topic can be found at [IErrorRecordsImpl::AddErrorRecord](https://docs.microsoft.com/cpp/data/oledb/ierrorrecordsimpl-adderrorrecord).  
