...
The latest version of this topic can be found at [CDynamicParameterAccessor::SetParamLength](https://docs.microsoft.com/cpp/data/oledb/cdynamicparameteraccessor-setparamlength).  
