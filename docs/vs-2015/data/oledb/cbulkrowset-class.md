...
The latest version of this topic can be found at [CBulkRowset Class](https://docs.microsoft.com/cpp/data/oledb/cbulkrowset-class).  
...
## Example  
 ...
 [!code-cpp[NVC_OLEDB_Consumer#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_OLEDB_Consumer/Cpp/NVC_OLEDB_Consumer.cpp#1)]  
