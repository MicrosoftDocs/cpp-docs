...
The latest version of this topic can be found at [CManualAccessor::CreateAccessor](https://docs.microsoft.com/cpp/data/oledb/cmanualaccessor-createaccessor).  
