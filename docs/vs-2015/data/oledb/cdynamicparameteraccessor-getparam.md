...
The latest version of this topic can be found at [CDynamicParameterAccessor::GetParam](https://docs.microsoft.com/cpp/data/oledb/cdynamicparameteraccessor-getparam).  
