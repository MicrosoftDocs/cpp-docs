...
The latest version of this topic can be found at [CColumnDomainUsage, CColumnDomainUsageInfo](https://docs.microsoft.com/cpp/data/oledb/ccolumndomainusage-ccolumndomainusageinfo).  
