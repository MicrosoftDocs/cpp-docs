...
The latest version of this topic can be found at [PROVIDER_COLUMN_ENTRY_TYPE_LENGTH](https://docs.microsoft.com/cpp/data/oledb/provider-column-entry-type-length).  
