...
The latest version of this topic can be found at [Provider Support for Bookmarks](https://docs.microsoft.com/cpp/data/oledb/provider-support-for-bookmarks).  
