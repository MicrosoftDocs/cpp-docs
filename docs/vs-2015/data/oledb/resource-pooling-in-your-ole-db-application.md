...
The latest version of this topic can be found at [Resource Pooling in Your OLE DB Application](https://docs.microsoft.com/cpp/data/oledb/resource-pooling-in-your-ole-db-application).  
