...
The latest version of this topic can be found at [CDynamicAccessor Class](https://docs.microsoft.com/cpp/data/oledb/cdynamicaccessor-class).  
...
|[Close](../../data/oledb/cdynamicaccessor-close.md)|Unbinds all the columns, releases the allocated memory, and releases the [IAccessor](https://msdn.microsoft.com/library/ms719672.aspx) interface pointer in the class.|  
