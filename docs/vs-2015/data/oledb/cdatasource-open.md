...
The latest version of this topic can be found at [CDataSource::Open](https://docs.microsoft.com/cpp/data/oledb/cdatasource-open).  
 ...
 *pPassword*  
 ...
 `nInitMode`  
 [in] Database initialization mode. See [Initialization Properties](https://msdn.microsoft.com/library/ms723127.aspx)in the *OLE DB Programmer's Reference* in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a list of valid initialization modes. If `nInitMode` is zero, no initialization mode is included in the property set used to open the connection.  
...
## Example  
 ...
 [!code-cpp[NVC_OLEDB_Consumer#7](../../snippets/cpp/VS_Snippets_Cpp/NVC_OLEDB_Consumer/Cpp/NVC_OLEDB_Consumer.cpp#7)]  
