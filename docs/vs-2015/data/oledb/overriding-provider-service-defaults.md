...
The latest version of this topic can be found at [Overriding Provider Service Defaults](https://docs.microsoft.com/cpp/data/oledb/overriding-provider-service-defaults).  
