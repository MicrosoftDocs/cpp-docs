...
The latest version of this topic can be found at [Creating an Updatable Provider](https://docs.microsoft.com/cpp/data/oledb/creating-an-updatable-provider).  
