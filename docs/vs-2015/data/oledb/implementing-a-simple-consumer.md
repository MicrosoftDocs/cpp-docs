...
The latest version of this topic can be found at [Implementing a Simple Consumer](https://docs.microsoft.com/cpp/data/oledb/implementing-a-simple-consumer).  
