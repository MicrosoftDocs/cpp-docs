...
The latest version of this topic can be found at [CCharacterSets, CCharacterSetInfo](https://docs.microsoft.com/cpp/data/oledb/ccharactersets-ccharactersetinfo).  
