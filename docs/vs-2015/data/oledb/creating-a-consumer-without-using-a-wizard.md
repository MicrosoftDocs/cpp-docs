...
The latest version of this topic can be found at [Creating a Consumer Without Using a Wizard](https://docs.microsoft.com/cpp/data/oledb/creating-a-consumer-without-using-a-wizard).  
