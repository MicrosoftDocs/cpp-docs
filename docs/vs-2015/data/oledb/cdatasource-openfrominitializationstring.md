...
The latest version of this topic can be found at [CDataSource::OpenFromInitializationString](https://docs.microsoft.com/cpp/data/oledb/cdatasource-openfrominitializationstring).  
