...
The latest version of this topic can be found at [CDataSource::OpenWithPromptFileName](https://docs.microsoft.com/cpp/data/oledb/cdatasource-openwithpromptfilename).  
