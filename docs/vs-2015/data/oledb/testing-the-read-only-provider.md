...
The latest version of this topic can be found at [Testing the Read-Only Provider](https://docs.microsoft.com/cpp/data/oledb/testing-the-read-only-provider).  
