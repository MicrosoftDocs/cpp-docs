...
The latest version of this topic can be found at [Enhancing the Simple Read-Only Provider](https://docs.microsoft.com/cpp/data/oledb/enhancing-the-simple-read-only-provider).  
