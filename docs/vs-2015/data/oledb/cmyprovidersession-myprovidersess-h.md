...
The latest version of this topic can be found at [CMyProviderSession (MyProviderSess.H)](https://docs.microsoft.com/cpp/data/oledb/cmyprovidersession-myprovidersess-h).  
