...
The latest version of this topic can be found at [CRowsetImpl::GetColumnInfo](https://docs.microsoft.com/cpp/data/oledb/crowsetimpl-getcolumninfo).  
...
## Remarks  
 ...
 [!code-cpp[NVC_OLEDB_Provider#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_OLEDB_Provider/Cpp/MyProviderRS.h#1)]  
