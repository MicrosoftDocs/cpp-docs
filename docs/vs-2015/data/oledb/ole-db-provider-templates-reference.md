...
The latest version of this topic can be found at [OLE DB Provider Templates Reference](https://docs.microsoft.com/cpp/data/oledb/ole-db-provider-templates-reference).  
