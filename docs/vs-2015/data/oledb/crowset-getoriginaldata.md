...
The latest version of this topic can be found at [CRowset::GetOriginalData](https://docs.microsoft.com/cpp/data/oledb/crowset-getoriginaldata).  
...
## See Also  
 ...
 [IRowsetUpdate::GetOriginalData](https://msdn.microsoft.com/library/ms709947.aspx)
