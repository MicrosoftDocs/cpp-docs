...
The latest version of this topic can be found at [CMyProviderCommand (MyProviderRS.H)](https://docs.microsoft.com/cpp/data/oledb/cmyprovidercommand-myproviderrs-h).  
