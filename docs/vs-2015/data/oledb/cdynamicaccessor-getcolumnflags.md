...
The latest version of this topic can be found at [CDynamicAccessor::GetColumnFlags](https://docs.microsoft.com/cpp/data/oledb/cdynamicaccessor-getcolumnflags).  
