...
The latest version of this topic can be found at [CDynamicAccessor::SetBlobSizeLimit](https://docs.microsoft.com/cpp/data/oledb/cdynamicaccessor-setblobsizelimit).  
