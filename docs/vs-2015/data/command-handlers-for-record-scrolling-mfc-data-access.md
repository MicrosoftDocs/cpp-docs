...
The latest version of this topic can be found at [Command Handlers for Record Scrolling  (MFC Data Access)](https://docs.microsoft.com/cpp/data/command-handlers-for-record-scrolling-mfc-data-access).  
