...
The latest version of this topic can be found at [MFC: Using Database Classes with Documents and Views](https://docs.microsoft.com/cpp/data/mfc-using-database-classes-with-documents-and-views).  
