...
The latest version of this topic can be found at [Recordset: Architecture (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-architecture-odbc).  
...
##  <a name="_core_using_m_nfields_and_m_nparams"></a> Using m_nFields and m_nParams  
 When a wizard writes a constructor for your class, it also initializes the [m_nFields](http://msdn.microsoft.com/library/ee7088af-bd8a-4984-81d3-897910d492b5) data member, which specifies the number of [field data members](#_core_field_data_members) in the class. If you add any [parameters](#_core_parameter_data_members) to your class, you must also add an initialization for the [m_nParams](http://msdn.microsoft.com/library/b49ec433-08de-47b5-a9c7-32c50a33b5a1) data member, which specifies the number of parameter data members. The framework uses these values to work with the data members.  
