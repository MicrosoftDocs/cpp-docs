...
The latest version of this topic can be found at [ODBC: The ODBC Cursor Library](https://docs.microsoft.com/cpp/data/odbc/odbc-the-odbc-cursor-library).  
