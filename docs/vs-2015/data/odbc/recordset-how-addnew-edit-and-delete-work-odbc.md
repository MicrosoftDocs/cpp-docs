...
##  <a name="_core_adding_a_record"></a> Adding a Record  
 Adding a new record to a recordset involves calling the recordset's [AddNew](http://msdn.microsoft.com/library/2db92826-51bc-46c0-924e-22986554bb1b) member function, setting the values of the new record's field data members, and calling the [Update](http://msdn.microsoft.com/library/2ed347a4-c7a8-4dad-b84d-cf85f1959eb6) member function to write the record to the data source.  
...
-   If **::SQLSetPos** cannot be used, MFC does the following:  
    ...
    2.  If there are changes, **Update** constructs a SQL **INSERT** statement. The columns represented by all dirty field data members are listed in the **INSERT** statement. To force a column to be included, call the [SetFieldDirty](http://msdn.microsoft.com/library/d58037cb-e0bc-4dec-8892-ff73f4c9dbd7) member function:  
...
##  <a name="_core_editing_an_existing_record"></a> Editing an Existing Record  
 Editing an existing record in a recordset involves scrolling to the record, calling the recordset's [Edit](http://msdn.microsoft.com/library/23e34175-5af8-4b65-9551-d6983d718ac7) member function, setting the values of the new record's field data members, and calling the [Update](http://msdn.microsoft.com/library/2ed347a4-c7a8-4dad-b84d-cf85f1959eb6) member function to write the changed record to the data source.  
...
##  <a name="_core_deleting_a_record"></a> Deleting a Record  
 Deleting a record from a recordset involves scrolling to the record and calling the recordset's [Delete](http://msdn.microsoft.com/library/b979f1fc-a45a-4d2e-8860-176a0d7af0ac) member function. Unlike `AddNew` and **Edit**, **Delete** does not require a matching call to **Update**.  
