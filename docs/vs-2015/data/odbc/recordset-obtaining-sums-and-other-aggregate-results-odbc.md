...
The latest version of this topic can be found at [Recordset: Obtaining SUMs and Other Aggregate Results (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-obtaining-sums-and-other-aggregate-results-odbc).  
...
2.  Modify the [DoFieldExchange](http://msdn.microsoft.com/library/197fb2fb-7752-4830-8188-589b4d4ce7e8) function for the recordset. Replace the string representing the column name (the second argument of the [RFX](../../data/odbc/record-field-exchange-using-rfx.md) function calls) with a string representing the aggregation function on the column. For example, replace:  
