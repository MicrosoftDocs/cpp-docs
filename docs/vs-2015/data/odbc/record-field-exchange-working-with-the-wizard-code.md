...
The latest version of this topic can be found at [Record Field Exchange: Working with the Wizard Code](https://docs.microsoft.com/cpp/data/odbc/record-field-exchange-working-with-the-wizard-code).  
