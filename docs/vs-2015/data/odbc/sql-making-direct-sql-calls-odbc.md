...
The latest version of this topic can be found at [SQL: Making Direct SQL Calls (ODBC)](https://docs.microsoft.com/cpp/data/odbc/sql-making-direct-sql-calls-odbc).  
...
##  <a name="_core_making_direct_sql_function_calls"></a> Making Direct SQL Function Calls  
 You can directly execute a SQL call using a [CDatabase Class](../../mfc/reference/cdatabase-class.md) object. Set up your SQL statement string (usually in a `CString`) and pass it to the [CDatabase::ExecuteSQL](http://msdn.microsoft.com/library/f019e896-136b-4e35-bb78-08f87dac2054) member function of your `CDatabase` object. If you use ODBC function calls to send a SQL statement that normally returns records, the records are ignored.  
