...
The latest version of this topic can be found at [Recordset (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-odbc).  
...
-   Pass the option **CRecordset::forwardOnly** as the `nOpenType` parameter of the [Open](http://msdn.microsoft.com/library/fb837c3c-133d-45e9-8f6c-aeb276193081) member function.  
