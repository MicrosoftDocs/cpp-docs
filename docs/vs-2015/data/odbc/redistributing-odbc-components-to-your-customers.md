...
The latest version of this topic can be found at [Redistributing ODBC Components to Your Customers](https://docs.microsoft.com/cpp/data/odbc/redistributing-odbc-components-to-your-customers).  
