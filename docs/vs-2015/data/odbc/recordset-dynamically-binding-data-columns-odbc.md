...
The latest version of this topic can be found at [Recordset: Dynamically Binding Data Columns (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-dynamically-binding-data-columns-odbc).  
