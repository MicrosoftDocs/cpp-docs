...
The latest version of this topic can be found at [Transaction: Performing a Transaction in a Recordset (ODBC)](https://docs.microsoft.com/cpp/data/odbc/transaction-performing-a-transaction-in-a-recordset-odbc).  
