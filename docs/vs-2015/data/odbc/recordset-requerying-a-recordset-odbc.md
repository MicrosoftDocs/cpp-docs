...
The latest version of this topic can be found at [Recordset: Requerying a Recordset (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-requerying-a-recordset-odbc).  
