...
The latest version of this topic can be found at [Programmatically Create a Table in an ODBC Data Source](https://docs.microsoft.com/cpp/data/odbc/data-source-programmatically-creating-a-table-in-an-odbc-data-source).  
