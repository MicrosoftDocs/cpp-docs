...
The latest version of this topic can be found at [Recordset: Parameterizing a Recordset (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-parameterizing-a-recordset-odbc).  
