...
The latest version of this topic can be found at [Record Field Exchange: How RFX Works](https://docs.microsoft.com/cpp/data/odbc/record-field-exchange-how-rfx-works).  
