...
The latest version of this topic can be found at [ODBC Driver Requirements for Dynasets](https://docs.microsoft.com/cpp/data/odbc/odbc-driver-requirements-for-dynasets).  
