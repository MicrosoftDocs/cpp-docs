...
The latest version of this topic can be found at [Recordset: More About Updates (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-more-about-updates-odbc).  
...
###  <a name="_core_how_closing_the_recordset_affects_updates"></a> How Closing the Recordset Affects Updates  
 If you close a recordset, or its associated `CDatabase` object, with a transaction in progress (you have not called [CDatabase::CommitTrans](http://msdn.microsoft.com/library/be4012df-5fae-4fcf-ac2b-cfbe2a6ba96d) or [CDatabase::Rollback](http://msdn.microsoft.com/library/42d03721-5e73-44ab-a2e3-b2fd9f049e16)), the transaction is rolled back automatically (unless your database backend is the Microsoft Jet database engine).  
