...
The latest version of this topic can be found at [Recordset: Performing a Join (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-performing-a-join-odbc).  
