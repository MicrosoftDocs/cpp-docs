...
The latest version of this topic can be found at [Recordset: Working with Large Data Items (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-working-with-large-data-items-odbc).  
