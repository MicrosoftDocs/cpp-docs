...
The latest version of this topic can be found at [Record Field Exchange: Using RFX](https://docs.microsoft.com/cpp/data/odbc/record-field-exchange-using-rfx).  
