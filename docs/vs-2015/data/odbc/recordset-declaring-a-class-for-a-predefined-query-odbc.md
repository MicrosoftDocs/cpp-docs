...
The latest version of this topic can be found at [Recordset: Declaring a Class for a Predefined Query (ODBC)](https://docs.microsoft.com/cpp/data/odbc/recordset-declaring-a-class-for-a-predefined-query-odbc).  
