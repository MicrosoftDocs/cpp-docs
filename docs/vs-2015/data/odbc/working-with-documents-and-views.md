...
The latest version of this topic can be found at [Working with Documents and Views](https://docs.microsoft.com/cpp/data/odbc/working-with-documents-and-views).  
