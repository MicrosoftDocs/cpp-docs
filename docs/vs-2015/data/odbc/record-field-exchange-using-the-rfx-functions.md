...
The latest version of this topic can be found at [Record Field Exchange: Using the RFX Functions](https://docs.microsoft.com/cpp/data/odbc/record-field-exchange-using-the-rfx-functions).  
...
|`RFX_Date`|`CTime`|  
 ...
 For more information, see the RFX function documentation under [Macros and Globals](http://msdn.microsoft.com/library/2b248a3a-8b21-4ba0-a014-260a0debc586) in the *Class Library Reference*. For information about how C++ data types map to SQL data types, see the table ANSI SQL Data Types Mapped to C++ Data Types in [SQL: SQL and C++ Data Types (ODBC)](../../data/odbc/sql-sql-and-cpp-data-types-odbc.md).  
