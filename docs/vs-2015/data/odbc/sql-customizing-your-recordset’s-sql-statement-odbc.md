...
The latest version of this topic can be found at [SQL: Customizing Your Recordset](https://docs.microsoft.com/cpp/data/odbc/sql-customizing-your-recordsets-sql-statement-odbc).  
