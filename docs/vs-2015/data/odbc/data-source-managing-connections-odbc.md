...
The latest version of this topic can be found at [Data Source: Managing Connections (ODBC)](https://docs.microsoft.com/cpp/data/odbc/data-source-managing-connections-odbc).  
...
2.  Call its `OpenEx` or **Open** member function.  
 ...
 For more information about how to specify the data source if it is something other than the one you specified with a wizard, see [CDatabase::OpenEx](http://msdn.microsoft.com/library/46a5b892-5534-47b5-9679-08c342073681) or [CDatabase::Open](http://msdn.microsoft.com/library/b4881066-daef-4aff-9190-6fc51e58612d) in the *MFC Reference*.  
...
1.  Call the `CDatabase` object's [Close](http://msdn.microsoft.com/library/8e56eb8d-784b-4816-9c0e-417650310208) member function.  
