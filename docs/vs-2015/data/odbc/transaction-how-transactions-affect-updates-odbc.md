...
The latest version of this topic can be found at [Transaction: How Transactions Affect Updates (ODBC)](https://docs.microsoft.com/cpp/data/odbc/transaction-how-transactions-affect-updates-odbc).  
