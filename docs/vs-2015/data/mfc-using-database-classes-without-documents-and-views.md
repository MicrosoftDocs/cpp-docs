...
The latest version of this topic can be found at [MFC: Using Database Classes Without Documents and Views](https://docs.microsoft.com/cpp/data/mfc-using-database-classes-without-documents-and-views).  
