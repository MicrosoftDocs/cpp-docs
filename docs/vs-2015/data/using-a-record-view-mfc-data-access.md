...
The latest version of this topic can be found at [Using a Record View  (MFC Data Access)](https://docs.microsoft.com/cpp/data/using-a-record-view-mfc-data-access).  
