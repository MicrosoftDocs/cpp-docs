...
The latest version of this topic can be found at [Your Role in Working with a Record View  (MFC Data Access)](https://docs.microsoft.com/cpp/data/your-role-in-working-with-a-record-view-mfc-data-access).  
