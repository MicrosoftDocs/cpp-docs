...
The latest version of this topic can be found at [ATL Database Classes (OLE DB Templates)](https://docs.microsoft.com/cpp/data/atl-database-classes-ole-db-templates).  
