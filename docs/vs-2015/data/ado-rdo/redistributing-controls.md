...
-   **Replicate the DSN.** You also need to replicate the data source name on the target computer. You can do this programmatically with functions such as [ConfigDSN](https://msdn.microsoft.com/library/ms709275.aspx).  
