...
The latest version of this topic can be found at [What Is the ATL Control-Hosting API?](https://docs.microsoft.com/cpp/atl/what-is-the-atl-control-hosting-api-q).  
