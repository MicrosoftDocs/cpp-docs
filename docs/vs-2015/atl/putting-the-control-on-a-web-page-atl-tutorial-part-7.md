...
The latest version of this topic can be found at [Putting the Control on a Web Page (ATL Tutorial, Part 7)](https://docs.microsoft.com/cpp/atl/putting-the-control-on-a-web-page-atl-tutorial-part-7).  
...
1.  Add the following line to the end of the list of inherited classes in PolyCtl.h and add a comma to the previous line:  
 ...
 [!code-cpp[NVC_ATL_Windowing#62](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#62)]  
  
2.  Add the following line to the COM map in PolyCtl.h:  
  
 [!code-cpp[NVC_ATL_Windowing#63](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#63)]  
