...
The latest version of this topic can be found at [Application Settings, ATL Project Wizard](https://docs.microsoft.com/cpp/atl/reference/application-settings-atl-project-wizard).  
