...
The latest version of this topic can be found at [Options, ATL Simple Object Wizard](https://docs.microsoft.com/cpp/atl/reference/options-atl-simple-object-wizard).  
