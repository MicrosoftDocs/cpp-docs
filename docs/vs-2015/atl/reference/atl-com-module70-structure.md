...
The latest version of this topic can be found at [_ATL_COM_MODULE70 Structure](https://docs.microsoft.com/cpp/atl/reference/atl-com-module70-structure).  
...
## Remarks  
 [_ATL_COM_MODULE](http://msdn.microsoft.com/library/3b93b150-742d-4f62-8f37-ee764860a64a) is defined as a typedef of `_ATL_COM_MODULE70`.  
