...
The latest version of this topic can be found at [CAtlMap Class](https://docs.microsoft.com/cpp/atl/reference/catlmap-class).  
...
### Example  
 [!code-cpp[NVC_ATL_Utilities#72](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#72)]  
