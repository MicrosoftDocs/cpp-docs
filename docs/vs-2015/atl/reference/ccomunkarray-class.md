...
The latest version of this topic can be found at [CComUnkArray Class](https://docs.microsoft.com/cpp/atl/reference/ccomunkarray-class).  
...
### Remarks  
 ...
 [!code-cpp[NVC_ATL_COM#44](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyControl.cpp#44)]  
