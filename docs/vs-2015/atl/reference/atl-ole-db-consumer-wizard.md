...
The latest version of this topic can be found at [ATL OLE DB Consumer Wizard](https://docs.microsoft.com/cpp/atl/reference/atl-ole-db-consumer-wizard).  
