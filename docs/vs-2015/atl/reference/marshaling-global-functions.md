...
The latest version of this topic can be found at [Marshaling Global Functions](https://docs.microsoft.com/cpp/atl/reference/marshaling-global-functions).  
...
### Example  
 [!code-cpp[NVC_ATL_COM#50](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyControl.cpp#50)]  
