...
The latest version of this topic can be found at [IPointerInactiveImpl Class](https://docs.microsoft.com/cpp/atl/reference/ipointerinactiveimpl-class).  
...
### Remarks  
 See [IPointerInactive::GetActivationPolicy](http://msdn.microsoft.com/library/windows/desktop/ms692470) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 See [IPointerInactive::OnInactiveMouseMove](http://msdn.microsoft.com/library/windows/desktop/ms693374) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 See [IPointerInactive::OnInactiveSetCursor](http://msdn.microsoft.com/library/windows/desktop/ms694336) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
