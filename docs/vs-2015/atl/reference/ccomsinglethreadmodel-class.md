...
The latest version of this topic can be found at [CComSingleThreadModel Class](https://docs.microsoft.com/cpp/atl/reference/ccomsinglethreadmodel-class).  
...
## Remarks  
 ...
 Typically, you use `CComSingleThreadModel` through one of two `typedef` names, either [CComObjectThreadModel](http://msdn.microsoft.com/library/69f1e800-c802-4068-9f37-75d59bfc4595) or [CComGlobalsThreadModel](http://msdn.microsoft.com/library/f112382f-da0a-4bfe-bb49-80f9fd908d47). The class referenced by each `typedef` depends on the threading model used, as shown in the following table:  
