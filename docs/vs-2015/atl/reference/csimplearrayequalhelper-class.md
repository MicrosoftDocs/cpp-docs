...
The latest version of this topic can be found at [CSimpleArrayEqualHelper Class](https://docs.microsoft.com/cpp/atl/reference/csimplearrayequalhelper-class).  
