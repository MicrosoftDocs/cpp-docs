...
The latest version of this topic can be found at [CSimpleMap Class](https://docs.microsoft.com/cpp/atl/reference/csimplemap-class).  
...
## Example  
 [!code-cpp[NVC_ATL_Utilities#91](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#91)]  
