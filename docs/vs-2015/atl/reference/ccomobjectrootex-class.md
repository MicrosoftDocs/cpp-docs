...
The latest version of this topic can be found at [CComObjectRootEx Class](https://docs.microsoft.com/cpp/atl/reference/ccomobjectrootex-class).  
...
### Example  
 [!code-cpp[NVC_ATL_COM#41](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyApp.h#41)]  
