...
The latest version of this topic can be found at [CStringRefElementTraits Class](https://docs.microsoft.com/cpp/atl/reference/cstringrefelementtraits-class).  
