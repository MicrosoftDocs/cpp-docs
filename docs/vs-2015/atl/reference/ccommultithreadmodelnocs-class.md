...
The latest version of this topic can be found at [CComMultiThreadModelNoCS Class](https://docs.microsoft.com/cpp/atl/reference/ccommultithreadmodelnocs-class).  
...
|`CComSingleThreadModel`|`CComSingleThreadModel`|  
 ...
 [!code-cpp[NVC_ATL_COM#37](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyAutoCritClass.h#37)]  
