...
The latest version of this topic can be found at [IDispEventImpl Class](https://docs.microsoft.com/cpp/atl/reference/idispeventimpl-class).  
...
### Remarks  
 See [IDispatch::GetIDsOfNames](http://msdn.microsoft.com/en-us/6f6cf233-3481-436e-8d6a-51f93bf91619) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 See [IDispatch::GetTypeInfoCount](http://msdn.microsoft.com/en-us/da876d53-cb8a-465c-a43e-c0eb272e2a12) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
