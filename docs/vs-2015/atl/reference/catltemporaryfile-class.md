...
The latest version of this topic can be found at [CAtlTemporaryFile Class](https://docs.microsoft.com/cpp/atl/reference/catltemporaryfile-class).  
...
### Example  
 [!code-cpp[NVC_ATL_Utilities#73](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#73)]  
...
### Remarks  
 The file name is generated in [CAtlTemporaryFile::CAtlTemporaryFile](#catltemporaryfile__catltemporaryfile) with a call to the [GetTempFile](http://msdn.microsoft.com/library/windows/desktop/aa364991)[!INCLUDE[winSDK](../../includes/winsdk-md.md)] function. The file extension will always be "TFR" for the temporary file.  
