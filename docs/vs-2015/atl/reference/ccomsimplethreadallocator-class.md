...
The latest version of this topic can be found at [CComSimpleThreadAllocator Class](https://docs.microsoft.com/cpp/atl/reference/ccomsimplethreadallocator-class).  
