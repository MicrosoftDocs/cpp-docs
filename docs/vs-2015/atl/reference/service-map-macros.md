...
The latest version of this topic can be found at [Service Map Macros](https://docs.microsoft.com/cpp/atl/reference/service-map-macros).  
...
### Example  
 [!code-cpp[NVC_ATL_COM#57](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyService.h#57)]  
