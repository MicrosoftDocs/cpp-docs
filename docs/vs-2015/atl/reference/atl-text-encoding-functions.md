...
The latest version of this topic can be found at [ATL Text Encoding Functions](https://docs.microsoft.com/cpp/atl/reference/atl-text-encoding-functions).  
...
## Example  
 ...
 [!code-cpp[NVC_ATL_Utilities#95](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#95)]  
