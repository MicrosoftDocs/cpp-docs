...
The latest version of this topic can be found at [ATL Active Server Page Component Wizard](https://docs.microsoft.com/cpp/atl/reference/atl-active-server-page-component-wizard).  
...
## Remarks  
 Beginning with [!INCLUDE[vs_orcas_long](../../includes/vs-orcas-long-md.md)], the registration script produced by this wizard will register its COM components under **HKEY_CURRENT_USER** instead of **HKEY_LOCAL_MACHINE**. To modify this behavior, set the **Register component for all users** option of the ATL Wizard.  
