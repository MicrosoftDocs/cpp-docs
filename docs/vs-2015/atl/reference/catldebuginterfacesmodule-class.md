...
The latest version of this topic can be found at [CAtlDebugInterfacesModule Class](https://docs.microsoft.com/cpp/atl/reference/catldebuginterfacesmodule-class).  
