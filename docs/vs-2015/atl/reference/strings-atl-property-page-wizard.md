...
The latest version of this topic can be found at [Strings, ATL Property Page Wizard](https://docs.microsoft.com/cpp/atl/reference/strings-atl-property-page-wizard).  
