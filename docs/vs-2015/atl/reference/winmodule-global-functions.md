...
The latest version of this topic can be found at [WinModule Global Functions](https://docs.microsoft.com/cpp/atl/reference/winmodule-global-functions).  
...
### Remarks  
 Initializes an `_AtlCreateWndData` structure, which is used to store the **this** pointer used to refer to class instances, and adds it to the list referenced by a module's `_ATL_WIN_MODULE70` structure. Called by [CAtlWinModule::AddCreateWndData](http://msdn.microsoft.com/library/dfef9bd1-409c-44bc-aac3-ef86bfc83570).  
