...
The latest version of this topic can be found at [CRBMultiMap Class](https://docs.microsoft.com/cpp/atl/reference/crbmultimap-class).  
...
### Example  
 [!code-cpp[NVC_ATL_Utilities#85](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#85)]  
...
### Return Value  
 Returns the next [CRBTree::CPair Class](http://msdn.microsoft.com/library/35e224ed-407e-4864-90ee-2dac2432ad41) element associated with the given key.  
