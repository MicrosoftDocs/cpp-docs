...
The latest version of this topic can be found at [IObjectWithSiteImpl Class](https://docs.microsoft.com/cpp/atl/reference/iobjectwithsiteimpl-class).  
...
### Remarks  
 ...
 See [IObjectWithSite::GetSite](http://msdn.microsoft.com/library/windows/desktop/ms694452) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 See [IObjectWithSite::SetSite](http://msdn.microsoft.com/library/windows/desktop/ms683869) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
