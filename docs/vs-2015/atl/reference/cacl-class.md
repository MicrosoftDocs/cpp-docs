...
The latest version of this topic can be found at [CAcl Class](https://docs.microsoft.com/cpp/atl/reference/cacl-class).  
...
-   System  
 ...
 For more details, see the [ACL](http://msdn.microsoft.com/library/windows/desktop/aa374872) discussion in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
