...
The latest version of this topic can be found at [CAtlServiceModuleT Class](https://docs.microsoft.com/cpp/atl/reference/catlservicemodulet-class).  
...
### Remarks  
 ...
 [!code-cpp[NVC_ATL_Service#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Service/Cpp/NVC_ATL_Service.cpp#1)]  
  
 For attributed service projects, this would be in  
  
 [!code-cpp[NVC_ATL_ServiceAttrib#1](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_ServiceAttrib/Cpp/NVC_ATL_ServiceAttrib.cpp#1)]  
