...
The latest version of this topic can be found at [IAxWinAmbientDispatchEx Interface](https://docs.microsoft.com/cpp/atl/reference/iaxwinambientdispatchex-interface).  
