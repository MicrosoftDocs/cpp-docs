...
The latest version of this topic can be found at [CPrimitiveElementTraits Class](https://docs.microsoft.com/cpp/atl/reference/cprimitiveelementtraits-class).  
