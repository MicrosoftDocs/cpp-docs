...
The latest version of this topic can be found at [IAxWinHostWindowLic Interface](https://docs.microsoft.com/cpp/atl/reference/iaxwinhostwindowlic-interface).  
