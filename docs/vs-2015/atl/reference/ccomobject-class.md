...
The latest version of this topic can be found at [CComObject Class](https://docs.microsoft.com/cpp/atl/reference/ccomobject-class).  
...
### Example  
 [!code-cpp[NVC_ATL_COM#38](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyCircle.h#38)]  
  
 [!code-cpp[NVC_ATL_COM#39](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyControl.cpp#39)]  
