...
The latest version of this topic can be found at [CPrivateObjectSecurityDesc Class](https://docs.microsoft.com/cpp/atl/reference/cprivateobjectsecuritydesc-class).  
