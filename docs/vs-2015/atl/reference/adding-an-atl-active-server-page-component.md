...
The latest version of this topic can be found at [Adding an ATL Active Server Page Component](https://docs.microsoft.com/cpp/atl/reference/adding-an-atl-active-server-page-component).  
