...
The latest version of this topic can be found at [CContainedWindowT Class](https://docs.microsoft.com/cpp/atl/reference/ccontainedwindowt-class).  
...
> [!NOTE]
> [CContainedWindow](http://msdn.microsoft.com/library/c2ee637f-92cf-40ea-b46f-554d0586b2fc) is a specialization of `CContainedWindowT`. If you want to change the base class or traits, use `CContainedWindowT` directly.  
...
>  For any given `CContainedWindowT` object, call either **Create** or `SubclassWindow`. You should not invoke both methods on the same object.  
 ...
 [!code-cpp[NVC_ATL_Windowing#38](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/AtlEdit.h#38)]  
  
 [!code-cpp[NVC_ATL_Windowing#39](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/AtlEdit.h#39)]  
  
 [!code-cpp[NVC_ATL_Windowing#40](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/AtlEdit.h#40)]  
...
|Windows|[Windows](http://msdn.microsoft.com/library/windows/desktop/ms632595) and subsequent topics in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]|  
...
### Parameters  
 ...
 `dwStyle`  
 [in] The style of the window. The default value is **WS_CHILD &#124; WS_VISIBLE**. For a list of possible values, see [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
 `dwExStyle`  
 [in] The extended window style. The default value is 0, meaning no extended style. For a list of possible values, see [CreateWindowEx](http://msdn.microsoft.com/library/windows/desktop/ms632680) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
