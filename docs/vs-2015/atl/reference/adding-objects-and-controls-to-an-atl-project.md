...
The latest version of this topic can be found at [Adding Objects and Controls to an ATL Project](https://docs.microsoft.com/cpp/atl/reference/adding-objects-and-controls-to-an-atl-project).  
