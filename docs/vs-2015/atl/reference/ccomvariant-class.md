...
The latest version of this topic can be found at [CComVariant Class](https://docs.microsoft.com/cpp/atl/reference/ccomvariant-class).  
...
### Remarks  
 ...
 [!code-cpp[NVC_ATL_Utilities#76](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#76)]  
