...
The latest version of this topic can be found at [IDocHostUIHandlerDispatch Interface](https://docs.microsoft.com/cpp/atl/reference/idochostuihandlerdispatch-interface).  
