...
The latest version of this topic can be found at [CAutoPtr Class](https://docs.microsoft.com/cpp/atl/reference/cautoptr-class).  
...
## Example  
 [!code-cpp[NVC_ATL_Utilities#74](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#74)]  
