...
The latest version of this topic can be found at [Security Identifier Global Functions](https://docs.microsoft.com/cpp/atl/reference/security-identifier-global-functions).  
