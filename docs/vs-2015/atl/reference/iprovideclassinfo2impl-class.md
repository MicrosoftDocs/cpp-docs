...
The latest version of this topic can be found at [IProvideClassInfo2Impl Class](https://docs.microsoft.com/cpp/atl/reference/iprovideclassinfo2impl-class).  
...
### Remarks  
 See [IProvideClassInfo::GetClassInfo](http://msdn.microsoft.com/library/windows/desktop/ms690192) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 See [IProvideClassInfo2::GetGUID](http://msdn.microsoft.com/library/windows/desktop/ms679721) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
