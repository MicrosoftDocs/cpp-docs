...
The latest version of this topic can be found at [CComSafeDeleteCriticalSection Class](https://docs.microsoft.com/cpp/atl/reference/ccomsafedeletecriticalsection-class).  
