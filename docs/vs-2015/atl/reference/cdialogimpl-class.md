...
The latest version of this topic can be found at [CDialogImpl Class](https://docs.microsoft.com/cpp/atl/reference/cdialogimpl-class).  
...
>  Your class must define an **IDD** member that specifies the dialog template resource ID. For example, the ATL Project Wizard automatically adds the following line to your class:  
 ...
 [!code-cpp[NVC_ATL_Windowing#41](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/MyDlg.h#41)]  
...
|Dialog boxes|[Dialog Boxes](http://msdn.microsoft.com/library/windows/desktop/ms632588) and subsequent topics in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]|  
