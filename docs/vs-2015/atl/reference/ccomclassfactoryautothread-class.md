...
The latest version of this topic can be found at [CComClassFactoryAutoThread Class](https://docs.microsoft.com/cpp/atl/reference/ccomclassfactoryautothread-class).  
