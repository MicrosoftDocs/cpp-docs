...
The latest version of this topic can be found at [CAxWindow Class](https://docs.microsoft.com/cpp/atl/reference/caxwindow-class).  
...
### Remarks  
 ...
 [!code-cpp[NVC_ATL_Windowing#42](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/MyCtrl.cpp#42)]  
