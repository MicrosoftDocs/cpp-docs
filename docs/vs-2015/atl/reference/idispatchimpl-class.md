...
The latest version of this topic can be found at [IDispatchImpl Class](https://docs.microsoft.com/cpp/atl/reference/idispatchimpl-class).  
...
## Remarks  
 ...
 [!code-cpp[NVC_ATL_COM#47](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/Beeper.h#47)]  
...
### Remarks  
 See [IDispatch::GetTypeInfo](http://msdn.microsoft.com/en-us/cc1ec9aa-6c40-4e70-819c-a7c6dd6b8c99) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 See `IDispatch::GetTypeInfoCount` in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 See [IDispatch::Invoke](http://msdn.microsoft.com/en-us/964ade8e-9d8a-4d32-bd47-aa678912a54d) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
