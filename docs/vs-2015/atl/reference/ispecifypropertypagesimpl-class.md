...
The latest version of this topic can be found at [ISpecifyPropertyPagesImpl Class](https://docs.microsoft.com/cpp/atl/reference/ispecifypropertypagesimpl-class).  
...
### Remarks  
 ...
 See [ISpecifyPropertyPages::GetPages](http://msdn.microsoft.com/library/windows/desktop/ms687276) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
