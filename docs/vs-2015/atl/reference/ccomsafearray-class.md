...
The latest version of this topic can be found at [CComSafeArray Class](https://docs.microsoft.com/cpp/atl/reference/ccomsafearray-class).  
...
## Example  
 [!code-cpp[NVC_ATL_Utilities#75](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#75)]  
