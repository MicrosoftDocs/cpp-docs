...
The latest version of this topic can be found at [IAtlMemMgr Class](https://docs.microsoft.com/cpp/atl/reference/iatlmemmgr-class).  
...
## Example  
 [!code-cpp[NVC_ATL_Utilities#94](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#94)]  
