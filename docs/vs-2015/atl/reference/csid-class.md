...
The latest version of this topic can be found at [CSid Class](https://docs.microsoft.com/cpp/atl/reference/csid-class).  
...
### Remarks  
 See [EqualPrefixSid](http://msdn.microsoft.com/library/windows/desktop/aa446621) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for more details.  
