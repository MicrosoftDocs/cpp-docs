...
The latest version of this topic can be found at [CAutoVectorPtrElementTraits Class](https://docs.microsoft.com/cpp/atl/reference/cautovectorptrelementtraits-class).  
