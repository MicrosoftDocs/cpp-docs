...
The latest version of this topic can be found at [Options, ATL Property Page Wizard](https://docs.microsoft.com/cpp/atl/reference/options-atl-property-page-wizard).  
