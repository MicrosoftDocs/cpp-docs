...
The latest version of this topic can be found at [Making an ATL Object Noncreatable](https://docs.microsoft.com/cpp/atl/reference/making-an-atl-object-noncreatable).  
