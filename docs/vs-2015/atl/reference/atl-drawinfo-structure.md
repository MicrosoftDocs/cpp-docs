...
The latest version of this topic can be found at [ATL_DRAWINFO Structure](https://docs.microsoft.com/cpp/atl/reference/atl-drawinfo-structure).  
 ...
 **prcWBounds**  
 If **hdcDraw** is a metafile device context (see [GetDeviceCaps](http://msdn.microsoft.com/library/windows/desktop/dd144877) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]), this is a pointer to a **RECTL** structure specifying the bounding rectangle in the underlying metafile. The rectangle structure contains the window extent and window origin. These values are useful for drawing metafiles. The rectangle indicated by **prcBounds** is nested inside this **prcWBounds** rectangle; they are in the same coordinate space.  
...
## Remarks  
 Typical usage of this structure would be the retrieval of information during the rendering of the target object. For example, you could retrieve values from `ATL_DRAWINFO` inside your overload of [CComControlBase::OnDrawAdvanced](http://msdn.microsoft.com/library/a8e59a81-50f7-4472-a341-dd5909fec133).  
...
## See Also  
 ...
 [CComControlBase::OnDrawAdvanced](http://msdn.microsoft.com/library/a8e59a81-50f7-4472-a341-dd5909fec133)
