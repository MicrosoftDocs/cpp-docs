...
The latest version of this topic can be found at [CComObjectRoot Class](https://docs.microsoft.com/cpp/atl/reference/ccomobjectroot-class).  
...
## Remarks  
 `CComObjectRoot` is a `typedef` of [CComObjectRootEx](../../atl/reference/ccomobjectrootex-class.md) templatized on the default threading model of the server. Thus [CComObjectThreadModel](http://msdn.microsoft.com/library/69f1e800-c802-4068-9f37-75d59bfc4595) will reference either [CComSingleThreadModel](../../atl/reference/ccomsinglethreadmodel-class.md) or [CComMultiThreadModel](../../atl/reference/ccommultithreadmodel-class.md).  
