...
The latest version of this topic can be found at [CAutoRevertImpersonation Class](https://docs.microsoft.com/cpp/atl/reference/cautorevertimpersonation-class).  
