...
The latest version of this topic can be found at [ATL Structures](https://docs.microsoft.com/cpp/atl/reference/atl-structures).  
...
## Related Sections  
 [ATL Reference](../../atl/atl-com-desktop-components.md)  
