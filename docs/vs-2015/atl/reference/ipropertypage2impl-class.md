...
The latest version of this topic can be found at [IPropertyPage2Impl Class](https://docs.microsoft.com/cpp/atl/reference/ipropertypage2impl-class).  
...
### Remarks  
 See [IPropertyPage2::EditProperty](http://msdn.microsoft.com/library/windows/desktop/ms690353) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
