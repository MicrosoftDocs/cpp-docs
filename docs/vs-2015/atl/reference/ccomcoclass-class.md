...
The latest version of this topic can be found at [CComCoClass Class](https://docs.microsoft.com/cpp/atl/reference/ccomcoclass-class).  
...
### Return Value  
 A standard `HRESULT` value. See [CoCreateInstance](http://msdn.microsoft.com/library/windows/desktop/ms686615) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)] for a description of possible return values.  
...
### Example  
 ...
 [!code-cpp[NVC_ATL_COM#11](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyApp.cpp#11)]  
