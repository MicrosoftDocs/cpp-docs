...
The latest version of this topic can be found at [ASP, ATL Active Server Page Component Wizard](https://docs.microsoft.com/cpp/atl/reference/asp-atl-active-server-page-component-wizard).  
