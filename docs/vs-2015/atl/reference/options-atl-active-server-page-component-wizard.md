...
The latest version of this topic can be found at [Options, ATL Active Server Page Component Wizard](https://docs.microsoft.com/cpp/atl/reference/options-atl-active-server-page-component-wizard).  
