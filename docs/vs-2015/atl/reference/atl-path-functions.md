...
The latest version of this topic can be found at [ATL Path functions](https://docs.microsoft.com/cpp/atl/reference/atl-path-functions).  
  
  
ATL provides the ATLPath class for manipulating paths in the form of [CPathT](../../atl/reference/cpatht-class.md). This code can be found in atlpath.h.  
