...
The latest version of this topic can be found at [CSnapInPropertyPageImpl Class](https://docs.microsoft.com/cpp/atl/reference/csnapinpropertypageimpl-class).  
...
### Remarks  
 ...
 For more information on this structure, including a listing of its members, see [PROPSHEETPAGE](http://msdn.microsoft.com/library/aa815151) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
