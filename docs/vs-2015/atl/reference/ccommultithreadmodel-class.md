...
The latest version of this topic can be found at [CComMultiThreadModel Class](https://docs.microsoft.com/cpp/atl/reference/ccommultithreadmodel-class).  
...
### Example  
 ...
 [!code-cpp[NVC_ATL_COM#36](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyAutoCritClass.h#36)]  
