...
The latest version of this topic can be found at [Specifying Compiler Optimization for an ATL Project](https://docs.microsoft.com/cpp/atl/reference/specifying-compiler-optimization-for-an-atl-project).  
