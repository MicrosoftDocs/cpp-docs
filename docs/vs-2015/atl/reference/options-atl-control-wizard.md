...
The latest version of this topic can be found at [Options, ATL Control Wizard](https://docs.microsoft.com/cpp/atl/reference/options-atl-control-wizard).  
