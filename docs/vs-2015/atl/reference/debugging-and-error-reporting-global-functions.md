...
The latest version of this topic can be found at [Debugging and Error Reporting Global Functions](https://docs.microsoft.com/cpp/atl/reference/debugging-and-error-reporting-global-functions).  
...
### Example  
 [!code-cpp[NVC_ATL_COM#52](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyControl.cpp#52)]  
...
### Example  
 [!code-cpp[NVC_ATL_Windowing#95](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/Buddy.h#95)]  
