...
The latest version of this topic can be found at [CDynamicChain Class](https://docs.microsoft.com/cpp/atl/reference/cdynamicchain-class).  
...
-   Call `CDynamicChain::SetChainEntry` to identify which object and which message map you want to chain to.  
 ...
 [!code-cpp[NVC_ATL_Windowing#88](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/MyWindow.h#88)]  
  
 The client then calls `CMyWindow::SetChainEntry`:  
  
 [!code-cpp[NVC_ATL_Windowing#89](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/MyCtrl.cpp#89)]  
