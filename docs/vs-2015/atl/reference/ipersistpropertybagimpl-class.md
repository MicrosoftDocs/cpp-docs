...
The latest version of this topic can be found at [IPersistPropertyBagImpl Class](https://docs.microsoft.com/cpp/atl/reference/ipersistpropertybagimpl-class).  
...
### Remarks  
 See [IPersistPropertyBag::InitNew](https://msdn.microsoft.com/library/aa768204.aspx) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Remarks  
 ...
 See [IPersistPropertyBag::Load](https://msdn.microsoft.com/library/aa768206.aspx) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
