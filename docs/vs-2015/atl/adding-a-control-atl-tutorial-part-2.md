...
The latest version of this topic can be found at [Adding a Control (ATL Tutorial, Part 2)](https://docs.microsoft.com/cpp/atl/adding-a-control-atl-tutorial-part-2).  
