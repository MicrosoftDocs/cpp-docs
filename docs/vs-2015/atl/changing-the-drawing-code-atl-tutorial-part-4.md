...
The latest version of this topic can be found at [Changing the Drawing Code (ATL Tutorial, Part 4)](https://docs.microsoft.com/cpp/atl/changing-the-drawing-code-atl-tutorial-part-4).  
...
1.  Add the line `#include <math.h>` to the top of PolyCtl.h. The top of the file should look like this:  
     ...
     [!code-cpp[NVC_ATL_Windowing#47](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.cpp#47)]  
...
2.  Once the polygon points are calculated, they will be stored in an array of type `POINT`, so add the array after the definition of `m_nSides` in PolyCtl.h:  
     ...
     [!code-cpp[NVC_ATL_Windowing#48](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#48)]  
...
1.  Replace the existing `OnDraw` method in PolyCtl.h with the following code:  
     ...
     [!code-cpp[NVC_ATL_Windowing#49](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.cpp#49)]  
...
1.  Add the declaration of `CalcPoints` to the `IPolyCtl` public section of the `CPolyCtl` class in PolyCtl.h:  
     ...
     [!code-cpp[NVC_ATL_Windowing#50](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#50)]  
  
     The last part of the public section of the `CPolyCtl` class will look like this:  
  
     [!code-cpp[NVC_ATL_Windowing#51](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#51)]  
  
2.  Add this implementation of the `CalcPoints` function to the end of PolyCtl.cpp:  
  
     [!code-cpp[NVC_ATL_Windowing#52](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.cpp#52)]  
...
1.  Use green as the default color by adding this line to the `CPolyCtl` constructor in PolyCtl.h:  
     ...
     [!code-cpp[NVC_ATL_Windowing#53](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#53)]  
  
 The constructor now looks like this:  
  
 [!code-cpp[NVC_ATL_Windowing#54](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#54)]  
...
1.  Update PolyCtl.cpp by adding the call to `FireViewChange` to the `put_Sides` method. When you have finished, the `put_Sides` method should look like this:  
     ...
     [!code-cpp[NVC_ATL_Windowing#55](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.cpp#55)]  
