...
The latest version of this topic can be found at [Adding a Property Page (ATL Tutorial, Part 6)](https://docs.microsoft.com/cpp/atl/adding-a-property-page-atl-tutorial-part-6).  
...
1.  Replace the `Apply` function in PolyProp.h with the following code:  
     ...
     [!code-cpp[NVC_ATL_Windowing#58](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyProp.h#58)]  
...
1.  Add the following code in Polyprop.cpp to the `OnEnChangeSides` method (deleting any code that the wizard put there):  
     ...
     [!code-cpp[NVC_ATL_Windowing#59](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyProp.cpp#59)]  
...
1.  Open PolyCtl.h and add this line to the property map:  
     ...
     [!code-cpp[NVC_ATL_Windowing#60](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#60)]  
  
 The control's property map now looks like this:  
  
 [!code-cpp[NVC_ATL_Windowing#61](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/PolyCtl.h#61)]  
