...
The latest version of this topic can be found at [Testing the Modified ATL DHTML Control](https://docs.microsoft.com/cpp/atl/testing-the-modified-atl-dhtml-control).  
