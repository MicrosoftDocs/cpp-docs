...
The latest version of this topic can be found at [ATL Composite Control Fundamentals](https://docs.microsoft.com/cpp/atl/atl-composite-control-fundamentals).  
