...
The latest version of this topic can be found at [Hosting ActiveX Controls Using ATL AXHost](https://docs.microsoft.com/cpp/atl/hosting-activex-controls-using-atl-axhost).  
...
|8|Main window|Multiple steps|AtlAxCreateControl|  
 ...
 [!code-cpp[NVC_ATL_AxHost#1](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_AxHost/Cpp/NVC_ATL_AxHost.cpp#1)]  
