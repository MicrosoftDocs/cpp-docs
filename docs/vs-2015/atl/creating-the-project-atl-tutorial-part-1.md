...
The latest version of this topic can be found at [Creating the Project (ATL Tutorial, Part 1)](https://docs.microsoft.com/cpp/atl/creating-the-project-atl-tutorial-part-1).  
