...
The latest version of this topic can be found at [Adding Functionality to the Composite Control](https://docs.microsoft.com/cpp/atl/adding-functionality-to-the-composite-control).  
