...
The latest version of this topic can be found at [Implementing the Event Handling Interface](https://docs.microsoft.com/cpp/atl/implementing-the-event-handling-interface).  
