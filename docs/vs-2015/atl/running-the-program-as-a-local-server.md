...
The latest version of this topic can be found at [Running the Program as a Local Server](https://docs.microsoft.com/cpp/atl/running-the-program-as-a-local-server).  
