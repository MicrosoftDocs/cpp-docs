...
The latest version of this topic can be found at [Benefits and Tradeoffs of the Method Used to Link to the CRT](https://docs.microsoft.com/cpp/atl/benefits-and-tradeoffs-of-the-method-used-to-link-to-the-crt).  
