...
The latest version of this topic can be found at [ATL Collection Classes](https://docs.microsoft.com/cpp/atl/atl-collection-classes).  
...
### Code  
 [!code-cpp[NVC_ATL_Utilities#112](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#112)]  
