...
The latest version of this topic can be found at [Implementing CComObjectRootEx](https://docs.microsoft.com/cpp/atl/implementing-ccomobjectrootex).  
  
  
CComObjectRootEx](../Topic/CComObjectRootEx%20Class.md) is essential; all ATL objects must have one instance of `CComObjectRootEx` or [CComObjectRoot](../atl/reference/ccomobjectroot-class.md) in their inheritance. `CComObjectRootEx` provides the default `QueryInterface` mechanism based on COM map entries.  
