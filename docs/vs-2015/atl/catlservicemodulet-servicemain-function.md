...
The latest version of this topic can be found at [CAtlServiceModuleT::ServiceMain Function](https://docs.microsoft.com/cpp/atl/catlservicemodulet-servicemain-function).  
