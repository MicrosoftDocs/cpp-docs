...
The latest version of this topic can be found at [Introduction to ATL Window Classes](https://docs.microsoft.com/cpp/atl/introduction-to-atl-window-classes).  
