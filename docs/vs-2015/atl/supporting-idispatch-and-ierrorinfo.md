...
The latest version of this topic can be found at [Supporting IDispatch and IErrorInfo](https://docs.microsoft.com/cpp/atl/supporting-idispatch-and-ierrorinfo).  
