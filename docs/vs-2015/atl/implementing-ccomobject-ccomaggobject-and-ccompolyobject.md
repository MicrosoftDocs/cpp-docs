...
The latest version of this topic can be found at [Implementing CComObject, CComAggObject, and CComPolyObject](https://docs.microsoft.com/cpp/atl/implementing-ccomobject-ccomaggobject-and-ccompolyobject).  
