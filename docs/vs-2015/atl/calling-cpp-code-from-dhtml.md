...
The latest version of this topic can be found at [Calling C++ Code from DHTML](https://docs.microsoft.com/cpp/atl/calling-cpp-code-from-dhtml).  
...
## Declaring WebBrowser Methods in the Header File  
 ...
 [!code-cpp[NVC_ATL_COM#4](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_COM/Cpp/MyDHTMLCtrl.h#4)]  
