...
The latest version of this topic can be found at [Which ATL Classes Facilitate ActiveX Control Containment?](https://docs.microsoft.com/cpp/atl/which-atl-classes-facilitate-activex-control-containment-q).  
