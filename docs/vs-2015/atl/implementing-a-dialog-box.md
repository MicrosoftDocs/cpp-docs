...
The latest version of this topic can be found at [Implementing a Dialog Box](https://docs.microsoft.com/cpp/atl/implementing-a-dialog-box).  
...
## Example  
 ...
 [!code-cpp[NVC_ATL_Windowing#66](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/MyWindow.h#66)]  
