...
The latest version of this topic can be found at [Active Template Library (ATL) Tutorial](https://docs.microsoft.com/cpp/atl/active-template-library-atl-tutorial).  
