...
The latest version of this topic can be found at [Using Replaceable Parameters (ATL Registrar)](https://docs.microsoft.com/cpp/atl/using-replaceable-parameters-the-registrar-s-preprocessor).  
...
```  
 ...
 [!code-cpp[NVC_ATL_Utilities#113](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Utilities/Cpp/NVC_ATL_Utilities.cpp#113)]  
