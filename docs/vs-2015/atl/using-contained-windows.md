...
The latest version of this topic can be found at [Using Contained Windows](https://docs.microsoft.com/cpp/atl/using-contained-windows).  
...
## Example  
 ...
 [!code-cpp[NVC_ATL_Windowing#67](../snippets/cpp/VS_Snippets_Cpp/NVC_ATL_Windowing/Cpp/MyWindow.h#67)]  
