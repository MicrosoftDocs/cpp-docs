...
The latest version of this topic can be found at [Identifying the Elements of the DHTML Control Project](https://docs.microsoft.com/cpp/atl/identifying-the-elements-of-the-dhtml-control-project).  
