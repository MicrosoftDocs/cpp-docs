...
The latest version of this topic can be found at [code_seg](https://docs.microsoft.com/cpp/preprocessor/code-seg).  
 ...
 **pop** (optional)  
 ...
 You can use the [DUMPBIN.EXE](../build/reference/dumpbin-command-line.md) application to view .obj files. Versions of DUMPBIN for each supported target architecture are included with [!INCLUDE[vsprvs](../includes/vsprvs-md.md)].  
