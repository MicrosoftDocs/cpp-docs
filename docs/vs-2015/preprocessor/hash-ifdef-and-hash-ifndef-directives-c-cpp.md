...
The latest version of this topic can be found at [#ifdef and #ifndef Directives (C/C++)](https://docs.microsoft.com/cpp/preprocessor/hash-ifdef-and-hash-ifndef-directives-c-cpp).  
