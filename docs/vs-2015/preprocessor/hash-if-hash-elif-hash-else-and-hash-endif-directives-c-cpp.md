...
The latest version of this topic can be found at [#if, #elif, #else, and #endif Directives (C/C++)](https://docs.microsoft.com/cpp/preprocessor/hash-if-hash-elif-hash-else-and-hash-endif-directives-c-cpp).  
