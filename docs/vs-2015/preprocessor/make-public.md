...
The latest version of this topic can be found at [make_public](https://docs.microsoft.com/cpp/preprocessor/make-public).  
...
## Remarks  
 ...
 The native type may be implicitly or explicitly private; see [Type Visibility](../misc/type-visibility.md) for more information.  
