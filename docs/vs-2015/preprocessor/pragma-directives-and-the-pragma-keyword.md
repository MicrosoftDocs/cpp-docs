...
The latest version of this topic can be found at [Pragma Directives and the __Pragma Keyword](https://docs.microsoft.com/cpp/preprocessor/pragma-directives-and-the-pragma-keyword).  
