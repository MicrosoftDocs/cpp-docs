...
The latest version of this topic can be found at [Compiler Warnings That Are Off by Default](https://docs.microsoft.com/cpp/preprocessor/compiler-warnings-that-are-off-by-default).  
