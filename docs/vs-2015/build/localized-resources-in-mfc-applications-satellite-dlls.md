...
The latest version of this topic can be found at [Localized Resources in MFC Applications: Satellite DLLs](https://docs.microsoft.com/cpp/build/localized-resources-in-mfc-applications-satellite-dlls).  
