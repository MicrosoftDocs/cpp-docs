...
The latest version of this topic can be found at [Common Visual C++ 64-bit Migration Issues](https://docs.microsoft.com/cpp/build/common-visual-cpp-64-bit-migration-issues).  
