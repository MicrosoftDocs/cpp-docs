...
The latest version of this topic can be found at [Working with Import Libraries and Export Files](https://docs.microsoft.com/cpp/build/reference/working-with-import-libraries-and-export-files).  
