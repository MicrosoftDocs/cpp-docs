...
The latest version of this topic can be found at [-Yc (Create Precompiled Header File)](https://docs.microsoft.com/cpp/build/reference/yc-create-precompiled-header-file).  
