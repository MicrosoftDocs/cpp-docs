...
The latest version of this topic can be found at [-TLBID (Specify Resource ID for TypeLib)](https://docs.microsoft.com/cpp/build/reference/tlbid-specify-resource-id-for-typelib).  
