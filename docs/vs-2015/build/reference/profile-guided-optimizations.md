...
The latest version of this topic can be found at [Profile-Guided Optimizations](https://docs.microsoft.com/cpp/build/reference/profile-guided-optimizations).  
