...
The latest version of this topic can be found at [-Zc:forScope (Force Conformance in for Loop Scope)](https://docs.microsoft.com/cpp/build/reference/zc-forscope-force-conformance-in-for-loop-scope).  
