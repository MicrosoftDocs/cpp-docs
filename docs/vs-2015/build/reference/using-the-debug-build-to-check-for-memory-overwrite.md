...
The latest version of this topic can be found at [Using the Debug Build to Check for Memory Overwrite](https://docs.microsoft.com/cpp/build/reference/using-the-debug-build-to-check-for-memory-overwrite).  
