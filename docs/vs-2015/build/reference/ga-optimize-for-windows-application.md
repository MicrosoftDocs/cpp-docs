...
The latest version of this topic can be found at [-GA (Optimize for Windows Application)](https://docs.microsoft.com/cpp/build/reference/ga-optimize-for-windows-application).  
