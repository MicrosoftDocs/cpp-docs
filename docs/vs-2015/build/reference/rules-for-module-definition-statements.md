...
The latest version of this topic can be found at [Rules for Module-Definition Statements](https://docs.microsoft.com/cpp/build/reference/rules-for-module-definition-statements).  
