...
The latest version of this topic can be found at [-MD, -MT, -LD (Use Run-Time Library)](https://docs.microsoft.com/cpp/build/reference/md-mt-ld-use-run-time-library).  
