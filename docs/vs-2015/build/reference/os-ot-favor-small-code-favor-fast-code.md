...
The latest version of this topic can be found at [-Os, -Ot (Favor Small Code, Favor Fast Code)](https://docs.microsoft.com/cpp/build/reference/os-ot-favor-small-code-favor-fast-code).  
