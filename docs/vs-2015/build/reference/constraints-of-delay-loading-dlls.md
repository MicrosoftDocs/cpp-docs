...
The latest version of this topic can be found at [Constraints of Delay Loading DLLs](https://docs.microsoft.com/cpp/build/reference/constraints-of-delay-loading-dlls).  
