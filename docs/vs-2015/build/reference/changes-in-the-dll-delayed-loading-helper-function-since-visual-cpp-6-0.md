...
The latest version of this topic can be found at [Changes in the DLL Delayed Loading Helper Function Since Visual C++ 6.0](https://docs.microsoft.com/cpp/build/reference/changes-in-the-dll-delayed-loading-helper-function-since-visual-cpp-6-0).  
