...
The latest version of this topic can be found at [-Zc:rvalueCast (Enforce type conversion rules)](https://docs.microsoft.com/cpp/build/reference/zc-rvaluecast-enforce-type-conversion-rules).  
