...
The latest version of this topic can be found at [-CLRUNMANAGEDCODECHECK (Add SupressUnmanagedCodeSecurityAttribute)](https://docs.microsoft.com/cpp/build/reference/clrunmanagedcodecheck-add-supressunmanagedcodesecurityattribute).  
