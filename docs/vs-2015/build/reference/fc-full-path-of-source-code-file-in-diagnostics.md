...
The latest version of this topic can be found at [-FC (Full Path of Source Code File in Diagnostics)](https://docs.microsoft.com/cpp/build/reference/fc-full-path-of-source-code-file-in-diagnostics).  
