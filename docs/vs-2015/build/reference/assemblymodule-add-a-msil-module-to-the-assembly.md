...
The latest version of this topic can be found at [-ASSEMBLYMODULE (Add a MSIL Module to the Assembly)](https://docs.microsoft.com/cpp/build/reference/assemblymodule-add-a-msil-module-to-the-assembly).  
