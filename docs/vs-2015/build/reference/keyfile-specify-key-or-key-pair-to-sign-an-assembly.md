...
The latest version of this topic can be found at [-KEYFILE (Specify Key or Key Pair to Sign an Assembly)](https://docs.microsoft.com/cpp/build/reference/keyfile-specify-key-or-key-pair-to-sign-an-assembly).  
