...
The latest version of this topic can be found at [-utf-8 (Set Source and Executable character sets to UTF-8)](https://docs.microsoft.com/cpp/build/reference/utf-8-set-source-and-executable-character-sets-to-utf-8).  
