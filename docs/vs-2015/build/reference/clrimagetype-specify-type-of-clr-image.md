...
The latest version of this topic can be found at [-CLRIMAGETYPE (Specify Type of CLR Image)](https://docs.microsoft.com/cpp/build/reference/clrimagetype-specify-type-of-clr-image).  
