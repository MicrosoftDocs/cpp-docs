...
The latest version of this topic can be found at [Specifying DLLs to Delay Load](https://docs.microsoft.com/cpp/build/reference/specifying-dlls-to-delay-load).  
