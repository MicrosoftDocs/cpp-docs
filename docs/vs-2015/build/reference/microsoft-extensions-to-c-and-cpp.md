...
The latest version of this topic can be found at [Microsoft Extensions to C and C++](https://docs.microsoft.com/cpp/build/reference/microsoft-extensions-to-c-and-cpp).  
