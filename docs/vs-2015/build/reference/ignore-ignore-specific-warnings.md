...
The latest version of this topic can be found at [-IGNORE (Ignore Specific Warnings)](https://docs.microsoft.com/cpp/build/reference/ignore-ignore-specific-warnings).  
