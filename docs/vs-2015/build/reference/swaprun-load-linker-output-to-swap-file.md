...
The latest version of this topic can be found at [-SWAPRUN (Load Linker Output to Swap File)](https://docs.microsoft.com/cpp/build/reference/swaprun-load-linker-output-to-swap-file).  
