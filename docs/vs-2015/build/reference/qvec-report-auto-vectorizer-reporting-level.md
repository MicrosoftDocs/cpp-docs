...
The latest version of this topic can be found at [-Qvec-report (Auto-Vectorizer Reporting Level)](https://docs.microsoft.com/cpp/build/reference/qvec-report-auto-vectorizer-reporting-level).  
