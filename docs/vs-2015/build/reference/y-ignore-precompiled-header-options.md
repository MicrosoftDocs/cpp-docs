...
The latest version of this topic can be found at [-Y- (Ignore Precompiled Header Options)](https://docs.microsoft.com/cpp/build/reference/y-ignore-precompiled-header-options).  
