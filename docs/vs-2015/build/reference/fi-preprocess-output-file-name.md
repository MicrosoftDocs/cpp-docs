...
The latest version of this topic can be found at [-Fi (Preprocess Output File Name)](https://docs.microsoft.com/cpp/build/reference/fi-preprocess-output-file-name).  
