...
The latest version of this topic can be found at [-Zm (Specify Precompiled Header Memory Allocation Limit)](https://docs.microsoft.com/cpp/build/reference/zm-specify-precompiled-header-memory-allocation-limit).  
