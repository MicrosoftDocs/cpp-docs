...
The latest version of this topic can be found at [-NOASSEMBLY (Create a MSIL Module)](https://docs.microsoft.com/cpp/build/reference/noassembly-create-a-msil-module).  
