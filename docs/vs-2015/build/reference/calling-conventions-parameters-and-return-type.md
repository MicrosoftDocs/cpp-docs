...
The latest version of this topic can be found at [Calling Conventions, Parameters, and Return Type](https://docs.microsoft.com/cpp/build/reference/calling-conventions-parameters-and-return-type).  
