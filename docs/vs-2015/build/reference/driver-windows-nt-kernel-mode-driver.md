...
The latest version of this topic can be found at [-DRIVER (Windows NT Kernel Mode Driver)](https://docs.microsoft.com/cpp/build/reference/driver-windows-nt-kernel-mode-driver).  
