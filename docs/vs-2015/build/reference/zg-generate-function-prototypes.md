...
The latest version of this topic can be found at [-Zg (Generate Function Prototypes)](https://docs.microsoft.com/cpp/build/reference/zg-generate-function-prototypes).  
