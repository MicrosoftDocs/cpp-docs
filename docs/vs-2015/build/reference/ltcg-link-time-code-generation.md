...
The latest version of this topic can be found at [-LTCG (Link-time Code Generation)](https://docs.microsoft.com/cpp/build/reference/ltcg-link-time-code-generation).  
