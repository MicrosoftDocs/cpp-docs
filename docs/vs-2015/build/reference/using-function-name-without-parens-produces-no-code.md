...
The latest version of this topic can be found at [Using Function Name Without () Produces No Code](https://docs.microsoft.com/cpp/build/reference/using-function-name-without-parens-produces-no-code).  
