...
The latest version of this topic can be found at [@ (Specify a Linker Response File)](https://docs.microsoft.com/cpp/build/reference/at-specify-a-linker-response-file).  
