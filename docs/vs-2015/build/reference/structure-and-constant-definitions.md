...
The latest version of this topic can be found at [Structure and Constant Definitions](https://docs.microsoft.com/cpp/build/reference/structure-and-constant-definitions).  
