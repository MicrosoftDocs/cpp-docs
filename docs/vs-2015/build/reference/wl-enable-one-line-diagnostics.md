...
The latest version of this topic can be found at [-WL (Enable One-Line Diagnostics)](https://docs.microsoft.com/cpp/build/reference/wl-enable-one-line-diagnostics).  
