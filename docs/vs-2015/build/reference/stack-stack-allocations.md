...
The latest version of this topic can be found at [-STACK (Stack Allocations)](https://docs.microsoft.com/cpp/build/reference/stack-stack-allocations).  
