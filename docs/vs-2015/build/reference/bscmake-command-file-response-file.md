...
The latest version of this topic can be found at [BSCMAKE Command File (Response File)](https://docs.microsoft.com/cpp/build/reference/bscmake-command-file-response-file).  
