...
The latest version of this topic can be found at [-PDBALTPATH (Use Alternate PDB Path)](https://docs.microsoft.com/cpp/build/reference/pdbaltpath-use-alternate-pdb-path).  
