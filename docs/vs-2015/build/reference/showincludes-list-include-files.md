...
The latest version of this topic can be found at [-showIncludes (List Include Files)](https://docs.microsoft.com/cpp/build/reference/showincludes-list-include-files).  
