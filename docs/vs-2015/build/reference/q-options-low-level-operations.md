...
The latest version of this topic can be found at [-Q Options (Low-Level Operations)](https://docs.microsoft.com/cpp/build/reference/q-options-low-level-operations).  
