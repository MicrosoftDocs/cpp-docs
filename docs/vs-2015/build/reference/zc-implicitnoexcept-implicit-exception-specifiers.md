...
The latest version of this topic can be found at [-Zc:implicitNoexcept (Implicit Exception Specifiers)](https://docs.microsoft.com/cpp/build/reference/zc-implicitnoexcept-implicit-exception-specifiers).  
