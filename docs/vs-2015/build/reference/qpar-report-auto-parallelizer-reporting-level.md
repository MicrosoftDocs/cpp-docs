...
The latest version of this topic can be found at [-Qpar-report (Auto-Parallelizer Reporting Level)](https://docs.microsoft.com/cpp/build/reference/qpar-report-auto-parallelizer-reporting-level).  
