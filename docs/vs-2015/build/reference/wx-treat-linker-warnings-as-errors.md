...
The latest version of this topic can be found at [-WX (Treat Linker Warnings as Errors)](https://docs.microsoft.com/cpp/build/reference/wx-treat-linker-warnings-as-errors).  
