...
The latest version of this topic can be found at [-MIDL (Specify MIDL Command Line Options)](https://docs.microsoft.com/cpp/build/reference/midl-specify-midl-command-line-options).  
