...
The latest version of this topic can be found at [-ASSEMBLYDEBUG (Add DebuggableAttribute)](https://docs.microsoft.com/cpp/build/reference/assemblydebug-add-debuggableattribute).  
