...
The latest version of this topic can be found at [-AI (Specify Metadata Directories)](https://docs.microsoft.com/cpp/build/reference/ai-specify-metadata-directories).  
