...
The latest version of this topic can be found at [-X (Ignore Standard Include Paths)](https://docs.microsoft.com/cpp/build/reference/x-ignore-standard-include-paths).  
