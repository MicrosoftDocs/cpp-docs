...
The latest version of this topic can be found at [How BSCMAKE Builds a .Bsc File](https://docs.microsoft.com/cpp/build/reference/how-bscmake-builds-a-dot-bsc-file).  
