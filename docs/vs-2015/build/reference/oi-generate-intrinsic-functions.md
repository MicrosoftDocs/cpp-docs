...
The latest version of this topic can be found at [-Oi (Generate Intrinsic Functions)](https://docs.microsoft.com/cpp/build/reference/oi-generate-intrinsic-functions).  
