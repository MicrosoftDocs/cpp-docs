...
The latest version of this topic can be found at [-Yl (Inject PCH Reference for Debug Library)](https://docs.microsoft.com/cpp/build/reference/yl-inject-pch-reference-for-debug-library).  
