...
The latest version of this topic can be found at [-Ob (Inline Function Expansion)](https://docs.microsoft.com/cpp/build/reference/ob-inline-function-expansion).  
