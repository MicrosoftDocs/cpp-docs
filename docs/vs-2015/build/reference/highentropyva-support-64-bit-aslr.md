...
The latest version of this topic can be found at [-HIGHENTROPYVA (Support 64-Bit ASLR)](https://docs.microsoft.com/cpp/build/reference/highentropyva-support-64-bit-aslr).  
