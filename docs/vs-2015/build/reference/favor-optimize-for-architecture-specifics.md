...
The latest version of this topic can be found at [-favor (Optimize for Architecture Specifics)](https://docs.microsoft.com/cpp/build/reference/favor-optimize-for-architecture-specifics).  
...
>  Intel64 architecture was previously known as Extended Memory 64 Technology, and the corresponding compiler option was **/favor:EM64T**.  
 ...
 For information about how to program for the [!INCLUDE[vcprx64](../../includes/vcprx64-md.md)] architecture, see [x64 Software Conventions](../../build/x64-software-conventions.md).  
