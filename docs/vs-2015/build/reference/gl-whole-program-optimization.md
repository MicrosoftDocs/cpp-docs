...
The latest version of this topic can be found at [-GL (Whole Program Optimization)](https://docs.microsoft.com/cpp/build/reference/gl-whole-program-optimization).  
