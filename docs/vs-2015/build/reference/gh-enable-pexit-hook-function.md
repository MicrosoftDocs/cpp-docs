...
The latest version of this topic can be found at [-GH (Enable _pexit Hook Function)](https://docs.microsoft.com/cpp/build/reference/gh-enable-pexit-hook-function).  
