...
The latest version of this topic can be found at [-vmb, -vmg (Representation Method)](https://docs.microsoft.com/cpp/build/reference/vmb-vmg-representation-method).  
