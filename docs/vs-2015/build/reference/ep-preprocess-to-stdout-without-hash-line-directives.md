...
The latest version of this topic can be found at [-EP (Preprocess to stdout Without #line Directives)](https://docs.microsoft.com/cpp/build/reference/ep-preprocess-to-stdout-without-hash-line-directives).  
