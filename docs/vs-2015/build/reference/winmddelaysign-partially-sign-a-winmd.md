...
The latest version of this topic can be found at [-WINMDDELAYSIGN (Partially Sign a winmd)](https://docs.microsoft.com/cpp/build/reference/winmddelaysign-partially-sign-a-winmd).  
