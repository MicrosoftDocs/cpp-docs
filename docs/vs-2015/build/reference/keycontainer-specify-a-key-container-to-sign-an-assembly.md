...
The latest version of this topic can be found at [-KEYCONTAINER (Specify a Key Container to Sign an Assembly)](https://docs.microsoft.com/cpp/build/reference/keycontainer-specify-a-key-container-to-sign-an-assembly).  
