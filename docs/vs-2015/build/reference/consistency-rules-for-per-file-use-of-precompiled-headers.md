...
The latest version of this topic can be found at [Consistency Rules for Per-File Use of Precompiled Headers](https://docs.microsoft.com/cpp/build/reference/consistency-rules-for-per-file-use-of-precompiled-headers).  
