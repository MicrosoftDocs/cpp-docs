...
The latest version of this topic can be found at [PCH Files in the Build Process](https://docs.microsoft.com/cpp/build/reference/pch-files-in-the-build-process).  
