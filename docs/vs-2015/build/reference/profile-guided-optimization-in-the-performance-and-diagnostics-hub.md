...
The latest version of this topic can be found at [Profile Guided Optimization in the Performance and Diagnostics Hub](https://docs.microsoft.com/cpp/build/reference/profile-guided-optimization-in-the-performance-and-diagnostics-hub).  
