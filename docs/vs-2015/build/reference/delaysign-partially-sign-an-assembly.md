...
The latest version of this topic can be found at [-DELAYSIGN (Partially Sign an Assembly)](https://docs.microsoft.com/cpp/build/reference/delaysign-partially-sign-an-assembly).  
