...
The latest version of this topic can be found at [-fp (Specify Floating-Point Behavior)](https://docs.microsoft.com/cpp/build/reference/fp-specify-floating-point-behavior).  
