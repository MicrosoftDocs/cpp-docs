...
The latest version of this topic can be found at [IEEE Floating-Point Representation](https://docs.microsoft.com/cpp/build/reference/ieee-floating-point-representation).  
