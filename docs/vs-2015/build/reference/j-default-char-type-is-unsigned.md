...
The latest version of this topic can be found at [-J (Default char Type Is unsigned)](https://docs.microsoft.com/cpp/build/reference/j-default-char-type-is-unsigned).  
