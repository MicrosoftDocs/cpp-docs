...
The latest version of this topic can be found at [Using an Import Library and Export File](https://docs.microsoft.com/cpp/build/reference/using-an-import-library-and-export-file).  
