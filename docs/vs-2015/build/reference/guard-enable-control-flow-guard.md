...
The latest version of this topic can be found at [-guard (Enable Control Flow Guard)](https://docs.microsoft.com/cpp/build/reference/guard-enable-control-flow-guard).  
