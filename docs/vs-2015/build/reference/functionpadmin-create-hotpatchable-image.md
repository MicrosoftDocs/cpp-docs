...
The latest version of this topic can be found at [-FUNCTIONPADMIN (Create Hotpatchable Image)](https://docs.microsoft.com/cpp/build/reference/functionpadmin-create-hotpatchable-image).  
