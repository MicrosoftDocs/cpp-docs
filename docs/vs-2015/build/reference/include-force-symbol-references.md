...
The latest version of this topic can be found at [-INCLUDE (Force Symbol References)](https://docs.microsoft.com/cpp/build/reference/include-force-symbol-references).  
