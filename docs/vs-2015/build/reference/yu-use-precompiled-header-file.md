...
The latest version of this topic can be found at [-Yu (Use Precompiled Header File)](https://docs.microsoft.com/cpp/build/reference/yu-use-precompiled-header-file).  
