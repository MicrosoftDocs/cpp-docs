...
The latest version of this topic can be found at [-DELAY (Delay Load Import Settings)](https://docs.microsoft.com/cpp/build/reference/delay-delay-load-import-settings).  
