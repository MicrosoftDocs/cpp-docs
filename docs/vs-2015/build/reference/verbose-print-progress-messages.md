...
The latest version of this topic can be found at [-VERBOSE (Print Progress Messages)](https://docs.microsoft.com/cpp/build/reference/verbose-print-progress-messages).  
