...
The latest version of this topic can be found at [-Yd (Place Debug Information in Object File)](https://docs.microsoft.com/cpp/build/reference/yd-place-debug-information-in-object-file).  
...
## Remarks  
 **/Yd** is deprecated; [!INCLUDE[vcprvc](../../includes/vcprvc-md.md)] now supports multiple objects writing to a single .pdb file, use **/Zi** instead. For more information, see [Deprecated Compiler Options in Visual C++ 2005](http://msdn.microsoft.com/en-us/aa59fce3-50b8-4f66-9aeb-ce09a7a84cce).  
