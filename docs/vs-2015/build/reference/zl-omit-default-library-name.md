...
The latest version of this topic can be found at [-Zl (Omit Default Library Name)](https://docs.microsoft.com/cpp/build/reference/zl-omit-default-library-name).  
