...
The latest version of this topic can be found at [Calculating Necessary Values](https://docs.microsoft.com/cpp/build/reference/calculating-necessary-values).  
