...
The latest version of this topic can be found at [-GX (Enable Exception Handling)](https://docs.microsoft.com/cpp/build/reference/gx-enable-exception-handling).  
