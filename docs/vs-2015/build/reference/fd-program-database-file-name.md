...
The latest version of this topic can be found at [-Fd (Program Database File Name)](https://docs.microsoft.com/cpp/build/reference/fd-program-database-file-name).  
