...
The latest version of this topic can be found at [-CLRTHREADATTRIBUTE (Set CLR Thread Attribute)](https://docs.microsoft.com/cpp/build/reference/clrthreadattribute-set-clr-thread-attribute).  
