...
The latest version of this topic can be found at [-CLRSUPPORTLASTERROR (Preserve Last Error Code for PInvoke Calls)](https://docs.microsoft.com/cpp/build/reference/clrsupportlasterror-preserve-last-error-code-for-pinvoke-calls).  
