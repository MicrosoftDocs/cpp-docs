...
The latest version of this topic can be found at [-SECTION (Specify Section Attributes)](https://docs.microsoft.com/cpp/build/reference/section-specify-section-attributes).  
