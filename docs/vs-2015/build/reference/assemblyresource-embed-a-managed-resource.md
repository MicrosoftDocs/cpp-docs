...
The latest version of this topic can be found at [-ASSEMBLYRESOURCE (Embed a Managed Resource)](https://docs.microsoft.com/cpp/build/reference/assemblyresource-embed-a-managed-resource).  
