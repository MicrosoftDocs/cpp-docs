...
The latest version of this topic can be found at [Building an Import Library and Export File](https://docs.microsoft.com/cpp/build/reference/building-an-import-library-and-export-file).  
