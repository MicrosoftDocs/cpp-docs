...
The latest version of this topic can be found at [-TSAWARE (Create Terminal Server Aware Application)](https://docs.microsoft.com/cpp/build/reference/tsaware-create-terminal-server-aware-application).  
