...
The latest version of this topic can be found at [.netmodule Files as Linker Input](https://docs.microsoft.com/cpp/build/reference/netmodule-files-as-linker-input).  
