...
The latest version of this topic can be found at [Module-Definition (.Def) Files](https://docs.microsoft.com/cpp/build/reference/module-definition-dot-def-files).  
