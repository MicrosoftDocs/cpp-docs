...
The latest version of this topic can be found at [Compiler Command-Line Syntax](https://docs.microsoft.com/cpp/build/reference/compiler-command-line-syntax).  
