...
The latest version of this topic can be found at [-execution-charset (Set Execution Character Set)](https://docs.microsoft.com/cpp/build/reference/execution-charset-set-execution-character-set).  
