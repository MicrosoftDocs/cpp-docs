...
The latest version of this topic can be found at [-validate-charset (Validate for compatible characters)](https://docs.microsoft.com/cpp/build/reference/validate-charset-validate-for-compatible-characters).  
