...
The latest version of this topic can be found at [-volatile (volatile Keyword Interpretation)](https://docs.microsoft.com/cpp/build/reference/volatile-volatile-keyword-interpretation).  
