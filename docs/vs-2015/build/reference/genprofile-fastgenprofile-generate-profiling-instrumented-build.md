...
The latest version of this topic can be found at [-GENPROFILE, -FASTGENPROFILE (Generate Profiling Instrumented Build)](https://docs.microsoft.com/cpp/build/reference/genprofile-fastgenprofile-generate-profiling-instrumented-build).  
