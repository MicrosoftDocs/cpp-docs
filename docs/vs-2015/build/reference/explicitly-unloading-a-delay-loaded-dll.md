...
The latest version of this topic can be found at [Explicitly Unloading a Delay-Loaded DLL](https://docs.microsoft.com/cpp/build/reference/explicitly-unloading-a-delay-loaded-dll).  
