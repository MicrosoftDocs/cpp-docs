...
The latest version of this topic can be found at [Developing Your Own Helper Function](https://docs.microsoft.com/cpp/build/reference/developing-your-own-helper-function).  
