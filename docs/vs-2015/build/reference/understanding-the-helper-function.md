...
The latest version of this topic can be found at [Understanding the Helper Function](https://docs.microsoft.com/cpp/build/reference/understanding-the-helper-function).  
