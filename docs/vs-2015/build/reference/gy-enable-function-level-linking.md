...
The latest version of this topic can be found at [-Gy (Enable Function-Level Linking)](https://docs.microsoft.com/cpp/build/reference/gy-enable-function-level-linking).  
