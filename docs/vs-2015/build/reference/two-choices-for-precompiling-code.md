...
The latest version of this topic can be found at [Two Choices for Precompiling Code](https://docs.microsoft.com/cpp/build/reference/two-choices-for-precompiling-code).  
