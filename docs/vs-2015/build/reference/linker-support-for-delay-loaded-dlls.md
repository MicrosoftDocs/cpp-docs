...
The latest version of this topic can be found at [Linker Support for Delay-Loaded DLLs](https://docs.microsoft.com/cpp/build/reference/linker-support-for-delay-loaded-dlls).  
  
  
The Visual C++ linker now supports the delayed loading of DLLs. This relieves you of the need to use the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)] functions **LoadLibrary** and **GetProcAddress** to implement DLL delayed loading.  
