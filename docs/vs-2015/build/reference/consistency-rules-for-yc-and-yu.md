...
The latest version of this topic can be found at [Consistency Rules for -Yc and -Yu](https://docs.microsoft.com/cpp/build/reference/consistency-rules-for-yc-and-yu).  
