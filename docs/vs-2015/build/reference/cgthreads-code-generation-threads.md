...
The latest version of this topic can be found at [-cgthreads (Code Generation Threads)](https://docs.microsoft.com/cpp/build/reference/cgthreads-code-generation-threads).  
