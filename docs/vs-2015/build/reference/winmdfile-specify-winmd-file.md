...
The latest version of this topic can be found at [-WINMDFILE (Specify winmd File)](https://docs.microsoft.com/cpp/build/reference/winmdfile-specify-winmd-file).  
