...
The latest version of this topic can be found at [-Gh (Enable _penter Hook Function)](https://docs.microsoft.com/cpp/build/reference/gh-enable-penter-hook-function).  
