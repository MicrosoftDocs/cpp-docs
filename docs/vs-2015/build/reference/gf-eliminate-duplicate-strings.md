...
The latest version of this topic can be found at [-GF (Eliminate Duplicate Strings)](https://docs.microsoft.com/cpp/build/reference/gf-eliminate-duplicate-strings).  
