...
The latest version of this topic can be found at [-std (Specify Language Standard Version)](https://docs.microsoft.com/cpp/build/reference/std-specify-language-standard-version).  
