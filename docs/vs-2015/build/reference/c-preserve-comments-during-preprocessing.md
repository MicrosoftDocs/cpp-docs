...
The latest version of this topic can be found at [-C (Preserve Comments During Preprocessing)](https://docs.microsoft.com/cpp/build/reference/c-preserve-comments-during-preprocessing).  
