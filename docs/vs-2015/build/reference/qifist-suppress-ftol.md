...
The latest version of this topic can be found at [-QIfist (Suppress _ftol)](https://docs.microsoft.com/cpp/build/reference/qifist-suppress-ftol).  
...
> [!NOTE]
>  **/QIfist** is only available in the compiler targeting x86; this compiler option is not available in the compilers targeting [!INCLUDE[vcprx64](../../includes/vcprx64-md.md)] orARM.  
