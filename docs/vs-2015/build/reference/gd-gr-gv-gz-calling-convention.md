...
The latest version of this topic can be found at [-Gd, -Gr, -Gv, -Gz (Calling Convention)](https://docs.microsoft.com/cpp/build/reference/gd-gr-gv-gz-calling-convention).  
