...
The latest version of this topic can be found at [-DEFAULTLIB (Specify Default Library)](https://docs.microsoft.com/cpp/build/reference/defaultlib-specify-default-library).  
