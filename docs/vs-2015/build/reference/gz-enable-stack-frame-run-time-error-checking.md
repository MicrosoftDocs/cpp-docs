...
The latest version of this topic can be found at [-GZ (Enable Stack Frame Run-Time Error Checking)](https://docs.microsoft.com/cpp/build/reference/gz-enable-stack-frame-run-time-error-checking).  
