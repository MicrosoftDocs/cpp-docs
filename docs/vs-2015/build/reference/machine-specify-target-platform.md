...
The latest version of this topic can be found at [-MACHINE (Specify Target Platform)](https://docs.microsoft.com/cpp/build/reference/machine-specify-target-platform).  
