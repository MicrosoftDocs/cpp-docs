...
The latest version of this topic can be found at [-NXCOMPAT (Compatible with Data Execution Prevention)](https://docs.microsoft.com/cpp/build/reference/nxcompat-compatible-with-data-execution-prevention).  
