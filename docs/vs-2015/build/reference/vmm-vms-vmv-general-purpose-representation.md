...
The latest version of this topic can be found at [-vmm, -vms, -vmv (General Purpose Representation)](https://docs.microsoft.com/cpp/build/reference/vmm-vms-vmv-general-purpose-representation).  
