...
The latest version of this topic can be found at [-Zc:wchar_t (wchar_t Is Native Type)](https://docs.microsoft.com/cpp/build/reference/zc-wchar-t-wchar-t-is-native-type).  
