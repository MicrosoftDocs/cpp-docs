...
The latest version of this topic can be found at [-MANIFESTDEPENDENCY (Specify Manifest Dependencies)](https://docs.microsoft.com/cpp/build/reference/manifestdependency-specify-manifest-dependencies).  
