...
The latest version of this topic can be found at [-H (Restrict Length of External Names)](https://docs.microsoft.com/cpp/build/reference/h-restrict-length-of-external-names).  
