...
The latest version of this topic can be found at [-Gs (Control Stack Checking Calls)](https://docs.microsoft.com/cpp/build/reference/gs-control-stack-checking-calls).  
