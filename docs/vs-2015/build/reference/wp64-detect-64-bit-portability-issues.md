...
The latest version of this topic can be found at [-Wp64 (Detect 64-Bit Portability Issues)](https://docs.microsoft.com/cpp/build/reference/wp64-detect-64-bit-portability-issues).  
