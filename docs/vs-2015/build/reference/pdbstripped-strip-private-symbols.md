...
The latest version of this topic can be found at [-PDBSTRIPPED (Strip Private Symbols)](https://docs.microsoft.com/cpp/build/reference/pdbstripped-strip-private-symbols).  
