...
The latest version of this topic can be found at [Using VERIFY Instead of ASSERT](https://docs.microsoft.com/cpp/build/reference/using-verify-instead-of-assert).  
