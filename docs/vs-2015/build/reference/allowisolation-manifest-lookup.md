...
The latest version of this topic can be found at [-ALLOWISOLATION (Manifest Lookup)](https://docs.microsoft.com/cpp/build/reference/allowisolation-manifest-lookup).  
