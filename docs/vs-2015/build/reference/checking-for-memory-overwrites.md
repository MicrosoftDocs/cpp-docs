...
The latest version of this topic can be found at [Checking for Memory Overwrites](https://docs.microsoft.com/cpp/build/reference/checking-for-memory-overwrites).  
