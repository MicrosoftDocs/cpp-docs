...
The latest version of this topic can be found at [-kernel (Create Kernel Mode Binary)](https://docs.microsoft.com/cpp/build/reference/kernel-create-kernel-mode-binary).  
