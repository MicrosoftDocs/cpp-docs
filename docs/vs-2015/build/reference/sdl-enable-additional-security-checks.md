...
The latest version of this topic can be found at [-sdl (Enable Additional Security Checks)](https://docs.microsoft.com/cpp/build/reference/sdl-enable-additional-security-checks).  
