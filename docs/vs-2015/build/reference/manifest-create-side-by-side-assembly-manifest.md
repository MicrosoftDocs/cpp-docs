...
The latest version of this topic can be found at [-MANIFEST (Create Side-by-Side Assembly Manifest)](https://docs.microsoft.com/cpp/build/reference/manifest-create-side-by-side-assembly-manifest).  
