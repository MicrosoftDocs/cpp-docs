...
The latest version of this topic can be found at [-Qimprecise_fwaits (Remove fwaits Inside Try Blocks)](https://docs.microsoft.com/cpp/build/reference/qimprecise-fwaits-remove-fwaits-inside-try-blocks).  
