...
The latest version of this topic can be found at [-MP (Build with Multiple Processes)](https://docs.microsoft.com/cpp/build/reference/mp-build-with-multiple-processes).  
