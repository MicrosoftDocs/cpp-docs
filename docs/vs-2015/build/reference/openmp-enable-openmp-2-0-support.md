...
The latest version of this topic can be found at [-openmp (Enable OpenMP 2.0 Support)](https://docs.microsoft.com/cpp/build/reference/openmp-enable-openmp-2-0-support).  
