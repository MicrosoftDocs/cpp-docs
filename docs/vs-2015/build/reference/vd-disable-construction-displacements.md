...
The latest version of this topic can be found at [-vd (Disable Construction Displacements)](https://docs.microsoft.com/cpp/build/reference/vd-disable-construction-displacements).  
