...
The latest version of this topic can be found at [-ORDER (Put Functions in Order)](https://docs.microsoft.com/cpp/build/reference/order-put-functions-in-order).  
