...
The latest version of this topic can be found at [-GR (Enable Run-Time Type Information)](https://docs.microsoft.com/cpp/build/reference/gr-enable-run-time-type-information).  
