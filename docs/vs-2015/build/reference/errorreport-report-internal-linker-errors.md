...
The latest version of this topic can be found at [-ERRORREPORT (Report Internal Linker Errors)](https://docs.microsoft.com/cpp/build/reference/errorreport-report-internal-linker-errors).  
