...
The latest version of this topic can be found at [-ASSEMBLYLINKRESOURCE (Link to .NET Framework Resource)](https://docs.microsoft.com/cpp/build/reference/assemblylinkresource-link-to-dotnet-framework-resource).  
