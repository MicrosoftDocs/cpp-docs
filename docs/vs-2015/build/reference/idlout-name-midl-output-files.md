...
The latest version of this topic can be found at [-IDLOUT (Name MIDL Output Files)](https://docs.microsoft.com/cpp/build/reference/idlout-name-midl-output-files).  
