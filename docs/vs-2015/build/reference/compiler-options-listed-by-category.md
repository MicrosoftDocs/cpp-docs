...
The latest version of this topic can be found at [Compiler Options Listed by Category](https://docs.microsoft.com/cpp/build/reference/compiler-options-listed-by-category).  
