...
The latest version of this topic can be found at [-clr (Common Language Runtime Compilation)](https://docs.microsoft.com/cpp/build/reference/clr-common-language-runtime-compilation).  
