...
The latest version of this topic can be found at [-ALLOWBIND (Prevent DLL Binding)](https://docs.microsoft.com/cpp/build/reference/allowbind-prevent-dll-binding).  
