...
The latest version of this topic can be found at [Unicode Support in the Compiler and Linker](https://docs.microsoft.com/cpp/build/reference/unicode-support-in-the-compiler-and-linker).  
