...
The latest version of this topic can be found at [-errorReport (Report Internal Compiler Errors)](https://docs.microsoft.com/cpp/build/reference/errorreport-report-internal-compiler-errors).  
