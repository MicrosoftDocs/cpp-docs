...
The latest version of this topic can be found at [-Zo (Enhance Optimized Debugging)](https://docs.microsoft.com/cpp/build/reference/zo-enhance-optimized-debugging).  
