...
The latest version of this topic can be found at [-WHOLEARCHIVE (Include All Library Object Files)](https://docs.microsoft.com/cpp/build/reference/wholearchive-include-all-library-object-files).  
