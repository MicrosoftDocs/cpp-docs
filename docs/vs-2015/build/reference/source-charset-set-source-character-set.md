...
The latest version of this topic can be found at [-source-charset (Set Source Character Set)](https://docs.microsoft.com/cpp/build/reference/source-charset-set-source-character-set).  
