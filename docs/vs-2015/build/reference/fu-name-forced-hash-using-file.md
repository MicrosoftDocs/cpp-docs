...
The latest version of this topic can be found at [-FU (Name Forced #using File)](https://docs.microsoft.com/cpp/build/reference/fu-name-forced-hash-using-file).  
