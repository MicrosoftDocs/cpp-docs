...
The latest version of this topic can be found at [-Tc, -Tp, -TC, -TP (Specify Source File Type)](https://docs.microsoft.com/cpp/build/reference/tc-tp-tc-tp-specify-source-file-type).  
