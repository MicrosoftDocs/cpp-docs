...
The latest version of this topic can be found at [Compiler-Controlled LINK Options](https://docs.microsoft.com/cpp/build/reference/compiler-controlled-link-options).  
