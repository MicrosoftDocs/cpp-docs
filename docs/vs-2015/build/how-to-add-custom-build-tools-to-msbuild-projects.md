...
The latest version of this topic can be found at [How to: Add Custom Build Tools to MSBuild Projects](https://docs.microsoft.com/cpp/build/how-to-add-custom-build-tools-to-msbuild-projects).  
