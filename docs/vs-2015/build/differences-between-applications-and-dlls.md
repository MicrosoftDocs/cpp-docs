...
The latest version of this topic can be found at [Differences Between Applications and DLLs](https://docs.microsoft.com/cpp/build/differences-between-applications-and-dlls).  
