...
The latest version of this topic can be found at [How to: Configure Visual C++ Projects to Target 64-Bit Platforms](https://docs.microsoft.com/cpp/build/how-to-configure-visual-cpp-projects-to-target-64-bit-platforms).  
