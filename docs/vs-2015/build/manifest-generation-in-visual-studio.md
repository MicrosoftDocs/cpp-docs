...
The latest version of this topic can be found at [Manifest Generation in Visual Studio](https://docs.microsoft.com/cpp/build/manifest-generation-in-visual-studio).  
