...
The latest version of this topic can be found at [Importing into an Application Using __declspec(dllimport)](https://docs.microsoft.com/cpp/build/importing-into-an-application-using-declspec-dllimport).  
