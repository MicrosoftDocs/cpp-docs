...
The latest version of this topic can be found at [Determining Which Linking Method to Use](https://docs.microsoft.com/cpp/build/determining-which-linking-method-to-use).  
