...
The latest version of this topic can be found at [Exporting from a DLL Using DEF Files](https://docs.microsoft.com/cpp/build/exporting-from-a-dll-using-def-files).  
