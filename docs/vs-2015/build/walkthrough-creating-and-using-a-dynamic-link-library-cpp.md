...
The latest version of this topic can be found at [Walkthrough: Creating and Using a Dynamic Link Library (C++)](https://docs.microsoft.com/cpp/build/walkthrough-creating-and-using-a-dynamic-link-library-cpp).  
