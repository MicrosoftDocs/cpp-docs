...
The latest version of this topic can be found at [Exporting C Functions for Use in C or C++ Language Executables](https://docs.microsoft.com/cpp/build/exporting-c-functions-for-use-in-c-or-cpp-language-executables).  
