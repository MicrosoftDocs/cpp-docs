...
The latest version of this topic can be found at [Importing Function Calls Using __declspec(dllimport)](https://docs.microsoft.com/cpp/build/importing-function-calls-using-declspec-dllimport).  
