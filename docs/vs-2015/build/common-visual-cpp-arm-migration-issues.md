...
The latest version of this topic can be found at [Common Visual C++ ARM Migration Issues](https://docs.microsoft.com/cpp/build/common-visual-cpp-arm-migration-issues).  
