...
The latest version of this topic can be found at [Importing and Exporting Inline Functions](https://docs.microsoft.com/cpp/build/importing-and-exporting-inline-functions).  
