...
The latest version of this topic can be found at [Determining Which Exporting Method to Use](https://docs.microsoft.com/cpp/build/determining-which-exporting-method-to-use).  
