...
The latest version of this topic can be found at [Building C/C++ Isolated Applications and Side-by-side Assemblies](https://docs.microsoft.com/cpp/build/building-c-cpp-isolated-applications-and-side-by-side-assemblies).  
