...
The latest version of this topic can be found at [Search Path Used by Windows to Locate a DLL](https://docs.microsoft.com/cpp/build/search-path-used-by-windows-to-locate-a-dll).  
