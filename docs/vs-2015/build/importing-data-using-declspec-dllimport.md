...
The latest version of this topic can be found at [Importing Data Using __declspec(dllimport)](https://docs.microsoft.com/cpp/build/importing-data-using-declspec-dllimport).  
