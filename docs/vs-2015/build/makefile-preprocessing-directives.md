...
The latest version of this topic can be found at [Makefile Preprocessing Directives](https://docs.microsoft.com/cpp/build/makefile-preprocessing-directives).  
