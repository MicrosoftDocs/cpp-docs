...
The latest version of this topic can be found at [Walkthrough: Compiling a C++/CLI Program on the Command Line](https://docs.microsoft.com/cpp/build/walkthrough-compiling-a-cpp-cli-program-on-the-command-line).  
...
1.  Open a **Developer Command Prompt** window. (On the **Start** window, open **Apps**. Open the **Visual Studio Tools** folder under your version of [!INCLUDE[vsprvs](../includes/vsprvs-md.md)], and then choose the **Developer Command Prompt** shortcut.) For more information about how to open a Command Prompt window, see [Setting the Path and Environment Variables for Command-Line Builds](../build/setting-the-path-and-environment-variables-for-command-line-builds.md).  
