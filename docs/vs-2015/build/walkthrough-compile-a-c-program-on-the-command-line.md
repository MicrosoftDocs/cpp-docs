...
The latest version of this topic can be found at [Walkthrough: Compile a C program on the command line](https://docs.microsoft.com/cpp/build/walkthrough-compile-a-c-program-on-the-command-line).  
