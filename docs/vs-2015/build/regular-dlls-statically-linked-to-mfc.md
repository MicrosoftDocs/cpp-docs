...
The latest version of this topic can be found at [Regular DLLs Statically Linked to MFC](https://docs.microsoft.com/cpp/build/regular-dlls-statically-linked-to-mfc).  
