...
The latest version of this topic can be found at [How to: Build Registration-Free COM Components](https://docs.microsoft.com/cpp/build/how-to-build-registration-free-com-components).  
