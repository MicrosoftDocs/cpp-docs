...
The latest version of this topic can be found at [Stack Allocation](https://docs.microsoft.com/cpp/build/stack-allocation).  
...
A function's prolog is responsible for allocating stack space for local variables, saved registers, stack parameters, and register parameters.  
 ...
 ![AMD conversion example](../build/media/vcamd-conv-ex-5.png "vcAmd_conv_ex_5")  
