...
The latest version of this topic can be found at [Command Macros and Options Macros](https://docs.microsoft.com/cpp/build/command-macros-and-options-macros).  
