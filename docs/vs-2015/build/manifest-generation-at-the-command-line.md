...
The latest version of this topic can be found at [Manifest Generation at the Command Line](https://docs.microsoft.com/cpp/build/manifest-generation-at-the-command-line).  
