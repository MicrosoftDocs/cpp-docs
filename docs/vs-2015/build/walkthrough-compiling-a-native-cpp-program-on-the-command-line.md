...
The latest version of this topic can be found at [Walkthrough: Compiling a Native C++ Program on the Command Line](https://docs.microsoft.com/cpp/build/walkthrough-compiling-a-native-cpp-program-on-the-command-line).  
