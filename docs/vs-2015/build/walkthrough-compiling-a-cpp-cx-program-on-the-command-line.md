...
The latest version of this topic can be found at [Walkthrough: Compiling a C++/CX Program on the Command Line](https://docs.microsoft.com/cpp/build/walkthrough-compiling-a-cpp-cx-program-on-the-command-line).  
