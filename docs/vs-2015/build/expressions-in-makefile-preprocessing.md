...
The latest version of this topic can be found at [Expressions in Makefile Preprocessing](https://docs.microsoft.com/cpp/build/expressions-in-makefile-preprocessing).  
