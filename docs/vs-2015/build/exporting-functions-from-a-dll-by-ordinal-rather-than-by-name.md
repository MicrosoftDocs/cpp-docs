...
The latest version of this topic can be found at [Exporting Functions from a DLL by Ordinal Rather Than by Name](https://docs.microsoft.com/cpp/build/exporting-functions-from-a-dll-by-ordinal-rather-than-by-name).  
