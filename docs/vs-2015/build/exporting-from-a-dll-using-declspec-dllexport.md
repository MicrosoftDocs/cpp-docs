...
The latest version of this topic can be found at [Exporting from a DLL Using __declspec(dllexport)](https://docs.microsoft.com/cpp/build/exporting-from-a-dll-using-declspec-dllexport).  
