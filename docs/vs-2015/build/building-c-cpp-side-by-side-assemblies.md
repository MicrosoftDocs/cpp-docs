...
The latest version of this topic can be found at [Building C/C++ Side-by-side Assemblies](https://docs.microsoft.com/cpp/build/building-c-cpp-side-by-side-assemblies).  
