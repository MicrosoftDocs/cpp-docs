...
The latest version of this topic can be found at [Configuring Programs for 64-Bit (Visual C++)](https://docs.microsoft.com/cpp/build/configuring-programs-for-64-bit-visual-cpp).  
