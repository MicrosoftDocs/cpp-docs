...
The latest version of this topic can be found at [Using Database, OLE, and Sockets Extension DLLs in Regular DLLs](https://docs.microsoft.com/cpp/build/using-database-ole-and-sockets-extension-dlls-in-regular-dlls).  
