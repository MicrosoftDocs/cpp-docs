...
The latest version of this topic can be found at [delegate (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/delegate-cpp-component-extensions).  
  
Declares a type that represents a function pointer.  
  
## All Runtimes  
 Both the [!INCLUDE[wrt](../includes/wrt-md.md)] and common language runtime support delegates.  
