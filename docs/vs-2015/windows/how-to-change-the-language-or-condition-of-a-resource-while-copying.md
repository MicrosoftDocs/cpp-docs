...
The latest version of this topic can be found at [How to: Change the Language or Condition of a Resource While Copying](https://docs.microsoft.com/cpp/windows/how-to-change-the-language-or-condition-of-a-resource-while-copying).  
