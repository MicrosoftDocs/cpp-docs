...
The latest version of this topic can be found at [How to: Add MFC Support to Resource Script Files](https://docs.microsoft.com/cpp/windows/how-to-add-mfc-support-to-resource-script-files).  
...
3.  In the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca), set the **MFC Mode** property to **True**.  
