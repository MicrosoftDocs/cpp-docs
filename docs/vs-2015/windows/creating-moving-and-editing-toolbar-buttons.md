...
The latest version of this topic can be found at [Creating, Moving, and Editing Toolbar Buttons](https://docs.microsoft.com/cpp/windows/creating-moving-and-editing-toolbar-buttons).  
