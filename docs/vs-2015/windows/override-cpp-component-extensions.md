...
The latest version of this topic can be found at [override  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/override-cpp-component-extensions).  
