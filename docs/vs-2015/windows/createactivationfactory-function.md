...
The latest version of this topic can be found at [CreateActivationFactory Function](https://docs.microsoft.com/cpp/windows/createactivationfactory-function).  
