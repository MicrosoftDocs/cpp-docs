...
The latest version of this topic can be found at [Picking up a Color from an Image to Use Elsewhere (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/picking-up-a-color-from-an-image-to-use-elsewhere-image-editor-for-icons).  
