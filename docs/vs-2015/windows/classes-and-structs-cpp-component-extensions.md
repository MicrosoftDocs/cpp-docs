...
The latest version of this topic can be found at [Classes and Structs  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/classes-and-structs-cpp-component-extensions).  
 ...
 *base_type* (optional)  
 ...
 For more information, see the language-specific descriptions of this parameter in the [!INCLUDE[wrt](../includes/wrt-md.md)] and [!INCLUDE[clr_for_headings](../includes/clr-for-headings-md.md)] sections.  
