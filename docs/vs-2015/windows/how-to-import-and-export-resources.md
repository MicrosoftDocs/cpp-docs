...
The latest version of this topic can be found at [How to: Import and Export Resources](https://docs.microsoft.com/cpp/windows/how-to-import-and-export-resources).  
