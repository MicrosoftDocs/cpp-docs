...
The latest version of this topic can be found at [Displaying or Hiding the Pixel Grid (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/displaying-or-hiding-the-pixel-grid-image-editor-for-icons).  
...
1.  On the **Image** menu, click **Grid Settings**.  
