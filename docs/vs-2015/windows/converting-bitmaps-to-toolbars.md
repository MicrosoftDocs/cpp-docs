...
The latest version of this topic can be found at [Converting Bitmaps to Toolbars](https://docs.microsoft.com/cpp/windows/converting-bitmaps-to-toolbars).  
...
3.  To finish the conversion, change the command **ID** of the button using the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca). Type the new **ID** or select an **ID** from the drop-down list.  
 ...
 You can also change the command IDs of the buttons on the new toolbar by using the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca). For information on editing the new toolbar, see [Creating, Moving, and Editing Toolbar Buttons](../mfc/creating-moving-and-editing-toolbar-buttons.md).  
