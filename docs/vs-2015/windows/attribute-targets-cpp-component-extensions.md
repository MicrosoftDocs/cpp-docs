...
The latest version of this topic can be found at [Attribute Targets (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/attribute-targets-cpp-component-extensions).  
