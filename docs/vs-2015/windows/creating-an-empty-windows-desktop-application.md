...
The latest version of this topic can be found at [Creating an Empty Windows Desktop Application](https://docs.microsoft.com/cpp/windows/creating-an-empty-windows-desktop-application).  
