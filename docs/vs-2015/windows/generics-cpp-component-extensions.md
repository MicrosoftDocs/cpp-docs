...
The latest version of this topic can be found at [Generics  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/generics-cpp-component-extensions).  
