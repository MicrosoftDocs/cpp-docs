...
The latest version of this topic can be found at [AsyncBase::CheckValidStateForResultsCall Method](https://docs.microsoft.com/cpp/windows/asyncbase-checkvalidstateforresultscall-method).  
