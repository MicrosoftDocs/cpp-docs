...
The latest version of this topic can be found at [Inverting the Colors in a Selection (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/inverting-the-colors-in-a-selection-image-editor-for-icons).  
