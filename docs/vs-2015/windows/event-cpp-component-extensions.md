...
The latest version of this topic can be found at [event  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/event-cpp-component-extensions).  
...
4.  Use the event:  
 ...
 For more information on [!INCLUDE[cppcli](../includes/cppcli-md.md)] events, see  
