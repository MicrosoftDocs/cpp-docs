...
The latest version of this topic can be found at [Microsoft::WRL::Wrappers::HandleTraits Namespace](https://docs.microsoft.com/cpp/windows/microsoft-wrl-wrappers-handletraits-namespace).  
