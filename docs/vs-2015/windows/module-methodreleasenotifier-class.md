...
The latest version of this topic can be found at [Module::MethodReleaseNotifier Class](https://docs.microsoft.com/cpp/windows/module-methodreleasenotifier-class).  
