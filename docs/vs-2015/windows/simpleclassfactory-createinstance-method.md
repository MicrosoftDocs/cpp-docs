...
The latest version of this topic can be found at [SimpleClassFactory::CreateInstance Method](https://docs.microsoft.com/cpp/windows/simpleclassfactory-createinstance-method).  
