...
The latest version of this topic can be found at [How to: Improve Performance with Generics (Visual C++)](https://docs.microsoft.com/cpp/windows/how-to-improve-performance-with-generics-visual-cpp).  
