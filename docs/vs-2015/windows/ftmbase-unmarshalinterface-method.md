...
The latest version of this topic can be found at [FtmBase::UnmarshalInterface Method](https://docs.microsoft.com/cpp/windows/ftmbase-unmarshalinterface-method).  
