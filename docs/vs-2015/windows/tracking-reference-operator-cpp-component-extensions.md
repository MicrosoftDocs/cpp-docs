...
The latest version of this topic can be found at [Tracking Reference Operator (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/tracking-reference-operator-cpp-component-extensions).  
