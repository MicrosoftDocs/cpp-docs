...
The latest version of this topic can be found at [Typedef, Enum, Union, and Struct Attributes](https://docs.microsoft.com/cpp/windows/typedef-enum-union-and-struct-attributes).  
