...
The latest version of this topic can be found at [interface class  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/interface-class-cpp-component-extensions).  
