...
The latest version of this topic can be found at [CreatorMap::factoryCreator Data Member](https://docs.microsoft.com/cpp/windows/creatormap-factorycreator-data-member).  
