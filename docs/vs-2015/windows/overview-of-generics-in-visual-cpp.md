...
The latest version of this topic can be found at [Overview of Generics in Visual C++](https://docs.microsoft.com/cpp/windows/overview-of-generics-in-visual-cpp).  
