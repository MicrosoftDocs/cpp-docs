...
The latest version of this topic can be found at [RuntimeClassType Enumeration](https://docs.microsoft.com/cpp/windows/runtimeclasstype-enumeration).  
...
|`WinRt`|A [!INCLUDE[wrt](../includes/wrt-md.md)] class.|  
