...
The latest version of this topic can be found at [User-Defined Attributes  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/user-defined-attributes-cpp-component-extensions).  
