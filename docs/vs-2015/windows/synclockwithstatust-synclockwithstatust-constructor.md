...
The latest version of this topic can be found at [SyncLockWithStatusT::SyncLockWithStatusT Constructor](https://docs.microsoft.com/cpp/windows/synclockwithstatust-synclockwithstatust-constructor).  
