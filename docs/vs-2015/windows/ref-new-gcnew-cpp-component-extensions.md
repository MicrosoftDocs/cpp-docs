...
The latest version of this topic can be found at [ref new, gcnew  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/ref-new-gcnew-cpp-component-extensions).  
