...
The latest version of this topic can be found at [Customizing or Changing Colors (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/customizing-or-changing-colors-image-editor-for-icons).  
