...
The latest version of this topic can be found at [Creating a 256-Color Icon or Cursor (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/creating-a-256-color-icon-or-cursor-image-editor-for-icons).  
