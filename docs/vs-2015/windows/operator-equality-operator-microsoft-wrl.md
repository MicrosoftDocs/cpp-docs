...
The latest version of this topic can be found at [operator== Operator (Microsoft::WRL)](https://docs.microsoft.com/cpp/windows/operator-equality-operator-microsoft-wrl).  
