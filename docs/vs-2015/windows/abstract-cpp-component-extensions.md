...
The latest version of this topic can be found at [abstract  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/abstract-cpp-component-extensions).  
