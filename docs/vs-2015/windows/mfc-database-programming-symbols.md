...
The latest version of this topic can be found at [MFC Database Programming Symbols](https://docs.microsoft.com/cpp/windows/mfc-database-programming-symbols).  
