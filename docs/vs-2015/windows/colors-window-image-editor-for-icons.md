...
The latest version of this topic can be found at [Colors Window (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/colors-window-image-editor-for-icons).  
