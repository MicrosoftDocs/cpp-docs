...
The latest version of this topic can be found at [Constraints on Generic Type Parameters (C++/CLI)](https://docs.microsoft.com/cpp/windows/constraints-on-generic-type-parameters-cpp-cli).  
