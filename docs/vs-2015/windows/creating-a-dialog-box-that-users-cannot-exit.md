...
The latest version of this topic can be found at [Creating a Dialog Box That Users Cannot Exit](https://docs.microsoft.com/cpp/windows/creating-a-dialog-box-that-users-cannot-exit).  
