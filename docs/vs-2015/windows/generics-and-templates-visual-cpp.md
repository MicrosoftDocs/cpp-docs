...
The latest version of this topic can be found at [Generics and Templates (Visual C++)](https://docs.microsoft.com/cpp/windows/generics-and-templates-visual-cpp).  
