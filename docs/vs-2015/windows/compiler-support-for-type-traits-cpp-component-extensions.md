...
The latest version of this topic can be found at [Compiler Support for Type Traits (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/compiler-support-for-type-traits-cpp-component-extensions).  
 ...
 **Remarks**  
 ...
 (In the following list, code examples are written only in [!INCLUDE[cppcli](../includes/cppcli-md.md)]. But the corresponding type trait is also supported in [!INCLUDE[cppwrt](../includes/cppwrt-md.md)] unless stated otherwise. The term, "platform type" refers to either [!INCLUDE[wrt](../includes/wrt-md.md)] types or common language runtime types.)  
...
-   `__has_finalizer(` `type` `)`  
     ...
     (Not supported in [!INCLUDE[cppwrt](../includes/cppwrt-md.md)].) Returns true if the CLR type has a finalizer. See [Destructors and Finalizers in Visual C++](../misc/destructors-and-finalizers-in-visual-cpp.md) for more information.  
