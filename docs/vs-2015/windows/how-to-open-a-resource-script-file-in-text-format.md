...
The latest version of this topic can be found at [How to: Open a Resource Script File in Text Format](https://docs.microsoft.com/cpp/windows/how-to-open-a-resource-script-file-in-text-format).  
