...
The latest version of this topic can be found at [Variable Argument Lists (...) (C++/CLI)](https://docs.microsoft.com/cpp/windows/variable-argument-lists-dot-dot-dot-cpp-cli).  
