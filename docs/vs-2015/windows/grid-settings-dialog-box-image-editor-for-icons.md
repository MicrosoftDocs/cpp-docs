...
The latest version of this topic can be found at [Grid Settings Dialog Box (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/grid-settings-dialog-box-image-editor-for-icons).  
