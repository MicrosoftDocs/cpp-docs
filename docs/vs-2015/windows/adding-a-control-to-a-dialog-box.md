...
The latest version of this topic can be found at [Adding a Control to a Dialog Box](https://docs.microsoft.com/cpp/windows/adding-a-control-to-a-dialog-box).  
...
2.  On the [Dialog Editor Tab](../mfc/dialog-editor-tab-toolbox.md) of the [Toolbox Window](http://msdn.microsoft.com/library/b754dad3-1f32-464f-8b9f-065e17e0bc22), select the control you want, then:  
