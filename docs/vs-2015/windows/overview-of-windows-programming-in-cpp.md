...
The latest version of this topic can be found at [Overview of Windows Programming in C++](https://docs.microsoft.com/cpp/windows/overview-of-windows-programming-in-cpp).   
...
##  <a name="BK_WindowsUniversal"></a> Windows Universal Apps  
 ...
 You can also write Universal Windows apps, games, and components without using the [!INCLUDE[cppwrt](../includes/cppwrt-md.md)] ([!INCLUDE[cppwrt_short](../includes/cppwrt-short-md.md)]); instead, you can use the [!INCLUDE[cppwrl](../includes/cppwrl-md.md)] ([!INCLUDE[cppwrl_short](../includes/cppwrl-short-md.md)]). For more information, see [Windows Runtime C++ Template Library (WRL)](../windows/windows-runtime-cpp-template-library-wrl.md).  
  
 With [!INCLUDE[cpp_dev14_long](../includes/cpp-dev14-long-md.md)], you can develop Universal Windows apps that run on Windows 10 desktop and mobile devices. You can also develop Windows 8.1 apps and Windows Phone 8.1 apps in [!INCLUDE[cpp_dev14_long](../includes/cpp-dev14-long-md.md)], but to do so, you must first install Visual Studio 2013 on the same computer, and then configure your project to use the **Visual Studio 2013 (v120)** toolset. To configure this setting in your project, open the project's properties and in the **General** section, set the **Platform Toolset** to **Visual Studio 2013 (v120)**.  
