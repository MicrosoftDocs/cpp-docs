...
The latest version of this topic can be found at [Exception Handling  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/exception-handling-cpp-component-extensions).  
