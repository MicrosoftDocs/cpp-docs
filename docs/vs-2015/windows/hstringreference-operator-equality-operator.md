...
The latest version of this topic can be found at [HStringReference::Operator== Operator](https://docs.microsoft.com/cpp/windows/hstringreference-operator-equality-operator).  
