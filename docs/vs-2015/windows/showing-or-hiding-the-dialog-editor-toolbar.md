...
The latest version of this topic can be found at [Showing or Hiding the Dialog Editor Toolbar](https://docs.microsoft.com/cpp/windows/showing-or-hiding-the-dialog-editor-toolbar).  
