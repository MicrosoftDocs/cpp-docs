...
The latest version of this topic can be found at [MakeAndInitialize Function](https://docs.microsoft.com/cpp/windows/makeandinitialize-function).  
  
  
Initializes the specified [!INCLUDE[wrt](../includes/wrt-md.md)] class. Use this function to instantiate a component that is defined in the same module.  
