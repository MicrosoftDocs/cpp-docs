...
The latest version of this topic can be found at [Handle to Object Operator (^)  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/handle-to-object-operator-hat-cpp-component-extensions).  
