...
The latest version of this topic can be found at [Attribute Parameter Types  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/attribute-parameter-types-cpp-component-extensions).  
