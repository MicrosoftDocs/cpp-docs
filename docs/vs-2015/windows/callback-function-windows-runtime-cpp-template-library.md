...
The latest version of this topic can be found at [Callback Function (Windows Runtime C++ Template Library)](https://docs.microsoft.com/cpp/windows/callback-function-windows-runtime-cpp-template-library).  
