...
The latest version of this topic can be found at [Flipping an Image (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/flipping-an-image-image-editor-for-icons).  
