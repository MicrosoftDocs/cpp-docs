...
The latest version of this topic can be found at [Files Affected by Resource Editing](https://docs.microsoft.com/cpp/windows/files-affected-by-resource-editing).  
