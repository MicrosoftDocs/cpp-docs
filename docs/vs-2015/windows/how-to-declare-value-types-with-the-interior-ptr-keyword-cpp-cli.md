...
The latest version of this topic can be found at [How to: Declare Value Types with the interior_ptr Keyword (C++/CLI)](https://docs.microsoft.com/cpp/windows/how-to-declare-value-types-with-the-interior-ptr-keyword-cpp-cli).  
...
### Description  
 The following [!INCLUDE[cppcli](../includes/cppcli-md.md)] sample shows how to use an `interior_ptr` with a value type.  
