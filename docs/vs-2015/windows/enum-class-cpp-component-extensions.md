...
The latest version of this topic can be found at [enum class  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/enum-class-cpp-component-extensions).  
 ...
 *underlying-type*  
 ...
 (Optional. [!INCLUDE[wrt](../includes/wrt-md.md)] only) The underlying type of the enumeration, which can be `bool`, `char`, `char16`, `int16`, `uint16`, `int`, `uint32`, `int64`, or `uint64`.  
