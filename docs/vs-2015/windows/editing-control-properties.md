...
The latest version of this topic can be found at [Editing Control Properties](https://docs.microsoft.com/cpp/windows/editing-control-properties).  
...
2.  In the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca), change the properties of your control.  
