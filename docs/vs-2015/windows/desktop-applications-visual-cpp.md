...
The latest version of this topic can be found at [Desktop Applications (Visual C++)](https://docs.microsoft.com/cpp/windows/desktop-applications-visual-cpp).  
