...
The latest version of this topic can be found at [safe_cast (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/safe-cast-cpp-component-extensions).  
 ...
 **Example**  
 ...
 The following code example demonstrates how to use `safe_cast` with the [!INCLUDE[wrt](../includes/wrt-md.md)].  
