...
The latest version of this topic can be found at [AsyncBase::TryTransitionToCompleted Method](https://docs.microsoft.com/cpp/windows/asyncbase-trytransitiontocompleted-method).  
