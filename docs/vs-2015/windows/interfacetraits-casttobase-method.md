...
The latest version of this topic can be found at [InterfaceTraits::CastToBase Method](https://docs.microsoft.com/cpp/windows/interfacetraits-casttobase-method).  
