...
The latest version of this topic can be found at [CriticalSection::CriticalSection Constructor](https://docs.microsoft.com/cpp/windows/criticalsection-criticalsection-constructor).  
