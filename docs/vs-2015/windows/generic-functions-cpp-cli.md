...
The latest version of this topic can be found at [Generic Functions (C++/CLI)](https://docs.microsoft.com/cpp/windows/generic-functions-cpp-cli).  
 ...
 **Remarks**  
 ...
 This feature is not supported in the [!INCLUDE[wrt](../includes/wrt-md.md)].  
 ...
 **Remarks**  
 ...
 In [!INCLUDE[vcprvc](../includes/vcprvc-md.md)], class or struct constructors may not be declared with generic type parameters.  
