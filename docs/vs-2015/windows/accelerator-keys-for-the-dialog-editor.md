...
The latest version of this topic can be found at [Accelerator Keys for the Dialog Editor](https://docs.microsoft.com/cpp/windows/accelerator-keys-for-the-dialog-editor).  
