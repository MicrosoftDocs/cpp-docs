...
The latest version of this topic can be found at [How to: Declare Interior Pointers with the const Keyword (C++/CLI)](https://docs.microsoft.com/cpp/windows/how-to-declare-interior-pointers-with-the-const-keyword-cpp-cli).  
