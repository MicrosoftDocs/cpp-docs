...
The latest version of this topic can be found at [ActivationFactory Class](https://docs.microsoft.com/cpp/windows/activationfactory-class).  
...
## Remarks  
 ...
 [!code-cpp[wrl-microsoft__wrl__activationfactory#1](../snippets/cpp/VS_Snippets_Misc/wrl-microsoft__wrl__activationfactory/cpp/activationfactory.cpp#1)]  
