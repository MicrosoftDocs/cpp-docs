...
The latest version of this topic can be found at [How to: Specify Include Directories for Resources](https://docs.microsoft.com/cpp/windows/how-to-specify-include-directories-for-resources).  
