...
The latest version of this topic can be found at [Adding Files to an Empty Win32 Applications](https://docs.microsoft.com/cpp/windows/adding-files-to-an-empty-win32-applications).  
