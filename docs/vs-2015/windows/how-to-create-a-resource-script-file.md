...
The latest version of this topic can be found at [How to: Create a Resource Script File](https://docs.microsoft.com/cpp/windows/how-to-create-a-resource-script-file).  
