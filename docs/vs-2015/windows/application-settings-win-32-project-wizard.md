...
The latest version of this topic can be found at [Application Settings, Win 32 Project Wizard](https://docs.microsoft.com/cpp/windows/application-settings-win-32-project-wizard).  
