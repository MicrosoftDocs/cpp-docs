...
The latest version of this topic can be found at [InterfaceTraits::CanCastTo Method](https://docs.microsoft.com/cpp/windows/interfacetraits-cancastto-method).  
