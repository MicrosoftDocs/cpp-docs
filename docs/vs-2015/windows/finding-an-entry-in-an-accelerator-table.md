...
The latest version of this topic can be found at [Finding an Entry in an Accelerator Table](https://docs.microsoft.com/cpp/windows/finding-an-entry-in-an-accelerator-table).  
...
2.  Click a column head to sort the contents of the column alphabetically. For example, click **ID** to display all the IDs in your accelerator table alphabetically.  
