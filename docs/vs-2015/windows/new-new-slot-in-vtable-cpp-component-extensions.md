...
The latest version of this topic can be found at [new (new slot in vtable)  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/new-new-slot-in-vtable-cpp-component-extensions).  
...
## Windows Runtime  
 Not supported in [!INCLUDE[wrt](../includes/wrt-md.md)].  
