...
The latest version of this topic can be found at [Custom Controls in the Dialog Editor](https://docs.microsoft.com/cpp/windows/custom-controls-in-the-dialog-editor).  
