...
## [Console Applications](console-applications-in-visual-cpp.md)
...
## [Windows Desktop Applications](windows-desktop-applications-cpp.md)
...
###### [Editing Graphical Resources](editing-graphical-resources-image-editor-for-icons.md)
...
####### [Drawing Lines or Closed Figures](drawing-lines-or-closed-figures-image-editor-for-icons.md)
####### [Selecting an Area of an Image](selecting-an-area-of-an-image-image-editor-for-icons.md)
####### [Editing Parts of an Image](editing-parts-of-an-image-image-editor-for-icons.md)
####### [Flipping an Image](flipping-an-image-image-editor-for-icons.md)
####### [Resizing an Image](resizing-an-image-image-editor-for-icons.md)
######## [Resizing an Entire Image](resizing-an-entire-image-image-editor-for-icons.md)
######## [Cropping or Extending an Entire Image](cropping-or-extending-an-entire-image-image-editor-for-icons.md)
######## [Shrinking or Stretching an Entire Image](shrinking-or-stretching-an-entire-image-image-editor-for-icons.md)
######## [Shrinking or Stretching Part of an Image](shrinking-or-stretching-part-of-an-image-image-editor-for-icons.md)
####### [Creating a Custom Brush](creating-a-custom-brush-image-editor-for-icons.md)
####### [Changing Image Properties](changing-image-properties-image-editor-for-icons.md)
####### [Saving Bitmaps as GIFs or JPEGs](saving-bitmaps-as-gifs-or-jpegs-image-editor-for-icons.md)
####### [Converting an Image From One Format to Another](converting-an-image-from-one-format-to-another-image-editor-for-icons.md)
####### [Editing an Image Outside of a Project](editing-an-image-outside-of-a-project-image-editor-for-icons.md)
####### [Image Menu](image-menu-image-editor-for-icons.md)
######## [Grid Settings Dialog Box](grid-settings-dialog-box-image-editor-for-icons.md)
####### [Toolbar](toolbar-image-editor-for-icons.md)
######## [Displaying or Hiding the Toolbar](displaying-or-hiding-the-toolbar-image-editor-for-icons.md)
######## [Text Tool Dialog Box](text-tool-dialog-box-image-editor-for-icons.md)
######## [Text Tool Font Dialog Box](text-tool-font-dialog-box-image-editor-for-icons.md)
######## [Changing the Font of Text on an Image](changing-the-font-of-text-on-an-image-image-editor-for-icons.md)
####### [Window Panes](window-panes-image-editor-for-icons.md)
######## [Changing the Magnification Factor](changing-the-magnification-factor-image-editor-for-icons.md)
######## [Displaying or Hiding the Pixel Grid](displaying-or-hiding-the-pixel-grid-image-editor-for-icons.md)
###### [Working with Color](working-with-color-image-editor-for-icons.md)
####### [Selecting Foreground or Background Colors](selecting-foreground-or-background-colors-image-editor-for-icons.md)
####### [Filling a Bounded Area of an Image with a Color](filling-a-bounded-area-of-an-image-with-a-color-image-editor-for-icons.md)
####### [Picking up a Color from an Image to Use Elsewhere](picking-up-a-color-from-an-image-to-use-elsewhere-image-editor-for-icons.md)
####### [Choosing a Transparent or Opaque Background](choosing-a-transparent-or-opaque-background-image-editor-for-icons.md)
####### [Inverting the Colors in a Selection](inverting-the-colors-in-a-selection-image-editor-for-icons.md)
####### [Customizing or Changing Colors](customizing-or-changing-colors-image-editor-for-icons.md)
######## [Custom Color Selector Dialog Box](custom-color-selector-dialog-box-image-editor-for-icons.md)
####### [Saving and Loading Different Color Palettes](saving-and-loading-different-color-palettes-image-editor-for-icons.md)
######## [Load Palette Colors Dialog Box](load-palette-colors-dialog-box-image-editor-for-icons.md)
####### [Colors Window](colors-window-image-editor-for-icons.md)
######## [Displaying or Hiding the Colors Window](displaying-or-hiding-the-colors-window-image-editor-for-icons.md)
###### [Icons and Cursors: Image Resources for Display Devices](icons-and-cursors-image-resources-for-display-devices-image-editor-for-icons.md)
####### [Creating a Device Image](creating-a-device-image-image-editor-for-icons.md)
######## [New <Device> Image Type Dialog Box](new-device-image-type-dialog-box-image-editor-for-icons.md)
######### [Custom Image Dialog Box](custom-image-dialog-box-image-editor-for-icons.md)
######## [Open <Device> Image Dialog Box](open-device-image-dialog-box-image-editor-for-icons.md)
####### [Adding an Image for a Different Display Device](adding-an-image-for-a-different-display-device-image-editor-for-icons.md)
####### [Copying a Device Image](copying-a-device-image-image-editor-for-icons.md)
####### [Deleting a Device Image](deleting-a-device-image-image-editor-for-icons.md)
####### [Creating Transparent or Inverse Regions in Device Images](creating-transparent-or-inverse-regions-in-device-images.md)
####### [Creating a 256-Color Icon or Cursor](creating-a-256-color-icon-or-cursor-image-editor-for-icons.md)
######## [Using the 256-Color Palette](using-the-256-color-palette-image-editor-for-icons.md)
####### [Setting a Cursor's Hot Spot](setting-a-cursor-s-hot-spot-image-editor-for-icons.md)
...
# [Universal Windows Apps](universal-windows-apps-cpp.md)
...
### [Class Library Project Template](wrl-class-library-project-template.md)
### [Walkthrough: Creating a Basic Windows Runtime Component](walkthrough-creating-a-basic-windows-runtime-component-using-wrl.md)
...
##### [Callback Function](callback-function-windows-runtime-cpp-template-library.md)
...
### [ptr](ptr.md)
### [public](public-cpp-attributes.md)
### [range](range-cpp.md)
### [rdx](rdx.md)
