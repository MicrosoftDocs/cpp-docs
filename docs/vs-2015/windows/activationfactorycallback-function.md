...
The latest version of this topic can be found at [ActivationFactoryCallback Function](https://docs.microsoft.com/cpp/windows/activationfactorycallback-function).  
