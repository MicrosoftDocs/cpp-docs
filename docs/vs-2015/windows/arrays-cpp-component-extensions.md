...
The latest version of this topic can be found at [Arrays (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/arrays-cpp-component-extensions).  
  
The `Platform::Array<T>` type in [!INCLUDE[cppwrt_short](../includes/cppwrt-short-md.md)], or the `array` keyword in [!INCLUDE[cppcli](../includes/cppcli-md.md)], declares an array of a specified type and initial value.  
 ...
 *qualifiers* [optional]  
 ...
 `array-type`  
 The type of the array variable. Valid types are [!INCLUDE[wrt](../includes/wrt-md.md)] classes and fundamental types, ref classes and structs, value classes and structs, and native pointers (`type``*`).  
 ...
 *qualifiers* [optional]  
 ...
 `array-type`  
 The type of the array variable. Valid types are [!INCLUDE[wrt](../includes/wrt-md.md)] classes and fundamental types, ref classes and structs, value classes and structs, native pointers (`type``*`), and native POD (plain old data) types.  
