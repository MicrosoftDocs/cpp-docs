...
The latest version of this topic can be found at [Override Specifiers  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/override-specifiers-cpp-component-extensions).  
