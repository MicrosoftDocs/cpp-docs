...
The latest version of this topic can be found at [CreatorMap Structure](https://docs.microsoft.com/cpp/windows/creatormap-structure).  
...
-   How to compare activation data depending on a classic COM or [!INCLUDE[wrt](../includes/wrt-md.md)] factory.  
...
|Name|Description|  
|----------|-----------------|  
|[CreatorMap::activationId Data Member](../windows/creatormap-activationid-data-member.md)|Represents an object ID that is identified either by a classic COM class ID or a [!INCLUDE[wrt](../includes/wrt-md.md)] name.|  
