...
The latest version of this topic can be found at [operator!= Operator (Microsoft::WRL)](https://docs.microsoft.com/cpp/windows/operator-inequality-operator-microsoft-wrl).  
