...
The latest version of this topic can be found at [SRWLockSharedTraits::Unlock Method](https://docs.microsoft.com/cpp/windows/srwlocksharedtraits-unlock-method).  
