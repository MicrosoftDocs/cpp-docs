...
The latest version of this topic can be found at [SimpleActivationFactory::GetRuntimeClassName Method](https://docs.microsoft.com/cpp/windows/simpleactivationfactory-getruntimeclassname-method).  
