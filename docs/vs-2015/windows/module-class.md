...
The latest version of this topic can be found at [Module Class](https://docs.microsoft.com/cpp/windows/module-class).  
...
|[Module::RegisterObjects Method](../windows/module-registerobjects-method.md)|Registers COM or [!INCLUDE[wrt](../includes/wrt-md.md)] objects so other applications can connect to them.|  
|[Module::RegisterWinRTObject Method](../windows/module-registerwinrtobject-method.md)|Registers one or more [!INCLUDE[wrt](../includes/wrt-md.md)] objects so other applications can connect to them.|  
...
|[Module::UnregisterWinRTObject Method](../windows/module-unregisterwinrtobject-method.md)|Unregisters one or more [!INCLUDE[wrt](../includes/wrt-md.md)] objects so that other applications cannot connect to them.|  
