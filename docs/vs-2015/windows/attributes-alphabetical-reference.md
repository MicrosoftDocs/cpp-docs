...
The latest version of this topic can be found at [Attributes Alphabetical Reference](https://docs.microsoft.com/cpp/windows/attributes-alphabetical-reference).      The following attributes are available in Visual C++.  
