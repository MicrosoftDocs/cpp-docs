...
The latest version of this topic can be found at [Context-Sensitive Keywords  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/context-sensitive-keywords-cpp-component-extensions).  
