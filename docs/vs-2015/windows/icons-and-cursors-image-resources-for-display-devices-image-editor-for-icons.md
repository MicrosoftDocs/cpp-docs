...
The latest version of this topic can be found at [Icons and Cursors: Image Resources for Display Devices (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/icons-and-cursors-image-resources-for-display-devices-image-editor-for-icons).  
