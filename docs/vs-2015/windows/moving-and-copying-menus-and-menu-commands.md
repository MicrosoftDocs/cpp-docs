...
The latest version of this topic can be found at [Moving and Copying Menus and Menu Commands](https://docs.microsoft.com/cpp/windows/moving-and-copying-menus-and-menu-commands).  
