...
The latest version of this topic can be found at [FtmBase::GetMarshalSizeMax Method](https://docs.microsoft.com/cpp/windows/ftmbase-getmarshalsizemax-method).  
