...
The latest version of this topic can be found at [How to: Open a Resource Script File Outside of a Project (Standalone)](https://docs.microsoft.com/cpp/windows/how-to-open-a-resource-script-file-outside-of-a-project-standalone).  
