...
The latest version of this topic can be found at [SimpleActivationFactory::ActivateInstance Method](https://docs.microsoft.com/cpp/windows/simpleactivationfactory-activateinstance-method).  
