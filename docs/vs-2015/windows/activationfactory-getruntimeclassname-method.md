...
The latest version of this topic can be found at [ActivationFactory::GetRuntimeClassName Method](https://docs.microsoft.com/cpp/windows/activationfactory-getruntimeclassname-method).  
