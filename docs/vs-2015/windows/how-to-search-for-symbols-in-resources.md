...
The latest version of this topic can be found at [How to: Search for Symbols in Resources](https://docs.microsoft.com/cpp/windows/how-to-search-for-symbols-in-resources).  
