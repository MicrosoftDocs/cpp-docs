...
The latest version of this topic can be found at [Changing the Names of Symbol Header Files](https://docs.microsoft.com/cpp/windows/changing-the-names-of-symbol-header-files).  
