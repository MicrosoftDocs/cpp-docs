...
The latest version of this topic can be found at [property  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/property-cpp-component-extensions).  
