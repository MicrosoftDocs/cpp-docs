...
The latest version of this topic can be found at [Sizing a Control While You Add It](https://docs.microsoft.com/cpp/windows/sizing-a-control-while-you-add-it).  
