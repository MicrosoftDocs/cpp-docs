...
The latest version of this topic can be found at [Adding an Entry to an Accelerator Table](https://docs.microsoft.com/cpp/windows/adding-an-entry-to-an-accelerator-table).  
