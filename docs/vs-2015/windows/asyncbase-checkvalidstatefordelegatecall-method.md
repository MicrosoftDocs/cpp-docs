...
The latest version of this topic can be found at [AsyncBase::CheckValidStateForDelegateCall Method](https://docs.microsoft.com/cpp/windows/asyncbase-checkvalidstatefordelegatecall-method).  
