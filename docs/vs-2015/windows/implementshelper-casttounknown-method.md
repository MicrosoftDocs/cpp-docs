...
The latest version of this topic can be found at [ImplementsHelper::CastToUnknown Method](https://docs.microsoft.com/cpp/windows/implementshelper-casttounknown-method).  
