...
The latest version of this topic can be found at [Adding Version Information for Another Language](https://docs.microsoft.com/cpp/windows/adding-version-information-for-another-language).  
...
2.  Right-click within the version information table and choose **New Version Info Block** from the shortcut menu.  
     ...
     This command adds an additional information block to the current version information resource and opens its corresponding properties in the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca).  
