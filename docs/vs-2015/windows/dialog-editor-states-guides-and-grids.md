...
The latest version of this topic can be found at [Dialog Editor States (Guides and Grids)](https://docs.microsoft.com/cpp/windows/dialog-editor-states-guides-and-grids).  
