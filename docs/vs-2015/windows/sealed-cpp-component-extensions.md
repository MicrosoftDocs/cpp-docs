...
The latest version of this topic can be found at [sealed  (C++ Component Extensions)](https://docs.microsoft.com/cpp/windows/sealed-cpp-component-extensions).  
 ...
 **Remarks**  
 ...
 The `sealed` keyword is valid for native targets, and also for the [!INCLUDE[wrt](../includes/wrt-md.md)] and the common language runtime (CLR). For more information, see [Override Specifiers and Native Compilations](../dotnet/how-to-declare-override-specifiers-in-native-compilations-cpp-cli.md).  
