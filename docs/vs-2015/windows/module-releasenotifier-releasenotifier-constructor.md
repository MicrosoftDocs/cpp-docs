...
The latest version of this topic can be found at [Module::ReleaseNotifier::ReleaseNotifier Constructor](https://docs.microsoft.com/cpp/windows/module-releasenotifier-releasenotifier-constructor).  
