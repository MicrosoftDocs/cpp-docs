...
The latest version of this topic can be found at [Using a Drawing Tool (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/using-a-drawing-tool-image-editor-for-icons).  
