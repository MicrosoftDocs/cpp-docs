...
The latest version of this topic can be found at [Creating a Custom Brush (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/creating-a-custom-brush-image-editor-for-icons).  
