...
The latest version of this topic can be found at [ChainInterfaces::IidCount Constant](https://docs.microsoft.com/cpp/windows/chaininterfaces-iidcount-constant).  
