...
The latest version of this topic can be found at [ComPtrRef::operator!= Operator](https://docs.microsoft.com/cpp/windows/comptrref-operator-inequality-operator).  
