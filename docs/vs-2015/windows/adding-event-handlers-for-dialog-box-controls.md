...
The latest version of this topic can be found at [Adding Event Handlers for Dialog Box Controls](https://docs.microsoft.com/cpp/windows/adding-event-handlers-for-dialog-box-controls).  
...
2.  In the [Properties window](http://msdn.microsoft.com/library/e6e0fa4f-75c4-4a52-af15-281cd61876ca), click the **ControlEvents** button to display the list of common Windows events associated with the control. For example, the standard **OK** button on the **About** dialog box lists the following notification events:  
