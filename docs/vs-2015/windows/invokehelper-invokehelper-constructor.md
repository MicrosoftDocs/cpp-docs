...
The latest version of this topic can be found at [InvokeHelper::InvokeHelper Constructor](https://docs.microsoft.com/cpp/windows/invokehelper-invokehelper-constructor).  
