...
The latest version of this topic can be found at [Module::GenericReleaseNotifier Class](https://docs.microsoft.com/cpp/windows/module-genericreleasenotifier-class).  
