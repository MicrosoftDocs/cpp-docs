...
The latest version of this topic can be found at [Selecting Foreground or Background Colors (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/selecting-foreground-or-background-colors-image-editor-for-icons).  
