...
The latest version of this topic can be found at [SRWLockExclusiveTraits Structure](https://docs.microsoft.com/cpp/windows/srwlockexclusivetraits-structure).  
