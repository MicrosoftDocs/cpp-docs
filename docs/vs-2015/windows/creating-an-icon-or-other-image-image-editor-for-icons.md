...
The latest version of this topic can be found at [Creating an Icon or Other Image (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/creating-an-icon-or-other-image-image-editor-for-icons).  
