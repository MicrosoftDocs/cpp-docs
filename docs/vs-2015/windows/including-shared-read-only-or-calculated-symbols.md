...
The latest version of this topic can be found at [Including Shared (Read-Only) or Calculated Symbols](https://docs.microsoft.com/cpp/windows/including-shared-read-only-or-calculated-symbols).  
