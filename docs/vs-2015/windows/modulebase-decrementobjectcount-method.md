...
The latest version of this topic can be found at [ModuleBase::DecrementObjectCount Method](https://docs.microsoft.com/cpp/windows/modulebase-decrementobjectcount-method).  
