...
The latest version of this topic can be found at [Window Panes (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/window-panes-image-editor-for-icons).  
