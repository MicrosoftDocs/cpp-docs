...
The latest version of this topic can be found at [Module::ReleaseNotifier::Invoke Method](https://docs.microsoft.com/cpp/windows/module-releasenotifier-invoke-method).  
