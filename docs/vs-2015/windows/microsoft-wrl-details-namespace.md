...
The latest version of this topic can be found at [Microsoft::WRL::Details Namespace](https://docs.microsoft.com/cpp/windows/microsoft-wrl-details-namespace).  
...
|[FactoryCache Structure](../windows/factorycache-structure.md)|Contains the location of a class factory and a value that identifies a registered [!INCLUDE[wrt](../includes/wrt-md.md)] or COM class object.|  
