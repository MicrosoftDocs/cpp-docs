...
The latest version of this topic can be found at [RuntimeClassBaseT::GetImplementedIIDS Method](https://docs.microsoft.com/cpp/windows/runtimeclassbaset-getimplementediids-method).  
