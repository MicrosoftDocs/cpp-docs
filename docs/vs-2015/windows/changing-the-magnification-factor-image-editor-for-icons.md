...
The latest version of this topic can be found at [Changing the Magnification Factor (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/changing-the-magnification-factor-image-editor-for-icons).  
