...
The latest version of this topic can be found at [Deleting an Entry From an Accelerator Table](https://docs.microsoft.com/cpp/windows/deleting-an-entry-from-an-accelerator-table).  
