...
The latest version of this topic can be found at [MakeAllocator::~MakeAllocator Destructor](https://docs.microsoft.com/cpp/windows/makeallocator-tilde-makeallocator-destructor).  
