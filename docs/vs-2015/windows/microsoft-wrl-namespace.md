...
The latest version of this topic can be found at [Microsoft::WRL Namespace](https://docs.microsoft.com/cpp/windows/microsoft-wrl-namespace).  
  
  
Defines the fundamental types that make up the [!INCLUDE[cppwrl_short](../includes/cppwrl-short-md.md)].  
