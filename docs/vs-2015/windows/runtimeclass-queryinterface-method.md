...
The latest version of this topic can be found at [RuntimeClass::QueryInterface Method](https://docs.microsoft.com/cpp/windows/runtimeclass-queryinterface-method).  
