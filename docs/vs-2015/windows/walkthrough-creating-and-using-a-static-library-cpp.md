...
The latest version of this topic can be found at [Walkthrough: Creating and Using a Static Library (C++)](https://docs.microsoft.com/cpp/windows/walkthrough-creating-and-using-a-static-library-cpp).  
...
2.  Add a class named **MyMathFuncs** to do common mathematical operations such as addition, subtraction, multiplication, and division. The code should resemble this:  
     ...
     [!code-cpp[NVC_Walkthrough_Create_Static_Lib#100](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_create_static_lib/cpp/mathfuncslib.h#100)]  
...
4.  Use this source file to implement the functionality for **MyMathFuncs**. The code should resemble this:  
     ...
     [!code-cpp[NVC_Walkthrough_Create_Static_Lib#110](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_create_static_lib/cpp/mathfuncslib.cpp#110)]  
...
5.  You can now use the **MyMathFuncs** class in this app. To do this, replace the contents of **MyExecRefsLib.cpp** with this code:  
     ...
     [!code-cpp[NVC_Walkthrough_Create_Static_Lib#120](../snippets/cpp/VS_Snippets_Cpp/nvc_walkthrough_create_static_lib/cpp/myexecrefslib.cpp#120)]  
