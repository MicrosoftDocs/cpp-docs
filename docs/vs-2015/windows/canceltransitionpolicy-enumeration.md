...
The latest version of this topic can be found at [CancelTransitionPolicy Enumeration](https://docs.microsoft.com/cpp/windows/canceltransitionpolicy-enumeration).  
