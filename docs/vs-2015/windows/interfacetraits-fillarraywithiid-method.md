...
The latest version of this topic can be found at [InterfaceTraits::FillArrayWithIid Method](https://docs.microsoft.com/cpp/windows/interfacetraits-fillarraywithiid-method).  
