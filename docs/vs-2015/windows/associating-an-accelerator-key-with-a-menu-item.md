...
The latest version of this topic can be found at [Associating an Accelerator Key with a Menu Item](https://docs.microsoft.com/cpp/windows/associating-an-accelerator-key-with-a-menu-item).  
