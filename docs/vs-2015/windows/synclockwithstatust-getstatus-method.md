...
The latest version of this topic can be found at [SyncLockWithStatusT::GetStatus Method](https://docs.microsoft.com/cpp/windows/synclockwithstatust-getstatus-method).  
