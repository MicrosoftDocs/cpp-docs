...
The latest version of this topic can be found at [Changing the Caption Property of Multiple Strings](https://docs.microsoft.com/cpp/windows/changing-the-caption-property-of-multiple-strings).  
