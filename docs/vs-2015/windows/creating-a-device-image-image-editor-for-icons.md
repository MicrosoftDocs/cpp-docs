...
The latest version of this topic can be found at [Creating a Device Image (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/creating-a-device-image-image-editor-for-icons).  
