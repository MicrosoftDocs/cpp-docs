...
The latest version of this topic can be found at [Microsoft::WRL::Wrappers Namespace](https://docs.microsoft.com/cpp/windows/microsoft-wrl-wrappers-namespace).  
