...
The latest version of this topic can be found at [Saving and Loading Different Color Palettes (Image Editor for Icons)](https://docs.microsoft.com/cpp/windows/saving-and-loading-different-color-palettes-image-editor-for-icons).  
