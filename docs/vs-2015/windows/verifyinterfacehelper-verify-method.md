...
The latest version of this topic can be found at [VerifyInterfaceHelper::Verify Method](https://docs.microsoft.com/cpp/windows/verifyinterfacehelper-verify-method).  
