...
The latest version of this topic can be found at [FtmBase::GetUnmarshalClass Method](https://docs.microsoft.com/cpp/windows/ftmbase-getunmarshalclass-method).  
