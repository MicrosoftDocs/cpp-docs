...
The latest version of this topic can be found at [Inserting a Space Between Buttons on a Toolbar](https://docs.microsoft.com/cpp/windows/inserting-a-space-between-buttons-on-a-toolbar).  
