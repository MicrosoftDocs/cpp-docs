...
The latest version of this topic can be found at [Working with Resource Files](https://docs.microsoft.com/cpp/windows/working-with-resource-files).  
  
   
WARNING]
>  This section applies to Windows desktop applications written in C++. For information about resources in [!INCLUDE[win8_appname_long](../includes/win8-appname-long-md.md)] apps written in C++, see [Defining App Resources](http://msdn.microsoft.com/en-us/476ea844-632c-4467-9ce3-966be1350dd4).  
>   
