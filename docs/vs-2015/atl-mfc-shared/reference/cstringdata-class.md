...
The latest version of this topic can be found at [CStringData Class](https://docs.microsoft.com/cpp/atl-mfc-shared/reference/cstringdata-class).  
...
### Remarks  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#104](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#104)]  
