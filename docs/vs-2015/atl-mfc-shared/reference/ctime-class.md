...
The latest version of this topic can be found at [CTime Class](https://docs.microsoft.com/cpp/atl-mfc-shared/reference/ctime-class).  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#161](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#161)]  
...
- `CTime`( **const FILETIME&** ) **;**Constructs a `CTime` object from a `FILETIME` structure. You most likely will not use `CTime``FILETIME` initialization directly. If you use a `CFile` object to manipulate a file, `CFile::GetStatus` retrieves the file time stamp for you through a `CTime` object initialized with a `FILETIME` structure. This constructor assumes a time based on UTC and automatically converts the value to local time before storing the result.  
 ...
 For more information, see the [SYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/ms724950) and [FILETIME](http://msdn.microsoft.com/library/windows/desktop/ms724284) structure in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. Also see the [MS-DOS Date and Time](http://msdn.microsoft.com/library/windows/desktop/ms724503) entry in the [!INCLUDE[winsdkshort](../../includes/winsdkshort-md.md)].  
  
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#148](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#148)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#149](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#149)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#150](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#150)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#151](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#151)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#152](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#152)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#153](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#153)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#154](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#154)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#155](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#155)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#156](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#156)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#157](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#157)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#158](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#158)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#159](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#159)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#160](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#160)]  
