...
The latest version of this topic can be found at [Classes Shared by MFC and ATL](https://docs.microsoft.com/cpp/atl-mfc-shared/reference/classes-shared-by-mfc-and-atl).  
