...
The latest version of this topic can be found at [CStringT Class](https://docs.microsoft.com/cpp/atl-mfc-shared/reference/cstringt-class).  
...
### Remarks  
 ...
 Commonly, if this string is passed to a COM function as an [in] parameter, then this requires the caller to free the string. This can be done by using [SysFreeString](http://msdn.microsoft.com/en-us/8f230ee3-5f6e-4cb9-a910-9c90b754dcd3), as described in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)]. For more information, see [Allocating and Releasing Memory for a BSTR](../../atl-mfc-shared/allocating-and-releasing-memory-for-a-bstr.md).  
  
 For more information about OLE allocation functions in Windows, see [SysAllocString](http://msdn.microsoft.com/en-us/9e0437a2-9b4a-4576-88b0-5cb9d08ca29b) in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 The following example demonstrates the use of `CStringT::AllocSysString`.  
  
 [!code-cpp[NVC_ATLMFC_Utilities#105](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#105)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#106](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#106)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#107](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#107)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#109](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#109)]  
...
### Example  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#110](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#110)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#111](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#111)]  
...
> [!NOTE]
>  Define the **_CSTRING_DISABLE_NARROW_WIDE_CONVERSION** macro to turn off implicit string conversion between [!INCLUDE[vcpransi](../../includes/vcpransi-md.md)] and [!INCLUDE[TLA#tla_unicode](../../includes/tlasharptla-unicode-md.md)] strings. The macro excludes from compilation constructors that support conversion.  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#112](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#112)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#113](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#113)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#114](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#114)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#115](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#115)]  
...
### Remarks  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#116](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#116)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#117](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#117)]  
...
> `FormatMessage` attempts to allocate system memory for the newly formatted string. If this attempt fails, a memory exception is automatically thrown.  
 ...
 Each insert must have a corresponding parameter following the `pszFormat` or `nFormatID` parameter. Within the message text, several escape sequences are supported for dynamically formatting the message. For more information, see the Windows [FormatMessage](http://msdn.microsoft.com/library/windows/desktop/ms679351) function in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
  
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#118](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#118)]  
...
> `FormatMessageV` calls [CStringT::FormatMessage](#cstringt__formatmessage), which attempts to allocate system memory for the newly formatted string. If this attempt fails, a memory exception is automatically thrown.  
 ...
 For more information, see the Windows [FormatMessage](http://msdn.microsoft.com/library/windows/desktop/ms679351) function in the [!INCLUDE[winSDK](../../includes/winsdk-md.md)].  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#119](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#119)]  
  
 [!code-cpp[NVC_ATLMFC_Utilities#120](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#120)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#121](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#121)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#122](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#122)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#123](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#123)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#124](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#124)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#125](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#125)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#126](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#126)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#127](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#127)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#128](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#128)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#140](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#140)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#141](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#141)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#142](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#142)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#143](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#143)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#144](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#144)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#145](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#145)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#146](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#146)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#147](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#147)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#129](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#129)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#200](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#200)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#130](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#130)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#131](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#131)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#132](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#132)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#133](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#133)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#134](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#134)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#135](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#135)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#136](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#136)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#137](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#137)]  
...
### Example  
 [!code-cpp[NVC_ATLMFC_Utilities#138](../../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#138)]  
