...
The latest version of this topic can be found at [Implementation of a Custom String Manager (Advanced Method)](https://docs.microsoft.com/cpp/atl-mfc-shared/implementation-of-a-custom-string-manager-advanced-method).  
