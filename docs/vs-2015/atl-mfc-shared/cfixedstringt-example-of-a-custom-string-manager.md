...
The latest version of this topic can be found at [CFixedStringT: Example of a Custom String Manager](https://docs.microsoft.com/cpp/atl-mfc-shared/cfixedstringt-example-of-a-custom-string-manager).  
