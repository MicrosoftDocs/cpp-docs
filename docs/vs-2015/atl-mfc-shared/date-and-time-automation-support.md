...
The latest version of this topic can be found at [Date and Time: Automation Support](https://docs.microsoft.com/cpp/atl-mfc-shared/date-and-time-automation-support).  
...
-   [Formatting a string representation of a date/time](../atl-mfc-shared/formatting-time-automation-classes.md)  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#176](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/DTDlg.cpp#176)]  
