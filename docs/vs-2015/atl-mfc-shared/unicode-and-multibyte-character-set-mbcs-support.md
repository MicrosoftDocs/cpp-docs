...
The latest version of this topic can be found at [Unicode and Multibyte Character Set (MBCS) Support](https://docs.microsoft.com/cpp/atl-mfc-shared/unicode-and-multibyte-character-set-mbcs-support).  
...
> [!IMPORTANT]
>  In [!INCLUDE[vs_dev12](../includes/vs-dev12-md.md)] and later, the MBCS versions of the MFC DLLs are available as a free add-in to Visual Studio from the MSDN download site. For more information, see [MFC MBCS DLL Add-in](../mfc/mfc-mbcs-dll-add-on.md).  
