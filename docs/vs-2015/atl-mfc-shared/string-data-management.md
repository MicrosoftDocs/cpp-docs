...
The latest version of this topic can be found at [String Data Management](https://docs.microsoft.com/cpp/atl-mfc-shared/string-data-management).  
...
>  which the compiler treats as a Unicode string. For example, the following code:  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#187](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#187)]  
