...
The latest version of this topic can be found at [Implementation of a Custom String Manager (Basic Method)](https://docs.microsoft.com/cpp/atl-mfc-shared/implementation-of-a-custom-string-manager-basic-method).  
...
-   [CComHeap](../atl/reference/ccomheap-class.md) Wraps the COM Task Allocator APIs: [CoTaskMemAlloc](http://msdn.microsoft.com/library/windows/desktop/ms692727), [CoTaskMemFree](http://msdn.microsoft.com/library/windows/desktop/ms680722), and [CoTaskMemRealloc](http://msdn.microsoft.com/library/windows/desktop/ms687280)  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#180](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#180)]  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#181](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#181)]  
