...
The latest version of this topic can be found at [Date and Time: Database Support](https://docs.microsoft.com/cpp/atl-mfc-shared/date-and-time-database-support).  
