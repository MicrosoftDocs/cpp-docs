...
The latest version of this topic can be found at [Basic CString Operations](https://docs.microsoft.com/cpp/atl-mfc-shared/basic-cstring-operations).  
...
-   Assign the value of a C literal string to a `CString` object.  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#183](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#183)]  
  
-   Assign the value of one `CString` to another `CString` object.  
  
 [!code-cpp[NVC_ATLMFC_Utilities#184](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#184)]  
...
##  <a name="_core_concatenating_two_cstring_objects"></a> Concatenating Two CString Objects  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#185](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#185)]  
...
|`Collate`|`_mbscoll`|`wcscoll`|  
 ...
 [!code-cpp[NVC_ATLMFC_Utilities#186](../snippets/cpp/VS_Snippets_Cpp/NVC_ATLMFC_Utilities/Cpp/NVC_ATLMFC_Utilities.cpp#186)]  
