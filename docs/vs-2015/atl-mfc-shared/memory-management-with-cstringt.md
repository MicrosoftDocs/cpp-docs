...
The latest version of this topic can be found at [Memory Management with CStringT](https://docs.microsoft.com/cpp/atl-mfc-shared/memory-management-with-cstringt).  
