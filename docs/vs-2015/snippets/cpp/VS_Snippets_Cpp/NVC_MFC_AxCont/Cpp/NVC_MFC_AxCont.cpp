// NVC_MFC_AxCont.cpp : Defines the class behaviors for the application.
//
...
// </Snippet17>
   ...
   pDocTemplate = new CMultiDocTemplate(IDR_NVC_MFC_AxContTYPE,
   ...
   TCHAR* pszDllName = NULL;
   int iReturn;
   const int FAIL_LOAD = 5;
