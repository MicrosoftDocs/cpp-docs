...
### Description  
 This example demonstrates how to convert from a wide character (Unicode) [System::String](<!-- TODO: review code entity reference <xref:assetId:///System::String?qualifyHint=True&amp;autoUpgrade=True>  -->) to the other string types listed above.  
