...
## Remarks  
 `CAtlServiceModuleT`, derived from [CAtlExeModuleT](../atl/catlexemodulet-class.md), implements a ATL Service module. `CAtlServiceModuleT` provides methods for command-line processing, installation, registering, and removal. If extra functionality is required, these and other methods can be overridden.  
  
 This class replaces the obsolete [CComModule Class](../atl/ccommodule-class.md) used in earlier versions of ATL. See [ATL Module Classes](../atl/atl-module-classes.md) for more details.  
...
## Inheritance Hierarchy  
 ...
 [CAtlExeModuleT](../atl/catlexemodulet-class.md)  
...
### Remarks  
 ...
 [!code[NVC_ATL_Service#1](../atl/codesnippet/CPP/catlservicemodulet-class_1.cpp)]  
  
 For attributed service projects, this would be in  
  
 [!code[NVC_ATL_ServiceAttrib#1](../atl/codesnippet/CPP/catlservicemodulet-class_2.cpp)]  
...
## See Also  
 [CAtlExeModuleT Class](../atl/catlexemodulet-class.md)   
