...
### Remarks  
 The property map stores property descriptions, property DISPIDs, property page CLSIDs, and `IDispatch` IIDs. Classes [IPerPropertyBrowsingImpl](../atl/iperpropertybrowsingimpl-class.md), [IPersistPropertyBagImpl](../atl/ipersistpropertybagimpl-class.md), [IPersistStreamInitImpl](../atl/ipersiststreaminitimpl-class.md), and [ISpecifyPropertyPagesImpl](../atl/ispecifypropertypagesimpl-class.md) use the property map to retrieve and set this information.  
...
### Example  
 [!code[NVC_ATL_Windowing#103](../atl/codesnippet/CPP/property-map-macros_1.h)]  
...
### Example  
 ...
 [!code[NVC_ATL_Windowing#131](../atl/codesnippet/CPP/property-map-macros_2.h)]  
  
 [!code[NVC_ATL_Windowing#132](../atl/codesnippet/CPP/property-map-macros_3.h)]  
...
### Example  
 ...
 [!code[NVC_ATL_Windowing#133](../atl/codesnippet/CPP/property-map-macros_4.h)]  
...
### Example  
 [!code[NVC_ATL_Windowing#134](../atl/codesnippet/CPP/property-map-macros_5.h)]  
