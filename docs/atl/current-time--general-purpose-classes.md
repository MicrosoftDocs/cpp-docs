...
1.  Allocate a `CTime` object, as follows:  
     ...
     [!code[NVC_ATLMFC_Utilities#171](../atl/codesnippet/CPP/current-time--general-purpose-classes_1.cpp)]  
...
2.  Call the `CTime::GetCurrentTime` function to get the current time from the operating system. This function returns a `CTime` object that can be used to set the value of `CTime`, as follows:  
     ...
     [!code[NVC_ATLMFC_Utilities#172](../atl/codesnippet/CPP/current-time--general-purpose-classes_2.cpp)]  
 ...
 [!code[NVC_ATLMFC_Utilities#173](../atl/codesnippet/CPP/current-time--general-purpose-classes_3.cpp)]  
