...
## Remarks  
 ...
 A companion class, [CTime](../atl/ctime-class.md), represents an absolute time.  
 ...
 For more information on using `CTimeSpan`, see the articles [Date and Time](../atl/date-and-time.md), and [Time Management](../crt/time-management.md) in the *Run-Time Library Reference*.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#169](../atl/codesnippet/CPP/ctimespan-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#162](../atl/codesnippet/CPP/ctimespan-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#163](../atl/codesnippet/CPP/ctimespan-class_3.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#164](../atl/codesnippet/CPP/ctimespan-class_4.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#165](../atl/codesnippet/CPP/ctimespan-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#166](../atl/codesnippet/CPP/ctimespan-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#167](../atl/codesnippet/CPP/ctimespan-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#168](../atl/codesnippet/CPP/ctimespan-class_8.cpp)]  
