...
## Remarks  
 ...
 The members of this class that are used to look up network addresses use the Win32 API function [getaddrinfo](https://msdn.microsoft.com/library/windows/desktop/ms738520).  
...
### Remarks  
 The host name parameter may be in either IPv4 or IPv6 format. This method calls the Win32 API function [getaddrinfo](https://msdn.microsoft.com/library/windows/desktop/ms738520) to perform the conversion.  
...
### Remarks  
 This method calls the Win32 API function [getaddrinfo](https://msdn.microsoft.com/library/windows/desktop/ms738520) to perform the conversion.  
