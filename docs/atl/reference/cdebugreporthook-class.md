...
## Remarks  
 ...
 Use of this class allows you to interactively debug components running in non-interactive [window stations](https://msdn.microsoft.com/library/windows/desktop/ms687096).  
