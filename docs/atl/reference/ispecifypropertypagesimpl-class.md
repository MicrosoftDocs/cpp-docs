...
This class implements `IUnknown` and provides a default implementation of the [ISpecifyPropertyPages](https://msdn.microsoft.com/library/windows/desktop/ms695217) interface.  
...
##  <a name="getpages"></a>  ISpecifyPropertyPagesImpl::GetPages  
 Fills the array in the [CAUUID](https://msdn.microsoft.com/library/windows/desktop/ms680048) structure with the CLSIDs for the property pages that can be displayed in the object's property sheet.  
...
### Remarks  
 ...
 See [ISpecifyPropertyPages::GetPages](https://msdn.microsoft.com/library/windows/desktop/ms687276) in the Windows SDK.  
