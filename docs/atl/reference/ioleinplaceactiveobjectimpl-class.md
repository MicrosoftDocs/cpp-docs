...
## Remarks  
 The [IOleInPlaceActiveObject](https://msdn.microsoft.com/library/windows/desktop/ms691299) interface assists communication between an in-place control and its container; for example, communicating the active state of the control and container, and informing the control it needs to resize itself. Class `IOleInPlaceActiveObjectImpl` provides a default implementation of `IOleInPlaceActiveObject` and supports `IUnknown` by sending information to the dump device in debug builds.  
...
### Remarks  
 See [IOleInPlaceActiveObject::EnableModeless](https://msdn.microsoft.com/library/windows/desktop/ms680115) in the Windows SDK.  
...
### Remarks  
 See [IOleInPlaceActiveObject::OnDocWindowActivate](https://msdn.microsoft.com/library/windows/desktop/ms687281) in the Windows SDK.  
...
### Remarks  
 See [IOleInPlaceActiveObject::OnFrameWindowActivate](https://msdn.microsoft.com/library/windows/desktop/ms683969) in the Windows SDK.  
...
### Remarks  
 See [IOleInPlaceActiveObject::ResizeBorder](https://msdn.microsoft.com/library/windows/desktop/ms680053) in the Windows SDK.  
...
### Remarks  
 See [IOleInPlaceActiveObject::TranslateAccelerator](https://msdn.microsoft.com/library/windows/desktop/ms693360) in the Windows SDK.  
