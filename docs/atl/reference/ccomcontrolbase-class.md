...
|[CComControlBase::m_spAdviseSink](#m_spadvisesink)|A direct pointer to the advisory connection on the container (the container's [IAdviseSink](https://msdn.microsoft.com/library/windows/desktop/ms692513)).|  
...
|[CComControlBase::m_spInPlaceSite](#m_spinplacesite)|A pointer to the container's [IOleInPlaceSite](https://msdn.microsoft.com/library/windows/desktop/ms686586), [IOleInPlaceSiteEx](https://msdn.microsoft.com/library/windows/desktop/ms693461), or [IOleInPlaceSiteWindowless](https://msdn.microsoft.com/library/windows/desktop/ms682300) interface pointer.|  
...
### Parameters  
 *ppFont*  
 A pointer to the container's ambient [IFont](https://msdn.microsoft.com/library/windows/desktop/ms680673) interface.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The data member `m_spInPlaceSite` points to an [IOleInPlaceSite](https://msdn.microsoft.com/library/windows/desktop/ms686586), [IOleInPlaceSiteEx](https://msdn.microsoft.com/library/windows/desktop/ms693461), or [IOleInPlaceSiteWindowless](https://msdn.microsoft.com/library/windows/desktop/ms682300) interface, depending on the value of the `m_bWndLess` and `m_bInPlaceSiteEx` flags. (The data member `m_bNegotiatedWnd` must be TRUE for the `m_spInPlaceSite` pointer to be valid.)  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 This flag is checked by [IOleObjectImpl::SetExtent](../../atl/reference/ioleobjectimpl-class.md#setextent) and, if TRUE, `SetExtent` notifies the container of view changes. if this flag is set, the OLEMISC_RECOMPOSEONRESIZE bit in the [OLEMISC](https://msdn.microsoft.com/library/windows/desktop/ms678497) enumeration should also be set.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The data member `m_spInPlaceSite` points to an [IOleInPlaceSite](https://msdn.microsoft.com/library/windows/desktop/ms686586), [IOleInPlaceSiteEx](https://msdn.microsoft.com/library/windows/desktop/ms693461), or [IOleInPlaceSiteWindowless](https://msdn.microsoft.com/library/windows/desktop/ms682300) interface, depending on the value of the `m_bWndLess` and [CComControlBase::m_bInPlaceSiteEx](#m_binplacesiteex) flags. (The data member [CComControlBase::m_bNegotiatedWnd](#m_bnegotiatedwnd) must be TRUE for the [CComControlBase::m_spInPlaceSite](#m_spinplacesite) pointer to be valid.)  
...
##  <a name="m_spadvisesink"></a>  CComControlBase::m_spAdviseSink  
 A direct pointer to the advisory connection on the container (the container's [IAdviseSink](https://msdn.microsoft.com/library/windows/desktop/ms692513)).  
...
##  <a name="m_spinplacesite"></a>  CComControlBase::m_spInPlaceSite  
 A pointer to the container's [IOleInPlaceSite](https://msdn.microsoft.com/library/windows/desktop/ms686586), [IOleInPlaceSiteEx](https://msdn.microsoft.com/library/windows/desktop/ms693461), or [IOleInPlaceSiteWindowless](https://msdn.microsoft.com/library/windows/desktop/ms682300) interface pointer.  
...
>  To use this data member within your control class, you must declare it as a data member in your control class. Your control class will not inherit this data member from the base class because it is declared within a union in the base class.  
 ...
 The interface `m_spOleAdviseHolder` implements the [IOleObject::Advise](https://msdn.microsoft.com/library/windows/desktop/ms686573) and [IOleObject::Unadvise](https://msdn.microsoft.com/library/windows/desktop/ms693749) methods to establish and delete advisory connections to the container. The control's container must implement an advise sink by supporting the [IAdviseSink](https://msdn.microsoft.com/library/windows/desktop/ms692513) interface.  
...
### Parameters  
 *advf*  
 Advise flags that specify how the call to [IAdviseSink::OnDataChange](https://msdn.microsoft.com/library/windows/desktop/ms687283) is made. Values are from the [ADVF](https://msdn.microsoft.com/library/windows/desktop/ms693742) enumeration.  
...
### Remarks  
 `SendOnViewChange` calls [IAdviseSink::OnViewChange](https://msdn.microsoft.com/library/windows/desktop/ms694337). The only value of *lindex* currently supported is -1, which indicates that the entire view is of interest.  
