...
## Remarks  
 The `SECURITY_ATTRIBUTES` structure contains a [security descriptor](https://msdn.microsoft.com/library/windows/desktop/aa379561) used for the creation of an object and specifies whether the handle retrieved by specifying this structure is inheritable.  
...
## See Also  
 ...
 [security descriptor](https://msdn.microsoft.com/library/windows/desktop/aa379561)   
