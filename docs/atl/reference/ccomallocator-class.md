...
### Remarks  
 Allocates memory. See [CoTaskMemAlloc](https://msdn.microsoft.com/library/windows/desktop/ms692727) for more details.  
...
### Remarks  
 Frees the allocated memory. See [CoTaskMemFree](https://msdn.microsoft.com/library/windows/desktop/ms680722) for more details.  
...
### Remarks  
 Resizes the amount of allocated memory. See [CoTaskMemRealloc](https://msdn.microsoft.com/library/windows/desktop/ms687280) for more details.  
