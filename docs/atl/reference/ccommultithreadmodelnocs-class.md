...
> [!NOTE]
>  The global `typedef` names [CComObjectThreadModel](../Topic/CComObjectThreadModel.md) and [CComGlobalsThreadModel](atl-typedefs.md#ccomglobalsthreadmodel) do not reference `CComMultiThreadModelNoCS`.  
