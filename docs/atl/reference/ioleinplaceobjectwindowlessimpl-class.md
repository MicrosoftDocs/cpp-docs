...
## Remarks  
 The [IOleInPlaceObject](https://msdn.microsoft.com/library/windows/desktop/ms692646) interface manages the reactivation and deactivation of in-place controls and determines how much of the control should be visible. The [IOleInPlaceObjectWindowless](https://msdn.microsoft.com/library/windows/desktop/ms687304) interface enables a windowless control to receive window messages and to participate in drag-and-drop operations. Class `IOleInPlaceObjectWindowlessImpl` provides a default implementation of `IOleInPlaceObject` and `IOleInPlaceObjectWindowless` and implements `IUnknown` by sending information to the dump device in debug builds.  
...
### Remarks  
 See [IOleWindow::ContextSensitiveHelp](https://msdn.microsoft.com/library/windows/desktop/ms680059) in the Windows SDK.  
...
### Remarks  
 See [IOleInPlaceObjectWindowless::GetDropTarget](https://msdn.microsoft.com/library/windows/desktop/ms678535) in the Windows SDK.  
...
### Remarks  
 ...
 See [IOleWindow::GetWindow](https://msdn.microsoft.com/library/windows/desktop/ms687282) in the Windows SDK.  
...
### Remarks  
 ...
 See [IOleInPlaceObject::InPlaceDeactivate](https://msdn.microsoft.com/library/windows/desktop/ms679700) in the Windows SDK.  
...
### Remarks  
 See [IOleInPlaceObjectWindowless::OnWindowMessage](https://msdn.microsoft.com/library/windows/desktop/ms693783) in the Windows SDK.  
...
### Remarks  
 See [IOleInPlaceObject::ReactivateAndUndo](https://msdn.microsoft.com/library/windows/desktop/ms691372) in the Windows SDK.  
...
### Remarks  
 ...
 See [IOleInPlaceObject::SetObjectRects](https://msdn.microsoft.com/library/windows/desktop/ms683767) in the Windows SDK.  
...
### Remarks  
 ...
 See [IOleInPlaceObject::UIDeactivate](https://msdn.microsoft.com/library/windows/desktop/ms693348) in the Windows SDK.  
