...
### Remarks  
 This method attempts to find a name for the specified `SID` (security identifier). For full details, see [LookupAccountSid](https://msdn.microsoft.com/library/windows/desktop/aa379166).  
...
### Return Value  
 Returns the `SID` structure as a string in a format suitable for display, storage, or transmission. Equivalent to [ConvertSidToStringSid](https://msdn.microsoft.com/library/windows/desktop/aa376399).  
