...
##  <a name="ccomclassfactoryautothread_class"></a>  CComClassFactoryAutoThread Class  
 This class implements the [IClassFactory](https://msdn.microsoft.com/library/windows/desktop/ms694364) interface, and allows objects to be created in multiple apartments.  
...
### Parameters  
 *statusFlags*  
 [in] The VIEWSTATUS flags. See [VIEWSTATUS](https://msdn.microsoft.com/library/windows/desktop/ms687201) for a list of flags.  
