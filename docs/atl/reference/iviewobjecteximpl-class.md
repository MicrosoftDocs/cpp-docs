...
This class implements `IUnknown` and provides default implementations of the [IViewObject](https://msdn.microsoft.com/library/windows/desktop/ms680763), [IViewObject2](https://msdn.microsoft.com/library/windows/desktop/ms691318), and [IViewObjectEx](https://msdn.microsoft.com/library/windows/desktop/ms682375) interfaces.  
...
|[IViewObjectExImpl::QueryHitPoint](#queryhitpoint)|Checks if the specified point is in the specified rectangle and returns a [HITRESULT](https://msdn.microsoft.com/library/windows/desktop/ms682187) value in `pHitResult`.|  
...
## Remarks  
 The [IViewObject](https://msdn.microsoft.com/library/windows/desktop/ms680763), [IViewObject2](https://msdn.microsoft.com/library/windows/desktop/ms691318), and [IViewObjectEx](https://msdn.microsoft.com/library/windows/desktop/ms682375) interfaces enable a control to display itself directly, and to create and manage an advise sink to notify the container of changes in the control display. The `IViewObjectEx` interface provides support for extended control features such as flicker-free drawing, non-rectangular and transparent controls, and hit-testing (for example, how close a mouse click must be to be considered on the control). Class `IViewObjectExImpl` provides a default implementation of these interfaces and implements `IUnknown` by sending information to the dump device in debug builds.  
...
### Remarks  
 ...
 See [IViewObject::Draw](https://msdn.microsoft.com/library/windows/desktop/ms688655) in the Windows SDK.  
...
### Remarks  
 See [IViewObject::Freeze](https://msdn.microsoft.com/library/windows/desktop/ms688728) in the Windows SDK.  
...
### Remarks  
 ...
 See [IViewObject::GetAdvise](https://msdn.microsoft.com/library/windows/desktop/ms692772) in the Windows SDK.  
...
### Remarks  
 See [IViewObject::GetColorSet](https://msdn.microsoft.com/library/windows/desktop/ms686553) in the Windows SDK.  
...
### Remarks  
 See [IViewObject2::GetExtent](https://msdn.microsoft.com/library/windows/desktop/ms684032) in the Windows SDK.  
...
### Remarks  
 ...
 See [IViewObjectEx::GetNaturalExtent](https://msdn.microsoft.com/library/windows/desktop/ms683718) in the Windows SDK.  
...
### Remarks  
 See [IViewObjectEx::GetRect](https://msdn.microsoft.com/library/windows/desktop/ms695246) in the Windows SDK.  
...
### Remarks  
 By default, ATL sets `pdwStatus` to indicate that the control supports VIEWSTATUS_OPAQUE (possible values are in the [VIEWSTATUS](https://msdn.microsoft.com/library/windows/desktop/ms687201) enumeration).  
  
 See [IViewObjectEx::GetViewStatus](https://msdn.microsoft.com/library/windows/desktop/ms693371) in the Windows SDK.  
  
##  <a name="queryhitpoint"></a>  IViewObjectExImpl::QueryHitPoint  
 Checks if the specified point is in the specified rectangle and returns a [HITRESULT](https://msdn.microsoft.com/library/windows/desktop/ms682187) value in `pHitResult`.  
...
### Remarks  
 ...
 If `dwAspect` equals [DVASPECT_CONTENT](https://msdn.microsoft.com/library/windows/desktop/ms690318), the method returns S_OK. Otherwise, the method returns E_FAIL.  
  
 See [IViewObjectEx::QueryHitPoint](https://msdn.microsoft.com/library/windows/desktop/ms691209) in the Windows SDK.  
  
##  <a name="queryhitrect"></a>  IViewObjectExImpl::QueryHitRect  
 Checks whether the control's display rectangle overlaps any point in the specified location rectangle and returns a [HITRESULT](https://msdn.microsoft.com/library/windows/desktop/ms682187) value in `pHitResult`.  
...
### Remarks  
 ...
 See [IViewObjectEx::QueryHitRect](https://msdn.microsoft.com/library/windows/desktop/ms693797) in the Windows SDK.  
...
### Remarks  
 ...
 The pointer to the [IAdviseSink](https://msdn.microsoft.com/library/windows/desktop/ms692513) interface on the advise sink is stored in the control class data member [CComControlBase::m_spAdviseSink](ccomcontrolbase-class.md#m_spadvisesink).  

  
 See [IViewObject::SetAdvise](https://msdn.microsoft.com/library/windows/desktop/ms683950) in the Windows SDK.  
...
### Remarks  
 See [IViewObject::Unfreeze](https://msdn.microsoft.com/library/windows/desktop/ms686641) in the Windows SDK.  
