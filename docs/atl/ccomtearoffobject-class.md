...
## Remarks  
 ...
 [!code[NVC_ATL_COM#43](../atl/codesnippet/CPP/ccomtearoffobject-class_1.h)]  
...
##  <a name="ccomtearoffobject__m_powner"></a>  CComTearOffObject::m_pOwner  
 A pointer to a [CComObject](../atl/ccomobject-class.md) object derived from *Owner*.  
...
## See Also  
 [CComCachedTearOffObject Class](../atl/ccomcachedtearoffobject-class.md)   
