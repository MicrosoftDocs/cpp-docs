...
#### Parameters  
 `ThreadModel`  
 The class whose methods implement the desired threading model. You can explicitly choose the threading model by setting `ThreadModel` to [CComSingleThreadModel](../atl/ccomsinglethreadmodel-class.md), [CComMultiThreadModel](../atl/ccommultithreadmodel-class.md), or [CComMultiThreadModelNoCS](../atl/ccommultithreadmodelnocs-class.md). You can accept the server's default thread model by setting `ThreadModel` to [CComObjectThreadModel](../Topic/CComObjectThreadModel.md) or [CComGlobalsThreadModel](../Topic/CComGlobalsThreadModel.md).  
...
## Remarks  
 ...
 A class that implements a COM server must inherit from `CComObjectRootEx` or [CComObjectRoot](../atl/ccomobjectroot-class.md).  
...
### Example  
 ...
 [!code[NVC_ATL_COM#40](../atl/codesnippet/CPP/ccomobjectrootex-class_1.h)]  
...
### Example  
 [!code[NVC_ATL_COM#41](../atl/codesnippet/CPP/ccomobjectrootex-class_2.h)]  
