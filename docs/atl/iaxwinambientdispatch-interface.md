...
## Remarks  
 This interface is exposed by ATL's ActiveX control hosting objects. Call the methods on this interface to set the ambient properties available to the hosted control or to specify other aspects of the container's behavior. To supplement the properties provided by `IAxWinAmbientDispatch`, use [IAxWinAmbientDispatchEx](../atl/iaxwinambientdispatchex-interface.md).  
...
## See Also  
 [IAxWinAmbientDispatchEx Interface](../atl/iaxwinambientdispatchex-interface.md)   
 [IAxWinHostWindow Interface](../atl/iaxwinhostwindow-interface.md)   
