...
### Remarks  
 Use the service map to implement service provider functionality on your COM object. First, you must derive your class from [IServiceProviderImpl](../atl/iserviceproviderimpl-class.md). There are two types of entries:  
...
### Example  
 [!code[NVC_ATL_COM#57](../atl/codesnippet/CPP/service-map-macros_1.h)]  
