...
---
# QueryInterface
Although there are mechanisms by which an object can express the functionality it provides statically (before it is instantiated), the fundamental COM mechanism is to use the `IUnknown` method called [QueryInterface](https://msdn.microsoft.com/library/windows/desktop/ms682521).  
...
## See Also  
 ...
 [QueryInterface: Navigating in an Object](https://msdn.microsoft.com/library/windows/desktop/ms687230)
