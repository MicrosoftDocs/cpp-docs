...
1.  Follow the steps in [Creating an ATL Project](../atl/creating-an-atl-project.md).  
  
2.  In Class View, right-click the project node, point to **Add**, and click **Add Class** from the shortcut menu. In the **Add Class** dialog box, double-click the [ATL Control Wizard](../atl/atl-control-wizard.md). In the ATL Control Wizard, click the **Options** tab and select **DHTML control**.  
