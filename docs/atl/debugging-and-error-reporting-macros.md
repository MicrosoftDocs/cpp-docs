...
|[ATLASSERT](../Topic/ATLASSERT.md)|Performs the same functionality as the [_ASSERTE](../crt/_assert--_asserte--_assert_expr-macros.md) macro found in the C run-time library.|  
...
##  <a name="atlassert"></a>  ATLASSERT  
 The `ATLASSERT` macro performs the same functionality as the [_ASSERTE](../crt/_assert--_asserte--_assert_expr-macros.md) macro found in the C run-time library.  
...
### Example  
 [!code[NVC_ATL_Utilities#108](../atl/codesnippet/CPP/debugging-and-error-reporting-macros_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#127](../atl/codesnippet/CPP/debugging-and-error-reporting-macros_2.cpp)]  
...
|**traceDumpContext**|Messages from [CDumpContext](../mfcref/cdumpcontext-class.md).|  
...
|**traceInternet**|Messages from MFC's Internet support.|  
 ...
 [!code[NVC_ATL_Utilities#109](../atl/codesnippet/CPP/debugging-and-error-reporting-macros_3.cpp)]  
 ...
 [!code[NVC_ATL_Utilities#110](../atl/codesnippet/CPP/debugging-and-error-reporting-macros_4.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#111](../atl/codesnippet/CPP/debugging-and-error-reporting-macros_5.cpp)]  
  
## See Also  
 [Macros](../atl/atl-macros.md)   
 [Debugging and Error Reporting Global Functions](../atl/debugging-and-error-reporting-global-functions.md)
