...
### Remarks  
 ...
 [!code[NVC_ATL_Windowing#42](../atl/codesnippet/CPP/caxwindow-class_1.cpp)]  
...
##  <a name="caxwindow__setexternaluihandler"></a>  CAxWindow::SetExternalUIHandler  
 Sets the external [IDocHostUIHandlerDispatch](../atl/idochostuihandlerdispatch-interface.md) interface for the `CAxWindow` object.  
...
## See Also  
 [ATLCON Sample](../top/visual-c---samples.md)   
