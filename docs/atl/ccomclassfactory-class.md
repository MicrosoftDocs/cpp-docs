...
## Remarks  
 ...
 [!code[NVC_ATL_COM#8](../atl/codesnippet/CPP/ccomclassfactory-class_1.h)]  
...
- [DECLARE_CLASSFACTORY2](../Topic/DECLARE_CLASSFACTORY2.md) Uses [CComClassFactory2](../atl/ccomclassfactory2-class.md), which controls creation through a license.  
  
- [DECLARE_CLASSFACTORY_AUTO_THREAD](../Topic/DECLARE_CLASSFACTORY_AUTO_THREAD.md) Uses [CComClassFactoryAutoThread](../atl/ccomclassfactoryautothread-class.md), which creates objects in multiple apartments.  
  
- [DECLARE_CLASSFACTORY_SINGLETON](../Topic/DECLARE_CLASSFACTORY_SINGLETON.md) Uses [CComClassFactorySingleton](../atl/ccomclassfactorysingleton-class.md), which constructs a single [CComObjectGlobal](../atl/ccomobjectglobal-class.md) object.  
...
### Remarks  
 **_Module** refers to the global instance of [CComModule](../atl/ccommodule-class.md) or a class derived from it.  
