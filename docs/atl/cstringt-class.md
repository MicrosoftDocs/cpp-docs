...
## Remarks  
 `CStringT` inherits from [CSimpleStringT Class](../atl/csimplestringt-class.md). Advanced features, such as character manipulation, ordering, and searching, are implemented by `CStringT`.  
...
-   Custom memory management for string buffers. For more information, see [Memory Management and CStringT](../atl/memory-management-with-cstringt.md).  
  
## CStringT Predefined Types  
 Because `CStringT` uses a template argument to define the character type (either [wchar_t](../crt/standard-types.md) or [char](../crt/standard-types.md)) supported, method parameter types can be complicated at times. To simplify this issue, a set of predefined types is defined and used throughout the `CStringT` class. The following table lists the various types:  
...
## Inheritance Hierarchy  
 [CSimpleStringT](../atl/csimplestringt-class.md)  
...
### Remarks  
 In MFC programs, a [CMemoryException Class](../mfcref/cmemoryexception-class.md) is thrown if insufficient memory exists. In ATL programs, a [CAtlException](../atl/catlexception-class.md) is thrown. This function is normally used to return strings for Automation.  
  
 Commonly, if this string is passed to a COM function as an [in] parameter, then this requires the caller to free the string. This can be done by using [SysFreeString](assetId:///8f230ee3-5f6e-4cb9-a910-9c90b754dcd3), as described in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)]. For more information, see [Allocating and Releasing Memory for a BSTR](../atl/allocating-and-releasing-memory-for-a-bstr.md).  
  
 For more information about OLE allocation functions in Windows, see [SysAllocString](assetId:///9e0437a2-9b4a-4576-88b0-5cb9d08ca29b) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
  
### Example  
 The following example demonstrates the use of `CStringT::AllocSysString`.  
  
 [!code[NVC_ATLMFC_Utilities#105](../atl/codesnippet/CPP/cstringt-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#106](../atl/codesnippet/CPP/cstringt-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#107](../atl/codesnippet/CPP/cstringt-class_3.cpp)]  
...
### Remarks  
 The generic-text function `_tcscoll`, which is defined in TCHAR.H, maps to either `strcoll`, `wcscoll`, or `_mbscoll`, depending on the character set that is defined at compile time. Each function performs a case-sensitive comparison of the strings according to the code page currently in use. For more information, see [strcoll, wcscoll, _mbscoll, _strcoll_l, _wcscoll_l, _mbscoll_l](../crt/strcoll--wcscoll--_mbscoll--_strcoll_l--_wcscoll_l--_mbscoll_l.md).  
...
### Remarks  
 The generic-text function `_tcscoll`, which is defined in TCHAR.H, maps to either `stricoll`, `wcsicoll`, or `_mbsicoll`, depending on the character set that is defined at compile time. Each function performs a case-insensitive comparison of the strings, according to the code page currently in use. For more information, see [strcoll, wcscoll, _mbscoll, _strcoll_l, _wcscoll_l, _mbscoll_l](../crt/strcoll--wcscoll--_mbscoll--_strcoll_l--_wcscoll_l--_mbscoll_l.md).  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#109](../atl/codesnippet/CPP/cstringt-class_4.cpp)]  
...
### Remarks  
 The generic-text function `_tcscmp`, which is defined in TCHAR.H, maps to either `strcmp`, `wcscmp`, or `_mbscmp`, depending on the character set that is defined at compile time. Each function performs a case-sensitive comparison of the strings and is not affected by locale. For more information, see [strcmp, wcscmp, _mbscmp](../crt/strcmp--wcscmp--_mbscmp.md).  
...
### Example  
 ...
 [!code[NVC_ATLMFC_Utilities#110](../atl/codesnippet/CPP/cstringt-class_5.cpp)]  
...
CSTRING_EXPLICIT CStringT(char ch,
    int nLength = 1) :
    CThisSimpleString(StringTraits::GetDefaultManager());

CSTRING_EXPLICIT CStringT(wchar_t ch,
    int nLength = 1) :
    CThisSimpleString(StringTraits::GetDefaultManager());

CStringT(const XCHAR* pch,
    int nLength) :
    CThisSimpleString(pch,
    nLength,
     StringTraits::GetDefaultManager());

CStringT(const YCHAR* pch,
    int nLength) :
    CThisSimpleString(StringTraits::GetDefaultManager());
...
### Parameters  
 ...
 `pStringMgr`  
 A pointer to the memory manager for the `CStringT` object. For more information on `IAtlStringMgr` and memory management for `CStringT`, see [Memory Management with CStringT](../atl/memory-management-with-cstringt.md).  
...
> [!NOTE]
>  Define the **_CSTRING_DISABLE_NARROW_WIDE_CONVERSION** macro to turn off implicit string conversion between [!INCLUDE[vcpransi](../atl/includes/vcpransi_md.md)] and [!INCLUDE[TLA#tla_unicode](../atl/includes/tlasharptla_unicode_md.md)] strings. The macro excludes from compilation constructors that support conversion.  
  
 Note that the `strSrc` parameter can be either a `CStringT` or `CThisSimpleString` object. For `CStringT`, use one of its default instantiations ( `CString`, `CStringA`, or `CStringW`); for `CThisSimpleString`, use a `this` pointer. `CThisSimpleString` declares an instance of the [CSimpleStringT Class](../atl/csimplestringt-class.md), which is a smaller string class with less built-in functionality than the `CStringT` class.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#112](../atl/codesnippet/CPP/cstringt-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#113](../atl/codesnippet/CPP/cstringt-class_8.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#114](../atl/codesnippet/CPP/cstringt-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#115](../atl/codesnippet/CPP/cstringt-class_10.cpp)]  
  
##  <a name="cstringt__format"></a>  CStringT::Format  
 Writes formatted data to a `CStringT` in the same way that [sprintf_s](../crt/sprintf_s--_sprintf_s_l--swprintf_s--_swprintf_s_l.md) formats data into a C-style character array.  
...
### Remarks  
 ...
 [!code[NVC_ATLMFC_Utilities#116](../atl/codesnippet/CPP/cstringt-class_11.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#117](../atl/codesnippet/CPP/cstringt-class_12.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#118](../atl/codesnippet/CPP/cstringt-class_13.cpp)]  
  
##  <a name="cstringt__formatmessagev"></a>  CStringT::FormatMessageV  
 Formats a message string using a variable argument list.  
  
```
void FormatMessageV(PCXSTR pszFormat,
    va_list*  pArgList);
```  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#119](../atl/codesnippet/CPP/cstringt-class_14.cpp)]  
  
 [!code[NVC_ATLMFC_Utilities#120](../atl/codesnippet/CPP/cstringt-class_15.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#122](../atl/codesnippet/CPP/cstringt-class_17.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#123](../atl/codesnippet/CPP/cstringt-class_18.cpp)]  
...
```
BOOL LoadString(HINSTANCE hInstance,
    UINT nID,
    WORD wLanguageID);
...
### Example  
 [!code[NVC_ATLMFC_Utilities#124](../atl/codesnippet/CPP/cstringt-class_19.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#125](../atl/codesnippet/CPP/cstringt-class_20.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#126](../atl/codesnippet/CPP/cstringt-class_21.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#127](../atl/codesnippet/CPP/cstringt-class_22.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#128](../atl/codesnippet/CPP/cstringt-class_23.cpp)]  
...
```
friend CStringT operator+(const CStringT& str1,
    const CStringT& str2);
...
### Example  
 [!code[NVC_ATLMFC_Utilities#140](../atl/codesnippet/CPP/cstringt-class_24.cpp)]  
...
template<bool bMFCDLL>
CStringT&  operator+=(const const CSimpleStringT<BaseType,
    bMFCDLL>& str);

template<int t_nSize>
CStringT&  operator+=(const CStaticString<XCHAR,
    t_nSize>& strSrc);
...
### Example  
 [!code[NVC_ATLMFC_Utilities#141](../atl/codesnippet/CPP/cstringt-class_25.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#142](../atl/codesnippet/CPP/cstringt-class_26.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#143](../atl/codesnippet/CPP/cstringt-class_27.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#144](../atl/codesnippet/CPP/cstringt-class_28.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#145](../atl/codesnippet/CPP/cstringt-class_29.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#146](../atl/codesnippet/CPP/cstringt-class_30.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#147](../atl/codesnippet/CPP/cstringt-class_31.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#129](../atl/codesnippet/CPP/cstringt-class_32.cpp)]  
...
```
int Replace(PCXSTR pszOld,
    PCXSTR pszNew);

int Replace(XCHAR chOld,
    XCHAR chNew);
```  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#200](../atl/codesnippet/CPP/cstringt-class_33.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#130](../atl/codesnippet/CPP/cstringt-class_34.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#131](../atl/codesnippet/CPP/cstringt-class_35.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#132](../atl/codesnippet/CPP/cstringt-class_36.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#133](../atl/codesnippet/CPP/cstringt-class_37.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#134](../atl/codesnippet/CPP/cstringt-class_38.cpp)]  
  
##  <a name="cstringt__tokenize"></a>  CStringT::Tokenize  
 Finds the next token in a target string  
  
```
CStringT Tokenize(PCXSTR pszTokens,
    int&  iStart) const;
```  
...
### Remarks  
 ...
 Unlike the CRT tokenize functions like [strtok_s, _strtok_s_l, wcstok_s, _wcstok_s_l, _mbstok_s, _mbstok_s_l](../crt/strtok_s--_strtok_s_l--wcstok_s--_wcstok_s_l--_mbstok_s--_mbstok_s_l.md), `Tokenize` does not modify the target string.  
  
### Example  
 [!code[NVC_ATLMFC_Utilities#135](../atl/codesnippet/CPP/cstringt-class_39.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#136](../atl/codesnippet/CPP/cstringt-class_40.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#137](../atl/codesnippet/CPP/cstringt-class_41.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#138](../atl/codesnippet/CPP/cstringt-class_42.cpp)]  
  
## See Also  
 [Hierarchy Chart](../mfc/hierarchy-chart.md)   
 [ATL/MFC Shared Classes](../atl/atl-mfc-shared-classes.md)   
 [CSimpleStringT Class](../atl/csimplestringt-class.md)
