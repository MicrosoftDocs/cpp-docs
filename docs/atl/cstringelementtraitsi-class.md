...
---
# CStringElementTraitsI Class
This class provides static functions related to strings stored in collection class objects. It is similar to [CStringElementTraits](../atl/cstringelementtraits-class.md), but performs case-insensitive comparisons.  
...
## See Also  
 ...
 [CStringElementTraits Class](../atl/cstringelementtraits-class.md)
