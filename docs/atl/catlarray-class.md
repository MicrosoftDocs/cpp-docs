 ...
 **CAtlArray** provides methods for creating and managing an array of elements of a user-defined type. Although similar to standard C arrays, the **CAtlArray** object can dynamically shrink and grow as necessary. The array index always starts at position 0, and the upper bound can be fixed, or allowed to expand as new elements are added.  
 ...
 For arrays with a small number of elements, the ATL class [CSimpleArray](../atl/csimplearray-class.md) can be used.  
...
### Example  
 [!code[NVC_ATL_Utilities#1](../atl/codesnippet/CPP/catlarray-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#2](../atl/codesnippet/CPP/catlarray-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#3](../atl/codesnippet/CPP/catlarray-class_3.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#4](../atl/codesnippet/CPP/catlarray-class_4.cpp)]  
...
> [!NOTE]
> `CAtlArray::Copy` does not support arrays consisting of elements created with the [CAutoPtr](../atl/cautoptr-class.md) class.  
  
### Example  
 [!code[NVC_ATL_Utilities#5](../atl/codesnippet/CPP/catlarray-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#6](../atl/codesnippet/CPP/catlarray-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#7](../atl/codesnippet/CPP/catlarray-class_7.cpp)]  
...
> [!NOTE]
> `CAtlArray::InsertArrayAt` does not support arrays consisting of elements created with the [CAutoPtr](../atl/cautoptr-class.md) class.  
  
### Example  
 [!code[NVC_ATL_Utilities#8](../atl/codesnippet/CPP/catlarray-class_8.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#9](../atl/codesnippet/CPP/catlarray-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#10](../atl/codesnippet/CPP/catlarray-class_10.cpp)]  
...
### Remarks  
 Performs a similar function to [CAtlArray::GetAt](../Topic/CAtlArray::GetAt.md). Unlike the MFC class [CArray](../mfcref/carray-class.md), this operator cannot be used as a substitute for [CAtlArray::SetAt](../Topic/CAtlArray::SetAt.md).  
...
### Example  
 [!code[NVC_ATL_Utilities#11](../atl/codesnippet/CPP/catlarray-class_11.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#12](../atl/codesnippet/CPP/catlarray-class_12.cpp)]  
