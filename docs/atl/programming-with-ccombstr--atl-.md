...
The ATL class [CComBSTR](../atl/ccombstr-class.md) provides a wrapper around the `BSTR` data type. While `CComBSTR` is a useful tool, there are several situations that require caution.  
...
### Example  
 [!code[NVC_ATL_Utilities#114](../atl/codesnippet/CPP/programming-with-ccombstr--atl-_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#115](../atl/codesnippet/CPP/programming-with-ccombstr--atl-_2.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#116](../atl/codesnippet/CPP/programming-with-ccombstr--atl-_3.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#117](../atl/codesnippet/CPP/programming-with-ccombstr--atl-_4.cpp)]  
...
### Example  
 [!code[NVC_ATL_Utilities#118](../atl/codesnippet/CPP/programming-with-ccombstr--atl-_5.cpp)]  
...
##  <a name="programmingwithccombstr_memoryleaks"></a> Memory Leak Issues  
 ...
 [!code[NVC_ATL_Utilities#119](../atl/codesnippet/CPP/programming-with-ccombstr--atl-_6.cpp)]  
...
## See Also  
 ...
 [String Conversion Macros](../atl/string-conversion-macros.md)