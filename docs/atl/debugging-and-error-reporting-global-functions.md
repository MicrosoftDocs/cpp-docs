...
|[AtlTraceLoadSettings](../notintoc/atltraceloadsettings.md)|Call this function to load trace settings from a file.|  
|[AtlTraceSaveSettings](../notintoc/atltracesavesettings.md)|Call this function to save the current trace settings to a file.|  
...
### Parameters  
 ...
 `hInst`  
 [in] The handle to the resource. By default, this parameter is **__AtlBaseModuleModule::GetResourceInstance**, where **__AtlBaseModuleModule** is the global instance of [CAtlBaseModule](../atl/catlbasemodule-class.md) or a class derived from it.  
...
### Example  
 [!code[NVC_ATL_COM#52](../atl/codesnippet/CPP/debugging-and-error-reporting-global-functions_1.cpp)]  
...
### Remarks  
 ...
 If **_ATL_NO_EXCEPTIONS** is not defined in an MFC project, this function throws a [CMemoryException](../mfcref/cmemoryexception-class.md) or a [COleException](../mfcref/coleexception-class.md) based on the value of the HRESULT.  
  
 If **_ATL_NO_EXCEPTIONS** is not defined in an ATL project, the function throws a [CAtlException](../atl/catlexception-class.md).  
...
### Example  
 [!code[NVC_ATL_Windowing#95](../atl/codesnippet/CPP/debugging-and-error-reporting-global-functions_2.h)]  
...
### Remarks  
 ...
 If **_ATL_NO_EXCEPTIONS** is not defined in an MFC project, this function throws a [CMemoryException](../mfcref/cmemoryexception-class.md) or a [COleException](../mfcref/coleexception-class.md) based on the value returned by `GetLastError`.  
...
## See Also  
 ...
 [Debugging and Error Reporting Macros](../atl/debugging-and-error-reporting-macros.md)
