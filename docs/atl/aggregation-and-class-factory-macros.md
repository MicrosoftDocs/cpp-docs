...
|||  
|-|-|  
|[DECLARE_AGGREGATABLE](../Topic/DECLARE_AGGREGATABLE.md)|Declares that your object can be aggregated (the default).|  
|[DECLARE_CLASSFACTORY](../Topic/DECLARE_CLASSFACTORY.md)|Declares the class factory to be [CComClassFactory](../atl/ccomclassfactory-class.md), the ATL default class factory.|  
|[DECLARE_CLASSFACTORY_EX](../Topic/DECLARE_CLASSFACTORY_EX.md)|Declares your class factory object to be the class factory.|  
|[DECLARE_CLASSFACTORY2](../Topic/DECLARE_CLASSFACTORY2.md)|Declares [CComClassFactory2](../atl/ccomclassfactory2-class.md) to be the class factory.|  
|[DECLARE_CLASSFACTORY_AUTO_THREAD](../Topic/DECLARE_CLASSFACTORY_AUTO_THREAD.md)|Declares [CComClassFactoryAutoThread](../atl/ccomclassfactoryautothread-class.md) to be the class factory.|  
|[DECLARE_CLASSFACTORY_SINGLETON](../Topic/DECLARE_CLASSFACTORY_SINGLETON.md)|Declares [CComClassFactorySingleton](../atl/ccomclassfactorysingleton-class.md) to be the class factory.|  
|[DECLARE_GET_CONTROLLING_UNKNOWN](../Topic/DECLARE_GET_CONTROLLING_UNKNOWN.md)|Declares a virtual `GetControllingUnknown` function.|  
|[DECLARE_NOT_AGGREGATABLE](../Topic/DECLARE_NOT_AGGREGATABLE.md)|Declares that your object cannot be aggregated.|  
|[DECLARE_ONLY_AGGREGATABLE](../Topic/DECLARE_ONLY_AGGREGATABLE.md)|Declares that your object must be aggregated.|  
|[DECLARE_POLY_AGGREGATABLE](../Topic/DECLARE_POLY_AGGREGATABLE.md)|Checks the value of the outer unknown and declares your object aggregatable or not aggregatable, as appropriate.|  
|[DECLARE_PROTECT_FINAL_CONSTRUCT](../Topic/DECLARE_PROTECT_FINAL_CONSTRUCT.md)|Protects the outer object from deletion during construction of an inner object.|  
|[DECLARE_VIEW_STATUS](../Topic/DECLARE_VIEW_STATUS.md)|Specifies the **VIEWSTATUS** flags to the container.|  
...
### Remarks  
 [CComCoClass](../atl/ccomcoclass-class.md) contains this macro to specify the default aggregation model. To override this default, specify either the [DECLARE_NOT_AGGREGATABLE](../Topic/DECLARE_NOT_AGGREGATABLE.md) or [DECLARE_ONLY_AGGREGATABLE](../Topic/DECLARE_ONLY_AGGREGATABLE.md) macro in your class definition.  
  
### Example  
 [!code[NVC_ATL_Windowing#121](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_1.h)]  
  
##  <a name="declare_classfactory"></a>  DECLARE_CLASSFACTORY  
 Declares [CComClassFactory](../atl/ccomclassfactory-class.md) to be the class factory.  
...
### Remarks  
 [CComCoClass](../atl/ccomcoclass-class.md) uses this macro to declare the default class factory for your object.  
  
### Example  
 [!code[NVC_ATL_COM#55](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_2.h)]  
...
### Remarks  
 ...
 [!code[NVC_ATL_COM#8](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_3.h)]  
...
- [DECLARE_CLASSFACTORY2](../Topic/DECLARE_CLASSFACTORY2.md)Â Â Â Uses [CComClassFactory2](../atl/ccomclassfactory2-class.md), which controls creation through a license.  
  
- [DECLARE_CLASSFACTORY_AUTO_THREAD](../Topic/DECLARE_CLASSFACTORY_AUTO_THREAD.md)Â Â Â Uses [CComClassFactoryAutoThread](../atl/ccomclassfactoryautothread-class.md), which creates objects in multiple apartments.  
  
- [DECLARE_CLASSFACTORY_SINGLETON](../Topic/DECLARE_CLASSFACTORY_SINGLETON.md)Â Â Â Uses [CComClassFactorySingleton](../atl/ccomclassfactorysingleton-class.md), which constructs a single [CComObjectGlobal](../atl/ccomobjectglobal-class.md) object.  
...
### Remarks  
 The `cf` parameter must derive from [CComClassFactory](../atl/ccomclassfactory-class.md) and override the `CreateInstance` method.  
  
 [CComCoClass](../atl/ccomcoclass-class.md) includes the [DECLARE_CLASSFACTORY](../Topic/DECLARE_CLASSFACTORY.md) macro, which specifies `CComClassFactory` as the default class factory. However, by including the `DECLARE_CLASSFACTORY_EX` macro in your object's class definition, you override this default.  
  
### Example  
 [!code[NVC_ATL_COM#8](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_3.h)]  
  
##  <a name="declare_classfactory2"></a>  DECLARE_CLASSFACTORY2  
 Declares [CComClassFactory2](../atl/ccomclassfactory2-class.md) to be the class factory.  
...
### Remarks  
 [CComCoClass](../atl/ccomcoclass-class.md) includes the [DECLARE_CLASSFACTORY](../Topic/DECLARE_CLASSFACTORY.md) macro, which specifies [CComClassFactory](../atl/ccomclassfactory-class.md) as the default class factory. However, by including the `DECLARE_CLASSFACTORY2` macro in your object's class definition, you override this default.  
  
### Example  
 [!code[NVC_ATL_COM#2](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_4.h)]  
 ...
 **CMyLicense**, the template parameter to `CComClassFactory2`, must implement the static functions `VerifyLicenseKey`, `GetLicenseKey`, and `IsLicenseValid`. The following is an example of a simple license class:  
 ...
 [!code[NVC_ATL_COM#3](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_5.h)]  
...
##  <a name="declare_classfactory_auto_thread"></a>  DECLARE_CLASSFACTORY_AUTO_THREAD  
 Declares [CComClassFactoryAutoThread](../atl/ccomclassfactoryautothread-class.md) to be the class factory.  
...
### Remarks  
 [CComCoClass](../atl/ccomcoclass-class.md) includes the [DECLARE_CLASSFACTORY](../Topic/DECLARE_CLASSFACTORY.md) macro, which specifies [CComClassFactory](../atl/ccomclassfactory-class.md) as the default class factory. However, by including the `DECLARE_CLASSFACTORY_AUTO_THREAD` macro in your object's class definition, you override this default.  
...
### Example  
 [!code[NVC_ATL_COM#9](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_6.h)]  
...
##  <a name="declare_classfactory_singleton"></a>  DECLARE_CLASSFACTORY_SINGLETON  
 Declares [CComClassFactorySingleton](../atl/ccomclassfactorysingleton-class.md) to be the class factory.  
...
### Remarks  
 [CComCoClass](../atl/ccomcoclass-class.md) includes the [DECLARE_CLASSFACTORY](../Topic/DECLARE_CLASSFACTORY.md) macro, which specifies [CComClassFactory](../atl/ccomclassfactory-class.md) as the default class factory. However, by including the `DECLARE_CLASSFACTORY_SINGLETON` macro in your object's class definition, you override this default.  
  
### Example  
 [!code[NVC_ATL_COM#10](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_7.h)]  
...
### Remarks  
 ...
 By default, [CComCoClass](../atl/ccomcoclass-class.md) contains the [DECLARE_AGGREGATABLE](../Topic/DECLARE_AGGREGATABLE.md) macro, which specifies that your object can be aggregated. To override this default behavior, include `DECLARE_NOT_AGGREGATABLE` in your class definition.  
...
### Remarks  
 ...
 By default, [CComCoClass](../atl/ccomcoclass-class.md) contains the [DECLARE_AGGREGATABLE](../Topic/DECLARE_AGGREGATABLE.md) macro, which specifies that your object can be aggregated. To override this default behavior, include `DECLARE_ONLY_AGGREGATABLE` in your class definition.  
  
### Example  
 [!code[NVC_ATL_Windowing#125](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_8.h)]  
...
### Example  
 [!code[NVC_ATL_Windowing#126](../atl/codesnippet/CPP/aggregation-and-class-factory-macros_9.h)]  
