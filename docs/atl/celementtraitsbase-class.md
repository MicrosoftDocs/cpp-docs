...
## Remarks  
 This base class defines methods for copying and relocating elements in a collection class. It is utilized by the classes [CDefaultElementTraits](../atl/cdefaultelementtraits-class.md), [CStringRefElementTraits](../atl/cstringrefelementtraits-class.md), and [CStringElementTraitsI](../atl/cstringelementtraitsi-class.md).  
...
### Remarks  
 This method calls [memmove](../crt/memmove--wmemmove.md), which is sufficient for most data types. If the objects being moved contain pointers to their own members, this method will need to be overridden.  
