 ...
 **Attributed**  
 ...
 See [Application Settings, ATL Project Wizard](../atl/application-settings--atl-project-wizard.md) and [Basic Mechanics of Attributes](../windows/basic-mechanics-of-attributes.md) for more information.  
