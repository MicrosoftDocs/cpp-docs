...
|Name|Description|  
|----------|-----------------|  
|[CComVariant::CComVariant](../Topic/CComVariant::CComVariant.md)|The constructor.|  
|[CComVariant::~CComVariant](../Topic/CComVariant::~CComVariant.md)|The destructor.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[CComVariant::Attach](../Topic/CComVariant::Attach.md)|Attaches a **VARIANT** to the `CComVariant` object.|  
|[CComVariant::ChangeType](../Topic/CComVariant::ChangeType.md)|Converts the `CComVariant` object to a new type.|  
|[CComVariant::Clear](../Topic/CComVariant::Clear.md)|Clears the `CComVariant` object.|  
|[CComVariant::Copy](../Topic/CComVariant::Copy.md)|Copies a **VARIANT** to the `CComVariant` object.|  
|[CComVariant::CopyTo](../Topic/CComVariant::CopyTo.md)|Copies the contents of the `CComVariant` object.|  
|[CComVariant::Detach](../Topic/CComVariant::Detach.md)|Detaches the underlying **VARIANT** from the `CComVariant` object.|  
|[CComVariant::GetSize](../Topic/CComVariant::GetSize.md)|Returns the size in number of bytes of the contents of the `CComVariant` object.|  
|[CComVariant::ReadFromStream](../Topic/CComVariant::ReadFromStream.md)|Loads a **VARIANT** from a stream.|  
|[CComVariant::SetByRef](../Topic/CComVariant::SetByRef.md)|Initializes the `CComVariant` object and sets the **vt** member to **VT_BYREF**.|  
|[CComVariant::WriteToStream](../Topic/CComVariant::WriteToStream.md)|Saves the underlying **VARIANT** to a stream.|  
  
### Public Operators  
  
|||  
|-|-|  
|[CComVariant::operator <](../Topic/CComVariant::operator%20%3C.md)|Indicates whether the `CComVariant` object is less than the specified **VARIANT**.|  
|[CComVariant::operator >](../Topic/CComVariant::operator%20%3E.md)|Indicates whether the `CComVariant` object is greater than the specified **VARIANT**.|  
|[operator !=](../Topic/CComVariant::operator%20!=.md)|Indicates whether the `CComVariant` object does not equal the specified **VARIANT**.|  
|[operator =](../Topic/CComVariant::operator%20=.md)|Assigns a value to the `CComVariant` object.|  
|[operator ==](../Topic/CComVariant::operator%20==.md)|Indicates whether the `CComVariant` object equals the specified **VARIANT**.|  
...
CComVariant() throw();
    ...
    CComVariant(
     int  nSrc,
    VARTYPE   vtSrc = VT_I4) throw();

    CComVariant(
     unsigned int  nSrc,
    VARTYPE   vtSrc = VT_UI4) throw();

    CComVariant(
     short  nSrc) throw();

    CComVariant(
     unsigned short  nSrc) throw();
    ...
    CComVariant(
     unsigned long  nSrc) throw();

    CComVariant(
     LONGLONG  nSrc) throw();

    CComVariant(
     ULONGLONG  nSrc) throw();
    ...
    CComVariant(
     double  dblSrc,
    VARTYPE   vtSrc = VT_R8) throw();

    CComVariant(
     CY  cySrc) throw();

    CComVariant(
     IDispatch*  pSrc) throw();
...
### Remarks  
 The destructor manages cleanup by calling [CComVariant::Clear](../Topic/CComVariant::Clear.md).  
...
### Remarks  
 This method manages cleanup by calling [CComVariant::Clear](../Topic/CComVariant::Clear.md).  
...
### Remarks  
 ...
 The size returned by this method matches the number of bytes used by [CComVariant::WriteToStream](../Topic/CComVariant::WriteToStream.md) under successful conditions.  
...
### Remarks  
 **ReadToStream** requires a previous call to [WriteToStream](../Topic/CComVariant::WriteToStream.md).  
...
### Remarks  
 ...
 [!code[NVC_ATL_Utilities#76](../atl/codesnippet/CPP/ccomvariant-class_1.cpp)]  
