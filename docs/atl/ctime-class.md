...
|[CTime::GetAsDBTIMESTAMP](#ctime__getasdbtimestamp)|Converts the time information stored in the                                         `CTime` object to a Win32-compatible                                         \<xref:System.Data.OleDb.OleDbType> structure.|  
...
## Remarks  
 ...
 `CTime` values are based on coordinated universal time (UTC), which is equivalent to Coordinated Universal time (Greenwich Mean Time, GMT). See  [Time Management](../crt/time-management.md) for information about how the time zone is determined.  
  
 When you create a                 `CTime` object, set the                 `nDST` parameter to 0 to indicate that standard time is in effect, or to a value larger than 0 to indicate that daylight saving time is in effect, or to a value less than zero to have the C run-time library code compute whether standard time or daylight saving time is in effect.                 `tm_isdst` is a required field. If not set, its value is undefined and the return value from  [mktime](../crt/mktime--_mktime32--_mktime64.md) is unpredictable. If                 `timeptr` points to a tm structure returned by a previous call to  [asctime_s](../crt/asctime_s--_wasctime_s.md),  [_gmtime_s](../crt/gmtime_s--_gmtime32_s--_gmtime64_s.md), or  [localtime_s](../crt/localtime_s--_localtime32_s--_localtime64_s.md), the                 `tm_isdst` field contains the correct value.  
  
 A companion class,  [CTimeSpan](../atl/ctimespan-class.md), represents a time interval.  
...
>  The upper date limit is 12/31/3000. The lower limit is 1/1/1970 12:00:00 AM GMT.  
 ...
 For more information about using                 `CTime`, see the articles  [Date and Time](../atl/date-and-time.md), and  [Time Management](../crt/time-management.md) in the Run-Time Library Reference.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#161](../atl/codesnippet/CPP/ctime-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#149](../atl/codesnippet/CPP/ctime-class_3.cpp)]  
...
### Parameters  
 `pszFormat`  
 Specifies a formatting string similar to the                                 `printf` formatting string. See the run-time function  [strftime](../crt/strftime--wcsftime--_strftime_l--_wcsftime_l.md) for details.  
...
##  <a name="ctime__getasdbtimestamp"></a>  CTime::GetAsDBTIMESTAMP  
 Call this member function to convert the time information stored in the                 `CTime` object to a Win32–compatible                 \<xref:System.Data.OleDb.OleDbType> structure.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#150](../atl/codesnippet/CPP/ctime-class_4.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#151](../atl/codesnippet/CPP/ctime-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#152](../atl/codesnippet/CPP/ctime-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#153](../atl/codesnippet/CPP/ctime-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#154](../atl/codesnippet/CPP/ctime-class_8.cpp)]  
...
### Return Value  
 A pointer to a filled-in                         **struct tm** as defined in the include file TIME.H. See  [gmtime, _gmtime32, _gmtime64](../crt/gmtime--_gmtime32--_gmtime64.md) for the structure layout.  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#155](../atl/codesnippet/CPP/ctime-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#156](../atl/codesnippet/CPP/ctime-class_10.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#157](../atl/codesnippet/CPP/ctime-class_11.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#158](../atl/codesnippet/CPP/ctime-class_12.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#159](../atl/codesnippet/CPP/ctime-class_13.cpp)]  
...
### Example  
 [!code[NVC_ATLMFC_Utilities#160](../atl/codesnippet/CPP/ctime-class_14.cpp)]  
...
## See Also  
 ...
 [_ftime_s, _ftime32_s, _ftime64_s](../crt/_ftime_s--_ftime32_s--_ftime64_s.md)   
