...
## Remarks  
 `CAtlDllModuleT` represents the module for a dynamic-link library (DLL) and provides functions used by all DLL projects. This specialization of [CAtlModuleT](../atl/catlmodulet-class.md) class includes support for registration.  
...
## See Also  
 [CAtlModuleT Class](../atl/catlmodulet-class.md)   
