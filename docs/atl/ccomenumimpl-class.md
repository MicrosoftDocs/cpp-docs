...
template <class Base,
    const IID* piid,
    class T,
    class Copy>  class ATL_NO_VTABLE CComEnumImpl :   public Base
```  
...
>  For details on further differences between `CComEnumImpl` and `IEnumOnSTLImpl`, see [CComEnumImpl::Init](../Topic/CComEnumImpl::Init.md).  
 ...
 Typically, you will *not* need to create your own enumerator class by deriving from this interface implementation. If you want to use an ATL-supplied enumerator based on an array, it is more common to create an instance of [CComEnum](../atl/ccomenum-class.md).  
...
## See Also  
 [IEnumOnSTLImpl Class](../atl/ienumonstlimpl-class.md)   
 [CComEnum Class](../atl/ccomenum-class.md)   
