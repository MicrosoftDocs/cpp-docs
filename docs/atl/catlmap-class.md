...
## Remarks  
 ...
 When a small number of elements need to be stored, consider using the [CSimpleMap](../atl/csimplemap-class.md) class instead.  
...
### Example  
 [!code[NVC_ATL_Utilities#72](../atl/codesnippet/CPP/catlmap-class_1.cpp)]  
