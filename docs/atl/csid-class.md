...
### Remarks  
 ...
 If initialization fails, the constructor will throw a [CAtlException Class](../atl/catlexception-class.md).  
...
##  <a name="csid__csidarray"></a>  CSid::CSidArray  
 An array of [CSid](../atl/csid-class.md) objects.  
...
## See Also  
 ...
 [Operators](../atl/atl-operators.md)
