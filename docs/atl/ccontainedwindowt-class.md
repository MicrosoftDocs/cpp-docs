...
>  For any given `CContainedWindowT` object, call either **Create** or `SubclassWindow`. You should not invoke both methods on the same object.  
 ...
 [!code[NVC_ATL_Windowing#38](../atl/codesnippet/CPP/ccontainedwindowt-class_1.h)]  
  
 [!code[NVC_ATL_Windowing#39](../atl/codesnippet/CPP/ccontainedwindowt-class_2.h)]  
  
 [!code[NVC_ATL_Windowing#40](../atl/codesnippet/CPP/ccontainedwindowt-class_3.h)]  
...
### Parameters  
 ...
 `pObject`  
 [in] A pointer to the containing object that declares the message map. This object's class must derive from [CMessageMap](../atl/cmessagemap-class.md).  
...
### Remarks  
 If you want to create a new window through [Create](../Topic/CContainedWindowT::Create.md), you must pass the name of an existing window class for the `lpszClassName` parameter. For an example, see the [CContainedWindow](../atl/ccontainedwindowt-class.md) overview.  
...
### Remarks  
 ...
 `m_dwMsgMapID` is first initialized by the constructor and can be changed by calling [SwitchMessageMap](../Topic/CContainedWindowT::SwitchMessageMap.md). For an example, see the [CContainedWindowT Overview](../atl/ccontainedwindowt-class.md).  
...
### Remarks  
 ...
 `m_lpszClassName` is initialized by the constructor. For an example, see the [CContainedWindowT](../atl/ccontainedwindowt-class.md) overview.  
...
### Remarks  
 This container, whose class must derive from [CMessageMap](../atl/cmessagemap-class.md), declares the message map used by the contained window.  
  
 `m_pObject` is initialized by the constructor. For an example, see the [CContainedWindowT](../atl/ccontainedwindowt-class.md) overview.  
...
## See Also  
 [CWindow Class](../atl/cwindow-class.md)   
 [CWindowImpl Class](../atl/cwindowimpl-class.md)   
 [CMessageMap Class](../atl/cmessagemap-class.md)   
