...
## Remarks  
 ...
 This interface is exposed by ATL's ActiveX control hosting objects. Derived from [IAxWinAmbientDispatch](../atl/iaxwinambientdispatch-interface.md), `IAxWinAmbientDispatchEx` adds a method that allows you to supplement the ambient property interface provided by ATL with one of your own.  
...
### Remarks  
 When `SetAmbientDispatch` is called with a pointer to a new interface, this new interface will be used to invoke any properties or methods asked for by the hosted control â€” if those properties are not already provided by [IAxWinAmbientDispatch](../atl/iaxwinambientdispatch-interface.md).  
  
## See Also  
 [IAxWinAmbientDispatch Interface](../atl/iaxwinambientdispatch-interface.md)
