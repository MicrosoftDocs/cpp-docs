...
|[RequestType](#workerarchetype__requesttype)|A typedef for the type of work item that can be processed by the worker class.|  
 ...
 [!code[NVC_ATL_Utilities#137](../atl/codesnippet/CPP/worker-archetype_1.cpp)]  
...
|Class|Description|  
|-----------|-----------------|  
|[CNonStatelessWorker](../atl/cnonstatelessworker-class.md)|Receives requests from the thread pool and passes them on to a worker object that is created and destroyed for each request.|  
...
|--------------------|-------------|  
|*Worker*|[CThreadPool](../atl/cthreadpool-class.md)|  
|*Worker*|[CNonStatelessWorker](../atl/cnonstatelessworker-class.md)|  
...
## See Also  
 [Archetypes](../atl/atl-archetypes.md)   
