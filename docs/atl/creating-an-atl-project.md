...
3.  Define your application settings using the [Application Settings](../atl/application-settings--atl-project-wizard.md) page of the `ATL Project Wizard`.  
