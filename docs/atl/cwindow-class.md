...
-   Create or subclass a window using one of the following classes derived from `CWindow`:  
 ...
 [CWindowImpl](../atl/cwindowimpl-class.md) Allows you to create a new window or subclass an existing window.  
  
 [CContainedWindow](../atl/ccontainedwindowt-class.md) Implements a window contained within another object. You can create a new window or subclass an existing window.  
  
 [CDialogImpl](../atl/cdialogimpl-class.md) Allows you to create a modal or modeless dialog box.  
...
### Example  
 [!code[NVC_ATL_Windowing#1](../atl/codesnippet/CPP/cwindow-class_1.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#2](../atl/codesnippet/CPP/cwindow-class_2.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#3](../atl/codesnippet/CPP/cwindow-class_3.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#4](../atl/codesnippet/CPP/cwindow-class_4.cpp)]  
...
### Parameters  
 ...
 `rect`  
 [in] A variable of type [_U_RECT](../atl/_u_rect-class.md) specifying the position of the window. The default value is **NULL**. When this parameter is **NULL**, the value of `CWindow::rcDefault` is used.  
 ...
 `MenuOrID`  
 [in] A variable of type [_U_MENUorID](../atl/_u_menuorid-class.md) specifying a handle to a menu or a window identifier. The default value is 0U.  
...
> [!NOTE]
> `CWindow::CWindow` does not create a window. Classes [CWindowImpl](../atl/cwindowimpl-class.md), [CContainedWindow](../atl/ccontainedwindowt-class.md), and [CDialogImpl](../atl/cdialogimpl-class.md) (all of which derive from `CWindow`) provide a method to create a window or dialog box, which is then assigned to `CWindow::m_hWnd`. You can also use the [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) Win32 function.  
...
### Example  
 [!code[NVC_ATL_Windowing#5](../atl/codesnippet/CPP/cwindow-class_5.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#6](../atl/codesnippet/CPP/cwindow-class_6.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#7](../atl/codesnippet/CPP/cwindow-class_7.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#8](../atl/codesnippet/CPP/cwindow-class_8.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#9](../atl/codesnippet/CPP/cwindow-class_9.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#10](../atl/codesnippet/CPP/cwindow-class_10.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#11](../atl/codesnippet/CPP/cwindow-class_11.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#12](../atl/codesnippet/CPP/cwindow-class_12.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#13](../atl/codesnippet/CPP/cwindow-class_13.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#14](../atl/codesnippet/CPP/cwindow-class_14.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#15](../atl/codesnippet/CPP/cwindow-class_15.cpp)]  
...
### Remarks  
 ...
 The second version of this method allows you to store the text in a `BSTR`; the third version allows you to store the result in a [CString](../atl/cstringt-class.md), since `CSimpleString` is the base class of `CString`.  
...
### Example  
 [!code[NVC_ATL_Windowing#16](../atl/codesnippet/CPP/cwindow-class_16.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#17](../atl/codesnippet/CPP/cwindow-class_17.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#18](../atl/codesnippet/CPP/cwindow-class_18.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#19](../atl/codesnippet/CPP/cwindow-class_19.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#20](../atl/codesnippet/CPP/cwindow-class_20.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#21](../atl/codesnippet/CPP/cwindow-class_21.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#22](../atl/codesnippet/CPP/cwindow-class_22.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#23](../atl/codesnippet/CPP/cwindow-class_23.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#24](../atl/codesnippet/CPP/cwindow-class_24.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#25](../atl/codesnippet/CPP/cwindow-class_25.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#26](../atl/codesnippet/CPP/cwindow-class_26.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#27](../atl/codesnippet/CPP/cwindow-class_27.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#28](../atl/codesnippet/CPP/cwindow-class_28.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#29](../atl/codesnippet/CPP/cwindow-class_29.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#30](../atl/codesnippet/CPP/cwindow-class_30.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#31](../atl/codesnippet/CPP/cwindow-class_31.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#32](../atl/codesnippet/CPP/cwindow-class_32.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#33](../atl/codesnippet/CPP/cwindow-class_33.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#34](../atl/codesnippet/CPP/cwindow-class_34.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#35](../atl/codesnippet/CPP/cwindow-class_35.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#36](../atl/codesnippet/CPP/cwindow-class_36.cpp)]  
...
### Example  
 [!code[NVC_ATL_Windowing#37](../atl/codesnippet/CPP/cwindow-class_37.cpp)]  
