...
## Return Value  
 ...
 For more information about `errno` and possible error return values, see [errno, _doserrno, _sys_errlist, and _sys_nerr](../crt/errno--_doserrno--_sys_errlist--and-_sys_nerr.md).  
  
## Remarks  
 `FLT_RADIX` is defined in \<float.h> as the native floating-point radix; on binary systems, it has a value of 2, and `scalbn` is equivalent to [ldexp](../crt/ldexp.md).  
...
## See Also  
 ...
 [frexp](../crt/frexp.md)   
 [ldexp](../crt/ldexp.md)   
 [modf, modff, modfl](../crt/modf--modff--modfl.md)