...
## Return Value  
 `ldiv` returns a structure of type [ldiv_t](../crt/standard-types.md) that comprises both the quotient and the remainder. `lldiv` returns a structure of type [lldiv_t](../crt/standard-types.md) that comprises both the quotient and the remainder.  
