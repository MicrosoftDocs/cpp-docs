...
## Remarks  
 ...
 In order for `_tolower` to give the expected results, [__isascii](../crt/isascii--__isascii--iswascii.md) and [isupper](../crt/isupper--_isupper_l--iswupper--_iswupper_l.md) must both return nonzero.  
