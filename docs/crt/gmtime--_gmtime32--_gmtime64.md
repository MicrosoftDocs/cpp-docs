...
Converts a time value to a structure. More secure versions of these functions are available; see [gmtime_s, _gmtime32_s, _gmtime64_s](../crt/gmtime_s--_gmtime32_s--_gmtime64_s.md).  
...
## Return Value  
 A pointer to a structure of type [tm](../crt/standard-types.md). The fields of the returned structure hold the evaluated value of the `timer` argument in UTC rather than in local time. Each of the structure fields is of type `int`, as follows:  
