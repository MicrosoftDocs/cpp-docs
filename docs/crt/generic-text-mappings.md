...
-   [Data types](../crt/data-type-mappings.md)  
  
-   [Constants and global variables](../crt/constant-and-global-variable-mappings.md)  
  
-   [Routine mappings](../crt/routine-mappings.md)  
  
 For more information, see [Using Generic-Text Mappings](../crt/using-generic-text-mappings.md). Generic-text mappings are Microsoft extensions that are not ANSI compatible.  
