...
## Remarks  
 ...
 Unless you specify otherwise with the [_CrtSetReportMode](../crt/_crtsetreportmode.md) and [_CrtSetReportFile](../crt/_crtsetreportfile.md) functions, messages appear in a pop-up dialog box equivalent to setting:  
  
```c  
_CrtSetReportMode(CRT_ASSERT, _CRTDBG_MODE_WNDW);  
```  
  
 `_CrtDbgReportW` generates the debug report and determines its destination or destinations, based on the current report mode or modes and file defined for the `_CRT_ASSERT` report type. By default, assertion failures and errors are directed to a debug message window. The [_CrtSetReportMode](../crt/_crtsetreportmode.md) and [_CrtSetReportFile](../crt/_crtsetreportfile.md) functions are used to define the destinations for each report type.  
...
## See Also  
 ...
 [_RPT, _RPTF, _RPTW, _RPTFW Macros](../crt/_rpt--_rptf--_rptw--_rptfw-macros.md)