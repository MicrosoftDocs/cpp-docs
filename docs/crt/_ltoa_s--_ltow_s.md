...
---
# _ltoa_s, _ltow_s
Converts a long integer to a string. These are versions of [_ltoa, _ltow](../crt/_ltoa--_ltow.md) with security enhancements as described in [Security Features in the CRT](../crt/security-features-in-the-crt.md).  
...
## See Also  
 ...
 [_ultoa_s, _ultow_s](../crt/_ultoa_s--_ultow_s.md)