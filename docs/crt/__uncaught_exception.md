...
---
# __uncaught_exception
Indicates whether one or more exceptions have been thrown, but have not yet been handled by the corresponding `catch` block of a [try-catch](../cpp/try--throw--and-catch-statements--c---.md) statement.  
