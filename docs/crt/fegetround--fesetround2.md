...
-   The results of floating-point arithmetic operators in constant expressions, which always round to the nearest value.  
 ...
 To use these functions, you must turn off floating-point optimizations that could prevent access by using the `#pragma fenv_access(on)` directive prior to the call. For more information, see [fenv_access](../c/fenv_access.md).  
...
## See Also  
 ...
 [lrint, lrintf, lrintl, llrint, llrintf, llrintl](../crt/lrint--lrintf--lrintl--llrint--llrintf--llrintl.md)