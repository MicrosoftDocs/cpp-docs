...
[!INCLUDE[win8_appname_long](../build/includes/win8_appname_long_md.md)] apps are programs that run in the [!INCLUDE[wrt](../atl/includes/wrt_md.md)] that executes on [!INCLUDE[win8](../buildref/includes/win8_md.md)].  The [!INCLUDE[wrt](../atl/includes/wrt_md.md)] is a trustworthy environment that controls the functions, variables, and resources that are available to a [!INCLUDE[win8_appname_long](../build/includes/win8_appname_long_md.md)] app. However, by design, [!INCLUDE[wrt](../atl/includes/wrt_md.md)] restrictions prevent the use of most C Run-Time Library (CRT) features in [!INCLUDE[win8_appname_long](../build/includes/win8_appname_long_md.md)] apps.  
  
 The [!INCLUDE[wrt](../atl/includes/wrt_md.md)] does not support the following CRT features:  
...
-   [!INCLUDE[win8_appname_long](../build/includes/win8_appname_long_md.md)] apps and DLLs that are statically linked to the CRT and built by using the [/MT](../buildref/-md---mt---ld--use-run-time-library-.md) or `/MTd` compiler options.  
  
     That is, an app that uses a multithread, static version of the CRT.  
  
-   An app that's built by using the [/MDd](../buildref/-md---mt---ld--use-run-time-library-.md) compiler option.  
  
     That is, a debug, multithread, and DLL-specific version of the CRT. Such an app is not supported on the [!INCLUDE[win8_appstore_long](../buildref/includes/win8_appstore_long_md.md)].  
...
## See Also  
 ...
 [Windows Runtime Unsupported CRT Functions](../crt/windows-runtime-unsupported-crt-functions.md)   
