...
|`_CrtIsValidPointer`|\<crtdbg.h>|  
 ...
 `_CrtIsValidPointer` is a Microsoft extension. For compatibility information, see [Compatibility](../crt/compatibility.md).  
