...
|----------------------|---------------|-----------------|  
|binmode.obj|pbinmode.obj|Sets the default file-translation mode to binary. See [_fmode](../crt/_fmode.md).|  
|chkstk.obj|n/a|Provides stack-checking and alloca support when not using the CRT.|  
|commode.obj|pcommode.obj|Sets the global commit flag to "commit". See [fopen, _wfopen](../crt/fopen--_wfopen.md) and [fopen_s, _wfopen_s](../crt/fopen_s--_wfopen_s.md).|  
|fp10.obj|n/a|Changes the default precision control to 64 bits. See [Floating-Point Support](../crt/floating-point-support.md).|  
...
|newmode.obj|pnewmode.obj|Causes [malloc](../crt/malloc.md) to call the new handler on failure. See [_set_new_mode](../crt/_set_new_mode.md), [_set_new_handler](../crt/_set_new_handler.md), [calloc](../crt/calloc.md), and [realloc](../crt/realloc.md).|  
...
|setargv.obj|psetargv.obj|Enables command-line argument wildcard expansion. See [Expanding Wildcard Arguments](../c/expanding-wildcard-arguments.md).|  
...
|wsetargv.obj|pwsetargv.obj|Enables command-line argument wildcard expansion. See [Expanding Wildcard Arguments](../c/expanding-wildcard-arguments.md).|  
