...
---
# vscanf_s, vwscanf_s
Reads formatted data from the standard input stream. These versions of [vscanf, vwscanf](../crt/vscanf--vwscanf.md) have security enhancements, as described in [Security Features in the CRT](../crt/security-features-in-the-crt.md).  
...
>  The size parameter is of type `unsigned`, not `size_t`.  
 ...
 For more information, see [scanf Width Specification](../crt/scanf-width-specification.md).  
...
## See Also  
 ...
 [vscanf, vwscanf](../crt/vscanf--vwscanf.md)