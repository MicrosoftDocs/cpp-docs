...
-   [_findnext, _wfindnext](../crt/75d97188-5add-4698-a46c-4c492378f0f8.md)  
  
-   [_findfirst, _wfindfirst](../crt/9bb46d1a-b946-47de-845a-a0b109a33ead.md)  
...
## Remarks  
 ...
 `time_t time_create`  
 Time of file creation (–1L for FAT file systems). This time is stored in UTC format. To convert to the local time, use [localtime_s](../crt/localtime_s--_localtime32_s--_localtime64_s.md).  
