...
---
# _lsearch_s
Performs a linear search for a value. A version of [_lsearch](../crt/_lsearch.md) with security enhancements as described in [Security Features in the CRT](../crt/security-features-in-the-crt.md).  
