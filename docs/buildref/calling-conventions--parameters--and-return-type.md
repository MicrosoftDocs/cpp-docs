...
```  
 ...
 For the definition of the `PCImgDelayDescr` structure, see [Structure and Constant Definitions](../buildref/structure-and-constant-definitions.md).  
...
## See Also  
 [Understanding the Helper Function](../buildref/understanding-the-helper-function.md)