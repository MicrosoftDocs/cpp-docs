...
For more information on error handling and notification, see [Understanding the Helper Function](assetId:///6279c12c-d908-4967-b0b3-cabfc3e91d3d).  
 ...
 For more information on hook functions, see [Structure and Constant Definitions](../buildref/structure-and-constant-definitions.md).  
...
-   [Notification Hooks](../buildref/notification-hooks.md)  
  
-   [Failure Hooks](../buildref/failure-hooks.md)  
  
-   [Exceptions](../buildref/exceptions--c-c---.md)  
