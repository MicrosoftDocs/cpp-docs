...
|--------------------------------|-----------------|  
|[#import](../c/sharpimport-directive--c---.md) preprocessor directive|Converts the types in a type library into C++ classes, and then writes those classes to a header file.|  
|[/E](../buildref/-e--preprocess-to-stdout-.md), [/EP](../buildref/-ep--preprocess-to-stdout-without-sharpline-directives-.md)|Copies preprocessor output to the standard output (**stdout**).|  
|[/Gm](../buildref/-gm--enable-minimal-rebuild-.md)|Enables an incremental rebuild.|  
|[/showIncludes](../buildref/-showincludes--list-include-files-.md)|Writes a list of include files to the standard error (**stderr**).|  
|[/Yc](../buildref/-yc--create-precompiled-header-file-.md)|Writes a precompiled header file.|  
...
|------------------------|-----------------|-----------------------|  
|`C2813`|The **#import** directive is not compatible with the **/MP** option.|The compilation ends unless a [compiler warning level](../buildref/-w---w0---w1---w2---w3---w4---w1---w2---w3---w4---wall---wd---we---wo---wv---wx--warning-level-.md) option specifies otherwise.|  
...
### Using Type Libraries (#import)  
 The compiler does not support the use of the [#import](../c/sharpimport-directive--c---.md) directive with the **/MP** switch. If possible, follow these steps to work around this problem:  
