...
-   The entry point (as *section*:*offset*)  
 ...
 The [/MAPINFO](../buildref/-mapinfo--include-information-in-mapfile-.md) option specifies additional information to be included in the mapfile.  
...
1.  See \<xref:Microsoft.VisualStudio.VCProjectEngine.VCLinkerTool.GenerateMapFile*> and \<xref:Microsoft.VisualStudio.VCProjectEngine.VCLinkerTool.MapFileName*>.  
