...
To create browse information for symbol browsing, the compiler creates an .sbr file for each source file in your project, then BSCMAKE.EXE concatenates the .sbr files into one .bsc file.  
 ...
 Use [/FR](../buildref/-fr---fr--create-.sbr-file-.md) or [/Fr](../buildref/-fr---fr--create-.sbr-file-.md) to tell the compiler to create .sbr files. To create .bsc files, you can call [BSCMAKE](../buildref/bscmake-command-line.md) from the command line. Using BSCMAKE from the command line gives you more precise control over the manipulation of browse information files. See [BSCMAKE Reference](../buildref/bscmake-reference.md) for more information.  
...
1.  Use [BSCMAKE command-line options](../buildref/bscmake-options.md) to exclude information from the browse information file.  
