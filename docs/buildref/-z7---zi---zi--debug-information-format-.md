 ...
 **/Zi** does not affect optimizations. However, **/Zi** does imply **/debug**; see [/DEBUG (Generate Debug Info)](../buildref/-debug--generate-debug-info-.md) for more information.  
  
 Type information is placed in the .pdb file, and not in the .obj file.  
  
 You can use [/Gm (Enable Minimal Rebuild)](../buildref/-gm--enable-minimal-rebuild-.md) with **/Zi**, whereas **/Gm** is not available when compiling with **/Z7**.  
 ...
 **/ZI** causes [/Gy (Enable Function-Level Linking)](../buildref/-gy--enable-function-level-linking-.md) and [/FC (Full Path of Source Code File in Diagnostics)](../buildref/-fc--full-path-of-source-code-file-in-diagnostics-.md) to be used in your compilation.  
  
 **/ZI** is not compatible with [/clr (Common Language Runtime Compilation)](../buildref/-clr--common-language-runtime-compilation-.md).  
