...
-   /FIXED:NO is in effect ([/FIXED (Fixed Base Address)](../buildref/-fixed--fixed-base-address-.md)).  
  
-   The extension of the output file will be .sys. Use **/OUT** to change the default filename and extension ([/OUT (Output File Name)](../buildref/-out--output-file-name-.md)).  
