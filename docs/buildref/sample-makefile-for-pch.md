...
```  
 ...
 For more information on makefiles, see [NMAKE Reference](../build/nmake-reference.md). Also see [Compiler Options](../buildref/compiler-options.md) and the [Linker Options](../buildref/linker-options.md).  
