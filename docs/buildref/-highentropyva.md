...
## Remarks  
 ...
 By default, the linker sets this option for 64-bit executable images. To set this option, the [/DYNAMICBASE](../buildref/-dynamicbase.md) option must also be set.  
  
## See Also  
 [EDITBIN Options](../buildref/editbin-options.md)   
 [/DYNAMICBASE](../buildref/-dynamicbase.md)   
