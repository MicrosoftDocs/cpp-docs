...
## Remarks  
 ...
 If /TLBOUT is not specified, the .tlb file will get its name from [/IDLOUT](../buildref/-idlout--name-midl-output-files-.md) *filename*. If /IDLOUT is not specified, the .tlb file will be called vc70.tlb.  
