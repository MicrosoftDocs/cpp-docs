...
-   [Changes in the DLL Delayed Loading Helper Function Since Visual C++ 6.0](../buildref/changes-in-the-dll-delayed-loading-helper-function-since-visual-c---6.0.md)  
  
-   [Calling Conventions, Parameters, and Return Type](../buildref/calling-conventions--parameters--and-return-type.md)  
  
-   [Structure and Constant Definitions](../buildref/structure-and-constant-definitions.md)  
  
-   [Calculating Necessary Values](../buildref/calculating-necessary-values.md)  
  
-   [Unloading a Delay-Loaded DLL](../buildref/explicitly-unloading-a-delay-loaded-dll.md)  
