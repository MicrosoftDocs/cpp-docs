 ...
 **1**  
 Allows expansion only of functions marked [inline](../notintoc/inline--__inline--__forceinline.md), [__inline](../notintoc/inline--__inline--__forceinline.md), or [__forceinline](../notintoc/inline--__inline--__forceinline.md), or in a C++ member function defined in a class declaration.  
 ...
 **/Ob2** is in effect when [/O1, /O2 (Minimize Size, Maximize Speed)](../buildref/-o1---o2--minimize-size--maximize-speed-.md) or [/Ox (Full Optimization)](../buildref/-ox--full-optimization-.md) is used.  
...
## Remarks  
 ...
 You can use the `#pragma`[auto_inline](../c/auto_inline.md) directive to exclude functions from consideration as candidates for inline expansion. Also see the `#pragma`[intrinsic](../c/intrinsic.md) directive.  
  
> [!NOTE]
>  Information that is gathered from profiling test runs overrides optimizations that would otherwise be in effect if you specify **/Ob**, **/Os**, or **/Ot**. For more information, see [Profile-Guided Optimizations](../buildref/profile-guided-optimizations.md).  
