...
|Symbol|Function|  
|------------|--------------|  
|_CHAR_UNSIGNED|Default char type is unsigned. Defined when the [/J](../buildref/-j--default-char-type-is-unsigned-.md) option is specified.|  
|_CPPRTTI|Defined for code compiled with the [/GR](../buildref/-gr--enable-run-time-type-information-.md) option.|  
|_CPPUNWIND|Defined for code compiled with the [/EHsc](../buildref/-eh--exception-handling-model-.md) option.|  
|_DLL|Defined when the [/MD](../buildref/-md---mt---ld--use-run-time-library-.md) option is specified.|  
|_M_IX86|By default, defined to 600 for x86 targets.|  
|_MSC_VER|For more information, see [Predefined Macros](../c/predefined-macros.md).|  
|_WIN32|Defined for WIN32 applications. Always defined.|  
|_MT|Defined when the [/MD or /MT](../buildref/-md---mt---ld--use-run-time-library-.md) option is specified.|  
...
## See Also  
 ...
 [/J (Default char Type Is unsigned)](../buildref/-j--default-char-type-is-unsigned-.md)   
 [/GR (Enable Run-Time Type Information)](../buildref/-gr--enable-run-time-type-information-.md)   
