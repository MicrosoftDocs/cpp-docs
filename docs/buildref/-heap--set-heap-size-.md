...
## Remarks  
 ...
 This functionality is also available via a module definition file with [HEAPSIZE](../buildref/heapsize.md).  
...
-   See \<xref:Microsoft.VisualStudio.VCProjectEngine.VCLinkerTool.HeapReserveSize*> and \<xref:Microsoft.VisualStudio.VCProjectEngine.VCLinkerTool.HeapCommitSize*>.  
