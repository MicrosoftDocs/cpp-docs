...
## Remarks  
 ...
 The data that is collected from instrumented runs is used to create an optimized image. For more information, see [Profile Guided Optimization](../buildref/profile-guided-optimizations.md). The short form of this option is /LTCG:PGI.  
  
 :PGOPTIMIZE (optional)  
 This option is deprecated. Instead, use **/LTCG** and  **/USEPROFILE** to build an optimized image. For more information, see [Profile Guided Optimization](../buildref/profile-guided-optimizations.md). The short form of this option is /LTCG:PGO.  
  
 :PGUPDATE (optional)  
 This option is deprecated. Instead, use **/LTCG** and  **/USEPROFILE** to build an optimized image. For more information, see [Profile Guided Optimization](../buildref/profile-guided-optimizations.md). The short form of this option is /LTCG:PGU.  
  
 The /LTCG option tells the linker to call the compiler and perform whole-program optimization. You can also do profile guided optimization. For more information, see [Profile Guided Optimization](../buildref/profile-guided-optimizations.md).  
...
-   [/BASE](../buildref/-base--base-address-.md)  
  
-   [/FIXED](../buildref/-fixed--fixed-base-address-.md)  
  
-   /LTCG  
  
-   [/MAP](../buildref/-map--generate-mapfile-.md)  
  
-   [/MAPINFO](../buildref/-mapinfo--include-information-in-mapfile-.md)  
  
-   [/NOLOGO](../buildref/-nologo--suppress-startup-banner---linker-.md)  
  
-   [/OUT](../buildref/-out--output-file-name-.md)  
  
-   [/PGD](../buildref/-pgd--specify-database-for-profile-guided-optimizations-.md)  
  
-   [/PDB](../buildref/-pdb--use-program-database-.md)  
  
-   [/PDBSTRIPPED](../buildref/-pdbstripped--strip-private-symbols-.md)  
  
-   [/STUB](../buildref/-stub--ms-dos-stub-file-name-.md)  
  
-   [/VERBOSE](../buildref/-verbose--print-progress-messages-.md)  
 ...
 /LTCG is implied with [/GL](../buildref/-gl--whole-program-optimization-.md).  
 ...
 **/LTCG** is not valid for use with [/INCREMENTAL](../buildref/-incremental--link-incrementally-.md).  
  
 When **/LTCG** is used to link modules compiled by using [/Og](../buildref/-og--global-optimizations-.md), [/O1](../buildref/-o1---o2--minimize-size--maximize-speed-.md), [/O2](../buildref/-o1---o2--minimize-size--maximize-speed-.md), or [/Ox](../buildref/-ox--full-optimization-.md), the following optimizations are performed:  
...
## /LTCG and MSIL Modules  
 Modules that are compiled by using [/GL](../buildref/-gl--whole-program-optimization-.md) and [/clr](../buildref/-clr--common-language-runtime-compilation-.md) can be used as input to the linker when **/LTCG** is specified.  
