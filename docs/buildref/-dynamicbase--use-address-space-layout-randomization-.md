...
Specifies whether to generate an executable image that can be randomly rebased at load time by using the address space layout randomization (ASLR) feature of [!INCLUDE[windowsver](../buildref/includes/windowsver_md.md)].  
...
## Remarks  
 ...
 Address space layout randomization is supported on [!INCLUDE[windowsver](../buildref/includes/windowsver_md.md)].  
