...
## Remarks  
 ...
 The /TSAWARE option is enabled by default for Windows 2000 and later, for Windows and console applications. See [/SUBSYSTEM](../buildref/-subsystem--specify-subsystem-.md) and [/VERSION](../buildref/-version--version-information-.md) for information.  
  
 /TSAWARE is not valid for drivers, VxDs, or DLLs.  
  
 If an application was linked with /TSAWARE, DUMPBIN [/HEADERS](../buildref/-headers.md) will display information to that effect.  
...
-   See \<xref:Microsoft.VisualStudio.VCProjectEngine.VCLinkerTool.TerminalServerAware*>.  
