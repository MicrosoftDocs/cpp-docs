...
## Remarks  
 For more information on the default library, see [Use Run-Time Library](../buildref/-md---mt---ld--use-run-time-library-.md).  
 ...
 Use [/NODEFAULTLIB (Ignore Libraries)](../buildref/-nodefaultlib--ignore-libraries-.md). to direct the linker to ignore library references in all .obj files.  
  
 For more information, see [CRT Library Features](../crt/crt-library-features.md).  
