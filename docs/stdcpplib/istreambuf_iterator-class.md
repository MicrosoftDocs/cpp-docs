...
|[traits_type](../stdcpplib/istream_iterator-class.md#istream_iterator__traits_type)|A type that provides for the character traits type of the `istream_iterator`.|  
...
## See Also  
 [iterator Struct](../stdcpplib/iterator-struct.md)   
