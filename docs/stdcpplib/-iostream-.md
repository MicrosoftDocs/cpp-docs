...
#### Return Value  
 An [ostream](../stdcpplib/-ostream--typedefs.md#ostream) object.  
  
#### Remarks  
 The object controls unbuffered insertions to the standard error output as a byte stream. Once the object is constructed, the expression `cerr.`[flags](../stdcpplib/ios_base-class.md#ios_base__flags) `&` [unitbuf](../stdcpplib/-ios--functions.md#unitbuf) is nonzero, and `cerr.tie() == &cout`.  
...
#### Return Value  
 An [istream](../stdcpplib/-istream--typedefs.md#istream) object.  
  
#### Remarks  
 The object controls extractions from the standard input as a byte stream. Once the object is constructed, the call `cin.`[tie](../stdcpplib/basic_ios-class.md#basic_ios__tie) returns `&`[cout](#cout).  
...
#### Return Value  
 A [wostream](../stdcpplib/-ostream--typedefs.md#wostream) object.  
  
#### Remarks  
 The object controls unbuffered insertions to the standard error output as a wide stream. Once the object is constructed, the expression `wcerr.`[flags](../stdcpplib/ios_base-class.md#ios_base__flags) `&` [unitbuf](../stdcpplib/-ios--functions.md#unitbuf) is nonzero.  
...
#### Return Value  
 A [wistream](../stdcpplib/-istream--typedefs.md#wistream) object.  
  
#### Remarks  
 The object controls extractions from the standard input as a wide stream. Once the object is constructed, the call `wcin.`[tie](../stdcpplib/basic_ios-class.md#basic_ios__tie) returns `&`[wcout](#wcout).  
...
```  
 ...
 For more information, see [Basic CString Operations](../atl/basic-cstring-operations.md).  
