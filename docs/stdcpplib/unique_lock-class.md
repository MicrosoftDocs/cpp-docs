...
|Name|Description|  
|----------|-----------------|  
|[unique_lock::operator bool](#unique_lock__operator_bool)|Specifies whether the calling thread has ownership of the associated `mutex`.|  
|[unique_lock::operator=](#unique_lock__operator_eq)|Copies the stored `mutex` pointer and associated ownership status from a specified object.|  
...
### Remarks  
 If the stored `mutex` pointer is `null`, this method throws a [system_error](../stdcpplib/system_error-class.md) that has an error code of `operation_not_permitted`.  
...
```cpp
explicit operatorbool() noexcept
```  
...
### Remarks  
 If the stored `mutex` pointer is `null`, the method throws a [system_error](../stdcpplib/system_error-class.md) that has an error code of `operation_not_permitted`.  
...
### Parameters  
 `Rel_time`  
 A [chrono::duration](../stdcpplib/duration-class.md) object that specifies the maximum amount of time that the method attempts to obtain ownership of the `mutex`.  
...
### Remarks  
 If the calling thread doesn't own the associated `mutex`, this method throws a [system_error](../stdcpplib/system_error-class.md) that has an error code of `operation_not_permitted`.  
