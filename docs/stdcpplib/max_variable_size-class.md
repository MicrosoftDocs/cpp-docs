...
---
# max_variable_size Class
Describes a [max class](../stdcpplib/-allocators-.md) object that limits a [freelist](../stdcpplib/freelist-class.md) object to a maximum length that is roughly proportional to the number of allocated memory blocks.  
