...
#### Parameters  
 `IntType`  
 The integer result type, defaults to `int`. For possible types, see [\<random>](../stdcpplib/-random-.md).  
  
## Remarks  
 This sampling distribution has uniform-width intervals with uniform probability in each interval. For information about other sampling distributions, see [piecewise_linear_distribution Class](../stdcpplib/piecewise_linear_distribution-class.md) and [piecewise_constant_distribution Class](../stdcpplib/piecewise_constant_distribution-class.md).  
...
### Parameters  
 See parent topic [discrete_distribution Class](../stdcpplib/discrete_distribution-class.md).  
  
### Remarks  
 This parameter package can be passed to [operator()](../notintoc/discrete_distribution--operator--.md) to generate the return value.  
