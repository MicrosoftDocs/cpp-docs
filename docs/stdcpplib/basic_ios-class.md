...
-   A tie pointer to an object of type [basic_istream](../stdcpplib/basic_istream-class.md)**\<Elem, Traits>**.  
  
-   A stream buffer pointer to an object of type [basic_streambuf](../stdcpplib/basic_streambuf-class.md)**\<Elem, Traits >**.  
  
- [Formatting information](../stdcpplib/ios_base-class.md).  
  
- [Stream state information](../stdcpplib/ios_base-class.md) in a base object of type [ios_base](../stdcpplib/ios_base-class.md).  
...
### Return Value  
 ...
 For more information on `badbit`, see [ios_base::iostate](../stdcpplib/ios_base-class.md#ios_base__iostate).  
...
### Remarks  
 ...
 If `state`**&**[exceptions](#basic_ios__exceptions) is nonzero, it then throws an object of class [failure](../stdcpplib/ios_base-class.md#ios_base__failure).  
  
### Example  
  See [rdstate](#basic_ios__rdstate) and [getline](../stdcpplib/-string--functions.md#getline_template_function) for examples using **clear**.  
...
### Remarks  
 The member function returns `true` if [rdstate](#basic_ios__rdstate) `& eofbit` is nonzero. For more information on `eofbit`, see [ios_base::iostate](../stdcpplib/ios_base-class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `failbit`, see [ios_base::iostate](../stdcpplib/ios_base-class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `goodbit`, see [ios_base::iostate](../stdcpplib/ios_base-class.md#ios_base__iostate).  
...
### Remarks  
 ...
 `rdbuf`-> [pubimbue](../stdcpplib/basic_streambuf-class.md#basic_streambuf__pubimbue)(_ *Loc*)  
  
 In any case, it returns [ios_base::imbue](../stdcpplib/ios_base-class.md#ios_base__imbue)(_ *Loc*).  
...
- [rdstate](#basic_ios__rdstate) returns [goodbit](../stdcpplib/ios_base-class.md#ios_base__iostate) if `_Sb` is nonzero; otherwise, it returns [badbit](../stdcpplib/ios_base-class.md#ios_base__iostate).  
  
- [exceptions](#basic_ios__exceptions) returns **goodbit**.  
  
- [flags](../stdcpplib/ios_base-class.md#ios_base__flags) returns [skipws](../stdcpplib/ios_base-class.md#ios_base__fmtflags) &#124; [dec](../stdcpplib/ios_base-class.md#ios_base__fmtflags).  
  
- [width](../stdcpplib/ios_base-class.md#ios_base__width) returns 0.  
  
- [precision](../stdcpplib/ios_base-class.md#ios_base__precision) returns 6.  
  
- [fill](#basic_ios__fill) returns the space character.  
  
- [getloc](../stdcpplib/ios_base-class.md#ios_base__getloc) returns `locale::classic`.  
  
- [iword](../stdcpplib/ios_base-class.md#ios_base__iword) returns zero, and [pword](../stdcpplib/ios_base-class.md#ios_base__pword) returns a null pointer for all argument values.  
...
### Remarks  
 The member function returns [use_facet](../stdcpplib/basic_filebuf-class.md#basic_filebuf__open)**<**Â **ctype**\< **E**> >( [getloc](../stdcpplib/ios_base-class.md#ios_base__getloc)( ) ). `narrow`( `_Char`, `_Default`).  
...
### Remarks  
 The member function returns [use_facet](../stdcpplib/basic_filebuf-class.md#basic_filebuf__open)< **ctype**\< **E**> >( [getloc](../stdcpplib/ios_base-class.md#ios_base__getloc)). `widen`( `_Char`).  
