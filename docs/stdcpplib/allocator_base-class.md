...
|`Sync`|The synchronization policy for the allocator, which is [sync_none Class](../stdcpplib/sync_none-class.md), [sync_per_container Class](../stdcpplib/sync_per_container-class.md), [sync_per_thread Class](../stdcpplib/sync_per_thread-class.md), or [sync_shared Class](../stdcpplib/sync_shared-class.md).|  
...
### Remarks  
 The first constructor constructs an [allocator_base](../stdcpplib/allocator_base-class.md) instance. The second constructor constructs an `allocator_base` instance such that for any `allocator_base<Type, _Sync>` instance `a`, `allocator_base<Type, Sync>(allocator_base<Other, Sync>(a)) == a`.  
