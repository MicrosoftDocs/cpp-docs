...
Represents a *mutex type*. In contrast to [mutex](../stdcpplib/mutex-class--stl-.md), the behavior of calls to locking methods for objects that are already locked is well-defined.  
