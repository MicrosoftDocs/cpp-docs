...
---
# cache_freelist Class
Defines a [block allocator](../stdcpplib/-allocators-.md) that allocates and deallocates memory blocks of a single size.  
...
|`Max`|The max class representing the maximum size of the free list. This can be [max_fixed_size](../stdcpplib/max_fixed_size-class.md), [max_none](../stdcpplib/max_none-class.md), [max_unbounded](../stdcpplib/max_unbounded-class.md), or [max_variable_size](../stdcpplib/max_variable_size-class.md).|  
