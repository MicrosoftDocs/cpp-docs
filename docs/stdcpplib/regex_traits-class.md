...
## Remarks  
 The template class describes various regular expression traits for type `Elem`. The template class [basic_regex Class](../stdcpplib/basic_regex-class.md) uses this information to manipulate elements of type `Elem`.  
...
## See Also  
 ...
 [regex_traits](../stdcpplib/regex_traits-class.md)   
 [regex_traits\<char> Class](../stdcpplib/regex_traits-char--class.md)   
 [regex_traits<wchar_t> Class](../stdcpplib/regex_traits-wchar_t--class.md)