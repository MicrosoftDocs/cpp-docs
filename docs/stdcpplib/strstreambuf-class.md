...
> [!NOTE]
>  This class is deprecated. Consider using [stringbuf](../stdcpplib/-sstream--typedefs.md#stringbuf) or [wstringbuf](../stdcpplib/-sstream--typedefs.md#wstringbuf) instead.  
...
### Remarks  
 Specifically, if [pptr](../stdcpplib/basic_streambuf-class.md#basic_streambuf__pptr) is a null pointer, the function returns zero. Otherwise, it returns `pptr` – [pbase](../stdcpplib/basic_streambuf-class.md#basic_streambuf__pbase).  
...
## See Also  
 [streambuf](../stdcpplib/-streambuf--typedefs.md#streambuf)   
