...
##  <a name="io_errc_enumeration"></a>  io_errc Enumeration  
 Provides symbolic names for the error conditions in \<iostream>. Can be used to create [error_condition](../stdcpplib/error_condition-class.md) objects to be compared with the value that's returned by the [ios_base::failure](../stdcpplib/ios_base-class.md#ios_base__failure)`code()` function.  
...
### Remarks  
 Both [std::make_error_code()](../stdcpplib/-system_error--functions.md#make_error_code) and [std::make_error_condition()](../stdcpplib/-system_error--functions.md#make_error_condition) are overloaded for this enum.  
