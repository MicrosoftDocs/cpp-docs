...
|`Max`|The max class representing the maximum number of elements to be stored in the free list. The max class can be [max_none](../stdcpplib/max_none-class.md), [max_unbounded](../stdcpplib/max_unbounded-class.md), [max_fixed_size](../stdcpplib/max_fixed_size-class.md), or [max_variable_size](../stdcpplib/max_variable_size-class.md).|  
