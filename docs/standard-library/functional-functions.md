...
dev_langs: ["C++"]
helpviewer_keywords: ["std::bind [C++]", "std::bind1st", "std::bind2nd", "std::bit_and [C++]", "std::bit_not [C++]", "std::bit_or [C++]", "std::bit_xor [C++]", "std::cref [C++]", "", "std::mem_fn [C++]", "std::mem_fun [C++]", "std::mem_fun_ref [C++]", "std::not1", "std::not2", "std::ptr_fun [C++]", "std::ref [C++]", "", "std::swap [C++]", "", "std::bind [C++]", "std::bind1st", "std::bind2nd", "std::bit_and [C++]", "std::bit_not [C++]", "std::bit_or [C++]", "std::bit_xor [C++]", "std::cref [C++]", "std::mem_fn [C++]", "std::mem_fun [C++]", "std::mem_fun_ref [C++]", "std::not1", "std::not2", "std::ptr_fun [C++]", "std::ref [C++]", "std::swap [C++]"]
