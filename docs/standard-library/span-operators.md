---
title: "&lt;span&gt; operators"
ms.date: "04/24/2020"
f1_keywords: ["span/std::array::operator[]", "span/std::array::operator=="]
---

# &lt;span&gt; operators

The \<span> header includes these **span** non-member template functions.

||||
|-|-|-|
|[operator[]](#op_at)|(#op_gt_eq)|
|[operator==](#op_eqlt)|[operator&lt;=](#op_lt_eq)|[operator==](#op_eq_eq)|
