...
int main()
{
	...
	// is_even check if the element is even.
	auto is_even = [](int const elem) { return !(elem % 2); };
	// using copy_if to select only even elements from li 
	...
	for (auto const& el : le)
		cout << el << " ";
	cout << ")" << endl;

	// is_odd check if the element is odd.
	auto is_odd = [](int const elem) { return (elem % 2); };
	// using copy_if to select only odd elements from li
