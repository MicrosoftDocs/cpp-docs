...
|[operator\<=](../standard-library/deque-operators.md#eq)|Tests if the deque object on the left side of the operator is less than or equal to the deque object on the right side.|  
...
|[operator>=](../standard-library/deque-operators.md#eq)|Tests if the deque object on the left side of the operator is greater than or equal to the deque object on the right side.|  
