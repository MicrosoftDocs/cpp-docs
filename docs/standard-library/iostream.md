...
ms.tgt_pltfrm: ""
ms.topic: "article"
f1_keywords: ["std::<iostream>", "<iostream>", "iostream/std::cerr", "iostream/std::cin", "iostream/std::clog", "iostream/std::cout", "iostream/std::wcerr", "iostream/std::wcin", "iostream/std::wclog", "iostream/std::wcout]
dev_langs: ["C++"]
