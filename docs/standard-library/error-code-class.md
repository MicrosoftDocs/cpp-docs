...
Tests if the [error_code](https://msdn.microsoft.com/09c6ef90-b6f8-430a-b584-e168716c7e31) object is less than the `error_code` object passed in for comparison.
...
Assigns a new enumeration value to the [error_code](https://msdn.microsoft.com/09c6ef90-b6f8-430a-b584-e168716c7e31) object.
