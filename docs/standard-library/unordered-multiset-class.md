...
description: "API reference for the C++ Standard Library container class `unordered_multiset`, which describes an object that controls a varying-length sequence of elements."
ms.date: "9/9/2020"
