...
|[operator<=](../standard-library/string-operators.md#eq)|Tests if the string object on the left side of the operator is less than or equal to the string object on the right side.|  
|[operator<\<](../standard-library/string-operators.md#lt)|A template function that inserts a string into the output stream.|  
...
|[operator>=](../standard-library/string-operators.md#eq)|Tests if the string object on the left side of the operator is greater than or equal to the string object on the right side.|  
|[operator>>](../standard-library/string-operators.md#gt)|A template function that extracts a string from the input stream.|  
