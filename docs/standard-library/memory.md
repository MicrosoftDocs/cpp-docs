...
|[checked_uninitialized_copy](memory-functions.md#checked_uninitialized_copy)|Same as `uninitialized_copy` but enforces the use of a checked iterator as output iterator.|  
|[checked_uninitialized_fill_n](memory-functions.md#checked_uninitialized_fill)|Same as `uninitialized_fill_n` but enforces the use of a checked iterator as output iterator.|  
