---
description: "Learn more about: <range>; functions"
title: "<range> functions"
ms.date: "04/13/2021"
f1_keywords: ["ranges/std::span::as_bytes", "span/std::as_writable_bytes"]
helpviewer_keywords: ["std::span [C++], as_writable_bytes", "std::as_bytes [C++]"]
---
# `<ranges> functions

The `<ranges>` header includes the following non-member functions that operate on **span** objects.
