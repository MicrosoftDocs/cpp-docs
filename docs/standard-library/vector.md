...
|[operator\<=](../standard-library/vector-operators.md#eq)|Tests if the vector object on the left side of the operator is less than or equal to the vector object on the right side.|  
...
|[operator>=](../standard-library/vector-operators.md#eq)|Tests if the vector object on the left side of the operator is greater than or equal to the vector object on the right side.|  
