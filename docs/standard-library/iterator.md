...
|[operator\<=](../standard-library/iterator-operators.md#eq)|Tests if the iterator object on the left side of the operator is less than or equal to the iterator object on the right side.|  
...
|[operator>=](../standard-library/iterator-operators.md#eq)|Tests if the iterator object on the left side of the operator is greater than or equal to the iterator object on the right side.|  
