...
entry point 'decorated_function_name' already has a thread attribute; 'attribute' ignored  
 ...
 An entry point, specified with [/ENTRY (Entry-Point Symbol)](../buildref/-entry--entry-point-symbol-.md), had a threading attribute, but [/CLRTHREADATTRIBUTE (Set CLR Thread Attribute)](../buildref/-clrthreadattribute--set-clr-thread-attribute-.md) was also specified, with a different threading model.  
