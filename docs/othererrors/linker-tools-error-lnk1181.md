...
-   A **/LIBPATH** statement that specifies the directory containing `filename` is missing.  
 ...
 For more information, see [.lib Files as Linker Input](../buildref/.lib-files-as-linker-input.md).  
  
## See Also  
 [/LIBPATH (Additional Libpath)](../buildref/-libpath--additional-libpath-.md)