 ...
 **/clr** implies **/EHa**, and you cannot specify any other **/EH** compiler option with **/clr**. For more information, see [/clr (Common Language Runtime Compilation)](../buildref/-clr--common-language-runtime-compilation-.md).  
 ...
 See [/RTC (Run-Time Error Checks)](../buildref/-rtc--run-time-error-checks-.md) for information on changing the **/RTC** property setting.