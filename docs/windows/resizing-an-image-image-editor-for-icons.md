...
1. Drag a sizing handle until the image is the desired size.
...
1. Hold down the **Shift** key and drag a sizing handle until the image is the desired size.
...
1. Drag one of the sizing handles until the selection is the desired size.
