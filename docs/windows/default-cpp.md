...
The **default** C++ attribute has the same functionality as the [default](/windows/desktop/Midl/default) MIDL attribute. The **default** attribute is also used with the [case](../windows/case-cpp.md) attribute.
