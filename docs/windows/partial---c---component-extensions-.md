---
title: "partial  (C++ Component Extensions)"
ms.custom: na
ms.date: "10/14/2016"
...
## All Runtimes  
 (This language feature applies only to the [!INCLUDE[wrt](../atl/includes/wrt_md.md)].)  
...
### Parameters  
 *class-key*  
 A keyword that declares a class or struct that is supported by the [!INCLUDE[wrt](../atl/includes/wrt_md.md)]. Either `ref class`, `value class`, `ref struct`, or `value struct`.  
