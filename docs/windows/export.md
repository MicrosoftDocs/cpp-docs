...
The typedefs valid for export are base types, structs, unions, enums, or type identifiers.  See [typedef](https://msdn.microsoft.com/library/windows/desktop/aa367287) for more information.
