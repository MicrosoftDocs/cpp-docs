...
The **import** C++ attribute causes an `#import` statement to be placed below the `import "docobj.idl"` statement in the generated .idl file. The **import** attribute has the same functionality as the [import](https://msdn.microsoft.com/library/windows/desktop/aa367047) MIDL attribute.
