...
-   [Attribute Targets](../windows/attribute-targets--c---component-extensions-.md)  
  
-   [Attribute Parameter Types](../windows/attribute-parameter-types---c---component-extensions-.md)  
  
 For information on signing assemblies in Visual C++, see [Strong Name Assemblies (Assembly Signing) (C++/CLI)](../cli/strong-name-assemblies--assembly-signing---c---cli-.md).  
 ...
 **Service Access = Read** **Example**  
 ...
 See [typeid](../windows/typeid---c---component-extensions-.md) for information on how to return a value of System::Type from a custom attribute block.  
