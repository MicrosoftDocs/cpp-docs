...
## Remarks  
 A C-style cast is not recommended. When compiling with [/clr (Common Language Runtime Compilation)](../buildref/-clr--common-language-runtime-compilation-.md), use [safe_cast](../windows/safe_cast--c---component-extensions-.md).  
