...
*hidden* (optional)  
A parameter that prevents the library from being displayed. See the [hidden](https://msdn.microsoft.com/library/windows/desktop/aa366861) MIDL attribute for more information.

*restricted*  (optional)  
Members of the library cannot be arbitrarily called. See the [restricted](https://msdn.microsoft.com/library/windows/desktop/aa367157) MIDL attribute for more information.
...
The **idl_module** attribute has functionality similar to the [module](https://msdn.microsoft.com/library/windows/desktop/aa367099) MIDL attribute.
