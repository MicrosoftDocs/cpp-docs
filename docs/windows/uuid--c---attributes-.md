...
## Remarks  
 ...
 When used in a project that does not also use ATL, specifying the `uuid` attribute is the same as specifying the [uuid](../cpp/uuid--c---.md) __declspec modifier. To retrieve the `uuid` of a class, you can use [__uuidof](../cpp/__uuidof-operator.md)  
