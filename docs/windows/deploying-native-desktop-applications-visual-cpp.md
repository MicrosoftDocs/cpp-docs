---
description: "Learn more about: Deploying Native Desktop Applications (Microsoft C++)"
title: "Deploying Native Desktop Applications (Microsoft C++)"
ms.date: "05/11/2018"
...
---
# Deploying Native Desktop Applications (Microsoft C++)
...
- [Deployment in Microsoft C++](deployment-in-visual-cpp.md)
...
- [Redistributing Microsoft C++ Files](redistributing-visual-cpp-files.md)
...
- [ClickOnce Deployment for Microsoft C++ Applications](clickonce-deployment-for-visual-cpp-applications.md)
