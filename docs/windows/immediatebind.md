...
The **immediatebind** C++ attribute has the same functionality as the [immediatebind](https://msdn.microsoft.com/library/windows/desktop/aa367045) MIDL attribute.
