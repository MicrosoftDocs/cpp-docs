...
### Remarks  
 In [!INCLUDE[cppwrt_short](../buildref/includes/cppwrt_short_md.md)],  typeid returns a [Platform::Type](../Topic/Platform::Type%20Class.md) that is constructed from runtime type information.  
 ...
 **Remarks**  
 ...
 `typeid` can take a native type name or common language runtime alias for the native type name; see [.NET Framework Equivalents to C++ Native Types (C++/CLI)](../cli/.net-framework-equivalents-to-c---native-types--c---cli-.md) for more information.  
 ...
 `typeid` is the sucessor to [__typeof](../notintoc/__typeof.md) in the previous **/clr** syntax.  
