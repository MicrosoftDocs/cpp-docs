...
Resources are also found in [other file types](../windows/editable-file-types-for-resources.md) such as .exe, .dll, and .res files. You can work with resources and resource files from within your project and the ones that aren't part of your current project. You can also work with resource files that weren't created in the development environment of Visual Studio. For example, you can:
...
The Visual Studio environment works with and affects the files shown in the following table during your resource editing session:
...
To open a manifest resource, choose from the following steps:

- For text editor, with your project open in **Solution Explorer**, expand the **Resource Files** folder and double-click the .manifest file.

- For another editor, in **Solution Explorer**, right-click the .manifest file and choose **Open With...** from the shortcut menu. In the **Open With** dialog box, specify the editor you would like to use and select **Open**.
