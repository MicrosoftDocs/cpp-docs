...
---
# call_as
Enables a [local](../windows/local--c---.md) function to be mapped to a remote function so that when the remote function is called, the local function is invoked.  
