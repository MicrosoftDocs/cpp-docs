---
title: "Adding a Control to a Dialog Box (C++) | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
...
2. On the [Dialog Editor Tab](../windows/dialog-editor-tab-toolbox.md) of the [Toolbox Window](/visualstudio/ide/reference/toolbox), select the control you want, then:
