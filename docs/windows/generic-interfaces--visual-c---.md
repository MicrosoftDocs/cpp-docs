...
The restrictions that apply to type parameters on classes are the same as those that apply to type parameters on interfaces (see [Generic Classes (C++/CLI)](../windows/generic-classes--c---cli-.md)).  
 ...
 For more information on interfaces, see [interface class](../windows/interface-class---c---component-extensions-.md).  
 ...
 **class** or **typename**  
 ...
 Takes the form specified in [Constraints on Generic Type Parameters (C++/CLI)](../windows/constraints-on-generic-type-parameters--c---cli-.md)  
