...
The **noncreatable** C++ attribute has the same functionality as the [noncreatable](https://msdn.microsoft.com/library/windows/desktop/aa367118) MIDL attribute and is automatically passed through to the generated .IDL file by the compiler.
