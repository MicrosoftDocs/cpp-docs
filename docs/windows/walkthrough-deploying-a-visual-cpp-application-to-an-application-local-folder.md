---
description: "Learn more about: Walkthrough: Deploying a Microsoft C++ Application to an Application-local Folder"
title: "Deploy a Microsoft C++ Application to an App-local Folder"
ms.date: "04/23/2019"
helpviewer_keywords: ["deploying Microsoft C++ applications"]
ms.assetid: 47a81c47-9dbe-47c6-96cc-fbb2fda5e6ad
ms.custom: intro-deployment
ms.topic: install-set-up-deploy
---
# Walkthrough: Deploying a Microsoft C++ Application to an Application-local Folder
...
1. Create and build an MFC application by following the steps in [Walkthrough: Deploying a Microsoft C++ Application By Using a Setup Project](walkthrough-deploying-a-visual-cpp-application-by-using-a-setup-project.md).
