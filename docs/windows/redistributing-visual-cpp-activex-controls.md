...
---
# Redistribute Visual C++ ActiveX controls

Visual C++ 6.0 supplies ActiveX controls that you can use in applications that you then redistribute. These controls are no longer included in Visual C++. According to the licensing agreements for Visual C++ 6.0, you can redistribute these controls with applications developed in Visual C++.
