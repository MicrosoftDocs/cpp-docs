...
The **usesgetlasterror** C++ attribute has the same functionality as the [usesgetlasterror](https://msdn.microsoft.com/library/windows/desktop/aa367297) MIDL attribute.
