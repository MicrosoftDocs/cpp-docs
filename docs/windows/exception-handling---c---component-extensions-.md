...
## In This Section  
 [Basic Concepts in Using Managed Exceptions](../cli/basic-concepts-in-using-managed-exceptions.md)  
 Describes throwing exceptions and using `try`/`catch` blocks.  
  
 [Differences in Exception Handling Behavior Under /CLR](../cli/differences-in-exception-handling-behavior-under--clr.md)  
 ...
 [How to: Define and Install a Global Exception Handler](../cli/how-to--define-and-install-a-global-exception-handler.md)  
 Demonstrates how unhandled exceptions can be captured.  
  
 [How to: Catch Exceptions in Native Code Thrown from MSIL](../cli/how-to--catch-exceptions-in-native-code-thrown-from-msil.md)  
