...
- To change the size of the layout grid, from the **Format** menu, choose **Guide Settings**, then type the height and width in DLUs for the cells in the grid. The minimum height or width is 4 DLUs.
