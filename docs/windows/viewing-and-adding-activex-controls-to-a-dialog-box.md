...
1. In the [Insert ActiveX Control dialog box](../windows/insert-activex-control-dialog-box.md), select the control you want to add to your dialog box and click **OK**.
   ...
   > [!NOTE]
   > You can add ActiveX controls to the [Toolbox window](/visualstudio/ide/reference/toolbox). For more information, see [Managing Items and Tabs in the Toolbox](https://msdn.microsoft.com/21285050-cadd-455a-b1f5-a2289a89c4db).
   ...
   You can place controls in the **Toolbox** window for easy access. For more information, see [Customize Toolbox dialog box](https://msdn.microsoft.com/bd07835f-18a8-433e-bccc-7141f65263bb).
