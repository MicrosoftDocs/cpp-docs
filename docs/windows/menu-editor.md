...
Select an existing menu name and press the **Insert** key or right-click on the menu bar and choose **Insert New** from the shortcut menu.
...
Right-click the menu name or command and choose **Delete** from the shortcut menu.
...
> [!NOTE]
> To change back to the menu-bar view, select **View as Popup** again (which removes the check mark and returns your menu-bar view).
