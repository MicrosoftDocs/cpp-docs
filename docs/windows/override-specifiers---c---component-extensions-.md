---
title: "Override Specifiers  (C++ Component Extensions)"
ms.custom: na
ms.date: "10/14/2016"
...
-   [new (new slot in vtable)](../windows/new--new-slot-in-vtable----c---component-extensions-.md)  
  
-   [override](../windows/override---c---component-extensions-.md)  
  
-   [sealed](../windows/sealed---c---component-extensions-.md)  
  
-   [Override Specifiers and Native Compilations](../cli/how-to--declare-override-specifiers-in-native-compilations--c---cli-.md)  
  
 `abstract` and `sealed` are also valid on type declarations, where they do not act as override specifiers.  
  
 For information about explicitly overriding base class functions, see [Explicit Overrides](../windows/explicit-overrides---c---component-extensions-.md).  
