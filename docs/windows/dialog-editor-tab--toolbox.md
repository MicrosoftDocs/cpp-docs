...
-   [Button control](../mfcref/cbutton-class.md)  
  
-   [Check Box control](../mfcref/button-styles.md)  
  
-   [Combo Box control](../mfcref/ccombobox-class.md)  
  
-   [Edit control](../mfcref/cedit-class.md)  
  
-   Group box  
  
-   [List Box control](../mfcref/clistbox-class.md)  
  
-   [Radio Button control](../mfcref/button-styles.md)  
  
-   [Static Text control](../mfcref/cstatic-class.md)  
  
-   [Picture control](../mfcref/cpictureholder-class.md)  
  
-   [Rich Edit 2.0 control](../mfc/using-cricheditctrl.md)  
  
-   [Scroll bar control](../mfcref/cscrollbar-class.md)  
...
-   [IP Address control](../mfcref/cipaddressctrl-class.md)  
...
-   [Custom control](../mfc/custom-controls-in-the-dialog-editor.md)  
 ...
 You can add custom controls to the dialog box by selecting the **Custom Control** icon in the Toolbox and dragging it to your dialog box. To add a Syslink control, add a custom control, then change the control's **Class** property to **Syslink**. This will cause the properties to refresh and show the Syslink control properties. For information on the MFC wrapper class, see [CLinkCtrl](../mfcref/clinkctrl-class.md).  
...
## See Also  
 ...
 [Scroll-Bar Styles](../mfcref/scroll-bar-styles.md)   
