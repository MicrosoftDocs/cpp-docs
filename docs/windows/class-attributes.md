...
---
# Class Attributes
The following attributes apply to the [class](../cpp/class--c---.md) C++ keyword.  
...
|[source](../windows/source--c---.md)|Specifies the control's source interfaces for connection points on a class. On a property or method, the **source** attribute indicates that the member returns an object or VARIANT that is a source of events.|  
|[support_error_info](../windows/support_error_info.md)|Supports error reporting for the target object.|  
|[threading](../windows/threading--c---.md)|Specifies the threading model for a control.|  
