...
## Benefits  
 ...
 The C++/CX is a high-level, language-based way to use [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)] components. Both the [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] and C++/CX simplify the writing of code for the [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)] by automatically performing housekeeping tasks on your behalf.  
  
 The [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] and C++/CX provide different benefits. Here are some reasons you might want to use the [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] instead of C++/CX:  
...
## Getting Started  
 ...
 In this Channel 9 video, learn more about how the [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] helps you write Universal Windows Platform apps and how to author and consume [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)] components.  
 ...
 Shows how to use the [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] to create a basic [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)] component that adds two numbers. Also demonstrates how to raise events and use the component from a Universal Windows Platform app that uses JavaScript.  
...
## [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] Compared to ATL  
 ...
 [!INCLUDE[cppwrl_short](../windows/includes/cppwrl_short_md.md)] supports the COM functionality that is required for Universal Windows Platform apps. Therefore, it differs from the ATL because it omits direct support for COM features such as:  
...
|[Quick Reference (Windows Runtime and Visual C++)](http://go.microsoft.com/fwlink/?LinkId=229180)|Briefly describes the C++/CX features that support the [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)].|  
|[Using Windows Runtime Components in Visual C++](http://go.microsoft.com/fwlink/?LinkId=229155)|Shows how to use C++/CX to create a basic [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)] component.|