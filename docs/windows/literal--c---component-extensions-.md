...
## Remarks  
 ...
 For more information, see [Static](../notintoc/static--c---.md) and [const](../cpp/const--c---.md).  
  
 `literal` is a context-sensitive keyword. See [Context-Sensitive Keywords](../windows/context-sensitive-keywords---c---component-extensions-.md) for more information.  
