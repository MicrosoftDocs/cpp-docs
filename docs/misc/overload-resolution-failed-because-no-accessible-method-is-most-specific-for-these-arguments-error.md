...
2.  In your calling statement, make the data types of the arguments match the data types of the parameters defined for the desired overload. You might have to use the [CType Function](/dotnet/articles/visual-basic/language-reference/functions/ctype-function) to convert one or more data types to the defined types.  
