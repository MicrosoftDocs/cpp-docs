...
A constraint list includes more than one class.  
 ...
 A constraint list on a type parameter can accept any number of interfaces but at most one class. A type argument supplied for that type parameter must inherit from that class, and [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] does not support multiple inheritance.  
