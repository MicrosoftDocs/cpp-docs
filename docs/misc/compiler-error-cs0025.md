...
Standard library file 'file' could not be found  
 ...
 If the file is a [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] system file, you may need to repair your [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] installation, or reinstall it completely.