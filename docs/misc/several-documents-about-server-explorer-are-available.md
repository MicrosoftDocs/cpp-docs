...
|[Additional resources for troubleshooting data access errors](/visualstudio/data-tools/additional-resources-for-troubleshooting-data-access-errors)|Links to documents about data services.|  
...
|[Local Data Overview](/visualstudio/data-tools/local-data-overview)|Describes how to convert a database file (.mdf) to a format that is used by [!INCLUDE[vs_dev11_long](../build/includes/vs_dev11_long_md.md)].|