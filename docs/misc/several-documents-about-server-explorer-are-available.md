...
[!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] Help contains the following documents about **Server Explorer** that may apply to your Help request. Select the document that best corresponds to the task you are trying to accomplish.  
...
|[Additional resources for troubleshooting data access errors](/visual-studio/data-tools/additional-resources-for-troubleshooting-data-access-errors)|Links to documents about data services.|  
...
|[Server Explorer](../Topic/Server%20Explorer.md)|Describes the **Server Explorer**/**Database Explorer**, which is the server management console for [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].|  
...
|[Local Data Overview](/visual-studio/data-tools/local-data-overview)|Describes how to convert a database file (.mdf) to a format that is used by [!INCLUDE[vs_dev11_long](../build/includes/vs_dev11_long_md.md)].|