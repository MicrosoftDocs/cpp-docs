...
A service can be obtained from any program that has access to the [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] Automation <xref:EnvDTE.DTEClass> object. For example, you can access the <xref:Microsoft.VisualStudio.Shell.Interop.SVsActivityLog> service from a wizard through the DTE object. You can use this service to write to the activity log. For more information, see [How to: Use the Activity Log](http://msdn.microsoft.com/Library/bb3d3322-0e5e-4dd5-b93a-24d5fbcd2ffd).  
