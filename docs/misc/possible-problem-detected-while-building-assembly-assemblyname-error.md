...
The ALink tool, called by the [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] compiler, reports an error building the assembly. Possible causes include the following:  
