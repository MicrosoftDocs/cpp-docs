...
-   Otherwise, this warning usually occurs when your ruleset is empty or all of the rule enabled in child ruleset have been disabled. Use the [!INCLUDE[vs_current_short](../misc/includes/vs_current_short_md.md)] ruleset editor to enable some rules in your ruleset. For more information, see [Creating Custom Rule Sets](../Topic/Creating%20Custom%20Code%20Analysis%20Rule%20Sets.md).  
