...
##  <a name="BKMK_Memory_use_in__NET_Framework_apps"></a> Memory use in .NET Framework apps  
 ...
 ![Back to top](../misc/media/pcs_backtotop.png "PCS_BackToTop") [Contents](#BKMK_Contents)  
...
##  <a name="BKMK_Identify_a_memory_issue_in_an_app"></a> Identify a memory issue in an app  
 ...
 ![Consistent memory growth in Resource Monitor](../misc/media/mngdmem_resourcemanagerconsistentgrowth.png "MNGDMEM_ResourceManagerConsistentGrowth")  
 ...
 ![Memory spikes in Resource Manager](../misc/media/mngdmem_resourcemanagerspikes.png "MNGDMEM_ResourceManagerSpikes")  
...
1.  You can create a dump file for a process that was started from a Visual Studio project, or you can attach the debugger to a running process. See [Attach to Running Processes](/visualstudio/debugger/attach-to-running-processes-with-the-visual-studio-debugger).  
...
2.  On the **Minidump File Summary** page, choose **Debug Managed Memory**.  
     ...
     ![Dump file summary page](../misc/media/mngdmem_dumpfilesummary.png "MNGDMEM_DumpFileSummary")  
...
-   **Inclusive Size (Bytes)** includes the sizes of referenced objects.  
 ...
 You can choose the instances icon (![The instance icon in the Object Type column](../misc/media/dbg_mma_instancesicon.png "DBG_MMA_InstancesIcon")) in the **Object Type** column to view a list of the instances of the type.  
  
#### Instance table  
 ![Instances table](../misc/media/dbg_mma_instancestable.png "DBG_MMA_InstancesTable")  
...
-   **Value** shows the actual value of value types. You can hover over the name of a reference type to view its data values in a data tip.  
     ...
     ![Instance values in a data tip](../misc/media/dbg_mma_instancevaluesindatatip.png "DBG_MMA_InstanceValuesInDataTip")  
...
2.  On the memory analysis report page, open the **Select baseline** list, and then choose **Browse** to specify the first dump file.  
 ...
 ![Diff columns in the type list](../misc/media/mngdmem_diffcolumns.png "MNGDMEM_DiffColumns")  
