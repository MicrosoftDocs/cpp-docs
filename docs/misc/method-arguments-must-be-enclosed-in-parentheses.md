...
The rules governing procedure calls are simpler in newer versions of [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)]. All arguments must be enclosed by parentheses.  
