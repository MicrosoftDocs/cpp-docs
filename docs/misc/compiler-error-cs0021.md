...
Cannot apply indexing with [] to an expression of type 'type'  
 ...
 An attempt was made to access a value through an indexer on a data type that does not support [Indexers](/dotnet/articles/csharp/programming-guide/indexers/index).  
