...
## In This Section  
 ...
 [Adding a Tool Window](/visualstudio/extensibility/adding-a-tool-window)  
 ...
 [Extending the Properties, Task List, Output, and Options Windows](/visualstudio/extensibility/extending-the-properties-task-list-output-and-options-windows)  
...
## Related Sections  
 ...
 [Inside the Visual Studio SDK](/visualstudio/extensibility/internals/inside-the-visual-studio-sdk)  
