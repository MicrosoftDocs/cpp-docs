...
A declaration or assignment statement includes an [Of](/dotnet/articles/visual-basic/language-reference/statements/of-clause) clause when invoking a non-generic type.  
