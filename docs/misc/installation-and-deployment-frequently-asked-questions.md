 ...
 **A:**  <xref:Microsoft.VisualStudio.Shell.Interop.IUIHostLocale2.GetUILocale%2A> or <xref:Microsoft.VisualStudio.Shell.Interop.IUIHostLocale.GetUILocale%2A>will return the LCID of [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] currently in use.  
