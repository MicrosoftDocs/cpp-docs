...
**The Visual Studio project system cannot convert "{0}" projects. It can only be used to convert C# and VB client projects.**  
 ...
 Only valid [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] and [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] projects can be converted using [!INCLUDE[vstecmsbuild](../build/includes/vstecmsbuild_md.md)].  
  
### To correct this error  
  
-   If the project is a [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] or [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] project, check whether the project file has been modified or corrupted. If it has been modified or corrupted, open the project in the version of [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] in which it was created, save it, and then attempt to convert it again.  
