...
A `ReadOnly` property declaration specifies access levels in both the [Property Statement](../Topic/Property%20Statement.md) and the [Get Statement](../Topic/Get%20Statement.md).  
