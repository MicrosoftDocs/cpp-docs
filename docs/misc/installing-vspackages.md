...
## Related Sections  
 ...
 Provides a set of tests to help make sure that VSPackages correctly integrate into [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
 [Releasing a Product](../misc/releasing-a-visual-studio-integration-product.md)  
 Shows how to release a [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] integration product.