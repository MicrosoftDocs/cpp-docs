...
|Title|Description|  
|-----------|-----------------|  
|[Visual C++](../top/visual-c---in-visual-studio-2015.md)|Contains reference and conceptual documentation about Visual C++. Part of the MSDN Library.|  
|[Windows Developer Center](http://go.microsoft.com/fwlink/p/?LinkId=256534)|Contains information about how to use C++ and other languages to develop apps for [!INCLUDE[win8](../buildref/includes/win8_md.md)]. Part of the Windows Developer Center; the C++ content is under the Docs > Language Reference node.|  
