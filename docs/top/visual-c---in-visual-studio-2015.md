...
## General Information about Visual C++  
 ...
 [Supported Platforms](../top/supported-platforms--visual-c---.md)  
...
## Writing Applications in C++  
 [Universal Windows Apps](../windows/universal-windows-apps--c---.md)  
 ...
 [Parallel Programming](../parallel/parallel-programming-in-visual-c--.md)  
 ...
 [Cloud and Web Programming](../top/cloud-and-web-programming-in-visual-c--.md)  
...
## C++ Development Tools  
 To find out about how to create projects, work with source code files, link to libraries, compile, debug, profile, deploy, and more, see [IDE and Development Tools](../ide/ide-and-tools-for-visual-c---development.md).  
  
## C++ Language Reference  
 For information about the C++ language, see [C++ Language Reference](../cpp/c---language-reference.md).  
  
 For information about the C++ preprocessor, see [C/C++ Preprocessor Reference](../c/c-c---preprocessor-reference.md).  
...
## C++ Libraries in Visual Studio  
 ...
 See also the documentation for [STL/CLR](../cli/stl-clr-library-reference.md) and the [C++ Support Library](../cli/c---support-library.md).  
