...
For hard-to-fix errors, try searching or posting a question on [Microsoft Docs Q&A](/answers/topics/c%2B%2B.html) or [C++ Developer Community](https://developercommunity.visualstudio.com/spaces/62/index.html).
