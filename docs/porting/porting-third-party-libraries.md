...
ms.date: 10/29/2025
helpviewer_keywords: ["3rd-party libraries", "vcpkg"]
...
If your open-source library isn't found in the **vcpkg** curated registry, you can open an issue on the [GitHub repo](https://github.com/Microsoft/vcpkg/issues). That's where the community and the Microsoft C++ team can see it and potentially create the port file for this library.
