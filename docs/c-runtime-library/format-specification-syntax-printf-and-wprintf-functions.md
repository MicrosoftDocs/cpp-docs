...
|----------------|----------------|-------------------------|  
|`long int`|**l** (lowercase L)|**d**, **i**, **o**, **u**, **x**, or **X**|  
|`long unsigned int`|**l**|**o**, **u**, **x**, or **X**|  
|`long long`|**ll**|**d**, **i**, **o**, **x**, or **X**|  
|`unsigned long long`|**ll**|**o**, **u**, **x**, or **X**|  
...
|`size_t` (that is, `unsigned __int32` on 32-bit platforms, `unsigned __int64` on 64-bit platforms)|**z** or **I**|**o**, **u**, **x**, or **X**|  
