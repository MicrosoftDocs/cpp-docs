...
|`_EXCEPTION_POINTERS`|Contains an exception record. See [EXCEPTION_POINTERS](/windows/desktop/api/winnt/ns-winnt-exception_pointers) for more information.|FPIEEE.H|
