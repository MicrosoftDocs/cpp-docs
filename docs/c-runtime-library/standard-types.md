...
|`_EXCEPTION_POINTERS`|Contains an exception record. See [EXCEPTION_POINTERS](https://msdn.microsoft.com/library/windows/desktop/ms679331) for more information.|FPIEEE.H|  
