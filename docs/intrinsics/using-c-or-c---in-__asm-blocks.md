...
-   [Using Operators in __asm Blocks](../intrinsics/using-operators-in-__asm-blocks.md)  
  
-   [Using C or C++ Symbols_in __asm Blocks](../intrinsics/using-c-or-c---symbols-in-__asm-blocks.md)  
  
-   [Accessing C or C++ Data in __asm Blocks](../intrinsics/accessing-c-or-c---data-in-__asm-blocks.md)  
  
-   [Writing Functions with Inline Assembly](../intrinsics/writing-functions-with-inline-assembly.md)  
