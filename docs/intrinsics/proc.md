...
---
# PROC
Marks start and end of a procedure block called *label*. The statements in the block can be called with the **CALL** instruction or [INVOKE](../intrinsics/invoke.md) directive.  
...
## Remarks  
 ...
 When the **FRAME** attribute is used, it must be followed by an [.ENDPROLOG](../intrinsics/.endprolog.md) directive.  
  
 See [MASM for x64 (ml64.exe)](../intrinsics/masm-for-x64--ml64.exe-.md) for more information on using ml64.exe.  
