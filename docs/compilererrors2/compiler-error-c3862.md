...
'function': cannot compile an unmanaged function with /clr:pure or /clr:safe  
 ...
 For more information, see [/clr (Common Language Runtime Compilation)](../buildref/-clr--common-language-runtime-compilation-.md) and [managed, unmanaged](../c/managed--unmanaged.md).  
