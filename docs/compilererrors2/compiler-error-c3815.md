...
return type of method 'get_accessor' must match type of the last parameter of a setter  
 ...
 When declaring [properties](../notintoc/__property.md), the return value of the `get_accessor` method must match the last parameter in the declaration of the set accessor method.  
