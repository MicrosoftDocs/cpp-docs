...
'argument': not a valid named attribute argument  
 ...
 For more information, see [property](../windows/property---c---component-extensions-.md) and [User-Defined Attributes](../windows/user-defined-attributes---c---component-extensions-.md).  
