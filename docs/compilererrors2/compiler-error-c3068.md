...
'function' : a 'naked' function cannot contain objects that would require unwinding if a C++ exception occurred  
 ...
 The compiler was unable to perform stack unwinding on a [naked](../cpp/naked--c---.md) function that threw an exception because a temporary object was created in the function and C++ exception handling ([/EHsc](../buildref/-eh--exception-handling-model-.md)) was specified.  
