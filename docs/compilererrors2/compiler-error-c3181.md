...
'type' : invalid operand for operator  
 ...
 An invalid parameter was passed to the [__typeof](../notintoc/__typeof.md) or [typeid](../windows/typeid---c---component-extensions-.md) operator. The parameter must be a managed type.  
