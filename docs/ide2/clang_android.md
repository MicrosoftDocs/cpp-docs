...
Enable C++ Exceptions | Specifies the model of exception handling to be used by the compiler. | **No** - Disable exception handling.<br>**Yes** - Enable exception handling.<br>**Unwind Tables** - Generates any needed static data, but does not affect the code generated.<br>
