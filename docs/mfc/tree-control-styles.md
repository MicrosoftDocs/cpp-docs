...
---
# Tree Control Styles
Tree control ([CTreeCtrl](../mfc/reference/ctreectrl-class.md)) styles govern aspects of a tree control's appearance. You set the initial styles when you create the tree control. You can retrieve and change the styles after creating the tree control by using the [GetWindowLong](https://msdn.microsoft.com/library/windows/desktop/ms633584) and [SetWindowLong](https://msdn.microsoft.com/library/windows/desktop/ms633591) Windows functions, specifying **GWL_STYLE** for the *nIndex* parameter. For a complete list of styles, see [Tree View Control Window Styles](https://msdn.microsoft.com/library/windows/desktop/bb760013) in the Windows SDK.  
