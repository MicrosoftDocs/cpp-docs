...
-   Set up a global hot key for activating a nonchild window by sending a [WM_SETHOTKEY](https://msdn.microsoft.com/library/windows/desktop/ms646284) message to the window to be activated.  
