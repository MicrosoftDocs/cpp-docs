...
3.  Use the [Add Member Variable Wizard](../ide/adding-a-member-variable---visual-c---.md) to add a member variable of type [CMonthCalCtrl](../mfcref/cmonthcalctrl-class.md) with the Control property. You can use this member to call `CMonthCalCtrl` member functions.  
  
4.  Use the Properties window to map handler functions in the dialog class for any month calendar control notification messages you need to handle (see [Mapping Messages to Functions](../mfcref/mapping-messages-to-functions.md)).  
