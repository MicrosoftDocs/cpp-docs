...
This topic describes how to add a toolbar button that contains a Windows control to a toolbar. In MFC, a toolbar button must be a [CMFCToolBarButton Class](../mfcref/cmfctoolbarbutton-class.md)-derived class, for example [CMFCToolBarComboBoxButton Class](../mfcref/cmfctoolbarcomboboxbutton-class.md), [CMFCToolBarEditBoxButton Class](../mfcref/cmfctoolbareditboxbutton-class.md), [CMFCDropDownToolbarButton Class](../mfcref/cmfcdropdowntoolbarbutton-class.md), or [CMFCToolBarMenuButton Class](../mfcref/cmfctoolbarmenubutton-class.md).  
...
## Toolbar Controls and Customization  
 ...
 When you enable customization, you create the **Customize** dialog box in the customization handler `OnViewCustomize` by using the [CMFCToolBarsCustomizeDialog Class](../mfcref/cmfctoolbarscustomizedialog-class.md) class. Before you display the **Customize** dialog box by calling [CMFCToolBarsCustomizeDialog::Create](../Topic/CMFCToolBarsCustomizeDialog::Create.md), call [CMFCToolBarsCustomizeDialog::ReplaceButton](../Topic/CMFCToolBarsCustomizeDialog::ReplaceButton.md) to replace the standard button with the new control.  
  
## Example: Creating a Find Combo Box  
 This section describes how to create a `Find` combo box control that appears on a toolbar and contains recently-used search strings. The user can type a string in the control and then press the enter key to search a document, or press the escape key to return the focus to the main frame. This example assumes that the document is displayed in a [CEditView Class](../mfcref/ceditview-class.md)-derived view.  
...
2.  Create a new class, `CFindComboBox`, derived from [CComboBox Class](../mfcref/ccombobox-class.md).  
...
4.  Create a class for the `Find` combo box button, derived from [CMFCToolBarComboBoxButton Class](../mfcref/cmfctoolbarcomboboxbutton-class.md). In this example, it is named `CFindComboButton`.  
...
5.  The constructor of `CMFCToolbarComboBoxButton` takes three parameters: the command ID of the button, the button image index, and the style of the combo box. Set these parameters as follows:  
    ...
    3.  For a list of available combo box styles, see [Combo-Box Styles](../mfcref/combo-box-styles.md).  
