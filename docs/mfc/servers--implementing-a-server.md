...
-   Initializing and launching the server application. For information on this topic, see [Registration](../mfc/registration.md).  
 ...
 For more information, see [COleServerItem](../mfcref/coleserveritem-class.md), [COleServerDoc](../mfcref/coleserverdoc-class.md), and [COleIPFrameWnd](../mfcref/coleipframewnd-class.md) in the *Class Library Reference*.  
