...
-   Modify your main dialog's `InitInstance` function (found in CONTAINER.CPP) by the MFC Application Wizard making a call to [AfxEnableControlContainer](../Topic/AfxEnableControlContainer.md), as in the following example:  
     ...
     [!code[NVC_MFCOleContainer#34](../mfc/codesnippet/CPP/activex-control-containers--manually-enabling-activex-control-containment_1.cpp)]  
    [!code[NVC_MFCOleContainer#35](../mfc/codesnippet/CPP/activex-control-containers--manually-enabling-activex-control-containment_2.cpp)]  
  
-   Add the following to your project's STDAFX.H header file:  
  
     [!code[NVC_MFCOleContainer#36](../mfc/codesnippet/CPP/activex-control-containers--manually-enabling-activex-control-containment_3.h)]  
