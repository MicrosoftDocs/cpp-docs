...
This article explains techniques you can use to optimize your ActiveX controls for better performance.  
 ...
 You can implement many of these optimizations through the [MFC ActiveX Control Wizard](../mfcref/mfc-activex-control-wizard.md), on the [Control Settings](../mfcref/control-settings--mfc-activex-control-wizard.md) page.  
