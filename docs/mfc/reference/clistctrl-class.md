...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_ApproximateViewRect](https://msdn.microsoft.com/library/windows/desktop/bb761231), as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_CANCELEDITLABEL](https://msdn.microsoft.com/library/windows/desktop/bb774886) message, as described in the Windows SDK.  
...
### Parameters  
 *dwStyle*  
 Specifies the list control's style. Apply any combination of list control styles to the control. See [List view window styles](https://msdn.microsoft.com/library/windows/desktop/bb774739) in the Windows SDK for a complete list of these styles. Set extended styles specific to a control using [SetExtendedStyle](#setextendedstyle).  
 ...
 *dwStyle*  
 Specifies the list control's style. Apply any combination of list control styles to the control. For a complete list of these styles, see [List view window styles](https://msdn.microsoft.com/library/windows/desktop/bb774739) in the Windows SDK.  
...
### Remarks  
 The `itemAction` member of the [DRAWITEMSTRUCT](https://msdn.microsoft.com/library/windows/desktop/bb775802) structure defines the drawing action that is to be performed.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_ENABLEGROUPVIEW](https://msdn.microsoft.com/library/windows/desktop/bb774900) message, as described in the Windows SDK.  
...
### Parameters  
 *pFindInfo*  
 A pointer to an [LVFINDINFO](https://msdn.microsoft.com/library/windows/desktop/bb774745) structure containing information about the item to be searched for.  
...
### Remarks  
 This method implements the behavior of the Win32 macro, [ListView_GetBkImage](https://msdn.microsoft.com/library/windows/desktop/bb761246), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetCheckState](https://msdn.microsoft.com/library/windows/desktop/bb761250), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetColumnOrderArray](https://msdn.microsoft.com/library/windows/desktop/bb761254), as described in the Windows SDK.  
...
### Remarks  
 This method sends the [LVM_GETEMPTYTEXT](https://msdn.microsoft.com/library/windows/desktop/bb774921) message, which is described in the Windows SDK.  
...
### Return Value  
 A combination of the extended styles currently in use by the list view control. For a descriptive list of these extended styles, see the [Extended List View Styles](https://msdn.microsoft.com/library/windows/desktop/bb774732) topic in the Windows SDK.  
  
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetExtendedListViewStyle](https://msdn.microsoft.com/library/windows/desktop/bb761264), as described in the Windows SDK.  
...
### Remarks  
 This method sends the [LVM_GETFOCUSEDGROUP](https://msdn.microsoft.com/library/windows/desktop/bb774925) message, which is described in the Windows SDK. For more information, see the LVGS_FOCUSED value of the `state` member of the [LVGROUP](https://msdn.microsoft.com/library/windows/desktop/bb774769) structure.  
...
### Remarks  
 This method sends the [LVM_GETGROUPCOUNT](https://msdn.microsoft.com/library/windows/desktop/bb774931) message, which is described in the Windows SDK -->.  
 ...
 *pgrp*  
 A pointer to the [LVGROUP](https://msdn.microsoft.com/library/windows/desktop/bb774769) containing information on the group specified.  
  
### Return Value  
 Returns the ID of the group if successful, or -1 otherwise.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_GETGROUPINFO](https://msdn.microsoft.com/library/windows/desktop/bb774932) message, as described in the Windows SDK.  
...
### Parameters  
 *pGroupMetrics*  
 A pointer to a [LVGROUPMETRICS](https://msdn.microsoft.com/library/windows/desktop/bb774752) containing the group metrics information.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_GETGROUPMETRICS](https://msdn.microsoft.com/library/windows/desktop/bb774934) message, as described in the Windows SDK.  
...
### Remarks  
 ...
 This method sends the [LVM_GETGROUPRECT](https://msdn.microsoft.com/library/windows/desktop/bb774935) message, which is described in the Windows SDK.  
...
|[in] *dwMask*|Mask that specifies the state value to retrieve for the specified group. For more information, see the `mask` member of the [LVGROUP](https://msdn.microsoft.com/library/windows/desktop/bb774769) structure.|  
  
### Return Value  
 The requested state for the specified group, or 0 if the group cannot be found.  
  
### Remarks  
 The return value is the result of a bitwise AND operation on the *dwMask* parameter and the value of the `state` member of an [LVGROUP](https://msdn.microsoft.com/library/windows/desktop/bb774769) structure that represents the current list-view control.  
  
 This method sends the [LVM_GETGROUPSTATE](https://msdn.microsoft.com/library/windows/desktop/bb774936) message, which is described in the Windows SDK. For more information, see the [ListView_GetGroupState](https://msdn.microsoft.com/library/windows/desktop/bb761288) macro.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetHeader](https://msdn.microsoft.com/library/windows/desktop/bb761290), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetHotItem](https://msdn.microsoft.com/library/windows/desktop/bb761294), as described in the Windows SDK. The hot item is defined as the currently selected item when hot tracking (and hover selection) is enabled.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetHoverTime](https://msdn.microsoft.com/library/windows/desktop/bb761296), as described in the Windows SDK.  
...
### Parameters  
 *lvim*  
 A pointer to an [LVINSERTMARK](https://msdn.microsoft.com/library/windows/desktop/bb774758) structure containing the information for the insert mark.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_GETINSERTMARK](https://msdn.microsoft.com/library/windows/desktop/bb774945) message, as described in the Windows SDK.  
...
### Return Value  
 Returns a [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) structure that contains the color of the insertion point.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_GETINSERTMARKCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb774947) message, as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_GETINSERTMARKRECT](https://msdn.microsoft.com/library/windows/desktop/bb774949) message, as described in the Windows SDK.  
...
### Parameters  
 *pItem*  
 Pointer to an [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure that receives the item's attributes.  
...
### Remarks  
 This value is the `lParam` member of the [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure, as described in the Windows SDK  
...
### Remarks  
 This method sends the [LVM_GETITEMINDEXRECT](https://msdn.microsoft.com/library/windows/desktop/bb761046) message, which is described in the Windows SDK. For more information, see [ListView_GetItemIndexRect Macro](https://msdn.microsoft.com/library/windows/desktop/bb774959).  
...
### Remarks  
 This method sends the [LVM_GETITEMSPACING](https://msdn.microsoft.com/library/windows/desktop/bb761051) message, which is described in the Windows SDK.  
...
### Remarks  
 An item's state is specified by the `state` member of the [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure, as described in the Windows SDK. When you specify or change an item's state, the `stateMask` member specifies which state bits you want to change.  
...
### Remarks  
 If *nSubItem* is zero, this function retrieves the item label; if *nSubItem* is nonzero, it retrieves the text of the subitem. For more information on the subitem argument, see the discussion of the [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetNumberOfWorkAreas](https://msdn.microsoft.com/library/windows/desktop/bb774988), as described in the Windows SDK.  
...
### Return Value  
 Returns a [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) structure containing the outline color.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_GETOUTLINECOLOR](https://msdn.microsoft.com/library/windows/desktop/bb761065) message, as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_GETSELECTEDCOLUMN](https://msdn.microsoft.com/library/windows/desktop/bb761067) message, as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetSelectionMark](https://msdn.microsoft.com/library/windows/desktop/bb774998), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetSubItemRect](https://msdn.microsoft.com/library/windows/desktop/bb775004), as described in the Windows SDK.  
...
### Parameters  
 *pti*  
 A pointer to an [LVTILEINFO](https://msdn.microsoft.com/library/windows/desktop/bb774766) structure that receives the tile information.  
  
### Return Value  
 The return value is not used.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_GETTILEINFO](https://msdn.microsoft.com/library/windows/desktop/bb761081) message, as described in the Windows SDK.  
...
### Parameters  
 *ptvi*  
 A pointer to an [LVTILEVIEWINFO](https://msdn.microsoft.com/library/windows/desktop/bb774768) structure that receives the retrieved information.  
  
### Return Value  
 The return value is not used.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_GETTILEVIEWINFO](https://msdn.microsoft.com/library/windows/desktop/bb761083) message, as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [LVM_GETTOOLTIPS](https://msdn.microsoft.com/library/windows/desktop/bb761085), as described in the Windows SDK. The MFC implementation of `GetToolTips` returns a `CToolTipCtrl` object, which is used by the list control, rather than a handle to a tooltip control.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_GETVIEW](https://msdn.microsoft.com/library/windows/desktop/bb761091) message, as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_GetWorkAreas](https://msdn.microsoft.com/library/windows/desktop/bb775024), as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_HASGROUP](https://msdn.microsoft.com/library/windows/desktop/bb761097) message, as described in the Windows SDK.  
 ...
 *pFlags*  
 Pointer to an integer that receives information about the results of the test. See the explanation of the `flags` member of the [LVHITTESTINFO](https://msdn.microsoft.com/library/windows/desktop/bb774754) structure in the Windows SDK.  
...
### Remarks  
 ...
 The [LVCOLUMN](https://msdn.microsoft.com/library/windows/desktop/bb774743) structure contains the attributes of a column in report view. It is also used to receive information about a column. This structure is described in the Windows SDK.  
 ...
 *pgrp*  
 A pointer to an [LVGROUP](https://msdn.microsoft.com/library/windows/desktop/bb774769) structure containing the group to be added.  
  
### Return Value  
 Returns the index of the item that the group was added to, or -1 if the operation failed.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_INSERTGROUP](https://msdn.microsoft.com/library/windows/desktop/bb761103) message, as described in the Windows SDK.  
...
### Parameters  
 *pStructInsert*  
 A pointer to an [LVINSERTGROUPSORTED](https://msdn.microsoft.com/library/windows/desktop/bb774756) structure that contains the group to insert.  
  
### Return Value  
 The return value is not used.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_INSERTGROUPSORTED](https://msdn.microsoft.com/library/windows/desktop/bb761105) message, as described in the Windows SDK.  
...
### Parameters  
 *pItem*  
 Pointer to an [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure that specifies the item's attributes, as described in the Windows SDK.  
 ...
 *nMask*  
 The *nMask* parameter specifies which item attributes passed as parameters are valid. It can be one or more of the mask values described in [LVITEM Structure](https://msdn.microsoft.com/library/windows/desktop/bb774760) in the Windows SDK. The valid values can be combined with the bitwise OR operator.  
  
 *nState*  
 Indicates the item's state, state image, and overlay image. See the Windows SDK topics [LVITEM Structure](https://msdn.microsoft.com/library/windows/desktop/bb774760) for more information and [List-View Item States](https://msdn.microsoft.com/library/windows/desktop/bb774733) for a list of valid flags.  
  
 *nStateMask*  
 Indicates which bits of the state member will be retrieved or modified. See [LVITEM Structure](https://msdn.microsoft.com/library/windows/desktop/bb774760) in the Windows SDK for more information.  
 ...
 *lvim*  
 A pointer to an [LVINSERTMARK](https://msdn.microsoft.com/library/windows/desktop/bb774758) structure that specifies the insertion point closest to the coordinates defined by the point parameter.  
  
### Return Value  
 The insertion point closest to the specified point.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_INSERTMARKHITTEST](https://msdn.microsoft.com/library/windows/desktop/bb761131) message, as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_ISGROUPVIEWENABLED](https://msdn.microsoft.com/library/windows/desktop/bb761133) message, as described in the Windows SDK.  
...
### Remarks  
 This method sends the [LVM_ISITEMVISIBLE](https://msdn.microsoft.com/library/windows/desktop/bb761135) message, which is described in the Windows SDK.  
...
### Remarks  
 ...
 This method sends the [LVM_MAPINDEXTOID](https://msdn.microsoft.com/library/windows/desktop/bb761139) message, which is described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_MOVEGROUP](https://msdn.microsoft.com/library/windows/desktop/bb761141) message, as described in the Windows SDK.  
...
>  This method currently is not implemented.  
 ...
 This method emulates the functionality of the [LVM_MOVEITEMTOGROUP](https://msdn.microsoft.com/library/windows/desktop/bb761143) message, as described in the Windows SDK.  
...
### Remarks  
 The specified items are not actually repainted until the list view window receives a WM_PAINT message. To repaint immediately, call the Windows [UpdateWindow](https://msdn.microsoft.com/library/windows/desktop/dd145167) function after using this function.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_REMOVEALLGROUPS](https://msdn.microsoft.com/library/windows/desktop/bb761147) message, as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_REMOVEGROUP](https://msdn.microsoft.com/library/windows/desktop/bb761149) message, as described in the Windows SDK.  
...
### Parameters  
 *cr*  
 Background color to set, or the CLR_NONE value for no background color. List view controls with background colors redraw themselves significantly faster than those without background colors. For information, see [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetColumnOrderArray](https://msdn.microsoft.com/library/windows/desktop/bb775072), as described in the Windows SDK.  
 ...
 *cx*  
 The new width of the column. Can be either LVSCW_AUTOSIZE or LVSCW_AUTOSIZE_USEHEADER, as described in [LVM_SETCOLUMNWIDTH](https://msdn.microsoft.com/library/windows/desktop/bb761163) in the Windows SDK.  
...
### Parameters  
 *dwNewStyle*  
 A combination of extended styles to be used by the list view control. For a descriptive list of these styles, see the [Extended List View Styles](https://msdn.microsoft.com/library/windows/desktop/bb774732) topic in the Windows SDK.  
  
### Return Value  
 A combination of the previous extended styles used by the list view control.  
  
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetExtendedListViewStyle](https://msdn.microsoft.com/library/windows/desktop/bb775076), as described in the Windows SDK.  
 ...
 *pgrp*  
 Pointer to an [LVGROUP](https://msdn.microsoft.com/library/windows/desktop/bb774769) structure that contains the information to set. The caller is responsible for allocating this structure and setting its members.  
  
### Return Value  
 The ID of the group if the method is successful; otherwise, -1.  
  
### Remarks  
 This method sends the [LVM_SETGROUPINFO](https://msdn.microsoft.com/library/windows/desktop/bb761167) message, which is described in the Windows SDK.  
...
### Parameters  
 *pGroupMetrics*  
 A pointer to an [LVGROUPMETRICS](https://msdn.microsoft.com/library/windows/desktop/bb774752) structure containing the group metrics information to be set.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_SETGROUPMETRICS](https://msdn.microsoft.com/library/windows/desktop/bb761168) message, as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetHotCursor](https://msdn.microsoft.com/library/windows/desktop/bb775082), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetHotItem](https://msdn.microsoft.com/library/windows/desktop/bb775083), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetHoverTime](https://msdn.microsoft.com/library/windows/desktop/bb775084), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetIconSpacing](https://msdn.microsoft.com/library/windows/desktop/bb775085), as described in the Windows SDK.  
...
### Parameters  
 *plvInfoTip*  
 A pointer to an [LVFSETINFOTIP](https://msdn.microsoft.com/library/windows/desktop/bb774764) structure containing the information to be set.  
  
### Return Value  
 Returns TRUE on success, FALSE on failure.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_SETINFOTIP](https://msdn.microsoft.com/library/windows/desktop/bb761180) message, as described in the Windows SDK.  
...
### Parameters  
 *lvim*  
 A pointer to an [LVINSERTMARK](https://msdn.microsoft.com/library/windows/desktop/bb774758) structure specifying where to set the insertion point.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_SETINSERTMARK](https://msdn.microsoft.com/library/windows/desktop/bb761182) message, as described in the Windows SDK.  
...
### Parameters  
 *color*  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) structure specifying the color to set the insertion point.  
  
### Return Value  
 Returns a `COLORREF` structure containing the previous color.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_SETINSERTMARKCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb761184) message, as described in the Windows SDK.  
...
### Parameters  
 *pItem*  
 Address of an [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure that contains the new item attributes, as described in the Windows SDK. The structure's `iItem` and `iSubItem` members identify the item or subitem, and the structure's `mask` member specifies which attributes to set. For more information on the `mask` member, see the **Remarks**.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetItemCount](https://msdn.microsoft.com/library/windows/desktop/bb775093), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetItemCountEx](https://msdn.microsoft.com/library/windows/desktop/bb775095), as described in the Windows SDKand should only be called for virtual list views.  
...
|[in] *dwState*|The state to set the item, which is a bitwise combination of [list view item states](https://msdn.microsoft.com/library/windows/desktop/bb774733). Specify zero to reset, or one to set, a state.|  
|[in] *dwMask*|A mask of the valid bits of the state specified by the *dwState* parameter. Specify a bitwise combination (OR) of [list view item states](https://msdn.microsoft.com/library/windows/desktop/bb774733).|  
  
### Return Value  
 TRUE if this method is successful; otherwise, FALSE.  
  
### Remarks  
 For more information about the *dwState* parameter, see [List View Item States](https://msdn.microsoft.com/library/windows/desktop/bb774733).  
  
 For more information about the *dwMask* parameter, see the *stateMask* member of the [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure.  
  
 This method sends the [LVM_SETITEMINDEXSTATE](https://msdn.microsoft.com/library/windows/desktop/bb761190) message, which is described in the Windows SDK.  
 ...
 *pItem*  
 Address of an [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure, as described in the Windows SDK. The structure's `stateMask` member specifies which state bits to change, and the structure's `state` member contains the new values for those bits. The other members are ignored.  
  
 *nState*  
 New values for the state bits. For a list of possible values, see [CListCtrl::GetNextItem](#getnextitem) and the [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) state member.  
  
 *nMask*  
 Mask specifying which state bits to change. This value corresponds to the stateMask member of  the [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure.  
...
### Remarks  
 This method is not intended for use with controls containing the LVS_OWNERDATA window style (in fact, this will cause an assertion in Debug builds). For more information about this list control style, see [List-View Controls Overview](https://msdn.microsoft.com/library/windows/desktop/bb774735).  
  
### Example  
  See the example for [CListCtrl::InsertItem](#insertitem).  
  
##  <a name="setoutlinecolor"></a>  CListCtrl::SetOutlineColor  
 Sets the color of the border of a list-view control if the [LVS_EX_BORDERSELECT](https://msdn.microsoft.com/library/windows/desktop/bb774739) extended window style is set.  
...
### Parameters  
 *color*  
 The new [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) structure containing the outline color.  
  
### Return Value  
 The previous `COLORREF` structure containing the outline color  
  
### Remarks  
 This member function emulates the functionality of the [LVM_SETOUTLINECOLOR](https://msdn.microsoft.com/library/windows/desktop/bb761200) message, as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_SETSELECTEDCOLUMN](https://msdn.microsoft.com/library/windows/desktop/bb761202) message, as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetSelectionMark](https://msdn.microsoft.com/library/windows/desktop/bb775112), as described in the Windows SDK.  
...
### Parameters  
 *cr*  
 A COLORREF specifying the new text background color. For information, see [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) in the Windows SDK.  
...
### Parameters  
 *cr*  
 A COLORREF specifying the new text color. For information, see [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) in the Windows SDK.  
...
### Parameters  
 *pti*  
 A pointer to an [LVTILEINFO](https://msdn.microsoft.com/library/windows/desktop/bb774766) structure containing the information to be set.  
  
### Return Value  
 Returns TRUE on success, FALSE on failure.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_SETTILEINFO](https://msdn.microsoft.com/library/windows/desktop/bb761210) message, as described in the Windows SDK.  
...
### Parameters  
 *ptvi*  
 A pointer to an [LVTILEVIEWINFO](https://msdn.microsoft.com/library/windows/desktop/bb774768) structure containing the information to set.  
  
### Return Value  
 Returns TRUE on success, FALSE on failure.  
  
### Remarks  
 This member function emulates the functionality of the [LVM_SETTILEVIEWINFO](https://msdn.microsoft.com/library/windows/desktop/bb761212) message, as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [LVM_SETTOOLTIPS](https://msdn.microsoft.com/library/windows/desktop/bb761216), as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_SETVIEW](https://msdn.microsoft.com/library/windows/desktop/bb761220) message, as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SetWorkAreas](https://msdn.microsoft.com/library/windows/desktop/bb775128), as described in the Windows SDK.  
...
### Remarks  
 This member function emulates the functionality of the [LVM_SORTGROUPS](https://msdn.microsoft.com/library/windows/desktop/bb761225) message, as described in the Windows SDK.  
...
The comparison function must return a negative value if the first item should precede the second, a positive value if the first item should follow the second, or zero if the two items are equal.  
 ...
 The *lParam1* parameter is the 32-bit value associated with the first item that is compared, and the *lParam2* parameter is the value associated with the second item. These are the values that were specified in the *lParam* member of the items' [LVITEM](https://msdn.microsoft.com/library/windows/desktop/bb774760) structure when they were inserted into the list. The *lParamSort* parameter is the same as the *dwData* value.  
  
 This method sends the [LVM_SORTITEMS](https://msdn.microsoft.com/library/windows/desktop/bb761227) message, which is described in the Windows SDK.  
...
int CALLBACK CompareFunc(LPARAM lParam1,
    ...
    LPARAM lParamSort);
```  
This message is like [LVM_SORTITEMS](https://msdn.microsoft.com/library/windows/desktop/bb761227), except for the type of information passed to the comparison function. In [LVM_SORTITEMS](https://msdn.microsoft.com/library/windows/desktop/bb761227), *lParam1* and *lParam2* are the values of the items to compare. In [LVM_SORTITEMSEX](https://msdn.microsoft.com/library/windows/desktop/bb761228), *lParam1* is the current index of the first item to compare and *lParam2* is the current index of the second item. You can send an [LVM_GETITEMTEXT](https://msdn.microsoft.com/library/windows/desktop/bb761055) message to retrieve more information about an item.  
  
 The comparison function must return a negative value if the first item should precede the second, a positive value if the first item should follow the second, or zero if the two items are equal.  
  
> [!NOTE]
>  During the sorting process, the list-view contents are unstable. If the callback function sends any messages to the list-view control other than [LVM_GETITEM](https://msdn.microsoft.com/library/windows/desktop/bb774953), the results are unpredictable.  
  
 This method sends the [LVM_SORTITEMSEX](https://msdn.microsoft.com/library/windows/desktop/bb761228) message, which is described in the Windows SDK.  
...
### Parameters  
 *pInfo*  
 A pointer to the [LVHITTESTINFO](https://msdn.microsoft.com/library/windows/desktop/bb774754) structure.  
  
### Return Value  
 The one-based index of the item, or subitem, being tested (if any), or -1 otherwise.  
  
### Remarks  
 This member function implements the behavior of the Win32 macro, [ListView_SubItemHitTest](https://msdn.microsoft.com/library/windows/desktop/bb775135), as described in the Windows SDK.  
