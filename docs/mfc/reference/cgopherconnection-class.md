 ...
 *dwGopherType*  
 This specifies whether *pstrSelectorString* refers to a directory or document, and whether the request is gopher or gopher+. See the attributes for the structure [GOPHER_FIND_DATA](https://msdn.microsoft.com/library/windows/desktop/aa384215) in the Windows SDK.  
