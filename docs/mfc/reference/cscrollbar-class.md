...
### Parameters  
 *pScrollInfo*  
 A pointer to the [SCROLLBARINFO](https://msdn.microsoft.com/library/windows/desktop/bb787535) structure.  
  
### Return Value  
 Returns TRUE on success, FALSE on failure.  
  
### Remarks  
 This member function emulates the functionality of the [SBM_SCROLLBARINFO](https://msdn.microsoft.com/library/windows/desktop/bb787545) message, as described in the Windows SDK.  
...
### Parameters  
 *lpScrollInfo*  
 A pointer to a [SCROLLINFO](https://msdn.microsoft.com/library/windows/desktop/bb787537) structure.  
