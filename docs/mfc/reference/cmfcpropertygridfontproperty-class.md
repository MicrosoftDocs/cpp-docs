...
### Parameters  
 ...
 Styles that are applied to the font dialog box that is displayed when you click the property value drop-down button. The default value is the bitwise combination (OR) of CF_EFFECTS and CF_SCREENFONTS. For more information, see the *Flags* parameter of the [CHOOSEFONT Structure](https://msdn.microsoft.com/library/windows/desktop/ms646832).  
...
### Return Value  
 A pointer to a [LOGFONT](https://msdn.microsoft.com/library/windows/desktop/dd145037) structure that describes the selected font.  
