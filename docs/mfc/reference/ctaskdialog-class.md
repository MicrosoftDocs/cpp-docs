...
This method calls [ShellExecute](https://msdn.microsoft.com/library/windows/desktop/bb762153) before it returns S_OK.
...
|TDN_HYPERLINK_CLICKED|Not used.|A [LPCWSTR](https://msdn.microsoft.com/library/windows/desktop/aa383751) structure that contains the link.|
