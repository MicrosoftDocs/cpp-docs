...
|[CPagerCtrl::ForwardMouse](#forwardmouse)|Enables or disables forwarding [WM_MOUSEMOVE](https://msdn.microsoft.com/library/windows/desktop/ms645616) messages to the window that is contained in the current pager control.|  
...
|[CPagerCtrl::GetDropTarget](#getdroptarget)|Retrieves the [IDropTarget](https://msdn.microsoft.com/library/windows/desktop/ms679679) interface for the current pager control.|  
...
## Remarks  
 ...
 The `CPagerCtrl` class is derived from the [CWnd](../../mfc/reference/cwnd-class.md) class. For more information and an illustration of a pager control, see [Pager Controls](https://msdn.microsoft.com/library/windows/desktop/bb760855).  
...
|---------------|-----------------|  
|[in] *dwStyle*|A bitwise combination (OR) of [window styles](../../mfc/reference/styles-used-by-mfc.md#window-styles) and [pager control styles](https://msdn.microsoft.com/library/windows/desktop/bb760859) to be applied to the control.|  
|[in] *rect*|A reference to a [RECT](https://msdn.microsoft.com/library/windows/desktop/dd162897) structure that contains the position and size of the control in client coordinates.|  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] *dwExStyle*|A bitwise combination of extended styles to be applied to the control. For more information, see the *dwExStyle* parameter of the [CreateWindowEx](https://msdn.microsoft.com/library/windows/desktop/ms632680) function.|  
|[in] *dwStyle*|A bitwise combination (OR) of [window styles](../../mfc/reference/styles-used-by-mfc.md#window-styles) and [pager control styles](https://msdn.microsoft.com/library/windows/desktop/bb760859) to be applied to the control.|  
|[in] *rect*|A reference to a [RECT](https://msdn.microsoft.com/library/windows/desktop/dd162897) structure that contains the position and size of the control in client coordinates.|  
|[in] *pParentWnd*|A pointer to a [CWnd](../../mfc/reference/cwnd-class.md) object that is the parent window of the control. This parameter cannot be NULL.|  
|[in] *nID*|The ID of the control.|  
...
##  <a name="forwardmouse"></a>  CPagerCtrl::ForwardMouse  
 Enables or disables forwarding [WM_MOUSEMOVE](https://msdn.microsoft.com/library/windows/desktop/ms645616) messages to the window that is contained in the current pager control.  
...
### Remarks  
 This method sends the [PGM_FORWARDMOUSE](https://msdn.microsoft.com/library/windows/desktop/bb760867) message, which is described in the Windows SDK.  
...
### Remarks  
 This method sends the [PGM_GETBORDER](https://msdn.microsoft.com/library/windows/desktop/bb760869) message, which is described in the Windows SDK.  
...
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) value that contains the current background color of the pager control.  
  
### Remarks  
 This method sends the [PGM_GETBKCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb760868) message, which is described in the Windows SDK.  
...
### Remarks  
 This method sends the [PGM_GETBUTTONSIZE](https://msdn.microsoft.com/library/windows/desktop/bb760870) message, which is described in the Windows SDK.  
  
 If the pager control has the PGS_HORZ style, the button size determines the width of the pager buttons, and if the pager control has the PGS_VERT style, the button size determines the height of the pager buttons. For more information, see [Pager Control Styles](https://msdn.microsoft.com/library/windows/desktop/bb760859).  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] *iButton*|Indicates the button for which the state is retrieved. If the pager control style is PGS_HORZ, specify PGB_TOPORLEFT for the left button and PGB_BOTTOMORRIGHT for the right button. If the pager control style is PGS_VERT, specify PGB_TOPORLEFT for the top button and PGB_BOTTOMORRIGHT for the bottom button. For more information, see [Pager Control Styles](https://msdn.microsoft.com/library/windows/desktop/bb760859).|  
  
### Return Value  
 The state of the button specified by the *iButton* parameter. The state is either PGF_INVISIBLE, PGF_NORMAL, PGF_GRAYED, PGF_DEPRESSED, or PGF_HOT. For more information, see the Return Value section of the [PGM_GETBUTTONSTATE](https://msdn.microsoft.com/library/windows/desktop/bb760871) message.  
  
### Remarks  
 This method sends the [PGM_GETBUTTONSTATE](https://msdn.microsoft.com/library/windows/desktop/bb760871) message, which is described in the Windows SDK.  
  
##  <a name="getdroptarget"></a>  CPagerCtrl::GetDropTarget  
 Retrieves the [IDropTarget](https://msdn.microsoft.com/library/windows/desktop/ms679679) interface for the current pager control.  
...
### Remarks  
 ...
 This method sends the [PGM_GETDROPTARGET](https://msdn.microsoft.com/library/windows/desktop/bb760872) message, which is described in the Windows SDK. The caller of this method is responsible for calling the `Release` member of the [IDropTarget](https://msdn.microsoft.com/library/windows/desktop/ms679679) interface when the interface is no longer needed.  
...
### Remarks  
 This method sends the [PGM_GETPOS](https://msdn.microsoft.com/library/windows/desktop/bb760874) message, which is described in the Windows SDK.  
...
### Remarks  
 This method sends the [PGM_RECALCSIZE](https://msdn.microsoft.com/library/windows/desktop/bb760876) message, which is described in the Windows SDK. Consequently, the pager control sends the [PGN_CALCSIZE](https://msdn.microsoft.com/library/windows/desktop/bb760864) notification to obtain the scrollable dimensions of the contained window.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[in] *clrBk*|A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) value that contains the new background color of the pager control.|  
  
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) value that contains the previous background color of the pager control.  
  
### Remarks  
 This method sends the [PGM_SETBKCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb760878) message, which is described in the Windows SDK.  
...
### Remarks  
 This method sends the [PGM_SETBORDER](https://msdn.microsoft.com/library/windows/desktop/bb760880) message, which is described in the Windows SDK.  
...
### Remarks  
 This method sends the [PGM_SETBUTTONSIZE](https://msdn.microsoft.com/library/windows/desktop/bb760886) message, which is described in the Windows SDK.  
  
 If the pager control has the PGS_HORZ style, the button size determines the width of the pager buttons, and if the pager control has the PGS_VERT style, the button size determines the height of the pager buttons. The default button size is three-fourths of the width of the scroll bar, and the minimum button size is 12 pixels. For more information, see [Pager Control Styles](https://msdn.microsoft.com/library/windows/desktop/bb760859).  
...
### Remarks  
 This method sends the [PGM_SETCHILD](https://msdn.microsoft.com/library/windows/desktop/bb760884) message, which is described in the Windows SDK.  
...
### Remarks  
 This method sends the [PGM_SETPOS](https://msdn.microsoft.com/library/windows/desktop/bb760886) message, which is described in the Windows SDK.  
  
## See Also  
 [CPagerCtrl Class](../../mfc/reference/cpagerctrl-class.md)   
 [Hierarchy Chart](../../mfc/hierarchy-chart.md)   
 [Pager Controls](https://msdn.microsoft.com/library/windows/desktop/bb760855)
