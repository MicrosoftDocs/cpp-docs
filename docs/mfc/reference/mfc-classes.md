...
## In This Section  
 ...
 Handles the calling of the Windows functions [GetDC](https://msdn.microsoft.com/library/windows/desktop/dd144871) at construction time and [ReleaseDC](https://msdn.microsoft.com/library/windows/desktop/dd162920) at destruction time.  
