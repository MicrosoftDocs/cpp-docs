...
|[CPen::CreatePenIndirect](#createpenindirect)|Creates a pen with the style, width, and color given in a [LOGPEN](https://msdn.microsoft.com/library/windows/desktop/dd145041) structure, and attaches it to the `CPen` object.|  
|[CPen::FromHandle](#fromhandle)|Returns a pointer to a `CPen` object when given a Windows HPEN.|  
|[CPen::GetExtLogPen](#getextlogpen)|Gets an [EXTLOGPEN](https://msdn.microsoft.com/library/windows/desktop/dd162711) underlying structure.|  
|[CPen::GetLogPen](#getlogpen)|Gets a [LOGPEN](https://msdn.microsoft.com/library/windows/desktop/dd145041) underlying structure.|  
...
- PS_JOIN_MITER Joins are mitered when they are within the current limit set by the [SetMiterLimit](https://msdn.microsoft.com/library/windows/desktop/dd145076) function. If the join exceeds this limit, it is beveled.  
 ...
 *pLogBrush*  
 Points to a [LOGBRUSH](https://msdn.microsoft.com/library/windows/desktop/dd145035) structure. If *nPenStyle* is PS_COSMETIC, the `lbColor` member of the `LOGBRUSH` structure specifies the color of the pen and the *lbStyle* member of the `LOGBRUSH` structure must be set to BS_SOLID. If nPenStyle is PS_GEOMETRIC, all members must be used to specify the brush attributes of the pen.  
...
### Parameters  
 *pLogPen*  
 Points to an [EXTLOGPEN](https://msdn.microsoft.com/library/windows/desktop/dd162711) structure that contains information about the pen.  
...
- [GetObject](https://msdn.microsoft.com/library/windows/desktop/dd144904)  
  
- [EXTLOGPEN](https://msdn.microsoft.com/library/windows/desktop/dd162711)  
  
- [LOGPEN](https://msdn.microsoft.com/library/windows/desktop/dd145041)  
  
- [ExtCreatePen](https://msdn.microsoft.com/library/windows/desktop/dd162705)  
...
### Parameters  
 *pLogPen*  
 Points to a [LOGPEN](https://msdn.microsoft.com/library/windows/desktop/dd145041) structure to contain information about the pen.  
...
### Remarks  
 ...
 For more information about using graphic objects, see the article [Graphic Objects](https://msdn.microsoft.com/library/windows/desktop/dd144962) in Windows SDK.  
