...
For more information, see the [CURRENCY](/windows/desktop/api/wtypes/ns-wtypes-tagcy) and [VARIANT](/windows/win32/api/oaidl/ns-oaidl-variant) entries in the Windows SDK.
