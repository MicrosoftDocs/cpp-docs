...
## Remarks  
 ...
 For more information, see the [OLEUIPASTESPECIAL](https://msdn.microsoft.com/library/windows/desktop/ms692434) structure in the Windows SDK.  
...
### Remarks  
 ...
 For more information, see the [TYMED](https://msdn.microsoft.com/library/windows/desktop/ms691227) enumeration type and the [FORMATETC](https://msdn.microsoft.com/library/windows/desktop/ms682177) structure in the Windows SDK.  
  
 For more information, see the [OLEUIPASTEFLAG](https://msdn.microsoft.com/library/windows/desktop/ms682172) enumerated type in the Windows SDK.  
...
### Return Value  
 An [OLEUIPASTEFLAG](https://msdn.microsoft.com/library/windows/desktop/ms682172) structure containing the information for the new link entry.  
...
- IDABORT if an error occurred. If IDABORT is returned, call the `COleDialog::GetLastError` member function to get more information about the type of error that occurred. For a listing of possible errors, see the [OleUIPasteSpecial](https://msdn.microsoft.com/library/windows/desktop/ms694512) function in the Windows SDK.  
...
### Remarks  
 ...
 For more information on drawing aspect, see the [FORMATETC](https://msdn.microsoft.com/library/windows/desktop/ms682177) structure in the Windows SDK.  
...
### Remarks  
 For more information, see the [OLEUIPASTEENTRY](https://msdn.microsoft.com/library/windows/desktop/ms690165) structure in the Windows SDK.  
