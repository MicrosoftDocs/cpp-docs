...
-   Using the C++ **new** and **delete** operators.  
 ...
 For more information about how to use `CMemoryState` and other diagnostics, see [Debugging MFC Applications](/visual-studio/debugger/mfc-debugging-techniques).  
