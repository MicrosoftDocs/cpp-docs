...
|[CDHtmlDialog::GetDropTarget](#getdroptarget)|Called by the contained WebBrowser control when it is being used as a drop target to allow the dialog to supply an alternative [IDropTarget](https://msdn.microsoft.com/library/windows/desktop/ms679679).|  
...
##  <a name="getdroptarget"></a>  CDHtmlDialog::GetDropTarget  
 Called by the contained WebBrowser control when it is being used as a drop target to allow the dialog to supply an alternative [IDropTarget](https://msdn.microsoft.com/library/windows/desktop/ms679679).  
