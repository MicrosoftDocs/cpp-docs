...
*pPrintDlg*  
A pointer to a [PRINTDLG](https://msdn.microsoft.com/library/windows/desktop/ms646843) structure.
...
> [!IMPORTANT]
> The data returned by this function is not necessarily NULL terminated, and the caller must perform validation. For more information, see [Avoiding Buffer Overruns](https://msdn.microsoft.com/library/windows/desktop/ms717795).
...
*nIDResource*  
ID of the cursor resource. For a list of resources, see [LoadCursor](https://msdn.microsoft.com/library/windows/desktop/ms648391) in the Windows SDK.
...
> [!NOTE]
> This member function calls the Win32 API function [LoadIcon](https://msdn.microsoft.com/library/windows/desktop/ms648072), which can only load an icon whose size conforms to the SM_CXICON and SM_CYICON system metric values.
...
*lpszIconName*  
A manifest constant identifier that specifies a predefined Windows icon. These identifiers are defined in WINDOWS.H. For a list of the possible predefined values and their descriptions, see the *lpIconName* parameter in [LoadIcon](https://msdn.microsoft.com/library/windows/desktop/ms648072) in the Windows SDK.
...
*hDevMode*  
A handle to a [DEVMODE](https://msdn.microsoft.com/library/windows/desktop/dd183565) structure that specifies information about the device initialization and environment of a printer.
...
*nCmd*  
Specifies the type of help requested. For a list of possible values and how they affect the *dwData* parameter, see the [WinHelp](https://msdn.microsoft.com/library/windows/desktop/bb762267) Windows function.
