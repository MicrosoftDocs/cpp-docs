...
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that specifies the text color of *pButton*.  
...
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that indicates the color of the text in *pBar*.  
...
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that indicates the background color of *pPropList*.  
...
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that indicates the text color of the property list.  
...
### Parameters  
 ...
 [out] *clrText*  
 A reference to a [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter. This is a reserved value and is currently unused.  
...
### Parameters  
 ...
 [in] *clrBar*  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter that indicates the initial color for the progress bar. The value is either the start of a color gradient or the complete color of the progress bar.  
...
### Parameters  
 ...
 [out] *clrText*  
 A reference to a [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter. The method writes the color of text on the caption bar to this parameter.  
...
### Parameters  
 ...
 [out] *clrText*  
 A reference to a [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) parameter. This method stores the text color of the outlook page button in this parameter.  
