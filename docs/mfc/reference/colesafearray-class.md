...
### Parameters  
 *varSrc*  
 A `VARIANT` object. The *varSrc* parameter must have the [VARTYPE](https://msdn.microsoft.com/317b911b-1805-402d-a9cb-159546bc88b4)VT_ARRAY.  
...
### Remarks  
 The function detaches the data in a safe array by setting the [VARTYPE](https://msdn.microsoft.com/317b911b-1805-402d-a9cb-159546bc88b4) of the object to VT_EMPTY. It is the caller's responsibility to free the array by calling the Windows function [VariantClear](/previous-versions/windows/desktop/api/oleauto/nf-oleauto-variantclear).  
