...
Once you have defined a message handler, you can go to the member function's definition to add or modify code.  
 ...
 To jump to a member function definition from [Class View](http://msdn.microsoft.com/8d7430a9-3e33-454c-a9e1-a85e3d2db925), double-click the function name in Class View.  
