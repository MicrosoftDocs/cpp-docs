...
- **Data Source**
   ...
   The **Data Source** button lets you set up the specified data source using the specified ODBC driver. For more information about data source files (DSN), see [File Data Sources](/previous-versions/windows/desktop/ms715401\(v=vs.85\)) in the ODBC SDK.
   ...
   - **Machine Data Source** tab:
      ...
      This tab lists system and User DATA sources. User data sources are specific to a user on this machine. System data sources can be used by all users on this machine or on a systemwide service. See [Machine Data Sources](/previous-versions/windows/desktop/ms710952\(v=vs.85\)) in the ODBC SDK  
