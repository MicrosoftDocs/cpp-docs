...
### Remarks  
 ...
 This member function implements the behavior of the Win32 message [TTM_ADJUSTRECT](https://msdn.microsoft.com/library/windows/desktop/bb760352), as described in the Windows SDK.  
...
### Parameters  
 *lpToolInfo*  
 A pointer to the tool tip's [TOOLINFO](https://msdn.microsoft.com/library/windows/desktop/bb760256) structure.  
  
### Return Value  
 The size of the tool tip.  
  
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_GETBUBBLESIZE](https://msdn.microsoft.com/library/windows/desktop/bb760387), as described in the Windows SDK.  
...
|---------------|-----------------|  
|[out] *lpToolInfo*|Pointer to a [TOOLINFO](https://msdn.microsoft.com/library/windows/desktop/bb760256) structure that receives information about the current tooltip window.|  
  
### Return Value  
 TRUE if the information is retrieved successfully; otherwise, FALSE.  
  
### Remarks  
 This method sends the [TTM_GETCURRENTTOOL](https://msdn.microsoft.com/library/windows/desktop/bb760389) message, which is described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_GETDELAYTIME](https://msdn.microsoft.com/library/windows/desktop/bb760390), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_GETMARGIN](https://msdn.microsoft.com/library/windows/desktop/bb760391), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_GETMAXTIPWIDTH](https://msdn.microsoft.com/library/windows/desktop/bb760392), as described in the Windows SDK.  
...
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) value that represents the background color.  
  
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_GETTIPBKCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb760394), as described in the Windows SDK.  
...
### Return Value  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) value that represents the text color.  
  
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_GETTIPTEXTCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb760395), as described in the Windows SDK.  
...
|Parameter|Description|  
|---------------|-----------------|  
|[out] *pttgt*|Pointer to a [TTGETTITLE](https://msdn.microsoft.com/library/windows/desktop/bb760260) structure that contains information about the ToolTip control. When this method returns, the *pszTitle* member of the [TTGETTITLE](https://msdn.microsoft.com/library/windows/desktop/bb760260) structure points to the text of the title.|  
  
### Remarks  
 This method sends the [TTM_GETTITLE](https://msdn.microsoft.com/library/windows/desktop/bb760396) message, which is described in the Windows SDK.  
 ...
 *lpToolInfo*  
 Pointer to [TOOLINFO](https://msdn.microsoft.com/library/windows/desktop/bb760256) structure that contains information about the tool.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_POP](https://msdn.microsoft.com/library/windows/desktop/bb760401), as described in the Windows SDK.  
...
### Remarks  
 This method sends the [TTM_POPUP](https://msdn.microsoft.com/library/windows/desktop/bb760402) message, which is described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_SETMARGIN](https://msdn.microsoft.com/library/windows/desktop/bb760406), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_SETMAXTIPWIDTH](https://msdn.microsoft.com/library/windows/desktop/bb760408), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_SETTIPBKCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb760411), as described in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_SETTIPTEXTCOLOR](https://msdn.microsoft.com/library/windows/desktop/bb760413), as described in the Windows SDK.  
...
### Parameters  
 *uIcon*  
 See *icon* in [TTM_SETTITLE](https://msdn.microsoft.com/library/windows/desktop/bb760414) in the Windows SDK.  
...
### Remarks  
 This member function implements the behavior of the Win32 message [TTM_SETTITLE](https://msdn.microsoft.com/library/windows/desktop/bb760414), as described in the Windows SDK.  
...
### Parameters  
 *lpToolInfo*  
 A pointer to a [TOOLINFO](https://msdn.microsoft.com/library/windows/desktop/bb760256) structure that specifies the information to set.  
...
### Remarks  
 This member function emulates the functionality of the [TTM_SETWINDOWTHEME](https://msdn.microsoft.com/library/windows/desktop/bb760418) message, as described in the Windows SDK.  
