...
|[CMFCRibbonPanel::GetPreferredMenuLocation](#getpreferredmenulocation)||
...
##  <a name="getpreferredmenulocation"></a>  CMFCRibbonPanel::GetPreferredMenuLocation

Retrieves the preferred display rectangle for the pop-up menu of the ribbon panel.

```
virtual BOOL GetPreferredMenuLocation(CRect& rect);
```
