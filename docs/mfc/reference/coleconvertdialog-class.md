...
For more information, see the [OLEUICONVERT](https://msdn.microsoft.com/library/windows/desktop/ms686657) structure in the Windows SDK.  
...
### Remarks  
 ...
 For more information, see [CLSID Key](https://msdn.microsoft.com/library/windows/desktop/ms691424) and the [OLEUICONVERT](https://msdn.microsoft.com/library/windows/desktop/ms686657) structure.  
...
- IDABORT if an error occurred. If IDABORT is returned, call the [COleDialog::GetLastError](../../mfc/reference/coledialog-class.md#getlasterror) member function to get more information about the type of error that occurred. For a listing of possible errors, see the [OleUIConvert](https://msdn.microsoft.com/library/windows/desktop/ms680694) function in the Windows SDK.  
...
### Remarks  
 ...
 For more information on drawing aspect, see the [FORMATETC](https://msdn.microsoft.com/library/windows/desktop/ms682177) data structure in the Windows SDK.  
