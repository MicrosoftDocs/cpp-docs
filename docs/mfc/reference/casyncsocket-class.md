...
>  When using MFC sockets in secondary threads in a statically linked MFC application, you must call `AfxSocketInit` in each thread that uses sockets to initialize the socket libraries. By default, `AfxSocketInit` is called only in the primary thread.  
 ...
 For more information, see [Windows Sockets: Using Class CAsyncSocket](../../mfc/windows-sockets-using-class-casyncsocket.md) and related articles., as well as [Windows Sockets 2 API](https://msdn.microsoft.com/library/windows/desktop/ms740673).  
...
### Remarks  
 ...
 For more information about the error codes, see [Windows Sockets 2 API](https://msdn.microsoft.com/library/windows/desktop/ms740673).  
