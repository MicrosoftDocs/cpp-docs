...
### Remarks  
 ...
 For more information, see the [PRINTDLG](https://msdn.microsoft.com/library/windows/desktop/ms646843) structure in the Windows SDK.  
  
 For more information, see the [DVTARGETDEVICE](https://msdn.microsoft.com/library/windows/desktop/ms686613) structure in the Windows SDK.  
