...
### Remarks  
 If you enable sound, the framework calls the [PlaySound](https://msdn.microsoft.com/library/windows/desktop/bb774426) method when a user opens a pop-up menu or selects a menu command. By default, this feature is enabled.  
