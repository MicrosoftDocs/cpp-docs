...
### Remarks  
 `GetLength` uses the Win32 structure [WIN32_FIND_DATA](https://msdn.microsoft.com/library/windows/desktop/aa365740) to get the value of the file size in bytes.  
