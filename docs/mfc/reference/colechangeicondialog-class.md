...
## Remarks  
 ...
 For more information, see the [OLEUICHANGEICON](https://msdn.microsoft.com/library/windows/desktop/ms680098) structure in the Windows SDK.  
