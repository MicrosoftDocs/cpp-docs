...
- [CDialog::OnSetFont](../../mfc/reference/cdialog-class.md#onsetfont)  
 ...
 To use a `CFileDialog` object, first create the object by using the `CFileDialog` constructor. After the dialog box has been constructed, you can set or modify any values in the [CFileDialog::m_ofn](#m_ofn) structure to initialize the values or states of the dialog box controls. The `m_ofn` structure is of type `OPENFILENAME`. For more information, see the [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure in the Windows SDK.  
...
> Under Windows Vista or later, multiple calls to [IFileDialog::SetFileTypes](https://msdn.microsoft.com/library/windows/desktop/bb775980) causes an error. The second call to `SetFileTypes` for any instance of a `CFileDialog` will return E_UNEXPECTED in Windows Vista or later. Some `CFileDialog` method functions call `SetFileTypes`. For example, two calls to `CFileDialog::DoModal` for the same instance of a `CFileDialog` generates [ASSERT](diagnostic-services.md#assert).  
 ...
 You can use the Windows [CommDlgExtendedError](https://msdn.microsoft.com/library/windows/desktop/ms646916) function to determine whether an error occurred during initialization of the dialog box and to learn more about the error.  
...
### Parameters  
 ...
 [in] *dwFlags*  
 A combination of one or more flags that you can use to customize the dialog box. For a description of these flags, see the [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure in the Windows SDK. If you modify the `m_ofn.Flags` structure member, use a bitwise-OR operator in your changes to keep the default behavior intact.  
...
### Remarks  
 ...
 For more information about the `IFileDialogCustomize` interface,  see [IFileDialogCustomize](https://msdn.microsoft.com/library/windows/desktop/bb775912).  
...
### Remarks  
 ...
 For more information about the `IFileSaveDialog` interface, see [IFileSaveDialog](https://msdn.microsoft.com/library/windows/desktop/bb775688).  
...
### Return Value  
 An [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure.  
...
-   OFN_SHOWHELP  
 ...
 For more information about this structure, see the [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure in the Windows SDK.  
...
### Remarks  
 ...
 The system sends this message only if the dialog box was created with the OFN_EXPLORER flag turned on. For more information about the notification, see [CDN_SELCHANGE](https://msdn.microsoft.com/library/windows/desktop/ms646865). For information about the OFN_EXPLORER flag, see the [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure and [Open and Save As Dialog Boxes](https://msdn.microsoft.com/library/windows/desktop/ms646960).  
...
### Remarks  
 ...
 Notification is sent only if the dialog box was created with the OFN_EXPLORER style. For more information about the notification, see [CDN_FOLDERCHANGE](https://msdn.microsoft.com/library/windows/desktop/ms646859). For information about the OFN_EXPLORER style, see the [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure and [Open and Save As Dialog Boxes](https://msdn.microsoft.com/library/windows/desktop/ms646960).  
...
### Remarks  
 ...
 The system sends this only if the dialog box was created with the OFN_EXPLORER style. For more information about the notification, see [CDN_INITDONE](https://msdn.microsoft.com/library/windows/desktop/ms646863). For information about the OFN_EXPLORER style, see the [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure and [Open and Save As Dialog Boxes](https://msdn.microsoft.com/library/windows/desktop/ms646960).  
...
### Remarks  
 ...
 Notification is sent only if the dialog box was created with the OFN_EXPLORER style. For more information about the notification, see [CDN_TYPECHANGE](https://msdn.microsoft.com/library/windows/desktop/ms646868). For information about the OFN_EXPLORER style, see the [OPENFILENAME](https://msdn.microsoft.com/library/windows/desktop/ms646839) structure and [Open and Save As Dialog Boxes](https://msdn.microsoft.com/library/windows/desktop/ms646960).  
...
### Parameters  
 *lpszPropList*  
 A list of predefined properties separated by ";". For a list of the flags, see the **Flags** section of [OPENFILENAME](https://msdn.microsoft.com/8cecfd45-f7c1-4f8d-81a0-4e7fecc3b104).  
...
> [!NOTE]
> Windows Vista or later style file dialog boxes do not support this function. Attempting to use this function on a Windows Vista or later style file dialog box will throw [CNotSupportedException](../../mfc/reference/cnotsupportedexception-class.md). An alternative is to use a customized dialog. For more information about using a custom `CFileDialog`, see [IFileDialogCustomize](https://msdn.microsoft.com/library/windows/desktop/bb775912).  
