...
### Remarks  
 ...
 For a list of Win32 error codes, see [Error Codes](https://msdn.microsoft.com/library/windows/desktop/ms681381). For a list of Internet-specific error messages, see  . Both topics are in the Windows SDK.  
