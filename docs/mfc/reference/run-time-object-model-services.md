 ...
 *nFlags*  
 Contains one or more of the following flags:  
    ...
    -   `afxRegFreeThreading` Sets the threading model in the registry to ThreadingModel=Free.  
         ...
         You can combine the two flags `afxRegApartmentThreading` and `afxRegFreeThreading` to set ThreadingModel=Both. See [InprocServer32](https://msdn.microsoft.com/library/windows/desktop/ms682390) in the Windows SDK for more information on threading model registration. 
...
### See Also  
 ...
 [CLSID Key](https://msdn.microsoft.com/library/windows/desktop/ms691424)
