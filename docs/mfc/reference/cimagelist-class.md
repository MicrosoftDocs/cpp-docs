...
##  <a name="copy"></a>  CImageList::Copy  
 This member function implements the behavior of the Win32 function [ImageList_Copy](https://msdn.microsoft.com/library/windows/desktop/bb761520), as described in the Windows SDK.  
 ...
 *sz*  
 Size of the portion of the image to draw relative to the upper-left corner of the image. See *dx* and *dy* in [ImageList_DrawEx](https://msdn.microsoft.com/library/windows/desktop/bb761536) in the Windows SDK.  
  
 *clrBk*  
 Background color of the image. See *rgbBk* in [ImageList_DrawEx](https://msdn.microsoft.com/library/windows/desktop/bb761536) in the Windows SDK.  
  
 *clrFg*  
 Foreground color of the image. See *rgbFg* in [ImageList_DrawEx](https://msdn.microsoft.com/library/windows/desktop/bb761536) in the Windows SDK.  
  
 *nStyle*  
 Flag specifying the drawing style. See *fStyle* in [ImageList_DrawEx](https://msdn.microsoft.com/library/windows/desktop/bb761536) in the Windows SDK.  
...
### Parameters  
 *pimldp*  
 A pointer to an [IMAGELISTDRAWPARAMS](https://msdn.microsoft.com/library/windows/desktop/bb761395) structure that contains information about the draw operation.  
 ...
 *fStyle*  
 ...
 Other possible styles are described under the *fStyle* member of the [IMAGELISTDRAWPARAMS](https://msdn.microsoft.com/library/windows/desktop/bb761395) structure.  
 ...
 *dwRop*  
 ...
 Other possible values are described under the *dwRop* member of the [IMAGELISTDRAWPARAMS](https://msdn.microsoft.com/library/windows/desktop/bb761395) structure.  
 ...
 *crEffect*  
 A [COLORREF](https://msdn.microsoft.com/library/windows/desktop/dd183449) value used for glow and shadow effects.  
...
### Remarks  
 This method relies on the behavior of the [ImageList_ExtractIcon](https://msdn.microsoft.com/library/windows/desktop/bb761401) macro to create the icon. Refer to the [ImageList_ExtractIcon](https://msdn.microsoft.com/library/windows/desktop/bb761401) macro for more information on icon creation and cleanup.  
 ...
 *pImageInfo*  
 Pointer to an [IMAGEINFO](https://msdn.microsoft.com/library/windows/desktop/bb761393) structure that receives information about the image. The information in this structure can be used to directly manipulate the bitmaps for the image.  
...
### Remarks  
 Because the dragging functions use the new image during a drag operation, you should use the Windows [ShowCursor](https://msdn.microsoft.com/library/windows/desktop/ms648396) function to hide the actual mouse cursor after calling `CImageList::SetDragCursorImage`. Otherwise, the system may appear to have two mouse cursors for the duration of the drag operation.  
