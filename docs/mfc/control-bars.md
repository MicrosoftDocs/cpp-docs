...
---
# Control Bars
"Control bar" is the general name for toolbars, status bars, and dialog bars. MFC classes `CToolBar`, `CStatusBar`, `CDialogBar`, `COleResizeBar`, and **CReBar** derive from class [CControlBar](../mfcref/ccontrolbar-class.md), which implements their common functionality.  
...
-   Toolbars, in class [CToolBar](../mfcref/ctoolbar-class.md)  
  
-   Status bars, in class [CStatusBar](../mfcref/cstatusbar-class.md)  
  
-   Dialog bars, in class [CDialogBar](../mfcref/cdialogbar-class.md)  
  
-   Rebars, in class [CReBar](../mfcref/crebar-class.md)  
