...
##  <a name="_core_customizing_the_dodataexchange_function"></a> Customizing the DoDataExchange Function  
 ...
 [!code[NVC_MFC_AxUI#31](../mfc/codesnippet/CPP/mfc-activex-controls--property-pages_1.cpp)]  
 ...
 [Property Pages](../mfcref/property-pages--mfc-.md) are available for other dialog control types, such as check boxes, radio buttons, and list boxes. The table below lists the entire set of property page **DDP_** functions and their purposes:  
