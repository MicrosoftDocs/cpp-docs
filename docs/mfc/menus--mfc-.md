...
helpviewer_keywords: 
  ...
  - "menus, MFC resources for working with"
...
-   Class [CMenu](../mfcref/cmenu-class.md) for manipulating your program's menus at run time. Use the documentation for `CMenu` and the sample to learn how to use `CMenu` effectively.  
