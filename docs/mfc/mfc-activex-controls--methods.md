...
An ActiveX control fires events to communicate between itself and its control container. A container can also communicate with a control by means of methods and properties. Methods are also called functions.  
 ...
 [!code[NVC_MFC_AxUI#13](../mfc/codesnippet/CPP/mfc-activex-controls--methods_1.h)]  
 ...
 [!code[NVC_MFC_AxUI#14](../mfc/codesnippet/CPP/mfc-activex-controls--methods_2.cpp)]  
[!code[NVC_MFC_AxUI#15](../mfc/codesnippet/CPP/mfc-activex-controls--methods_3.cpp)]  
  
 If you used the [MFC ActiveX Control Wizard](../mfcref/mfc-activex-control-wizard.md) to create the project, these lines were added automatically. If the MFC ActiveX Control Wizard was not used, you must add these lines manually.  
