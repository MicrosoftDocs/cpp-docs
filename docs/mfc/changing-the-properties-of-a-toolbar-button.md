...
2.  Type the new ID in the **ID** property in the [Properties Window](/visual-studio/ide/reference/properties-window), or use the drop-down list to select a new **ID**.  
