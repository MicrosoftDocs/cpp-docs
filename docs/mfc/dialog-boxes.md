...
-   Create an application whose user interface is a dialog box: see the [CMNCTRL1](../top/visual-c---samples.md) or [CMNCTRL2](../top/visual-c---samples.md) sample programs. The Application Wizard provides this option as well.  
