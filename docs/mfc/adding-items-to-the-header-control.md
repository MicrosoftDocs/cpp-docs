...
1.  Prepare an [HD_ITEM](https://msdn.microsoft.com/library/windows/desktop/bb775247) structure.  
...
3.  Repeat steps 1 and 2 for additional items.  
 ...
 For more information, see [Adding an Item to a Header Control](https://msdn.microsoft.com/library/windows/desktop/bb775238) in the Windows SDK.  
