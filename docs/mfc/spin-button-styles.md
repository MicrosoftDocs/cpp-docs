...
---
# Spin Button Styles
Many of the settings for a spin button ([CSpinButtonCtrl](../mfcref/cspinbuttonctrl-class.md)) are controlled by styles. You can set the following styles using the **Properties** window in the dialog editor.  
