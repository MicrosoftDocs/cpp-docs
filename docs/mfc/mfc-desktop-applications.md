...
[C++ Libraries Reference](../standard-library/cpp-standard-library-reference.md)<br/>
Provides links to the various libraries provided with Visual Studio, including ATL, MFC, OLE DB Templates, the C run-time library, and the C++ Standard Library.
