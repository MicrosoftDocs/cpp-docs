...
##  <a name="_core_implementing_the_dopropexchange_function"></a> Implementing the DoPropExchange Function  
 ...
 [!code[NVC_MFC_AxSer#1](../mfc/codesnippet/CPP/mfc-activex-controls--serializing_2.cpp)]  
[!code[NVC_MFC_AxSer#2](../mfc/codesnippet/CPP/mfc-activex-controls--serializing_3.cpp)]  
...
|**PX_UShort( )**|Serializes a type **USHORT** property.|  
 ...
 For more information on these property exchange functions, see [Persistence of OLE Controls](../mfcref/persistence-of-ole-controls.md) in the *MFC Reference*.  
...
##  <a name="_core_implementing_version_support"></a> Implementing Version Support  
 ...
 [!code[NVC_MFC_AxSer#1](../mfc/codesnippet/CPP/mfc-activex-controls--serializing_2.cpp)]  
[!code[NVC_MFC_AxSer#3](../mfc/codesnippet/CPP/mfc-activex-controls--serializing_4.cpp)]  
  
 You can use any `DWORD` as the version number. Projects generated by the ActiveX Control Wizard use **_wVerMinor** and **_wVerMajor** as the default. These are global constants defined in the implementation file of the project's ActiveX control class. Within the remainder of your `DoPropExchange` function, you can call [CPropExchange::GetVersion](../Topic/CPropExchange::GetVersion.md) at any time to retrieve the version you are saving or retrieving.  
 ...
 [!code[NVC_MFC_AxSer#4](../mfc/codesnippet/CPP/mfc-activex-controls--serializing_5.cpp)]  
[!code[NVC_MFC_AxSer#3](../mfc/codesnippet/CPP/mfc-activex-controls--serializing_4.cpp)]  
