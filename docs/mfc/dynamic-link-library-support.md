...
ms.topic: "article"
dev_langs: ["C++"]
helpviewer_keywords: ["regular MFC DLLs [MFC], project targets as DLLs", "DLLs [MFC], MFC", "NAFXDW.LIB", "MFC DLLs [MFC], regular MFC DLLs", "USRDLLs, DLL support", "NAFXDWD.LIB"]
