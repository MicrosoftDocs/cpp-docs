...
---
# Dialog Bars
A dialog bar is a toolbar, a kind of [control bar](../mfc/control-bars.md) that can contain any kind of control. Because it has the characteristics of a modeless dialog box, a [CDialogBar](../mfcref/cdialogbar-class.md) object provides a more powerful toolbar.  
...
## See Also  
 ...
 [Sample](../top/visual-c---samples.md)