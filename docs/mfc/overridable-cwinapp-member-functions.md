...
[CWinApp](../mfcref/cwinapp-class.md) provides several key overridable member functions (`CWinApp` overrides these members from class [CWinThread](../mfcref/cwinthread-class.md), from which `CWinApp` derives):  
