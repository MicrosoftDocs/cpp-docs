...
> [!NOTE]
>  The following procedure applies to either a [CListView](../mfcref/clistview-class.md) or [CListCtrl](../mfcref/clistctrl-class.md) object.  
 ...
 Each column has an associated header item (see [CHeaderCtrl](../mfcref/cheaderctrl-class.md)) object that labels the column and allows users to resize the column.  
