...
##  <a name="_core_using_compound_files_format_for_your_data"></a> Using Compound Files Format for Your Data  
 ...
 In the *OLE Programmer's Reference*, see [IStream](https://msdn.microsoft.com/library/windows/desktop/aa380034), [IStorage](https://msdn.microsoft.com/library/windows/desktop/aa380015), and [ILockBytes](https://msdn.microsoft.com/library/windows/desktop/aa379238).  
