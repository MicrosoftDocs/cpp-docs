...
## Remarks  
 The method returns a pair of iterators `-` [multimap::lower_bound (STL/CLR)](../cli/multimap--lower_bound--stl-clr-.md)`(``_Keyval``),` [multimap::upper_bound (STL/CLR)](../cli/multimap--upper_bound--stl-clr-.md)`(``_Keyval``)`. You use it to determine the range of elements currently in the controlled sequence that match a specified key.  
...
## See Also  
 ...
 [multimap::lower_bound (STL/CLR)](../cli/multimap--lower_bound--stl-clr-.md)   
