...
## Remarks  
 The member function returns a pair of iterators `cliext::pair<iterator, iterator>(` [multiset::lower_bound (STL/CLR)](../cli/multiset--lower_bound--stl-clr-.md)`(``key``),` [multiset::upper_bound (STL/CLR)](../cli/multiset--upper_bound--stl-clr-.md)`(``key``))`. You use it to determine the range of elements currently in the controlled sequence that match a specified key.  
...
## See Also  
 ...
 [multiset::count (STL/CLR)](../cli/multiset--count--stl-clr-.md)   
 [multiset::find (STL/CLR)](../cli/multiset--find--stl-clr-.md)   
