...
This outline shows you examples of some of the changes in the language from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../cli/includes/cpp_current_long_md.md)]. Follow the link that accompanies each item for more information.  
...
## No Double Underscore Keywords  
 ...
 See [Language Keywords (C++/CLI)](../cli/language-keywords--c---cli-.md) for more information.  
...
```  
 ...
 See [Managed Types (C++/CL)](../cli/managed-types--c---cl-.md) for more information.  
...
```  
 ...
 See [Declaration of a CLR Reference Class Object](../cli/declaration-of-a-clr-reference-class-object.md) for more information.  
...
## Array Declaration  
 ...
 See [Declaration of a CLR Array](../cli/declaration-of-a-clr-array.md) for more information.  
...
```  
 ...
 See [Property Declaration](../cli/property-declaration.md) for more information.  
...
```  
 ...
 See [Property Index Declaration](../cli/property-index-declaration.md) for more information.  
...
```  
 ...
 See [Overloaded Operators](../cli/overloaded-operators.md) for more information.  
...
```  
 ...
 See [Changes to Conversion Operators](../cli/changes-to-conversion-operators.md) for more information.  
...
```  
 ...
 See [Explicit Override of an Interface Member](../cli/explicit-override-of-an-interface-member.md) for more information.  
...
```  
 ...
 See [Private Virtual Functions](../cli/private-virtual-functions.md) for more information.  
...
-   The overload resolution between the built-in arithmetic types and the Object class hierarchy has reversed between Managed Extensions and [!INCLUDE[cpp_current_long](../cli/includes/cpp_current_long_md.md)]. As a side-effect, CLR enums are no longer implicitly converted to arithmetic types.  
...
-   In the new syntax, a CLR enum maintains its own scope, which is not the case in Managed Extensions. Previously, enumerators were visible within the containing scope of the enum; now, enumerators are encapsulated within the scope of the enum.  
 ...
 See [CLR Enum Type](../cli/clr-enum-type.md) for more information.  
...
```  
 ...
 See [A Tracking Handle to a Boxed Value](../cli/a-tracking-handle-to-a-boxed-value.md) for more information.  
...
```  
 ...
 See [Value Type Semantics](../cli/value-type-semantics.md) for more information.  
...
```  
 ...
 See [typeof Goes to T::typeid](../cli/typeof-goes-to-t--typeid.md) for more information.  
