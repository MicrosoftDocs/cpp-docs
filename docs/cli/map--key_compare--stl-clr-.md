...
## See Also  
 ...
 [map::key_comp (STL/CLR)](../cli/map--key_comp--stl-clr-.md)   
 [map::key_type (STL/CLR)](../cli/map--key_type--stl-clr-.md)   
 [map::value_compare (STL/CLR)](../cli/map--value_compare--stl-clr-.md)