...
This article shows how to use safe_cast in [!INCLUDE[cppcli](../buildref/includes/cppcli_md.md)] applications. For information about safe_cast in [!INCLUDE[cppwrt_short](../buildref/includes/cppwrt_short_md.md)], see [safe_cast](../windows/safe_cast--c---component-extensions-.md).  
