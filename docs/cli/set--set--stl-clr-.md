...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[set::begin (STL/CLR)](../cli/set--begin--stl-clr-.md)`(),` `right``.`[set::end (STL/CLR)](../cli/set--end--stl-clr-.md)`())`, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the set object `right`, with the default ordering predicate.  
...
## See Also  
 ...
 [set::generic_container (STL/CLR)](../cli/set--generic_container--stl-clr-.md)   
 [set::operator= (STL/CLR)](../cli/set--operator=--stl-clr-.md)