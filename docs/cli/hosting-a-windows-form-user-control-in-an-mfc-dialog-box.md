...
## In This Section  
 [How to: Create the User Control and Host in a Dialog Box](../cli/how-to--create-the-user-control-and-host-in-a-dialog-box.md)  
  
 [How to: Do DDX/DDV Data Binding with Windows Forms](../cli/how-to--do-ddx-ddv-data-binding-with-windows-forms.md)  
  
 [How to: Sink Windows Forms Events from Native C++ Classes](../cli/how-to--sink-windows-forms-events-from-native-c---classes.md)  
  
## Reference  
 [CWinFormsControl Class](../mfcref/cwinformscontrol-class.md) &#124; [CDialog Class](../mfcref/cdialog-class.md) &#124; [CWnd Class](../mfcref/cwnd-class.md) &#124; \<xref:System.Windows.Forms.Control>  
  
## See Also  
 [Using a Windows Form User Control in MFC](../cli/using-a-windows-form-user-control-in-mfc.md)   
 [Windows Forms/MFC Programming Differences](../cli/windows-forms-mfc-programming-differences.md)   
 [Hosting a Windows Forms User Control as an MFC View](../cli/hosting-a-windows-forms-user-control-as-an-mfc-view.md)   
 [Hosting a Windows Form User Control as an MFC Dialog Box](../cli/hosting-a-windows-form-user-control-as-an-mfc-dialog-box.md)