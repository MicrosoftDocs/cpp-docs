...
One way to determine whether an image was built for the common language runtime is to use **dumpbin**[/CLRHEADER](../buildref/-clrheader.md).  
  
 You can also programmatically check whether an image was built for the common language runtime. For more information, see [How to: Detect /clr Compilation](../cli/how-to--detect--clr-compilation.md).  
