...
## Remarks  
 ...
 `finally` is a context-sensitive keyword; see [Context-Sensitive Keywords](../windows/context-sensitive-keywords---c---component-extensions-.md) for more information.  
