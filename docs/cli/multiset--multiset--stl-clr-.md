...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[multiset::begin (STL/CLR)](../cli/multiset--begin--stl-clr-.md)`(),` `right``.`[multiset::end (STL/CLR)](../cli/multiset--end--stl-clr-.md)`())`, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the multiset object `right`, with the default ordering predicate.  
...
## See Also  
 ...
 [multiset::generic_container (STL/CLR)](../cli/multiset--generic_container--stl-clr-.md)   
 [multiset::operator= (STL/CLR)](../cli/multiset--operator=--stl-clr-.md)