...
The syntax for declaring an explicit override of an interface member within a class has changed from Managed Extensions for C++ to [!INCLUDE[cpp_current_long](../cli/includes/cpp_current_long_md.md)].  
...
## See Also  
 ...
 [Explicit Overrides](../windows/explicit-overrides---c---component-extensions-.md)