...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[hash_map::begin (STL/CLR)](../cli/hash_map--begin--stl-clr-.md)`(),` `right``.`[hash_map::end (STL/CLR)](../cli/hash_map--end--stl-clr-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_map object `right`, with the default ordering predicate and hash function.  
...
## See Also  
 ...
 [hash_map::generic_container (STL/CLR)](../cli/hash_map--generic_container--stl-clr-.md)   
 [hash_map::operator= (STL/CLR)](../cli/hash_map--operator=--stl-clr-.md)