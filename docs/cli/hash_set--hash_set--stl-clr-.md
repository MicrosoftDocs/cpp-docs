...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[hash_set::begin (STL/CLR)](../cli/hash_set--begin--stl-clr-.md)`(),` `right``.`[hash_set::end (STL/CLR)](../cli/hash_set--end--stl-clr-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_set object `right`, with the default ordering predicate and hash function.  
...
## See Also  
 ...
 [hash_set::generic_container (STL/CLR)](../cli/hash_set--generic_container--stl-clr-.md)   
 [hash_set::operator= (STL/CLR)](../cli/hash_set--operator=--stl-clr-.md)