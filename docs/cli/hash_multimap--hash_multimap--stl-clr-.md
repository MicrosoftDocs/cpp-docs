...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[hash_multimap::begin (STL/CLR)](../cli/hash_multimap--begin--stl-clr-.md)`(),` `right``.`[hash_multimap::end (STL/CLR)](../cli/hash_multimap--end--stl-clr-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_multimap object `right`, with the default ordering predicate and hash function.  
...
## See Also  
 ...
 [hash_multimap::operator= (STL/CLR)](../cli/hash_multimap--operator=--stl-clr-.md)