...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[list::begin (STL/CLR)](../cli/list--begin--stl-clr-.md)`(),` `right``.`[list::end (STL/CLR)](../cli/list--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the list object `right`.  
  
 The constructor:  
  
 `list(list<Value>^ right);`  
  
 initializes the controlled sequence with the sequence `[``right``->`[list::begin (STL/CLR)](../cli/list--begin--stl-clr-.md)`(),` `right``->`[list::end (STL/CLR)](../cli/list--end--stl-clr-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the list object whose handle is `right`.  
...
## See Also  
 ...
 [list::generic_container (STL/CLR)](../cli/list--generic_container--stl-clr-.md)   
 [list::operator= (STL/CLR)](../cli/list--operator=--stl-clr-.md)