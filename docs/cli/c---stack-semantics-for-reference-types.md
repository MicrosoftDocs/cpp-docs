...
## Remarks  
 ...
 If your type's destructor releases critical resources and you use stack semantics for reference types, you do not need to explicitly call the destructor (or call `delete`). For more information on destructors in reference types, see [Destructors and Finalizers in Visual C++](../notintoc/destructors-and-finalizers-in-visual-c--.md).  
