...
Using [gcnew](../windows/ref-new--gcnew---c---component-extensions-.md) on a value type will create a boxed value type, which can then be placed on the managed, garbage-collected heap.  
