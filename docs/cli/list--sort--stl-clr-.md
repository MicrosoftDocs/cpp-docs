...
## See Also  
 ...
 [list::merge (STL/CLR)](../cli/list--merge--stl-clr-.md)   
 [list::reverse (STL/CLR)](../cli/list--reverse--stl-clr-.md)   
 [list::splice (STL/CLR)](../cli/list--splice--stl-clr-.md)   
 [list::unique (STL/CLR)](../cli/list--unique--stl-clr-.md)