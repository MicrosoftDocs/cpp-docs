...
-   [/DELAYSIGN (Partially Sign an Assembly)](../buildref/-delaysign--partially-sign-an-assembly-.md)  
  
-   [/KEYFILE (Specify Key or Key Pair to Sign an Assembly)](../buildref/-keyfile--specify-key-or-key-pair-to-sign-an-assembly-.md)  
  
-   [/KEYCONTAINER (Specify a Key Container to Sign an Assembly)](../buildref/-keycontainer--specify-a-key-container-to-sign-an-assembly-.md)  
