...
## See Also  
 ...
 [vector::clear (STL/CLR)](../cli/vector--clear--stl-clr-.md)   
 [vector::erase (STL/CLR)](../cli/vector--erase--stl-clr-.md)   
 [vector::insert (STL/CLR)](../cli/vector--insert--stl-clr-.md)