 ...
 **Remarks**  
 ...
 An STL collection is also known as a *container*. For more information, see [STL Containers](../stdcpplib/stl-containers.md).  
  
## Examples  
 **Example**  
  
 The following code example uses `for each` to iterate over a [\<map>](../stdcpplib/-map-.md).  
