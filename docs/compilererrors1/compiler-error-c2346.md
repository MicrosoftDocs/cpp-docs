...
'function' cannot be compiled as native: reason  
 ...
 For more information, see [managed, unmanaged](../c/managed--unmanaged.md) and [/clr (Common Language Runtime Compilation)](../buildref/-clr--common-language-runtime-compilation-.md).  
