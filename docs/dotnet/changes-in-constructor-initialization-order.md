...
1. The code body of the class constructor is executed.
...
1. The initialization list for class `B` is evaluated. The `_m` member is initialized to `1`.

1. The code body of class `B` is executed.
