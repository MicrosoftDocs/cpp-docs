...
## Remarks  
 This function behaves the same as the C++ Standard Library function `copy_backward`. For more information, see [copy_backward](http://msdn.microsoft.com/Library/ddfab855-25a3-44db-a3cd-2b05ae97ea20).  
