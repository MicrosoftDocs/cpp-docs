...
ms.date: "11/04/2016"
ms.topic: "reference"
f1_keywords: ["com::ptr", "msclr::com::ptr", "msclr.com.ptr", "com.ptr", "ptr::ptr", "ptr.ptr", "msclr.com.ptr.ptr", "msclr::com::ptr::ptr", "msclr.com.ptr.~ptr", "ptr.~ptr", "msclr::com.ptr::~ptr", "~ptr", "ptr::~ptr", "msclr::com::ptr::Attach", "ptr::Attach", "ptr.Attach", "msclr.com.ptr.Attach", "ptr.CreateInstance", "msclr::com::ptr::CreateInstance", "msclr.com.ptr.CreateInstance", "ptr::CreateInstance", "ptr.Detach", "msclr.com.ptr.Detach", "ptr::Detach", "msclr::com::ptr::Detach", "ptr::GetInterface", "msclr::com::ptr::GetInterface", "GetInterface", "msclr.com.ptr.GetInterface", "ptr.GetInterface", "ptr.QueryInterface", "ptr::QueryInterface", "msclr::com::ptr::QueryInterface", "msclr.com.ptr.QueryInterface", "ptr.Release", "ptr::Release", "msclr.com.ptr.Release", "msclr::com::ptr::Release", "ptr.operator=", "msclr.com.ptr.operator=", "msclr::com::ptr::operator=", "ptr::operator=", "msclr.com.ptr.operator->", "ptr.operator->", "ptr::operator->", "msclr::com::ptr::operator->", "ptr::operator!", "msclr::com::ptr::operator!", "ptr.operator!", "msclr.com.ptr.operator!", "ptr::operator bool", "ptr.operator bool", "operator bool", "msclr::com::ptr::operator bool", "msclr.com.ptr.operator bool" ]
...
|Member|Description| 
|---------|-----------| 
|[ptr::ptr](#ptr::ptr)|Constructs a `com::ptr` to wrap a COM object.| 
|[ptr::~ptr](#ptr::~ptr)|Destructs a `com::ptr`.| 
|[ptr::Attach](#ptr::Attach)|Attaches a COM object to a `com::ptr`.| 
|[ptr::CreateInstance](#ptr::CreateInstance)|Creates an instance of a COM object within a `com::ptr`.| 
|[ptr::Detach](#ptr::Detach)|Gives up ownership of the COM object, returning a pointer to the object.| 
|[ptr::GetInterface](#ptr::GetInterface)|Creates an instance of a COM object within a `com::ptr`.| 
|[ptr::QueryInterface](#ptr::QueryInterface)|Queries the owned COM object for an interface and attaches the result to another `com::ptr`.| 
|[ptr::Release](#ptr::Release)|Releases all owned references on the COM object.|
|[ptr::operator=](#ptr::operator=)|Attaches a COM object to a `com::ptr`.| 
|[ptr::operator-&gt;](#ptr::operator-&gt;)|Member access operator, used to call methods on the owned COM object.| 
|[ptr::operator!](#ptr::operator!)|Operator to determine if the owned COM object is invalid.| 
|[ptr::operator&nbsp;bool](#ptr::operator&nbsp;bool)|Operator for using `com::ptr` in a conditional expression.| 

 

## <a name="ptr::ptr"></a>ptr::ptr
...
## <a name="ptr::Attach"></a>ptr::Attach
...
## <a name="ptr::CreateInstance"></a>ptr::CreateInstance
...
## <a name="ptr::Detach"></a>ptr::Detach
...
## <a name="ptr::GetInterface"></a>ptr::GetInterface
...
## <a name="ptr::QueryInterface"></a>ptr::QueryInterface
...
## <a name="ptr::Release"></a>ptr::Release
...
## <a name="ptr::operator="></a>ptr::operator=
