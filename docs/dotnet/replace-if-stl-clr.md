...
## Remarks  
 This function behaves the same as the C++ Standard Library function `replace_if`. For more information, see [replace_if](http://msdn.microsoft.com/Library/3d01105a-046d-42aa-9dc9-a6b1c53ec802).  
