...
```  
 ...
 The lifetime and visibility of identifiers are discussed in [Lifetime, Scope, Visibility, and Linkage](../c/lifetime--scope--visibility--and-linkage.md). For more information on functions, see [Functions](../c/functions--c-.md).  
