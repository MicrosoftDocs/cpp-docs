 ...
 **Microsoft Specific**  
 ...
 Signed integers are represented in two's-complement form. The most-significant bit holds the sign: 1 for negative, 0 for positive and zero. The range of values is given in [C++ Integer Limits](../c/c---integer-limits.md), which is taken from the LIMITS.H header file.  
