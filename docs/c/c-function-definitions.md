 ...
 **{**  `declaration`-*list* opt*statement-list* opt**}**  
 ...
 The sections [Function Attributes](../c/function-attributes.md), [Storage Class](../c/storage-class.md), [Return Type](../c/return-type.md), [Parameters](../c/parameters.md), and [Function Body](../c/function-body.md) describe the components of the function definition in detail.  
