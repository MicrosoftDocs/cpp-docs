...
> [!NOTE]
>  To turn on the collecting of browse information with this pragma, [browse information must first be enabled](../buildref/building-browse-information-files--overview.md).  
...
```  
 ...
 For more information, see the [Enable Minimal Rebuild](../buildref/-gm--enable-minimal-rebuild-.md) (/Gm) compiler option.  
