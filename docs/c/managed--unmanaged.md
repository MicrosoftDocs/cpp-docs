...
## Remarks  
 The [/clr](../buildref/-clr--common-language-runtime-compilation-.md) compiler option provides module-level control for compiling functions either as managed or unmanaged.  
...
-   Add the pragma after `#include` statements. Do not use these pragmas before `#include` statements.  
 ...
 For more information, see [Initialization of Mixed Assemblies](../cli/initialization-of-mixed-assemblies.md).  
