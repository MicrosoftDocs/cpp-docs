 ...
 **Microsoft Specific**  
 ...
 Microsoft C includes an extension to the ANSI C standard that allows casts of l-values to be used as l-values, as long as the size of the object is not lengthened through the cast. (See [Type-Cast Conversions](../c/type-cast-conversions.md) for more information.) The following example illustrates this feature:  
