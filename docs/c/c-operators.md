...
---
# C Operators
The C operators are a subset of the [C++ operators](../notintoc/c---operators.md).  
...
|**,**|Sequential-evaluation operator|  
 ...
 The base operator (**:>**), supported by previous versions of the Microsoft 16-bit C compiler, is described in [C Language Syntax Summary](../c/c-language-syntax-summary.md).  
