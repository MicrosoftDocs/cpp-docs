...
## Remarks  
 ...
 OBJ files can be viewed with the [dumpbin](../buildref/dumpbin-command-line.md) application. The default segment in the .obj file for initialized variables is .data. Variables that are uninitialized are considered to be initialized to zero and are stored in .bss.  
...
```  
 ...
 You can also specify sections for const variables ([const_seg](../c/const_seg.md)), uninitialized data ([bss_seg](../c/bss_seg.md)), and functions ([code_seg](../c/code_seg.md)).  
