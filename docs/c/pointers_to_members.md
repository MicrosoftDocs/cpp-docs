...
## Remarks  
 You can place a **pointers_to_members** pragma in your source file as an alternative to using the [/vmx](../buildref/-vmb---vmg--representation-method-.md) compiler options or the [inheritance keywords](../cpp/inheritance-keywords.md).  
