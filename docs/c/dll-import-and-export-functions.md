...
```  
 ...
 For specific information about the syntax for extended storage-class modifiers, see [Extended Storage-Class Attributes](../c/c-extended-storage-class-attributes.md).  
