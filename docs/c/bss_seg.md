...
## Remarks  
 Obj files can be viewed with the [dumpbin](../buildref/dumpbin-command-line.md) application. The default segment in the .obj file for uninitialized data is .bss. In some cases use of **bss_seg** can speed load times by grouping uninitialized data into one section.  
...
```  
 ...
 You can also specify sections for initialized data ([data_seg](../c/data_seg.md)), functions ([code_seg](../c/code_seg.md)), and const variables ([const_seg](../c/const_seg.md)).  
