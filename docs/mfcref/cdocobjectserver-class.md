...
## Remarks  
 ...
 A DocObject server document can contain [CDocObjectServerItem](../mfcref/cdocobjectserveritem-class.md) objects, which represent the server interface to DocObject items.  
 ...
 For further information on DocObjects, see [CDocObjectServerItem](../mfcref/cdocobjectserveritem-class.md) and [COleCmdUI](../mfcref/colecmdui-class.md) in the                 *MFC Reference*. Also see [Internet First Steps: Active Documents](../mfc/active-documents-on-the-internet.md) and [Active Documents](../mfc/active-documents-on-the-internet.md).  
