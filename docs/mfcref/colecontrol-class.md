...
-   Windowless controls reduce instance size and creation time of the object  
 ...
 When windowless activation is used, the container (which does have a window) is responsible for providing services that would otherwise have been provided by the control's own window. For example, if your control needs to query the keyboard focus, query the mouse capture, or obtain a device context, these operations are managed by the container. The `COleControl`[windowless-operation member functions](assetId:///e9e28f79-9a70-4ae4-a5aa-b3e92f1904df) invoke these operations on the container.  
 ...
 For more information on developing an OLE control framework, see the articles [MFC ActiveX Controls](../mfc/mfc-activex-controls.md) and [Overview: Creating an MFC ActiveX Control Program](../mfcref/mfc-activex-control-wizard.md). For information on optimizing OLE controls, including windowless and flicker-free controls, see [MFC ActiveX Controls: Optimization](../mfc/mfc-activex-controls--optimization.md).  
...
### Parameters  
 `pPX`  
 A pointer to a [CPropExchange](../mfcref/cpropexchange-class.md) object. The framework supplies this object to establish the context of the property exchange, including its direction.  
...
### Remarks  
 ...
 [!code[NVC_MFCAxCtl#1](../mfcref/codesnippet/CPP/colecontrol-class_1.cpp)]  
 ...
 [!code[NVC_MFCAxCtl#10](../mfcref/codesnippet/CPP/colecontrol-class_2.cpp)]  
...
### Remarks  
 Usually implemented by the [IMPLEMENT_OLECREATE_EX](../Topic/IMPLEMENT_OLECREATE_EX.md) macro.  
...
### Parameters  
 ...
 `fontHolder`  
 Reference to a [CFontHolder](../mfcref/cfontholder-class.md) object.  
...
### Parameters  
 ...
 `rMessage`  
 A reference to a [CString](../atl/cstringt-class.md) object through which a string will be returned.  
...
> [!NOTE]
>  For more information on the `BSTR` data type, see [Data Types](../mfcref/data-types--mfc-.md) in the Macros and Globals section.  
...
### Remarks  
 ...
 [!code[NVC_MFCAxCtl#2](../mfcref/codesnippet/CPP/colecontrol-class_3.cpp)]  
...
### Return Value  
 A reference to a [CFontHolder](../mfcref/cfontholder-class.md) object that contains the stock Font object.  
...
### Parameters  
 `pRgn`  
 A pointer to a [CRgn](../mfcref/crgn-class.md) object that identifies the display region of the OLE object to invalidate, in client coordinates of the containing window. If this parameter is **NULL**, the extent is the entire object.  
...
### Remarks  
 When converting a form that uses VBX controls to one that uses OLE controls, special loading code for the OLE controls may be required. For example, if you are loading an instance of your OLE control, you might have a call to [PX_Font](../Topic/PX_Font.md) in your `DoPropExchange`:  
  
 [!code[NVC_MFCAxCtl#3](../mfcref/codesnippet/CPP/colecontrol-class_4.cpp)]  
 ...
 [!code[NVC_MFCAxCtl#4](../mfcref/codesnippet/CPP/colecontrol-class_5.cpp)]  
 ...
 *prop*  
 A [CDataPathProperty](../mfcref/cdatapathproperty-class.md) object implementing an asynchronous control property.  
...
### Remarks  
 ...
 [!code[NVC_MFCAxCtl#5](../mfcref/codesnippet/CPP/colecontrol-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCAxCtl#6](../mfcref/codesnippet/CPP/colecontrol-class_7.cpp)]  
...
virtual BOOL OnQueryHitPoint(  
    DWORD dwAspect, LPCRECT pRectBounds, POINT ptlLoc, LONG lCloseHint, DWORD* pHitResult );  
```  
...
### Parameters  
 ...
 `pFile`  
 Points to a [CFile](../mfcref/cfile-class.md) object in which the data is to be rendered.  
  
### Return Value  
 Nonzero if successful; otherwise 0.  
  
### Remarks  
 The specified format is one previously placed in the control object using the [DelayRenderData](../mfcref/coledatasource-class.md#coledatasource__delayrenderdata) member function for delayed rendering. The default implementation of this function simply returns **FALSE**.  
...
virtual UINT ParentToClient(  
    LPCRECT lprcBounds, LPPOINT pPoint, BOOL bHitTest = FALSE ) const;  
```  
...
### Example  
 [!code[NVC_MFCAxCtl#7](../mfcref/codesnippet/CPP/colecontrol-class_8.cpp)]  
...
```  
void ScrollWindow(  
    int xAmount, int yAmount, LPCRECT lpRect = NULL, LPCRECT lpClipRect = NULL );  
```  
...
### Parameters  
 ...
 `lpRect`  
 Points to a [CRect](../atl/crect-class.md) object or RECT structure that specifies the portion of the OLE object's client area to scroll, in client coordinates of the containing window. If `lpRect` is **NULL**, the entire OLE object's client area is scrolled.  
...
### Parameters  
 ...
 `fontHolder`  
 Reference to the [CFontHolder](../mfcref/cfontholder-class.md) object representing the font to be selected.  
  
### Return Value  
 A pointer to the previously selected font. When the caller has finished all drawing operations that use                         *fontHolder,* it should reselect the previously selected font by passing it as a parameter to [CDC::SelectObject](../mfcref/cdc-class.md#cdc__selectobject).  
...
### Return Value  
 A pointer to the previously selected `CFont` object. You should use [CDC::SelectObject](../mfcref/cdc-class.md#cdc__selectobject) to select this font back into the device context when you are finished.  
...
### Example  
 [!code[NVC_MFCAxCtl#8](../mfcref/codesnippet/CPP/colecontrol-class_9.cpp)]  
...
DWORD SerializeVersion(  
    CArchive& ar, DWORD dwVersionDefault, BOOL bConvert = TRUE );  
```  
...
### Remarks  
 This function is useful to translate the stock ForeColor and BackColor properties to **COLORREF** types used by [CDC](../mfcref/cdc-class.md) member functions.  
...
## See Also  
 [MFC Sample CIRC3](../top/visual-c---samples.md)   
