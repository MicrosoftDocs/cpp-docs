...
-   **ON_EN_VSCROLL** The user clicks an edit control's vertical scroll bar. The parent window is notified before the screen is updated.  
 ...
 To modify certain styles in an edit control (such as **ES_READONLY**) you must send specific messages to the control instead of using [ModifyStyle](../mfcref/cwnd-class.md#cwnd__modifystyle). See                 [Edit Control Styles](http://msdn.microsoft.com/library/windows/desktop/bb775464) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFC_CEdit#1](../mfcref/codesnippet/CPP/cedit-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#3](../mfcref/codesnippet/CPP/cedit-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#4](../mfcref/codesnippet/CPP/cedit-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#5](../mfcref/codesnippet/CPP/cedit-class_4.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the edit control's style. Apply any combination of [edit styles](../mfcref/edit-styles.md) to the control.  
...
### Example  
 [!code[NVC_MFC_CEdit#2](../mfcref/codesnippet/CPP/cedit-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#6](../mfcref/codesnippet/CPP/cedit-class_6.cpp)]  
...
### Remarks  
 ...
 The undo flag is automatically cleared whenever the [SetWindowText](../mfcref/cwnd-class.md#cwnd__setwindowtext) or [SetHandle](#cedit__sethandle)`CWnd` member functions are called.  
...
### Example  
 [!code[NVC_MFC_CEdit#7](../mfcref/codesnippet/CPP/cedit-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#8](../mfcref/codesnippet/CPP/cedit-class_8.cpp)]  
...
### Return Value  
 ...
 For the second overload, a [CString](../atl/using-cstring.md) that contains the cue text if the method is successful; otherwise, the empty string ("").  
...
### Example  
 [!code[NVC_MFC_CEdit#9](../mfcref/codesnippet/CPP/cedit-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#10](../mfcref/codesnippet/CPP/cedit-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#11](../mfcref/codesnippet/CPP/cedit-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#12](../mfcref/codesnippet/CPP/cedit-class_12.cpp)]  
...
### Example  
  See the example for [CEditView::GetEditCtrl](../mfcref/ceditview-class.md#ceditview__geteditctrl).  
...
### Example  
 [!code[NVC_MFC_CEdit#13](../mfcref/codesnippet/CPP/cedit-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#14](../mfcref/codesnippet/CPP/cedit-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#15](../mfcref/codesnippet/CPP/cedit-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#17](../mfcref/codesnippet/CPP/cedit-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#18](../mfcref/codesnippet/CPP/cedit-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#19](../mfcref/codesnippet/CPP/cedit-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#20](../mfcref/codesnippet/CPP/cedit-class_19.cpp)]  
...
### Remarks  
 Replaces only a portion of the text in an edit control. If you want to replace all of the text, use the [CWnd::SetWindowText](../mfcref/cwnd-class.md#cwnd__setwindowtext) member function.  
...
### Example  
 ...
 [!code[NVC_MFC_CEdit_s1#2](../mfcref/codesnippet/CPP/cedit-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#22](../mfcref/codesnippet/CPP/cedit-class_21.cpp)]  
...
### Remarks  
 ...
 If the edit control is created with the [ES_PASSWORD](../mfcref/edit-styles.md) style, the default password character is set to an asterisk ( **\***). This style is removed if `SetPasswordChar` is called with                         *ch* set to 0.  
...
### Example  
 [!code[NVC_MFC_CEdit#16](../mfcref/codesnippet/CPP/cedit-class_22.cpp)]  
...
### Remarks  
 The current setting can be found by testing the [ES_READONLY](../mfcref/edit-styles.md) flag in the return value of [CWnd::GetStyle](../mfcref/cwnd-class.md#cwnd__getstyle).  
...
### Example  
 [!code[NVC_MFC_CEdit#23](../mfcref/codesnippet/CPP/cedit-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#24](../mfcref/codesnippet/CPP/cedit-class_24.cpp)]  
...
### Remarks  
 ...
 `SetTabStops` does not automatically redraw the edit window. If you change the tab stops for text already in the edit control, call [CWnd::InvalidateRect](../mfcref/cwnd-class.md#cwnd__invalidaterect) to redraw the edit window.  
...
### Example  
  See the example for [CEditView::SetTabStops](../mfcref/ceditview-class.md#ceditview__settabstops).  
...
### Example  
 ...
 [!code[NVC_MFC_CEdit_s1#1](../mfcref/codesnippet/CPP/cedit-class_25.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CEdit_s1#3](../mfcref/codesnippet/CPP/cedit-class_26.cpp)]  
...
### Example  
 [!code[NVC_MFC_CEdit#25](../mfcref/codesnippet/CPP/cedit-class_27.cpp)]  
  
## See Also  
 [MFC Sample CALCDRIV](../top/visual-c---samples.md)   
