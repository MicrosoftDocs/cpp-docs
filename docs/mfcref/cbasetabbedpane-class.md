...
|[CBaseTabbedPane::CanFloat](#cbasetabbedpane__canfloat)|Determines whether the pane can float. (Overrides [CBasePane::CanFloat](../mfcref/cbasepane-class.md#cbasepane__canfloat).)|  
...
|[CBaseTabbedPane::ConvertToTabbedDocument](#cbasetabbedpane__converttotabbeddocument)|(Overrides [CDockablePane::ConvertToTabbedDocument](../mfcref/cdockablepane-class.md#cdockablepane__converttotabbeddocument).)|  
...
|[CBaseTabbedPane::GetMinSize](#cbasetabbedpane__getminsize)|Retrieves the minimum allowed size for the pane. (Overrides [CPane::GetMinSize](../mfcref/cpane-class.md#cpane__getminsize).)|  
|[CBaseTabbedPane::GetPaneIcon](#cbasetabbedpane__getpaneicon)|Returns a handle to the pane icon. (Overrides [CBasePane::GetPaneIcon](../mfcref/cbasepane-class.md#cbasepane__getpaneicon).)|  
...
|[CBaseTabbedPane::RecalcLayout](#cbasetabbedpane__recalclayout)|Recalculates layout information for the pane. (Overrides [CPane::RecalcLayout](../mfcref/cpane-class.md#cpane__recalclayout).)|  
...
|[CBaseTabbedPane::SetAutoHideMode](#cbasetabbedpane__setautohidemode)|Toggles the docking pane between displayed and auto-hide mode. (Overrides [CDockablePane::SetAutoHideMode](../mfcref/cdockablepane-class.md#cdockablepane__setautohidemode).)|  
...
## Remarks  
 ...
 Currently, the library includes two derived tabbed pane classes: [CTabbedPane Class](../mfcref/ctabbedpane-class.md) and [CMFCOutlookBar Class](../mfcref/cmfcoutlookbar-class.md).  
  
 A `CBaseTabbedPane` object wraps a pointer to a [CMFCBaseTabCtrl Class](../mfcref/cmfcbasetabctrl-class.md) object. [CMFCBaseTabCtrl Class](../mfcref/cmfcbasetabctrl-class.md) then becomes a child window of the tabbed pane.  
  
 For more information about how to create tabbed panes, see [CDockablePane Class](../mfcref/cdockablepane-class.md), [CTabbedPane Class](../mfcref/ctabbedpane-class.md), and [CMFCOutlookBar Class](../mfcref/cmfcoutlookbar-class.md).  
...
### Remarks  
 The framework floats the detached pane if possible. For more information, see [CBasePane::CanFloat](../mfcref/cbasepane-class.md#cbasepane__canfloat).  
...
### Parameters  
 ...
 [in] `bGetWrappedBar`  
 `TRUE` to return the underlying (wrapped) window of the pane instead of the pane itself; otherwise `FALSE`. This only applies to panes derived from [CDockablePaneAdapter](../mfcref/cdockablepaneadapter-class.md).  
...
### Remarks  
 If consistent handling of minimum pane sizes is active ( [CPane::m_bHandleMinSize](../mfcref/cpane-class.md#cpane__m_bhandleminsize)), `size` is filled with the minimum allowed size for the active tab. Otherwise, `size` is filled with the return value of [CPane::GetMinSize](../mfcref/cpane-class.md#cpane__getminsize).  
...
### Parameters  
 ...
 [in] `dwAlignment`  
 Specifies the alignment of the auto-hide pane that is to be created. For a list of possible values, see [CPane::MoveByAlignment](../mfcref/cpane-class.md#cpane__movebyalignment).  
...
### Remarks  
 ...
 Auto-hide mode is set for each detachable pane in the tabbed pane. Panes that are non-detachable are ignored. For more information, see [CMFCBaseTabCtrl::EnableTabDetach](../mfcref/cmfcbasetabctrl-class.md#cmfcbasetabctrl__enabletabdetach).  
  
 Call this method to switch a tabbed pane to auto-hide mode programmatically. The pane must be docked to the main frame window ( [CDockablePane::GetDefaultPaneDivider](../mfcref/cdockablepane-class.md#cdockablepane__getdefaultpanedivider) must return a valid pointer to the [CPaneDivider](../mfcref/cpanedivider-class.md)).  
