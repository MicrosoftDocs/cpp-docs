...
### Example  
 [!code[NVC_MFCAutomation#2](../mfc/codesnippet/CPP/application-control_1.cpp)]  
...
### Example  
 [!code[NVC_MFCAutomation#3](../mfc/codesnippet/CPP/application-control_2.cpp)]  
  
 [!code[NVC_MFCAutomation#4](../mfc/codesnippet/CPP/application-control_3.cpp)]  
...
### Example  
 [!code[NVC_MFCAutomation#5](../mfc/codesnippet/CPP/application-control_4.cpp)]  
...
### Example  
 See the example for                                 [AfxOleLockApp](../Topic/AfxOleLockApp.md).  
