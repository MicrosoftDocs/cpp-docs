...
## Remarks  
 ...
 [!code[NVC_MFCSocketThread#4](../mfcref/codesnippet/CPP/csocket-class_1.cpp)]  
...
### Remarks  
 The **SOCKET** handle is stored in the object's [m_hSocket](../mfcref/casyncsocket-class.md#casyncsocket__m_hsocket) data member.  
  
 For more information, see [Windows Sockets: Using Sockets with Archives](../mfc/windows-sockets--using-sockets-with-archives.md).  
  
### Example  
 [!code[NVC_MFCSocketThread#1](../mfcref/codesnippet/CPP/csocket-class_2.h)]  
  
 [!code[NVC_MFCSocketThread#2](../mfcref/codesnippet/CPP/csocket-class_3.cpp)]  
  
 [!code[NVC_MFCSocketThread#3](../mfcref/codesnippet/CPP/csocket-class_4.cpp)]  
