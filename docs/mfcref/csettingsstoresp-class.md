...
---
# CSettingsStoreSP Class
The `CSettingsStoreSP` class is a helper class that you can use to create instances of the [CSettingsStore Class](../mfcref/csettingsstore-class.md).  
...
4.  In your application, call `CSettingsStoreSP::SetRuntimeClass` and pass in a pointer to the [CRuntimeClass Structure](../mfcref/cruntimeclass-structure.md) obtained from your class.  
...
##  <a name="csettingsstoresp__create"></a>  CSettingsStoreSP::Create  
 Creates a new instance of an object that is derived from the [CSettingsStore Class](../mfcref/csettingsstore-class.md).  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#33](../mfcref/codesnippet/CPP/csettingsstoresp-class_1.cpp)]  
  
##  <a name="csettingsstoresp__csettingsstoresp"></a>  CSettingsStoreSP::CSettingsStoreSP  
 Constructs a [CSettingsStoreSP Class](../mfcref/csettingsstoresp-class.md) object.  
...
### Parameters  
 [in] `pRTI`  
 A pointer to the runtime class information for a class derived from the [CSettingsStore Class](../mfcref/csettingsstore-class.md).  
  
### Return Value  
 `TRUE` if successful; `FALSE` if the class identified by `pRTI` is not derived from `CSettingsStore`.  
  
### Remarks  
 You can use the [CSettingsStoreSP Class](../mfcref/csettingsstoresp-class.md) to derive classes from `CSettingsStore`. Use the method `SetRuntimeClass` if you want to create objects of a custom class that is derived from `CSettingsStore`.  
