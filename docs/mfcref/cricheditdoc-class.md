...
---
# CRichEditDoc Class
With [CRichEditView](../mfcref/cricheditview-class.md) and [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md), provides the functionality of the rich edit control within the context of MFC's document view architecture.  
...
|[CRichEditDoc::GetView](#cricheditdoc__getview)|Retrieves the asssociated [CRichEditView](../mfcref/cricheditview-class.md) object.|  
...
## Remarks  
 ...
 For an example of using a rich edit document in an MFC application, see the [WORDPAD](../top/visual-c---samples.md) sample application.  
...
### Return Value  
 Pointer to a new [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md) object which has been added to this document.  
...
##  <a name="cricheditdoc__getview"></a>  CRichEditDoc::GetView  
 Call this function to access the [CRichEditView](../mfcref/cricheditview-class.md) object associated with this `CRichEditDoc` object.  
...
##  <a name="cricheditdoc__m_brtf"></a>  CRichEditDoc::m_bRTF  
 When **TRUE**, indicates that [CRichEditCtrl::StreamIn](../mfcref/cricheditctrl-class.md#cricheditctrl__streamin) and [CRichEditCtrl::StreamOut](../mfcref/cricheditctrl-class.md#cricheditctrl__streamout) should store paragraph and character-formatting characteristics.  
