...
1.  Call [CWnd::SetWindowText](../mfcref/cwnd-class.md#cwnd__setwindowtext) to update the text in pane 0 only.  
  
2.  Call [CCmdUI::SetText](../mfcref/ccmdui-class.md#ccmdui__settext) in the status bar's `ON_UPDATE_COMMAND_UI` handler.  
...
### Parameters  
 `pParentWnd`  
 Pointer to the [CWnd](../mfcref/cwnd-class.md) object whose Windows window is the parent of the status bar.  
  
 `dwStyle`  
 The status-bar style. In addition to the standard Windows [styles](../mfcref/window-styles.md), these styles are supported.  
...
### Parameters  
 ...
 `dwCtrlStyle`  
 Additional styles for the creation of the embedded [CStatusBarCtrl](../mfcref/cstatusbarctrl-class.md) object. The default specifies a status bar without a sizing grip or tooltip support. Status bar styles supported are:  
...
### Parameters  
 ...
 `lpRect`  
 Points to a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure or a [CRect](../atl/crect-class.md) object that will receive the coordinates of the indicator specified by `nIndex`.  
...
### Parameters  
 ...
 `rString`  
 A reference to a [CString](../atl/cstringt-class.md) object that contains the text to be retrieved.  
...
### Return Value  
 Contains a reference to a [CStatusBarCtrl](../mfcref/cstatusbarctrl-class.md) object.  
  
### Remarks  
 Use `GetStatusBarCtrl` to take advantage of the functionality of the Windows status-bar common control, and to take advantage of the support [CStatusBarCtrl](../mfcref/cstatusbarctrl-class.md) provides for status-bar customization. For example, by using the common control, you can specify a style that includes a sizing grip on the status bar, or you can specify a style to have the status bar appear at the top of the parent window's client area.  
...
### Example  
 [!code[NVC_MFCDocView#176](../mfc/codesnippet/CPP/cstatusbar-class_1.cpp)]  
  
 [!code[NVC_MFCDocView#177](../mfc/codesnippet/CPP/cstatusbar-class_2.cpp)]  
  
 [!code[NVC_MFCDocView#178](../mfc/codesnippet/CPP/cstatusbar-class_3.cpp)]  
...
## See Also  
 ...
 [CControlBar Class](../mfcref/ccontrolbar-class.md)   
 [CWnd::SetWindowText](../mfcref/cwnd-class.md#cwnd__setwindowtext)   
