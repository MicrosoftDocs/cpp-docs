...
### Example  
 ...
 [!code[NVC_MFC_CDateTimeCtrl_s1#1](../mfcref/codesnippet/CPP/cdatetimectrl-class_1.h)]  
  
### Example  
 The following code example closes the drop-down calendar for the current date and time picker control.  
  
 [!code[NVC_MFC_CDateTimeCtrl_s1#5](../mfcref/codesnippet/CPP/cdatetimectrl-class_2.cpp)]  
...
### Parameters  
 ...
 `pParentWnd`  
 A pointer to a [CWnd](../mfcref/cwnd-class.md) object that is the parent window of the date and time picker control. It must not be **NULL**.  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#1](../mfcref/codesnippet/CPP/cdatetimectrl-class_3.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CDateTimeCtrl_s1#4](../mfcref/codesnippet/CPP/cdatetimectrl-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#2](../mfcref/codesnippet/CPP/cdatetimectrl-class_5.cpp)]  
...
### Return Value  
 A pointer to a [CMonthCalCtrl](../mfcref/cmonthcalctrl-class.md) object, or **NULL** if unsuccessful or if the window is not visible.  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#3](../mfcref/codesnippet/CPP/cdatetimectrl-class_6.cpp)]  
...
### Return Value  
 A pointer to a [CFont](../mfcref/cfont-class.md) object, or **NULL** if unsuccessful.  
...
### Parameters  
 `pMinRange`  
 A pointer to a [COleDateTime](../atl/coledatetime-class.md) object or a [CTime](../atl/ctime-class.md) object containing the earliest time allowed in the `CDateTimeCtrl` object.  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#4](../mfcref/codesnippet/CPP/cdatetimectrl-class_7.cpp)]  
...
### Parameters  
 *timeDest*  
 In the first version, a reference to a [COleDateTime](../atl/coledatetime-class.md) object that will receive the system time information. In the second version, a reference to a [CTime](../atl/ctime-class.md) object that will receive the system time information.  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#5](../mfcref/codesnippet/CPP/cdatetimectrl-class_8.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CDateTimeCtrl_s1#2](../mfcref/codesnippet/CPP/cdatetimectrl-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#6](../mfcref/codesnippet/CPP/cdatetimectrl-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#7](../mfcref/codesnippet/CPP/cdatetimectrl-class_11.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CDateTimeCtrl_s1#3](../mfcref/codesnippet/CPP/cdatetimectrl-class_12.cpp)]  
...
### Parameters  
 *timeNew*  
 A reference to a [COleDateTime](../atl/coledatetime-class.md) object containing the to which the control will be set.  
  
 *pTimeNew*  
 In the second version above, a pointer to a [CTime](../atl/ctime-class.md) object containing the time to which the control will be set. In the third version above, a pointer to a                                 [SYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/ms724950) structure containing the time to which the control will be set.  
...
### Example  
 [!code[NVC_MFC_CDateTimeCtrl#8](../mfcref/codesnippet/CPP/cdatetimectrl-class_13.cpp)]  
