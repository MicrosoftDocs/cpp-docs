...
-   Create a **CDynLinkLibrary** object if the DLL will be exporting [CRuntimeClass](../mfcref/cruntimeclass-structure.md) objects or has its own custom resources.  
 ...
 [!code[NVC_MFC_DLL#2](../atl/codesnippet/CPP/afx_extension_module-structure_1.cpp)]  
 ...
 [!code[NVC_MFC_DLL#5](../atl/codesnippet/CPP/afx_extension_module-structure_2.cpp)]  
