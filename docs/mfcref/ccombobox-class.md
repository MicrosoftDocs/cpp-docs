...
## Remarks  
 ...
 The following table compares the three combo-box [styles](../mfcref/combo-box-styles.md).  
...
-   **ON_CBN_CLOSEUP** (Windows 3.1 and later.) The list box of a combo box has closed. This notification message is not sent for a combo box that has the [CBS_SIMPLE](../mfcref/combo-box-styles.md) style.  
  
-   **ON_CBN_DBLCLK** The user double-clicks a string in the list box of a combo box. This notification message is only sent for a combo box with the **CBS_SIMPLE** style. For a combo box with the [CBS_DROPDOWN](../mfcref/combo-box-styles.md) or [CBS_DROPDOWNLIST](../mfcref/combo-box-styles.md) style, a double-click cannot occur because a single click hides the list box.  
...
### Remarks  
 If the list box was not created with the [CBS_SORT](../mfcref/combo-box-styles.md) style, the string is added to the end of the list. Otherwise, the string is inserted into the list, and the list is sorted.  
...
### Example  
 [!code[NVC_MFC_CComboBox#3](../mfcref/codesnippet/CPP/ccombobox-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#1](../mfcref/codesnippet/CPP/ccombobox-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#4](../mfcref/codesnippet/CPP/ccombobox-class_3.cpp)]  
...
### Parameters  
 `lpCompareItemStruct`  
 A long pointer to a [COMPAREITEMSTRUCT](../mfcref/compareitemstruct-structure.md) structure.  
...
|1|Item 1 sorts after item 2.|  
 ...
 See [CWnd::OnCompareItem](../mfcref/cwnd-class.md#cwnd__oncompareitem) for a description of `COMPAREITEMSTRUCT`.  
...
### Example  
 [!code[NVC_MFC_CComboBox#5](../mfcref/codesnippet/CPP/ccombobox-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#6](../mfcref/codesnippet/CPP/ccombobox-class_5.cpp)]  
...
### Parameters  
 `dwStyle`  
 Specifies the style of the combo box. Apply any combination of [combo-box styles](../mfcref/combo-box-styles.md) to the box.  
...
### Remarks  
 ...
 When **Create** executes, Windows sends the [WM_NCCREATE](../mfcref/cwnd-class.md#cwnd__onnccreate), [WM_CREATE](../mfcref/cwnd-class.md#cwnd__oncreate), [WM_NCCALCSIZE](../mfcref/cwnd-class.md#cwnd__onnccalcsize), and [WM_GETMINMAXINFO](../mfcref/cwnd-class.md#cwnd__ongetminmaxinfo) messages to the combo box.  
 ...
 Apply the following [window styles](../mfcref/window-styles.md) to a combo-box control. :  
...
### Example  
 [!code[NVC_MFC_CComboBox#2](../mfcref/codesnippet/CPP/ccombobox-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#7](../mfcref/codesnippet/CPP/ccombobox-class_7.cpp)]  
...
### Parameters  
 `lpDeleteItemStruct`  
 A long pointer to a Windows [DELETEITEMSTRUCT](../mfcref/deleteitemstruct-structure.md) structure that contains information about the deleted item. See [CWnd::OnDeleteItem](../mfcref/cwnd-class.md#cwnd__ondeleteitem) for a description of this structure.  
  
### Remarks  
 The default implementation of this function does nothing. Override this function to redraw the combo box as needed.  
  
### Example  
 [!code[NVC_MFC_CComboBox#8](../mfcref/codesnippet/CPP/ccombobox-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#9](../mfcref/codesnippet/CPP/ccombobox-class_9.cpp)]  
...
### Parameters  
 `attr`  
 Can be any combination of the `enum` values described in [CFile::GetStatus](../mfcref/cfile-class.md#cfile__getstatus) or any combination of the following values:  
...
### Example  
 [!code[NVC_MFC_CComboBox#10](../mfcref/codesnippet/CPP/ccombobox-class_10.cpp)]  
...
### Parameters  
 `lpDrawItemStruct`  
 A pointer to a [DRAWITEMSTRUCT](../mfcref/drawitemstruct-structure.md) structure that contains information about the type of drawing required.  
  
### Remarks  
 The **itemAction** member of the `DRAWITEMSTRUCT` structure defines the drawing action that is to be performed. See [CWnd::OnDrawItem](../mfcref/cwnd-class.md#cwnd__ondrawitem) for a description of this structure.  
...
### Example  
 [!code[NVC_MFC_CComboBox#11](../mfcref/codesnippet/CPP/ccombobox-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#12](../mfcref/codesnippet/CPP/ccombobox-class_12.cpp)]  
...
### Remarks  
 If the combo box was created with an owner-draw style but without the [CBS_HASSTRINGS](../mfcref/combo-box-styles.md) style, `FindStringExact` attempts to match the doubleword value against the value of `lpszFind`.  
  
### Example  
 [!code[NVC_MFC_CComboBox#13](../mfcref/codesnippet/CPP/ccombobox-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#14](../mfcref/codesnippet/CPP/ccombobox-class_14.cpp)]  
...
### Return Value  
 In the first overload, a [CString](../atl/using-cstring.md) object that contains the cue banner text if it exists; otherwise, a `CString` object that has zero length.  
...
### Example  
 [!code[NVC_MFC_CComboBox#15](../mfcref/codesnippet/CPP/ccombobox-class_15.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#16](../mfcref/codesnippet/CPP/ccombobox-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#17](../mfcref/codesnippet/CPP/ccombobox-class_17.cpp)]  
...
### Remarks  
 This function only applies to combo boxes with the [CBS_DROPDOWN](../mfcref/combo-box-styles.md) or [CBS_DROPDOWNLIST](../mfcref/combo-box-styles.md) style.  
...
### Example  
 [!code[NVC_MFC_CComboBox#18](../mfcref/codesnippet/CPP/ccombobox-class_18.cpp)]  
...
-   Clicking the static control displays the list box only for combo boxes with the [CBS_DROPDOWNLIST](../mfcref/combo-box-styles.md) style.  
...
### Example  
 [!code[NVC_MFC_CComboBox#19](../mfcref/codesnippet/CPP/ccombobox-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#20](../mfcref/codesnippet/CPP/ccombobox-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#21](../mfcref/codesnippet/CPP/ccombobox-class_21.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#22](../mfcref/codesnippet/CPP/ccombobox-class_22.cpp)]  
...
### Parameters  
 `nIndex`  
 Specifies the component of the combo box whose height is to be retrieved. If the `nIndex` parameter is –1, the height of the edit-control (or static-text) portion of the combo box is retrieved. If the combo box has the [CBS_OWNERDRAWVARIABLE](../mfcref/combo-box-styles.md) style, `nIndex` specifies the zero-based index of the list item whose height is to be retrieved. Otherwise, `nIndex` should be set to 0.  
  
### Return Value  
 The height, in pixels, of the specified item in a combo box. The return value is **CB_ERR** if an error occurs.  
  
### Example  
 [!code[NVC_MFC_CComboBox#23](../mfcref/codesnippet/CPP/ccombobox-class_23.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#24](../mfcref/codesnippet/CPP/ccombobox-class_24.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#25](../mfcref/codesnippet/CPP/ccombobox-class_25.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#26](../mfcref/codesnippet/CPP/ccombobox-class_26.cpp)]  
...
### Remarks  
 Unlike the [AddString](#ccombobox__addstring) member function, the `InsertString` member function does not cause a list with the [CBS_SORT](../mfcref/combo-box-styles.md) style to be sorted.  
  
> [!NOTE]
>  This function is not supported by the Windows **ComboBoxEx** control. For more information on this control, see                             [ComboBoxEx Controls](http://msdn.microsoft.com/library/windows/desktop/bb775738) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFC_CComboBox#27](../mfcref/codesnippet/CPP/ccombobox-class_27.cpp)]  
...
### Return Value  
 Nonzero if successful. If called for a combo box with the style [CBS_DROPDOWNLIST](../mfcref/combo-box-styles.md) or for a combo box without an edit control, the return value is **CB_ERR**.  
  
### Remarks  
 If the combo box does not have the style [CBS_AUTOHSCROLL](../mfcref/combo-box-styles.md), setting the text limit to be larger than the size of the edit control will have no effect.  
...
### Example  
 [!code[NVC_MFC_CComboBox#28](../mfcref/codesnippet/CPP/ccombobox-class_28.cpp)]  
...
### Remarks  
 By default, this member function does nothing. Override this member function and fill in the `MEASUREITEMSTRUCT` structure to inform Windows of the dimensions of the list box in the combo box. If the combo box is created with the [CBS_OWNERDRAWVARIABLE](../mfcref/combo-box-styles.md) style, the framework calls this member function for each item in the list box. Otherwise, this member is called only once.  
  
 Using the **CBS_OWNERDRAWFIXED** style in an owner-draw combo box created with the [SubclassDlgItem](../mfcref/cwnd-class.md#cwnd__subclassdlgitem) member function of `CWnd` involves further programming considerations. See the discussion in [Technical Note 14](../mfc/tn014--custom-controls.md).  
  
 See [CWnd::OnMeasureItem](../mfcref/cwnd-class.md#cwnd__onmeasureitem) for a description of the `MEASUREITEMSTRUCT` structure.  
  
### Example  
 [!code[NVC_MFC_CComboBox#29](../mfcref/codesnippet/CPP/ccombobox-class_29.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#30](../mfcref/codesnippet/CPP/ccombobox-class_30.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#31](../mfcref/codesnippet/CPP/ccombobox-class_31.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#32](../mfcref/codesnippet/CPP/ccombobox-class_32.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CComboBox_s1#1](../mfcref/codesnippet/CPP/ccombobox-class_33.h)]  
  
### Example  
 The following code example sets the cue banner for the combo box control.  
  
 [!code[NVC_MFC_CComboBox_s1#2](../mfcref/codesnippet/CPP/ccombobox-class_34.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#33](../mfcref/codesnippet/CPP/ccombobox-class_35.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#34](../mfcref/codesnippet/CPP/ccombobox-class_36.cpp)]  
...
### Return Value  
 Nonzero if the member function is successful; otherwise 0. It is **CB_ERR** if `CComboBox` has the [CBS_DROPDOWNLIST](../mfcref/combo-box-styles.md) style or does not have a list box.  
...
##  <a name="ccombobox__setextendedui"></a>  CComboBox::SetExtendedUI  
 Call the `SetExtendedUI` member function to select either the default user interface or the extended user interface for a combo box that has the [CBS_DROPDOWN](../mfcref/combo-box-styles.md) or [CBS_DROPDOWNLIST](../mfcref/combo-box-styles.md) style.  
...
### Remarks  
 If the width of the list box is smaller than this value, the horizontal scroll bar will horizontally scroll items in the list box. If the width of the list box is equal to or greater than this value, the horizontal scroll bar is hidden or, if the combo box has the [CBS_DISABLENOSCROLL](../mfcref/combo-box-styles.md) style, disabled.  
  
### Example  
 [!code[NVC_MFC_CComboBox#35](../mfcref/codesnippet/CPP/ccombobox-class_37.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#36](../mfcref/codesnippet/CPP/ccombobox-class_38.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#37](../mfcref/codesnippet/CPP/ccombobox-class_39.cpp)]  
...
### Parameters  
 ...
 If the combo box has the [CBS_OWNERDRAWVARIABLE](../mfcref/combo-box-styles.md) style, `nIndex` specifies the zero-based index of the list item whose height is to be set; otherwise, `nIndex` must be 0 and the height of all list items will be set.  
...
### Example  
 [!code[NVC_MFC_CComboBox#38](../mfcref/codesnippet/CPP/ccombobox-class_40.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#39](../mfcref/codesnippet/CPP/ccombobox-class_41.cpp)]  
...
### Example  
 [!code[NVC_MFC_CComboBox#40](../mfcref/codesnippet/CPP/ccombobox-class_42.cpp)]  
  
##  <a name="ccombobox__showdropdown"></a>  CComboBox::ShowDropDown  
 Shows or hides the list box of a combo box that has the [CBS_DROPDOWN](../mfcref/combo-box-styles.md) or [CBS_DROPDOWNLIST](../mfcref/combo-box-styles.md) style.  
...
### Remarks  
 ...
 This member function has no effect on a combo box created with the [CBS_SIMPLE](../mfcref/combo-box-styles.md) style.  
  
### Example  
  See the example for [CComboBox::GetDroppedState](#ccombobox__getdroppedstate).  
  
## See Also  
 [MFC Sample CTRLBARS](../top/visual-c---samples.md)   
