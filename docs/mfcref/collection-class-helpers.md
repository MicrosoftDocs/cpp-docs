...
### Remarks  
 ...
 For information on implementing this and other helper functions, see the article                         [Collections: How to Make a Type-Safe Collection](../mfc/how-to--make-a-type-safe-collection.md).  
...
### Example  
 [!code[NVC_MFC_Utilities#34](../mfc/codesnippet/CPP/collection-class-helpers_1.cpp)]  
  
##  <a name="serializeelements"></a>  SerializeElements  
 [CArray](../mfcref/carray-class.md),                 [CList](../mfcref/clist-class.md), and                 [CMap](../mfcref/cmap-class.md) call this function to serialize elements.  
...
### Example  
 See the example in the article                                 [Collections: How to Make a Type-Safe Collection](../mfc/how-to--make-a-type-safe-collection.md).  
