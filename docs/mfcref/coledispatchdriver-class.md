...
### Example  
 [!code[NVC_MFCOleContainer#3](../mfc/codesnippet/CPP/coledispatchdriver-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#4](../mfc/codesnippet/CPP/coledispatchdriver-class_2.cpp)]  
...
### Remarks  
 ...
 For more information about the `LPDISPATCH` type, see [Implementing the IDispatch Interface](assetId:///0e171f7f-0022-4e9b-ac8e-98192828e945) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
  
### Example  
 [!code[NVC_MFCOleContainer#5](../mfc/codesnippet/CPP/coledispatchdriver-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#6](../mfc/codesnippet/CPP/coledispatchdriver-class_4.cpp)]  
...
|**VT_UNKNOWN**|`LPUNKNOWN`|  
 ...
 The `pbParamInfo` argument is a space-separated list of **VTS_** constants. One or more of these values, separated by spaces (not commas), specifies the function's parameter list. Possible values are listed with the [EVENT_CUSTOM](../Topic/EVENT_CUSTOM.md) macro.  
  
 This function converts the parameters to **VARIANTARG** values, then invokes the                         [IDispatch::Invoke](http://msdn.microsoft.com/library/windows/desktop/ms221479\(v=vs.85\).aspx) method. If the call to `Invoke` fails, this function will throw an exception. If the `SCODE` (status code) returned by **IDispatch::Invoke** is `DISP_E_EXCEPTION`, this function throws a [COleException](../mfcref/coleexception-class.md) object; otherwise it throws a [COleDispatchException](../mfcref/coledispatchexception-class.md).  
...
### Example  
 [!code[NVC_MFCOleContainer#9](../mfc/codesnippet/CPP/coledispatchdriver-class_5.cpp)]  
...
### Remarks  
 ...
 For more information, see [IDispatch](assetId:///0e171f7f-0022-4e9b-ac8e-98192828e945) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
...
### Example  
 [!code[NVC_MFCOleContainer#8](../mfc/codesnippet/CPP/coledispatchdriver-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCOleContainer#7](../mfc/codesnippet/CPP/coledispatchdriver-class_7.cpp)]  
