...
### Parameters  
 ...
 The string resource consists of up to seven substrings separated by the '\n' character (the '\n' character is needed as a placeholder if a substring is not included; however, trailing '\n' characters are not necessary); these substrings describe the document type. For information about the substrings, see [CDocTemplate::GetDocString](../mfcref/cdoctemplate-class.md#cdoctemplate__getdocstring). This string resource is found in the application's resource file. For example:  
...
### Example  
 [!code[NVC_MFCDocViewSDI#13](../mfc/codesnippet/CPP/csingledoctemplate-class_1.cpp)]  
  
 [!code[NVC_MFCDocViewSDI#14](../mfc/codesnippet/CPP/csingledoctemplate-class_2.cpp)]  
