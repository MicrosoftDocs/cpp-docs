...
|Name|Description|  
|----------|-----------------|  
|`CMFCRibbonCustomizeDialog::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../mfcref/cruntimeclass-structure.md) object that is associated with this class type.|  
...
## Remarks  
 ...
 Because this class is derived from [CMFCPropertySheet Class](../mfcref/cmfcpropertysheet-class.md), you can add custom pages by using the `CMFCPropertySheet` API.  
...
## Inheritance Hierarchy  
 ...
 [CMFCRibbonCustomizeDialog](../mfcref/cmfcribboncustomizedialog-class.md)  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#18](../mfcref/codesnippet/CPP/cmfcribboncustomizedialog-class_1.cpp)]  
  
### Remarks  
 The constructor instantiates a [CMFCRibbonCustomizePropertyPage Class](../mfcref/cmfcribboncustomizepropertypage-class.md) object and adds it to the collection of property sheet pages.  
