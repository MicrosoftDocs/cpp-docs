...
-   Indirectly construct it through a document template.  
 ...
 The `CMDIChildWnd` class inherits much of its default implementation from `CFrameWnd`. For a detailed list of these features, please refer to the [CFrameWnd](../mfcref/cframewnd-class.md) class description. The `CMDIChildWnd` class has the following additional features:  
...
### Parameters  
 ...
 `dwStyle`  
 Specifies the window [style](../mfcref/window-styles.md) attributes. The **WS_CHILD** style is required.  
 ...
 `pContext`  
 Specifies a [CCreateContext](../mfcref/ccreatecontext-structure.md) structure. This parameter can be **NULL**.  
...
### Example  
 ...
 [!code[NVC_MFCWindowing#7](../mfcref/codesnippet/CPP/cmdichildwnd-class_1.cpp)]  
  
### Example  
 Example 2:  
  
 [!code[NVC_MFCWindowing#8](../mfcref/codesnippet/CPP/cmdichildwnd-class_2.cpp)]  
  
 [!code[NVC_MFCWindowing#9](../mfcref/codesnippet/CPP/cmdichildwnd-class_3.cpp)]  
...
### Remarks  
 The frame returned is two parents removed from the `CMDIChildWnd` and is the parent of the window of type **MDICLIENT** that manages the `CMDIChildWnd` object. Call the [GetParent](../mfcref/cwnd-class.md#cwnd__getparent) member function to return the `CMDIChildWnd` object's immediate **MDICLIENT** parent as a temporary `CWnd` pointer.  
  
### Example  
  See the example for [CMDIFrameWnd::MDISetMenu](../mfcref/cmdiframewnd-class.md#cmdiframewnd__mdisetmenu).  
...
### Example  
  See the example for [CMDIFrameWnd::GetWindowMenuPopup](../mfcref/cmdiframewnd-class.md#cmdiframewnd__getwindowmenupopup).  
...
### Example  
 [!code[NVC_MFCWindowing#10](../mfcref/codesnippet/CPP/cmdichildwnd-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#11](../mfcref/codesnippet/CPP/cmdichildwnd-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#12](../mfcref/codesnippet/CPP/cmdichildwnd-class_6.cpp)]  
