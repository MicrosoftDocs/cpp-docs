...
## Remarks  
 ...
 The `CPagerCtrl` class is derived from the [CWnd](../mfcref/cwnd-class.md) class. For more information and an illustration of a pager control, see                 [Pager Controls](http://msdn.microsoft.com/library/windows/desktop/bb760855).  
...
|---------------|-----------------|  
|[in] `dwStyle`|A bitwise combination (OR) of [window styles](../mfcref/window-styles.md) and                                         [pager control styles](http://msdn.microsoft.com/library/windows/desktop/bb760859) to be applied to the control.|  
...
|[in] `pParentWnd`|A pointer to a [CWnd](../mfcref/cwnd-class.md) object that is the parent window of the control. This parameter cannot be `NULL`.|  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#1](../mfcref/codesnippet/CPP/cpagerctrl-class_1.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#5](../mfcref/codesnippet/CPP/cpagerctrl-class_2.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#4](../mfcref/codesnippet/CPP/cpagerctrl-class_3.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#7](../mfcref/codesnippet/CPP/cpagerctrl-class_4.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#6](../mfcref/codesnippet/CPP/cpagerctrl-class_5.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CSplitButton_s2#3](../mfcref/codesnippet/CPP/cpagerctrl-class_6.cpp)]  
  
### Example  
 The following example uses [message reflection](../mfc/tn062--message-reflection-for-windows-controls.md) to enable the pager control to recalculate its own size instead of requiring the control's parent dialog to perform the calculation. The example derives the `MyPagerCtrl` class from the [CPagerCtrl class](../mfcref/cpagerctrl-class.md), then uses a message map to associate the                                 [PGN_CALCSIZE](http://msdn.microsoft.com/library/windows/desktop/bb760864) notification with the `OnCalcsize` notification handler. In this example, the notification handler sets the width and height of the pager control to fixed values.  
  
 [!code[NVC_MFC_CSplitButton_s2#8](../mfcref/codesnippet/CPP/cpagerctrl-class_7.cpp)]  
