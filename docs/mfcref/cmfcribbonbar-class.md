...
|[CMFCRibbonBar::CreateEx](#cmfcribbonbar__createex)|Creates a control bar and attaches it to the [CPane](../mfcref/cpane-class.md) object. (Overrides [CPane::CreateEx](../mfcref/cpane-class.md#cpane__createex).)|  
...
|[CMFCRibbonBar::GetCaptionHeight](#cmfcribbonbar__getcaptionheight)|Returns the caption height. (Overrides [CBasePane::GetCaptionHeight](../mfcref/cbasepane-class.md#cbasepane__getcaptionheight).)|  
...
|[CMFCRibbonBar::OnSetAccData](#cmfcribbonbar__onsetaccdata)|(Overrides [CBasePane::OnSetAccData](../mfcref/cbasepane-class.md#cbasepane__onsetaccdata).)|  
...
|[CMFCRibbonBar::RecalcLayout](#cmfcribbonbar__recalclayout)|(Overrides [CPane::RecalcLayout](../mfcref/cpane-class.md#cpane__recalclayout).)|  
...
## Remarks  
 ...
 You can use the `CMFCRibbonStatusBar` class to implement a status bar similar to the one used in Office 2007. A ribbon category contains (and displays) a group of [ribbon panels](../mfcref/cmfcribbonpanel-class.md). Each ribbon panel contains one or more ribbon elements, which are derived from [CMFCRibbonBaseElement](../mfcref/cmfcribbonbaseelement-class.md).  
...
## Inheritance Hierarchy  
 ...
 [CMFCRibbonBar](../mfcref/cmfcribbonbar-class.md)  
...
### Parameters  
 ...
 [in] `pRTI`  
 Pointer to a [CMFCRibbonCategory Class](../mfcref/cmfcribboncategory-class.md) run-time class to dynamically create a ribbon category at run-time.  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#5](../mfcref/codesnippet/CPP/cmfcribbonbar-class_1.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#4](../mfcref/codesnippet/CPP/cmfcribbonbar-class_2.cpp)]  
...
##  <a name="cmfcribbonbar__cmfcribbonbar"></a>  CMFCRibbonBar::CMFCRibbonBar  
 Constructs and initializes a [CMFCRibbonBar](../mfcref/cmfcribbonbar-class.md) object.  
  
```  
CMFCRibbonBar(  
    BOOL bReplaceFrameCaption = TRUE);  
```  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#1](../mfcref/codesnippet/CPP/cmfcribbonbar-class_3.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#3](../mfcref/codesnippet/CPP/cmfcribbonbar-class_4.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#8](../mfcref/codesnippet/CPP/cmfcribbonbar-class_5.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#9](../mfcref/codesnippet/CPP/cmfcribbonbar-class_6.cpp)]  
