...
## Remarks  
 ...
 For more information on using `CFile`, see the articles [Files in MFC](../mfc/files-in-mfc.md) and [File Handling](../crt/file-handling.md) in the                 *Run-Time Library Reference*.  
...
### Example  
 [!code[NVC_MFCFiles#5](../atl/codesnippet/CPP/cfile-class_1.cpp)]  
...
|Value|Description|  
|-----------|-----------------|  
|`CFile::modeCreate`|Creates a new file if no file exists.; If the file already exists, [CFileException](../mfcref/cfileexception-class.md) is raised.|  
...
### Example  
 ...
 [!code[NVC_MFCFiles#4](../atl/codesnippet/CPP/cfile-class_2.cpp)]  
...
### Remarks  
 The use of `Flush` does not guarantee flushing of `CArchive` buffers. If you are using an archive, call [CArchive::Flush](../mfcref/carchive-class.md#carchive__flush) first.  
...
### Example  
 ...
 [!code[NVC_MFCFiles#6](../atl/codesnippet/CPP/cfile-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#7](../atl/codesnippet/CPP/cfile-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#8](../atl/codesnippet/CPP/cfile-class_5.cpp)]  
...
static BOOL PASCAL GetStatus(  
    LPCTSTR lpszFileName,  
    CFileStatus& rStatus, CAtlTransactionManager* pTM = NULL );  
```  
...
### Example  
 [!code[NVC_MFCFiles#10](../atl/codesnippet/CPP/cfile-class_6.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCFiles#22](../atl/codesnippet/CPP/cfile-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#12](../atl/codesnippet/CPP/cfile-class_8.cpp)]  
...
virtual BOOL Open(  
    LPCTSTR lpszFileName, UINT nOpenFlags, CAtlTransactionManager* pTM, CFileException* pError = NULL );  
```  
...
### Example  
 [!code[NVC_MFCFiles#13](../atl/codesnippet/CPP/cfile-class_9.cpp)]  
  
 [!code[NVC_MFCFiles#14](../atl/codesnippet/CPP/cfile-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#15](../atl/codesnippet/CPP/cfile-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#17](../atl/codesnippet/CPP/cfile-class_12.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#18](../atl/codesnippet/CPP/cfile-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#9](../atl/codesnippet/CPP/cfile-class_14.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#19](../atl/codesnippet/CPP/cfile-class_15.cpp)]  
...
##  <a name="cfile__setfilepath"></a>  CFile::SetFilePath  
 Call this function to specify the path of the file; for example, if the path of a file is not available when a [CFile](../mfcref/cfile-class.md) object is constructed, call `SetFilePath` to provide it.  
...
### Example  
 [!code[NVC_MFCFiles#20](../atl/codesnippet/CPP/cfile-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#11](../atl/codesnippet/CPP/cfile-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#21](../atl/codesnippet/CPP/cfile-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFCFiles#16](../atl/codesnippet/CPP/cfile-class_19.cpp)]  
  
 In addition, see the examples for [CFile::CFile](#cfile__cfile) and [CFile::Open](#cfile__open).  
  
## See Also  
 [MFC Sample DRAWCLI](../top/visual-c---samples.md)   
