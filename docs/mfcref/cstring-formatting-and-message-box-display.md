...
|[AfxMessageBox](../Topic/AfxMessageBox.md)|Displays a message box.|  
...
### Parameters  
 *rString*  
 -   Reference to a                                         [CString](../atl/using-cstring.md) object that will receive an individual substring.  
...
### Example  
 [!code[NVC_MFC_Utilities#48](../mfc/codesnippet/CPP/cstring-formatting-and-message-box-display_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#25](../mfc/codesnippet/CPP/cstring-formatting-and-message-box-display_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#26](../mfc/codesnippet/CPP/cstring-formatting-and-message-box-display_3.cpp)]  
...
### Parameters  
 ...
 `nType`  
 The style of the message box. Apply any of the                                 [message-box styles](../mfcref/message-box-styles.md) to the box.  
...
-   **IDYES** The Yes button was selected.  
 ...
 The functions                         [AfxFormatString1](../Topic/AfxFormatString1.md) and                         [AfxFormatString2](../Topic/AfxFormatString2.md) can be useful in formatting text that appears in a message box.  
...
### Example  
 [!code[NVC_MFCWindowing#133](../mfcref/codesnippet/CPP/cstring-formatting-and-message-box-display_4.cpp)]  
