...
## Remarks  
 ...
 Several of the memory [diagnostic services](../mfcref/diagnostic-services.md) use `afxDump` for their output.  
 ...
 If you use the [IMPLEMENT_DYNAMIC](../Topic/IMPLEMENT_DYNAMIC.md) or [IMPLEMENT_SERIAL](../Topic/IMPLEMENT_SERIAL.md) macro in the implementation of your class, then `CObject::Dump` will print the name of your `CObject`-derived class. Otherwise, it will print `CObject`.  
...
### Example  
 [!code[NVC_MFC_Utilities#12](../mfc/codesnippet/CPP/cdumpcontext-class_1.cpp)]  
...
### Example  
  [!code[NVC_MFC_Utilities#13](../mfc/codesnippet/CPP/cdumpcontext-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#14](../mfc/codesnippet/CPP/cdumpcontext-class_3.cpp)]  
...
### Example  
  [!code[NVC_MFC_Utilities#15](../mfc/codesnippet/CPP/cdumpcontext-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#17](../mfc/codesnippet/CPP/cdumpcontext-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_Utilities#16](../mfc/codesnippet/CPP/cdumpcontext-class_6.cpp)]  
