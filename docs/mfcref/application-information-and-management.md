...
When you write an application, you create a single             [CWinApp](../mfcref/cwinapp-class.md)-derived object. At times, you may want to get information about this object from outside the             `CWinApp`-derived object.  
...
|[AfxGetPerUserRegistration](../Topic/AfxGetPerUserRegistration.md)|Use this function to determine whether the application redirects registry access to the                             **HKEY_CURRENT_USER** (                            **HKCU**) node.|  
...
|[AfxGetThread](../Topic/AfxGetThread.md)|Retrieves a pointer to the current                             [CWinThread](../mfcref/cwinthread-class.md) object.|  
...
|[AfxSetPerUserRegistration](../Topic/AfxSetPerUserRegistration.md)|Sets whether the application redirects registry access to the                             **HKEY_CURRENT_USER** (                            **HKCU**) node.|  
...
|[AfxWinInit](../Topic/AfxWinInit.md)|Called by the MFC-supplied                             `WinMain` function, as part of the                             [CWinApp](../mfcref/cwinapp-class.md) initialization of a GUI-based application, to initialize MFC. Must be called directly for console applications that use MFC.|  
 ...
 *pThreadClass*  
 The                                 [RUNTIME_CLASS](../Topic/RUNTIME_CLASS.md) of an object derived from                                 [CWinThread](../mfcref/cwinthread-class.md).  
...
### Parameters  
 *hInstLib*  
 A handle of the loaded library module.                                 [AfxLoadLibrary](../Topic/AfxLoadLibrary.md) returns this handle.  
...
### Example  
 See the example for                                 [AfxLoadLibrary](../Topic/AfxLoadLibrary.md).  
...
### Example  
 [!code[NVC_MFCWindowing#126](../mfcref/codesnippet/CPP/application-information-and-management_1.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#127](../mfcref/codesnippet/CPP/application-information-and-management_2.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#128](../mfcref/codesnippet/CPP/application-information-and-management_3.cpp)]  
  
##  <a name="afxgetmainwnd"></a>  AfxGetMainWnd  
 If your application is an OLE server, call this function to retrieve a pointer to the active main window of the application instead of directly referring to the                 [m_pMainWnd](../Topic/CWinThread::m_pMainWnd.md) member of the application object.  
...
### Example  
 [!code[NVC_MFCWindowing#129](../mfcref/codesnippet/CPP/application-information-and-management_4.cpp)]  
...
### Remarks  
 ...
 To change whether the application redirects registry access, use                         [AfxSetPerUserRegistration](../Topic/AfxSetPerUserRegistration.md).  
...
### Example  
 [!code[NVC_MFCWindowing#130](../mfcref/codesnippet/CPP/application-information-and-management_5.cpp)]  
  
##  <a name="afxgetthread"></a>  AfxGetThread  
 Call this function to get a pointer to the                 [CWinThread](../mfcref/cwinthread-class.md) object representing the currently executing thread.  
...
> [!NOTE]
>  If you are porting an MFC project calling                             `AfxGetThread` from Visual C++ versions 4.2, 5.0, or 6.0,                             `AfxGetThread` calls                             [AfxGetApp](../Topic/AfxGetApp.md) if no thread is found. In Visual C+ .NET and later,                             `AfxGetThread` returns                             **NULL** if no thread was found. If you want the application thread, you must call                             `AfxGetApp`.  
  
### Example  
 [!code[NVC_MFCWindowing#132](../mfcref/codesnippet/CPP/application-information-and-management_6.cpp)]  
...
### Remarks  
 This function is provided for backward compatibility. Applications created with Visual C++ .NET and later use                         [AfxInitRichEdit2](../Topic/AfxInitRichEdit2.md).  
  
 `AfxInitRichEdit` loads RICHED32.DLL to initialize version 1.0 of the rich edit control. To use version 2.0 and 3.0 of the rich edit control, RICHED20.DLL needs to be loaded. This is accomplished with a call to                         [AfxInitRichEdit2](../Topic/AfxInitRichEdit2.md). If you have dialog resources with the rich edit control created prior to Visual C++ .NET, the rich edit controls are automatically version 1.0. Rich edit controls inserted using the Visual C++ .NET Resource Editor are version 2.0.  
 ...
 This function also initializes the common controls library, if the library hasn't already been initialized for the process. If you use the rich edit control directly from your MFC application, you should call this function to assure that MFC has properly initialized the rich edit control runtime. If you call the Create method of                         [CRichEditCtrl](../mfcref/cricheditctrl-class.md),                         [CRichEditView](../mfcref/cricheditview-class.md), or                         [CRichEditDoc](../mfcref/cricheditdoc-class.md), you typically don't need to call this function, but in some cases it might be necessary.  
...
### Remarks  
 Call this function to load the RICHED20.DLL and initialize version 2.0 of the rich edit control. If you call the Create method of                         [CRichEditCtrl](../mfcref/cricheditctrl-class.md),                         [CRichEditView](../mfcref/cricheditview-class.md), or                         [CRichEditDoc](../mfcref/cricheditdoc-class.md), you typically don't need to call this function, but in some cases it might be necessary.  
...
### Example  
 [!code[NVC_MFC_DLLUser#1](../mfcref/codesnippet/CPP/application-information-and-management_7.cpp)]  
[!code[NVC_MFC_DLLUser#2](../mfcref/codesnippet/CPP/application-information-and-management_8.cpp)]  
[!code[NVC_MFC_DLLUser#3](../mfcref/codesnippet/CPP/application-information-and-management_9.cpp)]  
...
### Example  
 [!code[NVC_MFC_DLL#3](../atl/codesnippet/CPP/application-information-and-management_10.cpp)]  
...
### Example  
 [!code[NVC_MFCWindowing#134](../mfcref/codesnippet/CPP/application-information-and-management_11.cpp)]  
...
### Remarks  
 Before                         [!INCLUDE[wiprlhext](../crt/includes/wiprlhext_md.md)], applications that access the registry usually use the                         **HKEY_CLASSES_ROOT** node. However, with                         [!INCLUDE[wiprlhext](../crt/includes/wiprlhext_md.md)], you must run an application in elevated mode to write to                         **HKCR**.  
...
### Example  
 [!code[NVC_MFCWindowing#135](../mfcref/codesnippet/CPP/application-information-and-management_12.cpp)]  
...
### Parameters  
 `lpwsaData`  
 A pointer to a                                 [WSADATA](../mfcref/wsadata-structure.md) structure. If                                 `lpwsaData` is not equal to                                 `NULL`, then the address of the                                 `WSADATA` structure is filled by the call to                                 `WSAStartup`. This function also ensures that                                 `WSACleanup` is called for you before the application terminates.  
...
##  <a name="afxwininit"></a>  AfxWinInit  
 This function is called by the MFC-supplied                 `WinMain` function, as part of the                 [CWinApp](../mfcref/cwinapp-class.md) initialization of a GUI-based application, to initialize MFC.  
...
### Example  
 [!code[NVC_MFC_AfxWinInit#1](../mfcref/codesnippet/CPP/application-information-and-management_13.cpp)]  
