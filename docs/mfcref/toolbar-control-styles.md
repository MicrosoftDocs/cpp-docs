...
---
# ToolBar Control Styles
[CMFCToolBarButton Class](../mfcref/cmfctoolbarbutton-class.md) has a set of style flags that determine the appearance and behavior of the button. You can set a combination of these flags by calling             [CMFCToolBarButton::SetStyle](../Topic/CMFCToolBarButton::SetStyle.md). This topic lists the style flag values and their meanings.  
