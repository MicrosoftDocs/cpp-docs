...
|Name|Description|  
|----------|-----------------|  
|`CMFCFontComboBox::CompareItem`|Called by the framework to determine the relative position of a new item in the sorted list box of the current font combo box control. (Overrides [CComboBox::CompareItem](../mfcref/ccombobox-class.md#ccombobox__compareitem).)|  
|`CMFCFontComboBox::DrawItem`|Called by the framework to draw a specified item in the current font combo box control. (Overrides [CComboBox::DrawItem](../mfcref/ccombobox-class.md#ccombobox__drawitem).)|  
|[CMFCFontComboBox::GetSelFont](#cmfcfontcombobox__getselfont)|Retrieves information about the currently selected font.|  
|`CMFCFontComboBox::MeasureItem`|Called by the framework to inform Windows of the dimensions of the list box in the current font combo box control. (Overrides [CComboBox::MeasureItem](../mfcref/ccombobox-class.md#ccombobox__measureitem).)|  
...
## Inheritance Hierarchy  
 ...
 [CMFCFontComboBox](../mfcref/cmfcfontcombobox-class.md)  
...
### Return Value  
 A pointer to [CMFCFontInfo Class](../mfcref/cmfcfontinfo-class.md) object that describes a font. It can be `NULL` if no font is selected in the combo box.  
...
### Example  
 The following example demonstrates how to use the `SelectFont` method in the `CMFCFontComboBox` class. This example is part of the [New Controls sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_NewControls#34](../mfcref/codesnippet/CPP/cmfcfontcombobox-class_1.h)]  
[!code[NVC_MFC_NewControls#35](../mfcref/codesnippet/CPP/cmfcfontcombobox-class_2.cpp)]  
...
### Example  
 The following example demonstrates how to use the `Setup` method in the `CMFCFontComboBox` class. This example is part of the [New Controls sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_NewControls#34](../mfcref/codesnippet/CPP/cmfcfontcombobox-class_1.h)]  
[!code[NVC_MFC_NewControls#36](../mfcref/codesnippet/CPP/cmfcfontcombobox-class_3.cpp)]  
  
## See Also  
 [Hierarchy Chart](../mfc/hierarchy-chart.md)   
 [Classes](../mfcref/mfc-classes.md)   
 [CMFCToolBarFontComboBox Class](../mfcref/cmfctoolbarfontcombobox-class.md)   
