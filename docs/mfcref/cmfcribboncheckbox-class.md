...
|Name|Description|  
|----------|-----------------|  
|[CMFCRibbonCheckBox::GetCompactSize](#cmfcribboncheckbox__getcompactsize)|(Overrides [CMFCRibbonButton::GetCompactSize](../mfcref/cmfcribbonbutton-class.md#cmfcribbonbutton__getcompactsize).)|  
|[CMFCRibbonCheckBox::GetIntermediateSize](#cmfcribboncheckbox__getintermediatesize)|(Overrides [CMFCRibbonButton::GetIntermediateSize](../mfcref/cmfcribbonbutton-class.md#cmfcribbonbutton__getintermediatesize).)|  
|[CMFCRibbonCheckBox::GetRegularSize](#cmfcribboncheckbox__getregularsize)|(Overrides [CMFCRibbonButton::GetRegularSize](../mfcref/cmfcribbonbutton-class.md#cmfcribbonbutton__getregularsize).)|  
...
|[CMFCRibbonCheckBox::OnDraw](#cmfcribboncheckbox__ondraw)|(Overrides [CMFCRibbonButton::OnDraw](../mfcref/cmfcribbonbutton-class.md#cmfcribbonbutton__ondraw).)|  
|[CMFCRibbonCheckBox::OnDrawMenuImage](#cmfcribboncheckbox__ondrawmenuimage)|(Overrides [CMFCRibbonBaseElement::OnDrawMenuImage](../mfcref/cmfcribbonbaseelement-class.md#cmfcribbonbaseelement__ondrawmenuimage).)|  
|[CMFCRibbonCheckBox::OnDrawOnList](#cmfcribboncheckbox__ondrawonlist)|(Overrides `CMFCRibbonButton::OnDrawOnList`.)|  
|[CMFCRibbonCheckBox::SetACCData](#cmfcribboncheckbox__setaccdata)|(Overrides [CMFCRibbonButton::SetACCData](../mfcref/cmfcribbonbutton-class.md#cmfcribbonbutton__setaccdata).)|  
...
```  
 ...
 You can add a check box to a ribbon panel by using [CMFCRibbonPanel::Add](../mfcref/cmfcribbonpanel-class.md#cmfcribbonpanel__add).  
...
## Inheritance Hierarchy  
 ...
 [CMFCRibbonCheckBox](../mfcref/cmfcribboncheckbox-class.md)  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#17](../mfcref/codesnippet/CPP/cmfcribboncheckbox-class_1.cpp)]  
