...
## Example  
 The following example demonstrates how to use the Open and Read methods of the `CSettingsStore` class. This code snippet is part of the [Tool Tip Demo sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_ToolTipDemo#1](../mfcref/codesnippet/CPP/csettingsstore-class_1.cpp)]  
  
## Inheritance Hierarchy  
 [CObject](../mfcref/cobject-class.md)  
  
 [CSettingsStore](../mfcref/csettingsstore-class.md)  
...
### Remarks  
 By default, this method is called from the destructor of the [CSettingsStore Class](../mfcref/csettingsstore-class.md).  
...
### Parameters  
 ...
 [out] `rect`  
 Reference to a [CRect](../atl/crect-class.md) variable that receives the value read from the registry key.  
 ...
 [out] `list`  
 Reference to a [CObList](../mfcref/coblist-class.md) variable that receives the value read from the registry key.  
  
 [out] `obj`  
 Reference to a [CObject](../mfcref/cobject-class.md) variable that receives the value read from the registry key.  
...
### Parameters  
 ...
 [in] `scStringList`  
 Reference to a [CStringList](../mfcref/cstringlist-class.md) variable that contains the data to store.  
 ...
 [in] `rect`  
 Reference to a [CRect](../atl/crect-class.md) variable that contains the data to store.  
 ...
 [in] `list`  
 Reference to a [CObList](../mfcref/coblist-class.md) variable that contains the data to store.  
  
 [in] `obj`  
 Reference to a [CObject](../mfcref/cobject-class.md) variable that contains the data to store.  
...
### Remarks  
 In order to write to the registry, you must set `bReadOnly` to a nonzero value when you create a [CSettingsStore](../mfcref/csettingsstore-class.md) object. For more information, see [CSettingsStore::CSettingsStore](#csettingsstore__csettingsstore).  
