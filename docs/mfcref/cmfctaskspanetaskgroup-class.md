...
## Remarks  
 ...
 ![Task group, expanded](../mfcref/media/nexttaskgrpexpand.png "NextTaskGrpExpand")  
  
 The following illustration shows a collapsed task group:  
  
 ![Collapsed task group](../mfcref/media/nexttaskgrpcollapse.png "NextTaskGrpCollapse")  
  
 The following illustration shows a task group without a caption:  
  
 ![Task group without a caption](../mfcref/media/nexttaskgrpnocapt.png "NextTaskGrpNoCapt")  
 ...
 ![Special task group](../mfcref/media/nexttaskgrpspecial.png "NextTaskGrpSpecial")  
  
## Inheritance Hierarchy  
 [CObject](../mfcref/cobject-class.md)  
  
 [CMFCTasksPaneTaskGroup](../mfcref/cmfctaskspanetaskgroup-class.md)  
...
### Remarks  
 Only one group can be aligned to the bottom of the task pane control. This task group must be added last. For more information, see [CMFCTasksPane::AddGroup](../mfcref/cmfctaskspane-class.md#cmfctaskspane__addgroup).  
...
### Remarks  
 You can enable or disable the ability to collapse groups on the task pane by calling [CMFCTasksPane::EnableGroupCollapse](../mfcref/cmfctaskspane-class.md#cmfctaskspane__enablegroupcollapse).  
...
### Remarks  
 To fill this list, call [CMFCTasksPane::AddTask](../mfcref/cmfctaskspane-class.md#cmfctaskspane__addtask).  
