...
When you [add ATL support to an existing MFC executable or DLL](../mfcref/adding-atl-support-to-your-mfc-project.md), Visual C++ makes the following modifications to the existing MFC project (in this example, the project is called `MFCEXE`):  
...
## See Also  
 [ATL Support in an MFC Project](../mfcref/adding-atl-support-to-your-mfc-project.md)   
