...
### Example  
 [!code[NVC_MFCDocView#43](../mfc/codesnippet/CPP/ccmdtarget-class_1.cpp)]  
...
### Remarks  
 Derived classes should override this member function (if not overridden, `GetDispatchIID` returns FALSE). See [COleControl](../mfcref/colecontrol-class.md).  
...
### Remarks  
 ...
 Derived classes can override this function to return appropriate values (if not overridden, `IsInvokeAllowed` returns TRUE). See in particular [COleControl::IsInvokeAllowed](../mfcref/colecontrol-class.md#colecontrol__isinvokeallowed).  
...
|-------------------|--------------------|  
|CN_COMMAND|[CCmdUI](../mfcref/ccmdui-class.md)*|  
|CN_EVENT|AFX_EVENT*|  
|CN_UPDATE_COMMAND_UI|CCmdUI*|  
|CN_OLECOMMAND|[COleCmdUI](../mfcref/colecmdui-class.md)*|  
|CN_OLE_UNREGISTER|NULL|  
  
### Example  
 [!code[NVC_MFCDocView#44](../mfc/codesnippet/CPP/ccmdtarget-class_2.cpp)]  
  
 [!code[NVC_MFCDocView#45](../mfc/codesnippet/CPP/ccmdtarget-class_3.cpp)]  
...
## See Also  
 [MFC Sample ACDUAL](../top/visual-c---samples.md)   
