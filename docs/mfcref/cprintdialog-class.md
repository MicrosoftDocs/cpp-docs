...
> [!NOTE]
>  The `CPrintDialogEx` class encapsulates the services provided by the Windows 2000 Print property sheet. For more information see the [CPrintDialogEx](../mfcref/cprintdialogex-class.md) overview.  
  
 `CPrintDialog`'s functionality is superceded by that of [CPageSetupDialog](../mfcref/cpagesetupdialog-class.md), which is designed to provide you with a common dialog box for both print setup and page setup.  
...
### Example  
 [!code[NVC_MFCDocView#174](../mfc/codesnippet/CPP/cprintdialog-class_1.cpp)]  
  
##  <a name="cprintdialog__createprinterdc"></a>  CPrintDialog::CreatePrinterDC  
 Creates a printer device context (DC) from the                 [DEVMODE](http://msdn.microsoft.com/library/windows/desktop/dd183565) and [DEVNAMES](../mfcref/devnames-structure.md) structures.  
...
### Example  
 [!code[NVC_MFCDocView#106](../mfc/codesnippet/CPP/cprintdialog-class_2.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCDocView#107](../mfc/codesnippet/CPP/cprintdialog-class_3.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFCDocView#108](../mfc/codesnippet/CPP/cprintdialog-class_4.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#109](../mfc/codesnippet/CPP/cprintdialog-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#111](../mfc/codesnippet/CPP/cprintdialog-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#110](../mfc/codesnippet/CPP/cprintdialog-class_7.cpp)]  
...
## See Also  
 ...
 [CPrintInfo Structure](../mfcref/cprintinfo-structure.md)