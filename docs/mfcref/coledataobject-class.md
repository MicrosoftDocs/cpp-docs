...
### Remarks  
 ...
 For more information, see                         [IEnumXXXX::Next](https://msdn.microsoft.com/en-us/library/ms695273.aspx) in the [!INCLUDE[winSDK](../atl/includes/winsdk_md.md)].  
...
### Example  
  See the example for [CRichEditView::QueryAcceptData](../mfcref/cricheditview-class.md#cricheditview__queryacceptdata).  
...
## See Also  
 ...
 [COleDataSource::DoDragDrop](../mfcref/coledatasource-class.md#coledatasource__dodragdrop)   
 [CView::OnDrop](../mfcref/cview-class.md#cview__ondrop)