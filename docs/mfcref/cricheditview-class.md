...
---
# CRichEditView Class
With [CRichEditDoc](../mfcref/cricheditdoc-class.md) and [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md), provides the functionality of the rich edit control within the context of MFC's document view architecture.  
...
|[CRichEditView::GetDocument](#cricheditview__getdocument)|Retrieves a pointer to the related [CRichEditDoc](../mfcref/cricheditdoc-class.md).|  
...
## Remarks  
 ...
 This Windows Common control (and therefore the [CRichEditCtrl](../mfcref/cricheditctrl-class.md) and related classes) is available only to programs running under Windows 95/98 and Windows NT versions 3.51 and later.  
  
 For an example of using a rich edit view in an MFC application, see the [WORDPAD](../top/visual-c---samples.md) sample application.  
...
### Parameters  
 `dataobj`  
 The [COleDataObject](../mfcref/coledataobject-class.md) containing the data to paste.  
...
### Example  
 [!code[NVC_MFCDocView#151](../mfc/codesnippet/CPP/cricheditview-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#152](../mfc/codesnippet/CPP/cricheditview-class_2.cpp)]  
...
### Return Value  
 Pointer to a [CRichEditDoc](../mfcref/cricheditdoc-class.md) object associated with your `CRichEditView` object.  
...
### Return Value  
 A pointer to the single, in-place active [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md) object in this rich edit view; **NULL** if there is no OLE item currently in the in-place active state.  
...
### Example  
 [!code[NVC_MFCDocView#153](../mfc/codesnippet/CPP/cricheditview-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#154](../mfc/codesnippet/CPP/cricheditview-class_4.cpp)]  
...
##  <a name="cricheditview__getricheditctrl"></a>  CRichEditView::GetRichEditCtrl  
 Call this function to retrieve the [CRichEditCtrl](../mfcref/cricheditctrl-class.md) object associated with the `CRichEditView` object.  
...
### Return Value  
 Pointer to a [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md) object selected in the `CRichEditView` object; **NULL** if no item is selected in this view.  
...
##  <a name="cricheditview__insertfileasobject"></a>  CRichEditView::InsertFileAsObject  
 Call this function to insert the specified file (as a [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md) object) into a rich edit view.  
...
##  <a name="cricheditview__insertitem"></a>  CRichEditView::InsertItem  
 Call this function to insert a [CRichEditCntrItem](../mfcref/cricheditcntritem-class.md) object into a rich edit view.  
...
### Example  
 [!code[NVC_MFCDocView#155](../mfc/codesnippet/CPP/cricheditview-class_5.cpp)]  
...
### Remarks  
 Typically, you would do this by creating a [COleStreamFile](../mfcref/colestreamfile-class.md) around the `IStorage`. The `COleStreamFile` can be attached to an archive and [CObject::Serialize](../mfcref/cobject-class.md#cobject__serialize) called to load the data.  
...
### Example  
 [!code[NVC_MFCDocView#156](../mfc/codesnippet/CPP/cricheditview-class_6.cpp)]  
...
### Parameters  
 `dcPrinter`  
 A [CDC](../mfcref/cdc-class.md) object for the new printer.  
...
### Example  
 [!code[NVC_MFCDocView#157](../mfc/codesnippet/CPP/cricheditview-class_7.cpp)]  
...
### Parameters  
 `pCmdUI`  
 Pointer to a [CCmdUI](../mfcref/ccmdui-class.md) object.  
...
### Example  
 [!code[NVC_MFCDocView#158](../mfc/codesnippet/CPP/cricheditview-class_8.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#159](../mfc/codesnippet/CPP/cricheditview-class_9.cpp)]  
 ...
 *rectLayout*  
 "RECT" or [CRect](../atl/crect-class.md) which defines the output area.  
...
### Remarks  
 Typically, this call is followed by a call to [CRichEditCtrl::DisplayBand](../mfcref/cricheditctrl-class.md#cricheditctrl__displayband) which generates the output.  
...
### Remarks  
 The layout of each page is controlled by [GetPageRect](#cricheditview__getpagerect) and [GetPrintRect](#cricheditview__getprintrect). Typically, this call is followed by a call to [CRichEditCtrl::DisplayBand](../mfcref/cricheditctrl-class.md#cricheditctrl__displayband) which generates the output.  
...
### Example  
 [!code[NVC_MFCDocView#160](../mfc/codesnippet/CPP/cricheditview-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#161](../mfc/codesnippet/CPP/cricheditview-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#162](../mfc/codesnippet/CPP/cricheditview-class_12.cpp)]  
  
##  <a name="cricheditview__textnotfound"></a>  CRichEditView::TextNotFound  
 Call this function to reset the internal search state of the [CRichEditView](../mfcref/cricheditview-class.md) control after a failed call to [FindText](#cricheditview__findtext).  
...
### Example  
 [!code[NVC_MFCDocView#163](../mfc/codesnippet/CPP/cricheditview-class_13.cpp)]  
