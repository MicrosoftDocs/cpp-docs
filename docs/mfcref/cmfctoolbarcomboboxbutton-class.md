...
---
# CMFCToolBarComboBoxButton Class
A toolbar button that contains a combo box control ( [CComboBox Class](../mfcref/ccombobox-class.md)).  
...
##  <a name="cmfctoolbarcomboboxbutton__cmfctoolbarcomboboxbutton"></a>  CMFCToolBarComboBoxButton::CMFCToolBarComboBoxButton  
 Constructs a [CMFCToolBarComboBoxButton](../mfcref/cmfctoolbarcomboboxbutton-class.md) object.  
...
### Remarks  
 ...
 For a list of toolbar button styles see [ToolBar Control Styles](../mfcref/toolbar-control-styles.md)  
...
### Remarks  
 The framework calls this method when it creates a new edit box for a combo box button. Override this method to change how [CMFCToolBarComboBoxEdit](../mfcref/cmfctoolbarcomboboxedit-class.md) is created.  
...
### Return Value  
 A pointer to the [CComboBox Class](../mfcref/ccombobox-class.md) object if the method was successful; otherwise `NULL`.  
