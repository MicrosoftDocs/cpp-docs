...
|[CDaoException::m_pErrorInfo](#cdaoexception__m_perrorinfo)|A pointer to a [CDaoErrorInfo](../mfcref/cdaoerrorinfo-structure.md) object that contains information about one DAO error object.|  
...
4.  Examine the current [CDaoErrorInfo](../mfcref/cdaoerrorinfo-structure.md) structure that `GetErrorInfo` returns in the [m_pErrorInfo](#cdaoexception__m_perrorinfo) data member. Its members provide information on the DAO error.  
...
|**m_lHelpContext**|Help Context|The context ID for a topic in the DAO Help file|  
 ...
 For full details about the information contained in the `CDaoErrorInfo` object, see the [CDaoErrorInfo](../mfcref/cdaoerrorinfo-structure.md) structure.  
