...
---
# CMFCRibbonCategory Class
The `CMFCRibbonCategory` class implements a ribbon tab that contains a group of [ribbon panels](../mfcref/cmfcribbonpanel-class.md).  
...
## Remarks  
 Typically, you create a ribbon category indirectly by calling [CMFCRibbonBar::AddCategory](../mfcref/cmfcribbonbar-class.md#cmfcribbonbar__addcategory), which returns a pointer to the newly created ribbon category. You add panels to the category by calling [CMFCRibbonCategory::AddPanel](#cmfcribboncategory__addpanel).  
  
 The `CMFCRibbonTab` class draws ribbon categories. It is derived from [CMFCRibbonBaseElement Class](../mfcref/cmfcribbonbaseelement-class.md).  
 ...
 ![CMFCRibbonCategory image](../mfcref/media/cmfcribboncategory.png "CMFCRibbonCategory")  
  
## Inheritance Hierarchy  
 [CObject](../mfcref/cobject-class.md)  
  
 [CMFCRibbonCategory](../mfcref/cmfcribboncategory-class.md)  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#10](../mfcref/codesnippet/CPP/cmfcribboncategory-class_1.cpp)]  
  
##  <a name="cmfcribboncategory__cmfcribboncategory"></a>  CMFCRibbonCategory::CMFCRibbonCategory  
 Constructs and initializes a [CMFCRibbonCategory](../mfcref/cmfcribboncategory-class.md) object.  
...
##  <a name="cmfcribboncategory__copyfrom"></a>  CMFCRibbonCategory::CopyFrom  
 Copies the state of the specified [CMFCRibbonCategory](../mfcref/cmfcribboncategory-class.md) to the current [CMFCRibbonCategory](../mfcref/cmfcribboncategory-class.md) object.  
...
### Parameters  
 [in] `src`  
 The source [CMFCRibbonCategory](../mfcref/cmfcribboncategory-class.md) object.  
...
### Parameters  
 [in, out] `arElements`  
 Reference to a [CArray](../mfcref/carray-class.md) of ribbon elements.  
...
### Remarks  
 For more information about highlighting a ribbon panel, see [CMFCRibbonPanel::Highlight](../mfcref/cmfcribbonpanel-class.md#cmfcribbonpanel__highlight).  
...
### Example  
 ...
 [!code[NVC_MFC_RibbonApp#13](../mfcref/codesnippet/CPP/cmfcribboncategory-class_2.cpp)]  
