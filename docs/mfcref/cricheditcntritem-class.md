...
---
# CRichEditCntrItem Class
With [CRichEditView](../mfcref/cricheditview-class.md) and [CRichEditDoc](../mfcref/cricheditdoc-class.md), provides the functionality of the rich edit control within the context of MFC's document view architecture.  
...
## Remarks  
 ...
 For an example of using rich edit container items in an MFC application, see the [WORDPAD](../top/visual-c---samples.md) sample application.  
...
## Inheritance Hierarchy  
 ...
 [COleClientItem](../mfcref/coleclientitem-class.md)  
 ...
 *preo*  
 ...
 `pContainer`  
 Pointer to the container document that will contain this item. If `pContainer` is **NULL**, you must explicitly call [COleDocument::AddItem](../mfcref/coledocument-class.md#coledocument__additem) to add this client item to a document.  
