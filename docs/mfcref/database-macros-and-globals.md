...
### Example  
 ...
 [!code[NVC_MFCDatabase#39](../mfc/codesnippet/CPP/database-macros-and-globals_1.cpp)]  
...
### Remarks  
 ...
 [!code[NVC_MFCDatabase#40](../mfc/codesnippet/CPP/database-macros-and-globals_2.cpp)]  
  
 you can simply make the assignment  
  
 [!code[NVC_MFCDatabase#41](../mfc/codesnippet/CPP/database-macros-and-globals_3.cpp)]  
...
### Return Value  
 The handle to the ODBC environment currently in use by MFC. Can be                         `SQL_HENV_NULL` if there are no                         [CDatabase](../mfcref/cdatabase-class.md) objects and no                         [CRecordset](../mfcref/crecordset-class.md) objects in use.  
