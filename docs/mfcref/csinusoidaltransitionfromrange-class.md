...
|Name|Description|  
|----------|-----------------|  
|[CSinusoidalTransitionFromRange::Create](#csinusoidaltransitionfromrange__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../mfcref/cbasetransition-class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CSinusoidalTransitionFromRange](../mfcref/csinusoidaltransitionfromrange-class.md)  
