...
## Remarks  
 ...
 All devices support bitmaps that have the **RC_BITBLT** bit set in the **RASTERCAPS** index of the [CDC::GetDeviceCaps](../Topic/CDC::GetDeviceCaps.md) member function.  
