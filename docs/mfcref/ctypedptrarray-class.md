...
### Remarks  
 For more detailed remarks, see [CObArray::Add](../mfcref/cobarray-class.md#cobarray__add).  
...
### Parameters  
 `BASE_CLASS`  
 Base class of the typed pointer array class; must be an array class ( [CObArray](../mfcref/cobarray-class.md) or [CPtrArray](../mfcref/cptrarray-class.md)).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Append](../mfcref/cobarray-class.md#cobarray__append).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Copy](../mfcref/cobarray-class.md#cobarray__copy).  
...
### Remarks  
 For more detailed remarks, see [CObArray::ElementAt](../mfcref/cobarray-class.md#cobarray__elementat).  
...
### Remarks  
 For more detailed remarks, see [CObArray::GetAt](../mfcref/cobarray-class.md#cobarray__getat)  
...
### Parameters  
 `nIndex`  
 An integer index that may be greater than the value returned by [CObArray::GetUpperBound](../mfcref/cobarray-class.md#cobarray__getupperbound).  
...
### Remarks  
 For more detailed remarks, see [CObArray::InsertAt](../mfcref/cobarray-class.md#cobarray__insertat).  
...
### Parameters  
 `nIndex`  
 An integer index that is greater than or equal to 0 and less than or equal to the value returned by [CObArray::GetUpperBound](../mfcref/cobarray-class.md#cobarray__getupperbound).  
...
### Remarks  
 For more detailed remarks, see [CObArray::SetAt](../mfcref/cobarray-class.md#cobarray__setat).  
...
### Remarks  
 For more detailed remarks, see [CObArray::SetAtGrow](../mfcref/cobarray-class.md#cobarray__setatgrow).  
