...
### Remarks  
 ...
 The `dwStyle` parameter can be any combination of [Window Styles](../mfcref/window-styles.md). In addition, a tool tip control has two class-specific styles: **TTS_ALWAYSTIP** and **TTS_NOPREFIX**.  
...
### Example  
 [!code[NVC_MFCControlLadenDialog#74](../mfc/codesnippet/CPP/ctooltipctrl-class_1.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CToolBarCtrl_s1#6](../mfcref/codesnippet/CPP/ctooltipctrl-class_2.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CToolBarCtrl_s1#7](../mfcref/codesnippet/CPP/ctooltipctrl-class_3.cpp)]  
