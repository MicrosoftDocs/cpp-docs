 ...
 *x3*  
 ...
 `lpRect`  
 Specifies the bounding rectangle (in logical units). You can pass either an `LPRECT` or a [CRect](../atl/crect-class.md) object for this parameter.  
  
 `ptStart`  
 Specifies the x- and y-coordinates of the point that defines the arc's starting point (in logical units). This point does not have to lie exactly on the arc. You can pass either a POINT structure or a [CPoint](../atl/cpoint-class.md) object for this parameter.  
...
### Example  
 [!code[NVC_MFCDocView#29](../mfc/codesnippet/CPP/cdc-class_1.cpp)]  
 ...
 *x3*  
 ...
 `lpRect`  
 Specifies the bounding rectangle (in logical units). You can pass either a pointer to a RECT data structure or a [CRect](../atl/crect-class.md) object for this parameter.  
  
 `ptStart`  
 Specifies the x- and y-coordinates of the point that defines the arc's starting point (in logical units). This point does not have to lie exactly on the arc. You can pass either a POINT data structure or a [CPoint](../atl/cpoint-class.md) object for this parameter.  
...
### Example  
 [!code[NVC_MFCDocView#30](../mfc/codesnippet/CPP/cdc-class_2.cpp)]  
 ...
 *x3*  
 ...
 `lpRect`  
 Specifies the bounding rectangle (in logical units). You can pass either a `LPRECT` or a [CRect](../atl/crect-class.md) object for this parameter.  
 ...
 `ptEnd`  
 Specifies the x- and y-coordinates of the point that defines the chord's ending point (in logical units). This point does not have to lie exactly on the chord. You can pass either a POINT structure or a [CPoint](../atl/cpoint-class.md) object for this parameter.  
...
### Example  
 [!code[NVC_MFCDocView#31](../mfc/codesnippet/CPP/cdc-class_3.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#32](../mfc/codesnippet/CPP/cdc-class_4.cpp)]  
...
### Remarks  
 ...
 An application must not delete a device context whose handle was obtained by calling [CWnd::GetDC](../mfcref/cwnd-class.md#cwnd__getdc). Instead, it must call [CWnd::ReleaseDC](../mfcref/cwnd-class.md#cwnd__releasedc) to free the device context. The [CClientDC](../mfcref/cclientdc-class.md) and [CWindowDC](../mfcref/cwindowdc-class.md) classes are provided to wrap this functionality.  
...
### Example  
  See the example for [CPrintDialog::GetPrinterDC](../mfcref/cprintdialog-class.md#cprintdialog__getprinterdc).  
...
### Parameters  
 `lpSize`  
 Points to a                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or [CSize](../atl/csize-class.md) object.  
...
### Parameters  
 `lpPoints`  
 Points to an array of POINT structures or [CPoint](../atl/cpoint-class.md) objects.  
  
 `nCount`  
 The number of points in the array.  
  
 `lpRect`  
 Points to a RECT structure or [CRect](../atl/crect-class.md) object. This parameter is used for the simple case of converting one rectangle from device points to logical points.  
...
### Parameters  
 `lpRect`  
 Specifies the bounding rectangle (in logical units). You can pass either a pointer to a RECT structure or a [CRect](../atl/crect-class.md) object for this parameter.  
...
### Example  
 [!code[NVC_MFCDocView#33](../mfc/codesnippet/CPP/cdc-class_5.cpp)]  
...
### Parameters  
 `lpRect`  
 Points to a RECT structure or a [CRect](../atl/crect-class.md) object that specifies the logical coordinates of a rectangle — in this case, the end position of the rectangle being redrawn.  
 ...
 `lpRectLast`  
 Points to a RECT structure or a [CRect](../atl/crect-class.md) object that specifies the logical coordinates of the position of a rectangle — in this case, the original position of the rectangle being redrawn.  
...
### Parameters  
 `lpRect`  
 Points to a RECT structure or a [CRect](../atl/crect-class.md) object that specifies the logical coordinates of the rectangle to be drawn.  
...
### Example  
 ...
 [!code[NVC_MFCDocView#34](../mfc/codesnippet/CPP/cdc-class_6.cpp)]  
 ...
 *y*  
 ...
 `point`  
 Specifies the logical x- and y-coordinates of the upper-left corner of the icon. You can pass a POINT structure or a [CPoint](../atl/cpoint-class.md) object for this parameter.  
...
### Example  
  See the example for [CWnd::IsIconic](../mfcref/cwnd-class.md#cwnd__isiconic).  
...
### Parameters  
 ...
 `lpRect`  
 Points to a RECT structure or [CRect](../atl/crect-class.md) object that contains the rectangle (in logical coordinates) in which the text is to be formatted.  
  
 `str`  
 A [CString](../atl/cstringt-class.md) object that contains the specified characters to be drawn.  
...
### Parameters  
 ...
 `lpRect`  
 Specifies the ellipse's bounding rectangle. You can also pass a [CRect](../atl/crect-class.md) object for this parameter.  
...
### Return Value  
 Specifies the last value returned by the [callback function](../mfcref/callback-function-for-cdc--enumobjects.md). Its meaning is user-defined.  
...
### Example  
 [!code[NVC_MFCDocView#35](../mfc/codesnippet/CPP/cdc-class_7.cpp)]  
...
-   **ETO_OPAQUE** Specifies that the current background color fills the rectangle. (You can set and query the current background color with the [SetBkColor](#cdc__setbkcolor) and [GetBkColor](#cdc__getbkcolor) member functions.)  
 ...
 `lpRect`  
 Points to a RECT structure that determines the dimensions of the rectangle. This parameter can be **NULL**. You can also pass a [CRect](../atl/crect-class.md) object for this parameter.  
  
 `lpszString`  
 Points to the specified character string to be drawn. You can also pass a [CString](../atl/cstringt-class.md) object for this parameter.  
...
### Parameters  
 `lpRect`  
 Points to a RECT structure that contains the logical coordinates of the rectangle to be filled. You can also pass a [CRect](../atl/crect-class.md) object for this parameter.  
...
### Remarks  
 ...
 The brush needs to either be created using the [CBrush](../mfcref/cbrush-class.md) member functions [CreateHatchBrush](../mfcref/cbrush-class.md#cbrush__createhatchbrush), [CreatePatternBrush](../mfcref/cbrush-class.md#cbrush__createpatternbrush), and [CreateSolidBrush](../mfcref/cbrush-class.md#cbrush__createsolidbrush), or retrieved by the `GetStockObject` Windows function.  
...
### Example  
  See the example for [CRgn::CreateRoundRectRgn](../mfcref/crgn-class.md#crgn__createroundrectrgn).  
...
### Parameters  
 `lpRect`  
 Points to a RECT structure or [CRect](../atl/crect-class.md) object that contains the logical coordinates of the upper-left and lower-right corners of the rectangle. You can also pass a `CRect` object for this parameter.  
...
### Example  
  See the example for [CRgn::CombineRgn](../mfcref/crgn-class.md#crgn__combinergn).  
...
### Return Value  
 The current origin of the brush (in device units) as a [CPoint](../atl/cpoint-class.md) object.  
...
### Parameters  
 ...
 `str`  
 A pointer to a [CString](../atl/cstringt-class.md) object to process.  
...
### Parameters  
 ...
 `lpabc`  
 Points to an array of [ABC](../mfcref/abc-structure.md) structures that receive the character widths when the function returns. This array must contain at least as many **ABC** structures as there are characters in the range specified by the `nFirstChar` and `nLastChar` parameters.  
  
 *lpABCF*  
 Points to an application-supplied buffer with an array of [ABCFLOAT](../mfcref/abcfloat-structure.md) structures to receive the character widths when the function returns. The widths returned by this function are in the IEEE floating-point format.  
...
### Parameters  
 `lpRect`  
 Points to the RECT structure or [CRect](../atl/crect-class.md) object that is to receive the rectangle dimensions.  
...
### Parameters  
 `lpColorAdjust`  
 Points to a [COLORADJUSTMENT](../mfcref/coloradjustment-structure.md) data structure to receive the color adjustment values.  
...
### Example  
  See the example for [CPrintDialog::GetDefaults](../mfcref/cprintdialog-class.md#cprintdialog__getdefaults).  
...
### Remarks  
 ...
 ![Detail of a dithered pen stroke](../mfcref/media/vc318s1.gif "vc318S1")  
...
### Parameters  
 `lpszString`  
 Points to a character string to be measured. You can also pass a [CString](../atl/cstringt-class.md) object for this parameter.  
...
### Return Value  
 The dimensions of the string (in logical units) in a [CSize](../atl/csize-class.md) object.  
...
### Parameters  
 `lpszString`  
 Points to a string of characters. You can also pass a [CString](../atl/cstringt-class.md) object for this parameter.  
...
### Return Value  
 The dimensions of the string (in logical units) returned in a [CSize](../atl/csize-class.md) object.  
...
### Remarks  
 ...
 The **GetPixel** member function has two forms. The first takes two coordinate values; the second takes either a POINT structure or a [CPoint](../atl/cpoint-class.md) object.  
...
### Parameters  
 `lpszString`  
 Points to a character string. You can also pass a [CString](../atl/cstringt-class.md) object for this parameter.  
 ...
 *lpszFacename*  
 ...
 `rString`  
 A reference to a [CString](../atl/cstringt-class.md) object.  
...
### Parameters  
 ...
 `lpfnOutput`  
 Specifies the procedure-instance address of the application-supplied callback function that will draw the string. For more information, see the description of the Windows **OutputFunc** [callback function](../mfcref/callback-function-for-cdc--graystring.md). If this parameter is **NULL**, the system uses the Windows `TextOut` function to draw the string, and `lpData` is assumed to be a long pointer to the character string to be output.  
...
### Example  
 [!code[NVC_MFCDocView#36](../mfc/codesnippet/CPP/cdc-class_8.cpp)]  
...
### Example  
  See the example for [CRect::CenterPoint](../Topic/CRect::CenterPoint.md).  
...
### Parameters  
 `lpPoints`  
 Points to an array of points. Each point in the array is a POINT structure or a [CPoint](../atl/cpoint-class.md) object.  
  
 `nCount`  
 The number of points in the array.  
  
 `lpRect`  
 Points to a RECT structure or a [CRect](../atl/crect-class.md) object. This parameter is used for the common case of mapping a rectangle from logical to device units.  
  
 `lpSize`  
 Points to a                                 [SIZE](http://msdn.microsoft.com/library/windows/desktop/dd145106) structure or a [CSize](../atl/csize-class.md) object.  
...
### Remarks  
 By default, this device context is equal to `m_hDC`. In general, `CDC` GDI calls that request information from the device context are directed to `m_hAttribDC`. See the [CDC](../mfcref/cdc-class.md) class description for more on the use of these two device contexts.  
 ...
 *x3*  
 ...
 `ptStart`  
 Specifies the starting point of the arc. This point does not have to lie exactly on the arc. You can pass either a POINT structure or a [CPoint](../atl/cpoint-class.md) object for this parameter.  
...
### Example  
 [!code[NVC_MFCDocView#37](../mfc/codesnippet/CPP/cdc-class_9.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#38](../mfc/codesnippet/CPP/cdc-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#39](../mfc/codesnippet/CPP/cdc-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#40](../mfc/codesnippet/CPP/cdc-class_12.cpp)]  
...
### Parameters  
 *pPen*  
 A pointer to a [CPen](../mfcref/cpen-class.md) object to be selected.  
  
 `pBrush`  
 A pointer to a [CBrush](../mfcref/cbrush-class.md) object to be selected.  
  
 `pFont`  
 A pointer to a [CFont](../mfcref/cfont-class.md) object to be selected.  
  
 `pBitmap`  
 A pointer to a [CBitmap](../mfcref/cbitmap-class.md) object to be selected.  
  
 `pRgn`  
 A pointer to a [CRgn](../mfcref/crgn-class.md) object to be selected.  
  
 `pObject`  
 A pointer to a [CGdiObject](../mfcref/cgdiobject-class.md) object to be selected.  
...
### Parameters  
 `pPalette`  
 Identifies the logical palette to be selected. This palette must already have been created with the `CPalette` member function [CreatePalette](../mfcref/cpalette-class.md#cpalette__createpalette).  
...
##  <a name="cdc__selectstockobject"></a>  CDC::SelectStockObject  
 Selects a [CGdiObject](../mfcref/cgdiobject-class.md) object that corresponds to one of the predefined stock pens, brushes, or fonts.  
...
### Return Value  
 A pointer to the `CGdiObject` object that was replaced if the function is successful. The actual object pointed to is a [CPen](../mfcref/cpen-class.md), [CBrush](../mfcref/cbrush-class.md), or [CFont](../mfcref/cfont-class.md) object. If the call is unsuccessful, the return value is **NULL**.  
...
### Parameters  
 `lpfn`  
 A pointer to the abort function to install as the abort procedure. For more about the callback function, see [Callback Function for CDC::SetAbortProc](../mfcref/callback-function-for-cdc--setabortproc.md).  
...
### Example  
  See the example for [CWnd::OnCtlColor](../mfcref/cwnd-class.md#cwnd__onctlcolor).  
...
### Parameters  
 `lpColorAdjust`  
 Points to a [COLORADJUSTMENT](../mfcref/coloradjustment-structure.md) data structure containing the color adjustment values.  
...
### Remarks  
 Normally, you would not call **SetLayout** for a window. Rather, you control the right-to-left layout in a window by setting the [extended window styles](../mfcref/extended-window-styles.md) such as **WS_EX_RTLREADING**. A device context, such as a printer or a metafile, does not inherit this layout. The only way to set the device context for a right-to-left layout is by calling **SetLayout**.  
...
### Example  
  See the example for [CView::OnPrepareDC](../mfcref/cview-class.md#cview__onpreparedc).  
 ...
 *y*  
 ...
 `point`  
 Specifies the logical x- and y-coordinates of the point to be set. You can pass either a POINT data structure or a [CPoint](../atl/cpoint-class.md) object for this parameter.  
...
### Return Value  
 The previous extents of the viewport as a [CSize](../atl/csize-class.md) object. When an error occurs, the x- and y-coordinates of the returned `CSize` object are both set to 0.  
...
### Example  
 ...
 [!code[NVC_MFCDocView#41](../mfc/codesnippet/CPP/cdc-class_13.cpp)]  
 ...
 *y*  
 ...
 `lpszString`  
 Points to the character string to draw. You can pass either a pointer to an array of characters or a [CString](../atl/cstringt-class.md) object for this parameter.  
