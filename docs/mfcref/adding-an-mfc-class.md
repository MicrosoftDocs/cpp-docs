...
> [!NOTE]
>  You can add MFC classes to an ATL COM application if you initially [created the application with MFC support](../atl/mfc-support-in-atl-projects.md). You can also add MFC classes to Win32 projects that have MFC support.  
...
3.  Define the settings for the new class in the [MFC Class Wizard](../mfcref/mfc-add-class-wizard.md) dialog box.  
