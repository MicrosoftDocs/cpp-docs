...
|[CMFCOutlookBarPane::CanBeAttached](#cmfcoutlookbarpane__canbeattached)|Determines whether the pane can be docked to another pane or frame window. (Overrides [CBasePane::CanBeAttached](../mfcref/cbasepane-class.md#cbasepane__canbeattached).)|  
|`CMFCOutlookBarPane::CanBeRestored`|Determines whether the system can restore a toolbar to its original state after customization. (Overrides [CMFCToolBar::CanBeRestored](../mfcref/cmfctoolbar-class.md#cmfctoolbar__canberestored).)|  
...
|`CMFCOutlookBarPane::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../mfcref/cruntimeclass-structure.md) object that is associated with this class type.|  
...
|`CMFCOutlookBarPane::OnBeforeFloat`|Called by the framework when a pane is about to float. (Overrides [CPane::OnBeforeFloat](../mfcref/cpane-class.md#cpane__onbeforefloat).)|  
|[CMFCOutlookBarPane::RemoveButton](#cmfcoutlookbarpane__removebutton)|Removes the button that has a specified command ID.|  
|`CMFCOutlookBarPane::RestoreOriginalstate`|Restores the original state of a toolbar. (Overrides [CMFCToolBar::RestoreOriginalState](../mfcref/cmfctoolbar-class.md#cmfctoolbar__restoreoriginalstate).)|  
...
|[CMFCOutlookBarPane::RemoveAllButtons](#cmfcoutlookbarpane__removeallbuttons)|Removes all the buttons from the Outlook bar pane. (Overrides [CMFCToolBar::RemoveAllButtons](../mfcref/cmfctoolbar-class.md#cmfctoolbar__removeallbuttons).)|  
  
## Remarks  
 For information about how to implement an Outlook bar, see [CMFCOutlookBar Class](../mfcref/cmfcoutlookbar-class.md).  
  
 For an example of an Outlook bar, see the OutlookDemo sample project.  
  
## Example  
 The following example demonstrates how to use various methods of the `CMFCOutlookBarPane` class. The example shows how to create an Outlook bar pane, enable the page scroll mode, enable docking, and set the background color of the Outlook bar. This code snippet is part of the [Outlook Multi Views sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_OutlookMultiViews#3](../mfcref/codesnippet/CPP/cmfcoutlookbarpane-class_1.h)]  
[!code[NVC_MFC_OutlookMultiViews#4](../mfcref/codesnippet/CPP/cmfcoutlookbarpane-class_2.cpp)]  
...
## Inheritance Hierarchy  
 ...
 [CMFCOutlookBarPane](../mfcref/cmfcoutlookbarpane-class.md)  
...
### Remarks  
 This method directly calls [CMFCToolBarImages::Clear](../mfcref/cmfctoolbarimages-class.md#cmfctoolbarimages__clear), which is called on the images that are used by the Outlook bar pane.  
...
### Parameters  
 ...
 [in] `dwStyle`  
 The window style.  For a list of window styles, see [Window Styles](../mfcref/window-styles.md).  
...
### Remarks  
 ...
 For more information about `dwControlBarStyle` see [CBasePane::CreateEx](../mfcref/cbasepane-class.md#cbasepane__createex).  
...
### Remarks  
 ...
 The default implementation checks the customization mode ( [CMFCToolBar::IsCustomizeMode](../mfcref/cmfctoolbar-class.md#cmfctoolbar__iscustomizemode)) and if it is set to `TRUE`, disables all the shortcut menu items except **Delete**. Then, it just passes the input parameters to `CMFCToolBar::EnableContextMenuItems`.  
...
### Remarks  
 Call this method to set the Outlook bar's background image. The list of background images is managed by the embedded [CMFCToolBarImages Class](../mfcref/cmfctoolbarimages-class.md) object.  
