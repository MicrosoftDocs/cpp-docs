...
-   For member functions involved in view creation, you must provide enough information to create the view. For example, for the first view in a splitter window, you must supply the view class information and the current document.  
 ...
 For more information on `CCreateContext`, see the MFC sample [VIEWEX](../top/visual-c---samples.md).  
...
## See Also  
 ...
 [CFrameWnd::Create](../mfcref/cframewnd-class.md#cframewnd__create)   
 [CFrameWnd::LoadFrame](../mfcref/cframewnd-class.md#cframewnd__loadframe)   
 [CFrameWnd::OnCreateClient](../mfcref/cframewnd-class.md#cframewnd__oncreateclient)   
 [CSplitterWnd::Create](../mfcref/csplitterwnd-class.md#csplitterwnd__create)   
 [CSplitterWnd::CreateView](../mfcref/csplitterwnd-class.md#csplitterwnd__createview)   
 [CWnd::Create](../mfcref/cwnd-class.md#cwnd__create)