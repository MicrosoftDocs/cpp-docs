...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#1](../mfcref/codesnippet/CPP/cheaderctrl-class_1.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#2](../mfcref/codesnippet/CPP/cheaderctrl-class_2.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#3](../mfcref/codesnippet/CPP/cheaderctrl-class_3.cpp)]  
...
### Parameters  
 ...
 `rect`  
 Specifies the header control's size and position. It can be either a [CRect](../atl/crect-class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure.  
...
-   `CCS_TOP` Causes the control to position itself at the top of the parent window's client area and sets the width to be the same as the parent window's width.  
 ...
 You can also apply the following window styles to a header control (see [Window Styles](../mfcref/window-styles.md) for more information):  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#4](../mfcref/codesnippet/CPP/cheaderctrl-class_4.cpp)]  
...
### Return Value  
 A pointer to a [CImageList](../mfcref/cimagelist-class.md) object if successful; otherwise **NULL**. The returned list contains only one image.  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#5](../mfcref/codesnippet/CPP/cheaderctrl-class_5.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#6](../mfcref/codesnippet/CPP/cheaderctrl-class_6.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#7](../mfcref/codesnippet/CPP/cheaderctrl-class_7.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#8](../mfcref/codesnippet/CPP/cheaderctrl-class_8.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#6](../mfcref/codesnippet/CPP/cheaderctrl-class_9.h)]  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#4](../mfcref/codesnippet/CPP/cheaderctrl-class_10.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#9](../mfcref/codesnippet/CPP/cheaderctrl-class_11.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#10](../mfcref/codesnippet/CPP/cheaderctrl-class_12.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#2](../mfcref/codesnippet/CPP/cheaderctrl-class_13.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#11](../mfcref/codesnippet/CPP/cheaderctrl-class_14.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#3](../mfcref/codesnippet/CPP/cheaderctrl-class_15.cpp)]  
...
### Example  
 ...
 [!code[NVC_MFC_CHeaderCtrl_s4#1](../mfcref/codesnippet/CPP/cheaderctrl-class_16.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#12](../mfcref/codesnippet/CPP/cheaderctrl-class_17.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#13](../mfcref/codesnippet/CPP/cheaderctrl-class_18.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#14](../mfcref/codesnippet/CPP/cheaderctrl-class_19.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#15](../mfcref/codesnippet/CPP/cheaderctrl-class_20.cpp)]  
...
### Example  
 [!code[NVC_MFC_CHeaderCtrl#16](../mfcref/codesnippet/CPP/cheaderctrl-class_21.cpp)]  
...
### Return Value  
 A pointer to the [CImageList](../mfcref/cimagelist-class.md) object previously assigned to the header control.  
