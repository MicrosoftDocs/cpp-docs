...
ActiveX control programs are modular programs designed to give a specific type of functionality to a parent application. For example, you can create a control such as a button for use in a dialog, or toolbar for use in a Web page.  
 ...
 The easiest way to create an MFC ActiveX control is to use the [MFC ActiveX Control Wizard](../mfcref/mfc-activex-control-wizard.md).  
...
3.  Define your [application settings](../mfcref/application-settings--mfc-activex-control-wizard.md), [control names](../mfcref/control-names--mfc-activex-control-wizard.md), and [control settings](../mfcref/control-settings--mfc-activex-control-wizard.md) using the MFC ActiveX Control Wizard.  
