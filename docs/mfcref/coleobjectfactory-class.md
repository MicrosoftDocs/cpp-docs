...
### Remarks  
 Override this function to create the object from something other than the [CRuntimeClass](../mfcref/cruntimeclass-structure.md) passed to the constructor.  
...
### Remarks  
 This function is usually called by [CWinApp::InitInstance](../mfcref/cwinapp-class.md#cwinapp__initinstance) when the application is launched.  
...
### Remarks  
 The framework calls this function automatically before the application terminates. If necessary, call it from an override of [CWinApp::ExitInstance](../mfcref/cwinapp-class.md#cwinapp__exitinstance).  
...
-   **UpdateRegistry(**  `lpszProgID`  **)** Registers this object factory with the OLE system registry. This function is usually called by [CWinApp::InitInstance](../mfcref/cwinapp-class.md#cwinapp__initinstance) when the application is launched.  
