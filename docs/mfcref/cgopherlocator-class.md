...
---
# CGopherLocator Class
Gets a gopher "locator" from a gopher server, determines the locator's type, and makes the locator available to [CGopherFileFind](../mfcref/cgopherfilefind-class.md).  
...
## Remarks  
 ...
 An application normally uses the locator for calls to [CGopherFileFind::FindFile](../mfcref/cgopherfilefind-class.md#cgopherfilefind__findfile) to retrieve a specific piece of information.  
...
### Remarks  
 You never create a `CGopherLocator` object directly. Instead, call [CGopherConnection::CreateLocator](../mfcref/cgopherconnection-class.md#cgopherconnection__createlocator) to create and return a pointer to the `CGopherLocator` object.  
