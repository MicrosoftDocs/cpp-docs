...
**Gray Bitmap Functions**  
 ...
 ![Comparison of gray and original icon versions](../mfcref/media/vcgraybitmap.gif "vcGrayBitmap")  
  
|||  
|-|-|  
|[AfxDrawGrayBitmap](../Topic/AfxDrawGrayBitmap.md)|Draws a gray version of a bitmap.|  
|[AfxGetGrayBitmap](../Topic/AfxGetGrayBitmap.md)|Copies a gray version of a bitmap.|  
  
 **Dithered Bitmap Functions**  
  
 MFC also provides two functions for replacing a bitmap's background with a dithered pattern.  
  
 ![Comparison of dithered and original icon versions](../mfcref/media/vcditheredbitmap.gif "vcDitheredBitmap")  
  
|||  
|-|-|  
|[AfxDrawDitheredBitmap](../Topic/AfxDrawDitheredBitmap.md)|Draws a bitmap with a dithered background.|  
|[AfxGetDitheredBitmap](../Topic/AfxGetDitheredBitmap.md)|Copies a bitmap with a dithered background.|  
...
### Example  
 [!code[NVC_MFCDocView#191](../mfc/codesnippet/CPP/gray-and-dithered-bitmap-functions_1.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#193](../mfc/codesnippet/CPP/gray-and-dithered-bitmap-functions_2.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#190](../mfc/codesnippet/CPP/gray-and-dithered-bitmap-functions_3.cpp)]  
...
### Example  
 [!code[NVC_MFCDocView#192](../mfc/codesnippet/CPP/gray-and-dithered-bitmap-functions_4.cpp)]  
