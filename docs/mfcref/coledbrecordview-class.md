...
> [!NOTE]
>  If you are working with the Data Access Objects (DAO) classes rather than the OLE DB Consumer Template classes, use class [CDaoRecordView](../mfcref/cdaorecordview-class.md) instead. For more information, see the article [Overview: Database Programming](../data/data-access-programming--mfc-atl-.md).  
 ...
 For more information about rowset classes, see the [Using OLE DB Consumer Templates](../data/ole-db-consumer-templates--c---.md) article.  
...
### Example  
 [!code[NVC_MFCDatabase#38](../mfc/codesnippet/CPP/coledbrecordview-class_1.cpp)]  
