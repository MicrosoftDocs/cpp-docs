...
> [!NOTE]
>  This class is one of MFC's Open Database Connectivity (ODBC) classes. If you are instead using the newer Data Access Objects (DAO) classes, use [CDaoException](../mfcref/cdaoexception-class.md) instead. All DAO class names have "CDao" as a prefix. For more information, see the article [Overview: Database Programming](../data/data-access-programming--mfc-atl-.md).  
...
## See Also  
 ...
 [CRecordset::Update](../mfcref/crecordset-class.md#crecordset__update)   
 [CRecordset::Delete](../mfcref/crecordset-class.md#crecordset__delete)   
 [CException Class](../mfcref/cexception-class.md)