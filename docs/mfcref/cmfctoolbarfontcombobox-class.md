...
3.  In the message handler that processes the `AFX_WM_RESETTOOLBAR` message, replace the original button with the new combo box button by using [CMFCToolBar::ReplaceButton](../mfcref/cmfctoolbar-class.md#cmfctoolbar__replacebutton).  
...
4.  Synchronize the font that is selected in the combo box with the font in the document by using the [CMFCToolBarFontComboBox::SetFont](#cmfctoolbarfontcombobox__setfont) method.  
 ...
 To synchronize the document's font with the font selected in the combo box, use the [CMFCToolBarFontComboBox::GetFontDesc](#cmfctoolbarfontcombobox__getfontdesc) method to retrieve the attributes of the selected font, and use those attributes to create a [CFont Class](../mfcref/cfont-class.md) object.  
...
## Inheritance Hierarchy  
 ...
 [CMFCToolBarFontComboBox](../mfcref/cmfctoolbarfontcombobox-class.md)  
  
## Requirements  
 **Header:** afxtoolbarfontcombobox.h  
  
##  <a name="cmfctoolbarfontcombobox__cmfctoolbarfontcombobox"></a>  CMFCToolBarFontComboBox::CMFCToolBarFontComboBox  
 Constructs a [CMFCToolBarFontComboBox](../mfcref/cmfctoolbarfontcombobox-class.md) object.  
...
### Parameters  
 ...
 [in] `iImage`  
 The zero-based index of a toolbar image. The image is located in the [CMFCToolBarImages Class](../mfcref/cmfctoolbarimages-class.md) object that [CMFCToolBar Class](../mfcref/cmfctoolbar-class.md) class maintains.  
 ...
 [in] `dwStyle`  
 The style of the combo box. (see [Combo-Box Styles](../mfcref/combo-box-styles.md))  
 ...
 Pointer to a [CObList Class](../mfcref/coblist-class.md) object that stores the available fonts.  
...
### Example  
 The following example demonstrates how to construct a `CMFCToolBarFontComboBox` object. This code snippet is part of the [Word Pad sample](../top/visual-c---samples.md).  
  
 [!code[NVC_MFC_WordPad#7](../mfcref/codesnippet/CPP/cmfctoolbarfontcombobox-class_1.cpp)]  
