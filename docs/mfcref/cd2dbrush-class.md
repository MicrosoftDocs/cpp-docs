...
|[CD2DBrush::Destroy](#cd2dbrush__destroy)|Destroys a CD2DBrush object. (Overrides [CD2DResource::Destroy](../mfcref/cd2dresource-class.md#cd2dresource__destroy).)|  
...
|[CD2DBrush::IsValid](#cd2dbrush__isvalid)|Checks resource validity (Overrides [CD2DResource::IsValid](../mfcref/cd2dresource-class.md#cd2dresource__isvalid).)|  
