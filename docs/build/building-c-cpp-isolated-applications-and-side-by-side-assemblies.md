...
Visual Studio supports a deployment model for Windows client applications based on the idea of [isolated applications](/windows/desktop/SbsCs/isolated-applications) and [side-by-side assemblies](/windows/desktop/SbsCs/about-side-by-side-assemblies-). By default, Visual Studio builds all native C/C++ applications as isolated applications that use [manifests](/windows/desktop/sbscs/manifests) to describe their dependencies on Visual C++ libraries.
