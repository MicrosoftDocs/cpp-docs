...
Visual C++ supports a deployment model for Windows client applications based on the idea of [isolated applications](/windows/desktop/SbsCs/isolated-applications) and [side-by-side assemblies](/windows/desktop/SbsCs/about-side-by-side-assemblies-). By default, Visual C++ builds all native C/C++ applications as isolated applications that use [manifests](https://msdn.microsoft.com/library/aa375365) to describe their dependencies on Visual C++ libraries.
