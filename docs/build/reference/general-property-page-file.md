---
description: Learn more about the General property page for files.
...
This article applies to Windows projects. For non-Windows projects, see [Linux C++ Property Page Reference](../../linux/prop-pages-linux.md).
...
- **Item Type**
   ...
   Specifies the tool that processes the file during the build process. [Files whose extension is known to Visual Studio](/visualstudio/extensibility/visual-cpp-project-extensibility#project-items) have a default value for this property. You can specify a custom tool if you have a custom file type or want to override the default tool for a known file type. For more information, see [Specifying custom build tools](../specifying-custom-build-tools.md). You can also use this property page to specify that a file isn't part of the build process.
   ...
   ![Screenshot of the Property Pages dialog showing the General property page for a file.](media/file-general-item-type.png "Item Type")
    ...
    |.resx|Compiled Managed Resource|[Resgen.exe (Resource File Generator)](/dotnet/framework/tools/resgen-exe-resource-file-generator)|
