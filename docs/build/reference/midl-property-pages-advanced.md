...
For information on how to access the **Advanced** property page in the **MIDL** folder, see [Set compiler and build properties](../working-with-project-properties.md).
