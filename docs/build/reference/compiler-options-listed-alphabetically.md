...
| [`/experimental:external`](external-external-headers.md) | Enables experimental external headers support. |
...
| [`/external`](external-external-headers.md) | Allows control of diagnostics in external headers. |
