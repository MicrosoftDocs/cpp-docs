...
The `header-units.json` file serves two purposes. In addition to specifying which header files can be translated into header units, it minimizes duplicated symbols to increase build throughput.
