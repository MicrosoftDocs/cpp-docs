...
For information on how to access the **General** property page in the **MIDL** folder, see [Set C++ compiler and build properties in Visual Studio](../working-with-project-properties.md).
