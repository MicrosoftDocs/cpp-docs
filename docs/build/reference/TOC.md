...
# [MSBuild reference for C++ projects](msbuild-reference-cpp.md)
...
## [File types used in C++ projects](file-types-created-for-visual-cpp-projects.md)
...
## [C++ project properties reference](property-pages-visual-cpp.md)
...
##### [MSVC floating point optimization](floating-point-optimization.md)
...
# [Compiler and build tools errors](../../error-messages/)
# [XML Documentation for C++](xml-documentation-visual-cpp.md)
## [Recommended Tags for C++ Documentation Comments](recommended-tags-for-documentation-comments-visual-cpp.md)
### [<c>](c-visual-cpp.md)
...
## [Delimiters for C++ Documentation Tags](delimiters-for-visual-cpp-documentation-tags.md)
