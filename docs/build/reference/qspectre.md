...
The **/Qspectre** option is available in Visual Studio 2017 version 15.5.5 and all updates to Microsoft Visual C++ compilers (MSVC) made on or after January 23, 2018. The **/Qspectre** option is also available in Visual Studio 2015 Update 3 through a patch. See [KB 4338871](https://support.microsoft.com/en-us/help/4338871) for more informatiom.
