...
## Related Sections  
 ...
 [/clr (Common Language Runtime Compilation)](../buildref/-clr--common-language-runtime-compilation-.md) for information on how to run an application compiled with **/clr:safe** under WOW64 on a 64-bit operating system.  
 ...
 [MASM for x64 (ml64.exe)](../intrinsics/masm-for-x64--ml64.exe-.md)  
