...
1.  Create the recordset object ([CRecordset](../mfcref/crecordset-class.md) for ODBC, [CDaoRecordset](../mfcref/cdaorecordset-class.md) for DAO).  
  
2.  Obtain a pointer to the [CComboBox](../mfcref/ccombobox-class.md) object for the combo box control.  
