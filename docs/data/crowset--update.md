...
## Remarks  
 Transmits any pending changes made to the current row since that row was last fetched or updated (using **Update** or [UpdateAll](../data/crowset--updateall.md)). You typically call [SetData](../data/crowset--setdata.md) to set data values in columns in a row, and then call **Update** to transmit those changes.  
...
## See Also  
 ...
 [CRowset::UpdateAll](../data/crowset--updateall.md)   
