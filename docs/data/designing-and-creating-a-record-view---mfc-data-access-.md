...
1.  See [Database Support, MFC Application Wizard](../mfcref/database-support--mfc-application-wizard.md).  
...
1.  See [Adding an MFC ODBC Consumer](../mfcref/adding-an-mfc-odbc-consumer.md).  
