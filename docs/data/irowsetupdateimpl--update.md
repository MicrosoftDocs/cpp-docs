...
## Remarks  
 Changes are transmitted by calling [IRowsetChangeImpl::FlushData](../data/irowsetchangeimpl--flushdata.md). The consumer must call [CRowset::Update](../data/crowset--update.md) for the changes to take effect. Set *prgRowstatus* to an appropriate value as described in [Row States](https://msdn.microsoft.com/en-us/library/ms722752.aspx) in the *OLE DB Programmer's Reference*.  
