...
## Return Value  
 ...
 Use `GetParam` to retrieve nonstring parameter data from the buffer. Use [GetParamString](../data/cdynamicparameteraccessor--getparamstring.md) to retrieve string parameter data from the buffer.  
