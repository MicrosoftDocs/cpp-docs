 ...
 *pDBID*  
 ...
 `bstr`  
 [in] A [CComBSTR](../atl/ccombstr-class.md) reference to place a copy of the **DBID** string.  
...
## Remarks  
 This method is called by the `CRowsetImpl` implementations of [ValidateCommandID](../data/crowsetimpl--validatecommandid.md) and [GetCommandFromID](../data/crowsetimpl--getcommandfromid.md).  
