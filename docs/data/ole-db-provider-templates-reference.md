...
The classes and interfaces for the OLE DB Provider Templates can be grouped into the following categories. The reference material also includes information about the [macros for OLE DB Provider Templates](../data/macros-for-ole-db-provider-templates.md).  
...
## Session Classes  
 [IDBCreateSessionImpl](../data/idbcreatesessionimpl-class.md)  
 ...
 [ISessionPropertiesImpl](../data/isessionpropertiesimpl-class.md)  
...
## Rowset Classes  
 [CRowsetImpl](../data/crowsetimpl-class.md)  
 ...
 [CSimpleRow](../data/csimplerow-class.md)  
 ...
 [IAccessorImpl](../data/iaccessorimpl-class.md)  
 ...
 [IDBSchemaRowsetImpl](../data/idbschemarowsetimpl-class.md)  
 Implements the **IDBSchemaRowset** interface and the templatized creator function `CreateSchemaRowset`.  
  
 [IOpenRowsetImpl](../data/iopenrowsetimpl-class.md)  
 ...
 [IRowsetChangeImpl](../data/irowsetchangeimpl-class.md)  
 ...
 [IRowsetCreatorImpl](../data/irowsetcreatorimpl-class.md)  
 ...
 [IRowsetLocateImpl](../data/irowsetlocateimpl-class.md)  
 ...
 [IRowsetNotifyCP](../data/irowsetnotifycp-class.md)  
 ...
 [IRowsetUpdateImpl](../data/irowsetupdateimpl-class.md)  
...
## Command Classes  
 [ICommandImpl](../data/icommandimpl-class.md)  
 ...
 [ICommandPropertiesImpl](../data/icommandpropertiesimpl-class.md)  
 ...
 [ICommandTextImpl](../data/icommandtextimpl-class.md)  
 Sets, stores, and returns the command text. Mandatory on commands.  
  
 [IDBCreateCommandImpl](../data/idbcreatecommandimpl-class.md)  
...
## Data Source Classes  
 [IDBInitializeImpl](../data/idbinitializeimpl-class.md)  
 ...
 [IDBPropertiesImpl](../data/idbpropertiesimpl-class.md)  
...
## Other Classes  
 ...
 [IErrorRecordsImpl](../data/ierrorrecordsimpl-class.md)  
