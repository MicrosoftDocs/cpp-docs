...
4.  Move through all records in the recordset, calling [CComboBox::AddString](../mfc/reference/ccombobox-class.md#addstring) for each string from the current record you want to add to the combo box.  
