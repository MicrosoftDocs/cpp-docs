...
## In This Section  
 [OLE DB Consumer Templates](../data/ole-db-consumer-templates-reference.md)  
 Provides links to the OLE DB Consumer Template classes listed by usage.  
  
 [OLE DB Provider Templates](../data/ole-db-provider-templates-reference.md)  
...
## Related Sections  
 ...
 [OLE DB Templates Samples](../top/visual-c---samples.md)  
