...
2.  Backward one record or one rowset: call the [MovePrev](../../mfc/reference/crecordset-class.md#moveprev) member function.  
  
3.  To the first record in the recordset: call the [MoveFirst](../../mfc/reference/crecordset-class.md#movefirst) member function.  
  
4.  To the last record in the recordset or to the last rowset: call the [MoveLast](../../mfc/reference/crecordset-class.md#movelast) member function.  
  
5.  *N* records relative to the current position: call the [Move](../../mfc/reference/crecordset-class.md#move) member function.  
...
2.  Have you scrolled ahead of the first record (moving backward)? Call the [IsBOF](../../mfc/reference/crecordset-class.md#isbof) member function.  
