...
|||  
|-|-|  
|[DeleteRows](../data/irowsetchangeimpl--deleterows.md)|Deletes rows from the rowset.|  
|[InsertRow](../data/irowsetchangeimpl--insertrow.md)|Inserts a row into the rowset.|  
|[SetData](../data/irowsetchangeimpl--setdata.md)|Sets data values in one or more columns.|  
  
### Implementation Method (Callback)  
  
|||  
|-|-|  
|[FlushData](../data/irowsetchangeimpl--flushdata.md)|Overidden by provider to commit data to its store.|  
