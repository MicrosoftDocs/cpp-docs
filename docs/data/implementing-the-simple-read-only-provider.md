...
-   [Read the strings into the provider](../data/reading-strings-into-the-ole-db-provider.md)  
  
-   [Store the strings in the provider](../data/storing-strings-in-the-ole-db-provider.md)  
