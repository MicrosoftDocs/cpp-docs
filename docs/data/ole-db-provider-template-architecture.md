...
## Data Sources and Sessions  
 ...
 ![Provider architecture](../data/media/vc4twb1.gif "vc4TWB1")  
...
-   [Data source](../data/data-source-object-interfaces.md)  
  
-   [Session](../data/session-object-interfaces.md)  
  
-   [Rowset](../data/rowset-object-interfaces.md)  
  
-   [Command](../data/command-object-interfaces.md)  
  
-   [Transaction](../data/transaction-object-interfaces.md)  
