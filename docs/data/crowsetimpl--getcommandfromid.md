...
---
# CRowsetImpl::GetCommandFromID
Checks to see if either or both parameters contain string values, and if so, copies the string values to the data members [m_strCommandText](../data/crowsetimpl--m_strcommandtext.md) and [m_strIndexText](../data/crowsetimpl--m_strindextext.md).  
