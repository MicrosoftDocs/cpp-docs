...
-   [Inserting the Control into a Visual C++ Application](../data/inserting-the-control-into-a-visual-c---application.md)  
  
-   [Wrapper Classes](../data/wrapper-classes.md)  
  
-   [Creating a Database Connection](../data/creating-database-connections.md)  
  
-   [Setting Control Properties at Design Time](../data/setting-control-properties-at-design-time.md)  
  
-   [Setting Event Handlers on ActiveX Controls](../data/setting-event-handlers-on-activex-controls.md)  
  
-   [Modifying a Control's Run-Time Behavior](../data/modifying-a-control-s-run-time-behavior.md)  
  
-   [Redistributing Controls](../data/redistributing-controls.md)  
