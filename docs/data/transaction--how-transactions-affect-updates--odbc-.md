...
## See Also  
 ...
 [Transaction (ODBC)](../data/transaction--odbc-.md)   
 [Transaction: Performing a Transaction in a Recordset (ODBC)](../data/transaction--performing-a-transaction-in-a-recordset--odbc-.md)   
