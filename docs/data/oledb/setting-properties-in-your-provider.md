...
- The variant type of the property (in [OLE DB Properties](https://docs.microsoft.com/previous-versions/windows/desktop/ms722734(v=vs.85)) in the **OLE DB Programmer's Reference**). Enter the VT_ type (such as VT_BOOL or VT_I2) corresponding to the data type.
