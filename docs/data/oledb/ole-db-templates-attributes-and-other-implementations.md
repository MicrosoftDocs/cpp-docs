...
-   See the list of [OLE DB templates samples](http://msdn.microsoft.com/08958863-0b5f-41ad-ae99-fca7440c553c).  
  
-   See [OLE DB Programmer's Reference](https://msdn.microsoft.com/library/ms713643.aspx) (in the Windows SDK).  
...
## OLE DB SDK Interfaces  
 In the cases where the OLE DB Templates do not support OLE DB functionality, you need to use the OLE DB interfaces themselves. For more information, see [OLE DB Programmer's Reference](https://msdn.microsoft.com/library/ms713643.aspx) in the Windows SDK.  
