...
|[Close](#close)|Unbinds all the columns, releases the allocated memory, and releases the [IAccessor](/previous-versions/windows/desktop/ms719672) interface pointer in the class.|  
