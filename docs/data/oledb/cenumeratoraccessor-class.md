...
|[m_szParseName](#szparsename)|String to pass to [IParseDisplayName](https://msdn.microsoft.com/library/windows/desktop/ms680604) to obtain a moniker for the data source or enumerator.|  
...
String to pass to [IParseDisplayName](https://msdn.microsoft.com/library/windows/desktop/ms680604) to obtain a moniker for the data source or enumerator.  
