...
> [!NOTE]
>  In the MFC DAO classes, you can get catalog information as follows: Use [CDaoDatabase::GetTableDefCount](../mfc/reference/cdaodatabase-class.md#gettabledefcount) and [CDaoDatabase::GetTableDefInfo](../mfc/reference/cdaodatabase-class.md#gettabledefinfo) to enumerate the tables in the database and obtain information for each table in a [CDaoTableDefInfo](../mfc/reference/cdaotabledefinfo-structure.md) structure.  
