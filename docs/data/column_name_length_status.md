...
---
# COLUMN_NAME_LENGTH_STATUS
Represents a binding on the rowset to the specific column in the rowset. Similar to [COLUMN_NAME](../data/column_name.md), except that this macro also takes column length and column status.  
