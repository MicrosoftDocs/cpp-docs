...
|||  
|-|-|  
|[Compare](../data/irowsetlocateimpl--compare.md)|Compares two bookmarks.|  
|[GetRowsAt](../data/irowsetlocateimpl--getrowsat.md)|Fetches rows starting with the row specified by an offset from a bookmark.|  
|[GetRowsByBookmark](../data/irowsetlocateimpl--getrowsbybookmark.md)|Fetches the rows that match the specified bookmarks.|  
|[Hash](../data/irowsetlocateimpl--hash.md)|Returns hash values for the specified bookmarks.|  
  
### Data Members  
  
|||  
|-|-|  
|[m_rgBookmarks](../data/irowsetlocateimpl--m_rgbookmarks.md)|An array of bookmarks.|  
...
## Remarks  
 ...
 For information on implementing bookmark support, see [Provider Support for Bookmarks](../data/provider-support-for-bookmarks.md) in the *Visual C++ Programmer's Guide* and [Bookmarks](https://msdn.microsoft.com/en-us/library/ms709728.aspx) in the *OLE DB Programmer's Reference* in the `Platform``SDK`.  
...
## See Also  
 ...
 [Provider Support for Bookmarks](../data/provider-support-for-bookmarks.md)   
