...
'function' : function signature contains type 'type'; C++ objects are unsafe to pass between pure code and mixed or native.  
 ...
 For more information on **/clr:pure**, see [How to: Migrate to /clr:pure (C++/CLI)](../cli/how-to--migrate-to--clr-pure--c---cli-.md).  
  
 C4412 is off by default. See [Compiler Warnings That Are Off by Default](../c/compiler-warnings-that-are-off-by-default.md) and [dllexport, dllimport](../cpp/dllexport--dllimport.md) for more information.  
