...
With Visual Studio 2019, you can create a new CMake project from scratch, or bring your own existing CMake project into Visual Studio. To create a new CMake project, follow the instructions below. Or skip ahead to [Open a CMake project folder](#open-a-cmake-project-folder).
...
[Configure a CMake Linux project](cmake-linux-debug.md)
