...
---
# VSPackage State
Many factors determine the set of persisted values, or state, of a [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] application.  
...
-   Objects that an application creates can have properties of their own.  
 ...
 Here are some of the ways that a [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] application state can be managed:  
...
## In This Section  
 [Support for State Persistence](../notintoc/support-for-state-persistence.md)  
 ...
 [Support for Settings Categories](../notintoc/support-for-settings-categories.md)  
 ...
 Explains how to create a [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] settings category and use it to save values to and restore values from a settings file.  
