...
**MSB3153: Xml validation did not pass for item '\<package>' located at '\<folder>'.**  
 ...
 This warning is generated when the manifest (specifically package.xml) does not pass XML validation. The specific problems are listed in a subsequent error message ([MSBuild Error MSB3159](../notintoc/msbuild-error-msb3159.md) or [MSBuild Error MSB3160](../notintoc/msbuild-error-msb3160.md)).  
