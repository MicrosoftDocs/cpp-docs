...
---
# VSPackage Branding
VSPackages can display icons and textual information about products (together called logos) in the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] splash screen and the **Help About** dialog box. For every product you add as a VSPackage, you can add one logo. The splash screen and **Help About** dialog box contain logos for the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] core products and other installed products.  
  
## In This Section  
 [Branding Overview](../notintoc/branding-overview.md)  
 Discusses several approaches to creating splash screen and **Help About** logos.  
  
 [How to: Brand a VSPackage (C# and Visual Basic)](../notintoc/how-to--brand-a-vspackage--csharp-and-visual-basic-.md)  
 Explains how to brand a managed VSPackage.  
  
 [How to: Brand a VSPackage (C++)](../notintoc/how-to--brand-a-vspackage--c---.md)  
 Explains how to brand an unmanaged VSPackage.  
  
 [How to: Test the Help About and Splash Screens](../notintoc/how-to--test-the-help-about-and-splash-screens.md)  
 Explains how to test the help about and splash screens.  
  
## Related Sections  
 Reference.Package Sample (C#) in [VSSDK Samples](../notintoc/vssdk-samples.md)  
