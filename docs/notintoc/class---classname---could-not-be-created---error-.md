...
A class initialization has failed. One possible cause is a corrupted [!INCLUDE[dnprdnshort](../ide/includes/dnprdnshort_md.md)] installation.  
...
2.  Reinstall the [!INCLUDE[dnprdnshort](../ide/includes/dnprdnshort_md.md)] and recompile the program.  
  
3.  If the error recurs, reinstall the [!INCLUDE[vbprvb](../cli/includes/vbprvb_md.md)] compiler.  
