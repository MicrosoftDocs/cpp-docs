...
---
# Options Pages
This content has been removed. For information about extending Tools Options pages, see [Using Options Pages](../notintoc/using-options-pages.md).  
  
## In This Section  
 [Using Options Pages](../notintoc/using-options-pages.md)  
 Provides an overview of how a VSPackage can use the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] automation model to manage the state of **Tools Options** pages.  
