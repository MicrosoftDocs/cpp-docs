...
## Remarks  
 For a code example, see [binomial_distribution Class](../stdcpplib/binomial_distribution-class.md).  
...
## See Also  
 ...
 [binomial_distribution Class](../stdcpplib/binomial_distribution-class.md)   
 [binomial_distribution::t](../notintoc/binomial_distribution--t.md)