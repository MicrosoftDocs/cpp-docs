...
The [!INCLUDE[vbprvb](../cli/includes/vbprvb_md.md)] compiler calls the Assembly Linker (Al.exe, also known as Alink) to generate an assembly with a manifest. The linker reported an error finding a key file or key name with which to sign the assembly.  
  
 **Error ID:** BC30139  
  
### To correct this error  
  
1.  Examine the quoted error message and consult the page named [Al.exe Tool Errors and Warnings](assetId:///7f125d49-0a03-47a6-9ba9-d61a679a7d4b) for further explanation and advice.  
