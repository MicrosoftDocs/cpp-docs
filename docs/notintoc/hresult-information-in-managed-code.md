...
>  The \<xref:Microsoft.VisualStudio.VSConstants> class contains constants for common HRESULTS, for example, \<xref:Microsoft.VisualStudio.VSConstants.S_OK> and \<xref:Microsoft.VisualStudio.VSConstants.E_NOTIMPL>, and [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] HRESULTS, for example, \<xref:Microsoft.VisualStudio.VSConstants.VS_E_INCOMPATIBLEDOCDATA> and \<xref:Microsoft.VisualStudio.VSConstants.VS_E_UNSUPPORTEDFORMAT>. \<xref:Microsoft.VisualStudio.VSConstants> also provides the \<xref:Microsoft.VisualStudio.ErrorHandler.Succeeded*> and \<xref:Microsoft.VisualStudio.ErrorHandler.Failed*> methods, which correspond to the SUCCEEDED and FAILED macros in COM.  
 ...
 [!code[VSSDKHRESULTInformation#1](../notintoc/codesnippet/VisualBasic/hresult-information-in-managed-code_1.vb)]
[!code[VSSDKHRESULTInformation#1](../notintoc/codesnippet/CSharp/hresult-information-in-managed-code_1.cs)]  
 ...
 [!code[VSSDKHRESULTInformation#2](../notintoc/codesnippet/VisualBasic/hresult-information-in-managed-code_2.vb)]
[!code[VSSDKHRESULTInformation#2](../notintoc/codesnippet/CSharp/hresult-information-in-managed-code_2.cs)]  
