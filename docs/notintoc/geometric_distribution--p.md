...
## Remarks  
 For a code example, see [geometric_distribution Class](../stdcpplib/geometric_distribution-class.md).  
...
## See Also  
 ...
 [geometric_distribution Class](../stdcpplib/geometric_distribution-class.md)