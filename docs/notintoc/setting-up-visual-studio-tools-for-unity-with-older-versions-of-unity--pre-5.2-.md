...
### 1 - Create a Unity Project  
 ...
 ![Create a new Unity project with the VSTU package.](../notintoc/media/vstu_configure_unity_import_vstu_new.png "vstu_configure_unity_import_vstu_new")  
...
### 2 - Configure Unity Editor to use Visual Studio Tools for Unity  
 ...
 ![Import the VSTU package into your Unity project.](../notintoc/media/vstu_configure_unity_import_vstu.png "vstu_configure_unity_import_vstu")  
 ...
 ![Configure the Unity build settings for debugging.](../notintoc/media/vstu_debugging_build_settings.png "vstu_debugging_build_settings")  
...
### 3 - Launch Visual Studio from Unity Editor  
 ...
 ![Open your unity project in Visual Studio.](../notintoc/media/vstu_configure_open_in_visual_studio.png "vstu_configure_open_in_visual_studio")  
