...
1.  Set the \<xref:Microsoft.VisualStudio.Shell.Interop.UIContextGuids80.SolutionOrProjectUpgrading> flag (defined in vsshell80.idl) in your project item implementation. This causes your project item VSPackage to auto load when the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] shell determines that a project system is in the process of upgrading.  
...
## See Also  
 ...
 [Upgrading Custom Projects](../notintoc/upgrading-custom-projects.md)