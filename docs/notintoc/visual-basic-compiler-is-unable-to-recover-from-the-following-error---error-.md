...
The [!INCLUDE[vbprvb](../cli/includes/vbprvb_md.md)] compiler is unable to recover from the following error: <`error`>.  
  
 Some IDE features have been disabled.  
  
 An internal error has occurred in the [!INCLUDE[vbprvb](../cli/includes/vbprvb_md.md)] compiler.  
  
 **Error ID:** BC31021  
  
### To correct this error  
  
1.  Save your work and restart [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)].  
  
2.  If the error recurs, reinstall [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)].  
