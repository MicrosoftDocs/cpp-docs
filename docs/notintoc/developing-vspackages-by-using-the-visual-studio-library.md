...
## In This Section  
 ...
 [Implementing VSPackages By Using the Visual Studio Library](../notintoc/implementing-vspackages-by-using-the-visual-studio-library.md)  
...
## Related Sections  
 ...
 Provides an overview of the [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] Development Environment SDK.