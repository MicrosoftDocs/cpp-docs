...
## Tool Window Essentials  
 ...
 Tool windows are typically created or opened by clicking a menu command. To create a tool window programmatically, see [Opening a Tool Window Programmatically](../notintoc/opening-a-tool-window-programmatically.md).  
...
## See Also  
 [Tool Windows](../notintoc/extending-tool-windows.md)   
