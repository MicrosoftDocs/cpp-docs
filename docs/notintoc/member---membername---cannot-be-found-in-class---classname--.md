...
2.  If the error recurs, save your work and restart [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)].  
  
3.  If the error persists, reinstall [!INCLUDE[vbprvb](../cli/includes/vbprvb_md.md)].  
