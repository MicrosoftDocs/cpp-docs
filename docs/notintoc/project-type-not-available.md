...
-   This dialog box appears because a product or product version required to open the specified file was not found. It is common for this error to occur when attempting to open a project file that cannot be opened with the installed version of [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)]. For example, attempting to open a [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] project file with [!INCLUDE[vbprvbxprlong](../notintoc/includes/vbprvbxprlong_md.md)] will open this dialog box.  
  
#### To work around this error  
  
-   Install the correct version of [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)].  
