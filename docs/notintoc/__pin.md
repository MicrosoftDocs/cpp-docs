...
---
# __pin
**Note** This topic applies only to version 1 of Managed Extensions for C++. This syntax should only be used to maintain version 1 code. See [pin_ptr (C++/CLI)](../windows/pin_ptr--c---cli-.md) for information on using the equivalent functionality in the new syntax.  
