...
f1_keywords: ["volatile_cpp", "volatile"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""interrupt handlers and volatile keyword [C++]"", ""volatile keyword [C++]"", ""volatile objects [C++]"", ""objects [C++], volatile""]"]
