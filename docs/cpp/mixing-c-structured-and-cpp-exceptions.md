...
1. C++ exception handling can catch and preserve unwind semantics in all modules compiled with the [/EH](../build/reference/eh-exception-handling-model.md) compiler option (this option enables unwind semantics).
...
- [Using setjmp or longjmp in C++ programs](../cpp/using-setjmp-longjmp.md)
  ...
  Read this for information on the use of **setjmp** and **longjmp** in C++ programs.
