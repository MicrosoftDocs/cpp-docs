...
dev_langs: ["C++"]
helpviewer_keywords: ["[""objects [C++], referencing"", ""references [C++]"", ""references [C++], to pointers"", ""declarations [C++], references"", ""references [C++], declaring"", ""referencing objects, declarator syntax""]"]
