...
dev_langs: ["C++"]
helpviewer_keywords: ["[""__single_inheritance keyword [C++]"", ""declaring derived classes [C++]"", ""keywords [C++], inheritance keywords"", ""__multiple_inheritance keyword [C++]"", ""__virtual_inheritance keyword [C++]"", ""inheritance [C++], declaring derived classes"", ""derived classes [C++], declaring"", ""inheritance [C++], keywords""]"]
