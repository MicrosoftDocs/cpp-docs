...
f1_keywords: ["<<", ">>"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""<< operator [C++], with specific objects"", ""left shift operators [C++]"", ""right shift operators [C++]"", ""bitwise-shift operators [C++]"", "">> operator [C++]"", ""shift operators [C++]"", ""operators [C++], shift""]"]
