...
f1_keywords: ["thread", "thread_cpp"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""thread local storage (TLS) [C++]"", ""thread __declspec keyword"", ""TLS (thread local storage), compiler implementation"", ""__declspec keyword [C++], thread""]"]
