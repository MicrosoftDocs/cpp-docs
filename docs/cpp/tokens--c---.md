...
-   Comments  
 ...
 The parser recognizes keywords, identifiers, literals, operators, and punctuators. For information on specific token types, see [Keywords](../cpp/keywords--c---.md), [Identifiers](../cpp/identifiers--c---.md), [Numeric, Boolean and Pointer Literals](../cpp/numeric--boolean-and-pointer-literals---c---.md), [String and Character Literals](../cpp/string-and-character-literals---c---.md), [User-Defined Literals](../cpp/user-defined-literals---c---.md), [C++ Built-in Operators, Precedence and Associativity](../cpp/c---built-in-operators--precedence-and-associativity.md), and [Punctuators](../cpp/punctuators--c---.md). White space is ignored, except as required to separate tokens.  
