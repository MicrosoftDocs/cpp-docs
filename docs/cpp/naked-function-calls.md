...
dev_langs: ["C++"]
helpviewer_keywords: ["[""virtual device drivers [C++]"", ""VXD virtual device drivers [C++]"", ""virtual device drivers, naked function calls"", ""naked functions [C++]"", ""prolog code [C++]"", ""epilog code [C++]"", ""naked keyword [C++]"", ""naked keyword [C++], storage-class attribute""]"]
