...
f1_keywords: ["Variant", "_variant_t"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""_variant_t class, operators"", ""_variant_t class"", ""_variant_t class, member functions"", ""VARIANT object [C++]"", ""VARIANT object, COM encapsulation""]"]
