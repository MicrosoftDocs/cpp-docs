...
## Remarks  
 ...
 In both forms of the **if** statement, *expression*, which can have any value except a structure, is evaluated, including all side effects. Control passes from the **if** statement to the next statement in the program unless one of the *statement*s contains a [break](../cpp/break-statement--c---.md), [continue](../cpp/continue-statement--c---.md), or [goto](../cpp/goto-statement--c---.md).  
