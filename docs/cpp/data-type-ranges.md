...
f1_keywords: ["unsigned", "wchar_t", "char", "signed", "short", "long", "double", "float", "int", "long_double"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""float keyword [C++]"", ""char keyword [C++]"", ""unsigned long [C++]"", ""__wchar_t keyword [C++]"", ""unsigned short int [C++]"", ""enum keyword [C++]"", ""unsigned char keyword [C++]"", ""integer data type, data type ranges"", ""int data type [C++]"", ""data types [C++], ranges"", ""unsigned int [C++]"", ""short data type [C++]"", ""short int data [C++]"", ""signed types [C++], data type ranges"", ""long long keyword [C++]"", ""long double keyword [C++]"", ""double data type, data type ranges"", ""signed short int [C++]"", ""unsigned short [C++]"", ""sized integer types [C++]"", ""signed int [C++]"", ""signed long int [C++]"", ""signed char keyword [C++]"", ""wchar_t keyword [C++]"", ""long keyword [C++]"", ""ranges [C++]"", ""unsigned types [C++], data type ranges"", ""floating-point numbers, data type ranges"", ""ranges [C++], data types"", ""long int keyword [C++]"", ""unsigned long int [C++]""]"]
