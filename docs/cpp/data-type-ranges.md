...
dev_langs: ["C++"]
helpviewer_keywords: ["float keyword [C++]", "char keyword [C++]", "unsigned long", "__wchar_t keyword [C++]", "unsigned short int", "enum keyword", "unsigned char keyword [C++]", "integer data type, data type ranges", "int data type", "data types [C++], ranges", "unsigned int", "short data type", "short int data", "signed types [C++], data type ranges", "long long keyword [C++]", "long double keyword [C++]", "double data type, data type ranges", "signed short int", "unsigned short", "sized integer types", "signed int", "signed long int", "signed char keyword [C++]", "wchar_t keyword [C++]", "long keyword [C++]", "ranges [C++]", "unsigned types [C++], data type ranges", "floating-point numbers, data type ranges", "ranges [C++], data types", "long int keyword [C++]", "unsigned long int"]
