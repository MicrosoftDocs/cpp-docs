...
dev_langs: ["C++"]
helpviewer_keywords: ["[""scope [C++], linkage rules"", ""linkage [C++], scope linkage rules"", ""names [C++], scope linkage rules"", ""static modifier [C++], file scope"", ""static names and file scope [C++]"", ""file scope [C++]"", ""declarations [C++], external"", ""external linkage, scope linkage rules"", ""static variables [C++], external declarations""]"]
