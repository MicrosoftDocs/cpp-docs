...
dev_langs: ["C++"]
helpviewer_keywords: ["[""arguments [C++], function"", ""functions [C++], paramters"", ""function parameters, reference-type"", ""function arguments, reference-type"", ""passing parameters, reference-type arguments""]"]
