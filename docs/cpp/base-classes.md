...
dev_langs: ["C++"]
helpviewer_keywords: ["[""inheritance [C++], multiple"", ""base classes [C++], virtual"", ""derived classes [C++], multiple bases"", ""multiple inheritance [C++], base classes"", ""virtual base classes [C++]"", ""base classes""]"]
