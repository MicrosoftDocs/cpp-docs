...
dev_langs: ["C++"]
helpviewer_keywords: ["[""casting [C++]"", ""coercion [C++]"", ""virtual functions [C++], in derived classes"", ""static cast operator [C++]"", ""dynamic cast operator [C++]"", ""polymorphic classes [C++]"", ""classes [C++], polymorphism""]"]
