...
dev_langs: ["C++"]
helpviewer_keywords: ["[""virtual functions [C++], explicit overrides"", ""overriding, functions"", ""derived classes [C++], virtual functions"", ""explicit virtual function overrides [C++]"", ""explicit override of virtual function [C++]""]"]
