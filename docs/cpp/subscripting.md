...
dev_langs: ["C++"]
helpviewer_keywords: ["[""subscript operator [C++], overloaded"", ""arrays [C++], subscripting"", ""subscripting [C++]"", ""operators [C++], overloading"", ""operator overloading [C++], examples"", ""subscript operator [C++]""]"]
