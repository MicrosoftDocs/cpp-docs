...
f1_keywords: ["not_eq", "!=", "=="]
dev_langs: ["C++"]
helpviewer_keywords: ["[""!= operator [C++]"", ""equality operator [C++]"", ""not equal to comparison operator [C++]"", ""equality operator [C++], syntax"", ""== operator [C++]"", ""not_eq operator [C++]"", ""equal to operator [C++]""]"]
