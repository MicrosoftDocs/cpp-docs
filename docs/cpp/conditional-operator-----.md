...
-   If both operands are of arithmetic or enumeration types, the usual arithmetic conversions (covered in [Arithmetic Conversions](../notintoc/arithmetic-conversions.md)) are performed to convert them to a common type.  
...
## See Also  
 ...
 [Conditional-Expression Operator](../c/conditional-expression-operator.md)