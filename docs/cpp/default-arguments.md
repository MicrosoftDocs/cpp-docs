...
dev_langs: ["C++"]
helpviewer_keywords: ["[""arguments [C++], function"", ""function declarators [C++]"", ""functions [C++], default arguments"", ""declaring functions [C++], declarators"", ""default arguments [C++]"", ""arguments [C++], default"", ""defaults [C++], arguments""]"]
