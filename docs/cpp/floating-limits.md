...
dev_langs: ["C++"]
helpviewer_keywords: ["[""ranges [C++], floating-point constants"", ""floating-point constants [C++], limits"", ""FLOAT.H header file"", ""limits, floating-point constants"", ""floating-point numbers, floating limits""]"]
