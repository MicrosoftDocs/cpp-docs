...
f1_keywords: ["single inheritance_cpp", "single inheritance"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""single inheritance [C++]"", ""base classes, indirect"", ""scope, scope resolution operator"", ""operators [C++], scope resolution"", ""scope resolution operator [C++]"", ""derived classes, single base class"", ""inheritance [C++], single""]"]
