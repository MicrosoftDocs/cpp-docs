...
Default constructors are one of the *special member functions*. In many cases, if no constructors are declared in a class, the compiler provides an implicit default constructor. 
