...
dev_langs: ["C++"]
helpviewer_keywords: ["[""classes [C++], declaring"", ""declarations [C++], class"", ""nested classes [C++]"", ""nested classes [C++], declaring"", ""declaring classes [C++]"", ""declarations [C++], nested classes""]"]
