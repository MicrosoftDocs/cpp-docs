...
dev_langs: ["C++"]
helpviewer_keywords: ["[""structured exception handling [C++], termination handlers"", ""exceptions [C++], terminating"", ""termination handlers [C++], writing"", ""handlers [C++]"", ""handlers [C++], termination"", ""termination handlers [C++]"", ""exception handling [C++], termination handlers"", ""try-catch keyword [C++], termination handlers""]"]
