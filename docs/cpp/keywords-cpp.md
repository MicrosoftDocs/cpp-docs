...
ms.tgt_pltfrm: ""
ms.topic: "index-page "
f1_keywords: ["_raise", "_value", "_interface", "_assume", "_declspec", "_if_exists", "cdecl", "_sealed", "_box", "_nogc", "_ptr64", "_fastcall", "_alignof", "_stdcall", "_single_inheritance", "_event", "_noop", "_based", "_cdecl", "_m64", "_virtual_inheritance", "_inline", "_delegate", "_int64", "_multiple_inheritance", "_m128d", "_try_cast", "_asm", "_int16", "_hook", "_int32", "_property", "_m128", "_m128i", "_int8", "_identifier", "_forceinline", "_gc", "_unaligned", "_uuidof", "_if_not_exists", "_unhook", "_pin", "_super", "_abstract"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""Visual C++, keywords"", ""keywords [C++]"", ""__identifer keyword [C++], naming"", ""Microsoft-specific keywords [C++]"", ""__identifer keyword [C++]""]"]
