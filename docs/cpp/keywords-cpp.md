...
|[unsigned](../cpp/fundamental-types-cpp.md)|[using](../cpp/using-declaration.md) declaration, [using](namespaces_cpp.md#using_directives) directive|[uuid](../cpp/uuid-cpp.md) <sup>1</sup>|  
