...
f1_keywords: ["%", "/"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""operators [C++], multiplicative"", ""arithmetic operators [C++], multiplicative operators"", ""modulus operator [C++]"", ""* operator [C++]"", ""division operator [C++], multiplicative operators"", ""% operator [C++]"", ""multiplication operator [C++], multiplicative operators"", ""multiplicative operators [C++]"", ""division operator [C++]""]"]
