...
## Remarks  
 A C++ [class](../cpp/class--c---.md) or [struct](../cpp/struct--c---.md) could be implemented with these rules, but `__interface` enforces them.  
...
```  
 ...
 For information on managed interfaces, see [interface class](../windows/interface-class---c---component-extensions-.md).  
