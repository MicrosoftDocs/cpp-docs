...
dev_langs: ["C++"]
helpviewer_keywords: ["[""defaults, arguments"", ""function definitions [C++]"", ""function definitions, about function definitions"", ""default arguments [C++]"", ""declarators [C++], functions""]"]
