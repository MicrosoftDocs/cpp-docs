...
f1_keywords: []
dev_langs: ["C++"]
helpviewer_keywords: ["[""operator Interface& [C++]"", ""* operator [C++], with specific objects"", ""operator& [C++]"", ""operator* [C++]"", ""-> operator [C++], with specific objects"", ""& operator [C++], with specific objects"", ""operator Interface* [C++]"", ""operator * [C++]"", ""operator-> [C++]"", ""operator bool [C++]"", ""extractors, _com_ptr_t class"", ""extractors [C++]""]"]
