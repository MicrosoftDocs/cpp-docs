...
dev_langs: ["C++"]
helpviewer_keywords: ["[""member-selection operators [C++]"", ""pointers [C++], smart"", ""member access [C++], overloaded operators"", ""operator overloading [C++], member access operators"", ""smart pointers [C++], definition"", ""smart pointers [C++]""]"]
