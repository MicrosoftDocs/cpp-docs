 ...
 *scalar* – *scalar*  
 ...
 If both operands are of arithmetic type, the conversions covered in [Arithmetic Conversions](../notintoc/arithmetic-conversions.md) are applied to the operands, and the result is of the converted type.  
...
## See Also  
 ...
 [Addition of Pointer Types](../notintoc/addition-of-pointer-types.md)   
 [Subtraction of Pointer Types](../notintoc/subtraction-of-pointer-types.md)   
