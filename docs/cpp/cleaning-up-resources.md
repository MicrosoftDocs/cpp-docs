...
dev_langs: ["C++"]
helpviewer_keywords: ["[""termination handlers [C++], cleaning up resources"", ""exception handling, cleaning up resources"", ""C++ exception handling, termination handlers"", ""resources [C++], cleaning up"", ""exception handling, cleanup code"", ""try-catch keyword [C++], termination handlers""]"]
