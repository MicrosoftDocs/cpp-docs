...
**Microsoft Specific**  
 ...
 Throws a [_com_error](../cpp/_com_error-class.md) in response to a failure.  
...
## Remarks  
 ...
 You can also use [_set_com_error_handler](../cpp/_set_com_error_handler.md) to replace the default error-handling function.  
 ...
 **Lib:** If the “wchar_t is Native Type” compiler option is on, use comsuppw.lib or comsuppwd.lib. If “wchar_t is Native Type” is off, use comsupp.lib. For more information, see [/Zc:wchar_t (wchar_t Is Native Type)](../buildref/-zc-wchar_t--wchar_t-is-native-type-.md).  
