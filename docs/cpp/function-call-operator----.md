...
```  
 ...
 Functions can be called recursively. For more information about function declarations, see [Function Specifiers](../notintoc/function-specifiers.md) and [Member Functions](../notintoc/member-functions--c---.md). Related material is in [Program and Linkage](../cpp/program-and-linkage---c---.md).  
