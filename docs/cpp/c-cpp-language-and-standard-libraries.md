...
|[Visual C++](../overview/visual-cpp-in-visual-studio.md)|Describes key features of C++ in Visual Studio and links to the rest of the Visual Studio C++ documentation.|
