...
|[SafeInt Library](../safeint/safeint-library.md)|Reference content for a portable library of functions that handle integers without the risk of overflow.|
|[C++ in Visual Studio](../overview/visual-cpp-in-visual-studio.md)|Describes key features of C++ in Visual Studio and links to the rest of the Visual Studio C++ documentation.|
|[Overview of C++ Development in Visual Studio](../overview/overview-of-cpp-development.md)|Links to other articles that contain information about how to use Visual Studio and its related tools to create, build, and deploy C++ apps.|
|[What's New for Visual C++](../overview/what-s-new-for-visual-cpp-in-visual-studio.md)|Describes the new features and enhancements in this release.|