...
dev_langs: ["C++"]
helpviewer_keywords: ["[""array-element initializers [C++]"", ""initializing arrays [C++], initializers"", ""arrays [C++], array-element initializers"", ""declarators [C++], as initializers"", ""initializers [C++], array element""]"]
