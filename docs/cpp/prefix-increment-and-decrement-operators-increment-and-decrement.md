...
f1_keywords: ["--", "++"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""increment operators [C++], syntax"", ""++ operator [C++], prefix increment operators"", ""operators [C++], decrement"", ""-operator [C++], prefix decrement operators"", ""operators [C++], increment"", ""decrement operators [C++], syntax"", ""decrement operators [C++]""]"]
