...
dev_langs: ["C++"]
helpviewer_keywords: ["[""operators [C++], bitwise"", ""exclusive OR operator [C++]"", ""XOR operator [C++]"", ""bitwise operators [C++], OR operator"", ""^ operator [C++]"", ""OR operator [C++], bitwise exclusive"", ""operators [C++], logical""]"]
