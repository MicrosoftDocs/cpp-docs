...
dev_langs: ["C++"]
helpviewer_keywords: ["[""arguments [C++], variable number of"", ""variable argument lists [C++]"", ""declarators [C++], functions"", ""argument lists [C++], variable number of"", ""declaring functions [C++], variables"", ""function calls, variable number of arguments""]"]
