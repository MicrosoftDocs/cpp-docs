...
#### Parameters  
 ...
 `ms-decl-spec`  
 Optional storage-class specification. For more information, refer to the [__declspec](../cpp/__declspec.md) keyword.  
 ...
 `base-list`  
 Optional list of classes or structures this structure will derive its members from. See [Base Classes](../cpp/base-classes.md) for more information. Each base class or structure name can be preceded by an access specifier ([public](../cpp/public--c---.md), [private](../cpp/private--c---.md), [protected](../cpp/protected--c---.md)) and the [virtual](../cpp/virtual--c---.md) keyword. See the member-access table in [Controlling Access to Class Members](../notintoc/controlling-access-to-class-members.md) for more information.  
...
## Remarks  
 ...
 For information on managed classes and structs, see [Classes and Structs](../windows/classes-and-structs---c---component-extensions-.md).  
...
## Using a Structure  
 ...
 For related information, see [class](../cpp/class--c---.md), [union](../cpp/unions.md), and [enum](../cpp/enumerations--c---.md).  
