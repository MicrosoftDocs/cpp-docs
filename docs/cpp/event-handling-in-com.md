...
dev_langs: ["C++"]
helpviewer_keywords: ["[""event handling [C++], COM"", ""event handling [C++], about event handling"", ""declaring events [C++]"", ""event handlers [C++], COM"", ""event handlers [C++]"", ""COM, events"", ""event receivers, in event handling"", ""event handling [C++]"", ""hooking events [C++]"", ""event receivers, name and signature matching"", ""event sources, in event handling"", ""declaring events, in COM"", ""declaring events, event handling in COM""]"]
