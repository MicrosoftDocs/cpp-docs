...
## Remarks  
 You can use the [/volatile](../buildref/-volatile--volatile-keyword-interpretation-.md) compiler switch to modify how the compiler interprets this keyword.  
 ...
 When `volatile` is used on a variable that also has the [__restrict](../cpp/__restrict.md) keyword, `volatile` takes precedence.  
