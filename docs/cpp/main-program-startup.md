...
dev_langs: ["C++"]
helpviewer_keywords: ["[""program startup [C++]"", ""entry points, program [C++]"", ""wmain function [C++]"", ""_tmain function [C++]"", ""startup code, main function"", ""main function, program startup""]"]
