...
f1_keywords: ["decltype", "decltype_cpp"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""operators [C++], decltype"", ""decltype operator [C++]"", ""operators [C++], type of an expression"", ""operators [C++], deduce expression type""]"]
