...
-   By using the copy constructor. For more information about the copy constructor, see [Rules for Declaring Constructors](../notintoc/rules-for-declaring-constructors.md).  
