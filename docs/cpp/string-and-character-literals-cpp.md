...
f1_keywords: ["R"]
dev_langs: ["C++"]
helpviewer_keywords: ["[""L constant [C++]"", ""escape sequences [C++]"", ""Null strings [C++], null-terminated strings"", ""literal strings [C++], C++"", ""Null strings [C++]"", ""string literals [C++], syntax"", ""string literals [C++]"", ""literal strings [C++]"", ""strings [C++], string literals"", ""NULL, character constant"", ""wide characters, strings""]"]
