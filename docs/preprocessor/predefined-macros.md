...
- **&#95;&#95;TIME&#95;&#95;** The time of translation of the preprocessed translation unit. The time is a character string literal of the form *hh:mm:ss*, the same as the time returned by the C Runtime Library [asctime](../c-runtime-library/reference/asctime-wasctime.md) function. This macro is always defined.
...
- **&#95;&#95;AVX&#95;&#95;** Defined as 1 when the [/arch:AVX](../build/reference/arch-x86.md) or [/arch:AVX2](../build/reference/arch-x86.md) compiler options are set and the compiler target is x86 or x64. Otherwise, undefined.
...
| Visual Studio Version        | MSVC compiler version (\_MSC\_VER) |
| ---------------------------- | ---------------------------------- |
| VS2015 and updates 1, 2, & 3 | 1900                               |
| VS2017, version 15.1 & 15.2  | 1910                               |
| VS2017, version 15.3 & 15.4  | 1911                               |
| VS2017, version 15.5         | 1912                               |
