...
In Visual Studio 2019 the [/Zc:preprocessor](../build/reference/zc-preprocessor.md) compiler option provides a fully conformant with C11 and C17. This is the default when you use the compiler flag `/std:c11` or `/std:c17`.
