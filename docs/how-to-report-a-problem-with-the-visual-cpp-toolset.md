...
If your problem has not been reported before, choose the **Report a problem** button next to the search box on the Developer Community page. You may be asked to sign in to your Visual Studio account and to agree to give the Developer Community app access to your profile. When you are signed in, you can submit a problem through the [web-interface on the C++ tab](https://developercommunity.visualstudio.com/spaces/62/index.html). Other tabs will prompt you to use the IDE, but the C++ tab will allow you to use a simple web-interface. You can include your repro code and command line, screen shots, links to related discussions, and any other information you think is relevant and useful.
