---
title: "Add a member variable (Visual C++)"
ms.date: "11/09/2018"
...
---
# Add a member variable  (Visual C++)
...
1. On the shortcut menu, click **Add Variable** to display the [add member variable wizard](#add-member-variable-wizard).
