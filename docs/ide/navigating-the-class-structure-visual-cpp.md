...
You can navigate a project class structure by using either **Class View** or the **Object Browser**. The project class structure may include functions, inheritance, and interfaces. For more information, see [Viewing the structure of code](/visualstudio/ide/viewing-the-structure-of-code).
