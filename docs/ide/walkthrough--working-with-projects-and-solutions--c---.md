...
## Creating a Project  
 To create a project, first choose a project-type template. For each project type, [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] sets compiler settings and—depending on the type—generates starter code that you can modify later.  
...
4.  Enter a name for the project in the **Name** box. For this example, enter **Game**.  
     ...
     When you create a project, [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] puts the project in a solution. By default, the solution has the same name as the project. You can change the name in the **Solution name** box, but for this example, keep the default name.  
...
## Organizing Projects and Files in a Solution  
 ...
 This part of the walkthrough shows how add a class to the project. When you add the class, [!INCLUDE[vsprvs](../build/includes/vsprvs_md.md)] adds the corresponding .h and .cpp files. Next, you add a new source code file for the main program that tests the class.  
...
4.  The Cardgame.h file is opened in the editor. Make these changes:  
    ...
    -   Add two private data members after the opening brace of the class definition.  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#100](../ide/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_1.h)]  
    ...
    -   Modify the default constructor that Visual Studio generated. After the `public:` access specifier, find the line that looks like this:  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#101](../ide/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_2.h)]  
    ...
    -   After the default destructor, add an inline declaration for a static int member function named **GetParticipants** that takes no parameters and returns the **totalParticipants** value.  
         ...
         [!code[NVC_Walkthrough_Working_With_Projects#102](../ide/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_3.h)]  
  
5.  The Cardgame.h file should resemble this after you change it:  
  
     [!code[NVC_Walkthrough_Working_With_Projects#103](../ide/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_4.h)]  
  
     The line `#pragma once` tells the compiler to include the file only one time. For more information, see [once](../c/once.md).  
  
     For information about other C++ keywords in this header file, see [class](../cpp/class--c---.md), [int](../cpp/fundamental-types---c---.md), [static](../notintoc/static--c---.md), and [public](../cpp/public--c---.md).  
...
7.  Delete everything in the file and replace it with this code:  
     ...
     [!code[NVC_Walkthrough_Working_With_Projects#111](../ide/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_5.cpp)]  
    ...
    >  You can use auto-completion when you are entering code. For example, if you were entering this code, you could enter **pl** or **tot** and then press Ctrl+Spacebar so that auto-completion finishes entering `players` or `totalParticipants` for you.  
     ...
     For information about `#include`, see [#include Directive (C/C++)](../c/sharpinclude-directive--c-c---.md).  
...
3.  In the TestGames.cpp editing window, enter the following code.  
     ...
     [!code[NVC_Walkthrough_Working_With_Projects#120](../ide/codesnippet/CPP/walkthrough--working-with-projects-and-solutions--c---_6.cpp)]  
...
## Next Steps  
 **Previous:** [Using the Visual Studio IDE for C++ Desktop Development](../ide/using-the-visual-studio-ide-for-c---desktop-development.md). **Next:**[Walkthrough: Building a Project (C++)](../ide/walkthrough--building-a-project--c---.md).  
