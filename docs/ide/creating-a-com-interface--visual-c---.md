...
-   [Adding ATL Support to Your MFC Project](../mfcref/adding-atl-support-to-your-mfc-project.md)  
...
-   [Creating an MFC ActiveX Control](../mfcref/creating-an-mfc-activex-control.md)  
  
     Open the [MFC ActiveX Control Wizard](../mfcref/mfc-activex-control-wizard.md) to create an ActiveX control with a dispinterface and an event map defined in the .idl file and the control class, respectively.  
  
-   [Adding an ATL Control](../atl/adding-an-atl-control.md)  
  
     Use a combination of the [ATL Project Wizard](../atl/atl-project-wizard.md) and the [ATL Control Wizard](../atl/atl-control-wizard.md) to create an ATL ActiveX control.  
...
-   [ATL COM+ 1.0 Component Wizard](../atl/atl-com--1.0-component-wizard.md)  
  
-   [ATL Simple Object Wizard](../atl/atl-simple-object-wizard.md)  
  
-   [ATL Active Server Page Component Wizard](../atl/atl-active-server-page-component-wizard.md)  
  
-   [ATL Control Wizard](../atl/atl-control-wizard.md)  
...
> [!NOTE]
>  Visual Studio does not provide a wizard to add an interface to a project. You can add an interface to an ATL project or to an [Adding ATL Support to Your MFC Project](../mfcref/adding-atl-support-to-your-mfc-project.md) by adding a simple object using the [ATL Simple Object Wizard](../atl/atl-simple-object-wizard.md). Alternately, open the project's .idl file and create the interface by typing:  
...
```  
 ...
 See [Implementing an Interface](../ide/implementing-an-interface--visual-c---.md) and [Adding Objects and Controls to an ATL Project](../atl/adding-objects-and-controls-to-an-atl-project.md) for more information.  
  
 Visual C++ provides several ways to view and [edit the COM interfaces](../ide/editing-a-com-interface.md) defined for your projects. [Class View](assetId:///8d7430a9-3e33-454c-a9e1-a85e3d2db925) displays icons for any interface or dispinterface defined in an .idl file in your C++ project.  
