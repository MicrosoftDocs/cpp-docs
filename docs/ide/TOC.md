...
## [Add a class (Visual C++)](adding-a-class-visual-cpp.md)
## [Add a class from an ActiveX control (Visual C++)](adding-a-class-from-an-activex-control-visual-cpp.md)
## [Add a generic C++ class](adding-a-generic-cpp-class.md)
## [Add a member function (Visual C++)](adding-a-member-function-visual-cpp.md)
## [Add a member variable  (Visual C++)](adding-a-member-variable-visual-cpp.md)
## [Add a method (Visual C++)](adding-a-method-visual-cpp.md)
## [Add a property (Visual C++)](adding-a-property-visual-cpp.md)
## [Add an event (Visual C++)](adding-an-event-visual-cpp.md)
## [Add an event handler (Visual C++)](adding-an-event-handler-visual-cpp.md)
## [Create a COM interface (Visual C++)](creating-a-com-interface-visual-cpp.md)
## [Implement a connection point (Visual C++)](implementing-a-connection-point-visual-cpp.md)
## [Implement an interface (Visual C++)](implementing-an-interface-visual-cpp.md)
## [Navigate the class structure (Visual C++)](navigating-the-class-structure-visual-cpp.md)
## [Override a virtual function (Visual C++)](overriding-a-virtual-function-visual-cpp.md)
