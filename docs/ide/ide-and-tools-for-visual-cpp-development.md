...
For more information about MSBuild configurations, see [Working with Project Properties](../build/working-with-project-properties.md) and [Building C++ Projects in Visual Studio](../build/reference/building-cpp-projects-in-visual-studio.md).
...
|[Building C++ Projects in Visual Studio](../build/reference/building-cpp-projects-in-visual-studio.md)|How to use the Visual Studio IDE to build projects.|
