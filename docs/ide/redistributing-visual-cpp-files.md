...
> [!NOTE]
> Are you here because you are looking for a download of one of the Visual C++ Runtime files? Go to the [Microsoft](http://www.microsoft.com/) website and enter **Visual C++ Redistributable** in the search box. Download and install the redistributable package for the architecture of your computer (for example, x64 if you are running 64-bit Windows) and the version of Visual C++ that you need.   
