...
1. Add `#include winapifamily.h` to include that header file from the Windows SDK for Universal Windows Platform apps and set the macro `WINAPI_FAMILY=WINAPI_PARTITION_APP`.
