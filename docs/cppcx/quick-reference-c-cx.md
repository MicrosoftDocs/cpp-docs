...
The [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)] supports [!INCLUDE[win8_appname_long](../cppcx/includes/win8-appname-long-md.md)] apps that execute only in a trustworthy operating system environment, use authorized functions, data types, and devices, and are distributed through the [!INCLUDE[win8_appstore_long](../cppcx/includes/win8-appstore-long-md.md)]. The [!INCLUDE[cppwrt](../cppcx/includes/cppwrt-md.md)] ([!INCLUDE[cppwrt_short](../cppcx/includes/cppwrt-short-md.md)]) simplify the writing of apps for the [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)]. This article is a quick reference; for more complete documentation, see [Type System](../cppcx/type-system-c-cx.md) and [Component Extensions for Runtime Platforms](http://go.microsoft.com/fwlink/?LinkId=228720).  
  
 When you build on the command line, use the **/ZW** compiler option to build a [!INCLUDE[win8_appname_long](../cppcx/includes/win8-appname-long-md.md)] app or [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)] component. To access [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)] declarations, which are defined in the [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)] metadata (.winmd) files, specify the `#using` directive or the **/FU** compiler option. When you create a project for a [!INCLUDE[win8_appname_long](../cppcx/includes/win8-appname-long-md.md)] app, Visual Studio by default sets these options and adds references to all [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)] libraries.  
  
## Quick reference  
  
|Concept|Standard C++|[!INCLUDE[cppwrt_short](../cppcx/includes/cppwrt-short-md.md)]|Remarks|  
|-------------|--------------------|------------------------------------------------------------------|-------------|  
|Fundamental types|C++ fundamental types.|[!INCLUDE[cppwrt_short](../cppcx/includes/cppwrt-short-md.md)] fundamental types that implement fundamental types that are defined in the [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)].|The `default` namespace contains [!INCLUDE[cppwrt_short](../cppcx/includes/cppwrt-short-md.md)] built-in, fundamental types. The compiler implicitly maps [!INCLUDE[cppwrt_short](../cppcx/includes/cppwrt-short-md.md)] fundamental types to standard C++ types.<br /><br /> The `Platform` family of namespaces contains types that implement fundamental [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)] types.|  
