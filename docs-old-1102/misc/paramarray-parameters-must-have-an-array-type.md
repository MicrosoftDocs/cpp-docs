...
2.  If the error recurs, save your work and restart [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
3.  If the error persists, reinstall [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
