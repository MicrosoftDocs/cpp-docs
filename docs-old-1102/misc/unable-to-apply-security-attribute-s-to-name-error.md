...
3.  If the error continues, save your work and restart [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
4.  If the error reoccurs, reinstall [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
