...
|[Additional resources for troubleshooting data access errors](../Topic/Additional%20resources%20for%20troubleshooting%20data%20access%20errors.md)|Links to documents about data services.|  
...
|[Local Data Overview](../Topic/Local%20Data%20Overview.md)|Describes how to convert a database file (.mdf) to a format that is used by [!INCLUDE[vs_dev11_long](../build/includes/vs_dev11_long_md.md)].|