...
1.  Re-enter the search string using the correct regular expression syntax. For more information, see [Regular Expressions](../Topic/Using%20Regular%20Expressions%20in%20Visual%20Studio.md).  
