...
|**Child maximized**|Specifies whether a child window is initially maximized by setting the cs.style flag **WS_MAXIMIZE** in the [PreCreateWindow](../Topic/CWnd::PreCreateWindow.md) member function of `CChildFrame`.|  
