...
---
# vscanf_s, vwscanf_s
Reads formatted data from the standard input stream. These versions of [vscanf, vwscanf](../VS_visualcpp/vscanf--vwscanf.md) have security enhancements, as described in [Security Features in the CRT](../VS_visualcpp/Security-Features-in-the-CRT.md).  
...
>  The size parameter is of type `unsigned`, not `size_t`.  
 ...
 For more information, see [scanf Width Specification](../VS_visualcpp/scanf-Width-Specification.md).  
