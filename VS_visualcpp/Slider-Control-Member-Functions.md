...
An application can call the slider control's member functions to retrieve information about the slider control ([CSliderCtrl](../VS_visualcpp/CSliderCtrl-Class.md)) and to change its characteristics.  
