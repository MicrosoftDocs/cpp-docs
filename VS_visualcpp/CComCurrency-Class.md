...
### Parameters  
 ...
 `nInteger`,  *nFraction*  
 The integer and fractional components of the initial monetary value. See the [CComCurrency](../VS_visualcpp/CComCurrency-Class.md) overview for more information.  
