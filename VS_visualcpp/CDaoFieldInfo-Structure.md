...
-   **dbCurrency** Currency; see MFC class [COleCurrency](../VS_visualcpp/COleCurrency-Class.md)  
  
-   **dbSingle** Single  
  
-   **dbDouble** Double  
  
-   **dbDate** Date/Time; see MFC class [COleDateTime](../VS_visualcpp/COleDateTime-Class.md)  
  
-   **dbText** Text; see MFC class [CString](../VS_visualcpp/CStringT-Class.md)  
  
-   **dbLongBinary** Long Binary (OLE Object); you might want to use MFC class [CByteArray](../VS_visualcpp/CByteArray-Class.md) instead of class `CLongBinary` as `CByteArray` is richer and easier to use.  
...
|**dbLongBinary**|0|Long Binary (OLE Object; [CByteArray](../VS_visualcpp/CByteArray-Class.md); use instead of `CLongBinary`)|  
 ...
 *m_strSourceTable*  
 ...
 For related information about tabledefs, see the **m_strValidationRule** member of the [CDaoTableDefInfo](../VS_visualcpp/CDaoTableDefInfo-Structure.md) structure.  
...
## Remarks  
 ...
 Field objects are not represented by an MFC class. Instead, the DAO objects underlying MFC objects of the following classes contain collections of field objects: [CDaoTableDef](../VS_visualcpp/CDaoTableDef-Class.md), [CDaoRecordset](../VS_visualcpp/CDaoRecordset-Class.md), and [CDaoQueryDef](../VS_visualcpp/CDaoQueryDef-Class.md). These classes supply member functions to access some individual items of field information, or you can access them all at once with a `CDaoFieldInfo` object by calling the `GetFieldInfo` member function of the containing object.  
