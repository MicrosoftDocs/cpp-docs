...
## Remarks  
 ...
 The /TSAWARE option is enabled by default for Windows 2000 and later, for Windows and console applications. See [/SUBSYSTEM](../VS_visualcpp/-SUBSYSTEM--Specify-Subsystem-.md) and [/VERSION](../VS_visualcpp/-VERSION--Version-Information-.md) for information.  
  
 /TSAWARE is not valid for drivers, VxDs, or DLLs.  
  
 If an application was linked with /TSAWARE, DUMPBIN [/HEADERS](../VS_visualcpp/-HEADERS.md) will display information to that effect.  
