...
> [!NOTE]
>  Visual Studio does not support defaulted move constructors or move-assignment operators as the C++11 standard mandates. For more information, see the Defaulted and Deleted functions section of [Support For C++11/14/17 Features (Modern C++)](../VS_visualcpp/Support-For-C--11-14-17-Features--Modern-C---.md).  
