...
The `CMFCRibbonBaseElement` class is the base class for all elements that you can add to a [ribbon bar](../VS_visualcpp/CMFCRibbonBar-Class.md). Examples of ribbon elements are ribbon buttons, ribbon check boxes, and ribbon combo boxes.  
...
### Parameters  
 [in] `arElems`  
 Reference to a [CArray](../VS_visualcpp/CArray-Class.md) of keytips.  
...
##  <a name="cmfcribbonbaseelement__copyfrom"></a>  CMFCRibbonBaseElement::CopyFrom  
 Copies the state of the specified [CMFCRibbonBaseElement](../VS_visualcpp/CMFCRibbonBaseElement-Class.md) to the current object.  
...
### Parameters  
 [in] `src`  
 The source [CMFCRibbonBaseElement](../VS_visualcpp/CMFCRibbonBaseElement-Class.md) object.  
...
### Return Value  
 The ribbon element description. The description is displayed either on the status bar, or in a tooltip, or under the menu button if the ribbon element is located on the [CMFCRibbonMainPanel Class](../VS_visualcpp/CMFCRibbonMainPanel-Class.md).  
...
### Remarks  
 The parent window for a ribbon element is a [CMFCRibbonBar Class](../VS_visualcpp/CMFCRibbonBar-Class.md) or a [CMFCRibbonPanelMenuBar](assetId:///7bd4b986-8b7b-493e-9746-bd3161b78581).  
