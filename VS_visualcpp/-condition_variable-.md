...
---
# &lt;condition_variable&gt;
Defines the classes [condition_variable](../VS_visualcpp/condition_variable-Class.md) and [condition_variable_any](../VS_visualcpp/condition_variable_any-Class.md) that are used to create objects that wait for a condition to become true.  
...
## See Also  
 ...
 [cv_status Enumeration](../VS_visualcpp/-condition_variable--enums.md#cv_status_enumeration)