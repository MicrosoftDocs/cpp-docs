...
### Remarks  
 The information and syntax presented in this topic is meant to supersede the information presented in [attribute](../VS_visualcpp/attribute.md).  
  
 You can define a custom attribute by defining a type and making <xref:System.Attribute?qualifyHint=False> a base class for the type and optionally applying the <xref:System.AttributeUsageAttribute?qualifyHint=False> attribute.  
...
-   [Attribute Targets](../VS_visualcpp/Attribute-Targets--C---Component-Extensions-.md)  
  
-   [Attribute Parameter Types](../VS_visualcpp/Attribute-Parameter-Types---C---Component-Extensions-.md)  
  
 For information on signing assemblies in Visual C++, see [Strong Name Assemblies (Assembly Signing) (C++/CLI)](../VS_visualcpp/Strong-Name-Assemblies--Assembly-Signing---C---CLI-.md).  
 ...
 **Service Access = Read** **Example**  
 ...
 See [typeid](../VS_visualcpp/typeid---C---Component-Extensions-.md) for information on how to return a value of System::Type from a custom attribute block.  
