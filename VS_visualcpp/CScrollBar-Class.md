...
## Remarks  
 ...
 For related information about using `CScrollBar`, see [Controls](../VS_visualcpp/Controls--MFC-.md).  
...
### Parameters  
 `dwStyle`  
 Specifies the scroll bar's style. Apply any combination of [scroll-bar styles](../VS_visualcpp/Scroll-Bar-Styles.md) to the scroll bar.  
...
### Remarks  
 ...
 Apply the following [window styles](../VS_visualcpp/Window-Styles.md) to a scroll bar:  
...
### Remarks  
 ...
 The MFC Windows message handlers that indicate scroll bar position, [CWnd::OnHScroll](../VS_visualcpp/CWnd-Class.md#cwnd__onhscroll) and [CWnd::OnVScroll](../VS_visualcpp/CWnd-Class.md#cwnd__onvscroll), provide only 16 bits of position data. `GetScrollInfo` and `SetScrollInfo` provide 32 bits of scroll bar position data. Thus, an application can call `GetScrollInfo` while processing either `CWnd::OnHScroll` or `CWnd::OnVScroll` to obtain 32-bit scroll bar position data.  
  
### Example  
  See the example for [CWnd::OnHScroll](../VS_visualcpp/CWnd-Class.md#cwnd__onhscroll).  
