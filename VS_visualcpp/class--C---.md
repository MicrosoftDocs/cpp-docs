...
#### Parameters  
 ...
 `tag`  
 The type name given to the class. The tag becomes a reserved word within the scope of the class. The tag is optional. If omitted, an anonymous class is defined. For more information, see [Anonymous Class Types](../VS_visualcpp/Anonymous-Class-Types.md).  
  
 `base-list`  
 Optional list of classes or structures this class will derive its members from. See [Base Classes](../VS_visualcpp/Base-Classes.md) for more information. Each base class or structure name can be preceded by an access specifier ([public](../VS_visualcpp/public--C---.md), [private](../VS_visualcpp/private--C---.md), [protected](../VS_visualcpp/protected--C---.md)) and the [virtual](../VS_visualcpp/virtual--C---.md) keyword. See the member-access table in [Controlling Access to Class Members](../Topic/Controlling%20Access%20to%20Class%20Members.md) for more information.  
  
 `member-list`  
 List of class members. Refer to [Class Member Overview](../VS_visualcpp/Class-Member-Overview.md) for more information.  
  
 `declarators`  
 Declarator list specifying the names of one or more instances of the class type. Declarators may include initializer lists if all data members of the class are `public`. This is more common in structures, whose data members are `public` by default, than in classes. See [Overview of Declarators](../VS_visualcpp/Overview-of-Declarators.md) for more information.  
...
-   [union](../VS_visualcpp/Unions.md)  
  
-   [__multiple_inheritance](../VS_visualcpp/Inheritance-Keywords.md)  
  
-   [__single_inheritance](../VS_visualcpp/Inheritance-Keywords.md)  
  
-   [__virtual_inheritance](../VS_visualcpp/Inheritance-Keywords.md)  
