...
## Remarks  
 ...
 For information on creating custom picture properties, see the article [MFC ActiveX Controls: Using Pictures in an ActiveX Control](../VS_visualcpp/MFC-ActiveX-Controls--Using-Pictures-in-an-ActiveX-Control.md).  
...
### Parameters  
 ...
 `pBitmap`  
 Pointer to a [CBitmap](../VS_visualcpp/CBitmap-Class.md) object.  
  
 *pPal*  
 Pointer to a [CPalette](../VS_visualcpp/CPalette-Class.md) object.  
...
### Parameters  
 `strValue`  
 Reference to the [CString](../VS_visualcpp/CStringT-Class.md) that is to hold the display string.  
 ...
 *rcWBounds*  
 A rectangle representing the bounding rectangle of the object rendering the picture. For a control, this rectangle is the `rcBounds` parameter passed to an override of [COleControl::OnDraw](../VS_visualcpp/COleControl-Class.md#colecontrol__ondraw).  
