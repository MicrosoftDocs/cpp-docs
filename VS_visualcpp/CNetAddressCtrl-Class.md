...
## Remarks  
 ...
 The `CNetAddressCtrl` class is derived from the [CEdit](../VS_visualcpp/CEdit-Class.md) class. Consequently, the network address control provides access to all Windows edit control messages.  
 ...
 ![Dialog with a network address control and infotip.](../VS_visualcpp/media/CNetAddCtrl.png "CNetAddCtrl")  
...
|---------------|-----------------|  
|[in] `dwStyle`|A bitwise combination of styles to be applied to the control. For more information, see [Edit Styles](../VS_visualcpp/Edit-Styles.md).|  
...
|[in] `dwStyle`|A bitwise combination (OR) of styles to be applied to the control. For more information, see [Edit Styles](../VS_visualcpp/Edit-Styles.md).|  
|[in] `rect`|A reference to a                                         [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure that contains the position and size of the control.|  
|[in] `pParentWnd`|A non-null pointer to a [CWnd](../VS_visualcpp/CWnd-Class.md) object that is the parent window of the control.|  
|[in] `nID`|The ID of the control.|  
