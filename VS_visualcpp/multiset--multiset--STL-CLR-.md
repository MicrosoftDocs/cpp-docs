...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[multiset::begin (STL/CLR)](../VS_visualcpp/multiset--begin--STL-CLR-.md)`(),` `right``.`[multiset::end (STL/CLR)](../VS_visualcpp/multiset--end--STL-CLR-.md)`())`, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the multiset object `right`, with the default ordering predicate.  
