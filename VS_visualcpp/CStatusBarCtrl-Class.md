...
## Remarks  
 ...
 For more information on using `CStatusBarCtrl`, see [Controls](../VS_visualcpp/Controls--MFC-.md) and [Using CStatusBarCtrl](../VS_visualcpp/Using-CStatusBarCtrl.md).  
...
### Parameters  
 ...
 `rect`  
 Specifies the status bar control's size and position. It can be either a [CRect](../VS_visualcpp/CRect-Class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure.  
...
### Remarks  
 ...
 A status bar control consists of a row of text output panes, which are also known as parts. For more information about the status bar, see [Status Bar Implementation in MFC](../VS_visualcpp/Status-Bar-Implementation-in-MFC.md) and [Setting the Mode of a CStatusBarCtrl Object](../VS_visualcpp/Setting-the-Mode-of-a-CStatusBarCtrl-Object.md).  
...
### Return Value  
 The length, in characters, of the text or a [CString](../VS_visualcpp/CStringT-Class.md) containing the current text.  
...
### Return Value  
 A [CString](../VS_visualcpp/CStringT-Class.md) object containing the text to be used in the tooltip.  
