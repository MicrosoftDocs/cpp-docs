...
3.  In the [Add Class](../VS_visualcpp/Add-Class-Dialog-Box.md) dialog box, in the templates pane, click **ATL Control**, and then click **Add** to display the [ATL Control Wizard](../VS_visualcpp/ATL-Control-Wizard.md).  
