...
## Explicit Linking  
 Most applications use implicit linking because it is the easiest linking method to use. However, there are times when [explicit linking](../VS_visualcpp/Linking-Explicitly.md) is necessary. Here are some common reasons to use explicit linking:  
