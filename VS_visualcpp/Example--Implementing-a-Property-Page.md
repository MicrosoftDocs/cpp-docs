...
This example shows how to build a property page that displays (and allows you to change) properties of the [Document Classes](../VS_visualcpp/Document-Classes.md) interface. This interface is exposed by documents in Visual Studio's [Common Environment Object Model Examples](../Topic/Common%20Environment%20Object%20Model%20Examples.md) (although the property page that you'll create won't care where the objects it manipulates come from as long as they support the correct interface).  
  
 The example is based on the [ATLPages sample](../VS_visualcpp/Visual-C---Samples.md).  
...
##  <a name="vcconusing_the_atl_object_wizard"></a> Adding the ATL Property Page Class  
 First, create a new ATL project for a DLL server called `ATLPages7`. Now use the [ATL Property Page Wizard](../VS_visualcpp/ATL-Property-Page-Wizard.md) to generate a property page. Give the property page a **Short Name** of **DocProperties** then switch to the **Strings** page to set property-page-specific items as shown in the table below.  
...
##  <a name="vcconediting_the_dialog_resource"></a> Editing the Dialog Resource  
 ...
 ![Editing a dialog resource](../VS_visualcpp/media/PPGResourceLabeled.gif "PPGResourceLabeled")  
...
##  <a name="vcconoverriding_ipropertypageimpl_activate"></a> Overriding IPropertyPageImpl::Activate  
 ...
 This code uses the COM methods of the **Document** interface to get the properties that you're interested in. It then uses the Win32 API wrappers provided by [CDialogImpl](../VS_visualcpp/CDialogImpl-Class.md) and its base classes to display the property values to the user.  
...
##  <a name="vccontesting_the_property_page"></a> Displaying the Property Page  
 ...
 Use the [Add Class dialog box](../VS_visualcpp/Add-Class-Dialog-Box.md) and the [ATL Simple Object Wizard](../VS_visualcpp/ATL-Simple-Object-Wizard.md) to generate a new class and use `Helper` as its short name. Once created, add a method as shown in the table below.  
