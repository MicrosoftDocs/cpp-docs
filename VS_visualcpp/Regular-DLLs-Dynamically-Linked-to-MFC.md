...
```  
 ...
 The **AFX_MANAGE_STATE** macro should not be used in regular DLLs that statically link to MFC or in extension DLLs. For more information, see [Managing the State Data of MFC Modules](../VS_visualcpp/Managing-the-State-Data-of-MFC-Modules.md).  
...
-   [The module states of a regular DLL dynamically linked to MFC](../VS_visualcpp/Module-States-of-a-Regular-DLL-Dynamically-Linked-to-MFC.md)  
