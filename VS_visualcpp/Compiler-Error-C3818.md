...
array property declaration 'property1' shall not overload an index property 'property2'  
 ...
 An overload is not possible for properties when one is an indexer and the other is an array property. See [__property](../Topic/__property.md) for more information.  
