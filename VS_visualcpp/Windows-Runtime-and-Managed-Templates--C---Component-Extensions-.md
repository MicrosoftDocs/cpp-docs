...
## All Runtimes  
 You can create templates from value or reference types.  For more information about creating value or reference types, see [Classes and Structs](../VS_visualcpp/Classes-and-Structs---C---Component-Extensions-.md).  
  
 For more information about standard C++ class templates, see [Class Templates](../VS_visualcpp/Class-Templates.md).  
