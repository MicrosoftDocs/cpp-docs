...
## Remarks  
 ...
 For more information about using data objects in your application, see the article [Data Objects and Data Sources (OLE)](../VS_visualcpp/Data-Objects-and-Data-Sources--OLE-.md).  
...
### Remarks  
 ...
 For more information, see                         [IEnumXXXX::Next](https://msdn.microsoft.com/en-us/library/ms695273.aspx) in the Windows SDK.  
...
### Example  
  See the example for [CRichEditView::QueryAcceptData](../VS_visualcpp/CRichEditView-Class.md#cricheditview__queryacceptdata).  
...
## See Also  
 ...
 [COleDataSource::DoDragDrop](../VS_visualcpp/COleDataSource-Class.md#coledatasource__dodragdrop)   
 [CView::OnDrop](../VS_visualcpp/CView-Class.md#cview__ondrop)