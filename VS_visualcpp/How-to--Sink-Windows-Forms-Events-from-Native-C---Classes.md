...
-   Create a delegate map using [BEGIN_DELEGATE_MAP](../Topic/BEGIN_DELEGATE_MAP.md), [END_DELEGATE_MAP](../Topic/END_DELEGATE_MAP.md), and [EVENT_DELEGATE_ENTRY](../Topic/EVENT_DELEGATE_ENTRY.md).  
 ...
 This sample continues the work you did in [How to: Do DDX/DDV Data Binding with Windows Forms](../VS_visualcpp/How-to--Do-DDX-DDV-Data-Binding-with-Windows-Forms.md).  
  
 Now, you will associate your MFC control (`m_MyControl`) with a managed event handler delegate called `OnClick` for the managed <xref:System.Windows.Forms.Control.Click?qualifyHint=False> event.  
