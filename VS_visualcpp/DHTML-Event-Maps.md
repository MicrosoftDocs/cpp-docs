...
## DHTML Event Map Macros  
 The following macros can be used to handle DHTML events in                 [CDHtmlDialog](../VS_visualcpp/CDHtmlDialog-Class.md)-derived classes.  
...
## URL Event Map Macros  
 The following macros can be used to handle DHTML events in                 [CMultiPageDHtmlDialog](../VS_visualcpp/CMultiPageDHtmlDialog-Class.md)-derived classes.  
...
### Parameters  
 `className`  
 The name of the class containing the DHTML event map. This class should derive directly or indirectly from                                 [CDHtmlDialog](../VS_visualcpp/CDHtmlDialog-Class.md) and include the                                 [DECLARE_DHTML_EVENT_MAP](../Topic/DECLARE_DHTML_EVENT_MAP.md) macro within its class definition.  
...
### Remarks  
 This macro is to be used in the definition of                         [CDHtmlDialog](../VS_visualcpp/CDHtmlDialog-Class.md)-derived classes.  
...
### Remarks  
 Put                         `BEGIN_DHTML_URL_EVENT_MAP` in the implementation file of your                         [CMultiPageDHtmlDialog](../VS_visualcpp/CMultiPageDHtmlDialog-Class.md)-derived class. Follow it with                         [embedded DHTML event maps](../Topic/BEGIN_EMBED_DHTML_EVENT_MAP.md) and                         [URL entries](../Topic/BEGIN_URL_ENTRIES.md), and then close it with                         [END_DHTML_URL_EVENT_MAP](../Topic/END_DHTML_URL_EVENT_MAP.md). Include the                         [DECLARE_DHTML_URL_EVENT_MAP](../Topic/DECLARE_DHTML_URL_EVENT_MAP.md) macro within the class definition.  
...
### Parameters  
 `className`  
 The name of the class containing the event map. This class should derive directly or indirectly from                                 [CMultiPageDHtmlDialog](../VS_visualcpp/CMultiPageDHtmlDialog-Class.md). The embedded DHTML event map must be inside a                                 [DHTML and URL event map](../Topic/BEGIN_DHTML_URL_EVENT_MAP.md)).  
...
### Remarks  
 ...
 Embedded event maps within a DHTML and URL event map consist of a                         `BEGIN_EMBED_DHTML_EVENT_MAP` macro followed by                         [DHTML_EVENT](../VS_visualcpp/DHTML-Event-Maps.md) macros and an                         [END_EMBED_DHTML_EVENT_MAP](../Topic/END_EMBED_DHTML_EVENT_MAP.md) macro.  
...
### Parameters  
 `className`  
 The name of the class containing the URL event entry map. This class should derive directly or indirectly from                                 [CMultiPageDHtmlDialog](../VS_visualcpp/CMultiPageDHtmlDialog-Class.md). The URL event entry map must be inside a                                 [DHTML and URL event map](../Topic/BEGIN_DHTML_URL_EVENT_MAP.md)).  
...
### Remarks  
 This macro is to be used in the definition of                         [CMultiPageDHtmlDialog](../VS_visualcpp/CMultiPageDHtmlDialog-Class.md)-derived classes.  
...
### Parameters  
 `className`  
 The name of the class containing the event map. This class should derive directly or indirectly from                                 [CMultiPageDHtmlDialog](../VS_visualcpp/CMultiPageDHtmlDialog-Class.md). This should match                                 `className` in the corresponding                                 [BEGIN_DHTML_URL_EVENT_MAP](../Topic/BEGIN_DHTML_URL_EVENT_MAP.md) macro.  
