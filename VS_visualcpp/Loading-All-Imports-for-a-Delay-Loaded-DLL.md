...
The **__HrLoadAllImportsForDll** function, which is defined in delayhlp.cpp, tells the linker to load all imports from a DLL that was specified with the [/delayload](../VS_visualcpp/-DELAYLOAD--Delay-Load-Import-.md) linker option.  
 ...
 Calling **__HrLoadAllImportsForDll** does not change the behavior of hooks and error handling; see [Error Handling and Notification](../VS_visualcpp/Error-Handling-and-Notification.md) for more information.  
