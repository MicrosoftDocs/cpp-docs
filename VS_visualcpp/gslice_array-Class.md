...
## Remarks  
 The class describes an object that stores a reference to an object **va** of class [valarray](../VS_visualcpp/valarray-Class.md)**<Type\>**, along with an object **gs** of class [gslice](../VS_visualcpp/gslice-Class.md) which describes the sequence of elements to select from the **valarray<Type\>** object.  
  
 You construct a **gslice_array<Type\>** object only by writing an expression of the form [va&#91;gs&#93;](../VS_visualcpp/valarray-Class.md#valarray__operator_at). The member functions of class gslice_array then behave like the corresponding function signatures defined for **valarray<Type\>**, except that only the sequence of selected elements is affected.  
...
## Example  
 See the example for [gslice::gslice](../VS_visualcpp/gslice-Class.md#gslice__gslice) for an example of how to declare and use a slice_array.  
