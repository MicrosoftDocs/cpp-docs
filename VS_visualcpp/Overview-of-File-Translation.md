...
2.  Preprocessing. This translation phase brings in ancillary source files referenced by `#include` directives, handles "stringizing" and "charizing" directives, and performs token pasting and macro expansion (see [Preprocessor Directives](../VS_visualcpp/Preprocessor-Directives.md) in the *Preprocessor Reference* for more information). The result of the preprocessing phase is a sequence of tokens that, taken together, define a "translation unit."  
...
3.  Code generation. This translation phase uses the tokens generated in the preprocessing phase to generate object code.  
 ...
 See [Phases of Translation](../VS_visualcpp/Phases-of-Translation.md) in the *Preprocessor Reference* for more information.  
...
-   Single-line comments are supported. See [Comments](../VS_visualcpp/Comments--C---.md) for more information.  
  
-   One predefined macro, **__cplusplus**, is defined only for C++. See [Predefined Macros](../VS_visualcpp/Predefined-Macros.md) in the *Preprocessor Reference* for more information.  
  
-   The C preprocessor does not recognize the C++ operators: **.\***, **–>\***, and `::`. See [Operators](../VS_visualcpp/C---Built-in-Operators--Precedence-and-Associativity.md) and [Expressions](../VS_visualcpp/Expressions--C---.md), for more information about operators.  
