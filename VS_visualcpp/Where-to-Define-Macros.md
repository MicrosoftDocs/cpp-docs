...
Define macros in a command line, command file, makefile, or the Tools.ini file.  
 ...
 In a makefile or the Tools.ini file, each macro definition must appear on a separate line and cannot start with a space or tab. Spaces or tabs around the equal sign are ignored. All [string characters](../VS_visualcpp/Defining-an-NMAKE-Macro.md) are literal, including surrounding quotation marks and embedded spaces.  
