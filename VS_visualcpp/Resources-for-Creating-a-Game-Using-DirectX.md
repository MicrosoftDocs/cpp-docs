...
## Resources  
 ...
 For Windows 8.1, DirectX is included in the Windows SDK. You don't have to download anything extra. For more information, see [Where is the DirectX SDK?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx).  
 ...
 [Win32 Windows Applications](../VS_visualcpp/Windows-Desktop-Applications--C---.md) contains articles that describe how to create a basic Windows desktop app.  
  
 [Developing Games](http://msdn.microsoft.com/library/windows/apps/hh452744.aspx) discusses Windows 8.x Store game development, but many of the concepts also apply to desktop games.