...
## Remarks  
 ...
 For more information on using `CTypedPtrArray`, see the articles [Collections](../VS_visualcpp/Collections.md) and [Template-Based Classes](../VS_visualcpp/Template-Based-Classes.md).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Add](../VS_visualcpp/CObArray-Class.md#cobarray__add).  
...
### Parameters  
 `BASE_CLASS`  
 Base class of the typed pointer array class; must be an array class ( [CObArray](../VS_visualcpp/CObArray-Class.md) or [CPtrArray](../VS_visualcpp/CPtrArray-Class.md)).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Append](../VS_visualcpp/CObArray-Class.md#cobarray__append).  
...
### Remarks  
 For more detailed remarks, see [CObArray::Copy](../VS_visualcpp/CObArray-Class.md#cobarray__copy).  
...
### Remarks  
 For more detailed remarks, see [CObArray::ElementAt](../VS_visualcpp/CObArray-Class.md#cobarray__elementat).  
...
### Remarks  
 For more detailed remarks, see [CObArray::GetAt](../VS_visualcpp/CObArray-Class.md#cobarray__getat)  
...
### Parameters  
 `nIndex`  
 An integer index that may be greater than the value returned by [CObArray::GetUpperBound](../VS_visualcpp/CObArray-Class.md#cobarray__getupperbound).  
...
### Remarks  
 For more detailed remarks, see [CObArray::InsertAt](../VS_visualcpp/CObArray-Class.md#cobarray__insertat).  
...
### Parameters  
 `nIndex`  
 An integer index that is greater than or equal to 0 and less than or equal to the value returned by [CObArray::GetUpperBound](../VS_visualcpp/CObArray-Class.md#cobarray__getupperbound).  
...
### Remarks  
 For more detailed remarks, see [CObArray::SetAt](../VS_visualcpp/CObArray-Class.md#cobarray__setat).  
...
### Remarks  
 For more detailed remarks, see [CObArray::SetAtGrow](../VS_visualcpp/CObArray-Class.md#cobarray__setatgrow).  
