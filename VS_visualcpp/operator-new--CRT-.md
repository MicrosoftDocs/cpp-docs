...
## Remarks  
 This form of `operator new` is known as scalar new, in contrast to the vector new form ([operator new&#91;&#93;](../VS_visualcpp/operator-new-CRT-.md)).  
 ...
 [operator delete](../VS_visualcpp/operator-delete--CRT-.md) frees memory allocated with `operator new`.  
  
 You can configure whether operator new returns null or throws an exception on failure. See [The new and delete Operators](../VS_visualcpp/new-and-delete-Operators.md) for more information.  
