...
> [!NOTE]
>  This topic applies to the MFC ODBC classes, including [CRecordset](../VS_visualcpp/CRecordset-Class.md). For information about dynasets in the DAO classes, see [CDaoRecordset](../VS_visualcpp/CDaoRecordset-Class.md). With DAO, you can open dynaset-type recordsets.  
