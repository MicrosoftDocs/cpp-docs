...
### Remarks  
 For more information on creating custom sites, see [COleControlContainer::AttachControlSite](../VS_visualcpp/COleControlContainer-Class.md#colecontrolcontainer__attachcontrolsite).  
...
### Remarks  
 Override this function to create a custom control site, using your [COleControlSite](../VS_visualcpp/COleControlSite-Class.md)-derived class.  
