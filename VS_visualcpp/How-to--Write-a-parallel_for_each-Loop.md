...
This example shows how to use the [concurrency::parallel_for_each](../Topic/parallel_for_each%20Function.md) algorithm to compute the count of prime numbers in a [std::array](../VS_visualcpp/array-Class--STL-.md) object in parallel.  
