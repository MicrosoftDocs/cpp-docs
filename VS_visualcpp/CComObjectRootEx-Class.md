...
#### Parameters  
 `ThreadModel`  
 The class whose methods implement the desired threading model. You can explicitly choose the threading model by setting `ThreadModel` to [CComSingleThreadModel](../VS_visualcpp/CComSingleThreadModel-Class.md), [CComMultiThreadModel](../VS_visualcpp/CComMultiThreadModel-Class.md), or [CComMultiThreadModelNoCS](../VS_visualcpp/CComMultiThreadModelNoCS-Class.md). You can accept the server's default thread model by setting `ThreadModel` to [CComObjectThreadModel](../Topic/CComObjectThreadModel.md) or [CComGlobalsThreadModel](../Topic/CComGlobalsThreadModel.md).  
...
## Remarks  
 ...
 A class that implements a COM server must inherit from `CComObjectRootEx` or [CComObjectRoot](../VS_visualcpp/CComObjectRoot-Class.md).  
