...
## Remarks  
 By default, [_com_raise_error](../VS_visualcpp/_com_raise_error.md) handles all COM errors. You can change this behavior by using `_set_com_error_handler` to call your own error-handling function.  
