...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[deque::begin (STL/CLR)](../VS_visualcpp/deque--begin--STL-CLR-.md)`(),` `right``.`[deque::end (STL/CLR)](../VS_visualcpp/deque--end--STL-CLR-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the deque object `right`.  
  
 The constructor:  
  
 `deque(deque<Value>^ right);`  
  
 initializes the controlled sequence with the sequence `[``right``->`[deque::begin (STL/CLR)](../VS_visualcpp/deque--begin--STL-CLR-.md)`(),` `right``->`[deque::end (STL/CLR)](../VS_visualcpp/deque--end--STL-CLR-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the deque object whose handle is `right`.  
