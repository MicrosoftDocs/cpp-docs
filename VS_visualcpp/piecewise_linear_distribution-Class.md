...
## Remarks  
 This sampling distribution has varying-width intervals with linearly varying probability in each interval. For information about other sampling distributions, see [piecewise_constant_distribution](../VS_visualcpp/piecewise_constant_distribution-Class.md) and [discrete_distribution](../VS_visualcpp/discrete_distribution-Class.md).  
...
### Parameters  
 See parent topic [piecewise_linear_distribution Class](../VS_visualcpp/piecewise_linear_distribution-Class.md).  
