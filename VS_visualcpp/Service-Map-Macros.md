...
### Remarks  
 Use the service map to implement service provider functionality on your COM object. First, you must derive your class from                         [IServiceProviderImpl](../VS_visualcpp/IServiceProviderImpl-Class.md). There are two types of entries:  
