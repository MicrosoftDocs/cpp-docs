...
virtual void Add(  
    LPCTSTR lpszPathName, LPCTSTR lpszAppID );  
  
void Add(  
    IShellItem* pItem, LPCTSTR lpszAppID );  
  
void Add(  
    IShellLink* pLink, LPCTSTR lpszAppID );  
  
void Add(  
    PIDLIST_ABSOLUTE pidl, LPCTSTR lpszAppID );  
```  
...
### Parameters  
 `pCmdUI`  
 A pointer to the [CCmdUI](../VS_visualcpp/CCmdUI-Class.md) object for the most recently used (MRU) file list menu.  
