...
|---------------|-----------------|  
|`Codecvt`|The [locale](../VS_visualcpp/locale-Class.md) facet that represents the conversion object.|  
...
-   A pointer to the allocated conversion object (which is freed when the [wbuffer_convert](../VS_visualcpp/wbuffer_convert-Class.md) object is destroyed)  
