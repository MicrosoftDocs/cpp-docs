...
'function' : function signature contains type 'type'; C++ objects are unsafe to pass between pure code and mixed or native.  
 ...
 For more information on **/clr:pure**, see [How to: Migrate to /clr:pure (C++/CLI)](../VS_visualcpp/How-to--Migrate-to--clr-pure--C---CLI-.md).  
  
 C4412 is off by default. See [Compiler Warnings That Are Off by Default](../VS_visualcpp/Compiler-Warnings-That-Are-Off-by-Default.md) and [dllexport, dllimport](../VS_visualcpp/dllexport--dllimport.md) for more information.  
