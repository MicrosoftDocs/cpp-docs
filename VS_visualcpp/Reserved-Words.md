...
---
# Reserved Words
The following words are reserved by the linker. These names can be used as arguments in [module-definition statements](../VS_visualcpp/Module-Definition--.Def--Files.md) only if the name is enclosed in double quotation marks ("").  
