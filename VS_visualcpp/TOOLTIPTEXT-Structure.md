...
In writing your [tool tip notification handler](../VS_visualcpp/Handling-TTN_NEEDTEXT-Notification-for-Tool-Tips.md), you need to use the `TOOLTIPTEXT` structure. The members of the `TOOLTIPTEXT`structure are:  
