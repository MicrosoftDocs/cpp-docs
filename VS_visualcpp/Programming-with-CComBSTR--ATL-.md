...
The ATL class [CComBSTR](../VS_visualcpp/CComBSTR-Class.md) provides a wrapper around the `BSTR` data type. While `CComBSTR` is a useful tool, there are several situations that require caution.  
