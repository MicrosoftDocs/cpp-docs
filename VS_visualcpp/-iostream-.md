...
#### Return Value  
 An [ostream](../VS_visualcpp/-ostream--typedefs.md#ostream) object.  
  
#### Remarks  
 The object controls unbuffered insertions to the standard error output as a byte stream. Once the object is constructed, the expression `cerr.`[flags](../VS_visualcpp/ios_base-Class.md#ios_base__flags) `&` [unitbuf](../VS_visualcpp/-ios--functions.md#unitbuf) is nonzero, and `cerr.tie() == &cout`.  
...
#### Return Value  
 An [istream](../VS_visualcpp/-istream--typedefs.md#istream) object.  
  
#### Remarks  
 The object controls extractions from the standard input as a byte stream. Once the object is constructed, the call `cin.`[tie](../VS_visualcpp/basic_ios-Class.md#basic_ios__tie) returns `&`[cout](#cout).  
...
#### Return Value  
 A [wostream](../VS_visualcpp/-ostream--typedefs.md#wostream) object.  
  
#### Remarks  
 The object controls unbuffered insertions to the standard error output as a wide stream. Once the object is constructed, the expression `wcerr.`[flags](../VS_visualcpp/ios_base-Class.md#ios_base__flags) `&` [unitbuf](../VS_visualcpp/-ios--functions.md#unitbuf) is nonzero.  
...
#### Return Value  
 A [wistream](../VS_visualcpp/-istream--typedefs.md#wistream) object.  
  
#### Remarks  
 The object controls extractions from the standard input as a wide stream. Once the object is constructed, the call `wcin.`[tie](../VS_visualcpp/basic_ios-Class.md#basic_ios__tie) returns `&`[wcout](#wcout).  
...
```  
 ...
 For more information, see [Basic CString Operations](../VS_visualcpp/Basic-CString-Operations.md).  
