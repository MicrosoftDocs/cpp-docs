...
-   Construct a [CImageList](../VS_visualcpp/CImageList-Class.md) object and call one of the overloads of its [Create](../Topic/CImageList::Create.md) function to create an image list and attach it to the `CImageList` object.  
