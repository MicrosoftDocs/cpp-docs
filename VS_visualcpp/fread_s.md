...
---
# fread_s
Reads data from a stream. This version of [fread](../VS_visualcpp/fread.md) has security enhancements, as described in [Security Features in the CRT](../VS_visualcpp/Security-Features-in-the-CRT.md).  
