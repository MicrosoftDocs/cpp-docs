...
## Exceptions  
 If the `com::ptr` already owns a reference to a COM object, `CreateInstance` throws <xref:System.InvalidOperationException?qualifyHint=False>.  
  
 This function calls `CoCreateInstance` and uses <xref:System.Runtime.InteropServices.Marshal.ThrowExceptionForHR?qualifyHint=False> to convert any error `HRESULT` to an appropriate exception.  
