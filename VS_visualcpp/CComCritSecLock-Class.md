...
## Remarks  
 Use this class to lock and unlock objects in a safer way than with the [CComCriticalSection Class](../VS_visualcpp/CComCriticalSection-Class.md) or [CComAutoCriticalSection Class](../VS_visualcpp/CComAutoCriticalSection-Class.md).  
