...
## Remarks  
 ...
 When defining a coclass, you can also specify the [uuid](../VS_visualcpp/uuid--C---Attributes-.md), [version](../VS_visualcpp/version--C---.md), [threading](../VS_visualcpp/threading--C---.md), [vi_progid](../VS_visualcpp/vi_progid.md), and [progid](../VS_visualcpp/progid.md) attributes. If any one of them is not specified, it will be generated.  
...
-   [CComCoClass Class](../VS_visualcpp/CComCoClass-Class.md) provides the default class factory and aggregation model for the object.  
  
-   [CComObjectRootEx Class](../VS_visualcpp/CComObjectRootEx-Class.md) has a template based on the threading model class specified by the [threading](../VS_visualcpp/threading--C---.md) attribute. If the **threading** attribute is not specified, the default threading model is apartment.  
  
-   [IProvideClassInfo2Impl](../VS_visualcpp/IProvideClassInfo2Impl-Class.md) is added if the [noncreatable](../VS_visualcpp/noncreatable.md) attribute is not specified for the target object.  
  
 Finally, any dual interface that is not defined using embedded IDL is replaced with the corresponding [IDispatchImpl](../VS_visualcpp/IDispatchImpl-Class.md) class. If the dual interface is defined in embedded IDL, the particular interface in the base list is not modified.  
...
-   **GetProgID**, which is related to registration, returns the string specified with the [progid](../VS_visualcpp/progid.md) attribute.  
  
-   **GetVersionIndependentProgID** has the same functionality as **GetProgID**, but it returns the string specified with [vi_progid](../VS_visualcpp/vi_progid.md).  
  
 The following changes, which are related to the COM map, are made to the target class:  
  
-   A COM map is added with entries for all interfaces the target class derives from and all entries specified by the [COM Interface Entry Points](../VS_visualcpp/COM-Interface-Entry-Points.md) attribute or those required by the [aggregates](../VS_visualcpp/aggregates.md) attribute.  
