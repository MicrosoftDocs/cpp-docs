...
-   **OMP_SCHEDULE** environment variable, see [Section 4.1](../VS_visualcpp/4.1-OMP_SCHEDULE.md) on page 48.  
  
-   **ordered** construct, see [Section 2.6.6](../VS_visualcpp/2.6.6-ordered-Construct.md) on page 22.  
  
-   [Appendix D](../VS_visualcpp/D.-Using-the-schedule-Clause.md), page 93, gives more information on using the schedule clause.