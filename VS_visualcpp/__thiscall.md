...
## Microsoft Specific  
 ...
 When compiling with [/clr:pure](../VS_visualcpp/-clr--Common-Language-Runtime-Compilation-.md), all functions and function pointers are `__clrcall` unless specified otherwise.  
