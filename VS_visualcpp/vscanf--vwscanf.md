...
---
# vscanf, vwscanf
Reads formatted data from the standard input stream. More secure versions of these function are available; see [vscanf_s, vwscanf_s](../VS_visualcpp/vscanf_s--vwscanf_s.md).  
...
> [!IMPORTANT]
>  When you use `vscanf` to read a string, always specify a width for the `%s` format (for example, `"%32s"` instead of `"%s"`); otherwise, incorrectly formatted input can cause a buffer overrun. As an alternative, you can use [vscanf_s, vwscanf_s](../VS_visualcpp/vscanf_s--vwscanf_s.md) or [fgets](../VS_visualcpp/fgets--fgetws.md).  
...
|`_vtscanf`|`vscanf`|`vscanf`|`vwscanf`|  
 ...
 For more information, see [Format Specification Fields: scanf and wscanf Functions](../VS_visualcpp/Format-Specification-Fields--scanf-and-wscanf-Functions.md).  
