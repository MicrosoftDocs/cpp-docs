...
## Friend declarations  
 ...
 Functions declared in a friend declaration are treated as if they had been declared using the `extern` keyword. (For more information about `extern`, see [Static Storage-Class Specifiers](assetId:///3ba9289a-a412-4a17-b319-ceb2c087df48).)  
...
```  
 ...
 ![Implications of friend relationship](../VS_visualcpp/media/vc38V41.gif "vc38V41")  
