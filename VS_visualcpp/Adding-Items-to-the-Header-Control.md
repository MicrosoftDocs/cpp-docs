...
After creating your header control ([CHeaderCtrl](../VS_visualcpp/CHeaderCtrl-Class.md)) in its parent window, add as many "header items" as you need: usually one per column.  
