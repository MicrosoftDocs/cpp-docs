...
-   [Client Data Download Services](#_core_client_data_download_services)  
 ...
 If you are ready to start writing your program now, see [Writing MFC Applications](../VS_visualcpp/Writing-MFC-Applications.md).  
...
|-----------------------|----------------------------|-------------------------|  
|[Internet Downloading Using Asynchronous Monikers](../VS_visualcpp/Asynchronous-Monikers-on-the-Internet.md)|For asynchronous transfer using COM, ActiveX controls, and any Internet protocol.|[CAsyncMonikerFile](../VS_visualcpp/CAsyncMonikerFile-Class.md), [CDataPathProperty](../VS_visualcpp/CDataPathProperty-Class.md)|  
|[WinInet](../VS_visualcpp/Win32-Internet-Extensions--WinInet-.md)|For Internet protocols for HTTP, FTP, and gopher. Data can be transferred synchronously or asynchronously and is stored in a system-wide cache.|[CInternetSession](../VS_visualcpp/CInternetSession-Class.md), [CFtpFileFind](../VS_visualcpp/CFtpFileFind-Class.md), [CGopherFileFind](../VS_visualcpp/CGopherFileFind-Class.md), and many more.|  
|[WinSock](../VS_visualcpp/Windows-Sockets-in-MFC.md)|For maximum efficiency and control. Requires understanding of sockets and TCP/IP protocols.|[CSocket](../VS_visualcpp/CSocket-Class.md), [CAsyncSocket](../VS_visualcpp/CAsyncSocket-Class.md)|  
