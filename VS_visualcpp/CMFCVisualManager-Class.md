...
|[CMFCVisualManager::OnDrawBrowseButton](#cmfcvisualmanager__ondrawbrowsebutton)|Called by the framework when it draws a browse button that belongs to an edit control ( [CMFCEditBrowseCtrl Class](../VS_visualcpp/CMFCEditBrowseCtrl-Class.md)).|  
...
|[CMFCVisualManager::OnDrawEditBorder](#cmfcvisualmanager__ondraweditborder)|Called by the framework when it draws a border around a [CMFCToolBarEditBoxButton](../VS_visualcpp/CMFCToolBarEditBoxButton-Class.md) object.|  
...
|[CMFCVisualManager::OnDrawPaneBorder](#cmfcvisualmanager__ondrawpaneborder)|Called by the framework when it draws the border of a [CPane Class](../VS_visualcpp/CPane-Class.md).|  
...
|[CMFCVisualManager::OnDrawRibbonProgressBar](#cmfcvisualmanager__ondrawribbonprogressbar)|Called by the framework when it draws a [CMFCRibbonProgressBar](../VS_visualcpp/CMFCRibbonProgressBar-Class.md) object.|  
...
|[CMFCVisualManager::OnDrawRibbonSliderChannel](#cmfcvisualmanager__ondrawribbonsliderchannel)|Called by the framework when it draws the channel of a [CMFCRibbonSlider](../VS_visualcpp/CMFCRibbonSlider-Class.md) object.|  
...
|[CMFCVisualManager::OnDrawTab](#cmfcvisualmanager__ondrawtab)|Called by the framework when it draws a [CMFCTabCtrl](../VS_visualcpp/CMFCTabCtrl-Class.md) object.|  
...
|[CMFCVisualManager::OnFillTasksGroupInterior](#cmfcvisualmanager__onfilltasksgroupinterior)|Called by the framework when it fills the interior of a [CMFCTasksPaneTaskGroup](../VS_visualcpp/CMFCTasksPaneTaskGroup-Class.md) object on the [CMFCTasksPane](../VS_visualcpp/CMFCTasksPane-Class.md).|  
...
## Remarks  
 ...
 To change the appearance of your application you must use other classes that provide methods for drawing all of the visual elements of your application. Some examples of these classes are [CMFCVisualManagerOfficeXP Class](../VS_visualcpp/CMFCVisualManagerOfficeXP-Class.md), [CMFCVisualManagerOffice2003 Class](../VS_visualcpp/CMFCVisualManagerOffice2003-Class.md), and [CMFCVisualManagerOffice2007 Class](../VS_visualcpp/CMFCVisualManagerOffice2007-Class.md). When you want to change the appearance of your application, pass one of these visual managers into the method `SetDefaultManager`. For an example that demonstrates how your application can mimic the appearance of Microsoft Office 2003, see [CMFCVisualManagerOffice2003 Class](../VS_visualcpp/CMFCVisualManagerOffice2003-Class.md).  
...
## Example  
 The following example demonstrates how to retrieve the default values of a `CMFCVisualManager` object. This code snippet is part of the [Tasks Pane sample](../VS_visualcpp/Visual-C---Samples.md).  
...
```  
virtual BOOL DrawComboBorderWinXP( CDC*, CRect, BOOL, BOOL, BOOL  
);  
```  
...
```  
virtual BOOL DrawComboDropButtonWinXP( CDC*, CRect, BOOL, BOOL, BOOL  
);  
```  
...
```  
virtual BOOL DrawPushButtonWinXP( CDC*, CRect, CMFCButton*, UINT  
);  
```  
...
### Return Value  
 A [CSize](../VS_visualcpp/CSize-Class.md) object that contains the extra size of the border for toolbar buttons.  
...
##  <a name="cmfcvisualmanager__getinstance"></a>  CMFCVisualManager::GetInstance  
 Returns a pointer to the current [CMFCVisualManager Class](../VS_visualcpp/CMFCVisualManager-Class.md) object for the application.  
...
### Return Value  
 A [CSize](../VS_visualcpp/CSize-Class.md) parameter that indicate the size of the system buttons.  
...
virtual COLORREF GetTabTextColor(  
   const CMFCBaseTabCtrl*, int, BOOL  
);  
```  
...
### Remarks  
 The text color of a [CMFCToolBarButton Class](../VS_visualcpp/CMFCToolBarButton-Class.md) object depends on the state of the button. The possible states of a toolbar button are `ButtonsIsRegular`, `ButtonsIsPressed`, or `ButtonsIsHighlighted`.  
...
```  
virtual BOOL IsDefaultWinXPPopupButton( CMFCDesktopAlertWndButton*  
) const;  
```  
...
### Remarks  
 This method is called by [CMFCToolBarImages::Draw](../VS_visualcpp/CMFCToolBarImages-Class.md#cmfctoolbarimages__draw) when it draws an image on the toolbar that is unavailable.  
...
### Remarks  
 The [CMFCPopupMenu Class](../VS_visualcpp/CMFCPopupMenu-Class.md) calls this method when it has to draw the menu and shadow. By default, this method returns `FALSE`. If you want to use pop-up menus similar to the pop-up menus in Office XP, override this method in a custom visual manager and return `TRUE`.  
...
### Parameters  
 ...
 [in] `rectBorderSize`  
 A [CRect](../VS_visualcpp/CRect-Class.md) parameter that contains the sizes of the borders.  
...
### Remarks  
 The default implementation of this method displays the standard gripper. To customize the appearance of the gripper, override this method in a custom class derived from the [CMFCVisualManager Class](../VS_visualcpp/CMFCVisualManager-Class.md).  
...
### Remarks  
 Override this function in a derived class if you want to customize the appearance of browse buttons in instances of the [CMFCEditBrowseCtrl Class](../VS_visualcpp/CMFCEditBrowseCtrl-Class.md). The possible values for the state of the button are `ButtonsIsRegular`, `ButtonsIsPressed`, and `ButtonsIsHighlighted`.  
...
##  <a name="cmfcvisualmanager__ondrawcaptionbutton"></a>  CMFCVisualManager::OnDrawCaptionButton  
 The framework calls this method when it draws a [CMFCCaptionButton](../VS_visualcpp/CMFCCaptionButton-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawcomboborder"></a>  CMFCVisualManager::OnDrawComboBorder  
 The framework calls this method when it draws the border around an instance of the [CMFCToolBarComboBoxButton Class](../VS_visualcpp/CMFCToolBarComboBoxButton-Class.md).  
...
##  <a name="cmfcvisualmanager__ondrawcombodropbutton"></a>  CMFCVisualManager::OnDrawComboDropButton  
 The framework calls this method when it draws the drop button of a [CMFCToolBarComboBoxButton](../VS_visualcpp/CMFCToolBarComboBoxButton-Class.md).  
...
##  <a name="cmfcvisualmanager__ondraweditborder"></a>  CMFCVisualManager::OnDrawEditBorder  
 The framework calls this method when it draws the border around an instance of the [CMFCToolBarEditBoxButton Class](../VS_visualcpp/CMFCToolBarEditBoxButton-Class.md).  
...
### Parameters  
 [in] `pCtrl`  
 A pointer to a header control. The visual manager draws the sort arrow of this [CMFCHeaderCtrl Class](../VS_visualcpp/CMFCHeaderCtrl-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawmenuborder"></a>  CMFCVisualManager::OnDrawMenuBorder  
 The framework calls this method when it draws the border of a [CMFCPopupMenu](../VS_visualcpp/CMFCPopupMenu-Class.md).  
...
### Remarks  
 ...
 The default implementation for this method calls [CDC::DrawFrameControl](../VS_visualcpp/CDC-Class.md#cdc__drawframecontrol) with the `DFC_CAPTION` type. Override this method in your derived visual manager class to customize the appearance of system buttons.  
...
##  <a name="cmfcvisualmanager__ondrawpanecaption"></a>  CMFCVisualManager::OnDrawPaneCaption  
 The framework calls this method when it draws a caption for an instance of the [CDockablePane Class](../VS_visualcpp/CDockablePane-Class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton](../VS_visualcpp/CMFCRibbonButton-Class.md) object. The framework draws the border for this ribbon button.  
...
##  <a name="cmfcvisualmanager__ondrawribboncategory"></a>  CMFCVisualManager::OnDrawRibbonCategory  
 The framework calls this method when it draws a [CMFCRibbonCategory](../VS_visualcpp/CMFCRibbonCategory-Class.md) object.  
...
### Remarks  
 A ribbon category is a logical grouping of menu commands. For more information about ribbon categories, see [CMFCRibbonCategory Class](../VS_visualcpp/CMFCRibbonCategory-Class.md).  
...
### Parameters  
 ...
 [in] `pContextCaption`  
 A pointer to a caption bar. The visual manager draws this [CMFCRibbonContextCaption Class](../VS_visualcpp/CMFCRibbonContextCaption-Class.md) object.  
...
### Remarks  
 Override this method in a derived class to customize the appearance of the caption bar for a ribbon category. For more information about the caption bar, see [CMFCRibbonContextCaption Class](../VS_visualcpp/CMFCRibbonContextCaption-Class.md).  
...
### Remarks  
 Override this method in a derived visual manager to customize the appearance of a ribbon category tab. For more information about ribbon categories, see [CMFCRibbonCategory Class](../VS_visualcpp/CMFCRibbonCategory-Class.md).  
...
### Parameters  
 ...
 [in] `pLabel`  
 A pointer to a [CMFCRibbonLabel](../VS_visualcpp/CMFCRibbonLabel-Class.md) object. The framework draws this ribbon label.  
...
##  <a name="cmfcvisualmanager__ondrawribbonmainpanelbuttonborder"></a>  CMFCVisualManager::OnDrawRibbonMainPanelButtonBorder  
 The framework calls this method when it draws the border of a [CMFCRibbonButton](../VS_visualcpp/CMFCRibbonButton-Class.md) that is positioned on the **Main** panel.  
...
##  <a name="cmfcvisualmanager__ondrawribbonmainpanelframe"></a>  CMFCVisualManager::OnDrawRibbonMainPanelFrame  
 The framework calls this method when it draws the frame around the [CMFCRibbonMainPanel](../VS_visualcpp/CMFCRibbonMainPanel-Class.md).  
...
##  <a name="cmfcvisualmanager__ondrawribbonpanel"></a>  CMFCVisualManager::OnDrawRibbonPanel  
 The framework calls this method when it draws a [CMFCRibbonPanel](../VS_visualcpp/CMFCRibbonPanel-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawribbonpanelcaption"></a>  CMFCVisualManager::OnDrawRibbonPanelCaption  
 The framework calls this method when it draws the caption of a [CMFCRibbonPanel Class](../VS_visualcpp/CMFCRibbonPanel-Class.md).  
...
##  <a name="cmfcvisualmanager__ondrawribbonprogressbar"></a>  CMFCVisualManager::OnDrawRibbonProgressBar  
 The framework calls this method when it draws a [CMFCRibbonProgressBar Class](../VS_visualcpp/CMFCRibbonProgressBar-Class.md).  
...
### Parameters  
 ...
 [in] `pSeparator`  
 A pointer to a [CMFCRibbonSeparator](../VS_visualcpp/CMFCRibbonSeparator-Class.md) object. The framework draws this ribbon separator.  
...
##  <a name="cmfcvisualmanager__ondrawribbonsliderthumb"></a>  CMFCVisualManager::OnDrawRibbonSliderThumb  
 The framework calls this method when it draws the thumb of a [CMFCRibbonSlider](../VS_visualcpp/CMFCRibbonSlider-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawribbonsliderzoombutton"></a>  CMFCVisualManager::OnDrawRibbonSliderZoomButton  
 The framework calls this method when it draws the zoom buttons for a [CMFCRibbonSlider](../VS_visualcpp/CMFCRibbonSlider-Class.md) object.  
...
### Parameters  
 ...
 [in] `pPane`  
 A pointer to a status bar pane. The framework draws this [CMFCRibbonStatusBarPane](../VS_visualcpp/CMFCRibbonStatusBarPane-Class.md) object.  
...
### Parameters  
 ...
 `pWndRibbonBar`  
 A pointer to a [CMFCRibbonBar](../VS_visualcpp/CMFCRibbonBar-Class.md) object. The framework draws the frame for this ribbon bar.  
...
##  <a name="cmfcvisualmanager__ondrawspinbuttons"></a>  CMFCVisualManager::OnDrawSpinButtons  
 The framework calls this method when it draws an instance of the [CMFCSpinButtonCtrl Class](../VS_visualcpp/CMFCSpinButtonCtrl-Class.md).  
...
##  <a name="cmfcvisualmanager__ondrawstatusbarpaneborder"></a>  CMFCVisualManager::OnDrawStatusBarPaneBorder  
 The framework calls this method when it draws the border for a [CMFCStatusBar](../VS_visualcpp/CMFCStatusBar-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawstatusbarprogress"></a>  CMFCVisualManager::OnDrawStatusBarProgress  
 The framework calls this method when it draws the progress indicator on the [CMFCStatusBar](../VS_visualcpp/CMFCStatusBar-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawstatusbarsizebox"></a>  CMFCVisualManager::OnDrawStatusBarSizeBox  
 The framework calls this method when it draws the size box for a [CMFCStatusBar](../VS_visualcpp/CMFCStatusBar-Class.md).  
...
##  <a name="cmfcvisualmanager__ondrawtab"></a>  CMFCVisualManager::OnDrawTab  
 The framework calls this method when it draws the tabs for a [CMFCBaseTabCtrl](../VS_visualcpp/CMFCBaseTabCtrl-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawtabcontent"></a>  CMFCVisualManager::OnDrawTabContent  
 The framework calls this method when it draws the contents located on the interior of an instance of the [CMFCBaseTabCtrl Class](../VS_visualcpp/CMFCBaseTabCtrl-Class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCButton](../VS_visualcpp/CMFCButton-Class.md) object. The framework draws the border for this `CMFCButton` instance.  
...
##  <a name="cmfcvisualmanager__ondrawtask"></a>  CMFCVisualManager::OnDrawTask  
 The framework calls this method when it draws a [CMFCTasksPane](../VS_visualcpp/CMFCTasksPane-Class.md) object.  
...
### Parameters  
 ...
 [in] `pTask`  
 A pointer to a [CMFCTasksPaneTask](../VS_visualcpp/CMFCTasksPaneTask-Class.md) object. The framework draws this task.  
...
##  <a name="cmfcvisualmanager__ondrawtasksgroupareaborder"></a>  CMFCVisualManager::OnDrawTasksGroupAreaBorder  
 The framework calls this method when it draws a border around a group on a [CMFCTasksPane Class](../VS_visualcpp/CMFCTasksPane-Class.md).  
...
##  <a name="cmfcvisualmanager__ondrawtasksgroupcaption"></a>  CMFCVisualManager::OnDrawTasksGroupCaption  
 The framework calls this method when it draws the caption for a [CMFCTasksPaneTaskGroup](../VS_visualcpp/CMFCTasksPaneTaskGroup-Class.md) object.  
...
### Remarks  
 The task groups appear on the [CMFCTasksPane](../VS_visualcpp/CMFCTasksPane-Class.md) object.  
...
##  <a name="cmfcvisualmanager__ondrawtearoffcaption"></a>  CMFCVisualManager::OnDrawTearOffCaption  
 The framework calls this method when it draws the caption for a [CMFCPopupMenu Class](../VS_visualcpp/CMFCPopupMenu-Class.md).  
...
### Remarks  
 The framework erases the text and icon for a button when a [CMFCBaseTabCtrl](../VS_visualcpp/CMFCBaseTabCtrl-Class.md) object processes the `WM_ERASEBKGND` message.  
...
##  <a name="cmfcvisualmanager__onerasetabsframe"></a>  CMFCVisualManager::OnEraseTabsFrame  
 The framework calls this method when it erases a frame on a [CMFCBaseTabCtrl Class](../VS_visualcpp/CMFCBaseTabCtrl-Class.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCAutoHideButton](../VS_visualcpp/CMFCAutoHideButton-Class.md) object. The framework fills the background for this auto-hide button.  
...
##  <a name="cmfcvisualmanager__onfillbarbackground"></a>  CMFCVisualManager::OnFillBarBackground  
 The framework calls this method when it fills the background of a [CBasePane](../VS_visualcpp/CBasePane-Class.md) object.  
...
### Example  
 The following example demonstrates how to use the `OnFillBarBackground` in the `CMFCVisualManager` class. This code snippet is part of the [Outlook Demo sample](../VS_visualcpp/Visual-C---Samples.md).  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCToolBarButton](../VS_visualcpp/CMFCToolBarButton-Class.md). The framework fills the background for this button.  
...
### Parameters  
 [in] `pCtrl`  
 A pointer to a [CMFCHeaderCtrl](../VS_visualcpp/CMFCHeaderCtrl-Class.md) object. The framework fills the background for this header control.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton](../VS_visualcpp/CMFCRibbonButton-Class.md) object. The framework fills the interior of this ribbon button.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCRibbonButton Class](../VS_visualcpp/CMFCRibbonButton-Class.md) object. The framework fills this ribbon button.  
...
### Parameters  
 ...
 [in] `pPanel`  
 A pointer to an instance of the [CMFCRibbonMainPanel Class](../VS_visualcpp/CMFCRibbonMainPanel-Class.md). The framework fills the menu frame for this ribbon panel.  
...
##  <a name="cmfcvisualmanager__onfilltasksgroupinterior"></a>  CMFCVisualManager::OnFillTasksGroupInterior  
 The framework calls this method when it fills the interior of a [CMFCTasksPaneTaskGroup](../VS_visualcpp/CMFCTasksPaneTaskGroup-Class.md) object.  
...
##  <a name="cmfcvisualmanager__onfilltaskspanebackground"></a>  CMFCVisualManager::OnFillTasksPaneBackground  
 The framework calls this method when it fills the background of a [CMFCTasksPane](../VS_visualcpp/CMFCTasksPane-Class.md) control.  
...
### Parameters  
 ...
 [in] `pButton`  
 A pointer to a [CMFCToolBarMenuButton](../VS_visualcpp/CMFCToolBarMenuButton-Class.md) object to display. The default implementation does not use this parameter.  
...
### Remarks  
 The framework calls this method to notify the visual manager that a region has been set for frames and pop-up menus. For more information, see [CWindow::SetWindowRgn](../Topic/CWindow::SetWindowRgn.md).  
...
```  
virtual COLORREF RibbonCategoryColorToRGB(  
...
### Remarks  
 Use the [CMFCVisualManager Class](../VS_visualcpp/CMFCVisualManager-Class.md) and any derived visual managers to customize the appearance of your application. After you set the default visual manager, this method redraws your application by using the new visual manager. For more information about how to use visual managers, see [Visualization Manager](../VS_visualcpp/Visualization-Manager.md).  
...
##  <a name="cmfcvisualmanager__setshadowhighlightedimage"></a>  CMFCVisualManager::SetShadowHighlightedImage  
 Sets a flag that indicates whether the [CMFCVisualManager](../VS_visualcpp/CMFCVisualManager-Class.md) displays shadows for highlighted images.  
  
```  
void SetShadowHighlightedImage(  
   BOOL bShadow = TRUE  
);  
```  
