...
-   If the module is a safe .netmodule, pass the module directly to the linker.  
 ...
 For more information, see [/ASSEMBLYMODULE (Add a MSIL Module to the Assembly)](../VS_visualcpp/-ASSEMBLYMODULE--Add-a-MSIL-Module-to-the-Assembly-.md) and [.netmodule Files as Linker Input](../VS_visualcpp/.netmodule-Files-as-Linker-Input.md).