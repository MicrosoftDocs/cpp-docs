...
## Example  
 A trivial property cannot have reference type. See [property](../VS_visualcpp/property---C---Component-Extensions-.md) for more information. The following sample generates C3699.  
