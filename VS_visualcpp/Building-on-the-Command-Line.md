...
2.  In the **Visual Studio** folder, choose the **Developer Command Prompt** for your version of Visual Studio. If you've installed the Visual C++ Build Tools edition, choose the **x86 Native Tools Command Prompt**.  
  
 To build a C/C++ project on the command line, you can use these Visual C++ command-line tools:  
  
 [CL](../VS_visualcpp/Compiling-a-C-C---Program.md)  
 Use the compiler (cl.exe) to compile and link source code files into apps, libraries, and DLLs.  
  
 [Link](../VS_visualcpp/Linking.md)  
 ...
 [NMAKE](../VS_visualcpp/NMAKE-Reference.md)  
...
## Related Sections  
 ...
 [C/C++ Compiler Options](../VS_visualcpp/Compiler-Options.md)  
