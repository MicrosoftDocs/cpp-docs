...
|[RegistryDataExchange](../Topic/RegistryDataExchange.md)|This function is called to read from, or write to, the system registry. Called by the                             [Registry Data Exchange Macros](../VS_visualcpp/Registry-Data-Exchange-Macros.md).|  
