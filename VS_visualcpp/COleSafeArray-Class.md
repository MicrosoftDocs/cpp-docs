...
|[COleSafeArray::GetByteArray](#colesafearray__getbytearray)|Copies the contents of the safe array into a [CByteArray](../VS_visualcpp/CByteArray-Class.md).|  
...
### Remarks  
 On error, the function throws a [CMemoryException](../VS_visualcpp/CMemoryException-Class.md) or [COleException](../VS_visualcpp/COleException-Class.md).  
...
### Remarks  
 This function will clear the current array data if necessary. On error, the function throws a [CMemoryException](../VS_visualcpp/CMemoryException-Class.md).  
...
### Remarks  
 ...
 On error, the function throws a [CMemoryException](../VS_visualcpp/CMemoryException-Class.md).  
...
### Remarks  
 If objects are stored in the array, each object is released. On error, the function throws a [CMemoryException](../VS_visualcpp/CMemoryException-Class.md) or [COleException](../VS_visualcpp/COleException-Class.md).  
...
### Remarks  
 ...
 On error, the function throws a [COleException](../VS_visualcpp/COleException-Class.md).  
...
### Remarks  
 On error, it throws a [COleException](../VS_visualcpp/COleException-Class.md).  
...
### Remarks  
 This function is called after access to the data in an array is finished. On error, it throws a [COleException](../VS_visualcpp/COleException-Class.md).  
