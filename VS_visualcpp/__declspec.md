 ...
 *extended-decl-modifier*:  
 ...
 Extended attribute grammar supports these Microsoft-specific storage-class attributes: [align](../VS_visualcpp/align--C---.md), [allocate](../VS_visualcpp/allocate.md), [appdomain](../VS_visualcpp/appdomain.md), [code_seg](../VS_visualcpp/code_seg--__declspec-.md), [deprecated](../VS_visualcpp/deprecated--C---.md), [dllexport](../VS_visualcpp/dllexport--dllimport.md), [dllimport](../VS_visualcpp/dllexport--dllimport.md), [jitintrinsic](../VS_visualcpp/jitintrinsic.md), [naked](../VS_visualcpp/naked--C---.md), [noalias](../VS_visualcpp/noalias.md), [noinline](../VS_visualcpp/noinline.md), [noreturn](../VS_visualcpp/noreturn.md), [nothrow](../VS_visualcpp/nothrow--C---.md), [novtable](../VS_visualcpp/novtable.md), [process](../VS_visualcpp/process.md), [restrict](../VS_visualcpp/restrict.md), [safebuffers](../VS_visualcpp/safebuffers.md), [selectany](../VS_visualcpp/selectany.md), and [thread](../VS_visualcpp/thread.md). It also supports these COM-object attributes: [property](../VS_visualcpp/property--C---.md) and [uuid](../VS_visualcpp/uuid--C---.md).  
