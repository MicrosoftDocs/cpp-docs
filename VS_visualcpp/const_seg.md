...
---
# const_seg
Specifies the segment where [const](../VS_visualcpp/const--C---.md) variables are stored in the .obj file.  
...
## Remarks  
 ...
 OBJ files can be viewed with the [dumpbin](../VS_visualcpp/DUMPBIN-Command-Line.md) application. The default segment in the .obj file for `const` variables is .rdata. Some `const` variables, such as scalars, are automatically inlined into the code stream. Inlined code will not appear in .rdata.  
...
## Comments  
 ...
 You can also specify sections for initialized data ([data_seg](../VS_visualcpp/data_seg.md)), uninitialized data ([bss_seg](../VS_visualcpp/bss_seg.md)), and functions ([code_seg](../VS_visualcpp/code_seg.md)).  
