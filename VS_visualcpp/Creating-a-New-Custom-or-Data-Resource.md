...
1.  [Create a .rc file](../VS_visualcpp/How-to--Create-a-Resource-Script-File.md) that contains the custom or data resource.  
...
4.  Click **OK** to record your changes.  
 ...
 Another way to create a custom resource is to import an external file as the custom resource. For more information, see [Importing and Exporting Resources](../VS_visualcpp/How-to--Import-and-Export-Resources.md).  
