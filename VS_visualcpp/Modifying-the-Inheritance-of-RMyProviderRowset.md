...
```  
 ...
 When this is done, you can [dynamically determine columns returned to the consumer](../VS_visualcpp/Dynamically-Determining-Columns-Returned-to-the-Consumer.md).  
