...
'override_function' : matches base ref class method 'base_class_function ', but is not marked 'new' or 'override'; 'new' (and 'virtual') is assumed  
 ...
 See [override](../VS_visualcpp/override---C---Component-Extensions-.md) and [new (new slot in vtable)](../VS_visualcpp/new--new-slot-in-vtable----C---Component-Extensions-.md) for more information.  
  
 C4485 is always issued as an error. Use the [warning](../VS_visualcpp/warning.md) pragma to suppress C4485.  
