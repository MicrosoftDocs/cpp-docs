 ...
 **Base class**  
 Specifies the name of the base class for the new class. By default, the base class is [CWnd](../VS_visualcpp/CWnd-Class.md). The base class you select determines whether other boxes on this page are active.  
...
-   Classes such as [CButton](../VS_visualcpp/CButton-Class.md), [CWnd](../VS_visualcpp/CWnd-Class.md), or [CDocument](../VS_visualcpp/CDocument-Class.md), which do not require a dialog ID or resource ID. These classes do not use a dialog or resource ID. If you select one of these classes for your base class, the **Dialog ID** box and the **DHTML resource ID** box are dimmed.  
  
-   Classes such as [CDialog](../VS_visualcpp/CDialog-Class.md), [CFormView](../VS_visualcpp/CFormView-Class.md), or [CPropertyPage](../VS_visualcpp/CPropertyPage-Class.md), which require a dialog ID.  
  
-   The class [CDHtmlDialog](../VS_visualcpp/CDHtmlDialog-Class.md), which requires a dialog ID, a DHTML resource ID, and an HTML file name.  
  
 For classes requiring a dialog ID, you might find it more efficient to use the [Resource editor](../VS_visualcpp/Resource-Editors.md) to create the dialog resource, assign its ID in the [Properties window](../Topic/Properties%20Window.md), and then create a class associated with that resource ID. See [Creating a New Dialog Box](../VS_visualcpp/Creating-a-New-Dialog-Box.md) for more information on creating a standard Windows dialog box.  
 ...
 **Active accessibility**  
 Enables MFC's support for Active Accessibility by calling [EnableActiveAccessibility](../Topic/CWnd::EnableActiveAccessibility.md) in the constructor. This option is available for classes derived from [CWnd](../VS_visualcpp/CWnd-Class.md).  
 ...
 **Automation**  
 Sets the class level of support for [Automation](../VS_visualcpp/Automation.md). Automation at the class level is available for all classes that support Automation. It is also available for projects created with support for Automation. That is, either an MFC project that [supports ATL](../VS_visualcpp/MFC-Support-in-ATL-Projects.md), or an MFC project for which you selected the **Automation** check box in the [Advanced Features](../VS_visualcpp/Advanced-Features--MFC-Application-Wizard.md) page of the MFC Application Wizard.  
 ...
 **Generate DocTemplate resources**  
 Indicates that the documents created by the application have document template resources. To activate this check box, the project must support the MFC document/view architecture, and the base class of this class must be [CFormView](../VS_visualcpp/CFormView-Class.md).  
  
 See [Document Templates and the Document/View Creation Process](../VS_visualcpp/Document-Templates-and-the-Document-View-Creation-Process.md) for more information.  
