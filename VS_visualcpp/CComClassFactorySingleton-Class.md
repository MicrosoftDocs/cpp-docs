...
|Name|Description|  
|----------|-----------------|  
|[CComClassFactorySingleton::m_spObj](../Topic/CComClassFactorySingleton::m_spObj.md)|The [CComObjectGlobal](../VS_visualcpp/CComObjectGlobal-Class.md) object constructed by `CComClassFactorySingleton`.|  
...
## Inheritance Hierarchy  
 ...
 [CComClassFactory](../VS_visualcpp/CComClassFactory-Class.md)  
...
##  <a name="ccomclassfactorysingleton__m_spobj"></a>  CComClassFactorySingleton::m_spObj  
 The [CComObjectGlobal](../VS_visualcpp/CComObjectGlobal-Class.md) object constructed by `CComClassFactorySingleton`.  
