...
|`CMFCMaskedEdit::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_visualcpp/CRuntimeClass-Structure.md) object that is associated with this class type.|  
...
## Example  
 The following example demonstrates how to set up a mask (for example a phone number) by using the `EnableMask` method to create the mask for the masked edit control, the `SetValidChars` method to specify a string of valid characters that the user can enter, and `SetWindowText` method to display a prompt in the masked edit control. This example is part of the [New Controls sample](../VS_visualcpp/Visual-C---Samples.md).  
...
## Inheritance Hierarchy  
 ...
 [CMFCMaskedEdit](../VS_visualcpp/CMFCMaskedEdit-Class.md)  
...
### Remarks  
 ...
 This method redefines [CWnd::GetWindowText](../VS_visualcpp/CWnd-Class.md#cwnd__getwindowtext).  
...
### Remarks  
 ...
 This method redefines [CWnd::SetWindowText](../VS_visualcpp/CWnd-Class.md#cwnd__setwindowtext).  
