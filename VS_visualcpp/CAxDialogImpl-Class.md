...
## Remarks  
 ...
 For more information on `CAxDialogImpl`, see [ATL Control Containment FAQ](../VS_visualcpp/ATL-Control-Containment-FAQ.md).  
...
### Remarks  
 ...
 The second override is provided only so dialog boxes can be used with [CComControl](../VS_visualcpp/CComControl-Class.md).  
