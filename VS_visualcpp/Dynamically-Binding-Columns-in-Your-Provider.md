...
3.  Implement the `GetColumnInfo` function. This function lays out how the information is stored. You might need to get properties or other information for this function. You might want to create a macro, similar to the [COLUMN_ENTRY](../VS_visualcpp/COLUMN_ENTRY.md) macro, to add your own information.  
