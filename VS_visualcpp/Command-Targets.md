...
---
# Command Targets
The figure [Commands in the Framework](../VS_visualcpp/User-Interface-Objects-and-Command-IDs.md) shows the connection between a user-interface object, such as a menu item, and the handler function that the framework calls to carry out the resulting command when the object is clicked.  
