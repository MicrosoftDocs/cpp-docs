...
Describes a [max class](../VS_visualcpp/-allocators-.md) object that limits a [freelist](../VS_visualcpp/freelist-Class.md) object to a maximum length that is roughly proportional to the number of allocated memory blocks.  
