...
---
# COLUMN_NAME_TYPE
Represents a binding on the rowset to the specific column in the rowset. Similar to [COLUMN_NAME](../VS_visualcpp/COLUMN_NAME.md), except that this macro also takes data type.  
