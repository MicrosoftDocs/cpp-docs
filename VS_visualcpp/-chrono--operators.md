...
##  <a name="operator-"></a>  operator-  
 Operator for subtraction or negation of [duration](../VS_visualcpp/duration-Class.md) and [time_point](../VS_visualcpp/time_point-Class.md) objects.  
...
##  <a name="operator_neq"></a>  operator!=  
 Inequality operator for [duration](../VS_visualcpp/duration-Class.md) or [time_point](../VS_visualcpp/time_point-Class.md) objects.  
...
##  <a name="operator_star"></a>  operator*  
 Multiplication operator for [duration](../VS_visualcpp/-chrono--operators.md#operator_star) objects.  
...
### Return Value  
 ...
 Unless `is_convertible<Rep2, common_type<Rep1, Rep2>>`*holds true*, the first function does not participate in overload resolution. For more information, sssee [<type_traits>](../VS_visualcpp/-type_traits-.md).  
  
 Unless `is_convertible<Rep1, common_type<Rep1, Rep2>>`*holds true*, the second function does not participate in overload resolution. For more information, see [<type_traits>](../VS_visualcpp/-type_traits-.md).  
  
##  <a name="operator_"></a>  operator/  
 Division operator for [duration](../VS_visualcpp/-chrono--operators.md#operator_star) objects.  
...
### Return Value  
 ...
 Unless `is_convertible<Rep2, common_type<Rep1, Rep2>>`*holds true*, and `Rep2` is not an instantiation of `duration`, the first operator does not participate in overload resolution. For more information, see [<type_traits>](../VS_visualcpp/-type_traits-.md).  
  
##  <a name="operator_add"></a>  operator+  
 Adds [duration](../VS_visualcpp/duration-Class.md) and [time_point](../VS_visualcpp/time_point-Class.md) objects.  
...
##  <a name="operator_lt_"></a>  operator&lt;  
 Determines whether one [duration](../VS_visualcpp/duration-Class.md) or [time_point](../VS_visualcpp/time_point-Class.md) object is less than another `duration` or `time_point` object.  
...
##  <a name="operator_lt__eq"></a>  operator&lt;=  
 Determines whether one [duration](../VS_visualcpp/duration-Class.md) or [time_point](../VS_visualcpp/time_point-Class.md) object is less than or equal to another `duration` or `time_point` object.  
...
##  <a name="operator_gt_"></a>  operator&gt;  
 Determines whether one [duration](../VS_visualcpp/duration-Class.md) or [time_point](../VS_visualcpp/time_point-Class.md) object is greater than another `duration` or `time_point` object.  
...
##  <a name="operator_gt__eq"></a>  operator&gt;=  
 Determines whether one [duration](../VS_visualcpp/duration-Class.md) or [time_point](../VS_visualcpp/time_point-Class.md) object is greater than or equal to another `duration` or `time_point` object.  
...
##  <a name="operator_modulo"></a>  operator modulo  
 Operator for modulo operations on [duration](../VS_visualcpp/duration-Class.md) objects.  
