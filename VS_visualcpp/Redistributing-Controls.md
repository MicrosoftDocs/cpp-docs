...
Visual C++ .NET supplies ActiveX controls that you can use in applications. You can then redistribute the controls along with the applications. In the **Insert ActiveX Control** dialog box, highlighting a control will display its .ocx or .dll file.  
 ...
 [MFC ActiveX Controls: Distributing ActiveX Controls](../VS_visualcpp/MFC-ActiveX-Controls--Distributing-ActiveX-Controls.md) explains how to install and register redistributable ActiveX controls.  
  
 [Merge Module Projects](assetId:///e92e4f85-fba5-45ee-a432-892a956daeb9) explains how Visual Studio .NET deployment handles the redistribution of files through merge modules.  
  
 [Redistributing Database Support Files](../VS_visualcpp/Redistributing-Database-Support-Files.md) discusses how to redistribute support files for the database technologies found in the Microsoft Data Access SDK.  
