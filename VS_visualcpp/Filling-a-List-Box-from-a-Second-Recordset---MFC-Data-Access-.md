...
1.  Create the recordset object ([CRecordset](../VS_visualcpp/CRecordset-Class.md) for ODBC, [CDaoRecordset](../VS_visualcpp/CDaoRecordset-Class.md) for DAO).  
  
2.  Obtain a pointer to the [CComboBox](../VS_visualcpp/CComboBox-Class.md) object for the combo box control.  
