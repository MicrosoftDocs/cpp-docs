...
## Remarks  
 ...
 For more information on using `CProgressCtrl`, see [Controls](../VS_visualcpp/Controls--MFC-.md) and [Using CProgressCtrl](../VS_visualcpp/Using-CProgressCtrl.md).  
...
### Remarks  
 The `SetBarColor` method sets the progress bar color only if a Windows Vista[theme](https://msdn.microsoft.com/en-us/library/windows/desktop/hh270423.aspx) is not in effect.  
