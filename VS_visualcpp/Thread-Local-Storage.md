...
-   The use of **__declspec(thread)** may interfere with [delay loading](../VS_visualcpp/Linker-Support-for-Delay-Loaded-DLLs.md) of DLL imports**.**  
...
-   The use of **__declspec(thread)** may interfere with [delay loading](../VS_visualcpp/Linker-Support-for-Delay-Loaded-DLLs.md) of DLL imports**.**  
 ...
 For more information about using the thread attribute, see [Multithreading Topics](../VS_visualcpp/Multithreading-Support-for-Older-Code--Visual-C---.md).  
