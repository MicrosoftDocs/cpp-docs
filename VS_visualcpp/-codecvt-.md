...
---
# &lt;codecvt&gt;
Defines several template classes that describe objects based on template class [codecvt](../VS_visualcpp/codecvt-Class.md). These objects can serve as [locale facets](../VS_visualcpp/locale-Class.md#facet_class) that control conversions between a sequence of values of type `Elem` and a sequence of values of type `char`.  
...
|||  
|-|-|  
|[codecvt_mode](../VS_visualcpp/-codecvt--enums.md#codecvt_mode_enumeration)|Specifies configuration information for locale facets.|  
  
### Classes  
  
|||  
|-|-|  
|[codecvt_utf8](../VS_visualcpp/codecvt_utf8.md)|Represents a locale facet that converts between wide characters encoded as UCS-2 or UCS-4, and a byte stream encoded as UTF-8.|  
|[codecvt_utf8_utf16](../VS_visualcpp/codecvt_utf8_utf16.md)|Represents a locale facet that converts between wide characters encoded as UTF-16 and a byte stream encoded as UTF-8.|  
|[codecvt_utf16](../VS_visualcpp/codecvt_utf16.md)|Represents a locale facet that converts between wide characters encoded as UCS-2 or UCS-4 and a byte stream encoded as UTF-16LE or UTF-16BE.|  
