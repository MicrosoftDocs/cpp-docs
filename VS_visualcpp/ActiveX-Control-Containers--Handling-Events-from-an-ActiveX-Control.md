...
>  This article uses a dialog-based ActiveX control container project named Container and an embedded control named Circ as examples in the procedures and code.  
 ...
 For more information on event sink maps, see [Event Sink Maps](../VS_visualcpp/Event-Sink-Maps.md) in the *Class Library Reference*.  
...
[!CODE [NVC_MFC_AxCont#9](../CodeSnippet/VS_Snippets_Cpp/NVC_MFC_AxCont#9)]  
 ...
 For more information on event sink macros, see [Event Sink Maps](../VS_visualcpp/Event-Sink-Maps.md) in the *Class Library Reference*.  
