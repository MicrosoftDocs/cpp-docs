...
```  
 ...
 The rules for how the compiler performs type deduction in function templates are based on the rules for ordinary functions. For more information, see [Overload Resolution of Function Template Calls](../VS_visualcpp/Overload-Resolution-of-Function-Template-Calls.md).  
...
```  
 ...
 For more information, see [Template Specialization](../VS_visualcpp/Template-Specialization--C---.md).