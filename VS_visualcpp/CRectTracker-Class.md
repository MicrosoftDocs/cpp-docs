...
## Remarks  
 ...
 For more information on using `CRectTracker`, see the article [Trackers](../VS_visualcpp/Trackers.md).  
...
### Remarks  
 ...
 ![Resize handle numbers](../VS_visualcpp/media/vc35DP1.gif "vc35DP1")  
...
## See Also  
 [MFC Sample TRACKER](../VS_visualcpp/Visual-C---Samples.md)   
