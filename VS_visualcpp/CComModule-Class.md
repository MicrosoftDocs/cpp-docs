...
---
# CComModule Class
As of ATL 7.0, `CComModule` is deprecated: see [ATL Module Classes](../VS_visualcpp/ATL-Module-Classes.md) for more details.  
...
> [!NOTE]
>  This class is deprecated, and the ATL code generation wizards now use the [CAtlAutoThreadModule](../VS_visualcpp/CAtlAutoThreadModule-Class.md) and [CAtlModule](../VS_visualcpp/CAtlModule-Class.md) derived classes. See [ATL Module Classes](../VS_visualcpp/ATL-Module-Classes.md) for more information. The information that follows is for use with applications created with older releases of ATL. `CComModule` is still part of ATL for backwards capability.  
...
-   Performing lifetime management of class objects.  
 ...
 When you run the ATL COM AppWizard, the wizard automatically generates `_Module`, a global instance of `CComModule` or a class derived from it. For more information about the ATL Project Wizard, see the article [Creating an ATL Project](../VS_visualcpp/Creating-an-ATL-Project.md).  
  
 In addition to `CComModule`, ATL provides [CComAutoThreadModule](../VS_visualcpp/CComAutoThreadModule-Class.md), which implements an apartment-model module for EXEs and Windows services. Derive your module from `CComAutoThreadModule` when you want to create objects in multiple apartments.  
...
##  <a name="ccommodule__getclassobject"></a>  CComModule::GetClassObject  
 As of ATL 7.0, `CComModule` is obsolete: see [ATL Module Classes](../VS_visualcpp/ATL-Module-Classes.md) for more details.  
