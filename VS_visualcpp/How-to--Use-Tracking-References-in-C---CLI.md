 ...
 **zip == 20100** The next sample shows that taking the address of a tracking reference returns an [interior_ptr (C++/CLI)](../VS_visualcpp/interior_ptr--C---CLI-.md), and shows how to modify and access data through a tracking reference.  
