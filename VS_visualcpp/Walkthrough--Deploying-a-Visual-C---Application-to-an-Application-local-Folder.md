...
1.  Create and build an MFC application by following the steps in [Walkthrough: Deploying a Visual C++ Application By Using a Setup Project](../VS_visualcpp/Walkthrough--Deploying-a-Visual-C---Application-By-Using-a-Setup-Project.md).  
