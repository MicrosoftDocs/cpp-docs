...
## Remarks  
 ...
 ![Example of CTaskDialog](../VS_visualcpp/media/CTaskDialogSample.png "CTaskDialogSample")  
CTaskDialog Sample  
...
### Remarks  
 The radio buttons for the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) enable you to gather information from the user. Use the function [CTaskDialog::GetSelectedRadioButtonID](#ctaskdialog__getselectedradiobuttonid) to determine which radio button is selected.  
...
##  <a name="ctaskdialog__ctaskdialog"></a>  CTaskDialog::CTaskDialog  
 Creates an instance of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md).  
...
### Remarks  
 Displays this instance of the [CTaskDialog](../VS_visualcpp/CTaskDialog-Class.md). The application then waits for the user to close the dialog box.  
...
### Remarks  
 The common buttons are the default buttons that you provide to [CTaskDialog::CTaskDialog](#ctaskdialog__ctaskdialog). The [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) displays the buttons along the bottom of the dialog box.  
...
##  <a name="ctaskdialog__getcommonbuttonflag"></a>  CTaskDialog::GetCommonButtonFlag  
 Converts a standard Windows button to the common button type associated with the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md).  
...
##  <a name="ctaskdialog__getcommonbuttonid"></a>  CTaskDialog::GetCommonButtonId  
 Converts one of the common button types associated with the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) to a standard Windows button.  
...
### Remarks  
 For more information about the options available to the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md), see [CTaskDialog::SetOptions](#ctaskdialog__setoptions).  
...
### Remarks  
 You can use this method to determine the availability of both command button controls and the common buttons of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md).  
...
### Remarks  
 Use this method to change whether a command button control is enabled or requires elevation after it has been added to the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md).  
...
### Remarks  
 You cannot call this method after the display window for this instance of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) is created. If you do, this method throws an exception.  
...
### Remarks  
 The content of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) is the text that is displayed to the user in the main section of the dialog box.  
...
### Remarks  
 The expansion area of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) enables you to provide additional information to the user. The expansion area is in the main part of the `CTaskDialog`, located immediately underneath the title and content string.  
...
### Remarks  
 The footer icon is displayed on the bottom of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md). It can have associated footer text. You can change the footer text with [CTaskDialog::SetFooterText](#ctaskdialog__setfootertext).  
...
### Remarks  
 The main instruction of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) is text displayed to the user in a large bold font. It is located in the dialog box underneath the title bar.  
...
### Remarks  
 The marquee bar appears underneath the main text of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md).  
...
### Remarks  
 This method throws an exception with the [ENSURE](../Topic/ENSURE%20\(MFC\).md) macro if this instance of the [CTaskDialog Class](../VS_visualcpp/CTaskDialog-Class.md) is already displayed.  
