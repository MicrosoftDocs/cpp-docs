...
> [!TIP]
>  For additional procedures on implementing multiple views for a single document, see [CDocument::AddView](../Topic/CDocument::AddView.md) and the [COLLECT](../VS_visualcpp/Visual-C---Samples.md) MFC sample.  
...
##  <a name="vcconswitchingtheviewa5"></a> Add Support for Switching the View  
 ...
 For more information on adding new menu items and command handler functions, see [Handlers for Commands and Control Notifications](../VS_visualcpp/Handlers-for-Commands-and-Control-Notifications.md).  
