...
## Remarks  
 The first constructor is the default constructor, which implictly creates an empty object. The second constructor specifies [__nullptr](../VS_visualcpp/nullptr---C---Component-Extensions-.md), which explicitly creates an empty object.  
