...
> [!NOTE]
>  Although [ClickOnce](../Topic/ClickOnce%20Security%20and%20Deployment.md) deployment for Visual C++ native applications is possible in Visual Studio, it requires extra steps. For more information, see [ClickOnce Deployment for Visual C++ Applications](../VS_visualcpp/ClickOnce-Deployment-for-Visual-C---Applications.md).  
