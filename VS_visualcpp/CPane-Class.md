...
---
# CPane Class
The `CPane` class is an enhancement of the [CControlBar Class](../VS_visualcpp/CControlBar-Class.md). If you are upgrading an existing MFC project, replace all occurrences of `CControlBar` with `CPane`.  
...
|[CPane::CopyState](#cpane__copystate)|Copies the state of a pane. (Overrides [CBasePane::CopyState](../VS_visualcpp/CBasePane-Class.md#cbasepane__copystate).)|  
...
|`CPane::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_visualcpp/CRuntimeClass-Structure.md) object that is associated with this class type.|  
...
|[CPane::IsResizable](#cpane__isresizable)|Determines whether the pane can be resized. (Overrides [CBasePane::IsResizable](../VS_visualcpp/CBasePane-Class.md#cbasepane__isresizable).)|  
|[CPane::IsTabbed](#cpane__istabbed)|Determines whether the pane has been inserted in the tab control of a tabbed window. (Overrides [CBasePane::IsTabbed](../VS_visualcpp/CBasePane-Class.md#cbasepane__istabbed).)|  
|[CPane::LoadState](#cpane__loadstate)|Loads the state of the pane from the registry. (Overrides [CBasePane::LoadState](../VS_visualcpp/CBasePane-Class.md#cbasepane__loadstate).)|  
...
|[CPane::RecalcLayout](#cpane__recalclayout)|Recalculates layout information for the pane. (Overrides [CBasePane::RecalcLayout](../VS_visualcpp/CBasePane-Class.md#cbasepane__recalclayout).)|  
|[CPane::SaveState](#cpane__savestate)|Saves the state of the pane to the registry. (Overrides [CBasePane::SaveState](../VS_visualcpp/CBasePane-Class.md#cbasepane__savestate).)|  
...
|[CPane::UndockPane](#cpane__undockpane)|Removes the pane from the dock site, default slider, or mini-frame window where it is currently docked. (Overrides [CBasePane::UndockPane](../VS_visualcpp/CBasePane-Class.md#cbasepane__undockpane).)|  
...
## Remarks  
 Typically, `CPane` objects are not instantiated directly. If you require a pane that has docking functionality, derive your object from [CDockablePane](../VS_visualcpp/CDockablePane-Class.md). If you require toolbar functionality, derive your object from [CMFCToolBar](../VS_visualcpp/CMFCToolBar-Class.md).  
  
 When you derive a class from `CPane`, it can be docked in a [CDockSite](../VS_visualcpp/CDockSite-Class.md) and it can be floated in a [CPaneFrameWnd](../VS_visualcpp/CPaneFrameWnd-Class.md).  
...
### Remarks  
 ...
 You enable docking to the various sides of the frame window by calling [CBasePane::EnableDocking](../VS_visualcpp/CBasePane-Class.md#cbasepane__enabledocking).  
...
### Remarks  
 Only dockable panes can be converted to tabbed documents. For information, see [CDockablePane::ConvertToTabbedDocument](../VS_visualcpp/CDockablePane-Class.md#cdockablepane__converttotabbeddocument).  
...
##  <a name="cpane__create"></a>  CPane::Create  
 Creates a control bar and attaches it to the [CPane](../VS_visualcpp/CPane-Class.md) object.  
...
### Parameters  
 ...
 [in] `dwStyle`  
 Specifies the window style attributes. For more information, see [Window Styles](../VS_visualcpp/Window-Styles.md).  
 ...
 Specifies the style for the pane. For more information, see [CBasePane::CreateEx](../VS_visualcpp/CBasePane-Class.md#cbasepane__createex).  
...
### Remarks  
 This method is called by the framework to create a mini-frame window when a pane is floated. The mini-frame window can be of type [CPaneFrameWnd](../VS_visualcpp/CPaneFrameWnd-Class.md) or of type [CMultiPaneFrameWnd](../VS_visualcpp/CMultiPaneFrameWnd-Class.md). A multi mini-frame window is created if the pane has the `AFX_CBRS_FLOAT_MULTI` style.  
...
### Parameters  
 [in] `dwStyleEx`  
 Specifies extended window style attributes. For more information, see [Extended Window Styles](../VS_visualcpp/Extended-Window-Styles.md).  
  
 [in] `lpszClassName`  
 Specifies the name of the Windows class.  
  
 [in] `dwStyle`  
 Specifies window style attributes. For more information, see [Window Styles](../VS_visualcpp/Window-Styles.md).  
...
### Remarks  
 This method docks the pane to the base pane that is specified by the `pDockBar` parameter. You must first enable docking by calling [CBasePane::EnableDocking](../VS_visualcpp/CBasePane-Class.md#cbasepane__enabledocking).  
...
### Remarks  
 This method is used only for panes that are derived from the [CDockablePane Class](../VS_visualcpp/CDockablePane-Class.md). For more information, see [CDockablePane::DockPaneStandard](../VS_visualcpp/CDockablePane-Class.md#cdockablepane__dockpanestandard).  
...
### Return Value  
 `FALSE` if a pane divider ( [CPaneDivider Class](../VS_visualcpp/CPaneDivider-Class.md)) cannot be created; otherwise, `TRUE`.  
...
### Return Value  
 `TRUE` if the pane was floated successfully or if the pane cannot be floated because [CBasePane::CanFloat](../VS_visualcpp/CBasePane-Class.md#cbasepane__canfloat) returns `FALSE`; otherwise, `FALSE`.  
...
### Remarks  
 The available stretch size is calculated by subtracting the minimum allowed size for the pane ( [CPane::GetMinSize](#cpane__getminsize)) from the current size ( [CWnd::GetWindowRect](../VS_visualcpp/CWnd-Class.md#cwnd__getwindowrect)).  
...
### Return Value  
 A [CRect](../VS_visualcpp/CRect-Class.md) object that contains the current width, in pixels, of each side of the pane. For example, the value of the `left` member of the `CRect` object is the width of the left border.  
...
##  <a name="cpane__getdocksiterow"></a>  CPane::GetDockSiteRow  
 Returns the dock row ( [CDockingPanesRow Class](../VS_visualcpp/CDockingPanesRow-Class.md)) in which the pane is docked.  
...
### Remarks  
 The menu contains several items that enable you to specify the pane's behavior, namely: **Floating**, **Docking**, **AutoHide**, and **Hide**. You can enable this menu for all panes by calling [CDockingManager::EnableDockSiteMenu](../VS_visualcpp/CDockingManager-Class.md#cdockingmanager__enabledocksitemenu).  
...
### Parameters  
 ...
 [in] `lpRect`  
 A [CRect](../VS_visualcpp/CRect-Class.md) object that contains the width, in pixels, of each border of the pane.  
...
### Remarks  
 This method is called by the framework to restore recent docking state information for the pane. A pane stores recent docking state information in [CPane::m_recentDockInfo](#cpane__m_recentdockinfo). For more information, see the [CRecentDockSiteInfo Class](../VS_visualcpp/CRecentDockSiteInfo-Class.md).  
...
### Remarks  
 When a pane is floated, it is put on a [CPaneFrameWnd](../VS_visualcpp/CPaneFrameWnd-Class.md) (mini-frame) window. You can provide a custom `CPaneFrameWnd`-derived class that will be used when [CPane::CreateDefaultMiniframe](#cpane__createdefaultminiframe) is called.  
...
### Parameters  
 [in] `bDelay`  
 If `FALSE`, the framework calls [CBasePane::AdjustDockingLayout](../VS_visualcpp/CBasePane-Class.md#cbasepane__adjustdockinglayout) to adjust the docking layout.  
