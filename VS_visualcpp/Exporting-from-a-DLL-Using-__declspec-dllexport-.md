 ...
 **__declspec(dllexport)** stores function names in the DLL's export table. If you want to optimize the table's size, see [Exporting Functions from a DLL by Ordinal Rather Than by Name](../VS_visualcpp/Exporting-Functions-from-a-DLL-by-Ordinal-Rather-Than-by-Name.md).  
...
-   [The __declspec keyword](../VS_visualcpp/__declspec.md)  
