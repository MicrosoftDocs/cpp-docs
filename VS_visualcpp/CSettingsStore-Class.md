...
## Example  
 The following example demonstrates how to use the Open and Read methods of the `CSettingsStore` class. This code snippet is part of the [Tool Tip Demo sample](../VS_visualcpp/Visual-C---Samples.md).  
...
## Inheritance Hierarchy  
 ...
 [CSettingsStore](../VS_visualcpp/CSettingsStore-Class.md)  
...
### Remarks  
 By default, this method is called from the destructor of the [CSettingsStore Class](../VS_visualcpp/CSettingsStore-Class.md).  
...
### Parameters  
 ...
 [out] `rect`  
 Reference to a [CRect](../VS_visualcpp/CRect-Class.md) variable that receives the value read from the registry key.  
 ...
 [out] `list`  
 Reference to a [CObList](../VS_visualcpp/CObList-Class.md) variable that receives the value read from the registry key.  
  
 [out] `obj`  
 Reference to a [CObject](../VS_visualcpp/CObject-Class.md) variable that receives the value read from the registry key.  
...
### Parameters  
 ...
 [in] `scStringList`  
 Reference to a [CStringList](../VS_visualcpp/CStringList-Class.md) variable that contains the data to store.  
 ...
 [in] `rect`  
 Reference to a [CRect](../VS_visualcpp/CRect-Class.md) variable that contains the data to store.  
 ...
 [in] `list`  
 Reference to a [CObList](../VS_visualcpp/CObList-Class.md) variable that contains the data to store.  
  
 [in] `obj`  
 Reference to a [CObject](../VS_visualcpp/CObject-Class.md) variable that contains the data to store.  
...
### Remarks  
 In order to write to the registry, you must set `bReadOnly` to a nonzero value when you create a [CSettingsStore](../VS_visualcpp/CSettingsStore-Class.md) object. For more information, see [CSettingsStore::CSettingsStore](#csettingsstore__csettingsstore).  
