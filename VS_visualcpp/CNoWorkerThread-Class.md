...
## Remarks  
 This class provides the same public interface as [CWorkerThread](../VS_visualcpp/CWorkerThread-Class.md). This interface is expected to be provided by the `MonitorClass` template parameter to cache classes.  
