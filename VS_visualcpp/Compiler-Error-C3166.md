...
'pointer' : cannot declare a pointer to an interior __gc pointer as a member of 'type'  
 ...
 The compiler found an invalid pointer declaration (a [__nogc](../Topic/__nogc.md) pointer to a [__gc](../Topic/__gc.md) pointer.). This syntax may be supported in a future release.  
