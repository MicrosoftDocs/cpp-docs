...
```  
 ...
 For more information about native enums, see [C++ Enumeration Declarations](../VS_visualcpp/Enumerations--C---.md).  
  
 For more information on CLR enums, see:  
  
-   [Underlying Type of an Enum](../VS_visualcpp/How-to--Define-and-consume-enums-in-C---CLI.md)  
  
-   [Managed and Standard Enumerations](../Topic/How%20to:%20Convert%20Between%20Managed%20and%20Standard%20Enumerations.md)  
  
-   [Operators and Enumerations](../Topic/Operators%20and%20Enumerations.md)  
