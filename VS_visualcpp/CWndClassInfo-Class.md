...
|[DECLARE_WND_SUPERCLASS](../Topic/DECLARE_WND_SUPERCLASS.md)|`CWndClassInfo` registers information for a window class that is based on an existing class but uses a different window procedure. This technique is called superclassing.|  
 ...
 For more information about using windows in ATL, see the article [ATL Window Classes](../VS_visualcpp/ATL-Window-Classes.md).  
...
### Remarks  
 ...
 `CWndClassInfo` uses `m_bSystemCursor` only when the [DECLARE_WND_CLASS](../Topic/DECLARE_WND_CLASS.md) (the default in [CWindowImpl](../VS_visualcpp/CWindowImpl-Class.md)) or the [DECLARE_WND_CLASS_EX](../Topic/DECLARE_WND_CLASS_EX.md) macro is specified. In this case, `m_bSystemCursor` is initialized to **TRUE**. For more information, see the [CWndClassInfo](../VS_visualcpp/CWndClassInfo-Class.md) overview.  
...
### Remarks  
 ...
 `CWndClassInfo` uses `m_lpszCursorID` only when the [DECLARE_WND_CLASS](../Topic/DECLARE_WND_CLASS.md) (the default in [CWindowImpl](../VS_visualcpp/CWindowImpl-Class.md)) or the [DECLARE_WND_CLASS_EX](../Topic/DECLARE_WND_CLASS_EX.md) macro is specified. In this case, `m_lpszCursorID` is initialized to **IDC_ARROW**. For more information, see the [CWndClassInfo](../VS_visualcpp/CWndClassInfo-Class.md) overview.  
...
### Remarks  
 `CWndClassInfo` uses `m_lpszOrigName` only when you include the [DECLARE_WND_SUPERCLASS](../Topic/DECLARE_WND_SUPERCLASS.md) macro in your class definition. In this case, `CWndClassInfo` registers a window class based on the class named by `m_lpszOrigName`. For more information, see the [CWndClassInfo](../VS_visualcpp/CWndClassInfo-Class.md) overview.  
...
### Remarks  
 If you have specified the [DECLARE_WND_CLASS](../Topic/DECLARE_WND_CLASS.md) (the default in [CWindowImpl](../VS_visualcpp/CWindowImpl-Class.md)) or the [DECLARE_WND_CLASS_EX](../Topic/DECLARE_WND_CLASS_EX.md) macro, `m_wc` contains information about a new window class.  
...
### Remarks  
 If you have specified the [DECLARE_WND_CLASS](../Topic/DECLARE_WND_CLASS.md) (the default in [CWindowImpl](../VS_visualcpp/CWindowImpl-Class.md)) or the [DECLARE_WND_CLASS_EX](../Topic/DECLARE_WND_CLASS_EX.md) macro, `Register` registers a new window class. In this case, the `pProc` parameter is not used.  
