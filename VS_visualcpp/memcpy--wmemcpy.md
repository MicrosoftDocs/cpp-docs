...
---
# memcpy, wmemcpy
Copies bytes between buffers. More secure versions of these functions are available; see [memcpy_s, wmemcpy_s](../VS_visualcpp/memcpy_s--wmemcpy_s.md).  
...
## Example  
 See [memmove](../VS_visualcpp/memmove--wmemmove.md) for a sample of how to use `memcpy`.  
