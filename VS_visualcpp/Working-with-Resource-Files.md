...
> [!WARNING]
>  This section applies to Windows desktop applications written in C++. For information about resources in Windows 8.x Store apps written in C++, see [Defining App Resources](assetId:///476ea844-632c-4467-9ce3-966be1350dd4).  
>   
...
## See Also  
 [Windows Desktop Applications](../VS_visualcpp/Windows-Desktop-Applications--C---.md)   
