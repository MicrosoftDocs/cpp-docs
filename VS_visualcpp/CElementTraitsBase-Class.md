...
## Remarks  
 This base class defines methods for copying and relocating elements in a collection class. It is utilized by the classes [CDefaultElementTraits](../VS_visualcpp/CDefaultElementTraits-Class.md), [CStringRefElementTraits](../VS_visualcpp/CStringRefElementTraits-Class.md), and [CStringElementTraitsI](../VS_visualcpp/CStringElementTraitsI-Class.md).  
...
### Remarks  
 This method calls [memmove](../VS_visualcpp/memmove--wmemmove.md), which is sufficient for most data types. If the objects being moved contain pointers to their own members, this method will need to be overridden.  
