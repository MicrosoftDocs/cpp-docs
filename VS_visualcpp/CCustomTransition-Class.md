...
|Name|Description|  
|----------|-----------------|  
|[CCustomTransition::Create](#ccustomtransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../VS_visualcpp/CBaseTransition-Class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CCustomTransition](../VS_visualcpp/CCustomTransition-Class.md)  
