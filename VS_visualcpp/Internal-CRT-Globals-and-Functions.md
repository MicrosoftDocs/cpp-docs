...
|----------|  
|__badioinfo|  
|[_acmdln](../VS_visualcpp/_acmdln--_tcmdln--_wcmdln.md)|  
|_commode|  
|_crtAssertBusy|  
|_crtBreakAlloc|  
|__initenv|  
|__lconv|  
|[__mb_cur_max](../VS_visualcpp/___mb_cur_max_func--___mb_cur_max_l_func--__p___mb_cur_max--__mb_cur_max.md)|  
|__pioinfo|  
|__unguarded_readlc_active|  
|[_wcmdln](../VS_visualcpp/_acmdln--_tcmdln--_wcmdln.md)|  
|__winitenv|  
...
|_except_handler4_common|  
|_except1|  
|[_execute_onexit_table](../VS_visualcpp/_execute_onexit_table--_initialize_onexit_table--_register_onexit_function.md)|  
|_fdclass|  
|_fdpcomp|  
|_fdsign|  
|_fdtest|  
...
|_get_wide_winmain_command_line|  
|_Getdays|  
|[__getmainargs](../VS_visualcpp/__getmainargs--__wgetmainargs.md)|  
|_Getmonths|  
|__GetPlatformExceptionInfo|  
|_getptd|  
|_Gettnames|  
...
|_initialize_lconv_for_unsigned_char|  
|_initialize_narrow_environment|  
|[_initialize_onexit_table](../VS_visualcpp/_execute_onexit_table--_initialize_onexit_table--_register_onexit_function.md)|  
|_initialize_wide_environment|  
|_initptd|  
|_invalid_parameter|  
|_invoke_watson|  
...
|_longjmpex|  
|_malloc_base|  
|[___mb_cur_max_func](../VS_visualcpp/___mb_cur_max_func--___mb_cur_max_l_func--__p___mb_cur_max--__mb_cur_max.md)|  
|[___mb_cur_max_l_func](../VS_visualcpp/___mb_cur_max_func--___mb_cur_max_l_func--__p___mb_cur_max--__mb_cur_max.md)|  
|_mbctype|  
|_NLG_Dispatch2|  
|_NLG_Return|  
|_NLG_Return2|  
...
|__p\_\__argv|  
|__p\_\__initenv|  
|[__p\_\__mb_cur_max](../VS_visualcpp/___mb_cur_max_func--___mb_cur_max_l_func--__p___mb_cur_max--__mb_cur_max.md)|  
|__p\_\__wargv|  
|__p\_\__winitenv|  
|__p\__acmdln|  
|[__p\__commode](../VS_visualcpp/__p__commode.md)|  
|__p\__crtAssertBusy|  
|__p\__crtBreakAlloc|  
|__p\__crtDbgFlag|  
|__p\__daylight|  
|__p\__dstbias|  
|__p\__environ|  
|[__p\__fmode](../VS_visualcpp/__p__fmode.md)|  
|__p\__iob|  
|__p\__mbcasemap|  
|__p\__mbctype|  
|__p\__pctype|  
...
|__pxcptinfoptrs|  
|_realloc_base|  
|[_register_onexit_function](../VS_visualcpp/_execute_onexit_table--_initialize_onexit_table--_register_onexit_function.md)|  
|_register_thread_local_exe_atexit_callback|  
|__report_gsfailure|  
|__RTCastToVoid|  
...
|__setlc_active|  
|[___setlc_active_func](../VS_visualcpp/___setlc_active_func--___unguarded_readlc_active_add_func.md)|  
...
|__unDNameHelper|  
|__unguarded_readlc_active|  
|[___unguarded_readlc_active_add_func](../VS_visualcpp/___setlc_active_func--___unguarded_readlc_active_add_func.md)|  
|_unloaddll|  
|_unlock_locales|  
|_vacopy|  
|_ValidateExecute|  
...
|_Wcsftime|  
|__wcsncnt|  
|[__wgetmainargs](../VS_visualcpp/__getmainargs--__wgetmainargs.md)|  
|_wsopen_dispatch|  
