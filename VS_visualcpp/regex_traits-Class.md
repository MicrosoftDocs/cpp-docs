...
## Remarks  
 The template class describes various regular expression traits for type `Elem`. The template class [basic_regex Class](../VS_visualcpp/basic_regex-Class.md) uses this information to manipulate elements of type `Elem`.  
...
## See Also  
 ...
 [regex_traits](../VS_visualcpp/regex_traits-Class.md)   
