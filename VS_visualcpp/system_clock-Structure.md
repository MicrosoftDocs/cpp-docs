...
## Remarks  
 A *clock type* is used to obtain the current time as UTC. The type embodies an instantiation of [duration](../VS_visualcpp/duration-Class.md) and the class template [time_point](../VS_visualcpp/time_point-Class.md), and defines a static member function `now()` that returns the time.  
...
##  <a name="system_clock__from_time_t_method"></a>  system_clock::from_time_t Method  
 Static method that returns a [time_point](../VS_visualcpp/time_point-Class.md) that most closely approximates the time that is represented by `Tm`.  
...
### Parameters  
 `Tm`  
 A [time_t](../VS_visualcpp/Standard-Types.md) object.  
...
### Return Value  
 A [time_point](../VS_visualcpp/time_point-Class.md) object that represents the current time.  
  
##  <a name="system_clock__to_time_t_method"></a>  system_clock::to_time_t Method  
 Static method that returns a [time_t](../VS_visualcpp/Standard-Types.md) that most closely approximates the time that is represented by `Time`.  
...
### Parameters  
 `Time`  
 A [time_point](../VS_visualcpp/time_point-Class.md) object.  
