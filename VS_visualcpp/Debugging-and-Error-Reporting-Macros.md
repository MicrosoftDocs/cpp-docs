...
|[ATLASSERT](../Topic/ATLASSERT.md)|Performs the same functionality as the                             [_ASSERTE](../VS_visualcpp/_ASSERT--_ASSERTE--_ASSERT_EXPR-Macros.md) macro found in the C run-time library.|  
...
##  <a name="atlassert"></a>  ATLASSERT  
 The                 `ATLASSERT` macro performs the same functionality as the                 [_ASSERTE](../VS_visualcpp/_ASSERT--_ASSERTE--_ASSERT_EXPR-Macros.md) macro found in the C run-time library.  
...
|**traceDumpContext**|Messages from                                         [CDumpContext](../VS_visualcpp/CDumpContext-Class.md).|  
