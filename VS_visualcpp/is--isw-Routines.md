...
|||  
|-|-|  
|[isalnum, iswalnum, _isalnum_l, _iswalnum_l](../VS_visualcpp/isalnum--iswalnum--_isalnum_l--_iswalnum_l.md)|[isgraph, iswgraph, _isgraph_l, _iswgraph_l](../VS_visualcpp/isgraph--iswgraph--_isgraph_l--_iswgraph_l.md)|  
|[isalpha, iswalpha, _isalpha_l, _iswalpha_l](../VS_visualcpp/isalpha--iswalpha--_isalpha_l--_iswalpha_l.md)|[isleadbyte, _isleadbyte_l](../VS_visualcpp/isleadbyte--_isleadbyte_l.md)|  
|[isascii, __isascii, iswascii](../VS_visualcpp/isascii--__isascii--iswascii.md)|[islower, iswlower, _islower_l, _iswlower_l](../VS_visualcpp/islower--iswlower--_islower_l--_iswlower_l.md)|  
|[isblank, iswblank, _isblank_l, _iswblank_l](../VS_visualcpp/isblank--iswblank--_isblank_l--_iswblank_l.md)|[isprint, iswprint, _isprint_l, _iswprint_l](../VS_visualcpp/isprint--iswprint--_isprint_l--_iswprint_l.md)|  
|[iscntrl, iswcntrl, _iscntrl_l, _iswcntrl_l](../VS_visualcpp/iscntrl--iswcntrl--_iscntrl_l--_iswcntrl_l.md)|[ispunct, iswpunct, _ispunct_l, _iswpunct_l](../VS_visualcpp/ispunct--iswpunct--_ispunct_l--_iswpunct_l.md)|  
|[iscsym, iscsymf, __iscsym, \__iswcsym, \__iscsymf, \__iswcsymf, _iscsym_l, _iswcsym_l, _iscsymf_l, _iswcsymf_l](../VS_visualcpp/iscsym--iscsymf--__iscsym--__iswcsym--__iscsymf--__iswcsymf--_iscsym_l--_iswcsym_l--_iscsymf_l--_iswcsymf_l.md)|[isspace, iswspace, _isspace_l, _iswspace_l](../VS_visualcpp/isspace--iswspace--_isspace_l--_iswspace_l.md)|  
|[_isctype, iswctype, _isctype_l, _iswctype_l](../VS_visualcpp/_isctype--iswctype--_isctype_l--_iswctype_l.md)|[isupper, _isupper_l, iswupper, _iswupper_l](../VS_visualcpp/isupper--_isupper_l--iswupper--_iswupper_l.md)|  
|[isdigit, iswdigit, _isdigit_l, _iswdigit_l](../VS_visualcpp/isdigit--iswdigit--_isdigit_l--_iswdigit_l.md)|[isxdigit, iswxdigit, _isxdigit_l, _iswxdigit_l](../VS_visualcpp/isxdigit--iswxdigit--_isxdigit_l--_iswxdigit_l.md)|  
