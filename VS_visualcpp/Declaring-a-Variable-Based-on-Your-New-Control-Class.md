...
3.  While pressing the CTRL key, double-click the control.  
     ...
     The [Add Member Variable](../VS_visualcpp/Add-Member-Variable-Wizard.md) dialog box appears.  
