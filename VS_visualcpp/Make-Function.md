...
## Remarks  
 See [How to: Instantiate WRL Components Directly](../VS_visualcpp/How-to--Instantiate-WRL-Components-Directly.md) to learn the differences between this function and [Microsoft::WRL::Details::MakeAndInitialize](../VS_visualcpp/MakeAndInitialize-Function.md), and for an example.  
