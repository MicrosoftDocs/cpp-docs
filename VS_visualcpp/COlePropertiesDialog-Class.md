...
## Remarks  
 ...
 For more information on OLE dialog boxes, see the article [Dialog Boxes in OLE](../VS_visualcpp/Dialog-Boxes-in-OLE.md).  
...
## See Also  
 [MFC Sample CIRC](../VS_visualcpp/Visual-C---Samples.md)   
