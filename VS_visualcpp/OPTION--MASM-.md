...
|**SCOPED**|**NOSCOPED**|**SEGMENT**|**SETIF2**.|  
 ...
 The syntax for LANGUAGE is **OPTION LANGUAGE:***x*, where *x* is one of C, SYSCALL, STDCALL, PASCAL, FORTRAN, or BASIC.  SYSCALL, PASCAL, FORTRAN, and BASIC are not supported with used with [.MODEL](../VS_visualcpp/.MODEL.md) FLAT.  
