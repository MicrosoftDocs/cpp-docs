...
3.  In the message handler that processes the `AFX_WM_RESETTOOLBAR` message, replace the original button with the new combo box button by using [CMFCToolBar::ReplaceButton](../VS_visualcpp/CMFCToolBar-Class.md#cmfctoolbar__replacebutton).  
...
4.  Synchronize the font that is selected in the combo box with the font in the document by using the [CMFCToolBarFontComboBox::SetFont](#cmfctoolbarfontcombobox__setfont) method.  
 ...
 To synchronize the document's font with the font selected in the combo box, use the [CMFCToolBarFontComboBox::GetFontDesc](#cmfctoolbarfontcombobox__getfontdesc) method to retrieve the attributes of the selected font, and use those attributes to create a [CFont Class](../VS_visualcpp/CFont-Class.md) object.  
...
## Inheritance Hierarchy  
 ...
 [CMFCToolBarFontComboBox](../VS_visualcpp/CMFCToolBarFontComboBox-Class.md)  
  
## Requirements  
 **Header:** afxtoolbarfontcombobox.h  
  
##  <a name="cmfctoolbarfontcombobox__cmfctoolbarfontcombobox"></a>  CMFCToolBarFontComboBox::CMFCToolBarFontComboBox  
 Constructs a [CMFCToolBarFontComboBox](../VS_visualcpp/CMFCToolBarFontComboBox-Class.md) object.  
...
### Parameters  
 ...
 [in] `iImage`  
 The zero-based index of a toolbar image. The image is located in the [CMFCToolBarImages Class](../VS_visualcpp/CMFCToolBarImages-Class.md) object that [CMFCToolBar Class](../VS_visualcpp/CMFCToolBar-Class.md) class maintains.  
 ...
 [in] `dwStyle`  
 The style of the combo box. (see [Combo-Box Styles](../VS_visualcpp/Combo-Box-Styles.md))  
 ...
 Pointer to a [CObList Class](../VS_visualcpp/CObList-Class.md) object that stores the available fonts.  
...
### Example  
 The following example demonstrates how to construct a `CMFCToolBarFontComboBox` object. This code snippet is part of the [Word Pad sample](../VS_visualcpp/Visual-C---Samples.md).  
