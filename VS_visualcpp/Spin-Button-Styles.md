...
---
# Spin Button Styles
Many of the settings for a spin button ([CSpinButtonCtrl](../VS_visualcpp/CSpinButtonCtrl-Class.md)) are controlled by styles. You can set the following styles using the **Properties** window in the dialog editor.  
