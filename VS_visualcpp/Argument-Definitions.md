...
```  
 ...
 `argv`  
 An array of null-terminated strings representing command-line arguments entered by the user of the program. By convention, `argv`**[0]** is the command with which the program is invoked, `argv`**[1]** is the first command-line argument, and so on, until `argv`**[**`argc`**]**, which is always **NULL**. See [Customizing Command Line Processing](../VS_visualcpp/Customizing-C---Command-Line-Processing.md) for information on suppressing command-line processing.  
