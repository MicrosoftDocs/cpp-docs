...
|**WS_TABSTOP**|Specifies that the control can receive focus when the user presses the TAB key to move to it.|  
 ...
 ![Standard progress bar style](../VS_visualcpp/media/vc4RUW1.gif "vc4RUW1")  
  
 With `PBS_SMOOTH` and `PBS_VERTICAL` styles:  
  
 ![Progress bar style, smooth and vertical](../VS_visualcpp/media/vc4RUW2.gif "vc4RUW2")  
  
 For more information, see [Window Styles](../VS_visualcpp/Frame-Window-Styles--MFC-.md) in the *MFC Reference*.  
