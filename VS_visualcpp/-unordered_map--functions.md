...
### Remarks  
 The template function executes `left.`[unordered_map::swap](../VS_visualcpp/unordered_map-Class.md#unordered_map__swap)`(right)`.  
...
### Remarks  
 The template function executes `left.`[unordered_multimap::swap](../VS_visualcpp/unordered_multimap-Class.md#unordered_multimap__swap)`(right)`.  
