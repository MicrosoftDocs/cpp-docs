...
1.  [Create](../VS_visualcpp/MFC-ActiveX-Control-Wizard.md) the control.  
  
2.  [Add methods](../VS_visualcpp/MFC-ActiveX-Controls--Methods.md).  
...
1.  Create an application, for example, an [MFC exe](../VS_visualcpp/MFC-Application-Wizard.md).  
