...
-   If you select **ODBC** under **Client type**, then the application's view class derives from [CRecordView](../VS_visualcpp/CRecordView-Class.md). This class is associated with a [CRecordset](../VS_visualcpp/CRecordset-Class.md)-derived class, which the MFC Application Wizard also creates for you. This option gives you a form-based application in which the record view is used to view and update records through its recordset.  
  
-   If you select **OLE DB** under **Client type**, then the view class derives from [COleDBRecordView](../VS_visualcpp/COleDBRecordView-Class.md), and it is associated with a [CTable](../VS_visualcpp/CTable-Class.md) or [CCommand](../VS_visualcpp/CCommand-Class.md)-derived class.  
