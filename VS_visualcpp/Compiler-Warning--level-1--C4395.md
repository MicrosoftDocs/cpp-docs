...
'function' : member function will be invoked on a copy of the initonly data member 'member'  
 ...
 A member function was called on an [initonly (C++/CLI)](../VS_visualcpp/initonly--C---CLI-.md) data member.  C4395 warns that the **initonly** data member cannot be modified by the function.  
