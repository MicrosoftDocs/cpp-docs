 ...
 **Execute** calls [CreateRowset](../VS_visualcpp/ICommandImpl--CreateRowset.md). Override the default implementation to create more than one rowset or to provide your own conditions for creating different rowsets.  
