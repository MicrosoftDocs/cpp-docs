...
-   **MCN_GETDAYSTATE** Requests information about which days should be displayed in bold. For information on handling this notification, see [Setting the Day State of a Month Calendar Control](../VS_visualcpp/Setting-the-Day-State-of-a-Month-Calendar-Control.md).  
