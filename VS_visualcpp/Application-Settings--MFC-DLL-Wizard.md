 ...
 **Automation**  
 Select **Automation** to allow your program to manipulate objects implemented in another program. Selecting **Automation** also exposes your program to other Automation clients. See [Automation](../VS_visualcpp/Automation.md) for more information.  
 ...
 **Windows sockets**  
 ...
 When your MFC DLL with Windows sockets support is created, [CWinApp::InitInstance](../Topic/CWinApp::InitInstance.md) initializes support for sockets and the MFC header file StdAfx.h includes AfxSock.h.  
