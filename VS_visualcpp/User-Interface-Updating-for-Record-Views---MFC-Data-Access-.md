...
1.  Referring to the information about using the [menu editor](../VS_visualcpp/Menu-Editor.md), create your own menu with the same four commands.  
  
#### To create toolbar buttons with the graphics editor  
  
1.  Referring to the information about using the [toolbar editor](../VS_visualcpp/Toolbar-Editor.md), edit the toolbar resource to add toolbar buttons for your record navigation commands.  
