...
## Remarks  
 You can use the [/volatile](../VS_visualcpp/-volatile--volatile-Keyword-Interpretation-.md) compiler switch to modify how the compiler interprets this keyword.  
 ...
 When `volatile` is used on a variable that also has the [__restrict](../VS_visualcpp/__restrict.md) keyword, `volatile` takes precedence.  
