...
-   [Termination functions](#_mfc_termination_functions), which cause program termination.  
 ...
 For examples and more details, see the article             [Exceptions](../VS_visualcpp/Exception-Handling-in-MFC.md).  
  
### Exception Macros  
  
|||  
|-|-|  
|[TRY](../Topic/TRY.md)|Designates a block of code for exception processing.|  
|[CATCH](../Topic/CATCH.md)|Designates a block of code for catching an exception from the preceding                             **TRY** block.|  
|[CATCH_ALL](../Topic/CATCH_ALL.md)|Designates a block of code for catching all exceptions from the preceding                             **TRY** block.|  
|[AND_CATCH](../Topic/AND_CATCH.md)|Designates a block of code for catching additional exception types from the preceding                             **TRY** block.|  
|[AND_CATCH_ALL](../Topic/AND_CATCH_ALL.md)|Designates a block of code for catching all other additional exception types thrown in a preceding                             **TRY** block.|  
|[END_CATCH](../Topic/END_CATCH.md)|Ends the last                             **CATCH** or                             `AND_CATCH` code block.|  
|[END_CATCH_ALL](../Topic/END_CATCH_ALL.md)|Ends the last                             `CATCH_ALL` code block.|  
|[THROW](../Topic/THROW%20\(MFC\).md)|Throws a specified exception.|  
|[THROW_LAST](../Topic/THROW_LAST.md)|Throws the currently handled exception to the next outer handler.|  
  
### Exception-Throwing Functions  
  
|||  
|-|-|  
|[AfxThrowArchiveException](../Topic/AfxThrowArchiveException.md)|Throws an archive exception.|  
|[AfxThrowFileException](../Topic/AfxThrowFileException.md)|Throws a file exception.|  
|[AfxThrowMemoryException](../Topic/AfxThrowMemoryException.md)|Throws a memory exception.|  
|[AfxThrowNotSupportedException](../Topic/AfxThrowNotSupportedException.md)|Throws a not-supported exception.|  
|[AfxThrowResourceException](../Topic/AfxThrowResourceException.md)|Throws a Windows resource-not-found exception.|  
|[AfxThrowUserException](../Topic/AfxThrowUserException.md)|Throws an exception in a user-initiated program action.|  
...
|||  
|-|-|  
|[AfxThrowOleDispatchException](../Topic/AfxThrowOleDispatchException.md)|Throws an exception within an OLE automation function.|  
|[AfxThrowOleException](../Topic/AfxThrowOleException.md)|Throws an OLE exception.|  
...
|||  
|-|-|  
|[AfxThrowDAOException](../Topic/AfxThrowDaoException.md)|Throws a                             [CDaoException](../VS_visualcpp/CDaoException-Class.md) from your own code.|  
|[AfxThrowDBException](../Topic/AfxThrowDBException.md)|Throws a                             [CDBException](../VS_visualcpp/CDBException-Class.md) from your own code.|  
...
|||  
|-|-|  
|[AfxAbort](../Topic/AfxAbort.md)|Called to terminate an application when a fatal error occurs.|  
...
### Remarks  
 ...
 For more information, see the article                         [Exceptions](../VS_visualcpp/Exception-Handling-in-MFC.md).  
  
### Example  
 See the example for                                 [CATCH](../Topic/CATCH.md).  
...
### Parameters  
 *exception_class*  
 Specifies the exception type to test for. For a list of standard exception classes, see class                                 [CException](../VS_visualcpp/CException-Class.md).  
...
>  The                             **CATCH** block is defined as a C++ scope delineated by braces. If you declare variables in this scope, they are accessible only within that scope. This also applies to                             *exception_object_pointer_name*.  
 ...
 For more information on exceptions and the                         **CATCH** macro, see the article                         [Exceptions](../VS_visualcpp/Exception-Handling-in-MFC.md).  
...
>  The                             `CATCH_ALL` block is defined as a C++ scope delineated by braces. If you declare variables in this scope, they are accessible only within that scope.  
 ...
 For more information on exceptions, see the article                         [Exceptions](../VS_visualcpp/Exception-Handling-in-MFC.md).  
...
### Remarks  
 For more information on the                         `END_CATCH` macro, see the article                         [Exceptions](../VS_visualcpp/Exception-Handling-in-MFC.md).  
...
### Parameters  
 `cause`  
 Specifies an integer that indicates the reason for the exception. For a list of the possible values, see                                 [CArchiveException::m_cause](../Topic/CArchiveException::m_cause.md).  
...
### Parameters  
 `cause`  
 Specifies an integer that indicates the reason for the exception. For a list of the possible values, see                                 [CFileException::m_cause](../Topic/CFileException::m_cause.md).  
...
##  <a name="afxthrowdaoexception"></a>  AfxThrowDaoException  
 Call this function to throw an exception of type                 [CDaoException](../VS_visualcpp/CDaoException-Class.md) from your own code.  
...
### Remarks  
 ...
 For information about exceptions related to the MFC DAO classes, see class                         `CDaoException` in this book and the article                         [Exceptions: Database Exceptions](../VS_visualcpp/Exceptions--Database-Exceptions.md).  
...
### Remarks  
 ...
 For information about the                         **RETCODE** values defined by ODBC, see Chapter 8, "Retrieving Status and Error Information," in the                         Windows SDK. For information about MFC extensions to these codes, see class                         [CDBException](../VS_visualcpp/CDBException-Class.md).  
