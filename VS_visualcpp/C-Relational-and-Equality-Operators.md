...
|`!=`|First operand not equal to second operand|  
 ...
 The first four operators in the list above have a higher precedence than the equality operators (`==` and `!=`). See the precedence information in the table [Precedence and Associativity of C Operators](../VS_visualcpp/Precedence-and-Order-of-Evaluation.md).  
