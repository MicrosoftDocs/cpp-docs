...
##  <a name="time_point_cast_function"></a>  time_point_cast Function  
 Casts a [time_point](../VS_visualcpp/time_point-Class.md) object to a specified type.  
...
### Remarks  
 Unless `To` is an instantiation of [duration](../VS_visualcpp/duration-Class.md), this function does not participate in overload resolution.  
