...
## Remarks  
 ...
 For information about managed arrays, see [Arrays](../VS_visualcpp/Arrays--C---Component-Extensions-.md).  
...
```  
 ...
 The subscript operator is commutative. Therefore, the expressions *array*[*index*] and *array*[*array*] are guaranteed to be equivalent as long as the subscript operator is not overloaded (see [Overloaded Operators](../VS_visualcpp/Operator-Overloading.md)). The first form is the most common coding practice, but either works.  
...
## See Also  
 ...
 [Multidimensional Arrays](../VS_visualcpp/Multidimensional-Arrays--C-.md)