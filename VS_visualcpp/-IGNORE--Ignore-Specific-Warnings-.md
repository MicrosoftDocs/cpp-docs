...
|[LNK4044](../VS_visualcpp/Linker-Tools-Warning-LNK4044.md)|unrecognized option '`option`'; ignored|  
|LNK4062|'`option`' not compatible with '`architecture`' target machine; option ignored|  
|[LNK4075](../VS_visualcpp/Linker-Tools-Warning-LNK4075.md)|ignoring "`option1`" due to "`option2`" specification|  
|[LNK4086](../VS_visualcpp/Linker-Tools-Warning-LNK4086.md)|entrypoint '`function`' is not __stdcall with '`number`' bytes of arguments; image may not run|  
|LNK4088|image being generated due to /FORCE option; image may not run|  
|[LNK4105](../VS_visualcpp/Linker-Tools-Warning-LNK4105.md)|no argument specified with option '`option`'; ignoring switch|  
|LNK4203|error reading program database '`filename`'; linking object as if no debug info|  
|[LNK4204](../VS_visualcpp/Linker-Tools-Warning-LNK4204.md)|'`filename`' is missing debugging information for referencing module; linking object as if no debug info|  
|[LNK4205](../VS_visualcpp/Linker-Tools-Warning-LNK4205.md)|'`filename`' is missing current debugging information for referencing module; linking object as if no debug info|  
|[LNK4206](../VS_visualcpp/Linker-Tools-Warning-LNK4206.md)|precompiled type information not found; '`filename`' not linked or overwritten; linking object as if no debug info|  
...
|[LNK4224](../VS_visualcpp/Linker-Tools-Warning-LNK4224.md)|`option` is no longer supported; ignored|  
|LNK4228|'`option`' invalid for a DLL; ignored|  
|[LNK4229](../VS_visualcpp/Linker-Tools-Warning-LNK4229.md)|invalid directive /`directive` found; ignored|  
