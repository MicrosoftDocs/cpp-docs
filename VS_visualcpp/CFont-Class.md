...
## Remarks  
 ...
 For more information on `CFont`, see [Graphic Objects](../VS_visualcpp/Graphic-Objects.md).  
...
### Remarks  
 ...
 This font has the characteristics specified in the                         [LOGFONT](http://msdn.microsoft.com/library/windows/desktop/dd145037) structure. When the font is selected by using the [CDC::SelectObject](../VS_visualcpp/CDC-Class.md#cdc__selectobject) member function, the GDI font mapper attempts to match the logical font with an existing physical font. If the font mapper fails to find an exact match for the logical font, it provides an alternative font whose characteristics match as many of the requested characteristics as possible.  
...
### Parameters  
 ...
 `pDC`  
 Pointer to the [CDC](../VS_visualcpp/CDC-Class.md) object to be used to convert the height in `nPointSize` to logical units. If **NULL**, a screen device context is used for the conversion.  
...
### Parameters  
 ...
 `pDC`  
 Pointer to the [CDC](../VS_visualcpp/CDC-Class.md) object to be used to convert the height in **lfHeight** to logical units. If **NULL**, a screen device context is used for the conversion.  
