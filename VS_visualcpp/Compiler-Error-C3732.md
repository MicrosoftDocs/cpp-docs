...
'interface': a custom interface that fires COM events cannot inherit from IDispatch  
 ...
 An interface that supports COM events cannot inherit from `IDispatch`. For more information, see [Event Handling in COM](../VS_visualcpp/Event-Handling-in-COM.md).  
