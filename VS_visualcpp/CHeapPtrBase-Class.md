...
## Remarks  
 This class forms the basis for several smart heap pointer classes. The derived classes, for example, [CHeapPtr](../VS_visualcpp/CHeapPtr-Class.md) and [CComHeapPtr](../VS_visualcpp/CComHeapPtr-Class.md), add their own constructors and operators. See these classes for implementation examples.  
