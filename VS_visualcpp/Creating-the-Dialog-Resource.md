...
To design the [dialog box](../VS_visualcpp/Dialog-Boxes.md) and create the dialog resource, you use the [dialog editor](../VS_visualcpp/Dialog-Editor.md). In the dialog editor, you can:  
...
-   Test your dialog box by simulating the appearance and behavior it will have in your program. In Test mode, you can manipulate the dialog box's controls by typing text in text boxes, clicking pushbuttons, and so on.  
 ...
 When you finish, your dialog-template resource is stored in your application's resource script file. You can edit it later if needed. For a full description of how to create and edit dialog resources, see the [dialog editor](../VS_visualcpp/Dialog-Editor.md) topics. This technique is also used to create the dialog-template resources for [CFormView](../VS_visualcpp/CFormView-Class.md) and [CRecordView](../VS_visualcpp/CRecordView-Class.md) classes.  
  
 When the dialog box's appearance suits you, create a dialog class and map its messages, as discussed in [Creating a Dialog Class with Code Wizards](../VS_visualcpp/Creating-a-Dialog-Class-with-Code-Wizards.md).  
