...
The `_ITERATOR_DEBUG_LEVEL` (IDL) macro supersedes and combines the functionality of the [_SECURE_SCL](../VS_visualcpp/_SECURE_SCL.md) (SCL) and [_HAS_ITERATOR_DEBUGGING](../VS_visualcpp/_HAS_ITERATOR_DEBUGGING.md) (HID) macros.  
