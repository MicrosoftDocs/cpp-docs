...
## Remarks  
 ...
 For more information on `CMapStringToString`, see the article [Collections](../VS_visualcpp/Collections.md).  
...
### Remarks  
 This is a nested structure within class [CMapStringToString](../VS_visualcpp/CMapStringToString-Class.md).  
