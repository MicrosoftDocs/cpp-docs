...
## Remarks  
 The class [CAtlAutoThreadModuleT](../VS_visualcpp/CAtlAutoThreadModuleT-Class.md) derives from `IAtlAutoThreadModule`, using it to provide code for creating an object and retrieving an interface pointer.  
