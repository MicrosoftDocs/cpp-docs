...
The steps in this article assume that you are creating a dialog-based ([CDialog Class](../VS_visualcpp/CDialog-Class.md)) Microsoft Foundation Classes (MFC) project, but you can also add support for a Windows Forms control to an existing MFC dialog box.  
