...
## Remarks  
 ...
 When a small number of elements need to be stored, consider using the [CSimpleMap](../VS_visualcpp/CSimpleMap-Class.md) class instead.  
