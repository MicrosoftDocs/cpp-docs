...
## Remarks  
 ...
 A companion class,                 [CTime](../VS_visualcpp/CTime-Class.md), represents an absolute time.  
 ...
 For more information on using                 `CTimeSpan`, see the articles                 [Date and Time](../VS_visualcpp/Date-and-Time.md), and                 [Time Management](../VS_visualcpp/Time-Management.md) in the                 *Run-Time Library Reference*.  
