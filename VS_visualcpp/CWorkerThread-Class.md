...
#### Parameters  
 `ThreadTraits`  
 The class providing the thread creation function, such as [CRTThreadTraits](../VS_visualcpp/CRTThreadTraits-Class.md) or [Win32ThreadTraits](../VS_visualcpp/Win32ThreadTraits-Class.md).  
...
|Name|Description|  
|----------|-----------------|  
|[CWorkerThread::CWorkerThread](../Topic/CWorkerThread::CWorkerThread.md)|The constructor for the worker thread.|  
|[CWorkerThread::~CWorkerThread](../Topic/CWorkerThread::~CWorkerThread.md)|The destructor for the worker thread.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[CWorkerThread::AddHandle](../Topic/CWorkerThread::AddHandle.md)|Call this method to add a waitable object's handle to the list maintained by the worker thread.|  
|[CWorkerThread::AddTimer](../Topic/CWorkerThread::AddTimer.md)|Call this method to add a periodic waitable timer to the list maintained by the worker thread.|  
|[CWorkerThread::GetThreadHandle](../Topic/CWorkerThread::GetThreadHandle.md)|Call this method to get the thread handle of the worker thread.|  
...
2.  Call [CWorkerThread::Initialize](../Topic/CWorkerThread::Initialize.md).  
  
3.  Call [CWorkerThread::AddHandle](../Topic/CWorkerThread::AddHandle.md) with the handle of a kernel object and a pointer to an implementation of [IWorkerThreadClient](../VS_visualcpp/IWorkerThreadClient-Interface.md).  
  
     – or –  
  
     Call [CWorkerThread::AddTimer](../Topic/CWorkerThread::AddTimer.md) with a pointer to an implementation of [IWorkerThreadClient](../VS_visualcpp/IWorkerThreadClient-Interface.md).  
  
4.  Implement [IWorkerThreadClient::Execute](../Topic/IWorkerThreadClient::Execute.md) to take some action when the handle or timer is signaled.  
...
### Parameters  
 ...
 `pClient`  
 The pointer to the [IWorkerThreadClient](../VS_visualcpp/IWorkerThreadClient-Interface.md) interface on the object to be called when the handle is signaled.  
  
 `dwParam`  
 The parameter to be passed to [IWorkerThreadClient::Execute](../Topic/IWorkerThreadClient::Execute.md) when the handle is signaled.  
  
### Return Value  
 Returns S_OK on success, or an error HRESULT on failure.  
  
### Remarks  
 [IWorkerThreadClient::Execute](../Topic/IWorkerThreadClient::Execute.md) will be called through `pClient` when the handle, `hObject`, is signaled.  
...
### Remarks  
 [IWorkerThreadClient::Execute](../Topic/IWorkerThreadClient::Execute.md) will be called through `pClient` when the timer is signaled.  
  
 Pass the timer handle from `phTimer` to [CWorkerThread::RemoveHandle](../Topic/CWorkerThread::RemoveHandle.md) to close the timer.  
...
### Remarks  
 When the handle is removed [IWorkerThreadClient::CloseHandle](../Topic/IWorkerThreadClient::CloseHandle.md) will be called on the associated object that was passed to [AddHandle](../Topic/CWorkerThread::AddHandle.md). If this call fails, `CWorkerThread` will call the Windows [CloseHandle](http://msdn.microsoft.com/library/windows/desktop/ms724211) function on the handle.  
...
### Remarks  
 To reuse the object, call [CWorkerThread::Initialize](../Topic/CWorkerThread::Initialize.md) after calling this method.  
