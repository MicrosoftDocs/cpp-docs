...
2.  On the [Image Editor toolbar](../VS_visualcpp/Toolbar--Image-Editor-for-Icons-.md), click the arrow to the right of the [Magnify tool](../VS_visualcpp/Toolbar--Image-Editor-for-Icons-.md) and select the magnification-factor from the submenu: **1X**, **2X**, **6X**, or **8X**.  
...
## See Also  
 ...
 [Window Panes](../VS_visualcpp/Window-Panes--Image-Editor-for-Icons-.md)