...
This topic lists the Record Field Exchange ([RFX](#_mfc_rfx_functions_.28.odbc.29), [Bulk RFX](#_mfc_bulk_rfx_functions_.28.odbc.29), and [DFX](#_mfc_dfx_functions_.28.dao.29)) functions used to automate the transfer of data between a recordset object and its data source and to perform other operations on the data.  
 ...
 For more information about how these functions are used, see the articles [Record Field Exchange: How RFX Works (ODBC)](../VS_visualcpp/Record-Field-Exchange--How-RFX-Works.md). For more information about bulk row fetching, see the article [Recordset: Fetching Records in Bulk (ODBC)](../VS_visualcpp/Recordset--Fetching-Records-in-Bulk--ODBC-.md).  
  
 For columns of data that you bind dynamically, you can also call the RFX or DFX functions yourself, as explained in the articles [Recordset: Dynamically Binding Data Columns (ODBC)](../VS_visualcpp/Recordset--Dynamically-Binding-Data-Columns--ODBC-.md). Additionally, you can write your own custom RFX or DFX routines, as explained in Technical Note [43](../VS_visualcpp/TN043--RFX-Routines.md) (for ODBC) and Technical Note [53](../VS_visualcpp/TN053--Custom-DFX-Routines-for-DAO-Database-Classes.md) (for DAO).  
...
|||  
|-|-|  
|[RFX_Binary](../Topic/RFX_Binary.md)|Transfers arrays of bytes of type [CByteArray](../VS_visualcpp/CByteArray-Class.md).|  
|[RFX_Bool](../Topic/RFX_Bool.md)|Transfers Boolean data.|  
|[RFX_Byte](../Topic/RFX_Byte.md)|Transfers a single byte of data.|  
|[RFX_Date](../Topic/RFX_Date.md)|Transfers time and date data using [CTime](../VS_visualcpp/CTime-Class.md) or **TIMESTAMP_STRUCT**.|  
...
|[RFX_LongBinary](../Topic/RFX_LongBinary.md)|Transfers binary large object (BLOB) data with an object of the [CLongBinary](../VS_visualcpp/CLongBinary-Class.md) class.|  
...
|||  
|-|-|  
|[DFX_Binary](../Topic/DFX_Binary.md)|Transfers arrays of bytes of type [CByteArray](../VS_visualcpp/CByteArray-Class.md).|  
|[DFX_Bool](../Topic/DFX_Bool.md)|Transfers Boolean data.|  
|[DFX_Byte](../Topic/DFX_Byte.md)|Transfers a single byte of data.|  
|[DFX_Currency](../Topic/DFX_Currency.md)|Transfers currency data, of type [COleCurrency](../VS_visualcpp/COleCurrency-Class.md).|  
|[DFX_DateTime](../Topic/DFX_DateTime.md)|Transfers time and date data, of type [COleDateTime](../VS_visualcpp/COleDateTime-Class.md).|  
