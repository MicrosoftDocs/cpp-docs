...
## Remarks  
 ...
 A DocObject server document can contain [CDocObjectServerItem](../VS_visualcpp/CDocObjectServerItem-Class.md) objects, which represent the server interface to DocObject items.  
 ...
 For further information on DocObjects, see [CDocObjectServerItem](../VS_visualcpp/CDocObjectServerItem-Class.md) and [COleCmdUI](../VS_visualcpp/COleCmdUI-Class.md) in the                 *MFC Reference*. Also see [Internet First Steps: Active Documents](../VS_visualcpp/Active-Documents-on-the-Internet.md) and [Active Documents](../VS_visualcpp/Active-Documents-on-the-Internet.md).  
