...
1.  In all cases, first construct a `CDaoTableDef` object, supplying a pointer to a [CDaoDatabase](../VS_visualcpp/CDaoDatabase-Class.md) object to which the table belongs.  
...
2.  Then do the following, depending on what you want:  
 ...
 To use a tabledef object to create a `CDaoRecordset` object, you typically create or open a tabledef as described above, then construct a recordset object, passing a pointer to your tabledef object when you call [CDaoRecordset::Open](../VS_visualcpp/CDaoRecordset-Class.md#cdaorecordset__open). The tabledef you pass must be in an open state. For more information, see class [CDaoRecordset](../VS_visualcpp/CDaoRecordset-Class.md).  
  
 When you finish using a tabledef object, call its [Close](../VS_visualcpp/CDaoRecordset-Class.md#cdaorecordset__close) member function; then destroy the tabledef object.  
...
### Parameters  
 `pDatabase`  
 A pointer to a [CDaoDatabase](../VS_visualcpp/CDaoDatabase-Class.md) object.  
...
### Remarks  
 Once you have named the tabledef, you can then call [Append](#cdaotabledef__append) to save the tabledef in the database's TableDefs collection. After calling **Append**, the tabledef is in an open state, and you can use it to create a [CDaoRecordset](../VS_visualcpp/CDaoRecordset-Class.md) object.  
...
|**dbInteger**|2|int|  
|**dbLong**|4|long|  
|**dbCurrency**|8|Currency ( [COleCurrency](../VS_visualcpp/COleCurrency-Class.md))|  
|**dbSingle**|4|float|  
|**dbDouble**|8|double|  
|**dbDate**|8|Date/Time ( [COleDateTime](../VS_visualcpp/COleDateTime-Class.md))|  
|**dbText**|1 – 255|Text ( [CString](../VS_visualcpp/CStringT-Class.md))|  
|**dbLongBinary**|0|Long Binary (OLE Object), [CLongBinary](../VS_visualcpp/CLongBinary-Class.md) or [CByteArray](../VS_visualcpp/CByteArray-Class.md)|  
|**dbMemo**|0|Memo ( [CString](../VS_visualcpp/CStringT-Class.md))|  
...
##  <a name="cdaotabledef__m_pdatabase"></a>  CDaoTableDef::m_pDatabase  
 Contains a pointer to the [CDaoDatabase](../VS_visualcpp/CDaoDatabase-Class.md) object for this table.  
...
### Remarks  
 ...
 To force the modified connect information to take effect, all open [CDaoRecordset](../VS_visualcpp/CDaoRecordset-Class.md) objects based on this tabledef must be closed.  
