...
## Remarks  
 As with standard dialog boxes, you derive a class from `CPropertyPage` for each page in your property sheet. To use `CPropertyPage`-derived objects, first create a [CPropertySheet](../VS_visualcpp/CPropertySheet-Class.md) object, and then create an object for each page that goes in the property sheet. Call [CPropertySheet::AddPage](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__addpage) for each page in the sheet, and then display the property sheet by calling [CPropertySheet::DoModal](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__domodal) for a modal property sheet, or [CPropertySheet::Create](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__create) for a modeless property sheet.  
 ...
 For more information on establishing a property sheet as a wizard, see [CPropertySheet::SetWizardMode](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__setwizardmode). For more information on using `CPropertyPage` objects, see the article [Property Sheets and Property Pages](../VS_visualcpp/Property-Sheets-and-Property-Pages-in-MFC.md).  
...
-   The page has been added to a property sheet using [CPropertySheet::AddPage](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__addpage).  
  
-   The property sheet's [DoModal](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__domodal) or [Create](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__create) function has been called.  
...
-   The user has selected (tabbed to) this page.  
 ...
 If you have multiple parameters (for example, if you are using an array), use [CPropertySheet::Construct](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__construct) instead of `CPropertyPage`.  
...
### Remarks  
 When the user chooses either the OK or the Apply Now button, the framework receives the                         [PSN_APPLY](http://msdn.microsoft.com/library/windows/desktop/bb774552) notification from the property page. The call to `OnOK` won't be made if you call [CPropertySheet::PressButton](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__pressbutton) because the property page does not send the notification in that case.  
...
### Example  
  See the example for [CPropertySheet::SetFinishText](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__setfinishtext).  
...
### Remarks  
 ...
 For more information on how to make a wizard-type property sheet, see [CPropertySheet::SetWizardMode](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__setwizardmode).  
...
## See Also  
 ...
 [CDialog Class](../VS_visualcpp/CDialog-Class.md)   
 [CPropertySheet::SetWizardMode](../VS_visualcpp/CPropertySheet-Class.md#cpropertysheet__setwizardmode)