...
A helper class that manages default state for the Quick Access Toolbar that is positioned on the ribbon bar ( [CMFCRibbonBar Class](../VS_visualcpp/CMFCRibbonBar-Class.md)).  
...
## Remarks  
 After you create the Quick Access Toolbar in your application, we recommend that you set its default state by calling [CMFCRibbonBar::SetQuickAccessDefaultState](../VS_visualcpp/CMFCRibbonBar-Class.md#cmfcribbonbar__setquickaccessdefaultstate). This default state is restored when a user clicks the **Reset** button on the **Customize** page of your application's **Options** dialog box.  
  
## Inheritance Hierarchy  
 [CMFCRibbonQuickAccessToolBarDefaultState](../VS_visualcpp/CMFCRibbonQuickAccessToolBarDefaultState-Class.md)  
...
### Remarks  
 By default, the list of commands that the new instance of [CMFRibbonQuickAccessToolBarDefaultState](../VS_visualcpp/CMFCRibbonQuickAccessToolBarDefaultState-Class.md) contains is empty.  
...
## See Also  
 ...
 [CMFCRibbonBar::SetQuickAccessDefaultState](../VS_visualcpp/CMFCRibbonBar-Class.md#cmfcribbonbar__setquickaccessdefaultstate)