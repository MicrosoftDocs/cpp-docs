...
## Remarks  
 You can derive a class from [CPaneFrameWnd Class](../VS_visualcpp/CPaneFrameWnd-Class.md) and use the protected method, `AddButton`, to add caption buttons to a mini frame window.  
...
## Inheritance Hierarchy  
 ...
 [CMFCCaptionButton](../VS_visualcpp/CMFCCaptionButton-Class.md)  
