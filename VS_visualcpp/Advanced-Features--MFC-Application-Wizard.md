 ...
 **Context-sensitive help (HTML)**  
 ...
 See [HTML Help: Context-Sensitive Help for Your Programs](../VS_visualcpp/HTML-Help--Context-Sensitive-Help-for-Your-Programs.md) and [Help Files (HTML Help)](../VS_visualcpp/Help-Files--HTML-Help-.md) for more information.  
  
 **Printing and print preview**  
 Generates the code to handle the print, print setup and print preview commands by calling member functions in the [CView Class](../VS_visualcpp/CView-Class.md) from the MFC library. The wizard also adds commands for these functions to the application's menu. Printing support is available only for applications that specify **Document/view architecture support** in the [Application Type, MFC Application Wizard](../VS_visualcpp/Application-Type--MFC-Application-Wizard.md) page of the wizard. By default, document/view applications have printing support.  
 ...
 **Active Accessibility**  
 Adds support for [IAccessible](http://msdn.microsoft.com/library/windows/desktop/dd318466) to [CWnd](../VS_visualcpp/CWnd-Class.md)-derived classes, which you can use to customize the user interface for better interaction with accessibility clients.  
