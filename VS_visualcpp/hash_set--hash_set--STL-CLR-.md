---
title: "hash_set::hash_set (STL-CLR)"
ms.custom: na
ms.date: 10/03/2016
ms.devlang: 
  - C++
...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[hash_set::begin (STL/CLR)](../VS_visualcpp/hash_set--begin--STL-CLR-.md)`(),` `right``.`[hash_set::end (STL/CLR)](../VS_visualcpp/hash_set--end--STL-CLR-.md)`())`, with the default ordering predicate, and with the default hash function. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the hash_set object `right`, with the default ordering predicate and hash function.  
