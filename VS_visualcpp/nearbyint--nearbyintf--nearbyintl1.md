...
apitype: DLLExport
H1: nearbyint, nearbyintf, nearbyintl
...
translation.priority.mt: 
  ...
  - zh-tw
---
# nearbyint, nearbyintf, nearbyintl1
...
|`x` = NaN|NaN|  
 ...
 Errors are not reported through [_matherr](../VS_visualcpp/_matherr.md); specifically, this function does not report any FE_INEXACT exceptions.  
