...
```  
 ...
 The lifetime and visibility of identifiers are discussed in [Lifetime, Scope, Visibility, and Linkage](../VS_visualcpp/Lifetime--Scope--Visibility--and-Linkage.md). For more information on functions, see [Functions](../VS_visualcpp/Functions--C-.md).  
