...
|Name|Description|  
|----------|-----------------|  
|[ArgTraitsHelper::args Constant](../VS_visualcpp/ArgTraitsHelper--args-Constant.md)|Helps [ArgTraits::args](../VS_visualcpp/ArgTraits--args-Constant.md) keep count of the number of parameters on the Invoke method of a delegate interface.|  
