...
## Remarks  
 This interface is implemented by [CComHeap](../VS_visualcpp/CComHeap-Class.md), [CCRTHeap](../VS_visualcpp/CCRTHeap-Class.md), [CLocalHeap](../VS_visualcpp/CLocalHeap-Class.md), [CGlobalHeap](../VS_visualcpp/CGlobalHeap-Class.md), or [CWin32Heap](../VS_visualcpp/CWin32Heap-Class.md).  
...
### Example  
 For an example, see the [IAtlMemMgr Overview](../VS_visualcpp/IAtlMemMgr-Class.md).  
...
### Remarks  
 When `SetAmbientDispatch` is called with a pointer to a new interface, this new interface will be used to invoke any properties or methods asked for by the hosted control — if those properties are not already provided by [IAxWinAmbientDispatch](../VS_visualcpp/IAxWinAmbientDispatch-Interface.md).  
