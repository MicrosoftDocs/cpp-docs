...
---
# &lt;seealso&gt; (Visual C++)
The <seealso\> tag lets you specify the text that you might want to appear in a See Also section. Use [<see\>](../VS_visualcpp/-see---Visual-C---.md) to specify a link from within text.  
...
## Remarks  
 ...
 See [<summary\>](../VS_visualcpp/-summary---Visual-C---.md) for an example of using <seealso\>.  
