...
These free functions in the [<filesystem\>](../VS_visualcpp/-filesystem-.md) header perform modifying and query operations on paths, files, symlinks, directories and volumes. For more information and code examples, see [File System Navigation (C++)](../VS_visualcpp/File-System-Navigation.md).  
