...
> [!NOTE]
>  To turn on the collecting of browse information with this pragma, [browse information must first be enabled](../VS_visualcpp/Building-Browse-Information-Files--Overview.md).  
...
```  
 ...
 For more information, see the [Enable Minimal Rebuild](../VS_visualcpp/-Gm--Enable-Minimal-Rebuild-.md) (/Gm) compiler option.  
