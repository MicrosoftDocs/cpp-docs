...
### Parameters  
 ...
 `pObject`  
 [in] A pointer to the containing object that declares the message map. This object's class must derive from [CMessageMap](../VS_visualcpp/CMessageMap-Class.md).  
...
### Remarks  
 If you want to create a new window through [Create](../Topic/CContainedWindowT::Create.md), you must pass the name of an existing window class for the `lpszClassName` parameter. For an example, see the [CContainedWindow](../VS_visualcpp/CContainedWindowT-Class.md) overview.  
...
### Remarks  
 ...
 `m_dwMsgMapID` is first initialized by the constructor and can be changed by calling [SwitchMessageMap](../Topic/CContainedWindowT::SwitchMessageMap.md). For an example, see the [CContainedWindowT Overview](../VS_visualcpp/CContainedWindowT-Class.md).  
...
### Remarks  
 ...
 `m_lpszClassName` is initialized by the constructor. For an example, see the [CContainedWindowT](../VS_visualcpp/CContainedWindowT-Class.md) overview.  
...
### Remarks  
 This container, whose class must derive from [CMessageMap](../VS_visualcpp/CMessageMap-Class.md), declares the message map used by the contained window.  
  
 `m_pObject` is initialized by the constructor. For an example, see the [CContainedWindowT](../VS_visualcpp/CContainedWindowT-Class.md) overview.  
