...
> [!NOTE]
>  If you are working with the Data Access Objects (DAO) classes rather than the OLE DB Consumer Template classes, use class [CDaoRecordView](../VS_visualcpp/CDaoRecordView-Class.md) instead. For more information, see the article [Overview: Database Programming](../VS_visualcpp/Data-Access-Programming--MFC-ATL-.md).  
 ...
 For more information about rowset classes, see the [Using OLE DB Consumer Templates](../VS_visualcpp/OLE-DB-Consumer-Templates--C---.md) article.  
