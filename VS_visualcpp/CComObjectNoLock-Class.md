...
## Remarks  
 `CComObjectNoLock` is similar to [CComObject](../VS_visualcpp/CComObject-Class.md) in that it implements [IUnknown](http://msdn.microsoft.com/library/windows/desktop/ms680509) for a nonaggregated object; however, `CComObjectNoLock` does not increment the module lock count in the constructor.  
...
##  <a name="ccomobjectnolock__ccomobjectnolock"></a>  CComObjectNoLock::CComObjectNoLock  
 The constructor. Unlike [CComObject](../VS_visualcpp/CComObject-Class.md), does not increment the module lock count.  
