...
Forces writes to the program database (PDB) file—created by [/Zi](../VS_visualcpp/-Z7---Zi---ZI--Debug-Information-Format-.md) or [/ZI](../VS_visualcpp/-Z7---Zi---ZI--Debug-Information-Format-.md)—to be serialized through MSPDBSRV.EXE.  
...
## Remarks  
 ...
 The [/MP](../VS_visualcpp/-MP--Build-with-Multiple-Processes-.md) option enables **/FS** by default.  
