...
---
# &lt;see&gt; (Visual C++)
The <see\> tag lets you specify a link from within text. Use [<seealso\>](../VS_visualcpp/-seealso---Visual-C---.md) to indicate text that you might want to appear in a See Also section.  
...
## Remarks  
 ...
 See [<summary\>](../VS_visualcpp/-summary---Visual-C---.md) for an example of using <see\>.  
