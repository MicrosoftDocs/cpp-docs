...
```  
 ...
 Because increment and decrement operators have side effects, using expressions with increment or decrement operators in a [preprocessor macro](../VS_visualcpp/Macros--C-C---.md) can have undesirable results. Consider this example:  
