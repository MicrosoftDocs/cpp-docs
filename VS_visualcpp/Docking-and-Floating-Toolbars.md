...
-   [Setting wrap positions for a fixed-style toolbar](#_core_setting_wrap_positions_for_a_fixed.2d.style_toolbar)  
 ...
 See the MFC General sample [DOCKTOOL](../VS_visualcpp/Visual-C---Samples.md) for examples.  
...
##  <a name="_core_setting_wrap_positions_for_a_fixed.2d.style_toolbar"></a> Setting Wrap Positions for a Fixed-Style Toolbar  
 ...
 The MFC General sample [DOCKTOOL](../VS_visualcpp/Visual-C---Samples.md) shows how to use member functions of classes [CControlBar](../VS_visualcpp/CControlBar-Class.md) and [CToolBar](../VS_visualcpp/CToolBar-Class.md) to manage dynamic layout of a toolbar. See the file EDITBAR.CPP in DOCKTOOL.  
