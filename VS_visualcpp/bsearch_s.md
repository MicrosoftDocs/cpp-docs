...
---
# bsearch_s
Performs a binary search of a sorted array. This is version of [bsearch](../VS_visualcpp/bsearch.md) with security enhancements as described in [Security Features in the CRT](../VS_visualcpp/Security-Features-in-the-CRT.md).  
...
## Example  
 This program sorts a string array with [qsort_s](../VS_visualcpp/qsort_s.md), and then uses bsearch_s to find the word "cat".  
...
## .NET Framework Equivalent  
 <xref:System.Collections.ArrayList.BinarySearch?qualifyHint=False>  
