...
## Remarks  
 ...
 For more information about enabling tool tips, see [Tool Tips in Windows not Derived from CFrameWnd](../VS_visualcpp/Tool-Tips-in-Windows-Not-Derived-from-CFrameWnd.md).  
  
 For more information on using `CToolTipCtrl`, see [Controls](../VS_visualcpp/Controls--MFC-.md) and [Using CToolTipCtrl](../VS_visualcpp/Using-CToolTipCtrl.md).  
...
### Remarks  
 ...
 The `dwStyle` parameter can be any combination of [Window Styles](../VS_visualcpp/Window-Styles.md). In addition, a tool tip control has two class-specific styles: **TTS_ALWAYSTIP** and **TTS_NOPREFIX**.  
...
### Example  
 [!CODE [NVC_MFCControlLadenDialog#74](../CodeSnippet/VS_Snippets_Cpp/NVC_MFCControlLadenDialog#74)]  
