...
## Remarks  
 Transmits any pending changes made to the current row since that row was last fetched or updated (using **Update** or [UpdateAll](../VS_visualcpp/CRowset--UpdateAll.md)). You typically call [SetData](../VS_visualcpp/CRowset--SetData.md) to set data values in columns in a row, and then call **Update** to transmit those changes.  
