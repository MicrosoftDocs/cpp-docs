...
## Remarks  
 ...
 Use the [m_fr](#cfindreplacedialog__m_fr) structure to initialize the dialog box before calling **Create**. The `m_fr` structure is of type                 [FINDREPLACE](http://msdn.microsoft.com/library/windows/desktop/ms646835). For more information on this structure, see the Windows SDK.  
 ...
 For more information on using `CFindReplaceDialog`, see [Common Dialog Classes](../VS_visualcpp/Common-Dialog-Classes.md).  
...
### Remarks  
 ...
 For more information on the construction of `CFindReplaceDialog` objects, see the [CFindReplaceDialog](../VS_visualcpp/CFindReplaceDialog-Class.md) overview. Use the [CFindReplaceDialog::Create](#cfindreplacedialog__create) member function to display the dialog box.  
