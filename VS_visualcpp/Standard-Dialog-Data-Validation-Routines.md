...
### Remarks  
 For more information about DDV, see                         [Dialog Data Exchange and Validation](../VS_visualcpp/Dialog-Data-Exchange-and-Validation.md).  
...
##  <a name="ddv_minmaxdatetime"></a>  DDV_MinMaxDateTime  
 Call                 `DDV_MinMaxDateTime` to verify that the time/date value in the date and time picker control (                [CDateTimeCtrl](../VS_visualcpp/CDateTimeCtrl-Class.md)) associated with                 *refValue* falls between                 `refMinRange` and                 `refMaxRange`.  
 ...
 *refValue*  
 A reference to a                                 [CTime](../VS_visualcpp/CTime-Class.md) or                                 [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) object associated with a member variable of the dialog box, form view, or control view object. This object contains the data to be validated.  
...
##  <a name="ddv_minmaxmonth"></a>  DDV_MinMaxMonth  
 Call                 `DDV_MinMaxMonth` to verify that the time/date value in the month calendar control (                [CMonthCalCtrl](../VS_visualcpp/CMonthCalCtrl-Class.md)) associated with                 *refValue* falls between                 `refMinRange` and                 `refMaxRange`.  
...
### Remarks  
 For more information about DDV, see                         [Dialog Data Exchange and Validation](../VS_visualcpp/Dialog-Data-Exchange-and-Validation.md). For information about slider controls, see                         [Using CSliderCtrl](../VS_visualcpp/Using-CSliderCtrl.md).  
