...
```  
 ...
 ![Memory layout of a date object](../VS_visualcpp/media/vc38UQ1.png "vc38UQ1")  
...
```  
 ...
 ![Layout of Date object with zero&#45;length bit field](../VS_visualcpp/media/vc38UQ2.png "vc38UQ2")  
Layout of Date Object with Zero-Length Bit Field  
  
 The underlying type of a bit field must be an integral type, as described in [Fundamental Types](../VS_visualcpp/Fundamental-Types---C---.md).  
