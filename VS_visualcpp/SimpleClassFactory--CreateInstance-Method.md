...
## Remarks  
 If __WRL_STRICT\_\_ is defined, an assert error is emitted if the base class specified in the class template parameter isn't derived from [RuntimeClass](../VS_visualcpp/RuntimeClass-Class.md), or isn't configured with the ClassicCom or WinRtClassicComMix [RuntimeClassType](../VS_visualcpp/RuntimeClassType-Enumeration.md) enumeration value.  
