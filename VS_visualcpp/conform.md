...
**C++ Specific**  
 ...
 Specifies the run-time behavior of the [/Zc:forScope](../VS_visualcpp/-Zc-forScope--Force-Conformance-in-for-Loop-Scope-.md) compiler option.  
 ...
 **on, off**(optional)  
 Setting *name* to **on** enables the [/Zc:forScope](../VS_visualcpp/-Zc-forScope--Force-Conformance-in-for-Loop-Scope-.md) compiler option. The default is **off**.  
