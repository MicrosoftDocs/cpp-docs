 ...
 **Control Bar Layout Algorithm**  
 ...
 MFC private Windows messages, including **WM_SIZEPARENT**, are documented in [Technical Note 24](../VS_visualcpp/TN024--MFC-Defined-Messages-and-Resources.md).  
...
-   **SetText**: To change the text. Be careful if you use this because the pane will not automatically resize.  
 ...
 Refer to class [CStatusBar](../VS_visualcpp/CStatusBar-Class.md) in the *Class Library Reference* for details about `CStatusBar` creation and customization APIs. Most customization of status bars should be done before the status bar is initially made visible.  
...
|RGB(255, 255, 255)|COLOR_BTNHIGHLIGHT|  
 ...
 Refer to class [CToolBar](../VS_visualcpp/CToolBar-Class.md) the *Class Library Reference* for details about the `CToolBar` creation and customization APIs. Most customization of toolbars should be done before the toolbar is initially made visible.  
