...
#### Parameters  
 `IntType`  
 The integer result type, defaults to `int`. For possible types, see [<random\>](../VS_visualcpp/-random-.md).  
  
## Remarks  
 This sampling distribution has uniform-width intervals with uniform probability in each interval. For information about other sampling distributions, see [piecewise_linear_distribution Class](../VS_visualcpp/piecewise_linear_distribution-Class.md) and [piecewise_constant_distribution Class](../VS_visualcpp/piecewise_constant_distribution-Class.md).  
...
|`discrete_distribution::operator()`|[discrete_distribution::param_type](#discrete_distribution__param_type)|  
 ...
 For more information about distribution classes and their members, see [<random\>](../VS_visualcpp/-random-.md).  
...
### Parameters  
 ...
 `weightlist`  
 The [initializer_list](../VS_visualcpp/Initializers.md) from which to construct the distribution.  
...
### Parameters  
 See parent topic [discrete_distribution Class](../VS_visualcpp/discrete_distribution-Class.md).  
  
### Remarks  
 This parameter package can be passed to [operator()](../Topic/discrete_distribution::operator\(\).md) to generate the return value.  
