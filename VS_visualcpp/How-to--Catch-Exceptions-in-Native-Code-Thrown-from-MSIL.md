...
In native code, you can catch native C++ exception from MSIL.  You can catch CLR exceptions with `__try` and `__except`.  
 ...
 For more information, see [Structured Exception Handling (C/C++)](../VS_visualcpp/Structured-Exception-Handling--C-C---.md) and [C++ Exception Handling](../VS_visualcpp/C---Exception-Handling.md).  
