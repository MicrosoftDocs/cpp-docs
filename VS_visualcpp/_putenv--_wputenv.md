...
---
# _putenv, _wputenv
Creates, modifies, or removes environment variables. More secure versions of these functions are available; see [_putenv_s, _wputenv_s](../VS_visualcpp/_putenv_s--_wputenv_s.md).  
...
## Example  
 For a sample of how to use `_putenv`, see [getenv, _wgetenv](../VS_visualcpp/getenv--_wgetenv.md).  
