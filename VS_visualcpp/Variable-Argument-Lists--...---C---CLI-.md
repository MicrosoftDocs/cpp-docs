...
> [!NOTE]
>  This topic pertains to C++/CLI. For information about using the `...` in ISO Standard C++, see [Ellipses and Variadic Templates](../VS_visualcpp/Ellipses-and-Variadic-Templates.md) and [Ellipses and Default Arguments](../Topic/Ellipses%20and%20Default%20Arguments.md).  
