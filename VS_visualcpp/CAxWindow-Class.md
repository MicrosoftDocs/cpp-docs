...
### Example  
 See [Hosting ActiveX Controls Using ATL AXHost](../VS_visualcpp/Hosting-ActiveX-Controls-Using-ATL-AXHost.md) for a sample that uses `CreateControl`.  
...
### Example  
 See [Hosting ActiveX Controls Using ATL AXHost](../VS_visualcpp/Hosting-ActiveX-Controls-Using-ATL-AXHost.md) for a sample that uses `CreateControlEx`.  
...
##  <a name="caxwindow__setexternaluihandler"></a>  CAxWindow::SetExternalUIHandler  
 Sets the external [IDocHostUIHandlerDispatch](../VS_visualcpp/IDocHostUIHandlerDispatch-Interface.md) interface for the `CAxWindow` object.  
...
## See Also  
 [ATLCON Sample](../VS_visualcpp/Visual-C---Samples.md)   
