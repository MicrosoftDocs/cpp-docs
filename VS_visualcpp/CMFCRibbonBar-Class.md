...
|[CMFCRibbonBar::CreateEx](#cmfcribbonbar__createex)|Creates a control bar and attaches it to the [CPane](../VS_visualcpp/CPane-Class.md) object. (Overrides [CPane::CreateEx](../VS_visualcpp/CPane-Class.md#cpane__createex).)|  
...
|[CMFCRibbonBar::GetCaptionHeight](#cmfcribbonbar__getcaptionheight)|Returns the caption height. (Overrides [CBasePane::GetCaptionHeight](../VS_visualcpp/CBasePane-Class.md#cbasepane__getcaptionheight).)|  
...
|[CMFCRibbonBar::OnSetAccData](#cmfcribbonbar__onsetaccdata)|(Overrides [CBasePane::OnSetAccData](../VS_visualcpp/CBasePane-Class.md#cbasepane__onsetaccdata).)|  
...
|[CMFCRibbonBar::RecalcLayout](#cmfcribbonbar__recalclayout)|(Overrides [CPane::RecalcLayout](../VS_visualcpp/CPane-Class.md#cpane__recalclayout).)|  
...
## Remarks  
 ...
 You can use the `CMFCRibbonStatusBar` class to implement a status bar similar to the one used in Office 2007. A ribbon category contains (and displays) a group of [ribbon panels](../VS_visualcpp/CMFCRibbonPanel-Class.md). Each ribbon panel contains one or more ribbon elements, which are derived from [CMFCRibbonBaseElement](../VS_visualcpp/CMFCRibbonBaseElement-Class.md).  
  
 For information about how to add a ribbon bar to your existing MFC application, see [Walkthrough: Updating the MFC Scribble Application](../VS_visualcpp/Walkthrough--Updating-the-MFC-Scribble-Application--Part-1-.md).  
...
## Inheritance Hierarchy  
 ...
 [CMFCRibbonBar](../VS_visualcpp/CMFCRibbonBar-Class.md)  
...
### Parameters  
 ...
 [in] `pRTI`  
 Pointer to a [CMFCRibbonCategory Class](../VS_visualcpp/CMFCRibbonCategory-Class.md) run-time class to dynamically create a ribbon category at run-time.  
...
##  <a name="cmfcribbonbar__cmfcribbonbar"></a>  CMFCRibbonBar::CMFCRibbonBar  
 Constructs and initializes a [CMFCRibbonBar](../VS_visualcpp/CMFCRibbonBar-Class.md) object.  
...
## See Also  
 ...
 [Walkthrough: Updating the MFC Scribble Application](../VS_visualcpp/Walkthrough--Updating-the-MFC-Scribble-Application--Part-1-.md)