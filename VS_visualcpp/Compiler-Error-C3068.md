...
'function' : a 'naked' function cannot contain objects that would require unwinding if a C++ exception occurred  
 ...
 The compiler was unable to perform stack unwinding on a [naked](../VS_visualcpp/naked--C---.md) function that threw an exception because a temporary object was created in the function and C++ exception handling ([/EHsc](../VS_visualcpp/-EH--Exception-Handling-Model-.md)) was specified.  
