...
## Remarks  
 ...
 When used in a project that does not also use ATL, specifying the `uuid` attribute is the same as specifying the [uuid](../VS_visualcpp/uuid--C---.md) __declspec modifier. To retrieve the `uuid` of a class, you can use [__uuidof](../VS_visualcpp/__uuidof-Operator.md)  
  
## Example  
 See the [bindable](../VS_visualcpp/bindable.md) example for a sample use of `uuid`.  
