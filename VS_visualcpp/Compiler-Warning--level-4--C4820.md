...
'bytes' bytes padding added after construct 'member_name'  
 ...
 The type and order of elements caused the compiler to add padding to the end of a struct. See [align](../VS_visualcpp/align--C---.md) for more information on padding in a struct.  
