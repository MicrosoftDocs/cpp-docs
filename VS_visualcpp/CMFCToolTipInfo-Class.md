...
|[CMFCToolTipInfo::m_bVislManagerTheme](#cmfctooltipinfo__m_bvislmanagertheme)|A Boolean variable that indicates whether the appearance of the tooltip should be controlled by a visual manager (see [CMFCVisualManager Class](../VS_visualcpp/CMFCVisualManager-Class.md)).|  
...
## Remarks  
 Use [CMFCToolTipCtrl Class](../VS_visualcpp/CMFCToolTipCtrl-Class.md), `CMFCToolTipInfo`, and [CTooltipManager Class](../VS_visualcpp/CTooltipManager-Class.md) together to implement customized tooltips in your application. For an example of how to use these tooltip classes, see the [CMFCToolTipCtrl Class](../VS_visualcpp/CMFCToolTipCtrl-Class.md) topic.  
...
## Inheritance Hierarchy  
 [CMFCToolTipInfo](../VS_visualcpp/CMFCToolTipInfo-Class.md)  
...
### Remarks  
 Set this member to `TRUE` to display the description, or `FALSE` to hide the description. You can specify the description on a tooltip by calling [CMFCToolTipCtrl::SetDescription](../VS_visualcpp/CMFCToolTipCtrl-Class.md#cmfctooltipctrl__setdescription)  
...
### Remarks  
 If `m_bVislManagerTheme` is `TRUE`, every tooltip requests a new [CMFCToolTipInfo](../VS_visualcpp/CMFCToolTipInfo-Class.md) from the visual manager of the application before they appear on the screen, and uses the values in that object to determine their appearance. The other members of your [CMFCToolTipInfo](../VS_visualcpp/CMFCToolTipInfo-Class.md) are ignored.  
