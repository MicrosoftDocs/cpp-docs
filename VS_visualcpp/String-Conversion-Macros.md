...
##  <a name="atl_and_mfc_string_conversion_macros"></a>  ATL and MFC String Conversion Macros  
 The string conversion macros discussed here are valid for both ATL and MFC. For more information on MFC string conversion, see                 [TN059: Using MFC MBCS/Unicode Conversion Macros](../VS_visualcpp/TN059--Using-MFC-MBCS-Unicode-Conversion-Macros.md) and                 [MFC Macros and Globals](../VS_visualcpp/MFC-Macros-and-Globals.md).  
