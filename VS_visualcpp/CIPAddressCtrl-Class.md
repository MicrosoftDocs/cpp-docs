...
### Parameters  
 ...
 `rect`  
 A reference to the IP Address Control's size and position. It can be either a [CRect](../VS_visualcpp/CRect-Class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure.  
