...
-   Read the topics about the [OLE DB Consumer Templates](../VS_visualcpp/OLE-DB-Consumer-Templates--C---.md) or [OLE DB Provider Templates](../VS_visualcpp/OLE-DB-Provider-Templates--C---.md).  
  
-   Create an [OLE DB consumer](../VS_visualcpp/Creating-an-OLE-DB-Consumer.md) or [OLE DB provider](../VS_visualcpp/Creating-an-OLE-DB-Provider.md).  
  
-   See the list of [OLE DB consumer classes](../VS_visualcpp/OLE-DB-Consumer-Templates-Reference.md) or [OLE DB provider classes](../VS_visualcpp/OLE-DB-Provider-Templates-Reference.md).  
...
## OLE DB Attributes  
 The [OLE DB consumer attributes](../VS_visualcpp/OLE-DB-Consumer-Attributes.md) provide a convenient way to create OLE DB consumers. The OLE DB attributes inject code based on the [OLE DB consumer templates](../VS_visualcpp/OLE-DB-Consumer-Templates-Reference.md) to create working OLE DB consumers and providers. If you need to specify functionality not supported by the attributes, you can use the OLE DB Templates in conjunction with attributes in your code.  
  
## MFC OLE DB Classes  
 The MFC library has one class, [COleDBRecordView](../VS_visualcpp/COleDBRecordView-Class.md), that displays database records in controls. The view is a form view directly connected to a `CRowset` object and displays the fields of the `CRowset` object in the dialog template's controls. It also supplies a default implementation for moving to the first, next, previous, or last record and an interface for updating the record currently on view. For more information, see `COleDBRecordView`.  
