...
-   [new (new slot in vtable)](../VS_visualcpp/new--new-slot-in-vtable----C---Component-Extensions-.md)  
  
 C4484 is always issued as an error. Use the [warning](../VS_visualcpp/warning.md) pragma to suppress C4484.  
