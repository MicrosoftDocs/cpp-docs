---
title: "Filling a Bounded Area of an Image with a Color (Image Editor for Icons)"
ms.custom: na
ms.date: 10/03/2016
ms.devlang: 
  - C++
...
2.  If necessary, choose drawing colors: In the [Colors palette](../VS_visualcpp/Colors-Window--Image-Editor-for-Icons-.md), click the left mouse button to select a foreground color or the right mouse button to select a background color.  
