...
> [!NOTE]
>  If you selected **Minimal control** on the [Options](../VS_visualcpp/Options--ATL-Control-Wizard.md) tab, no interfaces appear by default in the **Supported** list box.  
