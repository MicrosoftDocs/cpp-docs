...
This article shows how to use safe_cast in C++/CLI applications. For information about safe_cast in C++/CX, see [safe_cast](../VS_visualcpp/safe_cast--C---Component-Extensions-.md).  
