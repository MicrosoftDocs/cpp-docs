...
|Name|Description|  
|----------|-----------------|  
|[CCubicTransition::Create](#ccubictransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../VS_visualcpp/CBaseTransition-Class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CCubicTransition](../VS_visualcpp/CCubicTransition-Class.md)  
