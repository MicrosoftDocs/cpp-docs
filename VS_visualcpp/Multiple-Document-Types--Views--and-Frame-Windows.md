...
##  <a name="_core_multiple_document_types"></a> Multiple Document Types  
 ...
 To create extra document classes, see [Adding a Class](../VS_visualcpp/Adding-a-Class--Visual-C---.md). Choose [CDocument](../VS_visualcpp/CDocument-Class.md) as the Class Type to derive from and supply the requested document information. Then implement the new class's data.  
  
 To let the framework know about your extra document class, you must add a second call to [AddDocTemplate](../Topic/CWinApp::AddDocTemplate.md) in your application class's [InitInstance](../Topic/CWinApp::InitInstance.md) override. For more information, see [Document Templates](../VS_visualcpp/Document-Templates-and-the-Document-View-Creation-Process.md).  
  
##  <a name="_core_multiple_views"></a> Multiple Views  
 Many documents require only a single view, but it is possible to support more than one view of a single document. To help you implement multiple views, a document object keeps a list of its views, provides member functions for adding and removing views, and supplies the [UpdateAllViews](../Topic/CDocument::UpdateAllViews.md) member function for letting multiple views know when the document's data has changed.  
...
-   View objects of different classes in a single frame window.  
 ...
 ![Multiple&#45;view user interfaces](../VS_visualcpp/media/vc37A71.gif "vc37A71")  
Multiple-View User Interfaces  
  
 The framework provides these models by implementing the New Window command and by providing class [CSplitterWnd](../VS_visualcpp/CSplitterWnd-Class.md), as discussed in [Splitter Windows](#_core_splitter_windows). You can implement other models using these as your starting point. For sample programs that illustrate different configurations of views, frame windows, and splitters, see [MFC Samples](../VS_visualcpp/Visual-C---Samples.md).  
  
 For more information about `UpdateAllViews`, see class [CView](../VS_visualcpp/CView-Class.md) in the *MFC Reference* and the [Scribble sample](../VS_visualcpp/Visual-C---Samples.md).  
...
##  <a name="_core_splitter_windows"></a> Splitter Windows  
 ...
 For more information, see class [CSplitterWnd](../VS_visualcpp/CSplitterWnd-Class.md) in the *MFC Reference* and [MFC Samples](../VS_visualcpp/Visual-C---Samples.md).  
