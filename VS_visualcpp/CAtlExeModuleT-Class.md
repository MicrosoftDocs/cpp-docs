...
### Remarks  
 See the [CAtlExeModuleT Overview](../VS_visualcpp/CAtlExeModuleT-Class.md) for details.  
...
### Remarks  
 Change this value after calling [CAtlExeModuleT::InitializeCom](../Topic/CAtlExeModuleT::InitializeCom.md) to define the number of milliseconds used as the time-out value for shutting down the server. The default value is 5000 milliseconds. See the [CAtlExeModuleT Overview](../VS_visualcpp/CAtlExeModuleT-Class.md) for more details.  
...
## See Also  
 [ATLDuck Sample](../VS_visualcpp/Visual-C---Samples.md)   
