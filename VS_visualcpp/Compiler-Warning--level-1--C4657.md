...
expression involves a data type that is new since the last build  
 ...
 This warning will always be followed by [Fatal Error C1092](../VS_visualcpp/Fatal-Error-C1092.md). For further information, see the [Supported Code Changes](../Topic/Supported%20Code%20Changes%20\(C++\).md).  
