...
The *handle declarator* (`^`, pronounced "hat"), modifies the type [specifier](../VS_visualcpp/Overview-of-Declarators.md) to mean that the declared object should be automatically deleted when the system determines that the object is no longer accessible.  
...
## Windows Runtime  
 ...
 For information on how to instantiate an object, see [ref new](../VS_visualcpp/ref-new--gcnew---C---Component-Extensions-.md).  
...
## See Also  
 ...
 [Tracking Reference Operator](../VS_visualcpp/Tracking-Reference-Operator--C---Component-Extensions-.md)