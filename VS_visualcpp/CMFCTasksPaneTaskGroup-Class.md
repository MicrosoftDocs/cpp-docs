...
## Remarks  
 ...
 ![Collapsed task group](../VS_visualcpp/media/NextTaskGrpCollapse.png "NextTaskGrpCollapse")  
  
 The following illustration shows a task group without a caption:  
  
 ![Task group without a caption](../VS_visualcpp/media/NextTaskGrpNoCapt.png "NextTaskGrpNoCapt")  
 ...
 ![Special task group](../VS_visualcpp/media/NextTaskGrpSpecial.png "NextTaskGrpSpecial")  
  
## Inheritance Hierarchy  
 [CObject](../VS_visualcpp/CObject-Class.md)  
  
 [CMFCTasksPaneTaskGroup](../VS_visualcpp/CMFCTasksPaneTaskGroup-Class.md)  
...
### Remarks  
 Only one group can be aligned to the bottom of the task pane control. This task group must be added last. For more information, see [CMFCTasksPane::AddGroup](../VS_visualcpp/CMFCTasksPane-Class.md#cmfctaskspane__addgroup).  
...
### Remarks  
 You can enable or disable the ability to collapse groups on the task pane by calling [CMFCTasksPane::EnableGroupCollapse](../VS_visualcpp/CMFCTasksPane-Class.md#cmfctaskspane__enablegroupcollapse).  
...
### Remarks  
 To fill this list, call [CMFCTasksPane::AddTask](../VS_visualcpp/CMFCTasksPane-Class.md#cmfctaskspane__addtask).  
