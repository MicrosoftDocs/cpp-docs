...
---
# CStringArray Class
Supports arrays of [CString](../VS_visualcpp/Using-CString.md) objects.  
...
## Members  
 The member functions of `CStringArray` are similar to the member functions of class [CObArray](../VS_visualcpp/CObArray-Class.md). Because of this similarity, you can use the `CObArray` reference documentation for member function specifics. Wherever you see a `CObject` pointer as a return value, substitute a [CString](../VS_visualcpp/Using-CString.md) object (not a [CString](../VS_visualcpp/Using-CString.md) pointer). Wherever you see a `CObject` pointer as a function parameter, substitute a `LPCTSTR`.  
...
>  Before using an array, use `SetSize` to establish its size and allocate memory for it. If you do not use `SetSize`, adding elements to your array causes it to be frequently reallocated and copied. Frequent reallocation and copying are inefficient and can fragment memory.  
 ...
 For more information on using `CStringArray`, see the article [Collections](../VS_visualcpp/Collections.md).  
