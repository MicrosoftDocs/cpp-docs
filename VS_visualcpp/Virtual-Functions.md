...
```  
 ...
 Virtual functions in a base class must be defined unless they are declared using the *pure-specifier*. (For more information about pure virtual functions, see [Abstract Classes](../VS_visualcpp/Abstract-Classes--C---.md).)  
...
## See Also  
 [Access to Virtual Functions](../Topic/Access%20to%20Virtual%20Functions.md)