...
|Name|Description|  
|----------|-----------------|  
|[DeferrableEventArgs::GetDeferral Method](../VS_visualcpp/DeferrableEventArgs--GetDeferral-Method.md)|Gets a reference to the [Deferral](http://go.microsoft.com/fwlink/?LinkId=526520) object which represents a deferred event.|  
|[DeferrableEventArgs::InvokeAllFinished Method](../VS_visualcpp/DeferrableEventArgs--InvokeAllFinished-Method.md)|Called to indicate that all processing to handle a deferred event is complete.|  
