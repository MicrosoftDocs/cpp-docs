...
---
# _fread_nolock_s2
Reads data from a stream, without locking other threads. This version of [fread_nolock](../VS_visualcpp/_fread_nolock.md) has security enhancements, as described in [Security Features in the CRT](../VS_visualcpp/Security-Features-in-the-CRT.md).  
...
## Return Value  
 See [fread_s](../VS_visualcpp/fread_s.md).  
