 ...
 *delegate*  
 The [delegate](../VS_visualcpp/delegate---C---Component-Extensions-.md), whose signature the event handler must match.  
 ...
 *event block*  
 ...
 `event` is a context-sensitive keyword; see [Context-Sensitive Keywords](../VS_visualcpp/Context-Sensitive-Keywords---C---Component-Extensions-.md) for more information.  
...
-   [Events in an Interface](../VS_visualcpp/How-to--Use-Events-in-C---CLI.md)  
  
-   [Overriding the Default Access of add, remove, and raise Methods](../Topic/How%20to:%20Override%20Default%20Access%20of%20add,%20remove,%20and%20raise%20Methods.md)  
  
-   [Multiple Handlers to an Event](../Topic/How%20to:%20Add%20Multiple%20Handlers%20to%20Events.md)  
  
-   [Managed Virtual Events](../Topic/How%20to:%20Implement%20Managed%20Virtual%20Events.md)  
  
-   [Event Accessor Methods](../Topic/How%20to:%20Define%20Event%20Accessor%20Methods.md)  
  
-   [Static Events](../Topic/How%20to:%20Define%20and%20Use%20Static%20Events.md)  
  
-   [Raising an Event Defined in a Different Assembly](../Topic/How%20to:%20Raise%20Events%20Defined%20in%20a%20Different%20Assembly.md)  
  
-   [Abstract Events](../Topic/How%20to:%20Implement%20Abstract%20Events.md)  
