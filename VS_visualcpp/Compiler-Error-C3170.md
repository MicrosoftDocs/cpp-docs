...
cannot have different module identifiers in a project  
 ...
 [module](../VS_visualcpp/module--C---.md) attributes with different names were found in two of the files in a compilation. Only one unique `module` attribute can be specified per compilation.  
