...
'method' : the raise method has a different storage class from that of the event, 'event'  
 ...
 See [warning](../VS_visualcpp/warning.md) pragma for information on how to turn a warning off.  
  
## Example  
 C4803 can be generated using **/clr**. See [event](../VS_visualcpp/event---C---Component-Extensions-.md) for more information on using events..  
