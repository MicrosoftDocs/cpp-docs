...
## WM_COMMANDHELP, WM_HELPHITTEST, WM_EXITHELPMODE  
 These messages are used in the implementation of context-sensitive Help. Please refer to [Technical Note 28](../VS_visualcpp/TN028--Context-Sensitive-Help-Support.md) for more information.  
