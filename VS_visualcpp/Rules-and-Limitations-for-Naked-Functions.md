...
-   The `naked` keyword is ignored when compiling with [/clr](../VS_visualcpp/-clr--Common-Language-Runtime-Compilation-.md).  
  
-   For [__fastcall](../VS_visualcpp/__fastcall.md) naked functions, whenever there is a reference in C/C++ code to one of the register arguments, the prolog code should store the values of that register into the stack location for that variable. For example:  
