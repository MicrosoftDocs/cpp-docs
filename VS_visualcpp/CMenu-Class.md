...
-   **MF_CHECKED** and **MF_UNCHECKED**  
 ...
 Whenever a menu that resides in a window is changed (whether or not the window is displayed), the application should call [CWnd::DrawMenuBar](../VS_visualcpp/CWnd-Class.md#cwnd__drawmenubar).  
...
### Remarks  
 ...
 If the menu you want to manipulate is already associated with a window, you can use the [CWnd::GetMenu](../VS_visualcpp/CWnd-Class.md#cwnd__getmenu) function to get a handle to the menu.  
...
### Remarks  
 ...
 Whenever a menu that resides in a window is changed (whether or not the window is displayed), the application must call [CWnd::DrawMenuBar](../VS_visualcpp/CWnd-Class.md#cwnd__drawmenubar).  
  
### Example  
  See the example for [CWnd::GetMenu](../VS_visualcpp/CWnd-Class.md#cwnd__getmenu).  
...
### Parameters  
 `lpDrawItemStruct`  
 A pointer to a [DRAWITEMSTRUCT](../VS_visualcpp/DRAWITEMSTRUCT-Structure.md) structure that contains information about the type of drawing required.  
...
### Remarks  
 ...
 See [CWnd::OnDrawItem](../VS_visualcpp/CWnd-Class.md#cwnd__ondrawitem) for a description of the `DRAWITEMSTRUCT` structure.  
  
### Example  
 The following code is from the MFC [CTRLTEST](../VS_visualcpp/Visual-C---Samples.md) sample:  
...
### Remarks  
 ...
 See [CWnd::OnMeasureItem](../VS_visualcpp/CWnd-Class.md#cwnd__onmeasureitem) for a description of the `MEASUREITEMSTRUCT` structure.  
...
## See Also  
 [MFC Sample CTRLTEST](../VS_visualcpp/Visual-C---Samples.md)   
 [MFC Sample DYNAMENU](../VS_visualcpp/Visual-C---Samples.md)   
