...
## Remarks  
 `CAtlDllModuleT` represents the module for a dynamic-link library (DLL) and provides functions used by all DLL projects. This specialization of [CAtlModuleT](../VS_visualcpp/CAtlModuleT-Class.md) class includes support for registration.  
