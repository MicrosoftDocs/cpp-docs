...
```  
istream_iterator( ); istream_iterator(    istream_type&  _Istr );  
...
```  
istream_iterator<Type, CharType, Traits, Distance>& operator++( ); istream_iterator<Type, CharType, Traits, Distance> operator++( int );  
