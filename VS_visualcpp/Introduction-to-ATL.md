...
-   How a [template library](../VS_visualcpp/Using-a-Template-Library.md) differs from a standard C++ library.  
  
-   What you [can and cannot do with ATL](../VS_visualcpp/Scope-of-ATL.md).  
