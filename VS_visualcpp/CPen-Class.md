...
## Remarks  
 For more information on using `CPen`, see [Graphic Objects](../VS_visualcpp/Graphic-Objects.md).  
...
### Parameters  
 `lpLogPen`  
 Points to the Windows [LOGPEN](../VS_visualcpp/LOGPEN-Structure.md) structure that contains information about the pen.  
