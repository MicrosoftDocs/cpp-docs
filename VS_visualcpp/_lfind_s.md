...
---
# _lfind_s
Performs a linear search for the specified key. A version of [_lfind](../VS_visualcpp/_lfind.md) with security enhancements as described in [Security Features in the CRT](../VS_visualcpp/Security-Features-in-the-CRT.md).  
...
## Return Value  
 ...
 If invalid parameters are passed to the function, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_visualcpp/Parameter-Validation.md). If execution is allowed to continue, `errno` is set to `EINVAL` and the function returns `NULL`.  
...
## .NET Framework Equivalent  
 <xref:System.Collections.ArrayList.Contains?qualifyHint=False>  
