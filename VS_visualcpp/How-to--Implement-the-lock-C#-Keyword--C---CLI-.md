...
This topic shows how to implement the C# `lock` keyword in Visual C++. For more information, see [lock Statement](../Topic/lock%20Statement%20\(C%23%20Reference\).md).  
 ...
 You can also use the `lock` class in the C++ Support Library. See [Synchronization (lock Class)](../VS_visualcpp/Synchronization--lock-Class-.md) for more information.  
