...
---
# CControlBar Class
The base class for the control-bar classes [CStatusBar](../VS_visualcpp/CStatusBar-Class.md), [CToolBar](../VS_visualcpp/CToolBar-Class.md), [CDialogBar](../VS_visualcpp/CDialogBar-Class.md), [CReBar](../VS_visualcpp/CReBar-Class.md), and [COleResizeBar](../VS_visualcpp/COleResizeBar-Class.md).  
...
|Name|Description|  
|----------|-----------------|  
|[CControlBar::CalcDynamicLayout](#ccontrolbar__calcdynamiclayout)|Returns the size of a dynamic control bar as a [CSize](../VS_visualcpp/CSize-Class.md) object.|  
|[CControlBar::CalcFixedLayout](#ccontrolbar__calcfixedlayout)|Returns the size of the control bar as a [CSize](../VS_visualcpp/CSize-Class.md) object.|  
...
-   [Technical Note 31: Control Bars](../VS_visualcpp/TN031--Control-Bars.md).  
...
### Return Value  
 The control bar size, in pixels, of a [CSize](../VS_visualcpp/CSize-Class.md) object.  
  
### Remarks  
 Override this member function to provide your own dynamic layout in classes you derive from `CControlBar`. MFC classes derived from `CControlBar`, such as [CToolbar](../VS_visualcpp/CToolBar-Class.md), override this member function and provide their own implementation.  
...
### Return Value  
 A `CRect` object that contains the current width (in pixels) of each side of the control bar object. For example, the value of the `left` member, of [CRect](../VS_visualcpp/CRect-Class.md) object, is the width of the left hand border.  
...
### Return Value  
 The number of non- `HWND` items on the `CControlBar` object. This function returns 0 for a [CDialogBar](../VS_visualcpp/CDialogBar-Class.md) object.  
  
### Remarks  
 The type of the item depends on the derived object: panes for [CStatusBar](../VS_visualcpp/CStatusBar-Class.md) objects, and buttons and separators for [CToolBar](../VS_visualcpp/CToolBar-Class.md) objects.  
...
### Return Value  
 ...
 If the control bar is not docked to a frame window (that is, if the control bar is floating), this function will return a pointer to its parent [CMiniFrameWnd](../VS_visualcpp/CMiniFrameWnd-Class.md).  
  
### Remarks  
 For more information about dockable control bars, see [CControlBar::EnableDocking](#ccontrolbar__enabledocking) and [CFrameWnd::DockControlBar](../VS_visualcpp/CFrameWnd-Class.md#cframewnd__dockcontrolbar).  
...
### Remarks  
 To change the state of a control bar from docked to floating, call [CFrameWnd::FloatControlBar](../VS_visualcpp/CFrameWnd-Class.md#cframewnd__floatcontrolbar).  
 ...
 *cyBottom*  
 ...
 `lpRect`  
 A pointer to a [CRect](../VS_visualcpp/CRect-Class.md) object that contains the current width (in pixels)of each border of the control bar object.  
