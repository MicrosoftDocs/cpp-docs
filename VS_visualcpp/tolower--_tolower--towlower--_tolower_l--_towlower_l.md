...
## Remarks  
 ...
 In order for `_tolower` to give the expected results, [__isascii](../VS_visualcpp/isascii--__isascii--iswascii.md) and [isupper](../VS_visualcpp/isupper--_isupper_l--iswupper--_iswupper_l.md) must both return nonzero.  
