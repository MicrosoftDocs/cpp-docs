...
## Remarks  
 ...
 For more information about differences in exception handling in managed and unmanaged applications, see [Differences in Exception Handling Behavior Under Managed Extensions for C++](../VS_visualcpp/Differences-in-Exception-Handling-Behavior-Under--CLR.md).  
...
```  
 ...
 When throwing or catching unmanaged exceptions, we recommend that you use the [/EHsc](../VS_visualcpp/-EH--Exception-Handling-Model-.md) compiler option instead of **/EHs** or **/EHa**.  
