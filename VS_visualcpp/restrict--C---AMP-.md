...
> [!NOTE]
>  For information about the `restrict` keyword that is part of the `__declspec` storage-class attributes, see [restrict](../VS_visualcpp/restrict.md).  
...
-   The following are not allowed:  
    ...
    -   Variables declared with the [volatile](../VS_visualcpp/volatile--C---.md) keyword.  
    ...
    -   Static variables. Use [tile_static Keyword](../VS_visualcpp/tile_static-Keyword.md) instead.  
