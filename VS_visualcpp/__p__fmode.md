...
## Remarks  
 ...
 File translation mode specifies either `binary` or `text` translation for [_open](../VS_visualcpp/_open--_wopen.md) and [_pipe](../VS_visualcpp/_pipe.md) I/O operations. For more information, see [_fmode](../VS_visualcpp/_fmode.md).  
