...
'declarator' : a GUID can only be associated with a class, interface or namespace  
 ...
 A user-defined structure other than [class](../VS_visualcpp/class--C---.md), [interface](../VS_visualcpp/__interface.md), or [namespace](../Topic/namespace%20Declaration.md) cannot have a GUID.  
