...
-   [CWorkerThread](../VS_visualcpp/CWorkerThread-Class.md)  
 ...
 If the thread will not be using CRT functions, use [Win32ThreadTraits](../VS_visualcpp/Win32ThreadTraits-Class.md) instead.  
...
### Remarks  
 ...
 This function calls [_beginthreadex](../VS_visualcpp/_beginthread--_beginthreadex.md) to create the thread.  
