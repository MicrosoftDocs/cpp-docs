...
|Name|Description|  
|----------|-----------------|  
|[CDiscreteTransition::Create](#cdiscretetransition__create)|Calls the transition library to create encapsulated transition COM object. (Overrides [CBaseTransition::Create](../VS_visualcpp/CBaseTransition-Class.md#cbasetransition__create).)|  
...
## Inheritance Hierarchy  
 ...
 [CDiscreteTransition](../VS_visualcpp/CDiscreteTransition-Class.md)  
