...
### Remarks  
 By default, `AddRef` calls **_Module::Lock**, where **_Module** is the global instance of [CComModule](../VS_visualcpp/CComModule-Class.md) or a class derived from it.  
...
### Remarks  
 If you have not derived your base class from [CComObjectRoot](../VS_visualcpp/CComObjectRoot-Class.md), you must supply your own `FinalConstruct` method. The destructor calls `FinalRelease`.  
...
### Remarks  
 By default,                         **Release** calls **_Module::Unlock**, where **_Module** is the global instance of [CComModule](../VS_visualcpp/CComModule-Class.md) or a class derived from it.  
