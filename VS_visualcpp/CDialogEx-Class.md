...
## Remarks  
 ...
 A `CDialogEx` object can be a parent of a [CMFCPopupMenu Class](../VS_visualcpp/CMFCPopupMenu-Class.md) object. The [CMFCPopupMenu Class](../VS_visualcpp/CMFCPopupMenu-Class.md) object calls the `CDialogEx::SetActiveMenu` method when the [CMFCPopupMenu Class](../VS_visualcpp/CMFCPopupMenu-Class.md) object opens. Afterward, the `CDialogEx` object handles any menu event until the [CMFCPopupMenu Class](../VS_visualcpp/CMFCPopupMenu-Class.md) object is closed.  
