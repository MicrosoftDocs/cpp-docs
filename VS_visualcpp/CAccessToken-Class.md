...
### Parameters  
 `rSid`  
 Reference to a [CSid Class](../VS_visualcpp/CSid-Class.md) object.  
...
bool CreatePrimaryToken(  
    ...
    = MAXIMUM_ALLOWED,  
      const CSecurityAttributes*  pTokenAttributes  
    = NULL  
   ) const throw(...);  
...
bool CreateRestrictedToken(  
      ...
      const CTokenPrivileges&  PrivilegesToDelete  
    = CTokenPrivileges( )  
   ) const throw(...);  
...
### Parameters  
 `pDacl`  
 Pointer to the [CDacl Class](../VS_visualcpp/CDacl-Class.md) object which will receive the **CAccessToken** object's default DACL.  
...
### Parameters  
 *pGroups*  
 Pointer to the [CTokenGroups Class](../VS_visualcpp/CTokenGroups-Class.md) object which will receive the group information.  
...
### Parameters  
 `pSid`  
 Pointer to a [CSid Class](../VS_visualcpp/CSid-Class.md) object.  
...
### Parameters  
 `pPrivileges`  
 Pointer to a [CTokenPrivileges Class](../VS_visualcpp/CTokenPrivileges-Class.md) object which will receive the privileges.  
...
### Remarks  
 ...
 The [CAutoRevertImpersonation class](../VS_visualcpp/CAutoRevertImpersonation-Class.md) can be used to automatically revert impersonated access tokens.  
...
### Remarks  
 The [CAutoRevertImpersonation Class](../VS_visualcpp/CAutoRevertImpersonation-Class.md) can be used to automatically revert impersonated access tokens created by setting the `bImpersonate` flag to *true*.  
...
### Remarks  
 The reversion of impersonation tokens can be performed automatically with the [CAutoRevertImpersonation Class](../VS_visualcpp/CAutoRevertImpersonation-Class.md).  
...
### Parameters  
 `rDacl`  
 The new default [CDacl Class](../VS_visualcpp/CDacl-Class.md) information.  
...
### Parameters  
 `rSid`  
 The [CSid Class](../VS_visualcpp/CSid-Class.md) object containing the owner information.  
...
### Parameters  
 `rSid`  
 The [CSid Class](../VS_visualcpp/CSid-Class.md) object containing the primary group information.  
