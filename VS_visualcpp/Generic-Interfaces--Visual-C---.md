...
The restrictions that apply to type parameters on classes are the same as those that apply to type parameters on interfaces (see [Generic Classes (C++/CLI)](../VS_visualcpp/Generic-Classes--C---CLI-.md)).  
 ...
 For more information on interfaces, see [interface class](../VS_visualcpp/interface-class---C---Component-Extensions-.md).  
 ...
 **class** or **typename**  
 ...
 Takes the form specified in [Constraints on Generic Type Parameters (C++/CLI)](../VS_visualcpp/Constraints-on-Generic-Type-Parameters--C---CLI-.md)  
