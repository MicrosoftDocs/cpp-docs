...
## Remarks  
 This method increments the reference count for the current row handle. Call [ReleaseRows](../VS_visualcpp/CRowset--ReleaseRows.md) to decrement the count. Rows returned by the move methods have a reference count of one.  
