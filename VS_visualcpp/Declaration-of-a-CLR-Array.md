...
```  
 ...
 is considerably simplified in the new syntax (note that because boxing is implicit in the new syntax, the `__box` operator has been eliminated – see [Value Types and Their Behaviors (C++/CLI)](../VS_visualcpp/Value-Types-and-Their-Behaviors--C---CLI-.md) for a discussion):  
