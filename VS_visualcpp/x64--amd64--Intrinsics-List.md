...
|[__incgsbyte](../VS_visualcpp/__incgsbyte--__incgsword--__incgsdword--__incgsqword.md)||intrin.h|void __incgsbyte(unsigned long)|  
...
|[_InterlockedCompareExchange128_np](../VS_visualcpp/_InterlockedCompareExchange128.md)||intrin.h|unsigned char _InterlockedCompareExchange128(\__int64 volatile *,\__int64,\__int64,\__int64\*)|  
...
|[_InterlockedExchangePointer_HLEAcquire](../VS_visualcpp/_InterlockedExchangePointer-Intrinsic-Functions.md)|HLE [2]|immintrin.h|void * _InterlockedExchangePointer_HLEAcquire(void \*volatile \*,void \*)|  
...
|[_mm_stream_sd](../VS_visualcpp/_mm_stream_sd.md)|SSE4a|intrin.h|void _mm_stream_sd(double*,\__m128d)|  
...
|[_mm_stream_si64x](../VS_visualcpp/_mm_stream_si64x.md)|SSE2|intrin.h|void _mm_stream_si64x(\__int64 *,\__int64)|  
|[_mm_stream_ss](../VS_visualcpp/_mm_stream_ss.md)|SSE4a|intrin.h|void _mm_stream_ss(float*,\__m128)|  
...
|[__movsb](../VS_visualcpp/__movsb.md)||intrin.h|VOID __movsb(IN PBYTE,IN BYTE const *,IN SIZE_T)|  
|[__movsd](../VS_visualcpp/__movsd.md)||intrin.h|VOID __movsd(IN PDWORD,IN DWORD const *,IN SIZE_T)|  
|[__movsq](../VS_visualcpp/__movsq.md)||intrin.h|VOID __movsq(IN PDWORD64,IN DWORD64 const *,IN SIZE_T)|  
|[__movsw](../VS_visualcpp/__movsw.md)||intrin.h|VOID __movsw(IN PWORD,IN WORD const *,IN SIZE_T)|  
|[_mul128](../VS_visualcpp/__mul128.md)||intrin.h|__int64 _mul128(\__int64 multiplier,\__int64 multiplicand,\__int64 *highproduct)|  
|[__mulh](../VS_visualcpp/__mulh.md)||intrin.h|__int64 \__mulh(\__int64,\__int64)|  
...
|[__nop](../VS_visualcpp/__nop.md)||intrin.h|void __nop(void)|  
|__nvreg_restore_fence||intrin.h|void __nvreg_restore_fence(void)|  
|__nvreg_save_fence||intrin.h|void __nvreg_save_fence(void)|  
|[__outbyte](../VS_visualcpp/__outbyte.md)||intrin.h|void __outbyte(unsigned short Port,unsigned char Data)|  
|[__outbytestring](../VS_visualcpp/__outbytestring.md)||intrin.h|void __outbytestring(unsigned short Port,unsigned char *Buffer,unsigned long Count)|  
|[__outdword](../VS_visualcpp/__outdword.md)||intrin.h|void __outdword(unsigned short Port,unsigned long Data)|  
|[__outdwordstring](../VS_visualcpp/__outdwordstring.md)||intrin.h|void __outdwordstring(unsigned short Port,unsigned long *Buffer,unsigned long Count)|  
|[__outword](../VS_visualcpp/__outword.md)||intrin.h|void __outword(unsigned short Port,unsigned short Data)|  
|[__outwordstring](../VS_visualcpp/__outwordstring.md)||intrin.h|void __outwordstring(unsigned short Port,unsigned short *Buffer,unsigned long Count)|  
...
|[__popcnt](../VS_visualcpp/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned int __popcnt(unsigned int)|  
|[__popcnt16](../VS_visualcpp/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned short __popcnt16(unsigned short)|  
|[__popcnt64](../VS_visualcpp/__popcnt16--__popcnt--__popcnt64.md)|POPCNT|intrin.h|unsigned __int64 \__popcnt64(unsigned \__int64)|  
...
|[__rdtsc](../VS_visualcpp/__rdtsc.md)||intrin.h|unsigned __int64 \__rdtsc(void)|  
|[__rdtscp](../VS_visualcpp/__rdtscp.md)|RDTSCP|intrin.h|unsigned __int64 \__rdtscp(unsigned int*)|  
|[_ReadBarrier](../VS_visualcpp/_ReadBarrier.md)||intrin.h|void _ReadBarrier(void)|  
|[__readcr0](../VS_visualcpp/__readcr0.md)||intrin.h|unsigned __int64 \__readcr0(void)|  
|[__readcr2](../VS_visualcpp/__readcr2.md)||intrin.h|unsigned __int64 \__readcr2(void)|  
|[__readcr3](../VS_visualcpp/__readcr3.md)||intrin.h|unsigned __int64 \__readcr3(void)|  
|[__readcr4](../VS_visualcpp/__readcr4.md)||intrin.h|unsigned __int64 \__readcr4(void)|  
|[__readcr8](../VS_visualcpp/__readcr8.md)||intrin.h|unsigned __int64 \__readcr8(void)|  
|[__readdr](../VS_visualcpp/__readdr.md)||intrin.h|unsigned __int64 \__readdr(unsigned)|  
|[__readeflags](../VS_visualcpp/__readeflags.md)||intrin.h|unsigned __int64 \__readeflags(void)|  
...
|[__readgsbyte](../VS_visualcpp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned char __readgsbyte(unsigned long Offset)|  
|[__readgsdword](../VS_visualcpp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned long __readgsdword(unsigned long Offset)|  
|[__readgsqword](../VS_visualcpp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned __int64 \__readgsqword(unsigned long Offset)|  
|[__readgsword](../VS_visualcpp/__readgsbyte--__readgsdword--__readgsqword--__readgsword.md)||intrin.h|unsigned short __readgsword(unsigned long Offset)|  
|[__readmsr](../VS_visualcpp/__readmsr.md)||intrin.h|unsigned __int64 \__readmsr(unsigned long)|  
|[__readpmc](../VS_visualcpp/__readpmc.md)||intrin.h|unsigned __int64 \__readpmc(unsigned long a)|  
|[_ReadWriteBarrier](../VS_visualcpp/_ReadWriteBarrier.md)||intrin.h|void _ReadWriteBarrier(void)|  
|[_ReturnAddress](../VS_visualcpp/_ReturnAddress.md)||intrin.h|void * _ReturnAddress(void)|  
...
|[_rotl16](../VS_visualcpp/_rotl8--_rotl16.md)||intrin.h|unsigned short _rotl16(unsigned short value,unsigned char shift)|  
|[_rotl8](../VS_visualcpp/_rotl8--_rotl16.md)||intrin.h|unsigned char _rotl8(unsigned char value,unsigned char shift)|  
|[_rotr16](../VS_visualcpp/_rotr8--_rotr16.md)||intrin.h|unsigned short _rotr16(unsigned short value,unsigned char shift)|  
|[_rotr8](../VS_visualcpp/_rotr8--_rotr16.md)||intrin.h|unsigned char _rotr8(unsigned char value,unsigned char shift)|  
...
|[__segmentlimit](../VS_visualcpp/__segmentlimit.md)||intrin.h|unsigned long __segmentlimit(unsigned long a)|  
|_sgdt||intrin.h|void _sgdt(void*)|  
|[__shiftleft128](../VS_visualcpp/__shiftleft128.md)||intrin.h|unsigned __int64 \__shiftleft128(unsigned \__int64 LowPart,unsigned \__int64 HighPart,unsigned char Shift)|  
|[__shiftright128](../VS_visualcpp/__shiftright128.md)||intrin.h|unsigned __int64 \__shiftright128(unsigned \__int64 LowPart,unsigned \__int64 HighPart,unsigned char Shift)|  
...
|[__sidt](../VS_visualcpp/__sidt.md)||intrin.h|void __sidt(void*)|  
...
|[__stosb](../VS_visualcpp/__stosb.md)||intrin.h|void __stosb(IN PBYTE,IN BYTE,IN SIZE_T)|  
|[__stosd](../VS_visualcpp/__stosd.md)||intrin.h|void __stosd(IN PDWORD,IN DWORD,IN SIZE_T)|  
|[__stosq](../VS_visualcpp/__stosq.md)||intrin.h|void __stosq(IN PDWORD64,IN DWORD64,IN SIZE_T)|  
|[__stosw](../VS_visualcpp/__stosw.md)||intrin.h|void __stosw(IN PWORD,IN WORD,IN SIZE_T)|  
...
|[__svm_clgi](../VS_visualcpp/__svm_clgi.md)||intrin.h|void __svm_clgi(void)|  
|[__svm_invlpga](../VS_visualcpp/__svm_invlpga.md)||intrin.h|void __svm_invlpga(void*,int)|  
|[__svm_skinit](../VS_visualcpp/__svm_skinit.md)||intrin.h|void __svm_skinit(int)|  
|[__svm_stgi](../VS_visualcpp/__svm_stgi.md)||intrin.h|void __svm_stgi(void)|  
|[__svm_vmload](../VS_visualcpp/__svm_vmload.md)||intrin.h|void __svm_vmload(size_t)|  
|[__svm_vmrun](../VS_visualcpp/__svm_vmrun.md)||intrin.h|void __svm_vmrun(size_t)|  
|[__svm_vmsave](../VS_visualcpp/__svm_vmsave.md)||intrin.h|void __svm_vmsave(size_t)|  
...
|[__ud2](../VS_visualcpp/__ud2.md)||intrin.h|void __ud2(void)|  
|[__ull_rshift](../VS_visualcpp/__ull_rshift.md)||intrin.h|unsigned __int64 [pascal/cdecl] \__ull_rshift(unsigned \__int64,int)|  
|[_umul128](../VS_visualcpp/_umul128.md)||intrin.h|unsigned __int64 _umul128(unsigned \__int64 multiplier,unsigned \__int64 multiplicand,unsigned \__int64 *highproduct)|  
|[__umulh](../VS_visualcpp/__umulh.md)||intrin.h|unsigned __int64 \__umulh(unsigned \__int64,unsigned \__int64)|  
|[__vmx_off](../VS_visualcpp/__vmx_off.md)||intrin.h|void __vmx_off(void)|  
|[__vmx_on](../VS_visualcpp/__vmx_on.md)||intrin.h|unsigned char __vmx_on(unsigned \__int64*)|  
|[__vmx_vmclear](../VS_visualcpp/__vmx_vmclear.md)||intrin.h|unsigned char __vmx_vmclear(unsigned \__int64*)|  
|[__vmx_vmlaunch](../VS_visualcpp/__vmx_vmlaunch.md)||intrin.h|unsigned char __vmx_vmlaunch(void)|  
|[__vmx_vmptrld](../VS_visualcpp/__vmx_vmptrld.md)||intrin.h|unsigned char __vmx_vmptrld(unsigned \__int64*)|  
|[__vmx_vmptrst](../VS_visualcpp/__vmx_vmptrst.md)||intrin.h|void __vmx_vmptrst(unsigned \__int64 *)|  
|[__vmx_vmread](../VS_visualcpp/__vmx_vmread.md)||intrin.h|unsigned char __vmx_vmread(size_t,size_t*)|  
|[__vmx_vmresume](../VS_visualcpp/__vmx_vmresume.md)||intrin.h|unsigned char __vmx_vmresume(void)|  
|[__vmx_vmwrite](../VS_visualcpp/__vmx_vmwrite.md)||intrin.h|unsigned char __vmx_vmwrite(size_t,size_t)|  
|[__wbinvd](../VS_visualcpp/__wbinvd.md)||intrin.h|void __wbinvd(void)|  
|[_WriteBarrier](../VS_visualcpp/_WriteBarrier.md)||intrin.h|void _WriteBarrier(void)|  
|[__writecr0](../VS_visualcpp/__writecr0.md)||intrin.h|void __writecr0(unsigned \__int64)|  
|[__writecr3](../VS_visualcpp/__writecr3.md)||intrin.h|void __writecr3(unsigned \__int64)|  
|[__writecr4](../VS_visualcpp/__writecr4.md)||intrin.h|void __writecr4(unsigned \__int64)|  
|[__writecr8](../VS_visualcpp/__writecr8.md)||intrin.h|void __writecr8(unsigned \__int64)|  
|[__writedr](../VS_visualcpp/__writedr.md)||intrin.h|void __writedr(unsigned,unsigned \__int64)|  
|[__writeeflags](../VS_visualcpp/__writeeflags.md)||intrin.h|void __writeeflags(unsigned \__int64)|  
...
|[__writegsbyte](../VS_visualcpp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsbyte(unsigned long Offset,unsigned char Data)|  
|[__writegsdword](../VS_visualcpp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsdword(unsigned long Offset,unsigned long Data)|  
|[__writegsqword](../VS_visualcpp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsqword(unsigned long Offset,unsigned \__int64 Data)|  
|[__writegsword](../VS_visualcpp/__writegsbyte--__writegsdword--__writegsqword--__writegsword.md)||intrin.h|void __writegsword(unsigned long Offset,unsigned short Data)|  
|[__writemsr](../VS_visualcpp/__writemsr.md)||intrin.h|void __writemsr(unsigned long,unsigned \__int64)|  
...
## See Also  
 ...
 [x86 Intrinsics](../VS_visualcpp/x86-Intrinsics-List.md)