...
## Remarks  
 The database is a DAO object underlying an MFC object of class [CDaoDatabase](../VS_visualcpp/CDaoDatabase-Class.md). The references to Primary, Secondary, and All above indicate how the information is returned by the [CDaoWorkspace::GetDatabaseInfo](../Topic/CDaoWorkspace::GetDatabaseInfo.md) member function.  
