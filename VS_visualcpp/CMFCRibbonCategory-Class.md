...
The `CMFCRibbonCategory` class implements a ribbon tab that contains a group of [ribbon panels](../VS_visualcpp/CMFCRibbonPanel-Class.md).  
...
## Remarks  
 Typically, you create a ribbon category indirectly by calling [CMFCRibbonBar::AddCategory](../VS_visualcpp/CMFCRibbonBar-Class.md#cmfcribbonbar__addcategory), which returns a pointer to the newly created ribbon category. You add panels to the category by calling [CMFCRibbonCategory::AddPanel](#cmfcribboncategory__addpanel).  
  
 The `CMFCRibbonTab` class draws ribbon categories. It is derived from [CMFCRibbonBaseElement Class](../VS_visualcpp/CMFCRibbonBaseElement-Class.md).  
 ...
 ![CMFCRibbonCategory image](../VS_visualcpp/media/CMFCRibbonCategory.png "CMFCRibbonCategory")  
  
## Inheritance Hierarchy  
 [CObject](../VS_visualcpp/CObject-Class.md)  
  
 [CMFCRibbonCategory](../VS_visualcpp/CMFCRibbonCategory-Class.md)  
...
##  <a name="cmfcribboncategory__cmfcribboncategory"></a>  CMFCRibbonCategory::CMFCRibbonCategory  
 Constructs and initializes a [CMFCRibbonCategory](../VS_visualcpp/CMFCRibbonCategory-Class.md) object.  
...
##  <a name="cmfcribboncategory__copyfrom"></a>  CMFCRibbonCategory::CopyFrom  
 Copies the state of the specified [CMFCRibbonCategory](../VS_visualcpp/CMFCRibbonCategory-Class.md) to the current [CMFCRibbonCategory](../VS_visualcpp/CMFCRibbonCategory-Class.md) object.  
...
### Parameters  
 [in] `src`  
 The source [CMFCRibbonCategory](../VS_visualcpp/CMFCRibbonCategory-Class.md) object.  
...
### Parameters  
 [in, out] `arElements`  
 Reference to a [CArray](../VS_visualcpp/CArray-Class.md) of ribbon elements.  
...
### Remarks  
 For more information about highlighting a ribbon panel, see [CMFCRibbonPanel::Highlight](../VS_visualcpp/CMFCRibbonPanel-Class.md#cmfcribbonpanel__highlight).  
