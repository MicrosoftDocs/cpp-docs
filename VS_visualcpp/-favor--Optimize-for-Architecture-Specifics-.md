...
ms.tgt_pltfrm: na
ms.topic: article
H1: /favor (Optimize for Architecture Specifics)
...
>  Intel64 architecture was previously known as Extended Memory 64 Technology, and the corresponding compiler option was **/favor:EM64T**.  
 ...
 For information about how to program for the x64 architecture, see [x64 Software Conventions](../VS_visualcpp/x64-Software-Conventions.md).  
