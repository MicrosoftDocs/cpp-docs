...
## Example  
 ...
 You can implement this code in the MFC01 application you created in [How to: Create the User Control and Host in a Dialog Box](../VS_visualcpp/How-to--Create-the-User-Control-and-Host-in-a-Dialog-Box.md).  
