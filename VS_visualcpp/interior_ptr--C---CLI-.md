...
### Remarks  
 ...
 For information on how to declare an interior pointer that points into an object that cannot be moved on the garbage-collected heap, see [pin_ptr](../VS_visualcpp/pin_ptr--C---CLI-.md).  
  
 `interior_ptr` is in the cli namespace.  See [Platform, default, and cli Namespaces](../VS_visualcpp/Platform--default--and-cli-Namespaces---C---Component-Extensions-.md) for more information.  
