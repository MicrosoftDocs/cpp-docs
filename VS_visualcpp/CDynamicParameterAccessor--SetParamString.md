...
## Remarks  
 ...
 Use `SetParamString` to set string parameter data in the buffer. Use [SetParam](../VS_visualcpp/CDynamicParameterAccessor--SetParam.md) to set nonstring parameter data in the buffer.  
