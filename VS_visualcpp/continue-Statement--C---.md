...
Forces transfer of control to the controlling expression of the smallest enclosing [do](../VS_visualcpp/do-while-Statement--C---.md), [for](../VS_visualcpp/for-Statement--C---.md), or [while](../VS_visualcpp/while-Statement--C---.md) loop.  
