...
## Remarks  
 ...
 For more information, see [Static](../Topic/Static%20\(C++\).md) and [const](../VS_visualcpp/const--C---.md).  
  
 `literal` is a context-sensitive keyword. See [Context-Sensitive Keywords](../VS_visualcpp/Context-Sensitive-Keywords---C---Component-Extensions-.md) for more information.  
