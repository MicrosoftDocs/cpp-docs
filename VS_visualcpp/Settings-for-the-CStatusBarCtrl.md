...
The default position of a [CStatusBarCtrl](../VS_visualcpp/CStatusBarCtrl-Class.md) status window is along the bottom of the parent window, but you can specify the `CCS_TOP` style to have it appear at the top of the parent window's client area.  
