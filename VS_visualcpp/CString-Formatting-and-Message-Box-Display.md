...
### Parameters  
 *rString*  
 -   Reference to a                                         [CString](../VS_visualcpp/Using-CString.md) object that will receive an individual substring.  
...
### Parameters  
 ...
 `nType`  
 The style of the message box. Apply any of the                                 [message-box styles](../VS_visualcpp/Message-Box-Styles.md) to the box.  
