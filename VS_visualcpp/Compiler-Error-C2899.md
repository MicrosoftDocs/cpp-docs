...
typename cannot be used outside a template declaration  
 ...
 The [typename](../VS_visualcpp/typename.md) keyword can be used only in a template definition or declaration. In a template declaration, it can be used in two ways:  
