...
## Remarks  
 The name becomes a synonym for an entity declared elsewhere. It allows an *individual* name from a specific namespace to be used without [explicit qualification](../Topic/Explicit%20Qualification.md). This is in contrast to the `using` directive, which allows *all* the names in a namespace to be used without qualification. See [using Directive](../Topic/using%20Directive%20\(C++\).md) for more information. This keyword is also used for [type aliases](../VS_visualcpp/Aliases-and-typedefs--C---.md).  
...
## Example  
 ...
 See [Member-Access Control](../VS_visualcpp/Member-Access-Control--C---.md), for more information on accessibility of members.  
