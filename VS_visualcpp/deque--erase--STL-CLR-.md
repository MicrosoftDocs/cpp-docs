...
## Remarks  
 ...
 Both member functions return an iterator that designates the first element remaining beyond any elements removed, or [deque::end (STL/CLR)](../VS_visualcpp/deque--end--STL-CLR-.md)`()` if no such element exists.  
