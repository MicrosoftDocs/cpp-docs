...
To add a class in a Visual C++ project, in **Solution Explorer**, right-click the project, click **Add**, and then click **Class**. This opens the [Add Class Dialog Box](../VS_visualcpp/Add-Class-Dialog-Box.md) dialog box.  
...
-   For more information about how to create MFC classes, see [MFC Class](../VS_visualcpp/Adding-an-MFC-Class.md).  
  
-   For more information about how to create ATL classes, see [ATL Simple Object](../VS_visualcpp/Adding-an-ATL-Simple-Object.md).  
  
> [!NOTE]
>  The template **Add ATL Support to MFC** does not create a class, but instead configures the project to use ATL. For more information, see [ATL Support in an MFC Project](../VS_visualcpp/Adding-ATL-Support-to-Your-MFC-Project.md).  
  
 To make a C++ class that does not use MFC, ATL, or CLR, use the **C++ Class** template in the **C++** group of installed templates. For more information, see [Adding a Generic C++ Class](../VS_visualcpp/Adding-a-Generic-C---Class.md).  
  
 Two kinds of form-based C++ classes are available. The first one, [CFormView Class](../VS_visualcpp/CFormView-Class.md) creates an MFC class. The second one creates a CLR Windows Forms class.  
