...
5.  The new .rct file is added to your project and appears in Solution Explorer under the **Resources** folder.  
    ...
    > [!NOTE]
    >  When you create a new RCT file, Visual Studio searches for it in \Program Files\Microsoft Visual Studio 9.0\VC\VCResourceTemplates, in \Program Files\Microsoft Visual Studio 9.0\VC\VCResourceTemplates\\*LCID* (such as 1033 for English), *or* anywhere on the [include path](../VS_visualcpp/How-to--Specify-Include-Directories-for-Resources.md). If you prefer to store your RCT files in another file folder, for example \My Documents, you only need to add this folder to the include path and Visual Studio will find your RCT file.  
  
### To convert an existing .rc file to an .rct file  
  
1.  [Open the .rc file as a stand-alone file](../VS_visualcpp/How-to--Open-a-Resource-Script-File-Outside-of-a-Project--Standalone-.md).  
...
1.  In the [Resource View](../VS_visualcpp/Resource-View-Window.md) pane, right click the .rc file and choose **Add Resource** from the shortcut menu.  
...
4.  Modify the added resource as needed in its resource editor.  
     ...
     The resource editor automatically provides a unique resource ID. You can revise the [resource properties](../VS_visualcpp/Changing-the-Properties-of-a-Resource.md) as needed.  
