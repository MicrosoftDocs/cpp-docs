...
```  
 ...
 To see exactly how the compiler handles preprocessor directives, use [/P](../VS_visualcpp/-P--Preprocess-to-a-File-.md), [/E](../VS_visualcpp/-E--Preprocess-to-stdout-.md), or [/EP](../VS_visualcpp/-EP--Preprocess-to-stdout-Without-#line-Directives-.md).