...
---
# CStdioFile Class
Represents a C run-time stream file as opened by the run-time function [fopen](../VS_visualcpp/fopen--_wfopen.md).  
...
|Name|Description|  
|----------|-----------------|  
|[CStdioFile::Open](#cstdiofile__open)|Overloaded. Open is designed for use with the default `CStdioFile` constructor (Overrides [CFile::Open](../VS_visualcpp/CFile-Class.md#cfile__open)).|  
...
## Remarks  
 ...
 The [CFile](../VS_visualcpp/CFile-Class.md) functions [Duplicate](../VS_visualcpp/CFile-Class.md#cfile__duplicate), [LockRange](../VS_visualcpp/CFile-Class.md#cfile__lockrange), and [UnlockRange](../VS_visualcpp/CFile-Class.md#cfile__unlockrange) are not supported for `CStdioFile`.  
  
 If you call these functions on a `CStdioFile`, you will get a [CNotSupportedException](../VS_visualcpp/CNotSupportedException-Class.md).  
  
 For more information on using `CStdioFile`, see the articles [Files in MFC](../VS_visualcpp/Files-in-MFC.md) and [File Handling](../VS_visualcpp/File-Handling.md) in the                 *Run-Time Library Reference*.  
...
### Parameters  
 `pOpenStream`  
 Specifies the file pointer returned by a call to the C run-time function [fopen](../VS_visualcpp/fopen--_wfopen.md).  
 ...
 One file access mode option is required; other modes are optional. See [CFile::CFile](../VS_visualcpp/CFile-Class.md#cfile__cfile) for a list of mode options and other flags. In MFC version 3.0 and later, share flags are allowed.  
...
### Remarks  
 ...
 [CFile::Read](../VS_visualcpp/CFile-Class.md#cfile__read) is also available for text-mode input, but it does not terminate on a carriage return–linefeed pair.  
...
### Remarks  
 ...
 This implementation of `Seek` is based on the Run-Time Library (CRT) function `fseek`. There are several limits on the usage of `Seek` on streams opened in text mode. For more information, see [fseek, _fseeki64](../VS_visualcpp/fseek--_fseeki64.md).  
...
### Remarks  
 ...
 If you want to write data that is not null-terminated to a file, use `CStdioFile::Write` or [CFile::Write](../VS_visualcpp/CFile-Class.md#cfile__write).  
...
## See Also  
 ...
 [CFile Class](../VS_visualcpp/CFile-Class.md)   
 [CFile::Duplicate](../VS_visualcpp/CFile-Class.md#cfile__duplicate)   
 [CFile::LockRange](../VS_visualcpp/CFile-Class.md#cfile__lockrange)   
 [CFile::UnlockRange](../VS_visualcpp/CFile-Class.md#cfile__unlockrange)   
