...
## Remarks  
 ...
 The date and time picker control also uses notifications and callbacks, which are described in [Using CDateTimeCtrl](../VS_visualcpp/Using-CDateTimeCtrl.md).  
...
### Parameters  
 ...
 `pParentWnd`  
 A pointer to a [CWnd](../VS_visualcpp/CWnd-Class.md) object that is the parent window of the date and time picker control. It must not be **NULL**.  
...
### Return Value  
 A pointer to a [CMonthCalCtrl](../VS_visualcpp/CMonthCalCtrl-Class.md) object, or **NULL** if unsuccessful or if the window is not visible.  
...
### Return Value  
 A pointer to a [CFont](../VS_visualcpp/CFont-Class.md) object, or **NULL** if unsuccessful.  
...
### Parameters  
 `pMinRange`  
 A pointer to a [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) object or a [CTime](../VS_visualcpp/CTime-Class.md) object containing the earliest time allowed in the `CDateTimeCtrl` object.  
...
### Parameters  
 *timeDest*  
 In the first version, a reference to a [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) object that will receive the system time information. In the second version, a reference to a [CTime](../VS_visualcpp/CTime-Class.md) object that will receive the system time information.  
