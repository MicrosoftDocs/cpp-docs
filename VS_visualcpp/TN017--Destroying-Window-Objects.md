...
-   Default control bars (classes derived from `CControlBar`, see [Technical Note 31](../VS_visualcpp/TN031--Control-Bars.md) for enabling auto-delete for control bar objects).  
