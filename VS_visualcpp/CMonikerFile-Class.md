...
## Remarks  
 ...
 For more information on streams and monikers, see [COleStreamFile](../VS_visualcpp/COleStreamFile-Class.md) in the                 *MFC Reference* and                 [IStream](http://msdn.microsoft.com/library/windows/desktop/aa380034) and                 [IMoniker](http://msdn.microsoft.com/library/windows/desktop/ms679705) in the Windows SDK.  
