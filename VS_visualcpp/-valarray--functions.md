...
```  
template<class Type>    valarray<Type> abs(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> acos(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> asin(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> atan(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> atan2(       const valarray<Type>&  _Left ,       const valarray<Type>&  _Right    ); template<class Type>    valarray<Type> atan2(       const valarray<Type>  _Left ,        const Type&  _Right    ); template<class Type>    valarray<Type> atan2(       const Type&  _Left ,        const valarray<Type>&  _Right    );  
...
```  
template<class Type>    valarray<Type> cos(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> cosh(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> exp(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> log(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> log10(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> sin(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> sinh(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> sqrt(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> tan(       const valarray<Type>&  _Left    );  
...
```  
template<class Type>    valarray<Type> tanh(       const valarray<Type>&  _Left    );  
