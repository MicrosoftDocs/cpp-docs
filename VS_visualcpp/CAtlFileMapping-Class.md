...
This class represents a memory-mapped file, adding a cast operator to the methods of [CAtlFileMappingBase](../VS_visualcpp/CAtlFileMappingBase-Class.md).  
...
## Remarks  
 This class adds a single cast operator to allow implicit conversion of `CAtlFileMapping` objects to `T`**\***. Other members are supplied by the base class, [CAtlFileMappingBase](../VS_visualcpp/CAtlFileMappingBase-Class.md).  
  
## Inheritance Hierarchy  
 [CAtlFileMappingBase](../VS_visualcpp/CAtlFileMappingBase-Class.md)  
