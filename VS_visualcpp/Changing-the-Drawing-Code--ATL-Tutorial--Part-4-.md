...
1.  Build and start the ActiveX Control Test Container. For more information, see [TSTCON Sample: ActiveX Control Test Container](../VS_visualcpp/Visual-C---Samples.md).  
...
1.  Update PolyCtl.cpp by adding the call to `FireViewChange` to the `put_Sides` method. When you have finished, the `put_Sides` method should look like this:  
 ...
 [Back to Step 3](../VS_visualcpp/Adding-a-Property-to-the-Control--ATL-Tutorial--Part-3-.md) &#124; [On to Step 5](../VS_visualcpp/Adding-an-Event--ATL-Tutorial--Part-5-.md)  
