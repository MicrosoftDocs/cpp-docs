...
**Microsoft Specific**  
 ...
 Provide compiler intrinsic support for the Win32 Windows SDK [InterlockedIncrement](http://msdn.microsoft.com/library/ms683614.aspx) function.  
...
## Remarks  
 ...
 The variable pointed to by the `lpAddend` parameter must be aligned on a 32-bit boundary; otherwise, this function fails on multiprocessor x86 systems and any non-x86 systems. For more information, see [align](../VS_visualcpp/align--C---.md).  
...
## Example  
 For a sample of how to use `_InterlockedIncrement`, see [_InterlockedDecrement](../VS_visualcpp/_InterlockedDecrement-Intrinsic-Functions.md).  
