...
### Remarks  
 ...
 The remaining member operators are analogs to earlier ones, but with [Rvalue Reference Declarator: &&](../VS_visualcpp/Rvalue-Reference-Declarator----.md).  
...
### Remarks  
 ...
 The remaining constructors are analogs to earlier ones, but with [Rvalue Reference Declarator: &&](../VS_visualcpp/Rvalue-Reference-Declarator----.md).  
...
## See Also  
 ...
 [make_tuple Function](../VS_visualcpp/-tuple--functions.md#make_tuple_function)