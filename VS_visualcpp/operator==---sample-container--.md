...
## Return Value  
 Returns `_Left`**.**[size](../VS_visualcpp/Container-Class--size.md) **==** `_Right`**.size && equal**(_*Left***.**[begin](../VS_visualcpp/Container-Class--begin.md), `_Left`. [end](../VS_visualcpp/Container-Class--end.md)*, _Right***.begin**).  
