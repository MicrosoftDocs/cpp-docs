...
```  
 ...
 Note that the Microsoft C compiler maps **long double** to type **double**. See [Storage of Basic Types](../VS_visualcpp/Storage-of-Basic-Types.md) for information about type **double**, **float**, and **long**.  
