...
-   At the command line using the [/vmg](../VS_visualcpp/-vmb---vmg--Representation-Method-.md) switch  
  
-   Using the [pointers_to_members](../VS_visualcpp/pointers_to_members.md) pragma  
