...
```  
 ...
 The address of an overloaded function can be taken only when it is clear which version of the function is being referenced. See [Address of Overloaded Functions](../Topic/Address%20of%20Overloaded%20Functions.md) for information about how to obtain the address of a particular overloaded function.  
