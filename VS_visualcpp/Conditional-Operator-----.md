...
-   If both operands are of arithmetic or enumeration types, the usual arithmetic conversions (covered in [Arithmetic Conversions](../Topic/Arithmetic%20Conversions.md)) are performed to convert them to a common type.  
