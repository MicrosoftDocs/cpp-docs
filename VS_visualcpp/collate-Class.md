...
### Remarks  
 The type describes a specialization of template class [basic_string](../VS_visualcpp/basic_string-Class.md) whose objects can store copies of the source sequence.  
