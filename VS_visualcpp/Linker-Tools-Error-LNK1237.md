...
during code generation, compiler introduced reference to symbol 'symbol' defined in module 'module' compiled with /GL  
 ...
 For more information, see [/GL (Whole Program Optimization)](../VS_visualcpp/-GL--Whole-Program-Optimization-.md).  
  
 To resolve LNK1237, do not compile the symbol with **/GL** or use [/INCLUDE (Force Symbol References)](../VS_visualcpp/-INCLUDE--Force-Symbol-References-.md) to force a reference to the symbol.  
