...
## Remarks  
 The *filename* is the name of the precompiled header file to use or create (depending on whether [/Yu](../VS_visualcpp/-Yu--Use-Precompiled-Header-File-.md) or [/Yc](../VS_visualcpp/-Yc--Create-Precompiled-Header-File-.md) is specified). If *filename* does not contain a path specification, the precompiled header file is assumed to be in the same directory as the source file.  
