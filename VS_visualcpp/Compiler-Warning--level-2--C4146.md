...
1.  The number 2147483648 is evaluated. Because it is greater than the maximum integer value of 2147483647, the type of 2147483648 is not [int](../VS_visualcpp/Integer-Types.md), but `unsigned int`.  
