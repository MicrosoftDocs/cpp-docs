...
The following rules constrain how overloaded operators are implemented. However, they do not apply to the [new](../VS_visualcpp/new-Operator--C---.md) and [delete](../VS_visualcpp/delete-Operator--C---.md) operators, which are covered separately.  
