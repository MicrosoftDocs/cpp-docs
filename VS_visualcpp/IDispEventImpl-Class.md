...
|Name|Description|  
|----------|-----------------|  
|[IDispEventImpl::_tihclass](../VS_visualcpp/IDispEventImpl-Class.md)|The class used to manage the type information. By default, `CComTypeInfoHolder`.|  
...
## Remarks  
 ...
 `IDispEventImpl` provides the same functionality as [IDispEventSimpleImpl](../VS_visualcpp/IDispEventSimpleImpl-Class.md), except it gets type information about the interface from a type library rather than having it supplied as a pointer to an [_ATL_FUNC_INFO](../VS_visualcpp/_ATL_FUNC_INFO-Structure.md) structure. Use `IDispEventSimpleImpl` when you do not have a type library describing the event interface or want to avoid the overhead associated with using the type library.  
...
## Inheritance Hierarchy  
 ...
 [IDispEventSimpleImpl](../VS_visualcpp/IDispEventSimpleImpl-Class.md)  
