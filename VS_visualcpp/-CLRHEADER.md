...
## Remarks  
 ...
 `file`  
 An image file built with [/clr](../VS_visualcpp/-clr--Common-Language-Runtime-Compilation-.md).  
...
-   3 -- /clr:pure (image is MSIL only, but only able to run on x86 platforms).  
 ...
 You can also programmatically check if an image was built for the common language runtime.  For more information, see [How to: Determine if an Image is Native or CLR](../VS_visualcpp/How-to--Determine-if-an-Image-is-Native-or-CLR.md).  
