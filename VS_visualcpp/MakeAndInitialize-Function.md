...
## Remarks  
 See [How to: Instantiate WRL Components Directly](../VS_visualcpp/How-to--Instantiate-WRL-Components-Directly.md) to learn the differences between this function and [Microsoft::WRL::Make](../VS_visualcpp/Make-Function.md), and for an example.  
