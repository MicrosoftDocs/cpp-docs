 ...
 *declaration*  
 ...
 [Overview of Declarations](../VS_visualcpp/Overview-of-Declarations.md) gives the syntax for the `declaration` nonterminal, and the *Preprocessor Reference* explains how the [translation unit](../VS_visualcpp/Phases-of-Translation.md) is processed.  
  
> [!NOTE]
>  See the introduction to [C Language Syntax Summary](../VS_visualcpp/C-Language-Syntax-Summary.md), for an explanation of the ANSI syntax conventions.  
