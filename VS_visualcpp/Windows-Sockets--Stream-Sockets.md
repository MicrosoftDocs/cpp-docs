...
This article describes stream sockets, one of the two Windows Socket types available. (The other type is the [datagram socket](../VS_visualcpp/Windows-Sockets--Datagram-Sockets.md).)  
