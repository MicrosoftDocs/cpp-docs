...
##  <a name="_atl_using_.25.module.25"></a> Using %MODULE%  
 The [ATL Control Wizard](../VS_visualcpp/ATL-Control-Wizard.md) automatically generates a script that uses `%MODULE%`. ATL uses this replaceable parameter for the actual location of your server's DLL or EXE.  
...
```  
 ...
 Then, before calling one of the script processing methods listed in [Invoking Scripts](../VS_visualcpp/Invoking-Scripts.md), add a replacement to the map:  
