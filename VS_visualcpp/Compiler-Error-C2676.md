...
## Example  
 ...
 The `this` pointer is of type handle in a reference type. For more information, see [Semantics of the this pointer](../VS_visualcpp/How-to--Define-and-Consume-Classes-and-Structs--C---CLI-.md#BKMK_Semantics_of_the_this_pointer).  
