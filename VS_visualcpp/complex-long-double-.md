...
## Remarks  
 ...
 For more information on the template class `complex`, see [complex Class](../VS_visualcpp/complex-Class.md). For a list of members of the template class `complex`, see .  
