...
|VCOMPD.LIB|Multithreaded, dynamic link (import library for VCOMPD.LID) (debug)|  
 ...
 You can use [/NODEFAULTLIB (Ignore Libraries)](../VS_visualcpp/-NODEFAULTLIB--Ignore-Libraries-.md) to remove the default lib and explicitly link with the lib of your choice.  
