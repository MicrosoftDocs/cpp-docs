...
'member': a sealed or final function must be virtual  
 ...
 The [sealed](../VS_visualcpp/sealed---C---Component-Extensions-.md) and [final](../VS_visualcpp/final-Specifier.md) keywords are only allowed on a class, struct, or member function marked `virtual`.  
