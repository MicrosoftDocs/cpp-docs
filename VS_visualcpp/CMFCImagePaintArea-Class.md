...
### Remarks  
 ...
 The framework uses this class to display the picture area in an image editor dialog box. For more information about the image editor dialog box, see [CMFCImageEditorDialog Class](../VS_visualcpp/CMFCImageEditorDialog-Class.md).  
...
## Inheritance Hierarchy  
 ...
 [CMFCImagePaintArea](../VS_visualcpp/CMFCImagePaintArea-Class.md)  
...
### Remarks  
 ...
 The drawing color is used by the image editor dialog box for all drawing modes except for `IMAGE_EDIT_MODE_COLOR`. For more information about drawing modes, see [CMFCImagePaintArea::IMAGE_EDIT_MODE Enumeration](../VS_visualcpp/CMFCImagePaintArea--IMAGE_EDIT_MODE-Enumeration.md).  
