...
---
# Stock Properties
If you are adding a property to an MFC dispinterface using the [Add Property Wizard](../VS_visualcpp/IDL-Attributes--Add-Property-Wizard.md), you can choose a stock property from the **Property name** list in the [Names](../VS_visualcpp/Names--Add-Property-Wizard.md) page of the wizard. These properties are as follows:  
