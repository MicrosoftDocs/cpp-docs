...
## Remarks  
 ...
 For more information on using `CFontDialog`, see [Common Dialog Classes](../VS_visualcpp/Common-Dialog-Classes.md).  
...
### Remarks  
 For more information on the weight of a font, see [CFont::CreateFont](../VS_visualcpp/CFont-Class.md#cfont__createfont).  
