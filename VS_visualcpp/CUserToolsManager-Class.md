...
|[CUserToolsManager::GetDefExt](#cusertoolsmanager__getdefext)|Returns the default extension that the **File Open** dialog box ( [CFileDialog](../VS_visualcpp/CFileDialog-Class.md#cfiledialog__cfiledialog)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.|  
|[CUserToolsManager::GetFilter](#cusertoolsmanager__getfilter)|Returns the file filter that the **File Open** dialog box ( [CFileDialog Class](../VS_visualcpp/CFileDialog-Class.md)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.|  
...
|[CUserToolsManager::SetDefExt](#cusertoolsmanager__setdefext)|Specifies the default extension that the **File Open** dialog box ( [CFileDialog Class](../VS_visualcpp/CFileDialog-Class.md)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.|  
|[CUserToolsManager::SetFilter](#cusertoolsmanager__setfilter)|Specifies the file filter that the **File Open** dialog box ( [CFileDialog Class](../VS_visualcpp/CFileDialog-Class.md)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.|  
...
## Remarks  
 ...
 3. Call the [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools) method and supply the following parameters: menu command ID, first user tool command ID, and last user tool command ID.  
...
## Example  
 The following example demonstrates how to retrieve a reference to a `CUserToolsManager` object and how to create new user tools. This code snippet is part of the [Visual Studio Demo sample](../VS_visualcpp/Visual-C---Samples.md).  
...
## Inheritance Hierarchy  
 ...
 [CUserToolsManager](../VS_visualcpp/CUserToolsManager-Class.md)  
...
### Remarks  
 This method finds the first available menu command ID in the range that is supplied in the call to [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools) and assigns the user tool this ID.  
...
### Parameters  
 ...
 [in]  `pToolRTC`  
 The class that [CUserToolsManager::CreateNewTool](#cusertoolsmanager__createnewtool) creates. By using this class, you can use a derived type of [CUserTool Class](../VS_visualcpp/CUserTool-Class.md) instead of the default implementation.  
...
### Remarks  
 Do not call this constructor. Instead, call [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools) to enable user tools, and call [CWinAppEx::GetUserToolsManager](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__getusertoolsmanager) to obtain a pointer to the `CUserToolsManager`. For more information, see [User-defined Tools](../VS_visualcpp/User-defined-Tools.md).  
  
##  <a name="cusertoolsmanager__findtool"></a>  CUserToolsManager::FindTool  
 Returns the pointer to the [CUserTool Class](../VS_visualcpp/CUserTool-Class.md) object that is associated with a specified command ID.  
...
### Return Value  
 A pointer to a [CUserTool Class](../VS_visualcpp/CUserTool-Class.md) or `CUserTool`-derived object if success; otherwise `NULL`.  
  
### Remarks  
 When `FindTool` is successful, the returned type is the same as the type of the `pToolRTC` parameter to [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools).  
...
### Remarks  
 The `uArgMenuID` parameter of [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools) specifies the ID of the resource.  
  
##  <a name="cusertoolsmanager__getdefext"></a>  CUserToolsManager::GetDefExt  
 Returns the default extension that the **File Open** dialog box ( [CFileDialog](../VS_visualcpp/CFileDialog-Class.md#cfiledialog__cfiledialog)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.  
...
##  <a name="cusertoolsmanager__getfilter"></a>  CUserToolsManager::GetFilter  
 Returns the file filter that the **File Open** dialog box ( [CFileDialog Class](../VS_visualcpp/CFileDialog-Class.md)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.  
...
### Remarks  
 The returned ID is specified in the `uInitDirMenuID` parameter of [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools).  
...
### Remarks  
 Call this method to retrieve the maximum number of tools that can be allocated in the application. This number is the number of IDs in the range from the `uiCmdFirst` through the `uiCmdLast` parameters that you pass to [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools).  
...
### Return Value  
 A const reference to a [CObList Class](../VS_visualcpp/CObList-Class.md) object that contains a list of user tools.  
  
### Remarks  
 Call this method to retrieve a list of user tools that the [CUserToolsManager](../VS_visualcpp/CUserToolsManager-Class.md) object maintains. Each user tool is represented by an object of type [CUserTool Class](../VS_visualcpp/CUserTool-Class.md) or a type derived from `CUserTool`. The type is specified by the `pToolRTC` parameter when you call [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools) to enable user tools.  
...
### Remarks  
 This method checks whether the given command ID is in the command ID range. You specify the range when you call [CWinAppEx::EnableUserTools](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__enableusertools) to enable user tools.  
...
### Remarks  
 This method loads the state of the [CUserToolsManager](../VS_visualcpp/CUserToolsManager-Class.md) object from the Windows registry.  
  
 Usually, you do not call this method directly. [CWinAppEx::LoadState](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__loadstate) calls it as part of workspace initialization process.  
...
### Remarks  
 The method stores the current state of the [CUserToolsManager](../VS_visualcpp/CUserToolsManager-Class.md) object in the Windows registry.  
  
 Usually, you do not need to call this method directly, [CWinAppEx::SaveState](../VS_visualcpp/CWinAppEx-Class.md#cwinappex__savestate) calls it automatically as a part of the workspace serialization process of the application.  
  
##  <a name="cusertoolsmanager__setdefext"></a>  CUserToolsManager::SetDefExt  
 Specifies the default extension that the **File Open** dialog box ( [CFileDialog Class](../VS_visualcpp/CFileDialog-Class.md)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.  
...
##  <a name="cusertoolsmanager__setfilter"></a>  CUserToolsManager::SetFilter  
 Specifies the file filter that the **File Open** dialog box ( [CFileDialog Class](../VS_visualcpp/CFileDialog-Class.md)) uses in the **Command** field on the **Tools** tab of the **Customize** dialog box.  
