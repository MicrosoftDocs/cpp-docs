...
## Remarks  
 ...
 `COleClientItem` can be used with either the [COleDocument](../VS_visualcpp/COleDocument-Class.md), [COleLinkingDoc](../VS_visualcpp/COleLinkingDoc-Class.md), or [COleServerDoc](../VS_visualcpp/COleServerDoc-Class.md) class. To use `COleClientItem`, derive a class from it and implement the [OnChange](#coleclientitem__onchange) member function, which defines how the container responds to changes made to the item. To support in-place activation, override the [OnGetItemPosition](#coleclientitem__ongetitemposition) member function. This function provides information about the displayed position of the OLE item.  
  
 For more information about using the container interface, see the articles [Containers: Implementing a Container](../VS_visualcpp/Containers--Implementing-a-Container.md) and [Activation](../VS_visualcpp/Activation--C---.md).  
...
### Remarks  
 If the server application was written using the Microsoft Foundation Class Library, this function causes the [OnDoVerb](../VS_visualcpp/COleServerItem-Class.md#coleserveritem__ondoverb) member function of the corresponding `COleServerItem` object to be executed.  
 ...
 *clsidOld*  
 A reference to the item's current class ID. The class ID should represent the type of the actual object, as stored, unless it is a link. In that case, it should be the CLSID of the item to which the link refers. The [COleConvertDialog](../VS_visualcpp/COleConvertDialog-Class.md) automatically provides the correct class ID for the item.  
...
### Remarks  
 This is called automatically by [COleConvertDialog::DoConvert](../VS_visualcpp/COleConvertDialog-Class.md#coleconvertdialog__doconvert). It is not usually called directly.  
  
##  <a name="coleclientitem__attachdataobject"></a>  COleClientItem::AttachDataObject  
 Call this function to initialize a [COleDataObject](../VS_visualcpp/COleDataObject-Class.md) for accessing the data in the OLE item.  
...
### Parameters  
 `pDataObject`  
 Pointer to the [COleDataObject](../VS_visualcpp/COleDataObject-Class.md) object from which the OLE item is to be created.  
...
### Remarks  
 ...
 For more information, see the article [Data Objects and Data Sources (OLE)](../VS_visualcpp/Data-Objects-and-Data-Sources--OLE-.md).  
...
### Parameters  
 `pContainerDoc`  
 Pointer to the container document that will contain this item. This can be any [COleDocument](../VS_visualcpp/COleDocument-Class.md) derivative.  
  
### Remarks  
 If you pass a **NULL** pointer, no addition is made to the container document. You must explicitly call [COleDocument::AddItem](../VS_visualcpp/COleDocument-Class.md#coledocument__additem).  
...
### Remarks  
 This is called automatically by [COleConvertDialog](../VS_visualcpp/COleConvertDialog-Class.md). It is not necessary to call it directly.  
...
### Remarks  
 Data transfer operations, such as pasting from the Clipboard or drag-and-drop operations, provide `COleDataObject` objects containing the information offered by a server application. It is usually used in your override of [CView::OnDrop](../VS_visualcpp/CView-Class.md#cview__ondrop).  
...
### Remarks  
 The framework calls this function from [COleInsertDialog::CreateItem](../VS_visualcpp/COleInsertDialog-Class.md#coleinsertdialog__createitem) if the user chooses OK from the Insert Object dialog box when the Create from File button is selected.  
...
### Remarks  
 You typically call this function from the message handler for the Paste Link command on the Edit menu. (The Paste Link command is enabled in the default implementation of [COleDocument](../VS_visualcpp/COleDocument-Class.md) if the Clipboard contains an OLE item that can be linked to.)  
...
### Remarks  
 Call this during a drop operation when the user indicates a link should be created. It can also be used to handle the Edit Paste command. It is called by the framework in `COleClientItem::CreateLinkFromClipboard` and in [COlePasteSpecialDialog::CreateItem](../VS_visualcpp/COlePasteSpecialDialog-Class.md#colepastespecialdialog__createitem) when the Link option has been selected.  
...
### Remarks  
 The framework calls this function if the user chooses OK from the Insert Object dialog box when the Create from File button is selected and the Link check box is checked. It is called from [COleInsertDialog::CreateItem](../VS_visualcpp/COleInsertDialog-Class.md#coleinsertdialog__createitem).  
...
### Remarks  
 ...
 Used in [COlePasteSpecialDialog::CreateItem](../VS_visualcpp/COlePasteSpecialDialog-Class.md#colepastespecialdialog__createitem) when Static is selected.  
...
### Remarks  
 ...
 The delay time is specified by a registry key setting. You can change the delay time by calling [CWinApp::WriteProfileString](../VS_visualcpp/CWinApp-Class.md#cwinapp__writeprofilestring) or [CWinApp::WriteProfileInt](../VS_visualcpp/CWinApp-Class.md#cwinapp__writeprofileint). If you do not specify the delay time, a default value of 200 milliseconds is used. Drag delay time is stored as follows:  
...
### Parameters  
 `pDC`  
 Pointer to a [CDC](../VS_visualcpp/CDC-Class.md) object used for drawing the OLE item.  
  
 `lpBounds`  
 Pointer to a [CRect](../VS_visualcpp/CRect-Class.md) object or `RECT` structure that defines the bounding rectangle in which to draw the OLE item (in logical units determined by the device context).  
...
### Remarks  
 The function may use the metafile representation of the OLE item created by the [OnDraw](../VS_visualcpp/COleServerItem-Class.md#coleserveritem__ondraw) member function of `COleServerItem`.  
...
### Parameters  
 `lpSize`  
 Pointer to a **SIZE** structure or a [CSize](../VS_visualcpp/CSize-Class.md) object that will receive the size information.  
...
### Parameters  
 `pDataSource`  
 Pointer to a [COleDataSource](../VS_visualcpp/COleDataSource-Class.md) object that will receive the data contained in the OLE item.  
...
### Remarks  
 `GetClipboardData` is called as the default implementation of [OnGetClipboardData](#coleclientitem__ongetclipboarddata). Override `OnGetClipboardData` only if you want to offer data formats in addition to those offered by `CopyToClipboard`. Place those formats in the `COleDataSource` object before or after calling `CopyToClipboard`, and then pass the `COleDataSource` object to the [COleDataSource::SetClipboard](../VS_visualcpp/COleDataSource-Class.md#coledatasource__setclipboard) function. For example, if you want the OLE item's position in its container document to accompany it on the Clipboard, you would define your own format for passing that information and place it in the `COleDataSource` before calling `CopyToClipboard`.  
...
### Return Value  
 A **COleClientItem::ItemState** enumerated value, which can be one of the following: `emptyState`, **loadedState**, `openState`, `activeState`, `activeUIState`. For information about these states, see the article [Containers: Client-Item States](../VS_visualcpp/Containers--Client-Item-States.md).  
  
### Remarks  
 To be notified when the OLE item's state changes, use the [OnChange](#coleclientitem__onchange) member function.  
  
 For more information, see the article [Containers: Client-Item States](../VS_visualcpp/Containers--Client-Item-States.md).  
...
### Remarks  
 ...
 This function is called automatically by the [COleLinksDialog](../VS_visualcpp/COleLinksDialog-Class.md) class.  
...
-   `USERCLASSTYPE_APPNAME` Name of the application servicing the class.  
 ...
 `rString`  
 A reference to a [CString](../VS_visualcpp/CStringT-Class.md) object to which the string describing the OLE item's type is to be returned.  
...
### Remarks  
 ...
 This is called automatically by the [COleLinksDialog](../VS_visualcpp/COleLinksDialog-Class.md) implementation.  
...
### Remarks  
 It is used to determine when to draw the object with a hatching pattern. An open object should have a hatch pattern drawn on top of the object. You can use a [CRectTracker](../VS_visualcpp/CRectTracker-Class.md) object to accomplish this.  
...
### Remarks  
 ...
 Override this function to apply special rules to the resize/move operation. If the application is written in MFC, this call results because the server called [COleServerDoc::RequestPositionChange](../VS_visualcpp/COleServerDoc-Class.md#coleserverdoc__requestpositionchange).  
...
### Remarks  
 ...
 If the server was written with the Microsoft Foundation Class Library, the server can cause this function to be called by calling [COleServerDoc::DiscardUndoState](../VS_visualcpp/COleServerDoc-Class.md#coleserverdoc__discardundostate).  
...
### Return Value  
 A pointer to a [COleDataSource](../VS_visualcpp/COleDataSource-Class.md) object containing the Clipboard data.  
...
### Parameters  
 *rClipRect*  
 Pointer to an object of class [CRect](../VS_visualcpp/CRect-Class.md) that will hold the clipping-rectangle coordinates of the item.  
...
### Parameters  
 `rPosition`  
 Reference to the [CRect](../VS_visualcpp/CRect-Class.md) object that will contain the item's position coordinates.  
...
### Remarks  
 ...
 If the container is an MDI application, the default implementation returns a pointer to the [CMDIFrameWnd](../VS_visualcpp/CMDIFrameWnd-Class.md) object in `ppMainFrame` and a pointer to the active [CMDIChildWnd](../VS_visualcpp/CMDIChildWnd-Class.md) object in `ppDocFrame`. If the container is an SDI application, the default implementation returns a pointer to the [CFrameWnd](../VS_visualcpp/CFrameWnd-Class.md) object in `ppMainFrame` and returns **NULL** in `ppDocFrame`. The default implementation also fills in the members of `lpFrameInfo`.  
...
### Remarks  
 ...
 If the server application is written with the Microsoft Foundation Class Libraries, this function causes the server to call [COleServerDoc::OnReactivateAndUndo](../VS_visualcpp/COleServerDoc-Class.md#coleserverdoc__onreactivateandundo).  
...
### Parameters  
 `size`  
 A [CSize](../VS_visualcpp/CSize-Class.md) object that contains the size information.  
...
## See Also  
 [MFC Sample MFCBIND](../VS_visualcpp/Visual-C---Samples.md)   
