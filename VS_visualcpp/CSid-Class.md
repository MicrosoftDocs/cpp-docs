...
### Remarks  
 ...
 If initialization fails, the constructor will throw a [CAtlException Class](../VS_visualcpp/CAtlException-Class.md).  
...
##  <a name="csid__csidarray"></a>  CSid::CSidArray  
 An array of [CSid](../VS_visualcpp/CSid-Class.md) objects.  
...
```  
bool EqualPrefix(  
    const SID & rhs ) const throw();  
  
    bool EqualPrefix(  
    const CSid & rhs ) const throw();  
```  
...
## See Also  
 ...
 [Operators](../VS_visualcpp/ATL-Operators.md)