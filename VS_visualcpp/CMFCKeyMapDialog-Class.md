...
## Inheritance Hierarchy  
 ...
 [CMFCKeyMapDialog](../VS_visualcpp/CMFCKeyMapDialog-Class.md)  
...
### Example  
 The following example demonstrates how to construct an object of the `CMFCKeyMapDialog` class. This example is part of the [Visual Studio Demo sample](../VS_visualcpp/Visual-C---Samples.md).  
...
### Return Value  
 If successful, the height of the printed text. For more information, see the Return Value section of [CDC::DrawText](../VS_visualcpp/CDC-Class.md#cdc__drawtext).  
