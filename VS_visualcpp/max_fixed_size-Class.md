...
Describes a [max class](../VS_visualcpp/-allocators-.md) object that limits a [freelist](../VS_visualcpp/freelist-Class.md) object to a fixed maximum length.  
...
### Remarks  
 Decrements the stored value `_Nblocks`. The `released` member function of the current [max class](../VS_visualcpp/-allocators-.md) is called by `cache_freelist::allocate` whenever it removes a memory block from the free list.  
