...
### Remarks  
 ...
 For more information about the `LPDISPATCH` type, see [Implementing the IDispatch Interface](assetId:///0e171f7f-0022-4e9b-ac8e-98192828e945) in the Windows SDK.  
...
|**VT_UNKNOWN**|`LPUNKNOWN`|  
 ...
 This function converts the parameters to **VARIANTARG** values, then invokes the                         [IDispatch::Invoke](http://msdn.microsoft.com/library/windows/desktop/ms221479\(v=vs.85\).aspx) method. If the call to `Invoke` fails, this function will throw an exception. If the `SCODE` (status code) returned by **IDispatch::Invoke** is `DISP_E_EXCEPTION`, this function throws a [COleException](../VS_visualcpp/COleException-Class.md) object; otherwise it throws a [COleDispatchException](../VS_visualcpp/COleDispatchException-Class.md).  
...
### Remarks  
 ...
 For more information, see [IDispatch](assetId:///0e171f7f-0022-4e9b-ac8e-98192828e945) in the Windows SDK.  
