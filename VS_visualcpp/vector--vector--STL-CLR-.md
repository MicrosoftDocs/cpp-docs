...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[vector::begin (STL/CLR)](../VS_visualcpp/vector--begin--STL-CLR-.md)`(),` `right``.`[vector::end (STL/CLR)](../VS_visualcpp/vector--end--STL-CLR-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the vector object `right`.  
  
 The constructor:  
  
 `vector(vector<Value>^ right);`  
  
 initializes the controlled sequence with the sequence `[``right``->`[vector::begin (STL/CLR)](../VS_visualcpp/vector--begin--STL-CLR-.md)`(),` `right``->`[vector::end (STL/CLR)](../VS_visualcpp/vector--end--STL-CLR-.md)`())`. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the vector object whose handle is `right`.  
