...
-   Deriving from [IDispatchImpl](../VS_visualcpp/IDispatchImpl-Class.md) for dual interfaces described in a type library.  
  
-   Deriving from [IDispEventImpl](../VS_visualcpp/IDispEventImpl-Class.md) for dispinterfaces described in a type library.  
  
-   Deriving from [IDispEventSimpleImpl](../VS_visualcpp/IDispEventSimpleImpl-Class.md) for dispinterfaces not described in a type library or when you want to improve efficiency by not loading the type information at run time.  
