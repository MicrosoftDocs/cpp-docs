...
---
# Support for Unicode
Unicode is a specification for supporting all character sets, including those that cannot be represented in just one byte. If you are programming for an international market, we recommend that you use either Unicode or [multibyte character sets](../VS_visualcpp/Support-for-Multibyte-Character-Sets--MBCSs-.md) (MBCSs), or enable your program so you can build it for either by changing a switch.  
...
-   [Install Unicode support via MFC](../VS_visualcpp/Unicode-in-MFC.md)  
  
-   [Enable Unicode in my program](../VS_visualcpp/International-Enabling.md)  
  
-   [Enable both Unicode and MBCS in my program](../VS_visualcpp/Internationalization-Strategies.md)  
  
-   [Use Unicode to create an internationalized program](../VS_visualcpp/Unicode-Programming-Summary.md)  
  
-   [Learn the benefits of Unicode, including how using Unicode makes my program more efficient on Windows 2000](../VS_visualcpp/Benefits-of-Character-Set-Portability.md)  
  
-   [Use wmain so I can pass wide-character arguments to my program](../VS_visualcpp/Support-for-Using-wmain.md)  
  
-   [See a summary of Unicode programming](../VS_visualcpp/Unicode-Programming-Summary.md)  
