...
## Remarks  
 You can attach a `CMFCFontInfo` object to an item of the [CMFCToolBarFontComboBox Class](../VS_visualcpp/CMFCToolBarFontComboBox-Class.md) class. Call the [CMFCToolBarFontComboBox::GetFontDesc](../VS_visualcpp/CMFCToolBarFontComboBox-Class.md#cmfctoolbarfontcombobox__getfontdesc) method to retrieve a pointer to a `CMFCFontInfo` object.  
  
## Example  
 The following example demonstrates how to use various members of the `CMFCFontInfo` class. The example demonstrates how to get a `CMFCFontInfo` object from a `CMFCRibbonFontComboBox`, and how to access its local variables. This example is part of the [MSOffice 2007 Demo sample](../VS_visualcpp/Visual-C---Samples.md).  
