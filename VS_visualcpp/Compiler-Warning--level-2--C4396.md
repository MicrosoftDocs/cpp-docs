...
"name" : the inline specifier cannot be used when a friend declaration refers to a specialization of a function template  
 ...
 A specialization of a function template cannot specify any of the [inline](../Topic/inline,%20__inline,%20__forceinline.md) specifiers. The compiler issues warning C4396 and ignores the inline specifier.  
