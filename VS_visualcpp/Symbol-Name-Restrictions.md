...
-   All [symbols](../VS_visualcpp/Symbols--Resource-Identifiers.md) must be unique within the scope of the application. This prevents conflicting symbol definitions in the header files.  
