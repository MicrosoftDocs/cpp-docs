...
'type' : invalid operand for operator  
 ...
 An invalid parameter was passed to the [__typeof](../Topic/__typeof.md) or [typeid](../VS_visualcpp/typeid---C---Component-Extensions-.md) operator. The parameter must be a managed type.  
