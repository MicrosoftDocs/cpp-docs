...
This article describes datagram sockets, one of the two Windows Socket types available. (The other type is the [stream socket](../VS_visualcpp/Windows-Sockets--Stream-Sockets.md).)  
