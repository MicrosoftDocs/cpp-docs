...
> [!NOTE]
>  For C++ programs, C++ exception handling should be used instead of structured exception handling. For more information, see [Exception Handling](../VS_visualcpp/Exception-Handling-in-Visual-C--.md) in the *C++ Language Reference*.  
...
## Example  
 Following is an example of an exception handler and a termination handler. See [The try-finally Statement](../VS_visualcpp/try-finally-Statement--C-.md) for more information about termination handlers.  
