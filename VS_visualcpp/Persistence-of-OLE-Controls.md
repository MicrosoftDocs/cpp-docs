...
### Parameters  
 `pPX`  
 Pointer to the                                 [CPropExchange](../VS_visualcpp/CPropExchange-Class.md) object (typically passed as a parameter to                                 `DoPropExchange`).  
...
##  <a name="px_datapath"></a>  PX_DataPath  
 Call this function within your control's                 `DoPropExchange` member function to serialize or initialize a data path property of type                 [CDataPathProperty](../VS_visualcpp/CDataPathProperty-Class.md).  
...
### Parameters  
 ...
 `pict`  
 Reference to a                                 [CPictureHolder](../VS_visualcpp/CPictureHolder-Class.md) object where the property is stored (typically a member variable of your class).  
