...
##  <a name="io_errc_enumeration"></a>  io_errc Enumeration  
 Provides symbolic names for the error conditions in <iostream\>. Can be used to create [error_condition](../VS_visualcpp/error_condition-Class.md) objects to be compared with the value that's returned by the [ios_base::failure](../VS_visualcpp/ios_base-Class.md#ios_base__failure)`code()` function.  
...
### Remarks  
 Both [std::make_error_code()](../VS_visualcpp/-system_error--functions.md#make_error_code) and [std::make_error_condition()](../VS_visualcpp/-system_error--functions.md#make_error_condition) are overloaded for this enum.  
