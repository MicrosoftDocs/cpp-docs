...
The multithreaded classes provided with MFC fall into two categories: synchronization objects ([CSyncObject](../VS_visualcpp/CSyncObject-Class.md), [CSemaphore](../VS_visualcpp/CSemaphore-Class.md), [CMutex](../VS_visualcpp/CMutex-Class.md), [CCriticalSection](../VS_visualcpp/CCriticalSection-Class.md), and [CEvent](../VS_visualcpp/CEvent-Class.md)) and synchronization access objects ([CMultiLock](../VS_visualcpp/CMultiLock-Class.md) and [CSingleLock](../VS_visualcpp/CSingleLock-Class.md)).  
...
## Example 2: Using Synchronization Access Classes  
 ...
 For information about how the synchronization classes are used, see [Multithreading: How to Use the Synchronization Classes](../VS_visualcpp/Multithreading--How-to-Use-the-Synchronization-Classes.md). For information about synchronization, see [Synchronization](http://msdn.microsoft.com/library/windows/desktop/ms686353) in the Windows SDK. For information about multithreading support in MFC, see [Multithreading with C++ and MFC](../VS_visualcpp/Multithreading-with-C---and-MFC.md).  
