...
|[CMFCToolBarImages::CreateFromImageList](#cmfctoolbarimages__createfromimagelist)|Initializes the toolbar images from an image list ( [CImageList Class](../VS_visualcpp/CImageList-Class.md)).|  
...
## Inheritance Hierarchy  
 ...
 [CMFCToolBarImages](../VS_visualcpp/CMFCToolBarImages-Class.md)  
...
### Parameters  
 ...
 [in] `bSetBitPerPixel`  
 `TRUE` if the [CMFCToolBarImages](../VS_visualcpp/CMFCToolBarImages-Class.md) object uses the color depth (bits per pixel) of the new image; `FALSE` if the `CMFCToolbarImages` object keeps the current color depth.  
...
### Return Value  
 The number of toolbar images that the [CMFCToolBarImages](../VS_visualcpp/CMFCToolBarImages-Class.md) object maintains after the new bitmap was added successfully; -1 if the operation failed.  
...
##  <a name="cmfctoolbarimages__clear"></a>  CMFCToolBarImages::Clear  
 Frees the system resources that the [CMFCToolbarImages](../VS_visualcpp/CMFCToolBarImages-Class.md) object allocated.  
...
##  <a name="cmfctoolbarimages__createfromimagelist"></a>  CMFCToolBarImages::CreateFromImageList  
 Initializes the toolbar images from a [CImageList Class](../VS_visualcpp/CImageList-Class.md) object.  
...
### Return Value  
 The number of images in the [CMFCToolbarImages](../VS_visualcpp/CMFCToolBarImages-Class.md) object.  
...
### Remarks  
 The size of the source image is the size of the images that are stored in the [CMFCToolbarImages](../VS_visualcpp/CMFCToolBarImages-Class.md) object. You can call [CMFCToolBarImages::SetImageSize](#cmfctoolbarimages__setimagesize) to set the source size. The default value is 16x15 pixels.  
...
### Return Value  
 `TRUE` if the [CMFCToolbarImages](../VS_visualcpp/CMFCToolBarImages-Class.md) object contains user-defined toolbar images; otherwise `FALSE`.  
...
### Return Value  
 `TRUE` if a [CMFCToolbarImages](../VS_visualcpp/CMFCToolBarImages-Class.md) object is valid; otherwise `FALSE`.  
