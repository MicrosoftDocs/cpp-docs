...
---
# Failure Hooks
The failure hook is enabled in the same manner as the [notification hook](../VS_visualcpp/Notification-Hooks.md). The hook routine needs to return a suitable value so that processing can continue (an HINSTANCE or FARPROC) or 0 to indicate that an exception should be thrown.  
