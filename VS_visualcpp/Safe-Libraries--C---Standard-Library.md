...
Several enhancements have been made to the libraries that ship with Visual C++, including the Standard C++ Library, to make them more secure.  
 ...
 Several enhancements have also been made to make iterators and algorithms more secure. For more information, see [Checked Iterators](../VS_visualcpp/Checked-Iterators.md), [Debug Iterator Support](../VS_visualcpp/Debug-Iterator-Support.md) and [_ITERATOR_DEBUG_LEVEL](../VS_visualcpp/_ITERATOR_DEBUG_LEVEL.md).  
