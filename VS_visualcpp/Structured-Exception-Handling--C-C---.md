 ...
 **Throwing C++ exception**  
**Destroying TestClass!**  
**Executing SEH __except block** For more information, see [/EH (Exception Handling Model)](../VS_visualcpp/-EH--Exception-Handling-Model-.md).  
