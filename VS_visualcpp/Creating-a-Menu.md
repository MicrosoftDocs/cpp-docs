...
2.  Select the **New Item** box (the rectangle that contains "Type Here") on the menu bar.  
     ...
     ![New Item box in the menu editor](../VS_visualcpp/media/vcMenuEditorNewItemBox.gif "vcMenuEditorNewItemBox")  
New Item Box  
...
3.  Type a name for your new menu, for example, "File".  
     ...
     ![Expanded New Item box](../VS_visualcpp/media/vcMenuEditorNewItemBoxExpanded.gif "vcMenuEditorNewItemBoxExpanded")  
