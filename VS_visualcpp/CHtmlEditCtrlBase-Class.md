 ...
 **CHtmlEditCtrlBase** is not intended to stand on its own. It is designed to be a base class for derived classes that expose the HTML editing functionality of the WebBrowser (see [CHtmlEditCtrl](../VS_visualcpp/CHtmlEditCtrl-Class.md) and [CHtmlEditView](../VS_visualcpp/CHtmlEditView-Class.md)).  
