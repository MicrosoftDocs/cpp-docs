...
### Remarks  
 ...
 At some point in the future, you must call the [CurrentScheduler::Detach](../VS_visualcpp/CurrentScheduler-Class.md#currentscheduler__detach_method) method in order to allow the scheduler to shut down.  
 ...
 This method will throw an [improper_scheduler_attach](../VS_visualcpp/improper_scheduler_attach-Class.md) exception if this scheduler is the current scheduler of the calling context.  
...
### Remarks  
 ...
 The method will throw an [improper_scheduler_reference](../VS_visualcpp/improper_scheduler_reference-Class.md) exception if the reference count prior to calling the `Reference` method was zero and the call is made from a context that is not owned by the scheduler.  
...
### Remarks  
 If the `SetDefaultSchedulerPolicy` method is called when a default scheduler already exists within the process, the runtime will throw a [default_scheduler_exists](../VS_visualcpp/default_scheduler_exists-Class.md) exception.  
