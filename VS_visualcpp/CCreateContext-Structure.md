...
-   For member functions involved in view creation, you must provide enough information to create the view. For example, for the first view in a splitter window, you must supply the view class information and the current document.  
 ...
 For more information on `CCreateContext`, see the MFC sample [VIEWEX](../VS_visualcpp/Visual-C---Samples.md).  
...
## See Also  
 ...
 [CFrameWnd::Create](../VS_visualcpp/CFrameWnd-Class.md#cframewnd__create)   
 [CFrameWnd::LoadFrame](../VS_visualcpp/CFrameWnd-Class.md#cframewnd__loadframe)   
 [CFrameWnd::OnCreateClient](../VS_visualcpp/CFrameWnd-Class.md#cframewnd__oncreateclient)   
 [CSplitterWnd::Create](../VS_visualcpp/CSplitterWnd-Class.md#csplitterwnd__create)   
 [CSplitterWnd::CreateView](../VS_visualcpp/CSplitterWnd-Class.md#csplitterwnd__createview)   
 [CWnd::Create](../VS_visualcpp/CWnd-Class.md#cwnd__create)