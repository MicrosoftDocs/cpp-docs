...
## Remarks  
 Two predefined objects implement `error_category`: [generic_category](../VS_visualcpp/-system_error--functions.md#generic_category) and [system_category](../VS_visualcpp/-system_error--functions.md#system_category).  
...
|[operator<](#error_category__operator_lt_)|Tests if the [error_category](../VS_visualcpp/error_category-Class.md) object is less than the `error_category` object passed in for comparison.|  
...
|---------------|-----------------|  
|`_Errval`|The error code value to store in the [error_condition](../VS_visualcpp/error_condition-Class.md).|  
...
|`_Cond`|The [error_condition](../VS_visualcpp/error_condition-Class.md) object to compare.|  
|`_Code`|The [error_code](../VS_visualcpp/error_code-Class.md) object to compare.|  
...
##  <a name="error_category__operator_lt_"></a>  error_category::operator&lt;  
 Tests if the [error_category](../VS_visualcpp/error_category-Class.md) object is less than the `error_category` object passed in for comparison.  
