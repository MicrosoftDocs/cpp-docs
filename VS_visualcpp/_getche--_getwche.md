...
## Remarks  
 ...
 These functions lock the calling thread and are therefore thread-safe. For non-locking versions, see [_getche_nolock, _getwche_nolock](../VS_visualcpp/_getche_nolock--_getwche_nolock.md).  
