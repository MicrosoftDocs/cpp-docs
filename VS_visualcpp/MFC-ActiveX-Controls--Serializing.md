...
|**PX_UShort( )**|Serializes a type **USHORT** property.|  
 ...
 For more information on these property exchange functions, see [Persistence of OLE Controls](../VS_visualcpp/Persistence-of-OLE-Controls.md) in the *MFC Reference*.  
