...
## Remarks  
 ...
 To access resources controlled by `CSemaphore` objects in this manner, first create a variable of either type [CSingleLock](../VS_visualcpp/CSingleLock-Class.md) or type [CMultiLock](../VS_visualcpp/CMultiLock-Class.md) in your resource's access member function. Then call the lock object's `Lock` member function (for example, [CSingleLock::Lock](../VS_visualcpp/CSingleLock-Class.md#csinglelock__lock)). At this point, your thread will either gain access to the resource, wait for the resource to be released and gain access, or wait for the resource to be released and time out, failing to gain access to the resource. In any case, your resource has been accessed in a thread-safe manner. To release the resource, use the lock object's `Unlock` member function (for example, [CSingleLock::Unlock](../VS_visualcpp/CSingleLock-Class.md#csinglelock__unlock)), or allow the lock object to fall out of scope.  
 ...
 For more information on how to use **CSemaphore** objects, see the article [Multithreading: How to Use the Synchronization Classes](../VS_visualcpp/Multithreading--How-to-Use-the-Synchronization-Classes.md).  
...
### Remarks  
 To access or release a `CSemaphore` object, create a [CMultiLock](../VS_visualcpp/CMultiLock-Class.md) or [CSingleLock](../VS_visualcpp/CSingleLock-Class.md) object and call its [Lock](../VS_visualcpp/CSingleLock-Class.md#csinglelock__lock) and [Unlock](../VS_visualcpp/CSingleLock-Class.md#csinglelock__unlock) member functions.  
