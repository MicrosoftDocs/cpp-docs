...
### Parameters  
 `pItem`  
 Pointer to the linked [COleClientItem](../VS_visualcpp/COleClientItem-Class.md) whose source is to be updated.  
...
-   **IDABORT** if an error occurred. If **IDABORT** is returned, call the [COleDialog::GetLastError](../VS_visualcpp/COleDialog-Class.md#coledialog__getlasterror) member function to get more information about the type of error that occurred. For a listing of possible errors, see the                                 [OleUIChangeSource](http://msdn.microsoft.com/library/windows/desktop/ms682497) function in Windows SDK.  
...
### Return Value  
 The complete source display name (moniker) for the [COleClientItem](../VS_visualcpp/COleClientItem-Class.md) specified in the constructor.  
...
### Return Value  
 The file moniker portion of the source display name for the [COleClientItem](../VS_visualcpp/COleClientItem-Class.md) specified in the constructor.  
...
### Return Value  
 The item moniker portion of the source display name for the [COleClientItem](../VS_visualcpp/COleClientItem-Class.md) specified in the constructor.  
