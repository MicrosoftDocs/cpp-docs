...
-   For most purposes, URNGs produce raw bits that must be shaped by distributions. (A notable exception to this is [std::shuffle()](../VS_visualcpp/-algorithm--functions.md#std__shuffle) because it uses a URNG directly.)  
  
-   A single instantiation of a URNG or distribution cannot safely be called concurrently because running a URNG or distribution is a modifying operation. For more information, see [Thread Safety in the C++ Standard Library](../VS_visualcpp/Thread-Safety-in-the-C---Standard-Library.md).  
...
|||  
|-|-|  
|[random_device Class](../VS_visualcpp/random_device-Class.md)|Generates a non-deterministic, cryptographically secure random sequence by using an external device. Usually used to seed an engine. Low performance, very high quality. For more information, see [Remarks](#comments).|  
...
|||  
|-|-|  
|[linear_congruential_engine Class](../VS_visualcpp/linear_congruential_engine-Class.md)|Generates a random sequence by using the linear congruential algorithm. Most simplistic and lowest quality.|  
|[mersenne_twister_engine Class](../VS_visualcpp/mersenne_twister_engine-Class.md)|Generates a random sequence by using the Mersenne twister algorithm. Most complex, and is highest quality except for the random_device class. Very fast performance.|  
|[subtract_with_carry_engine Class](../VS_visualcpp/subtract_with_carry_engine-Class.md)|Generates a random sequence by using the subtract-with-carry algorithm. An improvement on `linear_congruential_engine`, but much lower quality and performance than `mersenne_twister_engine`.|  
...
|||  
|-|-|  
|[discard_block_engine Class](../VS_visualcpp/discard_block_engine-Class.md)|Generates a random sequence by discarding values returned by its base engine.|  
|[independent_bits_engine Class](../VS_visualcpp/independent_bits_engine-Class.md)|Generates a random sequence with a specified number of bits by repacking bits from the values returned by its base engine.|  
|[shuffle_order_engine Class](../VS_visualcpp/shuffle_order_engine-Class.md)|Generates a random sequence by reordering the values returned from its base engine.|  
...
|||  
|-|-|  
|[uniform_int_distribution Class](../VS_visualcpp/uniform_int_distribution-Class.md)|Produces a uniform integer value distribution across a range in the closed interval [a, b] (inclusive- inclusive).|  
|[uniform_real_distribution Class](../VS_visualcpp/uniform_real_distribution-Class.md)|Produces a uniform real (floating-point) value distribution across a range in the interval [a, b) (inclusive-exclusive).|  
|[generate_canonical](../VS_visualcpp/-random--functions.md#generate_canonical)|Produces an even distribution of real (floating point) values of a given precision across [0, 1) (inclusive-exclusive).|  
...
|||  
|-|-|  
|[bernoulli_distribution Class](../VS_visualcpp/bernoulli_distribution-Class.md)|Produces a Bernoulli distribution of `bool` values.|  
|[binomial_distribution Class](../VS_visualcpp/binomial_distribution-Class.md)|Produces a binomial distribution of integer values.|  
|[geometric_distribution Class](../VS_visualcpp/geometric_distribution-Class.md)|Produces a geometric distribution of integer values.|  
|[negative_binomial_distribution Class](../VS_visualcpp/negative_binomial_distribution-Class.md)|Produces a negative binomial distribution of integer values.|  
...
|||  
|-|-|  
|[cauchy_distribution Class](../VS_visualcpp/cauchy_distribution-Class.md)|Produces a Cauchy distribution of real (floating point) values.|  
|[chi_squared_distribution Class](../VS_visualcpp/chi_squared_distribution-Class.md)|Produces a chi-squared distribution of real (floating point) values.|  
|[fisher_f_distribution Class](../VS_visualcpp/fisher_f_distribution-Class.md)|Produces an F-distribution (also known as Snedecor's F distribution or the Fisher–Snedecor distribution) of real (floating point) values.|  
|[lognormal_distribution Class](../VS_visualcpp/lognormal_distribution-Class.md)|Produces a log-normal distribution of real (floating point) values.|  
|[normal_distribution Class](../VS_visualcpp/normal_distribution-Class.md)|Produces a normal (Gaussian) distribution of real (floating point) values.|  
|[student_t_distribution Class](../VS_visualcpp/student_t_distribution-Class.md)|Produces a Student's *t*-distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[exponential_distribution Class](../VS_visualcpp/exponential_distribution-Class.md)|Produces an exponential distribution of real (floating point) values.|  
|[extreme_value_distribution Class](../VS_visualcpp/extreme_value_distribution-Class.md)|Produces an extreme value distribution of real (floating point) values.|  
|[gamma_distribution Class](../VS_visualcpp/gamma_distribution-Class.md)|Produces a gamma distribution of real (floating point) values.|  
|[poisson_distribution Class](../VS_visualcpp/poisson_distribution-Class.md)|Produces a Poisson distribution of integer values.|  
|[weibull_distribution Class](../VS_visualcpp/weibull_distribution-Class.md)|Produces a Weibull distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[discrete_distribution Class](../VS_visualcpp/discrete_distribution-Class.md)|Produces a discrete integer distribution.|  
|[piecewise_constant_distribution Class](../VS_visualcpp/piecewise_constant_distribution-Class.md)|Produces a piecewise constant distribution of real (floating point) values.|  
|[piecewise_linear_distribution Class](../VS_visualcpp/piecewise_linear_distribution-Class.md)|Produces a piecewise linear distribution of real (floating point) values.|  
...
|||  
|-|-|  
|[seed_seq Class](../VS_visualcpp/seed_seq-Class.md)|Generates a non-biased scrambled seed sequence. Used to avoid replication of random variate streams. Useful when many URNGs are instantiated from engines.|  
...
-   `template <class Seq> void seed(Seq& q)` seeds the generator by using a [seed_seq](../VS_visualcpp/seed_seq-Class.md)`Seq`.  
