...
## Example  
 C2039 can occur when you try to release managed or unmanaged resources. For more information, see [Destructors and finalizers](../VS_visualcpp/How-to--Define-and-Consume-Classes-and-Structs--C---CLI-.md#BKMK_Destructors_and_finalizers).  
