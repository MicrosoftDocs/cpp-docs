...
## Remarks  
 ...
 initializes the controlled sequence with the sequence `[``right``.`[multimap::begin (STL/CLR)](../VS_visualcpp/multimap--begin--STL-CLR-.md)`(),` `right``.`[multimap::end (STL/CLR)](../VS_visualcpp/multimap--end--STL-CLR-.md)`())`, with the default ordering predicate. You use it to specify an initial controlled sequence that is a copy of the sequence controlled by the multimap object `right`, with the default ordering predicate.  
