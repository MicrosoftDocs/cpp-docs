...
```  
 ...
 In C++, you can use the **const** keyword instead of the [#define](../VS_visualcpp/#define-Directive--C-C---.md) preprocessor directive to define constant values. Values defined with **const** are subject to type checking, and can be used in place of constant expressions. In C++, you can specify the size of an array with a **const** variable as follows:  
...
```  
 ...
 For objects that are declared as **const**, you can only call [constant member functions](../Topic/Constant%20Member%20Functions.md). This ensures that the constant object is never modified.  
...
-   [Constant Values](../Topic/Constant%20Values.md)  
  
-   [Constant Member Functions](../Topic/Constant%20Member%20Functions.md)  
  
-   [const and volatile Pointers](../VS_visualcpp/const-and-volatile-Pointers.md)  
  
-   [Type Qualifiers (C Language Reference)](../VS_visualcpp/Type-Qualifiers.md)  
  
-   [volatile](../VS_visualcpp/volatile--C---.md)  
  
-   [#define](../VS_visualcpp/#define-Directive--C-C---.md).  
