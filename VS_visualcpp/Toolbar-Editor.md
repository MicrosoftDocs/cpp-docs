...
-   [Create new toolbars and buttons](../VS_visualcpp/Creating-New-Toolbars.md)  
  
-   [Convert bitmaps to toolbar resources](../VS_visualcpp/Converting-Bitmaps-to-Toolbars.md)  
  
-   [Create, move, and edit toolbar buttons](../VS_visualcpp/Creating--Moving--and-Editing-Toolbar-Buttons.md)  
  
-   [Create Tool Tips](../VS_visualcpp/Creating-a-Tool-Tip-for-a-Toolbar-Button.md)  
