---
title: "Associating an Accelerator Key with a Menu Item"
ms.custom: na
ms.date: 10/03/2016
ms.devlang: 
  - C++
...
Many times, you want a menu item and a keyboard combination to issue the same program command. You do this by assigning the same resource identifier (ID) to the menu item and to an entry in your application's accelerator table. You then edit the menu item's caption to show the name of the accelerator. For more information on menu items and accelerator keys, see [Associating a Menu Item with an Accelerator Key](../VS_visualcpp/Associating-a-Menu-Command-with-an-Accelerator-Key.md).  
