...
## Remarks  
 An object of type `error_code` class stores an error code value and a pointer to an object that represents a [category](../VS_visualcpp/error_category-Class.md) of error codes that describe reported low-level system errors.  
...
### Remarks  
 The member function stores a zero error code value and a pointer to the [generic_category](../VS_visualcpp/-system_error--functions.md#generic_category) object.  
...
### Return Value  
 The [error_condition](../VS_visualcpp/error_condition-Class.md) specified by [default_error_condition](../VS_visualcpp/error_category-Class.md#error_category__default_error_condition).  
...
### Remarks  
 The first constructor stores a zero error code value and a pointer to the [generic_category](../VS_visualcpp/-system_error--functions.md#generic_category).  
 ...
 The third constructor stores `(value_type)_Errcode` as the error code value and a pointer to the [generic_category](../VS_visualcpp/-system_error--functions.md#generic_category).  
...
### Remarks  
 The member operator stores `(value_type)_Errcode` as the error code value and a pointer to the [generic_category](../VS_visualcpp/-system_error--functions.md#generic_category). It returns `*this`.  
