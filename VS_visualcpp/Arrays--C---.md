...
-   Optional additional brackets enclosing constant expressions.  
 ...
 3. An optional initializer.  See [Initializers](../VS_visualcpp/Initializers.md).  
...
```  
 ...
 ![Conceptual layout of a multi&#45;dimensional array](../VS_visualcpp/media/vc38RC1.gif "vc38RC1")  
Conceptual Layout of Multidimensional Array  
  
 In declarations of multidimensioned arrays that have an initializer list (as described in [Initializers](../VS_visualcpp/Initializers.md)), the constant expression that specifies the bounds for the first dimension can be omitted. For example:  
...
-   [Using Arrays](../VS_visualcpp/Using-Arrays--C---.md)  
