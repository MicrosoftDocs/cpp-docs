...
```  
 ...
 A *literal* is a constant primary expression. Its type depends on the form of its specification. See [Literals](../VS_visualcpp/Numeric--Boolean-and-Pointer-Literals---C---.md) for complete information about specifying literals.  
