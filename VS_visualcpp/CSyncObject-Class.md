...
## Remarks  
 The Microsoft Foundation Class Library provides several classes derived from `CSyncObject`. These are [CEvent](../VS_visualcpp/CEvent-Class.md), [CMutex](../VS_visualcpp/CMutex-Class.md), [CCriticalSection](../VS_visualcpp/CCriticalSection-Class.md), and [CSemaphore](../VS_visualcpp/CSemaphore-Class.md).  
  
 For information on how to use the synchronization objects, see the article [Multithreading: How to Use the Synchronization Classes](../VS_visualcpp/Multithreading--How-to-Use-the-Synchronization-Classes.md).  
