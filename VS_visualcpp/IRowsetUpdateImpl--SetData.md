...
## Remarks  
 This method overrides the [IRowsetChangeImpl::SetData](../VS_visualcpp/IRowsetChangeImpl--SetData.md) method but includes caching of original data to permit either immediate or deferred processing of the operation.  
