...
The Properties window enables you to bind message handlers (member functions of MFC user-interface classes) to the messages generated by your application's resources. They use [MFC message maps](../VS_visualcpp/Messages-and-Commands-in-the-Framework.md) to create the binding.  
