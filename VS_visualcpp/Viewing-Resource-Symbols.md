...
1.  In [Resource View](../VS_visualcpp/Resource-View-Window.md), right-click your .rc file.  
...
2.  Select **Resource Symbols** from the shortcut menu to view a resource symbol table in the [Resource Symbols dialog box](../VS_visualcpp/Resource-Symbols-Dialog-Box.md).  
