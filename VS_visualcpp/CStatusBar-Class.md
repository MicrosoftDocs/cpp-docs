...
1.  Call [CWnd::SetWindowText](../VS_visualcpp/CWnd-Class.md#cwnd__setwindowtext) to update the text in pane 0 only.  
  
2.  Call [CCmdUI::SetText](../VS_visualcpp/CCmdUI-Class.md#ccmdui__settext) in the status bar's `ON_UPDATE_COMMAND_UI` handler.  
...
3.  Call [SetPaneText](#cstatusbar__setpanetext) to update the text for any pane.  
 ...
 For more information on using `CStatusBar`, see the article [Status Bar Implementation in MFC](../VS_visualcpp/Status-Bar-Implementation-in-MFC.md) and [Technical Note 31 : Control Bars](../VS_visualcpp/TN031--Control-Bars.md).  
...
### Parameters  
 `pParentWnd`  
 Pointer to the [CWnd](../VS_visualcpp/CWnd-Class.md) object whose Windows window is the parent of the status bar.  
  
 `dwStyle`  
 The status-bar style. In addition to the standard Windows [styles](../VS_visualcpp/Window-Styles.md), these styles are supported.  
...
### Parameters  
 ...
 `dwCtrlStyle`  
 Additional styles for the creation of the embedded [CStatusBarCtrl](../VS_visualcpp/CStatusBarCtrl-Class.md) object. The default specifies a status bar without a sizing grip or tooltip support. Status bar styles supported are:  
...
-   **SBT_TOOLTIPS** The status bar supports tooltips.  
 ...
 For details on these styles, see [Settings for the CStatusBarCtrl](../VS_visualcpp/Settings-for-the-CStatusBarCtrl.md).  
  
 `dwStyle`  
 The status bar style. The default specifies that a visible status bar be created at the bottom of the frame window. Apply any combination of status bar control styles listed in [Window Styles](../VS_visualcpp/Window-Styles.md) and [CDialogBar::Create](../VS_visualcpp/CDialogBar-Class.md#cdialogbar__create). However, this parameter should always include the WS_CHILD and WS_VISIBLE styles.  
...
### Parameters  
 ...
 `lpRect`  
 Points to a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure or a [CRect](../VS_visualcpp/CRect-Class.md) object that will receive the coordinates of the indicator specified by `nIndex`.  
...
### Parameters  
 ...
 `rString`  
 A reference to a [CString](../VS_visualcpp/CStringT-Class.md) object that contains the text to be retrieved.  
...
### Return Value  
 Contains a reference to a [CStatusBarCtrl](../VS_visualcpp/CStatusBarCtrl-Class.md) object.  
  
### Remarks  
 Use `GetStatusBarCtrl` to take advantage of the functionality of the Windows status-bar common control, and to take advantage of the support [CStatusBarCtrl](../VS_visualcpp/CStatusBarCtrl-Class.md) provides for status-bar customization. For example, by using the common control, you can specify a style that includes a sizing grip on the status bar, or you can specify a style to have the status bar appear at the top of the parent window's client area.  
...
## See Also  
 ...
 [MFC Sample DLGCBR32](../VS_visualcpp/Visual-C---Samples.md)   
 [CControlBar Class](../VS_visualcpp/CControlBar-Class.md)   
 [Hierarchy Chart](../VS_visualcpp/Hierarchy-Chart.md)   
 [CStatusBarCtrl Class](../VS_visualcpp/CStatusBarCtrl-Class.md)   
 [CControlBar Class](../VS_visualcpp/CControlBar-Class.md)   
 [CWnd::SetWindowText](../VS_visualcpp/CWnd-Class.md#cwnd__setwindowtext)   
