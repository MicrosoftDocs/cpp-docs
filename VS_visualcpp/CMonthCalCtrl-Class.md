...
-   Picking a month or a year from a pop-up menu.  
 ...
 For more information on using the month calendar control, see [Using CMonthCalCtrl](../VS_visualcpp/Using-CMonthCalCtrl.md).  
...
### Parameters  
 ...
 `pParentWnd`  
 A pointer to a [CWnd](../VS_visualcpp/CWnd-Class.md) object that is the parent window of the month calendar control. It must not be **NULL**.  
...
1.  Call [CMonthCalCtrl](../VS_visualcpp/CMonthCalCtrl-Class.md) to construct a `CMonthCalCtrl` object.  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) object or a [CTime](../VS_visualcpp/CTime-Class.md) object. Receives the current time.  
...
### Parameters  
 `refMinRange`  
 A reference to a [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) or [CTime](../VS_visualcpp/CTime-Class.md) object containing the minimum date allowed.  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) or [CTime](../VS_visualcpp/CTime-Class.md) object indicating the current day.  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) or [CTime](../VS_visualcpp/CTime-Class.md) object indicating the currently-selected month calendar control.  
...
### Parameters  
 `refDateTime`  
 A reference to a [COleDateTime](../VS_visualcpp/COleDateTime-Class.md) object that contains the current date.  
  
 `pDateTime`  
 In the second version, a pointer to a [CTime](../VS_visualcpp/CTime-Class.md) object containing the current date information. In the third version, a pointer to a                                 [SYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/ms724950) structure that contains the current date information.  
