...
## Remarks  
 You can place a **pointers_to_members** pragma in your source file as an alternative to using the [/vmx](../VS_visualcpp/-vmb---vmg--Representation-Method-.md) compiler options or the [inheritance keywords](../VS_visualcpp/Inheritance-Keywords.md).  
