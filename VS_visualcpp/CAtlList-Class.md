...
#### Parameters  
 ...
 `ETraits`  
 The code used to copy or move elements. See [CElementTraits Class](../VS_visualcpp/CElementTraits-Class.md) for more details.  
...
## Remarks  
 ...
 For more information regarding the collection classes available with ATL, see [ATL Collection Classes](../VS_visualcpp/ATL-Collection-Classes.md).  
