...
```  
 ...
 For more information about creating tables, see [Data Source: Programmatically Creating a Table in an ODBC Data Source](../VS_visualcpp/Data-Source--Programmatically-Creating-a-Table-in-an-ODBC-Data-Source.md).  
