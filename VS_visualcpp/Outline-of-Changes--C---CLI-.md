...
## No Double Underscore Keywords  
 ...
 See [Language Keywords (C++/CLI)](../VS_visualcpp/Language-Keywords--C---CLI-.md) for more information.  
...
```  
 ...
 See [Managed Types (C++/CL)](../VS_visualcpp/Managed-Types--C---CL-.md) for more information.  
...
```  
 ...
 See [Declaration of a CLR Reference Class Object](../VS_visualcpp/Declaration-of-a-CLR-Reference-Class-Object.md) for more information.  
...
## Array Declaration  
 ...
 See [Declaration of a CLR Array](../VS_visualcpp/Declaration-of-a-CLR-Array.md) for more information.  
...
```  
 ...
 See [Property Declaration](../VS_visualcpp/Property-Declaration.md) for more information.  
...
```  
 ...
 See [Property Index Declaration](../VS_visualcpp/Property-Index-Declaration.md) for more information.  
...
```  
 ...
 See [Overloaded Operators](../VS_visualcpp/Overloaded-Operators.md) for more information.  
...
```  
 ...
 See [Changes to Conversion Operators](../VS_visualcpp/Changes-to-Conversion-Operators.md) for more information.  
...
```  
 ...
 See [Explicit Override of an Interface Member](../VS_visualcpp/Explicit-Override-of-an-Interface-Member.md) for more information.  
...
```  
 ...
 See [Private Virtual Functions](../VS_visualcpp/Private-Virtual-Functions.md) for more information.  
...
-   In the new syntax, a CLR enum maintains its own scope, which is not the case in Managed Extensions. Previously, enumerators were visible within the containing scope of the enum; now, enumerators are encapsulated within the scope of the enum.  
 ...
 See [CLR Enum Type](../VS_visualcpp/CLR-Enum-Type.md) for more information.  
...
```  
 ...
 See [A Tracking Handle to a Boxed Value](../VS_visualcpp/A-Tracking-Handle-to-a-Boxed-Value.md) for more information.  
...
```  
 ...
 See [Value Type Semantics](../VS_visualcpp/Value-Type-Semantics.md) for more information.  
...
```  
 ...
 See [typeof Goes to T::typeid](../VS_visualcpp/typeof-Goes-to-T--typeid.md) for more information.  
