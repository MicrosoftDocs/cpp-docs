...
-   Create a **CDynLinkLibrary** object if the DLL will be exporting [CRuntimeClass](../VS_visualcpp/CRuntimeClass-Structure.md) objects or has its own custom resources.  
