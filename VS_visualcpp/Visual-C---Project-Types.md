...
|----------------------|-----------------------------|  
|ATL Project|[Creating an ATL Project](../VS_visualcpp/Creating-an-ATL-Project.md)|  
...
|Project template|How to create a project|  
|----------------------|-----------------------------|  
|Empty Project|[Creating Solutions and Projects](../Topic/Creating%20Solutions%20and%20Projects.md)|  
|Custom Wizard|[Creating a Custom Wizard](../VS_visualcpp/Creating-a-Custom-Wizard.md)|  
|Makefile Project|[Creating a Makefile Project](../VS_visualcpp/Creating-a-Makefile-Project.md)|  
  
### MFC  
  
|Project template|How to create a project|  
|----------------------|-----------------------------|  
|MFC ActiveX Control|[Creating an MFC ActiveX Control](../VS_visualcpp/Creating-an-MFC-ActiveX-Control.md)|  
|MFC Application|[Creating an MFC Application](../VS_visualcpp/Creating-an-MFC-Application.md)|  
|MFC DLL|[Creating an MFC DLL Project](../VS_visualcpp/Creating-an-MFC-DLL-Project.md)|  
  
### Test  
  
|Project template|How to create a project|  
|----------------------|-----------------------------|  
|Managed Test Project|[Create a unit test project](../Topic/Create%20a%20unit%20test%20project.md)|  
...
|Project template|How to create a project|  
|----------------------|-----------------------------|  
|Win32 Console Project|[Creating a Console Application](../VS_visualcpp/Creating-a-Console-Application.md)|  
...
## TODO Comments  
 Many of the files generated by a project template contain TODO comments to help you identify where you can provide your own source code. For more information about how to add code, see [Adding Functionality with Code Wizards](../VS_visualcpp/Adding-Functionality-with-Code-Wizards--C---.md) and [Working with Resource Files](../VS_visualcpp/Working-with-Resource-Files.md).  
