...
## Remarks  
 ...
 ![Example of RebarMenu](../VS_visualcpp/media/vc4SC61.gif "vc4SC61")  
 ...
 **CReBar** uses the [CReBarCtrl](../VS_visualcpp/CReBarCtrl-Class.md) class to provide its implementation. You can access the rebar control through [GetReBarCtrl](#crebar__getrebarctrl) to take advantage of the control's customization options. For more information about rebar controls, see `CReBarCtrl`. For more information about using rebar controls, see [Using CReBarCtrl](../VS_visualcpp/Using-CReBarCtrl.md).  
...
### Return Value  
 A reference to a [CReBarCtrl](../VS_visualcpp/CReBarCtrl-Class.md) object.  
...
### Remarks  
 ...
 For more information about using `CReBarCtrl` to customize your rebar, see [Using CReBarCtrl](../VS_visualcpp/Using-CReBarCtrl.md).  
