...
#### Parameters  
 `StringType`  
 The ATL/MFC string class to use for the path (see                         [CStringT](../VS_visualcpp/CStringT-Class.md)).  
...
|[CPathT::IsRoot](../Topic/CPathT::IsRoot.md)|Call this method to determine if the path is a directory root.|  
