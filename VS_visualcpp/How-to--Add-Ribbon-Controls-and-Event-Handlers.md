...
3.  In the **Event Handler Wizard**, confirm the default settings and click **Add and Edit**. For more information, see [Event Handler Wizard](../VS_visualcpp/Event-Handler-Wizard.md).  
...
## See Also  
 [RibbonGadgets Sample: Ribbon Gadgets Application](../VS_visualcpp/Visual-C---Samples.md)   
