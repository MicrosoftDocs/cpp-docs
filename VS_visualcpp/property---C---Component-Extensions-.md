...
-   The set method has a parameter of type `T`, and return type **void**.  
 ...
 `property` is a context-sensitive keyword.  For more information, see [Context-Sensitive Keywords](../VS_visualcpp/Context-Sensitive-Keywords---C---Component-Extensions-.md).  
