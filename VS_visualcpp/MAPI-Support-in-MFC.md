...
> [!TIP]
>  Rather than manually adding message map entries as previously described, you can use the class Properties window to map messages to functions. For more information, see [Mapping Messages to Functions](../VS_visualcpp/Mapping-Messages-to-Functions.md).  
  
 For related information, see the [MAPI](../VS_visualcpp/MAPI.md) overview.  
