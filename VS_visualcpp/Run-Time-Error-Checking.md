...
|--------------|---------|-------------------------------|  
|[_RTC_GetErrDesc](../VS_visualcpp/_RTC_GetErrDesc.md)|Returns a brief description of a run-time error check type.||  
|[_RTC_NumErrors](../VS_visualcpp/_RTC_NumErrors.md)|Returns the total number of errors that can be detected by run-time error checks.||  
|[_RTC_SetErrorFunc](../VS_visualcpp/_RTC_SetErrorFunc.md)|Designates a function as the handler for reporting run-time error checks.||  
|[_RTC_SetErrorType](../VS_visualcpp/_RTC_SetErrorType.md)|Associates an error that is detected by run-time error checks with a type.||  
