...
The **NMake** property page lets you specify build settings for NMake projects.  
 ...
 For more information about NMake projects, see [Creating a Makefile Project](../VS_visualcpp/Creating-a-Makefile-Project.md).  
 ...
 **Additional Options**  
 ...
 For information about how to access the **NMake** property page, see [How to: Specify Project Properties with Property Pages](../Topic/How%20to:%20Specify%20Project%20Properties%20with%20Property%20Pages.md).  
  
 For information about how to programmatically access members of this object, see <xref:Microsoft.VisualStudio.VCProjectEngine.VCNMakeTool?qualifyHint=False>.  
