...
```  
 ...
 C2819 can also occur when using [C++ Stack Semantics for Reference Types](../VS_visualcpp/C---Stack-Semantics-for-Reference-Types.md). The following sample generates C2819:  
