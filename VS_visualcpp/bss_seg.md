...
## Remarks  
 Obj files can be viewed with the [dumpbin](../VS_visualcpp/DUMPBIN-Command-Line.md) application. The default segment in the .obj file for uninitialized data is .bss. In some cases use of **bss_seg** can speed load times by grouping uninitialized data into one section.  
...
```  
 ...
 You can also specify sections for initialized data ([data_seg](../VS_visualcpp/data_seg.md)), functions ([code_seg](../VS_visualcpp/code_seg.md)), and const variables ([const_seg](../VS_visualcpp/const_seg.md)).  
