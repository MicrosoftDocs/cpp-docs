...
## Remarks  
 ...
 Note that there is a behavior change in the [As](../VS_visualcpp/WeakRef--As-Method.md), [AsIID](../VS_visualcpp/WeakRef--AsIID-Method.md) and [CopyTo](../VS_visualcpp/WeakRef--CopyTo-Method.md) methods in the Windows 10 SDK. Previously, after calling any of these methods, you could check the WeakRef for `nullptr` to determine if a strong reference was successfully obtained, as in the following code:  
...
|Name|Description|  
|----------|-----------------|  
|[WeakRef::WeakRef Constructor](../VS_visualcpp/WeakRef--WeakRef-Constructor.md)|Initializes a new instance of the WeakRef class.|  
|[WeakRef::~WeakRef Destructor](../VS_visualcpp/WeakRef--~WeakRef-Destructor.md)|Deinitializes the current instance of the WeakRef class.|  
  
### Public Methods  
  
|Name|Description|  
|----------|-----------------|  
|[WeakRef::As Method](../VS_visualcpp/WeakRef--As-Method.md)|Sets the specified ComPtr pointer parameter to represent the specified interface.|  
|[WeakRef::AsIID Method](../VS_visualcpp/WeakRef--AsIID-Method.md)|Sets the specified ComPtr pointer parameter to represent the specified interface ID.|  
|[WeakRef::CopyTo Method](../VS_visualcpp/WeakRef--CopyTo-Method.md)|Assigns a pointer to an interface, if available, to the specified pointer variable.|  
  
### Public Operators  
  
|Name|Description|  
|----------|-----------------|  
|[WeakRef::operator& Operator](../VS_visualcpp/WeakRef--operator--Operator.md)|Returns a ComPtrRef object that represents the current WeakRef object.|  
