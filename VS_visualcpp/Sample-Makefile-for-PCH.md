...
```  
 ...
 For more information on makefiles, see [NMAKE Reference](../VS_visualcpp/NMAKE-Reference.md). Also see [Compiler Options](../VS_visualcpp/Compiler-Options.md) and the [Linker Options](../VS_visualcpp/Linker-Options.md).  
