...
## Remarks  
 `db_source` creates a [CDataSource](../VS_visualcpp/CDataSource-Class.md) and a [CSession](../VS_visualcpp/CSession-Class.md) object, which together represent a connection with an OLE DB consumer data source.  
