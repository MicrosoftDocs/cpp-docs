---
title: "WeakReference::IncrementStrongReference Method"
ms.custom: na
ms.date: 10/03/2016
ms.devlang: 
  - C++
...
<developerReferenceWithSyntaxDocument xmlns="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://ddue.schemas.microsoft.com/authoring/2003/5 http://clixdevr3.blob.core.windows.net/ddueschema/developer.xsd">
  ...
  <syntaxSection>
    <legacySyntax>ULONG IncrementStrongReference();</legacySyntax>
  </syntaxSection>
  <returnValue>
    <content>
      <para>The incremented strong reference count.</para>
    </content>
  </returnValue>
  <languageReferenceRemarks>
    <content>
      <para>Increments the strong reference count of the current WeakReference object.</para>
    </content>
  </languageReferenceRemarks>
  <requirements>
    <content>
