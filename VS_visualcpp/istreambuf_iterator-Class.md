...
|[traits_type](../VS_visualcpp/istream_iterator-Class.md#istream_iterator__traits_type)|A type that provides for the character traits type of the `istream_iterator`.|  
