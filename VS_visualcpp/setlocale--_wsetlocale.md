...
|`_tsetlocale`|`setlocale`|`setlocale`|`_wsetlocale`|  
 ...
 This function validates the category parameter. If the category parameter is not one of the values given in the previous table, the invalid parameter handler is invoked, as described in [Parameter Validation](../VS_visualcpp/Parameter-Validation.md). If execution is allowed to continue, the function sets `errno` to `EINVAL` and returns `NULL`.  
 ...
 For more information, see the [setlocale](../VS_visualcpp/setlocale.md) pragma directive in the [C/C++ Preprocessor Reference](../VS_visualcpp/C-C---Preprocessor-Reference.md).  
  
 The function [_configthreadlocale](../VS_visualcpp/_configthreadlocale.md) is used to control whether `setlocale` affects the locale of all threads in a program or only the locale of the calling thread.  
