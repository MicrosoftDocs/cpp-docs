...
'function' candidate function(s) not accessible  
 ...
 C3767 may also be caused by a breaking change: native types are now private by default in a **/clr** compilation; see [Type visibility](../VS_visualcpp/How-to--Define-and-Consume-Classes-and-Structs--C---CLI-.md#BKMK_Type_visibility) for more information.  
