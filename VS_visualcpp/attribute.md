...
> [!NOTE]
>  The `attribute` attribute is now deprecated.  Use the common language runtime attribute System.Attribute to directly to create user-defined attirbutes.  For more information, see [User-Defined Attributes](../VS_visualcpp/User-Defined-Attributes---C---Component-Extensions-.md).  
  
 You define a [custom attribute](../VS_visualcpp/Custom-Attributes--C---.md) by placing the `attribute` attribute on a managed class or struct definition. The name of the class is the custom attribute. For example:  
...
```  
 ...
 For a list of possible attribute parameter types, see [Custom Attributes](../VS_visualcpp/Custom-Attributes--C---.md).  
  
 See [User-Defined Attributes](../VS_visualcpp/User-Defined-Attributes---C---Component-Extensions-.md) for a discussion on attribute targets.  
