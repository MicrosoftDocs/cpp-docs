...
|`Max`|The max class representing the maximum number of elements to be stored in the free list. The max class can be [max_none](../VS_visualcpp/max_none-Class.md), [max_unbounded](../VS_visualcpp/max_unbounded-Class.md), [max_fixed_size](../VS_visualcpp/max_fixed_size-Class.md), or [max_variable_size](../VS_visualcpp/max_variable_size-Class.md).|  
