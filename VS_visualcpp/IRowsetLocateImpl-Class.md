...
|||  
|-|-|  
|[Compare](../VS_visualcpp/IRowsetLocateImpl--Compare.md)|Compares two bookmarks.|  
|[GetRowsAt](../VS_visualcpp/IRowsetLocateImpl--GetRowsAt.md)|Fetches rows starting with the row specified by an offset from a bookmark.|  
|[GetRowsByBookmark](../VS_visualcpp/IRowsetLocateImpl--GetRowsByBookmark.md)|Fetches the rows that match the specified bookmarks.|  
|[Hash](../VS_visualcpp/IRowsetLocateImpl--Hash.md)|Returns hash values for the specified bookmarks.|  
  
### Data Members  
  
|||  
|-|-|  
|[m_rgBookmarks](../VS_visualcpp/IRowsetLocateImpl--m_rgBookmarks.md)|An array of bookmarks.|  
...
## Remarks  
 ...
 For information on implementing bookmark support, see [Provider Support for Bookmarks](../VS_visualcpp/Provider-Support-for-Bookmarks.md) in the *Visual C++ Programmer's Guide* and [Bookmarks](https://msdn.microsoft.com/en-us/library/ms709728.aspx) in the *OLE DB Programmer's Reference* in the `Platform``SDK`.  
