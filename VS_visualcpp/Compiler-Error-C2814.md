...
## Example  
 Using Managed Extensions for C++, you must explicitly specify the "managed-ness" of an embedded type using one of the following keywords: [__gc](../Topic/__gc.md), [__nogc](../Topic/__nogc.md), or [__value](../Topic/__value.md).  
