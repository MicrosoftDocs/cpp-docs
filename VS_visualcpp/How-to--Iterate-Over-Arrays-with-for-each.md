...
This topic shows how to use the [for each, in](../VS_visualcpp/for-each--in.md) keyword on different types of arrays.  
...
**3 = in MyClass2**   
## Example  
 This sample shows for each iterating over a <xref:System.Collections.ArrayList?qualifyHint=False>, which implements <xref:System.Collections.IEnumerable?qualifyHint=False>.  
