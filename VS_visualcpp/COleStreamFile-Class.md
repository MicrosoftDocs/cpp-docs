...
## Remarks  
 ...
 `COleStreamFile` objects are manipulated exactly like [CFile](../VS_visualcpp/CFile-Class.md) objects.  
  
 For more information about manipulating streams and storages, see the article [Containers: Compound Files](../VS_visualcpp/Containers--Compound-Files.md)..  
...
### Parameters  
 `pError`  
 Points to a [CFileException](../VS_visualcpp/CFileException-Class.md) object or **NULL** that indicates the completion status of the create operation. Supply this parameter if you want to monitor possible exceptions generated by attempting to create the stream.  
...
### Parameters  
 ...
 `nOpenFlags`  
 Access mode to use when opening the stream. Exclusive, read/write, and create modes are used by default. For a complete list of the available modes, see [CFile::CFile](../VS_visualcpp/CFile-Class.md#cfile__cfile).  
  
 `pError`  
 Points to a [CFileException](../VS_visualcpp/CFileException-Class.md) object or **NULL**. Supply this parameter if you want to monitor possible exceptions generated by attempting to create the stream.  
...
### Parameters  
 ...
 `nOpenFlags`  
 Access mode to use when opening the stream. Exclusive and read/write modes are used by default. For the complete list of the available modes, see [CFile::CFile](../VS_visualcpp/CFile-Class.md#cfile__cfile).  
  
 `pError`  
 Points to a [CFileException](../VS_visualcpp/CFileException-Class.md) object or **NULL**. Supply this parameter if you want to monitor possible exceptions generated by attempting to open the stream.  
