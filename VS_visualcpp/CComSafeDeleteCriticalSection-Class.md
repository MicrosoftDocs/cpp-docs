...
## Remarks  
 `CComSafeDeleteCriticalSection` derives from the class [CComCriticalSection](../VS_visualcpp/CComCriticalSection-Class.md). However, `CComSafeDeleteCriticalSection` provides additional safety mechanisms over [CComCriticalSection](../VS_visualcpp/CComCriticalSection-Class.md).  
 ...
 See [CComCriticalSection](../VS_visualcpp/CComCriticalSection-Class.md) for more information on critical section helper classes.  
...
### Remarks  
 The **m_bInitialized** data member is used to track validity of the underlying **CRITICAL_SECTION** object associated with the [CComSafeDeleteCriticalSection](../VS_visualcpp/CComSafeDeleteCriticalSection-Class.md) class. The underlying **CRITICAL_SECTION** object will not be attempted to be released from memory if this flag is not set to **true**.  
