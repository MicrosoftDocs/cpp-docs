...
Calling managed 'entrypoint': Managed code may not be run under loader lock, including the DLL entrypoint and calls reached from the DLL entrypoint  
 ...
 For more information, see [Initialization of Mixed Assemblies](../VS_visualcpp/Initialization-of-Mixed-Assemblies.md) and [Linker Tools Error LNK1306](../VS_visualcpp/Linker-Tools-Error-LNK1306.md).  
