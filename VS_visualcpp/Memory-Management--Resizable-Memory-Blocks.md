...
The **new** and **delete** operators, described in the article [Memory Management: Examples](../VS_visualcpp/Memory-Management--Examples.md), are good for allocating and deallocating fixed-size memory blocks and objects. Occasionally, your application may need resizable memory blocks. You must use the standard C run-time library functions [malloc](../VS_visualcpp/malloc.md), [realloc](../VS_visualcpp/realloc.md), and [free](../VS_visualcpp/free.md) to manage resizable memory blocks on the heap.  
