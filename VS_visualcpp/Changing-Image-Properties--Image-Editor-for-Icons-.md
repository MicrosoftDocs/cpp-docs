...
2.  In the **Properties** window, change any or all properties for your image.  
    ...
    |**Palette**|Changes color properties. Double-click to select a color and display the [Custom Color Selector dialog box](../VS_visualcpp/Custom-Color-Selector-Dialog-Box--Image-Editor-for-Icons-.md). Define the color by typing RGB or HSL values in the appropriate text boxes.|  
