...
'variable' : a symbol declared with __declspec(process) must be const in /clr:pure mode  
 ...
 For more information, see [process](../VS_visualcpp/process.md) and [/clr (Common Language Runtime Compilation)](../VS_visualcpp/-clr--Common-Language-Runtime-Compilation-.md).  
