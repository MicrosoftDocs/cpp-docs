...
## Remarks  
 ATL uses `CComQIPtr` and [CComPtr](../VS_visualcpp/CComPtr-Class.md) to manage COM interface pointers, both of which derive from [CComPtrBase](../VS_visualcpp/CComPtrBase-Class.md). Both classes perform automatic reference counting through calls to `AddRef` and **Release**. Overloaded operators handle pointer operations.  
  
## Inheritance Hierarchy  
 [CComPtrBase](../VS_visualcpp/CComPtrBase-Class.md)  
  
 [CComPtr](../VS_visualcpp/CComPtr-Class.md)  
