...
## Example  
 To examine examples that use specific scheduler policies to control the behavior of the scheduler, see [How to: Specify Specific Scheduler Policies](../VS_visualcpp/How-to--Specify-Specific-Scheduler-Policies.md) and [How to: Create Agents that Use Specific Scheduler Policies](../VS_visualcpp/How-to--Create-Agents-that-Use-Specific-Scheduler-Policies.md).  
