...
## Remarks  
 This class is used by [CComHeapPtr](../VS_visualcpp/CComHeapPtr-Class.md) to provide the COM memory allocation routines. The counterpart class, [CCRTAllocator](../VS_visualcpp/CCRTAllocator-Class.md), provides the same methods using CRT routines.  
