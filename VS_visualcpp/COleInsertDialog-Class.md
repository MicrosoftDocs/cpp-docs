...
##  <a name="coleinsertdialog__createitem"></a>  COleInsertDialog::CreateItem  
 Call this function to create an object of type [COleClientItem](../VS_visualcpp/COleClientItem-Class.md) only if [DoModal](#coleinsertdialog__domodal) returns **IDOK**.  
