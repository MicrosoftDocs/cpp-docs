...
---
# CTabView Class
The `CTabView` class simplifies the use of the tab control class ( [CMFCTabCtrl](../VS_visualcpp/CTabView-Class.md)) in applications that use MFC's document/view architecture.  
...
## Remarks  
 ...
 [TabbedView Sample: MFC Tabbed View Application](../VS_visualcpp/Visual-C---Samples.md) illustrates usage of `CTabView`.  
...
### Remarks  
 For more information see [CMFCTabCtrl::SetActiveTab](../VS_visualcpp/CMFCTabCtrl-Class.md#cmfctabctrl__setactivetab).  
  
## See Also  
 [Hierarchy Chart](../VS_visualcpp/Hierarchy-Chart.md)   
 [Classes](../VS_visualcpp/MFC-Classes.md)   
 [CMFCTabCtrl](../VS_visualcpp/CTabView-Class.md)   
