...
---
# CFileFind Class
Performs local file searches and is the base class for [CGopherFileFind](../VS_visualcpp/CGopherFileFind-Class.md) and [CFtpFileFind](../VS_visualcpp/CFtpFileFind-Class.md), which perform Internet file searches.  
...
## Remarks  
 ...
 For more information about how to use `CFileFind` and the other WinInet classes, see the article [Internet Programming with WinInet](../VS_visualcpp/Win32-Internet-Extensions--WinInet-.md).  
