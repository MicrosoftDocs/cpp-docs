...
**Microsoft Specific**  
 ...
 The most complete and up-to-date information on this topic can be found in [dllexport, dllimport](../VS_visualcpp/dllexport--dllimport.md).  
...
```  
 ...
 For specific information about the syntax for extended storage-class modifiers, see [Extended Storage-Class Attributes](../VS_visualcpp/C-Extended-Storage-Class-Attributes.md).  
