 ...
 **Concurrency Runtime Architecture**  
 ...
 ![The Concurrency Runtime Architecture](../VS_visualcpp/media/ConcurrencyRun.png "ConcurrencyRun")  
  
> [!IMPORTANT]
>  The Task Scheduler and Resource Manager components are not available from a Windows 8.x Store app or when you use the task class or other types in ppltasks.h.  
 ...
 The Concurrency Runtime also provides synchronization primitives that use cooperative blocking to synchronize access to resources. For more information about these synchronization primitives, see [Synchronization Data Structures](../VS_visualcpp/Synchronization-Data-Structures.md).  
...
### Parallel Patterns Library  
 ...
 For more information about the Parallel Patterns Library, see [Parallel Patterns Library (PPL)](../VS_visualcpp/Parallel-Patterns-Library--PPL-.md).  
...
### Task Scheduler  
 ...
 For more information about the Task Scheduler, see [Task Scheduler](../VS_visualcpp/Task-Scheduler--Concurrency-Runtime-.md).  
...
**6561**  
**65536**  
**390625** For more information about lambda functions in C++, see [Lambda Expressions](../VS_visualcpp/Lambda-Expressions-in-C--.md).  
...
|Resource Manager|concrtrm.h|  
 ...
 The Concurrency Runtime is declared in the [Concurrency](../VS_visualcpp/concurrency-Namespace.md) namespace. (You can also use [concurrency](../VS_visualcpp/concurrency-Namespace.md), which is an alias for this namespace.) The `concurrency::details` namespace supports the Concurrency Runtime framework, and is not intended to be used directly from your code.  
  
 The Concurrency Runtime is provided as part of the C Runtime Library (CRT). For more information about how to build an application that uses the CRT, see [CRT Library Features](../VS_visualcpp/CRT-Library-Features.md).  
