...
---
# setbuf
Controls stream buffering. This function is deprecated; use [setvbuf](../VS_visualcpp/setvbuf.md) instead.  
...
## Remarks  
 ...
 `setbuf` has been replaced by [setvbuf](../VS_visualcpp/setvbuf.md), which is the preferred routine for new code. `setbuf` is retained for compatibility with existing code.  
