...
-   Create or subclass a window using one of the following classes derived from `CWindow`:  
     ...
     [CWindowImpl](../VS_visualcpp/CWindowImpl-Class.md) Allows you to create a new window or subclass an existing window.  
  
     [CContainedWindow](../VS_visualcpp/CContainedWindowT-Class.md) Implements a window contained within another object. You can create a new window or subclass an existing window.  
  
     [CDialogImpl](../VS_visualcpp/CDialogImpl-Class.md) Allows you to create a modal or modeless dialog box.  
  
 For more information about windows, see [Windows](http://msdn.microsoft.com/library/windows/desktop/ms632595) and subsequent topics in the Windows SDK. For more information about using windows in ATL, see the article [ATL Window Classes](../VS_visualcpp/ATL-Window-Classes.md).  
...
### Parameters  
 ...
 `rect`  
 [in] A variable of type [_U_RECT](../VS_visualcpp/_U_RECT-Class.md) specifying the position of the window. The default value is **NULL**. When this parameter is **NULL**, the value of `CWindow::rcDefault` is used.  
 ...
 `MenuOrID`  
 [in] A variable of type [_U_MENUorID](../VS_visualcpp/_U_MENUorID-Class.md) specifying a handle to a menu or a window identifier. The default value is 0U.  
...
> [!NOTE]
>  `CWindow::CWindow` does not create a window. Classes [CWindowImpl](../VS_visualcpp/CWindowImpl-Class.md), [CContainedWindow](../VS_visualcpp/CContainedWindowT-Class.md), and [CDialogImpl](../VS_visualcpp/CDialogImpl-Class.md) (all of which derive from `CWindow`) provide a method to create a window or dialog box, which is then assigned to `CWindow::m_hWnd`. You can also use the [CreateWindow](http://msdn.microsoft.com/library/windows/desktop/ms632679) Win32 function.  
...
### Example  
 [!CODE [NVC_ATL_Windowing#13](../CodeSnippet/VS_Snippets_Cpp/NVC_ATL_Windowing#13)]  
...
### Remarks  
 ...
 The second version of this method allows you to store the text in a `BSTR`; the third version allows you to store the result in a [CString](../VS_visualcpp/CStringT-Class.md), since `CSimpleString` is the base class of `CString`.  
...
### Example  
 [!CODE [NVC_ATL_Windowing#17](../CodeSnippet/VS_Snippets_Cpp/NVC_ATL_Windowing#17)]  
...
### Example  
 [!CODE [NVC_ATL_Windowing#35](../CodeSnippet/VS_Snippets_Cpp/NVC_ATL_Windowing#35)]  
...
### Example  
 [!CODE [NVC_ATL_Windowing#37](../CodeSnippet/VS_Snippets_Cpp/NVC_ATL_Windowing#37)]  
