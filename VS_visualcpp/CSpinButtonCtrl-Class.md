...
## Remarks  
 ...
 For more information on using `CSpinButtonCtrl`, see [Controls](../VS_visualcpp/Controls--MFC-.md) and [Using CSpinButtonCtrl](../VS_visualcpp/Using-CSpinButtonCtrl.md).  
...
### Parameters  
 ...
 `rect`  
 Specifies the spin button control's size and position. It can be either a [CRect](../VS_visualcpp/CRect-Class.md) object or a                                 [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) structure  
