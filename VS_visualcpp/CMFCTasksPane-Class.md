...
|[CMFCTasksPane::CreateDefaultMiniframe](#cmfctaskspane__createdefaultminiframe)|(Overrides [CPane::CreateDefaultMiniframe](../VS_visualcpp/CPane-Class.md#cpane__createdefaultminiframe).)|  
...
|[CMFCTasksPane::GetScrollBarCtrl](#cmfctaskspane__getscrollbarctrl)|(Overrides [CWnd::GetScrollBarCtrl](../VS_visualcpp/CWnd-Class.md#cwnd__getscrollbarctrl).)|  
...
|[CMFCTasksPane::OnSetAccData](#cmfctaskspane__onsetaccdata)|(Overrides [CBasePane::OnSetAccData](../VS_visualcpp/CBasePane-Class.md#cbasepane__onsetaccdata).)|  
...
|[CMFCTasksPane::RecalcLayout](#cmfctaskspane__recalclayout)|(Overrides [CPane::RecalcLayout](../VS_visualcpp/CPane-Class.md#cpane__recalclayout).)|  
...
2.  When processing the `WM_CREATE` message, call the `Create` method. You can use the regular [CControlBar](../VS_visualcpp/CControlBar-Class.md) styles. For more information, see `CControlBar::Create`.  
...
5.  Call [CMFCTasksPane::EnableGroupCollapse](#cmfctaskspane__enablegroupcollapse) to specify whether item groups can collapse.  
 ...
 ![Example of Task Pane](../VS_visualcpp/media/NextTaskPane.png "NextTaskPane")  
 ...
 ![Custom task group](../VS_visualcpp/media/NextTaskGrpCustom.png "NextTaskGrpCustom")  
...
## Inheritance Hierarchy  
 ...
 [CBasePane](../VS_visualcpp/CBasePane-Class.md) [CPane](../VS_visualcpp/CPane-Class.md) [CDockablePane](../VS_visualcpp/CDockablePane-Class.md)  
  
 [CMFCTasksPane](../VS_visualcpp/CMFCTasksPane-Class.md)  
...
### Parameters  
 ...
 [in] `bSpecial`  
 `TRUE` to mark this group as a *special* group; otherwise, `FALSE`. For more information about special groups, see the Remarks section of [CMFCTasksPane Class](../VS_visualcpp/CMFCTasksPane-Class.md).  
...
##  <a name="cmfctaskspane__cmfctaskspane"></a>  CMFCTasksPane::CMFCTasksPane  
 Constructs a [CMFCTasksPane](../VS_visualcpp/CMFCTasksPane-Class.md) object.  
...
```  
void SetGroupCaptionHorzOffset(  
    int n = -1);  
```  
...
```  
void SetGroupCaptionVertOffset(  
    int n = -1);  
```  
