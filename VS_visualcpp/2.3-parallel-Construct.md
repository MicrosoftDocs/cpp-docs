...
-   **private**, **firstprivate**, **default**, **shared**, **copyin**, and **reduction** clauses, see [Section 2.7.2](../VS_visualcpp/2.7.2-Data-Sharing-Attribute-Clauses.md) on page 25.  
  
-   **OMP_NUM_THREADS** environment variable, [Section 4.2](../VS_visualcpp/4.2-OMP_NUM_THREADS.md) on page 48.  
  
-   **omp_set_dynamic** library function, see [Section 3.1.7](../VS_visualcpp/3.1.7-omp_set_dynamic-Function.md) on page 39.  
  
-   **OMP_DYNAMIC** environment variable, see [Section 4.3](../VS_visualcpp/4.3-OMP_DYNAMIC.md) on page 49.  
  
-   **omp_set_nested** function, see [Section 3.1.9](../VS_visualcpp/3.1.9-omp_set_nested-Function.md) on page 40.  
  
-   **OMP_NESTED** environment variable, see [Section 4.4](../VS_visualcpp/4.4-OMP_NESTED.md) on page 49.  
  
-   **omp_set_num_threads** library function, see [Section 3.1.1](../VS_visualcpp/3.1.1-omp_set_num_threads-Function.md) on page 36.