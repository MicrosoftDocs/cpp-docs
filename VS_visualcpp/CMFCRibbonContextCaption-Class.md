...
|`CMFCRibbonContextCaption::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_visualcpp/CRuntimeClass-Structure.md) object that is associated with this class type.|  
  
## Remarks  
 This class cannot be directly instantiated. The [CMFCRibbonBar Class](../VS_visualcpp/CMFCRibbonBar-Class.md) class uses this class internally to add color to ribbon categories.  
  
 To set the color for ribbon categories, call [CMFCRibbonCategory::SetTabColor](../VS_visualcpp/CMFCRibbonCategory-Class.md#cmfcribboncategory__settabcolor). To set the color for context categories, call [CMFCRibbonBar::AddContextCategory](../VS_visualcpp/CMFCRibbonBar-Class.md#cmfcribbonbar__addcontextcategory).  
...
## Inheritance Hierarchy  
 ...
 [CMFCRibbonContextCaption](../VS_visualcpp/CMFCRibbonContextCaption-Class.md)  
...
### Remarks  
 The color of the caption can be set by calling [CMFCRibbonCategory::SetTabColor](../VS_visualcpp/CMFCRibbonCategory-Class.md#cmfcribboncategory__settabcolor) or [CMFCRibbonBar::AddContextCategory](../VS_visualcpp/CMFCRibbonBar-Class.md#cmfcribbonbar__addcontextcategory).  
