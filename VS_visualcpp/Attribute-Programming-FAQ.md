...
##  <a name="vcconattributeprogrammmingfaqanchor2"></a> When do I have to specify the parameter name for an attribute?  
 In most cases, if the attribute has a single parameter, that parameter is named. This name is not required when inserting the attribute in your code. For example, the following usage of the [aggregatable](../VS_visualcpp/aggregatable.md) attribute:  
...
||||  
|-|-|-|  
|[call_as](../VS_visualcpp/call_as.md)|[case](../VS_visualcpp/case--C---.md)|[cpp_quote](../VS_visualcpp/cpp_quote.md)|  
|[default](../VS_visualcpp/default--C---.md)|[defaultvalue](../VS_visualcpp/defaultvalue.md)|[defaultvtable](../VS_visualcpp/defaultvtable.md)|  
|[emitidl](../VS_visualcpp/emitidl.md)|[entry](../VS_visualcpp/entry.md)|[first_is](../VS_visualcpp/first_is.md)|  
|[helpcontext](../VS_visualcpp/helpcontext.md)|[helpfile](../VS_visualcpp/helpfile.md)|[helpstring](../VS_visualcpp/helpstring.md)|  
|[helpstringcontext](../VS_visualcpp/helpstringcontext.md)|[helpstringdll](../VS_visualcpp/helpstringdll.md)|[id](../VS_visualcpp/id.md)|  
|[iid_is](../VS_visualcpp/iid_is.md)|[import](../VS_visualcpp/import.md)|[importlib](../VS_visualcpp/importlib.md)|  
|[include](../VS_visualcpp/include--C---.md)|[includelib](../VS_visualcpp/includelib--C---.md)|[last_is](../VS_visualcpp/last_is.md)|  
|[length_is](../VS_visualcpp/length_is.md)|[max_is](../VS_visualcpp/max_is.md)|[no_injected_text](../VS_visualcpp/no_injected_text.md)|  
|[pointer_default](../VS_visualcpp/pointer_default.md)|[pragma](../VS_visualcpp/pragma.md)|[restricted](../VS_visualcpp/restricted.md)|  
|[size_is](../VS_visualcpp/size_is.md)|[source](../VS_visualcpp/source--C---.md)|[switch_is](../VS_visualcpp/switch_is.md)|  
|[switch_type](../VS_visualcpp/switch_type.md)|[transmit_as](../VS_visualcpp/transmit_as.md)|[wire_marshal](../VS_visualcpp/wire_marshal.md)|  
...
##  <a name="vcconattributeprogrammmingfaqhowcaniforwarddeclareanattributedinterface"></a> How can I forward declare an attributed interface?  
 If you are going to make a forward declaration of an attributed interface, you must apply the same attributes to the forward declaration that you apply to the actual interface declaration. You must also apply the [export](../VS_visualcpp/export.md) attribute to your forward declaration.  
