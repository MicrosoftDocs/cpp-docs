...
> [!NOTE]
>  This class is one of MFC's Open Database Connectivity (ODBC) classes. If you are instead using the newer Data Access Objects (DAO) classes, use [CDaoException](../VS_visualcpp/CDaoException-Class.md) instead. All DAO class names have "CDao" as a prefix. For more information, see the article [Overview: Database Programming](../VS_visualcpp/Data-Access-Programming--MFC-ATL-.md).  
 ...
 For more information about exception handling in general, or about `CDBException` objects, see the articles [Exception Handling (MFC)](../VS_visualcpp/Exception-Handling-in-MFC.md) and [Exceptions: Database Exceptions](../VS_visualcpp/Exceptions--Database-Exceptions.md).  
...
## See Also  
 ...
 [CRecordset::Update](../VS_visualcpp/CRecordset-Class.md#crecordset__update)   
 [CRecordset::Delete](../VS_visualcpp/CRecordset-Class.md#crecordset__delete)   
 [CException Class](../VS_visualcpp/CException-Class.md)