...
### Remarks  
 The `generic_categor`y object is an implementation of [error_category](../VS_visualcpp/error_category-Class.md).  
...
### Remarks  
 The `system_categor`y object is an implementation of [error_category](../VS_visualcpp/error_category-Class.md).  
