 ...
 **db_accessor** groups database column bindings into one or more accessors. For a discussion of the scenarios in which you need to use multiple accessors, see [Using Multiple Accessors on a Rowset](../VS_visualcpp/Using-Multiple-Accessors-on-a-Rowset.md). Also see "User Record Support for Multiple Accessors" in [User Records](../VS_visualcpp/User-Records.md).  
