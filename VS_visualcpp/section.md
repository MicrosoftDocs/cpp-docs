...
## Remarks  
 ...
 Once a section is defined, it remains valid for the remainder of the compilation. However, you must use [__declspec(allocate)](../VS_visualcpp/allocate.md) or nothing will be placed in the section.  
  
 *section-name* is a required parameter that will be the name of the section. The name must not conflict with any standard section names. See [/SECTION](../VS_visualcpp/-SECTION--Specify-Section-Attributes-.md) for a list of names you should not use when creating a section.  
