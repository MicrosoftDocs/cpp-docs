...
#### Parameters  
 ...
 `CDV`  
 A class that manages the connections. The default value is [CComDynamicUnkArray](../VS_visualcpp/CComDynamicUnkArray-Class.md), which allows unlimited connections. You can also use [CComUnkArray](../VS_visualcpp/CComUnkArray-Class.md), which specifies a fixed number of connections.  
...
### Remarks  
 By default, `m_vec` is of type [CComDynamicUnkArray](../VS_visualcpp/CComDynamicUnkArray-Class.md).  
