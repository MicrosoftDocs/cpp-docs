...
>  If you want to use both snapshots and dynasets, you must base them on two different `CDatabase` objects (two different connections).  
 ...
 For more information about the properties snapshots share with all recordsets, see [Recordset (ODBC)](../VS_visualcpp/Recordset--ODBC-.md). For more information about ODBC and snapshots*,* including the ODBC Cursor Library, see [ODBC](../VS_visualcpp/ODBC-Basics.md).  
