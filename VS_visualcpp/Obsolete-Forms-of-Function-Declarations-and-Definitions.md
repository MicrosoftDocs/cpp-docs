...
```  
 ...
 The next section, [C Function Definitions](../VS_visualcpp/C-Function-Definitions.md), shows the syntax for function definitions, including the old-style syntax. The nonterminal for the list of parameters in the old-style syntax is *identifier-list*.  
