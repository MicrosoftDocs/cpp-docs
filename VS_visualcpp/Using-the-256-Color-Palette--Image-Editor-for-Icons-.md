...
To draw with a selection from the 256-color palette, you need to select the colors from the Colors palette in the [Colors window](../VS_visualcpp/Colors-Window--Image-Editor-for-Icons-.md).  
