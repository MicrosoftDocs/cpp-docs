...
---
# _lsearch_s
Performs a linear search for a value. A version of [_lsearch](../VS_visualcpp/_lsearch.md) with security enhancements as described in [Security Features in the CRT](../VS_visualcpp/Security-Features-in-the-CRT.md).  
