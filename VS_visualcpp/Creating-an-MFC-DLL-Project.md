...
1.  Define your application settings using the [application settings](../VS_visualcpp/Application-Settings--MFC-DLL-Wizard.md) page of the [MFC DLL Wizard](../VS_visualcpp/MFC-DLL-Wizard.md).  
