...
A type of toolbar button that behaves like a regular button when it is clicked. However, it opens a drop-down toolbar ( [CMFCDropDownToolBar Class](../VS_visualcpp/CMFCDropDownToolBar-Class.md) if the user presses and holds the toolbar button down.  
...
|Name|Description|  
|----------|-----------------|  
|[CMFCDropDownToolbarButton::CopyFrom](#cmfcdropdowntoolbarbutton__copyfrom)|Copies the properties of another toolbar button to the current button. (Overrides [CMFCToolBarButton::CopyFrom](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__copyfrom).)|  
...
|[CMFCDropDownToolbarButton::ExportToMenuButton](#cmfcdropdowntoolbarbutton__exporttomenubutton)|Copies text from the toolbar button to a menu. (Overrides [CMFCToolBarButton::ExportToMenuButton](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__exporttomenubutton).)|  
...
|`CMFCDropDownToolbarButton::GetThisClass`|Used by the framework to obtain a pointer to the [CRuntimeClass](../VS_visualcpp/CRuntimeClass-Structure.md) object that is associated with this class type.|  
...
|[CMFCDropDownToolbarButton::IsExtraSize](#cmfcdropdowntoolbarbutton__isextrasize)|Determines whether the button can be displayed with an extended border. (Overrides [CMFCToolBarButton::IsExtraSize](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__isextrasize).)|  
|[CMFCDropDownToolbarButton::OnCalculateSize](#cmfcdropdowntoolbarbutton__oncalculatesize)|Called by the framework to calculate the size of the button for the specified device context and docking state. (Overrides [CMFCToolBarButton::OnCalculateSize](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__oncalculatesize).)|  
...
|[CMFCDropDownToolbarButton::OnChangeParentWnd](#cmfcdropdowntoolbarbutton__onchangeparentwnd)|Called by the framework when the button is inserted into a new toolbar. (Overrides [CMFCToolBarButton::OnChangeParentWnd](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__onchangeparentwnd).)|  
|[CMFCDropDownToolbarButton::OnClick](#cmfcdropdowntoolbarbutton__onclick)|Called by the framework when the user clicks the mouse button. (Overrides [CMFCToolBarButton::OnClick](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__onclick).)|  
|[CMFCDropDownToolbarButton::OnClickUp](#cmfcdropdowntoolbarbutton__onclickup)|Called by the framework when the user releases the mouse button. (Overrides [CMFCToolBarButton::OnClickUp](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__onclickup).)|  
|[CMFCDropDownToolbarButton::OnContextHelp](#cmfcdropdowntoolbarbutton__oncontexthelp)|Called by the framework when the parent toolbar handles a `WM_HELPHITTEST` message. (Overrides [CMFCToolBarButton::OnContextHelp](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__oncontexthelp).)|  
|[CMFCDropDownToolbarButton::OnCustomizeMenu](#cmfcdropdowntoolbarbutton__oncustomizemenu)|Modifies the provided menu when the application displays a shortcut menu on the parent toolbar. (Overrides [CMFCToolBarButton::OnCustomizeMenu](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__oncustomizemenu).)|  
|[CMFCDropDownToolbarButton::OnDraw](#cmfcdropdowntoolbarbutton__ondraw)|Called by the framework to draw the button by using the specified styles and options. (Overrides [CMFCToolBarButton::OnDraw](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__ondraw).)|  
...
|[CMFCDropDownToolbarButton::Serialize](#cmfcdropdowntoolbarbutton__serialize)|Reads this object from an archive or writes it to an archive. (Overrides [CMFCToolBarButton::Serialize](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__serialize).)|  
...
## Remarks  
 ...
 For information about how to implement a drop-down toolbar, see [CMFCDropDownToolBar Class](../VS_visualcpp/CMFCDropDownToolBar-Class.md).  
  
 The `CMFCDropDownToolBarButton` object can be exported to a [CMFCToolBarMenuButton Class](../VS_visualcpp/CMFCToolBarMenuButton-Class.md) object and displayed as a menu button with a pop-up menu.  
...
## Inheritance Hierarchy  
 ...
 [CMFCDropDownToolbarButton](../VS_visualcpp/CMFCDropDownToolbarButton-Class.md)  
...
### Remarks  
 ...
 This methods creates the drop-down toolbar by using the [CMFCDropDownFrame::Create](../VS_visualcpp/CMFCDropDownFrame-Class.md#cmfcdropdownframe__create) method. If the parent toolbar is docked vertically, this method positions the drop-down toolbar either to the left-hand or right-hand side of the parent toolbar, depending on the fit. Otherwise, this method positions the drop-down toolbar underneath the parent toolbar.  
...
### Remarks  
 This method calls the base class implementation ( [CMFCToolBarButton::ExportToMenuButton](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__exporttomenubutton)) and then appends to the target menu button a pop-up menu that contains each toolbar menu item in this button. This method does not append sub-menus to the pop-up menu.  
...
### Remarks  
 For more information about extended borders, see [CMFCToolBarButton::IsExtraSize](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__isextrasize).  
...
### Remarks  
 This method extends the base class implementation ( [CMFCToolBarButton::OnCalculateSize](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__oncalculatesize)) by adding the width of the drop-down arrow to the horizontal dimension of the button size.  
...
### Remarks  
 This method overrides the base class implementation ( [CMFCToolBarButton::OnChangeParentWnd](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__onchangeparentwnd)) by clearing the text label ( [CMFCToolBarButton::m_strText](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__m_strtext)) and setting the [CMFCToolBarButton::m_bText](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__m_btext) and [CMFCToolBarButton::m_bUserButton](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__m_buserbutton) data members to `FALSE`.  
...
### Remarks  
 This method extends the base class implementation, [CMFCToolBarButton::OnClick](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__onclick), by updating the state of the drop-down toolbar.  
...
### Remarks  
 This method extends the base class implementation, [CMFCToolBarButton::OnClickUp](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__onclickup), by updating the state of the drop-down toolbar.  
...
### Remarks  
 This method extends the base class implementation ( [CMFCToolBarButton::OnContextHelp](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__oncontexthelp)) by calling the [CMFCDropDownToolbarButton::OnClick](#cmfcdropdowntoolbarbutton__onclick) method with `bDelay` set to `FALSE`. This method returns the value that is returned by [CMFCDropDownToolbarButton::OnClick](#cmfcdropdowntoolbarbutton__onclick).  
  
 For more information about the `WM_HELPHITTEST message, see` [TN028: Context-Sensitive Help Support](../VS_visualcpp/TN028--Context-Sensitive-Help-Support.md).  
...
### Remarks  
 This method extends the base class implementation ( [CMFCToolBarButton::OnCustomizeMenu](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__oncustomizemenu)) by disabling the following menu items:  
...
### Remarks  
 This method extends the base class implementation ( [CMFCToolBarButton::Serialize](../VS_visualcpp/CMFCToolBarButton-Class.md#cmfctoolbarbutton__serialize)) by serializing the resource ID of the parent toolbar. When the archive is loading ( [CArchive::IsLoading](../VS_visualcpp/CArchive-Class.md#carchive__isloading) returns a nonzero value), this method sets the `m_pToolBar` data member to the toolbar that contains the serialized resource ID.  
