...
6.  Click in the newly created tab in Visual Studio and type a valid Visual C++ program, or copy and paste one of the sample programs.  
     ...
     For example, you can use the [How to: Write a Text File (C++/CLI)](../VS_visualcpp/How-to--Write-a-Text-File--C---CLI-.md) sample program (in the **File Handling and I/O** node of the Programming Guide).  
     ...
     For more information on the new Visual C++ syntax, see [Component Extensions for Runtime Platforms](../VS_visualcpp/Component-Extensions-for-Runtime-Platforms.md).  
...
## What's Next  
 **Previous:** [Walkthrough: Compiling a Native C++ Program on the Command Line](../VS_visualcpp/Walkthrough--Compiling-a-Native-C---Program-on-the-Command-Line.md) &#124; **Next:**[Walkthrough: Compiling a C Program on the Command Line](../VS_visualcpp/Walkthrough--Compiling-a-C-Program-on-the-Command-Line.md)  
