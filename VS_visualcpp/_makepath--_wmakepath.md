...
Create a path name from components. More secure versions of these functions are available; see [_makepath_s, _wmakepath_s](../VS_visualcpp/_makepath_s--_wmakepath_s.md).  
