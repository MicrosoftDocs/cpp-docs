...
### Remarks  
 Specifies apartment threading. See                         [Specifying the Project's Threading Model](../VS_visualcpp/Specifying-the-Threading-Model-for-a-Project--ATL-.md) for other threading options, and                         [Options, ATL Simple Object Wizard](../VS_visualcpp/Options--ATL-Simple-Object-Wizard.md) for a description of the threading models available for an ATL object.  
...
### Remarks  
 Specifies free threading. Free threading is equivalent to a multithread apartment model. See                         [Specifying the Project's Threading Model](../VS_visualcpp/Specifying-the-Threading-Model-for-a-Project--ATL-.md) for other threading options, and                         [Options, ATL Simple Object Wizard](../VS_visualcpp/Options--ATL-Simple-Object-Wizard.md) for a description of the threading models available for an ATL object.  
...
### Remarks  
 Specifies that the object always runs in the primary COM thread. See                         [Specifying the Project's Threading Model](../VS_visualcpp/Specifying-the-Threading-Model-for-a-Project--ATL-.md) for other threading options, and                         [Options, ATL Simple Object Wizard](../VS_visualcpp/Options--ATL-Simple-Object-Wizard.md) for a description of the threading models available for an ATL object.  
