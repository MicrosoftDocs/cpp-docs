...
2.  In the **Configuration Manager** dialog box, choose the **Active Solution Configuration** drop-down button and select **Release**. Choose the **Close** button.  
 ...
 ![PGO in the Performance and Diagnostics Hub](../VS_visualcpp/media/PGOFig0Hub.png "PGOFig0Hub")  
  
 In **Available Tools**, select the **Profile Guided Optimization** check box. Choose the **Start** button to start the PGO plug-in.  
  
 ![PGO introduction page](../VS_visualcpp/media/PGOFig1Start.png "PGOFig1Start")  
 ...
 ![PGO instrumentation page](../VS_visualcpp/media/PGOFig2Instrument.png "PGOFig2Instrument")  
 ...
 ![PGO instrumented build page](../VS_visualcpp/media/PGOFig3Build.PNG "PGOFig3Build")  
 ...
 ![PGO training page](../VS_visualcpp/media/PGOFig4Training.PNG "PGOFig4Training")  
 ...
 ![PGO analysis page](../VS_visualcpp/media/PGOFig5Analyze.png "PGOFig5Analyze")  
 ...
 ![PGO data file in Solution Explorer](../VS_visualcpp/media/PGOFig6Data.png "PGOFig6Data")  
 ...
 ![PGO output diagnostics](../VS_visualcpp/media/PGOFig7Diagnostics.png "PGOFig7Diagnostics")  
