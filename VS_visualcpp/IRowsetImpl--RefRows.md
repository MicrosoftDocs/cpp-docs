...
---
# IRowsetImpl::RefRows
Called by [AddRefRows](../VS_visualcpp/IRowsetImpl--AddRefRows.md) and [ReleaseRows](../VS_visualcpp/IRowsetImpl--ReleaseRows.md) to either increment or release a reference count to an existing row handle.  
