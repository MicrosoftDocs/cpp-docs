...
A literal is a program element that directly represents a value. This article covers literals of type integer, floating-point, boolean and pointer. For information about string and character literals, see [String and Character Literals  (C++)](../VS_visualcpp/String-and-Character-Literals---C---.md). You can also define your own literals based on any of these categories; for more information see [User-Defined Literals  (C++)](../VS_visualcpp/User-Defined-Literals---C---.md)  
...
## Pointer literal (C++11)  
 C++ introduces the [nullptr](../VS_visualcpp/nullptr.md) literal to specify a zero-initialized pointer. In portable code, `nullptr` should be used instead of integral-type zero or macros such as NULL.  
...
## See Also  
 ...
 [C++ String Literals](../VS_visualcpp/String-and-Character-Literals---C---.md)   
 [C++ User-Defined Literals](../VS_visualcpp/User-Defined-Literals---C---.md)