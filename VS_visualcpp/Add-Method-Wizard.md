...
|MFC ActiveX control dispinterface|Provide your own or select either of the stock methods [DoClick](../Topic/COleControl::DoClick.md) and [Refresh](../Topic/COleControl::Refresh.md). See [MFC ActiveX Controls: Adding Stock Methods](../VS_visualcpp/MFC-ActiveX-Controls--Adding-Stock-Methods.md) for more information.|  
...
## See Also  
 [Adding a Method](../VS_visualcpp/Adding-a-Method---Visual-C---.md)   
