...
## Remarks  
 ...
 You must use [/EHa](../VS_visualcpp/-EH--Exception-Handling-Model-.md) when using `_set_se_translator`.  
...
|`_set_se_translator`|<eh.h>|  
 ...
 The functionality provided by `_set_se_translator` is not available in code compiled with the [/clr:pure](../VS_visualcpp/-clr--Common-Language-Runtime-Compilation-.md) compiler option.  
