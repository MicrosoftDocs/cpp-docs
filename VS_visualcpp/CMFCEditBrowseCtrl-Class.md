...
## Inheritance Hierarchy  
 ...
 [CMFCEditBrowseCtrl](../VS_visualcpp/CMFCEditBrowseCtrl-Class.md)  
  
## Example  
 The following example demonstrates how to use two methods in the `CMFCEditBrowseCtrl` class: `EnableFolderBrowseButton` and `EnableFileBrowseButton`. This example is part of the [New Controls sample](../VS_visualcpp/Visual-C---Samples.md).  
