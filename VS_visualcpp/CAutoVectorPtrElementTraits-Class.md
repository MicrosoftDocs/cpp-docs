...
## Remarks  
 This class provides methods, static functions, and typedefs for aiding the creation of collection class objects containing smart pointers. Unlike [CAutoPtrElementTraits](../VS_visualcpp/CAutoPtrElementTraits-Class.md), this class uses vector new and delete operators.  
