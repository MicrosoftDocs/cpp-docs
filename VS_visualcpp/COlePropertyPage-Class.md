...
## Remarks  
 ...
 For more information on using `COlePropertyPage`, see the article [ActiveX Controls: Property Pages](../VS_visualcpp/MFC-ActiveX-Controls--Property-Pages.md).  
...
## See Also  
 [MFC Sample CIRC3](../VS_visualcpp/Visual-C---Samples.md)   
