...
An "item" in a list control ([CListCtrl](../VS_visualcpp/CListCtrl-Class.md)) consists of an icon, a label, and possibly other information (in "subitems").  
