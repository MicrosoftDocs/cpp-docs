...
3.  Implement an override of `OnGetEmbeddedItem` for your server-document class. For further information, see the article [Servers: Implementing Server Documents](../VS_visualcpp/Servers--Implementing-Server-Documents.md) and the MFC OLE sample [HIERSVR](../VS_visualcpp/Visual-C---Samples.md).  
...
##  <a name="_core_a_tip_for_server.2d.item_architecture"></a> A Tip for Server-Item Architecture  
 ...
 For more information, see [CView::OnDraw](../Topic/CView::OnDraw.md), [COleServerItem](../VS_visualcpp/COleServerItem-Class.md), [COleServerItem::OnDraw](../Topic/COleServerItem::OnDraw.md), and [COleServerDoc::OnGetEmbeddedItem](../Topic/COleServerDoc::OnGetEmbeddedItem.md) in the *Class Library Reference*.  
