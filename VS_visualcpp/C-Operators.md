...
---
# C Operators
The C operators are a subset of the [C++ operators](../Topic/C++%20Operators.md).  
...
|**,**|Sequential-evaluation operator|  
 ...
 The base operator (**:>**), supported by previous versions of the Microsoft 16-bit C compiler, is described in [C Language Syntax Summary](../VS_visualcpp/C-Language-Syntax-Summary.md).  
