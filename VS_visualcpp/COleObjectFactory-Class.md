...
-   Registering control object factories with the OLE system registry.  
 ...
 For more information about object creation, see the articles [Data Objects and Data Sources (OLE)](../VS_visualcpp/Data-Objects-and-Data-Sources--OLE-.md) and [Data Objects and Data Sources: Creation and Destruction](../VS_visualcpp/Data-Objects-and-Data-Sources--Creation-and-Destruction.md). For more about registration, see the article [Registration](../VS_visualcpp/Registration.md).  
...
### Remarks  
 Override this function to create the object from something other than the [CRuntimeClass](../VS_visualcpp/CRuntimeClass-Structure.md) passed to the constructor.  
...
### Remarks  
 This function is usually called by [CWinApp::InitInstance](../VS_visualcpp/CWinApp-Class.md#cwinapp__initinstance) when the application is launched.  
...
### Remarks  
 The framework calls this function automatically before the application terminates. If necessary, call it from an override of [CWinApp::ExitInstance](../VS_visualcpp/CWinApp-Class.md#cwinapp__exitinstance).  
...
-   **UpdateRegistry(**  `lpszProgID`  **)** Registers this object factory with the OLE system registry. This function is usually called by [CWinApp::InitInstance](../VS_visualcpp/CWinApp-Class.md#cwinapp__initinstance) when the application is launched.  
