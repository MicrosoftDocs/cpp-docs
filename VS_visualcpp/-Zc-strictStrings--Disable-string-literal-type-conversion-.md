...
> [!NOTE]
>  The Standard C++ Library in Visual C++ in Visual Studio 2013 does not support the **/Zc:strictStrings** compiler option in debug builds. If you see several [C2665](../VS_visualcpp/Compiler-Error-C2665.md) errors in your build output, this may be the cause.  
