...
### Remarks  
 The object is used as a function argument to match the parameter type [std::nothrow_t](../VS_visualcpp/nothrow_t-Structure.md).  
...
### Remarks  
 The function stores `_Pnew` in a static [new handler](../VS_visualcpp/-new--typedefs.md#new_handler) pointer that it maintains, then returns the value previously stored in the pointer. The new handler is used by [operator new](../VS_visualcpp/-new--operators.md#operator_new)( **size_t**).  
