...
-   A tie pointer to an object of type [basic_istream](../VS_visualcpp/basic_istream-Class.md)**<Elem, Traits>**.  
  
-   A stream buffer pointer to an object of type [basic_streambuf](../VS_visualcpp/basic_streambuf-Class.md)**<Elem, Traits >**.  
  
-   [Formatting information](../VS_visualcpp/ios_base-Class.md).  
  
-   [Stream state information](../VS_visualcpp/ios_base-Class.md) in a base object of type [ios_base](../VS_visualcpp/ios_base-Class.md).  
...
### Return Value  
 ...
 For more information on `badbit`, see [ios_base::iostate](../VS_visualcpp/ios_base-Class.md#ios_base__iostate).  
...
### Remarks  
 ...
 If `state`**&**[exceptions](#basic_ios__exceptions) is nonzero, it then throws an object of class [failure](../VS_visualcpp/ios_base-Class.md#ios_base__failure).  
  
### Example  
  See [rdstate](#basic_ios__rdstate) and [getline](../VS_visualcpp/-string--functions.md#getline_template_function) for examples using **clear**.  
...
### Remarks  
 The member function reports the callback eventÂ erase_event. It then copies from `_Right` into **\*this** the fill character, the tie pointer, and the formatting information. Before altering the exception mask, it reports the callback event copyfmt_event. If, after the copy is complete,                         **state &**[exceptions](#basic_ios__exceptions) is nonzero, the function effectively calls [clear](#basic_ios__clear) with the argument [rdstate](#basic_ios__rdstate). It returns **\*this**.  
...
### Remarks  
 The member function returns `true` if [rdstate](#basic_ios__rdstate) `& eofbit` is nonzero. For more information on `eofbit`, see [ios_base::iostate](../VS_visualcpp/ios_base-Class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `failbit`, see [ios_base::iostate](../VS_visualcpp/ios_base-Class.md#ios_base__iostate).  
...
### Return Value  
 ...
 For more information on `goodbit`, see [ios_base::iostate](../VS_visualcpp/ios_base-Class.md#ios_base__iostate).  
...
### Remarks  
 ...
 `rdbuf`->                        [pubimbue](../VS_visualcpp/basic_streambuf-Class.md#basic_streambuf__pubimbue)(_ *Loc*)  
  
 In any case, it returns [ios_base::imbue](../VS_visualcpp/ios_base-Class.md#ios_base__imbue)(_ *Loc*).  
...
-   [rdstate](#basic_ios__rdstate) returns [goodbit](../VS_visualcpp/ios_base-Class.md#ios_base__iostate) if `_Sb` is nonzero; otherwise, it returns [badbit](../VS_visualcpp/ios_base-Class.md#ios_base__iostate).  
  
-   [exceptions](#basic_ios__exceptions) returns **goodbit**.  
  
-   [flags](../VS_visualcpp/ios_base-Class.md#ios_base__flags) returns [skipws](../VS_visualcpp/ios_base-Class.md#ios_base__fmtflags) &#124;                                 [dec](../VS_visualcpp/ios_base-Class.md#ios_base__fmtflags).  
  
-   [width](../VS_visualcpp/ios_base-Class.md#ios_base__width) returns 0.  
  
-   [precision](../VS_visualcpp/ios_base-Class.md#ios_base__precision) returns 6.  
  
-   [fill](#basic_ios__fill) returns the space character.  
  
-   [getloc](../VS_visualcpp/ios_base-Class.md#ios_base__getloc) returns `locale::classic`.  
  
-   [iword](../VS_visualcpp/ios_base-Class.md#ios_base__iword) returns zero, and [pword](../VS_visualcpp/ios_base-Class.md#ios_base__pword) returns a null pointer for all argument values.  
...
### Remarks  
 The member function returns [use_facet](../VS_visualcpp/basic_filebuf-Class.md#basic_filebuf__open)**<**Â **ctype**<                        **E**> >(                         [getloc](../VS_visualcpp/ios_base-Class.md#ios_base__getloc)( ) ).                         `narrow`(                        `_Char`,                         `_Default`).  
...
### Remarks  
 The member function returns [use_facet](../VS_visualcpp/basic_filebuf-Class.md#basic_filebuf__open)<                         **ctype**<                        **E**> >(                         [getloc](../VS_visualcpp/ios_base-Class.md#ios_base__getloc)).                         `widen`(                        `_Char`).  
