...
The `CDaoRelationInfo` structure contains information about a relation defined between fields of two tables in a [CDaoDatabase](../VS_visualcpp/CDaoDatabase-Class.md) object.  
...
-   **dbRelationDeleteCascade** Deletions will cascade.  
 ...
 `m_pFieldInfos`  
 A pointer to an array of [CDaoRelationFieldInfo](../VS_visualcpp/CDaoRelationFieldInfo-Structure.md) structures. The array contains one object for each field in the relation. The `m_nFields` data member gives a count of the array elements.  
