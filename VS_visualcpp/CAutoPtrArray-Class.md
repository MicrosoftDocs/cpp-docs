...
## Remarks  
 This class provides a constructor and derives methods from [CAtlArray](../VS_visualcpp/CAtlArray-Class.md) and [CAutoPtrElementTraits](../VS_visualcpp/CAutoPtrElementTraits-Class.md) to aid the creation of a collection class object storing smart pointers.  
